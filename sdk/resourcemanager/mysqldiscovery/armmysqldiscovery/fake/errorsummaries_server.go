...
type ErrorSummariesServer struct {
	...
	Get func(ctx context.Context, resourceGroupName string, siteName string, errorSummaryName string, options *armmysqldiscovery.ErrorSummariesClientGetOptions) (resp azfake.Responder[armmysqldiscovery.ErrorSummariesClientGetResponse], errResp azfake.ErrorResponder)

	// NewListBySitePager is the fake for method ErrorSummariesClient.NewListBySitePager
	// HTTP status codes to indicate success: http.StatusOK
	NewListBySitePager func(resourceGroupName string, siteName string, options *armmysqldiscovery.ErrorSummariesClientListBySiteOptions) (resp azfake.PagerResponder[armmysqldiscovery.ErrorSummariesClientListBySiteResponse])
}
