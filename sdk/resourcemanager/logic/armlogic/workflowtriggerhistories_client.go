...
func (client *WorkflowTriggerHistoriesClient) getCreateRequest(ctx context.Context, resourceGroupName string, workflowName string, triggerName string, historyName string, _ *WorkflowTriggerHistoriesClientGetOptions) (*policy.Request, error) {
...
//     method.
func (client *WorkflowTriggerHistoriesClient) BeginResubmit(ctx context.Context, resourceGroupName string, workflowName string, triggerName string, historyName string, options *WorkflowTriggerHistoriesClientBeginResubmitOptions) (*runtime.Poller[WorkflowTriggerHistoriesClientResubmitResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.resubmit(ctx, resourceGroupName, workflowName, triggerName, historyName, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2019-05-01
func (client *WorkflowTriggerHistoriesClient) resubmit(ctx context.Context, resourceGroupName string, workflowName string, triggerName string, historyName string, options *WorkflowTriggerHistoriesClientBeginResubmitOptions) (*http.Response, error) {
	var err error
...
func (client *WorkflowTriggerHistoriesClient) resubmitCreateRequest(ctx context.Context, resourceGroupName string, workflowName string, triggerName string, historyName string, _ *WorkflowTriggerHistoriesClientBeginResubmitOptions) (*policy.Request, error) {
