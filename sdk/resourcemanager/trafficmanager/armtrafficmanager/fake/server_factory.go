...
type ServerFactory struct {
	...
	// GeographicHierarchiesServer contains the fakes for client GeographicHierarchiesClient
	GeographicHierarchiesServer GeographicHierarchiesServer

	// HeatMapServer contains the fakes for client HeatMapClient
	HeatMapServer HeatMapServer

	// ProfilesServer contains the fakes for client ProfilesClient
	ProfilesServer ProfilesServer

	// UserMetricsKeysServer contains the fakes for client UserMetricsKeysClient
