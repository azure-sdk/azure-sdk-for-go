...
func (client *AccountConnectorsClient) createOrUpdateCreateRequest(ctx context.Context, connectorName string, connectorSetting ConnectorSetting, _ *AccountConnectorsClientCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *AccountConnectorsClient) deleteCreateRequest(ctx context.Context, connectorName string, _ *AccountConnectorsClientDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/providers/Microsoft.Security/connectors/{connectorName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *AccountConnectorsClient) getCreateRequest(ctx context.Context, connectorName string, _ *AccountConnectorsClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/providers/Microsoft.Security/connectors/{connectorName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *AccountConnectorsClient) listCreateRequest(ctx context.Context, _ *AccountConnectorsClientListOptions) (*policy.Request, error) {
