...
type PrivateAccessesServer struct {
	...
	// BeginPatch is the fake for method PrivateAccessesClient.BeginPatch
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginPatch func(ctx context.Context, resourceGroupName string, privateAccessName string, privateAccessPatch armchaos.PrivateAccessPatch, options *armchaos.PrivateAccessesClientBeginPatchOptions) (resp azfake.PollerResponder[armchaos.PrivateAccessesClientPatchResponse], errResp azfake.ErrorResponder)
}
...
func NewPrivateAccessesServerTransport(srv *PrivateAccessesServer) *PrivateAccessesServerTransport {
	return &PrivateAccessesServerTransport{
		...
		beginPatch:                             newTracker[azfake.PollerResponder[armchaos.PrivateAccessesClientPatchResponse]](),
	}
}
...
type PrivateAccessesServerTransport struct {
	...
	beginPatch                             *tracker[azfake.PollerResponder[armchaos.PrivateAccessesClientPatchResponse]]
}
...
func (p *PrivateAccessesServerTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "PrivateAccessesClient.BeginPatch":
...
func (p *PrivateAccessesServerTransport) dispatchBeginPatch(req *http.Request) (*http.Response, error) {
	...
	if beginPatch == nil {
		...
		respr, errRespr := p.srv.BeginPatch(req.Context(), resourceGroupNameParam, privateAccessNameParam, body, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginPatch = &respr
