...
- New function `*AzureBareMetalInstancesClient.Put(context.Context, string, string, *AzureBareMetalInstancesClientPutOptions) (AzureBareMetalInstancesClientPutResponse, error)`
