...
type ContainerAppsBuildsByContainerAppServer struct {
	...
	NewListPager func(resourceGroupName string, options *armappcontainers.ContainerAppsBuildsByContainerAppClientListOptions) (resp azfake.PagerResponder[armappcontainers.ContainerAppsBuildsByContainerAppClientListResponse])
}
