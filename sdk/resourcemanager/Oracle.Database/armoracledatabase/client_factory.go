...
func (c *ClientFactory) NewCloudExadataInfrastructuresClient() *CloudExadataInfrastructuresClient {
	subClient, _ := NewCloudExadataInfrastructuresClient(c.subscriptionID, c.credential, c.options)
	return subClient
}
...
func (c *ClientFactory) NewCloudVMClustersClient() *CloudVMClustersClient {
	subClient, _ := NewCloudVMClustersClient(c.subscriptionID, c.credential, c.options)
	return subClient
}
...
func (c *ClientFactory) NewDNSPrivateViewsClient() *DNSPrivateViewsClient {
	subClient, _ := NewDNSPrivateViewsClient(c.subscriptionID, c.credential, c.options)
	return subClient
}
...
func (c *ClientFactory) NewDbSystemShapesClient() *DbSystemShapesClient {
	subClient, _ := NewDbSystemShapesClient(c.subscriptionID, c.credential, c.options)
	return subClient
}

// NewGiVersionsClient creates a new instance of GiVersionsClient.
func (c *ClientFactory) NewGiVersionsClient() *GiVersionsClient {
	subClient, _ := NewGiVersionsClient(c.subscriptionID, c.credential, c.options)
	return subClient
}
...
func (c *ClientFactory) NewOracleSubscriptionsClient() *OracleSubscriptionsClient {
	subClient, _ := NewOracleSubscriptionsClient(c.subscriptionID, c.credential, c.options)
	return subClient
}
...
func (c *ClientFactory) NewVirtualNetworkAddressesClient() *VirtualNetworkAddressesClient {
	subClient, _ := NewVirtualNetworkAddressesClient(c.subscriptionID, c.credential, c.options)
	return subClient
}
