...
// SapLandscapeMonitorServer is a fake server for instances of the sapmonitors.SapLandscapeMonitorClient type.
type SapLandscapeMonitorServer struct {
	// Create is the fake for method SapLandscapeMonitorClient.Create
	// HTTP status codes to indicate success: http.StatusOK, http.StatusCreated
	Create func(ctx context.Context, resourceGroupName string, monitorName string, resource sapmonitors.SapLandscapeMonitorResource, options *sapmonitors.SapLandscapeMonitorClientCreateOptions) (resp azfake.Responder[sapmonitors.SapLandscapeMonitorClientCreateResponse], errResp azfake.ErrorResponder)

	// Delete is the fake for method SapLandscapeMonitorClient.Delete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	Delete func(ctx context.Context, resourceGroupName string, monitorName string, options *sapmonitors.SapLandscapeMonitorClientDeleteOptions) (resp azfake.Responder[sapmonitors.SapLandscapeMonitorClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method SapLandscapeMonitorClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, monitorName string, options *sapmonitors.SapLandscapeMonitorClientGetOptions) (resp azfake.Responder[sapmonitors.SapLandscapeMonitorClientGetResponse], errResp azfake.ErrorResponder)

	// NewListByMonitorPager is the fake for method SapLandscapeMonitorClient.NewListByMonitorPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByMonitorPager func(resourceGroupName string, monitorName string, options *sapmonitors.SapLandscapeMonitorClientListByMonitorOptions) (resp azfake.PagerResponder[sapmonitors.SapLandscapeMonitorClientListByMonitorResponse])

	// Update is the fake for method SapLandscapeMonitorClient.Update
	// HTTP status codes to indicate success: http.StatusOK
	Update func(ctx context.Context, resourceGroupName string, monitorName string, properties sapmonitors.SapLandscapeMonitorResource, options *sapmonitors.SapLandscapeMonitorClientUpdateOptions) (resp azfake.Responder[sapmonitors.SapLandscapeMonitorClientUpdateResponse], errResp azfake.ErrorResponder)
}
...
// The returned SapLandscapeMonitorServerTransport instance is connected to an instance of sapmonitors.SapLandscapeMonitorClient via the
...
func NewSapLandscapeMonitorServerTransport(srv *SapLandscapeMonitorServer) *SapLandscapeMonitorServerTransport {
	return &SapLandscapeMonitorServerTransport{
		srv:                   srv,
		newListByMonitorPager: newTracker[azfake.PagerResponder[sapmonitors.SapLandscapeMonitorClientListByMonitorResponse]](),
	}
}

// SapLandscapeMonitorServerTransport connects instances of sapmonitors.SapLandscapeMonitorClient to instances of SapLandscapeMonitorServer.
...
type SapLandscapeMonitorServerTransport struct {
	...
	newListByMonitorPager *tracker[azfake.PagerResponder[sapmonitors.SapLandscapeMonitorClientListByMonitorResponse]]
}
...
func (s *SapLandscapeMonitorServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if sapLandscapeMonitorServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = sapLandscapeMonitorServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "SapLandscapeMonitorClient.NewListByMonitorPager":
				res.resp, res.err = s.dispatchNewListByMonitorPager(req)
...
func (s *SapLandscapeMonitorServerTransport) dispatchCreate(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[sapmonitors.SapLandscapeMonitorResource](req)
	if err != nil {
		return nil, err
	}
...
func (s *SapLandscapeMonitorServerTransport) dispatchNewListByMonitorPager(req *http.Request) (*http.Response, error) {
	...
	if newListByMonitorPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListByMonitorPager, req, func(page *sapmonitors.SapLandscapeMonitorClientListByMonitorResponse, createLink func() string) {
...
// set this to conditionally intercept incoming requests to SapLandscapeMonitorServerTransport
var sapLandscapeMonitorServerTransportInterceptor interface {
