...
type ServerFactory struct {
	...
	AppSpaceResourcesServer                   AppSpaceResourcesServer
	AppSpacesServer                           AppSpacesServer
...
type ServerFactoryTransport struct {
	...
	trAppSpaceResourcesServer                   *AppSpaceResourcesServerTransport
	trAppSpacesServer                           *AppSpacesServerTransport
...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "AppSpaceResourcesClient":
		initServer(s, &s.trAppSpaceResourcesServer, func() *AppSpaceResourcesServerTransport {
			return NewAppSpaceResourcesServerTransport(&s.srv.AppSpaceResourcesServer)
		})
		resp, err = s.trAppSpaceResourcesServer.Do(req)
	case "AppSpacesClient":
		initServer(s, &s.trAppSpacesServer, func() *AppSpacesServerTransport { return NewAppSpacesServerTransport(&s.srv.AppSpacesServer) })
		resp, err = s.trAppSpacesServer.Do(req)
