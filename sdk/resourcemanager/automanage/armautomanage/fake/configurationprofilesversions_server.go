...
func (c *ConfigurationProfilesVersionsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if configurationProfilesVersionsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = configurationProfilesVersionsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "ConfigurationProfilesVersionsClient.NewListChildResourcesPager":
				res.resp, res.err = c.dispatchNewListChildResourcesPager(req)
			default:
...
// set this to conditionally intercept incoming requests to ConfigurationProfilesVersionsServerTransport
var configurationProfilesVersionsServerTransportInterceptor interface {
