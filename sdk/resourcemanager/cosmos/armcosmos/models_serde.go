...
// MarshalJSON implements the json.Marshaller interface for type ContainerEntity.
func (c ContainerEntity) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	objectMap["component"] = c.Component
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ContainerEntity.
func (c *ContainerEntity) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type DataTransferContainerDetails.
func (d DataTransferContainerDetails) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type DataTransferContainerDetails.
func (d *DataTransferContainerDetails) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", d, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "destination":
			d.Destination, err = unmarshalContainerEntityClassification(val)
			delete(rawMsg, key)
		case "processedCount":
			err = unpopulate(val, "ProcessedCount", &d.ProcessedCount)
			delete(rawMsg, key)
		case "source":
			d.Source, err = unmarshalContainerEntityClassification(val)
			delete(rawMsg, key)
		case "totalCount":
...
func (d DataTransferJobProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "processedCount", d.ProcessedCount)
	populate(objectMap, "source", d.Source)
	populate(objectMap, "sourceAndDestinationContainers", d.SourceAndDestinationContainers)
...
func (d *DataTransferJobProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "source":
			...
			delete(rawMsg, key)
		case "sourceAndDestinationContainers":
			err = unpopulate(val, "SourceAndDestinationContainers", &d.SourceAndDestinationContainers)
			delete(rawMsg, key)
		case "status":
