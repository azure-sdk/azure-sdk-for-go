...
func (client *IntegrationRuntimeCredentialsClient) syncCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, integrationRuntimeName string, _ *IntegrationRuntimeCredentialsClientSyncOptions) (*policy.Request, error) {
