...
// ListVPNLinkConnectionsSharedKeyResult - Result of the request to list VpnLink connection shared keys. It contains a list
// of VpnLink connection shared keys and a URL nextLink to get the next set of results.
type ListVPNLinkConnectionsSharedKeyResult struct {
	// URL to get the next set of operation list results if there are any.
	NextLink *string
...
// SharedKey - VpnLink connection shared key Resource.
...
// SharedKeyProperties - Response for get VpnLink connection shared key value service call.
