...
func (s ServerlessGpuSessionsSettings) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "serverlessGpuSessionsEnableStatus", s.ServerlessGpuSessionsEnableStatus)
	return json.Marshal(objectMap)
}
...
func (s *ServerlessGpuSessionsSettings) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "maxConcurrentSessionsPerProject":
			...
			delete(rawMsg, key)
		case "serverlessGpuSessionsEnableStatus":
			err = unpopulate(val, "ServerlessGpuSessionsEnableStatus", &s.ServerlessGpuSessionsEnableStatus)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", s, err)
...
func (w WorkspaceStorageSettings) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "workspaceStorageEnableStatus", w.WorkspaceStorageEnableStatus)
	return json.Marshal(objectMap)
}
...
func (w *WorkspaceStorageSettings) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		var err error
		switch key {
		case "workspaceStorageEnableStatus":
			err = unpopulate(val, "WorkspaceStorageEnableStatus", &w.WorkspaceStorageEnableStatus)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", w, err)
