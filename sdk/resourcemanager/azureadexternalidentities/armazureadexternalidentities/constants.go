...
// CAIMResourceSKUName - The name of the SKU for the tenant.
type CAIMResourceSKUName string

const (
	// CAIMResourceSKUNamePremiumP1 - Azure AD for customers usage is billed to a linked Azure subscription and uses number of
	// authentications based billing.
	CAIMResourceSKUNamePremiumP1 CAIMResourceSKUName = "PremiumP1"
	// CAIMResourceSKUNamePremiumP2 - Azure AD for customers usage is billed to a linked Azure subscription and uses number of
	// authentications based billing.
	CAIMResourceSKUNamePremiumP2 CAIMResourceSKUName = "PremiumP2"
	// CAIMResourceSKUNameStandard - Azure AD for customers usage is billed to a linked Azure subscription and uses a monthly
	// active users (MAU) billing model.
	CAIMResourceSKUNameStandard CAIMResourceSKUName = "Standard"
)

// PossibleCAIMResourceSKUNameValues returns the possible values for the CAIMResourceSKUName const type.
func PossibleCAIMResourceSKUNameValues() []CAIMResourceSKUName {
	return []CAIMResourceSKUName{
		CAIMResourceSKUNamePremiumP1,
		CAIMResourceSKUNamePremiumP2,
		CAIMResourceSKUNameStandard,
	}
}
