...
type DiffDiskSettings struct {
	// CONSTANT; This property can be used by user in the request to choose which location the operating system should be in.
	// e.g., cache disk space for Ephemeral OS disk provisioning. For more information on
	...
	// Field has constant value "CacheDisk", any specified value is ignored.
	Placement *string
}
