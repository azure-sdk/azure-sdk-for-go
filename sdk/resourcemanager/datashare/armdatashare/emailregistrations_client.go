...
func (client *EmailRegistrationsClient) activateEmailCreateRequest(ctx context.Context, location string, emailRegistration EmailRegistration, _ *EmailRegistrationsClientActivateEmailOptions) (*policy.Request, error) {
...
func (client *EmailRegistrationsClient) registerEmailCreateRequest(ctx context.Context, location string, _ *EmailRegistrationsClientRegisterEmailOptions) (*policy.Request, error) {
