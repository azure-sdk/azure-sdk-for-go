...
func (g *GuestUsagesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if guestUsagesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = guestUsagesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to GuestUsagesServerTransport
var guestUsagesServerTransportInterceptor interface {
