...
- New function `*SharedKeysClient.Get(context.Context, string, string, *SharedKeysClientGetOptions) (SharedKeysClientGetResponse, error)`
- New function `*SharedKeysClient.List(context.Context, string, string, *SharedKeysClientListOptions) (SharedKeysClientListResponse, error)`
