...
func (o *OrchestratorInstanceServiceServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if orchestratorInstanceServiceServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = orchestratorInstanceServiceServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "OrchestratorInstanceServiceClient.GetDetails":
				res.resp, res.err = o.dispatchGetDetails(req)
...
// set this to conditionally intercept incoming requests to OrchestratorInstanceServiceServerTransport
var orchestratorInstanceServiceServerTransportInterceptor interface {
