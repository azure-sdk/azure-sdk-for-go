...
type UploadServiceClientGetUploadTokenResponse struct {
	// A successful response from getUploadToken will contain an "uploadUrl" field. This uploadUrl field's value should be follow
	// the format: https://<storage-account-name>.blob.core.windows.net/<container-name>/<ENTER YOUR BLOB NAME HERE>?<SAS-token>
	UploadTokenResponse
}
