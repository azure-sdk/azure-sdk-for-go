...
// OperationStatusesServer is a fake server for instances of the armvideoanalyzer.OperationStatusesClient type.
type OperationStatusesServer struct {
	// Get is the fake for method OperationStatusesClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, locationName string, operationID string, options *armvideoanalyzer.OperationStatusesClientGetOptions) (resp azfake.Responder[armvideoanalyzer.OperationStatusesClientGetResponse], errResp azfake.ErrorResponder)
}
...
// The returned OperationStatusesServerTransport instance is connected to an instance of armvideoanalyzer.OperationStatusesClient via the
...
// OperationStatusesServerTransport connects instances of armvideoanalyzer.OperationStatusesClient to instances of OperationStatusesServer.
...
func (o *OperationStatusesServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.Media/locations/(?P<locationName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/videoAnalyzerOperationStatuses/(?P<operationId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)`
