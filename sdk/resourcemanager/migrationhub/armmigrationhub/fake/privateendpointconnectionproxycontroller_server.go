...
func (p *PrivateEndpointConnectionProxyControllerServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if privateEndpointConnectionProxyControllerServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = privateEndpointConnectionProxyControllerServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "PrivateEndpointConnectionProxyControllerClient.NewListPrivateEndpointConnectionProxiesPager":
				res.resp, res.err = p.dispatchNewListPrivateEndpointConnectionProxiesPager(req)
...
// set this to conditionally intercept incoming requests to PrivateEndpointConnectionProxyControllerServerTransport
var privateEndpointConnectionProxyControllerServerTransportInterceptor interface {
