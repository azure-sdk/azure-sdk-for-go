...
Azure Arc Connectivity module consists of one or more clients. We provide a client factory which could be used to create any client in this module.

```go
clientFactory, err := armhybridconnectivity.NewClientFactory(<subscription ID>, cred, nil)
```
...
[open an issue](https://github.com/Azure/azure-sdk-for-go/issues) and assign the `Arc Connectivity` label.
