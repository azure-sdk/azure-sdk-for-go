...
type CatalogsServer struct {
	...
	BeginUploadImage func(ctx context.Context, resourceGroupName string, catalogName string, body armsphere.Image, options *armsphere.CatalogsClientBeginUploadImageOptions) (resp azfake.PollerResponder[armsphere.CatalogsClientUploadImageResponse], errResp azfake.ErrorResponder)
}
