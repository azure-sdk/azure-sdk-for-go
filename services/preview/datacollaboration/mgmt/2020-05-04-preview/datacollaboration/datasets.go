...
func (client DataSetsClient) CreateOrUpdate(ctx context.Context, resourceGroupName string, workspaceName string, dataAssetName string, dataSetCategory DataSetCategoryType, dataSet BasicDataSet) (result DataSetModel, err error) {
...
func (client DataSetsClient) CreateOrUpdatePreparer(ctx context.Context, resourceGroupName string, workspaceName string, dataAssetName string, dataSetCategory DataSetCategoryType, dataSet BasicDataSet) (*http.Request, error) {
...
// dataAssetName - the name of the DataAsset
// dataSetCategory - the usage category name of the DataSet
func (client DataSetsClient) Delete(ctx context.Context, resourceGroupName string, workspaceName string, dataAssetName string, dataSetCategory DataSetCategoryType) (result DataSetsDeleteFuture, err error) {
	if tracing.IsEnabled() {
...
func (client DataSetsClient) DeletePreparer(ctx context.Context, resourceGroupName string, workspaceName string, dataAssetName string, dataSetCategory DataSetCategoryType) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"dataAssetName":     autorest.Encode("path", dataAssetName),
		"dataSetCategory":   autorest.Encode("path", dataSetCategory),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
...
// dataAssetName - the name of the DataAsset
// dataSetCategory - the usage category name of the DataSet
func (client DataSetsClient) Get(ctx context.Context, resourceGroupName string, workspaceName string, dataAssetName string, dataSetCategory DataSetCategoryType) (result DataSetModel, err error) {
	if tracing.IsEnabled() {
...
func (client DataSetsClient) GetPreparer(ctx context.Context, resourceGroupName string, workspaceName string, dataAssetName string, dataSetCategory DataSetCategoryType) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"dataAssetName":     autorest.Encode("path", dataAssetName),
		"dataSetCategory":   autorest.Encode("path", dataSetCategory),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
