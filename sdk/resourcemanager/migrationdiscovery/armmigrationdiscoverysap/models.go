...
type ExcelPerformanceData struct {
	// REQUIRED; The data source for this resource.
...
type SAPInstanceProperties struct {
	...
	// part of a landscape with a different Production SID. This field can be used to relate non-prod SIDs, other components,
...
type ServerInstanceProperties struct {
	...
	// you wish to migrate to Azure. Keeping this not equal to ID as for single tier all InstanceTypes would be on same server,
