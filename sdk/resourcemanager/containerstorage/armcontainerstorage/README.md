...
```go
client, err := armcontainerstorage.NewVolumeSnapshotsClient(<subscription ID>, cred, nil)
```
...
client, err := armcontainerstorage.NewVolumeSnapshotsClient(<subscription ID>, cred, &options)
```
