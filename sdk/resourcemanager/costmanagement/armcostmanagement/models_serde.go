...
// MarshalJSON implements the json.Marshaller interface for type ErrorDetailsWithIntegerCode.
func (e ErrorDetailsWithIntegerCode) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "code", e.Code)
	populate(objectMap, "message", e.Message)
	return json.Marshal(objectMap)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type ErrorDetailsWithIntegerCode.
func (e *ErrorDetailsWithIntegerCode) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", e, err)
	}
