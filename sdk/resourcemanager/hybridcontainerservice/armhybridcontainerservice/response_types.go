...
// ProvisionedClusterInstancesClientListUpgradeProfileResponse contains the response from method ProvisionedClusterInstancesClient.ListUpgradeProfile.
type ProvisionedClusterInstancesClientListUpgradeProfileResponse struct {
	// List of upgradeProfiles for the provisioned cluster.
	ProvisionedClusterUpgradeProfileList
}
