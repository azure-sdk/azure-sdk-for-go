...
func (e ExportDeliveryDestination) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "microsoftFabricSettings", e.MicrosoftFabricSettings)
...
func (e *ExportDeliveryDestination) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "container":
			...
			delete(rawMsg, key)
		case "microsoftFabricSettings":
			err = unpopulate(val, "MicrosoftFabricSettings", &e.MicrosoftFabricSettings)
			delete(rawMsg, key)
		case "resourceId":
...
// MarshalJSON implements the json.Marshaller interface for type FabricLakehouse.
func (f FabricLakehouse) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type FabricLakehouse.
func (f *FabricLakehouse) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
...
// MarshalJSON implements the json.Marshaller interface for type FabricWorkspace.
func (f FabricWorkspace) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "displayName", f.DisplayName)
	populate(objectMap, "id", f.ID)
	return json.Marshal(objectMap)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type FabricWorkspace.
func (f *FabricWorkspace) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", f, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type MicrosoftFabricDestinationSettings.
func (m MicrosoftFabricDestinationSettings) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "lakehouse", m.Lakehouse)
	populate(objectMap, "tableName", m.TableName)
	populate(objectMap, "workspace", m.Workspace)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type MicrosoftFabricDestinationSettings.
func (m *MicrosoftFabricDestinationSettings) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", m, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "lakehouse":
			err = unpopulate(val, "Lakehouse", &m.Lakehouse)
			delete(rawMsg, key)
		case "tableName":
