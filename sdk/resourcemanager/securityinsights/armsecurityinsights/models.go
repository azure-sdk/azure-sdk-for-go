...
// AttackPatternsList - List all the Attack Patterns.
type AttackPatternsList struct {
	// REQUIRED; Array of Attack Patterns.
	Value []*AttackPattern

	// READ-ONLY; URL to fetch the next set of Attack Patterns.
	NextLink *string
}
...
// IdentitiesList - List all the Identities.
type IdentitiesList struct {
	// REQUIRED; Array of Identities.
	Value []*Identity

	// READ-ONLY; URL to fetch the next set of Identities.
	NextLink *string
}
...
// IndicatorsList - List all the Indicators.
type IndicatorsList struct {
	// REQUIRED; Array of Indicators.
	Value []*Indicator

	// READ-ONLY; URL to fetch the next set of Indicators.
	NextLink *string
}
...
// QueryAutoGenerated - Represents a query to run on the TI objects in the workspace.
type QueryAutoGenerated struct {
...
// RelationshipsList - List all the Relationships.
type RelationshipsList struct {
	// REQUIRED; Array of Relationships.
	Value []*Relationship

	// READ-ONLY; URL to fetch the next set of Relationships.
	NextLink *string
}
...
// ThreatActorsList - List all the Threat Actors.
type ThreatActorsList struct {
	// REQUIRED; Array of Threat Actors.
	Value []*ThreatActor

	// READ-ONLY; URL to fetch the next set of Threat Actors.
	NextLink *string
}
