...
// ListByServer - Retrieve the list of available tuning options.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2024-11-01-preview
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - serverName - The name of the server.
//   - options - TuningOptionsClientListByServerOptions contains the optional parameters for the TuningOptionsClient.ListByServer
//     method.
func (client *TuningOptionsClient) ListByServer(ctx context.Context, resourceGroupName string, serverName string, options *TuningOptionsClientListByServerOptions) (TuningOptionsClientListByServerResponse, error) {
	var err error
	const operationName = "TuningOptionsClient.ListByServer"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
...
func (client *TuningOptionsClient) listByServerHandleResponse(resp *http.Response) (TuningOptionsClientListByServerResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.TuningOptionsResourceArray); err != nil {
		return TuningOptionsClientListByServerResponse{}, err
	}
	return result, nil
}

// ListRecommendations - Retrieve the list of available tuning index recommendations.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2024-11-01-preview
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - serverName - The name of the server.
//   - tuningOption - The name of the tuning option.
//   - options - TuningOptionsClientListRecommendationsOptions contains the optional parameters for the TuningOptionsClient.ListRecommendations
//     method.
func (client *TuningOptionsClient) ListRecommendations(ctx context.Context, resourceGroupName string, serverName string, tuningOption TuningOptionEnum, options *TuningOptionsClientListRecommendationsOptions) (TuningOptionsClientListRecommendationsResponse, error) {
	var err error
	const operationName = "TuningOptionsClient.ListRecommendations"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.listRecommendationsCreateRequest(ctx, resourceGroupName, serverName, tuningOption, options)
	if err != nil {
	...
	resp, err := client.listRecommendationsHandleResponse(httpResp)
	return resp, err
}
...
func (client *TuningOptionsClient) listRecommendationsHandleResponse(resp *http.Response) (TuningOptionsClientListRecommendationsResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.IndexRecommendationResourceArray); err != nil {
		return TuningOptionsClientListRecommendationsResponse{}, err
	}
	return result, nil
}
