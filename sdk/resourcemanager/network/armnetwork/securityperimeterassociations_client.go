...
func (client *SecurityPerimeterAssociationsClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, networkSecurityPerimeterName string, associationName string, parameters NspAssociation, options *SecurityPerimeterAssociationsClientBeginCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *SecurityPerimeterAssociationsClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, networkSecurityPerimeterName string, associationName string, options *SecurityPerimeterAssociationsClientBeginDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkSecurityPerimeters/{networkSecurityPerimeterName}/resourceAssociations/{associationName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *SecurityPerimeterAssociationsClient) getCreateRequest(ctx context.Context, resourceGroupName string, networkSecurityPerimeterName string, associationName string, options *SecurityPerimeterAssociationsClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkSecurityPerimeters/{networkSecurityPerimeterName}/resourceAssociations/{associationName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
//   - options - SecurityPerimeterAssociationsClientPostOptions contains the optional parameters for the SecurityPerimeterAssociationsClient.Post
//     method.
func (client *SecurityPerimeterAssociationsClient) Post(ctx context.Context, resourceGroupName string, networkSecurityPerimeterName string, associationName string, parameters any, options *SecurityPerimeterAssociationsClientPostOptions) (SecurityPerimeterAssociationsClientPostResponse, error) {
	var err error
	const operationName = "SecurityPerimeterAssociationsClient.Post"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.postCreateRequest(ctx, resourceGroupName, networkSecurityPerimeterName, associationName, parameters, options)
	if err != nil {
		return SecurityPerimeterAssociationsClientPostResponse{}, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
	if err != nil {
		return SecurityPerimeterAssociationsClientPostResponse{}, err
...
func (client *SecurityPerimeterAssociationsClient) postCreateRequest(ctx context.Context, resourceGroupName string, networkSecurityPerimeterName string, associationName string, parameters any, options *SecurityPerimeterAssociationsClientPostOptions) (*policy.Request, error) {
...
func (client *SecurityPerimeterAssociationsClient) postHandleResponse(resp *http.Response) (SecurityPerimeterAssociationsClientPostResponse, error) {
	result := SecurityPerimeterAssociationsClientPostResponse{}
