...
- New function `*OpenShiftVersionsClient.Get(context.Context, string, string, *OpenShiftVersionsClientGetOptions) (OpenShiftVersionsClientGetResponse, error)`
- New function `NewPlatformWorkloadIdentityRoleSetClient(string, azcore.TokenCredential, *arm.ClientOptions) (*PlatformWorkloadIdentityRoleSetClient, error)`
- New function `*PlatformWorkloadIdentityRoleSetClient.Get(context.Context, string, string, *PlatformWorkloadIdentityRoleSetClientGetOptions) (PlatformWorkloadIdentityRoleSetClientGetResponse, error)`
