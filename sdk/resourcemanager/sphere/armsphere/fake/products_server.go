	...
	go func() {
		...
		if !intercepted {
			...
			case "ProductsClient.CountDevices":
				res.resp, res.err = p.dispatchCountDevices(req)
			...
			case "ProductsClient.NewGenerateDefaultDeviceGroupsPager":
				res.resp, res.err = p.dispatchNewGenerateDefaultDeviceGroupsPager(req)
			case "ProductsClient.Get":
				res.resp, res.err = p.dispatchGet(req)
			case "ProductsClient.NewListByCatalogPager":
				res.resp, res.err = p.dispatchNewListByCatalogPager(req)
