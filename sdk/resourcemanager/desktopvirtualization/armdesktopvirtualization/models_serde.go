...
// MarshalJSON implements the json.Marshaller interface for type ScalingPlanPooledSchedulePut.
func (s ScalingPlanPooledSchedulePut) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "id", s.ID)
	populate(objectMap, "name", s.Name)
	populate(objectMap, "properties", s.Properties)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type ScalingPlanPooledSchedulePut.
func (s *ScalingPlanPooledSchedulePut) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type ScalingPlanPooledSchedulePutProperties.
func (s ScalingPlanPooledSchedulePutProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "daysOfWeek", s.DaysOfWeek)
	populate(objectMap, "name", s.Name)
	populate(objectMap, "offPeakLoadBalancingAlgorithm", s.OffPeakLoadBalancingAlgorithm)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type ScalingPlanPooledSchedulePutProperties.
func (s *ScalingPlanPooledSchedulePutProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
