...
- New value `CPUThresholdOneHundred` added to enum type `CPUThreshold`
...
- New function `*ConfigurationsClient.CreateInResourceGroupDuration(context.Context, string, ConfigurationName, ConfigData, *ConfigurationsClientCreateInResourceGroupDurationOptions) (ConfigurationsClientCreateInResourceGroupDurationResponse, error)`
- New function `*ConfigurationsClient.CreateInSubscriptionDuration(context.Context, ConfigurationName, ConfigData, *ConfigurationsClientCreateInSubscriptionDurationOptions) (ConfigurationsClientCreateInSubscriptionDurationResponse, error)`
