...
func (t *TrustedIDProvidersServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if trustedIdProvidersServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = trustedIdProvidersServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "TrustedIDProvidersClient.NewListByAccountPager":
				res.resp, res.err = t.dispatchNewListByAccountPager(req)
...
// set this to conditionally intercept incoming requests to TrustedIDProvidersServerTransport
var trustedIdProvidersServerTransportInterceptor interface {
