...
func (r *ResourceChangesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if resourceChangesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = resourceChangesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to ResourceChangesServerTransport
var resourceChangesServerTransportInterceptor interface {
