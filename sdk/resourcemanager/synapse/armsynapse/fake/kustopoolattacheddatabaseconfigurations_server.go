...
func (k *KustoPoolAttachedDatabaseConfigurationsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if kustoPoolAttachedDatabaseConfigurationsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = kustoPoolAttachedDatabaseConfigurationsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "KustoPoolAttachedDatabaseConfigurationsClient.NewListByKustoPoolPager":
				res.resp, res.err = k.dispatchNewListByKustoPoolPager(req)
			default:
...
// set this to conditionally intercept incoming requests to KustoPoolAttachedDatabaseConfigurationsServerTransport
var kustoPoolAttachedDatabaseConfigurationsServerTransportInterceptor interface {
