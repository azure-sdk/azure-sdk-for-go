...
- New enum type `ClusterAvailableUpgradeType` with values `ClusterAvailableUpgradeTypeAKSPatchUpgrade`, `ClusterAvailableUpgradeTypeHotfixUpgrade`, `ClusterAvailableUpgradeTypePatchVersionUpgrade`
...
- New enum type `ClusterUpgradeType` with values `ClusterUpgradeTypeAKSPatchUpgrade`, `ClusterUpgradeTypeHotfixUpgrade`, `ClusterUpgradeTypePatchVersionUpgrade`
...
- New field `ClusterAccessProfile`, `ManagedIdentityProfile`, `RangerPluginProfile`, `RangerProfile` in struct `ClusterProfile`
...
- New field `RangerPluginProfile`, `RangerProfile`, `SecretsProfile`, `TrinoProfile` in struct `UpdatableClusterProfile`
