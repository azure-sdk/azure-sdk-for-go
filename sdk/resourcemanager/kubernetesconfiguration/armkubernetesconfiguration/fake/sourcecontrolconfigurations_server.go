...
func (s *SourceControlConfigurationsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if sourceControlConfigurationsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = sourceControlConfigurationsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to SourceControlConfigurationsServerTransport
var sourceControlConfigurationsServerTransportInterceptor interface {
