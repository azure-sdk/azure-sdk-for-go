...
// MarshalJSON implements the json.Marshaller interface for type PolicyStatusCollection.
func (p PolicyStatusCollection) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "nextLink", p.NextLink)
	populate(objectMap, "value", p.Value)
	return json.Marshal(objectMap)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type PolicyStatusCollection.
func (p *PolicyStatusCollection) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", p, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type PolicyStatusContract.
func (p PolicyStatusContract) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "id", p.ID)
	populate(objectMap, "name", p.Name)
	populate(objectMap, "properties", p.Properties)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type PolicyStatusContract.
func (p *PolicyStatusContract) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", p, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type PolicyStatusContractProperties.
func (p PolicyStatusContractProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type PolicyStatusContractProperties.
func (p *PolicyStatusContractProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", p, err)
	}
...
func (r ResolverResultContractProperties) MarshalJSON() ([]byte, error) {
	...
	populateTimeRFC3339(objectMap, "started", r.Started)
	populate(objectMap, "status", r.Status)
	populateTimeRFC3339(objectMap, "updated", r.Updated)
	return json.Marshal(objectMap)
}
...
func (r *ResolverResultContractProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "resultInfo":
			...
			delete(rawMsg, key)
		case "started":
			err = unpopulateTimeRFC3339(val, "Started", &r.Started)
			delete(rawMsg, key)
		case "status":
			err = unpopulate(val, "Status", &r.Status)
			delete(rawMsg, key)
		case "updated":
			err = unpopulateTimeRFC3339(val, "Updated", &r.Updated)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", r, err)
