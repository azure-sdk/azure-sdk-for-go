...
func (s *ServerInstancesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if serverInstancesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = serverInstancesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "ServerInstancesClient.NewListBySapInstancePager":
				res.resp, res.err = s.dispatchNewListBySapInstancePager(req)
...
// set this to conditionally intercept incoming requests to ServerInstancesServerTransport
var serverInstancesServerTransportInterceptor interface {
