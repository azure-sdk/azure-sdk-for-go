...
const (
	// EncryptionTypeEncryptionAtRestWithPlatformKey - Volume/Snapshot is encrypted at rest with Platform managed key. It is the
	// default encryption type. This is not a valid encryption type for disk encryption sets.
...
const (
	...
	// NamePremiumZRS - Premium zone redundant storage
	NamePremiumZRS Name = "Premium_ZRS"
)
