...
func (r *RegistrationDefinitionsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if registrationDefinitionsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = registrationDefinitionsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to RegistrationDefinitionsServerTransport
var registrationDefinitionsServerTransportInterceptor interface {
