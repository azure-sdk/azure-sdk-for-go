...
func (p *PrivateLinkResourcesForSCCPowershellServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if privateLinkResourcesForSccPowershellServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = privateLinkResourcesForSccPowershellServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to PrivateLinkResourcesForSCCPowershellServerTransport
var privateLinkResourcesForSccPowershellServerTransportInterceptor interface {
