...
[![PkgGoDev](https://pkg.go.dev/badge/github.com/Azure/azure-sdk-for-go/sdk/resourcemanager/datadog/armdatadog/v2)](https://pkg.go.dev/github.com/Azure/azure-sdk-for-go/sdk/resourcemanager/datadog/armdatadog/v2)
...
```sh
go get github.com/Azure/azure-sdk-for-go/sdk/resourcemanager/datadog/armdatadog/v2
```
...
```go
client := clientFactory.NewBillingInfoClient()
```
