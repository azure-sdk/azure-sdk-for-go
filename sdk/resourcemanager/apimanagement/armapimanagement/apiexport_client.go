...
// accept - Format in which to export the Api Details to the Storage Blob with Sas Key valid for 5 minutes.
...
func (client *APIExportClient) Get(ctx context.Context, resourceGroupName string, serviceName string, apiID string, accept ExportFormat, export ExportAPI, options *APIExportClientGetOptions) (APIExportClientGetResponse, error) {
	req, err := client.getCreateRequest(ctx, resourceGroupName, serviceName, apiID, accept, export, options)
	if err != nil {
...
func (client *APIExportClient) getCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, apiID string, accept ExportFormat, export ExportAPI, options *APIExportClientGetOptions) (*policy.Request, error) {
