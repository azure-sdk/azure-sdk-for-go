...
type PrivateEndpointConnectionsServer struct {
	...
	BeginApprove func(ctx context.Context, resourceGroupName string, workspaceName string, privateEndpointConnectionName string, body armdashboard.PrivateEndpointConnection, accept string, options *armdashboard.PrivateEndpointConnectionsClientBeginApproveOptions) (resp azfake.PollerResponder[armdashboard.PrivateEndpointConnectionsClientApproveResponse], errResp azfake.ErrorResponder)
...
func (p *PrivateEndpointConnectionsServerTransport) dispatchBeginApprove(req *http.Request) (*http.Response, error) {
	...
	if beginApprove == nil {
		...
		respr, errRespr := p.srv.BeginApprove(req.Context(), resourceGroupNameParam, workspaceNameParam, privateEndpointConnectionNameParam, body, getHeaderValue(req.Header, "Accept"), nil)
