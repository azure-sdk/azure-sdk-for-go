...
func (client *DataTypesClient) createCreateRequest(ctx context.Context, resourceGroupName string, dataProductName string, dataTypeName string, resource DataType, _ *DataTypesClientBeginCreateOptions) (*policy.Request, error) {
...
func (client *DataTypesClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, dataProductName string, dataTypeName string, _ *DataTypesClientBeginDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetworkAnalytics/dataProducts/{dataProductName}/dataTypes/{dataTypeName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
//     method.
func (client *DataTypesClient) BeginDeleteData(ctx context.Context, resourceGroupName string, dataProductName string, dataTypeName string, body DeleteDataRequest, options *DataTypesClientBeginDeleteDataOptions) (*runtime.Poller[DataTypesClientDeleteDataResponse], error) {
	if options == nil || options.ResumeToken == "" {
...
//
// Generated from API version 2023-11-15
func (client *DataTypesClient) deleteData(ctx context.Context, resourceGroupName string, dataProductName string, dataTypeName string, body DeleteDataRequest, options *DataTypesClientBeginDeleteDataOptions) (*http.Response, error) {
	var err error
...
func (client *DataTypesClient) deleteDataCreateRequest(ctx context.Context, resourceGroupName string, dataProductName string, dataTypeName string, body DeleteDataRequest, _ *DataTypesClientBeginDeleteDataOptions) (*policy.Request, error) {
...
func (client *DataTypesClient) generateStorageContainerSasTokenCreateRequest(ctx context.Context, resourceGroupName string, dataProductName string, dataTypeName string, body ContainerSaS, _ *DataTypesClientGenerateStorageContainerSasTokenOptions) (*policy.Request, error) {
...
func (client *DataTypesClient) getCreateRequest(ctx context.Context, resourceGroupName string, dataProductName string, dataTypeName string, _ *DataTypesClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetworkAnalytics/dataProducts/{dataProductName}/dataTypes/{dataTypeName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
// NewListByParentPager - List data type by parent resource.
//
// Generated from API version 2023-11-15
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - dataProductName - The data product resource name
//   - options - DataTypesClientListByParentOptions contains the optional parameters for the DataTypesClient.NewListByParentPager
//     method.
func (client *DataTypesClient) NewListByParentPager(resourceGroupName string, dataProductName string, options *DataTypesClientListByParentOptions) *runtime.Pager[DataTypesClientListByParentResponse] {
	return runtime.NewPager(runtime.PagingHandler[DataTypesClientListByParentResponse]{
		More: func(page DataTypesClientListByParentResponse) bool {
			return page.NextLink != nil && len(*page.NextLink) > 0
		},
		Fetcher: func(ctx context.Context, page *DataTypesClientListByParentResponse) (DataTypesClientListByParentResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "DataTypesClient.NewListByParentPager")
			nextLink := ""
			if page != nil {
				nextLink = *page.NextLink
			}
			resp, err := runtime.FetcherForNextLink(ctx, client.internal.Pipeline(), nextLink, func(ctx context.Context) (*policy.Request, error) {
				return client.listByParentCreateRequest(ctx, resourceGroupName, dataProductName, options)
			}, nil)
			if err != nil {
				return DataTypesClientListByParentResponse{}, err
			}
...
func (client *DataTypesClient) listByParentCreateRequest(ctx context.Context, resourceGroupName string, dataProductName string, _ *DataTypesClientListByParentOptions) (*policy.Request, error) {
...
func (client *DataTypesClient) listByParentHandleResponse(resp *http.Response) (DataTypesClientListByParentResponse, error) {
	result := DataTypesClientListByParentResponse{}
...
func (client *DataTypesClient) BeginUpdate(ctx context.Context, resourceGroupName string, dataProductName string, dataTypeName string, properties DataType, options *DataTypesClientBeginUpdateOptions) (*runtime.Poller[DataTypesClientUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
...
//
// Generated from API version 2023-11-15
func (client *DataTypesClient) update(ctx context.Context, resourceGroupName string, dataProductName string, dataTypeName string, properties DataType, options *DataTypesClientBeginUpdateOptions) (*http.Response, error) {
	var err error
...
func (client *DataTypesClient) updateCreateRequest(ctx context.Context, resourceGroupName string, dataProductName string, dataTypeName string, properties DataType, _ *DataTypesClientBeginUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetworkAnalytics/dataProducts/{dataProductName}/dataTypes/{dataTypeName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
