...
// Agent - The Agent resource definition.
type Agent struct {
...
// AgentHealthProperties - Class for agent health properties.
type AgentHealthProperties struct {
...
type AgentProperties struct {
	// REQUIRED; Name of the appliance on which agent is running.
	MigrateApplianceName *string

	// REQUIRED; Service principal identity details used by agent for communication to the service.
...
// AgentResourcePatch - Object containing tags updates for patch operations.
type AgentResourcePatch struct {
	// The Agent properties resource definition.
	Properties *AgentResourcePatchProperties
}

// AgentResourcePatchProperties - Agent resource patch properties
type AgentResourcePatchProperties struct {
	// Health details of the agent.
	HealthDetails *AgentHealthProperties
}

// AgentSpnProperties - Class for agent spn properties.
type AgentSpnProperties struct {
