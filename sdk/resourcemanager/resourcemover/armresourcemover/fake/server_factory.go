...
type ServerFactory struct {
	// MoveCollectionsServer contains the fakes for client MoveCollectionsClient
	MoveCollectionsServer MoveCollectionsServer

	// MoveResourcesServer contains the fakes for client MoveResourcesClient
	MoveResourcesServer MoveResourcesServer

	// OperationsDiscoveryServer contains the fakes for client OperationsDiscoveryClient
	OperationsDiscoveryServer OperationsDiscoveryServer

	// UnresolvedDependenciesServer contains the fakes for client UnresolvedDependenciesClient
