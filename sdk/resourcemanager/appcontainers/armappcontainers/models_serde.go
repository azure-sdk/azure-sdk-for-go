...
func (b BuildToken) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateTimeRFC3339(objectMap, "expires", b.Expires)
...
func (b *BuildToken) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "expires":
			err = unpopulateTimeRFC3339(val, "Expires", &b.Expires)
			delete(rawMsg, key)
		case "token":
...
func (p PatchDetails) MarshalJSON() ([]byte, error) {
	...
	populateTimeRFC3339(objectMap, "lastDetectionTime", p.LastDetectionTime)
...
func (p *PatchDetails) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "lastDetectionTime":
			err = unpopulateTimeRFC3339(val, "LastDetectionTime", &p.LastDetectionTime)
			delete(rawMsg, key)
		case "newImageName":
