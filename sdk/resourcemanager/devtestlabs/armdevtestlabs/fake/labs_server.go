	...
	go func() {
		...
		if !intercepted {
			...
			case "LabsClient.BeginClaimAnyVM":
				res.resp, res.err = l.dispatchBeginClaimAnyVM(req)
			case "LabsClient.BeginCreateEnvironment":
				res.resp, res.err = l.dispatchBeginCreateEnvironment(req)
			...
			case "LabsClient.BeginExportResourceUsage":
				res.resp, res.err = l.dispatchBeginExportResourceUsage(req)
			case "LabsClient.GenerateUploadURI":
				res.resp, res.err = l.dispatchGenerateUploadURI(req)
			case "LabsClient.Get":
				res.resp, res.err = l.dispatchGet(req)
			case "LabsClient.BeginImportVirtualMachine":
				res.resp, res.err = l.dispatchBeginImportVirtualMachine(req)
			...
			case "LabsClient.NewListVhdsPager":
				res.resp, res.err = l.dispatchNewListVhdsPager(req)
