	...
	go func() {
		...
		if !intercepted {
			...
			case "CatalogsClient.BeginConnect":
				res.resp, res.err = c.dispatchBeginConnect(req)
			...
			case "CatalogsClient.GetSyncErrorDetails":
				res.resp, res.err = c.dispatchGetSyncErrorDetails(req)
			case "CatalogsClient.NewListByDevCenterPager":
				res.resp, res.err = c.dispatchNewListByDevCenterPager(req)
			case "CatalogsClient.BeginSync":
				res.resp, res.err = c.dispatchBeginSync(req)
