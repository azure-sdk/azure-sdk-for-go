...
- New value `ConnectionAuthTypeAccessKey`, `ConnectionAuthTypeServicePrincipal` added to enum type `ConnectionAuthType`
- New value `ConnectionCategoryAzureDataLakeGen2`, `ConnectionCategoryAzureMySQLDb`, `ConnectionCategoryAzurePostgresDb`, `ConnectionCategoryAzureSQLDb`, `ConnectionCategoryAzureSynapseAnalytics`, `ConnectionCategoryFeatureStore`, `ConnectionCategoryRedis`, `ConnectionCategoryS3`, `ConnectionCategorySnowflake` added to enum type `ConnectionCategory`
...
- New value `JobTypeLabeling`, `JobTypeSpark` added to enum type `JobType`
- New value `OutputDeliveryModeDirect` added to enum type `OutputDeliveryMode`
- New value `ProvisioningStateSoftDeleted` added to enum type `ProvisioningState`
...
- New enum type `ClassificationModelPerformanceMetric` with values `ClassificationModelPerformanceMetricAccuracy`, `ClassificationModelPerformanceMetricF1Score`, `ClassificationModelPerformanceMetricPrecision`, `ClassificationModelPerformanceMetricRecall`
...
- New enum type `FeaturestoreJobType` with values `FeaturestoreJobTypeBackfillMaterialization`, `FeaturestoreJobTypeRecurrentMaterialization`
...
- New enum type `JobTier` with values `JobTierBasic`, `JobTierPremium`, `JobTierSpot`, `JobTierStandard`
...
- New enum type `MonitoringInputDataContext` with values `MonitoringInputDataContextGroundTruth`, `MonitoringInputDataContextModelInputs`, `MonitoringInputDataContextModelOutputs`, `MonitoringInputDataContextTest`, `MonitoringInputDataContextTraining`, `MonitoringInputDataContextValidation`
- New enum type `MonitoringModelType` with values `MonitoringModelTypeClassification`, `MonitoringModelTypeRegression`
- New enum type `MonitoringNotificationMode` with values `MonitoringNotificationModeDisabled`, `MonitoringNotificationModeEnabled`
- New enum type `MonitoringSignalType` with values `MonitoringSignalTypeCustom`, `MonitoringSignalTypeDataDrift`, `MonitoringSignalTypeDataQuality`, `MonitoringSignalTypeFeatureAttributionDrift`, `MonitoringSignalTypeModelPerformance`, `MonitoringSignalTypePredictionDrift`
...
- New enum type `PackageInputDeliveryMode` with values `PackageInputDeliveryModeDownload`, `PackageInputDeliveryModeReadOnlyMount`
...
- New function `*AzMonMonitoringAlertNotificationSettings.GetMonitoringAlertNotificationSettingsBase() *MonitoringAlertNotificationSettingsBase`
...
- New function `*EmailMonitoringAlertNotificationSettings.GetMonitoringAlertNotificationSettingsBase() *MonitoringAlertNotificationSettingsBase`
...
- New function `*FeaturesetVersionsClient.NewListMaterializationJobsPager(string, string, string, string, *FeaturesetVersionsClientListMaterializationJobsOptions) *runtime.Pager[FeaturesetVersionsClientListMaterializationJobsResponse]`
...
- New function `*ModelPerformanceSignalBase.GetMonitoringSignalBase() *MonitoringSignalBase`
...
- New function `*MonitoringAlertNotificationSettingsBase.GetMonitoringAlertNotificationSettingsBase() *MonitoringAlertNotificationSettingsBase`
...
- New struct `AzMonMonitoringAlertNotificationSettings`
...
- New struct `Docker`
- New struct `EmailMonitoringAlertNotificationSettings`
...
- New struct `FeaturesetJob`
- New struct `FeaturesetJobArmPaginatedResult`
...
- New struct `ModelPerformanceSignalBase`
- New struct `MonitorDefinition`
- New struct `MonitoringDataSegment`
- New struct `MonitoringInputData`
...
- New field `AutoDeleteSetting` in struct `AssetJobOutput`
- New field `NotificationSetting` in struct `AutoMLJob`
- New field `QueueSettings` in struct `AutoMLJob`
- New field `SecretsConfiguration` in struct `AutoMLJob`
- New field `IntellectualProperty` in struct `AzureBlobDatastore`
- New field `ResourceGroup` in struct `AzureBlobDatastore`
- New field `SubscriptionID` in struct `AzureBlobDatastore`
- New field `IntellectualProperty` in struct `AzureDataLakeGen1Datastore`
...
- New field `IntellectualProperty` in struct `AzureDataLakeGen2Datastore`
...
- New field `IntellectualProperty` in struct `AzureFileDatastore`
...
- New field `AutoDeleteSetting` in struct `CodeVersionProperties`
- New field `ProvisioningState` in struct `CodeVersionProperties`
- New field `Hash` in struct `CodeVersionsClientListOptions`
- New field `HashVersion` in struct `CodeVersionsClientListOptions`
- New field `AutologgerSettings` in struct `CommandJob`
- New field `NotificationSetting` in struct `CommandJob`
- New field `QueueSettings` in struct `CommandJob`
- New field `SecretsConfiguration` in struct `CommandJob`
- New field `ProvisioningState` in struct `ComponentContainerProperties`
- New field `AutoDeleteSetting` in struct `ComponentVersionProperties`
- New field `ProvisioningState` in struct `ComponentVersionProperties`
- New field `Stage` in struct `ComponentVersionProperties`
...
- New field `AutoDeleteSetting` in struct `CustomModelJobOutput`
- New field `Stage` in struct `DataVersionsClientListOptions`
- New field `Locations` in struct `DeploymentResourceConfiguration`
- New field `MaxInstanceCount` in struct `DeploymentResourceConfiguration`
- New field `ProvisioningState` in struct `EnvironmentContainerProperties`
- New field `AutoDeleteSetting` in struct `EnvironmentVersionProperties`
- New field `IntellectualProperty` in struct `EnvironmentVersionProperties`
- New field `ProvisioningState` in struct `EnvironmentVersionProperties`
- New field `Stage` in struct `EnvironmentVersionProperties`
...
- New field `LogTrainingMetrics` in struct `ImageModelSettingsObjectDetection`
- New field `LogValidationLoss` in struct `ImageModelSettingsObjectDetection`
- New field `Locations` in struct `JobResourceConfiguration`
- New field `MaxInstanceCount` in struct `JobResourceConfiguration`
- New field `Nodes` in struct `JobService`
- New field `AssetName` in struct `JobsClientListOptions`
...
- New field `AutoDeleteSetting` in struct `MLFlowModelJobOutput`
- New field `AutoDeleteSetting` in struct `MLTableData`
- New field `IntellectualProperty` in struct `MLTableData`
- New field `Stage` in struct `MLTableData`
- New field `AssetName` in struct `MLTableJobOutput`
- New field `AssetVersion` in struct `MLTableJobOutput`
- New field `AutoDeleteSetting` in struct `MLTableJobOutput`
- New field `ExpiryTime` in struct `ManagedIdentityAuthTypeWorkspaceConnectionProperties`
- New field `DataCollector` in struct `ManagedOnlineDeployment`
- New field `ProvisioningState` in struct `ModelContainerProperties`
- New field `AutoDeleteSetting` in struct `ModelVersionProperties`
- New field `IntellectualProperty` in struct `ModelVersionProperties`
- New field `ProvisioningState` in struct `ModelVersionProperties`
- New field `Stage` in struct `ModelVersionProperties`
...
- New field `ExpiryTime` in struct `NoneAuthTypeWorkspaceConnectionProperties`
- New field `DataCollector` in struct `OnlineDeploymentProperties`
- New field `MirrorTraffic` in struct `OnlineEndpointProperties`
- New field `ExpiryTime` in struct `PATAuthTypeWorkspaceConnectionProperties`
- New field `NotificationSetting` in struct `PipelineJob`
- New field `SecretsConfiguration` in struct `PipelineJob`
...
- New field `Locations` in struct `ResourceConfiguration`
- New field `MaxInstanceCount` in struct `ResourceConfiguration`
- New field `ExpiryTime` in struct `SASAuthTypeWorkspaceConnectionProperties`
- New field `NotificationSetting` in struct `SweepJob`
- New field `QueueSettings` in struct `SweepJob`
- New field `SecretsConfiguration` in struct `SweepJob`
...
- New field `AutoDeleteSetting` in struct `TritonModelJobOutput`
- New field `AutoDeleteSetting` in struct `URIFileDataVersion`
- New field `IntellectualProperty` in struct `URIFileDataVersion`
- New field `Stage` in struct `URIFileDataVersion`
- New field `AssetName` in struct `URIFileJobOutput`
- New field `AssetVersion` in struct `URIFileJobOutput`
- New field `AutoDeleteSetting` in struct `URIFileJobOutput`
- New field `AutoDeleteSetting` in struct `URIFolderDataVersion`
- New field `IntellectualProperty` in struct `URIFolderDataVersion`
- New field `Stage` in struct `URIFolderDataVersion`
- New field `AssetName` in struct `URIFolderJobOutput`
- New field `AssetVersion` in struct `URIFolderJobOutput`
- New field `AutoDeleteSetting` in struct `URIFolderJobOutput`
- New field `ExpiryTime` in struct `UsernamePasswordAuthTypeWorkspaceConnectionProperties`
- New field `Kind` in struct `Workspace`
- New field `AssociatedWorkspaces` in struct `WorkspaceProperties`
- New field `ContainerRegistries` in struct `WorkspaceProperties`
- New field `EnableDataIsolation` in struct `WorkspaceProperties`
- New field `ExistingWorkspaces` in struct `WorkspaceProperties`
- New field `FeatureStoreSettings` in struct `WorkspaceProperties`
- New field `HubResourceID` in struct `WorkspaceProperties`
- New field `KeyVaults` in struct `WorkspaceProperties`
- New field `ManagedNetwork` in struct `WorkspaceProperties`
- New field `ScheduledPurgeDate` in struct `WorkspaceProperties`
- New field `SoftDeleteRetentionInDays` in struct `WorkspaceProperties`
- New field `SoftDeletedAt` in struct `WorkspaceProperties`
- New field `StorageAccounts` in struct `WorkspaceProperties`
...
- New field `FeatureStoreSettings` in struct `WorkspacePropertiesUpdateParameters`
- New field `ManagedNetwork` in struct `WorkspacePropertiesUpdateParameters`
- New field `ForceToPurge` in struct `WorkspacesClientBeginDeleteOptions`
- New field `Kind` in struct `WorkspacesClientListByResourceGroupOptions`
- New field `Kind` in struct `WorkspacesClientListBySubscriptionOptions`
