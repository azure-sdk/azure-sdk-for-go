...
// PolicySetDefinitionsServer is a fake server for instances of the armmanagedapplications.PolicySetDefinitionsClient type.
type PolicySetDefinitionsServer struct {
	...
	CreateOrUpdate func(ctx context.Context, policySetDefinitionName string, parameters armmanagedapplications.PolicySetDefinition, options *armmanagedapplications.PolicySetDefinitionsClientCreateOrUpdateOptions) (resp azfake.Responder[armmanagedapplications.PolicySetDefinitionsClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)

	// CreateOrUpdateAtManagementGroup is the fake for method PolicySetDefinitionsClient.CreateOrUpdateAtManagementGroup
	// HTTP status codes to indicate success: http.StatusOK, http.StatusCreated
	CreateOrUpdateAtManagementGroup func(ctx context.Context, managementGroupID string, policySetDefinitionName string, parameters armmanagedapplications.PolicySetDefinition, options *armmanagedapplications.PolicySetDefinitionsClientCreateOrUpdateAtManagementGroupOptions) (resp azfake.Responder[armmanagedapplications.PolicySetDefinitionsClientCreateOrUpdateAtManagementGroupResponse], errResp azfake.ErrorResponder)

	// Delete is the fake for method PolicySetDefinitionsClient.Delete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	Delete func(ctx context.Context, policySetDefinitionName string, options *armmanagedapplications.PolicySetDefinitionsClientDeleteOptions) (resp azfake.Responder[armmanagedapplications.PolicySetDefinitionsClientDeleteResponse], errResp azfake.ErrorResponder)

	// DeleteAtManagementGroup is the fake for method PolicySetDefinitionsClient.DeleteAtManagementGroup
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	DeleteAtManagementGroup func(ctx context.Context, managementGroupID string, policySetDefinitionName string, options *armmanagedapplications.PolicySetDefinitionsClientDeleteAtManagementGroupOptions) (resp azfake.Responder[armmanagedapplications.PolicySetDefinitionsClientDeleteAtManagementGroupResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method PolicySetDefinitionsClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, policySetDefinitionName string, options *armmanagedapplications.PolicySetDefinitionsClientGetOptions) (resp azfake.Responder[armmanagedapplications.PolicySetDefinitionsClientGetResponse], errResp azfake.ErrorResponder)

	// GetAtManagementGroup is the fake for method PolicySetDefinitionsClient.GetAtManagementGroup
	// HTTP status codes to indicate success: http.StatusOK
	GetAtManagementGroup func(ctx context.Context, managementGroupID string, policySetDefinitionName string, options *armmanagedapplications.PolicySetDefinitionsClientGetAtManagementGroupOptions) (resp azfake.Responder[armmanagedapplications.PolicySetDefinitionsClientGetAtManagementGroupResponse], errResp azfake.ErrorResponder)

	// GetBuiltIn is the fake for method PolicySetDefinitionsClient.GetBuiltIn
	// HTTP status codes to indicate success: http.StatusOK
	GetBuiltIn func(ctx context.Context, policySetDefinitionName string, options *armmanagedapplications.PolicySetDefinitionsClientGetBuiltInOptions) (resp azfake.Responder[armmanagedapplications.PolicySetDefinitionsClientGetBuiltInResponse], errResp azfake.ErrorResponder)

	// NewListPager is the fake for method PolicySetDefinitionsClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(options *armmanagedapplications.PolicySetDefinitionsClientListOptions) (resp azfake.PagerResponder[armmanagedapplications.PolicySetDefinitionsClientListResponse])

	// NewListBuiltInPager is the fake for method PolicySetDefinitionsClient.NewListBuiltInPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListBuiltInPager func(options *armmanagedapplications.PolicySetDefinitionsClientListBuiltInOptions) (resp azfake.PagerResponder[armmanagedapplications.PolicySetDefinitionsClientListBuiltInResponse])

	// NewListByManagementGroupPager is the fake for method PolicySetDefinitionsClient.NewListByManagementGroupPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByManagementGroupPager func(managementGroupID string, options *armmanagedapplications.PolicySetDefinitionsClientListByManagementGroupOptions) (resp azfake.PagerResponder[armmanagedapplications.PolicySetDefinitionsClientListByManagementGroupResponse])
}
...
// The returned PolicySetDefinitionsServerTransport instance is connected to an instance of armmanagedapplications.PolicySetDefinitionsClient via the
...
func NewPolicySetDefinitionsServerTransport(srv *PolicySetDefinitionsServer) *PolicySetDefinitionsServerTransport {
	return &PolicySetDefinitionsServerTransport{
		srv:                           srv,
		newListPager:                  newTracker[azfake.PagerResponder[armmanagedapplications.PolicySetDefinitionsClientListResponse]](),
		newListBuiltInPager:           newTracker[azfake.PagerResponder[armmanagedapplications.PolicySetDefinitionsClientListBuiltInResponse]](),
		newListByManagementGroupPager: newTracker[azfake.PagerResponder[armmanagedapplications.PolicySetDefinitionsClientListByManagementGroupResponse]](),
	}
}

// PolicySetDefinitionsServerTransport connects instances of armmanagedapplications.PolicySetDefinitionsClient to instances of PolicySetDefinitionsServer.
...
type PolicySetDefinitionsServerTransport struct {
	...
	newListPager                  *tracker[azfake.PagerResponder[armmanagedapplications.PolicySetDefinitionsClientListResponse]]
	newListBuiltInPager           *tracker[azfake.PagerResponder[armmanagedapplications.PolicySetDefinitionsClientListBuiltInResponse]]
	newListByManagementGroupPager *tracker[azfake.PagerResponder[armmanagedapplications.PolicySetDefinitionsClientListByManagementGroupResponse]]
}
...
func (p *PolicySetDefinitionsServerTransport) dispatchCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[armmanagedapplications.PolicySetDefinition](req)
	if err != nil {
		return nil, err
	}
...
func (p *PolicySetDefinitionsServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		var options *armmanagedapplications.PolicySetDefinitionsClientListOptions
		if filterParam != nil || topParam != nil {
			options = &armmanagedapplications.PolicySetDefinitionsClientListOptions{
				Filter: filterParam,
				Top:    topParam,
			}
		}
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armmanagedapplications.PolicySetDefinitionsClientListResponse, createLink func() string) {
...
func (p *PolicySetDefinitionsServerTransport) dispatchNewListBuiltInPager(req *http.Request) (*http.Response, error) {
	...
	if newListBuiltInPager == nil {
		...
		var options *armmanagedapplications.PolicySetDefinitionsClientListBuiltInOptions
		if filterParam != nil || topParam != nil {
			options = &armmanagedapplications.PolicySetDefinitionsClientListBuiltInOptions{
				Filter: filterParam,
				Top:    topParam,
			}
		}
		...
		server.PagerResponderInjectNextLinks(newListBuiltInPager, req, func(page *armmanagedapplications.PolicySetDefinitionsClientListBuiltInResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
...
func (p *PolicySetDefinitionsServerTransport) dispatchNewListByManagementGroupPager(req *http.Request) (*http.Response, error) {
	...
	if newListByManagementGroupPager == nil {
		...
		var options *armmanagedapplications.PolicySetDefinitionsClientListByManagementGroupOptions
		if filterParam != nil || topParam != nil {
			options = &armmanagedapplications.PolicySetDefinitionsClientListByManagementGroupOptions{
				Filter: filterParam,
				Top:    topParam,
			}
		}
		...
		server.PagerResponderInjectNextLinks(newListByManagementGroupPager, req, func(page *armmanagedapplications.PolicySetDefinitionsClientListByManagementGroupResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
