...
// ClusterKind - The type of cluster.
...
// PossibleClusterKindValues returns the possible values for the ClusterKind const type.
func PossibleClusterKindValues() []ClusterKind {
	return []ClusterKind{
		ClusterKindHADOOP,
		ClusterKindHBASE,
		ClusterKindINTERACTIVEHIVE,
		ClusterKindKAFKA,
		ClusterKindSPARK,
	}
}
