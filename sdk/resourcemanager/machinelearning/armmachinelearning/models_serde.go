...
func (c ComputeInstanceSSHSettings) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "adminPublicKeys", c.AdminPublicKeys)
...
func (c *ComputeInstanceSSHSettings) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "adminPublicKey":
			...
			delete(rawMsg, key)
		case "adminPublicKeys":
			err = unpopulate(val, "AdminPublicKeys", &c.AdminPublicKeys)
			delete(rawMsg, key)
		case "adminUserName":
...
// MarshalJSON implements the json.Marshaller interface for type SSHPublicKeyReference.
func (s SSHPublicKeyReference) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
...
// UnmarshalJSON implements the json.Unmarshaller interface for type SSHPublicKeyReference.
func (s *SSHPublicKeyReference) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
