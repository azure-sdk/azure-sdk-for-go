...
func (client *PrivateLinkResourcesForSCCPowershellClient) Get(ctx context.Context, resourceGroupName string, resourceName string, groupName string, options *PrivateLinkResourcesForSCCPowershellClientGetOptions) (PrivateLinkResourcesForSCCPowershellClientGetResponse, error) {
	var err error
	const operationName = "PrivateLinkResourcesForSCCPowershellClient.Get"
...
func (client *PrivateLinkResourcesForSCCPowershellClient) getCreateRequest(ctx context.Context, resourceGroupName string, resourceName string, groupName string, _ *PrivateLinkResourcesForSCCPowershellClientGetOptions) (*policy.Request, error) {
...
func (client *PrivateLinkResourcesForSCCPowershellClient) ListByService(ctx context.Context, resourceGroupName string, resourceName string, options *PrivateLinkResourcesForSCCPowershellClientListByServiceOptions) (PrivateLinkResourcesForSCCPowershellClientListByServiceResponse, error) {
	var err error
	const operationName = "PrivateLinkResourcesForSCCPowershellClient.ListByService"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
...
func (client *PrivateLinkResourcesForSCCPowershellClient) listByServiceCreateRequest(ctx context.Context, resourceGroupName string, resourceName string, _ *PrivateLinkResourcesForSCCPowershellClientListByServiceOptions) (*policy.Request, error) {
