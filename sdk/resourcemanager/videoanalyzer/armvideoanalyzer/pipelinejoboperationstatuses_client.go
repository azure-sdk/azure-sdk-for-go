...
func (client *PipelineJobOperationStatusesClient) Get(ctx context.Context, resourceGroupName string, accountName string, pipelineJobName string, operationID string, options *PipelineJobOperationStatusesClientGetOptions) (PipelineJobOperationStatusesClientGetResponse, error) {
	var err error
	const operationName = "PipelineJobOperationStatusesClient.Get"
...
func (client *PipelineJobOperationStatusesClient) getCreateRequest(ctx context.Context, resourceGroupName string, accountName string, pipelineJobName string, operationID string, _ *PipelineJobOperationStatusesClientGetOptions) (*policy.Request, error) {
