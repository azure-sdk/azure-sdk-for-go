...
func (p *PrivateEndpointConnectionsForSCCPowershellServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if privateEndpointConnectionsForSccPowershellServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = privateEndpointConnectionsForSccPowershellServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to PrivateEndpointConnectionsForSCCPowershellServerTransport
var privateEndpointConnectionsForSccPowershellServerTransportInterceptor interface {
