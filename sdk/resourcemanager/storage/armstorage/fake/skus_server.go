...
type SKUsServer struct {
	...
	List func(ctx context.Context, options *armstorage.SKUsClientListOptions) (resp azfake.Responder[armstorage.SKUsClientListResponse], errResp azfake.ErrorResponder)
}
...
func (s *SKUsServerTransport) dispatchList(req *http.Request) (*http.Response, error) {
	...
	resp, err := server.MarshalResponseAsJSON(respContent, server.GetResponse(respr).SKUListResult, req)
	if err != nil {
		return nil, err
	}
	return resp, nil
