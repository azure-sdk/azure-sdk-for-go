...
func unmarshalTrialClassification(rawMsg json.RawMessage) (TrialClassification, error) {
	if rawMsg == nil {
		return nil, nil
	}
	var m map[string]any
	...
	var b TrialClassification
	switch m["trialType"] {
	case string(TrialTypeCommandComponent):
		b = &TrialComponent{}
	case string(TrialTypePipelineComponent):
		b = &TrialPipelineComponent{}
	default:
		b = &Trial{}
	}
	if err := json.Unmarshal(rawMsg, b); err != nil {
