...
- New enum type `ArcScopeType` with values `ArcScopeTypeSubscriptionOrResourceGroupIDs`
- New enum type `AzureArcStatus` with values `AzureArcStatusEnabled`, `AzureArcStatusNotEnabled`, `AzureArcStatusUnknown`
...
- New enum type `ImportSQLInventoryJobResult` with values `ImportSQLInventoryJobResultCompleted`, `ImportSQLInventoryJobResultCompletedWithErrors`, `ImportSQLInventoryJobResultCompletedWithWarnings`, `ImportSQLInventoryJobResultFailed`, `ImportSQLInventoryJobResultInProgress`, `ImportSQLInventoryJobResultUnknown`, `ImportSQLInventoryJobResultWaitingForBlobUpload`
...
- New enum type `SQLImportType` with values `SQLImportTypeAzureMigrateCSV`, `SQLImportTypeUnknown`
...
- New enum type `Versions` with values `VersionsV20180501Preview`, `VersionsV20190501Preview`, `VersionsV20200101`, `VersionsV20200101Preview`, `VersionsV20200201`, `VersionsV20200707`, `VersionsV20200710`, `VersionsV20200801Preview`, `VersionsV20201111Preview`, `VersionsV20221027`, `VersionsV20230606`, `VersionsV20231001Preview`, `VersionsV20240501Preview`, `VersionsV20241201Preview`
...
- New function `*ClientFactory.NewSQLImportJobsControllerClient() *SQLImportJobsControllerClient`
...
- New function `*MasterSitesControllerClient.BeginRefreshArcStatus(context.Context, string, string, *MasterSitesControllerClientBeginRefreshArcStatusOptions) (*runtime.Poller[MasterSitesControllerClientRefreshArcStatusResponse], error)`
...
- New function `NewSQLImportJobsControllerClient(string, azcore.TokenCredential, *arm.ClientOptions) (*SQLImportJobsControllerClient, error)`
- New function `*SQLImportJobsControllerClient.GetImportjob(context.Context, string, string, string, string, *SQLImportJobsControllerClientGetImportjobOptions) (SQLImportJobsControllerClientGetImportjobResponse, error)`
- New function `*SQLImportJobsControllerClient.NewListImportjobsPager(string, string, string, *SQLImportJobsControllerClientListImportjobsOptions) *runtime.Pager[SQLImportJobsControllerClientListImportjobsResponse]`
...
- New function `*SQLSitesControllerClient.ExportImportedSQLInventoryAsync(context.Context, string, string, string, SQLInventoryImportBody, *SQLSitesControllerClientExportImportedSQLInventoryAsyncOptions) (SQLSitesControllerClientExportImportedSQLInventoryAsyncResponse, error)`
...
- New function `*SQLSitesControllerClient.BeginTriggerImportInventory(context.Context, string, string, string, SQLInventoryImportBody, *SQLSitesControllerClientBeginTriggerImportInventoryOptions) (*runtime.Poller[SQLSitesControllerClientTriggerImportInventoryResponse], error)`
...
- New function `*SQLSitesControllerClient.ValidateAndImportInventory(context.Context, string, string, string, SQLInventoryImportBody, *SQLSitesControllerClientValidateAndImportInventoryOptions) (SQLSitesControllerClientValidateAndImportInventoryResponse, error)`
...
- New struct `ArcDiscovery`
- New struct `ArcScopeProperties`
- New struct `ArcScopePropertiesUpdate`
...
- New struct `ImportSQLInventoryJob`
- New struct `ImportSQLInventoryJobProperties`
...
- New struct `PagedImportSQLInventoryJob`
...
- New struct `SQLImportJobErrorSummary`
- New struct `SQLInventoryImportBody`
- New struct `SQLJob`
...
- New struct `ServerSitesProperties`
