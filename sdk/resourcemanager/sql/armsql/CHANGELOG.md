...
- New function `*VulnerabilityAssessmentBaselinesClient.Get(context.Context, string, string, VulnerabilityAssessmentName, BaselineName, *VulnerabilityAssessmentBaselinesClientGetOptions) (VulnerabilityAssessmentBaselinesClientGetResponse, error)`
- New function `*VulnerabilityAssessmentBaselinesClient.NewListBySQLVulnerabilityAssessmentPager(string, string, VulnerabilityAssessmentName, *VulnerabilityAssessmentBaselinesClientListBySQLVulnerabilityAssessmentOptions) *runtime.Pager[VulnerabilityAssessmentBaselinesClientListBySQLVulnerabilityAssessmentResponse]`
...
- New function `*VulnerabilityAssessmentRuleBaselinesClient.CreateOrUpdate(context.Context, string, string, VulnerabilityAssessmentName, BaselineName, string, DatabaseSQLVulnerabilityAssessmentRuleBaselineInput, *VulnerabilityAssessmentRuleBaselinesClientCreateOrUpdateOptions) (VulnerabilityAssessmentRuleBaselinesClientCreateOrUpdateResponse, error)`
...
- New function `*VulnerabilityAssessmentRuleBaselinesClient.Get(context.Context, string, string, VulnerabilityAssessmentName, BaselineName, string, *VulnerabilityAssessmentRuleBaselinesClientGetOptions) (VulnerabilityAssessmentRuleBaselinesClientGetResponse, error)`
- New function `*VulnerabilityAssessmentRuleBaselinesClient.NewListByBaselinePager(string, string, VulnerabilityAssessmentName, BaselineName, *VulnerabilityAssessmentRuleBaselinesClientListByBaselineOptions) *runtime.Pager[VulnerabilityAssessmentRuleBaselinesClientListByBaselineResponse]`
...
- New function `*VulnerabilityAssessmentsSettingsClient.Delete(context.Context, string, string, VulnerabilityAssessmentName, *VulnerabilityAssessmentsSettingsClientDeleteOptions) (VulnerabilityAssessmentsSettingsClientDeleteResponse, error)`
...
- New struct `VulnerabilityAssessmentBaselinesClientGetOptions`
- New struct `VulnerabilityAssessmentBaselinesClientGetResponse`
- New struct `VulnerabilityAssessmentBaselinesClientListBySQLVulnerabilityAssessmentOptions`
- New struct `VulnerabilityAssessmentBaselinesClientListBySQLVulnerabilityAssessmentResponse`
...
- New struct `VulnerabilityAssessmentRuleBaselinesClientCreateOrUpdateOptions`
- New struct `VulnerabilityAssessmentRuleBaselinesClientCreateOrUpdateResponse`
...
- New struct `VulnerabilityAssessmentRuleBaselinesClientGetOptions`
- New struct `VulnerabilityAssessmentRuleBaselinesClientGetResponse`
- New struct `VulnerabilityAssessmentRuleBaselinesClientListByBaselineOptions`
- New struct `VulnerabilityAssessmentRuleBaselinesClientListByBaselineResponse`
...
- New struct `VulnerabilityAssessmentsSettingsClientDeleteOptions`
- New struct `VulnerabilityAssessmentsSettingsClientDeleteResponse`
