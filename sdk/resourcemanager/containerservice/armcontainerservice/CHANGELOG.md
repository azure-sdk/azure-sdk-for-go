...
- New function `*ContainerServicesClient.ListOrchestrators(context.Context, string, *ContainerServicesClientListOrchestratorsOptions) (ContainerServicesClientListOrchestratorsResponse, error)`
...
- New struct `ContainerServicesClientListOrchestratorsOptions`
- New struct `ContainerServicesClientListOrchestratorsResponse`
...
- New struct `OrchestratorProfile`
- New struct `OrchestratorVersionProfile`
- New struct `OrchestratorVersionProfileListResult`
- New struct `OrchestratorVersionProfileProperties`
