...
func (d *DeployedResourceServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if deployedResourceServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = deployedResourceServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to DeployedResourceServerTransport
var deployedResourceServerTransportInterceptor interface {
