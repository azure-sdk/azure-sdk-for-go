...
func (client *AnalyzerConfigsClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, workspaceName string, analyzerConfigName string, resource AnalyzerConfig, options *AnalyzerConfigsClientCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *AnalyzerConfigsClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, workspaceName string, analyzerConfigName string, options *AnalyzerConfigsClientDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiCenter/services/{serviceName}/workspaces/{workspaceName}/analyzerConfigs/{analyzerConfigName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *AnalyzerConfigsClient) exportRulesetCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, workspaceName string, analyzerConfigName string, options *AnalyzerConfigsClientBeginExportRulesetOptions) (*policy.Request, error) {
...
func (client *AnalyzerConfigsClient) getCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, workspaceName string, analyzerConfigName string, options *AnalyzerConfigsClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiCenter/services/{serviceName}/workspaces/{workspaceName}/analyzerConfigs/{analyzerConfigName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *AnalyzerConfigsClient) importRulesetCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, workspaceName string, analyzerConfigName string, body RulesetImportRequest, options *AnalyzerConfigsClientBeginImportRulesetOptions) (*policy.Request, error) {
