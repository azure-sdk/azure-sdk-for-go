...
- New struct `ComputeInstanceOsPatchingResult`
...
- New field `AutologgerSettings`, `CustomServices`, `EnableOSPatching`, `EnableRootAccess`, `EnableSSO`, `IdleTimeBeforeShutdown`, `OSImageMetadata`, `OSPatchingResult`, `ReleaseQuotaOnStop` in struct `ComputeInstanceProperties`
