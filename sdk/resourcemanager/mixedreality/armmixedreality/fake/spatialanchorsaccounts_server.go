...
func (s *SpatialAnchorsAccountsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if spatialAnchorsAccountsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = spatialAnchorsAccountsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to SpatialAnchorsAccountsServerTransport
var spatialAnchorsAccountsServerTransportInterceptor interface {
