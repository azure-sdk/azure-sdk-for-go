...
// MarshalJSON implements the json.Marshaller interface for type EventFilter.
...
// UnmarshalJSON implements the json.Unmarshaller interface for type EventFilter.
...
// MarshalJSON implements the json.Marshaller interface for type EventGridFilter.
func (e EventGridFilter) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type EventGridFilter.
func (e *EventGridFilter) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", e, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type EventGridFilterListResult.
func (e EventGridFilterListResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type EventGridFilterListResult.
func (e *EventGridFilterListResult) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", e, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type EventGridFilterProperties.
func (e EventGridFilterProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "filter", e.Filter)
	populate(objectMap, "provisioningState", e.ProvisioningState)
	populate(objectMap, "subscriberIdentityInfo", e.SubscriberIdentityInfo)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type EventGridFilterProperties.
func (e *EventGridFilterProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", e, err)
	}
	for key, val := range rawMsg {
		...
		case "provisioningState":
			...
			delete(rawMsg, key)
		case "subscriberIdentityInfo":
			err = unpopulate(val, "SubscriberIdentityInfo", &e.SubscriberIdentityInfo)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", e, err)
...
// MarshalJSON implements the json.Marshaller interface for type SubscriberIdentityInfo.
func (s SubscriberIdentityInfo) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "clientApplicationId", s.ClientApplicationID)
	populate(objectMap, "clientAuthorizationSource", s.ClientAuthorizationSource)
	populate(objectMap, "clientObjectId", s.ClientObjectID)
	populate(objectMap, "clientPrincipalId", s.ClientPrincipalID)
	populate(objectMap, "clientTenantId", s.ClientTenantID)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type SubscriberIdentityInfo.
func (s *SubscriberIdentityInfo) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
	for key, val := range rawMsg {
		var err error
		switch key {
		case "clientApplicationId":
			err = unpopulate(val, "ClientApplicationID", &s.ClientApplicationID)
			delete(rawMsg, key)
		case "clientAuthorizationSource":
			err = unpopulate(val, "ClientAuthorizationSource", &s.ClientAuthorizationSource)
			delete(rawMsg, key)
		case "clientObjectId":
			err = unpopulate(val, "ClientObjectID", &s.ClientObjectID)
			delete(rawMsg, key)
		case "clientPrincipalId":
			err = unpopulate(val, "ClientPrincipalID", &s.ClientPrincipalID)
			delete(rawMsg, key)
		case "clientTenantId":
			err = unpopulate(val, "ClientTenantID", &s.ClientTenantID)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", s, err)
