...
// StaticSiteRegion - Static site region.
type StaticSiteRegion struct {
	// Kind of resource.
	Kind *string

	// StaticSiteRegion resource specific properties
	Properties *StaticSiteRegionProperties
...
// StaticSiteRegionCollection - Collection of Static Site regions.
type StaticSiteRegionCollection struct {
	// REQUIRED; Collection of resources.
...
// StaticSiteRegionProperties - StaticSiteRegion resource specific properties
type StaticSiteRegionProperties struct {
	// READ-ONLY; Display name for region.
	DisplayName *string
}
