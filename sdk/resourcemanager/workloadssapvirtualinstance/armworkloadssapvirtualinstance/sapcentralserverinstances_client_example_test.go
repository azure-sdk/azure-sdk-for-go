...
func ExampleSAPCentralServerInstancesClient_BeginStart_startTheSapCentralServicesInstance() {
	...
	poller, err := clientFactory.NewSAPCentralServerInstancesClient().BeginStart(ctx, "test-rg", "X00", "centralServer", armworkloadssapvirtualinstance.StartRequest{}, nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	res, err := poller.PollUntilDone(ctx, nil)
...
func ExampleSAPCentralServerInstancesClient_BeginStart_startTheVirtualMachineSAndTheSapCentralServicesInstanceOnIt() {
	...
	poller, err := clientFactory.NewSAPCentralServerInstancesClient().BeginStart(ctx, "test-rg", "X00", "centralServer", armworkloadssapvirtualinstance.StartRequest{
		StartVM: to.Ptr(true),
	}, nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
...
func ExampleSAPCentralServerInstancesClient_BeginStop_stopTheSapCentralServicesInstance() {
	...
	poller, err := clientFactory.NewSAPCentralServerInstancesClient().BeginStop(ctx, "test-rg", "X00", "centralServer", armworkloadssapvirtualinstance.StopRequest{
