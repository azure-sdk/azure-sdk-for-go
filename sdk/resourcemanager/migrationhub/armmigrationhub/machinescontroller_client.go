...
func (client *MachinesControllerClient) getMachineCreateRequest(ctx context.Context, resourceGroupName string, migrateProjectName string, machineName string, _ *MachinesControllerClientGetMachineOptions) (*policy.Request, error) {
