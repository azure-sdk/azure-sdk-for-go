	...
	go func() {
		...
		if !intercepted {
			...
			case "GatewaysClient.ListEnvSecrets":
				res.resp, res.err = g.dispatchListEnvSecrets(req)
			case "GatewaysClient.BeginRestart":
				res.resp, res.err = g.dispatchBeginRestart(req)
			case "GatewaysClient.BeginUpdateCapacity":
				res.resp, res.err = g.dispatchBeginUpdateCapacity(req)
			case "GatewaysClient.ValidateDomain":
				res.resp, res.err = g.dispatchValidateDomain(req)
			default:
