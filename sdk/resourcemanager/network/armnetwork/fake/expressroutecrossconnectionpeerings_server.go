...
func (e *ExpressRouteCrossConnectionPeeringsServerTransport) dispatchBeginCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginCreateOrUpdate == nil {
		...
		respr, errRespr := e.srv.BeginCreateOrUpdate(req.Context(), resourceGroupNameParam, crossConnectionNameParam, peeringNameParam, body, nil)
...
func (e *ExpressRouteCrossConnectionPeeringsServerTransport) dispatchBeginDelete(req *http.Request) (*http.Response, error) {
	...
	if beginDelete == nil {
		...
		respr, errRespr := e.srv.BeginDelete(req.Context(), resourceGroupNameParam, crossConnectionNameParam, peeringNameParam, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginDelete = &respr
...
func (e *ExpressRouteCrossConnectionPeeringsServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := e.srv.Get(req.Context(), resourceGroupNameParam, crossConnectionNameParam, peeringNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
...
func (e *ExpressRouteCrossConnectionPeeringsServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		resp := e.srv.NewListPager(resourceGroupNameParam, crossConnectionNameParam, nil)
		newListPager = &resp
