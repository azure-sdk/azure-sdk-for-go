...
func (d *DesktopsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if desktopsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = desktopsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to DesktopsServerTransport
var desktopsServerTransportInterceptor interface {
