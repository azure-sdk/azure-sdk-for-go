...
type AvailabilityGroupConfigure struct {
	...
	// Whether an availability replica that is performing the secondary role (that is, a secondary replica) can accept connections
	// from clients.
...
type AvailabilityGroupState struct {
	...
	// Reflects a rollup of the database synchronization state (synchronization_state) of all joined availability databases (also
