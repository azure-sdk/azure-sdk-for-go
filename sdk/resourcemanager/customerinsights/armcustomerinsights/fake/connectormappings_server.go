...
func (c *ConnectorMappingsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if connectorMappingsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = connectorMappingsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "ConnectorMappingsClient.NewListByConnectorPager":
				res.resp, res.err = c.dispatchNewListByConnectorPager(req)
			default:
...
// set this to conditionally intercept incoming requests to ConnectorMappingsServerTransport
var connectorMappingsServerTransportInterceptor interface {
