...
func (client *MarketplaceRegistrationDefinitionsClient) getCreateRequest(ctx context.Context, scope string, marketplaceIdentifier string, _ *MarketplaceRegistrationDefinitionsClientGetOptions) (*policy.Request, error) {
