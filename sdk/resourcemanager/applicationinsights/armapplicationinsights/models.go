...
type AzureMonitorPrivateLinkScopeProperties struct {
	...
	ProvisioningState *AzureMonitorPrivateLinkScopePropertiesProvisioningState `json:"provisioningState,omitempty" azure:"ro"`
}
...
type ScopedResourceProperties struct {
	...
	ProvisioningState *ScopedResourcePropertiesProvisioningState `json:"provisioningState,omitempty" azure:"ro"`
}
...
// TagsResourcePrivateLinkScope - A container holding only the Tags for a resource, allowing the user to update the tags on
// a PrivateLinkScope instance.
type TagsResourcePrivateLinkScope struct {
	// Resource tags
	Tags map[string]*string `json:"tags,omitempty"`
}
