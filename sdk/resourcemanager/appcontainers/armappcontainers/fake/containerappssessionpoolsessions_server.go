...
type ContainerAppsSessionPoolSessionsServer struct {
	...
	// HTTP status codes to indicate success: http.StatusOK
	UpdateEnvironmentVariables func(ctx context.Context, resourceGroupName string, sessionPoolName string, name string, environmentVariables map[string][]*armappcontainers.EnvironmentVar, options *armappcontainers.ContainerAppsSessionPoolSessionsClientUpdateEnvironmentVariablesOptions) (resp azfake.Responder[armappcontainers.ContainerAppsSessionPoolSessionsClientUpdateEnvironmentVariablesResponse], errResp azfake.ErrorResponder)
}
...
func (c *ContainerAppsSessionPoolSessionsServerTransport) dispatchNewGenerateSessionsPager(req *http.Request) (*http.Response, error) {
	...
	if newGenerateSessionsPager == nil {
		...
		var options *armappcontainers.ContainerAppsSessionPoolSessionsClientGenerateSessionsOptions
		if countParam != nil {
			options = &armappcontainers.ContainerAppsSessionPoolSessionsClientGenerateSessionsOptions{
				Count: countParam,
			}
		}
		resp := c.srv.NewGenerateSessionsPager(resourceGroupNameParam, sessionPoolNameParam, body, options)
...
func (c *ContainerAppsSessionPoolSessionsServerTransport) dispatchUpdateEnvironmentVariables(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[map[string][]*armappcontainers.EnvironmentVar](req)
	if err != nil {
		return nil, err
	}
	resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
