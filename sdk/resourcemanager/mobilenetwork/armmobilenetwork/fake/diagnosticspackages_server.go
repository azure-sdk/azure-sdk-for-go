...
func (d *DiagnosticsPackagesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if diagnosticsPackagesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = diagnosticsPackagesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "DiagnosticsPackagesClient.NewListByPacketCoreControlPlanePager":
				res.resp, res.err = d.dispatchNewListByPacketCoreControlPlanePager(req)
			default:
...
// set this to conditionally intercept incoming requests to DiagnosticsPackagesServerTransport
var diagnosticsPackagesServerTransportInterceptor interface {
