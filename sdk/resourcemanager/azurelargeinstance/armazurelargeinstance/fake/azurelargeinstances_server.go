...
type AzureLargeInstancesServer struct {
	...
	BeginRestart func(ctx context.Context, resourceGroupName string, azureLargeInstanceName string, body armazurelargeinstance.ForceState, options *armazurelargeinstance.AzureLargeInstancesClientBeginRestartOptions) (resp azfake.PollerResponder[armazurelargeinstance.AzureLargeInstancesClientRestartResponse], errResp azfake.ErrorResponder)

	// BeginShutdown is the fake for method AzureLargeInstancesClient.BeginShutdown
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginShutdown func(ctx context.Context, resourceGroupName string, azureLargeInstanceName string, body any, options *armazurelargeinstance.AzureLargeInstancesClientBeginShutdownOptions) (resp azfake.PollerResponder[armazurelargeinstance.AzureLargeInstancesClientShutdownResponse], errResp azfake.ErrorResponder)

	// BeginStart is the fake for method AzureLargeInstancesClient.BeginStart
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginStart func(ctx context.Context, resourceGroupName string, azureLargeInstanceName string, body any, options *armazurelargeinstance.AzureLargeInstancesClientBeginStartOptions) (resp azfake.PollerResponder[armazurelargeinstance.AzureLargeInstancesClientStartResponse], errResp azfake.ErrorResponder)

	// Update is the fake for method AzureLargeInstancesClient.Update
	// HTTP status codes to indicate success: http.StatusOK
	Update func(ctx context.Context, resourceGroupName string, azureLargeInstanceName string, properties armazurelargeinstance.TagsUpdate, options *armazurelargeinstance.AzureLargeInstancesClientUpdateOptions) (resp azfake.Responder[armazurelargeinstance.AzureLargeInstancesClientUpdateResponse], errResp azfake.ErrorResponder)
}
...
func (a *AzureLargeInstancesServerTransport) dispatchBeginRestart(req *http.Request) (*http.Response, error) {
	...
	if beginRestart == nil {
		...
		respr, errRespr := a.srv.BeginRestart(req.Context(), resourceGroupNameParam, azureLargeInstanceNameParam, body, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginRestart = &respr
