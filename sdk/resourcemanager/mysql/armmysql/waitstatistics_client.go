...
func (client *WaitStatisticsClient) getCreateRequest(ctx context.Context, resourceGroupName string, serverName string, waitStatisticsID string, _ *WaitStatisticsClientGetOptions) (*policy.Request, error) {
...
func (client *WaitStatisticsClient) listByServerCreateRequest(ctx context.Context, resourceGroupName string, serverName string, parameters WaitStatisticsInput, _ *WaitStatisticsClientListByServerOptions) (*policy.Request, error) {
