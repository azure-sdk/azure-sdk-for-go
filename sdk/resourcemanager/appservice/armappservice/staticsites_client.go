...
// BeginZipDeploy - Description for Deploys zipped content to a static site.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2024-11-01
//   - resourceGroupName - Name of the resource group to which the resource belongs.
//   - name - Name of the static site.
//   - staticSiteEnvelope - A JSON representation of the StaticSiteZipDeploy properties. See example.
//   - options - StaticSitesClientBeginZipDeployOptions contains the optional parameters for the StaticSitesClient.BeginZipDeploy
//     method.
func (client *StaticSitesClient) BeginZipDeploy(ctx context.Context, resourceGroupName string, name string, staticSiteEnvelope StaticSiteZipDeployARMResource, options *StaticSitesClientBeginZipDeployOptions) (*runtime.Poller[StaticSitesClientZipDeployResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.zipDeploy(ctx, resourceGroupName, name, staticSiteEnvelope, options)
		if err != nil {
			return nil, err
		}
		poller, err := runtime.NewPoller(resp, client.internal.Pipeline(), &runtime.NewPollerOptions[StaticSitesClientZipDeployResponse]{
			Tracer: client.internal.Tracer(),
		})
		return poller, err
	} else {
		return runtime.NewPollerFromResumeToken(options.ResumeToken, client.internal.Pipeline(), &runtime.NewPollerFromResumeTokenOptions[StaticSitesClientZipDeployResponse]{
			Tracer: client.internal.Tracer(),
		})
	}
}

// ZipDeploy - Description for Deploys zipped content to a static site.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2024-11-01
func (client *StaticSitesClient) zipDeploy(ctx context.Context, resourceGroupName string, name string, staticSiteEnvelope StaticSiteZipDeployARMResource, options *StaticSitesClientBeginZipDeployOptions) (*http.Response, error) {
	var err error
	const operationName = "StaticSitesClient.BeginZipDeploy"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.zipDeployCreateRequest(ctx, resourceGroupName, name, staticSiteEnvelope, options)
	if err != nil {
		return nil, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
...
// zipDeployCreateRequest creates the ZipDeploy request.
func (client *StaticSitesClient) zipDeployCreateRequest(ctx context.Context, resourceGroupName string, name string, staticSiteEnvelope StaticSiteZipDeployARMResource, options *StaticSitesClientBeginZipDeployOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/staticSites/{name}/deploy"
	if resourceGroupName == "" {
		return nil, errors.New("parameter resourceGroupName cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{resourceGroupName}", url.PathEscape(resourceGroupName))
...
// BeginZipDeployStaging - Description for Deploys zipped content to a static site onto a specified static sites environment.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2024-11-01
//   - resourceGroupName - Name of the resource group to which the resource belongs.
//   - name - Name of the static site.
//   - environmentName - The stage site identifier.
//   - staticSiteEnvelope - A JSON representation of the StaticSiteZipDeployStaging properties. See example.
//   - options - StaticSitesClientBeginZipDeployStagingOptions contains the optional parameters for the StaticSitesClient.BeginZipDeployStaging
//     method.
func (client *StaticSitesClient) BeginZipDeployStaging(ctx context.Context, resourceGroupName string, name string, environmentName string, staticSiteEnvelope StaticSiteZipDeployARMResource, options *StaticSitesClientBeginZipDeployStagingOptions) (*runtime.Poller[StaticSitesClientZipDeployStagingResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.zipDeployStaging(ctx, resourceGroupName, name, environmentName, staticSiteEnvelope, options)
		if err != nil {
			return nil, err
		}
		poller, err := runtime.NewPoller(resp, client.internal.Pipeline(), &runtime.NewPollerOptions[StaticSitesClientZipDeployStagingResponse]{
			Tracer: client.internal.Tracer(),
		})
		return poller, err
	} else {
		return runtime.NewPollerFromResumeToken(options.ResumeToken, client.internal.Pipeline(), &runtime.NewPollerFromResumeTokenOptions[StaticSitesClientZipDeployStagingResponse]{
			Tracer: client.internal.Tracer(),
		})
	}
}

// ZipDeployStaging - Description for Deploys zipped content to a static site onto a specified static sites environment.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2024-11-01
func (client *StaticSitesClient) zipDeployStaging(ctx context.Context, resourceGroupName string, name string, environmentName string, staticSiteEnvelope StaticSiteZipDeployARMResource, options *StaticSitesClientBeginZipDeployStagingOptions) (*http.Response, error) {
	var err error
	const operationName = "StaticSitesClient.BeginZipDeployStaging"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.zipDeployStagingCreateRequest(ctx, resourceGroupName, name, environmentName, staticSiteEnvelope, options)
	if err != nil {
		return nil, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
...
// zipDeployStagingCreateRequest creates the ZipDeployStaging request.
func (client *StaticSitesClient) zipDeployStagingCreateRequest(ctx context.Context, resourceGroupName string, name string, environmentName string, staticSiteEnvelope StaticSiteZipDeployARMResource, options *StaticSitesClientBeginZipDeployStagingOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/staticSites/{name}/builds/{environmentName}/deploy"
	if resourceGroupName == "" {
		return nil, errors.New("parameter resourceGroupName cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{resourceGroupName}", url.PathEscape(resourceGroupName))
