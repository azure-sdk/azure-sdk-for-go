...
//     method.
func (client *GlobalReachConnectionsClient) NewListByPrivateCloudPager(resourceGroupName string, privateCloudName string, options *GlobalReachConnectionsClientListByPrivateCloudOptions) *runtime.Pager[GlobalReachConnectionsClientListByPrivateCloudResponse] {
...
func (client *GlobalReachConnectionsClient) listByPrivateCloudCreateRequest(ctx context.Context, resourceGroupName string, privateCloudName string, _ *GlobalReachConnectionsClientListByPrivateCloudOptions) (*policy.Request, error) {
