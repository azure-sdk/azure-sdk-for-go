...
func (client *LabsClient) claimAnyVMCreateRequest(ctx context.Context, resourceGroupName string, name string, _ *LabsClientBeginClaimAnyVMOptions) (*policy.Request, error) {
...
func (client *LabsClient) createEnvironmentCreateRequest(ctx context.Context, resourceGroupName string, name string, labVirtualMachineCreationParameter LabVirtualMachineCreationParameter, _ *LabsClientBeginCreateEnvironmentOptions) (*policy.Request, error) {
...
func (client *LabsClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, name string, lab Lab, _ *LabsClientBeginCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *LabsClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, name string, _ *LabsClientBeginDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs/{name}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *LabsClient) exportResourceUsageCreateRequest(ctx context.Context, resourceGroupName string, name string, exportResourceUsageParameters ExportResourceUsageParameters, _ *LabsClientBeginExportResourceUsageOptions) (*policy.Request, error) {
...
func (client *LabsClient) generateUploadURICreateRequest(ctx context.Context, resourceGroupName string, name string, generateUploadURIParameter GenerateUploadURIParameter, _ *LabsClientGenerateUploadURIOptions) (*policy.Request, error) {
...
func (client *LabsClient) importVirtualMachineCreateRequest(ctx context.Context, resourceGroupName string, name string, importLabVirtualMachineRequest ImportLabVirtualMachineRequest, _ *LabsClientBeginImportVirtualMachineOptions) (*policy.Request, error) {
...
func (client *LabsClient) listVhdsCreateRequest(ctx context.Context, resourceGroupName string, name string, _ *LabsClientListVhdsOptions) (*policy.Request, error) {
...
func (client *LabsClient) updateCreateRequest(ctx context.Context, resourceGroupName string, name string, lab LabFragment, _ *LabsClientUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs/{name}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
