...
- Type of `JobExecutionTemplate.Containers` has been changed from `[]*JobExecutionContainer` to `[]*Container`
- Type of `JobExecutionTemplate.InitContainers` has been changed from `[]*JobExecutionContainer` to `[]*InitContainer`
- Struct `JobExecutionContainer` has been removed
...
- New enum type `AppSpaceResourceLabel` with values `AppSpaceResourceLabelDefault`, `AppSpaceResourceLabelFavorite`
...
- New function `NewAppSpaceResourcesClient(string, azcore.TokenCredential, *arm.ClientOptions) (*AppSpaceResourcesClient, error)`
- New function `*AppSpaceResourcesClient.CreateOrUpdate(context.Context, string, string, string, AppSpaceResource, *AppSpaceResourcesClientCreateOrUpdateOptions) (AppSpaceResourcesClientCreateOrUpdateResponse, error)`
- New function `*AppSpaceResourcesClient.Delete(context.Context, string, string, string, *AppSpaceResourcesClientDeleteOptions) (AppSpaceResourcesClientDeleteResponse, error)`
- New function `*AppSpaceResourcesClient.Get(context.Context, string, string, string, *AppSpaceResourcesClientGetOptions) (AppSpaceResourcesClientGetResponse, error)`
- New function `*AppSpaceResourcesClient.NewListByAppSpacePager(string, string, *AppSpaceResourcesClientListByAppSpaceOptions) *runtime.Pager[AppSpaceResourcesClientListByAppSpaceResponse]`
- New function `*AppSpaceResourcesClient.Update(context.Context, string, string, string, AppSpaceResourcePatch, *AppSpaceResourcesClientUpdateOptions) (AppSpaceResourcesClientUpdateResponse, error)`
- New function `NewAppSpacesClient(string, azcore.TokenCredential, *arm.ClientOptions) (*AppSpacesClient, error)`
- New function `*AppSpacesClient.CreateOrUpdate(context.Context, string, string, AppSpace, *AppSpacesClientCreateOrUpdateOptions) (AppSpacesClientCreateOrUpdateResponse, error)`
- New function `*AppSpacesClient.Delete(context.Context, string, string, *AppSpacesClientDeleteOptions) (AppSpacesClientDeleteResponse, error)`
- New function `*AppSpacesClient.Get(context.Context, string, string, *AppSpacesClientGetOptions) (AppSpacesClientGetResponse, error)`
- New function `*AppSpacesClient.NewListByResourceGroupPager(string, *AppSpacesClientListByResourceGroupOptions) *runtime.Pager[AppSpacesClientListByResourceGroupResponse]`
- New function `*AppSpacesClient.NewListBySubscriptionPager(*AppSpacesClientListBySubscriptionOptions) *runtime.Pager[AppSpacesClientListBySubscriptionResponse]`
- New function `*AppSpacesClient.Update(context.Context, string, string, AppSpacePatch, *AppSpacesClientUpdateOptions) (AppSpacesClientUpdateResponse, error)`
...
- New function `*ClientFactory.NewAppSpaceResourcesClient() *AppSpaceResourcesClient`
- New function `*ClientFactory.NewAppSpacesClient() *AppSpacesClient`
...
- New struct `AppSpace`
- New struct `AppSpacePatch`
- New struct `AppSpaceProperties`
- New struct `AppSpaceResource`
- New struct `AppSpaceResourcePatch`
- New struct `AppSpaceResourceProperties`
- New struct `AppSpaceResourcesCollection`
- New struct `AppSpacesCollection`
...
- New struct `DeploymentInformation`
...
- New struct `RepositoryInformation`
