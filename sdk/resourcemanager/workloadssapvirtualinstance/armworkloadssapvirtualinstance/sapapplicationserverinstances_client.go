...
func (client *SAPApplicationServerInstancesClient) startCreateRequest(ctx context.Context, resourceGroupName string, sapVirtualInstanceName string, applicationInstanceName string, body StartRequest, _ *SAPApplicationServerInstancesClientBeginStartOptions) (*policy.Request, error) {
...
func (client *SAPApplicationServerInstancesClient) stopCreateRequest(ctx context.Context, resourceGroupName string, sapVirtualInstanceName string, applicationInstanceName string, body StopRequest, _ *SAPApplicationServerInstancesClientBeginStopOptions) (*policy.Request, error) {
