...
// Generated from example definition: 2025-03-01-preview/Endpoints_CreateOrUpdate_MaximumSet_Gen.json
func ExampleEndpointsClient_BeginCreateOrUpdate() {
	...
	poller, err := clientFactory.NewEndpointsClient().BeginCreateOrUpdate(ctx, "rgneon", "testOrg123", "test-entity", "test-entity", "test-entity", armneonpostgres.Endpoint{
	...
	// 			EndpointType: to.Ptr(armneonpostgres.EndpointTypeReadOnly),
	// 		},
	// 		ID: to.Ptr("/subscriptions/671936A4-ED6C-445D-ACEE-5637920E7051/resourceGroups/rgneon/providers/Microsoft.Neon/organizations/testOrg123/projects/test-entity/branches/test-entity/endpoints/test-entity"),
	// 		Name: to.Ptr("jabkliub"),
	// 		Type: to.Ptr("vgvoehftunspta"),
...
// Generated from example definition: 2025-03-01-preview/Endpoints_Delete_MaximumSet_Gen.json
func ExampleEndpointsClient_Delete() {
	...
	res, err := clientFactory.NewEndpointsClient().Delete(ctx, "rgneon", "testOrg123", "test-entity", "test-entity", "test-entity", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
...
// Generated from example definition: 2025-03-01-preview/Endpoints_Get_MaximumSet_Gen.json
func ExampleEndpointsClient_Get() {
	...
	res, err := clientFactory.NewEndpointsClient().Get(ctx, "rgneon", "testOrg123", "test-entity", "test-entity", "test-entity", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
...
// Generated from example definition: 2025-03-01-preview/Endpoints_List_MaximumSet_Gen.json
func ExampleEndpointsClient_NewListPager() {
	...
	pager := clientFactory.NewEndpointsClient().NewListPager("rgneon", "testOrg123", "test-entity", "test-entity", nil)
	for pager.More() {
		...
		// 			},
		// 		},
		// 		NextLink: to.Ptr("https://microsoft.com/akh"),
		// 	},
		// }
	}
}

// Generated from example definition: 2025-03-01-preview/Endpoints_Update_MaximumSet_Gen.json
func ExampleEndpointsClient_BeginUpdate() {
	...
	poller, err := clientFactory.NewEndpointsClient().BeginUpdate(ctx, "rgneon", "testOrg123", "test-entity", "test-entity", "test-entity", armneonpostgres.Endpoint{
		Properties: &armneonpostgres.EndpointProperties{
			EntityName: to.Ptr("test-name"),
			Attributes: []*armneonpostgres.Attributes{
				{
