...
// MarshalJSON implements the json.Marshaller interface for type CspmMonitorGitLab.
func (c CspmMonitorGitLab) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "description", c.Description)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type CspmMonitorGitLab.
func (c *CspmMonitorGitLab) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
