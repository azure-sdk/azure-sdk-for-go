...
type EndpointClientListOptions struct {
	...
	Expand                    *string
	IncludeInferenceEndpoints *bool
...
// WorkspacesClientListConnectionModelsOptions contains the optional parameters for the WorkspacesClient.ListConnectionModels
// method.
type WorkspacesClientListConnectionModelsOptions struct {
	// placeholder for future optional parameters
}
