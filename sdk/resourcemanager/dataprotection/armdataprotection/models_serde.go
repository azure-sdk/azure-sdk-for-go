...
// MarshalJSON implements the json.Marshaller interface for type AzureBackupJobProgressURL.
func (a AzureBackupJobProgressURL) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "progressUrl", a.ProgressURL)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type AzureBackupJobProgressURL.
func (a *AzureBackupJobProgressURL) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", a, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type UserAssignedIdentityDetails.
...
// UnmarshalJSON implements the json.Unmarshaller interface for type UserAssignedIdentityDetails.
func (u *UserAssignedIdentityDetails) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", u, err)
	}
