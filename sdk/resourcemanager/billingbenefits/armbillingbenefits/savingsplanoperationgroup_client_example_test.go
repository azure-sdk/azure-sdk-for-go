...
// Generated from example definition: 2024-11-01-preview/SavingsPlansList.json
func ExampleSavingsPlanOperationGroupClient_NewListAllPager() {
	...
	pager := clientFactory.NewSavingsPlanOperationGroupClient().NewListAllPager(&SavingsPlanOperationGroupClientListAllOptions{
		Filter:  to.Ptr("(properties%2farchived+eq+false)"),
	...
	for pager.More() {
		...
		for _, v := range page.AdditionalProperties {
			// You could use page here. We use blank identifier for just demo purposes.
			_ = v
		}
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armbillingbenefits.SavingsPlanOperationGroupClientListAllResponse{
...
// Generated from example definition: 2024-11-01-preview/SavingsPlanValidatePurchase.json
func ExampleSavingsPlanOperationGroupClient_ValidatePurchase() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	res, err := clientFactory.NewSavingsPlanOperationGroupClient().ValidatePurchase(ctx, armbillingbenefits.SavingsPlanPurchaseValidateRequest{
	...
	// res = armbillingbenefits.SavingsPlanOperationGroupClientValidatePurchaseResponse{
