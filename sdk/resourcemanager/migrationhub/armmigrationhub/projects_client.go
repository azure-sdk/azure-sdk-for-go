...
func (client *ProjectsClient) listCreateRequest(ctx context.Context, resourceGroupName string, _ *ProjectsClientListOptions) (*policy.Request, error) {
...
func (client *ProjectsClient) listBySubscriptionCreateRequest(ctx context.Context, _ *ProjectsClientListBySubscriptionOptions) (*policy.Request, error) {
