...
// ResourceMoveRequest - Request specifies the resources to be moved and the target Resource Group
type ResourceMoveRequest struct {
	// REQUIRED; Resources to be moved
	Resources []*string

	// REQUIRED; Target resource group
