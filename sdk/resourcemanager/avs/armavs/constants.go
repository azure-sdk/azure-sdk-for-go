...
const (
	...
	// MaintenanceStateNameNotScheduled - Maintenance NotScheduled
	MaintenanceStateNameNotScheduled MaintenanceStateName = "NotScheduled"
	// MaintenanceStateNamePlanned - Maintenance Planned
	MaintenanceStateNamePlanned MaintenanceStateName = "Planned"
...
// RescheduleConstraintKind - Constraints for rescheduling of maintenance
type RescheduleConstraintKind string

const (
	// RescheduleConstraintKindBlocked - Blocked time range constraint
	RescheduleConstraintKindBlocked RescheduleConstraintKind = "Blocked"
	// RescheduleConstraintKindDeadline - Deadline constraint
	RescheduleConstraintKindDeadline RescheduleConstraintKind = "Deadline"
	// RescheduleConstraintKindFreezeDays - Freeze days constraint
	RescheduleConstraintKindFreezeDays RescheduleConstraintKind = "FreezeDays"
)

// PossibleRescheduleConstraintKindValues returns the possible values for the RescheduleConstraintKind const type.
func PossibleRescheduleConstraintKindValues() []RescheduleConstraintKind {
	return []RescheduleConstraintKind{
		RescheduleConstraintKindBlocked,
		RescheduleConstraintKindDeadline,
		RescheduleConstraintKindFreezeDays,
	}
}
