...
func (client *TuningOptionsClient) Get(ctx context.Context, resourceGroupName string, serverName string, tuningOption string, options *TuningOptionsClientGetOptions) (TuningOptionsClientGetResponse, error) {
	var err error
...
func (client *TuningOptionsClient) getCreateRequest(ctx context.Context, resourceGroupName string, serverName string, tuningOption string, options *TuningOptionsClientGetOptions) (*policy.Request, error) {
