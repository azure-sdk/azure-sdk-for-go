...
func (client *PrivateStoreClient) AnyExistingOffersInTheCollections(ctx context.Context, privateStoreID string, options *PrivateStoreClientAnyExistingOffersInTheCollectionsOptions) (PrivateStoreClientAnyExistingOffersInTheCollectionsResponse, error) {
	...
	if !runtime.HasStatusCode(resp, http.StatusOK) {
		return PrivateStoreClientAnyExistingOffersInTheCollectionsResponse{}, runtime.NewResponseError(resp)
	}
	return client.anyExistingOffersInTheCollectionsHandleResponse(resp)
}

// anyExistingOffersInTheCollectionsCreateRequest creates the AnyExistingOffersInTheCollections request.
func (client *PrivateStoreClient) anyExistingOffersInTheCollectionsCreateRequest(ctx context.Context, privateStoreID string, options *PrivateStoreClientAnyExistingOffersInTheCollectionsOptions) (*policy.Request, error) {
...
func (client *PrivateStoreClient) anyExistingOffersInTheCollectionsHandleResponse(resp *http.Response) (PrivateStoreClientAnyExistingOffersInTheCollectionsResponse, error) {
...
func (client *PrivateStoreClient) createApprovalRequestCreateRequest(ctx context.Context, privateStoreID string, requestApprovalID string, payload RequestApprovalResource, options *PrivateStoreClientCreateApprovalRequestOptions) (*policy.Request, error) {
...
func (client *PrivateStoreClient) createOrUpdateCreateRequest(ctx context.Context, privateStoreID string, payload PrivateStore, options *PrivateStoreClientCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *PrivateStoreClient) QueryUserOffers(ctx context.Context, privateStoreID string, options *PrivateStoreClientQueryUserOffersOptions) (PrivateStoreClientQueryUserOffersResponse, error) {
	...
	if !runtime.HasStatusCode(resp, http.StatusOK) {
		return PrivateStoreClientQueryUserOffersResponse{}, runtime.NewResponseError(resp)
	}
	return client.queryUserOffersHandleResponse(resp)
}
...
func (client *PrivateStoreClient) queryUserOffersHandleResponse(resp *http.Response) (PrivateStoreClientQueryUserOffersResponse, error) {
...
func (client *PrivateStoreClient) updateAdminRequestApprovalCreateRequest(ctx context.Context, privateStoreID string, adminRequestApprovalID string, payload AdminRequestApprovalsResource, options *PrivateStoreClientUpdateAdminRequestApprovalOptions) (*policy.Request, error) {
	urlPath := "/providers/Microsoft.Marketplace/privateStores/{privateStoreId}/adminRequestApprovals/{adminRequestApprovalId}"
	if privateStoreID == "" {
		return nil, errors.New("parameter privateStoreID cannot be empty")
	}
