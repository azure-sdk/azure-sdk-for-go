...
func (client *CommunicationsNoSubscriptionClient) checkNameAvailabilityCreateRequest(ctx context.Context, supportTicketName string, checkNameAvailabilityInput CheckNameAvailabilityInput, _ *CommunicationsNoSubscriptionClientCheckNameAvailabilityOptions) (*policy.Request, error) {
...
func (client *CommunicationsNoSubscriptionClient) createCreateRequest(ctx context.Context, supportTicketName string, communicationName string, createCommunicationParameters CommunicationDetails, _ *CommunicationsNoSubscriptionClientBeginCreateOptions) (*policy.Request, error) {
...
func (client *CommunicationsNoSubscriptionClient) getCreateRequest(ctx context.Context, supportTicketName string, communicationName string, _ *CommunicationsNoSubscriptionClientGetOptions) (*policy.Request, error) {
	urlPath := "/providers/Microsoft.Support/supportTickets/{supportTicketName}/communications/{communicationName}"
	if supportTicketName == "" {
		return nil, errors.New("parameter supportTicketName cannot be empty")
	}
