...
func (client *FabricAgentClient) BeginCreate(ctx context.Context, resourceGroupName string, fabricName string, fabricAgentName string, body FabricAgentModel, options *FabricAgentClientBeginCreateOptions) (*runtime.Poller[FabricAgentClientCreateResponse], error) {
...
//
// Generated from API version 2024-09-01
func (client *FabricAgentClient) create(ctx context.Context, resourceGroupName string, fabricName string, fabricAgentName string, body FabricAgentModel, options *FabricAgentClientBeginCreateOptions) (*http.Response, error) {
	var err error
...
func (client *FabricAgentClient) createCreateRequest(ctx context.Context, resourceGroupName string, fabricName string, fabricAgentName string, body FabricAgentModel, _ *FabricAgentClientBeginCreateOptions) (*policy.Request, error) {
