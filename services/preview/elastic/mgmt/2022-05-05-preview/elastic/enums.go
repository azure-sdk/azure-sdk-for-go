...
// APIVersionParameter enumerates the values for api version parameter.
type APIVersionParameter string

const (
	// TwoZeroTwoOneHyphenMinusOneZeroHyphenMinusZeroOneHyphenMinuspreview ...
	TwoZeroTwoOneHyphenMinusOneZeroHyphenMinusZeroOneHyphenMinuspreview APIVersionParameter = "2021-10-01-preview"
	// TwoZeroTwoOneHyphenMinusZeroNineHyphenMinusZeroOneHyphenMinuspreview ...
	TwoZeroTwoOneHyphenMinusZeroNineHyphenMinusZeroOneHyphenMinuspreview APIVersionParameter = "2021-09-01-preview"
	// TwoZeroTwoTwoHyphenMinusZeroFiveHyphenMinusZeroFiveHyphenMinuspreview ...
	TwoZeroTwoTwoHyphenMinusZeroFiveHyphenMinusZeroFiveHyphenMinuspreview APIVersionParameter = "2022-05-05-preview"
	// TwoZeroTwoZeroHyphenMinusZeroSevenHyphenMinusZeroOne ...
	TwoZeroTwoZeroHyphenMinusZeroSevenHyphenMinusZeroOne APIVersionParameter = "2020-07-01"
	// TwoZeroTwoZeroHyphenMinusZeroSevenHyphenMinusZeroOneHyphenMinuspreview ...
	TwoZeroTwoZeroHyphenMinusZeroSevenHyphenMinusZeroOneHyphenMinuspreview APIVersionParameter = "2020-07-01-preview"
)

// PossibleAPIVersionParameterValues returns an array of possible values for the APIVersionParameter const type.
func PossibleAPIVersionParameterValues() []APIVersionParameter {
	return []APIVersionParameter{TwoZeroTwoOneHyphenMinusOneZeroHyphenMinusZeroOneHyphenMinuspreview, TwoZeroTwoOneHyphenMinusZeroNineHyphenMinusZeroOneHyphenMinuspreview, TwoZeroTwoTwoHyphenMinusZeroFiveHyphenMinusZeroFiveHyphenMinuspreview, TwoZeroTwoZeroHyphenMinusZeroSevenHyphenMinusZeroOne, TwoZeroTwoZeroHyphenMinusZeroSevenHyphenMinusZeroOneHyphenMinuspreview}
}
...
const (
	...
	AzurePrivateEndpoint Type = "azure_private_endpoint"
	// IP ...
	IP Type = "ip"
)
...
func PossibleTypeValues() []Type {
	return []Type{AzurePrivateEndpoint, IP}
}
