...
//     method.
func (client *MonitoredResourcesClient) CreateOrUpdate(ctx context.Context, resourceGroupName string, options *MonitoredResourcesClientCreateOrUpdateOptions) (MonitoredResourcesClientCreateOrUpdateResponse, error) {
	var err error
...
func (client *MonitoredResourcesClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, options *MonitoredResourcesClientCreateOrUpdateOptions) (*policy.Request, error) {
	...
	return runtime.NewPager(runtime.PagingHandler[MonitoredResourcesClientListByManagedInstanceResponse]{
		...
		Fetcher: func(ctx context.Context, page *MonitoredResourcesClientListByManagedInstanceResponse) (MonitoredResourcesClientListByManagedInstanceResponse, error) {
			...
			if !runtime.HasStatusCode(resp, http.StatusOK) {
				return MonitoredResourcesClientListByManagedInstanceResponse{}, runtime.NewResponseError(resp)
			}
