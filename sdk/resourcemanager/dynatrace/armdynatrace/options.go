...
// MonitorsClientUpdateAgentStatusOptions contains the optional parameters for the MonitorsClient.UpdateAgentStatus method.
type MonitorsClientUpdateAgentStatusOptions struct {
	// placeholder for future optional parameters
}
