...
func (i *InventoryItemsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if inventoryItemsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = inventoryItemsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "InventoryItemsClient.NewListByVmmServerPager":
				res.resp, res.err = i.dispatchNewListByVmmServerPager(req)
			default:
...
// set this to conditionally intercept incoming requests to InventoryItemsServerTransport
var inventoryItemsServerTransportInterceptor interface {
