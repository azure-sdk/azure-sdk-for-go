...
func ExampleVolumesClient_BeginCreate_volumesCreateMaximumSetGen() {
	...
	poller, err := clientFactory.NewVolumesClient().BeginCreate(ctx, "resourcegroupname", "elasticsanname", "volumegroupname", "volumename", nil)
	if err != nil {
...
func ExampleVolumesClient_BeginDelete_volumesDeleteMaximumSetGen() {
	...
	poller, err := clientFactory.NewVolumesClient().BeginDelete(ctx, "resourcegroupname", "elasticsanname", "volumegroupname", "volumename", &VolumesClientBeginDeleteOptions{
...
func ExampleVolumesClient_NewListByVolumeGroupPager_volumesListByVolumeGroupMaximumSetGen() {
	...
	pager := clientFactory.NewVolumesClient().NewListByVolumeGroupPager("resourcegroupname", "elasticsanname", "volumegroupname", &VolumesClientListByVolumeGroupOptions{
	...
	for pager.More() {
		...
		// 		NextLink: to.Ptr("vmcqengosaggkzwe"),
...
func ExampleVolumesClient_BeginRestoreVolume_restoreVolumeMaximumSetGen() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	poller, err := clientFactory.NewVolumesClient().BeginRestoreVolume(ctx, "resourcegroupname", "elasticsanname", "volumegroupname", "volumename-1741526907", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	res, err := poller.PollUntilDone(ctx, nil)
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armelasticsan.VolumesClientRestoreVolumeResponse{
	// 	Volume: &armelasticsan.Volume{
...
func ExampleVolumesClient_BeginRestoreVolume_restoreVolumeMinimumSetGen() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
...
func ExampleVolumesClient_BeginUpdate_volumesUpdateMaximumSetGen() {
	...
	poller, err := clientFactory.NewVolumesClient().BeginUpdate(ctx, "resourcegroupname", "elasticsanname", "volumegroupname", "volumename", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	res, err := poller.PollUntilDone(ctx, nil)
