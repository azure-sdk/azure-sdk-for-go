...
func (s *SQLPoolReplicationLinksServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if sqlPoolReplicationLinksServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = sqlPoolReplicationLinksServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to SQLPoolReplicationLinksServerTransport
var sqlPoolReplicationLinksServerTransportInterceptor interface {
