...
func (client *ScopeAssignmentsClient) createOrUpdateCreateRequest(ctx context.Context, scope string, scopeAssignmentName string, parameters ScopeAssignment, _ *ScopeAssignmentsClientCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *ScopeAssignmentsClient) deleteCreateRequest(ctx context.Context, scope string, scopeAssignmentName string, _ *ScopeAssignmentsClientDeleteOptions) (*policy.Request, error) {
	urlPath := "/{scope}/providers/Microsoft.ManagedNetwork/scopeAssignments/{scopeAssignmentName}"
	urlPath = strings.ReplaceAll(urlPath, "{scope}", scope)
	if scopeAssignmentName == "" {
		return nil, errors.New("parameter scopeAssignmentName cannot be empty")
...
func (client *ScopeAssignmentsClient) getCreateRequest(ctx context.Context, scope string, scopeAssignmentName string, _ *ScopeAssignmentsClientGetOptions) (*policy.Request, error) {
	urlPath := "/{scope}/providers/Microsoft.ManagedNetwork/scopeAssignments/{scopeAssignmentName}"
	urlPath = strings.ReplaceAll(urlPath, "{scope}", scope)
	if scopeAssignmentName == "" {
		return nil, errors.New("parameter scopeAssignmentName cannot be empty")
...
func (client *ScopeAssignmentsClient) listCreateRequest(ctx context.Context, scope string, _ *ScopeAssignmentsClientListOptions) (*policy.Request, error) {
