...
func (n *NetworkFunctionDefinitionVersionsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if networkFunctionDefinitionVersionsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = networkFunctionDefinitionVersionsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "NetworkFunctionDefinitionVersionsClient.NewListByNetworkFunctionDefinitionGroupPager":
				res.resp, res.err = n.dispatchNewListByNetworkFunctionDefinitionGroupPager(req)
...
// set this to conditionally intercept incoming requests to NetworkFunctionDefinitionVersionsServerTransport
var networkFunctionDefinitionVersionsServerTransportInterceptor interface {
