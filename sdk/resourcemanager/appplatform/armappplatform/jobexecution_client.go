...
func (client *JobExecutionClient) cancelCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, jobName string, jobExecutionName string, _ *JobExecutionClientBeginCancelOptions) (*policy.Request, error) {
...
func (client *JobExecutionClient) getCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, jobName string, jobExecutionName string, _ *JobExecutionClientGetOptions) (*policy.Request, error) {
...
func (client *JobExecutionClient) listEnvSecretsCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, jobName string, jobExecutionName string, _ *JobExecutionClientListEnvSecretsOptions) (*policy.Request, error) {
