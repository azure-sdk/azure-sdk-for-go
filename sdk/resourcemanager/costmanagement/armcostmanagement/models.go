...
type ExportDataset struct {
	...
	Grouping *ExportDatasetGrouping `json:"grouping,omitempty"`
}
...
// ExportDatasetGrouping - The group by union expression
type ExportDatasetGrouping struct {
	// Cost management report column types.
	ColumnType *ColumnType `json:"ColumnType,omitempty"`

	// The name of the column(dimension, metric)/key(tag) to filter on
	Name *string `json:"Name,omitempty"`
}
