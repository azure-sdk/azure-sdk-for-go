...
func (client *TagRulesClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, monitorName string, ruleSetName string, body MonitoringTagRules, options *TagRulesClientCreateOrUpdateOptions) (*policy.Request, error) {
