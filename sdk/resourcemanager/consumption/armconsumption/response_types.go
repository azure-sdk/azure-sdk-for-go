...
// OperationsResultClientListResponse contains the response from method OperationsResultClient.NewListPager.
type OperationsResultClientListResponse struct {
...
// PriceSheetsClientGetByBillingPeriodResponse contains the response from method PriceSheetsClient.GetByBillingPeriod.
type PriceSheetsClientGetByBillingPeriodResponse struct {
	PriceSheetResultV2
}

// PriceSheetsClientGetResponse contains the response from method PriceSheetsClient.Get.
type PriceSheetsClientGetResponse struct {
	PriceSheetResultV2
}
