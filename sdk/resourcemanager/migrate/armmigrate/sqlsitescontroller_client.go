...
func (client *SQLSitesControllerClient) createCreateRequest(ctx context.Context, resourceGroupName string, siteName string, sqlSiteName string, body SQLSite, _ *SQLSitesControllerClientCreateOptions) (*policy.Request, error) {
...
func (client *SQLSitesControllerClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, siteName string, sqlSiteName string, _ *SQLSitesControllerClientDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OffAzure/masterSites/{siteName}/sqlSites/{sqlSiteName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *SQLSitesControllerClient) errorSummaryCreateRequest(ctx context.Context, resourceGroupName string, siteName string, sqlSiteName string, body ErrorSummaryRequest, _ *SQLSitesControllerClientErrorSummaryOptions) (*policy.Request, error) {
...
// ExportImportedSQLInventoryAsync - Method to generate export/read SAS uri for import.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2024-12-01-preview
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
...
//   - sqlSiteName - SQL site name.
//   - body - The content of the action request
//   - options - SQLSitesControllerClientExportImportedSQLInventoryAsyncOptions contains the optional parameters for the SQLSitesControllerClient.ExportImportedSQLInventoryAsync
//     method.
func (client *SQLSitesControllerClient) ExportImportedSQLInventoryAsync(ctx context.Context, resourceGroupName string, siteName string, sqlSiteName string, body SQLInventoryImportBody, options *SQLSitesControllerClientExportImportedSQLInventoryAsyncOptions) (SQLSitesControllerClientExportImportedSQLInventoryAsyncResponse, error) {
	var err error
	const operationName = "SQLSitesControllerClient.ExportImportedSQLInventoryAsync"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.exportImportedSQLInventoryAsyncCreateRequest(ctx, resourceGroupName, siteName, sqlSiteName, body, options)
	if err != nil {
		return SQLSitesControllerClientExportImportedSQLInventoryAsyncResponse{}, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
	if err != nil {
		return SQLSitesControllerClientExportImportedSQLInventoryAsyncResponse{}, err
	...
	resp, err := client.exportImportedSQLInventoryAsyncHandleResponse(httpResp)
	return resp, err
}

// exportImportedSQLInventoryAsyncCreateRequest creates the ExportImportedSQLInventoryAsync request.
func (client *SQLSitesControllerClient) exportImportedSQLInventoryAsyncCreateRequest(ctx context.Context, resourceGroupName string, siteName string, sqlSiteName string, body SQLInventoryImportBody, _ *SQLSitesControllerClientExportImportedSQLInventoryAsyncOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OffAzure/masterSites/{siteName}/sqlSites/{sqlSiteName}/exportImportedSqlInventoryAsync"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{subscriptionId}", url.PathEscape(client.subscriptionID))
...
// exportImportedSQLInventoryAsyncHandleResponse handles the ExportImportedSQLInventoryAsync response.
func (client *SQLSitesControllerClient) exportImportedSQLInventoryAsyncHandleResponse(resp *http.Response) (SQLSitesControllerClientExportImportedSQLInventoryAsyncResponse, error) {
	result := SQLSitesControllerClientExportImportedSQLInventoryAsyncResponse{}
	if err := runtime.UnmarshalAsJSON(resp, &result.SQLInventoryImportBody); err != nil {
		return SQLSitesControllerClientExportImportedSQLInventoryAsyncResponse{}, err
	}
	return result, nil
}
...
func (client *SQLSitesControllerClient) exportSQLServerErrorsCreateRequest(ctx context.Context, resourceGroupName string, siteName string, sqlSiteName string, body any, _ *SQLSitesControllerClientBeginExportSQLServerErrorsOptions) (*policy.Request, error) {
...
func (client *SQLSitesControllerClient) exportSQLServersCreateRequest(ctx context.Context, resourceGroupName string, siteName string, sqlSiteName string, body ExportSQLServersRequest, _ *SQLSitesControllerClientBeginExportSQLServersOptions) (*policy.Request, error) {
...
func (client *SQLSitesControllerClient) getCreateRequest(ctx context.Context, resourceGroupName string, siteName string, sqlSiteName string, _ *SQLSitesControllerClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OffAzure/masterSites/{siteName}/sqlSites/{sqlSiteName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *SQLSitesControllerClient) listByMasterSiteCreateRequest(ctx context.Context, resourceGroupName string, siteName string, _ *SQLSitesControllerClientListByMasterSiteOptions) (*policy.Request, error) {
...
func (client *SQLSitesControllerClient) refreshCreateRequest(ctx context.Context, resourceGroupName string, siteName string, sqlSiteName string, body SQLSiteRefreshBody, _ *SQLSitesControllerClientBeginRefreshOptions) (*policy.Request, error) {
...
func (client *SQLSitesControllerClient) summaryCreateRequest(ctx context.Context, resourceGroupName string, siteName string, sqlSiteName string, _ *SQLSitesControllerClientSummaryOptions) (*policy.Request, error) {
...
// BeginTriggerImportInventory - Initiates SQL inventory import process. This is an asynchronous operation that returns a
// 202 Accepted response and requires polling for completion status.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2024-12-01-preview
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - siteName - Site name
//   - sqlSiteName - SQL site name.
//   - body - Import parameters
//   - options - SQLSitesControllerClientBeginTriggerImportInventoryOptions contains the optional parameters for the SQLSitesControllerClient.BeginTriggerImportInventory
//     method.
func (client *SQLSitesControllerClient) BeginTriggerImportInventory(ctx context.Context, resourceGroupName string, siteName string, sqlSiteName string, body SQLInventoryImportBody, options *SQLSitesControllerClientBeginTriggerImportInventoryOptions) (*runtime.Poller[SQLSitesControllerClientTriggerImportInventoryResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.triggerImportInventory(ctx, resourceGroupName, siteName, sqlSiteName, body, options)
		if err != nil {
			return nil, err
		}
		poller, err := runtime.NewPoller(resp, client.internal.Pipeline(), &runtime.NewPollerOptions[SQLSitesControllerClientTriggerImportInventoryResponse]{
			FinalStateVia: runtime.FinalStateViaLocation,
			Tracer:        client.internal.Tracer(),
		})
		return poller, err
	} else {
		return runtime.NewPollerFromResumeToken(options.ResumeToken, client.internal.Pipeline(), &runtime.NewPollerFromResumeTokenOptions[SQLSitesControllerClientTriggerImportInventoryResponse]{
			Tracer: client.internal.Tracer(),
		})
	}
}

// TriggerImportInventory - Initiates SQL inventory import process. This is an asynchronous operation that returns a 202 Accepted
// response and requires polling for completion status.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2024-12-01-preview
func (client *SQLSitesControllerClient) triggerImportInventory(ctx context.Context, resourceGroupName string, siteName string, sqlSiteName string, body SQLInventoryImportBody, options *SQLSitesControllerClientBeginTriggerImportInventoryOptions) (*http.Response, error) {
	var err error
	const operationName = "SQLSitesControllerClient.BeginTriggerImportInventory"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.triggerImportInventoryCreateRequest(ctx, resourceGroupName, siteName, sqlSiteName, body, options)
	if err != nil {
		return nil, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
...
// triggerImportInventoryCreateRequest creates the TriggerImportInventory request.
func (client *SQLSitesControllerClient) triggerImportInventoryCreateRequest(ctx context.Context, resourceGroupName string, siteName string, sqlSiteName string, body SQLInventoryImportBody, _ *SQLSitesControllerClientBeginTriggerImportInventoryOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OffAzure/masterSites/{siteName}/sqlSites/{sqlSiteName}/triggerImportInventory"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{subscriptionId}", url.PathEscape(client.subscriptionID))
...
func (client *SQLSitesControllerClient) updateCreateRequest(ctx context.Context, resourceGroupName string, siteName string, sqlSiteName string, properties SQLSiteUpdate, _ *SQLSitesControllerClientBeginUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OffAzure/masterSites/{siteName}/sqlSites/{sqlSiteName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
// ValidateAndImportInventory - Validates SQL inventory data for format and correctness before attempting import. This is
// a safer alternative to direct import as it prevents failed imports due to invalid data. The operation performs
// validation checks first and only proceeds with import if all checks pass.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2024-12-01-preview
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
...
//   - sqlSiteName - SQL site name.
//   - body - The content of the action request
//   - options - SQLSitesControllerClientValidateAndImportInventoryOptions contains the optional parameters for the SQLSitesControllerClient.ValidateAndImportInventory
//     method.
func (client *SQLSitesControllerClient) ValidateAndImportInventory(ctx context.Context, resourceGroupName string, siteName string, sqlSiteName string, body SQLInventoryImportBody, options *SQLSitesControllerClientValidateAndImportInventoryOptions) (SQLSitesControllerClientValidateAndImportInventoryResponse, error) {
	var err error
	const operationName = "SQLSitesControllerClient.ValidateAndImportInventory"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.validateAndImportInventoryCreateRequest(ctx, resourceGroupName, siteName, sqlSiteName, body, options)
	if err != nil {
		return SQLSitesControllerClientValidateAndImportInventoryResponse{}, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
	if err != nil {
		return SQLSitesControllerClientValidateAndImportInventoryResponse{}, err
	...
	resp, err := client.validateAndImportInventoryHandleResponse(httpResp)
	return resp, err
}

// validateAndImportInventoryCreateRequest creates the ValidateAndImportInventory request.
func (client *SQLSitesControllerClient) validateAndImportInventoryCreateRequest(ctx context.Context, resourceGroupName string, siteName string, sqlSiteName string, body SQLInventoryImportBody, _ *SQLSitesControllerClientValidateAndImportInventoryOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OffAzure/masterSites/{siteName}/sqlSites/{sqlSiteName}/validateAndImportInventory"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{subscriptionId}", url.PathEscape(client.subscriptionID))
...
// validateAndImportInventoryHandleResponse handles the ValidateAndImportInventory response.
func (client *SQLSitesControllerClient) validateAndImportInventoryHandleResponse(resp *http.Response) (SQLSitesControllerClientValidateAndImportInventoryResponse, error) {
	result := SQLSitesControllerClientValidateAndImportInventoryResponse{}
	if err := runtime.UnmarshalAsJSON(resp, &result.SQLInventoryImportBody); err != nil {
		return SQLSitesControllerClientValidateAndImportInventoryResponse{}, err
	}
	return result, nil
