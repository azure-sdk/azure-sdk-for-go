...
// AzureConnectionMethod - Which connection method Managed Cassandra should use to conenct to Azure resources it needs. 'None'
// is the deafukt which means conenct directly, 'Vpn' will connect through a VPN endpoint for added
// security and simplicity.
type AzureConnectionMethod string

const (
	AzureConnectionMethodNone AzureConnectionMethod = "None"
	AzureConnectionMethodVPN  AzureConnectionMethod = "Vpn"
)

// PossibleAzureConnectionMethodValues returns the possible values for the AzureConnectionMethod const type.
func PossibleAzureConnectionMethodValues() []AzureConnectionMethod {
	return []AzureConnectionMethod{
		AzureConnectionMethodNone,
		AzureConnectionMethodVPN,
	}
}
