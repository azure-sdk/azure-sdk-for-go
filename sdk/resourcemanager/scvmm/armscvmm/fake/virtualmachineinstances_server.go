	...
	go func() {
		...
		if !intercepted {
			...
			case "VirtualMachineInstancesClient.BeginCreateCheckpoint":
				res.resp, res.err = v.dispatchBeginCreateCheckpoint(req)
			...
			case "VirtualMachineInstancesClient.BeginDeleteCheckpoint":
				res.resp, res.err = v.dispatchBeginDeleteCheckpoint(req)
			...
			case "VirtualMachineInstancesClient.BeginRestoreCheckpoint":
				res.resp, res.err = v.dispatchBeginRestoreCheckpoint(req)
