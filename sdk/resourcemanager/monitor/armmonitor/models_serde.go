...
// MarshalJSON implements the json.Marshaller interface for type ErrorResponseAdditionalInfoItem.
func (e ErrorResponseAdditionalInfoItem) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateAny(objectMap, "info", e.Info)
	populate(objectMap, "type", e.Type)
	return json.Marshal(objectMap)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type ErrorResponseAdditionalInfoItem.
func (e *ErrorResponseAdditionalInfoItem) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", e, err)
	}
