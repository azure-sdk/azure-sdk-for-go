...
// VmwareOperationsStatusServer is a fake server for instances of the armmigrate.VmwareOperationsStatusClient type.
type VmwareOperationsStatusServer struct {
	...
	GetVmwareOperationStatus func(ctx context.Context, resourceGroupName string, siteName string, operationStatusName string, options *armmigrate.VmwareOperationsStatusClientGetVmwareOperationStatusOptions) (resp azfake.Responder[armmigrate.VmwareOperationsStatusClientGetVmwareOperationStatusResponse], errResp azfake.ErrorResponder)
}
...
// The returned VmwareOperationsStatusServerTransport instance is connected to an instance of armmigrate.VmwareOperationsStatusClient via the
...
// VmwareOperationsStatusServerTransport connects instances of armmigrate.VmwareOperationsStatusClient to instances of VmwareOperationsStatusServer.
