...
type SQLDbElasticPoolTargetProperties struct {
	// REQUIRED; The ARM ResourceId of the anchor database used to connect to an elastic pool.
	...
	// REQUIRED; The ARM ResourceId of an Azure SQL DB elastic pool target.
...
func (s *SQLDbElasticPoolTargetProperties) GetTargetProperties() *TargetProperties {
	return &TargetProperties{
		...
		TargetCollectionStatus:   s.TargetCollectionStatus,
...
type SQLDbSingleDatabaseTargetProperties struct {
	...
	// REQUIRED; The ARM ResourceId of an Azure SQL DB single database target.
...
type SQLMiTargetProperties struct {
	...
	// REQUIRED; The ARM ResourceId of an Azure SQL Managed Instance target.
...
type SQLVMTargetProperties struct {
	...
	// REQUIRED; The ARM ResourceId of an Azure SQL VM target.
