...
func (v *VmmServersServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if vmmServersServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = vmmServersServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to VmmServersServerTransport
var vmmServersServerTransportInterceptor interface {
