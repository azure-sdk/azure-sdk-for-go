...
type ResourceTypeSKU struct {
	...
	ElasticSan *SanTierInfo `json:"elasticSan,omitempty"`
...
type SourceCreationData struct {
	// CONSTANT; This enumerates the possible sources of a volume creation.
...
type VolumeTierInfo struct {
	...
	IopsPerBaseGiB *int64 `json:"iopsPerBaseGiB,omitempty" azure:"ro"`
