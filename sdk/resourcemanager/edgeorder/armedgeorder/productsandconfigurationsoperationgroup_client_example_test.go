...
func ExampleProductsAndConfigurationsOperationGroupClient_NewListConfigurationsPager() {
	...
	for pager.More() {
		...
		// page = armedgeorder.ProductsAndConfigurationsOperationGroupClientListConfigurationsResponse{
...
func ExampleProductsAndConfigurationsOperationGroupClient_NewListProductFamiliesPager() {
	...
	for pager.More() {
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armedgeorder.ProductsAndConfigurationsOperationGroupClientListProductFamiliesResponse{
...
func ExampleProductsAndConfigurationsOperationGroupClient_NewListProductFamiliesMetadataPager() {
	...
	for pager.More() {
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armedgeorder.ProductsAndConfigurationsOperationGroupClientListProductFamiliesMetadataResponse{
