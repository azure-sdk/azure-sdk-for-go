...
// MarshalJSON implements the json.Marshaller interface for type DatabaseBillingVersionProperties.
func (d DatabaseBillingVersionProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "billingVersion", d.BillingVersion)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type DatabaseBillingVersionProperties.
func (d *DatabaseBillingVersionProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", d, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "billingVersion":
			err = unpopulate(val, "BillingVersion", &d.BillingVersion)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", d, err)
...
// MarshalJSON implements the json.Marshaller interface for type DatabaseBillingVersionResponse.
func (d DatabaseBillingVersionResponse) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "id", d.ID)
	populate(objectMap, "name", d.Name)
	populate(objectMap, "properties", d.Properties)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type DatabaseBillingVersionResponse.
func (d *DatabaseBillingVersionResponse) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", d, err)
	}
...
func (d DatabaseProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "hyperscaleBillingVersion", d.HyperscaleBillingVersion)
...
func (d *DatabaseProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "highAvailabilityReplicaCount":
			...
			delete(rawMsg, key)
		case "hyperscaleBillingVersion":
			err = unpopulate(val, "HyperscaleBillingVersion", &d.HyperscaleBillingVersion)
			delete(rawMsg, key)
...
func (m ManagedInstanceProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "totalMemoryMB", m.TotalMemoryMB)
...
func (m *ManagedInstanceProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "timezoneId":
			...
			delete(rawMsg, key)
		case "totalMemoryMB":
			err = unpopulate(val, "TotalMemoryMB", &m.TotalMemoryMB)
			delete(rawMsg, key)
		case "vCores":
