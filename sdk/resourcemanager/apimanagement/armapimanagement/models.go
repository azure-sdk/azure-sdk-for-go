...
// BackendManagedIdentityCredentials - Managed Identity credential information.
type BackendManagedIdentityCredentials struct {
	// REQUIRED; The application ID of the target web API (secured resource) in Microsoft Entra ID.
	Resource *string
