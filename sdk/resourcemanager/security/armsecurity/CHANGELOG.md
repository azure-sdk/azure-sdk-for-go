...
- New const `StateForNotificationsByRoleOn`
- New const `ApplicationSourceResourceTypeAssessments`
- New const `StateForNotificationsByRoleOff`
- New const `SubPlanP1`
- New const `OfferingTypeDefenderForContainersGcp`
- New const `RolesOwner`
- New const `StateForAlertNotificationsOn`
- New const `TypeTVM`
...
- New const `StateForAlertNotificationsOff`
...
- New type alias `StateForAlertNotifications`
...
- New type alias `StateForNotificationsByRole`
...
- New function `PossibleStateForAlertNotificationsValues() []StateForAlertNotifications`
...
- New function `PossibleStateForNotificationsByRoleValues() []StateForNotificationsByRole`
