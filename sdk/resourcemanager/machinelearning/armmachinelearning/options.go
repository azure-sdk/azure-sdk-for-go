...
// CapacityReservationGroupsClientCapacityReservationGroupsListBySubscriptionOptions contains the optional parameters for
// the CapacityReservationGroupsClient.NewCapacityReservationGroupsListBySubscriptionPager method.
type CapacityReservationGroupsClientCapacityReservationGroupsListBySubscriptionOptions struct {
	// Continuation token for pagination.
	Skip *string
}
