...
type WorkloadNetworksServer struct {
	...
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginDeleteDhcp func(ctx context.Context, resourceGroupName string, privateCloudName string, workloadNetworkName string, dhcpID string, options *armavs.WorkloadNetworksClientBeginDeleteDhcpOptions) (resp azfake.PollerResponder[armavs.WorkloadNetworksClientDeleteDhcpResponse], errResp azfake.ErrorResponder)
	...
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginDeleteSegment func(ctx context.Context, resourceGroupName string, privateCloudName string, workloadNetworkName string, segmentID string, options *armavs.WorkloadNetworksClientBeginDeleteSegmentOptions) (resp azfake.PollerResponder[armavs.WorkloadNetworksClientDeleteSegmentResponse], errResp azfake.ErrorResponder)
	...
	Get func(ctx context.Context, resourceGroupName string, privateCloudName string, workloadNetworkName string, options *armavs.WorkloadNetworksClientGetOptions) (resp azfake.Responder[armavs.WorkloadNetworksClientGetResponse], errResp azfake.ErrorResponder)

	// GetDNSService is the fake for method WorkloadNetworksClient.GetDNSService
	// HTTP status codes to indicate success: http.StatusOK
	GetDNSService func(ctx context.Context, resourceGroupName string, privateCloudName string, workloadNetworkName string, dnsServiceID string, options *armavs.WorkloadNetworksClientGetDNSServiceOptions) (resp azfake.Responder[armavs.WorkloadNetworksClientGetDNSServiceResponse], errResp azfake.ErrorResponder)

	// GetDNSZone is the fake for method WorkloadNetworksClient.GetDNSZone
	// HTTP status codes to indicate success: http.StatusOK
	GetDNSZone func(ctx context.Context, resourceGroupName string, privateCloudName string, workloadNetworkName string, dnsZoneID string, options *armavs.WorkloadNetworksClientGetDNSZoneOptions) (resp azfake.Responder[armavs.WorkloadNetworksClientGetDNSZoneResponse], errResp azfake.ErrorResponder)
	...
	// HTTP status codes to indicate success: http.StatusOK
	GetGateway func(ctx context.Context, resourceGroupName string, privateCloudName string, workloadNetworkName string, gatewayID string, options *armavs.WorkloadNetworksClientGetGatewayOptions) (resp azfake.Responder[armavs.WorkloadNetworksClientGetGatewayResponse], errResp azfake.ErrorResponder)

	// GetPortMirroring is the fake for method WorkloadNetworksClient.GetPortMirroring
	// HTTP status codes to indicate success: http.StatusOK
	GetPortMirroring func(ctx context.Context, resourceGroupName string, privateCloudName string, workloadNetworkName string, portMirroringID string, options *armavs.WorkloadNetworksClientGetPortMirroringOptions) (resp azfake.Responder[armavs.WorkloadNetworksClientGetPortMirroringResponse], errResp azfake.ErrorResponder)

	// GetPublicIP is the fake for method WorkloadNetworksClient.GetPublicIP
	// HTTP status codes to indicate success: http.StatusOK
	GetPublicIP func(ctx context.Context, resourceGroupName string, privateCloudName string, workloadNetworkName string, publicIPID string, options *armavs.WorkloadNetworksClientGetPublicIPOptions) (resp azfake.Responder[armavs.WorkloadNetworksClientGetPublicIPResponse], errResp azfake.ErrorResponder)

	// GetSegment is the fake for method WorkloadNetworksClient.GetSegment
	// HTTP status codes to indicate success: http.StatusOK
	GetSegment func(ctx context.Context, resourceGroupName string, privateCloudName string, workloadNetworkName string, segmentID string, options *armavs.WorkloadNetworksClientGetSegmentOptions) (resp azfake.Responder[armavs.WorkloadNetworksClientGetSegmentResponse], errResp azfake.ErrorResponder)

	// GetVMGroup is the fake for method WorkloadNetworksClient.GetVMGroup
	// HTTP status codes to indicate success: http.StatusOK
	GetVMGroup func(ctx context.Context, resourceGroupName string, privateCloudName string, workloadNetworkName string, vmGroupID string, options *armavs.WorkloadNetworksClientGetVMGroupOptions) (resp azfake.Responder[armavs.WorkloadNetworksClientGetVMGroupResponse], errResp azfake.ErrorResponder)

	// GetVirtualMachine is the fake for method WorkloadNetworksClient.GetVirtualMachine
	// HTTP status codes to indicate success: http.StatusOK
	GetVirtualMachine func(ctx context.Context, resourceGroupName string, privateCloudName string, workloadNetworkName string, virtualMachineID string, options *armavs.WorkloadNetworksClientGetVirtualMachineOptions) (resp azfake.Responder[armavs.WorkloadNetworksClientGetVirtualMachineResponse], errResp azfake.ErrorResponder)
	...
	// HTTP status codes to indicate success: http.StatusOK
	NewListDNSServicePager func(resourceGroupName string, privateCloudName string, workloadNetworkName string, options *armavs.WorkloadNetworksClientListDNSServiceOptions) (resp azfake.PagerResponder[armavs.WorkloadNetworksClientListDNSServiceResponse])

	// NewListDNSZonesPager is the fake for method WorkloadNetworksClient.NewListDNSZonesPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListDNSZonesPager func(resourceGroupName string, privateCloudName string, workloadNetworkName string, options *armavs.WorkloadNetworksClientListDNSZonesOptions) (resp azfake.PagerResponder[armavs.WorkloadNetworksClientListDNSZonesResponse])

	// NewListDhcpPager is the fake for method WorkloadNetworksClient.NewListDhcpPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListDhcpPager func(resourceGroupName string, privateCloudName string, workloadNetworkName string, options *armavs.WorkloadNetworksClientListDhcpOptions) (resp azfake.PagerResponder[armavs.WorkloadNetworksClientListDhcpResponse])

	// NewListGatewaysPager is the fake for method WorkloadNetworksClient.NewListGatewaysPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListGatewaysPager func(resourceGroupName string, privateCloudName string, workloadNetworkName string, options *armavs.WorkloadNetworksClientListGatewaysOptions) (resp azfake.PagerResponder[armavs.WorkloadNetworksClientListGatewaysResponse])

	// NewListPortMirroringPager is the fake for method WorkloadNetworksClient.NewListPortMirroringPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPortMirroringPager func(resourceGroupName string, privateCloudName string, workloadNetworkName string, options *armavs.WorkloadNetworksClientListPortMirroringOptions) (resp azfake.PagerResponder[armavs.WorkloadNetworksClientListPortMirroringResponse])

	// NewListPublicIPsPager is the fake for method WorkloadNetworksClient.NewListPublicIPsPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPublicIPsPager func(resourceGroupName string, privateCloudName string, workloadNetworkName string, options *armavs.WorkloadNetworksClientListPublicIPsOptions) (resp azfake.PagerResponder[armavs.WorkloadNetworksClientListPublicIPsResponse])

	// NewListSegmentsPager is the fake for method WorkloadNetworksClient.NewListSegmentsPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListSegmentsPager func(resourceGroupName string, privateCloudName string, workloadNetworkName string, options *armavs.WorkloadNetworksClientListSegmentsOptions) (resp azfake.PagerResponder[armavs.WorkloadNetworksClientListSegmentsResponse])

	// NewListVMGroupsPager is the fake for method WorkloadNetworksClient.NewListVMGroupsPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListVMGroupsPager func(resourceGroupName string, privateCloudName string, workloadNetworkName string, options *armavs.WorkloadNetworksClientListVMGroupsOptions) (resp azfake.PagerResponder[armavs.WorkloadNetworksClientListVMGroupsResponse])

	// NewListVirtualMachinesPager is the fake for method WorkloadNetworksClient.NewListVirtualMachinesPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListVirtualMachinesPager func(resourceGroupName string, privateCloudName string, workloadNetworkName string, options *armavs.WorkloadNetworksClientListVirtualMachinesOptions) (resp azfake.PagerResponder[armavs.WorkloadNetworksClientListVirtualMachinesResponse])
...
func (w *WorkloadNetworksServerTransport) dispatchBeginCreateDNSService(req *http.Request) (*http.Response, error) {
	...
	if beginCreateDNSService == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.AVS/privateClouds/(?P<privateCloudName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/workloadNetworks/(?P<workloadNetworkName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/dnsServices/(?P<dnsServiceId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)`
		...
		workloadNetworkNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("workloadNetworkName")])
		if err != nil {
			return nil, err
		}
		...
		respr, errRespr := w.srv.BeginCreateDNSService(req.Context(), resourceGroupNameParam, privateCloudNameParam, workloadNetworkNameParam, dnsServiceIDParam, body, nil)
...
func (w *WorkloadNetworksServerTransport) dispatchBeginCreateDNSZone(req *http.Request) (*http.Response, error) {
	...
	if beginCreateDNSZone == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.AVS/privateClouds/(?P<privateCloudName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/workloadNetworks/(?P<workloadNetworkName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/dnsZones/(?P<dnsZoneId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 6 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
		...
		respr, errRespr := w.srv.BeginCreateDNSZone(req.Context(), resourceGroupNameParam, privateCloudNameParam, workloadNetworkNameParam, dnsZoneIDParam, body, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
...
func (w *WorkloadNetworksServerTransport) dispatchBeginCreateDhcp(req *http.Request) (*http.Response, error) {
	...
	if beginCreateDhcp == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.AVS/privateClouds/(?P<privateCloudName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/workloadNetworks/(?P<workloadNetworkName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/dhcpConfigurations/(?P<dhcpId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 6 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
		...
		respr, errRespr := w.srv.BeginCreateDhcp(req.Context(), resourceGroupNameParam, privateCloudNameParam, workloadNetworkNameParam, dhcpIDParam, body, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
...
func (w *WorkloadNetworksServerTransport) dispatchBeginCreatePortMirroring(req *http.Request) (*http.Response, error) {
	...
	if beginCreatePortMirroring == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.AVS/privateClouds/(?P<privateCloudName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/workloadNetworks/(?P<workloadNetworkName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/portMirroringProfiles/(?P<portMirroringId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 6 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
		...
		respr, errRespr := w.srv.BeginCreatePortMirroring(req.Context(), resourceGroupNameParam, privateCloudNameParam, workloadNetworkNameParam, portMirroringIDParam, body, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
...
func (w *WorkloadNetworksServerTransport) dispatchBeginCreatePublicIP(req *http.Request) (*http.Response, error) {
	...
	if beginCreatePublicIP == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.AVS/privateClouds/(?P<privateCloudName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/workloadNetworks/(?P<workloadNetworkName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/publicIPs/(?P<publicIPId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 6 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
		...
		respr, errRespr := w.srv.BeginCreatePublicIP(req.Context(), resourceGroupNameParam, privateCloudNameParam, workloadNetworkNameParam, publicIPIDParam, body, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
...
func (w *WorkloadNetworksServerTransport) dispatchBeginCreateSegment(req *http.Request) (*http.Response, error) {
	...
	if beginCreateSegment == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.AVS/privateClouds/(?P<privateCloudName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/workloadNetworks/(?P<workloadNetworkName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/segments/(?P<segmentId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 6 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
		...
		respr, errRespr := w.srv.BeginCreateSegment(req.Context(), resourceGroupNameParam, privateCloudNameParam, workloadNetworkNameParam, segmentIDParam, body, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
...
func (w *WorkloadNetworksServerTransport) dispatchBeginCreateVMGroup(req *http.Request) (*http.Response, error) {
	...
	if beginCreateVMGroup == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.AVS/privateClouds/(?P<privateCloudName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/workloadNetworks/(?P<workloadNetworkName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/vmGroups/(?P<vmGroupId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 6 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
		...
		respr, errRespr := w.srv.BeginCreateVMGroup(req.Context(), resourceGroupNameParam, privateCloudNameParam, workloadNetworkNameParam, vmGroupIDParam, body, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
...
func (w *WorkloadNetworksServerTransport) dispatchBeginDeleteDhcp(req *http.Request) (*http.Response, error) {
	...
	if beginDeleteDhcp == nil {
		...
		respr, errRespr := w.srv.BeginDeleteDhcp(req.Context(), resourceGroupNameParam, privateCloudNameParam, workloadNetworkNameParam, dhcpIDParam, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
...
func (w *WorkloadNetworksServerTransport) dispatchBeginDeleteSegment(req *http.Request) (*http.Response, error) {
	...
	if beginDeleteSegment == nil {
		...
		respr, errRespr := w.srv.BeginDeleteSegment(req.Context(), resourceGroupNameParam, privateCloudNameParam, workloadNetworkNameParam, segmentIDParam, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
...
func (w *WorkloadNetworksServerTransport) dispatchGetDNSService(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := w.srv.GetDNSService(req.Context(), resourceGroupNameParam, privateCloudNameParam, workloadNetworkNameParam, dnsServiceIDParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (w *WorkloadNetworksServerTransport) dispatchGetDNSZone(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := w.srv.GetDNSZone(req.Context(), resourceGroupNameParam, privateCloudNameParam, workloadNetworkNameParam, dnsZoneIDParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (w *WorkloadNetworksServerTransport) dispatchGetGateway(req *http.Request) (*http.Response, error) {
	...
	const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.AVS/privateClouds/(?P<privateCloudName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/workloadNetworks/(?P<workloadNetworkName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/gateways/(?P<gatewayId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)`
	regex := regexp.MustCompile(regexStr)
	matches := regex.FindStringSubmatch(req.URL.EscapedPath())
	if len(matches) < 6 {
		return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
	...
	respr, errRespr := w.srv.GetGateway(req.Context(), resourceGroupNameParam, privateCloudNameParam, workloadNetworkNameParam, gatewayIDParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (w *WorkloadNetworksServerTransport) dispatchGetPortMirroring(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := w.srv.GetPortMirroring(req.Context(), resourceGroupNameParam, privateCloudNameParam, workloadNetworkNameParam, portMirroringIDParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (w *WorkloadNetworksServerTransport) dispatchGetPublicIP(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := w.srv.GetPublicIP(req.Context(), resourceGroupNameParam, privateCloudNameParam, workloadNetworkNameParam, publicIPIDParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (w *WorkloadNetworksServerTransport) dispatchGetSegment(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := w.srv.GetSegment(req.Context(), resourceGroupNameParam, privateCloudNameParam, workloadNetworkNameParam, segmentIDParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (w *WorkloadNetworksServerTransport) dispatchGetVMGroup(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := w.srv.GetVMGroup(req.Context(), resourceGroupNameParam, privateCloudNameParam, workloadNetworkNameParam, vmGroupIDParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (w *WorkloadNetworksServerTransport) dispatchGetVirtualMachine(req *http.Request) (*http.Response, error) {
	...
	const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.AVS/privateClouds/(?P<privateCloudName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/workloadNetworks/(?P<workloadNetworkName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/virtualMachines/(?P<virtualMachineId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)`
	regex := regexp.MustCompile(regexStr)
	matches := regex.FindStringSubmatch(req.URL.EscapedPath())
	if len(matches) < 6 {
		return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
	...
	respr, errRespr := w.srv.GetVirtualMachine(req.Context(), resourceGroupNameParam, privateCloudNameParam, workloadNetworkNameParam, virtualMachineIDParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (w *WorkloadNetworksServerTransport) dispatchNewListDNSServicePager(req *http.Request) (*http.Response, error) {
	...
	if newListDNSServicePager == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.AVS/privateClouds/(?P<privateCloudName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/workloadNetworks/(?P<workloadNetworkName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/dnsServices`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 5 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
		...
		resp := w.srv.NewListDNSServicePager(resourceGroupNameParam, privateCloudNameParam, workloadNetworkNameParam, nil)
...
func (w *WorkloadNetworksServerTransport) dispatchNewListDNSZonesPager(req *http.Request) (*http.Response, error) {
	...
	if newListDNSZonesPager == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.AVS/privateClouds/(?P<privateCloudName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/workloadNetworks/(?P<workloadNetworkName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/dnsZones`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 5 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
		...
		resp := w.srv.NewListDNSZonesPager(resourceGroupNameParam, privateCloudNameParam, workloadNetworkNameParam, nil)
...
func (w *WorkloadNetworksServerTransport) dispatchNewListDhcpPager(req *http.Request) (*http.Response, error) {
	...
	if newListDhcpPager == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.AVS/privateClouds/(?P<privateCloudName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/workloadNetworks/(?P<workloadNetworkName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/dhcpConfigurations`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 5 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
		...
		resp := w.srv.NewListDhcpPager(resourceGroupNameParam, privateCloudNameParam, workloadNetworkNameParam, nil)
...
func (w *WorkloadNetworksServerTransport) dispatchNewListGatewaysPager(req *http.Request) (*http.Response, error) {
	...
	if newListGatewaysPager == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.AVS/privateClouds/(?P<privateCloudName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/workloadNetworks/(?P<workloadNetworkName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/gateways`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 5 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
		...
		resp := w.srv.NewListGatewaysPager(resourceGroupNameParam, privateCloudNameParam, workloadNetworkNameParam, nil)
...
func (w *WorkloadNetworksServerTransport) dispatchNewListPortMirroringPager(req *http.Request) (*http.Response, error) {
	...
	if newListPortMirroringPager == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.AVS/privateClouds/(?P<privateCloudName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/workloadNetworks/(?P<workloadNetworkName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/portMirroringProfiles`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 5 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
		...
		resp := w.srv.NewListPortMirroringPager(resourceGroupNameParam, privateCloudNameParam, workloadNetworkNameParam, nil)
...
func (w *WorkloadNetworksServerTransport) dispatchNewListPublicIPsPager(req *http.Request) (*http.Response, error) {
	...
	if newListPublicIPsPager == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.AVS/privateClouds/(?P<privateCloudName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/workloadNetworks/(?P<workloadNetworkName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/publicIPs`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 5 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
		...
		resp := w.srv.NewListPublicIPsPager(resourceGroupNameParam, privateCloudNameParam, workloadNetworkNameParam, nil)
...
func (w *WorkloadNetworksServerTransport) dispatchNewListSegmentsPager(req *http.Request) (*http.Response, error) {
	...
	if newListSegmentsPager == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.AVS/privateClouds/(?P<privateCloudName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/workloadNetworks/(?P<workloadNetworkName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/segments`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 5 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
		...
		resp := w.srv.NewListSegmentsPager(resourceGroupNameParam, privateCloudNameParam, workloadNetworkNameParam, nil)
...
func (w *WorkloadNetworksServerTransport) dispatchNewListVMGroupsPager(req *http.Request) (*http.Response, error) {
	...
	if newListVMGroupsPager == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.AVS/privateClouds/(?P<privateCloudName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/workloadNetworks/(?P<workloadNetworkName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/vmGroups`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 5 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
		...
		resp := w.srv.NewListVMGroupsPager(resourceGroupNameParam, privateCloudNameParam, workloadNetworkNameParam, nil)
...
func (w *WorkloadNetworksServerTransport) dispatchNewListVirtualMachinesPager(req *http.Request) (*http.Response, error) {
	...
	if newListVirtualMachinesPager == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.AVS/privateClouds/(?P<privateCloudName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/workloadNetworks/(?P<workloadNetworkName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/virtualMachines`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 5 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
		...
		resp := w.srv.NewListVirtualMachinesPager(resourceGroupNameParam, privateCloudNameParam, workloadNetworkNameParam, nil)
...
func (w *WorkloadNetworksServerTransport) dispatchBeginUpdateDNSService(req *http.Request) (*http.Response, error) {
	...
	if beginUpdateDNSService == nil {
		...
		respr, errRespr := w.srv.BeginUpdateDNSService(req.Context(), resourceGroupNameParam, privateCloudNameParam, workloadNetworkNameParam, dnsServiceIDParam, body, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
...
func (w *WorkloadNetworksServerTransport) dispatchBeginUpdateDNSZone(req *http.Request) (*http.Response, error) {
	...
	if beginUpdateDNSZone == nil {
		...
		respr, errRespr := w.srv.BeginUpdateDNSZone(req.Context(), resourceGroupNameParam, privateCloudNameParam, workloadNetworkNameParam, dnsZoneIDParam, body, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
...
func (w *WorkloadNetworksServerTransport) dispatchBeginUpdateDhcp(req *http.Request) (*http.Response, error) {
	...
	if beginUpdateDhcp == nil {
		...
		respr, errRespr := w.srv.BeginUpdateDhcp(req.Context(), resourceGroupNameParam, privateCloudNameParam, workloadNetworkNameParam, dhcpIDParam, body, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
...
func (w *WorkloadNetworksServerTransport) dispatchBeginUpdatePortMirroring(req *http.Request) (*http.Response, error) {
	...
	if beginUpdatePortMirroring == nil {
		...
		respr, errRespr := w.srv.BeginUpdatePortMirroring(req.Context(), resourceGroupNameParam, privateCloudNameParam, workloadNetworkNameParam, portMirroringIDParam, body, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
...
func (w *WorkloadNetworksServerTransport) dispatchBeginUpdateSegment(req *http.Request) (*http.Response, error) {
	...
	if beginUpdateSegment == nil {
		...
		respr, errRespr := w.srv.BeginUpdateSegment(req.Context(), resourceGroupNameParam, privateCloudNameParam, workloadNetworkNameParam, segmentIDParam, body, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
...
func (w *WorkloadNetworksServerTransport) dispatchBeginUpdateVMGroup(req *http.Request) (*http.Response, error) {
	...
	if beginUpdateVMGroup == nil {
		...
		respr, errRespr := w.srv.BeginUpdateVMGroup(req.Context(), resourceGroupNameParam, privateCloudNameParam, workloadNetworkNameParam, vmGroupIDParam, body, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
