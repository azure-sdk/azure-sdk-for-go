...
func (client *StandardsClient) createOrUpdateCreateRequest(ctx context.Context, scope string, standardID string, standard Standard, _ *StandardsClientCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *StandardsClient) Delete(ctx context.Context, scope string, standardID string, options *StandardsClientDeleteOptions) (StandardsClientDeleteResponse, error) {
	var err error
...
func (client *StandardsClient) deleteCreateRequest(ctx context.Context, scope string, standardID string, _ *StandardsClientDeleteOptions) (*policy.Request, error) {
	urlPath := "/{scope}/providers/Microsoft.Security/securityStandards/{standardId}"
	if scope == "" {
		return nil, errors.New("parameter scope cannot be empty")
	}
...
func (client *StandardsClient) getCreateRequest(ctx context.Context, scope string, standardID string, _ *StandardsClientGetOptions) (*policy.Request, error) {
	urlPath := "/{scope}/providers/Microsoft.Security/securityStandards/{standardId}"
	if scope == "" {
		return nil, errors.New("parameter scope cannot be empty")
	}
...
func (client *StandardsClient) listCreateRequest(ctx context.Context, scope string, _ *StandardsClientListOptions) (*policy.Request, error) {
