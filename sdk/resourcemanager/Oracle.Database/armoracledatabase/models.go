...
type CloudExadataInfrastructureProperties struct {
	...
	ProvisioningState *CloudExadataInfrastructureProvisioningState
...
type CloudVMClusterProperties struct {
	...
	ProvisioningState *CloudVMClusterProvisioningState
...
type DNSPrivateViewProperties struct {
	...
	ProvisioningState *DNSPrivateViewsProvisioningState
}
...
type DNSPrivateZoneProperties struct {
	...
	ProvisioningState *DNSPrivateZonesProvisioningState
...
type DbNodeProperties struct {
	...
	ProvisioningState *DbNodeProvisioningState
...
type DbServerProperties struct {
	...
	ProvisioningState *DbServerProvisioningState
...
type PrivateIPAddressesFilter struct {
	// REQUIRED; The OCID [/Content/General/Concepts/identifiers.htm] of the resource.
	SubnetID *string
...
type VirtualNetworkAddressProperties struct {
	...
	// READ-ONLY; virtual network address provisioning state.
	ProvisioningState *VirtualNetworkAddressProvisioningState
