...
func (f FleetspaceAccountProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "accountLocation", f.AccountLocation)
	populate(objectMap, "accountResourceIdentifier", f.AccountResourceIdentifier)
	populate(objectMap, "provisioningState", f.ProvisioningState)
	return json.Marshal(objectMap)
}
...
func (f *FleetspaceAccountProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "accountLocation":
			err = unpopulate(val, "AccountLocation", &f.AccountLocation)
			delete(rawMsg, key)
		case "accountResourceIdentifier":
			err = unpopulate(val, "AccountResourceIdentifier", &f.AccountResourceIdentifier)
			delete(rawMsg, key)
		case "provisioningState":
			err = unpopulate(val, "ProvisioningState", &f.ProvisioningState)
			delete(rawMsg, key)
...
// MarshalJSON implements the json.Marshaller interface for type PermissionAutoGenerated2.
func (p PermissionAutoGenerated2) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "dataActions", p.DataActions)
	populate(objectMap, "id", p.ID)
	populate(objectMap, "notDataActions", p.NotDataActions)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type PermissionAutoGenerated2.
func (p *PermissionAutoGenerated2) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", p, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type PermissionAutoGenerated3.
func (p PermissionAutoGenerated3) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "dataActions", p.DataActions)
	populate(objectMap, "id", p.ID)
	populate(objectMap, "notDataActions", p.NotDataActions)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type PermissionAutoGenerated3.
func (p *PermissionAutoGenerated3) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", p, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type PermissionAutoGenerated4.
func (p PermissionAutoGenerated4) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "dataActions", p.DataActions)
	populate(objectMap, "id", p.ID)
	populate(objectMap, "notDataActions", p.NotDataActions)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type PermissionAutoGenerated4.
func (p *PermissionAutoGenerated4) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", p, err)
	}
