...
func (client *PTUQuotaClient) getAvailableCreateRequest(ctx context.Context, location string, options *PTUQuotaClientGetAvailableOptions) (*policy.Request, error) {
