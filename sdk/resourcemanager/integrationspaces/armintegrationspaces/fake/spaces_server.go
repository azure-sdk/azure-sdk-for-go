...
func (s *SpacesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if spacesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = spacesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to SpacesServerTransport
var spacesServerTransportInterceptor interface {
