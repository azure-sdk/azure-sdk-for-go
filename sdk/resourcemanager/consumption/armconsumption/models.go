...
type EventProperties struct {
	...
	// READ-ONLY; The amount of charges for events of type SettleCharges and PendingEligibleCharges in Lot Currency.
	Charges *Amount
	...
	// READ-ONLY; The balance after the event, Note: This will not be returned for Contributor Organization Type in Multi-Entity
	// consumption commitment
	ClosedBalanceInLotCurrency *Amount
