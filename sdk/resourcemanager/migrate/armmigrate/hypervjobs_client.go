...
func NewHyperVJobsClient(credential azcore.TokenCredential, options *arm.ClientOptions) (*HyperVJobsClient, error) {
	if options == nil {
...
//     method.
func (client *HyperVJobsClient) NewGetAllJobsInSitePager(subscriptionID string, resourceGroupName string, siteName string, options *HyperVJobsClientGetAllJobsInSiteOptions) *runtime.Pager[HyperVJobsClientGetAllJobsInSiteResponse] {
...
func (client *HyperVJobsClient) getAllJobsInSiteCreateRequest(ctx context.Context, subscriptionID string, resourceGroupName string, siteName string, options *HyperVJobsClientGetAllJobsInSiteOptions) (*policy.Request, error) {
...
func (client *HyperVJobsClient) GetJob(ctx context.Context, subscriptionID string, resourceGroupName string, siteName string, jobName string, options *HyperVJobsClientGetJobOptions) (HyperVJobsClientGetJobResponse, error) {
...
func (client *HyperVJobsClient) getJobCreateRequest(ctx context.Context, subscriptionID string, resourceGroupName string, siteName string, jobName string, options *HyperVJobsClientGetJobOptions) (*policy.Request, error) {
