...
// NewAPIWikiServerTransport creates a new instance of APIWikiServerTransport with the provided implementation.
// The returned APIWikiServerTransport instance is connected to an instance of armapimanagement.APIWikiClient via the
// azcore.ClientOptions.Transporter field in the client's constructor parameters.
func NewAPIWikiServerTransport(srv *APIWikiServer) *APIWikiServerTransport {
	return &APIWikiServerTransport{srv: srv}
}

// APIWikiServerTransport connects instances of armapimanagement.APIWikiClient to instances of APIWikiServer.
// Don't use this type directly, use NewAPIWikiServerTransport instead.
type APIWikiServerTransport struct {
	srv *APIWikiServer
}

// Do implements the policy.Transporter interface for APIWikiServerTransport.
func (a *APIWikiServerTransport) Do(req *http.Request) (*http.Response, error) {
	...
	switch method {
	case "APIWikiClient.CreateOrUpdate":
		resp, err = a.dispatchCreateOrUpdate(req)
	case "APIWikiClient.Delete":
		resp, err = a.dispatchDelete(req)
	case "APIWikiClient.Get":
		resp, err = a.dispatchGet(req)
	case "APIWikiClient.GetEntityTag":
		resp, err = a.dispatchGetEntityTag(req)
	case "APIWikiClient.Update":
...
func (a *APIWikiServerTransport) dispatchCreateOrUpdate(req *http.Request) (*http.Response, error) {
	if a.srv.CreateOrUpdate == nil {
		return nil, &nonRetriableError{errors.New("fake for method CreateOrUpdate not implemented")}
	}
	const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.ApiManagement/service/(?P<serviceName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/apis/(?P<apiId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/wikis/default`
	...
	var options *armapimanagement.APIWikiClientCreateOrUpdateOptions
	if ifMatchParam != nil {
		options = &armapimanagement.APIWikiClientCreateOrUpdateOptions{
			IfMatch: ifMatchParam,
		}
	}
	respr, errRespr := a.srv.CreateOrUpdate(req.Context(), resourceGroupNameParam, serviceNameParam, apiIDParam, body, options)
...
func (a *APIWikiServerTransport) dispatchDelete(req *http.Request) (*http.Response, error) {
	if a.srv.Delete == nil {
	...
	respr, errRespr := a.srv.Delete(req.Context(), resourceGroupNameParam, serviceNameParam, apiIDParam, getHeaderValue(req.Header, "If-Match"), nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (a *APIWikiServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	if a.srv.Get == nil {
...
func (a *APIWikiServerTransport) dispatchGetEntityTag(req *http.Request) (*http.Response, error) {
...
func (a *APIWikiServerTransport) dispatchUpdate(req *http.Request) (*http.Response, error) {
	if a.srv.Update == nil {
