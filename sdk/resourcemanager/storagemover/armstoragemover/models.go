...
type JobRunProperties struct {
	...
	JobDefinitionProperties interface{} `json:"jobDefinitionProperties,omitempty" azure:"ro"`
	...
	SourceProperties interface{} `json:"sourceProperties,omitempty" azure:"ro"`
	...
	TargetProperties interface{} `json:"targetProperties,omitempty" azure:"ro"`
