...
// ApplicationGatewaysClientCommitMigrationResponse contains the response from method ApplicationGatewaysClient.BeginCommitMigration.
type ApplicationGatewaysClientCommitMigrationResponse struct {
	// placeholder for future response values
}
...
// ApplicationGatewaysClientExecuteMigrationResponse contains the response from method ApplicationGatewaysClient.BeginExecuteMigration.
type ApplicationGatewaysClientExecuteMigrationResponse struct {
	// placeholder for future response values
}
...
// ApplicationGatewaysClientPrepareMigrationResponse contains the response from method ApplicationGatewaysClient.BeginPrepareMigration.
type ApplicationGatewaysClientPrepareMigrationResponse struct {
	// placeholder for future response values
}
