...
// LedgerRunningState - Object representing LedgerRunningState for Confidential Ledger.
type LedgerRunningState string

const (
	LedgerRunningStateActive   LedgerRunningState = "Active"
	LedgerRunningStatePaused   LedgerRunningState = "Paused"
	LedgerRunningStatePausing  LedgerRunningState = "Pausing"
	LedgerRunningStateResuming LedgerRunningState = "Resuming"
	LedgerRunningStateUnknown  LedgerRunningState = "Unknown"
)

// PossibleLedgerRunningStateValues returns the possible values for the LedgerRunningState const type.
func PossibleLedgerRunningStateValues() []LedgerRunningState {
	return []LedgerRunningState{
		LedgerRunningStateActive,
		LedgerRunningStatePaused,
		LedgerRunningStatePausing,
		LedgerRunningStateResuming,
		LedgerRunningStateUnknown,
	}
}
