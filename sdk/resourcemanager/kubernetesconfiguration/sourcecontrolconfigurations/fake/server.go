...
import (
	...
	"github.com/Azure/azure-sdk-for-go/sdk/resourcemanager/kubernetesconfiguration/sourcecontrolconfigurations"
	"net/http"
	"net/url"
	"regexp"
)

// Server is a fake server for instances of the sourcecontrolconfigurations.Client type.
type Server struct {
	// CreateOrUpdate is the fake for method Client.CreateOrUpdate
	// HTTP status codes to indicate success: http.StatusOK, http.StatusCreated
	CreateOrUpdate func(ctx context.Context, resourceGroupName string, clusterRp string, clusterResourceName string, clusterName string, sourceControlConfigurationName string, sourceControlConfiguration sourcecontrolconfigurations.SourceControlConfiguration, options *sourcecontrolconfigurations.ClientCreateOrUpdateOptions) (resp azfake.Responder[sourcecontrolconfigurations.ClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)

	// BeginDelete is the fake for method Client.BeginDelete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	BeginDelete func(ctx context.Context, resourceGroupName string, clusterRp string, clusterResourceName string, clusterName string, sourceControlConfigurationName string, options *sourcecontrolconfigurations.ClientBeginDeleteOptions) (resp azfake.PollerResponder[sourcecontrolconfigurations.ClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method Client.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, clusterRp string, clusterResourceName string, clusterName string, sourceControlConfigurationName string, options *sourcecontrolconfigurations.ClientGetOptions) (resp azfake.Responder[sourcecontrolconfigurations.ClientGetResponse], errResp azfake.ErrorResponder)

	// NewListPager is the fake for method Client.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(resourceGroupName string, clusterRp string, clusterResourceName string, clusterName string, options *sourcecontrolconfigurations.ClientListOptions) (resp azfake.PagerResponder[sourcecontrolconfigurations.ClientListResponse])
}

// NewServerTransport creates a new instance of ServerTransport with the provided implementation.
// The returned ServerTransport instance is connected to an instance of sourcecontrolconfigurations.Client via the
// azcore.ClientOptions.Transporter field in the client's constructor parameters.
func NewServerTransport(srv *Server) *ServerTransport {
	return &ServerTransport{
		srv:          srv,
		beginDelete:  newTracker[azfake.PollerResponder[sourcecontrolconfigurations.ClientDeleteResponse]](),
		newListPager: newTracker[azfake.PagerResponder[sourcecontrolconfigurations.ClientListResponse]](),
	}
}

// ServerTransport connects instances of sourcecontrolconfigurations.Client to instances of Server.
// Don't use this type directly, use NewServerTransport instead.
type ServerTransport struct {
	srv          *Server
	beginDelete  *tracker[azfake.PollerResponder[sourcecontrolconfigurations.ClientDeleteResponse]]
	newListPager *tracker[azfake.PagerResponder[sourcecontrolconfigurations.ClientListResponse]]
}
...
func (s *ServerTransport) dispatchCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[sourcecontrolconfigurations.SourceControlConfiguration](req)
	if err != nil {
		return nil, err
	}
...
func (s *ServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *sourcecontrolconfigurations.ClientListResponse, createLink func() string) {
