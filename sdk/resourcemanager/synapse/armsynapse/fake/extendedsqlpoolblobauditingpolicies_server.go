...
func (e *ExtendedSQLPoolBlobAuditingPoliciesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if extendedSqlPoolBlobAuditingPoliciesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = extendedSqlPoolBlobAuditingPoliciesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "ExtendedSQLPoolBlobAuditingPoliciesClient.NewListBySQLPoolPager":
				res.resp, res.err = e.dispatchNewListBySQLPoolPager(req)
			default:
...
// set this to conditionally intercept incoming requests to ExtendedSQLPoolBlobAuditingPoliciesServerTransport
var extendedSqlPoolBlobAuditingPoliciesServerTransportInterceptor interface {
