...
//     method.
func (client *AnalyzerConfigsClient) CreateOrUpdate(ctx context.Context, resourceGroupName string, analyzerConfigName string, resource AnalyzerConfig, options *AnalyzerConfigsClientCreateOrUpdateOptions) (AnalyzerConfigsClientCreateOrUpdateResponse, error) {
	var err error
	const operationName = "AnalyzerConfigsClient.CreateOrUpdate"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.createOrUpdateCreateRequest(ctx, resourceGroupName, analyzerConfigName, resource, options)
	if err != nil {
...
func (client *AnalyzerConfigsClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, analyzerConfigName string, resource AnalyzerConfig, options *AnalyzerConfigsClientCreateOrUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiCenter/analyzerConfigs/{analyzerConfigName}"
...
func (client *AnalyzerConfigsClient) Delete(ctx context.Context, resourceGroupName string, analyzerConfigName string, options *AnalyzerConfigsClientDeleteOptions) (AnalyzerConfigsClientDeleteResponse, error) {
	var err error
	const operationName = "AnalyzerConfigsClient.Delete"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.deleteCreateRequest(ctx, resourceGroupName, analyzerConfigName, options)
	if err != nil {
...
func (client *AnalyzerConfigsClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, analyzerConfigName string, options *AnalyzerConfigsClientDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiCenter/analyzerConfigs/{analyzerConfigName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
//     method.
func (client *AnalyzerConfigsClient) BeginExportRuleset(ctx context.Context, resourceGroupName string, analyzerConfigName string, options *AnalyzerConfigsClientBeginExportRulesetOptions) (*runtime.Poller[AnalyzerConfigsClientExportRulesetResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.exportRuleset(ctx, resourceGroupName, analyzerConfigName, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2024-12-15-preview
func (client *AnalyzerConfigsClient) exportRuleset(ctx context.Context, resourceGroupName string, analyzerConfigName string, options *AnalyzerConfigsClientBeginExportRulesetOptions) (*http.Response, error) {
	var err error
	const operationName = "AnalyzerConfigsClient.BeginExportRuleset"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.exportRulesetCreateRequest(ctx, resourceGroupName, analyzerConfigName, options)
	if err != nil {
		return nil, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
...
func (client *AnalyzerConfigsClient) exportRulesetCreateRequest(ctx context.Context, resourceGroupName string, analyzerConfigName string, options *AnalyzerConfigsClientBeginExportRulesetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiCenter/analyzerConfigs/{analyzerConfigName}/exportRuleset"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{subscriptionId}", url.PathEscape(client.subscriptionID))
...
func (client *AnalyzerConfigsClient) Get(ctx context.Context, resourceGroupName string, analyzerConfigName string, options *AnalyzerConfigsClientGetOptions) (AnalyzerConfigsClientGetResponse, error) {
	var err error
	const operationName = "AnalyzerConfigsClient.Get"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.getCreateRequest(ctx, resourceGroupName, analyzerConfigName, options)
	if err != nil {
...
func (client *AnalyzerConfigsClient) getCreateRequest(ctx context.Context, resourceGroupName string, analyzerConfigName string, options *AnalyzerConfigsClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiCenter/analyzerConfigs/{analyzerConfigName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
//     method.
func (client *AnalyzerConfigsClient) BeginImportRuleset(ctx context.Context, resourceGroupName string, analyzerConfigName string, body RulesetImportRequest, options *AnalyzerConfigsClientBeginImportRulesetOptions) (*runtime.Poller[AnalyzerConfigsClientImportRulesetResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.importRuleset(ctx, resourceGroupName, analyzerConfigName, body, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2024-12-15-preview
func (client *AnalyzerConfigsClient) importRuleset(ctx context.Context, resourceGroupName string, analyzerConfigName string, body RulesetImportRequest, options *AnalyzerConfigsClientBeginImportRulesetOptions) (*http.Response, error) {
	var err error
	const operationName = "AnalyzerConfigsClient.BeginImportRuleset"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.importRulesetCreateRequest(ctx, resourceGroupName, analyzerConfigName, body, options)
	if err != nil {
		return nil, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
...
func (client *AnalyzerConfigsClient) importRulesetCreateRequest(ctx context.Context, resourceGroupName string, analyzerConfigName string, body RulesetImportRequest, options *AnalyzerConfigsClientBeginImportRulesetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiCenter/analyzerConfigs/{analyzerConfigName}/importRuleset"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{subscriptionId}", url.PathEscape(client.subscriptionID))
...
//     method.
func (client *AnalyzerConfigsClient) NewListPager(resourceGroupName string, options *AnalyzerConfigsClientListOptions) *runtime.Pager[AnalyzerConfigsClientListResponse] {
...
func (client *AnalyzerConfigsClient) listCreateRequest(ctx context.Context, resourceGroupName string, options *AnalyzerConfigsClientListOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiCenter/analyzerConfigs"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{subscriptionId}", url.PathEscape(client.subscriptionID))
