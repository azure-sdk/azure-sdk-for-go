...
- New value `DataConnectorKindGCP`, `DataConnectorKindMicrosoftPurviewInformationProtection`, `DataConnectorKindPurviewAudit`, `DataConnectorKindRestAPIPoller` added to enum type `DataConnectorKind`
...
- New value `KindNotebook`, `KindResourcesDataConnector`, `KindStandalone`, `KindSummaryRule` added to enum type `Kind`
