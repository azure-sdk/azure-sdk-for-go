...
type RevisionProperties struct {
	...
	// READ-ONLY; Traffic labels associated with this revision
	TrafficLabels []*TrafficLabel `json:"trafficLabels,omitempty" azure:"ro"`
...
// TrafficLabel - Traffic label information
type TrafficLabel struct {
	// READ-ONLY; Fully qualified domain name of a labelled revision
	Fqdn *string `json:"fqdn,omitempty" azure:"ro"`

	// READ-ONLY; Traffic label assigned to a revision
