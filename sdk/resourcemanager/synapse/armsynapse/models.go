...
// GetClientStop8A2431BC39114B709A447C12F99E3BB4Options contains the optional parameters for the GetClient.Stop8A2431BC39114B709A447C12F99E3BB4
// method.
type GetClientStop8A2431BC39114B709A447C12F99E3BB4Options struct {
	// placeholder for future optional parameters
}
...
// IntergrationruntimesOperationStatus - Workspace Stop Integrationruntimes 8A2431BC39114B709A447C12F99E3BB4.
type IntergrationruntimesOperationStatus struct {
	// Workspace Stop Integrationruntimes 8A2431BC39114B709A447C12F99E3BB4.Properties.
	Properties *IntergrationruntimesOperationStatusProperties `json:"properties,omitempty"`
...
// IntergrationruntimesOperationStatusProperties - Properties of the Integrationruntimes Stop 8A2431BC39114B709A447C12F99E3BB4.
type IntergrationruntimesOperationStatusProperties struct {
	// READ-ONLY; error value for 8A2431BC39114B709A447C12F99E3BB4
	Error *string `json:"error,omitempty" azure:"ro"`

	// READ-ONLY; Name of Operation Statuses.
	Name *string `json:"name,omitempty" azure:"ro"`

	// READ-ONLY; properties value for 8A2431BC39114B709A447C12F99E3BB4
	Properties *string `json:"properties,omitempty" azure:"ro"`

	// READ-ONLY; status of stop Integrationruntimes.
	Status *WorkspaceStatus `json:"status,omitempty" azure:"ro"`
}
