...
// ManagedNetworkSettingsDto - Managed Network settings for a machine learning workspace.
type ManagedNetworkSettingsDto struct {
...
type ManagedNetworkSettingsDtoBasicResource struct {
	// REQUIRED; Managed Network settings for a machine learning workspace.
...
// OutboundRuleDto - Public facing contract for the outbound rules of a machine learning workspace.
type OutboundRuleDto struct {
	// REQUIRED; Type of a managed network Outbound Rule of a machine learning workspace.
	Type *RuleType
...
// GetOutboundRuleDto implements the OutboundRuleDtoClassification interface for type OutboundRuleDto.
func (o *OutboundRuleDto) GetOutboundRuleDto() *OutboundRuleDto { return o }
