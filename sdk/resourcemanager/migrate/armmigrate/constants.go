...
// ArcScopeType - Arc scope type.
type ArcScopeType string

const (
	// ArcScopeTypeSubscriptionOrResourceGroupIDs - Scope is based on Subscription or Resource Group IDs.
	ArcScopeTypeSubscriptionOrResourceGroupIDs ArcScopeType = "SubscriptionOrResourceGroupIds"
)

// PossibleArcScopeTypeValues returns the possible values for the ArcScopeType const type.
func PossibleArcScopeTypeValues() []ArcScopeType {
	return []ArcScopeType{
		ArcScopeTypeSubscriptionOrResourceGroupIDs,
	}
}
...
// ImportSQLInventoryJobResult - Import SQL inventory job result.
type ImportSQLInventoryJobResult string

const (
	// ImportSQLInventoryJobResultCompleted - Completed value.
	ImportSQLInventoryJobResultCompleted ImportSQLInventoryJobResult = "Completed"
	// ImportSQLInventoryJobResultCompletedWithErrors - CompletedWithErrors value.
	ImportSQLInventoryJobResultCompletedWithErrors ImportSQLInventoryJobResult = "CompletedWithErrors"
	// ImportSQLInventoryJobResultCompletedWithWarnings - CompletedWithWarnings value.
	ImportSQLInventoryJobResultCompletedWithWarnings ImportSQLInventoryJobResult = "CompletedWithWarnings"
	// ImportSQLInventoryJobResultFailed - Failed value.
	ImportSQLInventoryJobResultFailed ImportSQLInventoryJobResult = "Failed"
	// ImportSQLInventoryJobResultInProgress - InProgress value.
	ImportSQLInventoryJobResultInProgress ImportSQLInventoryJobResult = "InProgress"
	// ImportSQLInventoryJobResultUnknown - Unknown value.
	ImportSQLInventoryJobResultUnknown ImportSQLInventoryJobResult = "Unknown"
	// ImportSQLInventoryJobResultWaitingForBlobUpload - WaitingForBlobUpload value.
	ImportSQLInventoryJobResultWaitingForBlobUpload ImportSQLInventoryJobResult = "WaitingForBlobUpload"
)

// PossibleImportSQLInventoryJobResultValues returns the possible values for the ImportSQLInventoryJobResult const type.
func PossibleImportSQLInventoryJobResultValues() []ImportSQLInventoryJobResult {
	return []ImportSQLInventoryJobResult{
		ImportSQLInventoryJobResultCompleted,
		ImportSQLInventoryJobResultCompletedWithErrors,
		ImportSQLInventoryJobResultCompletedWithWarnings,
		ImportSQLInventoryJobResultFailed,
		ImportSQLInventoryJobResultInProgress,
		ImportSQLInventoryJobResultUnknown,
		ImportSQLInventoryJobResultWaitingForBlobUpload,
	}
}
...
// SQLImportType - Import types enum supported for Sql Inventory using import.
type SQLImportType string

const (
	// SQLImportTypeAzureMigrateCSV - AzureMigrateCsv value.
	SQLImportTypeAzureMigrateCSV SQLImportType = "AzureMigrateCsv"
	// SQLImportTypeUnknown - Unknown value.
	SQLImportTypeUnknown SQLImportType = "Unknown"
)

// PossibleSQLImportTypeValues returns the possible values for the SQLImportType const type.
func PossibleSQLImportTypeValues() []SQLImportType {
	return []SQLImportType{
		SQLImportTypeAzureMigrateCSV,
		SQLImportTypeUnknown,
	}
}
...
const (
	...
	// VersionsV20241201Preview - Api version 2024-12-01-preview.
	VersionsV20241201Preview Versions = "2024-12-01-preview"
)
