...
func (client *GatesClient) BeginUpdate(ctx context.Context, resourceGroupName string, fleetName string, gateName string, properties GateUpdate, options *GatesClientBeginUpdateOptions) (*runtime.Poller[GatesClientUpdateResponse], error) {
...
//
// Generated from API version 2025-04-01-preview
func (client *GatesClient) update(ctx context.Context, resourceGroupName string, fleetName string, gateName string, properties GateUpdate, options *GatesClientBeginUpdateOptions) (*http.Response, error) {
	var err error
...
func (client *GatesClient) updateCreateRequest(ctx context.Context, resourceGroupName string, fleetName string, gateName string, properties GateUpdate, options *GatesClientBeginUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/fleets/{fleetName}/gates/{gateName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
