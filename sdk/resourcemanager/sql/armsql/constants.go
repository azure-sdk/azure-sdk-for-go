...
// DatabaseBillingVersion - The pricing model to use when calculating billing for this database.
type DatabaseBillingVersion int32

const (
	DatabaseBillingVersionOne DatabaseBillingVersion = 1
	DatabaseBillingVersionTwo DatabaseBillingVersion = 2
)

// PossibleDatabaseBillingVersionValues returns the possible values for the DatabaseBillingVersion const type.
func PossibleDatabaseBillingVersionValues() []DatabaseBillingVersion {
	return []DatabaseBillingVersion{
		DatabaseBillingVersionOne,
		DatabaseBillingVersionTwo,
	}
}
...
// HyperscaleBillingVersion - The pricing model to use when calculating billing for this database.
type HyperscaleBillingVersion int32

const (
	HyperscaleBillingVersionOne HyperscaleBillingVersion = 1
	HyperscaleBillingVersionTwo HyperscaleBillingVersion = 2
)

// PossibleHyperscaleBillingVersionValues returns the possible values for the HyperscaleBillingVersion const type.
func PossibleHyperscaleBillingVersionValues() []HyperscaleBillingVersion {
	return []HyperscaleBillingVersion{
		HyperscaleBillingVersionOne,
		HyperscaleBillingVersionTwo,
	}
}
