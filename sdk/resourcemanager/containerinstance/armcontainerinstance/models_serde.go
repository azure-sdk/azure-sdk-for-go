...
// MarshalJSON implements the json.Marshaller interface for type Components10Wh5UdSchemasContainergroupidentityPropertiesUserassignedidentitiesAdditionalproperties.
func (c Components10Wh5UdSchemasContainergroupidentityPropertiesUserassignedidentitiesAdditionalproperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
...
// UnmarshalJSON implements the json.Unmarshaller interface for type Components10Wh5UdSchemasContainergroupidentityPropertiesUserassignedidentitiesAdditionalproperties.
func (c *Components10Wh5UdSchemasContainergroupidentityPropertiesUserassignedidentitiesAdditionalproperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
...
func (i *IPAddress) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "dnsNameLabel":
			...
			delete(rawMsg, key)
		case "dnsNameLabelReusePolicy":
			err = unpopulate(val, "DNSNameLabelReusePolicy", &i.DNSNameLabelReusePolicy)
			delete(rawMsg, key)
		case "fqdn":
