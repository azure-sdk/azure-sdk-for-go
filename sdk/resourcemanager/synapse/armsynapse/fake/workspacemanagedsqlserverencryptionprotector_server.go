...
func (w *WorkspaceManagedSQLServerEncryptionProtectorServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if workspaceManagedSqlServerEncryptionProtectorServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = workspaceManagedSqlServerEncryptionProtectorServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "WorkspaceManagedSQLServerEncryptionProtectorClient.BeginRevalidate":
				res.resp, res.err = w.dispatchBeginRevalidate(req)
			default:
...
// set this to conditionally intercept incoming requests to WorkspaceManagedSQLServerEncryptionProtectorServerTransport
var workspaceManagedSqlServerEncryptionProtectorServerTransportInterceptor interface {
