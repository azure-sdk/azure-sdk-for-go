...
func (h *HCIReportsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if hciReportsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = hciReportsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "HCIReportsClient.NewListByConfigurationProfileAssignmentsPager":
				res.resp, res.err = h.dispatchNewListByConfigurationProfileAssignmentsPager(req)
			default:
...
// set this to conditionally intercept incoming requests to HCIReportsServerTransport
var hciReportsServerTransportInterceptor interface {
