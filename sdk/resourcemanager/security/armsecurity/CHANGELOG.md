...
- New function `*ClientFactory.NewTrustedIPsClient() *TrustedIPsClient`
- New function `NewTrustedIPsClient(azcore.TokenCredential, *arm.ClientOptions) (*TrustedIPsClient, error)`
- New function `*TrustedIPsClient.CreateOrUpdate(context.Context, string, string, TrustedIPs, *TrustedIPsClientCreateOrUpdateOptions) (TrustedIPsClientCreateOrUpdateResponse, error)`
- New function `*TrustedIPsClient.Delete(context.Context, string, string, *TrustedIPsClientDeleteOptions) (TrustedIPsClientDeleteResponse, error)`
- New function `*TrustedIPsClient.Get(context.Context, string, string, *TrustedIPsClientGetOptions) (TrustedIPsClientGetResponse, error)`
- New function `*TrustedIPsClient.NewListPager(string, *TrustedIPsClientListOptions) *runtime.Pager[TrustedIPsClientListResponse]`
- New struct `DevOpsCapability`
- New struct `ErrorDetailAutoGenerated2`
- New struct `ErrorResponseAutoGenerated2`
- New struct `TrustedIPs`
- New struct `TrustedIPsList`
- New struct `TrustedIPsMetadata`
- New struct `TrustedIPsProperties`
