...
```go
client, err := armvoiceservices.NewNameAvailabilityClient(<subscription ID>, cred, nil)
```
...
client, err := armvoiceservices.NewNameAvailabilityClient(<subscription ID>, cred, &options)
```
