...
func (client *ConnectionClient) getAllModelsCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, options *ConnectionClientGetAllModelsOptions) (*policy.Request, error) {
