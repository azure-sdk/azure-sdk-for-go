...
func (s *ServerDependencyMapControllerServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if serverDependencyMapControllerServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = serverDependencyMapControllerServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			case "ServerDependencyMapControllerClient.BeginClientGroupMembers":
				res.resp, res.err = s.dispatchBeginClientGroupMembers(req)
			case "ServerDependencyMapControllerClient.BeginExportDependencies":
				res.resp, res.err = s.dispatchBeginExportDependencies(req)
			case "ServerDependencyMapControllerClient.BeginGenerateCoarseMap":
				res.resp, res.err = s.dispatchBeginGenerateCoarseMap(req)
			case "ServerDependencyMapControllerClient.BeginGenerateDetailedMap":
				res.resp, res.err = s.dispatchBeginGenerateDetailedMap(req)
			case "ServerDependencyMapControllerClient.BeginServerGroupMembers":
				res.resp, res.err = s.dispatchBeginServerGroupMembers(req)
			default:
...
// set this to conditionally intercept incoming requests to ServerDependencyMapControllerServerTransport
var serverDependencyMapControllerServerTransportInterceptor interface {
