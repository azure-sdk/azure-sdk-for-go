...
// DataTypesClientListByParentOptions contains the optional parameters for the DataTypesClient.NewListByParentPager method.
type DataTypesClientListByParentOptions struct {
	// placeholder for future optional parameters
}
