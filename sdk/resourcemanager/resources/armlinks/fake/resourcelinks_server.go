...
func (r *ResourceLinksServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if resourceLinksServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = resourceLinksServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "ResourceLinksClient.NewListAtSourceScopePager":
				res.resp, res.err = r.dispatchNewListAtSourceScopePager(req)
			case "ResourceLinksClient.NewListAtSubscriptionPager":
				res.resp, res.err = r.dispatchNewListAtSubscriptionPager(req)
			default:
...
// set this to conditionally intercept incoming requests to ResourceLinksServerTransport
var resourceLinksServerTransportInterceptor interface {
