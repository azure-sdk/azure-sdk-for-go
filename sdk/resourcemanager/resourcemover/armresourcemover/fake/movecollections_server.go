...
func (m *MoveCollectionsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if moveCollectionsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = moveCollectionsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			case "MoveCollectionsClient.BeginBulkRemove":
				res.resp, res.err = m.dispatchBeginBulkRemove(req)
			case "MoveCollectionsClient.BeginCommit":
				res.resp, res.err = m.dispatchBeginCommit(req)
			...
			case "MoveCollectionsClient.BeginDiscard":
				res.resp, res.err = m.dispatchBeginDiscard(req)
			case "MoveCollectionsClient.Get":
				res.resp, res.err = m.dispatchGet(req)
			case "MoveCollectionsClient.BeginInitiateMove":
				res.resp, res.err = m.dispatchBeginInitiateMove(req)
			case "MoveCollectionsClient.NewListMoveCollectionsByResourceGroupPager":
				res.resp, res.err = m.dispatchNewListMoveCollectionsByResourceGroupPager(req)
			case "MoveCollectionsClient.NewListMoveCollectionsBySubscriptionPager":
				res.resp, res.err = m.dispatchNewListMoveCollectionsBySubscriptionPager(req)
			case "MoveCollectionsClient.ListRequiredFor":
				res.resp, res.err = m.dispatchListRequiredFor(req)
			case "MoveCollectionsClient.BeginPrepare":
				res.resp, res.err = m.dispatchBeginPrepare(req)
			case "MoveCollectionsClient.BeginResolveDependencies":
				res.resp, res.err = m.dispatchBeginResolveDependencies(req)
...
// set this to conditionally intercept incoming requests to MoveCollectionsServerTransport
var moveCollectionsServerTransportInterceptor interface {
