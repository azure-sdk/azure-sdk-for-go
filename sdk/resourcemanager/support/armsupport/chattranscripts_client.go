...
func (client *ChatTranscriptsClient) getCreateRequest(ctx context.Context, supportTicketName string, chatTranscriptName string, _ *ChatTranscriptsClientGetOptions) (*policy.Request, error) {
...
func (client *ChatTranscriptsClient) listCreateRequest(ctx context.Context, supportTicketName string, _ *ChatTranscriptsClientListOptions) (*policy.Request, error) {
