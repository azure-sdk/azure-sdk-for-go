...
func ExampleAddonsClient_BeginCreateOrUpdate_addonsCreateOrUpdateArcReg() {
	...
	poller, err := clientFactory.NewAddonsClient().BeginCreateOrUpdate(ctx, "group1", "cloud1", "arc", nil)
	if err != nil {
...
func ExampleAddonsClient_BeginCreateOrUpdate_addonsCreateOrUpdateHcx() {
	...
	poller, err := clientFactory.NewAddonsClient().BeginCreateOrUpdate(ctx, "group1", "cloud1", "hcx", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	res, err := poller.PollUntilDone(ctx, nil)
...
func ExampleAddonsClient_BeginCreateOrUpdate_addonsCreateOrUpdateSrm() {
	...
	poller, err := clientFactory.NewAddonsClient().BeginCreateOrUpdate(ctx, "group1", "cloud1", "srm", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	res, err := poller.PollUntilDone(ctx, nil)
...
func ExampleAddonsClient_BeginCreateOrUpdate_addonsCreateOrUpdateVr() {
	...
	poller, err := clientFactory.NewAddonsClient().BeginCreateOrUpdate(ctx, "group1", "cloud1", "vr", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	res, err := poller.PollUntilDone(ctx, nil)
