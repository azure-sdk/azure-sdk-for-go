...
func (s *SQLPoolTransparentDataEncryptionsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if sqlPoolTransparentDataEncryptionsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = sqlPoolTransparentDataEncryptionsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to SQLPoolTransparentDataEncryptionsServerTransport
var sqlPoolTransparentDataEncryptionsServerTransportInterceptor interface {
