...
func (a *AvailableClusterPoolVersionsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if availableClusterPoolVersionsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = availableClusterPoolVersionsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to AvailableClusterPoolVersionsServerTransport
var availableClusterPoolVersionsServerTransportInterceptor interface {
