...
func NewClientFactory(subscriptionID string, containerAppName string, credential azcore.TokenCredential, options *arm.ClientOptions) (*ClientFactory, error) {
...
func (c *ClientFactory) NewAppResiliencyClient() *AppResiliencyClient {
	return &AppResiliencyClient{
		...
		containerAppName: c.containerAppName,
		internal:         c.internal,
	}
}
...
// NewContainerAppsSessionPoolSessionsClient creates a new instance of ContainerAppsSessionPoolSessionsClient.
func (c *ClientFactory) NewContainerAppsSessionPoolSessionsClient() *ContainerAppsSessionPoolSessionsClient {
	return &ContainerAppsSessionPoolSessionsClient{
		subscriptionID:   c.subscriptionID,
		containerAppName: c.containerAppName,
		internal:         c.internal,
	}
