...
type DataTypesServer struct {
	...
	// HTTP status codes to indicate success: http.StatusAccepted, http.StatusNoContent
	BeginDeleteData func(ctx context.Context, resourceGroupName string, dataProductName string, dataTypeName string, body armnetworkanalytics.DeleteDataRequest, options *armnetworkanalytics.DataTypesClientBeginDeleteDataOptions) (resp azfake.PollerResponder[armnetworkanalytics.DataTypesClientDeleteDataResponse], errResp azfake.ErrorResponder)
	...
	// NewListByParentPager is the fake for method DataTypesClient.NewListByParentPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByParentPager func(resourceGroupName string, dataProductName string, options *armnetworkanalytics.DataTypesClientListByParentOptions) (resp azfake.PagerResponder[armnetworkanalytics.DataTypesClientListByParentResponse])

	// BeginUpdate is the fake for method DataTypesClient.BeginUpdate
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginUpdate func(ctx context.Context, resourceGroupName string, dataProductName string, dataTypeName string, properties armnetworkanalytics.DataType, options *armnetworkanalytics.DataTypesClientBeginUpdateOptions) (resp azfake.PollerResponder[armnetworkanalytics.DataTypesClientUpdateResponse], errResp azfake.ErrorResponder)
}
...
func NewDataTypesServerTransport(srv *DataTypesServer) *DataTypesServerTransport {
	return &DataTypesServerTransport{
		...
		newListByParentPager: newTracker[azfake.PagerResponder[armnetworkanalytics.DataTypesClientListByParentResponse]](),
...
type DataTypesServerTransport struct {
	...
	newListByParentPager *tracker[azfake.PagerResponder[armnetworkanalytics.DataTypesClientListByParentResponse]]
...
func (d *DataTypesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	case "DataTypesClient.NewListByParentPager":
		resp, err = d.dispatchNewListByParentPager(req)
...
func (d *DataTypesServerTransport) dispatchNewListByParentPager(req *http.Request) (*http.Response, error) {
	...
	if newListByParentPager == nil {
		...
		resp := d.srv.NewListByParentPager(resourceGroupNameParam, dataProductNameParam, nil)
		newListByParentPager = &resp
		d.newListByParentPager.add(req, newListByParentPager)
		server.PagerResponderInjectNextLinks(newListByParentPager, req, func(page *armnetworkanalytics.DataTypesClientListByParentResponse, createLink func() string) {
