...
// Generated from example definition: 2024-10-01/IntegrationFabrics_Create.json
func ExampleIntegrationFabricsClient_BeginCreate() {
	...
	poller, err := clientFactory.NewIntegrationFabricsClient().BeginCreate(ctx, "myResourceGroup", "myWorkspace", "sampleIntegration", nil)
	if err != nil {
...
// Generated from example definition: 2024-10-01/IntegrationFabrics_Delete.json
...
// Generated from example definition: 2024-10-01/IntegrationFabrics_Get.json
...
// Generated from example definition: 2024-10-01/IntegrationFabrics_List.json
...
// Generated from example definition: 2024-10-01/IntegrationFabrics_Update.json
func ExampleIntegrationFabricsClient_BeginUpdate() {
	...
	poller, err := clientFactory.NewIntegrationFabricsClient().BeginUpdate(ctx, "myResourceGroup", "myWorkspace", "sampleIntegration", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	res, err := poller.PollUntilDone(ctx, nil)
