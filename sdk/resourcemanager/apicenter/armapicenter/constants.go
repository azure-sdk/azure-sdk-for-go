...
// AnalyzerFilterOperator - Allowed analyzer filter operator values.
type AnalyzerFilterOperator string

const (
	// AnalyzerFilterOperatorContains - Contains operator.
	AnalyzerFilterOperatorContains AnalyzerFilterOperator = "contains"
	// AnalyzerFilterOperatorEquals - In operator.
	AnalyzerFilterOperatorEquals AnalyzerFilterOperator = "equals"
)

// PossibleAnalyzerFilterOperatorValues returns the possible values for the AnalyzerFilterOperator const type.
func PossibleAnalyzerFilterOperatorValues() []AnalyzerFilterOperator {
	return []AnalyzerFilterOperator{
		AnalyzerFilterOperatorContains,
		AnalyzerFilterOperatorEquals,
	}
}
