...
func (client *AssessmentsClient) Create(ctx context.Context, resourceGroupName string, projectName string, groupName string, assessmentName string, assessment Assessment, options *AssessmentsClientCreateOptions) (AssessmentsClientCreateResponse, error) {
	req, err := client.createCreateRequest(ctx, resourceGroupName, projectName, groupName, assessmentName, assessment, options)
	if err != nil {
...
func (client *AssessmentsClient) createCreateRequest(ctx context.Context, resourceGroupName string, projectName string, groupName string, assessmentName string, assessment Assessment, options *AssessmentsClientCreateOptions) (*policy.Request, error) {
