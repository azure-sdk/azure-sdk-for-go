...
// SecurityPolicyWebApplicationFirewallAssociationIsProfileLevel - Flag to signal whether the WAF policy association is at
// the default Profile level.
type SecurityPolicyWebApplicationFirewallAssociationIsProfileLevel string

const (
	SecurityPolicyWebApplicationFirewallAssociationIsProfileLevelFalse SecurityPolicyWebApplicationFirewallAssociationIsProfileLevel = "False"
	SecurityPolicyWebApplicationFirewallAssociationIsProfileLevelTrue  SecurityPolicyWebApplicationFirewallAssociationIsProfileLevel = "True"
)

// PossibleSecurityPolicyWebApplicationFirewallAssociationIsProfileLevelValues returns the possible values for the SecurityPolicyWebApplicationFirewallAssociationIsProfileLevel const type.
func PossibleSecurityPolicyWebApplicationFirewallAssociationIsProfileLevelValues() []SecurityPolicyWebApplicationFirewallAssociationIsProfileLevel {
	return []SecurityPolicyWebApplicationFirewallAssociationIsProfileLevel{
		SecurityPolicyWebApplicationFirewallAssociationIsProfileLevelFalse,
		SecurityPolicyWebApplicationFirewallAssociationIsProfileLevelTrue,
	}
}
