...
func (w *WorkloadNetworkDhcpConfigurationsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if workloadNetworkDhcpConfigurationsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = workloadNetworkDhcpConfigurationsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to WorkloadNetworkDhcpConfigurationsServerTransport
var workloadNetworkDhcpConfigurationsServerTransportInterceptor interface {
