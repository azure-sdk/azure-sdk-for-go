...
func (c *ClientFactory) NewStorageTaskAssignmentClient() *StorageTaskAssignmentClient {
	subClient, _ := NewStorageTaskAssignmentClient(c.subscriptionID, c.credential, c.options)
	return subClient
}
...
func (c *ClientFactory) NewStorageTasksClient() *StorageTasksClient {
	subClient, _ := NewStorageTasksClient(c.subscriptionID, c.credential, c.options)
	return subClient
}
...
func (c *ClientFactory) NewStorageTasksReportClient() *StorageTasksReportClient {
	subClient, _ := NewStorageTasksReportClient(c.subscriptionID, c.credential, c.options)
	return subClient
}
