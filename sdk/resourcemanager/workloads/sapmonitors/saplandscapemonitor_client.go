...
//   - resource - Request body representing a configuration for Sap Landscape Monitor Dashboard
//   - options - SapLandscapeMonitorClientCreateOptions contains the optional parameters for the SapLandscapeMonitorClient.Create
//     method.
func (client *SapLandscapeMonitorClient) Create(ctx context.Context, resourceGroupName string, monitorName string, resource SapLandscapeMonitorSapLandscapeMonitorResource, options *SapLandscapeMonitorClientCreateOptions) (SapLandscapeMonitorClientCreateResponse, error) {
	var err error
...
func (client *SapLandscapeMonitorClient) createCreateRequest(ctx context.Context, resourceGroupName string, monitorName string, resource SapLandscapeMonitorSapLandscapeMonitorResource, options *SapLandscapeMonitorClientCreateOptions) (*policy.Request, error) {
...
func (client *SapLandscapeMonitorClient) createHandleResponse(resp *http.Response) (SapLandscapeMonitorClientCreateResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.SapLandscapeMonitorSapLandscapeMonitorResource); err != nil {
		return SapLandscapeMonitorClientCreateResponse{}, err
	}
	return result, nil
}
...
// NewListByMonitorPager - Gets configuration values for Single Pane Of Glass for SAP monitor for the specified subscription,
// resource group, and resource name.
//
// Generated from API version 2023-12-01-preview
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - monitorName - Name of the SAP monitor resource.
//   - options - SapLandscapeMonitorClientListByMonitorOptions contains the optional parameters for the SapLandscapeMonitorClient.NewListByMonitorPager
//     method.
func (client *SapLandscapeMonitorClient) NewListByMonitorPager(resourceGroupName string, monitorName string, options *SapLandscapeMonitorClientListByMonitorOptions) *runtime.Pager[SapLandscapeMonitorClientListByMonitorResponse] {
	return runtime.NewPager(runtime.PagingHandler[SapLandscapeMonitorClientListByMonitorResponse]{
		More: func(page SapLandscapeMonitorClientListByMonitorResponse) bool {
			return page.NextLink != nil && len(*page.NextLink) > 0
		},
		Fetcher: func(ctx context.Context, page *SapLandscapeMonitorClientListByMonitorResponse) (SapLandscapeMonitorClientListByMonitorResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "SapLandscapeMonitorClient.NewListByMonitorPager")
			nextLink := ""
			if page != nil {
			...
			if err != nil {
				return SapLandscapeMonitorClientListByMonitorResponse{}, err
			}
...
func (client *SapLandscapeMonitorClient) listByMonitorCreateRequest(ctx context.Context, resourceGroupName string, monitorName string, options *SapLandscapeMonitorClientListByMonitorOptions) (*policy.Request, error) {
...
func (client *SapLandscapeMonitorClient) listByMonitorHandleResponse(resp *http.Response) (SapLandscapeMonitorClientListByMonitorResponse, error) {
	result := SapLandscapeMonitorClientListByMonitorResponse{}
	if err := runtime.UnmarshalAsJSON(resp, &result.SapLandscapeMonitorResourceListResult); err != nil {
		return SapLandscapeMonitorClientListByMonitorResponse{}, err
	}
	return result, nil
}
...
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - monitorName - Name of the SAP monitor resource.
//   - properties - Request body representing a configuration for Sap Landscape Monitor Dashboard
//   - options - SapLandscapeMonitorClientUpdateOptions contains the optional parameters for the SapLandscapeMonitorClient.Update
//     method.
func (client *SapLandscapeMonitorClient) Update(ctx context.Context, resourceGroupName string, monitorName string, properties SapLandscapeMonitorSapLandscapeMonitorResource, options *SapLandscapeMonitorClientUpdateOptions) (SapLandscapeMonitorClientUpdateResponse, error) {
	var err error
...
func (client *SapLandscapeMonitorClient) updateCreateRequest(ctx context.Context, resourceGroupName string, monitorName string, properties SapLandscapeMonitorSapLandscapeMonitorResource, options *SapLandscapeMonitorClientUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Workloads/monitors/{monitorName}/sapLandscapeMonitor/default"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
