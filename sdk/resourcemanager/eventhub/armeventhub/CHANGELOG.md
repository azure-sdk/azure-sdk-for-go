...
- New value `CleanupPolicyRetentionDescriptionCompact`, `CleanupPolicyRetentionDescriptionDeleteOrCompact` added to enum type `CleanupPolicyRetentionDescription`
...
- New field `Identifier`, `MessageTimestampDescription`, `UserMetadata` in struct `Properties`
