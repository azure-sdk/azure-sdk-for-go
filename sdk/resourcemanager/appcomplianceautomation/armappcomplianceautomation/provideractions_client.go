...
// ProviderActionsClient contains the methods for the Microsoft.AppComplianceAutomation namespace.
...
func (client *ProviderActionsClient) checkNameAvailabilityCreateRequest(ctx context.Context, body CheckNameAvailabilityRequest, _ *ProviderActionsClientCheckNameAvailabilityOptions) (*policy.Request, error) {
...
func (client *ProviderActionsClient) getCollectionCountCreateRequest(ctx context.Context, body GetCollectionCountRequest, _ *ProviderActionsClientGetCollectionCountOptions) (*policy.Request, error) {
...
func (client *ProviderActionsClient) getOverviewStatusCreateRequest(ctx context.Context, body GetOverviewStatusRequest, _ *ProviderActionsClientGetOverviewStatusOptions) (*policy.Request, error) {
...
func (client *ProviderActionsClient) listInUseStorageAccountsCreateRequest(ctx context.Context, body ListInUseStorageAccountsRequest, _ *ProviderActionsClientListInUseStorageAccountsOptions) (*policy.Request, error) {
...
func (client *ProviderActionsClient) onboardCreateRequest(ctx context.Context, body OnboardRequest, _ *ProviderActionsClientBeginOnboardOptions) (*policy.Request, error) {
...
func (client *ProviderActionsClient) triggerEvaluationCreateRequest(ctx context.Context, body TriggerEvaluationRequest, _ *ProviderActionsClientBeginTriggerEvaluationOptions) (*policy.Request, error) {
