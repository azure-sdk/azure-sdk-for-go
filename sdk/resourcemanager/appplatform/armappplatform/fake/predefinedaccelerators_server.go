...
func (p *PredefinedAcceleratorsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if predefinedAcceleratorsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = predefinedAcceleratorsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			case "PredefinedAcceleratorsClient.BeginDisable":
				res.resp, res.err = p.dispatchBeginDisable(req)
			case "PredefinedAcceleratorsClient.BeginEnable":
				res.resp, res.err = p.dispatchBeginEnable(req)
...
// set this to conditionally intercept incoming requests to PredefinedAcceleratorsServerTransport
var predefinedAcceleratorsServerTransportInterceptor interface {
