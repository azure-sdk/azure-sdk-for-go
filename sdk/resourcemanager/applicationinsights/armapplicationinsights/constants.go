...
// AzureMonitorPrivateLinkScopePropertiesProvisioningState - Current state of this PrivateLinkScope: whether or not is has
// been provisioned within the resource group it is defined. Users cannot change this value but are able to read from it.
// Values will include
// Provisioning ,Succeeded, Canceled and Failed.
type AzureMonitorPrivateLinkScopePropertiesProvisioningState string

const (
	// AzureMonitorPrivateLinkScopePropertiesProvisioningStateCanceled - The state is Canceled.
	AzureMonitorPrivateLinkScopePropertiesProvisioningStateCanceled AzureMonitorPrivateLinkScopePropertiesProvisioningState = "Canceled"
	// AzureMonitorPrivateLinkScopePropertiesProvisioningStateFailed - The state is Failed.
	AzureMonitorPrivateLinkScopePropertiesProvisioningStateFailed AzureMonitorPrivateLinkScopePropertiesProvisioningState = "Failed"
	// AzureMonitorPrivateLinkScopePropertiesProvisioningStateProvisioning - The state is Provisioning.
	AzureMonitorPrivateLinkScopePropertiesProvisioningStateProvisioning AzureMonitorPrivateLinkScopePropertiesProvisioningState = "Provisioning"
	// AzureMonitorPrivateLinkScopePropertiesProvisioningStateSucceeded - The state is Succeeded.
	AzureMonitorPrivateLinkScopePropertiesProvisioningStateSucceeded AzureMonitorPrivateLinkScopePropertiesProvisioningState = "Succeeded"
)

// PossibleAzureMonitorPrivateLinkScopePropertiesProvisioningStateValues returns the possible values for the AzureMonitorPrivateLinkScopePropertiesProvisioningState const type.
func PossibleAzureMonitorPrivateLinkScopePropertiesProvisioningStateValues() []AzureMonitorPrivateLinkScopePropertiesProvisioningState {
	return []AzureMonitorPrivateLinkScopePropertiesProvisioningState{
		AzureMonitorPrivateLinkScopePropertiesProvisioningStateCanceled,
		AzureMonitorPrivateLinkScopePropertiesProvisioningStateFailed,
		AzureMonitorPrivateLinkScopePropertiesProvisioningStateProvisioning,
...
// ScopedResourcePropertiesProvisioningState - State of the private endpoint connection.
type ScopedResourcePropertiesProvisioningState string

const (
	// ScopedResourcePropertiesProvisioningStateCanceled - The state is Canceled.
	ScopedResourcePropertiesProvisioningStateCanceled ScopedResourcePropertiesProvisioningState = "Canceled"
	// ScopedResourcePropertiesProvisioningStateFailed - The state is Failed.
	ScopedResourcePropertiesProvisioningStateFailed ScopedResourcePropertiesProvisioningState = "Failed"
	// ScopedResourcePropertiesProvisioningStateProvisioning - The state is Provisioning.
	ScopedResourcePropertiesProvisioningStateProvisioning ScopedResourcePropertiesProvisioningState = "Provisioning"
	// ScopedResourcePropertiesProvisioningStateSucceeded - The state is Succeeded.
	ScopedResourcePropertiesProvisioningStateSucceeded ScopedResourcePropertiesProvisioningState = "Succeeded"
)

// PossibleScopedResourcePropertiesProvisioningStateValues returns the possible values for the ScopedResourcePropertiesProvisioningState const type.
func PossibleScopedResourcePropertiesProvisioningStateValues() []ScopedResourcePropertiesProvisioningState {
	return []ScopedResourcePropertiesProvisioningState{
		ScopedResourcePropertiesProvisioningStateCanceled,
		ScopedResourcePropertiesProvisioningStateFailed,
		ScopedResourcePropertiesProvisioningStateProvisioning,
		ScopedResourcePropertiesProvisioningStateSucceeded,
	}
}
