...
```go
client, err := armstorsimple1200series.NewFileSharesClient(<subscription ID>, cred, nil)
```
...
client, err := armstorsimple1200series.NewFileSharesClient(<subscription ID>, cred, &options)
```
