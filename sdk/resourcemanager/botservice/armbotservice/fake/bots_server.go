...
type BotsServer struct {
	...
	// CreateSignInURL is the fake for method BotsClient.CreateSignInURL
	// HTTP status codes to indicate success: http.StatusOK
	CreateSignInURL func(ctx context.Context, resourceGroupName string, resourceName string, options *armbotservice.BotsClientCreateSignInURLOptions) (resp azfake.Responder[armbotservice.BotsClientCreateSignInURLResponse], errResp azfake.ErrorResponder)
	...
	// ListByBotResource is the fake for method BotsClient.ListByBotResource
	// HTTP status codes to indicate success: http.StatusOK
	ListByBotResource func(ctx context.Context, resourceGroupName string, resourceName string, options *armbotservice.BotsClientListByBotResourceOptions) (resp azfake.Responder[armbotservice.BotsClientListByBotResourceResponse], errResp azfake.ErrorResponder)
...
func (b *BotsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		if !intercepted {
			...
			case "BotsClient.CreateSignInURL":
				res.resp, res.err = b.dispatchCreateSignInURL(req)
			...
			case "BotsClient.ListByBotResource":
				res.resp, res.err = b.dispatchListByBotResource(req)
...
func (b *BotsServerTransport) dispatchCreateSignInURL(req *http.Request) (*http.Response, error) {
	if b.srv.CreateSignInURL == nil {
	...
	respr, errRespr := b.srv.CreateSignInURL(req.Context(), resourceGroupNameParam, resourceNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (b *BotsServerTransport) dispatchListByBotResource(req *http.Request) (*http.Response, error) {
	if b.srv.ListByBotResource == nil {
	...
	respr, errRespr := b.srv.ListByBotResource(req.Context(), resourceGroupNameParam, resourceNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
