...
func (a *ApplyUpdateForResourceGroupServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if applyUpdateForResourceGroupServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = applyUpdateForResourceGroupServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
func (a *ApplyUpdateForResourceGroupServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armmaintenance.ApplyUpdateForResourceGroupClientListResponse, createLink func() string) {
...
// set this to conditionally intercept incoming requests to ApplyUpdateForResourceGroupServerTransport
var applyUpdateForResourceGroupServerTransportInterceptor interface {
