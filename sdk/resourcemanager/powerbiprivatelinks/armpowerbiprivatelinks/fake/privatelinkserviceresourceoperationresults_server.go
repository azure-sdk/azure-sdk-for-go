...
func (p *PrivateLinkServiceResourceOperationResultsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if privateLinkServiceResourceOperationResultsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = privateLinkServiceResourceOperationResultsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			case "PrivateLinkServiceResourceOperationResultsClient.BeginGet":
				res.resp, res.err = p.dispatchBeginGet(req)
			default:
...
// set this to conditionally intercept incoming requests to PrivateLinkServiceResourceOperationResultsServerTransport
var privateLinkServiceResourceOperationResultsServerTransportInterceptor interface {
