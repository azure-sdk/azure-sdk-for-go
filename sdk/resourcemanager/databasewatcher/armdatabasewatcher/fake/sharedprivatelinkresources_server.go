...
type SharedPrivateLinkResourcesServer struct {
	...
	// NewListByParentPager is the fake for method SharedPrivateLinkResourcesClient.NewListByParentPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByParentPager func(resourceGroupName string, watcherName string, options *armdatabasewatcher.SharedPrivateLinkResourcesClientListByParentOptions) (resp azfake.PagerResponder[armdatabasewatcher.SharedPrivateLinkResourcesClientListByParentResponse])
}
...
func NewSharedPrivateLinkResourcesServerTransport(srv *SharedPrivateLinkResourcesServer) *SharedPrivateLinkResourcesServerTransport {
	return &SharedPrivateLinkResourcesServerTransport{
		...
		newListByParentPager: newTracker[azfake.PagerResponder[armdatabasewatcher.SharedPrivateLinkResourcesClientListByParentResponse]](),
	}
}
...
type SharedPrivateLinkResourcesServerTransport struct {
	...
	newListByParentPager *tracker[azfake.PagerResponder[armdatabasewatcher.SharedPrivateLinkResourcesClientListByParentResponse]]
}
...
func (s *SharedPrivateLinkResourcesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	case "SharedPrivateLinkResourcesClient.NewListByParentPager":
...
func (s *SharedPrivateLinkResourcesServerTransport) dispatchNewListByParentPager(req *http.Request) (*http.Response, error) {
	...
	if newListByParentPager == nil {
		...
		resp := s.srv.NewListByParentPager(resourceGroupNameParam, watcherNameParam, nil)
		newListByParentPager = &resp
		s.newListByParentPager.add(req, newListByParentPager)
		server.PagerResponderInjectNextLinks(newListByParentPager, req, func(page *armdatabasewatcher.SharedPrivateLinkResourcesClientListByParentResponse, createLink func() string) {
