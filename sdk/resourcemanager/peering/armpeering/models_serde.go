...
func (d DirectConnection) MarshalJSON() ([]byte, error) {
	...
	populateDateTimeRFC3339(objectMap, "lastFailureTimeUtc", d.LastFailureTimeUTC)
	populate(objectMap, "microsoftTrackingId", d.MicrosoftTrackingID)
	populate(objectMap, "migrationWorkWindowBgpSessionSameDevice", d.MigrationWorkWindowBgpSessionSameDevice)
	populate(objectMap, "migrationWorkWindowTracker", d.MigrationWorkWindowTracker)
	populate(objectMap, "peeringDBFacilityId", d.PeeringDBFacilityID)
	populate(objectMap, "previousConnectionProvisioningState", d.PreviousConnectionProvisioningState)
...
func (d *DirectConnection) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "errorMessage":
			...
			delete(rawMsg, key)
		case "lastFailureTimeUtc":
			err = unpopulateDateTimeRFC3339(val, "LastFailureTimeUTC", &d.LastFailureTimeUTC)
			delete(rawMsg, key)
		case "microsoftTrackingId":
			err = unpopulate(val, "MicrosoftTrackingID", &d.MicrosoftTrackingID)
			delete(rawMsg, key)
		case "migrationWorkWindowBgpSessionSameDevice":
			err = unpopulate(val, "MigrationWorkWindowBgpSessionSameDevice", &d.MigrationWorkWindowBgpSessionSameDevice)
			delete(rawMsg, key)
		case "migrationWorkWindowTracker":
			err = unpopulate(val, "MigrationWorkWindowTracker", &d.MigrationWorkWindowTracker)
			delete(rawMsg, key)
		case "peeringDBFacilityId":
			err = unpopulate(val, "PeeringDBFacilityID", &d.PeeringDBFacilityID)
			delete(rawMsg, key)
		case "previousConnectionProvisioningState":
			err = unpopulate(val, "PreviousConnectionProvisioningState", &d.PreviousConnectionProvisioningState)
			delete(rawMsg, key)
...
func (e ExchangeConnection) MarshalJSON() ([]byte, error) {
	...
	populateDateTimeRFC3339(objectMap, "lastFailureTimeUtc", e.LastFailureTimeUTC)
	populate(objectMap, "migrationWorkWindowBgpSessionSameDevice", e.MigrationWorkWindowBgpSessionSameDevice)
	populate(objectMap, "migrationWorkWindowTracker", e.MigrationWorkWindowTracker)
	populate(objectMap, "peeringDBFacilityId", e.PeeringDBFacilityID)
	populate(objectMap, "previousConnectionProvisioningState", e.PreviousConnectionProvisioningState)
	return json.Marshal(objectMap)
}
...
func (e *ExchangeConnection) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "errorMessage":
			...
			delete(rawMsg, key)
		case "lastFailureTimeUtc":
			err = unpopulateDateTimeRFC3339(val, "LastFailureTimeUTC", &e.LastFailureTimeUTC)
			delete(rawMsg, key)
		case "migrationWorkWindowBgpSessionSameDevice":
			err = unpopulate(val, "MigrationWorkWindowBgpSessionSameDevice", &e.MigrationWorkWindowBgpSessionSameDevice)
			delete(rawMsg, key)
		case "migrationWorkWindowTracker":
			err = unpopulate(val, "MigrationWorkWindowTracker", &e.MigrationWorkWindowTracker)
			delete(rawMsg, key)
		case "peeringDBFacilityId":
			err = unpopulate(val, "PeeringDBFacilityID", &e.PeeringDBFacilityID)
			delete(rawMsg, key)
		case "previousConnectionProvisioningState":
			err = unpopulate(val, "PreviousConnectionProvisioningState", &e.PreviousConnectionProvisioningState)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", e, err)
