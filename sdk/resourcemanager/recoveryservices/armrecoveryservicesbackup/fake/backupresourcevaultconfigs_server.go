...
func (b *BackupResourceVaultConfigsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if backupResourceVaultConfigsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = backupResourceVaultConfigsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to BackupResourceVaultConfigsServerTransport
var backupResourceVaultConfigsServerTransportInterceptor interface {
