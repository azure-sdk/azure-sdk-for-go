...
func (p *PublicKeysServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if publicKeysServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = publicKeysServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "PublicKeysClient.NewListByDataManagerPager":
				res.resp, res.err = p.dispatchNewListByDataManagerPager(req)
			default:
...
// set this to conditionally intercept incoming requests to PublicKeysServerTransport
var publicKeysServerTransportInterceptor interface {
