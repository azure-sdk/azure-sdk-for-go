...
// CloudsClient contains the methods for the Microsoft.ScVmm namespace.
...
// BeginCreateOrUpdate - Implements Clouds PUT method.
...
// CreateOrUpdate - Implements Clouds PUT method.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2023-10-07
...
func (client *CloudsClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, cloudResourceName string, resource Cloud, _ *CloudsClientBeginCreateOrUpdateOptions) (*policy.Request, error) {
...
// BeginDelete - Implements Cloud resource DELETE method.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2023-10-07
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
...
// Delete - Implements Cloud resource DELETE method.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2023-10-07
...
func (client *CloudsClient) getCreateRequest(ctx context.Context, resourceGroupName string, cloudResourceName string, _ *CloudsClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ScVmm/clouds/{cloudResourceName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
// NewListByResourceGroupPager - Implements GET Clouds in a resource group.
//
// Generated from API version 2023-10-07
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
...
func (client *CloudsClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, _ *CloudsClientListByResourceGroupOptions) (*policy.Request, error) {
...
// NewListBySubscriptionPager - Implements GET Clouds in a subscription.
//
// Generated from API version 2023-10-07
...
func (client *CloudsClient) listBySubscriptionCreateRequest(ctx context.Context, _ *CloudsClientListBySubscriptionOptions) (*policy.Request, error) {
...
// BeginUpdate - Implements the Clouds PATCH method.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2023-10-07
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
...
// Update - Implements the Clouds PATCH method.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2023-10-07
...
func (client *CloudsClient) updateCreateRequest(ctx context.Context, resourceGroupName string, cloudResourceName string, properties CloudTagsUpdate, _ *CloudsClientBeginUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ScVmm/clouds/{cloudResourceName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
