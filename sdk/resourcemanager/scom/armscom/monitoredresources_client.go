...
func (client *MonitoredResourcesClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, _ *MonitoredResourcesClientCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *MonitoredResourcesClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, _ *MonitoredResourcesClientDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Scom/managedInstances/{instanceName}/monitoredResources/{monitoredResourceName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *MonitoredResourcesClient) getCreateRequest(ctx context.Context, resourceGroupName string, _ *MonitoredResourcesClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Scom/managedInstances/{instanceName}/monitoredResources/{monitoredResourceName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *MonitoredResourcesClient) listByManagedInstanceCreateRequest(ctx context.Context, resourceGroupName string, _ *MonitoredResourcesClientListByManagedInstanceOptions) (*policy.Request, error) {
