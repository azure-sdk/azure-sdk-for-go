...
// BuildsClientListAuthTokenOptions contains the optional parameters for the BuildsClient.ListAuthToken method.
type BuildsClientListAuthTokenOptions struct {
	// placeholder for future optional parameters
}
...
// ManagedEnvironmentSecretsClientCreateOrUpdateOptions contains the optional parameters for the ManagedEnvironmentSecretsClient.CreateOrUpdate
// method.
type ManagedEnvironmentSecretsClientCreateOrUpdateOptions struct {
	// placeholder for future optional parameters
}

// ManagedEnvironmentSecretsClientDeleteOptions contains the optional parameters for the ManagedEnvironmentSecretsClient.Delete
// method.
type ManagedEnvironmentSecretsClientDeleteOptions struct {
	// placeholder for future optional parameters
}

// ManagedEnvironmentSecretsClientGetOptions contains the optional parameters for the ManagedEnvironmentSecretsClient.Get
// method.
type ManagedEnvironmentSecretsClientGetOptions struct {
	// placeholder for future optional parameters
}

// ManagedEnvironmentSecretsClientGetValueOptions contains the optional parameters for the ManagedEnvironmentSecretsClient.GetValue
// method.
type ManagedEnvironmentSecretsClientGetValueOptions struct {
	// placeholder for future optional parameters
}

// ManagedEnvironmentSecretsClientListOptions contains the optional parameters for the ManagedEnvironmentSecretsClient.NewListPager
// method.
type ManagedEnvironmentSecretsClientListOptions struct {
	// placeholder for future optional parameters
}
