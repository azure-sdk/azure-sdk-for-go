...
type VolumesServer struct {
	...
	BeginCreateOrUpdate func(ctx context.Context, resourceGroupName string, poolName string, volumeName string, resource armcontainerstorage.Volume, options *armcontainerstorage.VolumesClientBeginCreateOrUpdateOptions) (resp azfake.PollerResponder[armcontainerstorage.VolumesClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)

	// BeginDelete is the fake for method VolumesClient.BeginDelete
	// HTTP status codes to indicate success: http.StatusAccepted, http.StatusNoContent
	BeginDelete func(ctx context.Context, resourceGroupName string, poolName string, volumeName string, options *armcontainerstorage.VolumesClientBeginDeleteOptions) (resp azfake.PollerResponder[armcontainerstorage.VolumesClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method VolumesClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, poolName string, volumeName string, options *armcontainerstorage.VolumesClientGetOptions) (resp azfake.Responder[armcontainerstorage.VolumesClientGetResponse], errResp azfake.ErrorResponder)

	// NewListByPoolPager is the fake for method VolumesClient.NewListByPoolPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByPoolPager func(resourceGroupName string, poolName string, options *armcontainerstorage.VolumesClientListByPoolOptions) (resp azfake.PagerResponder[armcontainerstorage.VolumesClientListByPoolResponse])

	// BeginUpdate is the fake for method VolumesClient.BeginUpdate
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginUpdate func(ctx context.Context, resourceGroupName string, poolName string, volumeName string, properties armcontainerstorage.Volume, options *armcontainerstorage.VolumesClientBeginUpdateOptions) (resp azfake.PollerResponder[armcontainerstorage.VolumesClientUpdateResponse], errResp azfake.ErrorResponder)
}
...
func (v *VolumesServerTransport) dispatchBeginCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginCreateOrUpdate == nil {
		...
		respr, errRespr := v.srv.BeginCreateOrUpdate(req.Context(), resourceGroupNameParam, poolNameParam, volumeNameParam, body, nil)
...
func (v *VolumesServerTransport) dispatchBeginDelete(req *http.Request) (*http.Response, error) {
	...
	if beginDelete == nil {
		...
		respr, errRespr := v.srv.BeginDelete(req.Context(), resourceGroupNameParam, poolNameParam, volumeNameParam, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginDelete = &respr
...
func (v *VolumesServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := v.srv.Get(req.Context(), resourceGroupNameParam, poolNameParam, volumeNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
...
func (v *VolumesServerTransport) dispatchNewListByPoolPager(req *http.Request) (*http.Response, error) {
	...
	if newListByPoolPager == nil {
		...
		resp := v.srv.NewListByPoolPager(resourceGroupNameParam, poolNameParam, nil)
...
func (v *VolumesServerTransport) dispatchBeginUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginUpdate == nil {
		...
		respr, errRespr := v.srv.BeginUpdate(req.Context(), resourceGroupNameParam, poolNameParam, volumeNameParam, body, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginUpdate = &respr
