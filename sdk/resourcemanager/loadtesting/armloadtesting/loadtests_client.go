...
func (client *LoadTestsClient) listOutboundNetworkDependenciesEndpointsCreateRequest(ctx context.Context, resourceGroupName string, loadTestName string, _ *LoadTestsClientListOutboundNetworkDependenciesEndpointsOptions) (*policy.Request, error) {
