...
func (client *EmailEventsClient) getCreateRequest(ctx context.Context, resourceGroupName string, testBaseAccountName string, emailEventResourceName string, _ *EmailEventsClientGetOptions) (*policy.Request, error) {
...
func (client *EmailEventsClient) listCreateRequest(ctx context.Context, resourceGroupName string, testBaseAccountName string, _ *EmailEventsClientListOptions) (*policy.Request, error) {
