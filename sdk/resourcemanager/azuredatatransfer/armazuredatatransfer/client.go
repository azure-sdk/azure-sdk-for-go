...
func (client *Client) ListApprovedSchemas(ctx context.Context, body ListApprovedSchemasRequest, options *ClientListApprovedSchemasOptions) (ClientListApprovedSchemasResponse, error) {
	var err error
	const operationName = "Client.ListApprovedSchemas"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.listApprovedSchemasCreateRequest(ctx, body, options)
	if err != nil {
...
func (client *Client) listApprovedSchemasCreateRequest(ctx context.Context, body ListApprovedSchemasRequest, _ *ClientListApprovedSchemasOptions) (*policy.Request, error) {
...
func (client *Client) ValidateSchema(ctx context.Context, body Schema, options *ClientValidateSchemaOptions) (ClientValidateSchemaResponse, error) {
	var err error
	const operationName = "Client.ValidateSchema"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.validateSchemaCreateRequest(ctx, body, options)
	if err != nil {
...
func (client *Client) validateSchemaCreateRequest(ctx context.Context, body Schema, _ *ClientValidateSchemaOptions) (*policy.Request, error) {
