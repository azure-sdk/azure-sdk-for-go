...
func (a AllocationRequestBaseProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "resourceProviderScope", a.ResourceProviderScope)
	return json.Marshal(objectMap)
}
...
func (a *AllocationRequestBaseProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "resourceProviderScope":
			err = unpopulate(val, "ResourceProviderScope", &a.ResourceProviderScope)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", a, err)
...
func (g GroupQuotaDetails) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "resourceProviderScope", g.ResourceProviderScope)
...
func (g *GroupQuotaDetails) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "provisioningState":
			...
			delete(rawMsg, key)
		case "resourceProviderScope":
			err = unpopulate(val, "ResourceProviderScope", &g.ResourceProviderScope)
			delete(rawMsg, key)
		case "unit":
...
func (s SubscriptionQuotaDetails) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "name", s.Name)
	populate(objectMap, "provisioningState", s.ProvisioningState)
	populate(objectMap, "resourceProviderScope", s.ResourceProviderScope)
...
func (s *SubscriptionQuotaDetails) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "provisioningState":
			...
			delete(rawMsg, key)
		case "resourceProviderScope":
			err = unpopulate(val, "ResourceProviderScope", &s.ResourceProviderScope)
			delete(rawMsg, key)
		case "shareableQuota":
