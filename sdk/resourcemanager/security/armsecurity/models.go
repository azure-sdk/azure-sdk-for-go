...
type ScannerConfiguration struct {
	// REQUIRED; Properties of the VM Scanner resource
...
type ScannerProperties struct {
	// Dictionary of string key-value pairs representing the tags used to exclude resources from being scanned. Resources tagged
	// with one of these values will not be scanned. The values in the dictionary are
	// case-sensitive
...
// VMScannersClientCreateOrUpdateOptions contains the optional parameters for the VMScannersClient.CreateOrUpdate method.
type VMScannersClientCreateOrUpdateOptions struct {
	// placeholder for future optional parameters
}

// VMScannersClientDeleteOptions contains the optional parameters for the VMScannersClient.Delete method.
type VMScannersClientDeleteOptions struct {
	// placeholder for future optional parameters
}

// VMScannersClientGetOptions contains the optional parameters for the VMScannersClient.Get method.
type VMScannersClientGetOptions struct {
	// placeholder for future optional parameters
}

// VMScannersClientListBySubscriptionOptions contains the optional parameters for the VMScannersClient.ListBySubscription
// method.
type VMScannersClientListBySubscriptionOptions struct {
	// placeholder for future optional parameters
}
