...
// BeginGetSessionRecordingSasURL - Get SAS URL for session recording for the Bastion Host.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2024-01-01
//   - resourceGroupName - The name of the resource group.
//   - bastionHostName - The name of the Bastion Host.
//   - options - ManagementClientBeginGetSessionRecordingSasURLOptions contains the optional parameters for the ManagementClient.BeginGetSessionRecordingSasURL
//     method.
func (client *ManagementClient) BeginGetSessionRecordingSasURL(ctx context.Context, resourceGroupName string, bastionHostName string, options *ManagementClientBeginGetSessionRecordingSasURLOptions) (*runtime.Poller[ManagementClientGetSessionRecordingSasURLResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.getSessionRecordingSasURL(ctx, resourceGroupName, bastionHostName, options)
		if err != nil {
			return nil, err
		}
		poller, err := runtime.NewPoller(resp, client.internal.Pipeline(), &runtime.NewPollerOptions[ManagementClientGetSessionRecordingSasURLResponse]{
			FinalStateVia: runtime.FinalStateViaLocation,
			Tracer:        client.internal.Tracer(),
		})
		return poller, err
	} else {
		return runtime.NewPollerFromResumeToken(options.ResumeToken, client.internal.Pipeline(), &runtime.NewPollerFromResumeTokenOptions[ManagementClientGetSessionRecordingSasURLResponse]{
			Tracer: client.internal.Tracer(),
		})
	}
}

// GetSessionRecordingSasURL - Get SAS URL for session recording for the Bastion Host.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2024-01-01
func (client *ManagementClient) getSessionRecordingSasURL(ctx context.Context, resourceGroupName string, bastionHostName string, options *ManagementClientBeginGetSessionRecordingSasURLOptions) (*http.Response, error) {
	var err error
	const operationName = "ManagementClient.BeginGetSessionRecordingSasURL"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.getSessionRecordingSasURLCreateRequest(ctx, resourceGroupName, bastionHostName, options)
	if err != nil {
		return nil, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
...
// getSessionRecordingSasURLCreateRequest creates the GetSessionRecordingSasURL request.
func (client *ManagementClient) getSessionRecordingSasURLCreateRequest(ctx context.Context, resourceGroupName string, bastionHostName string, options *ManagementClientBeginGetSessionRecordingSasURLOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/bastionHosts/{bastionHostName}/getSessionRecordingSasUrl"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{subscriptionId}", url.PathEscape(client.subscriptionID))
...
// BeginSetSessionRecordingSasURL - Set SAS URL for session recording for the Bastion Host.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2024-01-01
//   - resourceGroupName - The name of the resource group.
//   - bastionHostName - The name of the Bastion Host.
//   - sasurl - The SAS URL for session recording.
//   - options - ManagementClientBeginSetSessionRecordingSasURLOptions contains the optional parameters for the ManagementClient.BeginSetSessionRecordingSasURL
//     method.
func (client *ManagementClient) BeginSetSessionRecordingSasURL(ctx context.Context, resourceGroupName string, bastionHostName string, sasurl string, options *ManagementClientBeginSetSessionRecordingSasURLOptions) (*runtime.Poller[ManagementClientSetSessionRecordingSasURLResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.setSessionRecordingSasURL(ctx, resourceGroupName, bastionHostName, sasurl, options)
		if err != nil {
			return nil, err
		}
		poller, err := runtime.NewPoller(resp, client.internal.Pipeline(), &runtime.NewPollerOptions[ManagementClientSetSessionRecordingSasURLResponse]{
			FinalStateVia: runtime.FinalStateViaLocation,
			Tracer:        client.internal.Tracer(),
		})
		return poller, err
	} else {
		return runtime.NewPollerFromResumeToken(options.ResumeToken, client.internal.Pipeline(), &runtime.NewPollerFromResumeTokenOptions[ManagementClientSetSessionRecordingSasURLResponse]{
			Tracer: client.internal.Tracer(),
		})
	}
}

// SetSessionRecordingSasURL - Set SAS URL for session recording for the Bastion Host.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2024-01-01
func (client *ManagementClient) setSessionRecordingSasURL(ctx context.Context, resourceGroupName string, bastionHostName string, sasurl string, options *ManagementClientBeginSetSessionRecordingSasURLOptions) (*http.Response, error) {
	var err error
	const operationName = "ManagementClient.BeginSetSessionRecordingSasURL"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.setSessionRecordingSasURLCreateRequest(ctx, resourceGroupName, bastionHostName, sasurl, options)
	if err != nil {
		return nil, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
...
// setSessionRecordingSasURLCreateRequest creates the SetSessionRecordingSasURL request.
func (client *ManagementClient) setSessionRecordingSasURLCreateRequest(ctx context.Context, resourceGroupName string, bastionHostName string, sasurl string, options *ManagementClientBeginSetSessionRecordingSasURLOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/bastionHosts/{bastionHostName}/setSessionRecordingSasUrl"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{subscriptionId}", url.PathEscape(client.subscriptionID))
	...
	req.Raw().URL.RawQuery = reqQP.Encode()
	req.Raw().Header["Accept"] = []string{"application/json"}
	if err := runtime.MarshalAsJSON(req, sasurl); err != nil {
		return nil, err
	}
	return req, nil
}
