...
func (client *LibraryClient) Get(ctx context.Context, resourceGroupName string, libraryName string, workspaceName string, options *LibraryClientGetOptions) (LibraryClientGetResponse, error) {
	var err error
	const operationName = "LibraryClient.Get"
...
func (client *LibraryClient) getCreateRequest(ctx context.Context, resourceGroupName string, libraryName string, workspaceName string, _ *LibraryClientGetOptions) (*policy.Request, error) {
