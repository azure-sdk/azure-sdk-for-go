...
```go
client, err := armazureadexternalidentities.NewB2CTenantsClient(<subscription ID>, cred, nil)
```
...
client, err := armazureadexternalidentities.NewB2CTenantsClient(<subscription ID>, cred, &options)
```
