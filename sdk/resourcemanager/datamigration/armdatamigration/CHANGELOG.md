...
- New enum type `MigrateMySQLAzureDbForMySQLOfflineTaskOutputMigrationLevelMigrationType` with values `MigrateMySQLAzureDbForMySQLOfflineTaskOutputMigrationLevelMigrationTypeInitialLoad`
- New enum type `MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutputMigrationLevelMigrationType` with values `MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutputMigrationLevelMigrationTypeCdc`
- New enum type `MigrateMySQLAzureDbForMySQLSyncTaskOutputMigrationLevelMigrationType` with values `MigrateMySQLAzureDbForMySQLSyncTaskOutputMigrationLevelMigrationTypeInitialLoad`
...
- New function `*MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutputMigrationLevel.GetMigrateMySQLAzureDbForMySQLReplicateChangesTaskOutputMigrationLevel() *MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutputMigrationLevel`
- New function `*MigrateMySQLAzureDbForMySQLReplicateChangesTaskProperties.GetProjectTaskProperties() *ProjectTaskProperties`
- New function `*MigrateMySQLAzureDbForMySQLSyncTaskOutputMigrationLevelV2.GetMigrateMySQLAzureDbForMySQLReplicateChangesTaskOutput() *MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutput`
- New function `*MigrateMySQLAzureDbForMySQLSyncTaskOutputMigrationLevelV2.GetMigrateMySQLAzureDbForMySQLReplicateChangesTaskOutputMigrationLevel() *MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutputMigrationLevel`
- New function `*MigrateMySQLAzureDbForMySQLSyncTaskOutputMigrationLevelV2.GetMigrateMySQLAzureDbForMySQLSyncTaskOutput() *MigrateMySQLAzureDbForMySQLSyncTaskOutput`
...
- New struct `MigrateMySQLAzureDbForMySQLSyncTaskOutputMigrationLevelV2`
...
- New field `SelectedEvents`, `SelectedRoutines`, `SelectedTriggers`, `SelectedViews`, `TablesToMigrateSchema` in struct `MigrateMySQLAzureDbForMySQLOfflineDatabaseInput`
- New field `EncryptedKeyForSecureFields`, `MigrateAllEvents`, `MigrateAllRoutines`, `MigrateAllTablesSchema`, `MigrateAllTriggers`, `MigrateAllViews`, `MigrateUserSystemTables`, `SourceServerResourceID`, `TargetServerResourceID` in struct `MigrateMySQLAzureDbForMySQLOfflineTaskInput`
- New field `MigrationType`, `SourceBinlogPosition` in struct `MigrateMySQLAzureDbForMySQLOfflineTaskOutputMigrationLevel`
- New field `IsCloneable`, `TaskID` in struct `MigrateMySQLAzureDbForMySQLOfflineTaskProperties`
- New field `SelectedEvents`, `SelectedRoutines`, `SelectedTriggers`, `SelectedViews`, `TablesToMigrateSchema` in struct `MigrateMySQLAzureDbForMySQLSyncDatabaseInput`
- New field `EncryptedKeyForSecureFields`, `MigrateAllEvents`, `MigrateAllRoutines`, `MigrateAllTablesSchema`, `MigrateAllTriggers`, `MigrateAllViews`, `MigrateUserSystemTables`, `OptionalAgentSettings`, `SourceServerResourceID`, `StartedOn`, `TargetServerResourceID` in struct `MigrateMySQLAzureDbForMySQLSyncTaskInput`
- New field `MigrationType` in struct `MigrateMySQLAzureDbForMySQLSyncTaskOutputMigrationLevel`
