...
const (
	// SettingTypeTaginheritance - This setting applies, all the resource group and subscription tags to usage data of child resources.
	// Inherited tags will be seen within 24 hours for the current month's usage data.
