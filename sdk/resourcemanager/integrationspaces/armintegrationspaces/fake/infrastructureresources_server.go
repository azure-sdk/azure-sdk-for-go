...
func (i *InfrastructureResourcesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if infrastructureResourcesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = infrastructureResourcesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "InfrastructureResourcesClient.NewListBySpacePager":
				res.resp, res.err = i.dispatchNewListBySpacePager(req)
			case "InfrastructureResourcesClient.Patch":
				res.resp, res.err = i.dispatchPatch(req)
			default:
...
// set this to conditionally intercept incoming requests to InfrastructureResourcesServerTransport
var infrastructureResourcesServerTransportInterceptor interface {
