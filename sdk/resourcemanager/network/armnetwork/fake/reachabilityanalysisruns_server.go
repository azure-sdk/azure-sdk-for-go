...
func (r *ReachabilityAnalysisRunsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if reachabilityAnalysisRunsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = reachabilityAnalysisRunsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to ReachabilityAnalysisRunsServerTransport
var reachabilityAnalysisRunsServerTransportInterceptor interface {
