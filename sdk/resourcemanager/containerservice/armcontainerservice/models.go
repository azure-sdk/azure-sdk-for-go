...
type ManagedClusterAgentPoolProfile struct {
	...
	// fail to run correctly. Create agent pools without specifying a vmSize to allow
	// AKS to find an appropriate VM SKU for your deployment, based on quota and capacity. For more details on restricted VM sizes,
	// see: https://docs.microsoft.com/azure/aks/quotas-skus-regions
	VMSize *string
