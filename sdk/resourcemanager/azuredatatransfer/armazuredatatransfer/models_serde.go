...
func (c ConnectionProperties) MarshalJSON() ([]byte, error) {
	...
	populateTimeRFC3339(objectMap, "dateSubmitted", c.DateSubmitted)
...
func (c *ConnectionProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "approver":
			...
			delete(rawMsg, key)
		case "dateSubmitted":
			err = unpopulateTimeRFC3339(val, "DateSubmitted", &c.DateSubmitted)
			delete(rawMsg, key)
		case "direction":
...
func (p PendingConnection) MarshalJSON() ([]byte, error) {
	...
	populateTimeRFC3339(objectMap, "dateSubmitted", p.DateSubmitted)
...
func (p *PendingConnection) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "approver":
			...
			delete(rawMsg, key)
		case "dateSubmitted":
			err = unpopulateTimeRFC3339(val, "DateSubmitted", &p.DateSubmitted)
			delete(rawMsg, key)
		case "direction":
