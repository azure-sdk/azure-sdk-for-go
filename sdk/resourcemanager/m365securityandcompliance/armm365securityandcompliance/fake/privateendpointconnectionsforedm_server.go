...
// The returned PrivateEndpointConnectionsForEDMServerTransport instance is connected to an instance of armm365securityandcompliance.PrivateEndpointConnectionsForEDMClient via the
...
func NewPrivateEndpointConnectionsForEDMServerTransport(srv *PrivateEndpointConnectionsForEDMServer) *PrivateEndpointConnectionsForEDMServerTransport {
	return &PrivateEndpointConnectionsForEDMServerTransport{
		srv:                   srv,
		beginCreateOrUpdate:   newTracker[azfake.PollerResponder[armm365securityandcompliance.PrivateEndpointConnectionsForEDMClientCreateOrUpdateResponse]](),
		beginDelete:           newTracker[azfake.PollerResponder[armm365securityandcompliance.PrivateEndpointConnectionsForEDMClientDeleteResponse]](),
		newListByServicePager: newTracker[azfake.PagerResponder[armm365securityandcompliance.PrivateEndpointConnectionsForEDMClientListByServiceResponse]](),
	}
}

// PrivateEndpointConnectionsForEDMServerTransport connects instances of armm365securityandcompliance.PrivateEndpointConnectionsForEDMClient to instances of PrivateEndpointConnectionsForEDMServer.
// Don't use this type directly, use NewPrivateEndpointConnectionsForEDMServerTransport instead.
type PrivateEndpointConnectionsForEDMServerTransport struct {
	srv                   *PrivateEndpointConnectionsForEDMServer
	beginCreateOrUpdate   *tracker[azfake.PollerResponder[armm365securityandcompliance.PrivateEndpointConnectionsForEDMClientCreateOrUpdateResponse]]
	beginDelete           *tracker[azfake.PollerResponder[armm365securityandcompliance.PrivateEndpointConnectionsForEDMClientDeleteResponse]]
	newListByServicePager *tracker[azfake.PagerResponder[armm365securityandcompliance.PrivateEndpointConnectionsForEDMClientListByServiceResponse]]
}

// Do implements the policy.Transporter interface for PrivateEndpointConnectionsForEDMServerTransport.
func (p *PrivateEndpointConnectionsForEDMServerTransport) Do(req *http.Request) (*http.Response, error) {
...
func (p *PrivateEndpointConnectionsForEDMServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if privateEndpointConnectionsForEdmServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = privateEndpointConnectionsForEdmServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			case "PrivateEndpointConnectionsForEDMClient.BeginCreateOrUpdate":
				res.resp, res.err = p.dispatchBeginCreateOrUpdate(req)
			case "PrivateEndpointConnectionsForEDMClient.BeginDelete":
				res.resp, res.err = p.dispatchBeginDelete(req)
			case "PrivateEndpointConnectionsForEDMClient.Get":
				res.resp, res.err = p.dispatchGet(req)
			case "PrivateEndpointConnectionsForEDMClient.NewListByServicePager":
...
func (p *PrivateEndpointConnectionsForEDMServerTransport) dispatchBeginCreateOrUpdate(req *http.Request) (*http.Response, error) {
	if p.srv.BeginCreateOrUpdate == nil {
		return nil, &nonRetriableError{errors.New("fake for method BeginCreateOrUpdate not implemented")}
	}
	beginCreateOrUpdate := p.beginCreateOrUpdate.get(req)
	if beginCreateOrUpdate == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.M365SecurityAndCompliance/privateLinkServicesForEDMUpload/(?P<resourceName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/privateEndpointConnections/(?P<privateEndpointConnectionName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)`
...
func (p *PrivateEndpointConnectionsForEDMServerTransport) dispatchBeginDelete(req *http.Request) (*http.Response, error) {
...
func (p *PrivateEndpointConnectionsForEDMServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	if p.srv.Get == nil {
...
func (p *PrivateEndpointConnectionsForEDMServerTransport) dispatchNewListByServicePager(req *http.Request) (*http.Response, error) {
	...
	if newListByServicePager == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.M365SecurityAndCompliance/privateLinkServicesForEDMUpload/(?P<resourceName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/privateEndpointConnections`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		...
		server.PagerResponderInjectNextLinks(newListByServicePager, req, func(page *armm365securityandcompliance.PrivateEndpointConnectionsForEDMClientListByServiceResponse, createLink func() string) {
...
// set this to conditionally intercept incoming requests to PrivateEndpointConnectionsForEDMServerTransport
var privateEndpointConnectionsForEdmServerTransportInterceptor interface {
