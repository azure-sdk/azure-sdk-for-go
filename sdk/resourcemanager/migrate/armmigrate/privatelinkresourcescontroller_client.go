...
func (client *PrivateLinkResourcesControllerClient) getCreateRequest(ctx context.Context, resourceGroupName string, siteName string, privateLinkResourceName string, _ *PrivateLinkResourcesControllerClientGetOptions) (*policy.Request, error) {
...
func (client *PrivateLinkResourcesControllerClient) listByMasterSiteCreateRequest(ctx context.Context, resourceGroupName string, siteName string, _ *PrivateLinkResourcesControllerClientListByMasterSiteOptions) (*policy.Request, error) {
