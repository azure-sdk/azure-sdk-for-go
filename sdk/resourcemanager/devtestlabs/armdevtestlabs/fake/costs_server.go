...
func (c *CostsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if costsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = costsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to CostsServerTransport
var costsServerTransportInterceptor interface {
