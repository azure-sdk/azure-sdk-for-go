...
// EvidenceClientListByReportResourceResponse contains the response from method EvidenceClient.NewListByReportResourcePager.
type EvidenceClientListByReportResourceResponse struct {
...
// ReportClientCheckNameAvailabilityResponse contains the response from method ReportClient.CheckNameAvailability.
type ReportClientCheckNameAvailabilityResponse struct {
	// The check availability result.
	CheckNameAvailabilityResponse
}
...
// ReportClientListByTenantResponse contains the response from method ReportClient.NewListByTenantPager.
type ReportClientListByTenantResponse struct {
...
// ScopingConfigurationClientListByReportResourceResponse contains the response from method ScopingConfigurationClient.NewListByReportResourcePager.
type ScopingConfigurationClientListByReportResourceResponse struct {
...
// SnapshotClientListByReportResourceResponse contains the response from method SnapshotClient.NewListByReportResourcePager.
type SnapshotClientListByReportResourceResponse struct {
...
// WebhookClientListByReportResourceResponse contains the response from method WebhookClient.NewListByReportResourcePager.
type WebhookClientListByReportResourceResponse struct {
