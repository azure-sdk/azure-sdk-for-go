...
type DataPlaneAuthOptions struct {
	...
	APIKeyOnly any `json:"apiKeyOnly,omitempty"`
}
...
type EncryptionWithCmk struct {
	...
	EncryptionComplianceStatus *SearchEncryptionComplianceStatus `json:"encryptionComplianceStatus,omitempty" azure:"ro"`
}
