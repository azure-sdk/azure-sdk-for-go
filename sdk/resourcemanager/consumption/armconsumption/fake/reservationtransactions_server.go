...
func (r *ReservationTransactionsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if reservationTransactionsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = reservationTransactionsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to ReservationTransactionsServerTransport
var reservationTransactionsServerTransportInterceptor interface {
