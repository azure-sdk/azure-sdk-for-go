...
func (w WorkspaceResourceProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "managedStorageAccount", w.ManagedStorageAccount)
...
func (w *WorkspaceResourceProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "managedOnBehalfOfConfiguration":
			...
			delete(rawMsg, key)
		case "managedStorageAccount":
			err = unpopulate(val, "ManagedStorageAccount", &w.ManagedStorageAccount)
			delete(rawMsg, key)
		case "providers":
...
// MarshalJSON implements the json.Marshaller interface for type WorkspaceTagsUpdate.
func (w WorkspaceTagsUpdate) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "tags", w.Tags)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type WorkspaceTagsUpdate.
func (w *WorkspaceTagsUpdate) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", w, err)
	}
