...
// BeginDelete - Delete a LoadBalancer
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2023-10-01-preview
//   - resourceURI - The fully qualified Azure Resource manager identifier of the resource.
...
//     method.
func (client *LoadBalancersClient) BeginDelete(ctx context.Context, resourceURI string, loadBalancerName string, options *LoadBalancersClientBeginDeleteOptions) (*runtime.Poller[LoadBalancersClientDeleteResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.deleteOperation(ctx, resourceURI, loadBalancerName, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2023-10-01-preview
func (client *LoadBalancersClient) deleteOperation(ctx context.Context, resourceURI string, loadBalancerName string, options *LoadBalancersClientBeginDeleteOptions) (*http.Response, error) {
	var err error
...
func (client *LoadBalancersClient) deleteCreateRequest(ctx context.Context, resourceURI string, loadBalancerName string, options *LoadBalancersClientBeginDeleteOptions) (*policy.Request, error) {
	urlPath := "/{resourceUri}/providers/Microsoft.KubernetesRuntime/loadBalancers/{loadBalancerName}"
	urlPath = strings.ReplaceAll(urlPath, "{resourceUri}", resourceURI)
	if loadBalancerName == "" {
		return nil, errors.New("parameter loadBalancerName cannot be empty")
