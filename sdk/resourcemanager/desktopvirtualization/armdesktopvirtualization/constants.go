...
// CanaryPolicy - Policy on whether a Canary VM should be provisioned during a session host provisioning operation.
type CanaryPolicy string

const (
	CanaryPolicyAlways CanaryPolicy = "Always"
	CanaryPolicyAuto   CanaryPolicy = "Auto"
	CanaryPolicyNever  CanaryPolicy = "Never"
)

// PossibleCanaryPolicyValues returns the possible values for the CanaryPolicy const type.
func PossibleCanaryPolicyValues() []CanaryPolicy {
	return []CanaryPolicy{
		CanaryPolicyAlways,
		CanaryPolicyAuto,
		CanaryPolicyNever,
...
// DiffDiskOption - Specifies the ephemeral disk settings for operating system disk.
type DiffDiskOption string

const (
	// DiffDiskOptionLocal - Operating system disk local setting
	DiffDiskOptionLocal DiffDiskOption = "Local"
)

// PossibleDiffDiskOptionValues returns the possible values for the DiffDiskOption const type.
func PossibleDiffDiskOptionValues() []DiffDiskOption {
	return []DiffDiskOption{
		DiffDiskOptionLocal,
	}
}

// DiffDiskPlacement - Gets or sets specifies the ephemeral disk placement for operating system disk. The defaulting behavior
// is: CacheDisk if one is configured for the VM size otherwise ResourceDisk is used. Refer to the
...
const (
	// DiffDiskPlacementCacheDisk - Cache disk placement
	DiffDiskPlacementCacheDisk DiffDiskPlacement = "CacheDisk"
	// DiffDiskPlacementResourceDisk - Resource disk placement
...
// FailedSessionHostCleanupPolicySHC - The policy that should be applied when the Session Host provisioning operation fails.
type FailedSessionHostCleanupPolicySHC string

const (
	FailedSessionHostCleanupPolicySHCKeepAll  FailedSessionHostCleanupPolicySHC = "KeepAll"
	FailedSessionHostCleanupPolicySHCKeepNone FailedSessionHostCleanupPolicySHC = "KeepNone"
	FailedSessionHostCleanupPolicySHCKeepOne  FailedSessionHostCleanupPolicySHC = "KeepOne"
)

// PossibleFailedSessionHostCleanupPolicySHCValues returns the possible values for the FailedSessionHostCleanupPolicySHC const type.
func PossibleFailedSessionHostCleanupPolicySHCValues() []FailedSessionHostCleanupPolicySHC {
	return []FailedSessionHostCleanupPolicySHC{
		...
		FailedSessionHostCleanupPolicySHCKeepOne,
	}
}
...
// HostPoolProvisioningAction - Action types for controlling hostpool provisioning.
type HostPoolProvisioningAction string

const (
	// HostPoolProvisioningActionCancel - Cancel the hostpool provisioning.
	HostPoolProvisioningActionCancel HostPoolProvisioningAction = "Cancel"
)

// PossibleHostPoolProvisioningActionValues returns the possible values for the HostPoolProvisioningAction const type.
func PossibleHostPoolProvisioningActionValues() []HostPoolProvisioningAction {
	return []HostPoolProvisioningAction{
		HostPoolProvisioningActionCancel,
	}
}
...
// ScalingMethod - The desired scaling method to be used to scale the hosts in the assigned host pool.
type ScalingMethod string

const (
	// ScalingMethodCreateDeletePowerManage - Scaling will manage the hosts in the host pool by power managing the hosts, as well
	// as creating and deleting hosts to modify the host pool size. This requires the create delete object to be set, and the
	// assigned hostpool to have a session host config property.
	ScalingMethodCreateDeletePowerManage ScalingMethod = "CreateDeletePowerManage"
	// ScalingMethodPowerManage - Scaling will manage hosts in the host pool by power managing the hosts, but will not change
	// the host pool size.
	ScalingMethodPowerManage ScalingMethod = "PowerManage"
)

// PossibleScalingMethodValues returns the possible values for the ScalingMethod const type.
func PossibleScalingMethodValues() []ScalingMethod {
	return []ScalingMethod{
		ScalingMethodCreateDeletePowerManage,
		ScalingMethodPowerManage,
	}
}
