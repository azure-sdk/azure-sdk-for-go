...
//     method.
func (client *PrivateCloudsClient) NewListByResourceGroupPager(resourceGroupName string, options *PrivateCloudsClientListByResourceGroupOptions) *runtime.Pager[PrivateCloudsClientListByResourceGroupResponse] {
...
func (client *PrivateCloudsClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, _ *PrivateCloudsClientListByResourceGroupOptions) (*policy.Request, error) {
...
func (client *PrivateCloudsClient) Update(ctx context.Context, resourceGroupName string, privateCloudName string, privateCloudUpdate PrivateCloudUpdate, options *PrivateCloudsClientUpdateOptions) (PrivateCloudsClientUpdateResponse, error) {
	var err error
	const operationName = "PrivateCloudsClient.Update"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
...
func (client *PrivateCloudsClient) updateCreateRequest(ctx context.Context, resourceGroupName string, privateCloudName string, privateCloudUpdate PrivateCloudUpdate, _ *PrivateCloudsClientUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AVS/privateClouds/{privateCloudName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
