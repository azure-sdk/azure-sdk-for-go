...
func NewRegistryEnvironmentVersionsClient(subscriptionID string, credential azcore.TokenCredential, options *arm.ClientOptions) (*RegistryEnvironmentVersionsClient, error) {
	cl, err := arm.NewClient(moduleName+".RegistryEnvironmentVersionsClient", moduleVersion, credential, options)
	if err != nil {
		return nil, err
	}
...
func (client *RegistryEnvironmentVersionsClient) BeginCreateOrUpdate(ctx context.Context, resourceGroupName string, registryName string, environmentName string, version string, body EnvironmentVersion, options *RegistryEnvironmentVersionsClientBeginCreateOrUpdateOptions) (*runtime.Poller[RegistryEnvironmentVersionsClientCreateOrUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return runtime.NewPollerFromResumeToken[RegistryEnvironmentVersionsClientCreateOrUpdateResponse](options.ResumeToken, client.internal.Pipeline(), nil)
	}
}
...
func (client *RegistryEnvironmentVersionsClient) BeginDelete(ctx context.Context, resourceGroupName string, registryName string, environmentName string, version string, options *RegistryEnvironmentVersionsClientBeginDeleteOptions) (*runtime.Poller[RegistryEnvironmentVersionsClientDeleteResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return runtime.NewPollerFromResumeToken[RegistryEnvironmentVersionsClientDeleteResponse](options.ResumeToken, client.internal.Pipeline(), nil)
	}
}
...
// GetBlobReferenceSAS - Get a SAS for a blob reference associated with the environment
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2023-10-01
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - registryName - Name of Azure Machine Learning registry. This is case-insensitive
//   - environmentName - Environment name. This is case-sensitive.
//   - version - Version identifier. This is case-sensitive.
//   - body - blob reference request object
//   - options - RegistryEnvironmentVersionsClientGetBlobReferenceSASOptions contains the optional parameters for the RegistryEnvironmentVersionsClient.GetBlobReferenceSAS
//     method.
func (client *RegistryEnvironmentVersionsClient) GetBlobReferenceSAS(ctx context.Context, resourceGroupName string, registryName string, environmentName string, version string, body BlobReferenceSASRequestDto, options *RegistryEnvironmentVersionsClientGetBlobReferenceSASOptions) (RegistryEnvironmentVersionsClientGetBlobReferenceSASResponse, error) {
	var err error
	req, err := client.getBlobReferenceSASCreateRequest(ctx, resourceGroupName, registryName, environmentName, version, body, options)
	if err != nil {
		return RegistryEnvironmentVersionsClientGetBlobReferenceSASResponse{}, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
	if err != nil {
		return RegistryEnvironmentVersionsClientGetBlobReferenceSASResponse{}, err
...
func (client *RegistryEnvironmentVersionsClient) getBlobReferenceSASCreateRequest(ctx context.Context, resourceGroupName string, registryName string, environmentName string, version string, body BlobReferenceSASRequestDto, options *RegistryEnvironmentVersionsClientGetBlobReferenceSASOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/registries/{registryName}/environments/{environmentName}/versions/{version}/getBlobReferenceSAS"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{subscriptionId}", url.PathEscape(client.subscriptionID))
...
func (client *RegistryEnvironmentVersionsClient) getBlobReferenceSASHandleResponse(resp *http.Response) (RegistryEnvironmentVersionsClientGetBlobReferenceSASResponse, error) {
	result := RegistryEnvironmentVersionsClientGetBlobReferenceSASResponse{}
