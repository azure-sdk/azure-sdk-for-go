...
func NewDefenderForStorageClient(credential azcore.TokenCredential, options *arm.ClientOptions) (*DefenderForStorageClient, error) {
	cl, err := arm.NewClient(moduleName+".DefenderForStorageClient", moduleVersion, credential, options)
	if err != nil {
		return nil, err
	}
...
// Create - Creates or updates the Defender for Storage settings on a specified resource.
...
func (client *DefenderForStorageClient) Create(ctx context.Context, resourceID string, settingName SettingNameAutoGenerated, defenderForStorageSetting DefenderForStorageSetting, options *DefenderForStorageClientCreateOptions) (DefenderForStorageClientCreateResponse, error) {
	...
	if !runtime.HasStatusCode(resp, http.StatusOK, http.StatusCreated) {
		return DefenderForStorageClientCreateResponse{}, runtime.NewResponseError(resp)
	}
...
func (client *DefenderForStorageClient) createCreateRequest(ctx context.Context, resourceID string, settingName SettingNameAutoGenerated, defenderForStorageSetting DefenderForStorageSetting, options *DefenderForStorageClientCreateOptions) (*policy.Request, error) {
	...
	return req, runtime.MarshalAsJSON(req, defenderForStorageSetting)
}
...
// Get - Gets the Defender for Storage settings for the specified resource.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2022-12-01-preview
//   - resourceID - The identifier of the resource.
...
func (client *DefenderForStorageClient) Get(ctx context.Context, resourceID string, settingName SettingNameAutoGenerated, options *DefenderForStorageClientGetOptions) (DefenderForStorageClientGetResponse, error) {
	...
	if !runtime.HasStatusCode(resp, http.StatusOK) {
		return DefenderForStorageClientGetResponse{}, runtime.NewResponseError(resp)
	}
