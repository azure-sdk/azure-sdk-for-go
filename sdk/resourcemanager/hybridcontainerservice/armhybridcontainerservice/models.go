...
// KubernetesVersionProfilePropertiesAutoGenerated - Kubernetes version profile for given major.minor release
type KubernetesVersionProfilePropertiesAutoGenerated struct {
...
type KubernetesVersionReadiness struct {
	...
	// READ-ONLY; The particular KubernetesVersion's Image's OS SKU (CBLMariner, Windows, Windows2022)
	OSSKU *OsSKU
...
// ProvisionedClusterUpgradeProfileList - List of upgradeProfiles for the provisioned cluster.
type ProvisionedClusterUpgradeProfileList struct {
	// Url to follow for getting next page of upgradeProfiles.
	NextLink *string

	// Array of upgradeProfiles
	Value []*ProvisionedClusterUpgradeProfile
}
...
// VMSKUProfilePropertiesAutoGenerated - The profile for supported VM skus
type VMSKUProfilePropertiesAutoGenerated struct {
