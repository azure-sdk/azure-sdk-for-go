...
type AutoImportJobPropertiesStatus struct {
	...
	// READ-ONLY; The time (in UTC) of the last completed auto import job.
	LastCompletionTimeUTC *time.Time

	// READ-ONLY; The time (in UTC) the latest auto import job started.
	LastStartedTimeUTC *time.Time
...
type AutoImportJobPropertiesStatusBlobSyncEvents struct {
	...
	// READ-ONLY; Rate of blob import per second during auto import.
	RateOfBlobImport *int64
