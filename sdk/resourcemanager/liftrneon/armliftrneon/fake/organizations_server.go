...
// OrganizationsServer is a fake server for instances of the armliftrneon.OrganizationsClient type.
type OrganizationsServer struct {
	...
	BeginCreateOrUpdate func(ctx context.Context, resourceGroupName string, organizationName string, resource armliftrneon.OrganizationResource, options *armliftrneon.OrganizationsClientBeginCreateOrUpdateOptions) (resp azfake.PollerResponder[armliftrneon.OrganizationsClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)

	// BeginDelete is the fake for method OrganizationsClient.BeginDelete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginDelete func(ctx context.Context, resourceGroupName string, organizationName string, options *armliftrneon.OrganizationsClientBeginDeleteOptions) (resp azfake.PollerResponder[armliftrneon.OrganizationsClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method OrganizationsClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, organizationName string, options *armliftrneon.OrganizationsClientGetOptions) (resp azfake.Responder[armliftrneon.OrganizationsClientGetResponse], errResp azfake.ErrorResponder)

	// NewListByResourceGroupPager is the fake for method OrganizationsClient.NewListByResourceGroupPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByResourceGroupPager func(resourceGroupName string, options *armliftrneon.OrganizationsClientListByResourceGroupOptions) (resp azfake.PagerResponder[armliftrneon.OrganizationsClientListByResourceGroupResponse])

	// NewListBySubscriptionPager is the fake for method OrganizationsClient.NewListBySubscriptionPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListBySubscriptionPager func(options *armliftrneon.OrganizationsClientListBySubscriptionOptions) (resp azfake.PagerResponder[armliftrneon.OrganizationsClientListBySubscriptionResponse])

	// BeginUpdate is the fake for method OrganizationsClient.BeginUpdate
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginUpdate func(ctx context.Context, resourceGroupName string, organizationName string, properties armliftrneon.OrganizationResource, options *armliftrneon.OrganizationsClientBeginUpdateOptions) (resp azfake.PollerResponder[armliftrneon.OrganizationsClientUpdateResponse], errResp azfake.ErrorResponder)
}

// NewOrganizationsServerTransport creates a new instance of OrganizationsServerTransport with the provided implementation.
// The returned OrganizationsServerTransport instance is connected to an instance of armliftrneon.OrganizationsClient via the
...
func NewOrganizationsServerTransport(srv *OrganizationsServer) *OrganizationsServerTransport {
	return &OrganizationsServerTransport{
		srv:                         srv,
		beginCreateOrUpdate:         newTracker[azfake.PollerResponder[armliftrneon.OrganizationsClientCreateOrUpdateResponse]](),
		beginDelete:                 newTracker[azfake.PollerResponder[armliftrneon.OrganizationsClientDeleteResponse]](),
		newListByResourceGroupPager: newTracker[azfake.PagerResponder[armliftrneon.OrganizationsClientListByResourceGroupResponse]](),
		newListBySubscriptionPager:  newTracker[azfake.PagerResponder[armliftrneon.OrganizationsClientListBySubscriptionResponse]](),
		beginUpdate:                 newTracker[azfake.PollerResponder[armliftrneon.OrganizationsClientUpdateResponse]](),
	}
}

// OrganizationsServerTransport connects instances of armliftrneon.OrganizationsClient to instances of OrganizationsServer.
...
type OrganizationsServerTransport struct {
	...
	beginCreateOrUpdate         *tracker[azfake.PollerResponder[armliftrneon.OrganizationsClientCreateOrUpdateResponse]]
	beginDelete                 *tracker[azfake.PollerResponder[armliftrneon.OrganizationsClientDeleteResponse]]
	newListByResourceGroupPager *tracker[azfake.PagerResponder[armliftrneon.OrganizationsClientListByResourceGroupResponse]]
	newListBySubscriptionPager  *tracker[azfake.PagerResponder[armliftrneon.OrganizationsClientListBySubscriptionResponse]]
	beginUpdate                 *tracker[azfake.PollerResponder[armliftrneon.OrganizationsClientUpdateResponse]]
}
...
func (o *OrganizationsServerTransport) dispatchBeginCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginCreateOrUpdate == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armliftrneon.OrganizationResource](req)
		if err != nil {
			return nil, err
		}
...
func (o *OrganizationsServerTransport) dispatchNewListByResourceGroupPager(req *http.Request) (*http.Response, error) {
	...
	if newListByResourceGroupPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListByResourceGroupPager, req, func(page *armliftrneon.OrganizationsClientListByResourceGroupResponse, createLink func() string) {
...
func (o *OrganizationsServerTransport) dispatchNewListBySubscriptionPager(req *http.Request) (*http.Response, error) {
	...
	if newListBySubscriptionPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListBySubscriptionPager, req, func(page *armliftrneon.OrganizationsClientListBySubscriptionResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
