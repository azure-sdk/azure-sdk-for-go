...
type Server struct {
	...
	// HTTP status codes to indicate success: http.StatusOK
	Update func(ctx context.Context, resourceGroupName string, azureLargeInstanceName string, tagsParameter armazurelargeinstance.TagsUpdate, options *armazurelargeinstance.ClientUpdateOptions) (resp azfake.Responder[armazurelargeinstance.ClientUpdateResponse], errResp azfake.ErrorResponder)
}
