...
type MonitorsServer struct {
	...
	BeginCreate func(ctx context.Context, resourceGroupName string, monitorName string, resource armworkloads.Monitor, options *armworkloads.MonitorsClientBeginCreateOptions) (resp azfake.PollerResponder[armworkloads.MonitorsClientCreateResponse], errResp azfake.ErrorResponder)
	...
	BeginUpdate func(ctx context.Context, resourceGroupName string, monitorName string, properties armworkloads.UpdateMonitorRequest, options *armworkloads.MonitorsClientBeginUpdateOptions) (resp azfake.PollerResponder[armworkloads.MonitorsClientUpdateResponse], errResp azfake.ErrorResponder)
}
...
func NewMonitorsServerTransport(srv *MonitorsServer) *MonitorsServerTransport {
	return &MonitorsServerTransport{
		...
		beginUpdate:                 newTracker[azfake.PollerResponder[armworkloads.MonitorsClientUpdateResponse]](),
	}
}
...
type MonitorsServerTransport struct {
	...
	beginUpdate                 *tracker[azfake.PollerResponder[armworkloads.MonitorsClientUpdateResponse]]
}
