...
type DataMaskingPoliciesServer struct {
	...
	CreateOrUpdate func(ctx context.Context, resourceGroupName string, serverName string, databaseName string, dataMaskingPolicyName armsql.DataMaskingPolicyName, parameters armsql.DataMaskingPolicy, options *armsql.DataMaskingPoliciesClientCreateOrUpdateOptions) (resp azfake.Responder[armsql.DataMaskingPoliciesClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method DataMaskingPoliciesClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, serverName string, databaseName string, dataMaskingPolicyName armsql.DataMaskingPolicyName, options *armsql.DataMaskingPoliciesClientGetOptions) (resp azfake.Responder[armsql.DataMaskingPoliciesClientGetResponse], errResp azfake.ErrorResponder)
}
...
func (d *DataMaskingPoliciesServerTransport) dispatchCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := d.srv.CreateOrUpdate(req.Context(), resourceGroupNameParam, serverNameParam, databaseNameParam, dataMaskingPolicyNameParam, body, nil)
...
func (d *DataMaskingPoliciesServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := d.srv.Get(req.Context(), resourceGroupNameParam, serverNameParam, databaseNameParam, dataMaskingPolicyNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
