...
// ContainerAppsAPIClientGetVerificationIDResponse contains the response from method ContainerAppsAPIClient.GetVerificationID.
type ContainerAppsAPIClientGetVerificationIDResponse struct {
	// Verification Id of a subscription
	Value *string
}
