...
func (f *FormulasServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if formulasServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = formulasServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to FormulasServerTransport
var formulasServerTransportInterceptor interface {
