...
type AzureLargeStorageInstancesServer struct {
	// Create is the fake for method AzureLargeStorageInstancesClient.Create
	// HTTP status codes to indicate success: http.StatusOK, http.StatusCreated
	Create func(ctx context.Context, resourceGroupName string, azureLargeStorageInstanceName string, requestBodyParameters armazurelargeinstance.AzureLargeStorageInstance, options *armazurelargeinstance.AzureLargeStorageInstancesClientCreateOptions) (resp azfake.Responder[armazurelargeinstance.AzureLargeStorageInstancesClientCreateResponse], errResp azfake.ErrorResponder)

	// Delete is the fake for method AzureLargeStorageInstancesClient.Delete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	Delete func(ctx context.Context, resourceGroupName string, azureLargeStorageInstanceName string, options *armazurelargeinstance.AzureLargeStorageInstancesClientDeleteOptions) (resp azfake.Responder[armazurelargeinstance.AzureLargeStorageInstancesClientDeleteResponse], errResp azfake.ErrorResponder)
...
func (a *AzureLargeStorageInstancesServerTransport) Do(req *http.Request) (*http.Response, error) {
	...
	switch method {
	case "AzureLargeStorageInstancesClient.Create":
		resp, err = a.dispatchCreate(req)
	case "AzureLargeStorageInstancesClient.Delete":
...
func (a *AzureLargeStorageInstancesServerTransport) dispatchCreate(req *http.Request) (*http.Response, error) {
	if a.srv.Create == nil {
	...
	body, err := server.UnmarshalRequestAsJSON[armazurelargeinstance.AzureLargeStorageInstance](req)
	if err != nil {
		return nil, err
	}
...
func (a *AzureLargeStorageInstancesServerTransport) dispatchDelete(req *http.Request) (*http.Response, error) {
	if a.srv.Delete == nil {
