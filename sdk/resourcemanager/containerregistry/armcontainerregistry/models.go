...
type ArchiveListResult struct {
	...
	// distributions.
	Value []*Archive `json:"value,omitempty"`
}
...
type ArchiveVersionListResult struct {
	...
	Value []*ArchiveVersion `json:"value,omitempty"`
}
...
// ArchivesClientBeginUpdateOptions contains the optional parameters for the ArchivesClient.BeginUpdate method.
type ArchivesClientBeginUpdateOptions struct {
	// Resumes the LRO from the provided token.
	ResumeToken string
}
