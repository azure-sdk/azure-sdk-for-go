...
type MigrateMySQLAzureDbForMySQLOfflineDatabaseInput struct {
	...
	TablesToMigrateSchema map[string]*string
...
// MigrateMySQLAzureDbForMySQLOfflineTaskInputOptionalAgentSettings - Optional parameters for fine tuning the data migration
...
// MigrateMySQLAzureDbForMySQLOfflineTaskOutput - MySQL to Azure Database for MySQL offline migration task output
...
type MigrateMySQLAzureDbForMySQLOfflineTaskOutputMigrationLevel struct {
	...
	// READ-ONLY
	MigrationType *MigrateMySQLAzureDbForMySQLOfflineTaskOutputMigrationLevelMigrationType

	// READ-ONLY; The binlog position when the consistent snapshot was taken. Only returned when consistent backup is enabled
	// in the migration inputs.
	SourceBinlogPosition *MySQLBinlogPositionOutput
...
type MigrateMySQLAzureDbForMySQLOfflineTaskOutputTableLevel struct {
	...
	// READ-ONLY; Table migration end time
	EndedOn *time.Time
	...
	// READ-ONLY; Table migration start time
	StartedOn *time.Time
...
type MigrateMySQLAzureDbForMySQLReplicateChangesTaskInput struct {
	// REQUIRED; The binlog position to start replicating the changes at
...
// Use a type switch to determine the concrete type.  The possible types are:
// - *MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutput, *MigrateMySQLAzureDbForMySQLSyncTaskOutputMigrationLevelV2
...
// MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutputMigrationLevelClassification provides polymorphic access to related types.
// Call the interface's GetMigrateMySQLAzureDbForMySQLReplicateChangesTaskOutputMigrationLevel() method to access the common type.
// Use a type switch to determine the concrete type.  The possible types are:
// - *MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutputMigrationLevel, *MigrateMySQLAzureDbForMySQLSyncTaskOutputMigrationLevelV2
type MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutputMigrationLevelClassification interface {
	MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutputClassification
	// GetMigrateMySQLAzureDbForMySQLReplicateChangesTaskOutputMigrationLevel returns the MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutputMigrationLevel content of the underlying type.
	GetMigrateMySQLAzureDbForMySQLReplicateChangesTaskOutputMigrationLevel() *MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutputMigrationLevel
}
...
type MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutputMigrationLevel struct {
	...
	ContinuousDataMovementProgress *MySQLContinuousDataMovementProgress

	// READ-ONLY; Migration end time
	EndedOn *time.Time

	// READ-ONLY; Indicates that the migration has server level error
	HasServerLevelError *bool
	...
	// READ-ONLY
	MigrationType *MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutputMigrationLevelMigrationType
...
// GetMigrateMySQLAzureDbForMySQLReplicateChangesTaskOutputMigrationLevel implements the MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutputMigrationLevelClassification
// interface for type MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutputMigrationLevel.
func (m *MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutputMigrationLevel) GetMigrateMySQLAzureDbForMySQLReplicateChangesTaskOutputMigrationLevel() *MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutputMigrationLevel {
	return m
}
...
type MigrateMySQLAzureDbForMySQLReplicateChangesTaskProperties struct {
	...
	// READ-ONLY; Task output. This is ignored if submitted.
	Output []MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutputClassification
...
// - *MigrateMySQLAzureDbForMySQLSyncTaskOutputError, *MigrateMySQLAzureDbForMySQLSyncTaskOutputMigrationLevelV2, *MigrateMySQLAzureDbForMySQLSyncTaskOutputTableLevel
...
// MigrateMySQLAzureDbForMySQLSyncTaskOutput - MySQL to Azure Database for MySQL online migration task output
...
type MigrateMySQLAzureDbForMySQLSyncTaskOutputMigrationLevel struct {
	...
	// READ-ONLY
	MigrationType *MigrateMySQLAzureDbForMySQLSyncTaskOutputMigrationLevelMigrationType
...
type MigrateMySQLAzureDbForMySQLSyncTaskOutputMigrationLevelV2 struct {
	// REQUIRED; Result type
	ResultType *string
...
// GetMigrateMySQLAzureDbForMySQLReplicateChangesTaskOutput implements the MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutputClassification
// interface for type MigrateMySQLAzureDbForMySQLSyncTaskOutputMigrationLevelV2.
func (m *MigrateMySQLAzureDbForMySQLSyncTaskOutputMigrationLevelV2) GetMigrateMySQLAzureDbForMySQLReplicateChangesTaskOutput() *MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutput {
	return &MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutput{
		ID:         m.ID,
		ResultType: m.ResultType,
	}
...
// GetMigrateMySQLAzureDbForMySQLReplicateChangesTaskOutputMigrationLevel implements the MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutputMigrationLevelClassification
// interface for type MigrateMySQLAzureDbForMySQLSyncTaskOutputMigrationLevelV2.
func (m *MigrateMySQLAzureDbForMySQLSyncTaskOutputMigrationLevelV2) GetMigrateMySQLAzureDbForMySQLReplicateChangesTaskOutputMigrationLevel() *MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutputMigrationLevel {
	return &MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutputMigrationLevel{
		MigrationType:                  m.MigrationType,
		StartedOn:                      m.StartedOn,
		EndedOn:                        m.EndedOn,
		Status:                         m.Status,
		SourceServerVersion:            m.SourceServerVersion,
		TargetServerVersion:            m.TargetServerVersion,
		LastStorageUpdate:              m.LastStorageUpdate,
		MigrationID:                    m.MigrationID,
		HasServerLevelError:            m.HasServerLevelError,
		RetryingSummary:                m.RetryingSummary,
		TotalRetryingTime:              m.TotalRetryingTime,
		TotalSourceRetryCount:          m.TotalSourceRetryCount,
		TotalTargetRetryCount:          m.TotalTargetRetryCount,
		TotalOtherRetryCount:           m.TotalOtherRetryCount,
		ContinuousDataMovementProgress: m.ContinuousDataMovementProgress,
		ID:                             m.ID,
		ResultType:                     m.ResultType,
	}
}
...
// GetMigrateMySQLAzureDbForMySQLSyncTaskOutput implements the MigrateMySQLAzureDbForMySQLSyncTaskOutputClassification interface
// for type MigrateMySQLAzureDbForMySQLSyncTaskOutputMigrationLevelV2.
func (m *MigrateMySQLAzureDbForMySQLSyncTaskOutputMigrationLevelV2) GetMigrateMySQLAzureDbForMySQLSyncTaskOutput() *MigrateMySQLAzureDbForMySQLSyncTaskOutput {
	return &MigrateMySQLAzureDbForMySQLSyncTaskOutput{
		ID:         m.ID,
		ResultType: m.ResultType,
	}
...
type MySQLBinlogPositionOutput struct {
	// READ-ONLY; Specifies the the sequential number of the binlog fie, extracted from the file name
	FileSeqNum *int32
