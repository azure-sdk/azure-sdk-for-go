...
func NewContainerAppsBuildsClient(subscriptionID string, containerAppName string, credential azcore.TokenCredential, options *arm.ClientOptions) (*ContainerAppsBuildsClient, error) {
...
//     method.
func (client *ContainerAppsBuildsClient) BeginDelete(ctx context.Context, resourceGroupName string, buildName string, options *ContainerAppsBuildsClientBeginDeleteOptions) (*runtime.Poller[ContainerAppsBuildsClientDeleteResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.deleteOperation(ctx, resourceGroupName, buildName, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2024-02-02-preview
func (client *ContainerAppsBuildsClient) deleteOperation(ctx context.Context, resourceGroupName string, buildName string, options *ContainerAppsBuildsClientBeginDeleteOptions) (*http.Response, error) {
	var err error
	const operationName = "ContainerAppsBuildsClient.BeginDelete"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.deleteCreateRequest(ctx, resourceGroupName, buildName, options)
	if err != nil {
		return nil, err
	}
...
func (client *ContainerAppsBuildsClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, buildName string, options *ContainerAppsBuildsClientBeginDeleteOptions) (*policy.Request, error) {
...
func (client *ContainerAppsBuildsClient) Get(ctx context.Context, resourceGroupName string, buildName string, options *ContainerAppsBuildsClientGetOptions) (ContainerAppsBuildsClientGetResponse, error) {
	var err error
	const operationName = "ContainerAppsBuildsClient.Get"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.getCreateRequest(ctx, resourceGroupName, buildName, options)
	if err != nil {
...
func (client *ContainerAppsBuildsClient) getCreateRequest(ctx context.Context, resourceGroupName string, buildName string, options *ContainerAppsBuildsClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.App/containerApps/{containerAppName}/builds/{buildName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
