...
func (client *ExtensionPublisherClient) listCreateRequest(ctx context.Context, location string, options *ExtensionPublisherClientListOptions) (*policy.Request, error) {
