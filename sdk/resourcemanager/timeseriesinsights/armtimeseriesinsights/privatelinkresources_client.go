...
func (client *PrivateLinkResourcesClient) listSupportedCreateRequest(ctx context.Context, resourceGroupName string, environmentName string, _ *PrivateLinkResourcesClientListSupportedOptions) (*policy.Request, error) {
