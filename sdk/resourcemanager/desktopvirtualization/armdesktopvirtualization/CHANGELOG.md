...
- New function `*ClientFactory.NewValidateSessionHostUpdateClient() *ValidateSessionHostUpdateClient`
...
- New function `NewValidateSessionHostUpdateClient(string, azcore.TokenCredential, *arm.ClientOptions) (*ValidateSessionHostUpdateClient, error)`
- New function `*ValidateSessionHostUpdateClient.BeginPost(context.Context, string, string, *ValidateSessionHostUpdateClientBeginPostOptions) (*runtime.Poller[ValidateSessionHostUpdateClientPostResponse], error)`
...
- New struct `ValidateSessionHostUpdateRequestBody`
