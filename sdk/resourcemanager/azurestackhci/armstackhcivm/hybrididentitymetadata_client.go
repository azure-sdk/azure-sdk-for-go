...
func (client *HybridIdentityMetadataClient) listByVirtualMachineInstanceCreateRequest(ctx context.Context, resourceURI string, options *HybridIdentityMetadataClientListByVirtualMachineInstanceOptions) (*policy.Request, error) {
