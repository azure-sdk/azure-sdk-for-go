...
// BuildSettingClientCreateOrUpdateResponse contains the response from method BuildSettingClient.BeginCreateOrUpdate.
type BuildSettingClientCreateOrUpdateResponse struct {
	// Build setting resource object
	BuildSettingResource
}

// BuildSettingsClientDeleteResponse contains the response from method BuildSettingsClient.BeginDelete.
type BuildSettingsClientDeleteResponse struct {
	// placeholder for future response values
}

// BuildSettingsClientGetResponse contains the response from method BuildSettingsClient.Get.
type BuildSettingsClientGetResponse struct {
	// Build setting resource object
	BuildSettingResource
}

// BuildSettingsClientListResponse contains the response from method BuildSettingsClient.NewListPager.
type BuildSettingsClientListResponse struct {
	// Object that includes an array of build setting resources and a possible link for next set
	BuildSettingResourceCollection
}

// BuildSettingsClientListSupportedTypesResponse contains the response from method BuildSettingsClient.NewListSupportedTypesPager.
type BuildSettingsClientListSupportedTypesResponse struct {
...
// ConfigServersClientDeleteResponse contains the response from method ConfigServersClient.BeginDelete.
type ConfigServersClientDeleteResponse struct {
	// placeholder for future response values
}
...
// ConfigServersClientListResponse contains the response from method ConfigServersClient.NewListPager.
type ConfigServersClientListResponse struct {
