...
// MarshalJSON implements the json.Marshaller interface for type OutboundNetworkDependenciesEndpointDetail.
func (o OutboundNetworkDependenciesEndpointDetail) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
...
// UnmarshalJSON implements the json.Unmarshaller interface for type OutboundNetworkDependenciesEndpointDetail.
func (o *OutboundNetworkDependenciesEndpointDetail) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", o, err)
	}
...
func (o OutboundNetworkDependenciesEndpointProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "endpointDetails", o.EndpointDetails)
	return json.Marshal(objectMap)
}
...
func (o *OutboundNetworkDependenciesEndpointProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "endpointDetails":
			err = unpopulate(val, "EndpointDetails", &o.EndpointDetails)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", o, err)
