...
func (b *BotConnectionServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if botConnectionServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = botConnectionServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "BotConnectionClient.NewListByBotServicePager":
				res.resp, res.err = b.dispatchNewListByBotServicePager(req)
			...
			case "BotConnectionClient.ListWithSecrets":
				res.resp, res.err = b.dispatchListWithSecrets(req)
...
// set this to conditionally intercept incoming requests to BotConnectionServerTransport
var botConnectionServerTransportInterceptor interface {
