...
func (a AFDEndpointProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "DedicatedVIP", a.DedicatedVIP)
	populate(objectMap, "deploymentStatus", a.DeploymentStatus)
...
func (a *AFDEndpointProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "autoGeneratedDomainNameLabelScope":
			...
			delete(rawMsg, key)
		case "DedicatedVIP":
			err = unpopulate(val, "DedicatedVIP", &a.DedicatedVIP)
			delete(rawMsg, key)
		case "deploymentStatus":
			err = unpopulate(val, "DeploymentStatus", &a.DeploymentStatus)
			delete(rawMsg, key)
...
func (a AFDOriginGroupProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "profileName", a.ProfileName)
	populate(objectMap, "provisioningState", a.ProvisioningState)
	populate(objectMap, "RouteType", a.RouteType)
	populate(objectMap, "sessionAffinityState", a.SessionAffinityState)
	populate(objectMap, "SessionAffinityType", a.SessionAffinityType)
...
func (a *AFDOriginGroupProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "provisioningState":
			...
			delete(rawMsg, key)
		case "RouteType":
			err = unpopulate(val, "RouteType", &a.RouteType)
			delete(rawMsg, key)
		case "sessionAffinityState":
			err = unpopulate(val, "SessionAffinityState", &a.SessionAffinityState)
			delete(rawMsg, key)
		case "SessionAffinityType":
			err = unpopulate(val, "SessionAffinityType", &a.SessionAffinityType)
			delete(rawMsg, key)
...
func (a AFDOriginProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "ClientIPPreservationState", a.ClientIPPreservationState)
	populate(objectMap, "deploymentStatus", a.DeploymentStatus)
	populate(objectMap, "enabledState", a.EnabledState)
	...
	populate(objectMap, "OriginPorts", a.OriginPorts)
...
func (a *AFDOriginProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "azureOrigin":
			...
			delete(rawMsg, key)
		case "ClientIPPreservationState":
			err = unpopulate(val, "ClientIPPreservationState", &a.ClientIPPreservationState)
			delete(rawMsg, key)
		case "deploymentStatus":
			err = unpopulate(val, "DeploymentStatus", &a.DeploymentStatus)
			delete(rawMsg, key)
		...
		case "originHostHeader":
			...
			delete(rawMsg, key)
		case "OriginPorts":
			err = unpopulate(val, "OriginPorts", &a.OriginPorts)
			delete(rawMsg, key)
		case "priority":
...
func (h HealthProbeParameters) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "ProbePort", h.ProbePort)
...
func (h *HealthProbeParameters) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "probePath":
			...
			delete(rawMsg, key)
		case "ProbePort":
			err = unpopulate(val, "ProbePort", &h.ProbePort)
			delete(rawMsg, key)
		case "probeProtocol":
...
// MarshalJSON implements the json.Marshaller interface for type L4Route.
func (l L4Route) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type L4Route.
func (l *L4Route) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
...
// MarshalJSON implements the json.Marshaller interface for type L4RouteBaseSettings.
func (l L4RouteBaseSettings) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "BackendProtocol", l.BackendProtocol)
	populate(objectMap, "FrontendProtocol", l.FrontendProtocol)
	populate(objectMap, "Ports", l.Ports)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type L4RouteBaseSettings.
func (l *L4RouteBaseSettings) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", l, err)
	}
	for key, val := range rawMsg {
		...
		case "BackendProtocol":
			err = unpopulate(val, "BackendProtocol", &l.BackendProtocol)
			delete(rawMsg, key)
		case "FrontendProtocol":
			err = unpopulate(val, "FrontendProtocol", &l.FrontendProtocol)
			delete(rawMsg, key)
		case "Ports":
...
// MarshalJSON implements the json.Marshaller interface for type L4RouteListResult.
func (l L4RouteListResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type L4RouteListResult.
func (l *L4RouteListResult) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", l, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type L4RouteProperties.
func (l L4RouteProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "customDomains", l.CustomDomains)
	populate(objectMap, "deploymentStatus", l.DeploymentStatus)
	populate(objectMap, "enabledState", l.EnabledState)
	populate(objectMap, "L4RouteBaseSettings", l.L4RouteBaseSettings)
	populate(objectMap, "originGroup", l.OriginGroup)
	populate(objectMap, "provisioningState", l.ProvisioningState)
	populate(objectMap, "RoutingMethod", l.RoutingMethod)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type L4RouteProperties.
func (l *L4RouteProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", l, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "customDomains":
			err = unpopulate(val, "CustomDomains", &l.CustomDomains)
			delete(rawMsg, key)
		case "deploymentStatus":
			err = unpopulate(val, "DeploymentStatus", &l.DeploymentStatus)
			delete(rawMsg, key)
		case "enabledState":
			err = unpopulate(val, "EnabledState", &l.EnabledState)
			delete(rawMsg, key)
		case "L4RouteBaseSettings":
			err = unpopulate(val, "L4RouteBaseSettings", &l.L4RouteBaseSettings)
			delete(rawMsg, key)
		case "originGroup":
			err = unpopulate(val, "OriginGroup", &l.OriginGroup)
			delete(rawMsg, key)
		case "provisioningState":
			err = unpopulate(val, "ProvisioningState", &l.ProvisioningState)
			delete(rawMsg, key)
		case "RoutingMethod":
			err = unpopulate(val, "RoutingMethod", &l.RoutingMethod)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", l, err)
...
// MarshalJSON implements the json.Marshaller interface for type L4RouteUpdatePropertiesParameters.
func (l L4RouteUpdatePropertiesParameters) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "customDomains", l.CustomDomains)
	populate(objectMap, "enabledState", l.EnabledState)
	populate(objectMap, "L4RouteBaseSettings", l.L4RouteBaseSettings)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type L4RouteUpdatePropertiesParameters.
func (l *L4RouteUpdatePropertiesParameters) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", l, err)
	}
