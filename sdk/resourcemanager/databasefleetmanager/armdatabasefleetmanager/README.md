...
```go
clientFactory, err := armdatabasefleetmanager.NewClientFactory(<subscription ID>, cred, nil)
```
...
clientFactory, err := armdatabasefleetmanager.NewClientFactory(<subscription ID>, cred, &options)
```
