...
func (b BalanceProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "refundedOverageCredits", b.RefundedOverageCredits)
...
func (b *BalanceProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "priceHidden":
			...
			delete(rawMsg, key)
		case "refundedOverageCredits":
			err = unpopulate(val, "RefundedOverageCredits", &b.RefundedOverageCredits)
			delete(rawMsg, key)
		case "serviceOverage":
