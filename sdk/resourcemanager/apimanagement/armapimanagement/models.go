...
type AdditionalLocation struct {
	...
	// READ-ONLY; Outbound public IP address prefixes associated with NAT Gateway deployed service. Available only for Premium
	// SKU.
	NatOutboundAddresses []*string `json:"natOutboundAddresses,omitempty" azure:"ro"`
