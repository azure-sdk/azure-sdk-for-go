...
// MarshalJSON implements the json.Marshaller interface for type BenchmarkReferenceAutoGenerated.
func (b BenchmarkReferenceAutoGenerated) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "benchmark", b.Benchmark)
	populate(objectMap, "reference", b.Reference)
	return json.Marshal(objectMap)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type BenchmarkReferenceAutoGenerated.
func (b *BenchmarkReferenceAutoGenerated) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", b, err)
	}
...
func (m MdeOnboardingDataProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "onboardingPackageLinux", m.OnboardingPackageLinux)
	populate(objectMap, "onboardingPackageWindows", m.OnboardingPackageWindows)
	return json.Marshal(objectMap)
}
...
func (m *MdeOnboardingDataProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "onboardingPackageLinux":
			err = unpopulate(val, "OnboardingPackageLinux", &m.OnboardingPackageLinux)
			delete(rawMsg, key)
		case "onboardingPackageWindows":
			err = unpopulate(val, "OnboardingPackageWindows", &m.OnboardingPackageWindows)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", m, err)
...
func (s SQLServerVulnerabilityProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "benchmarks", s.Benchmarks)
	populateDateTimeRFC3339(objectMap, "lastReportedScanTime", s.LastReportedScanTime)
...
func (s *SQLServerVulnerabilityProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "assessedResourceType":
			...
			delete(rawMsg, key)
		case "benchmarks":
			err = unpopulate(val, "Benchmarks", &s.Benchmarks)
			delete(rawMsg, key)
		case "lastReportedScanTime":
			err = unpopulateDateTimeRFC3339(val, "LastReportedScanTime", &s.LastReportedScanTime)
			delete(rawMsg, key)
		case "query":
