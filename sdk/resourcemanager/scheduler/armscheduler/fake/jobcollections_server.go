...
func (j *JobCollectionsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if jobCollectionsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = jobCollectionsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "JobCollectionsClient.BeginDisable":
				res.resp, res.err = j.dispatchBeginDisable(req)
			case "JobCollectionsClient.BeginEnable":
				res.resp, res.err = j.dispatchBeginEnable(req)
			...
			case "JobCollectionsClient.Patch":
				res.resp, res.err = j.dispatchPatch(req)
			default:
...
// set this to conditionally intercept incoming requests to JobCollectionsServerTransport
var jobCollectionsServerTransportInterceptor interface {
