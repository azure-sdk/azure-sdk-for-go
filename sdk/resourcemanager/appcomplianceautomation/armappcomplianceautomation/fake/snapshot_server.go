...
func (s *SnapshotServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if snapshotServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = snapshotServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			case "SnapshotClient.BeginDownload":
				res.resp, res.err = s.dispatchBeginDownload(req)
...
// set this to conditionally intercept incoming requests to SnapshotServerTransport
var snapshotServerTransportInterceptor interface {
