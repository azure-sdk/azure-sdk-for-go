...
const (
	// DNSNameLabelReusePolicyDefaultValueIfNotSelectedAndMeansTheObjectSDomainNameLabelIsNotSecuredAgainstSubdomainTakeover -
	// Unsecure
	DNSNameLabelReusePolicyDefaultValueIfNotSelectedAndMeansTheObjectSDomainNameLabelIsNotSecuredAgainstSubdomainTakeover DNSNameLabelReusePolicy = "Default value if not selected and means the object's domain name label is not secured against subdomain takeover."
	// DNSNameLabelReusePolicyDefaultValueIfSelectedAndMeansTheObjectSDomainNameLabelCanBeReusedWithinTheSameTenant - TenantReuse
	DNSNameLabelReusePolicyDefaultValueIfSelectedAndMeansTheObjectSDomainNameLabelCanBeReusedWithinTheSameTenant DNSNameLabelReusePolicy = "Default value if selected and means the object's domain name label can be reused within the same tenant."
	// DNSNameLabelReusePolicyObjectSDomainNameLabelCanBeReusedWithinTheSameResourceGroup - ResourceGroupReuse
	DNSNameLabelReusePolicyObjectSDomainNameLabelCanBeReusedWithinTheSameResourceGroup DNSNameLabelReusePolicy = "Object's domain name label can be reused within the same resource group."
	// DNSNameLabelReusePolicyObjectSDomainNameLabelCanBeReusedWithinTheSameSubscription - SubscriptionReuse
	DNSNameLabelReusePolicyObjectSDomainNameLabelCanBeReusedWithinTheSameSubscription DNSNameLabelReusePolicy = "Object's domain name label can be reused within the same subscription."
	// DNSNameLabelReusePolicyObjectSDomainNameLabelCannotBeReusedWithinTheSameResourceGroupSubscriptionOrTenant - NoReuse
	DNSNameLabelReusePolicyObjectSDomainNameLabelCannotBeReusedWithinTheSameResourceGroupSubscriptionOrTenant DNSNameLabelReusePolicy = "Object's domain name label cannot be reused within the same resource group, subscription, or tenant."
)
...
func PossibleDNSNameLabelReusePolicyValues() []DNSNameLabelReusePolicy {
	return []DNSNameLabelReusePolicy{
		DNSNameLabelReusePolicyDefaultValueIfNotSelectedAndMeansTheObjectSDomainNameLabelIsNotSecuredAgainstSubdomainTakeover,
		DNSNameLabelReusePolicyDefaultValueIfSelectedAndMeansTheObjectSDomainNameLabelCanBeReusedWithinTheSameTenant,
		DNSNameLabelReusePolicyObjectSDomainNameLabelCanBeReusedWithinTheSameResourceGroup,
		DNSNameLabelReusePolicyObjectSDomainNameLabelCanBeReusedWithinTheSameSubscription,
		DNSNameLabelReusePolicyObjectSDomainNameLabelCannotBeReusedWithinTheSameResourceGroupSubscriptionOrTenant,
	}
}
