...
- New enum type `ServerCreateMode` with values `ServerCreateModeDatabaseMigrationV1`, `ServerCreateModeNormal`, `ServerCreateModeRestore`, `ServerCreateModeServerMigration`, `ServerCreateModeServerMigrationV1`, `ServerCreateModeStandby`
