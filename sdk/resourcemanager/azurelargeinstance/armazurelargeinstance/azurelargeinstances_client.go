...
// Create - Create an Azure Large Instance Resource allowing you to see the provisioned resource
...
//   - azurelargeinstanceproperties - Request body that contains the azure large instance.
//   - options - AzureLargeInstancesClientCreateOptions contains the optional parameters for the AzureLargeInstancesClient.Create
//     method.
func (client *AzureLargeInstancesClient) Create(ctx context.Context, resourceGroupName string, azureLargeInstanceName string, azurelargeinstanceproperties AzureLargeInstance, options *AzureLargeInstancesClientCreateOptions) (AzureLargeInstancesClientCreateResponse, error) {
	var err error
	const operationName = "AzureLargeInstancesClient.Create"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.createCreateRequest(ctx, resourceGroupName, azureLargeInstanceName, azurelargeinstanceproperties, options)
	if err != nil {
		return AzureLargeInstancesClientCreateResponse{}, err
	}
...
func (client *AzureLargeInstancesClient) createCreateRequest(ctx context.Context, resourceGroupName string, azureLargeInstanceName string, azurelargeinstanceproperties AzureLargeInstance, options *AzureLargeInstancesClientCreateOptions) (*policy.Request, error) {
	...
	if err := runtime.MarshalAsJSON(req, azurelargeinstanceproperties); err != nil {
		return nil, err
	}
	return req, nil
}
...
func (client *AzureLargeInstancesClient) createHandleResponse(resp *http.Response) (AzureLargeInstancesClientCreateResponse, error) {
	result := AzureLargeInstancesClientCreateResponse{}
...
// BeginDelete - Delete the azure large instance after physical decomission is completed.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2023-07-20-preview
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - azureLargeInstanceName - Name of the AzureLargeInstance.
//   - options - AzureLargeInstancesClientBeginDeleteOptions contains the optional parameters for the AzureLargeInstancesClient.BeginDelete
//     method.
func (client *AzureLargeInstancesClient) BeginDelete(ctx context.Context, resourceGroupName string, azureLargeInstanceName string, options *AzureLargeInstancesClientBeginDeleteOptions) (*runtime.Poller[AzureLargeInstancesClientDeleteResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.deleteOperation(ctx, resourceGroupName, azureLargeInstanceName, options)
		if err != nil {
			return nil, err
		}
		poller, err := runtime.NewPoller(resp, client.internal.Pipeline(), &runtime.NewPollerOptions[AzureLargeInstancesClientDeleteResponse]{
			Tracer: client.internal.Tracer(),
		})
		return poller, err
	} else {
		return runtime.NewPollerFromResumeToken(options.ResumeToken, client.internal.Pipeline(), &runtime.NewPollerFromResumeTokenOptions[AzureLargeInstancesClientDeleteResponse]{
			Tracer: client.internal.Tracer(),
		})
	}
}

// Delete - Delete the azure large instance after physical decomission is completed.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2023-07-20-preview
func (client *AzureLargeInstancesClient) deleteOperation(ctx context.Context, resourceGroupName string, azureLargeInstanceName string, options *AzureLargeInstancesClientBeginDeleteOptions) (*http.Response, error) {
	var err error
	const operationName = "AzureLargeInstancesClient.BeginDelete"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
...
func (client *AzureLargeInstancesClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, azureLargeInstanceName string, options *AzureLargeInstancesClientBeginDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureLargeInstance/azureLargeInstances/{azureLargeInstanceName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
//     method.
func (client *AzureLargeInstancesClient) Update(ctx context.Context, resourceGroupName string, azureLargeInstanceName string, tagsParameter Tags, options *AzureLargeInstancesClientUpdateOptions) (AzureLargeInstancesClientUpdateResponse, error) {
	var err error
...
func (client *AzureLargeInstancesClient) updateCreateRequest(ctx context.Context, resourceGroupName string, azureLargeInstanceName string, tagsParameter Tags, options *AzureLargeInstancesClientUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureLargeInstance/azureLargeInstances/{azureLargeInstanceName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
