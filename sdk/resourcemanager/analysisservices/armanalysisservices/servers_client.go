...
func (client *ServersClient) checkNameAvailabilityCreateRequest(ctx context.Context, location string, serverParameters CheckServerNameAvailabilityParameters, _ *ServersClientCheckNameAvailabilityOptions) (*policy.Request, error) {
...
func (client *ServersClient) createCreateRequest(ctx context.Context, resourceGroupName string, serverName string, serverParameters Server, _ *ServersClientBeginCreateOptions) (*policy.Request, error) {
...
func (client *ServersClient) dissociateGatewayCreateRequest(ctx context.Context, resourceGroupName string, serverName string, _ *ServersClientDissociateGatewayOptions) (*policy.Request, error) {
...
func (client *ServersClient) getDetailsCreateRequest(ctx context.Context, resourceGroupName string, serverName string, _ *ServersClientGetDetailsOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AnalysisServices/servers/{serverName}"
	if resourceGroupName == "" {
		return nil, errors.New("parameter resourceGroupName cannot be empty")
	}
...
func (client *ServersClient) listGatewayStatusCreateRequest(ctx context.Context, resourceGroupName string, serverName string, _ *ServersClientListGatewayStatusOptions) (*policy.Request, error) {
...
func (client *ServersClient) listOperationResultsCreateRequest(ctx context.Context, location string, operationID string, _ *ServersClientListOperationResultsOptions) (*policy.Request, error) {
...
func (client *ServersClient) listOperationStatusesCreateRequest(ctx context.Context, location string, operationID string, _ *ServersClientListOperationStatusesOptions) (*policy.Request, error) {
...
func (client *ServersClient) listSKUsForExistingCreateRequest(ctx context.Context, resourceGroupName string, serverName string, _ *ServersClientListSKUsForExistingOptions) (*policy.Request, error) {
...
func (client *ServersClient) listSKUsForNewCreateRequest(ctx context.Context, _ *ServersClientListSKUsForNewOptions) (*policy.Request, error) {
...
func (client *ServersClient) resumeCreateRequest(ctx context.Context, resourceGroupName string, serverName string, _ *ServersClientBeginResumeOptions) (*policy.Request, error) {
...
func (client *ServersClient) suspendCreateRequest(ctx context.Context, resourceGroupName string, serverName string, _ *ServersClientBeginSuspendOptions) (*policy.Request, error) {
...
func (client *ServersClient) updateCreateRequest(ctx context.Context, resourceGroupName string, serverName string, serverUpdateParameters ServerUpdateParameters, _ *ServersClientBeginUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AnalysisServices/servers/{serverName}"
	if resourceGroupName == "" {
		return nil, errors.New("parameter resourceGroupName cannot be empty")
	}
