...
func (client *AvailableOSClient) getCreateRequest(ctx context.Context, resourceGroupName string, testBaseAccountName string, availableOSResourceName string, _ *AvailableOSClientGetOptions) (*policy.Request, error) {
...
func (client *AvailableOSClient) listCreateRequest(ctx context.Context, resourceGroupName string, testBaseAccountName string, osUpdateType OsUpdateType, _ *AvailableOSClientListOptions) (*policy.Request, error) {
