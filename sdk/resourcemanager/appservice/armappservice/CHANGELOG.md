...
- New value `SKUNameDedicated` added to enum type `SKUName`
...
- New function `*WebSiteManagementClient.NewListStaticSiteRegionsPager(*WebSiteManagementClientListStaticSiteRegionsOptions) *runtime.Pager[WebSiteManagementClientListStaticSiteRegionsResponse]`
- New struct `CipherSuites`
- New struct `StaticSiteRegion`
- New struct `StaticSiteRegionCollection`
- New struct `StaticSiteRegionProperties`
