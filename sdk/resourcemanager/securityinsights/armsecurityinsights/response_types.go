...
// OverviewClientListResponse contains the response from method OverviewClient.List.
type OverviewClientListResponse struct {
	// A dictionary of all overview sections, where the keys are the sections name.
	Value map[string]*OverviewSection
}
