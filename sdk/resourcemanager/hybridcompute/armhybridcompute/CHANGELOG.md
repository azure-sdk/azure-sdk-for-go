...
- New function `*ManagementClient.BeginSetupExtensions(context.Context, string, string, MachineExtensionSetup, *ManagementClientBeginSetupExtensionsOptions) (*runtime.Poller[ManagementClientSetupExtensionsResponse], error)`
...
- New struct `MachineExtensionSetup`
