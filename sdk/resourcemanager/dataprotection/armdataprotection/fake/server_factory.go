...
type ServerFactory struct {
	...
	Server                                    Server
	CrossRegionRestoreJobServer               CrossRegionRestoreJobServer
	CrossRegionRestoreJobsServer              CrossRegionRestoreJobsServer
	...
	SecondaryRPsServer                        SecondaryRPsServer
}
...
type ServerFactoryTransport struct {
	...
	trCrossRegionRestoreJobServer               *CrossRegionRestoreJobServerTransport
	trCrossRegionRestoreJobsServer              *CrossRegionRestoreJobsServerTransport
	...
	trSecondaryRPsServer                        *SecondaryRPsServerTransport
}
...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "CrossRegionRestoreJobClient":
		initServer(s, &s.trCrossRegionRestoreJobServer, func() *CrossRegionRestoreJobServerTransport {
			return NewCrossRegionRestoreJobServerTransport(&s.srv.CrossRegionRestoreJobServer)
		})
		resp, err = s.trCrossRegionRestoreJobServer.Do(req)
	case "CrossRegionRestoreJobsClient":
		initServer(s, &s.trCrossRegionRestoreJobsServer, func() *CrossRegionRestoreJobsServerTransport {
			return NewCrossRegionRestoreJobsServerTransport(&s.srv.CrossRegionRestoreJobsServer)
		})
		resp, err = s.trCrossRegionRestoreJobsServer.Do(req)
	...
	case "SecondaryRPsClient":
		initServer(s, &s.trSecondaryRPsServer, func() *SecondaryRPsServerTransport { return NewSecondaryRPsServerTransport(&s.srv.SecondaryRPsServer) })
		resp, err = s.trSecondaryRPsServer.Do(req)
	default:
