...
type FreeTrialStaticWebAppsProxyEntityProperties struct {
	// A static site.
	StaticSite *StaticSite                 `json:"staticSite,omitempty"`
	User       *FreeTrialStaticWebAppsUser `json:"user,omitempty"`

	// READ-ONLY
	StaticSiteResourceID *string `json:"staticSiteResourceId,omitempty" azure:"ro"`
}

type FreeTrialStaticWebAppsUser struct {
...
type StaticSite struct {
	...
	TargetResourceGroupResourceID *string `json:"targetResourceGroupResourceId,omitempty"`
