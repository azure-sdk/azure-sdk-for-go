...
func (p *PublishedBlueprintsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if publishedBlueprintsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = publishedBlueprintsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to PublishedBlueprintsServerTransport
var publishedBlueprintsServerTransportInterceptor interface {
