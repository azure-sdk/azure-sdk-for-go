...
// Generated from example definition: 2024-11-01-preview/SavingsPlanOrderAliasCreate.json
func ExampleSavingsPlanOrderAliasModelsClient_BeginCreate_savingsPlanOrderAliasCreate() {
	...
	poller, err := clientFactory.NewSavingsPlanOrderAliasModelsClient().BeginCreate(ctx, "spAlias123", armbillingbenefits.SavingsPlanOrderAliasModel{
	...
	// res = armbillingbenefits.SavingsPlanOrderAliasModelsClientCreateResponse{
...
// Generated from example definition: 2024-11-01-preview/SavingsPlanOrderAliasCreateSingleScope.json
func ExampleSavingsPlanOrderAliasModelsClient_BeginCreate_savingsPlanOrderAliasCreateSingleScope() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
...
// Generated from example definition: 2024-11-01-preview/SavingsPlanOrderAliasGet.json
func ExampleSavingsPlanOrderAliasModelsClient_Get() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	res, err := clientFactory.NewSavingsPlanOrderAliasModelsClient().Get(ctx, "spAlias123", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armbillingbenefits.SavingsPlanOrderAliasModelsClientGetResponse{
	// 	SavingsPlanOrderAliasModel: &armbillingbenefits.SavingsPlanOrderAliasModel{
