...
func (client *ManagementClient) getAvailableOperationsCreateRequest(ctx context.Context, _ *ManagementClientGetAvailableOperationsOptions) (*policy.Request, error) {
