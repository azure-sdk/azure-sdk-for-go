...
- New enum type `BuildSettingProvisioningState` with values `BuildSettingProvisioningStateCanceled`, `BuildSettingProvisioningStateCreating`, `BuildSettingProvisioningStateDeleting`, `BuildSettingProvisioningStateFailed`, `BuildSettingProvisioningStateSucceeded`, `BuildSettingProvisioningStateUpdating`
...
- New function `NewBuildSettingClient(string, azcore.TokenCredential, *arm.ClientOptions) (*BuildSettingClient, error)`
- New function `*BuildSettingClient.BeginCreateOrUpdate(context.Context, string, string, string, string, BuildSettingResource, *BuildSettingClientBeginCreateOrUpdateOptions) (*runtime.Poller[BuildSettingClientCreateOrUpdateResponse], error)`
- New function `NewBuildSettingsClient(string, azcore.TokenCredential, *arm.ClientOptions) (*BuildSettingsClient, error)`
- New function `*BuildSettingsClient.BeginDelete(context.Context, string, string, string, string, *BuildSettingsClientBeginDeleteOptions) (*runtime.Poller[BuildSettingsClientDeleteResponse], error)`
- New function `*BuildSettingsClient.Get(context.Context, string, string, string, string, *BuildSettingsClientGetOptions) (BuildSettingsClientGetResponse, error)`
- New function `*BuildSettingsClient.NewListPager(string, string, string, *BuildSettingsClientListOptions) *runtime.Pager[BuildSettingsClientListResponse]`
- New function `*BuildSettingsClient.NewListSupportedTypesPager(string, string, string, *BuildSettingsClientListSupportedTypesOptions) *runtime.Pager[BuildSettingsClientListSupportedTypesResponse]`
- New function `*ClientFactory.NewBuildSettingClient() *BuildSettingClient`
- New function `*ClientFactory.NewBuildSettingsClient() *BuildSettingsClient`
...
- New struct `BuildSettingProperties`
- New struct `BuildSettingPropertiesSecrets`
- New struct `BuildSettingReference`
- New struct `BuildSettingResource`
- New struct `BuildSettingResourceCollection`
...
- New struct `JobResourceRequests`
...
- New struct `Secret`
- New struct `SupportedBuildSettingType`
- New struct `SupportedBuildSettingTypes`
...
- New field `BuildSettings` in struct `BuildProperties`
...
- New enum type `CustomizedAcceleratorProvisioningState` with values `CustomizedAcceleratorProvisioningStateCanceled`, `CustomizedAcceleratorProvisioningStateCreating`, `CustomizedAcceleratorProvisioningStateDeleting`, `CustomizedAcceleratorProvisioningStateFailed`, `CustomizedAcceleratorProvisioningStateSucceeded`, `CustomizedAcceleratorProvisioningStateUpdating`
...
- New enum type `PredefinedAcceleratorProvisioningState` with values `PredefinedAcceleratorProvisioningStateCanceled`, `PredefinedAcceleratorProvisioningStateCreating`, `PredefinedAcceleratorProvisioningStateFailed`, `PredefinedAcceleratorProvisioningStateSucceeded`, `PredefinedAcceleratorProvisioningStateUpdating`
...
- New function `*CustomizedAcceleratorsClient.BeginValidate(context.Context, string, string, string, string, CustomizedAcceleratorProperties, *CustomizedAcceleratorsClientBeginValidateOptions) (*runtime.Poller[CustomizedAcceleratorsClientValidateResponse], error)`
...
- New field `CustomPersistentDisks`, `IngressSettings`, `VnetAddons` in struct `AppResourceProperties`
...
- New field `MarketplaceResource`, `PowerState`, `VnetAddons` in struct `ClusterResourceProperties`
...
- New field `Apms`, `ContainerProbeSettings`, `LivenessProbe`, `ReadinessProbe`, `StartupProbe`, `TerminationGracePeriodSeconds` in struct `DeploymentSettings`
- New field `Expand` in struct `DeploymentsClientListForClusterOptions`
- New field `AutoSync`, `ProvisioningState` in struct `KeyVaultCertificateProperties`
