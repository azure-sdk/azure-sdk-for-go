...
// MachineRunCommandInstanceView - Describes the Machine Extension Instance View.
...
// MachineRunCommandInstanceViewStatus - Instance view status.
type MachineRunCommandInstanceViewStatus struct {
	// The status code.
	Code *string
