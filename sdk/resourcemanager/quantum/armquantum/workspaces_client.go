...
func (client *WorkspacesClient) checkNameAvailabilityCreateRequest(ctx context.Context, location string, body CheckNameAvailabilityRequest, _ *WorkspacesClientCheckNameAvailabilityOptions) (*policy.Request, error) {
...
func (client *WorkspacesClient) regenerateKeysCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, body APIKeys, _ *WorkspacesClientRegenerateKeysOptions) (*policy.Request, error) {
...
func (client *WorkspacesClient) updateTagsCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, properties WorkspaceTagsUpdate, _ *WorkspacesClientUpdateTagsOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Quantum/workspaces/{workspaceName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
