...
// SAPCentralInstancesServer is a fake server for instances of the armsapvirtualinstance.SAPCentralInstancesClient type.
type SAPCentralInstancesServer struct {
	...
	BeginCreate func(ctx context.Context, resourceGroupName string, sapVirtualInstanceName string, centralInstanceName string, body armsapvirtualinstance.SAPCentralServerInstance, options *armsapvirtualinstance.SAPCentralInstancesClientBeginCreateOptions) (resp azfake.PollerResponder[armsapvirtualinstance.SAPCentralInstancesClientCreateResponse], errResp azfake.ErrorResponder)

	// BeginDelete is the fake for method SAPCentralInstancesClient.BeginDelete
	// HTTP status codes to indicate success: http.StatusAccepted, http.StatusNoContent
	BeginDelete func(ctx context.Context, resourceGroupName string, sapVirtualInstanceName string, centralInstanceName string, options *armsapvirtualinstance.SAPCentralInstancesClientBeginDeleteOptions) (resp azfake.PollerResponder[armsapvirtualinstance.SAPCentralInstancesClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method SAPCentralInstancesClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, sapVirtualInstanceName string, centralInstanceName string, options *armsapvirtualinstance.SAPCentralInstancesClientGetOptions) (resp azfake.Responder[armsapvirtualinstance.SAPCentralInstancesClientGetResponse], errResp azfake.ErrorResponder)

	// NewListPager is the fake for method SAPCentralInstancesClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(resourceGroupName string, sapVirtualInstanceName string, options *armsapvirtualinstance.SAPCentralInstancesClientListOptions) (resp azfake.PagerResponder[armsapvirtualinstance.SAPCentralInstancesClientListResponse])

	// BeginStartInstance is the fake for method SAPCentralInstancesClient.BeginStartInstance
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginStartInstance func(ctx context.Context, resourceGroupName string, sapVirtualInstanceName string, centralInstanceName string, options *armsapvirtualinstance.SAPCentralInstancesClientBeginStartInstanceOptions) (resp azfake.PollerResponder[armsapvirtualinstance.SAPCentralInstancesClientStartInstanceResponse], errResp azfake.ErrorResponder)

	// BeginStopInstance is the fake for method SAPCentralInstancesClient.BeginStopInstance
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginStopInstance func(ctx context.Context, resourceGroupName string, sapVirtualInstanceName string, centralInstanceName string, options *armsapvirtualinstance.SAPCentralInstancesClientBeginStopInstanceOptions) (resp azfake.PollerResponder[armsapvirtualinstance.SAPCentralInstancesClientStopInstanceResponse], errResp azfake.ErrorResponder)

	// Update is the fake for method SAPCentralInstancesClient.Update
	// HTTP status codes to indicate success: http.StatusOK
	Update func(ctx context.Context, resourceGroupName string, sapVirtualInstanceName string, centralInstanceName string, body armsapvirtualinstance.UpdateSAPCentralInstanceRequest, options *armsapvirtualinstance.SAPCentralInstancesClientUpdateOptions) (resp azfake.Responder[armsapvirtualinstance.SAPCentralInstancesClientUpdateResponse], errResp azfake.ErrorResponder)
}
...
// The returned SAPCentralInstancesServerTransport instance is connected to an instance of armsapvirtualinstance.SAPCentralInstancesClient via the
...
func NewSAPCentralInstancesServerTransport(srv *SAPCentralInstancesServer) *SAPCentralInstancesServerTransport {
	return &SAPCentralInstancesServerTransport{
		srv:                srv,
		beginCreate:        newTracker[azfake.PollerResponder[armsapvirtualinstance.SAPCentralInstancesClientCreateResponse]](),
		beginDelete:        newTracker[azfake.PollerResponder[armsapvirtualinstance.SAPCentralInstancesClientDeleteResponse]](),
		newListPager:       newTracker[azfake.PagerResponder[armsapvirtualinstance.SAPCentralInstancesClientListResponse]](),
		beginStartInstance: newTracker[azfake.PollerResponder[armsapvirtualinstance.SAPCentralInstancesClientStartInstanceResponse]](),
		beginStopInstance:  newTracker[azfake.PollerResponder[armsapvirtualinstance.SAPCentralInstancesClientStopInstanceResponse]](),
	}
}

// SAPCentralInstancesServerTransport connects instances of armsapvirtualinstance.SAPCentralInstancesClient to instances of SAPCentralInstancesServer.
...
type SAPCentralInstancesServerTransport struct {
	...
	beginCreate        *tracker[azfake.PollerResponder[armsapvirtualinstance.SAPCentralInstancesClientCreateResponse]]
	beginDelete        *tracker[azfake.PollerResponder[armsapvirtualinstance.SAPCentralInstancesClientDeleteResponse]]
	newListPager       *tracker[azfake.PagerResponder[armsapvirtualinstance.SAPCentralInstancesClientListResponse]]
	beginStartInstance *tracker[azfake.PollerResponder[armsapvirtualinstance.SAPCentralInstancesClientStartInstanceResponse]]
	beginStopInstance  *tracker[azfake.PollerResponder[armsapvirtualinstance.SAPCentralInstancesClientStopInstanceResponse]]
}
...
func (s *SAPCentralInstancesServerTransport) dispatchBeginCreate(req *http.Request) (*http.Response, error) {
	...
	if beginCreate == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armsapvirtualinstance.SAPCentralServerInstance](req)
		if err != nil {
			return nil, err
		}
...
func (s *SAPCentralInstancesServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armsapvirtualinstance.SAPCentralInstancesClientListResponse, createLink func() string) {
...
func (s *SAPCentralInstancesServerTransport) dispatchBeginStartInstance(req *http.Request) (*http.Response, error) {
	...
	if beginStartInstance == nil {
		...
		var options *armsapvirtualinstance.SAPCentralInstancesClientBeginStartInstanceOptions
		if !reflect.ValueOf(body).IsZero() {
			options = &armsapvirtualinstance.SAPCentralInstancesClientBeginStartInstanceOptions{
				Body: &body,
			}
		}
...
func (s *SAPCentralInstancesServerTransport) dispatchBeginStopInstance(req *http.Request) (*http.Response, error) {
	...
	if beginStopInstance == nil {
		...
		var options *armsapvirtualinstance.SAPCentralInstancesClientBeginStopInstanceOptions
		if !reflect.ValueOf(body).IsZero() {
			options = &armsapvirtualinstance.SAPCentralInstancesClientBeginStopInstanceOptions{
				Body: &body,
			}
		}
...
func (s *SAPCentralInstancesServerTransport) dispatchUpdate(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[armsapvirtualinstance.UpdateSAPCentralInstanceRequest](req)
	if err != nil {
		return nil, err
	}
	resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
