...
func (s *ServerSitesControllerServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if serverSitesControllerServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = serverSitesControllerServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "ServerSitesControllerClient.BeginRefreshSite":
				res.resp, res.err = s.dispatchBeginRefreshSite(req)
			...
			case "ServerSitesControllerClient.BeginUpdateDependencyMapStatus":
				res.resp, res.err = s.dispatchBeginUpdateDependencyMapStatus(req)
			case "ServerSitesControllerClient.BeginUpdateProperties":
				res.resp, res.err = s.dispatchBeginUpdateProperties(req)
			default:
...
// set this to conditionally intercept incoming requests to ServerSitesControllerServerTransport
var serverSitesControllerServerTransportInterceptor interface {
