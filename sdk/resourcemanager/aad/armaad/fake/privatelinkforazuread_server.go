...
func (p *PrivateLinkForAzureAdServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if privateLinkForAzureAdServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = privateLinkForAzureAdServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to PrivateLinkForAzureAdServerTransport
var privateLinkForAzureAdServerTransportInterceptor interface {
