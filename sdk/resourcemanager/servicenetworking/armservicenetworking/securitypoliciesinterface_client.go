...
// NewListByResourceGroupPager - List SecurityPolicy resources by TrafficController
//
// Generated from API version 2024-05-01-preview
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - trafficControllerName - traffic controller name for path
//   - options - SecurityPoliciesInterfaceClientListByResourceGroupOptions contains the optional parameters for the SecurityPoliciesInterfaceClient.NewListByResourceGroupPager
//     method.
func (client *SecurityPoliciesInterfaceClient) NewListByResourceGroupPager(resourceGroupName string, trafficControllerName string, options *SecurityPoliciesInterfaceClientListByResourceGroupOptions) *runtime.Pager[SecurityPoliciesInterfaceClientListByResourceGroupResponse] {
	return runtime.NewPager(runtime.PagingHandler[SecurityPoliciesInterfaceClientListByResourceGroupResponse]{
		More: func(page SecurityPoliciesInterfaceClientListByResourceGroupResponse) bool {
			return page.NextLink != nil && len(*page.NextLink) > 0
		},
		Fetcher: func(ctx context.Context, page *SecurityPoliciesInterfaceClientListByResourceGroupResponse) (SecurityPoliciesInterfaceClientListByResourceGroupResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "SecurityPoliciesInterfaceClient.NewListByResourceGroupPager")
			nextLink := ""
			if page != nil {
				nextLink = *page.NextLink
			}
			resp, err := runtime.FetcherForNextLink(ctx, client.internal.Pipeline(), nextLink, func(ctx context.Context) (*policy.Request, error) {
				return client.listByResourceGroupCreateRequest(ctx, resourceGroupName, trafficControllerName, options)
			}, nil)
			if err != nil {
				return SecurityPoliciesInterfaceClientListByResourceGroupResponse{}, err
			}
...
func (client *SecurityPoliciesInterfaceClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, trafficControllerName string, _ *SecurityPoliciesInterfaceClientListByResourceGroupOptions) (*policy.Request, error) {
...
func (client *SecurityPoliciesInterfaceClient) listByResourceGroupHandleResponse(resp *http.Response) (SecurityPoliciesInterfaceClientListByResourceGroupResponse, error) {
	result := SecurityPoliciesInterfaceClientListByResourceGroupResponse{}
...
//     method.
func (client *SecurityPoliciesInterfaceClient) Update(ctx context.Context, resourceGroupName string, trafficControllerName string, securityPolicyName string, properties SecurityPolicy, options *SecurityPoliciesInterfaceClientUpdateOptions) (SecurityPoliciesInterfaceClientUpdateResponse, error) {
	var err error
...
func (client *SecurityPoliciesInterfaceClient) updateCreateRequest(ctx context.Context, resourceGroupName string, trafficControllerName string, securityPolicyName string, properties SecurityPolicy, _ *SecurityPoliciesInterfaceClientUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceNetworking/trafficControllers/{trafficControllerName}/securityPolicy/{securityPolicyName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
