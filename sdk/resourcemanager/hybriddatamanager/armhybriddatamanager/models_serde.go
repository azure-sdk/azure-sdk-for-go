...
func (j JobDefinitionProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "jobDefinitionSchemaVersion", j.JobDefinitionSchemaVersion)
	populate(objectMap, "jobDefinitionState", j.JobDefinitionState)
...
func (j *JobDefinitionProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "dataSourceId":
			...
			delete(rawMsg, key)
		case "jobDefinitionSchemaVersion":
			err = unpopulate(val, "JobDefinitionSchemaVersion", &j.JobDefinitionSchemaVersion)
			delete(rawMsg, key)
		case "jobDefinitionState":
			err = unpopulate(val, "JobDefinitionState", &j.JobDefinitionState)
			delete(rawMsg, key)
...
func (j JobProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populateTimeRFC3339(objectMap, "backupEndTime", j.BackupEndTime)
	populateTimeRFC3339(objectMap, "backupStartTime", j.BackupStartTime)
	populate(objectMap, "bytesCopied", j.BytesCopied)
	populate(objectMap, "bytesProcessed", j.BytesProcessed)
	populateTimeRFC3339(objectMap, "cleanupComputeEndTime", j.CleanupComputeEndTime)
	populateTimeRFC3339(objectMap, "cleanupComputeStartTime", j.CleanupComputeStartTime)
	populateTimeRFC3339(objectMap, "copyConfigureComputeEndTime", j.CopyConfigureComputeEndTime)
	populateTimeRFC3339(objectMap, "copyConfigureComputeStartTime", j.CopyConfigureComputeStartTime)
	populateTimeRFC3339(objectMap, "copyEndTime", j.CopyEndTime)
	populate(objectMap, "copyErrors", j.CopyErrors)
	populateTimeRFC3339(objectMap, "copyStartTime", j.CopyStartTime)
	...
	populateTimeRFC3339(objectMap, "directoryParserEndTime", j.DirectoryParserEndTime)
	populateTimeRFC3339(objectMap, "directoryParserStartTime", j.DirectoryParserStartTime)
	populateTimeRFC3339(objectMap, "estimationConfigureComputeEndTime", j.EstimationConfigureComputeEndTime)
	populateTimeRFC3339(objectMap, "estimationConfigureComputeStartTime", j.EstimationConfigureComputeStartTime)
	populateTimeRFC3339(objectMap, "estimationEndTime", j.EstimationEndTime)
	populateTimeRFC3339(objectMap, "estimationStartTime", j.EstimationStartTime)
	populate(objectMap, "filesCopiedCounter", j.FilesCopiedCounter)
	populate(objectMap, "filesDeletedCounter", j.FilesDeletedCounter)
	populate(objectMap, "isCancellable", j.IsCancellable)
	populate(objectMap, "itemsDeleted", j.ItemsDeleted)
	populate(objectMap, "itemsProcessed", j.ItemsProcessed)
	populateTimeRFC3339(objectMap, "postCopyEndTime", j.PostCopyEndTime)
	populateTimeRFC3339(objectMap, "postCopyStartTime", j.PostCopyStartTime)
	populateTimeRFC3339(objectMap, "postEstimationEndTime", j.PostEstimationEndTime)
	populateTimeRFC3339(objectMap, "postEstimationStartTime", j.PostEstimationStartTime)
	populateTimeRFC3339(objectMap, "purgeDetectionEndTime", j.PurgeDetectionEndTime)
	populateTimeRFC3339(objectMap, "purgeDetectionStartTime", j.PurgeDetectionStartTime)
	populate(objectMap, "totalBytesToProcess", j.TotalBytesToProcess)
	populate(objectMap, "totalItemsToDelete", j.TotalItemsToDelete)
	populate(objectMap, "totalItemsToProcess", j.TotalItemsToProcess)
	populate(objectMap, "unsupportedFiles", j.UnsupportedFiles)
	return json.Marshal(objectMap)
}
...
func (j *JobProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "backupEndTime":
			err = unpopulateTimeRFC3339(val, "BackupEndTime", &j.BackupEndTime)
			delete(rawMsg, key)
		case "backupStartTime":
			err = unpopulateTimeRFC3339(val, "BackupStartTime", &j.BackupStartTime)
			delete(rawMsg, key)
		case "bytesCopied":
			err = unpopulate(val, "BytesCopied", &j.BytesCopied)
			delete(rawMsg, key)
		case "bytesProcessed":
			err = unpopulate(val, "BytesProcessed", &j.BytesProcessed)
			delete(rawMsg, key)
		case "cleanupComputeEndTime":
			err = unpopulateTimeRFC3339(val, "CleanupComputeEndTime", &j.CleanupComputeEndTime)
			delete(rawMsg, key)
		case "cleanupComputeStartTime":
			err = unpopulateTimeRFC3339(val, "CleanupComputeStartTime", &j.CleanupComputeStartTime)
			delete(rawMsg, key)
		case "copyConfigureComputeEndTime":
			err = unpopulateTimeRFC3339(val, "CopyConfigureComputeEndTime", &j.CopyConfigureComputeEndTime)
			delete(rawMsg, key)
		case "copyConfigureComputeStartTime":
			err = unpopulateTimeRFC3339(val, "CopyConfigureComputeStartTime", &j.CopyConfigureComputeStartTime)
			delete(rawMsg, key)
		case "copyEndTime":
			err = unpopulateTimeRFC3339(val, "CopyEndTime", &j.CopyEndTime)
			delete(rawMsg, key)
		case "copyErrors":
			err = unpopulate(val, "CopyErrors", &j.CopyErrors)
			delete(rawMsg, key)
		case "copyStartTime":
			err = unpopulateTimeRFC3339(val, "CopyStartTime", &j.CopyStartTime)
			delete(rawMsg, key)
		case "dataSinkName":
		...
		case "details":
			...
			delete(rawMsg, key)
		case "directoryParserEndTime":
			err = unpopulateTimeRFC3339(val, "DirectoryParserEndTime", &j.DirectoryParserEndTime)
			delete(rawMsg, key)
		case "directoryParserStartTime":
			err = unpopulateTimeRFC3339(val, "DirectoryParserStartTime", &j.DirectoryParserStartTime)
			delete(rawMsg, key)
		case "estimationConfigureComputeEndTime":
			err = unpopulateTimeRFC3339(val, "EstimationConfigureComputeEndTime", &j.EstimationConfigureComputeEndTime)
			delete(rawMsg, key)
		case "estimationConfigureComputeStartTime":
			err = unpopulateTimeRFC3339(val, "EstimationConfigureComputeStartTime", &j.EstimationConfigureComputeStartTime)
			delete(rawMsg, key)
		case "estimationEndTime":
			err = unpopulateTimeRFC3339(val, "EstimationEndTime", &j.EstimationEndTime)
			delete(rawMsg, key)
		case "estimationStartTime":
			err = unpopulateTimeRFC3339(val, "EstimationStartTime", &j.EstimationStartTime)
			delete(rawMsg, key)
		case "filesCopiedCounter":
			err = unpopulate(val, "FilesCopiedCounter", &j.FilesCopiedCounter)
			delete(rawMsg, key)
		case "filesDeletedCounter":
			err = unpopulate(val, "FilesDeletedCounter", &j.FilesDeletedCounter)
			delete(rawMsg, key)
		case "isCancellable":
			err = unpopulate(val, "IsCancellable", &j.IsCancellable)
			delete(rawMsg, key)
		case "itemsDeleted":
			err = unpopulate(val, "ItemsDeleted", &j.ItemsDeleted)
			delete(rawMsg, key)
		case "itemsProcessed":
			err = unpopulate(val, "ItemsProcessed", &j.ItemsProcessed)
			delete(rawMsg, key)
		case "postCopyEndTime":
			err = unpopulateTimeRFC3339(val, "PostCopyEndTime", &j.PostCopyEndTime)
			delete(rawMsg, key)
		case "postCopyStartTime":
			err = unpopulateTimeRFC3339(val, "PostCopyStartTime", &j.PostCopyStartTime)
			delete(rawMsg, key)
		case "postEstimationEndTime":
			err = unpopulateTimeRFC3339(val, "PostEstimationEndTime", &j.PostEstimationEndTime)
			delete(rawMsg, key)
		case "postEstimationStartTime":
			err = unpopulateTimeRFC3339(val, "PostEstimationStartTime", &j.PostEstimationStartTime)
			delete(rawMsg, key)
		case "purgeDetectionEndTime":
			err = unpopulateTimeRFC3339(val, "PurgeDetectionEndTime", &j.PurgeDetectionEndTime)
			delete(rawMsg, key)
		case "purgeDetectionStartTime":
			err = unpopulateTimeRFC3339(val, "PurgeDetectionStartTime", &j.PurgeDetectionStartTime)
			delete(rawMsg, key)
		case "totalBytesToProcess":
			err = unpopulate(val, "TotalBytesToProcess", &j.TotalBytesToProcess)
			delete(rawMsg, key)
		case "totalItemsToDelete":
			err = unpopulate(val, "TotalItemsToDelete", &j.TotalItemsToDelete)
			delete(rawMsg, key)
