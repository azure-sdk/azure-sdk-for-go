...
func (client *LibrariesClient) listByWorkspaceCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, _ *LibrariesClientListByWorkspaceOptions) (*policy.Request, error) {
