...
func (c *ClientFactory) NewResourceMoveClient() *ResourceMoveClient {
	subClient, _ := NewResourceMoveClient(c.subscriptionID, c.credential, c.options)
	return subClient
}

func (c *ClientFactory) NewRpUnbilledPrefixesClient() *RpUnbilledPrefixesClient {
	subClient, _ := NewRpUnbilledPrefixesClient(c.subscriptionID, c.credential, c.options)
	return subClient
}
