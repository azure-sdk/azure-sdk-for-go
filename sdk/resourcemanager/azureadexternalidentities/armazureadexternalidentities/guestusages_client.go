...
func (client *GuestUsagesClient) createCreateRequest(ctx context.Context, resourceGroupName string, resourceName string, resource GuestUsagesResource, _ *GuestUsagesClientCreateOptions) (*policy.Request, error) {
...
func (client *GuestUsagesClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, resourceName string, _ *GuestUsagesClientDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureActiveDirectory/guestUsages/{resourceName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *GuestUsagesClient) getCreateRequest(ctx context.Context, resourceGroupName string, resourceName string, _ *GuestUsagesClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureActiveDirectory/guestUsages/{resourceName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *GuestUsagesClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, _ *GuestUsagesClientListByResourceGroupOptions) (*policy.Request, error) {
...
func (client *GuestUsagesClient) listBySubscriptionCreateRequest(ctx context.Context, _ *GuestUsagesClientListBySubscriptionOptions) (*policy.Request, error) {
...
func (client *GuestUsagesClient) updateCreateRequest(ctx context.Context, resourceGroupName string, resourceName string, resourcePatch GuestUsagesResourcePatch, _ *GuestUsagesClientUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureActiveDirectory/guestUsages/{resourceName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
