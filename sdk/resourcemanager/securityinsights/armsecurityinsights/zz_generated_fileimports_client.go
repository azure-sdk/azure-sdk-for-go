...
func (client *FileImportsClient) BeginDelete(ctx context.Context, resourceGroupName string, workspaceName string, fileImportID string, options *FileImportsClientBeginDeleteOptions) (*armruntime.Poller[FileImportsClientDeleteResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.deleteOperation(ctx, resourceGroupName, workspaceName, fileImportID, options)
		if err != nil {
			return nil, err
		}
		return armruntime.NewPoller[FileImportsClientDeleteResponse](resp, client.pl, nil)
	} else {
		return armruntime.NewPollerFromResumeToken[FileImportsClientDeleteResponse](options.ResumeToken, client.pl, nil)
	}
}
...
func (client *FileImportsClient) List(resourceGroupName string, workspaceName string, options *FileImportsClientListOptions) *runtime.Pager[FileImportsClientListResponse] {
	return runtime.NewPager(runtime.PageProcessor[FileImportsClientListResponse]{
