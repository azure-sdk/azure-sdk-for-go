...
// ReplicaLinkState - Gets the link state of a replica server. This property is returned only for replicas api call. Supported
// values are Active, Catchup, Provisioning, Updating, Broken, Reconfiguring
type ReplicaLinkState string

const (
	ReplicaLinkStateActive        ReplicaLinkState = "Active"
	ReplicaLinkStateBroken        ReplicaLinkState = "Broken"
	ReplicaLinkStateCatchup       ReplicaLinkState = "Catchup"
	ReplicaLinkStateProvisioning  ReplicaLinkState = "Provisioning"
	ReplicaLinkStateReconfiguring ReplicaLinkState = "Reconfiguring"
	ReplicaLinkStateUpdating      ReplicaLinkState = "Updating"
)

// PossibleReplicaLinkStateValues returns the possible values for the ReplicaLinkState const type.
func PossibleReplicaLinkStateValues() []ReplicaLinkState {
	return []ReplicaLinkState{
		ReplicaLinkStateActive,
		ReplicaLinkStateBroken,
		ReplicaLinkStateCatchup,
		ReplicaLinkStateProvisioning,
		ReplicaLinkStateReconfiguring,
		ReplicaLinkStateUpdating,
	}
}

// ReplicationPromoteMode - Sets the promote mode for a replica server. This is a write only property.
...
// PossibleReplicationPromoteModeValues returns the possible values for the ReplicationPromoteMode const type.
func PossibleReplicationPromoteModeValues() []ReplicationPromoteMode {
	return []ReplicationPromoteMode{
		ReplicationPromoteModeSiteswap,
		ReplicationPromoteModeStandalone,
	}
}
