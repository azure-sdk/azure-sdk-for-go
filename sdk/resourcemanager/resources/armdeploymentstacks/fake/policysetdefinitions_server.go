...
// PolicySetDefinitionsServer is a fake server for instances of the armdeploymentstacks.PolicySetDefinitionsClient type.
type PolicySetDefinitionsServer struct {
	...
	CreateOrUpdate func(ctx context.Context, policySetDefinitionName string, parameters armdeploymentstacks.PolicySetDefinition, options *armdeploymentstacks.PolicySetDefinitionsClientCreateOrUpdateOptions) (resp azfake.Responder[armdeploymentstacks.PolicySetDefinitionsClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)

	// CreateOrUpdateAtManagementGroup is the fake for method PolicySetDefinitionsClient.CreateOrUpdateAtManagementGroup
	// HTTP status codes to indicate success: http.StatusOK, http.StatusCreated
	CreateOrUpdateAtManagementGroup func(ctx context.Context, managementGroupID string, policySetDefinitionName string, parameters armdeploymentstacks.PolicySetDefinition, options *armdeploymentstacks.PolicySetDefinitionsClientCreateOrUpdateAtManagementGroupOptions) (resp azfake.Responder[armdeploymentstacks.PolicySetDefinitionsClientCreateOrUpdateAtManagementGroupResponse], errResp azfake.ErrorResponder)

	// Delete is the fake for method PolicySetDefinitionsClient.Delete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	Delete func(ctx context.Context, policySetDefinitionName string, options *armdeploymentstacks.PolicySetDefinitionsClientDeleteOptions) (resp azfake.Responder[armdeploymentstacks.PolicySetDefinitionsClientDeleteResponse], errResp azfake.ErrorResponder)

	// DeleteAtManagementGroup is the fake for method PolicySetDefinitionsClient.DeleteAtManagementGroup
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	DeleteAtManagementGroup func(ctx context.Context, managementGroupID string, policySetDefinitionName string, options *armdeploymentstacks.PolicySetDefinitionsClientDeleteAtManagementGroupOptions) (resp azfake.Responder[armdeploymentstacks.PolicySetDefinitionsClientDeleteAtManagementGroupResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method PolicySetDefinitionsClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, policySetDefinitionName string, options *armdeploymentstacks.PolicySetDefinitionsClientGetOptions) (resp azfake.Responder[armdeploymentstacks.PolicySetDefinitionsClientGetResponse], errResp azfake.ErrorResponder)

	// GetAtManagementGroup is the fake for method PolicySetDefinitionsClient.GetAtManagementGroup
	// HTTP status codes to indicate success: http.StatusOK
	GetAtManagementGroup func(ctx context.Context, managementGroupID string, policySetDefinitionName string, options *armdeploymentstacks.PolicySetDefinitionsClientGetAtManagementGroupOptions) (resp azfake.Responder[armdeploymentstacks.PolicySetDefinitionsClientGetAtManagementGroupResponse], errResp azfake.ErrorResponder)

	// GetBuiltIn is the fake for method PolicySetDefinitionsClient.GetBuiltIn
	// HTTP status codes to indicate success: http.StatusOK
	GetBuiltIn func(ctx context.Context, policySetDefinitionName string, options *armdeploymentstacks.PolicySetDefinitionsClientGetBuiltInOptions) (resp azfake.Responder[armdeploymentstacks.PolicySetDefinitionsClientGetBuiltInResponse], errResp azfake.ErrorResponder)

	// NewListPager is the fake for method PolicySetDefinitionsClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(options *armdeploymentstacks.PolicySetDefinitionsClientListOptions) (resp azfake.PagerResponder[armdeploymentstacks.PolicySetDefinitionsClientListResponse])

	// NewListBuiltInPager is the fake for method PolicySetDefinitionsClient.NewListBuiltInPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListBuiltInPager func(options *armdeploymentstacks.PolicySetDefinitionsClientListBuiltInOptions) (resp azfake.PagerResponder[armdeploymentstacks.PolicySetDefinitionsClientListBuiltInResponse])

	// NewListByManagementGroupPager is the fake for method PolicySetDefinitionsClient.NewListByManagementGroupPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByManagementGroupPager func(managementGroupID string, options *armdeploymentstacks.PolicySetDefinitionsClientListByManagementGroupOptions) (resp azfake.PagerResponder[armdeploymentstacks.PolicySetDefinitionsClientListByManagementGroupResponse])
}
...
// The returned PolicySetDefinitionsServerTransport instance is connected to an instance of armdeploymentstacks.PolicySetDefinitionsClient via the
...
func NewPolicySetDefinitionsServerTransport(srv *PolicySetDefinitionsServer) *PolicySetDefinitionsServerTransport {
	return &PolicySetDefinitionsServerTransport{
		srv:                           srv,
		newListPager:                  newTracker[azfake.PagerResponder[armdeploymentstacks.PolicySetDefinitionsClientListResponse]](),
		newListBuiltInPager:           newTracker[azfake.PagerResponder[armdeploymentstacks.PolicySetDefinitionsClientListBuiltInResponse]](),
		newListByManagementGroupPager: newTracker[azfake.PagerResponder[armdeploymentstacks.PolicySetDefinitionsClientListByManagementGroupResponse]](),
	}
}

// PolicySetDefinitionsServerTransport connects instances of armdeploymentstacks.PolicySetDefinitionsClient to instances of PolicySetDefinitionsServer.
...
type PolicySetDefinitionsServerTransport struct {
	...
	newListPager                  *tracker[azfake.PagerResponder[armdeploymentstacks.PolicySetDefinitionsClientListResponse]]
	newListBuiltInPager           *tracker[azfake.PagerResponder[armdeploymentstacks.PolicySetDefinitionsClientListBuiltInResponse]]
	newListByManagementGroupPager *tracker[azfake.PagerResponder[armdeploymentstacks.PolicySetDefinitionsClientListByManagementGroupResponse]]
}
...
func (p *PolicySetDefinitionsServerTransport) dispatchCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[armdeploymentstacks.PolicySetDefinition](req)
	if err != nil {
		return nil, err
	}
...
func (p *PolicySetDefinitionsServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		var options *armdeploymentstacks.PolicySetDefinitionsClientListOptions
		if filterParam != nil || topParam != nil {
			options = &armdeploymentstacks.PolicySetDefinitionsClientListOptions{
				Filter: filterParam,
				Top:    topParam,
			}
		}
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armdeploymentstacks.PolicySetDefinitionsClientListResponse, createLink func() string) {
...
func (p *PolicySetDefinitionsServerTransport) dispatchNewListBuiltInPager(req *http.Request) (*http.Response, error) {
	...
	if newListBuiltInPager == nil {
		...
		var options *armdeploymentstacks.PolicySetDefinitionsClientListBuiltInOptions
		if filterParam != nil || topParam != nil {
			options = &armdeploymentstacks.PolicySetDefinitionsClientListBuiltInOptions{
				Filter: filterParam,
				Top:    topParam,
			}
		}
		...
		server.PagerResponderInjectNextLinks(newListBuiltInPager, req, func(page *armdeploymentstacks.PolicySetDefinitionsClientListBuiltInResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
...
func (p *PolicySetDefinitionsServerTransport) dispatchNewListByManagementGroupPager(req *http.Request) (*http.Response, error) {
	...
	if newListByManagementGroupPager == nil {
		...
		var options *armdeploymentstacks.PolicySetDefinitionsClientListByManagementGroupOptions
		if filterParam != nil || topParam != nil {
			options = &armdeploymentstacks.PolicySetDefinitionsClientListByManagementGroupOptions{
				Filter: filterParam,
				Top:    topParam,
			}
		}
		...
		server.PagerResponderInjectNextLinks(newListByManagementGroupPager, req, func(page *armdeploymentstacks.PolicySetDefinitionsClientListByManagementGroupResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
