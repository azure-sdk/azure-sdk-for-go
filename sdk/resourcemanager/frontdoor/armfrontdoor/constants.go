...
// ScrubbingRuleEntryMatchOperator - Comparison type to use for matching with the variable value in log.
...
// WebApplicationFirewallScrubbingState - State of the log scrub config. Default value is Enabled.
