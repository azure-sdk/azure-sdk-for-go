...
// CreateOrUpdate - Creates or updates diagnostic settings for AadCustomSecurityAttributesDiagnosticSettings.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2017-04-01-preview
//   - diagnosticSettingName - The name of the diagnostic setting.
...
//     method.
func (client *DiagnosticSettingsClient) CreateOrUpdate(ctx context.Context, diagnosticSettingName string, parameters DiagnosticSettingsResource, options *DiagnosticSettingsClientCreateOrUpdateOptions) (DiagnosticSettingsClientCreateOrUpdateResponse, error) {
	req, err := client.createOrUpdateCreateRequest(ctx, diagnosticSettingName, parameters, options)
	if err != nil {
...
func (client *DiagnosticSettingsClient) createOrUpdateCreateRequest(ctx context.Context, diagnosticSettingName string, parameters DiagnosticSettingsResource, options *DiagnosticSettingsClientCreateOrUpdateOptions) (*policy.Request, error) {
	urlPath := "/providers/Microsoft.AadCustomSecurityAttributesDiagnosticSettings/diagnosticSettings/{diagnosticSettingName}"
	if diagnosticSettingName == "" {
		return nil, errors.New("parameter diagnosticSettingName cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{diagnosticSettingName}", url.PathEscape(diagnosticSettingName))
...
// Delete - Deletes existing diagnostic setting for AadCustomSecurityAttributesDiagnosticSettings.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2017-04-01-preview
//   - diagnosticSettingName - The name of the diagnostic setting.
...
//     method.
func (client *DiagnosticSettingsClient) Delete(ctx context.Context, diagnosticSettingName string, options *DiagnosticSettingsClientDeleteOptions) (DiagnosticSettingsClientDeleteResponse, error) {
	req, err := client.deleteCreateRequest(ctx, diagnosticSettingName, options)
	if err != nil {
...
func (client *DiagnosticSettingsClient) deleteCreateRequest(ctx context.Context, diagnosticSettingName string, options *DiagnosticSettingsClientDeleteOptions) (*policy.Request, error) {
	urlPath := "/providers/Microsoft.AadCustomSecurityAttributesDiagnosticSettings/diagnosticSettings/{diagnosticSettingName}"
	if diagnosticSettingName == "" {
		return nil, errors.New("parameter diagnosticSettingName cannot be empty")
	}
...
// Get - Gets the active diagnostic setting for AadCustomSecurityAttributesDiagnosticSettings.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2017-04-01-preview
//   - diagnosticSettingName - The name of the diagnostic setting.
//   - options - DiagnosticSettingsClientGetOptions contains the optional parameters for the DiagnosticSettingsClient.Get method.
func (client *DiagnosticSettingsClient) Get(ctx context.Context, diagnosticSettingName string, options *DiagnosticSettingsClientGetOptions) (DiagnosticSettingsClientGetResponse, error) {
	req, err := client.getCreateRequest(ctx, diagnosticSettingName, options)
	if err != nil {
...
func (client *DiagnosticSettingsClient) getCreateRequest(ctx context.Context, diagnosticSettingName string, options *DiagnosticSettingsClientGetOptions) (*policy.Request, error) {
	urlPath := "/providers/Microsoft.AadCustomSecurityAttributesDiagnosticSettings/diagnosticSettings/{diagnosticSettingName}"
	if diagnosticSettingName == "" {
		return nil, errors.New("parameter diagnosticSettingName cannot be empty")
	}
...
// List - Gets the active diagnostic settings list for AadCustomSecurityAttributesDiagnosticSettings.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2017-04-01-preview
...
func (client *DiagnosticSettingsClient) listCreateRequest(ctx context.Context, options *DiagnosticSettingsClientListOptions) (*policy.Request, error) {
	urlPath := "/providers/Microsoft.AadCustomSecurityAttributesDiagnosticSettings/diagnosticSettings"
	req, err := runtime.NewRequest(ctx, http.MethodGet, runtime.JoinPaths(client.internal.Endpoint(), urlPath))
	if err != nil {
		return nil, err
	}
