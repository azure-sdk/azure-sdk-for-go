...
func (client *HostPoolsClient) Update(ctx context.Context, resourceGroupName string, hostPoolName string, body HostPoolPatch, options *HostPoolsClientUpdateOptions) (HostPoolsClientUpdateResponse, error) {
	var err error
...
func (client *HostPoolsClient) updateCreateRequest(ctx context.Context, resourceGroupName string, hostPoolName string, body HostPoolPatch, options *HostPoolsClientUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DesktopVirtualization/hostPools/{hostPoolName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *HostPoolsClient) updateHandleResponse(resp *http.Response) (HostPoolsClientUpdateResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.HostPoolPatch); err != nil {
		return HostPoolsClientUpdateResponse{}, err
	}
	return result, nil
}
