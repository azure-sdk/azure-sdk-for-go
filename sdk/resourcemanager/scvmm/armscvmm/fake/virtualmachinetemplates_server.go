...
func (v *VirtualMachineTemplatesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if virtualMachineTemplatesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = virtualMachineTemplatesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to VirtualMachineTemplatesServerTransport
var virtualMachineTemplatesServerTransportInterceptor interface {
