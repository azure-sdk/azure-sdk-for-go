...
func (client *RoutingInfoClient) getCreateRequest(ctx context.Context, resourceGroupName string, packetCoreControlPlaneName string, _ *RoutingInfoClientGetOptions) (*policy.Request, error) {
...
func (client *RoutingInfoClient) listCreateRequest(ctx context.Context, resourceGroupName string, packetCoreControlPlaneName string, _ *RoutingInfoClientListOptions) (*policy.Request, error) {
