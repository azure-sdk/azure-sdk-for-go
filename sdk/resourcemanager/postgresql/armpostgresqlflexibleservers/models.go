...
type DataEncryption struct {
	...
	GeoBackupDelegatedIdentityClientID *string
...
// DelegatedResources - Defines delegated resources.
type DelegatedResources struct {
...
type UserAssignedIdentity struct {
	...
	DelegatedResources map[string]*DelegatedResources
