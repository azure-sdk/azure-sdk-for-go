...
func NewRegistryComponentVersionsClient(subscriptionID string, credential azcore.TokenCredential, options *arm.ClientOptions) (*RegistryComponentVersionsClient, error) {
	cl, err := arm.NewClient(moduleName+".RegistryComponentVersionsClient", moduleVersion, credential, options)
	if err != nil {
		return nil, err
	}
...
func (client *RegistryComponentVersionsClient) BeginCreateOrUpdate(ctx context.Context, resourceGroupName string, registryName string, componentName string, version string, body ComponentVersion, options *RegistryComponentVersionsClientBeginCreateOrUpdateOptions) (*runtime.Poller[RegistryComponentVersionsClientCreateOrUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return runtime.NewPollerFromResumeToken[RegistryComponentVersionsClientCreateOrUpdateResponse](options.ResumeToken, client.internal.Pipeline(), nil)
	}
}
...
func (client *RegistryComponentVersionsClient) BeginDelete(ctx context.Context, resourceGroupName string, registryName string, componentName string, version string, options *RegistryComponentVersionsClientBeginDeleteOptions) (*runtime.Poller[RegistryComponentVersionsClientDeleteResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return runtime.NewPollerFromResumeToken[RegistryComponentVersionsClientDeleteResponse](options.ResumeToken, client.internal.Pipeline(), nil)
	}
}
...
// GetBlobReferenceSAS - Get a SAS for a blob reference associated with the component
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2023-10-01
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - registryName - Name of Azure Machine Learning registry. This is case-insensitive
//   - componentName - Component name. This is case-sensitive.
//   - version - Version identifier. This is case-sensitive.
//   - body - blob reference request object
//   - options - RegistryComponentVersionsClientGetBlobReferenceSASOptions contains the optional parameters for the RegistryComponentVersionsClient.GetBlobReferenceSAS
//     method.
func (client *RegistryComponentVersionsClient) GetBlobReferenceSAS(ctx context.Context, resourceGroupName string, registryName string, componentName string, version string, body BlobReferenceSASRequestDto, options *RegistryComponentVersionsClientGetBlobReferenceSASOptions) (RegistryComponentVersionsClientGetBlobReferenceSASResponse, error) {
	var err error
	req, err := client.getBlobReferenceSASCreateRequest(ctx, resourceGroupName, registryName, componentName, version, body, options)
	if err != nil {
		return RegistryComponentVersionsClientGetBlobReferenceSASResponse{}, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
	if err != nil {
		return RegistryComponentVersionsClientGetBlobReferenceSASResponse{}, err
...
func (client *RegistryComponentVersionsClient) getBlobReferenceSASCreateRequest(ctx context.Context, resourceGroupName string, registryName string, componentName string, version string, body BlobReferenceSASRequestDto, options *RegistryComponentVersionsClientGetBlobReferenceSASOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/registries/{registryName}/components/{componentName}/versions/{version}/getBlobReferenceSAS"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{subscriptionId}", url.PathEscape(client.subscriptionID))
...
func (client *RegistryComponentVersionsClient) getBlobReferenceSASHandleResponse(resp *http.Response) (RegistryComponentVersionsClientGetBlobReferenceSASResponse, error) {
	result := RegistryComponentVersionsClientGetBlobReferenceSASResponse{}
