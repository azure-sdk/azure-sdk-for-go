...
// Get - Gets an application in a VM scale set instance.
...
//   - options - VirtualMachineScaleSetVirtualMachineApplicationsClientGetOptions contains the optional parameters for the VirtualMachineScaleSetVirtualMachineApplicationsClient.Get
//     method.
func (client *VirtualMachineScaleSetVirtualMachineApplicationsClient) Get(ctx context.Context, resourceGroupName string, vmScaleSetName string, instanceID string, applicationName string, options *VirtualMachineScaleSetVirtualMachineApplicationsClientGetOptions) (VirtualMachineScaleSetVirtualMachineApplicationsClientGetResponse, error) {
...
func (client *VirtualMachineScaleSetVirtualMachineApplicationsClient) GetInstanceView(ctx context.Context, resourceGroupName string, vmScaleSetName string, instanceID string, applicationName string, options *VirtualMachineScaleSetVirtualMachineApplicationsClientGetInstanceViewOptions) (VirtualMachineScaleSetVirtualMachineApplicationsClientGetInstanceViewResponse, error) {
	...
	if !runtime.HasStatusCode(resp, http.StatusOK) {
		return VirtualMachineScaleSetVirtualMachineApplicationsClientGetInstanceViewResponse{}, runtime.NewResponseError(resp)
	}
