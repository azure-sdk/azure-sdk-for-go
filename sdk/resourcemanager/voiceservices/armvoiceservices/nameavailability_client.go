...
func (client *NameAvailabilityClient) checkLocalCreateRequest(ctx context.Context, location string, body CheckNameAvailabilityRequest, _ *NameAvailabilityClientCheckLocalOptions) (*policy.Request, error) {
