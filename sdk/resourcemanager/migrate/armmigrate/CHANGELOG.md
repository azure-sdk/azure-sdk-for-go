...
- New function `*SQLSitesControllerClient.TriggerImportInventory(context.Context, string, string, string, SQLInventoryImportBody, *SQLSitesControllerClientTriggerImportInventoryOptions) (SQLSitesControllerClientTriggerImportInventoryResponse, error)`
