	...
	go func() {
		...
		if !intercepted {
			...
			case "Client.BeginDeleteKubernetesVersions":
				res.resp, res.err = s.dispatchBeginDeleteKubernetesVersions(req)
			case "Client.BeginDeleteVMSKUs":
				res.resp, res.err = s.dispatchBeginDeleteVMSKUs(req)
			case "Client.GetKubernetesVersions":
				res.resp, res.err = s.dispatchGetKubernetesVersions(req)
			case "Client.GetVMSKUs":
				res.resp, res.err = s.dispatchGetVMSKUs(req)
			case "Client.BeginPutKubernetesVersions":
				res.resp, res.err = s.dispatchBeginPutKubernetesVersions(req)
			case "Client.BeginPutVMSKUs":
				res.resp, res.err = s.dispatchBeginPutVMSKUs(req)
			default:
