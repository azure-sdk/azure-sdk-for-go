...
func (i *IscsiTargetsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if iscsiTargetsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = iscsiTargetsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "IscsiTargetsClient.NewListByDiskPoolPager":
				res.resp, res.err = i.dispatchNewListByDiskPoolPager(req)
...
// set this to conditionally intercept incoming requests to IscsiTargetsServerTransport
var iscsiTargetsServerTransportInterceptor interface {
