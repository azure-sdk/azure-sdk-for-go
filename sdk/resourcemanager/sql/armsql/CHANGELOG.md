...
- New field `SupportedAutoPauseDelay`, `SupportedMinCapacities`, `SupportedPerDatabaseAutoPauseDelay` in struct `ElasticPoolPerformanceLevelCapability`
...
- New field `Identity` in struct `JobAgentUpdate`
