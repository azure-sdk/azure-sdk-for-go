...
// AttackPatternClientCreateOrUpdateResponse contains the response from method AttackPatternClient.CreateOrUpdate.
type AttackPatternClientCreateOrUpdateResponse struct {
	// Represents an attack pattern in Azure Security Insights.
	AttackPattern
}

// AttackPatternClientDeleteResponse contains the response from method AttackPatternClient.Delete.
type AttackPatternClientDeleteResponse struct {
	// placeholder for future response values
}

// AttackPatternClientGetResponse contains the response from method AttackPatternClient.Get.
type AttackPatternClientGetResponse struct {
	// Represents an attack pattern in Azure Security Insights.
	AttackPattern
}

// AttackPatternsClientListResponse contains the response from method AttackPatternsClient.NewListPager.
type AttackPatternsClientListResponse struct {
	// List all the Attack Patterns.
	AttackPatternsList
}
...
// IdentitiesClientListResponse contains the response from method IdentitiesClient.NewListPager.
type IdentitiesClientListResponse struct {
	// List all the Identities.
	IdentitiesList
}

// IdentityClientCreateOrUpdateResponse contains the response from method IdentityClient.CreateOrUpdate.
type IdentityClientCreateOrUpdateResponse struct {
	// Represents an identity in Azure Security Insights.
	Identity
}

// IdentityClientDeleteResponse contains the response from method IdentityClient.Delete.
type IdentityClientDeleteResponse struct {
	// placeholder for future response values
}

// IdentityClientGetResponse contains the response from method IdentityClient.Get.
type IdentityClientGetResponse struct {
	// Represents an identity in Azure Security Insights.
	Identity
}
...
// IndicatorClientCreateOrUpdateResponse contains the response from method IndicatorClient.CreateOrUpdate.
type IndicatorClientCreateOrUpdateResponse struct {
	// Represents an indicator in Azure Security Insights.
	Indicator
}

// IndicatorClientDeleteResponse contains the response from method IndicatorClient.Delete.
type IndicatorClientDeleteResponse struct {
	// placeholder for future response values
}

// IndicatorClientGetResponse contains the response from method IndicatorClient.Get.
type IndicatorClientGetResponse struct {
	// Represents an indicator in Azure Security Insights.
	Indicator
}

// IndicatorsClientListResponse contains the response from method IndicatorsClient.NewListPager.
type IndicatorsClientListResponse struct {
...
// RelationshipClientCreateOrUpdateResponse contains the response from method RelationshipClient.CreateOrUpdate.
type RelationshipClientCreateOrUpdateResponse struct {
	// Represents a relationship in Azure Security Insights.
	Relationship
}

// RelationshipClientDeleteResponse contains the response from method RelationshipClient.Delete.
type RelationshipClientDeleteResponse struct {
	// placeholder for future response values
}

// RelationshipClientGetResponse contains the response from method RelationshipClient.Get.
type RelationshipClientGetResponse struct {
	// Represents a relationship in Azure Security Insights.
	Relationship
}

// RelationshipsClientListResponse contains the response from method RelationshipsClient.NewListPager.
type RelationshipsClientListResponse struct {
...
// ThreatActorClientCreateOrUpdateResponse contains the response from method ThreatActorClient.CreateOrUpdate.
type ThreatActorClientCreateOrUpdateResponse struct {
	// Represents a threat actor in Azure Security Insights.
	ThreatActor
}

// ThreatActorClientDeleteResponse contains the response from method ThreatActorClient.Delete.
type ThreatActorClientDeleteResponse struct {
	// placeholder for future response values
}

// ThreatActorClientGetResponse contains the response from method ThreatActorClient.Get.
type ThreatActorClientGetResponse struct {
	// Represents a threat actor in Azure Security Insights.
	ThreatActor
}

// ThreatActorsClientListResponse contains the response from method ThreatActorsClient.NewListPager.
type ThreatActorsClientListResponse struct {
	// List all the Threat Actors.
	ThreatActorsList
}
