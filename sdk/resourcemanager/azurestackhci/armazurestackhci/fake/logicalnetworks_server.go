...
// The returned LogicalNetworksServerTransport instance is connected to an instance of armazurestackhci.LogicalNetworksClient via the
...
func NewLogicalNetworksServerTransport(srv *LogicalNetworksServer) *LogicalNetworksServerTransport {
	return &LogicalNetworksServerTransport{
		srv:                 srv,
		beginCreateOrUpdate: newTracker[azfake.PollerResponder[armazurestackhci.LogicalNetworksClientCreateOrUpdateResponse]](),
		beginDelete:         newTracker[azfake.PollerResponder[armazurestackhci.LogicalNetworksClientDeleteResponse]](),
		newListPager:        newTracker[azfake.PagerResponder[armazurestackhci.LogicalNetworksClientListResponse]](),
		newListAllPager:     newTracker[azfake.PagerResponder[armazurestackhci.LogicalNetworksClientListAllResponse]](),
		beginUpdate:         newTracker[azfake.PollerResponder[armazurestackhci.LogicalNetworksClientUpdateResponse]](),
	}
}

// LogicalNetworksServerTransport connects instances of armazurestackhci.LogicalNetworksClient to instances of LogicalNetworksServer.
...
type LogicalNetworksServerTransport struct {
	...
	beginCreateOrUpdate *tracker[azfake.PollerResponder[armazurestackhci.LogicalNetworksClientCreateOrUpdateResponse]]
	beginDelete         *tracker[azfake.PollerResponder[armazurestackhci.LogicalNetworksClientDeleteResponse]]
	newListPager        *tracker[azfake.PagerResponder[armazurestackhci.LogicalNetworksClientListResponse]]
	newListAllPager     *tracker[azfake.PagerResponder[armazurestackhci.LogicalNetworksClientListAllResponse]]
	beginUpdate         *tracker[azfake.PollerResponder[armazurestackhci.LogicalNetworksClientUpdateResponse]]
}
...
func (l *LogicalNetworksServerTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "LogicalNetworksClient.NewListPager":
...
func (l *LogicalNetworksServerTransport) dispatchBeginCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginCreateOrUpdate == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armazurestackhci.LogicalNetworks](req)
		if err != nil {
			return nil, err
		}
...
func (l *LogicalNetworksServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	resp, err := server.MarshalResponseAsJSON(respContent, server.GetResponse(respr).LogicalNetworks, req)
	if err != nil {
		return nil, err
	}
	return resp, nil
...
func (l *LogicalNetworksServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armazurestackhci.LogicalNetworksClientListResponse, createLink func() string) {
...
func (l *LogicalNetworksServerTransport) dispatchNewListAllPager(req *http.Request) (*http.Response, error) {
	...
	if newListAllPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListAllPager, req, func(page *armazurestackhci.LogicalNetworksClientListAllResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
...
func (l *LogicalNetworksServerTransport) dispatchBeginUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginUpdate == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armazurestackhci.LogicalNetworksUpdateRequest](req)
		if err != nil {
			return nil, err
		}
		resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
