...
type AvailabilityGroupListener struct {
	...
	// READ-ONLY; Name of the availability group listener.
	Name *string
...
// AvailabilityGroupListenerListResult - The response of a AvailabilityGroupListener list operation.
type AvailabilityGroupListenerListResult struct {
	// READ-ONLY; The AvailabilityGroupListener items on this page
...
type Group struct {
	...
	// READ-ONLY; Name of the SQL virtual machine group.
	Name *string
...
// GroupListResult - The response of a SqlVirtualMachineGroup list operation.
type GroupListResult struct {
	// READ-ONLY; The SqlVirtualMachineGroup items on this page
	Value []*Group
...
// ListResult - The response of a SqlVirtualMachine list operation.
type ListResult struct {
	// READ-ONLY; The SqlVirtualMachine items on this page
...
type Operation struct {
	// READ-ONLY; he localized display information for this particular operation / action.
	...
	Properties map[string]*OperationProperty
}
...
// OperationListResult - Virtual machine resource id for response.
...
type SQLVirtualMachine struct {
	...
	// READ-ONLY; Name of the SQL virtual machine.
	Name *string
