...
// MarshalJSON implements the json.Marshaller interface for type RebootNodeKinds.
func (r RebootNodeKinds) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "nodeRebootOption", r.NodeRebootKind)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type RebootNodeKinds.
func (r *RebootNodeKinds) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
