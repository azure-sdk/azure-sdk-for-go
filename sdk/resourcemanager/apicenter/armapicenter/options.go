...
// WorkspacesClientBeginImportAPISourceOptions contains the optional parameters for the WorkspacesClient.BeginImportAPISource
// method.
type WorkspacesClientBeginImportAPISourceOptions struct {
	// Resumes the LRO from the provided token.
	ResumeToken string
}
