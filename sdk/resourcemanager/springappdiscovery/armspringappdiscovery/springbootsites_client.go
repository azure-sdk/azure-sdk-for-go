...
func (client *SpringbootsitesClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, springbootsitesName string, springbootsites SpringbootsitesModel, _ *SpringbootsitesClientCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *SpringbootsitesClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, springbootsitesName string, _ *SpringbootsitesClientBeginDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OffAzureSpringBoot/springbootsites/{springbootsitesName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *SpringbootsitesClient) getCreateRequest(ctx context.Context, resourceGroupName string, springbootsitesName string, _ *SpringbootsitesClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OffAzureSpringBoot/springbootsites/{springbootsitesName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *SpringbootsitesClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, _ *SpringbootsitesClientListByResourceGroupOptions) (*policy.Request, error) {
...
func (client *SpringbootsitesClient) listBySubscriptionCreateRequest(ctx context.Context, _ *SpringbootsitesClientListBySubscriptionOptions) (*policy.Request, error) {
...
func (client *SpringbootsitesClient) triggerRefreshSiteCreateRequest(ctx context.Context, resourceGroupName string, springbootsitesName string, _ *SpringbootsitesClientBeginTriggerRefreshSiteOptions) (*policy.Request, error) {
...
func (client *SpringbootsitesClient) updateCreateRequest(ctx context.Context, resourceGroupName string, springbootsitesName string, springbootsites SpringbootsitesPatch, _ *SpringbootsitesClientBeginUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OffAzureSpringBoot/springbootsites/{springbootsitesName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
