...
func NewUsagesClient(location string, subscriptionID string, credential azcore.TokenCredential, options *arm.ClientOptions) (*UsagesClient, error) {
...
//     method.
func (client *UsagesClient) NewListBySubscriptionPager(searchManagementRequestOptions *SearchManagementRequestOptions, options *UsagesClientListBySubscriptionOptions) *runtime.Pager[UsagesClientListBySubscriptionResponse] {
	return runtime.NewPager(runtime.PagingHandler[UsagesClientListBySubscriptionResponse]{
		...
		Fetcher: func(ctx context.Context, page *UsagesClientListBySubscriptionResponse) (UsagesClientListBySubscriptionResponse, error) {
			...
			if !runtime.HasStatusCode(resp, http.StatusOK) {
				return UsagesClientListBySubscriptionResponse{}, runtime.NewResponseError(resp)
			}
...
func (client *UsagesClient) listBySubscriptionCreateRequest(ctx context.Context, searchManagementRequestOptions *SearchManagementRequestOptions, options *UsagesClientListBySubscriptionOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/providers/Microsoft.Search/locations/{location}/usages"
	if client.location == "" {
		return nil, errors.New("parameter client.location cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{location}", url.PathEscape(client.location))
