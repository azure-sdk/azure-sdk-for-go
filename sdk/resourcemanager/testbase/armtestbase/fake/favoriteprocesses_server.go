...
func (f *FavoriteProcessesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if favoriteProcessesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = favoriteProcessesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to FavoriteProcessesServerTransport
var favoriteProcessesServerTransportInterceptor interface {
