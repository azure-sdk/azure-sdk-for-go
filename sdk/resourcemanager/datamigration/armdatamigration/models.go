...
type DatabaseMigrationPropertiesSQLDb struct {
	...
	// Resource Type
	Kind *DatabaseMigrationPropertiesSQLDbKind `json:"kind,omitempty"`
	...
	// READ-ONLY; Source Location details of backups.
	BackupConfiguration *SQLDbBackupConfiguration `json:"backupConfiguration,omitempty" azure:"ro"`
	...
	// READ-ONLY; Minimum Row count and size of a table with a clustered index required to perform parallel data copy
	SQLDataCopyThresholds *SQLDataCopyThresholds `json:"sqlDataCopyThresholds,omitempty" azure:"ro"`
...
// DatabaseMigrationSQLMiListResult - A list of Database Migrations for SQL Managed Instance.
type DatabaseMigrationSQLMiListResult struct {
	// READ-ONLY
	NextLink *string `json:"nextLink,omitempty" azure:"ro"`

	// READ-ONLY
	Value []*DatabaseMigrationSQLMi `json:"value,omitempty" azure:"ro"`
}
...
// DatabaseMigrationSQLVMListResult - A list of Database Migrations for SQL Virtual Machine.
type DatabaseMigrationSQLVMListResult struct {
	// READ-ONLY
	NextLink *string `json:"nextLink,omitempty" azure:"ro"`

	// READ-ONLY
	Value []*DatabaseMigrationSQLVM `json:"value,omitempty" azure:"ro"`
}
...
// DatabaseMigrationsSQLDbClientRetryOptions contains the optional parameters for the DatabaseMigrationsSQLDbClient.Retry
// method.
type DatabaseMigrationsSQLDbClientRetryOptions struct {
...
// DatabaseMigrationsSQLMiClientListByScopeOptions contains the optional parameters for the DatabaseMigrationsSQLMiClient.ListByScope
// method.
type DatabaseMigrationsSQLMiClientListByScopeOptions struct {
	// placeholder for future optional parameters
}
...
// DatabaseMigrationsSQLVMClientListByScopeOptions contains the optional parameters for the DatabaseMigrationsSQLVMClient.ListByScope
// method.
type DatabaseMigrationsSQLVMClientListByScopeOptions struct {
	// placeholder for future optional parameters
}
...
// KeyVaultProperties - Key Vault properties for user credentials.
type KeyVaultProperties struct {
	// Key Vault Secret Name corresponding to file share password.
	FileSharePasswordSecretName *string `json:"fileSharePasswordSecretName,omitempty"`

	// Key Vault Secret Name corresponding to file share username.
	FileShareUsernameSecretName *string `json:"fileShareUsernameSecretName,omitempty"`

	// Key Vault Name.
	Name *string `json:"name,omitempty"`

	// Key Vault Secret Name corresponding to source password.
	SourcePasswordSecretName *string `json:"sourcePasswordSecretName,omitempty"`

	// Key Vault Secret Name corresponding to source username.
	SourceUsernameSecretName *string `json:"sourceUsernameSecretName,omitempty"`
}
...
// SQLDataCopyThresholds - Minimum Row count and size of a table with a clustered index required to perform parallel data
// copy
type SQLDataCopyThresholds struct {
	// Minimum required size in kbs of a table with a clustered index to perform parallel data copy
	CidxKbsThreshold *int32 `json:"cidxKbsThreshold,omitempty"`

	// Minimum row count of a table with clustered index to perform parallel data copy
	CidxRowThreshold *int32 `json:"cidxRowThreshold,omitempty"`
}

// SQLDbBackupConfiguration - Backup Configuration
type SQLDbBackupConfiguration struct {
	// READ-ONLY; Source location of backups.
	SourceLocation *SQLDbSourceBackupLocation `json:"sourceLocation,omitempty" azure:"ro"`
}
...
// SQLDbSourceBackupLocation - Source Location details of backups.
type SQLDbSourceBackupLocation struct {
...
// SQLMigrationServicesClientMonitoringDataOptions contains the optional parameters for the SQLMigrationServicesClient.MonitoringData
// method.
type SQLMigrationServicesClientMonitoringDataOptions struct {
	// placeholder for future optional parameters
}
...
// SQLMigrationServicesClientValidateIROptions contains the optional parameters for the SQLMigrationServicesClient.ValidateIR
// method.
type SQLMigrationServicesClientValidateIROptions struct {
	// placeholder for future optional parameters
}
...
type TestConnectivityData struct {
	Code    *string `json:"code,omitempty"`
	Message *string `json:"message,omitempty"`
}
...
// ValidateIR - IR validations for MI / VM
type ValidateIR struct {
	// Backup configuration info.
	BackupConfiguration *BackupConfiguration `json:"backupConfiguration,omitempty"`

	// Validation errors.
	Errors []*TestConnectivityData `json:"errors,omitempty"`

	// Resource Type
	Kind *ValidateIRKind `json:"kind,omitempty"`
