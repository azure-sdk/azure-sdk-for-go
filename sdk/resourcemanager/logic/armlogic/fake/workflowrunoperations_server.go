...
func (w *WorkflowRunOperationsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if workflowRunOperationsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = workflowRunOperationsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to WorkflowRunOperationsServerTransport
var workflowRunOperationsServerTransportInterceptor interface {
