...
```go
client, err := armconnectedvmware.NewMachineExtensionsClient(<subscription ID>, cred, nil)
```
...
client, err := armconnectedvmware.NewMachineExtensionsClient(<subscription ID>, cred, &options)
```
