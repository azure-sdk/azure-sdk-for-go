...
// RunAsAccountsControllerServer is a fake server for instances of the armmigrationdiscovery.RunAsAccountsControllerClient type.
type RunAsAccountsControllerServer struct {
	// Get is the fake for method RunAsAccountsControllerClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, siteName string, accountName string, options *armmigrationdiscovery.RunAsAccountsControllerClientGetOptions) (resp azfake.Responder[armmigrationdiscovery.RunAsAccountsControllerClientGetResponse], errResp azfake.ErrorResponder)

	// NewListByVmwareSitePager is the fake for method RunAsAccountsControllerClient.NewListByVmwareSitePager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByVmwareSitePager func(resourceGroupName string, siteName string, options *armmigrationdiscovery.RunAsAccountsControllerClientListByVmwareSiteOptions) (resp azfake.PagerResponder[armmigrationdiscovery.RunAsAccountsControllerClientListByVmwareSiteResponse])
}
...
// The returned RunAsAccountsControllerServerTransport instance is connected to an instance of armmigrationdiscovery.RunAsAccountsControllerClient via the
...
func NewRunAsAccountsControllerServerTransport(srv *RunAsAccountsControllerServer) *RunAsAccountsControllerServerTransport {
	return &RunAsAccountsControllerServerTransport{
		srv:                      srv,
		newListByVmwareSitePager: newTracker[azfake.PagerResponder[armmigrationdiscovery.RunAsAccountsControllerClientListByVmwareSiteResponse]](),
	}
}

// RunAsAccountsControllerServerTransport connects instances of armmigrationdiscovery.RunAsAccountsControllerClient to instances of RunAsAccountsControllerServer.
...
type RunAsAccountsControllerServerTransport struct {
	...
	newListByVmwareSitePager *tracker[azfake.PagerResponder[armmigrationdiscovery.RunAsAccountsControllerClientListByVmwareSiteResponse]]
}
...
func (r *RunAsAccountsControllerServerTransport) dispatchNewListByVmwareSitePager(req *http.Request) (*http.Response, error) {
	...
	if newListByVmwareSitePager == nil {
		...
		server.PagerResponderInjectNextLinks(newListByVmwareSitePager, req, func(page *armmigrationdiscovery.RunAsAccountsControllerClientListByVmwareSiteResponse, createLink func() string) {
