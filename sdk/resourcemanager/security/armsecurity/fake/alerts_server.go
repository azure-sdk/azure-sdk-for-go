	...
	go func() {
		...
		if !intercepted {
			...
			case "AlertsClient.GetResourceGroupLevel":
				res.resp, res.err = a.dispatchGetResourceGroupLevel(req)
			case "AlertsClient.GetSubscriptionLevel":
				res.resp, res.err = a.dispatchGetSubscriptionLevel(req)
			...
			case "AlertsClient.NewListResourceGroupLevelByRegionPager":
				res.resp, res.err = a.dispatchNewListResourceGroupLevelByRegionPager(req)
			case "AlertsClient.NewListSubscriptionLevelByRegionPager":
				res.resp, res.err = a.dispatchNewListSubscriptionLevelByRegionPager(req)
			case "AlertsClient.BeginSimulate":
				res.resp, res.err = a.dispatchBeginSimulate(req)
			case "AlertsClient.UpdateResourceGroupLevelStateToActivate":
				res.resp, res.err = a.dispatchUpdateResourceGroupLevelStateToActivate(req)
			case "AlertsClient.UpdateResourceGroupLevelStateToDismiss":
				res.resp, res.err = a.dispatchUpdateResourceGroupLevelStateToDismiss(req)
			case "AlertsClient.UpdateResourceGroupLevelStateToInProgress":
				res.resp, res.err = a.dispatchUpdateResourceGroupLevelStateToInProgress(req)
			case "AlertsClient.UpdateResourceGroupLevelStateToResolve":
				res.resp, res.err = a.dispatchUpdateResourceGroupLevelStateToResolve(req)
			case "AlertsClient.UpdateSubscriptionLevelStateToActivate":
				res.resp, res.err = a.dispatchUpdateSubscriptionLevelStateToActivate(req)
			case "AlertsClient.UpdateSubscriptionLevelStateToDismiss":
				res.resp, res.err = a.dispatchUpdateSubscriptionLevelStateToDismiss(req)
			case "AlertsClient.UpdateSubscriptionLevelStateToInProgress":
				res.resp, res.err = a.dispatchUpdateSubscriptionLevelStateToInProgress(req)
			case "AlertsClient.UpdateSubscriptionLevelStateToResolve":
				res.resp, res.err = a.dispatchUpdateSubscriptionLevelStateToResolve(req)
			default:
