...
func (b BatchDeploymentConfiguration) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	objectMap["deploymentPropertyType"] = b.DeploymentPropertyType
	return json.Marshal(objectMap)
}
...
func (b *BatchDeploymentConfiguration) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		var err error
		switch key {
		case "deploymentPropertyType":
			err = unpopulate(val, "DeploymentPropertyType", &b.DeploymentPropertyType)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", b, err)
...
func (b BatchDeploymentProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "deploymentProperties", b.DeploymentProperties)
...
func (b *BatchDeploymentProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "deploymentProperties":
			b.DeploymentProperties, err = unmarshalBatchDeploymentConfigurationClassification(val)
			delete(rawMsg, key)
		case "description":
...
func (b BatchPipelineComponentDeploymentConfiguration) MarshalJSON() ([]byte, error) {
	...
	objectMap["deploymentPropertyType"] = BatchDeploymentConfigurationTypePipelineComponent
	populate(objectMap, "description", b.Description)
