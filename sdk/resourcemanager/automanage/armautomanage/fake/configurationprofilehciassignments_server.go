...
func (c *ConfigurationProfileHCIAssignmentsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if configurationProfileHciAssignmentsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = configurationProfileHciAssignmentsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to ConfigurationProfileHCIAssignmentsServerTransport
var configurationProfileHciAssignmentsServerTransportInterceptor interface {
