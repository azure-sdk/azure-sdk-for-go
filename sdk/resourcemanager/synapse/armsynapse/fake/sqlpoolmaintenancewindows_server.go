...
func (s *SQLPoolMaintenanceWindowsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if sqlPoolMaintenanceWindowsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = sqlPoolMaintenanceWindowsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to SQLPoolMaintenanceWindowsServerTransport
var sqlPoolMaintenanceWindowsServerTransportInterceptor interface {
