...
func (client *WebhookClient) createOrUpdateCreateRequest(ctx context.Context, reportName string, webhookName string, properties WebhookResource, _ *WebhookClientCreateOrUpdateOptions) (*policy.Request, error) {
