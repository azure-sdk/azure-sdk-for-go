...
// MarshalJSON implements the json.Marshaller interface for type DiskInfoPatchProperties.
func (d DiskInfoPatchProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "type", d.Type)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type DiskInfoPatchProperties.
func (d *DiskInfoPatchProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", d, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type HostPoolControlParameter.
func (h HostPoolControlParameter) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type HostPoolControlParameter.
func (h *HostPoolControlParameter) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", h, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type SessionHostConfigurationOperationStatus.
func (s SessionHostConfigurationOperationStatus) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type SessionHostConfigurationOperationStatus.
func (s *SessionHostConfigurationOperationStatus) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type SessionHostConfigurationOperationStatusList.
func (s SessionHostConfigurationOperationStatusList) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "nextLink", s.NextLink)
	populate(objectMap, "value", s.Value)
	return json.Marshal(objectMap)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type SessionHostConfigurationOperationStatusList.
func (s *SessionHostConfigurationOperationStatusList) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type SessionHostManagementOperationStatus.
func (s SessionHostManagementOperationStatus) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateDateTimeRFC3339(objectMap, "endTime", s.EndTime)
	populate(objectMap, "error", s.Error)
	populate(objectMap, "id", s.ID)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type SessionHostManagementOperationStatus.
func (s *SessionHostManagementOperationStatus) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type SessionHostManagementOperationStatusList.
func (s SessionHostManagementOperationStatusList) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "nextLink", s.NextLink)
	populate(objectMap, "value", s.Value)
	return json.Marshal(objectMap)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type SessionHostManagementOperationStatusList.
func (s *SessionHostManagementOperationStatusList) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type SessionHostManagementOperationStatusProperties.
func (s SessionHostManagementOperationStatusProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "action", s.Action)
	populate(objectMap, "correlationId", s.CorrelationID)
	populate(objectMap, "parentId", s.ParentID)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type SessionHostManagementOperationStatusProperties.
func (s *SessionHostManagementOperationStatusProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
	for key, val := range rawMsg {
		...
		case "correlationId":
			...
			delete(rawMsg, key)
		case "parentId":
			err = unpopulate(val, "ParentID", &s.ParentID)
			delete(rawMsg, key)
		case "progress":
...
// MarshalJSON implements the json.Marshaller interface for type ValidateSessionHostUpdateRequestBody.
func (v ValidateSessionHostUpdateRequestBody) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateDateTimeRFC3339(objectMap, "scheduledDateTime", v.ScheduledDateTime)
	populate(objectMap, "sessionHostConfiguration", v.SessionHostConfiguration)
	populate(objectMap, "sessionHostManagement", v.SessionHostManagement)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ValidateSessionHostUpdateRequestBody.
func (v *ValidateSessionHostUpdateRequestBody) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "scheduledDateTime":
			err = unpopulateDateTimeRFC3339(val, "ScheduledDateTime", &v.ScheduledDateTime)
			delete(rawMsg, key)
		case "sessionHostConfiguration":
			err = unpopulate(val, "SessionHostConfiguration", &v.SessionHostConfiguration)
			delete(rawMsg, key)
		case "sessionHostManagement":
			err = unpopulate(val, "SessionHostManagement", &v.SessionHostManagement)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", v, err)
