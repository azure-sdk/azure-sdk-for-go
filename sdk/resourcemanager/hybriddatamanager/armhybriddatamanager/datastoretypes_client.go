...
func (client *DataStoreTypesClient) getCreateRequest(ctx context.Context, dataStoreTypeName string, resourceGroupName string, dataManagerName string, _ *DataStoreTypesClientGetOptions) (*policy.Request, error) {
...
func (client *DataStoreTypesClient) listByDataManagerCreateRequest(ctx context.Context, resourceGroupName string, dataManagerName string, _ *DataStoreTypesClientListByDataManagerOptions) (*policy.Request, error) {
