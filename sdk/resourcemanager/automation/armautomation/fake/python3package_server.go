...
type Python3PackageServer struct {
	// BeginCreateOrUpdate is the fake for method Python3PackageClient.BeginCreateOrUpdate
	// HTTP status codes to indicate success: http.StatusOK, http.StatusCreated
	BeginCreateOrUpdate func(ctx context.Context, resourceGroupName string, automationAccountName string, packageName string, parameters armautomation.PythonPackageCreateParameters, options *armautomation.Python3PackageClientBeginCreateOrUpdateOptions) (resp azfake.PollerResponder[armautomation.Python3PackageClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)
...
func NewPython3PackageServerTransport(srv *Python3PackageServer) *Python3PackageServerTransport {
	return &Python3PackageServerTransport{
		srv:                             srv,
		beginCreateOrUpdate:             newTracker[azfake.PollerResponder[armautomation.Python3PackageClientCreateOrUpdateResponse]](),
...
type Python3PackageServerTransport struct {
	...
	beginCreateOrUpdate             *tracker[azfake.PollerResponder[armautomation.Python3PackageClientCreateOrUpdateResponse]]
...
func (p *Python3PackageServerTransport) Do(req *http.Request) (*http.Response, error) {
	...
	switch method {
	case "Python3PackageClient.BeginCreateOrUpdate":
...
func (p *Python3PackageServerTransport) dispatchBeginCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginCreateOrUpdate == nil {
		...
		respr, errRespr := p.srv.BeginCreateOrUpdate(req.Context(), resourceGroupNameParam, automationAccountNameParam, packageNameParam, body, nil)
