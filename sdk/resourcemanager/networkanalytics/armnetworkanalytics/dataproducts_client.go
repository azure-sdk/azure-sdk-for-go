...
func (client *DataProductsClient) updateCreateRequest(ctx context.Context, resourceGroupName string, dataProductName string, properties DataProductUpdate, _ *DataProductsClientBeginUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetworkAnalytics/dataProducts/{dataProductName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
