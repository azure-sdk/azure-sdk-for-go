...
// BusinessApplicationAgentClientGetOptions contains the optional parameters for the BusinessApplicationAgentClient.Get method.
type BusinessApplicationAgentClientGetOptions struct {
	// placeholder for future optional parameters
}

// BusinessApplicationAgentsClientCreateOrUpdateOptions contains the optional parameters for the BusinessApplicationAgentsClient.CreateOrUpdate
// method.
type BusinessApplicationAgentsClientCreateOrUpdateOptions struct {
	// The Business Application Agent
	AgentToUpsert *BusinessApplicationAgentResource
}

// BusinessApplicationAgentsClientDeleteOptions contains the optional parameters for the BusinessApplicationAgentsClient.Delete
// method.
type BusinessApplicationAgentsClientDeleteOptions struct {
	// placeholder for future optional parameters
}

// BusinessApplicationAgentsClientListOptions contains the optional parameters for the BusinessApplicationAgentsClient.NewListPager
// method.
type BusinessApplicationAgentsClientListOptions struct {
	// Filters the results, based on a Boolean condition. Optional.
	Filter *string
...
// SystemsClientCreateOrUpdateOptions contains the optional parameters for the SystemsClient.CreateOrUpdate method.
type SystemsClientCreateOrUpdateOptions struct {
	// The system to upsert.
	SystemToUpsert *SystemResource
}

// SystemsClientDeleteOptions contains the optional parameters for the SystemsClient.Delete method.
type SystemsClientDeleteOptions struct {
	// placeholder for future optional parameters
}

// SystemsClientGetOptions contains the optional parameters for the SystemsClient.Get method.
type SystemsClientGetOptions struct {
	// placeholder for future optional parameters
}

// SystemsClientListActionsOptions contains the optional parameters for the SystemsClient.NewListActionsPager method.
type SystemsClientListActionsOptions struct {
	// placeholder for future optional parameters
}

// SystemsClientListOptions contains the optional parameters for the SystemsClient.NewListPager method.
type SystemsClientListOptions struct {
	// Filters the results, based on a Boolean condition. Optional.
	Filter *string
...
// SystemsClientReportActionStatusOptions contains the optional parameters for the SystemsClient.ReportActionStatus method.
type SystemsClientReportActionStatusOptions struct {
	// Report a status of the action that was performed by the agent
	Payload *ReportActionStatusPayload
}

// SystemsClientUndoActionOptions contains the optional parameters for the SystemsClient.UndoAction method.
type SystemsClientUndoActionOptions struct {
