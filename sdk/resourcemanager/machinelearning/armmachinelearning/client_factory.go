...
func (c *ClientFactory) NewIndexesClient() *IndexesClient {
	subClient, _ := NewIndexesClient(c.subscriptionID, c.credential, c.options)
	return subClient
}

// NewIndexesVersionsClient creates a new instance of IndexesVersionsClient.
func (c *ClientFactory) NewIndexesVersionsClient() *IndexesVersionsClient {
	subClient, _ := NewIndexesVersionsClient(c.subscriptionID, c.credential, c.options)
	return subClient
}
