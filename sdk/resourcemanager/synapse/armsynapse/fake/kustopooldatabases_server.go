...
func (k *KustoPoolDatabasesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if kustoPoolDatabasesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = kustoPoolDatabasesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to KustoPoolDatabasesServerTransport
var kustoPoolDatabasesServerTransportInterceptor interface {
