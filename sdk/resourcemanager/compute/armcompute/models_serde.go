...
func (d DiskProperties) MarshalJSON() ([]byte, error) {
	...
	populateTimeRFC3339(objectMap, "LastOwnershipUpdateTime", d.LastOwnershipUpdateTime)
...
func (d *DiskProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "LastOwnershipUpdateTime":
			err = unpopulateTimeRFC3339(val, "LastOwnershipUpdateTime", &d.LastOwnershipUpdateTime)
			delete(rawMsg, key)
		case "maxShares":
...
func (u UefiKey) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "signatureType", u.SignatureType)
...
func (u *UefiKey) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "signatureType":
			err = unpopulate(val, "SignatureType", &u.SignatureType)
			delete(rawMsg, key)
		case "value":
