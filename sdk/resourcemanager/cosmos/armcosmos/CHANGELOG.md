...
- New field `CustomerManagedKeyStatus`, `DefaultPriorityLevel`, `EnablePerRegionPerPartitionAutoscale`, `EnablePriorityBasedExecution` in struct `DatabaseAccountCreateUpdateProperties`
- New field `CustomerManagedKeyStatus`, `DefaultPriorityLevel`, `EnablePerRegionPerPartitionAutoscale`, `EnablePriorityBasedExecution` in struct `DatabaseAccountGetProperties`
- New field `CustomerManagedKeyStatus`, `DefaultPriorityLevel`, `EnablePerRegionPerPartitionAutoscale`, `EnablePriorityBasedExecution` in struct `DatabaseAccountUpdateProperties`
