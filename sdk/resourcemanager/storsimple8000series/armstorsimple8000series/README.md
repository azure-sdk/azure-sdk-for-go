...
```go
client, err := armstorsimple8000series.NewCloudAppliancesClient(<subscription ID>, cred, nil)
```
...
client, err := armstorsimple8000series.NewCloudAppliancesClient(<subscription ID>, cred, &options)
```
