...
func (client *AvailableClusterVersionsClient) listByLocationCreateRequest(ctx context.Context, location string, _ *AvailableClusterVersionsClientListByLocationOptions) (*policy.Request, error) {
