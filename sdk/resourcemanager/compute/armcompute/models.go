...
// VirtualMachineRunCommandScriptSource - Describes the script sources for run command. Use only one these script sources:
// script, scriptUri, commandId, galleryScriptReferenceId.
type VirtualMachineRunCommandScriptSource struct {
	// Specifies a commandId of predefined built-in script. commandIds available for Linux listed at https://aka.ms/RunCommandManagedLinux#available-commands,
	// Windows at
