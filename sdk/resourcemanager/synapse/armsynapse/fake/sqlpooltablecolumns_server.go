...
func (s *SQLPoolTableColumnsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if sqlPoolTableColumnsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = sqlPoolTableColumnsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			case "SQLPoolTableColumnsClient.NewListByTableNamePager":
				res.resp, res.err = s.dispatchNewListByTableNamePager(req)
			default:
...
// set this to conditionally intercept incoming requests to SQLPoolTableColumnsServerTransport
var sqlPoolTableColumnsServerTransportInterceptor interface {
