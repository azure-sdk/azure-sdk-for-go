...
// ChannelBinding enumerates the values for channel binding.
type ChannelBinding string

const (
	// Disabled ...
	Disabled ChannelBinding = "Disabled"
	// Enabled ...
	Enabled ChannelBinding = "Enabled"
)

// PossibleChannelBindingValues returns an array of possible values for the ChannelBinding const type.
func PossibleChannelBindingValues() []ChannelBinding {
	return []ChannelBinding{Disabled, Enabled}
}
...
func PossibleExternalAccessValues() []ExternalAccess {
	return []ExternalAccess{ExternalAccessDisabled, ExternalAccessEnabled}
}
...
// KerberosArmoring enumerates the values for kerberos armoring.
...
// PossibleKerberosArmoringValues returns an array of possible values for the KerberosArmoring const type.
func PossibleKerberosArmoringValues() []KerberosArmoring {
	return []KerberosArmoring{KerberosArmoringDisabled, KerberosArmoringEnabled}
}

// KerberosRc4Encryption enumerates the values for kerberos rc 4 encryption.
...
// PossibleKerberosRc4EncryptionValues returns an array of possible values for the KerberosRc4Encryption const type.
func PossibleKerberosRc4EncryptionValues() []KerberosRc4Encryption {
	return []KerberosRc4Encryption{KerberosRc4EncryptionDisabled, KerberosRc4EncryptionEnabled}
}
...
// LdapSigning enumerates the values for ldap signing.
...
// PossibleLdapSigningValues returns an array of possible values for the LdapSigning const type.
func PossibleLdapSigningValues() []LdapSigning {
	return []LdapSigning{LdapSigningDisabled, LdapSigningEnabled}
}
...
func PossibleStatusValues() []Status {
	return []Status{Failure, None, OK, Running, Skipped, Warning}
}
