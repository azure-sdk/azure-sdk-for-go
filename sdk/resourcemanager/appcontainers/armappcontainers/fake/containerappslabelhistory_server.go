...
type ContainerAppsLabelHistoryServer struct {
	...
	// HTTP status codes to indicate success: http.StatusNoContent, http.StatusConflict
...
func (c *ContainerAppsLabelHistoryServerTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "ContainerAppsLabelHistoryClient.DeleteLabelHistory":
		resp, err = c.dispatchDeleteLabelHistory(req)
	case "ContainerAppsLabelHistoryClient.GetLabelHistory":
		resp, err = c.dispatchGetLabelHistory(req)
	case "ContainerAppsLabelHistoryClient.NewListLabelHistoryPager":
		resp, err = c.dispatchNewListLabelHistoryPager(req)
	default:
...
func (c *ContainerAppsLabelHistoryServerTransport) dispatchDeleteLabelHistory(req *http.Request) (*http.Response, error) {
	...
	if !contains([]int{http.StatusNoContent, http.StatusConflict}, respContent.HTTPStatus) {
		return nil, &nonRetriableError{fmt.Errorf("unexpected status code %d. acceptable values are http.StatusNoContent, http.StatusConflict", respContent.HTTPStatus)}
	}
