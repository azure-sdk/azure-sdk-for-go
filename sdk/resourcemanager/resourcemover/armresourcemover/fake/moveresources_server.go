...
func (m *MoveResourcesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if moveResourcesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = moveResourcesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to MoveResourcesServerTransport
var moveResourcesServerTransportInterceptor interface {
