...
func NewMonitoredResourcesClient(subscriptionID string, instanceName string, monitoredResourceName string, credential azcore.TokenCredential, options *arm.ClientOptions) (*MonitoredResourcesClient, error) {
...
//   - monitoredResource - SCOM Monitored Resource
...
//     method.
func (client *MonitoredResourcesClient) CreateOrUpdate(ctx context.Context, resourceGroupName string, monitoredResource MonitoredResource, options *MonitoredResourcesClientCreateOrUpdateOptions) (MonitoredResourcesClientCreateOrUpdateResponse, error) {
	var err error
	const operationName = "MonitoredResourcesClient.CreateOrUpdate"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.createOrUpdateCreateRequest(ctx, resourceGroupName, monitoredResource, options)
	if err != nil {
...
func (client *MonitoredResourcesClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, monitoredResource MonitoredResource, options *MonitoredResourcesClientCreateOrUpdateOptions) (*policy.Request, error) {
	...
	if client.monitoredResourceName == "" {
		return nil, errors.New("parameter client.monitoredResourceName cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{monitoredResourceName}", url.PathEscape(client.monitoredResourceName))
	...
	if err := runtime.MarshalAsJSON(req, monitoredResource); err != nil {
		return nil, err
	}
	return req, nil
}
...
//     method.
func (client *MonitoredResourcesClient) Delete(ctx context.Context, resourceGroupName string, options *MonitoredResourcesClientDeleteOptions) (MonitoredResourcesClientDeleteResponse, error) {
	var err error
...
func (client *MonitoredResourcesClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, options *MonitoredResourcesClientDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Scom/managedInstances/{instanceName}/monitoredResources/{monitoredResourceName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *MonitoredResourcesClient) Get(ctx context.Context, resourceGroupName string, options *MonitoredResourcesClientGetOptions) (MonitoredResourcesClientGetResponse, error) {
	var err error
...
func (client *MonitoredResourcesClient) getCreateRequest(ctx context.Context, resourceGroupName string, options *MonitoredResourcesClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Scom/managedInstances/{instanceName}/monitoredResources/{monitoredResourceName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
//     method.
func (client *MonitoredResourcesClient) NewListByManagedInstancePager(resourceGroupName string, options *MonitoredResourcesClientListByManagedInstanceOptions) *runtime.Pager[MonitoredResourcesClientListByManagedInstanceResponse] {
...
func (client *MonitoredResourcesClient) listByManagedInstanceCreateRequest(ctx context.Context, resourceGroupName string, options *MonitoredResourcesClientListByManagedInstanceOptions) (*policy.Request, error) {
...
func (client *MonitoredResourcesClient) listByManagedInstanceHandleResponse(resp *http.Response) (MonitoredResourcesClientListByManagedInstanceResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.MonitoredResources); err != nil {
		return MonitoredResourcesClientListByManagedInstanceResponse{}, err
	}
	return result, nil
}
