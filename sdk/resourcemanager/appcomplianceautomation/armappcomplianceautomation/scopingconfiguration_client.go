...
// ScopingConfigurationClient contains the methods for the Microsoft.AppComplianceAutomation namespace.
...
//   - parameters - Parameters for the create or update operation, this is a singleton resource, so please make sure you're using
//     'default' as the name.
...
//     method.
func (client *ScopingConfigurationClient) CreateOrUpdate(ctx context.Context, reportName string, scopingConfigurationName string, parameters ScopingConfigurationResource, options *ScopingConfigurationClientCreateOrUpdateOptions) (ScopingConfigurationClientCreateOrUpdateResponse, error) {
	var err error
	const operationName = "ScopingConfigurationClient.CreateOrUpdate"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.createOrUpdateCreateRequest(ctx, reportName, scopingConfigurationName, parameters, options)
	if err != nil {
...
func (client *ScopingConfigurationClient) createOrUpdateCreateRequest(ctx context.Context, reportName string, scopingConfigurationName string, parameters ScopingConfigurationResource, _ *ScopingConfigurationClientCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *ScopingConfigurationClient) deleteCreateRequest(ctx context.Context, reportName string, scopingConfigurationName string, _ *ScopingConfigurationClientDeleteOptions) (*policy.Request, error) {
	urlPath := "/providers/Microsoft.AppComplianceAutomation/reports/{reportName}/scopingConfigurations/{scopingConfigurationName}"
	if reportName == "" {
		return nil, errors.New("parameter reportName cannot be empty")
	}
...
func (client *ScopingConfigurationClient) getCreateRequest(ctx context.Context, reportName string, scopingConfigurationName string, _ *ScopingConfigurationClientGetOptions) (*policy.Request, error) {
	urlPath := "/providers/Microsoft.AppComplianceAutomation/reports/{reportName}/scopingConfigurations/{scopingConfigurationName}"
	if reportName == "" {
		return nil, errors.New("parameter reportName cannot be empty")
	}
...
// NewListByReportResourcePager - Returns a list format of the singleton scopingConfiguration for a specified report.
//
// Generated from API version 2024-06-27
//   - reportName - Report Name.
//   - options - ScopingConfigurationClientListByReportResourceOptions contains the optional parameters for the ScopingConfigurationClient.NewListByReportResourcePager
//     method.
func (client *ScopingConfigurationClient) NewListByReportResourcePager(reportName string, options *ScopingConfigurationClientListByReportResourceOptions) *runtime.Pager[ScopingConfigurationClientListByReportResourceResponse] {
	return runtime.NewPager(runtime.PagingHandler[ScopingConfigurationClientListByReportResourceResponse]{
		More: func(page ScopingConfigurationClientListByReportResourceResponse) bool {
			return page.NextLink != nil && len(*page.NextLink) > 0
		},
		Fetcher: func(ctx context.Context, page *ScopingConfigurationClientListByReportResourceResponse) (ScopingConfigurationClientListByReportResourceResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "ScopingConfigurationClient.NewListByReportResourcePager")
			nextLink := ""
			if page != nil {
			...
			if err != nil {
				return ScopingConfigurationClientListByReportResourceResponse{}, err
			}
...
func (client *ScopingConfigurationClient) listByReportResourceCreateRequest(ctx context.Context, reportName string, _ *ScopingConfigurationClientListByReportResourceOptions) (*policy.Request, error) {
...
func (client *ScopingConfigurationClient) listByReportResourceHandleResponse(resp *http.Response) (ScopingConfigurationClientListByReportResourceResponse, error) {
	result := ScopingConfigurationClientListByReportResourceResponse{}
