...
func (c *CustomizationTasksServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if customizationTasksServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = customizationTasksServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "CustomizationTasksClient.NewListByCatalogPager":
				res.resp, res.err = c.dispatchNewListByCatalogPager(req)
			default:
...
// set this to conditionally intercept incoming requests to CustomizationTasksServerTransport
var customizationTasksServerTransportInterceptor interface {
