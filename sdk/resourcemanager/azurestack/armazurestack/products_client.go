...
func (client *ProductsClient) getCreateRequest(ctx context.Context, resourceGroup string, registrationName string, productName string, _ *ProductsClientGetOptions) (*policy.Request, error) {
...
func (client *ProductsClient) listCreateRequest(ctx context.Context, resourceGroup string, registrationName string, _ *ProductsClientListOptions) (*policy.Request, error) {
...
func (client *ProductsClient) listDetailsCreateRequest(ctx context.Context, resourceGroup string, registrationName string, productName string, _ *ProductsClientListDetailsOptions) (*policy.Request, error) {
