...
type AccountMergeInfo struct {
	...
	// READ-ONLY; The type of account this account is for the merge operation.
...
type AccountProperties struct {
	...
	SoftDeletedModel *PublicSoftDeletedModel
	...
	// READ-ONLY; Gets or sets the default domain in the account.
...
// DomainScopedUserAssignedIdentity - The Domain Scoped User Assigned Managed Identity of the resource
type DomainScopedUserAssignedIdentity struct {
	// Client Id
	ClientID *string
	...
	// Domain Usage Status
	DomainUsageStatus *DomainUsageStatus
...
// DomainUserIdentityRequest - The User Assigned Managed Identity requests payload.
type DomainUserIdentityRequest struct {
...
// PublicSoftDeletedModel - The Soft Deleted Model.
type PublicSoftDeletedModel struct {
	// Metadata pertaining to creation and last modification of the resource.
	SystemData *SystemData

	// READ-ONLY; The Scheduled Hard Delete time.
	ScheduledHardDeleteTime *time.Time
}
