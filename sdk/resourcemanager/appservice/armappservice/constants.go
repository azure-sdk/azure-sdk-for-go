...
type TrafficSplittingName string

const (
	TrafficSplittingNameDefault TrafficSplittingName = "default"
)

// PossibleTrafficSplittingNameValues returns the possible values for the TrafficSplittingName const type.
func PossibleTrafficSplittingNameValues() []TrafficSplittingName {
	return []TrafficSplittingName{
		TrafficSplittingNameDefault,
	}
}
