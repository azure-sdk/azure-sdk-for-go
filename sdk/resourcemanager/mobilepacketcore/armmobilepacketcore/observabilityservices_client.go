...
//     method.
func (client *ObservabilityServicesClient) CreateOrUpdate(ctx context.Context, resourceGroupName string, observabilityServiceName string, resource ObservabilityServiceResource, options *ObservabilityServicesClientCreateOrUpdateOptions) (ObservabilityServicesClientCreateOrUpdateResponse, error) {
	var err error
	const operationName = "ObservabilityServicesClient.CreateOrUpdate"
...
func (client *ObservabilityServicesClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, observabilityServiceName string, resource ObservabilityServiceResource, _ *ObservabilityServicesClientCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *ObservabilityServicesClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, observabilityServiceName string, _ *ObservabilityServicesClientBeginDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MobilePacketCore/observabilityServices/{observabilityServiceName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *ObservabilityServicesClient) getCreateRequest(ctx context.Context, resourceGroupName string, observabilityServiceName string, _ *ObservabilityServicesClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MobilePacketCore/observabilityServices/{observabilityServiceName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *ObservabilityServicesClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, _ *ObservabilityServicesClientListByResourceGroupOptions) (*policy.Request, error) {
...
func (client *ObservabilityServicesClient) listBySubscriptionCreateRequest(ctx context.Context, _ *ObservabilityServicesClientListBySubscriptionOptions) (*policy.Request, error) {
...
func (client *ObservabilityServicesClient) updateTagsCreateRequest(ctx context.Context, resourceGroupName string, observabilityServiceName string, properties ObservabilityServiceResourceTagsUpdate, _ *ObservabilityServicesClientUpdateTagsOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MobilePacketCore/observabilityServices/{observabilityServiceName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
