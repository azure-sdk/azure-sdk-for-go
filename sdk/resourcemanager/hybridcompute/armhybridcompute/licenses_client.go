...
//     method.
func (client *LicensesClient) BeginValidateLicense(ctx context.Context, parameters LicenseValidateModel, options *LicensesClientBeginValidateLicenseOptions) (*runtime.Poller[LicensesClientValidateLicenseResponse], error) {
	if options == nil || options.ResumeToken == "" {
...
//
// Generated from API version 2023-10-03-preview
func (client *LicensesClient) validateLicense(ctx context.Context, parameters LicenseValidateModel, options *LicensesClientBeginValidateLicenseOptions) (*http.Response, error) {
	var err error
...
func (client *LicensesClient) validateLicenseCreateRequest(ctx context.Context, parameters LicenseValidateModel, options *LicensesClientBeginValidateLicenseOptions) (*policy.Request, error) {
