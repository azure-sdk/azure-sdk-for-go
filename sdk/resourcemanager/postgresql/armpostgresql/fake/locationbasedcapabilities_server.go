...
// LocationBasedCapabilitiesServer is a fake server for instances of the armpostgresql.LocationBasedCapabilitiesClient type.
type LocationBasedCapabilitiesServer struct {
	...
	NewExecutePager func(locationName string, options *armpostgresql.LocationBasedCapabilitiesClientExecuteOptions) (resp azfake.PagerResponder[armpostgresql.LocationBasedCapabilitiesClientExecuteResponse])
}
...
// The returned LocationBasedCapabilitiesServerTransport instance is connected to an instance of armpostgresql.LocationBasedCapabilitiesClient via the
...
func NewLocationBasedCapabilitiesServerTransport(srv *LocationBasedCapabilitiesServer) *LocationBasedCapabilitiesServerTransport {
	return &LocationBasedCapabilitiesServerTransport{
		srv:             srv,
		newExecutePager: newTracker[azfake.PagerResponder[armpostgresql.LocationBasedCapabilitiesClientExecuteResponse]](),
	}
}

// LocationBasedCapabilitiesServerTransport connects instances of armpostgresql.LocationBasedCapabilitiesClient to instances of LocationBasedCapabilitiesServer.
...
type LocationBasedCapabilitiesServerTransport struct {
	...
	newExecutePager *tracker[azfake.PagerResponder[armpostgresql.LocationBasedCapabilitiesClientExecuteResponse]]
}
...
func (l *LocationBasedCapabilitiesServerTransport) dispatchNewExecutePager(req *http.Request) (*http.Response, error) {
	...
	if newExecutePager == nil {
		...
		server.PagerResponderInjectNextLinks(newExecutePager, req, func(page *armpostgresql.LocationBasedCapabilitiesClientExecuteResponse, createLink func() string) {
