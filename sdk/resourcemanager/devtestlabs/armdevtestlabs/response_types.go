...
// LabSecretsClientCreateOrUpdateResponse contains the response from method LabSecretsClient.CreateOrUpdate.
type LabSecretsClientCreateOrUpdateResponse struct {
	LabSecret
}

// LabSecretsClientDeleteResponse contains the response from method LabSecretsClient.Delete.
...
// LabSecretsClientListResponse contains the response from method LabSecretsClient.List.
...
// PolicySetsClientListResponse contains the response from method PolicySetsClient.List.
...
// ServiceRunnersClientListResponse contains the response from method ServiceRunnersClient.List.
...
// SharedImagesClientListResponse contains the response from method SharedImagesClient.List.
