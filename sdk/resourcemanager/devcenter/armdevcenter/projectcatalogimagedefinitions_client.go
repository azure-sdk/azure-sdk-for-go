...
func (client *ProjectCatalogImageDefinitionsClient) buildImageCreateRequest(ctx context.Context, resourceGroupName string, projectName string, catalogName string, imageDefinitionName string, options *ProjectCatalogImageDefinitionsClientBeginBuildImageOptions) (*policy.Request, error) {
...
func (client *ProjectCatalogImageDefinitionsClient) getErrorDetailsCreateRequest(ctx context.Context, resourceGroupName string, projectName string, catalogName string, imageDefinitionName string, options *ProjectCatalogImageDefinitionsClientGetErrorDetailsOptions) (*policy.Request, error) {
