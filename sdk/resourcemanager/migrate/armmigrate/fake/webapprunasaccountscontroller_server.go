...
// WebAppRunAsAccountsControllerServer is a fake server for instances of the armmigrate.WebAppRunAsAccountsControllerClient type.
type WebAppRunAsAccountsControllerServer struct {
	...
	Get func(ctx context.Context, resourceGroupName string, siteName string, webAppSiteName string, accountName string, options *armmigrate.WebAppRunAsAccountsControllerClientGetOptions) (resp azfake.Responder[armmigrate.WebAppRunAsAccountsControllerClientGetResponse], errResp azfake.ErrorResponder)

	// NewListByWebAppSitePager is the fake for method WebAppRunAsAccountsControllerClient.NewListByWebAppSitePager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByWebAppSitePager func(resourceGroupName string, siteName string, webAppSiteName string, options *armmigrate.WebAppRunAsAccountsControllerClientListByWebAppSiteOptions) (resp azfake.PagerResponder[armmigrate.WebAppRunAsAccountsControllerClientListByWebAppSiteResponse])
}
...
// The returned WebAppRunAsAccountsControllerServerTransport instance is connected to an instance of armmigrate.WebAppRunAsAccountsControllerClient via the
...
func NewWebAppRunAsAccountsControllerServerTransport(srv *WebAppRunAsAccountsControllerServer) *WebAppRunAsAccountsControllerServerTransport {
	return &WebAppRunAsAccountsControllerServerTransport{
		srv:                      srv,
		newListByWebAppSitePager: newTracker[azfake.PagerResponder[armmigrate.WebAppRunAsAccountsControllerClientListByWebAppSiteResponse]](),
	}
}

// WebAppRunAsAccountsControllerServerTransport connects instances of armmigrate.WebAppRunAsAccountsControllerClient to instances of WebAppRunAsAccountsControllerServer.
...
type WebAppRunAsAccountsControllerServerTransport struct {
	...
	newListByWebAppSitePager *tracker[azfake.PagerResponder[armmigrate.WebAppRunAsAccountsControllerClientListByWebAppSiteResponse]]
}
...
func (w *WebAppRunAsAccountsControllerServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if webAppRunAsAccountsControllerServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = webAppRunAsAccountsControllerServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
func (w *WebAppRunAsAccountsControllerServerTransport) dispatchNewListByWebAppSitePager(req *http.Request) (*http.Response, error) {
	...
	if newListByWebAppSitePager == nil {
		...
		server.PagerResponderInjectNextLinks(newListByWebAppSitePager, req, func(page *armmigrate.WebAppRunAsAccountsControllerClientListByWebAppSiteResponse, createLink func() string) {
...
// set this to conditionally intercept incoming requests to WebAppRunAsAccountsControllerServerTransport
var webAppRunAsAccountsControllerServerTransportInterceptor interface {
