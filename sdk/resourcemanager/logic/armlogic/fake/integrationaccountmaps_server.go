...
type IntegrationAccountMapsServer struct {
	...
	CreateOrUpdate func(ctx context.Context, resourceGroupName string, integrationAccountName string, mapName string, resource armlogic.IntegrationAccountMap, options *armlogic.IntegrationAccountMapsClientCreateOrUpdateOptions) (resp azfake.Responder[armlogic.IntegrationAccountMapsClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)
	...
	// HTTP status codes to indicate success: http.StatusOK
	ListContentCallbackURL func(ctx context.Context, resourceGroupName string, integrationAccountName string, mapName string, body armlogic.GetCallbackURLParameters, options *armlogic.IntegrationAccountMapsClientListContentCallbackURLOptions) (resp azfake.Responder[armlogic.IntegrationAccountMapsClientListContentCallbackURLResponse], errResp azfake.ErrorResponder)
}
...
func (i *IntegrationAccountMapsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if integrationAccountMapsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = integrationAccountMapsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to IntegrationAccountMapsServerTransport
var integrationAccountMapsServerTransportInterceptor interface {
