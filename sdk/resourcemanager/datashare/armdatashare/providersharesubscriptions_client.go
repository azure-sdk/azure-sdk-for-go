...
func (client *ProviderShareSubscriptionsClient) adjustCreateRequest(ctx context.Context, resourceGroupName string, accountName string, shareName string, providerShareSubscriptionID string, providerShareSubscription ProviderShareSubscription, _ *ProviderShareSubscriptionsClientAdjustOptions) (*policy.Request, error) {
...
func (client *ProviderShareSubscriptionsClient) getByShareCreateRequest(ctx context.Context, resourceGroupName string, accountName string, shareName string, providerShareSubscriptionID string, _ *ProviderShareSubscriptionsClientGetByShareOptions) (*policy.Request, error) {
...
func (client *ProviderShareSubscriptionsClient) reinstateCreateRequest(ctx context.Context, resourceGroupName string, accountName string, shareName string, providerShareSubscriptionID string, providerShareSubscription ProviderShareSubscription, _ *ProviderShareSubscriptionsClientReinstateOptions) (*policy.Request, error) {
...
func (client *ProviderShareSubscriptionsClient) revokeCreateRequest(ctx context.Context, resourceGroupName string, accountName string, shareName string, providerShareSubscriptionID string, _ *ProviderShareSubscriptionsClientBeginRevokeOptions) (*policy.Request, error) {
