...
func (s *SoftwareUpdateConfigurationRunsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if softwareUpdateConfigurationRunsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = softwareUpdateConfigurationRunsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to SoftwareUpdateConfigurationRunsServerTransport
var softwareUpdateConfigurationRunsServerTransportInterceptor interface {
