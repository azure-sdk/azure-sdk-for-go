...
// ClientDppResourceGuardProxyDeleteOptions contains the optional parameters for the Client.DppResourceGuardProxyDelete method.
type ClientDppResourceGuardProxyDeleteOptions struct {
	// placeholder for future optional parameters
}

// ClientDppResourceGuardProxyGetOptions contains the optional parameters for the Client.DppResourceGuardProxyGet method.
type ClientDppResourceGuardProxyGetOptions struct {
	// placeholder for future optional parameters
}

// ClientDppResourceGuardProxyListOptions contains the optional parameters for the Client.DppResourceGuardProxyList method.
type ClientDppResourceGuardProxyListOptions struct {
	// placeholder for future optional parameters
}

// ClientDppResourceGuardProxyPutOptions contains the optional parameters for the Client.DppResourceGuardProxyPut method.
type ClientDppResourceGuardProxyPutOptions struct {
	// placeholder for future optional parameters
}

// ClientDppResourceGuardProxyUnlockDeleteOptions contains the optional parameters for the Client.DppResourceGuardProxyUnlockDelete
// method.
type ClientDppResourceGuardProxyUnlockDeleteOptions struct {
	// placeholder for future optional parameters
}
