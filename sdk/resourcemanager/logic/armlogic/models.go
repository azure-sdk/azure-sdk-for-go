...
// ConnectionExportValidity - The connection export validity.
type ConnectionExportValidity struct {
...
// ExportDetail - The workflow export detail.
...
// ResourceExportValidity - The resource export validity.
type ResourceExportValidity struct {
	// Error response describing why the operation failed.
	Details *ErrorResponse
...
type WorkflowExportRequest struct {
	// REQUIRED; The workflow export options flags. Possible options are: CloneConnections, GenerateInfrastructureTemplates
	WorkflowExportOptions *WorkflowExportOptions

	// REQUIRED; The workflows for export.
	Workflows []*ResourceReference
}

// WorkflowExportResult - The workflow export result.
...
// WorkflowExportValidity - The workflow export validity.
type WorkflowExportValidity struct {
	// The connections export validity.
	Connections map[string]*ConnectionExportValidity

	// The parameters export validity.
	Parameters map[string]*ResourceExportValidity

	// The validation state for the workflow.
	ValidationState *ValidationState

	// The workflow operations export validity.
	WorkflowOperations map[string]*ResourceExportValidity
}

// WorkflowExportValidityResult - The workflow export validity result.
type WorkflowExportValidityResult struct {
	// The validation state for the workflow export.
	ValidationState *ValidationState

	// The workflows export validity.
	Workflows map[string]*WorkflowExportValidity
}
