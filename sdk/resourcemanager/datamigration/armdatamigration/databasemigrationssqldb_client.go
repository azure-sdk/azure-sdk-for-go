...
// options - DatabaseMigrationsSQLDbClientRetryOptions contains the optional parameters for the DatabaseMigrationsSQLDbClient.Retry
// method.
func (client *DatabaseMigrationsSQLDbClient) Retry(ctx context.Context, resourceGroupName string, sqlDbInstanceName string, targetDbName string, migrationOperationInput MigrationOperationInput, options *DatabaseMigrationsSQLDbClientRetryOptions) (DatabaseMigrationsSQLDbClientRetryResponse, error) {
	req, err := client.retryCreateRequest(ctx, resourceGroupName, sqlDbInstanceName, targetDbName, migrationOperationInput, options)
	if err != nil {
		return DatabaseMigrationsSQLDbClientRetryResponse{}, err
	}
	resp, err := client.pl.Do(req)
	if err != nil {
		return DatabaseMigrationsSQLDbClientRetryResponse{}, err
	...
	if !runtime.HasStatusCode(resp, http.StatusAccepted) {
		return DatabaseMigrationsSQLDbClientRetryResponse{}, runtime.NewResponseError(resp)
	}
	return client.retryHandleResponse(resp)
}

// retryCreateRequest creates the Retry request.
func (client *DatabaseMigrationsSQLDbClient) retryCreateRequest(ctx context.Context, resourceGroupName string, sqlDbInstanceName string, targetDbName string, migrationOperationInput MigrationOperationInput, options *DatabaseMigrationsSQLDbClientRetryOptions) (*policy.Request, error) {
	...
	req.Raw().URL.RawQuery = reqQP.Encode()
	req.Raw().Header["Accept"] = []string{"application/json"}
	return req, runtime.MarshalAsJSON(req, migrationOperationInput)
}

// retryHandleResponse handles the Retry response.
func (client *DatabaseMigrationsSQLDbClient) retryHandleResponse(resp *http.Response) (DatabaseMigrationsSQLDbClientRetryResponse, error) {
	result := DatabaseMigrationsSQLDbClientRetryResponse{}
	if err := runtime.UnmarshalAsJSON(resp, &result.DatabaseMigrationSQLDb); err != nil {
		return DatabaseMigrationsSQLDbClientRetryResponse{}, err
	}
	return result, nil
