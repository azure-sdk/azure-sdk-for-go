...
type MigrateMySQLAzureDbForMySQLOfflineTaskInput struct {
	...
	MigrateAllEvents *bool `json:"migrateAllEvents,omitempty"`

	// If true, all routine definitions will be migrated in the selected databases
	MigrateAllRoutines *bool `json:"migrateAllRoutines,omitempty"`

	// If true, all trigger definitions will be migrated in the selected databases
	MigrateAllTriggers *bool `json:"migrateAllTriggers,omitempty"`

	// If true, all view definitions will be migrated in the selected databases
	MigrateAllViews *bool `json:"migrateAllViews,omitempty"`

	// Optional parameters for fine tuning the data transfer rate during migration
	OptionalAgentSettings *MigrateMySQLAzureDbForMySQLOfflineTaskInputOptionalAgentSettings `json:"optionalAgentSettings,omitempty"`
...
// MigrateMySQLAzureDbForMySQLOfflineTaskInputOptionalAgentSettings - Optional parameters for fine tuning the data transfer
// rate during migration
type MigrateMySQLAzureDbForMySQLOfflineTaskInputOptionalAgentSettings struct {
	// OPTIONAL; Contains additional key/value pairs not defined in the schema.
	AdditionalProperties map[string]*string

	// Setting to enable transactional consistency
	EnableConsistentBackup *bool `json:"enableConsistentBackup,omitempty"`
}
...
type MigrateMySQLAzureDbForMySQLOfflineTaskOutputClassification interface {
	MigrateMySQLAzureDbForMySQLTaskResultClassification
...
// GetMigrateMySQLAzureDbForMySQLTaskResult implements the MigrateMySQLAzureDbForMySQLTaskResultClassification interface for
// type MigrateMySQLAzureDbForMySQLOfflineTaskOutput.
func (m *MigrateMySQLAzureDbForMySQLOfflineTaskOutput) GetMigrateMySQLAzureDbForMySQLTaskResult() *MigrateMySQLAzureDbForMySQLTaskResult {
	return &MigrateMySQLAzureDbForMySQLTaskResult{
		ID:         m.ID,
...
func (m *MigrateMySQLAzureDbForMySQLOfflineTaskOutputDatabaseLevel) GetMigrateMySQLAzureDbForMySQLTaskResult() *MigrateMySQLAzureDbForMySQLTaskResult {
	return &MigrateMySQLAzureDbForMySQLTaskResult{
		ID:         m.ID,
		ResultType: m.ResultType,
	}
...
func (m *MigrateMySQLAzureDbForMySQLOfflineTaskOutputError) GetMigrateMySQLAzureDbForMySQLTaskResult() *MigrateMySQLAzureDbForMySQLTaskResult {
	return &MigrateMySQLAzureDbForMySQLTaskResult{
		ID:         m.ID,
		ResultType: m.ResultType,
	}
...
type MigrateMySQLAzureDbForMySQLOfflineTaskOutputMigrationLevel struct {
	...
	// READ-ONLY
	MigrationType *MigrateMySQLAzureDbForMySQLOfflineTaskOutputMigrationLevelMigrationType `json:"migrationType,omitempty" azure:"ro"`

	// READ-ONLY; The binlog position when the consistent snapshot was taken
	SourceBinlogPosition *MySQLBinlogPositionOutput `json:"sourceBinlogPosition,omitempty" azure:"ro"`
...
func (m *MigrateMySQLAzureDbForMySQLOfflineTaskOutputMigrationLevel) GetMigrateMySQLAzureDbForMySQLTaskResult() *MigrateMySQLAzureDbForMySQLTaskResult {
	return &MigrateMySQLAzureDbForMySQLTaskResult{
		ID:         m.ID,
		ResultType: m.ResultType,
	}
...
func (m *MigrateMySQLAzureDbForMySQLOfflineTaskOutputTableLevel) GetMigrateMySQLAzureDbForMySQLTaskResult() *MigrateMySQLAzureDbForMySQLTaskResult {
	return &MigrateMySQLAzureDbForMySQLTaskResult{
		ID:         m.ID,
		ResultType: m.ResultType,
	}
...
// MigrateMySQLAzureDbForMySQLReplicateChangesDatabaseInput - Database specific information for MySQL to Azure Database for
// MySQL migration task inputs
type MigrateMySQLAzureDbForMySQLReplicateChangesDatabaseInput struct {
	// Name of the database
	Name *string `json:"name,omitempty"`
...
// MigrateMySQLAzureDbForMySQLReplicateChangesTaskInput - Input for the task that migrates MySQL databases to Azure Database
// for MySQL for the replicate changes migrations
type MigrateMySQLAzureDbForMySQLReplicateChangesTaskInput struct {
	// REQUIRED; Databases to migrate
	SelectedDatabases []*MigrateMySQLAzureDbForMySQLReplicateChangesDatabaseInput `json:"selectedDatabases,omitempty"`
	...
	BinLogInfo *MySQLBinlogPositionInput `json:"binLogInfo,omitempty"`
...
// MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutputClassification provides polymorphic access to related types.
// Call the interface's GetMigrateMySQLAzureDbForMySQLReplicateChangesTaskOutput() method to access the common type.
// Use a type switch to determine the concrete type.  The possible types are:
// - *MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutput, *MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutputError,
// - *MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutputMigrationLevel
type MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutputClassification interface {
	MigrateMySQLAzureDbForMySQLTaskResultClassification
	// GetMigrateMySQLAzureDbForMySQLReplicateChangesTaskOutput returns the MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutput content of the underlying type.
	GetMigrateMySQLAzureDbForMySQLReplicateChangesTaskOutput() *MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutput
}

// MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutput - Output for the task that migrates MySQL databases to Azure Database
// for MySQL for the replicate changes migrations
type MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutput struct {
	// REQUIRED; Result type
	ResultType *string `json:"resultType,omitempty"`
...
// GetMigrateMySQLAzureDbForMySQLReplicateChangesTaskOutput implements the MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutputClassification
// interface for type MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutput.
func (m *MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutput) GetMigrateMySQLAzureDbForMySQLReplicateChangesTaskOutput() *MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutput {
	return m
}

// GetMigrateMySQLAzureDbForMySQLTaskResult implements the MigrateMySQLAzureDbForMySQLTaskResultClassification interface for
// type MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutput.
func (m *MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutput) GetMigrateMySQLAzureDbForMySQLTaskResult() *MigrateMySQLAzureDbForMySQLTaskResult {
	return &MigrateMySQLAzureDbForMySQLTaskResult{
		ID:         m.ID,
		ResultType: m.ResultType,
	}
...
type MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutputError struct {
	// REQUIRED; Result type
	ResultType *string `json:"resultType,omitempty"`
...
// GetMigrateMySQLAzureDbForMySQLReplicateChangesTaskOutput implements the MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutputClassification
// interface for type MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutputError.
func (m *MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutputError) GetMigrateMySQLAzureDbForMySQLReplicateChangesTaskOutput() *MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutput {
	return &MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutput{
		ID:         m.ID,
		ResultType: m.ResultType,
	}
}
...
// GetMigrateMySQLAzureDbForMySQLTaskResult implements the MigrateMySQLAzureDbForMySQLTaskResultClassification interface for
// type MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutputError.
func (m *MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutputError) GetMigrateMySQLAzureDbForMySQLTaskResult() *MigrateMySQLAzureDbForMySQLTaskResult {
	return &MigrateMySQLAzureDbForMySQLTaskResult{
		ID:         m.ID,
		ResultType: m.ResultType,
	}
...
type MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutputMigrationLevel struct {
	// REQUIRED; Result type
	ResultType *string `json:"resultType,omitempty"`

	// READ-ONLY; Migration progress
	ContinuousDataMovementProgress *MySQLContinuousDataMovementProgress `json:"continuousDataMovementProgress,omitempty" azure:"ro"`

	// READ-ONLY; Migration end time
	EndedOn *time.Time `json:"endedOn,omitempty" azure:"ro"`

	// READ-ONLY; Indicates that the migration has server level error
	HasServerLevelError *bool `json:"hasServerLevelError,omitempty" azure:"ro"`

	// READ-ONLY; Result identifier
	ID *string `json:"id,omitempty" azure:"ro"`

	// READ-ONLY; Last time the migration status storage was updated
	LastStorageUpdate *time.Time `json:"lastStorageUpdate,omitempty" azure:"ro"`
	...
	// READ-ONLY
	MigrationType *MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutputMigrationLevelMigrationType `json:"migrationType,omitempty" azure:"ro"`

	// READ-ONLY; Retrying summary
	RetryingSummary interface{} `json:"retryingSummary,omitempty" azure:"ro"`
	...
	// READ-ONLY; Total number of retries that have occurred due to transient errors raised by the unknown source
	TotalOtherRetryCount *int32 `json:"totalOtherRetryCount,omitempty" azure:"ro"`

	// READ-ONLY; Total amount of time during the migration where operations were impacted by transient errors
	TotalRetryingTime *string `json:"totalRetryingTime,omitempty" azure:"ro"`

	// READ-ONLY; Total number of retries that have occurred due to transient errors raised by the source server
	TotalSourceRetryCount *int32 `json:"totalSourceRetryCount,omitempty" azure:"ro"`

	// READ-ONLY; Total number of retries that have occurred due to transient errors raised by the target server
	TotalTargetRetryCount *int32 `json:"totalTargetRetryCount,omitempty" azure:"ro"`
}

// GetMigrateMySQLAzureDbForMySQLReplicateChangesTaskOutput implements the MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutputClassification
// interface for type MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutputMigrationLevel.
func (m *MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutputMigrationLevel) GetMigrateMySQLAzureDbForMySQLReplicateChangesTaskOutput() *MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutput {
	return &MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutput{
		ID:         m.ID,
		ResultType: m.ResultType,
	}
...
// GetMigrateMySQLAzureDbForMySQLTaskResult implements the MigrateMySQLAzureDbForMySQLTaskResultClassification interface for
// type MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutputMigrationLevel.
func (m *MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutputMigrationLevel) GetMigrateMySQLAzureDbForMySQLTaskResult() *MigrateMySQLAzureDbForMySQLTaskResult {
	return &MigrateMySQLAzureDbForMySQLTaskResult{
		ID:         m.ID,
		ResultType: m.ResultType,
	}
...
// MigrateMySQLAzureDbForMySQLReplicateChangesTaskProperties - Properties for the task that migrates MySQL databases to Azure
// Database for MySQL for replicate changes migrations
type MigrateMySQLAzureDbForMySQLReplicateChangesTaskProperties struct {
	// REQUIRED; Task type.
	TaskType *TaskType `json:"taskType,omitempty"`
	...
	// Task input
	Input *MigrateMySQLAzureDbForMySQLReplicateChangesTaskInput `json:"input,omitempty"`
	...
	// READ-ONLY; Task output. This is ignored if submitted.
	Output []MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutputClassification `json:"output,omitempty" azure:"ro"`

	// READ-ONLY; The state of the task. This is ignored if submitted.
	State *TaskState `json:"state,omitempty" azure:"ro"`
}

// GetProjectTaskProperties implements the ProjectTaskPropertiesClassification interface for type MigrateMySQLAzureDbForMySQLReplicateChangesTaskProperties.
func (m *MigrateMySQLAzureDbForMySQLReplicateChangesTaskProperties) GetProjectTaskProperties() *ProjectTaskProperties {
	return &ProjectTaskProperties{
		TaskType:   m.TaskType,
		Errors:     m.Errors,
		State:      m.State,
...
func (m *MigrateMySQLAzureDbForMySQLSyncTaskOutput) GetMigrateMySQLAzureDbForMySQLTaskResult() *MigrateMySQLAzureDbForMySQLTaskResult {
	return &MigrateMySQLAzureDbForMySQLTaskResult{
		ID:         m.ID,
		ResultType: m.ResultType,
	}
...
type MigrateMySQLAzureDbForMySQLSyncTaskProperties struct {
	...
	// READ-ONLY; Task output. This is ignored if submitted.
	Output []MigrateMySQLAzureDbForMySQLTaskResultClassification `json:"output,omitempty" azure:"ro"`
...
// MigrateMySQLAzureDbForMySQLTaskResultClassification provides polymorphic access to related types.
// Call the interface's GetMigrateMySQLAzureDbForMySQLTaskResult() method to access the common type.
// Use a type switch to determine the concrete type.  The possible types are:
// - *MigrateMySQLAzureDbForMySQLOfflineTaskOutput, *MigrateMySQLAzureDbForMySQLOfflineTaskOutputDatabaseLevel, *MigrateMySQLAzureDbForMySQLOfflineTaskOutputError,
// - *MigrateMySQLAzureDbForMySQLOfflineTaskOutputMigrationLevel, *MigrateMySQLAzureDbForMySQLOfflineTaskOutputTableLevel,
// - *MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutput, *MigrateMySQLAzureDbForMySQLSyncTaskOutput, *MigrateMySQLAzureDbForMySQLTaskResult
type MigrateMySQLAzureDbForMySQLTaskResultClassification interface {
	// GetMigrateMySQLAzureDbForMySQLTaskResult returns the MigrateMySQLAzureDbForMySQLTaskResult content of the underlying type.
	GetMigrateMySQLAzureDbForMySQLTaskResult() *MigrateMySQLAzureDbForMySQLTaskResult
}

// MigrateMySQLAzureDbForMySQLTaskResult - Output for the task that migrates MySQL databases to Azure Database for MySQL
type MigrateMySQLAzureDbForMySQLTaskResult struct {
	// REQUIRED; Result type
	ResultType *string `json:"resultType,omitempty"`
...
// GetMigrateMySQLAzureDbForMySQLTaskResult implements the MigrateMySQLAzureDbForMySQLTaskResultClassification interface for
// type MigrateMySQLAzureDbForMySQLTaskResult.
func (m *MigrateMySQLAzureDbForMySQLTaskResult) GetMigrateMySQLAzureDbForMySQLTaskResult() *MigrateMySQLAzureDbForMySQLTaskResult {
	return m
}
...
// MySQLBinlogPositionInput - MySQL binlog reference
type MySQLBinlogPositionInput struct {
...
// MySQLBinlogPositionOutput - MySQL binlog reference
type MySQLBinlogPositionOutput struct {
	// Specifies the the sequential number of the binlog fie, extracted from the file name
	FileSeqNum *int32 `json:"fileSeqNum,omitempty"`

	// READ-ONLY; Specifies the MySQL binlog file name
	Name *string `json:"name,omitempty" azure:"ro"`

	// READ-ONLY; Specifies the position in the binlog file
	Position *int64 `json:"position,omitempty" azure:"ro"`
}
...
type MySQLContinuousDataMovementProgress struct {
	// READ-ONLY; Current binlog position of the last event committed at target
	BinlogPosition *MySQLBinlogPositionOutput `json:"binlogPosition,omitempty" azure:"ro"`

	// READ-ONLY; The total number of the DELETEROWSEVENTs processed
	NumberOfDeleteRowsEventsProcessed *int32 `json:"numberOfDeleteRowsEventsProcessed,omitempty" azure:"ro"`

	// READ-ONLY; The total number of query events executed at target, such as DDL, or DML when using mixed binlog mode
	NumberOfQueryEventsProcessed *int32 `json:"numberOfQueryEventsProcessed,omitempty" azure:"ro"`

	// READ-ONLY; The total number of rows deleted at target
	NumberOfRowsDeleted *int32 `json:"numberOfRowsDeleted,omitempty" azure:"ro"`

	// READ-ONLY; The total number of rows inserted at target
	NumberOfRowsInserted *int32 `json:"numberOfRowsInserted,omitempty" azure:"ro"`

	// READ-ONLY; The total number of rows updated at target
	NumberOfRowsUpdated *int32 `json:"numberOfRowsUpdated,omitempty" azure:"ro"`

	// READ-ONLY; The the total number of the UPDATEROWSEVENTs processed
	NumberOfUpdateRowsEventsProcessed *int32 `json:"numberOfUpdateRowsEventsProcessed,omitempty" azure:"ro"`

	// READ-ONLY; The the total number of the WRITEROWSEVENTs processed
	NumberOfWriteRowsEventsProcessed *int32 `json:"numberOfWriteRowsEventsProcessed,omitempty" azure:"ro"`

	// READ-ONLY; The the number of seconds the replica server is behind the source server
	SecondsBehindSource *int32 `json:"secondsBehindSource,omitempty" azure:"ro"`

	// READ-ONLY; The timestamp exposed by the last binlog event that has been committed at target
	Timestamp *time.Time `json:"timestamp,omitempty" azure:"ro"`
}

// MySQLSchemaMigrationOptions - MySQL schema migration options
type MySQLSchemaMigrationOptions struct {
	// If true, all event definitions will be migrated in the selected databases
	MigrateAllEvents *bool `json:"migrateAllEvents,omitempty"`
...
// - *MigrateMongoDbTaskProperties, *MigrateMySQLAzureDbForMySQLOfflineTaskProperties, *MigrateMySQLAzureDbForMySQLReplicateChangesTaskProperties,
// - *MigrateMySQLAzureDbForMySQLSyncTaskProperties, *MigrateOracleAzureDbForPostgreSQLSyncTaskProperties, *MigratePostgreSQLAzureDbForPostgreSQLSyncTaskProperties,
// - *MigrateSQLServerSQLDbSyncTaskProperties, *MigrateSQLServerSQLDbTaskProperties, *MigrateSQLServerSQLMISyncTaskProperties,
// - *MigrateSQLServerSQLMITaskProperties, *MigrateSchemaSQLServerSQLDbTaskProperties, *MigrateSsisTaskProperties, *ProjectTaskProperties,
// - *UploadOCIDriverTaskProperties, *ValidateMigrationInputSQLServerSQLDbSyncTaskProperties, *ValidateMigrationInputSQLServerSQLMISyncTaskProperties,
// - *ValidateMigrationInputSQLServerSQLMITaskProperties, *ValidateMongoDbTaskProperties, *ValidateOracleAzureDbForPostgreSQLSyncTaskProperties
