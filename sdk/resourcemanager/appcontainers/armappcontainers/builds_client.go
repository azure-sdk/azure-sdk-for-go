...
func NewBuildsClient(subscriptionID string, credential azcore.TokenCredential, options *arm.ClientOptions) (*BuildsClient, error) {
	cl, err := arm.NewClient(moduleName+".BuildsClient", moduleVersion, credential, options)
	if err != nil {
		return nil, err
	}
	client := &BuildsClient{
...
func (client *BuildsClient) BeginCreateOrUpdate(ctx context.Context, resourceGroupName string, builderName string, buildName string, buildEnvelope BuildResource, options *BuildsClientBeginCreateOrUpdateOptions) (*runtime.Poller[BuildsClientCreateOrUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return runtime.NewPollerFromResumeToken[BuildsClientCreateOrUpdateResponse](options.ResumeToken, client.internal.Pipeline(), nil)
	}
}
...
func (client *BuildsClient) BeginDelete(ctx context.Context, resourceGroupName string, builderName string, buildName string, options *BuildsClientBeginDeleteOptions) (*runtime.Poller[BuildsClientDeleteResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return runtime.NewPollerFromResumeToken[BuildsClientDeleteResponse](options.ResumeToken, client.internal.Pipeline(), nil)
	}
}
...
// ListAuthToken - Gets the token used to connect to the endpoint where source code can be uploaded for a build.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2023-08-01-preview
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - builderName - The name of the builder.
//   - buildName - The name of a build.
//   - options - BuildsClientListAuthTokenOptions contains the optional parameters for the BuildsClient.ListAuthToken method.
func (client *BuildsClient) ListAuthToken(ctx context.Context, resourceGroupName string, builderName string, buildName string, options *BuildsClientListAuthTokenOptions) (BuildsClientListAuthTokenResponse, error) {
	var err error
	req, err := client.listAuthTokenCreateRequest(ctx, resourceGroupName, builderName, buildName, options)
	if err != nil {
		return BuildsClientListAuthTokenResponse{}, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
	if err != nil {
		return BuildsClientListAuthTokenResponse{}, err
	...
	resp, err := client.listAuthTokenHandleResponse(httpResp)
	return resp, err
}

// listAuthTokenCreateRequest creates the ListAuthToken request.
func (client *BuildsClient) listAuthTokenCreateRequest(ctx context.Context, resourceGroupName string, builderName string, buildName string, options *BuildsClientListAuthTokenOptions) (*policy.Request, error) {
...
// listAuthTokenHandleResponse handles the ListAuthToken response.
func (client *BuildsClient) listAuthTokenHandleResponse(resp *http.Response) (BuildsClientListAuthTokenResponse, error) {
	result := BuildsClientListAuthTokenResponse{}
...
// NewListByBuilderResourcePager - List BuildResource resources by BuilderResource
//
// Generated from API version 2023-08-01-preview
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - builderName - The name of the builder.
//   - options - BuildsClientListByBuilderResourceOptions contains the optional parameters for the BuildsClient.NewListByBuilderResourcePager
//     method.
func (client *BuildsClient) NewListByBuilderResourcePager(resourceGroupName string, builderName string, options *BuildsClientListByBuilderResourceOptions) *runtime.Pager[BuildsClientListByBuilderResourceResponse] {
	return runtime.NewPager(runtime.PagingHandler[BuildsClientListByBuilderResourceResponse]{
		More: func(page BuildsClientListByBuilderResourceResponse) bool {
			return page.NextLink != nil && len(*page.NextLink) > 0
		},
		Fetcher: func(ctx context.Context, page *BuildsClientListByBuilderResourceResponse) (BuildsClientListByBuilderResourceResponse, error) {
			...
			if err != nil {
				return BuildsClientListByBuilderResourceResponse{}, err
			}
			...
			if !runtime.HasStatusCode(resp, http.StatusOK) {
				return BuildsClientListByBuilderResourceResponse{}, runtime.NewResponseError(resp)
			}
			return client.listByBuilderResourceHandleResponse(resp)
		},
	})
}

// listByBuilderResourceCreateRequest creates the ListByBuilderResource request.
func (client *BuildsClient) listByBuilderResourceCreateRequest(ctx context.Context, resourceGroupName string, builderName string, options *BuildsClientListByBuilderResourceOptions) (*policy.Request, error) {
...
func (client *BuildsClient) listByBuilderResourceHandleResponse(resp *http.Response) (BuildsClientListByBuilderResourceResponse, error) {
	result := BuildsClientListByBuilderResourceResponse{}
