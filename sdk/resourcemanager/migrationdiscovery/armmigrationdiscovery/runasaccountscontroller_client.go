...
func (client *RunAsAccountsControllerClient) getCreateRequest(ctx context.Context, resourceGroupName string, siteName string, accountName string, _ *RunAsAccountsControllerClientGetOptions) (*policy.Request, error) {
...
func (client *RunAsAccountsControllerClient) listByVmwareSiteCreateRequest(ctx context.Context, resourceGroupName string, siteName string, _ *RunAsAccountsControllerClientListByVmwareSiteOptions) (*policy.Request, error) {
