...
// MarshalJSON implements the json.Marshaller interface for type GenericGalleryParameter.
func (g GenericGalleryParameter) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "defaultValue", g.DefaultValue)
	populate(objectMap, "description", g.Description)
	populate(objectMap, "name", g.Name)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type GenericGalleryParameter.
func (g *GenericGalleryParameter) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", g, err)
	}
