...
//     method.
func (client *ScriptCmdletsClient) NewListByScriptPackagePager(resourceGroupName string, privateCloudName string, scriptPackageName string, options *ScriptCmdletsClientListByScriptPackageOptions) *runtime.Pager[ScriptCmdletsClientListByScriptPackageResponse] {
	return runtime.NewPager(runtime.PagingHandler[ScriptCmdletsClientListByScriptPackageResponse]{
		...
		Fetcher: func(ctx context.Context, page *ScriptCmdletsClientListByScriptPackageResponse) (ScriptCmdletsClientListByScriptPackageResponse, error) {
			...
			resp, err := runtime.FetcherForNextLink(ctx, client.internal.Pipeline(), nextLink, func(ctx context.Context) (*policy.Request, error) {
				return client.listByScriptPackageCreateRequest(ctx, resourceGroupName, privateCloudName, scriptPackageName, options)
			}, nil)
			if err != nil {
...
func (client *ScriptCmdletsClient) listByScriptPackageCreateRequest(ctx context.Context, resourceGroupName string, privateCloudName string, scriptPackageName string, _ *ScriptCmdletsClientListByScriptPackageOptions) (*policy.Request, error) {
