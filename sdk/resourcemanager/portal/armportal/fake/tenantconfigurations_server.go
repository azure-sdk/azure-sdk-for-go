...
func (t *TenantConfigurationsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if tenantConfigurationsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = tenantConfigurationsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to TenantConfigurationsServerTransport
var tenantConfigurationsServerTransportInterceptor interface {
