...
func (client *Client) listNodeImageVersionsCreateRequest(ctx context.Context, location string, options *ClientListNodeImageVersionsOptions) (*policy.Request, error) {
