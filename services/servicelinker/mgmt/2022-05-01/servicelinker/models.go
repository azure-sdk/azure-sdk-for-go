...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/servicelinker/mgmt/2022-05-01/servicelinker"
...
type AzureKeyVaultProperties struct {
	...
	// Type - Possible values include: 'TypeAzureResourcePropertiesBase', 'TypeKeyVault'
	Type TypeBasicAzureResourcePropertiesBase `json:"type,omitempty"`
}

// MarshalJSON is the custom marshaler for AzureKeyVaultProperties.
func (akvp AzureKeyVaultProperties) MarshalJSON() ([]byte, error) {
	akvp.Type = TypeKeyVault
	objectMap := make(map[string]interface{})
	if akvp.ConnectAsKubernetesCsiDriver != nil {
		objectMap["connectAsKubernetesCsiDriver"] = akvp.ConnectAsKubernetesCsiDriver
	}
	if akvp.Type != "" {
		objectMap["type"] = akvp.Type
	}
	return json.Marshal(objectMap)
}

// AsAzureKeyVaultProperties is the BasicAzureResourcePropertiesBase implementation for AzureKeyVaultProperties.
func (akvp AzureKeyVaultProperties) AsAzureKeyVaultProperties() (*AzureKeyVaultProperties, bool) {
	return &akvp, true
}

// AsAzureResourcePropertiesBase is the BasicAzureResourcePropertiesBase implementation for AzureKeyVaultProperties.
func (akvp AzureKeyVaultProperties) AsAzureResourcePropertiesBase() (*AzureResourcePropertiesBase, bool) {
	return nil, false
}

// AsBasicAzureResourcePropertiesBase is the BasicAzureResourcePropertiesBase implementation for AzureKeyVaultProperties.
func (akvp AzureKeyVaultProperties) AsBasicAzureResourcePropertiesBase() (BasicAzureResourcePropertiesBase, bool) {
	return &akvp, true
}
...
type AzureResource struct {
	...
	ResourceProperties BasicAzureResourcePropertiesBase `json:"resourceProperties,omitempty"`
	// Type - Possible values include: 'TypeTargetServiceBase', 'TypeAzureResource', 'TypeConfluentBootstrapServer', 'TypeConfluentSchemaRegistry'
	Type Type `json:"type,omitempty"`
}

// MarshalJSON is the custom marshaler for AzureResource.
func (ar AzureResource) MarshalJSON() ([]byte, error) {
	ar.Type = TypeAzureResource
	objectMap := make(map[string]interface{})
	if ar.ID != nil {
		objectMap["id"] = ar.ID
	}
	objectMap["resourceProperties"] = ar.ResourceProperties
	if ar.Type != "" {
...
// AsAzureResource is the BasicTargetServiceBase implementation for AzureResource.
func (ar AzureResource) AsAzureResource() (*AzureResource, bool) {
	return &ar, true
}

// AsConfluentBootstrapServer is the BasicTargetServiceBase implementation for AzureResource.
func (ar AzureResource) AsConfluentBootstrapServer() (*ConfluentBootstrapServer, bool) {
	return nil, false
}

// AsConfluentSchemaRegistry is the BasicTargetServiceBase implementation for AzureResource.
func (ar AzureResource) AsConfluentSchemaRegistry() (*ConfluentSchemaRegistry, bool) {
	return nil, false
}

// AsTargetServiceBase is the BasicTargetServiceBase implementation for AzureResource.
func (ar AzureResource) AsTargetServiceBase() (*TargetServiceBase, bool) {
	return nil, false
}

// AsBasicTargetServiceBase is the BasicTargetServiceBase implementation for AzureResource.
func (ar AzureResource) AsBasicTargetServiceBase() (BasicTargetServiceBase, bool) {
	return &ar, true
}

// UnmarshalJSON is the custom unmarshaler for AzureResource struct.
func (ar *AzureResource) UnmarshalJSON(body []byte) error {
	...
	for k, v := range m {
		...
		case "resourceProperties":
			if v != nil {
				resourceProperties, err := unmarshalBasicAzureResourcePropertiesBase(*v)
				if err != nil {
					return err
				}
				ar.ResourceProperties = resourceProperties
			}
		case "type":
			if v != nil {
				var typeVar Type
...
// BasicAzureResourcePropertiesBase the azure resource properties
type BasicAzureResourcePropertiesBase interface {
	AsAzureKeyVaultProperties() (*AzureKeyVaultProperties, bool)
	AsAzureResourcePropertiesBase() (*AzureResourcePropertiesBase, bool)
}
...
func unmarshalBasicAzureResourcePropertiesBase(body []byte) (BasicAzureResourcePropertiesBase, error) {
	var m map[string]interface{}
	err := json.Unmarshal(body, &m)
	if err != nil {
		return nil, err
	...
	case string(TypeKeyVault):
		var akvp AzureKeyVaultProperties
		err := json.Unmarshal(body, &akvp)
		return akvp, err
	default:
		var arpb AzureResourcePropertiesBase
		err := json.Unmarshal(body, &arpb)
		return arpb, err
	}
}
func unmarshalBasicAzureResourcePropertiesBaseArray(body []byte) ([]BasicAzureResourcePropertiesBase, error) {
	var rawMessages []*json.RawMessage
	err := json.Unmarshal(body, &rawMessages)
	if err != nil {
		return nil, err
	...
	arpbArray := make([]BasicAzureResourcePropertiesBase, len(rawMessages))

	for index, rawMessage := range rawMessages {
		arpb, err := unmarshalBasicAzureResourcePropertiesBase(*rawMessage)
		if err != nil {
			return nil, err
		}
		arpbArray[index] = arpb
	}
	return arpbArray, nil
}

// MarshalJSON is the custom marshaler for AzureResourcePropertiesBase.
func (arpb AzureResourcePropertiesBase) MarshalJSON() ([]byte, error) {
	arpb.Type = TypeAzureResourcePropertiesBase
	objectMap := make(map[string]interface{})
	if arpb.Type != "" {
		objectMap["type"] = arpb.Type
	}
	return json.Marshal(objectMap)
}

// AsAzureKeyVaultProperties is the BasicAzureResourcePropertiesBase implementation for AzureResourcePropertiesBase.
func (arpb AzureResourcePropertiesBase) AsAzureKeyVaultProperties() (*AzureKeyVaultProperties, bool) {
	return nil, false
}

// AsAzureResourcePropertiesBase is the BasicAzureResourcePropertiesBase implementation for AzureResourcePropertiesBase.
func (arpb AzureResourcePropertiesBase) AsAzureResourcePropertiesBase() (*AzureResourcePropertiesBase, bool) {
	return &arpb, true
}

// AsBasicAzureResourcePropertiesBase is the BasicAzureResourcePropertiesBase implementation for AzureResourcePropertiesBase.
func (arpb AzureResourcePropertiesBase) AsBasicAzureResourcePropertiesBase() (BasicAzureResourcePropertiesBase, bool) {
	return &arpb, true
}
...
// MarshalJSON is the custom marshaler for ConfluentBootstrapServer.
func (cbs ConfluentBootstrapServer) MarshalJSON() ([]byte, error) {
	cbs.Type = TypeConfluentBootstrapServer
	objectMap := make(map[string]interface{})
	if cbs.Endpoint != nil {
		objectMap["endpoint"] = cbs.Endpoint
	}
	if cbs.Type != "" {
		objectMap["type"] = cbs.Type
	}
	return json.Marshal(objectMap)
}

// AsAzureResource is the BasicTargetServiceBase implementation for ConfluentBootstrapServer.
func (cbs ConfluentBootstrapServer) AsAzureResource() (*AzureResource, bool) {
	return nil, false
}

// AsConfluentBootstrapServer is the BasicTargetServiceBase implementation for ConfluentBootstrapServer.
func (cbs ConfluentBootstrapServer) AsConfluentBootstrapServer() (*ConfluentBootstrapServer, bool) {
	return &cbs, true
}

// AsConfluentSchemaRegistry is the BasicTargetServiceBase implementation for ConfluentBootstrapServer.
func (cbs ConfluentBootstrapServer) AsConfluentSchemaRegistry() (*ConfluentSchemaRegistry, bool) {
	return nil, false
}

// AsTargetServiceBase is the BasicTargetServiceBase implementation for ConfluentBootstrapServer.
func (cbs ConfluentBootstrapServer) AsTargetServiceBase() (*TargetServiceBase, bool) {
	return nil, false
}

// AsBasicTargetServiceBase is the BasicTargetServiceBase implementation for ConfluentBootstrapServer.
func (cbs ConfluentBootstrapServer) AsBasicTargetServiceBase() (BasicTargetServiceBase, bool) {
	return &cbs, true
}
...
// MarshalJSON is the custom marshaler for ConfluentSchemaRegistry.
func (csr ConfluentSchemaRegistry) MarshalJSON() ([]byte, error) {
	csr.Type = TypeConfluentSchemaRegistry
	objectMap := make(map[string]interface{})
	if csr.Endpoint != nil {
		objectMap["endpoint"] = csr.Endpoint
	}
	if csr.Type != "" {
...
// AsAzureResource is the BasicTargetServiceBase implementation for ConfluentSchemaRegistry.
func (csr ConfluentSchemaRegistry) AsAzureResource() (*AzureResource, bool) {
	return nil, false
}

// AsConfluentBootstrapServer is the BasicTargetServiceBase implementation for ConfluentSchemaRegistry.
func (csr ConfluentSchemaRegistry) AsConfluentBootstrapServer() (*ConfluentBootstrapServer, bool) {
	return nil, false
}

// AsConfluentSchemaRegistry is the BasicTargetServiceBase implementation for ConfluentSchemaRegistry.
func (csr ConfluentSchemaRegistry) AsConfluentSchemaRegistry() (*ConfluentSchemaRegistry, bool) {
	return &csr, true
}

// AsTargetServiceBase is the BasicTargetServiceBase implementation for ConfluentSchemaRegistry.
func (csr ConfluentSchemaRegistry) AsTargetServiceBase() (*TargetServiceBase, bool) {
	return nil, false
}

// AsBasicTargetServiceBase is the BasicTargetServiceBase implementation for ConfluentSchemaRegistry.
func (csr ConfluentSchemaRegistry) AsBasicTargetServiceBase() (BasicTargetServiceBase, bool) {
	return &csr, true
}
...
// KeyVaultSecretReferenceSecretInfo the secret info when type is keyVaultSecretReference. It's for
// scenario that user provides a secret stored in user's keyvault and source is Azure Kubernetes. The key
// Vault's resource id is linked to secretStore.keyVaultId.
type KeyVaultSecretReferenceSecretInfo struct {
	...
	// SecretType - Possible values include: 'SecretTypeSecretInfoBase', 'SecretTypeRawValue', 'SecretTypeKeyVaultSecretReference', 'SecretTypeKeyVaultSecretURI'
	SecretType SecretTypeBasicSecretInfoBase `json:"secretType,omitempty"`
}

// MarshalJSON is the custom marshaler for KeyVaultSecretReferenceSecretInfo.
func (kvsrsi KeyVaultSecretReferenceSecretInfo) MarshalJSON() ([]byte, error) {
	kvsrsi.SecretType = SecretTypeKeyVaultSecretReference
	objectMap := make(map[string]interface{})
	if kvsrsi.Name != nil {
		objectMap["name"] = kvsrsi.Name
	}
	if kvsrsi.Version != nil {
		objectMap["version"] = kvsrsi.Version
	}
	if kvsrsi.SecretType != "" {
		objectMap["secretType"] = kvsrsi.SecretType
	}
	return json.Marshal(objectMap)
}

// AsValueSecretInfo is the BasicSecretInfoBase implementation for KeyVaultSecretReferenceSecretInfo.
func (kvsrsi KeyVaultSecretReferenceSecretInfo) AsValueSecretInfo() (*ValueSecretInfo, bool) {
	return nil, false
}

// AsKeyVaultSecretReferenceSecretInfo is the BasicSecretInfoBase implementation for KeyVaultSecretReferenceSecretInfo.
func (kvsrsi KeyVaultSecretReferenceSecretInfo) AsKeyVaultSecretReferenceSecretInfo() (*KeyVaultSecretReferenceSecretInfo, bool) {
	return &kvsrsi, true
}

// AsKeyVaultSecretURISecretInfo is the BasicSecretInfoBase implementation for KeyVaultSecretReferenceSecretInfo.
func (kvsrsi KeyVaultSecretReferenceSecretInfo) AsKeyVaultSecretURISecretInfo() (*KeyVaultSecretURISecretInfo, bool) {
	return nil, false
}

// AsSecretInfoBase is the BasicSecretInfoBase implementation for KeyVaultSecretReferenceSecretInfo.
func (kvsrsi KeyVaultSecretReferenceSecretInfo) AsSecretInfoBase() (*SecretInfoBase, bool) {
	return nil, false
}

// AsBasicSecretInfoBase is the BasicSecretInfoBase implementation for KeyVaultSecretReferenceSecretInfo.
func (kvsrsi KeyVaultSecretReferenceSecretInfo) AsBasicSecretInfoBase() (BasicSecretInfoBase, bool) {
	return &kvsrsi, true
}

// KeyVaultSecretURISecretInfo the secret info when type is keyVaultSecretUri. It's for scenario that user
// provides a secret stored in user's keyvault and source is Web App, Spring Cloud or Container App.
...
// MarshalJSON is the custom marshaler for KeyVaultSecretURISecretInfo.
func (kvsusi KeyVaultSecretURISecretInfo) MarshalJSON() ([]byte, error) {
	kvsusi.SecretType = SecretTypeKeyVaultSecretURI
	objectMap := make(map[string]interface{})
	if kvsusi.Value != nil {
		objectMap["value"] = kvsusi.Value
	}
	if kvsusi.SecretType != "" {
		objectMap["secretType"] = kvsusi.SecretType
	}
	return json.Marshal(objectMap)
}

// AsValueSecretInfo is the BasicSecretInfoBase implementation for KeyVaultSecretURISecretInfo.
func (kvsusi KeyVaultSecretURISecretInfo) AsValueSecretInfo() (*ValueSecretInfo, bool) {
	return nil, false
}

// AsKeyVaultSecretReferenceSecretInfo is the BasicSecretInfoBase implementation for KeyVaultSecretURISecretInfo.
func (kvsusi KeyVaultSecretURISecretInfo) AsKeyVaultSecretReferenceSecretInfo() (*KeyVaultSecretReferenceSecretInfo, bool) {
	return nil, false
}

// AsKeyVaultSecretURISecretInfo is the BasicSecretInfoBase implementation for KeyVaultSecretURISecretInfo.
func (kvsusi KeyVaultSecretURISecretInfo) AsKeyVaultSecretURISecretInfo() (*KeyVaultSecretURISecretInfo, bool) {
	return &kvsusi, true
}

// AsSecretInfoBase is the BasicSecretInfoBase implementation for KeyVaultSecretURISecretInfo.
func (kvsusi KeyVaultSecretURISecretInfo) AsSecretInfoBase() (*SecretInfoBase, bool) {
	return nil, false
}

// AsBasicSecretInfoBase is the BasicSecretInfoBase implementation for KeyVaultSecretURISecretInfo.
func (kvsusi KeyVaultSecretURISecretInfo) AsBasicSecretInfoBase() (BasicSecretInfoBase, bool) {
	return &kvsusi, true
}
...
type LinkerProperties struct {
	...
	TargetService BasicTargetServiceBase `json:"targetService,omitempty"`
...
func (lp LinkerProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	objectMap["targetService"] = lp.TargetService
...
func (lp *LinkerProperties) UnmarshalJSON(body []byte) error {
	...
	for k, v := range m {
		...
		case "targetService":
			if v != nil {
				targetService, err := unmarshalBasicTargetServiceBase(*v)
				if err != nil {
					return err
				}
				lp.TargetService = targetService
			}
		case "authInfo":
			if v != nil {
...
type SecretAuthInfo struct {
	...
	SecretInfo BasicSecretInfoBase `json:"secretInfo,omitempty"`
	// AuthType - Possible values include: 'AuthTypeAuthInfoBase', 'AuthTypeSecret', 'AuthTypeUserAssignedIdentity', 'AuthTypeSystemAssignedIdentity', 'AuthTypeServicePrincipalSecret', 'AuthTypeServicePrincipalCertificate'
	AuthType AuthTypeBasicAuthInfoBase `json:"authType,omitempty"`
}
...
func (sai SecretAuthInfo) MarshalJSON() ([]byte, error) {
	...
	objectMap["secretInfo"] = sai.SecretInfo
	if sai.AuthType != "" {
...
// UnmarshalJSON is the custom unmarshaler for SecretAuthInfo struct.
func (sai *SecretAuthInfo) UnmarshalJSON(body []byte) error {
	var m map[string]*json.RawMessage
	err := json.Unmarshal(body, &m)
	if err != nil {
		return err
	...
	for k, v := range m {
		...
		case "secretInfo":
			if v != nil {
				secretInfo, err := unmarshalBasicSecretInfoBase(*v)
				if err != nil {
					return err
				}
				sai.SecretInfo = secretInfo
			}
		case "authType":
			if v != nil {
				var authType AuthTypeBasicAuthInfoBase
				err = json.Unmarshal(*v, &authType)
				if err != nil {
					return err
				}
				sai.AuthType = authType
			}
		}
	}
...
// BasicSecretInfoBase the secret info
type BasicSecretInfoBase interface {
	AsValueSecretInfo() (*ValueSecretInfo, bool)
	AsKeyVaultSecretReferenceSecretInfo() (*KeyVaultSecretReferenceSecretInfo, bool)
	AsKeyVaultSecretURISecretInfo() (*KeyVaultSecretURISecretInfo, bool)
	AsSecretInfoBase() (*SecretInfoBase, bool)
}
...
func unmarshalBasicSecretInfoBase(body []byte) (BasicSecretInfoBase, error) {
	var m map[string]interface{}
	err := json.Unmarshal(body, &m)
	if err != nil {
		return nil, err
	...
	case string(SecretTypeRawValue):
		var vsi ValueSecretInfo
		err := json.Unmarshal(body, &vsi)
		return vsi, err
	case string(SecretTypeKeyVaultSecretReference):
		var kvsrsi KeyVaultSecretReferenceSecretInfo
		err := json.Unmarshal(body, &kvsrsi)
		return kvsrsi, err
	case string(SecretTypeKeyVaultSecretURI):
		var kvsusi KeyVaultSecretURISecretInfo
		err := json.Unmarshal(body, &kvsusi)
		return kvsusi, err
	default:
		var sib SecretInfoBase
		err := json.Unmarshal(body, &sib)
		return sib, err
	}
}
func unmarshalBasicSecretInfoBaseArray(body []byte) ([]BasicSecretInfoBase, error) {
	var rawMessages []*json.RawMessage
	err := json.Unmarshal(body, &rawMessages)
	if err != nil {
		return nil, err
	...
	sibArray := make([]BasicSecretInfoBase, len(rawMessages))

	for index, rawMessage := range rawMessages {
		sib, err := unmarshalBasicSecretInfoBase(*rawMessage)
		if err != nil {
			return nil, err
		}
		sibArray[index] = sib
...
// MarshalJSON is the custom marshaler for SecretInfoBase.
func (sib SecretInfoBase) MarshalJSON() ([]byte, error) {
	sib.SecretType = SecretTypeSecretInfoBase
	objectMap := make(map[string]interface{})
	if sib.SecretType != "" {
		objectMap["secretType"] = sib.SecretType
	}
	return json.Marshal(objectMap)
}

// AsValueSecretInfo is the BasicSecretInfoBase implementation for SecretInfoBase.
func (sib SecretInfoBase) AsValueSecretInfo() (*ValueSecretInfo, bool) {
	return nil, false
}

// AsKeyVaultSecretReferenceSecretInfo is the BasicSecretInfoBase implementation for SecretInfoBase.
func (sib SecretInfoBase) AsKeyVaultSecretReferenceSecretInfo() (*KeyVaultSecretReferenceSecretInfo, bool) {
	return nil, false
}

// AsKeyVaultSecretURISecretInfo is the BasicSecretInfoBase implementation for SecretInfoBase.
func (sib SecretInfoBase) AsKeyVaultSecretURISecretInfo() (*KeyVaultSecretURISecretInfo, bool) {
	return nil, false
}

// AsSecretInfoBase is the BasicSecretInfoBase implementation for SecretInfoBase.
func (sib SecretInfoBase) AsSecretInfoBase() (*SecretInfoBase, bool) {
	return &sib, true
}

// AsBasicSecretInfoBase is the BasicSecretInfoBase implementation for SecretInfoBase.
func (sib SecretInfoBase) AsBasicSecretInfoBase() (BasicSecretInfoBase, bool) {
	return &sib, true
}
...
// BasicTargetServiceBase the target service properties
type BasicTargetServiceBase interface {
	AsAzureResource() (*AzureResource, bool)
	AsConfluentBootstrapServer() (*ConfluentBootstrapServer, bool)
	AsConfluentSchemaRegistry() (*ConfluentSchemaRegistry, bool)
	AsTargetServiceBase() (*TargetServiceBase, bool)
}
...
func unmarshalBasicTargetServiceBase(body []byte) (BasicTargetServiceBase, error) {
	var m map[string]interface{}
	err := json.Unmarshal(body, &m)
	if err != nil {
		return nil, err
	...
	case string(TypeAzureResource):
		var ar AzureResource
		err := json.Unmarshal(body, &ar)
		return ar, err
	case string(TypeConfluentBootstrapServer):
		var cbs ConfluentBootstrapServer
		err := json.Unmarshal(body, &cbs)
		return cbs, err
	case string(TypeConfluentSchemaRegistry):
		var csr ConfluentSchemaRegistry
		err := json.Unmarshal(body, &csr)
		return csr, err
	default:
		var tsb TargetServiceBase
		err := json.Unmarshal(body, &tsb)
		return tsb, err
	}
}
func unmarshalBasicTargetServiceBaseArray(body []byte) ([]BasicTargetServiceBase, error) {
	var rawMessages []*json.RawMessage
	err := json.Unmarshal(body, &rawMessages)
	if err != nil {
		return nil, err
	...
	tsbArray := make([]BasicTargetServiceBase, len(rawMessages))

	for index, rawMessage := range rawMessages {
		tsb, err := unmarshalBasicTargetServiceBase(*rawMessage)
		if err != nil {
			return nil, err
		}
		tsbArray[index] = tsb
...
// MarshalJSON is the custom marshaler for TargetServiceBase.
func (tsb TargetServiceBase) MarshalJSON() ([]byte, error) {
	tsb.Type = TypeTargetServiceBase
	objectMap := make(map[string]interface{})
	if tsb.Type != "" {
...
// AsAzureResource is the BasicTargetServiceBase implementation for TargetServiceBase.
func (tsb TargetServiceBase) AsAzureResource() (*AzureResource, bool) {
	return nil, false
}

// AsConfluentBootstrapServer is the BasicTargetServiceBase implementation for TargetServiceBase.
func (tsb TargetServiceBase) AsConfluentBootstrapServer() (*ConfluentBootstrapServer, bool) {
	return nil, false
}

// AsConfluentSchemaRegistry is the BasicTargetServiceBase implementation for TargetServiceBase.
func (tsb TargetServiceBase) AsConfluentSchemaRegistry() (*ConfluentSchemaRegistry, bool) {
	return nil, false
}

// AsTargetServiceBase is the BasicTargetServiceBase implementation for TargetServiceBase.
func (tsb TargetServiceBase) AsTargetServiceBase() (*TargetServiceBase, bool) {
	return &tsb, true
}

// AsBasicTargetServiceBase is the BasicTargetServiceBase implementation for TargetServiceBase.
func (tsb TargetServiceBase) AsBasicTargetServiceBase() (BasicTargetServiceBase, bool) {
	return &tsb, true
}
...
type ValidateResult struct {
	autorest.Response `json:"-"`
	// LinkerName - The linker name.
	LinkerName *string `json:"linkerName,omitempty"`
	// IsConnectionAvailable - A boolean value indicating whether the connection is available or not
	...
	// SourceID - The resource id of the linker source application.
	...
	// ValidationDetail - The detail of validation result
...
type ValidationResultItem struct {
	...
	Description *string `json:"description,omitempty"`
	// Result - The result of validation. Possible values include: 'Success', 'Failed', 'Warning'
	Result ValidationResultStatus `json:"result,omitempty"`
	// ErrorMessage - The error message of validation result
	ErrorMessage *string `json:"errorMessage,omitempty"`
	// ErrorCode - The error code of validation result
...
// MarshalJSON is the custom marshaler for ValueSecretInfo.
func (vsi ValueSecretInfo) MarshalJSON() ([]byte, error) {
	vsi.SecretType = SecretTypeRawValue
	objectMap := make(map[string]interface{})
	if vsi.Value != nil {
		objectMap["value"] = vsi.Value
	}
	if vsi.SecretType != "" {
		objectMap["secretType"] = vsi.SecretType
	}
	return json.Marshal(objectMap)
}

// AsValueSecretInfo is the BasicSecretInfoBase implementation for ValueSecretInfo.
func (vsi ValueSecretInfo) AsValueSecretInfo() (*ValueSecretInfo, bool) {
	return &vsi, true
}

// AsKeyVaultSecretReferenceSecretInfo is the BasicSecretInfoBase implementation for ValueSecretInfo.
func (vsi ValueSecretInfo) AsKeyVaultSecretReferenceSecretInfo() (*KeyVaultSecretReferenceSecretInfo, bool) {
	return nil, false
}

// AsKeyVaultSecretURISecretInfo is the BasicSecretInfoBase implementation for ValueSecretInfo.
func (vsi ValueSecretInfo) AsKeyVaultSecretURISecretInfo() (*KeyVaultSecretURISecretInfo, bool) {
	return nil, false
}

// AsSecretInfoBase is the BasicSecretInfoBase implementation for ValueSecretInfo.
func (vsi ValueSecretInfo) AsSecretInfoBase() (*SecretInfoBase, bool) {
	return nil, false
}

// AsBasicSecretInfoBase is the BasicSecretInfoBase implementation for ValueSecretInfo.
func (vsi ValueSecretInfo) AsBasicSecretInfoBase() (BasicSecretInfoBase, bool) {
	return &vsi, true
}
