...
- New enum type `Relevance` with values `RelevanceIrrelevant`, `RelevanceRelevant`
...
- New enum type `Status` with values `StatusCanceled`, `StatusClosed`, `StatusFailed`, `StatusInProgress`, `StatusMitigated`, `StatusNew`, `StatusOnHold`, `StatusResolved`, `StatusSucceeded`
