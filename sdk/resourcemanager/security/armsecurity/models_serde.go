...
// MarshalJSON implements the json.Marshaller interface for type ParametersSchema.
func (p ParametersSchema) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "scenarioName", p.ScenarioName)
	populateAny(objectMap, "scenarioParameters", p.ScenarioParameters)
	populate(objectMap, "scopes", p.Scopes)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ParametersSchema.
func (p *ParametersSchema) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
	...
	for key, val := range rawMsg {
		...
		case "scenarioName":
			...
			delete(rawMsg, key)
		case "scenarioParameters":
			err = unpopulate(val, "ScenarioParameters", &p.ScenarioParameters)
			delete(rawMsg, key)
		case "scopes":
...
// MarshalJSON implements the json.Marshaller interface for type ScenarioResponse.
func (s ScenarioResponse) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateAny(objectMap, "scenarioResult", s.ScenarioResult)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ScenarioResponse.
func (s *ScenarioResponse) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "scenarioResult":
			err = unpopulate(val, "ScenarioResult", &s.ScenarioResult)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", s, err)
