...
type DiskConfiguration struct {
	...
	DiskVolumeConfiguration map[string]*DiskVolumeConfiguration `json:"diskVolumeConfiguration,omitempty"`
}
...
type DiskSKU struct {
	// The sku name required such as 'StandardSSDLRS', 'PremiumLRS'. Only one of these will be an accepted input.
	Name *string `json:"name,omitempty"`
}
