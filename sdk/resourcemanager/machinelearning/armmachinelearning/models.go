...
type APIKeyAuthWorkspaceConnectionProperties struct {
	...
	// READ-ONLY; The arm id of the workspace which created this connection
...
// Indexes - Azure Resource Manager resource envelope.
type Indexes struct {
	// REQUIRED; [Required] Additional attributes of the entity.
...
// IndexesProperties - Indexes resource definition
type IndexesProperties struct {
	// The asset description text.
	Description *string

	// Placeholder for extras. Example: any index details we are prototyping for surfacing.
	IndexConfigurations map[string]*string

	// Reference to the Index this index was versioned off of. Null implies creation of a new versioned set. Uri
	// azureml://subscriptions/{{sub}}/resourcegroups/{{rg}}/workspaces/{{workspace}}/indexes/{{previous}} Should not be required
	// to be the latest. Just one of the assets in the set.
	PreviousVersionIndexID *string

	// The asset property dictionary.
	Properties map[string]*string

	// Default workspace blob storage Uri. Should work across storage types and auth scenarios. Uri
	...
	// READ-ONLY; Set by system: format {Major-Version}.{Minor-Version}. Example 3.5, major version 3 minor version 5.
	Version *string
}

// IndexesResourceArmPaginatedResult - A paginated list of Indexes entities.
type IndexesResourceArmPaginatedResult struct {
...
type ManagedNetworkSettings struct {
	...
	// READ-ONLY; Detail isolation modes for the managed network of a machine learning workspace.
...
type ServerlessEndpointProperties struct {
	// REQUIRED; [Required] The publisher-defined Serverless Offer to provision the endpoint with.
	Offer *ServerlessOffer
