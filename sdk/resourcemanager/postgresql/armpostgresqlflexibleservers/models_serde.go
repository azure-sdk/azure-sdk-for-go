...
func (d DataEncryption) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "geoBackupDelegatedIdentityClientId", d.GeoBackupDelegatedIdentityClientID)
...
func (d *DataEncryption) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		var err error
		switch key {
		case "geoBackupDelegatedIdentityClientId":
			err = unpopulate(val, "GeoBackupDelegatedIdentityClientID", &d.GeoBackupDelegatedIdentityClientID)
			delete(rawMsg, key)
		...
		case "primaryDelegatedIdentityClientId":
			err = unpopulate(val, "PrimaryDelegatedIdentityClientID", &d.PrimaryDelegatedIdentityClientID)
			delete(rawMsg, key)
...
// MarshalJSON implements the json.Marshaller interface for type DelegatedResources.
func (d DelegatedResources) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "location", d.Location)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type DelegatedResources.
func (d *DelegatedResources) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", d, err)
	}
...
func (u UserAssignedIdentity) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "delegatedResources", u.DelegatedResources)
...
func (u *UserAssignedIdentity) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "delegatedResources":
			err = unpopulate(val, "DelegatedResources", &u.DelegatedResources)
			delete(rawMsg, key)
		case "principalId":
