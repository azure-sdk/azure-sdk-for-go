...
// JobsExecutionsClientBeginListOptions contains the optional parameters for the JobsExecutionsClient.BeginList method.
type JobsExecutionsClientBeginListOptions struct {
	// The filter to apply on the operation.
	Filter *string
	// Resumes the LRO from the provided token.
	ResumeToken string
