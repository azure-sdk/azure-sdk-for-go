...
// FunctionsAlwaysReadyConfig - Sets the number of 'Always Ready' instances for a specific Azure Function or a specific trigger
// type.
...
// FunctionsDeployment - Configuration section for Azure Function app deployment.
...
// FunctionsDeploymentStorage - Storage for deployed package used by the Azure Function app.
type FunctionsDeploymentStorage struct {
	...
	// Property to set the URL for the selected Azure Storage Type. Example: For blobContainer, value will be like https://.blob.core.windows.net/.
	Value *string
}

// FunctionsDeploymentStorageAuthentication - Authentication method to access the storage for deployment.
type FunctionsDeploymentStorageAuthentication struct {
	// Property to select Authentication Type to access the selected storage. Available options: SystemAssignedIdentity, UserAssignedIdentity,
	// StorageAccountAccessKey.
	Type *string

	// Property to set the value for the selected Authentication Type. Example: For SystemAssignedIdentity, do not set value.
	// For UserAssignedIdentity, set resource ID of identity. For
	// StorageAccountAccessKey, set name of the app setting that has the storage account access key.
	Value *string
}

// FunctionsScaleAndConcurrency - Scale and concurrency settings for an Azure Functions app.
type FunctionsScaleAndConcurrency struct {
	...
	// Set the amount of memory allocated to each instance of the function app in MiB; CPU and network bandwidth are allocated
	// proportionally.
...
// FunctionsScaleAndConcurrencyTriggers - Scale and concurrency settings for Azure Functions triggers.
