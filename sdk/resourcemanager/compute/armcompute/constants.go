...
// Mode - Specifies the mode that ProxyAgent will execute on. ProxyAgent will start to simulate and log access control over
// requests to IMDS endpoints in Audit mode, while in Enforce mode it will enforce access
