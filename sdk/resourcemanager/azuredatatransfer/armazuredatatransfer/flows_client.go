...
//   - resource - Flow body
//   - options - FlowsClientCreateOrUpdateOptions contains the optional parameters for the FlowsClient.CreateOrUpdate method.
func (client *FlowsClient) CreateOrUpdate(ctx context.Context, resourceGroupName string, connectionName string, flowName string, resource Flow, options *FlowsClientCreateOrUpdateOptions) (FlowsClientCreateOrUpdateResponse, error) {
	var err error
	const operationName = "FlowsClient.CreateOrUpdate"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.createOrUpdateCreateRequest(ctx, resourceGroupName, connectionName, flowName, resource, options)
	if err != nil {
		return FlowsClientCreateOrUpdateResponse{}, err
	}
...
func (client *FlowsClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, connectionName string, flowName string, resource Flow, _ *FlowsClientCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *FlowsClient) createOrUpdateHandleResponse(resp *http.Response) (FlowsClientCreateOrUpdateResponse, error) {
	result := FlowsClientCreateOrUpdateResponse{}
...
func (client *FlowsClient) BeginLink(ctx context.Context, resourceGroupName string, connectionName string, flowName string, body ResourceBody, options *FlowsClientBeginLinkOptions) (*runtime.Poller[FlowsClientLinkResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.link(ctx, resourceGroupName, connectionName, flowName, body, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2025-04-11-preview
func (client *FlowsClient) link(ctx context.Context, resourceGroupName string, connectionName string, flowName string, body ResourceBody, options *FlowsClientBeginLinkOptions) (*http.Response, error) {
	var err error
	const operationName = "FlowsClient.BeginLink"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.linkCreateRequest(ctx, resourceGroupName, connectionName, flowName, body, options)
	if err != nil {
		return nil, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
...
func (client *FlowsClient) linkCreateRequest(ctx context.Context, resourceGroupName string, connectionName string, flowName string, body ResourceBody, _ *FlowsClientBeginLinkOptions) (*policy.Request, error) {
...
func (client *FlowsClient) listByConnectionHandleResponse(resp *http.Response) (FlowsClientListByConnectionResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.FlowListResult); err != nil {
		return FlowsClientListByConnectionResponse{}, err
	}
	return result, nil
}
...
//   - connectionName - The name for the connection that is to be requested.
//   - flowName - The name for the flow that is to be onboarded.
//   - body - Stream ID destination endpoint ports wanted
...
//     method.
func (client *FlowsClient) BeginSetDestinationEndpointPorts(ctx context.Context, resourceGroupName string, connectionName string, flowName string, body SetDestinationEndpointPorts, options *FlowsClientBeginSetDestinationEndpointPortsOptions) (*runtime.Poller[FlowsClientSetDestinationEndpointPortsResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.setDestinationEndpointPorts(ctx, resourceGroupName, connectionName, flowName, body, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2025-04-11-preview
func (client *FlowsClient) setDestinationEndpointPorts(ctx context.Context, resourceGroupName string, connectionName string, flowName string, body SetDestinationEndpointPorts, options *FlowsClientBeginSetDestinationEndpointPortsOptions) (*http.Response, error) {
	var err error
	const operationName = "FlowsClient.BeginSetDestinationEndpointPorts"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.setDestinationEndpointPortsCreateRequest(ctx, resourceGroupName, connectionName, flowName, body, options)
	if err != nil {
		return nil, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
...
func (client *FlowsClient) setDestinationEndpointPortsCreateRequest(ctx context.Context, resourceGroupName string, connectionName string, flowName string, body SetDestinationEndpointPorts, _ *FlowsClientBeginSetDestinationEndpointPortsOptions) (*policy.Request, error) {
...
//   - connectionName - The name for the connection that is to be requested.
//   - flowName - The name for the flow that is to be onboarded.
//   - body - Stream ID destination endpoints wanted
...
//     method.
func (client *FlowsClient) BeginSetDestinationEndpoints(ctx context.Context, resourceGroupName string, connectionName string, flowName string, body SetDestinationEndpoints, options *FlowsClientBeginSetDestinationEndpointsOptions) (*runtime.Poller[FlowsClientSetDestinationEndpointsResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.setDestinationEndpoints(ctx, resourceGroupName, connectionName, flowName, body, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2025-04-11-preview
func (client *FlowsClient) setDestinationEndpoints(ctx context.Context, resourceGroupName string, connectionName string, flowName string, body SetDestinationEndpoints, options *FlowsClientBeginSetDestinationEndpointsOptions) (*http.Response, error) {
	var err error
	const operationName = "FlowsClient.BeginSetDestinationEndpoints"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.setDestinationEndpointsCreateRequest(ctx, resourceGroupName, connectionName, flowName, body, options)
	if err != nil {
		return nil, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
...
func (client *FlowsClient) setDestinationEndpointsCreateRequest(ctx context.Context, resourceGroupName string, connectionName string, flowName string, body SetDestinationEndpoints, _ *FlowsClientBeginSetDestinationEndpointsOptions) (*policy.Request, error) {
...
//   - connectionName - The name for the connection that is to be requested.
//   - flowName - The name for the flow that is to be onboarded.
//   - body - Passphrase to set
//   - options - FlowsClientBeginSetPassphraseOptions contains the optional parameters for the FlowsClient.BeginSetPassphrase
//     method.
func (client *FlowsClient) BeginSetPassphrase(ctx context.Context, resourceGroupName string, connectionName string, flowName string, body SetStreamPassphrase, options *FlowsClientBeginSetPassphraseOptions) (*runtime.Poller[FlowsClientSetPassphraseResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.setPassphrase(ctx, resourceGroupName, connectionName, flowName, body, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2025-04-11-preview
func (client *FlowsClient) setPassphrase(ctx context.Context, resourceGroupName string, connectionName string, flowName string, body SetStreamPassphrase, options *FlowsClientBeginSetPassphraseOptions) (*http.Response, error) {
	var err error
	const operationName = "FlowsClient.BeginSetPassphrase"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.setPassphraseCreateRequest(ctx, resourceGroupName, connectionName, flowName, body, options)
	if err != nil {
		return nil, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
...
func (client *FlowsClient) setPassphraseCreateRequest(ctx context.Context, resourceGroupName string, connectionName string, flowName string, body SetStreamPassphrase, _ *FlowsClientBeginSetPassphraseOptions) (*policy.Request, error) {
...
//     method.
func (client *FlowsClient) BeginSetSourceAddresses(ctx context.Context, resourceGroupName string, connectionName string, flowName string, body SetSourceAddresses, options *FlowsClientBeginSetSourceAddressesOptions) (*runtime.Poller[FlowsClientSetSourceAddressesResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.setSourceAddresses(ctx, resourceGroupName, connectionName, flowName, body, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2025-04-11-preview
func (client *FlowsClient) setSourceAddresses(ctx context.Context, resourceGroupName string, connectionName string, flowName string, body SetSourceAddresses, options *FlowsClientBeginSetSourceAddressesOptions) (*http.Response, error) {
	var err error
	const operationName = "FlowsClient.BeginSetSourceAddresses"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.setSourceAddressesCreateRequest(ctx, resourceGroupName, connectionName, flowName, body, options)
	if err != nil {
		return nil, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
...
func (client *FlowsClient) setSourceAddressesCreateRequest(ctx context.Context, resourceGroupName string, connectionName string, flowName string, body SetSourceAddresses, _ *FlowsClientBeginSetSourceAddressesOptions) (*policy.Request, error) {
...
//   - connectionName - The name for the connection that is to be requested.
//   - flowName - The name for the flow that is to be onboarded.
//   - properties - Flow body
//   - options - FlowsClientBeginUpdateOptions contains the optional parameters for the FlowsClient.BeginUpdate method.
func (client *FlowsClient) BeginUpdate(ctx context.Context, resourceGroupName string, connectionName string, flowName string, properties FlowsPatch, options *FlowsClientBeginUpdateOptions) (*runtime.Poller[FlowsClientUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.update(ctx, resourceGroupName, connectionName, flowName, properties, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2025-04-11-preview
func (client *FlowsClient) update(ctx context.Context, resourceGroupName string, connectionName string, flowName string, properties FlowsPatch, options *FlowsClientBeginUpdateOptions) (*http.Response, error) {
	var err error
	const operationName = "FlowsClient.BeginUpdate"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.updateCreateRequest(ctx, resourceGroupName, connectionName, flowName, properties, options)
	if err != nil {
		return nil, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
...
func (client *FlowsClient) updateCreateRequest(ctx context.Context, resourceGroupName string, connectionName string, flowName string, properties FlowsPatch, _ *FlowsClientBeginUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureDataTransfer/connections/{connectionName}/flows/{flowName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
