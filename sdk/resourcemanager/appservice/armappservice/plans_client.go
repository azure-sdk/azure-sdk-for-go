...
// NewListByVirtualNetworkIntegrationsPager - Get all Virtual Networks associated with an App Service plan and their properties,
// such as IP allocation and resource allocation
//
// Generated from API version 2024-11-01
//   - resourceGroupName - Name of the resource group to which the resource belongs.
//   - name - Name of the App Service plan.
//   - options - PlansClientListByVirtualNetworkIntegrationsOptions contains the optional parameters for the PlansClient.NewListByVirtualNetworkIntegrationsPager
//     method.
func (client *PlansClient) NewListByVirtualNetworkIntegrationsPager(resourceGroupName string, name string, options *PlansClientListByVirtualNetworkIntegrationsOptions) *runtime.Pager[PlansClientListByVirtualNetworkIntegrationsResponse] {
	return runtime.NewPager(runtime.PagingHandler[PlansClientListByVirtualNetworkIntegrationsResponse]{
		More: func(page PlansClientListByVirtualNetworkIntegrationsResponse) bool {
			return page.NextLink != nil && len(*page.NextLink) > 0
		},
		Fetcher: func(ctx context.Context, page *PlansClientListByVirtualNetworkIntegrationsResponse) (PlansClientListByVirtualNetworkIntegrationsResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "PlansClient.NewListByVirtualNetworkIntegrationsPager")
			nextLink := ""
			if page != nil {
				nextLink = *page.NextLink
			}
			resp, err := runtime.FetcherForNextLink(ctx, client.internal.Pipeline(), nextLink, func(ctx context.Context) (*policy.Request, error) {
				return client.listByVirtualNetworkIntegrationsCreateRequest(ctx, resourceGroupName, name, options)
			}, nil)
			if err != nil {
				return PlansClientListByVirtualNetworkIntegrationsResponse{}, err
			}
			return client.listByVirtualNetworkIntegrationsHandleResponse(resp)
		},
		Tracer: client.internal.Tracer(),
	})
}

// listByVirtualNetworkIntegrationsCreateRequest creates the ListByVirtualNetworkIntegrations request.
func (client *PlansClient) listByVirtualNetworkIntegrationsCreateRequest(ctx context.Context, resourceGroupName string, name string, options *PlansClientListByVirtualNetworkIntegrationsOptions) (*policy.Request, error) {
...
// listByVirtualNetworkIntegrationsHandleResponse handles the ListByVirtualNetworkIntegrations response.
func (client *PlansClient) listByVirtualNetworkIntegrationsHandleResponse(resp *http.Response) (PlansClientListByVirtualNetworkIntegrationsResponse, error) {
	result := PlansClientListByVirtualNetworkIntegrationsResponse{}
