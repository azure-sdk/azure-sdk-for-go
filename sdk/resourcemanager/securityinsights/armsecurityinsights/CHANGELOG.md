...
- Type of `EntityQueriesClientListOptions.Kind` has been changed from `*Enum13` to `*Enum21`
- Type of `EntityQueryTemplatesClientListOptions.Kind` has been changed from `*Enum15` to `*Enum23`
...
- New enum type `Enum21` with values `Enum21Activity`, `Enum21Expansion`
- New enum type `Enum23` with values `Enum23Activity`
...
- New function `NewAttackPatternClient(string, azcore.TokenCredential, *arm.ClientOptions) (*AttackPatternClient, error)`
- New function `*AttackPatternClient.CreateOrUpdate(context.Context, string, string, string, AttackPattern, *AttackPatternClientCreateOrUpdateOptions) (AttackPatternClientCreateOrUpdateResponse, error)`
- New function `*AttackPatternClient.Delete(context.Context, string, string, string, *AttackPatternClientDeleteOptions) (AttackPatternClientDeleteResponse, error)`
- New function `*AttackPatternClient.Get(context.Context, string, string, string, *AttackPatternClientGetOptions) (AttackPatternClientGetResponse, error)`
- New function `NewAttackPatternsClient(string, azcore.TokenCredential, *arm.ClientOptions) (*AttackPatternsClient, error)`
- New function `*AttackPatternsClient.NewListPager(string, string, *AttackPatternsClientListOptions) *runtime.Pager[AttackPatternsClientListResponse]`
...
- New function `*ClientFactory.NewAttackPatternClient() *AttackPatternClient`
- New function `*ClientFactory.NewAttackPatternsClient() *AttackPatternsClient`
...
- New function `*ClientFactory.NewIdentitiesClient() *IdentitiesClient`
- New function `*ClientFactory.NewIdentityClient() *IdentityClient`
- New function `*ClientFactory.NewIncidentTasksClient() *IncidentTasksClient`
- New function `*ClientFactory.NewIndicatorClient() *IndicatorClient`
- New function `*ClientFactory.NewIndicatorsClient() *IndicatorsClient`
...
- New function `*ClientFactory.NewRelationshipClient() *RelationshipClient`
- New function `*ClientFactory.NewRelationshipsClient() *RelationshipsClient`
- New function `*ClientFactory.NewThreatActorClient() *ThreatActorClient`
- New function `*ClientFactory.NewThreatActorsClient() *ThreatActorsClient`
...
- New function `NewIdentitiesClient(string, azcore.TokenCredential, *arm.ClientOptions) (*IdentitiesClient, error)`
- New function `*IdentitiesClient.NewListPager(string, string, *IdentitiesClientListOptions) *runtime.Pager[IdentitiesClientListResponse]`
- New function `*Identity.GetTIObject() *TIObject`
- New function `NewIdentityClient(string, azcore.TokenCredential, *arm.ClientOptions) (*IdentityClient, error)`
- New function `*IdentityClient.CreateOrUpdate(context.Context, string, string, string, Identity, *IdentityClientCreateOrUpdateOptions) (IdentityClientCreateOrUpdateResponse, error)`
- New function `*IdentityClient.Delete(context.Context, string, string, string, *IdentityClientDeleteOptions) (IdentityClientDeleteResponse, error)`
- New function `*IdentityClient.Get(context.Context, string, string, string, *IdentityClientGetOptions) (IdentityClientGetResponse, error)`
...
- New function `NewIndicatorClient(string, azcore.TokenCredential, *arm.ClientOptions) (*IndicatorClient, error)`
- New function `*IndicatorClient.CreateOrUpdate(context.Context, string, string, string, Indicator, *IndicatorClientCreateOrUpdateOptions) (IndicatorClientCreateOrUpdateResponse, error)`
- New function `*IndicatorClient.Delete(context.Context, string, string, string, *IndicatorClientDeleteOptions) (IndicatorClientDeleteResponse, error)`
- New function `*IndicatorClient.Get(context.Context, string, string, string, *IndicatorClientGetOptions) (IndicatorClientGetResponse, error)`
- New function `NewIndicatorsClient(string, azcore.TokenCredential, *arm.ClientOptions) (*IndicatorsClient, error)`
- New function `*IndicatorsClient.NewListPager(string, string, *IndicatorsClientListOptions) *runtime.Pager[IndicatorsClientListResponse]`
...
- New function `NewRelationshipClient(string, azcore.TokenCredential, *arm.ClientOptions) (*RelationshipClient, error)`
- New function `*RelationshipClient.CreateOrUpdate(context.Context, string, string, string, Relationship, *RelationshipClientCreateOrUpdateOptions) (RelationshipClientCreateOrUpdateResponse, error)`
- New function `*RelationshipClient.Delete(context.Context, string, string, string, *RelationshipClientDeleteOptions) (RelationshipClientDeleteResponse, error)`
- New function `*RelationshipClient.Get(context.Context, string, string, string, *RelationshipClientGetOptions) (RelationshipClientGetResponse, error)`
- New function `NewRelationshipsClient(string, azcore.TokenCredential, *arm.ClientOptions) (*RelationshipsClient, error)`
- New function `*RelationshipsClient.NewListPager(string, string, *RelationshipsClientListOptions) *runtime.Pager[RelationshipsClientListResponse]`
...
- New function `NewThreatActorClient(string, azcore.TokenCredential, *arm.ClientOptions) (*ThreatActorClient, error)`
- New function `*ThreatActorClient.CreateOrUpdate(context.Context, string, string, string, ThreatActor, *ThreatActorClientCreateOrUpdateOptions) (ThreatActorClientCreateOrUpdateResponse, error)`
- New function `*ThreatActorClient.Delete(context.Context, string, string, string, *ThreatActorClientDeleteOptions) (ThreatActorClientDeleteResponse, error)`
- New function `*ThreatActorClient.Get(context.Context, string, string, string, *ThreatActorClientGetOptions) (ThreatActorClientGetResponse, error)`
- New function `NewThreatActorsClient(string, azcore.TokenCredential, *arm.ClientOptions) (*ThreatActorsClient, error)`
- New function `*ThreatActorsClient.NewListPager(string, string, *ThreatActorsClientListOptions) *runtime.Pager[ThreatActorsClientListResponse]`
...
- New struct `EnrichmentIPGeodataAutoGenerated`
