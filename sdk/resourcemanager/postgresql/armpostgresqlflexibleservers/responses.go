...
type TuningOptionsClientListByServerResponse struct {
	// A list of available tuning options for the server.
	TuningOptionsResourceArray []*TuningOptionsResource
}

// TuningOptionsClientListRecommendationsResponse contains the response from method TuningOptionsClient.ListRecommendations.
type TuningOptionsClientListRecommendationsResponse struct {
	// A list of available index recommendations.
	IndexRecommendationResourceArray []*IndexRecommendationResource
}
