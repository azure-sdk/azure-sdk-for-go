...
type ChannelSettings struct {
	...
	// READ-ONLY; The extensionKey1
	ExtensionKey1 *string `json:"extensionKey1,omitempty" azure:"ro"`

	// READ-ONLY; The extensionKey2
	ExtensionKey2 *string `json:"extensionKey2,omitempty" azure:"ro"`
}
