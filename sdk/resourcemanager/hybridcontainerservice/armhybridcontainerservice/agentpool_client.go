...
func (client *AgentPoolClient) createOrUpdateCreateRequest(ctx context.Context, connectedClusterResourceURI string, agentPoolName string, agentPool AgentPool, _ *AgentPoolClientBeginCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *AgentPoolClient) deleteCreateRequest(ctx context.Context, connectedClusterResourceURI string, agentPoolName string, _ *AgentPoolClientBeginDeleteOptions) (*policy.Request, error) {
	urlPath := "/{connectedClusterResourceUri}/providers/Microsoft.HybridContainerService/provisionedClusterInstances/default/agentPools/{agentPoolName}"
	urlPath = strings.ReplaceAll(urlPath, "{connectedClusterResourceUri}", connectedClusterResourceURI)
	if agentPoolName == "" {
		return nil, errors.New("parameter agentPoolName cannot be empty")
...
func (client *AgentPoolClient) getCreateRequest(ctx context.Context, connectedClusterResourceURI string, agentPoolName string, _ *AgentPoolClientGetOptions) (*policy.Request, error) {
	urlPath := "/{connectedClusterResourceUri}/providers/Microsoft.HybridContainerService/provisionedClusterInstances/default/agentPools/{agentPoolName}"
	urlPath = strings.ReplaceAll(urlPath, "{connectedClusterResourceUri}", connectedClusterResourceURI)
	if agentPoolName == "" {
		return nil, errors.New("parameter agentPoolName cannot be empty")
...
func (client *AgentPoolClient) listByProvisionedClusterCreateRequest(ctx context.Context, connectedClusterResourceURI string, _ *AgentPoolClientListByProvisionedClusterOptions) (*policy.Request, error) {
