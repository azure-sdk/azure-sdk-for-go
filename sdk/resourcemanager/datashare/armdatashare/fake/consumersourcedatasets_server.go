...
func (c *ConsumerSourceDataSetsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if consumerSourceDataSetsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = consumerSourceDataSetsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			case "ConsumerSourceDataSetsClient.NewListByShareSubscriptionPager":
				res.resp, res.err = c.dispatchNewListByShareSubscriptionPager(req)
			default:
...
// set this to conditionally intercept incoming requests to ConsumerSourceDataSetsServerTransport
var consumerSourceDataSetsServerTransportInterceptor interface {
