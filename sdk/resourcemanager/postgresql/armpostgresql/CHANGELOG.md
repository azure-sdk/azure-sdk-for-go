...
- Field `ByokEnforcement`, `EarliestRestoreDate`, `InfrastructureEncryption`, `MasterServerID`, `MinimalTLSVersion`, `PrivateEndpointConnections`, `PublicNetworkAccess`, `SSLEnforcement`, `StorageProfile`, `UserVisibleState` of struct `ServerProperties` has been removed
...
- New value `ServerVersionFifteen`, `ServerVersionFourteen`, `ServerVersionThirteen`, `ServerVersionTwelve` added to enum type `ServerVersion`
...
- New field `AdministratorLoginPassword`, `AuthConfig`, `AvailabilityZone`, `Backup`, `CreateMode`, `DataEncryption`, `HighAvailability`, `MaintenanceWindow`, `MinorVersion`, `Network`, `PointInTimeUTC`, `SourceServerResourceID`, `State`, `Storage` in struct `ServerProperties`
