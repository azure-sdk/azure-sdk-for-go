...
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - elasticSanName - The name of the ElasticSan.
//   - options - ElasticSansClientListByElasticSanOptions contains the optional parameters for the ElasticSansClient.NewListByElasticSanPager
//     method.
func (client *ElasticSansClient) NewListByElasticSanPager(resourceGroupName string, elasticSanName string, options *ElasticSansClientListByElasticSanOptions) *runtime.Pager[ElasticSansClientListByElasticSanResponse] {
	return runtime.NewPager(runtime.PagingHandler[ElasticSansClientListByElasticSanResponse]{
		More: func(page ElasticSansClientListByElasticSanResponse) bool {
			return page.NextLink != nil && len(*page.NextLink) > 0
		},
		Fetcher: func(ctx context.Context, page *ElasticSansClientListByElasticSanResponse) (ElasticSansClientListByElasticSanResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "ElasticSansClient.NewListByElasticSanPager")
			nextLink := ""
			if page != nil {
			...
			if err != nil {
				return ElasticSansClientListByElasticSanResponse{}, err
			}
...
func (client *ElasticSansClient) listByElasticSanCreateRequest(ctx context.Context, resourceGroupName string, elasticSanName string, _ *ElasticSansClientListByElasticSanOptions) (*policy.Request, error) {
...
func (client *ElasticSansClient) listByElasticSanHandleResponse(resp *http.Response) (ElasticSansClientListByElasticSanResponse, error) {
	result := ElasticSansClientListByElasticSanResponse{}
