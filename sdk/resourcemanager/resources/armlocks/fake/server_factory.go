...
type ServerFactory struct {
	// AuthorizationOperationsServer contains the fakes for client AuthorizationOperationsClient
	AuthorizationOperationsServer AuthorizationOperationsServer

	// ManagementLocksServer contains the fakes for client ManagementLocksClient
