...
// VMApplicationProxyResourceWithInstanceView - The entity representing a Gallery Application Version assigned with a VM or
// VMSS
type VMApplicationProxyResourceWithInstanceView struct {
	// READ-ONLY; Resource Id
	ID *string
...
// VirtualMachineScaleSetVirtualMachineApplicationsClientGetOptions contains the optional parameters for the VirtualMachineScaleSetVirtualMachineApplicationsClient.Get
// method.
