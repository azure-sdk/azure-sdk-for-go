...
// RaiBlocklistClientCreateOrUpdateResponse contains the response from method RaiBlocklistClient.CreateOrUpdate.
type RaiBlocklistClientCreateOrUpdateResponse struct {
	// Cognitive Services RaiBlocklist.
	RaiBlocklist
}

// RaiBlocklistClientGetResponse contains the response from method RaiBlocklistClient.Get.
type RaiBlocklistClientGetResponse struct {
	// Cognitive Services RaiBlocklist.
	RaiBlocklist
}

// RaiBlocklistItemClientCreateOrUpdateResponse contains the response from method RaiBlocklistItemClient.CreateOrUpdate.
type RaiBlocklistItemClientCreateOrUpdateResponse struct {
	// Cognitive Services RaiBlocklist Item.
	RaiBlocklistItem
}

// RaiBlocklistItemClientDeleteResponse contains the response from method RaiBlocklistItemClient.BeginDelete.
type RaiBlocklistItemClientDeleteResponse struct {
	// placeholder for future response values
}

// RaiBlocklistItemClientGetResponse contains the response from method RaiBlocklistItemClient.Get.
type RaiBlocklistItemClientGetResponse struct {
	// Cognitive Services RaiBlocklist Item.
	RaiBlocklistItem
}
