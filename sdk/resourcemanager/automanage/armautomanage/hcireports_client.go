...
func (client *HCIReportsClient) getCreateRequest(ctx context.Context, resourceGroupName string, clusterName string, configurationProfileAssignmentName string, reportName string, _ *HCIReportsClientGetOptions) (*policy.Request, error) {
...
func (client *HCIReportsClient) listByConfigurationProfileAssignmentsCreateRequest(ctx context.Context, resourceGroupName string, clusterName string, configurationProfileAssignmentName string, _ *HCIReportsClientListByConfigurationProfileAssignmentsOptions) (*policy.Request, error) {
