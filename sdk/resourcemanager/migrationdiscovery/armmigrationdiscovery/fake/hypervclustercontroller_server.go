...
// HypervClusterControllerServer is a fake server for instances of the armmigrationdiscovery.HypervClusterControllerClient type.
type HypervClusterControllerServer struct {
	...
	BeginCreateCluster func(ctx context.Context, resourceGroupName string, siteName string, clusterName string, body armmigrationdiscovery.HypervCluster, options *armmigrationdiscovery.HypervClusterControllerClientBeginCreateClusterOptions) (resp azfake.PollerResponder[armmigrationdiscovery.HypervClusterControllerClientCreateClusterResponse], errResp azfake.ErrorResponder)

	// Delete is the fake for method HypervClusterControllerClient.Delete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	Delete func(ctx context.Context, resourceGroupName string, siteName string, clusterName string, options *armmigrationdiscovery.HypervClusterControllerClientDeleteOptions) (resp azfake.Responder[armmigrationdiscovery.HypervClusterControllerClientDeleteResponse], errResp azfake.ErrorResponder)

	// GetCluster is the fake for method HypervClusterControllerClient.GetCluster
	// HTTP status codes to indicate success: http.StatusOK
	GetCluster func(ctx context.Context, resourceGroupName string, siteName string, clusterName string, options *armmigrationdiscovery.HypervClusterControllerClientGetClusterOptions) (resp azfake.Responder[armmigrationdiscovery.HypervClusterControllerClientGetClusterResponse], errResp azfake.ErrorResponder)

	// NewListByHypervSitePager is the fake for method HypervClusterControllerClient.NewListByHypervSitePager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByHypervSitePager func(resourceGroupName string, siteName string, options *armmigrationdiscovery.HypervClusterControllerClientListByHypervSiteOptions) (resp azfake.PagerResponder[armmigrationdiscovery.HypervClusterControllerClientListByHypervSiteResponse])
}
...
// The returned HypervClusterControllerServerTransport instance is connected to an instance of armmigrationdiscovery.HypervClusterControllerClient via the
...
func NewHypervClusterControllerServerTransport(srv *HypervClusterControllerServer) *HypervClusterControllerServerTransport {
	return &HypervClusterControllerServerTransport{
		srv:                      srv,
		beginCreateCluster:       newTracker[azfake.PollerResponder[armmigrationdiscovery.HypervClusterControllerClientCreateClusterResponse]](),
		newListByHypervSitePager: newTracker[azfake.PagerResponder[armmigrationdiscovery.HypervClusterControllerClientListByHypervSiteResponse]](),
	}
}

// HypervClusterControllerServerTransport connects instances of armmigrationdiscovery.HypervClusterControllerClient to instances of HypervClusterControllerServer.
...
type HypervClusterControllerServerTransport struct {
	...
	beginCreateCluster       *tracker[azfake.PollerResponder[armmigrationdiscovery.HypervClusterControllerClientCreateClusterResponse]]
	newListByHypervSitePager *tracker[azfake.PagerResponder[armmigrationdiscovery.HypervClusterControllerClientListByHypervSiteResponse]]
}
...
func (h *HypervClusterControllerServerTransport) dispatchBeginCreateCluster(req *http.Request) (*http.Response, error) {
	...
	if beginCreateCluster == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armmigrationdiscovery.HypervCluster](req)
		if err != nil {
			return nil, err
		}
...
func (h *HypervClusterControllerServerTransport) dispatchNewListByHypervSitePager(req *http.Request) (*http.Response, error) {
	...
	if newListByHypervSitePager == nil {
		...
		var options *armmigrationdiscovery.HypervClusterControllerClientListByHypervSiteOptions
		if filterParam != nil {
			options = &armmigrationdiscovery.HypervClusterControllerClientListByHypervSiteOptions{
				Filter: filterParam,
			}
		}
		...
		server.PagerResponderInjectNextLinks(newListByHypervSitePager, req, func(page *armmigrationdiscovery.HypervClusterControllerClientListByHypervSiteResponse, createLink func() string) {
