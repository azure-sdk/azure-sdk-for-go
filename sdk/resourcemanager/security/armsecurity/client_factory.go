...
func (c *ClientFactory) NewCustomRecommendationsClient() *CustomRecommendationsClient {
	subClient, _ := NewCustomRecommendationsClient(c.credential, c.options)
	return subClient
}

func (c *ClientFactory) NewStandardsClient() *StandardsClient {
	subClient, _ := NewStandardsClient(c.credential, c.options)
	return subClient
}

func (c *ClientFactory) NewStandardAssignmentsClient() *StandardAssignmentsClient {
	subClient, _ := NewStandardAssignmentsClient(c.credential, c.options)
	return subClient
}
