...
func (client *ContainerAppsRevisionsClient) activateRevisionCreateRequest(ctx context.Context, resourceGroupName string, containerAppName string, name string, _ *ContainerAppsRevisionsClientActivateRevisionOptions) (*policy.Request, error) {
...
func (client *ContainerAppsRevisionsClient) deactivateRevisionCreateRequest(ctx context.Context, resourceGroupName string, containerAppName string, name string, _ *ContainerAppsRevisionsClientDeactivateRevisionOptions) (*policy.Request, error) {
...
func (client *ContainerAppsRevisionsClient) getRevisionCreateRequest(ctx context.Context, resourceGroupName string, containerAppName string, name string, _ *ContainerAppsRevisionsClientGetRevisionOptions) (*policy.Request, error) {
...
func (client *ContainerAppsRevisionsClient) listRevisionsCreateRequest(ctx context.Context, resourceGroupName string, containerAppName string, _ *ContainerAppsRevisionsClientListRevisionsOptions) (*policy.Request, error) {
...
func (client *ContainerAppsRevisionsClient) restartRevisionCreateRequest(ctx context.Context, resourceGroupName string, containerAppName string, name string, _ *ContainerAppsRevisionsClientRestartRevisionOptions) (*policy.Request, error) {
