...
func (client *MarketplaceAgreementsClient) createOrUpdateCreateRequest(ctx context.Context, body AgreementResource, options *MarketplaceAgreementsClientCreateOrUpdateOptions) (*policy.Request, error) {
