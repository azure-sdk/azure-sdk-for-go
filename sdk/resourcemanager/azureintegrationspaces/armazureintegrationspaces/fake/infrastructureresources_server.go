...
// InfrastructureResourcesServer is a fake server for instances of the armazureintegrationspaces.InfrastructureResourcesClient type.
type InfrastructureResourcesServer struct {
	...
	CreateOrUpdate func(ctx context.Context, resourceGroupName string, spaceName string, infrastructureResourceName string, resource armazureintegrationspaces.InfrastructureResource, options *armazureintegrationspaces.InfrastructureResourcesClientCreateOrUpdateOptions) (resp azfake.Responder[armazureintegrationspaces.InfrastructureResourcesClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)

	// Delete is the fake for method InfrastructureResourcesClient.Delete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	Delete func(ctx context.Context, resourceGroupName string, spaceName string, infrastructureResourceName string, options *armazureintegrationspaces.InfrastructureResourcesClientDeleteOptions) (resp azfake.Responder[armazureintegrationspaces.InfrastructureResourcesClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method InfrastructureResourcesClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, spaceName string, infrastructureResourceName string, options *armazureintegrationspaces.InfrastructureResourcesClientGetOptions) (resp azfake.Responder[armazureintegrationspaces.InfrastructureResourcesClientGetResponse], errResp azfake.ErrorResponder)

	// NewListBySpacePager is the fake for method InfrastructureResourcesClient.NewListBySpacePager
	// HTTP status codes to indicate success: http.StatusOK
	NewListBySpacePager func(resourceGroupName string, spaceName string, options *armazureintegrationspaces.InfrastructureResourcesClientListBySpaceOptions) (resp azfake.PagerResponder[armazureintegrationspaces.InfrastructureResourcesClientListBySpaceResponse])

	// Patch is the fake for method InfrastructureResourcesClient.Patch
	// HTTP status codes to indicate success: http.StatusOK
	Patch func(ctx context.Context, resourceGroupName string, spaceName string, infrastructureResourceName string, properties armazureintegrationspaces.InfrastructureResourceUpdate, options *armazureintegrationspaces.InfrastructureResourcesClientPatchOptions) (resp azfake.Responder[armazureintegrationspaces.InfrastructureResourcesClientPatchResponse], errResp azfake.ErrorResponder)
}
...
// The returned InfrastructureResourcesServerTransport instance is connected to an instance of armazureintegrationspaces.InfrastructureResourcesClient via the
...
func NewInfrastructureResourcesServerTransport(srv *InfrastructureResourcesServer) *InfrastructureResourcesServerTransport {
	return &InfrastructureResourcesServerTransport{
		srv:                 srv,
		newListBySpacePager: newTracker[azfake.PagerResponder[armazureintegrationspaces.InfrastructureResourcesClientListBySpaceResponse]](),
	}
}

// InfrastructureResourcesServerTransport connects instances of armazureintegrationspaces.InfrastructureResourcesClient to instances of InfrastructureResourcesServer.
...
type InfrastructureResourcesServerTransport struct {
	...
	newListBySpacePager *tracker[azfake.PagerResponder[armazureintegrationspaces.InfrastructureResourcesClientListBySpaceResponse]]
}
...
func (i *InfrastructureResourcesServerTransport) dispatchCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[armazureintegrationspaces.InfrastructureResource](req)
	if err != nil {
		return nil, err
	}
...
func (i *InfrastructureResourcesServerTransport) dispatchNewListBySpacePager(req *http.Request) (*http.Response, error) {
	...
	if newListBySpacePager == nil {
		...
		var options *armazureintegrationspaces.InfrastructureResourcesClientListBySpaceOptions
		if topParam != nil || skipParam != nil || maxpagesizeParam != nil || filterParam != nil || len(selectParam) > 0 || len(expandParam) > 0 || len(orderbyParam) > 0 {
			options = &armazureintegrationspaces.InfrastructureResourcesClientListBySpaceOptions{
				Top:         topParam,
				Skip:        skipParam,
		...
		server.PagerResponderInjectNextLinks(newListBySpacePager, req, func(page *armazureintegrationspaces.InfrastructureResourcesClientListBySpaceResponse, createLink func() string) {
...
func (i *InfrastructureResourcesServerTransport) dispatchPatch(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[armazureintegrationspaces.InfrastructureResourceUpdate](req)
	if err != nil {
		return nil, err
	}
	resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
