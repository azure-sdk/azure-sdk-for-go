...
func (l LotProperties) MarshalJSON() ([]byte, error) {
	...
	populateAny(objectMap, "extendedProperties", l.ExtendedProperties)
	populate(objectMap, "isEstimatedBalance", l.IsEstimatedBalance)
	populate(objectMap, "lotSource", l.LotSource)
	populate(objectMap, "lotType", l.LotType)
...
func (l *LotProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "isEstimatedBalance":
			...
			delete(rawMsg, key)
		case "lotSource":
			err = unpopulate(val, "LotSource", &l.LotSource)
			delete(rawMsg, key)
		case "lotType":
			err = unpopulate(val, "LotType", &l.LotType)
			delete(rawMsg, key)
