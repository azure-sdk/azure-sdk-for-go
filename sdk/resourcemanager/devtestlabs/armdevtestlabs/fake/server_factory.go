...
type ServerFactory struct {
	// ArmTemplatesServer contains the fakes for client ArmTemplatesClient
	ArmTemplatesServer ArmTemplatesServer

	// ArtifactSourcesServer contains the fakes for client ArtifactSourcesClient
	ArtifactSourcesServer ArtifactSourcesServer

	// ArtifactsServer contains the fakes for client ArtifactsClient
	ArtifactsServer ArtifactsServer

	// CostsServer contains the fakes for client CostsClient
	CostsServer CostsServer

	// CustomImagesServer contains the fakes for client CustomImagesClient
	...
	// FormulasServer contains the fakes for client FormulasClient
	...
	// GlobalSchedulesServer contains the fakes for client GlobalSchedulesClient
	GlobalSchedulesServer GlobalSchedulesServer

	// LabsServer contains the fakes for client LabsClient
	LabsServer LabsServer

	// NotificationChannelsServer contains the fakes for client NotificationChannelsClient
	...
	// PolicySetsServer contains the fakes for client PolicySetsClient
	PolicySetsServer PolicySetsServer

	// ProviderOperationsServer contains the fakes for client ProviderOperationsClient
	...
	// ServiceFabricSchedulesServer contains the fakes for client ServiceFabricSchedulesClient
	ServiceFabricSchedulesServer ServiceFabricSchedulesServer

	// ServiceFabricsServer contains the fakes for client ServiceFabricsClient
	ServiceFabricsServer ServiceFabricsServer

	// ServiceRunnersServer contains the fakes for client ServiceRunnersClient
	ServiceRunnersServer ServiceRunnersServer

	// UsersServer contains the fakes for client UsersClient
	UsersServer UsersServer

	// VirtualMachineSchedulesServer contains the fakes for client VirtualMachineSchedulesClient
