	...
	go func() {
		...
		if !intercepted {
			...
			case "DevicesClient.AuthorizeForServiceEncryptionKeyRollover":
				res.resp, res.err = d.dispatchAuthorizeForServiceEncryptionKeyRollover(req)
			case "DevicesClient.BeginConfigure":
				res.resp, res.err = d.dispatchBeginConfigure(req)
			case "DevicesClient.BeginDeactivate":
				res.resp, res.err = d.dispatchBeginDeactivate(req)
			...
			case "DevicesClient.NewListByManagerPager":
				res.resp, res.err = d.dispatchNewListByManagerPager(req)
			case "DevicesClient.NewListFailoverSetsPager":
				res.resp, res.err = d.dispatchNewListFailoverSetsPager(req)
			case "DevicesClient.NewListFailoverTargetsPager":
				res.resp, res.err = d.dispatchNewListFailoverTargetsPager(req)
			case "DevicesClient.NewListMetricDefinitionPager":
				res.resp, res.err = d.dispatchNewListMetricDefinitionPager(req)
