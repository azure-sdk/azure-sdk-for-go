...
type IntegrationAccountCertificatesServer struct {
	...
	CreateOrUpdate func(ctx context.Context, resourceGroupName string, integrationAccountName string, certificateName string, resource armlogic.IntegrationAccountCertificate, options *armlogic.IntegrationAccountCertificatesClientCreateOrUpdateOptions) (resp azfake.Responder[armlogic.IntegrationAccountCertificatesClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)
