...
// AutomaticExpansionPolicy - The configuration parameters used by Automatic AZ Balancing for expanding the scale set to a
// target zonal instance count.
type AutomaticExpansionPolicy struct {
	// Specifies the minimum number of zonal VMs that will be gradually provisioned to the scale set.
	MinTargetZonalInstanceCount *int32
}
...
type AutomaticZoneRebalancingPolicy struct {
	// Optional property used for performing automatic expansion. If defined, the scale set will grow to minTargetZonalInstanceCount.
	// Until then, automatic rebalancing will not take effect.
