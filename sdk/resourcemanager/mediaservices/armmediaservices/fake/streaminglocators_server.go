...
func (s *StreamingLocatorsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if streamingLocatorsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = streamingLocatorsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "StreamingLocatorsClient.ListContentKeys":
				res.resp, res.err = s.dispatchListContentKeys(req)
			case "StreamingLocatorsClient.ListPaths":
				res.resp, res.err = s.dispatchListPaths(req)
			default:
...
// set this to conditionally intercept incoming requests to StreamingLocatorsServerTransport
var streamingLocatorsServerTransportInterceptor interface {
