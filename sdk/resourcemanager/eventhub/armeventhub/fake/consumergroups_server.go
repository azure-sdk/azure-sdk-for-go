...
func (c *ConsumerGroupsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if consumerGroupsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = consumerGroupsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "ConsumerGroupsClient.NewListByEventHubPager":
				res.resp, res.err = c.dispatchNewListByEventHubPager(req)
			default:
...
// set this to conditionally intercept incoming requests to ConsumerGroupsServerTransport
var consumerGroupsServerTransportInterceptor interface {
