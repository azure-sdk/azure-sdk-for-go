...
type AddonsServer struct {
	...
	// HTTP status codes to indicate success: http.StatusOK
	NewListByPrivateCloudPager func(resourceGroupName string, privateCloudName string, options *armavs.AddonsClientListByPrivateCloudOptions) (resp azfake.PagerResponder[armavs.AddonsClientListByPrivateCloudResponse])
}
