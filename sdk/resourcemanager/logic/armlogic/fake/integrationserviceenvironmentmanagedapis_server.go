...
type IntegrationServiceEnvironmentManagedApisServer struct {
	...
	BeginDelete func(ctx context.Context, integrationServiceEnvironmentName string, apiName string, options *armlogic.IntegrationServiceEnvironmentManagedApisClientBeginDeleteOptions) (resp azfake.PollerResponder[armlogic.IntegrationServiceEnvironmentManagedApisClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method IntegrationServiceEnvironmentManagedApisClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, integrationServiceEnvironmentName string, apiName string, options *armlogic.IntegrationServiceEnvironmentManagedApisClientGetOptions) (resp azfake.Responder[armlogic.IntegrationServiceEnvironmentManagedApisClientGetResponse], errResp azfake.ErrorResponder)

	// NewListPager is the fake for method IntegrationServiceEnvironmentManagedApisClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(integrationServiceEnvironmentName string, options *armlogic.IntegrationServiceEnvironmentManagedApisClientListOptions) (resp azfake.PagerResponder[armlogic.IntegrationServiceEnvironmentManagedApisClientListResponse])

	// BeginPut is the fake for method IntegrationServiceEnvironmentManagedApisClient.BeginPut
	// HTTP status codes to indicate success: http.StatusOK, http.StatusCreated
	BeginPut func(ctx context.Context, integrationServiceEnvironmentName string, apiName string, resource armlogic.IntegrationServiceEnvironmentManagedAPI, options *armlogic.IntegrationServiceEnvironmentManagedApisClientBeginPutOptions) (resp azfake.PollerResponder[armlogic.IntegrationServiceEnvironmentManagedApisClientPutResponse], errResp azfake.ErrorResponder)
}
...
func (i *IntegrationServiceEnvironmentManagedApisServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if integrationServiceEnvironmentManagedApisServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = integrationServiceEnvironmentManagedApisServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "IntegrationServiceEnvironmentManagedApisClient.BeginPut":
				res.resp, res.err = i.dispatchBeginPut(req)
			default:
...
func (i *IntegrationServiceEnvironmentManagedApisServerTransport) dispatchBeginDelete(req *http.Request) (*http.Response, error) {
	...
	if beginDelete == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.Logic/integrationServiceEnvironments/(?P<integrationServiceEnvironmentName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/managedApis/(?P<apiName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)`
		...
		respr, errRespr := i.srv.BeginDelete(req.Context(), integrationServiceEnvironmentNameParam, apiNameParam, nil)
...
func (i *IntegrationServiceEnvironmentManagedApisServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := i.srv.Get(req.Context(), integrationServiceEnvironmentNameParam, apiNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
...
func (i *IntegrationServiceEnvironmentManagedApisServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.Logic/integrationServiceEnvironments/(?P<integrationServiceEnvironmentName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/managedApis`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
...
func (i *IntegrationServiceEnvironmentManagedApisServerTransport) dispatchBeginPut(req *http.Request) (*http.Response, error) {
	...
	if beginPut == nil {
		...
		respr, errRespr := i.srv.BeginPut(req.Context(), integrationServiceEnvironmentNameParam, apiNameParam, body, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginPut = &respr
...
// set this to conditionally intercept incoming requests to IntegrationServiceEnvironmentManagedApisServerTransport
var integrationServiceEnvironmentManagedApisServerTransportInterceptor interface {
