...
func (client *SpringbootappsClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, siteName string, springbootappsName string, springbootapps SpringbootappsModel, _ *SpringbootappsClientBeginCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *SpringbootappsClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, siteName string, springbootappsName string, _ *SpringbootappsClientBeginDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OffAzureSpringBoot/springbootsites/{siteName}/springbootapps/{springbootappsName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *SpringbootappsClient) getCreateRequest(ctx context.Context, resourceGroupName string, siteName string, springbootappsName string, _ *SpringbootappsClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OffAzureSpringBoot/springbootsites/{siteName}/springbootapps/{springbootappsName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *SpringbootappsClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, siteName string, _ *SpringbootappsClientListByResourceGroupOptions) (*policy.Request, error) {
...
func (client *SpringbootappsClient) listBySubscriptionCreateRequest(ctx context.Context, siteName string, _ *SpringbootappsClientListBySubscriptionOptions) (*policy.Request, error) {
...
func (client *SpringbootappsClient) updateCreateRequest(ctx context.Context, resourceGroupName string, siteName string, springbootappsName string, springbootapps SpringbootappsPatch, _ *SpringbootappsClientUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OffAzureSpringBoot/springbootsites/{siteName}/springbootapps/{springbootappsName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
