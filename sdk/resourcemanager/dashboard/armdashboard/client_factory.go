...
func (c *ClientFactory) NewEnterpriseDetailsClient() *EnterpriseDetailsClient {
	subClient, _ := NewEnterpriseDetailsClient(c.subscriptionID, c.credential, c.options)
	return subClient
}

func (c *ClientFactory) NewGrafanaClient() *GrafanaClient {
	subClient, _ := NewGrafanaClient(c.subscriptionID, c.credential, c.options)
	return subClient
}
