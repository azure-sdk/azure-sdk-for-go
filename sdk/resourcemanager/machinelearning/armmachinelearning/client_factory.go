...
func (c *ClientFactory) NewEndpointDeploymentClient() *EndpointDeploymentClient {
	subClient, _ := NewEndpointDeploymentClient(c.subscriptionID, c.credential, c.options)
	return subClient
}
...
func (c *ClientFactory) NewMarketplaceSubscriptionsClient() *MarketplaceSubscriptionsClient {
	subClient, _ := NewMarketplaceSubscriptionsClient(c.subscriptionID, c.credential, c.options)
	return subClient
}
