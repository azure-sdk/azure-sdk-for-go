...
// MarshalJSON implements the json.Marshaller interface for type AzureAiServicesConfiguration.
func (a AzureAiServicesConfiguration) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "azureAiServicesEnableStatus", a.AzureAiServicesEnableStatus)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type AzureAiServicesConfiguration.
func (a *AzureAiServicesConfiguration) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", a, err)
	}
	for key, val := range rawMsg {
		var err error
		switch key {
		case "azureAiServicesEnableStatus":
			err = unpopulate(val, "AzureAiServicesEnableStatus", &a.AzureAiServicesEnableStatus)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", a, err)
...
// MarshalJSON implements the json.Marshaller interface for type CatalogImageDefinition.
func (c CatalogImageDefinition) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "id", c.ID)
	populate(objectMap, "name", c.Name)
	populate(objectMap, "properties", c.Properties)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type CatalogImageDefinition.
func (c *CatalogImageDefinition) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type CatalogImageDefinitionMetadataProperties.
func (c CatalogImageDefinitionMetadataProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "activeImageReference", c.ActiveImageReference)
	populate(objectMap, "autoImageBuild", c.AutoImageBuild)
	populate(objectMap, "fileUrl", c.FileURL)
	populate(objectMap, "imageReference", c.ImageReference)
	populate(objectMap, "imageValidationErrorDetails", c.ImageValidationErrorDetails)
	populate(objectMap, "imageValidationStatus", c.ImageValidationStatus)
	populate(objectMap, "latestBuild", c.LatestBuild)
	populate(objectMap, "validationStatus", c.ValidationStatus)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type CatalogImageDefinitionMetadataProperties.
func (c *CatalogImageDefinitionMetadataProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
	for key, val := range rawMsg {
		...
		case "activeImageReference":
			err = unpopulate(val, "ActiveImageReference", &c.ActiveImageReference)
			delete(rawMsg, key)
		case "autoImageBuild":
			err = unpopulate(val, "AutoImageBuild", &c.AutoImageBuild)
			delete(rawMsg, key)
		case "fileUrl":
			err = unpopulate(val, "FileURL", &c.FileURL)
			delete(rawMsg, key)
		case "imageReference":
			err = unpopulate(val, "ImageReference", &c.ImageReference)
			delete(rawMsg, key)
		case "imageValidationErrorDetails":
			err = unpopulate(val, "ImageValidationErrorDetails", &c.ImageValidationErrorDetails)
			delete(rawMsg, key)
		case "imageValidationStatus":
			err = unpopulate(val, "ImageValidationStatus", &c.ImageValidationStatus)
			delete(rawMsg, key)
		case "latestBuild":
			err = unpopulate(val, "LatestBuild", &c.LatestBuild)
			delete(rawMsg, key)
...
// MarshalJSON implements the json.Marshaller interface for type CatalogImageDefinitionProperties.
func (c CatalogImageDefinitionProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "activeImageReference", c.ActiveImageReference)
	populate(objectMap, "autoImageBuild", c.AutoImageBuild)
	populate(objectMap, "extends", c.Extends)
	populate(objectMap, "fileUrl", c.FileURL)
	populate(objectMap, "imageReference", c.ImageReference)
	populate(objectMap, "imageValidationErrorDetails", c.ImageValidationErrorDetails)
	populate(objectMap, "imageValidationStatus", c.ImageValidationStatus)
	...
	populate(objectMap, "userTasks", c.UserTasks)
	populate(objectMap, "validationStatus", c.ValidationStatus)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type CatalogImageDefinitionProperties.
func (c *CatalogImageDefinitionProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
	for key, val := range rawMsg {
		...
		case "autoImageBuild":
			...
			delete(rawMsg, key)
		case "extends":
			err = unpopulate(val, "Extends", &c.Extends)
			delete(rawMsg, key)
		case "fileUrl":
			err = unpopulate(val, "FileURL", &c.FileURL)
			delete(rawMsg, key)
		...
		case "tasks":
			...
			delete(rawMsg, key)
		case "userTasks":
			err = unpopulate(val, "UserTasks", &c.UserTasks)
			delete(rawMsg, key)
		case "validationStatus":
			err = unpopulate(val, "ValidationStatus", &c.ValidationStatus)
			delete(rawMsg, key)
...
func (c ConfigurationPolicies) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "azureAiServicesConfiguration", c.AzureAiServicesConfiguration)
	populate(objectMap, "devBoxAutoDeleteConfiguration", c.DevBoxAutoDeleteConfiguration)
	populate(objectMap, "devBoxTunnelEnableStatus", c.DevBoxTunnelEnableStatus)
	populate(objectMap, "userCustomizationsEnableStatus", c.UserCustomizationsEnableStatus)
	return json.Marshal(objectMap)
}
...
func (c *ConfigurationPolicies) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		var err error
		switch key {
		case "azureAiServicesConfiguration":
			err = unpopulate(val, "AzureAiServicesConfiguration", &c.AzureAiServicesConfiguration)
			delete(rawMsg, key)
		case "devBoxAutoDeleteConfiguration":
			err = unpopulate(val, "DevBoxAutoDeleteConfiguration", &c.DevBoxAutoDeleteConfiguration)
			delete(rawMsg, key)
		case "devBoxTunnelEnableStatus":
			err = unpopulate(val, "DevBoxTunnelEnableStatus", &c.DevBoxTunnelEnableStatus)
			delete(rawMsg, key)
		case "userCustomizationsEnableStatus":
			err = unpopulate(val, "UserCustomizationsEnableStatus", &c.UserCustomizationsEnableStatus)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", c, err)
...
// MarshalJSON implements the json.Marshaller interface for type DevBoxAutoDeleteConfiguration.
func (d DevBoxAutoDeleteConfiguration) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "enableStatus", d.EnableStatus)
	populate(objectMap, "gracePeriod", d.GracePeriod)
	populate(objectMap, "inactiveThreshold", d.InactiveThreshold)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type DevBoxAutoDeleteConfiguration.
func (d *DevBoxAutoDeleteConfiguration) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "enableStatus":
			err = unpopulate(val, "EnableStatus", &d.EnableStatus)
			delete(rawMsg, key)
		case "gracePeriod":
