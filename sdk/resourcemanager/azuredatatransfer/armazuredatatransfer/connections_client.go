...
//   - resource - Connection body
//   - options - ConnectionsClientCreateOrUpdateOptions contains the optional parameters for the ConnectionsClient.CreateOrUpdate
//     method.
func (client *ConnectionsClient) CreateOrUpdate(ctx context.Context, resourceGroupName string, connectionName string, resource Connection, options *ConnectionsClientCreateOrUpdateOptions) (ConnectionsClientCreateOrUpdateResponse, error) {
	var err error
	const operationName = "ConnectionsClient.CreateOrUpdate"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.createOrUpdateCreateRequest(ctx, resourceGroupName, connectionName, resource, options)
	if err != nil {
...
func (client *ConnectionsClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, connectionName string, resource Connection, _ *ConnectionsClientCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *ConnectionsClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, connectionName string, _ *ConnectionsClientBeginDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureDataTransfer/connections/{connectionName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *ConnectionsClient) getCreateRequest(ctx context.Context, resourceGroupName string, connectionName string, _ *ConnectionsClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureDataTransfer/connections/{connectionName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *ConnectionsClient) BeginLink(ctx context.Context, resourceGroupName string, connectionName string, body ResourceBody, options *ConnectionsClientBeginLinkOptions) (*runtime.Poller[ConnectionsClientLinkResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.link(ctx, resourceGroupName, connectionName, body, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2025-04-11-preview
func (client *ConnectionsClient) link(ctx context.Context, resourceGroupName string, connectionName string, body ResourceBody, options *ConnectionsClientBeginLinkOptions) (*http.Response, error) {
	var err error
	const operationName = "ConnectionsClient.BeginLink"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.linkCreateRequest(ctx, resourceGroupName, connectionName, body, options)
	if err != nil {
		return nil, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
...
func (client *ConnectionsClient) linkCreateRequest(ctx context.Context, resourceGroupName string, connectionName string, body ResourceBody, _ *ConnectionsClientBeginLinkOptions) (*policy.Request, error) {
...
func (client *ConnectionsClient) NewListPager(resourceGroupName string, connectionName string, options *ConnectionsClientListOptions) *runtime.Pager[ConnectionsClientListResponse] {
...
func (client *ConnectionsClient) listCreateRequest(ctx context.Context, resourceGroupName string, connectionName string, _ *ConnectionsClientListOptions) (*policy.Request, error) {
...
func (client *ConnectionsClient) listHandleResponse(resp *http.Response) (ConnectionsClientListResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.PendingConnectionListResult); err != nil {
		return ConnectionsClientListResponse{}, err
	}
	return result, nil
}
...
func (client *ConnectionsClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, _ *ConnectionsClientListByResourceGroupOptions) (*policy.Request, error) {
...
func (client *ConnectionsClient) listBySubscriptionCreateRequest(ctx context.Context, _ *ConnectionsClientListBySubscriptionOptions) (*policy.Request, error) {
...
// NewListPendingFlowsListPager - Lists all pending flows for a connection.
//
// Generated from API version 2025-04-11-preview
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - connectionName - The name for the connection that is to be requested.
//   - options - ConnectionsClientListPendingFlowsListOptions contains the optional parameters for the ConnectionsClient.NewListPendingFlowsListPager
//     method.
func (client *ConnectionsClient) NewListPendingFlowsListPager(resourceGroupName string, connectionName string, options *ConnectionsClientListPendingFlowsListOptions) *runtime.Pager[ConnectionsClientListPendingFlowsListResponse] {
	return runtime.NewPager(runtime.PagingHandler[ConnectionsClientListPendingFlowsListResponse]{
		More: func(page ConnectionsClientListPendingFlowsListResponse) bool {
			return page.NextLink != nil && len(*page.NextLink) > 0
		},
		Fetcher: func(ctx context.Context, page *ConnectionsClientListPendingFlowsListResponse) (ConnectionsClientListPendingFlowsListResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "ConnectionsClient.NewListPendingFlowsListPager")
			nextLink := ""
			if page != nil {
				nextLink = *page.NextLink
			}
			resp, err := runtime.FetcherForNextLink(ctx, client.internal.Pipeline(), nextLink, func(ctx context.Context) (*policy.Request, error) {
				return client.listPendingFlowsListCreateRequest(ctx, resourceGroupName, connectionName, options)
			}, nil)
			if err != nil {
				return ConnectionsClientListPendingFlowsListResponse{}, err
			}
			return client.listPendingFlowsListHandleResponse(resp)
		},
		Tracer: client.internal.Tracer(),
	})
}

// listPendingFlowsListCreateRequest creates the ListPendingFlowsList request.
func (client *ConnectionsClient) listPendingFlowsListCreateRequest(ctx context.Context, resourceGroupName string, connectionName string, _ *ConnectionsClientListPendingFlowsListOptions) (*policy.Request, error) {
...
// listPendingFlowsListHandleResponse handles the ListPendingFlowsList response.
func (client *ConnectionsClient) listPendingFlowsListHandleResponse(resp *http.Response) (ConnectionsClientListPendingFlowsListResponse, error) {
	result := ConnectionsClientListPendingFlowsListResponse{}
	if err := runtime.UnmarshalAsJSON(resp, &result.PendingFlowListResult); err != nil {
		return ConnectionsClientListPendingFlowsListResponse{}, err
	}
	return result, nil
}
...
func (client *ConnectionsClient) BeginUpdate(ctx context.Context, resourceGroupName string, connectionName string, properties ConnectionsPatch, options *ConnectionsClientBeginUpdateOptions) (*runtime.Poller[ConnectionsClientUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.update(ctx, resourceGroupName, connectionName, properties, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2025-04-11-preview
func (client *ConnectionsClient) update(ctx context.Context, resourceGroupName string, connectionName string, properties ConnectionsPatch, options *ConnectionsClientBeginUpdateOptions) (*http.Response, error) {
	var err error
	const operationName = "ConnectionsClient.BeginUpdate"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.updateCreateRequest(ctx, resourceGroupName, connectionName, properties, options)
	if err != nil {
		return nil, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
...
func (client *ConnectionsClient) updateCreateRequest(ctx context.Context, resourceGroupName string, connectionName string, properties ConnectionsPatch, _ *ConnectionsClientBeginUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureDataTransfer/connections/{connectionName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
