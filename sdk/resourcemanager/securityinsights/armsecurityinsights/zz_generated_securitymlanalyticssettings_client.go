...
// method.
func (client *SecurityMLAnalyticsSettingsClient) List(resourceGroupName string, workspaceName string, options *SecurityMLAnalyticsSettingsClientListOptions) *runtime.Pager[SecurityMLAnalyticsSettingsClientListResponse] {
	return runtime.NewPager(runtime.PageProcessor[SecurityMLAnalyticsSettingsClientListResponse]{
