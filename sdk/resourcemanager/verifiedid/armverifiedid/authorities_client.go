...
// AuthoritiesClient contains the methods for the Microsoft.VerifiedId namespace.
...
func (client *AuthoritiesClient) updateCreateRequest(ctx context.Context, resourceGroupName string, authorityName string, properties AuthorityUpdate, _ *AuthoritiesClientUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.VerifiedId/authorities/{authorityName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
