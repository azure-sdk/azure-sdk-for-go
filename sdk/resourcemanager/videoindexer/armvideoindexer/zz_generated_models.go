...
// AccountForGet - An Azure Video Indexer account.
type AccountForGet struct {
	...
	Properties *AccountPropertiesForGetRequest `json:"properties,omitempty"`
...
// AccountForPut - An Azure Video Indexer account.
type AccountForPut struct {
	// REQUIRED; The geo-location where the resource lives
	Location *string `json:"location,omitempty"`
...
type AccountList struct {
	...
	Value []*AccountForGet `json:"value,omitempty" azure:"ro"`
}
...
// AccountPropertiesForGetRequest - Azure Video Indexer account properties
type AccountPropertiesForGetRequest struct {
