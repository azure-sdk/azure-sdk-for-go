...
// AzureArcVMwareManagementServiceAPIClientUpgradeExtensionsResponse contains the response from method AzureArcVMwareManagementServiceAPIClient.BeginUpgradeExtensions.
