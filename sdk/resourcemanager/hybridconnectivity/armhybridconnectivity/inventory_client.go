...
func (client *InventoryClient) getCreateRequest(ctx context.Context, resourceURI string, solutionConfiguration string, inventoryID string, options *InventoryClientGetOptions) (*policy.Request, error) {
...
// NewListByWidgetPager - List InventoryResource resources by SolutionConfiguration
//
// Generated from API version 2024-12-01
//   - resourceURI - The fully qualified Azure Resource manager identifier of the resource.
//   - solutionConfiguration - Represent Solution Configuration Resource.
//   - options - InventoryClientListByWidgetOptions contains the optional parameters for the InventoryClient.NewListByWidgetPager
//     method.
func (client *InventoryClient) NewListByWidgetPager(resourceURI string, solutionConfiguration string, options *InventoryClientListByWidgetOptions) *runtime.Pager[InventoryClientListByWidgetResponse] {
	return runtime.NewPager(runtime.PagingHandler[InventoryClientListByWidgetResponse]{
		More: func(page InventoryClientListByWidgetResponse) bool {
			return page.NextLink != nil && len(*page.NextLink) > 0
		},
		Fetcher: func(ctx context.Context, page *InventoryClientListByWidgetResponse) (InventoryClientListByWidgetResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "InventoryClient.NewListByWidgetPager")
			nextLink := ""
			if page != nil {
				nextLink = *page.NextLink
			}
			resp, err := runtime.FetcherForNextLink(ctx, client.internal.Pipeline(), nextLink, func(ctx context.Context) (*policy.Request, error) {
				return client.listByWidgetCreateRequest(ctx, resourceURI, solutionConfiguration, options)
			}, nil)
			if err != nil {
				return InventoryClientListByWidgetResponse{}, err
			}
			return client.listByWidgetHandleResponse(resp)
		},
		Tracer: client.internal.Tracer(),
	})
}

// listByWidgetCreateRequest creates the ListByWidget request.
func (client *InventoryClient) listByWidgetCreateRequest(ctx context.Context, resourceURI string, solutionConfiguration string, options *InventoryClientListByWidgetOptions) (*policy.Request, error) {
...
// listByWidgetHandleResponse handles the ListByWidget response.
func (client *InventoryClient) listByWidgetHandleResponse(resp *http.Response) (InventoryClientListByWidgetResponse, error) {
	result := InventoryClientListByWidgetResponse{}
