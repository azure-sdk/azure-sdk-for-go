...
func (c Certificate) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "revocations", c.Revocations)
...
func (c *Certificate) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "expiryDate":
			...
			delete(rawMsg, key)
		case "revocations":
			err = unpopulate(val, "Revocations", &c.Revocations)
			delete(rawMsg, key)
		case "serialNumber":
...
// MarshalJSON implements the json.Marshaller interface for type CertificateProfilePatch.
func (c CertificateProfilePatch) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "properties", c.Properties)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type CertificateProfilePatch.
func (c *CertificateProfilePatch) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type CertificateProfilePatchProperties.
func (c CertificateProfilePatchProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "certificates", c.Certificates)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type CertificateProfilePatchProperties.
func (c *CertificateProfilePatchProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type CertificateProfiles.
func (c CertificateProfiles) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type CertificateProfiles.
func (c *CertificateProfiles) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
...
func (r Revocation) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "requestedAt", r.RequestedAt)
	populate(objectMap, "revokedAt", r.RevokedAt)
	return json.Marshal(objectMap)
}
...
func (r *Revocation) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "remarks":
			...
			delete(rawMsg, key)
		case "requestedAt":
			err = unpopulate(val, "RequestedAt", &r.RequestedAt)
			delete(rawMsg, key)
		case "revokedAt":
			err = unpopulate(val, "RevokedAt", &r.RevokedAt)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", r, err)
