...
- New field `AppInsightsConfiguration`, `AvailabilityZones`, `IngressConfiguration`, `OpenTelemetryConfiguration`, `PrivateEndpointConnections`, `PrivateLinkDefaultDomain`, `PublicNetworkAccess` in struct `ManagedEnvironmentProperties`
