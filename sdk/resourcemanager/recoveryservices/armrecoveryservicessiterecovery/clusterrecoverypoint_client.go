...
func (client *ClusterRecoveryPointClient) getCreateRequest(ctx context.Context, resourceGroupName string, resourceName string, fabricName string, protectionContainerName string, replicationProtectionClusterName string, recoveryPointName string, options *ClusterRecoveryPointClientGetOptions) (*policy.Request, error) {
