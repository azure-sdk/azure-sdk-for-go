...
func (client PipelinesClient) ListByWorkspace(ctx context.Context, resourceGroupName string, workspaceName string, skipToken string, filter string, orderby string) (result PipelineListPage, err error) {
	if tracing.IsEnabled() {
...
func (client PipelinesClient) ListByWorkspacePreparer(ctx context.Context, resourceGroupName string, workspaceName string, skipToken string, filter string, orderby string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"subscriptionId":    autorest.Encode("path", client.SubscriptionID),
		"workspaceName":     autorest.Encode("path", workspaceName),
...
func (client PipelinesClient) ListByWorkspaceComplete(ctx context.Context, resourceGroupName string, workspaceName string, skipToken string, filter string, orderby string) (result PipelineListIterator, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/PipelinesClient.ListByWorkspace")
		defer func() {
			sc := -1
...
// workspaceName - the name of the workspace.
// pipelineName - the name of the pipeline.
// pipelineRunParameters - the parameters for running the pipeline
func (client PipelinesClient) Run(ctx context.Context, resourceGroupName string, workspaceName string, pipelineName string, pipelineRunParameters PipelineRunParameters) (result PipelinesRunFuture, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.RunPreparer(ctx, resourceGroupName, workspaceName, pipelineName, pipelineRunParameters)
	if err != nil {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "datacollaboration.PipelinesClient", "Run", result.Response(), "Failure sending request")
		return
	}
...
func (client PipelinesClient) RunPreparer(ctx context.Context, resourceGroupName string, workspaceName string, pipelineName string, pipelineRunParameters PipelineRunParameters) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"pipelineName":      autorest.Encode("path", pipelineName),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"subscriptionId":    autorest.Encode("path", client.SubscriptionID),
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithJSON(pipelineRunParameters),
		autorest.WithQueryParameters(queryParameters))
	return preparer.Prepare((&http.Request{}).WithContext(ctx))
}
...
// http.Response Body if it receives an error.
func (client PipelinesClient) RunSender(req *http.Request) (future PipelinesRunFuture, err error) {
	var resp *http.Response
	future.FutureAPI = &azure.Future{}
	resp, err = client.Send(req, azure.DoRetryWithRegistration(client.Client))
	if err != nil {
