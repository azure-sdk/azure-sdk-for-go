...
type SnapshotServer struct {
	...
	// NewListByReportResourcePager is the fake for method SnapshotClient.NewListByReportResourcePager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByReportResourcePager func(reportName string, options *armappcomplianceautomation.SnapshotClientListByReportResourceOptions) (resp azfake.PagerResponder[armappcomplianceautomation.SnapshotClientListByReportResourceResponse])
}
...
func NewSnapshotServerTransport(srv *SnapshotServer) *SnapshotServerTransport {
	return &SnapshotServerTransport{
		...
		newListByReportResourcePager: newTracker[azfake.PagerResponder[armappcomplianceautomation.SnapshotClientListByReportResourceResponse]](),
	}
}
...
type SnapshotServerTransport struct {
	...
	newListByReportResourcePager *tracker[azfake.PagerResponder[armappcomplianceautomation.SnapshotClientListByReportResourceResponse]]
}
...
func (s *SnapshotServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	case "SnapshotClient.NewListByReportResourcePager":
...
func (s *SnapshotServerTransport) dispatchNewListByReportResourcePager(req *http.Request) (*http.Response, error) {
	...
	if newListByReportResourcePager == nil {
		...
		var options *armappcomplianceautomation.SnapshotClientListByReportResourceOptions
		if skipTokenParam != nil || topParam != nil || selectParamParam != nil || filterParam != nil || orderbyParam != nil || offerGUIDParam != nil || reportCreatorTenantIDParam != nil {
			options = &armappcomplianceautomation.SnapshotClientListByReportResourceOptions{
		...
		server.PagerResponderInjectNextLinks(newListByReportResourcePager, req, func(page *armappcomplianceautomation.SnapshotClientListByReportResourceResponse, createLink func() string) {
