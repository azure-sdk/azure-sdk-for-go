...
type ResourceReferenceServer struct {
	...
	GetByTargetResources func(ctx context.Context, body armdns.ResourceReferenceRequest, options *armdns.ResourceReferenceClientGetByTargetResourcesOptions) (resp azfake.Responder[armdns.ResourceReferenceClientGetByTargetResourcesResponse], errResp azfake.ErrorResponder)
}
