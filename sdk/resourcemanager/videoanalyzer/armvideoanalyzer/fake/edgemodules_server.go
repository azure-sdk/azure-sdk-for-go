...
func (e *EdgeModulesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if edgeModulesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = edgeModulesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "EdgeModulesClient.ListProvisioningToken":
				res.resp, res.err = e.dispatchListProvisioningToken(req)
			default:
...
// set this to conditionally intercept incoming requests to EdgeModulesServerTransport
var edgeModulesServerTransportInterceptor interface {
