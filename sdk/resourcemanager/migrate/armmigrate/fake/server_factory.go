...
type ServerFactory struct {
	...
	// SQLImportJobsControllerServer contains the fakes for client SQLImportJobsControllerClient
	SQLImportJobsControllerServer SQLImportJobsControllerServer
...
type ServerFactoryTransport struct {
	...
	trSQLImportJobsControllerServer                  *SQLImportJobsControllerServerTransport
...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "SQLImportJobsControllerClient":
		initServer(s, &s.trSQLImportJobsControllerServer, func() *SQLImportJobsControllerServerTransport {
			return NewSQLImportJobsControllerServerTransport(&s.srv.SQLImportJobsControllerServer)
		})
		resp, err = s.trSQLImportJobsControllerServer.Do(req)
