...
func (u *UeInformationServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if ueInformationServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = ueInformationServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to UeInformationServerTransport
var ueInformationServerTransportInterceptor interface {
