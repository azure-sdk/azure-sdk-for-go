...
// EAPriceSheetProperties - The properties of the EA price sheet. Properties added with version 2023-11-01 are marked with
// *
type EAPriceSheetProperties struct {
	...
	// it is after sign-on. May appear as null or 0 where not applicable. Base price is
	// unavailable for ReservedInstance meters.
	BasePrice *string
	...
	// READ-ONLY; How usage is measured for the service. [1] The field “Unit” has been removed with version 2023-11-01 as a duplicate
	// of “UnitofMeasure”, please use the field “UnitOfMeasure”.
...
type EAPricesheetDownloadProperties struct {
	...
	// READ-ONLY; Download link validity. The URI is available for use for 1 hour.
	ValidTill *time.Time
}
