...
func (client *ProfilesClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, hubName string, profileName string, parameters ProfileResourceFormat, _ *ProfilesClientBeginCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *ProfilesClient) getEnrichingKpisCreateRequest(ctx context.Context, resourceGroupName string, hubName string, profileName string, _ *ProfilesClientGetEnrichingKpisOptions) (*policy.Request, error) {
