...
func (client *AssociationsClient) createOrUpdateCreateRequest(ctx context.Context, scope string, associationName string, association Association, _ *AssociationsClientBeginCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *AssociationsClient) deleteCreateRequest(ctx context.Context, scope string, associationName string, _ *AssociationsClientBeginDeleteOptions) (*policy.Request, error) {
	urlPath := "/{scope}/providers/Microsoft.CustomProviders/associations/{associationName}"
	urlPath = strings.ReplaceAll(urlPath, "{scope}", scope)
	if associationName == "" {
		return nil, errors.New("parameter associationName cannot be empty")
...
func (client *AssociationsClient) getCreateRequest(ctx context.Context, scope string, associationName string, _ *AssociationsClientGetOptions) (*policy.Request, error) {
	urlPath := "/{scope}/providers/Microsoft.CustomProviders/associations/{associationName}"
	urlPath = strings.ReplaceAll(urlPath, "{scope}", scope)
	if associationName == "" {
		return nil, errors.New("parameter associationName cannot be empty")
...
func (client *AssociationsClient) listAllCreateRequest(ctx context.Context, scope string, _ *AssociationsClientListAllOptions) (*policy.Request, error) {
