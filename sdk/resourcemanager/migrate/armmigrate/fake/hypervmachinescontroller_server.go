...
// HypervMachinesControllerServer is a fake server for instances of the armmigrate.HypervMachinesControllerClient type.
type HypervMachinesControllerServer struct {
	// Get is the fake for method HypervMachinesControllerClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, siteName string, machineName string, options *armmigrate.HypervMachinesControllerClientGetOptions) (resp azfake.Responder[armmigrate.HypervMachinesControllerClientGetResponse], errResp azfake.ErrorResponder)

	// NewListByHypervSitePager is the fake for method HypervMachinesControllerClient.NewListByHypervSitePager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByHypervSitePager func(resourceGroupName string, siteName string, options *armmigrate.HypervMachinesControllerClientListByHypervSiteOptions) (resp azfake.PagerResponder[armmigrate.HypervMachinesControllerClientListByHypervSiteResponse])

	// Update is the fake for method HypervMachinesControllerClient.Update
	// HTTP status codes to indicate success: http.StatusOK
	Update func(ctx context.Context, resourceGroupName string, siteName string, machineName string, body armmigrate.HypervMachineUpdate, options *armmigrate.HypervMachinesControllerClientUpdateOptions) (resp azfake.Responder[armmigrate.HypervMachinesControllerClientUpdateResponse], errResp azfake.ErrorResponder)
...
// The returned HypervMachinesControllerServerTransport instance is connected to an instance of armmigrate.HypervMachinesControllerClient via the
...
func NewHypervMachinesControllerServerTransport(srv *HypervMachinesControllerServer) *HypervMachinesControllerServerTransport {
	return &HypervMachinesControllerServerTransport{
		srv:                      srv,
		newListByHypervSitePager: newTracker[azfake.PagerResponder[armmigrate.HypervMachinesControllerClientListByHypervSiteResponse]](),
		beginUpdateProperties:    newTracker[azfake.PollerResponder[armmigrate.HypervMachinesControllerClientUpdatePropertiesResponse]](),
	}
}

// HypervMachinesControllerServerTransport connects instances of armmigrate.HypervMachinesControllerClient to instances of HypervMachinesControllerServer.
...
type HypervMachinesControllerServerTransport struct {
	...
	newListByHypervSitePager *tracker[azfake.PagerResponder[armmigrate.HypervMachinesControllerClientListByHypervSiteResponse]]
	beginUpdateProperties    *tracker[azfake.PollerResponder[armmigrate.HypervMachinesControllerClientUpdatePropertiesResponse]]
}
...
func (h *HypervMachinesControllerServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if hypervMachinesControllerServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = hypervMachinesControllerServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "HypervMachinesControllerClient.BeginUpdateProperties":
				res.resp, res.err = h.dispatchBeginUpdateProperties(req)
			default:
...
func (h *HypervMachinesControllerServerTransport) dispatchNewListByHypervSitePager(req *http.Request) (*http.Response, error) {
	...
	if newListByHypervSitePager == nil {
		...
		var options *armmigrate.HypervMachinesControllerClientListByHypervSiteOptions
		...
		server.PagerResponderInjectNextLinks(newListByHypervSitePager, req, func(page *armmigrate.HypervMachinesControllerClientListByHypervSiteResponse, createLink func() string) {
...
func (h *HypervMachinesControllerServerTransport) dispatchUpdate(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[armmigrate.HypervMachineUpdate](req)
	if err != nil {
		return nil, err
	}
	resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
...
// set this to conditionally intercept incoming requests to HypervMachinesControllerServerTransport
var hypervMachinesControllerServerTransportInterceptor interface {
