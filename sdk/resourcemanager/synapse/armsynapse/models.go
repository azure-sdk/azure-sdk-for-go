...
type SKU struct {
	...
	// READ-ONLY; If the SKU supports scale out/in then the capacity integer should be included. If scale out/in is not possible
...
type ServerVulnerabilityAssessmentProperties struct {
	...
	StorageContainerPath any `json:"storageContainerPath,omitempty"`
...
type WorkspaceProperties struct {
	...
	AzureADOnlyAuthentication any `json:"azureADOnlyAuthentication,omitempty"`
