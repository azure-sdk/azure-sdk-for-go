...
// GroupsClientListBySQLVMGroupResponse contains the response from method GroupsClient.NewListBySQLVMGroupPager.
type GroupsClientListBySQLVMGroupResponse struct {
...
// SQLVirtualMachinesClientTroubleshootResponse contains the response from method SQLVirtualMachinesClient.BeginTroubleshoot.
type SQLVirtualMachinesClientTroubleshootResponse struct {
