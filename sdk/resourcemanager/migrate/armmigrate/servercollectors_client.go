...
// collectorBody - New or Updated Server collector.
...
func (client *ServerCollectorsClient) Create(ctx context.Context, resourceGroupName string, projectName string, serverCollectorName string, collectorBody ServerCollector, options *ServerCollectorsClientCreateOptions) (ServerCollectorsClientCreateResponse, error) {
	req, err := client.createCreateRequest(ctx, resourceGroupName, projectName, serverCollectorName, collectorBody, options)
	if err != nil {
...
func (client *ServerCollectorsClient) createCreateRequest(ctx context.Context, resourceGroupName string, projectName string, serverCollectorName string, collectorBody ServerCollector, options *ServerCollectorsClientCreateOptions) (*policy.Request, error) {
