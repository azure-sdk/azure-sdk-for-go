...
func (c *ClientFactory) NewSQLPoolsDatawareHouseQueriesClient() *SQLPoolsDatawareHouseQueriesClient {
	subClient, _ := NewSQLPoolsDatawareHouseQueriesClient(c.subscriptionID, c.credential, c.options)
	return subClient
}

func (c *ClientFactory) NewSQLPoolsDatawareHouseQueriesStepsClient() *SQLPoolsDatawareHouseQueriesStepsClient {
	subClient, _ := NewSQLPoolsDatawareHouseQueriesStepsClient(c.subscriptionID, c.credential, c.options)
	return subClient
}
...
func (c *ClientFactory) NewWorkspaceTrustedServiceByPassConfigurationClient() *WorkspaceTrustedServiceByPassConfigurationClient {
	subClient, _ := NewWorkspaceTrustedServiceByPassConfigurationClient(c.subscriptionID, c.credential, c.options)
	return subClient
}

func (c *ClientFactory) NewWorkspaceCheckDefaultStorageAccountStatusClient() *WorkspaceCheckDefaultStorageAccountStatusClient {
	subClient, _ := NewWorkspaceCheckDefaultStorageAccountStatusClient(c.subscriptionID, c.credential, c.options)
	return subClient
}

func (c *ClientFactory) NewScopePoolsListByWorkspaceClient() *ScopePoolsListByWorkspaceClient {
	subClient, _ := NewScopePoolsListByWorkspaceClient(c.subscriptionID, c.credential, c.options)
	return subClient
}
