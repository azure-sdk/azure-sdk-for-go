...
type ServerFactory struct {
	// BestPracticesServer contains the fakes for client BestPracticesClient
	BestPracticesServer BestPracticesServer

	// BestPracticesVersionsServer contains the fakes for client BestPracticesVersionsClient
	BestPracticesVersionsServer BestPracticesVersionsServer

	// ConfigurationProfileAssignmentsServer contains the fakes for client ConfigurationProfileAssignmentsClient
	ConfigurationProfileAssignmentsServer ConfigurationProfileAssignmentsServer

	// ConfigurationProfileHCIAssignmentsServer contains the fakes for client ConfigurationProfileHCIAssignmentsClient
	ConfigurationProfileHCIAssignmentsServer ConfigurationProfileHCIAssignmentsServer

	// ConfigurationProfileHCRPAssignmentsServer contains the fakes for client ConfigurationProfileHCRPAssignmentsClient
	ConfigurationProfileHCRPAssignmentsServer ConfigurationProfileHCRPAssignmentsServer

	// ConfigurationProfilesServer contains the fakes for client ConfigurationProfilesClient
	ConfigurationProfilesServer ConfigurationProfilesServer

	// ConfigurationProfilesVersionsServer contains the fakes for client ConfigurationProfilesVersionsClient
	ConfigurationProfilesVersionsServer ConfigurationProfilesVersionsServer

	// HCIReportsServer contains the fakes for client HCIReportsClient
	HCIReportsServer HCIReportsServer

	// HCRPReportsServer contains the fakes for client HCRPReportsClient
	...
	// ServicePrincipalsServer contains the fakes for client ServicePrincipalsClient
