...
func (h *HostPoolsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if hostPoolsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = hostPoolsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "HostPoolsClient.ListRegistrationTokens":
				res.resp, res.err = h.dispatchListRegistrationTokens(req)
			case "HostPoolsClient.RetrieveRegistrationToken":
				res.resp, res.err = h.dispatchRetrieveRegistrationToken(req)
...
// set this to conditionally intercept incoming requests to HostPoolsServerTransport
var hostPoolsServerTransportInterceptor interface {
