...
// ManagedEnvironmentSecret - Secret resource for managedEnvironment.
type ManagedEnvironmentSecret struct {
	// Secret properties
...
// ManagedEnvironmentSecretProperties - Secret properties
type ManagedEnvironmentSecretProperties struct {
	// Resource ID of a managed identity to authenticate with Azure Key Vault, or System to use a system-assigned identity.
	Identity *string
...
// ManagedEnvironmentSecretsCollection - Collection of Secrets for Environments
type ManagedEnvironmentSecretsCollection struct {
	// REQUIRED; Collection of secret resources.
