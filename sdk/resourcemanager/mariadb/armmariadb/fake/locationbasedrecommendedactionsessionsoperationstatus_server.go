...
func (l *LocationBasedRecommendedActionSessionsOperationStatusServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if locationBasedRecommendedActionSessionsOperationStatusServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = locationBasedRecommendedActionSessionsOperationStatusServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to LocationBasedRecommendedActionSessionsOperationStatusServerTransport
var locationBasedRecommendedActionSessionsOperationStatusServerTransportInterceptor interface {
