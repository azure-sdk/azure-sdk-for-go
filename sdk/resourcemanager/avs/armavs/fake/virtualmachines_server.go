...
type VirtualMachinesServer struct {
	...
	// HTTP status codes to indicate success: http.StatusOK
	NewListByClusterPager func(resourceGroupName string, privateCloudName string, clusterName string, options *armavs.VirtualMachinesClientListByClusterOptions) (resp azfake.PagerResponder[armavs.VirtualMachinesClientListByClusterResponse])
...
func (v *VirtualMachinesServerTransport) dispatchNewListByClusterPager(req *http.Request) (*http.Response, error) {
	...
	if newListByClusterPager == nil {
		...
		resp := v.srv.NewListByClusterPager(resourceGroupNameParam, privateCloudNameParam, clusterNameParam, nil)
