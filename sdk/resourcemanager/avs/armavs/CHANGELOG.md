...
- Type of `PrivateCloudUpdate.Identity` has been changed from `*PrivateCloudIdentity` to `*AzureResourceManagerCommonTypesSystemAssignedServiceIdentityUpdate`
...
- New struct `AzureResourceManagerCommonTypesSKUUpdate`
- New struct `AzureResourceManagerCommonTypesSystemAssignedServiceIdentityUpdate`
