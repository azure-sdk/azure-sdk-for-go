...
func (w *WorkspaceAADAdminsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if workspaceAadAdminsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = workspaceAadAdminsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to WorkspaceAADAdminsServerTransport
var workspaceAadAdminsServerTransportInterceptor interface {
