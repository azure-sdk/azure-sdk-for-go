...
func (p *PowerBIResourcesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if powerBiResourcesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = powerBiResourcesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "PowerBIResourcesClient.ListByResourceName":
				res.resp, res.err = p.dispatchListByResourceName(req)
...
// set this to conditionally intercept incoming requests to PowerBIResourcesServerTransport
var powerBiResourcesServerTransportInterceptor interface {
