...
type MigratePostgreSQLAzureDbForPostgreSQLSyncDatabaseInput struct {
	// Migration settings which tune the migration behavior
	MigrationSetting map[string]any `json:"migrationSetting,omitempty"`
...
type MigrateSQLServerSQLDbDatabaseInput struct {
	...
	SchemaSetting any `json:"schemaSetting,omitempty"`
...
type NodeMonitoringData struct {
	...
	AdditionalProperties map[string]any `json:"additionalProperties,omitempty" azure:"ro"`
...
type ServiceStatusResponse struct {
	// Agent Configuration
	AgentConfiguration any `json:"agentConfiguration,omitempty"`
