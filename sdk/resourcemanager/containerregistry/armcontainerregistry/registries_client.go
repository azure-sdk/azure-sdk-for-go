...
// CheckCacheRuleArtifactSyncEstimate - Checks the contents of an upstream repository and executes the query of a cache rule's
// artifact sync scope filter.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2024-01-01-preview
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - registryName - The name of the container registry.
//   - cacheRuleCreateParameters - The cache rule resource.
//   - options - RegistriesClientCheckCacheRuleArtifactSyncEstimateOptions contains the optional parameters for the RegistriesClient.CheckCacheRuleArtifactSyncEstimate
//     method.
func (client *RegistriesClient) CheckCacheRuleArtifactSyncEstimate(ctx context.Context, resourceGroupName string, registryName string, cacheRuleCreateParameters CacheRule, options *RegistriesClientCheckCacheRuleArtifactSyncEstimateOptions) (RegistriesClientCheckCacheRuleArtifactSyncEstimateResponse, error) {
	var err error
	const operationName = "RegistriesClient.CheckCacheRuleArtifactSyncEstimate"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.checkCacheRuleArtifactSyncEstimateCreateRequest(ctx, resourceGroupName, registryName, cacheRuleCreateParameters, options)
	if err != nil {
		return RegistriesClientCheckCacheRuleArtifactSyncEstimateResponse{}, err
	}
	...
	resp, err := client.checkCacheRuleArtifactSyncEstimateHandleResponse(httpResp)
	return resp, err
}

// checkCacheRuleArtifactSyncEstimateCreateRequest creates the CheckCacheRuleArtifactSyncEstimate request.
func (client *RegistriesClient) checkCacheRuleArtifactSyncEstimateCreateRequest(ctx context.Context, resourceGroupName string, registryName string, cacheRuleCreateParameters CacheRule, options *RegistriesClientCheckCacheRuleArtifactSyncEstimateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerRegistry/registries/{registryName}/checkCacheRuleArtifactSyncEstimate"
...
// checkCacheRuleArtifactSyncEstimateHandleResponse handles the CheckCacheRuleArtifactSyncEstimate response.
func (client *RegistriesClient) checkCacheRuleArtifactSyncEstimateHandleResponse(resp *http.Response) (RegistriesClientCheckCacheRuleArtifactSyncEstimateResponse, error) {
	result := RegistriesClientCheckCacheRuleArtifactSyncEstimateResponse{}
	if err := runtime.UnmarshalAsJSON(resp, &result.CacheRuleArtifactSyncEstimateResult); err != nil {
		return RegistriesClientCheckCacheRuleArtifactSyncEstimateResponse{}, err
	}
	return result, nil
}
