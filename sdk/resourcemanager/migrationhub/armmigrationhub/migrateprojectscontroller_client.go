...
func (client *MigrateProjectsControllerClient) deleteMigrateProjectCreateRequest(ctx context.Context, resourceGroupName string, migrateProjectName string, _ *MigrateProjectsControllerClientDeleteMigrateProjectOptions) (*policy.Request, error) {
...
func (client *MigrateProjectsControllerClient) getMigrateProjectCreateRequest(ctx context.Context, resourceGroupName string, migrateProjectName string, _ *MigrateProjectsControllerClientGetMigrateProjectOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Migrate/migrateProjects/{migrateProjectName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *MigrateProjectsControllerClient) getToolRegistrationDetailsCreateRequest(ctx context.Context, resourceGroupName string, migrateProjectName string, input RegistrationDetailsInput, _ *MigrateProjectsControllerClientGetToolRegistrationDetailsOptions) (*policy.Request, error) {
...
func (client *MigrateProjectsControllerClient) patchMigrateProjectCreateRequest(ctx context.Context, resourceGroupName string, migrateProjectName string, body MigrateProject, _ *MigrateProjectsControllerClientPatchMigrateProjectOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Migrate/migrateProjects/{migrateProjectName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *MigrateProjectsControllerClient) putMigrateProjectCreateRequest(ctx context.Context, resourceGroupName string, migrateProjectName string, body MigrateProject, _ *MigrateProjectsControllerClientPutMigrateProjectOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Migrate/migrateProjects/{migrateProjectName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *MigrateProjectsControllerClient) refreshSummaryCreateRequest(ctx context.Context, resourceGroupName string, migrateProjectName string, input RefreshSummaryInput, _ *MigrateProjectsControllerClientRefreshSummaryOptions) (*policy.Request, error) {
...
func (client *MigrateProjectsControllerClient) registerToolCreateRequest(ctx context.Context, resourceGroupName string, migrateProjectName string, input RegisterToolInput, _ *MigrateProjectsControllerClientRegisterToolOptions) (*policy.Request, error) {
