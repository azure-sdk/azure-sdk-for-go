...
// StaticSitesClientPurgeStaticSiteBuildResponse contains the response from method StaticSitesClient.PurgeStaticSiteBuild.
type StaticSitesClientPurgeStaticSiteBuildResponse struct {
	// placeholder for future response values
}

// StaticSitesClientPurgeStaticSiteResponse contains the response from method StaticSitesClient.PurgeStaticSite.
