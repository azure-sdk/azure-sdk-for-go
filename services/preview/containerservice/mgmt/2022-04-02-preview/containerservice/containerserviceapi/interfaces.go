...
type TrustedAccessRolesClientAPI interface {
	List(ctx context.Context, location string) (result containerservice.TrustedAccessRoleListResult, err error)
}
...
type TrustedAccessRoleBindingsClientAPI interface {
	...
	List(ctx context.Context, resourceGroupName string, resourceName string) (result containerservice.TrustedAccessRoleBindingListResult, err error)
}
