...
// PolicyDefinitionsServer is a fake server for instances of the armtemplatespecs.PolicyDefinitionsClient type.
type PolicyDefinitionsServer struct {
	...
	CreateOrUpdate func(ctx context.Context, policyDefinitionName string, parameters armtemplatespecs.PolicyDefinition, options *armtemplatespecs.PolicyDefinitionsClientCreateOrUpdateOptions) (resp azfake.Responder[armtemplatespecs.PolicyDefinitionsClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)

	// CreateOrUpdateAtManagementGroup is the fake for method PolicyDefinitionsClient.CreateOrUpdateAtManagementGroup
	// HTTP status codes to indicate success: http.StatusCreated
	CreateOrUpdateAtManagementGroup func(ctx context.Context, managementGroupID string, policyDefinitionName string, parameters armtemplatespecs.PolicyDefinition, options *armtemplatespecs.PolicyDefinitionsClientCreateOrUpdateAtManagementGroupOptions) (resp azfake.Responder[armtemplatespecs.PolicyDefinitionsClientCreateOrUpdateAtManagementGroupResponse], errResp azfake.ErrorResponder)

	// Delete is the fake for method PolicyDefinitionsClient.Delete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	Delete func(ctx context.Context, policyDefinitionName string, options *armtemplatespecs.PolicyDefinitionsClientDeleteOptions) (resp azfake.Responder[armtemplatespecs.PolicyDefinitionsClientDeleteResponse], errResp azfake.ErrorResponder)

	// DeleteAtManagementGroup is the fake for method PolicyDefinitionsClient.DeleteAtManagementGroup
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	DeleteAtManagementGroup func(ctx context.Context, managementGroupID string, policyDefinitionName string, options *armtemplatespecs.PolicyDefinitionsClientDeleteAtManagementGroupOptions) (resp azfake.Responder[armtemplatespecs.PolicyDefinitionsClientDeleteAtManagementGroupResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method PolicyDefinitionsClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, policyDefinitionName string, options *armtemplatespecs.PolicyDefinitionsClientGetOptions) (resp azfake.Responder[armtemplatespecs.PolicyDefinitionsClientGetResponse], errResp azfake.ErrorResponder)

	// GetAtManagementGroup is the fake for method PolicyDefinitionsClient.GetAtManagementGroup
	// HTTP status codes to indicate success: http.StatusOK
	GetAtManagementGroup func(ctx context.Context, managementGroupID string, policyDefinitionName string, options *armtemplatespecs.PolicyDefinitionsClientGetAtManagementGroupOptions) (resp azfake.Responder[armtemplatespecs.PolicyDefinitionsClientGetAtManagementGroupResponse], errResp azfake.ErrorResponder)

	// GetBuiltIn is the fake for method PolicyDefinitionsClient.GetBuiltIn
	// HTTP status codes to indicate success: http.StatusOK
	GetBuiltIn func(ctx context.Context, policyDefinitionName string, options *armtemplatespecs.PolicyDefinitionsClientGetBuiltInOptions) (resp azfake.Responder[armtemplatespecs.PolicyDefinitionsClientGetBuiltInResponse], errResp azfake.ErrorResponder)

	// NewListPager is the fake for method PolicyDefinitionsClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(options *armtemplatespecs.PolicyDefinitionsClientListOptions) (resp azfake.PagerResponder[armtemplatespecs.PolicyDefinitionsClientListResponse])

	// NewListBuiltInPager is the fake for method PolicyDefinitionsClient.NewListBuiltInPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListBuiltInPager func(options *armtemplatespecs.PolicyDefinitionsClientListBuiltInOptions) (resp azfake.PagerResponder[armtemplatespecs.PolicyDefinitionsClientListBuiltInResponse])

	// NewListByManagementGroupPager is the fake for method PolicyDefinitionsClient.NewListByManagementGroupPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByManagementGroupPager func(managementGroupID string, options *armtemplatespecs.PolicyDefinitionsClientListByManagementGroupOptions) (resp azfake.PagerResponder[armtemplatespecs.PolicyDefinitionsClientListByManagementGroupResponse])
}
...
// The returned PolicyDefinitionsServerTransport instance is connected to an instance of armtemplatespecs.PolicyDefinitionsClient via the
...
func NewPolicyDefinitionsServerTransport(srv *PolicyDefinitionsServer) *PolicyDefinitionsServerTransport {
	return &PolicyDefinitionsServerTransport{
		srv:                           srv,
		newListPager:                  newTracker[azfake.PagerResponder[armtemplatespecs.PolicyDefinitionsClientListResponse]](),
		newListBuiltInPager:           newTracker[azfake.PagerResponder[armtemplatespecs.PolicyDefinitionsClientListBuiltInResponse]](),
		newListByManagementGroupPager: newTracker[azfake.PagerResponder[armtemplatespecs.PolicyDefinitionsClientListByManagementGroupResponse]](),
	}
}

// PolicyDefinitionsServerTransport connects instances of armtemplatespecs.PolicyDefinitionsClient to instances of PolicyDefinitionsServer.
...
type PolicyDefinitionsServerTransport struct {
	...
	newListPager                  *tracker[azfake.PagerResponder[armtemplatespecs.PolicyDefinitionsClientListResponse]]
	newListBuiltInPager           *tracker[azfake.PagerResponder[armtemplatespecs.PolicyDefinitionsClientListBuiltInResponse]]
	newListByManagementGroupPager *tracker[azfake.PagerResponder[armtemplatespecs.PolicyDefinitionsClientListByManagementGroupResponse]]
}
...
func (p *PolicyDefinitionsServerTransport) dispatchCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[armtemplatespecs.PolicyDefinition](req)
	if err != nil {
		return nil, err
	}
...
func (p *PolicyDefinitionsServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		var options *armtemplatespecs.PolicyDefinitionsClientListOptions
		if filterParam != nil || topParam != nil {
			options = &armtemplatespecs.PolicyDefinitionsClientListOptions{
				Filter: filterParam,
				Top:    topParam,
			}
		}
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armtemplatespecs.PolicyDefinitionsClientListResponse, createLink func() string) {
...
func (p *PolicyDefinitionsServerTransport) dispatchNewListBuiltInPager(req *http.Request) (*http.Response, error) {
	...
	if newListBuiltInPager == nil {
		...
		var options *armtemplatespecs.PolicyDefinitionsClientListBuiltInOptions
		if filterParam != nil || topParam != nil {
			options = &armtemplatespecs.PolicyDefinitionsClientListBuiltInOptions{
				Filter: filterParam,
				Top:    topParam,
			}
		}
		...
		server.PagerResponderInjectNextLinks(newListBuiltInPager, req, func(page *armtemplatespecs.PolicyDefinitionsClientListBuiltInResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
...
func (p *PolicyDefinitionsServerTransport) dispatchNewListByManagementGroupPager(req *http.Request) (*http.Response, error) {
	...
	if newListByManagementGroupPager == nil {
		...
		var options *armtemplatespecs.PolicyDefinitionsClientListByManagementGroupOptions
		if filterParam != nil || topParam != nil {
			options = &armtemplatespecs.PolicyDefinitionsClientListByManagementGroupOptions{
				Filter: filterParam,
				Top:    topParam,
			}
		}
		...
		server.PagerResponderInjectNextLinks(newListByManagementGroupPager, req, func(page *armtemplatespecs.PolicyDefinitionsClientListByManagementGroupResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
