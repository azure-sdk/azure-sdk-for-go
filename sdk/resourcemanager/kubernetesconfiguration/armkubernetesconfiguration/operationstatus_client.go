...
func (client *OperationStatusClient) listCreateRequest(ctx context.Context, resourceGroupName string, clusterRp string, clusterResourceName string, clusterName string, _ *OperationStatusClientListOptions) (*policy.Request, error) {
