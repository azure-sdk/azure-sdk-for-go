...
// CategoriesClientGetResponse contains the response from method CategoriesClient.Get.
type CategoriesClientGetResponse struct {
	// ImpactCategory resource
	Category
}

// CategoriesClientListBySubscriptionResponse contains the response from method CategoriesClient.NewListBySubscriptionPager.
type CategoriesClientListBySubscriptionResponse struct {
...
// TopologyImpactsClientCreateResponse contains the response from method TopologyImpactsClient.BeginCreate.
type TopologyImpactsClientCreateResponse struct {
	// Topology Impact properties
	TopologyImpact
}

// TopologyImpactsClientDeleteResponse contains the response from method TopologyImpactsClient.Delete.
type TopologyImpactsClientDeleteResponse struct {
	// placeholder for future response values
}

// TopologyImpactsClientGetResponse contains the response from method TopologyImpactsClient.Get.
type TopologyImpactsClientGetResponse struct {
	// Topology Impact properties
	TopologyImpact
}

// TopologyImpactsClientListBySubscriptionResponse contains the response from method TopologyImpactsClient.NewListBySubscriptionPager.
type TopologyImpactsClientListBySubscriptionResponse struct {
