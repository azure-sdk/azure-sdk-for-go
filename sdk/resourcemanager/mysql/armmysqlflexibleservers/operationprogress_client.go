...
func (client *OperationProgressClient) getCreateRequest(ctx context.Context, locationName string, operationID string, _ *OperationProgressClientGetOptions) (*policy.Request, error) {
