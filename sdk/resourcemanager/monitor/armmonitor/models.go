...
type MetricDefinitionCollection struct {
	...
	// READ-ONLY; URL to get the next set of metric definitions (if there are any).
	NextLink *string
}
...
// Operation - Details of a REST API operation, returned from the Microsoft.Insights Operations API
type Operation struct {
	...
	// The name of the operation, as per Resource-Based Access Control (RBAC). Examples: "Microsoft.Insights/components/write",
...
type OperationDisplay struct {
	...
	// The concise, localized friendly name for the operation; suitable for dropdowns. E.g. "Reading an application insights component
	// configuration", "Application Insights component metrics read".
	Operation *string
	...
	// The localized friendly name of the resource type related to this operation. E.g. "Application insights components" or "Log
	// Definitions".
	Resource *string
}
...
// OperationListResult - A list of REST API operations supported by the Microsoft.Insights Azure Resource Provider. It contains
