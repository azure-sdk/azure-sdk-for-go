...
// FlowRunExecutionMode - The flow run execution mode.
type FlowRunExecutionMode string

const (
	// FlowRunExecutionModeNotSpecified - The flow run execution mode is not specified.
	FlowRunExecutionModeNotSpecified FlowRunExecutionMode = "NotSpecified"
	// FlowRunExecutionModeResubmittedResults - The flow run execution mode is resubmitted results.
	FlowRunExecutionModeResubmittedResults FlowRunExecutionMode = "ResubmittedResults"
	// FlowRunExecutionModeStaticResults - The flow run execution mode is static results.
	FlowRunExecutionModeStaticResults FlowRunExecutionMode = "StaticResults"
)

// PossibleFlowRunExecutionModeValues returns the possible values for the FlowRunExecutionMode const type.
func PossibleFlowRunExecutionModeValues() []FlowRunExecutionMode {
	return []FlowRunExecutionMode{
		FlowRunExecutionModeNotSpecified,
		FlowRunExecutionModeResubmittedResults,
		FlowRunExecutionModeStaticResults,
	}
}

// FlowTemplateSKU - The flow template sku.
type FlowTemplateSKU string

const (
	// FlowTemplateSKUConsumption - The flow template sku is consumption.
	FlowTemplateSKUConsumption FlowTemplateSKU = "Consumption"
	// FlowTemplateSKUNone - The flow template sku is none.
	FlowTemplateSKUNone FlowTemplateSKU = "None"
	// FlowTemplateSKUStandard - The flow template sku is standard.
	FlowTemplateSKUStandard FlowTemplateSKU = "Standard"
)

// PossibleFlowTemplateSKUValues returns the possible values for the FlowTemplateSKU const type.
func PossibleFlowTemplateSKUValues() []FlowTemplateSKU {
	return []FlowTemplateSKU{
		FlowTemplateSKUConsumption,
		FlowTemplateSKUNone,
		FlowTemplateSKUStandard,
	}
}

// FlowTemplateState - The flow template state.
type FlowTemplateState string

const (
	// FlowTemplateStateDevelopment - The flow template is in the development state.
	FlowTemplateStateDevelopment FlowTemplateState = "Development"
	// FlowTemplateStateNotSpecified - The flow template is in the draft state.
	FlowTemplateStateNotSpecified FlowTemplateState = "NotSpecified"
	// FlowTemplateStateProduction - The flow template is in the production state.
	FlowTemplateStateProduction FlowTemplateState = "Production"
	// FlowTemplateStateTesting - The flow template is in the testing state.
	FlowTemplateStateTesting FlowTemplateState = "Testing"
)

// PossibleFlowTemplateStateValues returns the possible values for the FlowTemplateState const type.
func PossibleFlowTemplateStateValues() []FlowTemplateState {
	return []FlowTemplateState{
		FlowTemplateStateDevelopment,
		FlowTemplateStateNotSpecified,
		FlowTemplateStateProduction,
		FlowTemplateStateTesting,
	}
}

// FlowTemplateType - The flow template type.
type FlowTemplateType string

const (
	// FlowTemplateTypeAccelerator - The flow template type is accelerator.
	FlowTemplateTypeAccelerator FlowTemplateType = "Accelerator"
	// FlowTemplateTypeNotSpecified - The flow template type is not specified.
	FlowTemplateTypeNotSpecified FlowTemplateType = "NotSpecified"
	// FlowTemplateTypeWorkflow - The flow template type is workflow.
	FlowTemplateTypeWorkflow FlowTemplateType = "Workflow"
)

// PossibleFlowTemplateTypeValues returns the possible values for the FlowTemplateType const type.
func PossibleFlowTemplateTypeValues() []FlowTemplateType {
	return []FlowTemplateType{
		FlowTemplateTypeAccelerator,
		FlowTemplateTypeNotSpecified,
		FlowTemplateTypeWorkflow,
	}
}
