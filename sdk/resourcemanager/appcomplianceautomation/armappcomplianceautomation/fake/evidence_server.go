...
type EvidenceServer struct {
	...
	CreateOrUpdate func(ctx context.Context, reportName string, evidenceName string, parameters armappcomplianceautomation.EvidenceResource, options *armappcomplianceautomation.EvidenceClientCreateOrUpdateOptions) (resp azfake.Responder[armappcomplianceautomation.EvidenceClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)
	...
	// NewListByReportResourcePager is the fake for method EvidenceClient.NewListByReportResourcePager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByReportResourcePager func(reportName string, options *armappcomplianceautomation.EvidenceClientListByReportResourceOptions) (resp azfake.PagerResponder[armappcomplianceautomation.EvidenceClientListByReportResourceResponse])
}
...
func NewEvidenceServerTransport(srv *EvidenceServer) *EvidenceServerTransport {
	return &EvidenceServerTransport{
		srv:                          srv,
		newListByReportResourcePager: newTracker[azfake.PagerResponder[armappcomplianceautomation.EvidenceClientListByReportResourceResponse]](),
	}
}
...
type EvidenceServerTransport struct {
	srv                          *EvidenceServer
	newListByReportResourcePager *tracker[azfake.PagerResponder[armappcomplianceautomation.EvidenceClientListByReportResourceResponse]]
}
...
func (e *EvidenceServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	case "EvidenceClient.NewListByReportResourcePager":
		resp, err = e.dispatchNewListByReportResourcePager(req)
	default:
...
func (e *EvidenceServerTransport) dispatchNewListByReportResourcePager(req *http.Request) (*http.Response, error) {
	if e.srv.NewListByReportResourcePager == nil {
		return nil, &nonRetriableError{errors.New("fake for method NewListByReportResourcePager not implemented")}
	}
	newListByReportResourcePager := e.newListByReportResourcePager.get(req)
	if newListByReportResourcePager == nil {
		...
		var options *armappcomplianceautomation.EvidenceClientListByReportResourceOptions
		if skipTokenParam != nil || topParam != nil || selectParamParam != nil || filterParam != nil || orderbyParam != nil || offerGUIDParam != nil || reportCreatorTenantIDParam != nil {
			options = &armappcomplianceautomation.EvidenceClientListByReportResourceOptions{
		...
		resp := e.srv.NewListByReportResourcePager(reportNameParam, options)
		newListByReportResourcePager = &resp
		e.newListByReportResourcePager.add(req, newListByReportResourcePager)
		server.PagerResponderInjectNextLinks(newListByReportResourcePager, req, func(page *armappcomplianceautomation.EvidenceClientListByReportResourceResponse, createLink func() string) {
	...
	if !contains([]int{http.StatusOK}, resp.StatusCode) {
		e.newListByReportResourcePager.remove(req)
