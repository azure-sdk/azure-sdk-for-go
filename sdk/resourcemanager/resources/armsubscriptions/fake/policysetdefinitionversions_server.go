...
// PolicySetDefinitionVersionsServer is a fake server for instances of the armsubscriptions.PolicySetDefinitionVersionsClient type.
type PolicySetDefinitionVersionsServer struct {
	...
	CreateOrUpdate func(ctx context.Context, policySetDefinitionName string, policyDefinitionVersion string, parameters armsubscriptions.PolicySetDefinitionVersion, options *armsubscriptions.PolicySetDefinitionVersionsClientCreateOrUpdateOptions) (resp azfake.Responder[armsubscriptions.PolicySetDefinitionVersionsClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)

	// CreateOrUpdateAtManagementGroup is the fake for method PolicySetDefinitionVersionsClient.CreateOrUpdateAtManagementGroup
	// HTTP status codes to indicate success: http.StatusOK, http.StatusCreated
	CreateOrUpdateAtManagementGroup func(ctx context.Context, managementGroupName string, policySetDefinitionName string, policyDefinitionVersion string, parameters armsubscriptions.PolicySetDefinitionVersion, options *armsubscriptions.PolicySetDefinitionVersionsClientCreateOrUpdateAtManagementGroupOptions) (resp azfake.Responder[armsubscriptions.PolicySetDefinitionVersionsClientCreateOrUpdateAtManagementGroupResponse], errResp azfake.ErrorResponder)

	// Delete is the fake for method PolicySetDefinitionVersionsClient.Delete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	Delete func(ctx context.Context, policySetDefinitionName string, policyDefinitionVersion string, options *armsubscriptions.PolicySetDefinitionVersionsClientDeleteOptions) (resp azfake.Responder[armsubscriptions.PolicySetDefinitionVersionsClientDeleteResponse], errResp azfake.ErrorResponder)

	// DeleteAtManagementGroup is the fake for method PolicySetDefinitionVersionsClient.DeleteAtManagementGroup
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	DeleteAtManagementGroup func(ctx context.Context, managementGroupName string, policySetDefinitionName string, policyDefinitionVersion string, options *armsubscriptions.PolicySetDefinitionVersionsClientDeleteAtManagementGroupOptions) (resp azfake.Responder[armsubscriptions.PolicySetDefinitionVersionsClientDeleteAtManagementGroupResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method PolicySetDefinitionVersionsClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, policySetDefinitionName string, policyDefinitionVersion string, options *armsubscriptions.PolicySetDefinitionVersionsClientGetOptions) (resp azfake.Responder[armsubscriptions.PolicySetDefinitionVersionsClientGetResponse], errResp azfake.ErrorResponder)

	// GetAtManagementGroup is the fake for method PolicySetDefinitionVersionsClient.GetAtManagementGroup
	// HTTP status codes to indicate success: http.StatusOK
	GetAtManagementGroup func(ctx context.Context, managementGroupName string, policySetDefinitionName string, policyDefinitionVersion string, options *armsubscriptions.PolicySetDefinitionVersionsClientGetAtManagementGroupOptions) (resp azfake.Responder[armsubscriptions.PolicySetDefinitionVersionsClientGetAtManagementGroupResponse], errResp azfake.ErrorResponder)

	// GetBuiltIn is the fake for method PolicySetDefinitionVersionsClient.GetBuiltIn
	// HTTP status codes to indicate success: http.StatusOK
	GetBuiltIn func(ctx context.Context, policySetDefinitionName string, policyDefinitionVersion string, options *armsubscriptions.PolicySetDefinitionVersionsClientGetBuiltInOptions) (resp azfake.Responder[armsubscriptions.PolicySetDefinitionVersionsClientGetBuiltInResponse], errResp azfake.ErrorResponder)

	// NewListPager is the fake for method PolicySetDefinitionVersionsClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(policySetDefinitionName string, options *armsubscriptions.PolicySetDefinitionVersionsClientListOptions) (resp azfake.PagerResponder[armsubscriptions.PolicySetDefinitionVersionsClientListResponse])

	// ListAll is the fake for method PolicySetDefinitionVersionsClient.ListAll
	// HTTP status codes to indicate success: http.StatusOK
	ListAll func(ctx context.Context, options *armsubscriptions.PolicySetDefinitionVersionsClientListAllOptions) (resp azfake.Responder[armsubscriptions.PolicySetDefinitionVersionsClientListAllResponse], errResp azfake.ErrorResponder)

	// ListAllAtManagementGroup is the fake for method PolicySetDefinitionVersionsClient.ListAllAtManagementGroup
	// HTTP status codes to indicate success: http.StatusOK
	ListAllAtManagementGroup func(ctx context.Context, managementGroupName string, options *armsubscriptions.PolicySetDefinitionVersionsClientListAllAtManagementGroupOptions) (resp azfake.Responder[armsubscriptions.PolicySetDefinitionVersionsClientListAllAtManagementGroupResponse], errResp azfake.ErrorResponder)

	// ListAllBuiltins is the fake for method PolicySetDefinitionVersionsClient.ListAllBuiltins
	// HTTP status codes to indicate success: http.StatusOK
	ListAllBuiltins func(ctx context.Context, options *armsubscriptions.PolicySetDefinitionVersionsClientListAllBuiltinsOptions) (resp azfake.Responder[armsubscriptions.PolicySetDefinitionVersionsClientListAllBuiltinsResponse], errResp azfake.ErrorResponder)

	// NewListBuiltInPager is the fake for method PolicySetDefinitionVersionsClient.NewListBuiltInPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListBuiltInPager func(policySetDefinitionName string, options *armsubscriptions.PolicySetDefinitionVersionsClientListBuiltInOptions) (resp azfake.PagerResponder[armsubscriptions.PolicySetDefinitionVersionsClientListBuiltInResponse])

	// NewListByManagementGroupPager is the fake for method PolicySetDefinitionVersionsClient.NewListByManagementGroupPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByManagementGroupPager func(managementGroupName string, policySetDefinitionName string, options *armsubscriptions.PolicySetDefinitionVersionsClientListByManagementGroupOptions) (resp azfake.PagerResponder[armsubscriptions.PolicySetDefinitionVersionsClientListByManagementGroupResponse])
}
...
// The returned PolicySetDefinitionVersionsServerTransport instance is connected to an instance of armsubscriptions.PolicySetDefinitionVersionsClient via the
...
func NewPolicySetDefinitionVersionsServerTransport(srv *PolicySetDefinitionVersionsServer) *PolicySetDefinitionVersionsServerTransport {
	return &PolicySetDefinitionVersionsServerTransport{
		srv:                           srv,
		newListPager:                  newTracker[azfake.PagerResponder[armsubscriptions.PolicySetDefinitionVersionsClientListResponse]](),
		newListBuiltInPager:           newTracker[azfake.PagerResponder[armsubscriptions.PolicySetDefinitionVersionsClientListBuiltInResponse]](),
		newListByManagementGroupPager: newTracker[azfake.PagerResponder[armsubscriptions.PolicySetDefinitionVersionsClientListByManagementGroupResponse]](),
	}
}

// PolicySetDefinitionVersionsServerTransport connects instances of armsubscriptions.PolicySetDefinitionVersionsClient to instances of PolicySetDefinitionVersionsServer.
...
type PolicySetDefinitionVersionsServerTransport struct {
	...
	newListPager                  *tracker[azfake.PagerResponder[armsubscriptions.PolicySetDefinitionVersionsClientListResponse]]
	newListBuiltInPager           *tracker[azfake.PagerResponder[armsubscriptions.PolicySetDefinitionVersionsClientListBuiltInResponse]]
	newListByManagementGroupPager *tracker[azfake.PagerResponder[armsubscriptions.PolicySetDefinitionVersionsClientListByManagementGroupResponse]]
}
...
func (p *PolicySetDefinitionVersionsServerTransport) dispatchCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[armsubscriptions.PolicySetDefinitionVersion](req)
	if err != nil {
		return nil, err
	}
...
func (p *PolicySetDefinitionVersionsServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		var options *armsubscriptions.PolicySetDefinitionVersionsClientListOptions
		if topParam != nil {
			options = &armsubscriptions.PolicySetDefinitionVersionsClientListOptions{
				Top: topParam,
			}
		}
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armsubscriptions.PolicySetDefinitionVersionsClientListResponse, createLink func() string) {
...
func (p *PolicySetDefinitionVersionsServerTransport) dispatchNewListBuiltInPager(req *http.Request) (*http.Response, error) {
	...
	if newListBuiltInPager == nil {
		...
		var options *armsubscriptions.PolicySetDefinitionVersionsClientListBuiltInOptions
		if topParam != nil {
			options = &armsubscriptions.PolicySetDefinitionVersionsClientListBuiltInOptions{
				Top: topParam,
			}
		}
		...
		server.PagerResponderInjectNextLinks(newListBuiltInPager, req, func(page *armsubscriptions.PolicySetDefinitionVersionsClientListBuiltInResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
...
func (p *PolicySetDefinitionVersionsServerTransport) dispatchNewListByManagementGroupPager(req *http.Request) (*http.Response, error) {
	...
	if newListByManagementGroupPager == nil {
		...
		var options *armsubscriptions.PolicySetDefinitionVersionsClientListByManagementGroupOptions
		if topParam != nil {
			options = &armsubscriptions.PolicySetDefinitionVersionsClientListByManagementGroupOptions{
				Top: topParam,
			}
		}
		...
		server.PagerResponderInjectNextLinks(newListByManagementGroupPager, req, func(page *armsubscriptions.PolicySetDefinitionVersionsClientListByManagementGroupResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
