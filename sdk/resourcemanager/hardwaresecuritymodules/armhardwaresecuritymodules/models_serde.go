...
// MarshalJSON implements the json.Marshaller interface for type BackupRestoreBaseResult.
func (b BackupRestoreBaseResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type BackupRestoreBaseResult.
func (b *BackupRestoreBaseResult) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", b, err)
	}
