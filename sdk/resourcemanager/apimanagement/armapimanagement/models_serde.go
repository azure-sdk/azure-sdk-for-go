...
func (a AdditionalLocation) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "natOutboundAddresses", a.NatOutboundAddresses)
...
func (a *AdditionalLocation) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "natGatewayState":
			...
			delete(rawMsg, key)
		case "natOutboundAddresses":
			err = unpopulate(val, "NatOutboundAddresses", &a.NatOutboundAddresses)
			delete(rawMsg, key)
...
func (s ServiceBaseProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "natOutboundAddresses", s.NatOutboundAddresses)
...
func (s *ServiceBaseProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "natGatewayState":
			...
			delete(rawMsg, key)
		case "natOutboundAddresses":
			err = unpopulate(val, "NatOutboundAddresses", &s.NatOutboundAddresses)
			delete(rawMsg, key)
