...
func (client *IntegrationRuntimeNodeIPAddressClient) getCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, integrationRuntimeName string, nodeName string, _ *IntegrationRuntimeNodeIPAddressClientGetOptions) (*policy.Request, error) {
