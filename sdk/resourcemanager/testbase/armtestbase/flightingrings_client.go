...
func (client *FlightingRingsClient) getCreateRequest(ctx context.Context, resourceGroupName string, testBaseAccountName string, flightingRingResourceName string, _ *FlightingRingsClientGetOptions) (*policy.Request, error) {
...
func (client *FlightingRingsClient) listCreateRequest(ctx context.Context, resourceGroupName string, testBaseAccountName string, _ *FlightingRingsClientListOptions) (*policy.Request, error) {
