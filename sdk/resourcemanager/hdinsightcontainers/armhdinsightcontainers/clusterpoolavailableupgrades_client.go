...
func (client *ClusterPoolAvailableUpgradesClient) listCreateRequest(ctx context.Context, resourceGroupName string, clusterPoolName string, _ *ClusterPoolAvailableUpgradesClientListOptions) (*policy.Request, error) {
