...
func (client *PrivateLinkResourcesClient) ListByProvider(ctx context.Context, resourceGroupName string, providerName string, options *PrivateLinkResourcesClientListByProviderOptions) (PrivateLinkResourcesClientListByProviderResponse, error) {
	...
	if !runtime.HasStatusCode(resp, http.StatusOK) {
		return PrivateLinkResourcesClientListByProviderResponse{}, runtime.NewResponseError(resp)
	}
	return client.listByProviderHandleResponse(resp)
}

// listByProviderCreateRequest creates the ListByProvider request.
func (client *PrivateLinkResourcesClient) listByProviderCreateRequest(ctx context.Context, resourceGroupName string, providerName string, options *PrivateLinkResourcesClientListByProviderOptions) (*policy.Request, error) {
