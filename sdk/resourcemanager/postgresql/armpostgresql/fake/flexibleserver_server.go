...
// FlexibleServerServer is a fake server for instances of the armpostgresql.FlexibleServerClient type.
type FlexibleServerServer struct {
	...
	BeginStartLtrBackup func(ctx context.Context, resourceGroupName string, serverName string, parameters armpostgresql.LtrBackupRequest, options *armpostgresql.FlexibleServerClientBeginStartLtrBackupOptions) (resp azfake.PollerResponder[armpostgresql.FlexibleServerClientStartLtrBackupResponse], errResp azfake.ErrorResponder)

	// TriggerLtrPreBackup is the fake for method FlexibleServerClient.TriggerLtrPreBackup
	// HTTP status codes to indicate success: http.StatusOK
	TriggerLtrPreBackup func(ctx context.Context, resourceGroupName string, serverName string, parameters armpostgresql.LtrPreBackupRequest, options *armpostgresql.FlexibleServerClientTriggerLtrPreBackupOptions) (resp azfake.Responder[armpostgresql.FlexibleServerClientTriggerLtrPreBackupResponse], errResp azfake.ErrorResponder)
}
...
// The returned FlexibleServerServerTransport instance is connected to an instance of armpostgresql.FlexibleServerClient via the
...
func NewFlexibleServerServerTransport(srv *FlexibleServerServer) *FlexibleServerServerTransport {
	return &FlexibleServerServerTransport{
		srv:                 srv,
		beginStartLtrBackup: newTracker[azfake.PollerResponder[armpostgresql.FlexibleServerClientStartLtrBackupResponse]](),
	}
}

// FlexibleServerServerTransport connects instances of armpostgresql.FlexibleServerClient to instances of FlexibleServerServer.
...
type FlexibleServerServerTransport struct {
	...
	beginStartLtrBackup *tracker[azfake.PollerResponder[armpostgresql.FlexibleServerClientStartLtrBackupResponse]]
}
...
func (f *FlexibleServerServerTransport) dispatchBeginStartLtrBackup(req *http.Request) (*http.Response, error) {
	...
	if beginStartLtrBackup == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armpostgresql.LtrBackupRequest](req)
		if err != nil {
			return nil, err
		}
