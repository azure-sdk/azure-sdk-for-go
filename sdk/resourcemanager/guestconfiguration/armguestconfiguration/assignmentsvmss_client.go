...
//     method.
func (client *AssignmentsVMSSClient) CreateOrUpdate(ctx context.Context, name string, resourceGroupName string, vmssName string, parameters Assignment, options *AssignmentsVMSSClientCreateOrUpdateOptions) (AssignmentsVMSSClientCreateOrUpdateResponse, error) {
	req, err := client.createOrUpdateCreateRequest(ctx, name, resourceGroupName, vmssName, parameters, options)
	if err != nil {
	...
	if !runtime.HasStatusCode(resp, http.StatusOK, http.StatusCreated) {
		return AssignmentsVMSSClientCreateOrUpdateResponse{}, runtime.NewResponseError(resp)
	}
	return client.createOrUpdateHandleResponse(resp)
}

// createOrUpdateCreateRequest creates the CreateOrUpdate request.
func (client *AssignmentsVMSSClient) createOrUpdateCreateRequest(ctx context.Context, name string, resourceGroupName string, vmssName string, parameters Assignment, options *AssignmentsVMSSClientCreateOrUpdateOptions) (*policy.Request, error) {
