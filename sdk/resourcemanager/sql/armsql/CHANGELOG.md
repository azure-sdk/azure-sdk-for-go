...
- New struct `DatabaseEncryptionProtectorsClientRevalidateResponse`
- New struct `DatabaseEncryptionProtectorsClientRevertResponse`
...
- New struct `ManagedLedgerDigestUploadsClientCreateOrUpdateResponse`
- New struct `ManagedLedgerDigestUploadsClientDisableResponse`
- New struct `ManagedLedgerDigestUploadsClientListByDatabaseResponse`
