...
// ChildMoveResourceProperties - Defines the child move resource properties.
type ChildMoveResourceProperties struct {
	// REQUIRED; Gets or sets the Source ARM Id of the child resource.
	SourceID *string

	// Gets or sets the resource settings.
	ResourceSettings ResourceSettingsClassification

	// READ-ONLY; Defines the child move resource errors.
	Errors *ChildMoveResourcePropertiesErrors

	// READ-ONLY; Defines the child move resource state.
	MoveState *MoveState
...
// ChildMoveResourcePropertiesErrors - Defines the child move resource errors.
type ChildMoveResourcePropertiesErrors struct {
