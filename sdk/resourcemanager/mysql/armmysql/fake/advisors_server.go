...
func (a *AdvisorsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if advisorsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = advisorsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to AdvisorsServerTransport
var advisorsServerTransportInterceptor interface {
