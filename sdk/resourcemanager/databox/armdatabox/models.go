...
// CustomerInterventionStageProgress - Progress information for job stages where customer intervention might be required
type CustomerInterventionStageProgress struct {
	// Provides additional information about an http error response.
	Error *CloudError `json:"error,omitempty"`
