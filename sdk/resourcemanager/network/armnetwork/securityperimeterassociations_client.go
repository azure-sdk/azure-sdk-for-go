...
func (client *SecurityPerimeterAssociationsClient) postCreateRequest(ctx context.Context, resourceGroupName string, networkSecurityPerimeterName string, associationName string, parameters any, _ *SecurityPerimeterAssociationsClientPostOptions) (*policy.Request, error) {
