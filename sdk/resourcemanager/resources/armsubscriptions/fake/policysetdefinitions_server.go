...
// PolicySetDefinitionsServer is a fake server for instances of the armsubscriptions.PolicySetDefinitionsClient type.
type PolicySetDefinitionsServer struct {
	...
	CreateOrUpdate func(ctx context.Context, policySetDefinitionName string, parameters armsubscriptions.PolicySetDefinition, options *armsubscriptions.PolicySetDefinitionsClientCreateOrUpdateOptions) (resp azfake.Responder[armsubscriptions.PolicySetDefinitionsClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)

	// CreateOrUpdateAtManagementGroup is the fake for method PolicySetDefinitionsClient.CreateOrUpdateAtManagementGroup
	// HTTP status codes to indicate success: http.StatusOK, http.StatusCreated
	CreateOrUpdateAtManagementGroup func(ctx context.Context, managementGroupID string, policySetDefinitionName string, parameters armsubscriptions.PolicySetDefinition, options *armsubscriptions.PolicySetDefinitionsClientCreateOrUpdateAtManagementGroupOptions) (resp azfake.Responder[armsubscriptions.PolicySetDefinitionsClientCreateOrUpdateAtManagementGroupResponse], errResp azfake.ErrorResponder)

	// Delete is the fake for method PolicySetDefinitionsClient.Delete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	Delete func(ctx context.Context, policySetDefinitionName string, options *armsubscriptions.PolicySetDefinitionsClientDeleteOptions) (resp azfake.Responder[armsubscriptions.PolicySetDefinitionsClientDeleteResponse], errResp azfake.ErrorResponder)

	// DeleteAtManagementGroup is the fake for method PolicySetDefinitionsClient.DeleteAtManagementGroup
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	DeleteAtManagementGroup func(ctx context.Context, managementGroupID string, policySetDefinitionName string, options *armsubscriptions.PolicySetDefinitionsClientDeleteAtManagementGroupOptions) (resp azfake.Responder[armsubscriptions.PolicySetDefinitionsClientDeleteAtManagementGroupResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method PolicySetDefinitionsClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, policySetDefinitionName string, options *armsubscriptions.PolicySetDefinitionsClientGetOptions) (resp azfake.Responder[armsubscriptions.PolicySetDefinitionsClientGetResponse], errResp azfake.ErrorResponder)

	// GetAtManagementGroup is the fake for method PolicySetDefinitionsClient.GetAtManagementGroup
	// HTTP status codes to indicate success: http.StatusOK
	GetAtManagementGroup func(ctx context.Context, managementGroupID string, policySetDefinitionName string, options *armsubscriptions.PolicySetDefinitionsClientGetAtManagementGroupOptions) (resp azfake.Responder[armsubscriptions.PolicySetDefinitionsClientGetAtManagementGroupResponse], errResp azfake.ErrorResponder)

	// GetBuiltIn is the fake for method PolicySetDefinitionsClient.GetBuiltIn
	// HTTP status codes to indicate success: http.StatusOK
	GetBuiltIn func(ctx context.Context, policySetDefinitionName string, options *armsubscriptions.PolicySetDefinitionsClientGetBuiltInOptions) (resp azfake.Responder[armsubscriptions.PolicySetDefinitionsClientGetBuiltInResponse], errResp azfake.ErrorResponder)

	// NewListPager is the fake for method PolicySetDefinitionsClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(options *armsubscriptions.PolicySetDefinitionsClientListOptions) (resp azfake.PagerResponder[armsubscriptions.PolicySetDefinitionsClientListResponse])

	// NewListBuiltInPager is the fake for method PolicySetDefinitionsClient.NewListBuiltInPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListBuiltInPager func(options *armsubscriptions.PolicySetDefinitionsClientListBuiltInOptions) (resp azfake.PagerResponder[armsubscriptions.PolicySetDefinitionsClientListBuiltInResponse])

	// NewListByManagementGroupPager is the fake for method PolicySetDefinitionsClient.NewListByManagementGroupPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByManagementGroupPager func(managementGroupID string, options *armsubscriptions.PolicySetDefinitionsClientListByManagementGroupOptions) (resp azfake.PagerResponder[armsubscriptions.PolicySetDefinitionsClientListByManagementGroupResponse])
}
...
// The returned PolicySetDefinitionsServerTransport instance is connected to an instance of armsubscriptions.PolicySetDefinitionsClient via the
...
func NewPolicySetDefinitionsServerTransport(srv *PolicySetDefinitionsServer) *PolicySetDefinitionsServerTransport {
	return &PolicySetDefinitionsServerTransport{
		srv:                           srv,
		newListPager:                  newTracker[azfake.PagerResponder[armsubscriptions.PolicySetDefinitionsClientListResponse]](),
		newListBuiltInPager:           newTracker[azfake.PagerResponder[armsubscriptions.PolicySetDefinitionsClientListBuiltInResponse]](),
		newListByManagementGroupPager: newTracker[azfake.PagerResponder[armsubscriptions.PolicySetDefinitionsClientListByManagementGroupResponse]](),
	}
}

// PolicySetDefinitionsServerTransport connects instances of armsubscriptions.PolicySetDefinitionsClient to instances of PolicySetDefinitionsServer.
...
type PolicySetDefinitionsServerTransport struct {
	...
	newListPager                  *tracker[azfake.PagerResponder[armsubscriptions.PolicySetDefinitionsClientListResponse]]
	newListBuiltInPager           *tracker[azfake.PagerResponder[armsubscriptions.PolicySetDefinitionsClientListBuiltInResponse]]
	newListByManagementGroupPager *tracker[azfake.PagerResponder[armsubscriptions.PolicySetDefinitionsClientListByManagementGroupResponse]]
}
...
func (p *PolicySetDefinitionsServerTransport) dispatchCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[armsubscriptions.PolicySetDefinition](req)
	if err != nil {
		return nil, err
	}
...
func (p *PolicySetDefinitionsServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		var options *armsubscriptions.PolicySetDefinitionsClientListOptions
		if filterParam != nil || topParam != nil {
			options = &armsubscriptions.PolicySetDefinitionsClientListOptions{
				Filter: filterParam,
				Top:    topParam,
			}
		}
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armsubscriptions.PolicySetDefinitionsClientListResponse, createLink func() string) {
...
func (p *PolicySetDefinitionsServerTransport) dispatchNewListBuiltInPager(req *http.Request) (*http.Response, error) {
	...
	if newListBuiltInPager == nil {
		...
		var options *armsubscriptions.PolicySetDefinitionsClientListBuiltInOptions
		if filterParam != nil || topParam != nil {
			options = &armsubscriptions.PolicySetDefinitionsClientListBuiltInOptions{
				Filter: filterParam,
				Top:    topParam,
			}
		}
		...
		server.PagerResponderInjectNextLinks(newListBuiltInPager, req, func(page *armsubscriptions.PolicySetDefinitionsClientListBuiltInResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
...
func (p *PolicySetDefinitionsServerTransport) dispatchNewListByManagementGroupPager(req *http.Request) (*http.Response, error) {
	...
	if newListByManagementGroupPager == nil {
		...
		var options *armsubscriptions.PolicySetDefinitionsClientListByManagementGroupOptions
		if filterParam != nil || topParam != nil {
			options = &armsubscriptions.PolicySetDefinitionsClientListByManagementGroupOptions{
				Filter: filterParam,
				Top:    topParam,
			}
		}
		...
		server.PagerResponderInjectNextLinks(newListByManagementGroupPager, req, func(page *armsubscriptions.PolicySetDefinitionsClientListByManagementGroupResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
