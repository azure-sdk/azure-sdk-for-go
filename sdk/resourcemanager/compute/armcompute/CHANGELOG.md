...
- Function `*ClientFactory.NewGalleriesClient` parameter(s) have been changed from `(<none>)` to `(string)`
- Function `*ClientFactory.NewGalleryApplicationVersionsClient` parameter(s) have been changed from `(<none>)` to `(string)`
- Function `*ClientFactory.NewGalleryApplicationsClient` parameter(s) have been changed from `(<none>)` to `(string)`
- Function `*ClientFactory.NewGalleryImageVersionsClient` parameter(s) have been changed from `(<none>)` to `(string)`
- Function `*ClientFactory.NewGalleryImagesClient` parameter(s) have been changed from `(<none>)` to `(string)`
- Function `*ClientFactory.NewGalleryInVMAccessControlProfileVersionsClient` parameter(s) have been changed from `(<none>)` to `(string)`
- Function `*ClientFactory.NewGalleryInVMAccessControlProfilesClient` parameter(s) have been changed from `(<none>)` to `(string)`
- Function `*ClientFactory.NewGallerySharingProfileClient` parameter(s) have been changed from `(<none>)` to `(string)`
- Function `*ClientFactory.NewSoftDeletedResourceClient` parameter(s) have been changed from `(<none>)` to `(string)`
...
- New function `*ClientFactory.NewGalleryScriptVersionsClient(string, string, string) *GalleryScriptVersionsClient`
- New function `*ClientFactory.NewGalleryScriptsClient(string, string) *GalleryScriptsClient`
