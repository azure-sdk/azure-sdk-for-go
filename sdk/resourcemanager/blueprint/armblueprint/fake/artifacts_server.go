...
func (a *ArtifactsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if artifactsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = artifactsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to ArtifactsServerTransport
var artifactsServerTransportInterceptor interface {
