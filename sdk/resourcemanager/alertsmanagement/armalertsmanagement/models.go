...
// ClientPrometheusRuleGroupsListBySubscriptionOptions contains the optional parameters for the Client.NewPrometheusRuleGroupsListBySubscriptionPager
// method.
type ClientPrometheusRuleGroupsListBySubscriptionOptions struct {
	// placeholder for future optional parameters
}
...
type PrometheusRule struct {
	// REQUIRED; The PromQL expression to evaluate. Every evaluation cycle this is evaluated at the current time, and the result
	// recorded as a new set of time series with the metric name as given by 'record'.
	...
	// relevant for alerts.
	Actions *PrometheusRuleGroupActions `json:"actions,omitempty"`
...
// PrometheusRuleGroupActions - An alert action. Only relevant for alerts.
type PrometheusRuleGroupActions struct {
	// The resource ids of the action group to use.
	...
	// The custom properties of an action group object.
...
type PrometheusRuleGroupProperties struct {
	...
	// REQUIRED; The list of azure resource id's that this rule group is scoped to.
	Scopes []*string `json:"scopes,omitempty"`
