...
func (a *ApplicationResourcesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if applicationResourcesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = applicationResourcesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "ApplicationResourcesClient.NewListByApplicationPager":
				res.resp, res.err = a.dispatchNewListByApplicationPager(req)
...
// set this to conditionally intercept incoming requests to ApplicationResourcesServerTransport
var applicationResourcesServerTransportInterceptor interface {
