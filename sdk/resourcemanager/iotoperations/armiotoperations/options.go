...
// AkriDiscoveryHandlerClientBeginCreateOrUpdateOptions contains the optional parameters for the AkriDiscoveryHandlerClient.BeginCreateOrUpdate
// method.
type AkriDiscoveryHandlerClientBeginCreateOrUpdateOptions struct {
	// Resumes the long-running operation from the provided token.
	ResumeToken string
}

// AkriDiscoveryHandlerClientBeginDeleteOptions contains the optional parameters for the AkriDiscoveryHandlerClient.BeginDelete
// method.
type AkriDiscoveryHandlerClientBeginDeleteOptions struct {
	// Resumes the long-running operation from the provided token.
	ResumeToken string
}

// AkriDiscoveryHandlerClientGetOptions contains the optional parameters for the AkriDiscoveryHandlerClient.Get method.
type AkriDiscoveryHandlerClientGetOptions struct {
	// placeholder for future optional parameters
}

// AkriDiscoveryHandlerClientListByInstanceResourceOptions contains the optional parameters for the AkriDiscoveryHandlerClient.NewListByInstanceResourcePager
// method.
type AkriDiscoveryHandlerClientListByInstanceResourceOptions struct {
	// placeholder for future optional parameters
}
...
// DiagnosticClientListByInstanceResourceOptions contains the optional parameters for the DiagnosticClient.NewListByInstanceResourcePager
// method.
type DiagnosticClientListByInstanceResourceOptions struct {
	// placeholder for future optional parameters
}
