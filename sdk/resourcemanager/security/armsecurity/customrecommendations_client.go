...
func (client *CustomRecommendationsClient) deleteCreateRequest(ctx context.Context, scope string, customRecommendationName string, options *CustomRecommendationsClientDeleteOptions) (*policy.Request, error) {
	urlPath := "/{scope}/providers/Microsoft.Security/customRecommendations/{customRecommendationName}"
	if scope == "" {
		return nil, errors.New("parameter scope cannot be empty")
	}
