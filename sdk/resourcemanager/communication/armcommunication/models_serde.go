...
// MarshalJSON implements the json.Marshaller interface for type RemoveValidSenderUsernameParameters.
func (r RemoveValidSenderUsernameParameters) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "validSenderUsernameList", r.ValidSenderUsernameList)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type RemoveValidSenderUsernameParameters.
func (r *RemoveValidSenderUsernameParameters) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", r, err)
	}
	for key, val := range rawMsg {
		var err error
		switch key {
		case "validSenderUsernameList":
			err = unpopulate(val, "ValidSenderUsernameList", &r.ValidSenderUsernameList)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", r, err)
...
// MarshalJSON implements the json.Marshaller interface for type SuppressionListAddRequest.
func (s SuppressionListAddRequest) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "addressInfoList", s.AddressInfoList)
	populate(objectMap, "validSenderUsername", s.ValidSenderUsername)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type SuppressionListAddRequest.
func (s *SuppressionListAddRequest) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
	for key, val := range rawMsg {
		var err error
		switch key {
		case "addressInfoList":
			err = unpopulate(val, "AddressInfoList", &s.AddressInfoList)
			delete(rawMsg, key)
		case "validSenderUsername":
			err = unpopulate(val, "ValidSenderUsername", &s.ValidSenderUsername)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", s, err)
...
// MarshalJSON implements the json.Marshaller interface for type SuppressionListAddressInfo.
func (s SuppressionListAddressInfo) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type SuppressionListAddressInfo.
func (s *SuppressionListAddressInfo) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type SuppressionListRecordDto.
func (s SuppressionListRecordDto) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "email", s.Email)
	populate(objectMap, "firstName", s.FirstName)
	populate(objectMap, "lastName", s.LastName)
	populate(objectMap, "lastUpdated", s.LastUpdated)
	populate(objectMap, "listId", s.ListID)
	populate(objectMap, "notes", s.Notes)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type SuppressionListRecordDto.
func (s *SuppressionListRecordDto) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
	for key, val := range rawMsg {
		...
		case "lastUpdated":
			...
			delete(rawMsg, key)
		case "listId":
			err = unpopulate(val, "ListID", &s.ListID)
			delete(rawMsg, key)
		case "notes":
			err = unpopulate(val, "Notes", &s.Notes)
			delete(rawMsg, key)
...
// MarshalJSON implements the json.Marshaller interface for type SuppressionListRemoveRequest.
func (s SuppressionListRemoveRequest) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type SuppressionListRemoveRequest.
func (s *SuppressionListRemoveRequest) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "addresses":
			err = unpopulate(val, "Addresses", &s.Addresses)
			delete(rawMsg, key)
		case "validSenderUsername":
			err = unpopulate(val, "ValidSenderUsername", &s.ValidSenderUsername)
			delete(rawMsg, key)
...
// MarshalJSON implements the json.Marshaller interface for type SuppressionListRequest.
func (s SuppressionListRequest) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "validSenderUsername", s.ValidSenderUsername)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type SuppressionListRequest.
func (s *SuppressionListRequest) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type SuppressionListResponse.
func (s SuppressionListResponse) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "nextLink", s.NextLink)
	populate(objectMap, "value", s.Value)
	return json.Marshal(objectMap)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type SuppressionListResponse.
func (s *SuppressionListResponse) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type ValidSenderUsername.
func (v ValidSenderUsername) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type ValidSenderUsername.
func (v *ValidSenderUsername) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
...
// MarshalJSON implements the json.Marshaller interface for type ValidSenderUsernameCollection.
func (v ValidSenderUsernameCollection) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "value", v.Value)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ValidSenderUsernameCollection.
func (v *ValidSenderUsernameCollection) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", v, err)
	}
