...
func (client *SchemaRegistriesClient) createOrReplaceCreateRequest(ctx context.Context, resourceGroupName string, schemaRegistryName string, resource SchemaRegistry, options *SchemaRegistriesClientBeginCreateOrReplaceOptions) (*policy.Request, error) {
...
func (client *SchemaRegistriesClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, schemaRegistryName string, options *SchemaRegistriesClientBeginDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DeviceRegistry/schemaRegistries/{schemaRegistryName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *SchemaRegistriesClient) getCreateRequest(ctx context.Context, resourceGroupName string, schemaRegistryName string, options *SchemaRegistriesClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DeviceRegistry/schemaRegistries/{schemaRegistryName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *SchemaRegistriesClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, options *SchemaRegistriesClientListByResourceGroupOptions) (*policy.Request, error) {
...
func (client *SchemaRegistriesClient) listBySubscriptionCreateRequest(ctx context.Context, options *SchemaRegistriesClientListBySubscriptionOptions) (*policy.Request, error) {
...
func (client *SchemaRegistriesClient) updateCreateRequest(ctx context.Context, resourceGroupName string, schemaRegistryName string, properties SchemaRegistryUpdate, options *SchemaRegistriesClientBeginUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DeviceRegistry/schemaRegistries/{schemaRegistryName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
