...
// GetTrial implements the TrialClassification interface for type Trial.
func (t *Trial) GetTrial() *Trial { return t }
...
// GetTrial implements the TrialClassification interface for type TrialComponent.
func (t *TrialComponent) GetTrial() *Trial {
	return &Trial{
		TrialType: t.TrialType,
	}
}

type TrialPipelineComponent struct {
	// REQUIRED; Name of policy configuration
	TrialType *TrialType
...
// GetTrial implements the TrialClassification interface for type TrialPipelineComponent.
func (t *TrialPipelineComponent) GetTrial() *Trial {
	return &Trial{
		TrialType: t.TrialType,
	}
}
