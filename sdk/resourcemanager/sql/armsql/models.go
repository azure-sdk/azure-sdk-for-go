...
// BaseLongTermRetentionPolicyPropertiesAutoGenerated - Properties of a long term retention policy
type BaseLongTermRetentionPolicyPropertiesAutoGenerated struct {
	// The monthly retention policy for an LTR backup in an ISO 8601 format.
	MonthlyRetention *string `json:"monthlyRetention,omitempty"`
...
type DatabaseExtensionsProperties struct {
	...
	// REQUIRED; Storage key for the storage account.
	StorageKey *string `json:"storageKey,omitempty"`

	// REQUIRED; Storage key type: StorageAccessKey or SharedAccessKey.
...
type DatabaseOperationProperties struct {
	...
	OperationPhaseDetails *PhaseDetails `json:"operationPhaseDetails,omitempty" azure:"ro"`
...
type DistributedAvailabilityGroupProperties struct {
	...
	// READ-ONLY; Role of managed instance
	InstanceRole *string `json:"instanceRole,omitempty" azure:"ro"`
...
type DistributedAvailabilityGroupSetRole struct {
	...
	InstanceRole *InstanceRole `json:"instanceRole,omitempty"`

	// REQUIRED; The type of the role change, can be Planned or Forced.
	RoleChangeType *RoleChangeType `json:"roleChangeType,omitempty"`
}
...
type EditionCapability struct {
	...
	ZonePinning *bool `json:"zonePinning,omitempty" azure:"ro"`
...
// JobExecutionAutoGenerated - An execution of a job
type JobExecutionAutoGenerated struct {
	// Resource properties.
	Properties *JobExecutionPropertiesAutoGenerated `json:"properties,omitempty"`
...
// JobExecutionAutoGenerated2 - An execution of a job
type JobExecutionAutoGenerated2 struct {
	// Resource properties.
	Properties *JobExecutionPropertiesAutoGenerated2 `json:"properties,omitempty"`
...
// JobExecutionListResultAutoGenerated - A list of job executions.
type JobExecutionListResultAutoGenerated struct {
	// READ-ONLY; Link to retrieve next page of results.
	NextLink *string `json:"nextLink,omitempty" azure:"ro"`

	// READ-ONLY; Array of results.
	Value []*JobExecutionAutoGenerated `json:"value,omitempty" azure:"ro"`
}

// JobExecutionListResultAutoGenerated2 - A list of job executions.
type JobExecutionListResultAutoGenerated2 struct {
	// READ-ONLY; Link to retrieve next page of results.
	NextLink *string `json:"nextLink,omitempty" azure:"ro"`

	// READ-ONLY; Array of results.
	Value []*JobExecutionAutoGenerated2 `json:"value,omitempty" azure:"ro"`
}
...
// JobExecutionPropertiesAutoGenerated - Properties for an Azure SQL Database Elastic job execution.
type JobExecutionPropertiesAutoGenerated struct {
	// Number of times the job execution has been attempted.
	CurrentAttempts *int32 `json:"currentAttempts,omitempty"`
...
// JobExecutionPropertiesAutoGenerated2 - Properties for an Azure SQL Database Elastic job execution.
type JobExecutionPropertiesAutoGenerated2 struct {
	// Number of times the job execution has been attempted.
	CurrentAttempts *int32 `json:"currentAttempts,omitempty"`
...
type ManagedInstanceLongTermRetentionPolicy struct {
	// Resource properties.
	Properties *BaseLongTermRetentionPolicyPropertiesAutoGenerated `json:"properties,omitempty"`
...
type ManagedInstanceOperationSteps struct {
	...
	StepsList []*UpsertManagedServerOperationStepWithEstimatesAndDuration `json:"stepsList,omitempty" azure:"ro"`
...
type ManagedInstanceProperties struct {
	...
	VirtualClusterID *string `json:"virtualClusterId,omitempty" azure:"ro"`
}
...
type PhaseDetails struct {
	...
	Phase *Phase `json:"phase,omitempty" azure:"ro"`

	// READ-ONLY; The operation phase information.
	PhaseInformation map[string]*string `json:"phaseInformation,omitempty" azure:"ro"`
}
...
type RecommendedActionProperties struct {
	...
	Details map[string]any `json:"details,omitempty" azure:"ro"`
...
type ReplicationLinkProperties struct {
	...
	PartnerDatabaseID *string `json:"partnerDatabaseId,omitempty" azure:"ro"`
...
type ServerProperties struct {
	...
	ExternalGovernanceStatus *ExternalGovernanceStatus `json:"externalGovernanceStatus,omitempty" azure:"ro"`
...
type UpsertManagedServerOperationStepWithEstimatesAndDuration struct {
	...
	StepEndTime   *time.Time `json:"stepEndTime,omitempty"`
...
type VulnerabilityAssessmentScanRecordForSQLProperties struct {
	...
	LastScanTime *time.Time `json:"lastScanTime,omitempty" azure:"ro"`
