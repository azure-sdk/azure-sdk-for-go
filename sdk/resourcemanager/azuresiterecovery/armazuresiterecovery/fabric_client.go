...
func NewFabricClient(credential azcore.TokenCredential, options *arm.ClientOptions) (*FabricClient, error) {
...
func (client *FabricClient) BeginCreate(ctx context.Context, subscriptionID string, resourceGroupName string, fabricName string, body FabricModel, options *FabricClientBeginCreateOptions) (*runtime.Poller[FabricClientCreateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.create(ctx, subscriptionID, resourceGroupName, fabricName, body, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2021-02-16-preview
func (client *FabricClient) create(ctx context.Context, subscriptionID string, resourceGroupName string, fabricName string, body FabricModel, options *FabricClientBeginCreateOptions) (*http.Response, error) {
	var err error
	req, err := client.createCreateRequest(ctx, subscriptionID, resourceGroupName, fabricName, body, options)
	if err != nil {
		return nil, err
	}
...
func (client *FabricClient) createCreateRequest(ctx context.Context, subscriptionID string, resourceGroupName string, fabricName string, body FabricModel, options *FabricClientBeginCreateOptions) (*policy.Request, error) {
...
func (client *FabricClient) BeginDelete(ctx context.Context, subscriptionID string, resourceGroupName string, fabricName string, options *FabricClientBeginDeleteOptions) (*runtime.Poller[FabricClientDeleteResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.deleteOperation(ctx, subscriptionID, resourceGroupName, fabricName, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2021-02-16-preview
func (client *FabricClient) deleteOperation(ctx context.Context, subscriptionID string, resourceGroupName string, fabricName string, options *FabricClientBeginDeleteOptions) (*http.Response, error) {
	var err error
	req, err := client.deleteCreateRequest(ctx, subscriptionID, resourceGroupName, fabricName, options)
	if err != nil {
		return nil, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
...
func (client *FabricClient) deleteCreateRequest(ctx context.Context, subscriptionID string, resourceGroupName string, fabricName string, options *FabricClientBeginDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataReplication/replicationFabrics/{fabricName}"
	if subscriptionID == "" {
		return nil, errors.New("parameter subscriptionID cannot be empty")
	}
...
func (client *FabricClient) Get(ctx context.Context, subscriptionID string, resourceGroupName string, fabricName string, options *FabricClientGetOptions) (FabricClientGetResponse, error) {
	var err error
	req, err := client.getCreateRequest(ctx, subscriptionID, resourceGroupName, fabricName, options)
	if err != nil {
...
func (client *FabricClient) getCreateRequest(ctx context.Context, subscriptionID string, resourceGroupName string, fabricName string, options *FabricClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataReplication/replicationFabrics/{fabricName}"
	if subscriptionID == "" {
		return nil, errors.New("parameter subscriptionID cannot be empty")
	}
...
func (client *FabricClient) NewListPager(subscriptionID string, resourceGroupName string, options *FabricClientListOptions) *runtime.Pager[FabricClientListResponse] {
...
func (client *FabricClient) listCreateRequest(ctx context.Context, subscriptionID string, resourceGroupName string, options *FabricClientListOptions) (*policy.Request, error) {
...
//     method.
func (client *FabricClient) NewListBySubscriptionPager(subscriptionID string, options *FabricClientListBySubscriptionOptions) *runtime.Pager[FabricClientListBySubscriptionResponse] {
...
func (client *FabricClient) listBySubscriptionCreateRequest(ctx context.Context, subscriptionID string, options *FabricClientListBySubscriptionOptions) (*policy.Request, error) {
...
func (client *FabricClient) BeginUpdate(ctx context.Context, subscriptionID string, resourceGroupName string, fabricName string, body FabricModelUpdate, options *FabricClientBeginUpdateOptions) (*runtime.Poller[FabricClientUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.update(ctx, subscriptionID, resourceGroupName, fabricName, body, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2021-02-16-preview
func (client *FabricClient) update(ctx context.Context, subscriptionID string, resourceGroupName string, fabricName string, body FabricModelUpdate, options *FabricClientBeginUpdateOptions) (*http.Response, error) {
	var err error
	req, err := client.updateCreateRequest(ctx, subscriptionID, resourceGroupName, fabricName, body, options)
	if err != nil {
		return nil, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
...
func (client *FabricClient) updateCreateRequest(ctx context.Context, subscriptionID string, resourceGroupName string, fabricName string, body FabricModelUpdate, options *FabricClientBeginUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataReplication/replicationFabrics/{fabricName}"
	if subscriptionID == "" {
		return nil, errors.New("parameter subscriptionID cannot be empty")
	}
