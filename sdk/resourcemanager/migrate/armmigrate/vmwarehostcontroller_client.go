...
func (client *VmwareHostControllerClient) getCreateRequest(ctx context.Context, resourceGroupName string, siteName string, hostName string, _ *VmwareHostControllerClientGetOptions) (*policy.Request, error) {
...
func (client *VmwareHostControllerClient) listByVmwareSiteCreateRequest(ctx context.Context, resourceGroupName string, siteName string, _ *VmwareHostControllerClientListByVmwareSiteOptions) (*policy.Request, error) {
