...
func (c Component) MarshalJSON() ([]byte, error) {
	...
	populateTimeRFC3339(objectMap, "releaseDate", c.ReleaseDate)
...
func (c CryptoCertificate) MarshalJSON() ([]byte, error) {
	...
	populateTimeRFC3339(objectMap, "issuedDate", c.IssuedDate)
...
func (c *CryptoCertificate) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "isWeakSignature":
			...
			delete(rawMsg, key)
		case "issuedDate":
			err = unpopulateTimeRFC3339(val, "IssuedDate", &c.IssuedDate)
			delete(rawMsg, key)
		case "issuer":
...
func (c Cve) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "name", c.Name)
	populateTimeRFC3339(objectMap, "publishDate", c.PublishDate)
	populate(objectMap, "severity", c.Severity)
	populateTimeRFC3339(objectMap, "updatedDate", c.UpdatedDate)
	return json.Marshal(objectMap)
}
...
func (c *Cve) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "name":
			...
			delete(rawMsg, key)
		case "publishDate":
			err = unpopulateTimeRFC3339(val, "PublishDate", &c.PublishDate)
			delete(rawMsg, key)
		case "severity":
			err = unpopulate(val, "Severity", &c.Severity)
			delete(rawMsg, key)
		case "updatedDate":
			err = unpopulateTimeRFC3339(val, "UpdatedDate", &c.UpdatedDate)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", c, err)
