...
// ContainerAppsLabelsClientBeginCreateOrUpdateOptions contains the optional parameters for the ContainerAppsLabelsClient.BeginCreateOrUpdate
// method.
type ContainerAppsLabelsClientBeginCreateOrUpdateOptions struct {
	// Resumes the LRO from the provided token.
	ResumeToken string
}

// ContainerAppsLabelsClientBeginDeleteOptions contains the optional parameters for the ContainerAppsLabelsClient.BeginDelete
// method.
type ContainerAppsLabelsClientBeginDeleteOptions struct {
	// Resumes the LRO from the provided token.
	ResumeToken string
}

// ContainerAppsLabelsClientGetOptions contains the optional parameters for the ContainerAppsLabelsClient.Get method.
type ContainerAppsLabelsClientGetOptions struct {
	// placeholder for future optional parameters
}

// ContainerAppsLabelsClientListOptions contains the optional parameters for the ContainerAppsLabelsClient.NewListPager method.
type ContainerAppsLabelsClientListOptions struct {
	// placeholder for future optional parameters
}
