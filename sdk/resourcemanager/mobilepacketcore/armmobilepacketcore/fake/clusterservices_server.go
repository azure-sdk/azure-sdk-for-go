...
func (c *ClusterServicesServerTransport) dispatchCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := c.srv.CreateOrUpdate(req.Context(), resourceGroupNameParam, clusterServiceNameParam, body, nil)
