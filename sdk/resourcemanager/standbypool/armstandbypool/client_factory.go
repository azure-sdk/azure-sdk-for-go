...
func (c *ClientFactory) NewStandbyContainerGroupPoolsClient() *StandbyContainerGroupPoolsClient {
	subClient, _ := NewStandbyContainerGroupPoolsClient(c.subscriptionID, c.credential, c.options)
	return subClient
}
...
func (c *ClientFactory) NewStandbyVirtualMachinePoolsClient() *StandbyVirtualMachinePoolsClient {
	subClient, _ := NewStandbyVirtualMachinePoolsClient(c.subscriptionID, c.credential, c.options)
	return subClient
}
...
func (c *ClientFactory) NewStandbyVirtualMachinesClient() *StandbyVirtualMachinesClient {
	subClient, _ := NewStandbyVirtualMachinesClient(c.subscriptionID, c.credential, c.options)
	return subClient
}
