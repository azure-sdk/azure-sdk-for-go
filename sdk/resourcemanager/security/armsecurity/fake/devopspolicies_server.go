...
func (d *DevOpsPoliciesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if devOpsPoliciesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = devOpsPoliciesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to DevOpsPoliciesServerTransport
var devOpsPoliciesServerTransportInterceptor interface {
