...
type VirtualNetworkAddressesServer struct {
	...
	// NewListByParentPager is the fake for method VirtualNetworkAddressesClient.NewListByParentPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByParentPager func(resourceGroupName string, cloudvmclustername string, options *armoracledatabase.VirtualNetworkAddressesClientListByParentOptions) (resp azfake.PagerResponder[armoracledatabase.VirtualNetworkAddressesClientListByParentResponse])
}
...
func NewVirtualNetworkAddressesServerTransport(srv *VirtualNetworkAddressesServer) *VirtualNetworkAddressesServerTransport {
	return &VirtualNetworkAddressesServerTransport{
		...
		newListByParentPager: newTracker[azfake.PagerResponder[armoracledatabase.VirtualNetworkAddressesClientListByParentResponse]](),
	}
}
...
type VirtualNetworkAddressesServerTransport struct {
	...
	newListByParentPager *tracker[azfake.PagerResponder[armoracledatabase.VirtualNetworkAddressesClientListByParentResponse]]
}
...
func (v *VirtualNetworkAddressesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		if !intercepted {
			...
			case "VirtualNetworkAddressesClient.NewListByParentPager":
				res.resp, res.err = v.dispatchNewListByParentPager(req)
			default:
...
func (v *VirtualNetworkAddressesServerTransport) dispatchNewListByParentPager(req *http.Request) (*http.Response, error) {
	if v.srv.NewListByParentPager == nil {
		return nil, &nonRetriableError{errors.New("fake for method NewListByParentPager not implemented")}
	}
	newListByParentPager := v.newListByParentPager.get(req)
	if newListByParentPager == nil {
		...
		resp := v.srv.NewListByParentPager(resourceGroupNameParam, cloudvmclusternameParam, nil)
		newListByParentPager = &resp
		v.newListByParentPager.add(req, newListByParentPager)
		server.PagerResponderInjectNextLinks(newListByParentPager, req, func(page *armoracledatabase.VirtualNetworkAddressesClientListByParentResponse, createLink func() string) {
	...
	if !contains([]int{http.StatusOK}, resp.StatusCode) {
		v.newListByParentPager.remove(req)
