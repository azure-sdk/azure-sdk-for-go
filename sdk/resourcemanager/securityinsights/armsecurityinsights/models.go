...
// PremiumMdtiDataConnectorDataTypes - The available data types for Premium Microsoft Defender for Threat Intelligence data
// connector.
type PremiumMdtiDataConnectorDataTypes struct {
	// REQUIRED; Data type for Premium Microsoft Defender for Threat Intelligence data connector.
	Connector *PremiumMdtiDataConnectorDataTypesConnector
}

// PremiumMdtiDataConnectorDataTypesConnector - Data type for Premium Microsoft Defender for Threat Intelligence data connector.
type PremiumMdtiDataConnectorDataTypesConnector struct {
	// Describe whether this data type connection is enabled or not.
	State *DataTypeState
}

// PremiumMdtiDataConnectorProperties - Premium Microsoft Defender for Threat Intelligence data connector properties.
...
// PremiumMicrosoftDefenderForThreatIntelligence - Represents Premium Microsoft Defender for Threat Intelligence data connector.
