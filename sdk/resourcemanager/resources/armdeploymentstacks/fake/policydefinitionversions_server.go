...
// PolicyDefinitionVersionsServer is a fake server for instances of the armdeploymentstacks.PolicyDefinitionVersionsClient type.
type PolicyDefinitionVersionsServer struct {
	...
	CreateOrUpdate func(ctx context.Context, policyDefinitionName string, policyDefinitionVersion string, parameters armdeploymentstacks.PolicyDefinitionVersion, options *armdeploymentstacks.PolicyDefinitionVersionsClientCreateOrUpdateOptions) (resp azfake.Responder[armdeploymentstacks.PolicyDefinitionVersionsClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)

	// CreateOrUpdateAtManagementGroup is the fake for method PolicyDefinitionVersionsClient.CreateOrUpdateAtManagementGroup
	// HTTP status codes to indicate success: http.StatusOK, http.StatusCreated
	CreateOrUpdateAtManagementGroup func(ctx context.Context, managementGroupName string, policyDefinitionName string, policyDefinitionVersion string, parameters armdeploymentstacks.PolicyDefinitionVersion, options *armdeploymentstacks.PolicyDefinitionVersionsClientCreateOrUpdateAtManagementGroupOptions) (resp azfake.Responder[armdeploymentstacks.PolicyDefinitionVersionsClientCreateOrUpdateAtManagementGroupResponse], errResp azfake.ErrorResponder)

	// Delete is the fake for method PolicyDefinitionVersionsClient.Delete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	Delete func(ctx context.Context, policyDefinitionName string, policyDefinitionVersion string, options *armdeploymentstacks.PolicyDefinitionVersionsClientDeleteOptions) (resp azfake.Responder[armdeploymentstacks.PolicyDefinitionVersionsClientDeleteResponse], errResp azfake.ErrorResponder)

	// DeleteAtManagementGroup is the fake for method PolicyDefinitionVersionsClient.DeleteAtManagementGroup
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	DeleteAtManagementGroup func(ctx context.Context, managementGroupName string, policyDefinitionName string, policyDefinitionVersion string, options *armdeploymentstacks.PolicyDefinitionVersionsClientDeleteAtManagementGroupOptions) (resp azfake.Responder[armdeploymentstacks.PolicyDefinitionVersionsClientDeleteAtManagementGroupResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method PolicyDefinitionVersionsClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, policyDefinitionName string, policyDefinitionVersion string, options *armdeploymentstacks.PolicyDefinitionVersionsClientGetOptions) (resp azfake.Responder[armdeploymentstacks.PolicyDefinitionVersionsClientGetResponse], errResp azfake.ErrorResponder)

	// GetAtManagementGroup is the fake for method PolicyDefinitionVersionsClient.GetAtManagementGroup
	// HTTP status codes to indicate success: http.StatusOK
	GetAtManagementGroup func(ctx context.Context, managementGroupName string, policyDefinitionName string, policyDefinitionVersion string, options *armdeploymentstacks.PolicyDefinitionVersionsClientGetAtManagementGroupOptions) (resp azfake.Responder[armdeploymentstacks.PolicyDefinitionVersionsClientGetAtManagementGroupResponse], errResp azfake.ErrorResponder)

	// GetBuiltIn is the fake for method PolicyDefinitionVersionsClient.GetBuiltIn
	// HTTP status codes to indicate success: http.StatusOK
	GetBuiltIn func(ctx context.Context, policyDefinitionName string, policyDefinitionVersion string, options *armdeploymentstacks.PolicyDefinitionVersionsClientGetBuiltInOptions) (resp azfake.Responder[armdeploymentstacks.PolicyDefinitionVersionsClientGetBuiltInResponse], errResp azfake.ErrorResponder)

	// NewListPager is the fake for method PolicyDefinitionVersionsClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(policyDefinitionName string, options *armdeploymentstacks.PolicyDefinitionVersionsClientListOptions) (resp azfake.PagerResponder[armdeploymentstacks.PolicyDefinitionVersionsClientListResponse])

	// ListAll is the fake for method PolicyDefinitionVersionsClient.ListAll
	// HTTP status codes to indicate success: http.StatusOK
	ListAll func(ctx context.Context, options *armdeploymentstacks.PolicyDefinitionVersionsClientListAllOptions) (resp azfake.Responder[armdeploymentstacks.PolicyDefinitionVersionsClientListAllResponse], errResp azfake.ErrorResponder)

	// ListAllAtManagementGroup is the fake for method PolicyDefinitionVersionsClient.ListAllAtManagementGroup
	// HTTP status codes to indicate success: http.StatusOK
	ListAllAtManagementGroup func(ctx context.Context, managementGroupName string, options *armdeploymentstacks.PolicyDefinitionVersionsClientListAllAtManagementGroupOptions) (resp azfake.Responder[armdeploymentstacks.PolicyDefinitionVersionsClientListAllAtManagementGroupResponse], errResp azfake.ErrorResponder)

	// ListAllBuiltins is the fake for method PolicyDefinitionVersionsClient.ListAllBuiltins
	// HTTP status codes to indicate success: http.StatusOK
	ListAllBuiltins func(ctx context.Context, options *armdeploymentstacks.PolicyDefinitionVersionsClientListAllBuiltinsOptions) (resp azfake.Responder[armdeploymentstacks.PolicyDefinitionVersionsClientListAllBuiltinsResponse], errResp azfake.ErrorResponder)

	// NewListBuiltInPager is the fake for method PolicyDefinitionVersionsClient.NewListBuiltInPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListBuiltInPager func(policyDefinitionName string, options *armdeploymentstacks.PolicyDefinitionVersionsClientListBuiltInOptions) (resp azfake.PagerResponder[armdeploymentstacks.PolicyDefinitionVersionsClientListBuiltInResponse])

	// NewListByManagementGroupPager is the fake for method PolicyDefinitionVersionsClient.NewListByManagementGroupPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByManagementGroupPager func(managementGroupName string, policyDefinitionName string, options *armdeploymentstacks.PolicyDefinitionVersionsClientListByManagementGroupOptions) (resp azfake.PagerResponder[armdeploymentstacks.PolicyDefinitionVersionsClientListByManagementGroupResponse])
}
...
// The returned PolicyDefinitionVersionsServerTransport instance is connected to an instance of armdeploymentstacks.PolicyDefinitionVersionsClient via the
...
func NewPolicyDefinitionVersionsServerTransport(srv *PolicyDefinitionVersionsServer) *PolicyDefinitionVersionsServerTransport {
	return &PolicyDefinitionVersionsServerTransport{
		srv:                           srv,
		newListPager:                  newTracker[azfake.PagerResponder[armdeploymentstacks.PolicyDefinitionVersionsClientListResponse]](),
		newListBuiltInPager:           newTracker[azfake.PagerResponder[armdeploymentstacks.PolicyDefinitionVersionsClientListBuiltInResponse]](),
		newListByManagementGroupPager: newTracker[azfake.PagerResponder[armdeploymentstacks.PolicyDefinitionVersionsClientListByManagementGroupResponse]](),
	}
}

// PolicyDefinitionVersionsServerTransport connects instances of armdeploymentstacks.PolicyDefinitionVersionsClient to instances of PolicyDefinitionVersionsServer.
...
type PolicyDefinitionVersionsServerTransport struct {
	...
	newListPager                  *tracker[azfake.PagerResponder[armdeploymentstacks.PolicyDefinitionVersionsClientListResponse]]
	newListBuiltInPager           *tracker[azfake.PagerResponder[armdeploymentstacks.PolicyDefinitionVersionsClientListBuiltInResponse]]
	newListByManagementGroupPager *tracker[azfake.PagerResponder[armdeploymentstacks.PolicyDefinitionVersionsClientListByManagementGroupResponse]]
}
...
func (p *PolicyDefinitionVersionsServerTransport) dispatchCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[armdeploymentstacks.PolicyDefinitionVersion](req)
	if err != nil {
		return nil, err
	}
...
func (p *PolicyDefinitionVersionsServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		var options *armdeploymentstacks.PolicyDefinitionVersionsClientListOptions
		if topParam != nil {
			options = &armdeploymentstacks.PolicyDefinitionVersionsClientListOptions{
				Top: topParam,
			}
		}
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armdeploymentstacks.PolicyDefinitionVersionsClientListResponse, createLink func() string) {
...
func (p *PolicyDefinitionVersionsServerTransport) dispatchNewListBuiltInPager(req *http.Request) (*http.Response, error) {
	...
	if newListBuiltInPager == nil {
		...
		var options *armdeploymentstacks.PolicyDefinitionVersionsClientListBuiltInOptions
		if topParam != nil {
			options = &armdeploymentstacks.PolicyDefinitionVersionsClientListBuiltInOptions{
				Top: topParam,
			}
		}
		...
		server.PagerResponderInjectNextLinks(newListBuiltInPager, req, func(page *armdeploymentstacks.PolicyDefinitionVersionsClientListBuiltInResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
...
func (p *PolicyDefinitionVersionsServerTransport) dispatchNewListByManagementGroupPager(req *http.Request) (*http.Response, error) {
	...
	if newListByManagementGroupPager == nil {
		...
		var options *armdeploymentstacks.PolicyDefinitionVersionsClientListByManagementGroupOptions
		if topParam != nil {
			options = &armdeploymentstacks.PolicyDefinitionVersionsClientListByManagementGroupOptions{
				Top: topParam,
			}
		}
		...
		server.PagerResponderInjectNextLinks(newListByManagementGroupPager, req, func(page *armdeploymentstacks.PolicyDefinitionVersionsClientListByManagementGroupResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
