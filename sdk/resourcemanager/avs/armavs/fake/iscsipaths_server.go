...
type IscsiPathsServer struct {
	...
	BeginDelete func(ctx context.Context, resourceGroupName string, privateCloudName string, iscsiPathName string, options *armavs.IscsiPathsClientBeginDeleteOptions) (resp azfake.PollerResponder[armavs.IscsiPathsClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method IscsiPathsClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, privateCloudName string, iscsiPathName string, options *armavs.IscsiPathsClientGetOptions) (resp azfake.Responder[armavs.IscsiPathsClientGetResponse], errResp azfake.ErrorResponder)
...
func (i *IscsiPathsServerTransport) dispatchBeginCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginCreateOrUpdate == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.AVS/privateClouds/(?P<privateCloudName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/iscsiPaths/(?P<iscsiPathName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)`
		...
		iscsiPathNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("iscsiPathName")])
		if err != nil {
			return nil, err
		}
		respr, errRespr := i.srv.BeginCreateOrUpdate(req.Context(), resourceGroupNameParam, privateCloudNameParam, iscsiPathNameParam, body, nil)
...
func (i *IscsiPathsServerTransport) dispatchBeginDelete(req *http.Request) (*http.Response, error) {
	...
	if beginDelete == nil {
		...
		respr, errRespr := i.srv.BeginDelete(req.Context(), resourceGroupNameParam, privateCloudNameParam, iscsiPathNameParam, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginDelete = &respr
...
func (i *IscsiPathsServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := i.srv.Get(req.Context(), resourceGroupNameParam, privateCloudNameParam, iscsiPathNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
