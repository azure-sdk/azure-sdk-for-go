...
func (p *PeeringPoliciesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if peeringPoliciesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = peeringPoliciesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "PeeringPoliciesClient.NewListByManagedNetworkPager":
				res.resp, res.err = p.dispatchNewListByManagedNetworkPager(req)
			default:
...
// set this to conditionally intercept incoming requests to PeeringPoliciesServerTransport
var peeringPoliciesServerTransportInterceptor interface {
