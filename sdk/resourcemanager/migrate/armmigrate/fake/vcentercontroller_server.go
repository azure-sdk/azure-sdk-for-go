...
type VcenterControllerServer struct {
	...
	// Delete is the fake for method VcenterControllerClient.Delete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	Delete func(ctx context.Context, resourceGroupName string, siteName string, vcenterName string, options *armmigrate.VcenterControllerClientDeleteOptions) (resp azfake.Responder[armmigrate.VcenterControllerClientDeleteResponse], errResp azfake.ErrorResponder)
...
func (v *VcenterControllerServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if vcenterControllerServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = vcenterControllerServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			case "VcenterControllerClient.BeginCreate":
				res.resp, res.err = v.dispatchBeginCreate(req)
			case "VcenterControllerClient.Delete":
...
func (v *VcenterControllerServerTransport) dispatchDelete(req *http.Request) (*http.Response, error) {
	if v.srv.Delete == nil {
	...
	respr, errRespr := v.srv.Delete(req.Context(), resourceGroupNameParam, siteNameParam, vcenterNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
...
// set this to conditionally intercept incoming requests to VcenterControllerServerTransport
var vcenterControllerServerTransportInterceptor interface {
