...
// options - TenantAccessGitClientGetOptions contains the optional parameters for the TenantAccessGitClient.Get method.
func (client *TenantAccessGitClient) Get(ctx context.Context, resourceGroupName string, serviceName string, accessName AccessIDName, options *TenantAccessGitClientGetOptions) (TenantAccessGitClientGetResponse, error) {
	req, err := client.getCreateRequest(ctx, resourceGroupName, serviceName, accessName, options)
	if err != nil {
		return TenantAccessGitClientGetResponse{}, err
	}
	...
	if !runtime.HasStatusCode(resp, http.StatusOK) {
		return TenantAccessGitClientGetResponse{}, runtime.NewResponseError(resp)
	}
	return client.getHandleResponse(resp)
}

// getCreateRequest creates the Get request.
func (client *TenantAccessGitClient) getCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, accessName AccessIDName, options *TenantAccessGitClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/tenant/{accessName}/git"
...
func (client *TenantAccessGitClient) getHandleResponse(resp *http.Response) (TenantAccessGitClientGetResponse, error) {
	result := TenantAccessGitClientGetResponse{}
