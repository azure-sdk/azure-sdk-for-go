...
func (s *SQLServersServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if sqlServersServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = sqlServersServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to SQLServersServerTransport
var sqlServersServerTransportInterceptor interface {
