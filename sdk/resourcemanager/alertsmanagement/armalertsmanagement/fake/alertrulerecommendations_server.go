...
func (a *AlertRuleRecommendationsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if alertRuleRecommendationsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = alertRuleRecommendationsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			case "AlertRuleRecommendationsClient.NewListByResourcePager":
				res.resp, res.err = a.dispatchNewListByResourcePager(req)
			case "AlertRuleRecommendationsClient.NewListByTargetTypePager":
				res.resp, res.err = a.dispatchNewListByTargetTypePager(req)
			default:
...
// set this to conditionally intercept incoming requests to AlertRuleRecommendationsServerTransport
var alertRuleRecommendationsServerTransportInterceptor interface {
