...
func (client *VirtualMachinesClient) addDataDiskCreateRequest(ctx context.Context, resourceGroupName string, labName string, name string, dataDiskProperties DataDiskProperties, _ *VirtualMachinesClientBeginAddDataDiskOptions) (*policy.Request, error) {
...
func (client *VirtualMachinesClient) applyArtifactsCreateRequest(ctx context.Context, resourceGroupName string, labName string, name string, applyArtifactsRequest ApplyArtifactsRequest, _ *VirtualMachinesClientBeginApplyArtifactsOptions) (*policy.Request, error) {
...
func (client *VirtualMachinesClient) claimCreateRequest(ctx context.Context, resourceGroupName string, labName string, name string, _ *VirtualMachinesClientBeginClaimOptions) (*policy.Request, error) {
...
func (client *VirtualMachinesClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, labName string, name string, labVirtualMachine LabVirtualMachine, _ *VirtualMachinesClientBeginCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *VirtualMachinesClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, labName string, name string, _ *VirtualMachinesClientBeginDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs/{labName}/virtualmachines/{name}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *VirtualMachinesClient) detachDataDiskCreateRequest(ctx context.Context, resourceGroupName string, labName string, name string, detachDataDiskProperties DetachDataDiskProperties, _ *VirtualMachinesClientBeginDetachDataDiskOptions) (*policy.Request, error) {
...
func (client *VirtualMachinesClient) getRdpFileContentsCreateRequest(ctx context.Context, resourceGroupName string, labName string, name string, _ *VirtualMachinesClientGetRdpFileContentsOptions) (*policy.Request, error) {
...
func (client *VirtualMachinesClient) listApplicableSchedulesCreateRequest(ctx context.Context, resourceGroupName string, labName string, name string, _ *VirtualMachinesClientListApplicableSchedulesOptions) (*policy.Request, error) {
...
func (client *VirtualMachinesClient) redeployCreateRequest(ctx context.Context, resourceGroupName string, labName string, name string, _ *VirtualMachinesClientBeginRedeployOptions) (*policy.Request, error) {
...
func (client *VirtualMachinesClient) resizeCreateRequest(ctx context.Context, resourceGroupName string, labName string, name string, resizeLabVirtualMachineProperties ResizeLabVirtualMachineProperties, _ *VirtualMachinesClientBeginResizeOptions) (*policy.Request, error) {
...
func (client *VirtualMachinesClient) restartCreateRequest(ctx context.Context, resourceGroupName string, labName string, name string, _ *VirtualMachinesClientBeginRestartOptions) (*policy.Request, error) {
...
func (client *VirtualMachinesClient) startCreateRequest(ctx context.Context, resourceGroupName string, labName string, name string, _ *VirtualMachinesClientBeginStartOptions) (*policy.Request, error) {
...
func (client *VirtualMachinesClient) stopCreateRequest(ctx context.Context, resourceGroupName string, labName string, name string, _ *VirtualMachinesClientBeginStopOptions) (*policy.Request, error) {
...
func (client *VirtualMachinesClient) transferDisksCreateRequest(ctx context.Context, resourceGroupName string, labName string, name string, _ *VirtualMachinesClientBeginTransferDisksOptions) (*policy.Request, error) {
...
func (client *VirtualMachinesClient) unClaimCreateRequest(ctx context.Context, resourceGroupName string, labName string, name string, _ *VirtualMachinesClientBeginUnClaimOptions) (*policy.Request, error) {
...
func (client *VirtualMachinesClient) updateCreateRequest(ctx context.Context, resourceGroupName string, labName string, name string, labVirtualMachine LabVirtualMachineFragment, _ *VirtualMachinesClientUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs/{labName}/virtualmachines/{name}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
