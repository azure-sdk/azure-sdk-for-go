...
type ServerFactory struct {
	// AuthorizationPoliciesServer contains the fakes for client AuthorizationPoliciesClient
	AuthorizationPoliciesServer AuthorizationPoliciesServer

	// ConnectorMappingsServer contains the fakes for client ConnectorMappingsClient
	...
	// InteractionsServer contains the fakes for client InteractionsClient
	InteractionsServer InteractionsServer

	// KpiServer contains the fakes for client KpiClient
	KpiServer KpiServer

	// LinksServer contains the fakes for client LinksClient
	LinksServer LinksServer

	// OperationsServer contains the fakes for client OperationsClient
	OperationsServer OperationsServer

	// PredictionsServer contains the fakes for client PredictionsClient
	...
	// RelationshipLinksServer contains the fakes for client RelationshipLinksClient
	...
	// WidgetTypesServer contains the fakes for client WidgetTypesClient
