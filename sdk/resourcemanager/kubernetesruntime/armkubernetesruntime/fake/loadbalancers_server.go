...
type LoadBalancersServer struct {
	...
	// NewListByParentPager is the fake for method LoadBalancersClient.NewListByParentPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByParentPager func(resourceURI string, options *armkubernetesruntime.LoadBalancersClientListByParentOptions) (resp azfake.PagerResponder[armkubernetesruntime.LoadBalancersClientListByParentResponse])
}
...
func NewLoadBalancersServerTransport(srv *LoadBalancersServer) *LoadBalancersServerTransport {
	return &LoadBalancersServerTransport{
		...
		newListByParentPager: newTracker[azfake.PagerResponder[armkubernetesruntime.LoadBalancersClientListByParentResponse]](),
	}
}
...
type LoadBalancersServerTransport struct {
	...
	newListByParentPager *tracker[azfake.PagerResponder[armkubernetesruntime.LoadBalancersClientListByParentResponse]]
}
...
func (l *LoadBalancersServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	case "LoadBalancersClient.NewListByParentPager":
		resp, err = l.dispatchNewListByParentPager(req)
	default:
...
func (l *LoadBalancersServerTransport) dispatchNewListByParentPager(req *http.Request) (*http.Response, error) {
	if l.srv.NewListByParentPager == nil {
		return nil, &nonRetriableError{errors.New("fake for method NewListByParentPager not implemented")}
	}
	newListByParentPager := l.newListByParentPager.get(req)
	if newListByParentPager == nil {
		...
		resp := l.srv.NewListByParentPager(resourceURIParam, nil)
		newListByParentPager = &resp
		l.newListByParentPager.add(req, newListByParentPager)
		server.PagerResponderInjectNextLinks(newListByParentPager, req, func(page *armkubernetesruntime.LoadBalancersClientListByParentResponse, createLink func() string) {
	...
	if !contains([]int{http.StatusOK}, resp.StatusCode) {
		l.newListByParentPager.remove(req)
