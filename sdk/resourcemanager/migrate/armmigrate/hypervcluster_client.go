...
func NewHyperVClusterClient(credential azcore.TokenCredential, options *arm.ClientOptions) (*HyperVClusterClient, error) {
	if options == nil {
...
//     method.
func (client *HyperVClusterClient) NewGetAllClustersInSitePager(subscriptionID string, resourceGroupName string, siteName string, options *HyperVClusterClientGetAllClustersInSiteOptions) *runtime.Pager[HyperVClusterClientGetAllClustersInSiteResponse] {
	return runtime.NewPager(runtime.PagingHandler[HyperVClusterClientGetAllClustersInSiteResponse]{
		...
		Fetcher: func(ctx context.Context, page *HyperVClusterClientGetAllClustersInSiteResponse) (HyperVClusterClientGetAllClustersInSiteResponse, error) {
			...
			var err error
			if page == nil {
				req, err = client.getAllClustersInSiteCreateRequest(ctx, subscriptionID, resourceGroupName, siteName, options)
			} else {
...
func (client *HyperVClusterClient) getAllClustersInSiteCreateRequest(ctx context.Context, subscriptionID string, resourceGroupName string, siteName string, options *HyperVClusterClientGetAllClustersInSiteOptions) (*policy.Request, error) {
...
//     method.
func (client *HyperVClusterClient) GetCluster(ctx context.Context, subscriptionID string, resourceGroupName string, siteName string, clusterName string, options *HyperVClusterClientGetClusterOptions) (HyperVClusterClientGetClusterResponse, error) {
	req, err := client.getClusterCreateRequest(ctx, subscriptionID, resourceGroupName, siteName, clusterName, options)
	if err != nil {
...
func (client *HyperVClusterClient) getClusterCreateRequest(ctx context.Context, subscriptionID string, resourceGroupName string, siteName string, clusterName string, options *HyperVClusterClientGetClusterOptions) (*policy.Request, error) {
...
//     method.
func (client *HyperVClusterClient) PutCluster(ctx context.Context, subscriptionID string, resourceGroupName string, siteName string, clusterName string, body HyperVCluster, options *HyperVClusterClientPutClusterOptions) (HyperVClusterClientPutClusterResponse, error) {
	req, err := client.putClusterCreateRequest(ctx, subscriptionID, resourceGroupName, siteName, clusterName, body, options)
	if err != nil {
...
func (client *HyperVClusterClient) putClusterCreateRequest(ctx context.Context, subscriptionID string, resourceGroupName string, siteName string, clusterName string, body HyperVCluster, options *HyperVClusterClientPutClusterOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OffAzure/HyperVSites/{siteName}/clusters/{clusterName}"
	if subscriptionID == "" {
		return nil, errors.New("parameter subscriptionID cannot be empty")
	}
