...
// NetworkPluginMode enumerates the values for network plugin mode.
type NetworkPluginMode string

const (
	// Overlay Pods are given IPs from the PodCIDR address space but use Azure Routing Domains rather than
	// Kubenet reference plugins host-local and bridge.
	Overlay NetworkPluginMode = "Overlay"
)

// PossibleNetworkPluginModeValues returns an array of possible values for the NetworkPluginMode const type.
func PossibleNetworkPluginModeValues() []NetworkPluginMode {
	return []NetworkPluginMode{Overlay}
}
...
const (
	...
	Ubuntu OSSKU = "Ubuntu"
	// Windows2019 ...
	Windows2019 OSSKU = "Windows2019"
	// Windows2022 ...
	Windows2022 OSSKU = "Windows2022"
)

// PossibleOSSKUValues returns an array of possible values for the OSSKU const type.
func PossibleOSSKUValues() []OSSKU {
	return []OSSKU{CBLMariner, Ubuntu, Windows2019, Windows2022}
}
...
// TrustedAccessRoleBindingProvisioningState enumerates the values for trusted access role binding provisioning
// state.
...
// PossibleTrustedAccessRoleBindingProvisioningStateValues returns an array of possible values for the TrustedAccessRoleBindingProvisioningState const type.
func PossibleTrustedAccessRoleBindingProvisioningStateValues() []TrustedAccessRoleBindingProvisioningState {
	return []TrustedAccessRoleBindingProvisioningState{TrustedAccessRoleBindingProvisioningStateDeleting, TrustedAccessRoleBindingProvisioningStateFailed, TrustedAccessRoleBindingProvisioningStateSucceeded, TrustedAccessRoleBindingProvisioningStateUpdating}
}
