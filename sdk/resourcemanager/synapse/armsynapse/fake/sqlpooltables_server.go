...
func (s *SQLPoolTablesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if sqlPoolTablesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = sqlPoolTablesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to SQLPoolTablesServerTransport
var sqlPoolTablesServerTransportInterceptor interface {
