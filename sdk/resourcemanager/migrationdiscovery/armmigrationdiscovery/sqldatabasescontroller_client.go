...
func (client *SQLDatabasesControllerClient) getCreateRequest(ctx context.Context, resourceGroupName string, siteName string, sqlSiteName string, sqlDatabaseName string, _ *SQLDatabasesControllerClientGetOptions) (*policy.Request, error) {
