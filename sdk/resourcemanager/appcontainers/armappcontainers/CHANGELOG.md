...
- New function `*HTTPRouteConfigClient.Update(context.Context, string, string, string, HTTPRouteConfigPatch, *HTTPRouteConfigClientUpdateOptions) (HTTPRouteConfigClientUpdateResponse, error)`
...
- New struct `HTTPRouteConfigPatch`
- New struct `HTTPRouteConfigPatchProperties`
...
- New field `IdentitySettings`, `RevisionTransitionThreshold`, `Runtime`, `TargetLabel` in struct `Configuration`
