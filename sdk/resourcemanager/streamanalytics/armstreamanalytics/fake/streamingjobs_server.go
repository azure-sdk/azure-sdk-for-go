...
func (s *StreamingJobsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if streamingJobsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = streamingJobsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to StreamingJobsServerTransport
var streamingJobsServerTransportInterceptor interface {
