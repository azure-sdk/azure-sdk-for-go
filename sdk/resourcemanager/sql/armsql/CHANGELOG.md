...
- Function `*DatabaseRecommendedActionsClient.Update` parameter(s) have been changed from `(context.Context, string, string, string, string, string, RecommendedAction, *DatabaseRecommendedActionsClientUpdateOptions)` to `(context.Context, string, string, string, string, string, RecommendedActionAutoGenerated, *DatabaseRecommendedActionsClientUpdateOptions)`
...
- Field `NetworkIsolation` of struct `ExportDatabaseDefinition` has been removed
- Field `NetworkIsolation` of struct `ImportExistingDatabaseDefinition` has been removed
