...
- New type alias `ProvisioningState` with values `ProvisioningStateCanceled`, `ProvisioningStateCreating`, `ProvisioningStateDeleting`, `ProvisioningStateFailed`, `ProvisioningStateMoving`, `ProvisioningStateRunning`, `ProvisioningStateSucceeded`, `ProvisioningStateUnknown`, `ProvisioningStateUpdating`
