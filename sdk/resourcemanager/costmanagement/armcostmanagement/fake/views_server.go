...
func (v *ViewsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if viewsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = viewsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to ViewsServerTransport
var viewsServerTransportInterceptor interface {
