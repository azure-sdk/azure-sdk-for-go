...
- New field `RunningState` in struct `ReplicaContainer`
- New field `RunningStateDetails` in struct `ReplicaContainer`
- New field `InitContainers` in struct `ReplicaProperties`
- New field `RunningState` in struct `ReplicaProperties`
- New field `RunningStateDetails` in struct `ReplicaProperties`
