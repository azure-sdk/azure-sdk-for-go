...
// VulnerabilityAssessmentRuleBaselineClientDeleteResponse contains the response from method VulnerabilityAssessmentRuleBaselineClient.Delete.
type VulnerabilityAssessmentRuleBaselineClientDeleteResponse struct {
	// placeholder for future response values
}
