...
func (b *BackupSchedulesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if backupSchedulesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = backupSchedulesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "BackupSchedulesClient.NewListByBackupPolicyPager":
				res.resp, res.err = b.dispatchNewListByBackupPolicyPager(req)
			default:
...
// set this to conditionally intercept incoming requests to BackupSchedulesServerTransport
var backupSchedulesServerTransportInterceptor interface {
