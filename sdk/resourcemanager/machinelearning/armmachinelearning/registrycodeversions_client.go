...
// GetBlobReferenceSAS - Get a SAS for a blob reference associated with the code
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2023-10-01
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - registryName - Name of Azure Machine Learning registry. This is case-insensitive
//   - codeName - Code name. This is case-sensitive.
//   - version - Version identifier. This is case-sensitive.
//   - body - blob reference request object
//   - options - RegistryCodeVersionsClientGetBlobReferenceSASOptions contains the optional parameters for the RegistryCodeVersionsClient.GetBlobReferenceSAS
//     method.
func (client *RegistryCodeVersionsClient) GetBlobReferenceSAS(ctx context.Context, resourceGroupName string, registryName string, codeName string, version string, body BlobReferenceSASRequestDto, options *RegistryCodeVersionsClientGetBlobReferenceSASOptions) (RegistryCodeVersionsClientGetBlobReferenceSASResponse, error) {
	var err error
	req, err := client.getBlobReferenceSASCreateRequest(ctx, resourceGroupName, registryName, codeName, version, body, options)
	if err != nil {
		return RegistryCodeVersionsClientGetBlobReferenceSASResponse{}, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
	if err != nil {
		return RegistryCodeVersionsClientGetBlobReferenceSASResponse{}, err
...
func (client *RegistryCodeVersionsClient) getBlobReferenceSASCreateRequest(ctx context.Context, resourceGroupName string, registryName string, codeName string, version string, body BlobReferenceSASRequestDto, options *RegistryCodeVersionsClientGetBlobReferenceSASOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/registries/{registryName}/codes/{codeName}/versions/{version}/getBlobReferenceSAS"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{subscriptionId}", url.PathEscape(client.subscriptionID))
...
func (client *RegistryCodeVersionsClient) getBlobReferenceSASHandleResponse(resp *http.Response) (RegistryCodeVersionsClientGetBlobReferenceSASResponse, error) {
	result := RegistryCodeVersionsClientGetBlobReferenceSASResponse{}
