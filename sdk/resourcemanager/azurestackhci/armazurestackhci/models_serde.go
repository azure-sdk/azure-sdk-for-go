...
func (c ClusterNode) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "id", c.ID)
	populateTimeRFC3339(objectMap, "lastLicensingTimestamp", c.LastLicensingTimestamp)
...
func (c *ClusterNode) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "lastLicensingTimestamp":
			err = unpopulateTimeRFC3339(val, "LastLicensingTimestamp", &c.LastLicensingTimestamp)
			delete(rawMsg, key)
		case "manufacturer":
...
func (d DefaultExtensionDetails) MarshalJSON() ([]byte, error) {
	...
	populateTimeRFC3339(objectMap, "consentTime", d.ConsentTime)
	return json.Marshal(objectMap)
}
...
func (d *DefaultExtensionDetails) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "category":
			...
			delete(rawMsg, key)
		case "consentTime":
			err = unpopulateTimeRFC3339(val, "ConsentTime", &d.ConsentTime)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", d, err)
...
func (e ExtensionInstanceViewStatus) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "message", e.Message)
	populateTimeRFC3339(objectMap, "time", e.Time)
	return json.Marshal(objectMap)
}
...
func (e *ExtensionInstanceViewStatus) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "message":
			...
			delete(rawMsg, key)
		case "time":
			err = unpopulateTimeRFC3339(val, "Time", &e.Time)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", e, err)
...
// MarshalJSON implements the json.Marshaller interface for type ExtensionParametersProtectedSettings.
func (e ExtensionParametersProtectedSettings) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "workspaceKey", e.WorkspaceKey)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ExtensionParametersProtectedSettings.
func (e *ExtensionParametersProtectedSettings) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", e, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "workspaceKey":
			err = unpopulate(val, "WorkspaceKey", &e.WorkspaceKey)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", e, err)
...
// MarshalJSON implements the json.Marshaller interface for type ExtensionParametersSettings.
func (e ExtensionParametersSettings) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "workspaceId", e.WorkspaceID)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ExtensionParametersSettings.
func (e *ExtensionParametersSettings) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", e, err)
	}
...
func (u UpdateProperties) MarshalJSON() ([]byte, error) {
	...
	populateTimeRFC3339(objectMap, "healthCheckDate", u.HealthCheckDate)
...
func (u *UpdateProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "healthCheckDate":
			err = unpopulateTimeRFC3339(val, "HealthCheckDate", &u.HealthCheckDate)
			delete(rawMsg, key)
...
func (u UpdateRunProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "provisioningState", u.ProvisioningState)
	populate(objectMap, "state", u.State)
	populateTimeRFC3339(objectMap, "timeStarted", u.TimeStarted)
	return json.Marshal(objectMap)
}
...
func (u *UpdateRunProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "state":
			...
			delete(rawMsg, key)
		case "timeStarted":
			err = unpopulateTimeRFC3339(val, "TimeStarted", &u.TimeStarted)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", u, err)
...
func (u UpdateSummariesProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "healthCheckResult", u.HealthCheckResult)
	populate(objectMap, "healthState", u.HealthState)
	populateTimeRFC3339(objectMap, "lastChecked", u.LastChecked)
	populateTimeRFC3339(objectMap, "lastUpdated", u.LastUpdated)
...
func (u *UpdateSummariesProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "healthState":
			...
			delete(rawMsg, key)
		case "lastChecked":
			err = unpopulateTimeRFC3339(val, "LastChecked", &u.LastChecked)
			delete(rawMsg, key)
		case "lastUpdated":
			err = unpopulateTimeRFC3339(val, "LastUpdated", &u.LastUpdated)
			delete(rawMsg, key)
		case "oemFamily":
