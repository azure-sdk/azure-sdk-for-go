...
type IntegrationAccountSchemasServer struct {
	...
	CreateOrUpdate func(ctx context.Context, resourceGroupName string, integrationAccountName string, schemaName string, resource armlogic.IntegrationAccountSchema, options *armlogic.IntegrationAccountSchemasClientCreateOrUpdateOptions) (resp azfake.Responder[armlogic.IntegrationAccountSchemasClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)
	...
	// HTTP status codes to indicate success: http.StatusOK
	ListContentCallbackURL func(ctx context.Context, resourceGroupName string, integrationAccountName string, schemaName string, body armlogic.GetCallbackURLParameters, options *armlogic.IntegrationAccountSchemasClientListContentCallbackURLOptions) (resp azfake.Responder[armlogic.IntegrationAccountSchemasClientListContentCallbackURLResponse], errResp azfake.ErrorResponder)
}
...
func (i *IntegrationAccountSchemasServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if integrationAccountSchemasServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = integrationAccountSchemasServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to IntegrationAccountSchemasServerTransport
var integrationAccountSchemasServerTransportInterceptor interface {
