...
type WorkflowRunActionsServer struct {
	...
	// HTTP status codes to indicate success: http.StatusOK
	NewListExpressionTracesPager func(resourceGroupName string, workflowName string, runName string, actionName string, options *armlogic.WorkflowRunActionsClientListExpressionTracesOptions) (resp azfake.PagerResponder[armlogic.WorkflowRunActionsClientListExpressionTracesResponse])
}
...
func NewWorkflowRunActionsServerTransport(srv *WorkflowRunActionsServer) *WorkflowRunActionsServerTransport {
	return &WorkflowRunActionsServerTransport{
		...
		newListExpressionTracesPager: newTracker[azfake.PagerResponder[armlogic.WorkflowRunActionsClientListExpressionTracesResponse]](),
	}
}
...
type WorkflowRunActionsServerTransport struct {
	...
	newListExpressionTracesPager *tracker[azfake.PagerResponder[armlogic.WorkflowRunActionsClientListExpressionTracesResponse]]
}
...
func (w *WorkflowRunActionsServerTransport) dispatchNewListExpressionTracesPager(req *http.Request) (*http.Response, error) {
	...
	if newListExpressionTracesPager == nil {
		...
		resp := w.srv.NewListExpressionTracesPager(resourceGroupNameParam, workflowNameParam, runNameParam, actionNameParam, nil)
