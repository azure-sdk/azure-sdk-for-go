...
The `armoperations` module provides operations for working with Azure Kubernetesconfiguration.

[Source code](https://github.com/Azure/azure-sdk-for-go/tree/main/sdk/resourcemanager/kubernetesconfiguration/armoperations)
...
```sh
go get github.com/Azure/azure-sdk-for-go/sdk/resourcemanager/kubernetesconfiguration/armoperations
```
...
```go
clientFactory, err := armoperations.NewClientFactory(<subscription ID>, cred, nil)
```
...
clientFactory, err := armoperations.NewClientFactory(<subscription ID>, cred, &options)
```
...
```go
client := clientFactory.NewOperationStatusClient()
```
