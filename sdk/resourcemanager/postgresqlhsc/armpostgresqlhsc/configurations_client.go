...
// BeginUpdate - Updates configuration of coordinator in a cluster
...
// method.
func (client *ConfigurationsClient) BeginUpdate(ctx context.Context, resourceGroupName string, clusterName string, configurationName string, parameters ServerConfigurationRequest, options *ConfigurationsClientBeginUpdateOptions) (*runtime.Poller[ConfigurationsClientUpdateResponse], error) {
...
// Update - Updates configuration of coordinator in a cluster
// If the operation fails it returns an *azcore.ResponseError type.
// Generated from API version 2022-11-08
func (client *ConfigurationsClient) update(ctx context.Context, resourceGroupName string, clusterName string, configurationName string, parameters ServerConfigurationRequest, options *ConfigurationsClientBeginUpdateOptions) (*http.Response, error) {
...
func (client *ConfigurationsClient) updateCreateRequest(ctx context.Context, resourceGroupName string, clusterName string, configurationName string, parameters ServerConfigurationRequest, options *ConfigurationsClientBeginUpdateOptions) (*policy.Request, error) {
