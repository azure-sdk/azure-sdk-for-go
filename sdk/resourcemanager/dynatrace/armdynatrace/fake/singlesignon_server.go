...
func (s *SingleSignOnServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if singleSignOnServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = singleSignOnServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to SingleSignOnServerTransport
var singleSignOnServerTransportInterceptor interface {
