...
// JobsClientGenerateProgressURLOptions contains the optional parameters for the JobsClient.GenerateProgressURL method.
type JobsClientGenerateProgressURLOptions struct {
	// placeholder for future optional parameters
}
