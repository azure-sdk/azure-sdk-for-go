...
func (client *GroupsClient) Create(ctx context.Context, resourceGroupName string, projectName string, groupName string, group Group, options *GroupsClientCreateOptions) (GroupsClientCreateResponse, error) {
	req, err := client.createCreateRequest(ctx, resourceGroupName, projectName, groupName, group, options)
	if err != nil {
...
func (client *GroupsClient) createCreateRequest(ctx context.Context, resourceGroupName string, projectName string, groupName string, group Group, options *GroupsClientCreateOptions) (*policy.Request, error) {
	...
	return req, runtime.MarshalAsJSON(req, group)
}
