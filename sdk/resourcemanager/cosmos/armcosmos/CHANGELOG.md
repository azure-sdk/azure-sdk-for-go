...
- New enum type `AzureConnectionMethod` with values `AzureConnectionMethodNone`, `AzureConnectionMethodVPN`
...
- New field `AzureConnectionMethod`, `BackupSchedules`, `ClusterType`, `Extensions`, `PrivateLinkAutoApproveSubscriptions`, `PrivateLinkResourceID` in struct `ClusterResourceProperties`
