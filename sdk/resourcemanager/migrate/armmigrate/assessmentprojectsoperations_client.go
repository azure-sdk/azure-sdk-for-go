...
func NewAssessmentProjectsOperationsClient(subscriptionID string, credential azcore.TokenCredential, options *arm.ClientOptions) (*AssessmentProjectsOperationsClient, error) {
	cl, err := arm.NewClient(moduleName+".AssessmentProjectsOperationsClient", moduleVersion, credential, options)
	if err != nil {
		return nil, err
	}
...
func (client *AssessmentProjectsOperationsClient) BeginCreate(ctx context.Context, resourceGroupName string, projectName string, resource AssessmentProject, options *AssessmentProjectsOperationsClientBeginCreateOptions) (*runtime.Poller[AssessmentProjectsOperationsClientCreateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return runtime.NewPollerFromResumeToken[AssessmentProjectsOperationsClientCreateResponse](options.ResumeToken, client.internal.Pipeline(), nil)
	}
}
...
func (client *AssessmentProjectsOperationsClient) createCreateRequest(ctx context.Context, resourceGroupName string, projectName string, resource AssessmentProject, options *AssessmentProjectsOperationsClientBeginCreateOptions) (*policy.Request, error) {
...
func (client *AssessmentProjectsOperationsClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, projectName string, options *AssessmentProjectsOperationsClientDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Migrate/assessmentProjects/{projectName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *AssessmentProjectsOperationsClient) getCreateRequest(ctx context.Context, resourceGroupName string, projectName string, options *AssessmentProjectsOperationsClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Migrate/assessmentProjects/{projectName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
	...
	return runtime.NewPager(runtime.PagingHandler[AssessmentProjectsOperationsClientListByResourceGroupResponse]{
		...
		Fetcher: func(ctx context.Context, page *AssessmentProjectsOperationsClientListByResourceGroupResponse) (AssessmentProjectsOperationsClientListByResourceGroupResponse, error) {
			...
			if !runtime.HasStatusCode(resp, http.StatusOK) {
				return AssessmentProjectsOperationsClientListByResourceGroupResponse{}, runtime.NewResponseError(resp)
			}
...
func (client *AssessmentProjectsOperationsClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, options *AssessmentProjectsOperationsClientListByResourceGroupOptions) (*policy.Request, error) {
...
func (client *AssessmentProjectsOperationsClient) NewListBySubscriptionPager(options *AssessmentProjectsOperationsClientListBySubscriptionOptions) *runtime.Pager[AssessmentProjectsOperationsClientListBySubscriptionResponse] {
	return runtime.NewPager(runtime.PagingHandler[AssessmentProjectsOperationsClientListBySubscriptionResponse]{
		...
		Fetcher: func(ctx context.Context, page *AssessmentProjectsOperationsClientListBySubscriptionResponse) (AssessmentProjectsOperationsClientListBySubscriptionResponse, error) {
			...
			if !runtime.HasStatusCode(resp, http.StatusOK) {
				return AssessmentProjectsOperationsClientListBySubscriptionResponse{}, runtime.NewResponseError(resp)
			}
...
func (client *AssessmentProjectsOperationsClient) listBySubscriptionCreateRequest(ctx context.Context, options *AssessmentProjectsOperationsClientListBySubscriptionOptions) (*policy.Request, error) {
...
func (client *AssessmentProjectsOperationsClient) BeginUpdate(ctx context.Context, resourceGroupName string, projectName string, properties AssessmentProjectUpdate, options *AssessmentProjectsOperationsClientBeginUpdateOptions) (*runtime.Poller[AssessmentProjectsOperationsClientUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return runtime.NewPollerFromResumeToken[AssessmentProjectsOperationsClientUpdateResponse](options.ResumeToken, client.internal.Pipeline(), nil)
	}
}
...
func (client *AssessmentProjectsOperationsClient) updateCreateRequest(ctx context.Context, resourceGroupName string, projectName string, properties AssessmentProjectUpdate, options *AssessmentProjectsOperationsClientBeginUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Migrate/assessmentProjects/{projectName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
