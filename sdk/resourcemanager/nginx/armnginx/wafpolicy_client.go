...
func (client *WafPolicyClient) BeginCreate(ctx context.Context, resourceGroupName string, deploymentName string, wafPolicyName string, options *WafPolicyClientBeginCreateOptions) (*runtime.Poller[WafPolicyClientCreateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.create(ctx, resourceGroupName, deploymentName, wafPolicyName, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2025-03-01-preview
func (client *WafPolicyClient) create(ctx context.Context, resourceGroupName string, deploymentName string, wafPolicyName string, options *WafPolicyClientBeginCreateOptions) (*http.Response, error) {
	var err error
	const operationName = "WafPolicyClient.BeginCreate"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.createCreateRequest(ctx, resourceGroupName, deploymentName, wafPolicyName, options)
	if err != nil {
		return nil, err
	}
...
func (client *WafPolicyClient) createCreateRequest(ctx context.Context, resourceGroupName string, deploymentName string, wafPolicyName string, options *WafPolicyClientBeginCreateOptions) (*policy.Request, error) {
