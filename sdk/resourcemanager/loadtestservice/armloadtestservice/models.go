...
// CheckQuotaAvailabilityResponse - Check Quota Availability Response.
...
// QuotaBucketRequest - Quota Bucket Request.
...
// QuotaBucketRequestProperties - Quota Bucket Request properties.
...
// QuotaBucketRequestPropertiesDimensions - Dimensions for new quota request of the quota bucket.
...
// QuotaResource - Quota Bucket details
...
// QuotaResourceList - A list of Quota Bucket details. It contains an URL link to get the next set of results.
type QuotaResourceList struct {
	// READ-ONLY; URL to get the next set of Quota Bucket details results (if there are any).
	NextLink *string `json:"nextLink,omitempty" azure:"ro"`

	// READ-ONLY; List of Quota Bucket details by the loadtestservice resource provider
	Value []*QuotaResource `json:"value,omitempty" azure:"ro"`
}

// QuotaResourceProperties - Quota resource properties.
