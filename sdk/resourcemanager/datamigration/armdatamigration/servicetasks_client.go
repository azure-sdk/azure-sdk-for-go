...
// since service tasks have no mutable custom properties, there is little reason to update an existing one. Database Migration
// Service (classic) - SQL scenarios are on a deprecation path and will be
