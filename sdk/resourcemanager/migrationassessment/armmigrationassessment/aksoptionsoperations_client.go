...
func (client *AksOptionsOperationsClient) getCreateRequest(ctx context.Context, resourceGroupName string, projectName string, assessmentOptionsName string, options *AksOptionsOperationsClientGetOptions) (*policy.Request, error) {
...
func (client *AksOptionsOperationsClient) listByAssessmentProjectCreateRequest(ctx context.Context, resourceGroupName string, projectName string, options *AksOptionsOperationsClientListByAssessmentProjectOptions) (*policy.Request, error) {
