...
const (
	...
	// ResourceTypeExpressRouteCircuits - Value when customer wants to provide custom naming convention for ExpressRoute.
	ResourceTypeExpressRouteCircuits ResourceType = "expressRouteCircuits"
	// ResourceTypeManagementGroups - Value when customer wants to provide custom naming convention for management group.
	ResourceTypeManagementGroups ResourceType = "managementGroups"
	...
	// ResourceTypePublicIPAddresses - Value when customer wants to provide custom naming convention for public IP address.
	ResourceTypePublicIPAddresses ResourceType = "publicIPAddresses"
	// ResourceTypeResourceGroups - Value when customer wants to provide custom naming convention for resource group.
	...
	// ResourceTypeSubscriptions - Value when customer wants to provide custom naming convention for subscription.
...
func PossibleResourceTypeValues() []ResourceType {
	return []ResourceType{
		...
		ResourceTypeExpressRouteCircuits,
		ResourceTypeManagementGroups,
		ResourceTypeNetworkSecurityGroups,
		ResourceTypePublicIPAddresses,
		ResourceTypeResourceGroups,
		ResourceTypeRouteTables,
		ResourceTypeSubscriptions,
