...
func NewRunAsAccountsClient(subscriptionID string, credential azcore.TokenCredential, options *arm.ClientOptions) (*RunAsAccountsClient, error) {
	if options == nil {
...
//     method.
func (client *RunAsAccountsClient) NewGetAllRunAsAccountsInSitePager(resourceGroupName string, siteName string, options *RunAsAccountsClientGetAllRunAsAccountsInSiteOptions) *runtime.Pager[RunAsAccountsClientGetAllRunAsAccountsInSiteResponse] {
...
func (client *RunAsAccountsClient) getAllRunAsAccountsInSiteCreateRequest(ctx context.Context, resourceGroupName string, siteName string, options *RunAsAccountsClientGetAllRunAsAccountsInSiteOptions) (*policy.Request, error) {
...
//     method.
func (client *RunAsAccountsClient) GetRunAsAccount(ctx context.Context, resourceGroupName string, siteName string, accountName string, options *RunAsAccountsClientGetRunAsAccountOptions) (RunAsAccountsClientGetRunAsAccountResponse, error) {
...
func (client *RunAsAccountsClient) getRunAsAccountCreateRequest(ctx context.Context, resourceGroupName string, siteName string, accountName string, options *RunAsAccountsClientGetRunAsAccountOptions) (*policy.Request, error) {
