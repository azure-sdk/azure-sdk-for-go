...
func (c *ClientFactory) NewAzureLargeInstancesClient() *AzureLargeInstancesClient {
	subClient, _ := NewAzureLargeInstancesClient(c.subscriptionID, c.credential, c.options)
	return subClient
}
...
func (c *ClientFactory) NewAzureLargeStorageInstancesClient() *AzureLargeStorageInstancesClient {
	subClient, _ := NewAzureLargeStorageInstancesClient(c.subscriptionID, c.credential, c.options)
	return subClient
}
