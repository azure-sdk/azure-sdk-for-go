...
func NewCustomImagesClient(subscriptionID string, credential azcore.TokenCredential, options *arm.ClientOptions) (*CustomImagesClient, error) {
	cl, err := arm.NewClient(moduleName+".CustomImagesClient", moduleVersion, credential, options)
	if err != nil {
		return nil, err
	}
...
func (client *CustomImagesClient) checkImageNameAvailabilityCreateRequest(ctx context.Context, resourceGroupName string, testBaseAccountName string, parameters ImageNameCheckAvailabilityParameters, options *CustomImagesClientCheckImageNameAvailabilityOptions) (*policy.Request, error) {
...
func (client *CustomImagesClient) BeginCreate(ctx context.Context, resourceGroupName string, testBaseAccountName string, customImageName string, parameters CustomImageResource, options *CustomImagesClientBeginCreateOptions) (*runtime.Poller[CustomImagesClientCreateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return runtime.NewPollerFromResumeToken[CustomImagesClientCreateResponse](options.ResumeToken, client.internal.Pipeline(), nil)
	}
}
...
func (client *CustomImagesClient) createCreateRequest(ctx context.Context, resourceGroupName string, testBaseAccountName string, customImageName string, parameters CustomImageResource, options *CustomImagesClientBeginCreateOptions) (*policy.Request, error) {
...
func (client *CustomImagesClient) BeginDelete(ctx context.Context, resourceGroupName string, testBaseAccountName string, customImageName string, options *CustomImagesClientBeginDeleteOptions) (*runtime.Poller[CustomImagesClientDeleteResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return runtime.NewPollerFromResumeToken[CustomImagesClientDeleteResponse](options.ResumeToken, client.internal.Pipeline(), nil)
	}
}
...
func (client *CustomImagesClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, testBaseAccountName string, customImageName string, options *CustomImagesClientBeginDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.TestBase/testBaseAccounts/{testBaseAccountName}/customImages/{customImageName}"
	urlPath = strings.ReplaceAll(urlPath, "{subscriptionId}", url.PathEscape(client.subscriptionID))
	if resourceGroupName == "" {
		return nil, errors.New("parameter resourceGroupName cannot be empty")
...
func (client *CustomImagesClient) getCreateRequest(ctx context.Context, resourceGroupName string, testBaseAccountName string, customImageName string, options *CustomImagesClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.TestBase/testBaseAccounts/{testBaseAccountName}/customImages/{customImageName}"
	urlPath = strings.ReplaceAll(urlPath, "{subscriptionId}", url.PathEscape(client.subscriptionID))
	if resourceGroupName == "" {
		return nil, errors.New("parameter resourceGroupName cannot be empty")
	...
	return runtime.NewPager(runtime.PagingHandler[CustomImagesClientListByTestBaseAccountResponse]{
		...
		Fetcher: func(ctx context.Context, page *CustomImagesClientListByTestBaseAccountResponse) (CustomImagesClientListByTestBaseAccountResponse, error) {
			...
			if !runtime.HasStatusCode(resp, http.StatusOK) {
				return CustomImagesClientListByTestBaseAccountResponse{}, runtime.NewResponseError(resp)
			}
...
func (client *CustomImagesClient) listByTestBaseAccountCreateRequest(ctx context.Context, resourceGroupName string, testBaseAccountName string, options *CustomImagesClientListByTestBaseAccountOptions) (*policy.Request, error) {
