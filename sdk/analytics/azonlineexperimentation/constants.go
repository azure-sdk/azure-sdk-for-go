...
const (
	// DiagnosticCodeFailedSchemaValidation - The metric definition does not conform to the JSON schema.
	DiagnosticCodeFailedSchemaValidation DiagnosticCode = "FailedSchemaValidation"
	// DiagnosticCodeInvalidEventCondition - The KQL filter condition provided is invalid.
...
// ValidationResult - The result of validating an experiment metric.
type ValidationResult string

const (
	// ValidationResultInvalid - The experiment metric is invalid.
	ValidationResultInvalid ValidationResult = "Invalid"
	// ValidationResultValid - The experiment metric is valid.
	ValidationResultValid ValidationResult = "Valid"
)

// PossibleValidationResultValues returns the possible values for the ValidationResult const type.
func PossibleValidationResultValues() []ValidationResult {
