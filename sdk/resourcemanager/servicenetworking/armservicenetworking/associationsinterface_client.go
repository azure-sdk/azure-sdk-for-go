...
// NewListByResourceGroupPager - List Association resources by TrafficController
//
// Generated from API version 2024-05-01-preview
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - trafficControllerName - traffic controller name for path
//   - options - AssociationsInterfaceClientListByResourceGroupOptions contains the optional parameters for the AssociationsInterfaceClient.NewListByResourceGroupPager
//     method.
func (client *AssociationsInterfaceClient) NewListByResourceGroupPager(resourceGroupName string, trafficControllerName string, options *AssociationsInterfaceClientListByResourceGroupOptions) *runtime.Pager[AssociationsInterfaceClientListByResourceGroupResponse] {
	return runtime.NewPager(runtime.PagingHandler[AssociationsInterfaceClientListByResourceGroupResponse]{
		More: func(page AssociationsInterfaceClientListByResourceGroupResponse) bool {
			return page.NextLink != nil && len(*page.NextLink) > 0
		},
		Fetcher: func(ctx context.Context, page *AssociationsInterfaceClientListByResourceGroupResponse) (AssociationsInterfaceClientListByResourceGroupResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "AssociationsInterfaceClient.NewListByResourceGroupPager")
			nextLink := ""
			if page != nil {
			...
			if err != nil {
				return AssociationsInterfaceClientListByResourceGroupResponse{}, err
			}
...
func (client *AssociationsInterfaceClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, trafficControllerName string, _ *AssociationsInterfaceClientListByResourceGroupOptions) (*policy.Request, error) {
...
func (client *AssociationsInterfaceClient) listByResourceGroupHandleResponse(resp *http.Response) (AssociationsInterfaceClientListByResourceGroupResponse, error) {
	result := AssociationsInterfaceClientListByResourceGroupResponse{}
...
//     method.
func (client *AssociationsInterfaceClient) Update(ctx context.Context, resourceGroupName string, trafficControllerName string, associationName string, properties Association, options *AssociationsInterfaceClientUpdateOptions) (AssociationsInterfaceClientUpdateResponse, error) {
	var err error
...
func (client *AssociationsInterfaceClient) updateCreateRequest(ctx context.Context, resourceGroupName string, trafficControllerName string, associationName string, properties Association, _ *AssociationsInterfaceClientUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceNetworking/trafficControllers/{trafficControllerName}/associations/{associationName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
