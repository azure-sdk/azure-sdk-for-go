...
// NewListByParentPager - List Target resources by Watcher
//
// Generated from API version 2023-09-01-preview
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - watcherName - The database watcher name.
//   - options - TargetsClientListByParentOptions contains the optional parameters for the TargetsClient.NewListByParentPager
//     method.
func (client *TargetsClient) NewListByParentPager(resourceGroupName string, watcherName string, options *TargetsClientListByParentOptions) *runtime.Pager[TargetsClientListByParentResponse] {
	return runtime.NewPager(runtime.PagingHandler[TargetsClientListByParentResponse]{
		More: func(page TargetsClientListByParentResponse) bool {
			return page.NextLink != nil && len(*page.NextLink) > 0
		},
		Fetcher: func(ctx context.Context, page *TargetsClientListByParentResponse) (TargetsClientListByParentResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "TargetsClient.NewListByParentPager")
			nextLink := ""
			if page != nil {
			...
			if err != nil {
				return TargetsClientListByParentResponse{}, err
			}
...
func (client *TargetsClient) listByParentCreateRequest(ctx context.Context, resourceGroupName string, watcherName string, _ *TargetsClientListByParentOptions) (*policy.Request, error) {
...
func (client *TargetsClient) listByParentHandleResponse(resp *http.Response) (TargetsClientListByParentResponse, error) {
	result := TargetsClientListByParentResponse{}
