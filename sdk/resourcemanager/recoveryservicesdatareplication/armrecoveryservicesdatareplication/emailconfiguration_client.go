...
func (client *EmailConfigurationClient) createCreateRequest(ctx context.Context, resourceGroupName string, vaultName string, emailConfigurationName string, body EmailConfigurationModel, _ *EmailConfigurationClientCreateOptions) (*policy.Request, error) {
