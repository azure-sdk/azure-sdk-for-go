...
func (t *TestJobStreamsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if testJobStreamsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = testJobStreamsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "TestJobStreamsClient.NewListByTestJobPager":
				res.resp, res.err = t.dispatchNewListByTestJobPager(req)
			default:
...
// set this to conditionally intercept incoming requests to TestJobStreamsServerTransport
var testJobStreamsServerTransportInterceptor interface {
