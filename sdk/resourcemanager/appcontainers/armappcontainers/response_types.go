...
// AppResiliencyClientPatchResponse contains the response from method AppResiliencyClient.Patch.
type AppResiliencyClientPatchResponse struct {
	// Configuration to setup App Resiliency
	AppResiliency
}
...
// JobsClientProxyListResponse contains the response from method JobsClient.ProxyList.
type JobsClientProxyListResponse struct {
	// Container Apps Jobs collection ARM resource.
	JobsCollection
}
