...
// PolicyDefinitionsServer is a fake server for instances of the armdeploymentstacks.PolicyDefinitionsClient type.
type PolicyDefinitionsServer struct {
	...
	CreateOrUpdate func(ctx context.Context, policyDefinitionName string, parameters armdeploymentstacks.PolicyDefinition, options *armdeploymentstacks.PolicyDefinitionsClientCreateOrUpdateOptions) (resp azfake.Responder[armdeploymentstacks.PolicyDefinitionsClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)

	// CreateOrUpdateAtManagementGroup is the fake for method PolicyDefinitionsClient.CreateOrUpdateAtManagementGroup
	// HTTP status codes to indicate success: http.StatusCreated
	CreateOrUpdateAtManagementGroup func(ctx context.Context, managementGroupID string, policyDefinitionName string, parameters armdeploymentstacks.PolicyDefinition, options *armdeploymentstacks.PolicyDefinitionsClientCreateOrUpdateAtManagementGroupOptions) (resp azfake.Responder[armdeploymentstacks.PolicyDefinitionsClientCreateOrUpdateAtManagementGroupResponse], errResp azfake.ErrorResponder)

	// Delete is the fake for method PolicyDefinitionsClient.Delete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	Delete func(ctx context.Context, policyDefinitionName string, options *armdeploymentstacks.PolicyDefinitionsClientDeleteOptions) (resp azfake.Responder[armdeploymentstacks.PolicyDefinitionsClientDeleteResponse], errResp azfake.ErrorResponder)

	// DeleteAtManagementGroup is the fake for method PolicyDefinitionsClient.DeleteAtManagementGroup
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	DeleteAtManagementGroup func(ctx context.Context, managementGroupID string, policyDefinitionName string, options *armdeploymentstacks.PolicyDefinitionsClientDeleteAtManagementGroupOptions) (resp azfake.Responder[armdeploymentstacks.PolicyDefinitionsClientDeleteAtManagementGroupResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method PolicyDefinitionsClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, policyDefinitionName string, options *armdeploymentstacks.PolicyDefinitionsClientGetOptions) (resp azfake.Responder[armdeploymentstacks.PolicyDefinitionsClientGetResponse], errResp azfake.ErrorResponder)

	// GetAtManagementGroup is the fake for method PolicyDefinitionsClient.GetAtManagementGroup
	// HTTP status codes to indicate success: http.StatusOK
	GetAtManagementGroup func(ctx context.Context, managementGroupID string, policyDefinitionName string, options *armdeploymentstacks.PolicyDefinitionsClientGetAtManagementGroupOptions) (resp azfake.Responder[armdeploymentstacks.PolicyDefinitionsClientGetAtManagementGroupResponse], errResp azfake.ErrorResponder)

	// GetBuiltIn is the fake for method PolicyDefinitionsClient.GetBuiltIn
	// HTTP status codes to indicate success: http.StatusOK
	GetBuiltIn func(ctx context.Context, policyDefinitionName string, options *armdeploymentstacks.PolicyDefinitionsClientGetBuiltInOptions) (resp azfake.Responder[armdeploymentstacks.PolicyDefinitionsClientGetBuiltInResponse], errResp azfake.ErrorResponder)

	// NewListPager is the fake for method PolicyDefinitionsClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(options *armdeploymentstacks.PolicyDefinitionsClientListOptions) (resp azfake.PagerResponder[armdeploymentstacks.PolicyDefinitionsClientListResponse])

	// NewListBuiltInPager is the fake for method PolicyDefinitionsClient.NewListBuiltInPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListBuiltInPager func(options *armdeploymentstacks.PolicyDefinitionsClientListBuiltInOptions) (resp azfake.PagerResponder[armdeploymentstacks.PolicyDefinitionsClientListBuiltInResponse])

	// NewListByManagementGroupPager is the fake for method PolicyDefinitionsClient.NewListByManagementGroupPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByManagementGroupPager func(managementGroupID string, options *armdeploymentstacks.PolicyDefinitionsClientListByManagementGroupOptions) (resp azfake.PagerResponder[armdeploymentstacks.PolicyDefinitionsClientListByManagementGroupResponse])
}
...
// The returned PolicyDefinitionsServerTransport instance is connected to an instance of armdeploymentstacks.PolicyDefinitionsClient via the
...
func NewPolicyDefinitionsServerTransport(srv *PolicyDefinitionsServer) *PolicyDefinitionsServerTransport {
	return &PolicyDefinitionsServerTransport{
		srv:                           srv,
		newListPager:                  newTracker[azfake.PagerResponder[armdeploymentstacks.PolicyDefinitionsClientListResponse]](),
		newListBuiltInPager:           newTracker[azfake.PagerResponder[armdeploymentstacks.PolicyDefinitionsClientListBuiltInResponse]](),
		newListByManagementGroupPager: newTracker[azfake.PagerResponder[armdeploymentstacks.PolicyDefinitionsClientListByManagementGroupResponse]](),
	}
}

// PolicyDefinitionsServerTransport connects instances of armdeploymentstacks.PolicyDefinitionsClient to instances of PolicyDefinitionsServer.
...
type PolicyDefinitionsServerTransport struct {
	...
	newListPager                  *tracker[azfake.PagerResponder[armdeploymentstacks.PolicyDefinitionsClientListResponse]]
	newListBuiltInPager           *tracker[azfake.PagerResponder[armdeploymentstacks.PolicyDefinitionsClientListBuiltInResponse]]
	newListByManagementGroupPager *tracker[azfake.PagerResponder[armdeploymentstacks.PolicyDefinitionsClientListByManagementGroupResponse]]
}
...
func (p *PolicyDefinitionsServerTransport) dispatchCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[armdeploymentstacks.PolicyDefinition](req)
	if err != nil {
		return nil, err
	}
...
func (p *PolicyDefinitionsServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		var options *armdeploymentstacks.PolicyDefinitionsClientListOptions
		if filterParam != nil || topParam != nil {
			options = &armdeploymentstacks.PolicyDefinitionsClientListOptions{
				Filter: filterParam,
				Top:    topParam,
			}
		}
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armdeploymentstacks.PolicyDefinitionsClientListResponse, createLink func() string) {
...
func (p *PolicyDefinitionsServerTransport) dispatchNewListBuiltInPager(req *http.Request) (*http.Response, error) {
	...
	if newListBuiltInPager == nil {
		...
		var options *armdeploymentstacks.PolicyDefinitionsClientListBuiltInOptions
		if filterParam != nil || topParam != nil {
			options = &armdeploymentstacks.PolicyDefinitionsClientListBuiltInOptions{
				Filter: filterParam,
				Top:    topParam,
			}
		}
		...
		server.PagerResponderInjectNextLinks(newListBuiltInPager, req, func(page *armdeploymentstacks.PolicyDefinitionsClientListBuiltInResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
...
func (p *PolicyDefinitionsServerTransport) dispatchNewListByManagementGroupPager(req *http.Request) (*http.Response, error) {
	...
	if newListByManagementGroupPager == nil {
		...
		var options *armdeploymentstacks.PolicyDefinitionsClientListByManagementGroupOptions
		if filterParam != nil || topParam != nil {
			options = &armdeploymentstacks.PolicyDefinitionsClientListByManagementGroupOptions{
				Filter: filterParam,
				Top:    topParam,
			}
		}
		...
		server.PagerResponderInjectNextLinks(newListByManagementGroupPager, req, func(page *armdeploymentstacks.PolicyDefinitionsClientListByManagementGroupResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
