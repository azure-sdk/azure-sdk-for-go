...
// MarshalJSON implements the json.Marshaller interface for type SetDefaultKeyParameterBody.
func (s SetDefaultKeyParameterBody) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "body", s.Body)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type SetDefaultKeyParameterBody.
func (s *SetDefaultKeyParameterBody) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
