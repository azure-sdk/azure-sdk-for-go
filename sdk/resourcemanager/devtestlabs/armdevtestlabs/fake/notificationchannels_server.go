...
func (n *NotificationChannelsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if notificationChannelsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = notificationChannelsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "NotificationChannelsClient.Notify":
				res.resp, res.err = n.dispatchNotify(req)
...
// set this to conditionally intercept incoming requests to NotificationChannelsServerTransport
var notificationChannelsServerTransportInterceptor interface {
