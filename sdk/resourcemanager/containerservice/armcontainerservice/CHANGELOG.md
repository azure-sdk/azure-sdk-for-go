...
- New function `*ClientFactory.NewMachineClient() *MachineClient`
...
- New function `NewMachineClient(string, string, azcore.TokenCredential, *arm.ClientOptions) (*MachineClient, error)`
- New function `*MachineClient.Get(context.Context, string, string, string, *MachineClientGetOptions) (MachineClientGetResponse, error)`
