...
// CreateOrGetPendingUpload - Generate a storage location and credential for the client to upload a model asset to.
...
//   - options - RegistryModelVersionsClientCreateOrGetPendingUploadOptions contains the optional parameters for the RegistryModelVersionsClient.CreateOrGetPendingUpload
//     method.
func (client *RegistryModelVersionsClient) CreateOrGetPendingUpload(ctx context.Context, resourceGroupName string, registryName string, modelName string, version string, body PendingUploadRequestDto, options *RegistryModelVersionsClientCreateOrGetPendingUploadOptions) (RegistryModelVersionsClientCreateOrGetPendingUploadResponse, error) {
	req, err := client.createOrGetPendingUploadCreateRequest(ctx, resourceGroupName, registryName, modelName, version, body, options)
	if err != nil {
		return RegistryModelVersionsClientCreateOrGetPendingUploadResponse{}, err
	}
	...
	if !runtime.HasStatusCode(resp, http.StatusOK) {
		return RegistryModelVersionsClientCreateOrGetPendingUploadResponse{}, runtime.NewResponseError(resp)
	}
...
func (client *RegistryModelVersionsClient) createOrGetPendingUploadCreateRequest(ctx context.Context, resourceGroupName string, registryName string, modelName string, version string, body PendingUploadRequestDto, options *RegistryModelVersionsClientCreateOrGetPendingUploadOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/registries/{registryName}/models/{modelName}/versions/pendingUpload/{version}"
...
func (client *RegistryModelVersionsClient) createOrGetPendingUploadHandleResponse(resp *http.Response) (RegistryModelVersionsClientCreateOrGetPendingUploadResponse, error) {
	result := RegistryModelVersionsClientCreateOrGetPendingUploadResponse{}
