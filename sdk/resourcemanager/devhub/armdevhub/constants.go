...
// ManifestGenerationMode - The mode of generation to be used for generating Dockerfiles.
...
const (
	// ManifestTypeHelm - Manifests using helm
	ManifestTypeHelm ManifestType = "helm"
	// ManifestTypeKube - Standard Kubernetes manifests
	ManifestTypeKube ManifestType = "kube"
	// ManifestTypeKustomize - Manifests using kustomize
