...
// WorkloadsServer is a fake server for instances of the armsapvirtualinstance.WorkloadsClient type.
type WorkloadsServer struct {
	...
	SAPAvailabilityZoneDetails func(ctx context.Context, location string, options *armsapvirtualinstance.WorkloadsClientSAPAvailabilityZoneDetailsOptions) (resp azfake.Responder[armsapvirtualinstance.WorkloadsClientSAPAvailabilityZoneDetailsResponse], errResp azfake.ErrorResponder)

	// SAPDiskConfigurations is the fake for method WorkloadsClient.SAPDiskConfigurations
	// HTTP status codes to indicate success: http.StatusOK
	SAPDiskConfigurations func(ctx context.Context, location string, options *armsapvirtualinstance.WorkloadsClientSAPDiskConfigurationsOptions) (resp azfake.Responder[armsapvirtualinstance.WorkloadsClientSAPDiskConfigurationsResponse], errResp azfake.ErrorResponder)

	// SAPSizingRecommendations is the fake for method WorkloadsClient.SAPSizingRecommendations
	// HTTP status codes to indicate success: http.StatusOK
	SAPSizingRecommendations func(ctx context.Context, location string, options *armsapvirtualinstance.WorkloadsClientSAPSizingRecommendationsOptions) (resp azfake.Responder[armsapvirtualinstance.WorkloadsClientSAPSizingRecommendationsResponse], errResp azfake.ErrorResponder)

	// SAPSupportedSKU is the fake for method WorkloadsClient.SAPSupportedSKU
	// HTTP status codes to indicate success: http.StatusOK
	SAPSupportedSKU func(ctx context.Context, location string, options *armsapvirtualinstance.WorkloadsClientSAPSupportedSKUOptions) (resp azfake.Responder[armsapvirtualinstance.WorkloadsClientSAPSupportedSKUResponse], errResp azfake.ErrorResponder)
}

// NewWorkloadsServerTransport creates a new instance of WorkloadsServerTransport with the provided implementation.
// The returned WorkloadsServerTransport instance is connected to an instance of armsapvirtualinstance.WorkloadsClient via the
...
// WorkloadsServerTransport connects instances of armsapvirtualinstance.WorkloadsClient to instances of WorkloadsServer.
...
func (w *WorkloadsServerTransport) dispatchSAPAvailabilityZoneDetails(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[armsapvirtualinstance.SAPAvailabilityZoneDetailsRequest](req)
	if err != nil {
		return nil, err
	}
	...
	var options *armsapvirtualinstance.WorkloadsClientSAPAvailabilityZoneDetailsOptions
	if !reflect.ValueOf(body).IsZero() {
		options = &armsapvirtualinstance.WorkloadsClientSAPAvailabilityZoneDetailsOptions{
...
func (w *WorkloadsServerTransport) dispatchSAPDiskConfigurations(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[armsapvirtualinstance.SAPDiskConfigurationsRequest](req)
	if err != nil {
		return nil, err
	}
	locationParam, err := url.PathUnescape(matches[regex.SubexpIndex("location")])
	...
	var options *armsapvirtualinstance.WorkloadsClientSAPDiskConfigurationsOptions
	if !reflect.ValueOf(body).IsZero() {
		options = &armsapvirtualinstance.WorkloadsClientSAPDiskConfigurationsOptions{
...
func (w *WorkloadsServerTransport) dispatchSAPSizingRecommendations(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[armsapvirtualinstance.SAPSizingRecommendationRequest](req)
	if err != nil {
		return nil, err
	}
	locationParam, err := url.PathUnescape(matches[regex.SubexpIndex("location")])
	...
	var options *armsapvirtualinstance.WorkloadsClientSAPSizingRecommendationsOptions
	if !reflect.ValueOf(body).IsZero() {
		options = &armsapvirtualinstance.WorkloadsClientSAPSizingRecommendationsOptions{
...
func (w *WorkloadsServerTransport) dispatchSAPSupportedSKU(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[armsapvirtualinstance.SAPSupportedSKUsRequest](req)
	if err != nil {
		return nil, err
	}
	locationParam, err := url.PathUnescape(matches[regex.SubexpIndex("location")])
	...
	var options *armsapvirtualinstance.WorkloadsClientSAPSupportedSKUOptions
	if !reflect.ValueOf(body).IsZero() {
		options = &armsapvirtualinstance.WorkloadsClientSAPSupportedSKUOptions{
