...
func (e EdgeModuleProvisioningToken) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateDateTimeRFC3339(objectMap, "expirationDate", e.ExpirationDate)
...
func (e *EdgeModuleProvisioningToken) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "expirationDate":
			err = unpopulateDateTimeRFC3339(val, "ExpirationDate", &e.ExpirationDate)
			delete(rawMsg, key)
		case "token":
...
func (p PipelineJobProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "description", p.Description)
	populate(objectMap, "error", p.Error)
	populateDateTimeRFC3339(objectMap, "expiration", p.Expiration)
...
func (p *PipelineJobProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "error":
			...
			delete(rawMsg, key)
		case "expiration":
			err = unpopulateDateTimeRFC3339(val, "Expiration", &p.Expiration)
			delete(rawMsg, key)
		case "parameters":
...
func (v VideoContentToken) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateDateTimeRFC3339(objectMap, "expirationDate", v.ExpirationDate)
...
func (v *VideoContentToken) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "expirationDate":
			err = unpopulateDateTimeRFC3339(val, "ExpirationDate", &v.ExpirationDate)
			delete(rawMsg, key)
		case "token":
