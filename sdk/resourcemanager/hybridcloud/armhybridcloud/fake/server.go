...
// Server is a fake server for instances of the armhybridcloud.Client type.
type Server struct {
	// NewListOperationsPager is the fake for method Client.NewListOperationsPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListOperationsPager func(options *armhybridcloud.ClientListOperationsOptions) (resp azfake.PagerResponder[armhybridcloud.ClientListOperationsResponse])
}

// NewServerTransport creates a new instance of ServerTransport with the provided implementation.
// The returned ServerTransport instance is connected to an instance of armhybridcloud.Client via the
// azcore.ClientOptions.Transporter field in the client's constructor parameters.
func NewServerTransport(srv *Server) *ServerTransport {
	return &ServerTransport{
		srv:                    srv,
		newListOperationsPager: newTracker[azfake.PagerResponder[armhybridcloud.ClientListOperationsResponse]](),
	}
}

// ServerTransport connects instances of armhybridcloud.Client to instances of Server.
// Don't use this type directly, use NewServerTransport instead.
type ServerTransport struct {
	srv                    *Server
	newListOperationsPager *tracker[azfake.PagerResponder[armhybridcloud.ClientListOperationsResponse]]
}
