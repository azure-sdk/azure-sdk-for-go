...
- New function `*ProjectsClient.BeginCreate(context.Context, string, string, string, Account, *ProjectsClientBeginCreateOptions) (*runtime.Poller[ProjectsClientCreateResponse], error)`
...
- New function `*ProjectsClient.BeginUpdate(context.Context, string, string, string, Account, *ProjectsClientBeginUpdateOptions) (*runtime.Poller[ProjectsClientUpdateResponse], error)`
