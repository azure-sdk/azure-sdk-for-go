	...
	go func() {
		...
		if !intercepted {
			...
			case "ManagersClient.CreateExtendedInfo":
				res.resp, res.err = m.dispatchCreateExtendedInfo(req)
			...
			case "ManagersClient.DeleteExtendedInfo":
				res.resp, res.err = m.dispatchDeleteExtendedInfo(req)
			case "ManagersClient.Get":
				res.resp, res.err = m.dispatchGet(req)
			case "ManagersClient.GetActivationKey":
				res.resp, res.err = m.dispatchGetActivationKey(req)
			case "ManagersClient.GetDevicePublicEncryptionKey":
				res.resp, res.err = m.dispatchGetDevicePublicEncryptionKey(req)
			case "ManagersClient.GetEncryptionSettings":
				res.resp, res.err = m.dispatchGetEncryptionSettings(req)
			case "ManagersClient.GetExtendedInfo":
				res.resp, res.err = m.dispatchGetExtendedInfo(req)
			case "ManagersClient.GetPublicEncryptionKey":
				res.resp, res.err = m.dispatchGetPublicEncryptionKey(req)
			...
			case "ManagersClient.NewListFeatureSupportStatusPager":
				res.resp, res.err = m.dispatchNewListFeatureSupportStatusPager(req)
			case "ManagersClient.NewListMetricDefinitionPager":
				res.resp, res.err = m.dispatchNewListMetricDefinitionPager(req)
			case "ManagersClient.NewListMetricsPager":
				res.resp, res.err = m.dispatchNewListMetricsPager(req)
			case "ManagersClient.RegenerateActivationKey":
				res.resp, res.err = m.dispatchRegenerateActivationKey(req)
			case "ManagersClient.Update":
				res.resp, res.err = m.dispatchUpdate(req)
			case "ManagersClient.UpdateExtendedInfo":
				res.resp, res.err = m.dispatchUpdateExtendedInfo(req)
			default:
