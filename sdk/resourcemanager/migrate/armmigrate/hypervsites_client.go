...
func (client *HypervSitesClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, _ *HypervSitesClientListByResourceGroupOptions) (*policy.Request, error) {
...
func (client *HypervSitesClient) listBySubscriptionCreateRequest(ctx context.Context, _ *HypervSitesClientListBySubscriptionOptions) (*policy.Request, error) {
