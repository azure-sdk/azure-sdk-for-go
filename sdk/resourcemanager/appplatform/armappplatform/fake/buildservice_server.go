...
func (b *BuildServiceServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if buildServiceServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = buildServiceServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "BuildServiceClient.CreateOrUpdateBuild":
				res.resp, res.err = b.dispatchCreateOrUpdateBuild(req)
			case "BuildServiceClient.BeginDeleteBuild":
				res.resp, res.err = b.dispatchBeginDeleteBuild(req)
			case "BuildServiceClient.GetBuild":
				res.resp, res.err = b.dispatchGetBuild(req)
			case "BuildServiceClient.GetBuildResult":
				res.resp, res.err = b.dispatchGetBuildResult(req)
			case "BuildServiceClient.GetBuildResultLog":
				res.resp, res.err = b.dispatchGetBuildResultLog(req)
			case "BuildServiceClient.GetBuildService":
				res.resp, res.err = b.dispatchGetBuildService(req)
			case "BuildServiceClient.GetResourceUploadURL":
				res.resp, res.err = b.dispatchGetResourceUploadURL(req)
			case "BuildServiceClient.GetSupportedBuildpack":
				res.resp, res.err = b.dispatchGetSupportedBuildpack(req)
			case "BuildServiceClient.GetSupportedStack":
				res.resp, res.err = b.dispatchGetSupportedStack(req)
			case "BuildServiceClient.NewListBuildResultsPager":
				res.resp, res.err = b.dispatchNewListBuildResultsPager(req)
			case "BuildServiceClient.NewListBuildServicesPager":
				res.resp, res.err = b.dispatchNewListBuildServicesPager(req)
			case "BuildServiceClient.NewListBuildsPager":
				res.resp, res.err = b.dispatchNewListBuildsPager(req)
			case "BuildServiceClient.ListSupportedBuildpacks":
				res.resp, res.err = b.dispatchListSupportedBuildpacks(req)
			case "BuildServiceClient.ListSupportedStacks":
				res.resp, res.err = b.dispatchListSupportedStacks(req)
			default:
...
// set this to conditionally intercept incoming requests to BuildServiceServerTransport
var buildServiceServerTransportInterceptor interface {
