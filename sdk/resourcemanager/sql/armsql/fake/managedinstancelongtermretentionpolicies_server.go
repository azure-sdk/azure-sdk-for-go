...
type ManagedInstanceLongTermRetentionPoliciesServer struct {
	...
	// BeginDelete is the fake for method ManagedInstanceLongTermRetentionPoliciesClient.BeginDelete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginDelete func(ctx context.Context, resourceGroupName string, managedInstanceName string, databaseName string, policyName armsql.ManagedInstanceLongTermRetentionPolicyName, options *armsql.ManagedInstanceLongTermRetentionPoliciesClientBeginDeleteOptions) (resp azfake.PollerResponder[armsql.ManagedInstanceLongTermRetentionPoliciesClientDeleteResponse], errResp azfake.ErrorResponder)
...
func NewManagedInstanceLongTermRetentionPoliciesServerTransport(srv *ManagedInstanceLongTermRetentionPoliciesServer) *ManagedInstanceLongTermRetentionPoliciesServerTransport {
	return &ManagedInstanceLongTermRetentionPoliciesServerTransport{
		...
		beginDelete:            newTracker[azfake.PollerResponder[armsql.ManagedInstanceLongTermRetentionPoliciesClientDeleteResponse]](),
...
type ManagedInstanceLongTermRetentionPoliciesServerTransport struct {
	...
	beginDelete            *tracker[azfake.PollerResponder[armsql.ManagedInstanceLongTermRetentionPoliciesClientDeleteResponse]]
...
func (m *ManagedInstanceLongTermRetentionPoliciesServerTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "ManagedInstanceLongTermRetentionPoliciesClient.BeginDelete":
...
func (m *ManagedInstanceLongTermRetentionPoliciesServerTransport) dispatchBeginDelete(req *http.Request) (*http.Response, error) {
	...
	if beginDelete == nil {
		...
		respr, errRespr := m.srv.BeginDelete(req.Context(), resourceGroupNameParam, managedInstanceNameParam, databaseNameParam, policyNameParam, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginDelete = &respr
