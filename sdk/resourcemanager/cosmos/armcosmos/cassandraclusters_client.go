...
func (client *CassandraClustersClient) BeginCreateUpdate(ctx context.Context, resourceGroupName string, clusterName string, body ClusterResource, options *CassandraClustersClientBeginCreateUpdateOptions) (*runtime.Poller[CassandraClustersClientCreateUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		poller, err := runtime.NewPoller[CassandraClustersClientCreateUpdateResponse](resp, client.internal.Pipeline(), nil)
		return poller, err
	} else {
...
func (client *CassandraClustersClient) BeginDeallocate(ctx context.Context, resourceGroupName string, clusterName string, options *CassandraClustersClientBeginDeallocateOptions) (*runtime.Poller[CassandraClustersClientDeallocateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		poller, err := runtime.NewPoller[CassandraClustersClientDeallocateResponse](resp, client.internal.Pipeline(), nil)
		return poller, err
	} else {
...
func (client *CassandraClustersClient) BeginDelete(ctx context.Context, resourceGroupName string, clusterName string, options *CassandraClustersClientBeginDeleteOptions) (*runtime.Poller[CassandraClustersClientDeleteResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		poller, err := runtime.NewPoller[CassandraClustersClientDeleteResponse](resp, client.internal.Pipeline(), nil)
		return poller, err
	} else {
...
// BeginGetCommandAsync - Get list of details about commands that were run asynchronously. Use "all" as commandId to list
// all commands in three days associated with the cluster.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2023-11-15-preview
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
...
//   - options - CassandraClustersClientBeginGetCommandAsyncOptions contains the optional parameters for the CassandraClustersClient.BeginGetCommandAsync
//     method.
func (client *CassandraClustersClient) BeginGetCommandAsync(ctx context.Context, resourceGroupName string, clusterName string, commandID string, options *CassandraClustersClientBeginGetCommandAsyncOptions) (*runtime.Poller[CassandraClustersClientGetCommandAsyncResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.getCommandAsync(ctx, resourceGroupName, clusterName, commandID, options)
		if err != nil {
			return nil, err
		}
		poller, err := runtime.NewPoller[CassandraClustersClientGetCommandAsyncResponse](resp, client.internal.Pipeline(), nil)
		return poller, err
	} else {
		return runtime.NewPollerFromResumeToken[CassandraClustersClientGetCommandAsyncResponse](options.ResumeToken, client.internal.Pipeline(), nil)
	}
}

// GetCommandAsync - Get list of details about commands that were run asynchronously. Use "all" as commandId to list all commands
// in three days associated with the cluster.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2023-11-15-preview
func (client *CassandraClustersClient) getCommandAsync(ctx context.Context, resourceGroupName string, clusterName string, commandID string, options *CassandraClustersClientBeginGetCommandAsyncOptions) (*http.Response, error) {
	var err error
...
func (client *CassandraClustersClient) getCommandAsyncCreateRequest(ctx context.Context, resourceGroupName string, clusterName string, commandID string, options *CassandraClustersClientBeginGetCommandAsyncOptions) (*policy.Request, error) {
...
func (client *CassandraClustersClient) BeginInvokeCommand(ctx context.Context, resourceGroupName string, clusterName string, body CommandPostBody, options *CassandraClustersClientBeginInvokeCommandOptions) (*runtime.Poller[CassandraClustersClientInvokeCommandResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		poller, err := runtime.NewPoller[CassandraClustersClientInvokeCommandResponse](resp, client.internal.Pipeline(), nil)
		return poller, err
	} else {
...
//     method.
func (client *CassandraClustersClient) BeginInvokeCommandAsync(ctx context.Context, resourceGroupName string, clusterName string, body CommandPostBody, options *CassandraClustersClientBeginInvokeCommandAsyncOptions) (*runtime.Poller[CassandraClustersClientInvokeCommandAsyncResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.invokeCommandAsync(ctx, resourceGroupName, clusterName, body, options)
		if err != nil {
			return nil, err
		}
		poller, err := runtime.NewPoller[CassandraClustersClientInvokeCommandAsyncResponse](resp, client.internal.Pipeline(), nil)
		return poller, err
	} else {
		return runtime.NewPollerFromResumeToken[CassandraClustersClientInvokeCommandAsyncResponse](options.ResumeToken, client.internal.Pipeline(), nil)
	}
}
...
//
// Generated from API version 2023-11-15-preview
func (client *CassandraClustersClient) invokeCommandAsync(ctx context.Context, resourceGroupName string, clusterName string, body CommandPostBody, options *CassandraClustersClientBeginInvokeCommandAsyncOptions) (*http.Response, error) {
	var err error
...
func (client *CassandraClustersClient) invokeCommandAsyncCreateRequest(ctx context.Context, resourceGroupName string, clusterName string, body CommandPostBody, options *CassandraClustersClientBeginInvokeCommandAsyncOptions) (*policy.Request, error) {
...
// BeginListCommand - List all commands currently running on ring info
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2023-11-15-preview
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - clusterName - Managed Cassandra cluster name.
//   - options - CassandraClustersClientBeginListCommandOptions contains the optional parameters for the CassandraClustersClient.BeginListCommand
//     method.
func (client *CassandraClustersClient) BeginListCommand(ctx context.Context, resourceGroupName string, clusterName string, options *CassandraClustersClientBeginListCommandOptions) (*runtime.Poller[CassandraClustersClientListCommandResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.listCommand(ctx, resourceGroupName, clusterName, options)
		if err != nil {
			return nil, err
		}
		poller, err := runtime.NewPoller[CassandraClustersClientListCommandResponse](resp, client.internal.Pipeline(), nil)
		return poller, err
	} else {
		return runtime.NewPollerFromResumeToken[CassandraClustersClientListCommandResponse](options.ResumeToken, client.internal.Pipeline(), nil)
	}
}

// ListCommand - List all commands currently running on ring info
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2023-11-15-preview
func (client *CassandraClustersClient) listCommand(ctx context.Context, resourceGroupName string, clusterName string, options *CassandraClustersClientBeginListCommandOptions) (*http.Response, error) {
	var err error
...
func (client *CassandraClustersClient) listCommandCreateRequest(ctx context.Context, resourceGroupName string, clusterName string, options *CassandraClustersClientBeginListCommandOptions) (*policy.Request, error) {
...
func (client *CassandraClustersClient) BeginStart(ctx context.Context, resourceGroupName string, clusterName string, options *CassandraClustersClientBeginStartOptions) (*runtime.Poller[CassandraClustersClientStartResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		poller, err := runtime.NewPoller[CassandraClustersClientStartResponse](resp, client.internal.Pipeline(), nil)
		return poller, err
	} else {
...
func (client *CassandraClustersClient) BeginUpdate(ctx context.Context, resourceGroupName string, clusterName string, body ClusterResource, options *CassandraClustersClientBeginUpdateOptions) (*runtime.Poller[CassandraClustersClientUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		poller, err := runtime.NewPoller[CassandraClustersClientUpdateResponse](resp, client.internal.Pipeline(), nil)
		return poller, err
	} else {
