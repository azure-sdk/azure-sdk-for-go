...
// LabelHistoryRecordItemStatus - Status of the label history record.
type LabelHistoryRecordItemStatus string

const (
	LabelHistoryRecordItemStatusFailed    LabelHistoryRecordItemStatus = "Failed"
	LabelHistoryRecordItemStatusStarting  LabelHistoryRecordItemStatus = "Starting"
	LabelHistoryRecordItemStatusSucceeded LabelHistoryRecordItemStatus = "Succeeded"
)

// PossibleLabelHistoryRecordItemStatusValues returns the possible values for the LabelHistoryRecordItemStatus const type.
func PossibleLabelHistoryRecordItemStatusValues() []LabelHistoryRecordItemStatus {
	return []LabelHistoryRecordItemStatus{
		LabelHistoryRecordItemStatusFailed,
		LabelHistoryRecordItemStatusStarting,
		LabelHistoryRecordItemStatusSucceeded,
	}
}
