...
// Generated from example definition: 2025-03-30-preview/Operations_List_MaximumSet_Gen.json
func ExampleOperationsClient_NewListPager_operationsListMaximumSetGenGeneratedByMaximumSetRule() {
	...
	for pager.More() {
		...
		// 					Provider: to.Ptr("ti"),
		// 					Resource: to.Ptr("wdhioeuhxgfawmuxbddkt"),
		// 					Operation: to.Ptr("y"),
		// 					Description: to.Ptr("fgvkipcscaeospzgx"),
		// 				},
...
// Generated from example definition: 2025-03-30-preview/Operations_List_MinimumSet_Gen.json
