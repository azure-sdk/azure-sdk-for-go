...
// Generated from example definition: 2024-11-01-preview/ApplicableDiscountsList.json
func ExampleDiscountsOperationGroupClient_NewScopeListPager() {
	...
	pager := clientFactory.NewDiscountsOperationGroupClient().NewScopeListPager("providers/Microsoft.Billing/billingAccounts/{acctId}", nil)
	for pager.More() {
		...
		// page = armbillingbenefits.DiscountsOperationGroupClientScopeListResponse{
