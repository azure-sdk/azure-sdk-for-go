...
func unmarshalDeliveryRuleActionAutoGeneratedClassification(rawMsg json.RawMessage) (DeliveryRuleActionAutoGeneratedClassification, error) {
	...
	case string(DeliveryRuleActionCustomErrorPageURL):
		b = &DeliveryRuleCustomErrorPageAction{}
	...
	case string(DeliveryRuleActionOverrideResponseStatusCode):
		b = &DeliveryRuleOverrideResponseStatusCodeAction{}
...
func unmarshalDeliveryRuleConditionClassification(rawMsg json.RawMessage) (DeliveryRuleConditionClassification, error) {
	...
	case string(MatchVariableResponseStatusCode):
		b = &DeliveryRuleResponseStatusCodeCondition{}
