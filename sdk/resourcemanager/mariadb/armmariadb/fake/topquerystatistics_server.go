...
func (t *TopQueryStatisticsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if topQueryStatisticsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = topQueryStatisticsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to TopQueryStatisticsServerTransport
var topQueryStatisticsServerTransportInterceptor interface {
