...
func (client *SapVirtualInstancesClient) invokeAvailabilityZoneDetailsCreateRequest(ctx context.Context, location string, body SAPAvailabilityZoneDetailsRequest, _ *SapVirtualInstancesClientInvokeAvailabilityZoneDetailsOptions) (*policy.Request, error) {
...
func (client *SapVirtualInstancesClient) invokeDiskConfigurationsCreateRequest(ctx context.Context, location string, body SAPDiskConfigurationsRequest, _ *SapVirtualInstancesClientInvokeDiskConfigurationsOptions) (*policy.Request, error) {
...
func (client *SapVirtualInstancesClient) invokeSapSupportedSKUCreateRequest(ctx context.Context, location string, body SAPSupportedSKUsRequest, _ *SapVirtualInstancesClientInvokeSapSupportedSKUOptions) (*policy.Request, error) {
...
func (client *SapVirtualInstancesClient) invokeSizingRecommendationsCreateRequest(ctx context.Context, location string, body SAPSizingRecommendationRequest, _ *SapVirtualInstancesClientInvokeSizingRecommendationsOptions) (*policy.Request, error) {
