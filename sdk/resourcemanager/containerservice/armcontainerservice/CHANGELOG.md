...
- New field `GatewayProfile`, `PodIPAllocationMode` in struct `ManagedClusterAgentPoolProfile`
- New field `GatewayProfile`, `PodIPAllocationMode` in struct `ManagedClusterAgentPoolProfileProperties`
