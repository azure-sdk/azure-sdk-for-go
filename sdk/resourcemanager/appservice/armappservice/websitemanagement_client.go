...
// GetUsagesInLocation - Gets the usage in cores for a subscription in a given location.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2023-01-01
//   - location - The location for which to check usages
//   - options - WebSiteManagementClientGetUsagesInLocationOptions contains the optional parameters for the WebSiteManagementClient.GetUsagesInLocation
//     method.
func (client *WebSiteManagementClient) GetUsagesInLocation(ctx context.Context, location string, options *WebSiteManagementClientGetUsagesInLocationOptions) (WebSiteManagementClientGetUsagesInLocationResponse, error) {
	req, err := client.getUsagesInLocationCreateRequest(ctx, location, options)
	if err != nil {
		return WebSiteManagementClientGetUsagesInLocationResponse{}, err
	}
	resp, err := client.internal.Pipeline().Do(req)
	if err != nil {
		return WebSiteManagementClientGetUsagesInLocationResponse{}, err
	...
	if !runtime.HasStatusCode(resp, http.StatusOK) {
		return WebSiteManagementClientGetUsagesInLocationResponse{}, runtime.NewResponseError(resp)
	}
	return client.getUsagesInLocationHandleResponse(resp)
}

// getUsagesInLocationCreateRequest creates the GetUsagesInLocation request.
func (client *WebSiteManagementClient) getUsagesInLocationCreateRequest(ctx context.Context, location string, options *WebSiteManagementClientGetUsagesInLocationOptions) (*policy.Request, error) {
...
// getUsagesInLocationHandleResponse handles the GetUsagesInLocation response.
func (client *WebSiteManagementClient) getUsagesInLocationHandleResponse(resp *http.Response) (WebSiteManagementClientGetUsagesInLocationResponse, error) {
	result := WebSiteManagementClientGetUsagesInLocationResponse{}
...
// GetZoneRedundantUsagesInLocation - Gets the usage in cores for a subscription in a given location, with zone redundance.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2023-01-01
//   - location - The location for which to check ZR usages
//   - options - WebSiteManagementClientGetZoneRedundantUsagesInLocationOptions contains the optional parameters for the WebSiteManagementClient.GetZoneRedundantUsagesInLocation
//     method.
func (client *WebSiteManagementClient) GetZoneRedundantUsagesInLocation(ctx context.Context, location string, options *WebSiteManagementClientGetZoneRedundantUsagesInLocationOptions) (WebSiteManagementClientGetZoneRedundantUsagesInLocationResponse, error) {
	req, err := client.getZoneRedundantUsagesInLocationCreateRequest(ctx, location, options)
	if err != nil {
		return WebSiteManagementClientGetZoneRedundantUsagesInLocationResponse{}, err
	}
	resp, err := client.internal.Pipeline().Do(req)
	if err != nil {
		return WebSiteManagementClientGetZoneRedundantUsagesInLocationResponse{}, err
	...
	if !runtime.HasStatusCode(resp, http.StatusOK) {
		return WebSiteManagementClientGetZoneRedundantUsagesInLocationResponse{}, runtime.NewResponseError(resp)
	}
	return client.getZoneRedundantUsagesInLocationHandleResponse(resp)
}

// getZoneRedundantUsagesInLocationCreateRequest creates the GetZoneRedundantUsagesInLocation request.
func (client *WebSiteManagementClient) getZoneRedundantUsagesInLocationCreateRequest(ctx context.Context, location string, options *WebSiteManagementClientGetZoneRedundantUsagesInLocationOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/providers/Microsoft.Web/locations/{location}/zoneRedundant/usages"
	if location == "" {
		return nil, errors.New("parameter location cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{location}", url.PathEscape(location))
...
// getZoneRedundantUsagesInLocationHandleResponse handles the GetZoneRedundantUsagesInLocation response.
func (client *WebSiteManagementClient) getZoneRedundantUsagesInLocationHandleResponse(resp *http.Response) (WebSiteManagementClientGetZoneRedundantUsagesInLocationResponse, error) {
	result := WebSiteManagementClientGetZoneRedundantUsagesInLocationResponse{}
	if err := runtime.UnmarshalAsJSON(resp, &result.CsmUsageQuotaCollection); err != nil {
		return WebSiteManagementClientGetZoneRedundantUsagesInLocationResponse{}, err
	}
	return result, nil
