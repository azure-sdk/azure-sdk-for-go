...
// WorkspacesClientBeginFailbackOptions contains the optional parameters for the WorkspacesClient.BeginFailback method.
type WorkspacesClientBeginFailbackOptions struct {
	// Resumes the long-running operation from the provided token.
	ResumeToken string
}

// WorkspacesClientBeginFailoverOptions contains the optional parameters for the WorkspacesClient.BeginFailover method.
type WorkspacesClientBeginFailoverOptions struct {
	// Resumes the long-running operation from the provided token.
	ResumeToken string
}
