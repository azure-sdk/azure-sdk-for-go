...
type CheckNameAvailabilityRequest struct {
	...
	// CONSTANT; undefinedField has constant value "Microsoft.Sql/servers", any specified value is ignored.
	Type *string
}
...
// DatabaseBillingVersionProperties - Properties of a billing version response.
type DatabaseBillingVersionProperties struct {
	// The pricing model to use when calculating billing for this database.
	BillingVersion *DatabaseBillingVersion
}

// DatabaseBillingVersionResponse - A response containing a billing version.
type DatabaseBillingVersionResponse struct {
	// Billing Version response properties.
	Properties *DatabaseBillingVersionProperties
...
type DatabaseProperties struct {
	...
	// READ-ONLY; The pricing model to use when calculating billing for this database.
...
type ManagedInstanceProperties struct {
	...
	// Total memory in MB. Minimum value: 7168. Maximum value: 891328. Increments of 1 MB allowed only. Maximum value depends
