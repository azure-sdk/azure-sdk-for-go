...
type CategoriesServer struct {
	...
	// HTTP status codes to indicate success: http.StatusOK
	NewListBySubscriptionPager func(resourceType string, options *armimpact.CategoriesClientListBySubscriptionOptions) (resp azfake.PagerResponder[armimpact.CategoriesClientListBySubscriptionResponse])
}
...
func (c *CategoriesServerTransport) dispatchNewListBySubscriptionPager(req *http.Request) (*http.Response, error) {
	...
	if newListBySubscriptionPager == nil {
		...
		resp := c.srv.NewListBySubscriptionPager(resourceTypeParam, options)
