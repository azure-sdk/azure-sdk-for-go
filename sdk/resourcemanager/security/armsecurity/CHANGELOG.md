...
- New function `*ClientFactory.NewDataScannersClient() *DataScannersClient`
- New function `NewDataScannersClient(string, azcore.TokenCredential, *arm.ClientOptions) (*DataScannersClient, error)`
- New function `*DataScannersClient.CreateOrUpdate(context.Context, string, *DataScannersClientCreateOrUpdateOptions) (DataScannersClientCreateOrUpdateResponse, error)`
- New function `*DataScannersClient.Delete(context.Context, string, *DataScannersClientDeleteOptions) (DataScannersClientDeleteResponse, error)`
- New function `*DataScannersClient.Get(context.Context, string, *DataScannersClientGetOptions) (DataScannersClientGetResponse, error)`
- New function `*DataScannersClient.NewListBySubscriptionPager(*DataScannersClientListBySubscriptionOptions) *runtime.Pager[DataScannersClientListBySubscriptionResponse]`
...
- New struct `DataScanner`
- New struct `DataScannersList`
