...
func (p *ProjectCatalogEnvironmentDefinitionsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if projectCatalogEnvironmentDefinitionsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = projectCatalogEnvironmentDefinitionsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to ProjectCatalogEnvironmentDefinitionsServerTransport
var projectCatalogEnvironmentDefinitionsServerTransportInterceptor interface {
