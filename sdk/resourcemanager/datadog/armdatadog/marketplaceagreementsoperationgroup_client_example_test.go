...
func ExampleMarketplaceAgreementsOperationGroupClient_CreateOrUpdate() {
	...
	res, err := clientFactory.NewMarketplaceAgreementsOperationGroupClient().CreateOrUpdate(ctx, armdatadog.AgreementResource{
	...
	// res = armdatadog.MarketplaceAgreementsOperationGroupClientCreateOrUpdateResponse{
...
func ExampleMarketplaceAgreementsOperationGroupClient_NewListPager() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	pager := clientFactory.NewMarketplaceAgreementsOperationGroupClient().NewListPager(nil)
	for pager.More() {
		...
		// page = armdatadog.MarketplaceAgreementsOperationGroupClientListResponse{
