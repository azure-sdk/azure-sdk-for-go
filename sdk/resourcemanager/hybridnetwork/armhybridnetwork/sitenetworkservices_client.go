...
func (client *SiteNetworkServicesClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, siteNetworkServiceName string, parameters SiteNetworkService, _ *SiteNetworkServicesClientBeginCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *SiteNetworkServicesClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, siteNetworkServiceName string, _ *SiteNetworkServicesClientBeginDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HybridNetwork/siteNetworkServices/{siteNetworkServiceName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *SiteNetworkServicesClient) getCreateRequest(ctx context.Context, resourceGroupName string, siteNetworkServiceName string, _ *SiteNetworkServicesClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HybridNetwork/siteNetworkServices/{siteNetworkServiceName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *SiteNetworkServicesClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, _ *SiteNetworkServicesClientListByResourceGroupOptions) (*policy.Request, error) {
...
func (client *SiteNetworkServicesClient) listBySubscriptionCreateRequest(ctx context.Context, _ *SiteNetworkServicesClientListBySubscriptionOptions) (*policy.Request, error) {
...
func (client *SiteNetworkServicesClient) updateTagsCreateRequest(ctx context.Context, resourceGroupName string, siteNetworkServiceName string, parameters TagsObject, _ *SiteNetworkServicesClientUpdateTagsOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HybridNetwork/siteNetworkServices/{siteNetworkServiceName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
