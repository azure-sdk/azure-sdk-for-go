...
func (client *WorkloadImpactsClient) createCreateRequest(ctx context.Context, workloadImpactName string, resource WorkloadImpact, options *WorkloadImpactsClientBeginCreateOptions) (*policy.Request, error) {
...
func (client *WorkloadImpactsClient) deleteCreateRequest(ctx context.Context, workloadImpactName string, options *WorkloadImpactsClientDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/providers/Microsoft.Impact/workloadImpacts/{workloadImpactName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *WorkloadImpactsClient) getCreateRequest(ctx context.Context, workloadImpactName string, options *WorkloadImpactsClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/providers/Microsoft.Impact/workloadImpacts/{workloadImpactName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *WorkloadImpactsClient) listBySubscriptionCreateRequest(ctx context.Context, options *WorkloadImpactsClientListBySubscriptionOptions) (*policy.Request, error) {
