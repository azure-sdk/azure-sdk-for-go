...
func (a *AzureBareMetalStorageInstancesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if azureBareMetalStorageInstancesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = azureBareMetalStorageInstancesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to AzureBareMetalStorageInstancesServerTransport
var azureBareMetalStorageInstancesServerTransportInterceptor interface {
