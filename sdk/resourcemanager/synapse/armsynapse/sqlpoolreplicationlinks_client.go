...
func (client *SQLPoolReplicationLinksClient) getByNameCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, sqlPoolName string, linkID string, _ *SQLPoolReplicationLinksClientGetByNameOptions) (*policy.Request, error) {
...
func (client *SQLPoolReplicationLinksClient) listCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, sqlPoolName string, _ *SQLPoolReplicationLinksClientListOptions) (*policy.Request, error) {
