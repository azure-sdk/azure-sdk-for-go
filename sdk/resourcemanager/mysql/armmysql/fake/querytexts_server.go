...
func (q *QueryTextsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if queryTextsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = queryTextsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "QueryTextsClient.NewListByServerPager":
				res.resp, res.err = q.dispatchNewListByServerPager(req)
			default:
...
// set this to conditionally intercept incoming requests to QueryTextsServerTransport
var queryTextsServerTransportInterceptor interface {
