...
func (client *AttestationStatusesClient) getCreateRequest(ctx context.Context, resourceURI string, options *AttestationStatusesClientGetOptions) (*policy.Request, error) {
