...
// DistanceFunction - Indicates the type of distance function of the Embedding
...
// VectorDataType - Indicates the type of Embedding
...
// VectorIndexType - Vector Indexing Type to be applied on the path
