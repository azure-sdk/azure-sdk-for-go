...
func (client *SQLImportJobsControllerClient) getImportjobCreateRequest(ctx context.Context, resourceGroupName string, siteName string, sqlSiteName string, jobName string, options *SQLImportJobsControllerClientGetImportjobOptions) (*policy.Request, error) {
...
func (client *SQLImportJobsControllerClient) listImportjobsCreateRequest(ctx context.Context, resourceGroupName string, siteName string, sqlSiteName string, options *SQLImportJobsControllerClientListImportjobsOptions) (*policy.Request, error) {
