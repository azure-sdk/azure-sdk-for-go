...
type WorkspacesServer struct {
	...
	// HTTP status codes to indicate success: http.StatusOK
	UpdateTags func(ctx context.Context, resourceGroupName string, workspaceName string, properties armquantum.TagsObject, options *armquantum.WorkspacesClientUpdateTagsOptions) (resp azfake.Responder[armquantum.WorkspacesClientUpdateTagsResponse], errResp azfake.ErrorResponder)
}
