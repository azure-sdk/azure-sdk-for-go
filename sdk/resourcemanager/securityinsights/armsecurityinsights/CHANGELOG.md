...
- New value `DataConnectorKindRestAPIPoller` added to enum type `DataConnectorKind`
...
- New enum type `SourceType` with values `SourceTypeLocalFile`, `SourceTypeRemoteStorage`
