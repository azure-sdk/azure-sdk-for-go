...
func (client *PrivateLinkResourcesClient) getCreateRequest(ctx context.Context, resourceGroupName string, azureResourceName string, privateLinkResourceName string, _ *PrivateLinkResourcesClientGetOptions) (*policy.Request, error) {
...
func (client *PrivateLinkResourcesClient) listByResourceCreateRequest(ctx context.Context, resourceGroupName string, azureResourceName string, _ *PrivateLinkResourcesClientListByResourceOptions) (*policy.Request, error) {
