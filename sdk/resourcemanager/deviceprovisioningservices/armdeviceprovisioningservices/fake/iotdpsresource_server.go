...
type IotDpsResourceServer struct {
	...
	// HTTP status codes to indicate success: http.StatusOK, http.StatusCreated
	BeginCreateOrUpdatePrivateEndpointConnection func(ctx context.Context, resourceGroupName string, provisioningServiceName string, privateEndpointConnectionName string, privateEndpointConnection armdeviceprovisioningservices.PrivateEndpointConnection, options *armdeviceprovisioningservices.IotDpsResourceClientBeginCreateOrUpdatePrivateEndpointConnectionOptions) (resp azfake.PollerResponder[armdeviceprovisioningservices.IotDpsResourceClientCreateOrUpdatePrivateEndpointConnectionResponse], errResp azfake.ErrorResponder)
	...
	BeginDeletePrivateEndpointConnection func(ctx context.Context, resourceGroupName string, provisioningServiceName string, privateEndpointConnectionName string, options *armdeviceprovisioningservices.IotDpsResourceClientBeginDeletePrivateEndpointConnectionOptions) (resp azfake.PollerResponder[armdeviceprovisioningservices.IotDpsResourceClientDeletePrivateEndpointConnectionResponse], errResp azfake.ErrorResponder)
	...
	// HTTP status codes to indicate success: http.StatusOK
	GetPrivateEndpointConnection func(ctx context.Context, resourceGroupName string, provisioningServiceName string, privateEndpointConnectionName string, options *armdeviceprovisioningservices.IotDpsResourceClientGetPrivateEndpointConnectionOptions) (resp azfake.Responder[armdeviceprovisioningservices.IotDpsResourceClientGetPrivateEndpointConnectionResponse], errResp azfake.ErrorResponder)

	// GetPrivateLinkResources is the fake for method IotDpsResourceClient.GetPrivateLinkResources
	// HTTP status codes to indicate success: http.StatusOK
	GetPrivateLinkResources func(ctx context.Context, resourceGroupName string, provisioningServiceName string, groupID string, options *armdeviceprovisioningservices.IotDpsResourceClientGetPrivateLinkResourcesOptions) (resp azfake.Responder[armdeviceprovisioningservices.IotDpsResourceClientGetPrivateLinkResourcesResponse], errResp azfake.ErrorResponder)
	...
	// HTTP status codes to indicate success: http.StatusOK
	ListPrivateEndpointConnections func(ctx context.Context, resourceGroupName string, provisioningServiceName string, options *armdeviceprovisioningservices.IotDpsResourceClientListPrivateEndpointConnectionsOptions) (resp azfake.Responder[armdeviceprovisioningservices.IotDpsResourceClientListPrivateEndpointConnectionsResponse], errResp azfake.ErrorResponder)

	// ListPrivateLinkResources is the fake for method IotDpsResourceClient.ListPrivateLinkResources
	// HTTP status codes to indicate success: http.StatusOK
	ListPrivateLinkResources func(ctx context.Context, resourceGroupName string, provisioningServiceName string, options *armdeviceprovisioningservices.IotDpsResourceClientListPrivateLinkResourcesOptions) (resp azfake.Responder[armdeviceprovisioningservices.IotDpsResourceClientListPrivateLinkResourcesResponse], errResp azfake.ErrorResponder)
...
func (i *IotDpsResourceServerTransport) dispatchBeginCreateOrUpdatePrivateEndpointConnection(req *http.Request) (*http.Response, error) {
	...
	if beginCreateOrUpdatePrivateEndpointConnection == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.Devices/provisioningServices/(?P<provisioningServiceName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/privateEndpointConnections/(?P<privateEndpointConnectionName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		...
		respr, errRespr := i.srv.BeginCreateOrUpdatePrivateEndpointConnection(req.Context(), resourceGroupNameParam, provisioningServiceNameParam, privateEndpointConnectionNameParam, body, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
...
func (i *IotDpsResourceServerTransport) dispatchBeginDeletePrivateEndpointConnection(req *http.Request) (*http.Response, error) {
	...
	if beginDeletePrivateEndpointConnection == nil {
		...
		respr, errRespr := i.srv.BeginDeletePrivateEndpointConnection(req.Context(), resourceGroupNameParam, provisioningServiceNameParam, privateEndpointConnectionNameParam, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
...
func (i *IotDpsResourceServerTransport) dispatchGetOperationResult(req *http.Request) (*http.Response, error) {
	...
	const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.Devices/provisioningServices/(?P<provisioningServiceName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/operationresults/(?P<operationId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/getOperationResult`
	regex := regexp.MustCompile(regexStr)
	matches := regex.FindStringSubmatch(req.URL.EscapedPath())
	if matches == nil || len(matches) < 4 {
		return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
...
func (i *IotDpsResourceServerTransport) dispatchGetPrivateEndpointConnection(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := i.srv.GetPrivateEndpointConnection(req.Context(), resourceGroupNameParam, provisioningServiceNameParam, privateEndpointConnectionNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (i *IotDpsResourceServerTransport) dispatchGetPrivateLinkResources(req *http.Request) (*http.Response, error) {
	...
	const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.Devices/provisioningServices/(?P<provisioningServiceName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/privateLinkResources/(?P<groupId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)`
	regex := regexp.MustCompile(regexStr)
	matches := regex.FindStringSubmatch(req.URL.EscapedPath())
	if matches == nil || len(matches) < 4 {
		return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
	...
	respr, errRespr := i.srv.GetPrivateLinkResources(req.Context(), resourceGroupNameParam, provisioningServiceNameParam, groupIDParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (i *IotDpsResourceServerTransport) dispatchListPrivateEndpointConnections(req *http.Request) (*http.Response, error) {
	...
	const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.Devices/provisioningServices/(?P<provisioningServiceName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/privateEndpointConnections`
	regex := regexp.MustCompile(regexStr)
	matches := regex.FindStringSubmatch(req.URL.EscapedPath())
	if matches == nil || len(matches) < 3 {
		return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
	...
	respr, errRespr := i.srv.ListPrivateEndpointConnections(req.Context(), resourceGroupNameParam, provisioningServiceNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (i *IotDpsResourceServerTransport) dispatchListPrivateLinkResources(req *http.Request) (*http.Response, error) {
	...
	const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.Devices/provisioningServices/(?P<provisioningServiceName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/privateLinkResources`
	regex := regexp.MustCompile(regexStr)
	matches := regex.FindStringSubmatch(req.URL.EscapedPath())
	if matches == nil || len(matches) < 3 {
		return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
	...
	respr, errRespr := i.srv.ListPrivateLinkResources(req.Context(), resourceGroupNameParam, provisioningServiceNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
