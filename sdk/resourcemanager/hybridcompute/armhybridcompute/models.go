...
type AgentUpgrade struct {
	...
	LastAttemptMessage *string `json:"lastAttemptMessage,omitempty" azure:"ro"`

	// READ-ONLY; Specifies the status of Agent Upgrade.
	LastAttemptStatus *LastAttemptStatusEnum `json:"lastAttemptStatus,omitempty" azure:"ro"`

	// READ-ONLY; Timestamp of last upgrade attempt
	LastAttemptTimestamp *string `json:"lastAttemptTimestamp,omitempty" azure:"ro"`
}
...
type IPAddress struct {
	...
	Subnet *Subnet `json:"subnet,omitempty" azure:"ro"`
}
