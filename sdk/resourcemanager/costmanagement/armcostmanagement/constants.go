...
// CompressionModeType - Allow customers to select compress data(gzip, snappy) for exports. This setting will enable destination
// file compression scheme at runtime. By default set to None.
