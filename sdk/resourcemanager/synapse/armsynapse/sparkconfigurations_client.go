...
func (client *SparkConfigurationsClient) listByWorkspaceCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, _ *SparkConfigurationsClientListByWorkspaceOptions) (*policy.Request, error) {
