...
// PrometheusRuleGroupsClientListBySubscriptionTestResponse contains the response from method PrometheusRuleGroupsClient.NewListBySubscriptionTestPager.
type PrometheusRuleGroupsClientListBySubscriptionTestResponse struct {
	// Represents a collection of alert rule resources.
	PrometheusRuleGroupResourceCollection
}
