...
//     method.
func (client *DatastoresClient) NewListByClusterPager(resourceGroupName string, privateCloudName string, clusterName string, options *DatastoresClientListByClusterOptions) *runtime.Pager[DatastoresClientListByClusterResponse] {
...
func (client *DatastoresClient) listByClusterCreateRequest(ctx context.Context, resourceGroupName string, privateCloudName string, clusterName string, _ *DatastoresClientListByClusterOptions) (*policy.Request, error) {
