...
func (w *WebhookServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if webhookServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = webhookServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "WebhookClient.GenerateURI":
				res.resp, res.err = w.dispatchGenerateURI(req)
...
// set this to conditionally intercept incoming requests to WebhookServerTransport
var webhookServerTransportInterceptor interface {
