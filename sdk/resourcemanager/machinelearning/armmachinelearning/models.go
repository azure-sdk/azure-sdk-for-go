...
type BatchEndpointProperties struct {
	// REQUIRED; [Required] Use 'Key' for key-based authentication, 'AMLToken' for Azure Machine Learning token-based authentication,
	// and 'AADToken' for Microsoft Entra token-based authentication.
...
type RegenerateEndpointKeysRequest struct {
	...
	// [Deprecated] The value the key is set to. This value is no longer supported, and should not be set. If set, the KeyValue
	// will be ignored.
	KeyValue *string
}
