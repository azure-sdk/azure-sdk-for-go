...
type ServerFactory struct {
	...
	// ActionRequestsServer contains the fakes for client ActionRequestsClient
	ActionRequestsServer ActionRequestsServer

	// AnalysisResultsServer contains the fakes for client AnalysisResultsClient
	AnalysisResultsServer AnalysisResultsServer

	// AvailableInplaceUpgradeOSServer contains the fakes for client AvailableInplaceUpgradeOSClient
	AvailableInplaceUpgradeOSServer AvailableInplaceUpgradeOSServer

	// AvailableOSServer contains the fakes for client AvailableOSClient
	AvailableOSServer AvailableOSServer

	// BillingHubServiceServer contains the fakes for client BillingHubServiceClient
	BillingHubServiceServer BillingHubServiceServer

	// ChatSessionServer contains the fakes for client ChatSessionClient
	ChatSessionServer ChatSessionServer

	// ChatSessionsServer contains the fakes for client ChatSessionsClient
	...
	// CustomerEventsServer contains the fakes for client CustomerEventsClient
	CustomerEventsServer CustomerEventsServer

	// DraftPackagesServer contains the fakes for client DraftPackagesClient
	DraftPackagesServer DraftPackagesServer

	// EmailEventsServer contains the fakes for client EmailEventsClient
	EmailEventsServer EmailEventsServer

	// FavoriteProcessesServer contains the fakes for client FavoriteProcessesClient
	FavoriteProcessesServer FavoriteProcessesServer

	// FeatureUpdateSupportedOsesServer contains the fakes for client FeatureUpdateSupportedOsesClient
	FeatureUpdateSupportedOsesServer FeatureUpdateSupportedOsesServer

	// FirstPartyAppsServer contains the fakes for client FirstPartyAppsClient
	FirstPartyAppsServer FirstPartyAppsServer

	// FlightingRingsServer contains the fakes for client FlightingRingsClient
	FlightingRingsServer FlightingRingsServer

	// FreeHourBalancesServer contains the fakes for client FreeHourBalancesClient
	FreeHourBalancesServer FreeHourBalancesServer

	// GalleryAppSKUsServer contains the fakes for client GalleryAppSKUsClient
	GalleryAppSKUsServer GalleryAppSKUsServer

	// GalleryAppsServer contains the fakes for client GalleryAppsClient
	GalleryAppsServer GalleryAppsServer

	// ImageDefinitionsServer contains the fakes for client ImageDefinitionsClient
	ImageDefinitionsServer ImageDefinitionsServer

	// OSUpdatesServer contains the fakes for client OSUpdatesClient
	OSUpdatesServer OSUpdatesServer

	// OperationsServer contains the fakes for client OperationsClient
	OperationsServer OperationsServer

	// PackagesServer contains the fakes for client PackagesClient
	PackagesServer PackagesServer

	// SKUsServer contains the fakes for client SKUsClient
	SKUsServer SKUsServer

	// TestResultsServer contains the fakes for client TestResultsClient
	TestResultsServer TestResultsServer

	// TestSummariesServer contains the fakes for client TestSummariesClient
	TestSummariesServer TestSummariesServer

	// TestTypesServer contains the fakes for client TestTypesClient
	TestTypesServer TestTypesServer

	// UsageServer contains the fakes for client UsageClient
	UsageServer UsageServer

	// VHDsServer contains the fakes for client VHDsClient
