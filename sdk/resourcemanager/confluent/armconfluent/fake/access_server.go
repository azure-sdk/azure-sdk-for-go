...
type AccessServer struct {
	...
	DeleteRoleBinding func(ctx context.Context, resourceGroupName string, organizationName string, options *armconfluent.AccessClientDeleteRoleBindingOptions) (resp azfake.Responder[armconfluent.AccessClientDeleteRoleBindingResponse], errResp azfake.ErrorResponder)
...
func (a *AccessServerTransport) dispatchDeleteRoleBinding(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := a.srv.DeleteRoleBinding(req.Context(), resourceGroupNameParam, organizationNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
