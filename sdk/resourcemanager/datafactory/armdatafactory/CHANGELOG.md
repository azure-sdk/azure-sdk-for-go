...
- New enum type `WebConnectionAuthenticationType` with values `WebConnectionAuthenticationTypeAADServicePrincipal`, `WebConnectionAuthenticationTypeAnonymous`, `WebConnectionAuthenticationTypeBasic`, `WebConnectionAuthenticationTypeClientCertificate`, `WebConnectionAuthenticationTypeManagedServiceIdentity`, `WebConnectionAuthenticationTypeUserAssignedManagedIdentity`
...
- New function `*WebConnectionLinkedService.GetLinkedService() *LinkedService`
...
- New struct `WebConnectionLinkedService`
- New struct `WebConnectionLinkedServiceTypeProperties`
...
- New field `HTTPRequestTimeout`, `RelativeURL`, `TurnOffAsync` in struct `WebActivityTypeProperties`
- New field `ConnectVia` in struct `WebHookActivityTypeProperties`
