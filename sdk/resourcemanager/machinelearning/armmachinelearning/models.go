...
// GetStandbyPoolResponse - The response object from a successful call requesting a particular standby pool.
type GetStandbyPoolResponse struct {
	// Location of the standby pool.
	Location *string
	...
	Properties *StandbyPoolProperties

	// READ-ONLY; ARM resource ID of the standby pool.
	ID *string

	// READ-ONLY; Type of the ARM resource. In this case, a Standby Pool.
	Type *string
}
...
// StandbyPoolProperties - The properties of a standby pool.
type StandbyPoolProperties struct {
...
// StandbyPoolResourceStatus - The status of a resource within a standby pool.
type StandbyPoolResourceStatus struct {
