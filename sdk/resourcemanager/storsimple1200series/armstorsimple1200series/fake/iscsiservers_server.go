...
func (i *IscsiServersServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if iscsiServersServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = iscsiServersServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			case "IscsiServersClient.BeginBackupNow":
				res.resp, res.err = i.dispatchBeginBackupNow(req)
			...
			case "IscsiServersClient.NewListByManagerPager":
				res.resp, res.err = i.dispatchNewListByManagerPager(req)
...
// set this to conditionally intercept incoming requests to IscsiServersServerTransport
var iscsiServersServerTransportInterceptor interface {
