...
type CloudLinksServer struct {
	...
	// HTTP status codes to indicate success: http.StatusOK
	NewListByPrivateCloudPager func(resourceGroupName string, privateCloudName string, options *armavs.CloudLinksClientListByPrivateCloudOptions) (resp azfake.PagerResponder[armavs.CloudLinksClientListByPrivateCloudResponse])
}
