...
// MarshalJSON implements the json.Marshaller interface for type ActionGroupForActivityLogAlerts.
func (a ActionGroupForActivityLogAlerts) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
...
// UnmarshalJSON implements the json.Unmarshaller interface for type ActionGroupForActivityLogAlerts.
func (a *ActionGroupForActivityLogAlerts) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", a, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type ResourceForAutoscale.
func (r ResourceForAutoscale) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "id", r.ID)
	populate(objectMap, "location", r.Location)
	populate(objectMap, "name", r.Name)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type ResourceForAutoscale.
func (r *ResourceForAutoscale) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", r, err)
	}
