	...
	go func() {
		...
		if !intercepted {
			...
			case "ClustersClient.NewListByClusterPoolNamePager":
				res.resp, res.err = c.dispatchNewListByClusterPoolNamePager(req)
			case "ClustersClient.NewListInstanceViewsPager":
				res.resp, res.err = c.dispatchNewListInstanceViewsPager(req)
			case "ClustersClient.NewListServiceConfigsPager":
				res.resp, res.err = c.dispatchNewListServiceConfigsPager(req)
			...
			case "ClustersClient.BeginUpgradeManualRollback":
				res.resp, res.err = c.dispatchBeginUpgradeManualRollback(req)
			default:
