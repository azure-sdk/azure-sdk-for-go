...
- Type of `AutonomousDatabaseBackupUpdate.Properties` has been changed from `*AutonomousDatabaseBackupUpdateProperties` to `*AutonomousDatabaseBackupProperties`
...
- New field `ID`, `Name`, `SystemData`, `Type` in struct `AutonomousDatabaseBackupUpdate`
