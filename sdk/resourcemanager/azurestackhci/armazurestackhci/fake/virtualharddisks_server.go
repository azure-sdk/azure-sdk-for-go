...
// The returned VirtualHardDisksServerTransport instance is connected to an instance of armazurestackhci.VirtualHardDisksClient via the
...
func NewVirtualHardDisksServerTransport(srv *VirtualHardDisksServer) *VirtualHardDisksServerTransport {
	return &VirtualHardDisksServerTransport{
		srv:                 srv,
		beginCreateOrUpdate: newTracker[azfake.PollerResponder[armazurestackhci.VirtualHardDisksClientCreateOrUpdateResponse]](),
		beginDelete:         newTracker[azfake.PollerResponder[armazurestackhci.VirtualHardDisksClientDeleteResponse]](),
		newListPager:        newTracker[azfake.PagerResponder[armazurestackhci.VirtualHardDisksClientListResponse]](),
		newListAllPager:     newTracker[azfake.PagerResponder[armazurestackhci.VirtualHardDisksClientListAllResponse]](),
		beginUpdate:         newTracker[azfake.PollerResponder[armazurestackhci.VirtualHardDisksClientUpdateResponse]](),
	}
}

// VirtualHardDisksServerTransport connects instances of armazurestackhci.VirtualHardDisksClient to instances of VirtualHardDisksServer.
...
type VirtualHardDisksServerTransport struct {
	...
	beginCreateOrUpdate *tracker[azfake.PollerResponder[armazurestackhci.VirtualHardDisksClientCreateOrUpdateResponse]]
	beginDelete         *tracker[azfake.PollerResponder[armazurestackhci.VirtualHardDisksClientDeleteResponse]]
	newListPager        *tracker[azfake.PagerResponder[armazurestackhci.VirtualHardDisksClientListResponse]]
	newListAllPager     *tracker[azfake.PagerResponder[armazurestackhci.VirtualHardDisksClientListAllResponse]]
	beginUpdate         *tracker[azfake.PollerResponder[armazurestackhci.VirtualHardDisksClientUpdateResponse]]
}
...
func (v *VirtualHardDisksServerTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "VirtualHardDisksClient.NewListPager":
...
func (v *VirtualHardDisksServerTransport) dispatchBeginCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginCreateOrUpdate == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armazurestackhci.VirtualHardDisks](req)
		if err != nil {
			return nil, err
		}
...
func (v *VirtualHardDisksServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	resp, err := server.MarshalResponseAsJSON(respContent, server.GetResponse(respr).VirtualHardDisks, req)
	if err != nil {
		return nil, err
	}
	return resp, nil
...
func (v *VirtualHardDisksServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armazurestackhci.VirtualHardDisksClientListResponse, createLink func() string) {
...
func (v *VirtualHardDisksServerTransport) dispatchNewListAllPager(req *http.Request) (*http.Response, error) {
	...
	if newListAllPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListAllPager, req, func(page *armazurestackhci.VirtualHardDisksClientListAllResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
...
func (v *VirtualHardDisksServerTransport) dispatchBeginUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginUpdate == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armazurestackhci.VirtualHardDisksUpdateRequest](req)
		if err != nil {
			return nil, err
		}
		resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
