...
// KeyRotationPolicyActionType - The type of the action.
type KeyRotationPolicyActionType string

const (
	// KeyRotationPolicyActionTypeNotify - Trigger Event Grid events. Defaults to 30 days before expiry. Key Vault only.
	KeyRotationPolicyActionTypeNotify KeyRotationPolicyActionType = "Notify"
	// KeyRotationPolicyActionTypeRotate - Rotate the key based on the key policy. Managed HSM only. Key Vault uses PascalCase
	// 'Rotate' instead.
	KeyRotationPolicyActionTypeRotate KeyRotationPolicyActionType = "rotate"
	// KeyRotationPolicyActionTypeRotateHSM - Rotate the key based on the key policy. Key Vault only. Managed HSM uses camelCase
	// 'rotate' instead.
	KeyRotationPolicyActionTypeRotateHSM KeyRotationPolicyActionType = "Rotate"
)
...
func PossibleKeyRotationPolicyActionTypeValues() []KeyRotationPolicyActionType {
	return []KeyRotationPolicyActionType{
		...
		KeyRotationPolicyActionTypeRotateHSM,
	}
}
