...
func (client *DatabasesClient) flushCreateRequest(ctx context.Context, resourceGroupName string, clusterName string, databaseName string, parameters FlushParameters, _ *DatabasesClientBeginFlushOptions) (*policy.Request, error) {
