...
func (b BuildServiceProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "defaultBuilderConfiguration", b.DefaultBuilderConfiguration)
...
func (b *BuildServiceProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "containerRegistry":
			...
			delete(rawMsg, key)
		case "defaultBuilderConfiguration":
			err = unpopulate(val, "DefaultBuilderConfiguration", &b.DefaultBuilderConfiguration)
			delete(rawMsg, key)
		case "kPackVersion":
...
func (m ManualJobTriggerConfig) MarshalJSON() ([]byte, error) {
	...
	objectMap["triggerType"] = TriggerTypeManual
	return json.Marshal(objectMap)
}
