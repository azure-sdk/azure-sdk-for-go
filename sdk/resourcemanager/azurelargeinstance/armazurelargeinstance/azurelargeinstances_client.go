...
//     method.
func (client *AzureLargeInstancesClient) BeginRestart(ctx context.Context, resourceGroupName string, azureLargeInstanceName string, body ForceState, options *AzureLargeInstancesClientBeginRestartOptions) (*runtime.Poller[AzureLargeInstancesClientRestartResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.restart(ctx, resourceGroupName, azureLargeInstanceName, body, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2023-07-20-preview
func (client *AzureLargeInstancesClient) restart(ctx context.Context, resourceGroupName string, azureLargeInstanceName string, body ForceState, options *AzureLargeInstancesClientBeginRestartOptions) (*http.Response, error) {
	var err error
	const operationName = "AzureLargeInstancesClient.BeginRestart"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.restartCreateRequest(ctx, resourceGroupName, azureLargeInstanceName, body, options)
	if err != nil {
		return nil, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
...
func (client *AzureLargeInstancesClient) restartCreateRequest(ctx context.Context, resourceGroupName string, azureLargeInstanceName string, body ForceState, options *AzureLargeInstancesClientBeginRestartOptions) (*policy.Request, error) {
...
//     method.
func (client *AzureLargeInstancesClient) BeginShutdown(ctx context.Context, resourceGroupName string, azureLargeInstanceName string, body map[string]any, options *AzureLargeInstancesClientBeginShutdownOptions) (*runtime.Poller[AzureLargeInstancesClientShutdownResponse], error) {
	if options == nil || options.ResumeToken == "" {
...
//
// Generated from API version 2023-07-20-preview
func (client *AzureLargeInstancesClient) shutdown(ctx context.Context, resourceGroupName string, azureLargeInstanceName string, body map[string]any, options *AzureLargeInstancesClientBeginShutdownOptions) (*http.Response, error) {
	var err error
...
func (client *AzureLargeInstancesClient) shutdownCreateRequest(ctx context.Context, resourceGroupName string, azureLargeInstanceName string, body map[string]any, options *AzureLargeInstancesClientBeginShutdownOptions) (*policy.Request, error) {
...
//     method.
func (client *AzureLargeInstancesClient) BeginStart(ctx context.Context, resourceGroupName string, azureLargeInstanceName string, body map[string]any, options *AzureLargeInstancesClientBeginStartOptions) (*runtime.Poller[AzureLargeInstancesClientStartResponse], error) {
	if options == nil || options.ResumeToken == "" {
...
//
// Generated from API version 2023-07-20-preview
func (client *AzureLargeInstancesClient) start(ctx context.Context, resourceGroupName string, azureLargeInstanceName string, body map[string]any, options *AzureLargeInstancesClientBeginStartOptions) (*http.Response, error) {
	var err error
...
func (client *AzureLargeInstancesClient) startCreateRequest(ctx context.Context, resourceGroupName string, azureLargeInstanceName string, body map[string]any, options *AzureLargeInstancesClientBeginStartOptions) (*policy.Request, error) {
