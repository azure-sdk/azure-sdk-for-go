...
func (client *SQLPoolDataWarehouseUserActivitiesClient) getCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, sqlPoolName string, dataWarehouseUserActivityName DataWarehouseUserActivityName, _ *SQLPoolDataWarehouseUserActivitiesClientGetOptions) (*policy.Request, error) {
