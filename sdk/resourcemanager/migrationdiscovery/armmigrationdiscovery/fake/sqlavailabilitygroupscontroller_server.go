...
// SQLAvailabilityGroupsControllerServer is a fake server for instances of the armmigrationdiscovery.SQLAvailabilityGroupsControllerClient type.
type SQLAvailabilityGroupsControllerServer struct {
	...
	Get func(ctx context.Context, resourceGroupName string, siteName string, sqlSiteName string, sqlAvailabilityGroupName string, options *armmigrationdiscovery.SQLAvailabilityGroupsControllerClientGetOptions) (resp azfake.Responder[armmigrationdiscovery.SQLAvailabilityGroupsControllerClientGetResponse], errResp azfake.ErrorResponder)

	// NewListBySQLSitePager is the fake for method SQLAvailabilityGroupsControllerClient.NewListBySQLSitePager
	// HTTP status codes to indicate success: http.StatusOK
	NewListBySQLSitePager func(resourceGroupName string, siteName string, sqlSiteName string, options *armmigrationdiscovery.SQLAvailabilityGroupsControllerClientListBySQLSiteOptions) (resp azfake.PagerResponder[armmigrationdiscovery.SQLAvailabilityGroupsControllerClientListBySQLSiteResponse])
}
...
// The returned SQLAvailabilityGroupsControllerServerTransport instance is connected to an instance of armmigrationdiscovery.SQLAvailabilityGroupsControllerClient via the
...
func NewSQLAvailabilityGroupsControllerServerTransport(srv *SQLAvailabilityGroupsControllerServer) *SQLAvailabilityGroupsControllerServerTransport {
	return &SQLAvailabilityGroupsControllerServerTransport{
		srv:                   srv,
		newListBySQLSitePager: newTracker[azfake.PagerResponder[armmigrationdiscovery.SQLAvailabilityGroupsControllerClientListBySQLSiteResponse]](),
	}
}

// SQLAvailabilityGroupsControllerServerTransport connects instances of armmigrationdiscovery.SQLAvailabilityGroupsControllerClient to instances of SQLAvailabilityGroupsControllerServer.
...
type SQLAvailabilityGroupsControllerServerTransport struct {
	...
	newListBySQLSitePager *tracker[azfake.PagerResponder[armmigrationdiscovery.SQLAvailabilityGroupsControllerClientListBySQLSiteResponse]]
}
...
func (s *SQLAvailabilityGroupsControllerServerTransport) dispatchNewListBySQLSitePager(req *http.Request) (*http.Response, error) {
	...
	if newListBySQLSitePager == nil {
		...
		var options *armmigrationdiscovery.SQLAvailabilityGroupsControllerClientListBySQLSiteOptions
		if filterParam != nil || topParam != nil || continuationTokenParam != nil || totalRecordCountParam != nil {
			options = &armmigrationdiscovery.SQLAvailabilityGroupsControllerClientListBySQLSiteOptions{
				Filter:            filterParam,
				Top:               topParam,
		...
		server.PagerResponderInjectNextLinks(newListBySQLSitePager, req, func(page *armmigrationdiscovery.SQLAvailabilityGroupsControllerClientListBySQLSiteResponse, createLink func() string) {
