...
// PolicyDefinitionsServer is a fake server for instances of the armresources.PolicyDefinitionsClient type.
type PolicyDefinitionsServer struct {
	...
	CreateOrUpdate func(ctx context.Context, policyDefinitionName string, parameters armresources.PolicyDefinition, options *armresources.PolicyDefinitionsClientCreateOrUpdateOptions) (resp azfake.Responder[armresources.PolicyDefinitionsClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)

	// CreateOrUpdateAtManagementGroup is the fake for method PolicyDefinitionsClient.CreateOrUpdateAtManagementGroup
	// HTTP status codes to indicate success: http.StatusCreated
	CreateOrUpdateAtManagementGroup func(ctx context.Context, managementGroupID string, policyDefinitionName string, parameters armresources.PolicyDefinition, options *armresources.PolicyDefinitionsClientCreateOrUpdateAtManagementGroupOptions) (resp azfake.Responder[armresources.PolicyDefinitionsClientCreateOrUpdateAtManagementGroupResponse], errResp azfake.ErrorResponder)

	// Delete is the fake for method PolicyDefinitionsClient.Delete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	Delete func(ctx context.Context, policyDefinitionName string, options *armresources.PolicyDefinitionsClientDeleteOptions) (resp azfake.Responder[armresources.PolicyDefinitionsClientDeleteResponse], errResp azfake.ErrorResponder)

	// DeleteAtManagementGroup is the fake for method PolicyDefinitionsClient.DeleteAtManagementGroup
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	DeleteAtManagementGroup func(ctx context.Context, managementGroupID string, policyDefinitionName string, options *armresources.PolicyDefinitionsClientDeleteAtManagementGroupOptions) (resp azfake.Responder[armresources.PolicyDefinitionsClientDeleteAtManagementGroupResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method PolicyDefinitionsClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, policyDefinitionName string, options *armresources.PolicyDefinitionsClientGetOptions) (resp azfake.Responder[armresources.PolicyDefinitionsClientGetResponse], errResp azfake.ErrorResponder)

	// GetAtManagementGroup is the fake for method PolicyDefinitionsClient.GetAtManagementGroup
	// HTTP status codes to indicate success: http.StatusOK
	GetAtManagementGroup func(ctx context.Context, managementGroupID string, policyDefinitionName string, options *armresources.PolicyDefinitionsClientGetAtManagementGroupOptions) (resp azfake.Responder[armresources.PolicyDefinitionsClientGetAtManagementGroupResponse], errResp azfake.ErrorResponder)

	// GetBuiltIn is the fake for method PolicyDefinitionsClient.GetBuiltIn
	// HTTP status codes to indicate success: http.StatusOK
	GetBuiltIn func(ctx context.Context, policyDefinitionName string, options *armresources.PolicyDefinitionsClientGetBuiltInOptions) (resp azfake.Responder[armresources.PolicyDefinitionsClientGetBuiltInResponse], errResp azfake.ErrorResponder)

	// NewListPager is the fake for method PolicyDefinitionsClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(options *armresources.PolicyDefinitionsClientListOptions) (resp azfake.PagerResponder[armresources.PolicyDefinitionsClientListResponse])

	// NewListBuiltInPager is the fake for method PolicyDefinitionsClient.NewListBuiltInPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListBuiltInPager func(options *armresources.PolicyDefinitionsClientListBuiltInOptions) (resp azfake.PagerResponder[armresources.PolicyDefinitionsClientListBuiltInResponse])

	// NewListByManagementGroupPager is the fake for method PolicyDefinitionsClient.NewListByManagementGroupPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByManagementGroupPager func(managementGroupID string, options *armresources.PolicyDefinitionsClientListByManagementGroupOptions) (resp azfake.PagerResponder[armresources.PolicyDefinitionsClientListByManagementGroupResponse])
}
...
// The returned PolicyDefinitionsServerTransport instance is connected to an instance of armresources.PolicyDefinitionsClient via the
...
func NewPolicyDefinitionsServerTransport(srv *PolicyDefinitionsServer) *PolicyDefinitionsServerTransport {
	return &PolicyDefinitionsServerTransport{
		srv:                           srv,
		newListPager:                  newTracker[azfake.PagerResponder[armresources.PolicyDefinitionsClientListResponse]](),
		newListBuiltInPager:           newTracker[azfake.PagerResponder[armresources.PolicyDefinitionsClientListBuiltInResponse]](),
		newListByManagementGroupPager: newTracker[azfake.PagerResponder[armresources.PolicyDefinitionsClientListByManagementGroupResponse]](),
	}
}

// PolicyDefinitionsServerTransport connects instances of armresources.PolicyDefinitionsClient to instances of PolicyDefinitionsServer.
...
type PolicyDefinitionsServerTransport struct {
	...
	newListPager                  *tracker[azfake.PagerResponder[armresources.PolicyDefinitionsClientListResponse]]
	newListBuiltInPager           *tracker[azfake.PagerResponder[armresources.PolicyDefinitionsClientListBuiltInResponse]]
	newListByManagementGroupPager *tracker[azfake.PagerResponder[armresources.PolicyDefinitionsClientListByManagementGroupResponse]]
}
...
func (p *PolicyDefinitionsServerTransport) dispatchCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[armresources.PolicyDefinition](req)
	if err != nil {
		return nil, err
	}
...
func (p *PolicyDefinitionsServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		var options *armresources.PolicyDefinitionsClientListOptions
		if filterParam != nil || topParam != nil {
			options = &armresources.PolicyDefinitionsClientListOptions{
				Filter: filterParam,
				Top:    topParam,
			}
		}
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armresources.PolicyDefinitionsClientListResponse, createLink func() string) {
...
func (p *PolicyDefinitionsServerTransport) dispatchNewListBuiltInPager(req *http.Request) (*http.Response, error) {
	...
	if newListBuiltInPager == nil {
		...
		var options *armresources.PolicyDefinitionsClientListBuiltInOptions
		if filterParam != nil || topParam != nil {
			options = &armresources.PolicyDefinitionsClientListBuiltInOptions{
				Filter: filterParam,
				Top:    topParam,
			}
		}
		...
		server.PagerResponderInjectNextLinks(newListBuiltInPager, req, func(page *armresources.PolicyDefinitionsClientListBuiltInResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
...
func (p *PolicyDefinitionsServerTransport) dispatchNewListByManagementGroupPager(req *http.Request) (*http.Response, error) {
	...
	if newListByManagementGroupPager == nil {
		...
		var options *armresources.PolicyDefinitionsClientListByManagementGroupOptions
		if filterParam != nil || topParam != nil {
			options = &armresources.PolicyDefinitionsClientListByManagementGroupOptions{
				Filter: filterParam,
				Top:    topParam,
			}
		}
		...
		server.PagerResponderInjectNextLinks(newListByManagementGroupPager, req, func(page *armresources.PolicyDefinitionsClientListByManagementGroupResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
