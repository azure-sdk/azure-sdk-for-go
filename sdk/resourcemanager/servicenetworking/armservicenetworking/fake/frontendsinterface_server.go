...
type FrontendsInterfaceServer struct {
	...
	// NewListByResourceGroupPager is the fake for method FrontendsInterfaceClient.NewListByResourceGroupPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByResourceGroupPager func(resourceGroupName string, trafficControllerName string, options *armservicenetworking.FrontendsInterfaceClientListByResourceGroupOptions) (resp azfake.PagerResponder[armservicenetworking.FrontendsInterfaceClientListByResourceGroupResponse])

	// Update is the fake for method FrontendsInterfaceClient.Update
	// HTTP status codes to indicate success: http.StatusOK
	Update func(ctx context.Context, resourceGroupName string, trafficControllerName string, frontendName string, properties armservicenetworking.Frontend, options *armservicenetworking.FrontendsInterfaceClientUpdateOptions) (resp azfake.Responder[armservicenetworking.FrontendsInterfaceClientUpdateResponse], errResp azfake.ErrorResponder)
}
...
func NewFrontendsInterfaceServerTransport(srv *FrontendsInterfaceServer) *FrontendsInterfaceServerTransport {
	return &FrontendsInterfaceServerTransport{
		...
		newListByResourceGroupPager: newTracker[azfake.PagerResponder[armservicenetworking.FrontendsInterfaceClientListByResourceGroupResponse]](),
	}
}
...
type FrontendsInterfaceServerTransport struct {
	...
	newListByResourceGroupPager *tracker[azfake.PagerResponder[armservicenetworking.FrontendsInterfaceClientListByResourceGroupResponse]]
}
...
func (f *FrontendsInterfaceServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	case "FrontendsInterfaceClient.NewListByResourceGroupPager":
...
func (f *FrontendsInterfaceServerTransport) dispatchNewListByResourceGroupPager(req *http.Request) (*http.Response, error) {
	...
	if newListByResourceGroupPager == nil {
		...
		resp := f.srv.NewListByResourceGroupPager(resourceGroupNameParam, trafficControllerNameParam, nil)
		newListByResourceGroupPager = &resp
		f.newListByResourceGroupPager.add(req, newListByResourceGroupPager)
		server.PagerResponderInjectNextLinks(newListByResourceGroupPager, req, func(page *armservicenetworking.FrontendsInterfaceClientListByResourceGroupResponse, createLink func() string) {
