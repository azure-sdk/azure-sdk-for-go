...
// GetProviderSpecificInput implements the ProviderSpecificInputClassification interface for type DisableProtectionProviderSpecificInput.
func (d *DisableProtectionProviderSpecificInput) GetProviderSpecificInput() *ProviderSpecificInput {
...
// GetProviderSpecificInput implements the ProviderSpecificInputClassification interface for type InMageDisableProtectionProviderSpecificInput.
func (i *InMageDisableProtectionProviderSpecificInput) GetProviderSpecificInput() *ProviderSpecificInput {
	return &ProviderSpecificInput{
		InstanceType: i.InstanceType,
	}
}
...
// ProviderSpecificInputClassification provides polymorphic access to related types.
// Call the interface's GetProviderSpecificInput() method to access the common type.
// Use a type switch to determine the concrete type.  The possible types are:
// - *DisableProtectionProviderSpecificInput, *InMageDisableProtectionProviderSpecificInput, *ProviderSpecificInput
type ProviderSpecificInputClassification interface {
	// GetProviderSpecificInput returns the ProviderSpecificInput content of the underlying type.
	GetProviderSpecificInput() *ProviderSpecificInput
}
...
// GetProviderSpecificInput implements the ProviderSpecificInputClassification interface for type ProviderSpecificInput.
func (p *ProviderSpecificInput) GetProviderSpecificInput() *ProviderSpecificInput { return p }
