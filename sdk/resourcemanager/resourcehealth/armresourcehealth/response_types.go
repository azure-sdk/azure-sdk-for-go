...
// ImpactedResourcesClientListByTenantIDAndEventIDResponse contains the response from method ImpactedResourcesClient.ListByTenantIDAndEventID.
...
// SecurityAdvisoryImpactedResourcesClientListBySubscriptionIDAndEventIDResponse contains the response from method SecurityAdvisoryImpactedResourcesClient.ListBySubscriptionIDAndEventID.
type SecurityAdvisoryImpactedResourcesClientListBySubscriptionIDAndEventIDResponse struct {
	EventImpactedResourceListResult
}

// SecurityAdvisoryImpactedResourcesClientListByTenantIDAndEventIDResponse contains the response from method SecurityAdvisoryImpactedResourcesClient.ListByTenantIDAndEventID.
