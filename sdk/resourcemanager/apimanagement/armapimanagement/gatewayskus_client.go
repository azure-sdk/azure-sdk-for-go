...
func (client *GatewaySKUsClient) listAvailableSKUsCreateRequest(ctx context.Context, resourceGroupName string, gatewayName string, options *GatewaySKUsClientListAvailableSKUsOptions) (*policy.Request, error) {
