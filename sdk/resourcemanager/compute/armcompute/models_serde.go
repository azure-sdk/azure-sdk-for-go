...
// MarshalJSON implements the json.Marshaller interface for type AutomaticExpansionPolicy.
func (a AutomaticExpansionPolicy) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "minTargetZonalInstanceCount", a.MinTargetZonalInstanceCount)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type AutomaticExpansionPolicy.
func (a *AutomaticExpansionPolicy) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", a, err)
	}
	for key, val := range rawMsg {
		var err error
		switch key {
		case "minTargetZonalInstanceCount":
			err = unpopulate(val, "MinTargetZonalInstanceCount", &a.MinTargetZonalInstanceCount)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", a, err)
...
func (a AutomaticZoneRebalancingPolicy) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "automaticExpansionPolicy", a.AutomaticExpansionPolicy)
	populate(objectMap, "enabled", a.Enabled)
...
func (a *AutomaticZoneRebalancingPolicy) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		var err error
		switch key {
		case "automaticExpansionPolicy":
			err = unpopulate(val, "AutomaticExpansionPolicy", &a.AutomaticExpansionPolicy)
			delete(rawMsg, key)
		case "enabled":
			err = unpopulate(val, "Enabled", &a.Enabled)
			delete(rawMsg, key)
