...
func (client *AvailableGroundStationsClient) listByCapabilityCreateRequest(ctx context.Context, capability CapabilityParameter, _ *AvailableGroundStationsClientListByCapabilityOptions) (*policy.Request, error) {
