...
// AuthorizationConfirmConsentCodeClientPostResponse contains the response from method AuthorizationConfirmConsentCodeClient.Post.
type AuthorizationConfirmConsentCodeClientPostResponse struct {
	// ETag contains the information returned from the ETag header response.
	ETag *string
