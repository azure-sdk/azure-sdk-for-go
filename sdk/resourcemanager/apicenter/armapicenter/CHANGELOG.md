...
- New enum type `AnalyzerFilterOperator` with values `AnalyzerFilterOperatorContains`, `AnalyzerFilterOperatorEquals`
...
- New struct `AnalyzerFilterCondition`
