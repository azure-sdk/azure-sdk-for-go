...
func (c CertificateProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "domainControlValidation", c.DomainControlValidation)
	...
	populate(objectMap, "validationToken", c.ValidationToken)
...
func (c *CertificateProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "domainControlValidation":
			err = unpopulate(val, "DomainControlValidation", &c.DomainControlValidation)
			delete(rawMsg, key)
		case "error":
		...
		case "validationToken":
			err = unpopulate(val, "ValidationToken", &c.ValidationToken)
			delete(rawMsg, key)
		case "value":
