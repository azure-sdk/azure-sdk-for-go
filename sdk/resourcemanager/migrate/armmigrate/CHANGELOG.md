...
- New function `*SQLSitesControllerClient.BeginImportInventory(context.Context, string, string, string, SQLInventoryImportBody, *SQLSitesControllerClientBeginImportInventoryOptions) (*runtime.Poller[SQLSitesControllerClientImportInventoryResponse], error)`
