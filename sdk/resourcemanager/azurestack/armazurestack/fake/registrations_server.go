...
func (r *RegistrationsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if registrationsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = registrationsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "RegistrationsClient.EnableRemoteManagement":
				res.resp, res.err = r.dispatchEnableRemoteManagement(req)
			case "RegistrationsClient.Get":
				res.resp, res.err = r.dispatchGet(req)
			case "RegistrationsClient.GetActivationKey":
				res.resp, res.err = r.dispatchGetActivationKey(req)
...
// set this to conditionally intercept incoming requests to RegistrationsServerTransport
var registrationsServerTransportInterceptor interface {
