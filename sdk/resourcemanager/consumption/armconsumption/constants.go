...
const (
	LotSourceAwardedCredit         LotSource = "AwardedCredit"
	...
	LotSourceServiceSpecificCredit LotSource = "ServiceSpecificCredit"
)

// PossibleLotSourceValues returns the possible values for the LotSource const type.
func PossibleLotSourceValues() []LotSource {
	return []LotSource{
		LotSourceAwardedCredit,
		LotSourceConsumptionCommitment,
		LotSourcePromotionalCredit,
		LotSourcePurchasedCredit,
		LotSourceServiceSpecificCredit,
	}
}

// LotType - The type of the lot.
type LotType string

const (
	LotTypeBillingCorrectionCredit        LotType = "BillingCorrectionCredit"
	LotTypeFreeTrial                      LotType = "FreeTrial"
	LotTypeGoodwillCredit                 LotType = "GoodwillCredit"
	LotTypeMACC                           LotType = "MACC"
	LotTypeMonetaryCommitment             LotType = "MonetaryCommitment"
	LotTypeOutageCredit                   LotType = "OutageCredit"
	LotTypeSSC                            LotType = "SSC"
	LotTypeSubscriptionInterruptionCredit LotType = "SubscriptionInterruptionCredit"
)

// PossibleLotTypeValues returns the possible values for the LotType const type.
func PossibleLotTypeValues() []LotType {
	return []LotType{
		LotTypeBillingCorrectionCredit,
		LotTypeFreeTrial,
		LotTypeGoodwillCredit,
		LotTypeMACC,
		LotTypeMonetaryCommitment,
		LotTypeOutageCredit,
		LotTypeSSC,
		LotTypeSubscriptionInterruptionCredit,
	}
}
