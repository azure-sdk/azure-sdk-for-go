...
func (p *ProvisionedClusterInstancesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if provisionedClusterInstancesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = provisionedClusterInstancesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "ProvisionedClusterInstancesClient.GetUpgradeProfile":
				res.resp, res.err = p.dispatchGetUpgradeProfile(req)
			...
			case "ProvisionedClusterInstancesClient.BeginListAdminKubeconfig":
				res.resp, res.err = p.dispatchBeginListAdminKubeconfig(req)
			case "ProvisionedClusterInstancesClient.BeginListUserKubeconfig":
				res.resp, res.err = p.dispatchBeginListUserKubeconfig(req)
			default:
...
// set this to conditionally intercept incoming requests to ProvisionedClusterInstancesServerTransport
var provisionedClusterInstancesServerTransportInterceptor interface {
