...
func (client *OperationStatusesClient) getCreateRequest(ctx context.Context, locationName string, operationID string, _ *OperationStatusesClientGetOptions) (*policy.Request, error) {
