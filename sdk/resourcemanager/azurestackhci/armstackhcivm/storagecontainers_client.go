...
func (client *StorageContainersClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, storageContainerName string, resource StorageContainer, options *StorageContainersClientBeginCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *StorageContainersClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, options *StorageContainersClientListByResourceGroupOptions) (*policy.Request, error) {
...
func (client *StorageContainersClient) updateCreateRequest(ctx context.Context, resourceGroupName string, storageContainerName string, properties StorageContainerTagsUpdate, options *StorageContainersClientBeginUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureStackHCI/storageContainers/{storageContainerName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
