...
func (b *BillingHubServiceServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if billingHubServiceServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = billingHubServiceServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			case "BillingHubServiceClient.GetFreeHourBalance":
				res.resp, res.err = b.dispatchGetFreeHourBalance(req)
			case "BillingHubServiceClient.GetUsage":
				res.resp, res.err = b.dispatchGetUsage(req)
			default:
...
// set this to conditionally intercept incoming requests to BillingHubServiceServerTransport
var billingHubServiceServerTransportInterceptor interface {
