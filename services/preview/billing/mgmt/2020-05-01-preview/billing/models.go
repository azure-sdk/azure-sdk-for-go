...
type InvoiceSectionProperties struct {
	...
	// Tags - Dictionary of metadata associated with the invoice section. Maximum key/value length supported of 256 characters. Keys/value should not empty value nor null. Keys can not contain < > % & \ ? /
...
type SubscriptionProperties struct {
	...
	// SkuDescription - READ-ONLY; The sku description of the Azure plan for the subscription.
	SkuDescription *string `json:"skuDescription,omitempty"`
	// SuspensionReasons - READ-ONLY; The suspension reason for a subscription. Applies only to subscriptions in Microsoft Online Services Program billing accounts.
...
type ValidateAddressResponse struct {
	...
	// SuggestedAddressList - The list of suggested addresses.
