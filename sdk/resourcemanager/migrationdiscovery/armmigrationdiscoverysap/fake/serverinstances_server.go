...
type ServerInstancesServer struct {
	...
	// NewListPager is the fake for method ServerInstancesClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(resourceGroupName string, sapDiscoverySiteName string, sapInstanceName string, options *armmigrationdiscoverysap.ServerInstancesClientListOptions) (resp azfake.PagerResponder[armmigrationdiscoverysap.ServerInstancesClientListResponse])
...
func NewServerInstancesServerTransport(srv *ServerInstancesServer) *ServerInstancesServerTransport {
	return &ServerInstancesServerTransport{
		...
		newListPager: newTracker[azfake.PagerResponder[armmigrationdiscoverysap.ServerInstancesClientListResponse]](),
	}
}
...
type ServerInstancesServerTransport struct {
	...
	newListPager *tracker[azfake.PagerResponder[armmigrationdiscoverysap.ServerInstancesClientListResponse]]
}
...
func (s *ServerInstancesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	case "ServerInstancesClient.NewListPager":
...
func (s *ServerInstancesServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		resp := s.srv.NewListPager(resourceGroupNameParam, sapDiscoverySiteNameParam, sapInstanceNameParam, nil)
		newListPager = &resp
		s.newListPager.add(req, newListPager)
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armmigrationdiscoverysap.ServerInstancesClientListResponse, createLink func() string) {
