...
// MarshalJSON implements the json.Marshaller interface for type ListGuardrailsVersionsResponse.
func (l ListGuardrailsVersionsResponse) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
...
// UnmarshalJSON implements the json.Unmarshaller interface for type ListGuardrailsVersionsResponse.
func (l *ListGuardrailsVersionsResponse) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", l, err)
	}
