...
func (client *BestPracticesVersionsClient) getCreateRequest(ctx context.Context, bestPracticeName string, versionName string, _ *BestPracticesVersionsClientGetOptions) (*policy.Request, error) {
...
func (client *BestPracticesVersionsClient) listByTenantCreateRequest(ctx context.Context, bestPracticeName string, _ *BestPracticesVersionsClientListByTenantOptions) (*policy.Request, error) {
