...
type SQLSitesControllerServer struct {
	...
	// ExportImportedSQLInventoryAsync is the fake for method SQLSitesControllerClient.ExportImportedSQLInventoryAsync
	// HTTP status codes to indicate success: http.StatusOK
	ExportImportedSQLInventoryAsync func(ctx context.Context, resourceGroupName string, siteName string, sqlSiteName string, body armmigrate.SQLInventoryImportBody, options *armmigrate.SQLSitesControllerClientExportImportedSQLInventoryAsyncOptions) (resp azfake.Responder[armmigrate.SQLSitesControllerClientExportImportedSQLInventoryAsyncResponse], errResp azfake.ErrorResponder)
	...
	// BeginTriggerImportInventory is the fake for method SQLSitesControllerClient.BeginTriggerImportInventory
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginTriggerImportInventory func(ctx context.Context, resourceGroupName string, siteName string, sqlSiteName string, body armmigrate.SQLInventoryImportBody, options *armmigrate.SQLSitesControllerClientBeginTriggerImportInventoryOptions) (resp azfake.PollerResponder[armmigrate.SQLSitesControllerClientTriggerImportInventoryResponse], errResp azfake.ErrorResponder)
	...
	// ValidateAndImportInventory is the fake for method SQLSitesControllerClient.ValidateAndImportInventory
	// HTTP status codes to indicate success: http.StatusOK
	ValidateAndImportInventory func(ctx context.Context, resourceGroupName string, siteName string, sqlSiteName string, body armmigrate.SQLInventoryImportBody, options *armmigrate.SQLSitesControllerClientValidateAndImportInventoryOptions) (resp azfake.Responder[armmigrate.SQLSitesControllerClientValidateAndImportInventoryResponse], errResp azfake.ErrorResponder)
}
...
func NewSQLSitesControllerServerTransport(srv *SQLSitesControllerServer) *SQLSitesControllerServerTransport {
	return &SQLSitesControllerServerTransport{
		...
		beginTriggerImportInventory: newTracker[azfake.PollerResponder[armmigrate.SQLSitesControllerClientTriggerImportInventoryResponse]](),
...
type SQLSitesControllerServerTransport struct {
	...
	beginTriggerImportInventory *tracker[azfake.PollerResponder[armmigrate.SQLSitesControllerClientTriggerImportInventoryResponse]]
...
func (s *SQLSitesControllerServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		if !intercepted {
			...
			case "SQLSitesControllerClient.ExportImportedSQLInventoryAsync":
				res.resp, res.err = s.dispatchExportImportedSQLInventoryAsync(req)
			...
			case "SQLSitesControllerClient.BeginTriggerImportInventory":
				res.resp, res.err = s.dispatchBeginTriggerImportInventory(req)
			case "SQLSitesControllerClient.BeginUpdate":
				res.resp, res.err = s.dispatchBeginUpdate(req)
			case "SQLSitesControllerClient.ValidateAndImportInventory":
				res.resp, res.err = s.dispatchValidateAndImportInventory(req)
			default:
...
func (s *SQLSitesControllerServerTransport) dispatchExportImportedSQLInventoryAsync(req *http.Request) (*http.Response, error) {
	if s.srv.ExportImportedSQLInventoryAsync == nil {
		return nil, &nonRetriableError{errors.New("fake for method ExportImportedSQLInventoryAsync not implemented")}
	}
	const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.OffAzure/masterSites/(?P<siteName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/sqlSites/(?P<sqlSiteName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/exportImportedSqlInventoryAsync`
	regex := regexp.MustCompile(regexStr)
	matches := regex.FindStringSubmatch(req.URL.EscapedPath())
	if matches == nil || len(matches) < 4 {
		return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
	}
	body, err := server.UnmarshalRequestAsJSON[armmigrate.SQLInventoryImportBody](req)
	if err != nil {
		return nil, err
	}
	resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
	...
	respr, errRespr := s.srv.ExportImportedSQLInventoryAsync(req.Context(), resourceGroupNameParam, siteNameParam, sqlSiteNameParam, body, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
	...
	resp, err := server.MarshalResponseAsJSON(respContent, server.GetResponse(respr).SQLInventoryImportBody, req)
	if err != nil {
		return nil, err
	}
	return resp, nil
...
func (s *SQLSitesControllerServerTransport) dispatchBeginTriggerImportInventory(req *http.Request) (*http.Response, error) {
	if s.srv.BeginTriggerImportInventory == nil {
		return nil, &nonRetriableError{errors.New("fake for method BeginTriggerImportInventory not implemented")}
	}
	beginTriggerImportInventory := s.beginTriggerImportInventory.get(req)
	if beginTriggerImportInventory == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.OffAzure/masterSites/(?P<siteName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/sqlSites/(?P<sqlSiteName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/triggerImportInventory`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if matches == nil || len(matches) < 4 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
		...
		respr, errRespr := s.srv.BeginTriggerImportInventory(req.Context(), resourceGroupNameParam, siteNameParam, sqlSiteNameParam, body, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginTriggerImportInventory = &respr
		s.beginTriggerImportInventory.add(req, beginTriggerImportInventory)
	}

	resp, err := server.PollerResponderNext(beginTriggerImportInventory, req)
	if err != nil {
		return nil, err
	}

	if !contains([]int{http.StatusOK, http.StatusAccepted, http.StatusNoContent}, resp.StatusCode) {
		s.beginTriggerImportInventory.remove(req)
		return nil, &nonRetriableError{fmt.Errorf("unexpected status code %d. acceptable values are http.StatusOK, http.StatusAccepted, http.StatusNoContent", resp.StatusCode)}
	}
	if !server.PollerResponderMore(beginTriggerImportInventory) {
		s.beginTriggerImportInventory.remove(req)
	}
...
func (s *SQLSitesControllerServerTransport) dispatchValidateAndImportInventory(req *http.Request) (*http.Response, error) {
	if s.srv.ValidateAndImportInventory == nil {
		return nil, &nonRetriableError{errors.New("fake for method ValidateAndImportInventory not implemented")}
	}
	const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.OffAzure/masterSites/(?P<siteName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/sqlSites/(?P<sqlSiteName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/validateAndImportInventory`
	regex := regexp.MustCompile(regexStr)
	matches := regex.FindStringSubmatch(req.URL.EscapedPath())
	if matches == nil || len(matches) < 4 {
		return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
	...
	respr, errRespr := s.srv.ValidateAndImportInventory(req.Context(), resourceGroupNameParam, siteNameParam, sqlSiteNameParam, body, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
