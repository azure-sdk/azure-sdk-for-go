...
func (f FabricAgentModelProperties) MarshalJSON() ([]byte, error) {
	...
	populateDateTimeRFC3339(objectMap, "lastHeartbeat", f.LastHeartbeat)
...
func (f *FabricAgentModelProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "isResponsive":
			...
			delete(rawMsg, key)
		case "lastHeartbeat":
			err = unpopulateDateTimeRFC3339(val, "LastHeartbeat", &f.LastHeartbeat)
			delete(rawMsg, key)
		case "machineId":
...
// MarshalJSON implements the json.Marshaller interface for type JobModelCustomPropertiesAffectedObjectDetails.
func (j JobModelCustomPropertiesAffectedObjectDetails) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type JobModelCustomPropertiesAffectedObjectDetails.
func (j *JobModelCustomPropertiesAffectedObjectDetails) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", j, err)
	}
