...
// VirtualNetworkIntegrations - Retrieve information regarding the provided virtual network integration, such as its allocated
...
//   - location - The name of the Azure region.
//   - request - Object contains the subnetResourceId
//   - options - WebSiteManagementClientVirtualNetworkIntegrationsOptions contains the optional parameters for the WebSiteManagementClient.VirtualNetworkIntegrations
//     method.
func (client *WebSiteManagementClient) VirtualNetworkIntegrations(ctx context.Context, location string, request VirtualNetworkIntegrationRequest, options *WebSiteManagementClientVirtualNetworkIntegrationsOptions) (WebSiteManagementClientVirtualNetworkIntegrationsResponse, error) {
	var err error
	const operationName = "WebSiteManagementClient.VirtualNetworkIntegrations"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.virtualNetworkIntegrationsCreateRequest(ctx, location, request, options)
	if err != nil {
		return WebSiteManagementClientVirtualNetworkIntegrationsResponse{}, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
	if err != nil {
		return WebSiteManagementClientVirtualNetworkIntegrationsResponse{}, err
	...
	resp, err := client.virtualNetworkIntegrationsHandleResponse(httpResp)
	return resp, err
}

// virtualNetworkIntegrationsCreateRequest creates the VirtualNetworkIntegrations request.
func (client *WebSiteManagementClient) virtualNetworkIntegrationsCreateRequest(ctx context.Context, location string, request VirtualNetworkIntegrationRequest, options *WebSiteManagementClientVirtualNetworkIntegrationsOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/providers/Microsoft.Web/locations/{location}/virtualNetworkIntegrations"
	if location == "" {
		return nil, errors.New("parameter location cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{location}", url.PathEscape(location))
...
// virtualNetworkIntegrationsHandleResponse handles the VirtualNetworkIntegrations response.
func (client *WebSiteManagementClient) virtualNetworkIntegrationsHandleResponse(resp *http.Response) (WebSiteManagementClientVirtualNetworkIntegrationsResponse, error) {
	result := WebSiteManagementClientVirtualNetworkIntegrationsResponse{}
