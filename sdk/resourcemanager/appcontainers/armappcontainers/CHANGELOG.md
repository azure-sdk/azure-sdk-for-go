...
- New function `*ContainerAppsSessionPoolsClient.CreateOrUpdate(context.Context, string, string, SessionPool, *ContainerAppsSessionPoolsClientCreateOrUpdateOptions) (ContainerAppsSessionPoolsClientCreateOrUpdateResponse, error)`
- New function `*ContainerAppsSessionPoolsClient.Delete(context.Context, string, string, *ContainerAppsSessionPoolsClientDeleteOptions) (ContainerAppsSessionPoolsClientDeleteResponse, error)`
...
- New function `*ContainerAppsSessionPoolsClient.Update(context.Context, string, string, PatchProperties, *ContainerAppsSessionPoolsClientUpdateOptions) (ContainerAppsSessionPoolsClientUpdateResponse, error)`
...
- New struct `PatchPropertiesProperties`
