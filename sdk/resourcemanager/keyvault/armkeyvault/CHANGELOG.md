...
- New struct `Trigger`
- New field `ReleasePolicy`, `RotationPolicy` in struct `KeyProperties`
- New field `Etag`, `ID` in struct `MHSMPrivateEndpointConnectionItem`
- New field `Regions`, `SecurityDomainProperties` in struct `ManagedHsmProperties`
