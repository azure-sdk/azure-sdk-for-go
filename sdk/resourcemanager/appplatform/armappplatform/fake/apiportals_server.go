...
func (a *APIPortalsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if apiPortalsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = apiPortalsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to APIPortalsServerTransport
var apiPortalsServerTransportInterceptor interface {
