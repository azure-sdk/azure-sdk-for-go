...
// VirtualMachinesExecuteDelete - VirtualMachinesExecuteCreate: Execute delete operation for a batch of virtual machines,
// this operation is triggered as soon as Computeschedule receives it.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2025-05-01
...
// VirtualMachinesSubmitCreate - VirtualMachinesSubmitCreate: submit create operation for a batch of virtual machines, at
// datetime in future.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2025-05-01
//   - locationparameter - The location name.
//   - requestBody - The request body
//   - options - ScheduledActionsClientVirtualMachinesSubmitCreateOptions contains the optional parameters for the ScheduledActionsClient.VirtualMachinesSubmitCreate
//     method.
func (client *ScheduledActionsClient) VirtualMachinesSubmitCreate(ctx context.Context, locationparameter string, requestBody SubmitCreateRequest, options *ScheduledActionsClientVirtualMachinesSubmitCreateOptions) (ScheduledActionsClientVirtualMachinesSubmitCreateResponse, error) {
	var err error
	const operationName = "ScheduledActionsClient.VirtualMachinesSubmitCreate"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.virtualMachinesSubmitCreateCreateRequest(ctx, locationparameter, requestBody, options)
	if err != nil {
		return ScheduledActionsClientVirtualMachinesSubmitCreateResponse{}, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
	if err != nil {
		return ScheduledActionsClientVirtualMachinesSubmitCreateResponse{}, err
	...
	resp, err := client.virtualMachinesSubmitCreateHandleResponse(httpResp)
	return resp, err
}

// virtualMachinesSubmitCreateCreateRequest creates the VirtualMachinesSubmitCreate request.
func (client *ScheduledActionsClient) virtualMachinesSubmitCreateCreateRequest(ctx context.Context, locationparameter string, requestBody SubmitCreateRequest, _ *ScheduledActionsClientVirtualMachinesSubmitCreateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/providers/Microsoft.ComputeSchedule/locations/{locationparameter}/virtualMachinesSubmitCreate"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{subscriptionId}", url.PathEscape(client.subscriptionID))
...
// virtualMachinesSubmitCreateHandleResponse handles the VirtualMachinesSubmitCreate response.
func (client *ScheduledActionsClient) virtualMachinesSubmitCreateHandleResponse(resp *http.Response) (ScheduledActionsClientVirtualMachinesSubmitCreateResponse, error) {
	result := ScheduledActionsClientVirtualMachinesSubmitCreateResponse{}
	if err := runtime.UnmarshalAsJSON(resp, &result.CreateResourceOperationResponse); err != nil {
		return ScheduledActionsClientVirtualMachinesSubmitCreateResponse{}, err
	}
	return result, nil
...
// VirtualMachinesSubmitDelete - VirtualMachinesSubmitDelete: submit delete operation for a batch of virtual machines, at
// datetime in future.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2025-05-01
//   - locationparameter - The location name.
//   - requestBody - The request body
//   - options - ScheduledActionsClientVirtualMachinesSubmitDeleteOptions contains the optional parameters for the ScheduledActionsClient.VirtualMachinesSubmitDelete
//     method.
func (client *ScheduledActionsClient) VirtualMachinesSubmitDelete(ctx context.Context, locationparameter string, requestBody SubmitDeleteRequest, options *ScheduledActionsClientVirtualMachinesSubmitDeleteOptions) (ScheduledActionsClientVirtualMachinesSubmitDeleteResponse, error) {
	var err error
	const operationName = "ScheduledActionsClient.VirtualMachinesSubmitDelete"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.virtualMachinesSubmitDeleteCreateRequest(ctx, locationparameter, requestBody, options)
	if err != nil {
		return ScheduledActionsClientVirtualMachinesSubmitDeleteResponse{}, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
	if err != nil {
		return ScheduledActionsClientVirtualMachinesSubmitDeleteResponse{}, err
	...
	resp, err := client.virtualMachinesSubmitDeleteHandleResponse(httpResp)
	return resp, err
}

// virtualMachinesSubmitDeleteCreateRequest creates the VirtualMachinesSubmitDelete request.
func (client *ScheduledActionsClient) virtualMachinesSubmitDeleteCreateRequest(ctx context.Context, locationparameter string, requestBody SubmitDeleteRequest, _ *ScheduledActionsClientVirtualMachinesSubmitDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/providers/Microsoft.ComputeSchedule/locations/{locationparameter}/virtualMachinesSubmitDelete"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{subscriptionId}", url.PathEscape(client.subscriptionID))
...
// virtualMachinesSubmitDeleteHandleResponse handles the VirtualMachinesSubmitDelete response.
func (client *ScheduledActionsClient) virtualMachinesSubmitDeleteHandleResponse(resp *http.Response) (ScheduledActionsClientVirtualMachinesSubmitDeleteResponse, error) {
	result := ScheduledActionsClientVirtualMachinesSubmitDeleteResponse{}
	if err := runtime.UnmarshalAsJSON(resp, &result.DeleteResourceOperationResponse); err != nil {
		return ScheduledActionsClientVirtualMachinesSubmitDeleteResponse{}, err
	}
	return result, nil
