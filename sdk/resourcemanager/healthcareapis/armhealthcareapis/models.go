...
// StorageMonitorConfiguration - The configuration for monitoring changes in a connected storage account.
...
// StorageMonitorQueue - An Azure Storage queue used for Data Lake Storage Gen 2 events.
type StorageMonitorQueue struct {
