...
func (m *ManagementAssociationsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if managementAssociationsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = managementAssociationsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to ManagementAssociationsServerTransport
var managementAssociationsServerTransportInterceptor interface {
