...
func (p *PacketCoreControlPlanesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if packetCoreControlPlanesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = packetCoreControlPlanesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			case "PacketCoreControlPlanesClient.BeginCollectDiagnosticsPackage":
				res.resp, res.err = p.dispatchBeginCollectDiagnosticsPackage(req)
			...
			case "PacketCoreControlPlanesClient.BeginReinstall":
				res.resp, res.err = p.dispatchBeginReinstall(req)
			case "PacketCoreControlPlanesClient.BeginRollback":
				res.resp, res.err = p.dispatchBeginRollback(req)
...
// set this to conditionally intercept incoming requests to PacketCoreControlPlanesServerTransport
var packetCoreControlPlanesServerTransportInterceptor interface {
