...
func (client *BestPracticesClient) getCreateRequest(ctx context.Context, bestPracticeName string, _ *BestPracticesClientGetOptions) (*policy.Request, error) {
...
func (client *BestPracticesClient) listByTenantCreateRequest(ctx context.Context, _ *BestPracticesClientListByTenantOptions) (*policy.Request, error) {
