...
// Generated from API version 2022-08-31
...
// method.
func (client *Client) DppResourceGuardProxyDelete(ctx context.Context, vaultName string, resourceGroupName string, resourceGuardProxyName string, options *ClientDppResourceGuardProxyDeleteOptions) (ClientDppResourceGuardProxyDeleteResponse, error) {
	req, err := client.dppResourceGuardProxyDeleteCreateRequest(ctx, vaultName, resourceGroupName, resourceGuardProxyName, options)
	if err != nil {
...
func (client *Client) dppResourceGuardProxyDeleteCreateRequest(ctx context.Context, vaultName string, resourceGroupName string, resourceGuardProxyName string, options *ClientDppResourceGuardProxyDeleteOptions) (*policy.Request, error) {
	...
	reqQP.Set("api-version", "2022-08-31")
...
// method.
func (client *Client) DppResourceGuardProxyGet(ctx context.Context, vaultName string, resourceGroupName string, resourceGuardProxyName string, options *ClientDppResourceGuardProxyGetOptions) (ClientDppResourceGuardProxyGetResponse, error) {
	req, err := client.dppResourceGuardProxyGetCreateRequest(ctx, vaultName, resourceGroupName, resourceGuardProxyName, options)
	if err != nil {
...
func (client *Client) dppResourceGuardProxyGetCreateRequest(ctx context.Context, vaultName string, resourceGroupName string, resourceGuardProxyName string, options *ClientDppResourceGuardProxyGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataProtection/backupVaults/{vaultName}/backupResourceGuardProxies/{resourceGuardProxyName}"
	if vaultName == "" {
		return nil, errors.New("parameter vaultName cannot be empty")
	}
...
// method.
func (client *Client) NewDppResourceGuardProxyListPager(vaultName string, resourceGroupName string, options *ClientDppResourceGuardProxyListOptions) *runtime.Pager[ClientDppResourceGuardProxyListResponse] {
	return runtime.NewPager(runtime.PagingHandler[ClientDppResourceGuardProxyListResponse]{
		...
		Fetcher: func(ctx context.Context, page *ClientDppResourceGuardProxyListResponse) (ClientDppResourceGuardProxyListResponse, error) {
			...
			var err error
			if page == nil {
				req, err = client.dppResourceGuardProxyListCreateRequest(ctx, vaultName, resourceGroupName, options)
			} else {
...
func (client *Client) dppResourceGuardProxyListCreateRequest(ctx context.Context, vaultName string, resourceGroupName string, options *ClientDppResourceGuardProxyListOptions) (*policy.Request, error) {
...
// method.
func (client *Client) DppResourceGuardProxyPut(ctx context.Context, vaultName string, resourceGroupName string, resourceGuardProxyName string, parameters ResourceGuardProxyBaseResource, options *ClientDppResourceGuardProxyPutOptions) (ClientDppResourceGuardProxyPutResponse, error) {
	req, err := client.dppResourceGuardProxyPutCreateRequest(ctx, vaultName, resourceGroupName, resourceGuardProxyName, parameters, options)
	if err != nil {
...
func (client *Client) dppResourceGuardProxyPutCreateRequest(ctx context.Context, vaultName string, resourceGroupName string, resourceGuardProxyName string, parameters ResourceGuardProxyBaseResource, options *ClientDppResourceGuardProxyPutOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataProtection/backupVaults/{vaultName}/backupResourceGuardProxies/{resourceGuardProxyName}"
	if vaultName == "" {
		return nil, errors.New("parameter vaultName cannot be empty")
	}
...
// method.
func (client *Client) DppResourceGuardProxyUnlockDelete(ctx context.Context, vaultName string, resourceGroupName string, resourceGuardProxyName string, parameters UnlockDeleteRequest, options *ClientDppResourceGuardProxyUnlockDeleteOptions) (ClientDppResourceGuardProxyUnlockDeleteResponse, error) {
	req, err := client.dppResourceGuardProxyUnlockDeleteCreateRequest(ctx, vaultName, resourceGroupName, resourceGuardProxyName, parameters, options)
	if err != nil {
...
func (client *Client) dppResourceGuardProxyUnlockDeleteCreateRequest(ctx context.Context, vaultName string, resourceGroupName string, resourceGuardProxyName string, parameters UnlockDeleteRequest, options *ClientDppResourceGuardProxyUnlockDeleteOptions) (*policy.Request, error) {
