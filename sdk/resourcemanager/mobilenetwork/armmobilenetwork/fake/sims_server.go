...
func (s *SimsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if simsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = simsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			case "SimsClient.BeginBulkDelete":
				res.resp, res.err = s.dispatchBeginBulkDelete(req)
			case "SimsClient.BeginBulkUpload":
				res.resp, res.err = s.dispatchBeginBulkUpload(req)
			case "SimsClient.BeginBulkUploadEncrypted":
				res.resp, res.err = s.dispatchBeginBulkUploadEncrypted(req)
			case "SimsClient.BeginClone":
				res.resp, res.err = s.dispatchBeginClone(req)
...
// set this to conditionally intercept incoming requests to SimsServerTransport
var simsServerTransportInterceptor interface {
