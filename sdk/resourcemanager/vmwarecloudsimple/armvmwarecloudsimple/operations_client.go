...
func (client *OperationsClient) getCreateRequest(ctx context.Context, regionID string, referer string, operationID string, _ *OperationsClientGetOptions) (*policy.Request, error) {
