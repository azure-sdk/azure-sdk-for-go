...
type CassandraRoleDefinitionResourceProperties struct {
	...
	Permissions []*PermissionAutoGenerated2
...
type GremlinRoleDefinitionResourceProperties struct {
	...
	// The set of operations allowed through this Role Definition.
	Permissions []*PermissionAutoGenerated4
...
type MongoMIRoleDefinitionResourceProperties struct {
	...
	// The set of operations allowed through this Role Definition.
	Permissions []*PermissionAutoGenerated3
...
// PermissionAutoGenerated2 - The set of data plane operations permitted through this Role Definition.
type PermissionAutoGenerated2 struct {
	// An array of data actions that are allowed.
	DataActions []*string
...
// PermissionAutoGenerated3 - The set of data plane operations permitted through this Role Definition.
type PermissionAutoGenerated3 struct {
	// An array of data actions that are allowed.
	DataActions []*string
...
// PermissionAutoGenerated4 - The set of data plane operations permitted through this Role Definition.
type PermissionAutoGenerated4 struct {
	// An array of data actions that are allowed.
	DataActions []*string
