...
func (d *DedicatedCloudServicesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if dedicatedCloudServicesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = dedicatedCloudServicesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to DedicatedCloudServicesServerTransport
var dedicatedCloudServicesServerTransportInterceptor interface {
