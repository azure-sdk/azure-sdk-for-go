...
```go
client, err := armnewrelicobservability.NewMonitorsClient(<subscription ID>, cred, nil)
```
...
client, err := armnewrelicobservability.NewMonitorsClient(<subscription ID>, cred, &options)
```
