...
type ServerFactory struct {
	...
	// SKUsOperationGroupServer contains the fakes for client SKUsOperationGroupClient
	SKUsOperationGroupServer SKUsOperationGroupServer
...
type ServerFactoryTransport struct {
	...
	trSKUsOperationGroupServer         *SKUsOperationGroupServerTransport
...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "SKUsOperationGroupClient":
		initServer(s, &s.trSKUsOperationGroupServer, func() *SKUsOperationGroupServerTransport {
			return NewSKUsOperationGroupServerTransport(&s.srv.SKUsOperationGroupServer)
		})
		resp, err = s.trSKUsOperationGroupServer.Do(req)
