...
type SapLandscapeMonitorServer struct {
	...
	Create func(ctx context.Context, resourceGroupName string, monitorName string, resource sapmonitors.SapLandscapeMonitorSapLandscapeMonitorResource, options *sapmonitors.SapLandscapeMonitorClientCreateOptions) (resp azfake.Responder[sapmonitors.SapLandscapeMonitorClientCreateResponse], errResp azfake.ErrorResponder)
	...
	// HTTP status codes to indicate success: http.StatusOK
	Update func(ctx context.Context, resourceGroupName string, monitorName string, properties sapmonitors.SapLandscapeMonitorSapLandscapeMonitorResource, options *sapmonitors.SapLandscapeMonitorClientUpdateOptions) (resp azfake.Responder[sapmonitors.SapLandscapeMonitorClientUpdateResponse], errResp azfake.ErrorResponder)
}
...
func (s *SapLandscapeMonitorServerTransport) dispatchCreate(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[sapmonitors.SapLandscapeMonitorSapLandscapeMonitorResource](req)
	if err != nil {
		return nil, err
	}
	...
	resp, err := server.MarshalResponseAsJSON(respContent, server.GetResponse(respr).SapLandscapeMonitorSapLandscapeMonitorResource, req)
	if err != nil {
		return nil, err
	}
	return resp, nil
