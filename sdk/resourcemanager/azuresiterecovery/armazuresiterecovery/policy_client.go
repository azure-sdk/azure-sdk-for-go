...
func (client *PolicyClient) BeginCreate(ctx context.Context, subscriptionID string, resourceGroupName string, vaultName string, policyName string, body PolicyModel, options *PolicyClientBeginCreateOptions) (*runtime.Poller[PolicyClientCreateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.create(ctx, subscriptionID, resourceGroupName, vaultName, policyName, body, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2021-02-16-preview
func (client *PolicyClient) create(ctx context.Context, subscriptionID string, resourceGroupName string, vaultName string, policyName string, body PolicyModel, options *PolicyClientBeginCreateOptions) (*http.Response, error) {
	var err error
	req, err := client.createCreateRequest(ctx, subscriptionID, resourceGroupName, vaultName, policyName, body, options)
	if err != nil {
		return nil, err
	}
...
func (client *PolicyClient) createCreateRequest(ctx context.Context, subscriptionID string, resourceGroupName string, vaultName string, policyName string, body PolicyModel, options *PolicyClientBeginCreateOptions) (*policy.Request, error) {
...
func (client *PolicyClient) BeginDelete(ctx context.Context, subscriptionID string, resourceGroupName string, vaultName string, policyName string, options *PolicyClientBeginDeleteOptions) (*runtime.Poller[PolicyClientDeleteResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.deleteOperation(ctx, subscriptionID, resourceGroupName, vaultName, policyName, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2021-02-16-preview
func (client *PolicyClient) deleteOperation(ctx context.Context, subscriptionID string, resourceGroupName string, vaultName string, policyName string, options *PolicyClientBeginDeleteOptions) (*http.Response, error) {
	var err error
	req, err := client.deleteCreateRequest(ctx, subscriptionID, resourceGroupName, vaultName, policyName, options)
	if err != nil {
		return nil, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
...
func (client *PolicyClient) deleteCreateRequest(ctx context.Context, subscriptionID string, resourceGroupName string, vaultName string, policyName string, options *PolicyClientBeginDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataReplication/replicationVaults/{vaultName}/replicationPolicies/{policyName}"
	if subscriptionID == "" {
		return nil, errors.New("parameter subscriptionID cannot be empty")
	}
...
func (client *PolicyClient) Get(ctx context.Context, subscriptionID string, resourceGroupName string, vaultName string, policyName string, options *PolicyClientGetOptions) (PolicyClientGetResponse, error) {
	var err error
	req, err := client.getCreateRequest(ctx, subscriptionID, resourceGroupName, vaultName, policyName, options)
	if err != nil {
...
func (client *PolicyClient) getCreateRequest(ctx context.Context, subscriptionID string, resourceGroupName string, vaultName string, policyName string, options *PolicyClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataReplication/replicationVaults/{vaultName}/replicationPolicies/{policyName}"
	if subscriptionID == "" {
		return nil, errors.New("parameter subscriptionID cannot be empty")
	}
...
func (client *PolicyClient) NewListPager(subscriptionID string, resourceGroupName string, vaultName string, options *PolicyClientListOptions) *runtime.Pager[PolicyClientListResponse] {
...
func (client *PolicyClient) listCreateRequest(ctx context.Context, subscriptionID string, resourceGroupName string, vaultName string, options *PolicyClientListOptions) (*policy.Request, error) {
