...
// List - List trusted access role bindings.
// If the operation fails it returns an *azcore.ResponseError type.
// resourceGroupName - The name of the resource group. The name is case insensitive.
// resourceName - The name of the managed cluster resource.
...
// method.
func (client *TrustedAccessRoleBindingsClient) List(ctx context.Context, resourceGroupName string, resourceName string, options *TrustedAccessRoleBindingsClientListOptions) (TrustedAccessRoleBindingsClientListResponse, error) {
