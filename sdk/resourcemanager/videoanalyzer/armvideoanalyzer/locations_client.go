...
func (client *LocationsClient) checkNameAvailabilityCreateRequest(ctx context.Context, locationName string, parameters CheckNameAvailabilityRequest, _ *LocationsClientCheckNameAvailabilityOptions) (*policy.Request, error) {
