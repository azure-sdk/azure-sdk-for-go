...
func (client *StorageDomainsClient) createOrUpdateCreateRequest(ctx context.Context, storageDomainName string, resourceGroupName string, managerName string, storageDomain StorageDomain, _ *StorageDomainsClientBeginCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *StorageDomainsClient) deleteCreateRequest(ctx context.Context, storageDomainName string, resourceGroupName string, managerName string, _ *StorageDomainsClientBeginDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorSimple/managers/{managerName}/storageDomains/{storageDomainName}"
	if storageDomainName == "" {
		return nil, errors.New("parameter storageDomainName cannot be empty")
	}
...
func (client *StorageDomainsClient) getCreateRequest(ctx context.Context, storageDomainName string, resourceGroupName string, managerName string, _ *StorageDomainsClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorSimple/managers/{managerName}/storageDomains/{storageDomainName}"
	if storageDomainName == "" {
		return nil, errors.New("parameter storageDomainName cannot be empty")
	}
...
func (client *StorageDomainsClient) listByManagerCreateRequest(ctx context.Context, resourceGroupName string, managerName string, _ *StorageDomainsClientListByManagerOptions) (*policy.Request, error) {
