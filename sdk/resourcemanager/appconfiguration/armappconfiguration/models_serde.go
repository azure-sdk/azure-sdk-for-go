...
// MarshalJSON implements the json.Marshaller interface for type Experimentation.
func (e Experimentation) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type Experimentation.
func (e *Experimentation) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", e, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type ExperimentationListResult.
func (e ExperimentationListResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type ExperimentationListResult.
func (e *ExperimentationListResult) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", e, err)
	}
...
func (e ExperimentationProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "managedResourceGroupName", e.ManagedResourceGroupName)
	populate(objectMap, "onlineExperimentationWorkspaceResourceId", e.OnlineExperimentationWorkspaceResourceID)
...
func (e *ExperimentationProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "managedResourceGroupName":
			err = unpopulate(val, "ManagedResourceGroupName", &e.ManagedResourceGroupName)
			delete(rawMsg, key)
		case "onlineExperimentationWorkspaceResourceId":
			err = unpopulate(val, "OnlineExperimentationWorkspaceResourceID", &e.OnlineExperimentationWorkspaceResourceID)
			delete(rawMsg, key)
		case "provisioningState":
