...
func (client *GetClient) integrationRuntimeEnableInteractivequeryCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, integrationRuntimeName string, integrationRuntimeOperationID string, _ *GetClientIntegrationRuntimeEnableInteractivequeryOptions) (*policy.Request, error) {
...
func (client *GetClient) integrationRuntimeStartCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, integrationRuntimeName string, integrationRuntimeOperationID string, _ *GetClientIntegrationRuntimeStartOptions) (*policy.Request, error) {
...
func (client *GetClient) integrationRuntimeStopCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, integrationRuntimeName string, integrationRuntimeOperationID string, _ *GetClientIntegrationRuntimeStopOptions) (*policy.Request, error) {
