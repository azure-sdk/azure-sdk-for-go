...
func (client *EdgeDeviceJobsClient) createOrUpdateCreateRequest(ctx context.Context, resourceURI string, edgeDeviceName string, jobsName string, resource EdgeDeviceJobClassification, options *EdgeDeviceJobsClientBeginCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *EdgeDeviceJobsClient) deleteCreateRequest(ctx context.Context, resourceURI string, edgeDeviceName string, jobsName string, options *EdgeDeviceJobsClientBeginDeleteOptions) (*policy.Request, error) {
	urlPath := "/{resourceUri}/providers/Microsoft.AzureStackHCI/edgeDevices/{edgeDeviceName}/jobs/{jobsName}"
	urlPath = strings.ReplaceAll(urlPath, "{resourceUri}", resourceURI)
	if edgeDeviceName == "" {
		return nil, errors.New("parameter edgeDeviceName cannot be empty")
...
func (client *EdgeDeviceJobsClient) getCreateRequest(ctx context.Context, resourceURI string, edgeDeviceName string, jobsName string, options *EdgeDeviceJobsClientGetOptions) (*policy.Request, error) {
	urlPath := "/{resourceUri}/providers/Microsoft.AzureStackHCI/edgeDevices/{edgeDeviceName}/jobs/{jobsName}"
	urlPath = strings.ReplaceAll(urlPath, "{resourceUri}", resourceURI)
	if edgeDeviceName == "" {
		return nil, errors.New("parameter edgeDeviceName cannot be empty")
...
func (client *EdgeDeviceJobsClient) listByEdgeDeviceCreateRequest(ctx context.Context, resourceURI string, edgeDeviceName string, options *EdgeDeviceJobsClientListByEdgeDeviceOptions) (*policy.Request, error) {
