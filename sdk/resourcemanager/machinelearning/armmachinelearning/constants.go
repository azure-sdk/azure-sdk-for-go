...
// DataReferenceCredentialType - Enum to determine data reference credential type
...
// PendingUploadCredentialType - Enum to determine PendingUploads credential type
