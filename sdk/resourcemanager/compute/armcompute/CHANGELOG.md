...
- Field `Etag` of struct `VirtualMachine` has been removed
...
- Field `Name`, `Type` of struct `VirtualMachineScaleSetExtension` has been removed
- Field `Name`, `Type` of struct `VirtualMachineScaleSetVMExtension` has been removed

### Features Added

- New enum type `ActionType` with values `ActionTypeInternal`
- New enum type `CreatedByType` with values `CreatedByTypeApplication`, `CreatedByTypeKey`, `CreatedByTypeManagedIdentity`, `CreatedByTypeUser`
- New enum type `ExpandType` with values `ExpandTypeProperties`
...
- New field `ETag`, `SystemData` in struct `VirtualMachine`
...
- New field `ETag`, `SystemData` in struct `VirtualMachineScaleSet`
- New field `DiskIopsReadWrite` in struct `VirtualMachineScaleSetDataDisk`
- New field `VMName`, `VMType` in struct `VirtualMachineScaleSetExtension`
- New field `SystemData` in struct `VirtualMachineScaleSetVM`
- New field `VMName`, `VMType` in struct `VirtualMachineScaleSetVMExtension`
