...
func (e ExportDataset) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "grouping", e.Grouping)
	return json.Marshal(objectMap)
}
...
func (e *ExportDataset) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "granularity":
			...
			delete(rawMsg, key)
		case "grouping":
			err = unpopulate(val, "Grouping", &e.Grouping)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", e, err)
...
// MarshalJSON implements the json.Marshaller interface for type ExportDatasetGrouping.
func (e ExportDatasetGrouping) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "ColumnType", e.ColumnType)
	populate(objectMap, "Name", e.Name)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ExportDatasetGrouping.
func (e *ExportDatasetGrouping) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", e, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "ColumnType":
			err = unpopulate(val, "ColumnType", &e.ColumnType)
			delete(rawMsg, key)
		case "Name":
			err = unpopulate(val, "Name", &e.Name)
			delete(rawMsg, key)
