...
type Paths1J3Lu7WSubscriptionsSubscriptionidResourcegroupsResourcegroupnameProvidersMicrosoftOperationalinsightsWorkspacesWorkspacenameProvidersMicrosoftSecurityinsightsSourcecontrolsSourcecontrolidDeletePostRequestbodyContentApplicationJSONSchema struct {
	// REQUIRED; Credentials to access repository.
...
type SourceControlProperties struct {
	...
	// READ-ONLY; Service principal metadata.
