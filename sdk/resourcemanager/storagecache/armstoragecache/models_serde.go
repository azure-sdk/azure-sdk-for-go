...
// MarshalJSON implements the json.Marshaller interface for type AutoExportJobUpdateProperties.
func (a AutoExportJobUpdateProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "adminStatus", a.AdminStatus)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type AutoExportJobUpdateProperties.
func (a *AutoExportJobUpdateProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", a, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type AutoImportJob.
func (a AutoImportJob) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "id", a.ID)
	populate(objectMap, "location", a.Location)
	populate(objectMap, "name", a.Name)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type AutoImportJob.
func (a *AutoImportJob) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", a, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type AutoImportJobProperties.
func (a AutoImportJobProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "adminStatus", a.AdminStatus)
	populate(objectMap, "autoImportPrefixes", a.AutoImportPrefixes)
	populate(objectMap, "conflictResolutionMode", a.ConflictResolutionMode)
	populate(objectMap, "enableDeletions", a.EnableDeletions)
	populate(objectMap, "maximumErrors", a.MaximumErrors)
	populate(objectMap, "provisioningState", a.ProvisioningState)
	populate(objectMap, "status", a.Status)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type AutoImportJobProperties.
func (a *AutoImportJobProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", a, err)
	}
	for key, val := range rawMsg {
		...
		case "adminStatus":
			err = unpopulate(val, "AdminStatus", &a.AdminStatus)
			delete(rawMsg, key)
		case "autoImportPrefixes":
			err = unpopulate(val, "AutoImportPrefixes", &a.AutoImportPrefixes)
			delete(rawMsg, key)
		case "conflictResolutionMode":
			err = unpopulate(val, "ConflictResolutionMode", &a.ConflictResolutionMode)
			delete(rawMsg, key)
		case "enableDeletions":
			err = unpopulate(val, "EnableDeletions", &a.EnableDeletions)
			delete(rawMsg, key)
		case "maximumErrors":
			err = unpopulate(val, "MaximumErrors", &a.MaximumErrors)
			delete(rawMsg, key)
		case "provisioningState":
			err = unpopulate(val, "ProvisioningState", &a.ProvisioningState)
			delete(rawMsg, key)
...
// MarshalJSON implements the json.Marshaller interface for type AutoImportJobPropertiesStatus.
func (a AutoImportJobPropertiesStatus) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "blobSyncEvents", a.BlobSyncEvents)
	populate(objectMap, "importedDirectories", a.ImportedDirectories)
	populate(objectMap, "importedFiles", a.ImportedFiles)
	populate(objectMap, "importedSymlinks", a.ImportedSymlinks)
	populateDateTimeRFC3339(objectMap, "lastCompletionTimeUTC", a.LastCompletionTimeUTC)
	populateDateTimeRFC3339(objectMap, "lastStartedTimeUTC", a.LastStartedTimeUTC)
	populate(objectMap, "preexistingDirectories", a.PreexistingDirectories)
	populate(objectMap, "preexistingFiles", a.PreexistingFiles)
	populate(objectMap, "preexistingSymlinks", a.PreexistingSymlinks)
	populate(objectMap, "rateOfBlobImport", a.RateOfBlobImport)
	populate(objectMap, "rateOfBlobWalk", a.RateOfBlobWalk)
	populateDateTimeRFC3339(objectMap, "scanEndTime", a.ScanEndTime)
	populateDateTimeRFC3339(objectMap, "scanStartTime", a.ScanStartTime)
	populate(objectMap, "state", a.State)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type AutoImportJobPropertiesStatus.
func (a *AutoImportJobPropertiesStatus) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", a, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "blobSyncEvents":
			err = unpopulate(val, "BlobSyncEvents", &a.BlobSyncEvents)
			delete(rawMsg, key)
		case "importedDirectories":
			err = unpopulate(val, "ImportedDirectories", &a.ImportedDirectories)
			delete(rawMsg, key)
		case "importedFiles":
			err = unpopulate(val, "ImportedFiles", &a.ImportedFiles)
			delete(rawMsg, key)
		case "importedSymlinks":
			err = unpopulate(val, "ImportedSymlinks", &a.ImportedSymlinks)
			delete(rawMsg, key)
		case "lastCompletionTimeUTC":
			err = unpopulateDateTimeRFC3339(val, "LastCompletionTimeUTC", &a.LastCompletionTimeUTC)
			delete(rawMsg, key)
		...
		case "preexistingDirectories":
			err = unpopulate(val, "PreexistingDirectories", &a.PreexistingDirectories)
			delete(rawMsg, key)
		case "preexistingFiles":
			err = unpopulate(val, "PreexistingFiles", &a.PreexistingFiles)
			delete(rawMsg, key)
		case "preexistingSymlinks":
			err = unpopulate(val, "PreexistingSymlinks", &a.PreexistingSymlinks)
			delete(rawMsg, key)
		case "rateOfBlobImport":
			err = unpopulate(val, "RateOfBlobImport", &a.RateOfBlobImport)
			delete(rawMsg, key)
		case "rateOfBlobWalk":
			err = unpopulate(val, "RateOfBlobWalk", &a.RateOfBlobWalk)
			delete(rawMsg, key)
		case "scanEndTime":
			err = unpopulateDateTimeRFC3339(val, "ScanEndTime", &a.ScanEndTime)
			delete(rawMsg, key)
		case "scanStartTime":
			err = unpopulateDateTimeRFC3339(val, "ScanStartTime", &a.ScanStartTime)
			delete(rawMsg, key)
		case "state":
			err = unpopulate(val, "State", &a.State)
			delete(rawMsg, key)
...
// MarshalJSON implements the json.Marshaller interface for type AutoImportJobPropertiesStatusBlobSyncEvents.
func (a AutoImportJobPropertiesStatusBlobSyncEvents) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "deletions", a.Deletions)
	populate(objectMap, "importedDirectories", a.ImportedDirectories)
	populate(objectMap, "importedFiles", a.ImportedFiles)
	populate(objectMap, "importedSymlinks", a.ImportedSymlinks)
	populateDateTimeRFC3339(objectMap, "lastChangeFeedEventConsumedTime", a.LastChangeFeedEventConsumedTime)
	populateDateTimeRFC3339(objectMap, "lastTimeFullySynchronized", a.LastTimeFullySynchronized)
	populate(objectMap, "preexistingDirectories", a.PreexistingDirectories)
	populate(objectMap, "preexistingFiles", a.PreexistingFiles)
	populate(objectMap, "preexistingSymlinks", a.PreexistingSymlinks)
	populate(objectMap, "rateOfBlobImport", a.RateOfBlobImport)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type AutoImportJobPropertiesStatusBlobSyncEvents.
func (a *AutoImportJobPropertiesStatusBlobSyncEvents) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", a, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "deletions":
			err = unpopulate(val, "Deletions", &a.Deletions)
			delete(rawMsg, key)
		case "importedDirectories":
			err = unpopulate(val, "ImportedDirectories", &a.ImportedDirectories)
			delete(rawMsg, key)
		...
		case "importedSymlinks":
			err = unpopulate(val, "ImportedSymlinks", &a.ImportedSymlinks)
			delete(rawMsg, key)
		case "lastChangeFeedEventConsumedTime":
			err = unpopulateDateTimeRFC3339(val, "LastChangeFeedEventConsumedTime", &a.LastChangeFeedEventConsumedTime)
			delete(rawMsg, key)
		case "lastTimeFullySynchronized":
			err = unpopulateDateTimeRFC3339(val, "LastTimeFullySynchronized", &a.LastTimeFullySynchronized)
			delete(rawMsg, key)
		case "preexistingDirectories":
			err = unpopulate(val, "PreexistingDirectories", &a.PreexistingDirectories)
			delete(rawMsg, key)
...
// MarshalJSON implements the json.Marshaller interface for type AutoImportJobUpdate.
func (a AutoImportJobUpdate) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "properties", a.Properties)
	populate(objectMap, "tags", a.Tags)
	return json.Marshal(objectMap)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type AutoImportJobUpdate.
func (a *AutoImportJobUpdate) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", a, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type AutoImportJobUpdateProperties.
func (a AutoImportJobUpdateProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "adminStatus", a.AdminStatus)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type AutoImportJobUpdateProperties.
func (a *AutoImportJobUpdateProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", a, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type AutoImportJobsListResult.
func (a AutoImportJobsListResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "nextLink", a.NextLink)
	populate(objectMap, "value", a.Value)
	return json.Marshal(objectMap)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type AutoImportJobsListResult.
func (a *AutoImportJobsListResult) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", a, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type ImportJobUpdateProperties.
func (i ImportJobUpdateProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "adminStatus", i.AdminStatus)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ImportJobUpdateProperties.
func (i *ImportJobUpdateProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", i, err)
	}
