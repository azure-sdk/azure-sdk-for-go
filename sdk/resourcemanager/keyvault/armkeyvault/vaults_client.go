...
func (client *VaultsClient) NewListPager(apiVersion ResourceManagerAPIVersions, options *VaultsClientListOptions) *runtime.Pager[VaultsClientListResponse] {
	return runtime.NewPager(runtime.PagingHandler[VaultsClientListResponse]{
		...
		Fetcher: func(ctx context.Context, page *VaultsClientListResponse) (VaultsClientListResponse, error) {
			...
			var err error
			if page == nil {
				req, err = client.listCreateRequest(ctx, apiVersion, options)
			} else {
...
func (client *VaultsClient) listCreateRequest(ctx context.Context, apiVersion ResourceManagerAPIVersions, options *VaultsClientListOptions) (*policy.Request, error) {
