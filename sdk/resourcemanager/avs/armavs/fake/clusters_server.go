...
type ClustersServer struct {
	...
	// HTTP status codes to indicate success: http.StatusOK
	NewListByPrivateCloudPager func(resourceGroupName string, privateCloudName string, options *armavs.ClustersClientListByPrivateCloudOptions) (resp azfake.PagerResponder[armavs.ClustersClientListByPrivateCloudResponse])
	...
	// HTTP status codes to indicate success: http.StatusOK, http.StatusCreated
	Update func(ctx context.Context, resourceGroupName string, privateCloudName string, clusterName string, clusterUpdate armavs.ClusterUpdate, options *armavs.ClustersClientUpdateOptions) (resp azfake.Responder[armavs.ClustersClientUpdateResponse], errResp azfake.ErrorResponder)
}
...
func (c *ClustersServerTransport) dispatchNewListByPrivateCloudPager(req *http.Request) (*http.Response, error) {
	...
	if newListByPrivateCloudPager == nil {
		...
		resp := c.srv.NewListByPrivateCloudPager(resourceGroupNameParam, privateCloudNameParam, nil)
...
func (c *ClustersServerTransport) dispatchUpdate(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := c.srv.Update(req.Context(), resourceGroupNameParam, privateCloudNameParam, clusterNameParam, body, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
