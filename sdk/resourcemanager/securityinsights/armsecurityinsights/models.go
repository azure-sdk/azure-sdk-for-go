...
type TIObjectCommonProperties struct {
	...
	CreatedBy *UserInfoAutoGenerated
	...
	LastModifiedBy *UserInfoAutoGenerated
...
// UserInfoAutoGenerated - Data about a user or client application.
type UserInfoAutoGenerated struct {
	...
	// READ-ONLY; The user's object ID.
	ObjectID *string
}
