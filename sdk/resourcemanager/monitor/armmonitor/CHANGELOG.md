...
- Type of `DataCollectionRulesClientUpdateOptions.Body` has been changed from `*ResourceForUpdate` to `*ResourceForUpdateAutoGenerated`
...
- Type of `ErrorResponseAutoGenerated2.Error` has been changed from `*ErrorDetailAutoGenerated` to `*ErrorDetail`
...
- New struct `MetadataAutoGenerated`
- New struct `MetadataAutoGenerated2`
...
- New struct `ResourceForUpdateAutoGenerated`
- New struct `ResourceForUpdateDceProperties`
- New struct `ResourceForUpdateDcePropertiesFailoverConfiguration`
- New struct `ResourceForUpdateDcePropertiesMetadata`
- New struct `ResourceForUpdateProperties`
...
- New field `AdditionalInfo`, `Details`, `Target` in struct `ErrorResponseAutoGenerated`
...
- New field `Kind`, `Properties` in struct `ResourceForUpdate`
