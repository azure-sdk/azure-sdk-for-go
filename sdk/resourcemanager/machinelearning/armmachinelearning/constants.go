...
const (
	...
	// ClassificationModelPerformanceMetricF1Score - Calculates the F1 score of the model predictions.
...
// PossibleFeaturestoreJobTypeValues returns the possible values for the FeaturestoreJobType const type.
func PossibleFeaturestoreJobTypeValues() []FeaturestoreJobType {
	return []FeaturestoreJobType{
		FeaturestoreJobTypeBackfillMaterialization,
		FeaturestoreJobTypeRecurrentMaterialization,
	}
}
...
const (
	// MonitoringAlertNotificationTypeAzureMonitor - Settings for Azure Monitor based alerting.
	MonitoringAlertNotificationTypeAzureMonitor MonitoringAlertNotificationType = "AzureMonitor"
	// MonitoringAlertNotificationTypeEmail - Settings for AML email notifications.
	MonitoringAlertNotificationTypeEmail MonitoringAlertNotificationType = "Email"
)

// PossibleMonitoringAlertNotificationTypeValues returns the possible values for the MonitoringAlertNotificationType const type.
func PossibleMonitoringAlertNotificationTypeValues() []MonitoringAlertNotificationType {
	return []MonitoringAlertNotificationType{
		MonitoringAlertNotificationTypeAzureMonitor,
...
const (
	// MonitoringInputDataContextGroundTruth - A dataset containing the ground truth data.
	MonitoringInputDataContextGroundTruth MonitoringInputDataContext = "GroundTruth"
	// MonitoringInputDataContextModelInputs - A dataset containing the feature input to the model.
	MonitoringInputDataContextModelInputs MonitoringInputDataContext = "ModelInputs"
	// MonitoringInputDataContextModelOutputs - A dataset containing the inferred results of the model.
	MonitoringInputDataContextModelOutputs MonitoringInputDataContext = "ModelOutputs"
	// MonitoringInputDataContextTest - A dataset leveraged to test the model.
	MonitoringInputDataContextTest MonitoringInputDataContext = "Test"
	// MonitoringInputDataContextTraining - A dataset containing the data used for training the model.
	MonitoringInputDataContextTraining MonitoringInputDataContext = "Training"
	// MonitoringInputDataContextValidation - A dataset leveraged for model validation.
	MonitoringInputDataContextValidation MonitoringInputDataContext = "Validation"
)

// PossibleMonitoringInputDataContextValues returns the possible values for the MonitoringInputDataContext const type.
func PossibleMonitoringInputDataContextValues() []MonitoringInputDataContext {
	return []MonitoringInputDataContext{
...
const (
	// MonitoringNotificationModeDisabled - Disabled notifications will not produce emails/metrics leveraged for alerting.
	MonitoringNotificationModeDisabled MonitoringNotificationMode = "Disabled"
	// MonitoringNotificationModeEnabled - Enabled notification will produce emails/metrics leveraged for alerting.
	MonitoringNotificationModeEnabled MonitoringNotificationMode = "Enabled"
)

// PossibleMonitoringNotificationModeValues returns the possible values for the MonitoringNotificationMode const type.
func PossibleMonitoringNotificationModeValues() []MonitoringNotificationMode {
	return []MonitoringNotificationMode{
...
// RuleStatus - Status of a managed network Outbound Rule of a machine learning workspace.
