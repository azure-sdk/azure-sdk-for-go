...
type Server struct {
	...
	// HTTP status codes to indicate success: http.StatusOK
	Update func(ctx context.Context, resourceGroupName string, scriptName string, deploymentScript armdeploymentscripts.DeploymentScriptUpdateParameter, options *armdeploymentscripts.ClientUpdateOptions) (resp azfake.Responder[armdeploymentscripts.ClientUpdateResponse], errResp azfake.ErrorResponder)
}
