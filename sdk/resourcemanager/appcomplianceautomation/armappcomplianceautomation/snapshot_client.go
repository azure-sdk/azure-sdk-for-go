...
func (client *SnapshotClient) BeginDownload(ctx context.Context, reportName string, snapshotName string, downloadType DownloadType, options *SnapshotClientBeginDownloadOptions) (*runtime.Poller[SnapshotClientDownloadResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.download(ctx, reportName, snapshotName, downloadType, options)
		if err != nil {
			return nil, err
		}
...
// If the operation fails it returns an *azcore.ResponseError type.
// Generated from API version 2022-11-16-preview
func (client *SnapshotClient) download(ctx context.Context, reportName string, snapshotName string, downloadType DownloadType, options *SnapshotClientBeginDownloadOptions) (*http.Response, error) {
	req, err := client.downloadCreateRequest(ctx, reportName, snapshotName, downloadType, options)
	if err != nil {
		return nil, err
	}
...
func (client *SnapshotClient) downloadCreateRequest(ctx context.Context, reportName string, snapshotName string, downloadType DownloadType, options *SnapshotClientBeginDownloadOptions) (*policy.Request, error) {
	...
	reqQP.Set("downloadType", string(downloadType))
