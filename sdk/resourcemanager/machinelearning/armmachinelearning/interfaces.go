...
// OutboundRuleDtoClassification provides polymorphic access to related types.
// Call the interface's GetOutboundRuleDto() method to access the common type.
// Use a type switch to determine the concrete type.  The possible types are:
// - *OutboundRuleDto
type OutboundRuleDtoClassification interface {
	// GetOutboundRuleDto returns the OutboundRuleDto content of the underlying type.
	GetOutboundRuleDto() *OutboundRuleDto
}
