...
func (r *ReferenceDataSetsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if referenceDataSetsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = referenceDataSetsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "ReferenceDataSetsClient.ListByEnvironment":
				res.resp, res.err = r.dispatchListByEnvironment(req)
...
// set this to conditionally intercept incoming requests to ReferenceDataSetsServerTransport
var referenceDataSetsServerTransportInterceptor interface {
