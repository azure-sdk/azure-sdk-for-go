...
func NewIotDpsResourceClient(subscriptionID string, credential azcore.TokenCredential, options *arm.ClientOptions) (*IotDpsResourceClient, error) {
	cl, err := arm.NewClient(moduleName+".IotDpsResourceClient", moduleVersion, credential, options)
	if err != nil {
		return nil, err
	}
...
//
// Generated from API version 2023-04-13-preview
...
func (client *IotDpsResourceClient) checkProvisioningServiceNameAvailabilityCreateRequest(ctx context.Context, arguments OperationInputs, options *IotDpsResourceClientCheckProvisioningServiceNameAvailabilityOptions) (*policy.Request, error) {
	...
	reqQP.Set("api-version", "2023-04-13-preview")
...
func (client *IotDpsResourceClient) BeginCreateOrUpdate(ctx context.Context, resourceGroupName string, provisioningServiceName string, iotDpsDescription ProvisioningServiceDescription, options *IotDpsResourceClientBeginCreateOrUpdateOptions) (*runtime.Poller[IotDpsResourceClientCreateOrUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return runtime.NewPoller[IotDpsResourceClientCreateOrUpdateResponse](resp, client.internal.Pipeline(), nil)
	} else {
		return runtime.NewPollerFromResumeToken[IotDpsResourceClientCreateOrUpdateResponse](options.ResumeToken, client.internal.Pipeline(), nil)
	}
}
...
func (client *IotDpsResourceClient) BeginCreateOrUpdatePrivateEndpointConnection(ctx context.Context, resourceGroupName string, resourceName string, privateEndpointConnectionName string, privateEndpointConnection PrivateEndpointConnection, options *IotDpsResourceClientBeginCreateOrUpdatePrivateEndpointConnectionOptions) (*runtime.Poller[IotDpsResourceClientCreateOrUpdatePrivateEndpointConnectionResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return runtime.NewPoller[IotDpsResourceClientCreateOrUpdatePrivateEndpointConnectionResponse](resp, client.internal.Pipeline(), nil)
	} else {
		return runtime.NewPollerFromResumeToken[IotDpsResourceClientCreateOrUpdatePrivateEndpointConnectionResponse](options.ResumeToken, client.internal.Pipeline(), nil)
	}
}
...
func (client *IotDpsResourceClient) BeginDelete(ctx context.Context, provisioningServiceName string, resourceGroupName string, options *IotDpsResourceClientBeginDeleteOptions) (*runtime.Poller[IotDpsResourceClientDeleteResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return runtime.NewPoller[IotDpsResourceClientDeleteResponse](resp, client.internal.Pipeline(), nil)
	} else {
		return runtime.NewPollerFromResumeToken[IotDpsResourceClientDeleteResponse](options.ResumeToken, client.internal.Pipeline(), nil)
	}
}
...
func (client *IotDpsResourceClient) BeginDeletePrivateEndpointConnection(ctx context.Context, resourceGroupName string, resourceName string, privateEndpointConnectionName string, options *IotDpsResourceClientBeginDeletePrivateEndpointConnectionOptions) (*runtime.Poller[IotDpsResourceClientDeletePrivateEndpointConnectionResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return runtime.NewPoller[IotDpsResourceClientDeletePrivateEndpointConnectionResponse](resp, client.internal.Pipeline(), nil)
	} else {
		return runtime.NewPollerFromResumeToken[IotDpsResourceClientDeletePrivateEndpointConnectionResponse](options.ResumeToken, client.internal.Pipeline(), nil)
	}
}
...
// Failover - Start Customer Initiated Failover for the given provisioning service
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2023-04-13-preview
//   - resourceGroupName - The name of the resource group that contains the provisioning service.
//   - provisioningServiceName - The provisioning service name to start customer initiated failover.
//   - dpsFailoverDescription - Failover description
//   - options - IotDpsResourceClientFailoverOptions contains the optional parameters for the IotDpsResourceClient.Failover method.
func (client *IotDpsResourceClient) Failover(ctx context.Context, resourceGroupName string, provisioningServiceName string, dpsFailoverDescription CustomerInitiatedFailoverInput, options *IotDpsResourceClientFailoverOptions) (IotDpsResourceClientFailoverResponse, error) {
	req, err := client.failoverCreateRequest(ctx, resourceGroupName, provisioningServiceName, dpsFailoverDescription, options)
	if err != nil {
		return IotDpsResourceClientFailoverResponse{}, err
	}
	resp, err := client.internal.Pipeline().Do(req)
	if err != nil {
		return IotDpsResourceClientFailoverResponse{}, err
	...
	if !runtime.HasStatusCode(resp, http.StatusAccepted) {
		return IotDpsResourceClientFailoverResponse{}, runtime.NewResponseError(resp)
	}
	return IotDpsResourceClientFailoverResponse{}, nil
}

// failoverCreateRequest creates the Failover request.
func (client *IotDpsResourceClient) failoverCreateRequest(ctx context.Context, resourceGroupName string, provisioningServiceName string, dpsFailoverDescription CustomerInitiatedFailoverInput, options *IotDpsResourceClientFailoverOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Devices/provisioningServices/{provisioningServiceName}/failover"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{subscriptionId}", url.PathEscape(client.subscriptionID))
	...
	req.Raw().URL.RawQuery = reqQP.Encode()
	req.Raw().Header["Accept"] = []string{"application/json"}
	return req, runtime.MarshalAsJSON(req, dpsFailoverDescription)
}
...
func (client *IotDpsResourceClient) BeginUpdate(ctx context.Context, resourceGroupName string, provisioningServiceName string, provisioningServiceTags TagsResource, options *IotDpsResourceClientBeginUpdateOptions) (*runtime.Poller[IotDpsResourceClientUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return runtime.NewPoller[IotDpsResourceClientUpdateResponse](resp, client.internal.Pipeline(), nil)
	} else {
		return runtime.NewPollerFromResumeToken[IotDpsResourceClientUpdateResponse](options.ResumeToken, client.internal.Pipeline(), nil)
	}
}
