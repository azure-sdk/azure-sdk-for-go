...
// EnterprisePackageDownloadInfo - Information on enterprise package download
type EnterprisePackageDownloadInfo struct {
	// READ-ONLY; package checksum
	Checksum *string
...
// FullPackageDownloadInfo - Information on full package downloads
type FullPackageDownloadInfo struct {
...
// PackageBaseDownloadInfo - Information on a specific package download
type PackageBaseDownloadInfo struct {
	// READ-ONLY; Download link
	Link *string
...
type PackageDownloadInfo struct {
	...
	// READ-ONLY; Package release date
	ReleaseDate *string

	// READ-ONLY; scope of the version
	Scope *Scope

	// READ-ONLY; Package supported until date
...
type PackageDownloads struct {
	...
	// READ-ONLY; All downloads for enterprise
	Enterprise []*EnterprisePackageDownloadInfo

	// READ-ONLY; Contains all Sensor binary downloads
	Sensor *PackageDownloadsSensor

	// READ-ONLY; SNMP Server file
	Snmp []*PackageBaseDownloadInfo

	// READ-ONLY; All downloads for threat intelligence
	ThreatIntelligence []*PackageBaseDownloadInfo
}
