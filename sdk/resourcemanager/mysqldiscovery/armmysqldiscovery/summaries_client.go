...
func (client *SummariesClient) getCreateRequest(ctx context.Context, resourceGroupName string, summaryName string, _ *SummariesClientGetOptions) (*policy.Request, error) {
...
func (client *SummariesClient) listBySiteCreateRequest(ctx context.Context, resourceGroupName string, _ *SummariesClientListBySiteOptions) (*policy.Request, error) {
