...
type ResourceSyncRulesServer struct {
	...
	// Update is the fake for method ResourceSyncRulesClient.Update
	// HTTP status codes to indicate success: http.StatusOK
	Update func(ctx context.Context, resourceGroupName string, resourceName string, childResourceName string, parameters armextendedlocation.PatchableResourceSyncRule, options *armextendedlocation.ResourceSyncRulesClientUpdateOptions) (resp azfake.Responder[armextendedlocation.ResourceSyncRulesClientUpdateResponse], errResp azfake.ErrorResponder)
}
...
func (r *ResourceSyncRulesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		if !intercepted {
			...
			case "ResourceSyncRulesClient.Update":
...
func (r *ResourceSyncRulesServerTransport) dispatchUpdate(req *http.Request) (*http.Response, error) {
	if r.srv.Update == nil {
	...
	respr, errRespr := r.srv.Update(req.Context(), resourceGroupNameParam, resourceNameParam, childResourceNameParam, body, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
