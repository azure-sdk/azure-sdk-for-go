...
// CloudHsmClustersClientValidateBackupResponse contains the response from method CloudHsmClustersClient.BeginValidateBackup.
type CloudHsmClustersClientValidateBackupResponse struct {
	// Backup operation Result
	BackupResult
}

// CloudHsmClustersClientValidateRestoreResponse contains the response from method CloudHsmClustersClient.BeginValidateRestore.
type CloudHsmClustersClientValidateRestoreResponse struct {
	// Restore operation properties
	RestoreResult
}
