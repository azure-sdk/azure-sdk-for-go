...
// CassandraClustersClientBeginGetCommandAsyncOptions contains the optional parameters for the CassandraClustersClient.BeginGetCommandAsync
// method.
type CassandraClustersClientBeginGetCommandAsyncOptions struct {
	// Resumes the LRO from the provided token.
	ResumeToken string
}
...
// CassandraClustersClientBeginListCommandOptions contains the optional parameters for the CassandraClustersClient.BeginListCommand
// method.
type CassandraClustersClientBeginListCommandOptions struct {
	// Resumes the LRO from the provided token.
	ResumeToken string
}
