...
// MetricAlertResourceKind - Indicates the type of metric alert
type MetricAlertResourceKind string

const (
	MetricAlertResourceKindMetric MetricAlertResourceKind = "Metric"
	MetricAlertResourceKindQuery  MetricAlertResourceKind = "Query"
)

// PossibleMetricAlertResourceKindValues returns the possible values for the MetricAlertResourceKind const type.
func PossibleMetricAlertResourceKindValues() []MetricAlertResourceKind {
	return []MetricAlertResourceKind{
		MetricAlertResourceKindMetric,
		MetricAlertResourceKindQuery,
	}
}

// MetricAlertRuleCriteriaOperator - The operator used to compare the metric value against the threshold
type MetricAlertRuleCriteriaOperator string

const (
	MetricAlertRuleCriteriaOperatorEquals             MetricAlertRuleCriteriaOperator = "Equals"
	MetricAlertRuleCriteriaOperatorGreaterThan        MetricAlertRuleCriteriaOperator = "GreaterThan"
	MetricAlertRuleCriteriaOperatorGreaterThanOrEqual MetricAlertRuleCriteriaOperator = "GreaterThanOrEqual"
	MetricAlertRuleCriteriaOperatorLessThan           MetricAlertRuleCriteriaOperator = "LessThan"
	MetricAlertRuleCriteriaOperatorLessThanOrEqual    MetricAlertRuleCriteriaOperator = "LessThanOrEqual"
	MetricAlertRuleCriteriaOperatorNotEquals          MetricAlertRuleCriteriaOperator = "NotEquals"
)

// PossibleMetricAlertRuleCriteriaOperatorValues returns the possible values for the MetricAlertRuleCriteriaOperator const type.
func PossibleMetricAlertRuleCriteriaOperatorValues() []MetricAlertRuleCriteriaOperator {
	return []MetricAlertRuleCriteriaOperator{
		MetricAlertRuleCriteriaOperatorEquals,
		MetricAlertRuleCriteriaOperatorGreaterThan,
		MetricAlertRuleCriteriaOperatorGreaterThanOrEqual,
		MetricAlertRuleCriteriaOperatorLessThan,
		MetricAlertRuleCriteriaOperatorLessThanOrEqual,
		MetricAlertRuleCriteriaOperatorNotEquals,
	}
}
