...
func (a AvailableWorkloadProfileProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "billingMeterCategory", a.BillingMeterCategory)
...
func (a *AvailableWorkloadProfileProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "applicability":
			...
			delete(rawMsg, key)
		case "billingMeterCategory":
			err = unpopulate(val, "BillingMeterCategory", &a.BillingMeterCategory)
			delete(rawMsg, key)
		case "cores":
...
func (c ConnectedEnvironmentProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "daprResiliencyDefaults", c.DaprResiliencyDefaults)
...
func (c *ConnectedEnvironmentProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "daprAIConnectionString":
			...
			delete(rawMsg, key)
		case "daprResiliencyDefaults":
			err = unpopulate(val, "DaprResiliencyDefaults", &c.DaprResiliencyDefaults)
			delete(rawMsg, key)
		case "defaultDomain":
...
func (c ContainerAppAuthTokenProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateTimeRFC3339(objectMap, "expires", c.Expires)
...
func (c *ContainerAppAuthTokenProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "expires":
			err = unpopulateTimeRFC3339(val, "Expires", &c.Expires)
			delete(rawMsg, key)
		case "token":
...
func (c *ContainerAppProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "workloadProfileType":
			err = unpopulate(val, "WorkloadProfileType", &c.WorkloadProfileType)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", c, err)
...
func (d Dapr) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "resiliencyTargets", d.ResiliencyTargets)
	return json.Marshal(objectMap)
}
...
func (d *Dapr) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "logLevel":
			...
			delete(rawMsg, key)
		case "resiliencyTargets":
			err = unpopulate(val, "ResiliencyTargets", &d.ResiliencyTargets)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", d, err)
...
// MarshalJSON implements the json.Marshaller interface for type DaprActorResiliencyTarget.
func (d DaprActorResiliencyTarget) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "circuitBreaker", d.CircuitBreaker)
	populate(objectMap, "circuitBreakerCacheSize", d.CircuitBreakerCacheSize)
	populate(objectMap, "circuitBreakerScope", d.CircuitBreakerScope)
	populate(objectMap, "retry", d.Retry)
	populate(objectMap, "target", d.Target)
	populate(objectMap, "timeout", d.Timeout)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type DaprActorResiliencyTarget.
func (d *DaprActorResiliencyTarget) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", d, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "circuitBreaker":
			err = unpopulate(val, "CircuitBreaker", &d.CircuitBreaker)
			delete(rawMsg, key)
		case "circuitBreakerCacheSize":
			err = unpopulate(val, "CircuitBreakerCacheSize", &d.CircuitBreakerCacheSize)
			delete(rawMsg, key)
		case "circuitBreakerScope":
			err = unpopulate(val, "CircuitBreakerScope", &d.CircuitBreakerScope)
			delete(rawMsg, key)
		case "retry":
			err = unpopulate(val, "Retry", &d.Retry)
			delete(rawMsg, key)
		case "target":
...
// MarshalJSON implements the json.Marshaller interface for type DaprAppResiliencyTarget.
func (d DaprAppResiliencyTarget) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "circuitBreaker", d.CircuitBreaker)
	populate(objectMap, "circuitBreakerCacheSize", d.CircuitBreakerCacheSize)
	populate(objectMap, "retry", d.Retry)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type DaprAppResiliencyTarget.
func (d *DaprAppResiliencyTarget) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", d, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type DaprComponentResiliencyTarget.
func (d DaprComponentResiliencyTarget) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type DaprComponentResiliencyTarget.
func (d *DaprComponentResiliencyTarget) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", d, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type DaprComponentResiliencyTargetInbound.
func (d DaprComponentResiliencyTargetInbound) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "circuitBreaker", d.CircuitBreaker)
	populate(objectMap, "retry", d.Retry)
	populate(objectMap, "timeout", d.Timeout)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type DaprComponentResiliencyTargetInbound.
func (d *DaprComponentResiliencyTargetInbound) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", d, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type DaprComponentResiliencyTargetOutbound.
func (d DaprComponentResiliencyTargetOutbound) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "circuitBreaker", d.CircuitBreaker)
	populate(objectMap, "retry", d.Retry)
	populate(objectMap, "timeout", d.Timeout)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type DaprComponentResiliencyTargetOutbound.
func (d *DaprComponentResiliencyTargetOutbound) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", d, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type DaprResiliencyCircuitBreakerPoliciesCollection.
func (d DaprResiliencyCircuitBreakerPoliciesCollection) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "nextLink", d.NextLink)
	populate(objectMap, "value", d.Value)
	return json.Marshal(objectMap)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type DaprResiliencyCircuitBreakerPoliciesCollection.
func (d *DaprResiliencyCircuitBreakerPoliciesCollection) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", d, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type DaprResiliencyCircuitBreakerPolicy.
func (d DaprResiliencyCircuitBreakerPolicy) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "id", d.ID)
	populate(objectMap, "name", d.Name)
	populate(objectMap, "properties", d.Properties)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type DaprResiliencyCircuitBreakerPolicy.
func (d *DaprResiliencyCircuitBreakerPolicy) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", d, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type DaprResiliencyCircuitBreakerPolicyProperties.
func (d DaprResiliencyCircuitBreakerPolicyProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "circuitBreakerCacheSize", d.CircuitBreakerCacheSize)
	populate(objectMap, "circuitBreakerScope", d.CircuitBreakerScope)
	populate(objectMap, "interval", d.Interval)
	populate(objectMap, "maxRequests", d.MaxRequests)
	populate(objectMap, "timeout", d.Timeout)
	populate(objectMap, "trip", d.Trip)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type DaprResiliencyCircuitBreakerPolicyProperties.
func (d *DaprResiliencyCircuitBreakerPolicyProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", d, err)
	}
	for key, val := range rawMsg {
		...
		case "circuitBreakerScope":
			...
			delete(rawMsg, key)
		case "interval":
			err = unpopulate(val, "Interval", &d.Interval)
			delete(rawMsg, key)
		case "maxRequests":
			err = unpopulate(val, "MaxRequests", &d.MaxRequests)
			delete(rawMsg, key)
		case "timeout":
			err = unpopulate(val, "Timeout", &d.Timeout)
			delete(rawMsg, key)
		case "trip":
			err = unpopulate(val, "Trip", &d.Trip)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", d, err)
...
// MarshalJSON implements the json.Marshaller interface for type DaprResiliencyDefaults.
func (d DaprResiliencyDefaults) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "circuitBreakers", d.CircuitBreakers)
	populate(objectMap, "retries", d.Retries)
	populate(objectMap, "timeouts", d.Timeouts)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type DaprResiliencyDefaults.
func (d *DaprResiliencyDefaults) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", d, err)
	}
	for key, val := range rawMsg {
		...
		case "circuitBreakers":
			err = unpopulate(val, "CircuitBreakers", &d.CircuitBreakers)
			delete(rawMsg, key)
		case "retries":
			err = unpopulate(val, "Retries", &d.Retries)
			delete(rawMsg, key)
		case "timeouts":
			err = unpopulate(val, "Timeouts", &d.Timeouts)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", d, err)
...
// MarshalJSON implements the json.Marshaller interface for type DaprResiliencyRetryPoliciesCollection.
func (d DaprResiliencyRetryPoliciesCollection) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "nextLink", d.NextLink)
	populate(objectMap, "value", d.Value)
	return json.Marshal(objectMap)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type DaprResiliencyRetryPoliciesCollection.
func (d *DaprResiliencyRetryPoliciesCollection) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", d, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type DaprResiliencyRetryPolicy.
func (d DaprResiliencyRetryPolicy) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "id", d.ID)
	populate(objectMap, "name", d.Name)
	populate(objectMap, "properties", d.Properties)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type DaprResiliencyRetryPolicy.
func (d *DaprResiliencyRetryPolicy) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", d, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type DaprResiliencyRetryPolicyProperties.
func (d DaprResiliencyRetryPolicyProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "duration", d.Duration)
	populate(objectMap, "maxInterval", d.MaxInterval)
	populate(objectMap, "maxRetries", d.MaxRetries)
	populate(objectMap, "policy", d.Policy)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type DaprResiliencyRetryPolicyProperties.
func (d *DaprResiliencyRetryPolicyProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", d, err)
	}
	for key, val := range rawMsg {
		...
		case "duration":
			...
			delete(rawMsg, key)
		case "maxInterval":
			err = unpopulate(val, "MaxInterval", &d.MaxInterval)
			delete(rawMsg, key)
		case "maxRetries":
...
// MarshalJSON implements the json.Marshaller interface for type DaprResiliencyTargets.
func (d DaprResiliencyTargets) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "actors", d.Actors)
	populate(objectMap, "apps", d.Apps)
	populate(objectMap, "components", d.Components)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type DaprResiliencyTargets.
func (d *DaprResiliencyTargets) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", d, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "actors":
			err = unpopulate(val, "Actors", &d.Actors)
			delete(rawMsg, key)
		case "apps":
			err = unpopulate(val, "Apps", &d.Apps)
			delete(rawMsg, key)
		case "components":
...
// MarshalJSON implements the json.Marshaller interface for type DaprResiliencyTimeoutPoliciesCollection.
func (d DaprResiliencyTimeoutPoliciesCollection) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "nextLink", d.NextLink)
	populate(objectMap, "value", d.Value)
	return json.Marshal(objectMap)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type DaprResiliencyTimeoutPoliciesCollection.
func (d *DaprResiliencyTimeoutPoliciesCollection) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", d, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type DaprResiliencyTimeoutPolicy.
func (d DaprResiliencyTimeoutPolicy) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "id", d.ID)
	populate(objectMap, "name", d.Name)
	populate(objectMap, "properties", d.Properties)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type DaprResiliencyTimeoutPolicy.
func (d *DaprResiliencyTimeoutPolicy) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", d, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type DaprResiliencyTimeoutPolicyProperties.
func (d DaprResiliencyTimeoutPolicyProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "timeout", d.Timeout)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type DaprResiliencyTimeoutPolicyProperties.
func (d *DaprResiliencyTimeoutPolicyProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", d, err)
	}
...
func (m ManagedEnvironmentProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "daprResiliencyDefaults", m.DaprResiliencyDefaults)
...
func (m *ManagedEnvironmentProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "daprConfiguration":
			...
			delete(rawMsg, key)
		case "daprResiliencyDefaults":
			err = unpopulate(val, "DaprResiliencyDefaults", &m.DaprResiliencyDefaults)
			delete(rawMsg, key)
		case "defaultDomain":
...
func (r RevisionProperties) MarshalJSON() ([]byte, error) {
	...
	populateTimeRFC3339(objectMap, "lastActiveTime", r.LastActiveTime)
...
func (r *RevisionProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "healthState":
			...
			delete(rawMsg, key)
		case "lastActiveTime":
			err = unpopulateTimeRFC3339(val, "LastActiveTime", &r.LastActiveTime)
			delete(rawMsg, key)
