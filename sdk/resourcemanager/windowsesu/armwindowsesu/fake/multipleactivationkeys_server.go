...
func (m *MultipleActivationKeysServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if multipleActivationKeysServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = multipleActivationKeysServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to MultipleActivationKeysServerTransport
var multipleActivationKeysServerTransportInterceptor interface {
