...
type Replica struct {
	...
	PromoteMode *ReplicationPromoteMode
	...
	// READ-ONLY; Gets the link state of a replica server. This property is returned only for replicas api call. Supported values
	// are Active, Catchup, Provisioning, Updating, Broken, Reconfiguring
	LinkState *ReplicaLinkState
}
