...
func (c *ClientFactory) NewUpgradeWindowClient() *UpgradeWindowClient {
	subClient, _ := NewUpgradeWindowClient(c.subscriptionID, c.credential, c.options)
	return subClient
}

func (c *ClientFactory) NewUpgradeWindowHistoryClient() *UpgradeWindowHistoryClient {
	subClient, _ := NewUpgradeWindowHistoryClient(c.subscriptionID, c.credential, c.options)
	return subClient
}

func (c *ClientFactory) NewUpgradeWindowTriggerClient() *UpgradeWindowTriggerClient {
	subClient, _ := NewUpgradeWindowTriggerClient(c.subscriptionID, c.credential, c.options)
	return subClient
}
