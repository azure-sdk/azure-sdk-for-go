...
// ScheduledActionsClientVirtualMachinesSubmitCreateResponse contains the response from method ScheduledActionsClient.VirtualMachinesSubmitCreate.
type ScheduledActionsClientVirtualMachinesSubmitCreateResponse struct {
	// The response from a create request
	CreateResourceOperationResponse
}
...
// ScheduledActionsClientVirtualMachinesSubmitDeleteResponse contains the response from method ScheduledActionsClient.VirtualMachinesSubmitDelete.
type ScheduledActionsClientVirtualMachinesSubmitDeleteResponse struct {
	// The response from a delete request
	DeleteResourceOperationResponse
}
