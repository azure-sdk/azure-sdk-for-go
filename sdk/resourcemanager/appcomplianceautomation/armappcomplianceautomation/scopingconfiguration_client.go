...
func (client *ScopingConfigurationClient) listCreateRequest(ctx context.Context, reportName string, _ *ScopingConfigurationClientListOptions) (*policy.Request, error) {
