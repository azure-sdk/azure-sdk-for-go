...
func NewInferencePoolsClient(subscriptionID string, credential azcore.TokenCredential, options *arm.ClientOptions) (*InferencePoolsClient, error) {
	cl, err := arm.NewClient(moduleName+".InferencePoolsClient", moduleVersion, credential, options)
	if err != nil {
		return nil, err
	}
...
//     method.
func (client *InferencePoolsClient) BeginCreateOrUpdate(ctx context.Context, resourceGroupName string, workspaceName string, name string, body InferencePool, options *InferencePoolsClientBeginCreateOrUpdateOptions) (*runtime.Poller[InferencePoolsClientCreateOrUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return runtime.NewPollerFromResumeToken[InferencePoolsClientCreateOrUpdateResponse](options.ResumeToken, client.internal.Pipeline(), nil)
	}
}
...
//
// Generated from API version 2023-08-01-preview
func (client *InferencePoolsClient) createOrUpdate(ctx context.Context, resourceGroupName string, workspaceName string, name string, body InferencePool, options *InferencePoolsClientBeginCreateOrUpdateOptions) (*http.Response, error) {
	var err error
...
func (client *InferencePoolsClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, name string, body InferencePool, options *InferencePoolsClientBeginCreateOrUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/inferencePools/{name}"
...
//     method.
func (client *InferencePoolsClient) BeginDelete(ctx context.Context, resourceGroupName string, workspaceName string, name string, options *InferencePoolsClientBeginDeleteOptions) (*runtime.Poller[InferencePoolsClientDeleteResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return runtime.NewPollerFromResumeToken[InferencePoolsClientDeleteResponse](options.ResumeToken, client.internal.Pipeline(), nil)
	}
}
...
//
// Generated from API version 2023-08-01-preview
func (client *InferencePoolsClient) deleteOperation(ctx context.Context, resourceGroupName string, workspaceName string, name string, options *InferencePoolsClientBeginDeleteOptions) (*http.Response, error) {
	var err error
...
func (client *InferencePoolsClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, name string, options *InferencePoolsClientBeginDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/inferencePools/{name}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *InferencePoolsClient) Get(ctx context.Context, resourceGroupName string, workspaceName string, name string, options *InferencePoolsClientGetOptions) (InferencePoolsClientGetResponse, error) {
	var err error
...
func (client *InferencePoolsClient) getCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, name string, options *InferencePoolsClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/inferencePools/{name}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
//     method.
func (client *InferencePoolsClient) GetStatus(ctx context.Context, resourceGroupName string, workspaceName string, name string, options *InferencePoolsClientGetStatusOptions) (InferencePoolsClientGetStatusResponse, error) {
	var err error
...
func (client *InferencePoolsClient) getStatusCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, name string, options *InferencePoolsClientGetStatusOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/inferencePools/{name}/status"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{subscriptionId}", url.PathEscape(client.subscriptionID))
	...
	return runtime.NewPager(runtime.PagingHandler[InferencePoolsClientListResponse]{
		...
		Fetcher: func(ctx context.Context, page *InferencePoolsClientListResponse) (InferencePoolsClientListResponse, error) {
			...
			if !runtime.HasStatusCode(resp, http.StatusOK) {
				return InferencePoolsClientListResponse{}, runtime.NewResponseError(resp)
			}
...
//     method.
func (client *InferencePoolsClient) NewListSKUsPager(resourceGroupName string, workspaceName string, name string, options *InferencePoolsClientListSKUsOptions) *runtime.Pager[InferencePoolsClientListSKUsResponse] {
	return runtime.NewPager(runtime.PagingHandler[InferencePoolsClientListSKUsResponse]{
		...
		Fetcher: func(ctx context.Context, page *InferencePoolsClientListSKUsResponse) (InferencePoolsClientListSKUsResponse, error) {
			...
			var err error
			if page == nil {
				req, err = client.listSKUsCreateRequest(ctx, resourceGroupName, workspaceName, name, options)
			} else {
				req, err = runtime.NewRequest(ctx, http.MethodGet, *page.NextLink)
			}
			if err != nil {
			...
			if !runtime.HasStatusCode(resp, http.StatusOK) {
				return InferencePoolsClientListSKUsResponse{}, runtime.NewResponseError(resp)
			}
...
func (client *InferencePoolsClient) listSKUsCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, name string, options *InferencePoolsClientListSKUsOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/inferencePools/{name}/skus"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{subscriptionId}", url.PathEscape(client.subscriptionID))
...
//     method.
func (client *InferencePoolsClient) BeginUpdate(ctx context.Context, resourceGroupName string, workspaceName string, name string, body PartialMinimalTrackedResourceWithSKUAndIdentity, options *InferencePoolsClientBeginUpdateOptions) (*runtime.Poller[InferencePoolsClientUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.update(ctx, resourceGroupName, workspaceName, name, body, options)
		if err != nil {
			return nil, err
		}
		poller, err := runtime.NewPoller[InferencePoolsClientUpdateResponse](resp, client.internal.Pipeline(), nil)
		return poller, err
	} else {
		return runtime.NewPollerFromResumeToken[InferencePoolsClientUpdateResponse](options.ResumeToken, client.internal.Pipeline(), nil)
	}
}
...
//
// Generated from API version 2023-08-01-preview
func (client *InferencePoolsClient) update(ctx context.Context, resourceGroupName string, workspaceName string, name string, body PartialMinimalTrackedResourceWithSKUAndIdentity, options *InferencePoolsClientBeginUpdateOptions) (*http.Response, error) {
	var err error
...
func (client *InferencePoolsClient) updateCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, name string, body PartialMinimalTrackedResourceWithSKUAndIdentity, options *InferencePoolsClientBeginUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/inferencePools/{name}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
