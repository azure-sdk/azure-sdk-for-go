...
func (c ConfigurationStoreProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "sasAuth", c.SasAuth)
...
func (c *ConfigurationStoreProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "publicNetworkAccess":
			...
			delete(rawMsg, key)
		case "sasAuth":
			err = unpopulate(val, "SasAuth", &c.SasAuth)
			delete(rawMsg, key)
...
// MarshalJSON implements the json.Marshaller interface for type KvResourceParameters.
func (k KvResourceParameters) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "key", k.Key)
	populate(objectMap, "label", k.Label)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type KvResourceParameters.
func (k *KvResourceParameters) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", k, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type ResetSasTokensParameters.
func (r ResetSasTokensParameters) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "kind", r.Kind)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ResetSasTokensParameters.
func (r *ResetSasTokensParameters) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", r, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type ResourceParameters.
func (r ResourceParameters) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	objectMap["resourceType"] = r.ResourceType
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ResourceParameters.
func (r *ResourceParameters) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", r, err)
	}
...
func (s SasTokenGenerationParameters) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "resourceParameters", s.ResourceParameters)
	return json.Marshal(objectMap)
}
...
func (s *SasTokenGenerationParameters) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "resourceParameters":
			s.ResourceParameters, err = unmarshalResourceParametersClassification(val)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", s, err)
...
// MarshalJSON implements the json.Marshaller interface for type SnapshotResourceParameters.
func (s SnapshotResourceParameters) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "name", s.Name)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type SnapshotResourceParameters.
func (s *SnapshotResourceParameters) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
