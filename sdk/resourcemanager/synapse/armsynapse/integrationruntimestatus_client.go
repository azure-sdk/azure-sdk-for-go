...
func (client *IntegrationRuntimeStatusClient) getCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, integrationRuntimeName string, _ *IntegrationRuntimeStatusClientGetOptions) (*policy.Request, error) {
