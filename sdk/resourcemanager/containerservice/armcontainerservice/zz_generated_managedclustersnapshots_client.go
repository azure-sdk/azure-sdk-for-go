...
// method.
func (client *ManagedClusterSnapshotsClient) List(options *ManagedClusterSnapshotsClientListOptions) *runtime.Pager[ManagedClusterSnapshotsClientListResponse] {
...
// ListByResourceGroup - Lists managed cluster snapshots in the specified subscription and resource group.
// If the operation fails it returns an *azcore.ResponseError type.
// resourceGroupName - The name of the resource group. The name is case insensitive.
...
// method.
func (client *ManagedClusterSnapshotsClient) ListByResourceGroup(resourceGroupName string, options *ManagedClusterSnapshotsClientListByResourceGroupOptions) *runtime.Pager[ManagedClusterSnapshotsClientListByResourceGroupResponse] {
