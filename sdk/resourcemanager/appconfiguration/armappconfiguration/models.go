...
// ExperimentationListResult - The result of a request to list experimentation.
...
type ExperimentationProperties struct {
	...
	// READ-ONLY; The resource ID of the managed Microsoft.OnlineExperimentation/workspaces resource.
	OnlineExperimentationWorkspaceResourceID *string

	// READ-ONLY; The provisioning state of the experimentation.
	ProvisioningState *ProvisioningState

	// READ-ONLY; The resource ID of the managed Microsoft.Storage/storageAccounts resource.
