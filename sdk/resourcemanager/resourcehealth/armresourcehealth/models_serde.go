...
func (e *EmergingIssue) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "refreshTimestamp":
			err = unpopulateTimeRFC3339(val, "RefreshTimestamp", &e.RefreshTimestamp)
			delete(rawMsg, key)
...
// MarshalJSON implements the json.Marshaller interface for type ImpactedResourceListResult.
func (i ImpactedResourceListResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
...
// UnmarshalJSON implements the json.Unmarshaller interface for type ImpactedResourceListResult.
func (i *ImpactedResourceListResult) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", i, err)
	}
...
func (i ImpactedResourceStatusProperties) MarshalJSON() ([]byte, error) {
	...
	populateTimeRFC3339(objectMap, "occuredTime", i.OccuredTime)
...
func (i *ImpactedResourceStatusProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "availabilityState":
			...
			delete(rawMsg, key)
		case "occuredTime":
			err = unpopulateTimeRFC3339(val, "OccuredTime", &i.OccuredTime)
			delete(rawMsg, key)
		case "reasonType":
