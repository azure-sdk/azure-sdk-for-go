...
```go
client, err := armapp.NewContainerAppsDiagnosticsClient(<subscription ID>, cred, nil)
```
...
client, err := armapp.NewContainerAppsDiagnosticsClient(<subscription ID>, cred, &options)
```
