...
// MachinesControllerServer is a fake server for instances of the armmigrationdiscovery.MachinesControllerClient type.
type MachinesControllerServer struct {
	// Get is the fake for method MachinesControllerClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, siteName string, machineName string, options *armmigrationdiscovery.MachinesControllerClientGetOptions) (resp azfake.Responder[armmigrationdiscovery.MachinesControllerClientGetResponse], errResp azfake.ErrorResponder)

	// NewListByVmwareSitePager is the fake for method MachinesControllerClient.NewListByVmwareSitePager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByVmwareSitePager func(resourceGroupName string, siteName string, options *armmigrationdiscovery.MachinesControllerClientListByVmwareSiteOptions) (resp azfake.PagerResponder[armmigrationdiscovery.MachinesControllerClientListByVmwareSiteResponse])

	// BeginStart is the fake for method MachinesControllerClient.BeginStart
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginStart func(ctx context.Context, resourceGroupName string, siteName string, machineName string, options *armmigrationdiscovery.MachinesControllerClientBeginStartOptions) (resp azfake.PollerResponder[armmigrationdiscovery.MachinesControllerClientStartResponse], errResp azfake.ErrorResponder)

	// BeginStop is the fake for method MachinesControllerClient.BeginStop
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginStop func(ctx context.Context, resourceGroupName string, siteName string, machineName string, options *armmigrationdiscovery.MachinesControllerClientBeginStopOptions) (resp azfake.PollerResponder[armmigrationdiscovery.MachinesControllerClientStopResponse], errResp azfake.ErrorResponder)

	// Update is the fake for method MachinesControllerClient.Update
	// HTTP status codes to indicate success: http.StatusOK
	Update func(ctx context.Context, resourceGroupName string, siteName string, machineName string, body armmigrationdiscovery.MachineResourceUpdate, options *armmigrationdiscovery.MachinesControllerClientUpdateOptions) (resp azfake.Responder[armmigrationdiscovery.MachinesControllerClientUpdateResponse], errResp azfake.ErrorResponder)
}
...
// The returned MachinesControllerServerTransport instance is connected to an instance of armmigrationdiscovery.MachinesControllerClient via the
...
func NewMachinesControllerServerTransport(srv *MachinesControllerServer) *MachinesControllerServerTransport {
	return &MachinesControllerServerTransport{
		srv:                      srv,
		newListByVmwareSitePager: newTracker[azfake.PagerResponder[armmigrationdiscovery.MachinesControllerClientListByVmwareSiteResponse]](),
		beginStart:               newTracker[azfake.PollerResponder[armmigrationdiscovery.MachinesControllerClientStartResponse]](),
		beginStop:                newTracker[azfake.PollerResponder[armmigrationdiscovery.MachinesControllerClientStopResponse]](),
	}
}

// MachinesControllerServerTransport connects instances of armmigrationdiscovery.MachinesControllerClient to instances of MachinesControllerServer.
...
type MachinesControllerServerTransport struct {
	...
	newListByVmwareSitePager *tracker[azfake.PagerResponder[armmigrationdiscovery.MachinesControllerClientListByVmwareSiteResponse]]
	beginStart               *tracker[azfake.PollerResponder[armmigrationdiscovery.MachinesControllerClientStartResponse]]
	beginStop                *tracker[azfake.PollerResponder[armmigrationdiscovery.MachinesControllerClientStopResponse]]
}
...
func (m *MachinesControllerServerTransport) dispatchNewListByVmwareSitePager(req *http.Request) (*http.Response, error) {
	...
	if newListByVmwareSitePager == nil {
		...
		var options *armmigrationdiscovery.MachinesControllerClientListByVmwareSiteOptions
		if filterParam != nil || topParam != nil || continuationTokenParam != nil || totalRecordCountParam != nil {
			options = &armmigrationdiscovery.MachinesControllerClientListByVmwareSiteOptions{
				Filter:            filterParam,
				Top:               topParam,
		...
		server.PagerResponderInjectNextLinks(newListByVmwareSitePager, req, func(page *armmigrationdiscovery.MachinesControllerClientListByVmwareSiteResponse, createLink func() string) {
...
func (m *MachinesControllerServerTransport) dispatchUpdate(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[armmigrationdiscovery.MachineResourceUpdate](req)
	if err != nil {
		return nil, err
	}
	resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
