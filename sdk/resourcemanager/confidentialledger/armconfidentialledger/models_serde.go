...
func (l LedgerProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "certificateClientEndpoint", l.CertificateClientEndpoint)
...
func (l *LedgerProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "certBasedSecurityPrincipals":
			...
			delete(rawMsg, key)
		case "certificateClientEndpoint":
			err = unpopulate(val, "CertificateClientEndpoint", &l.CertificateClientEndpoint)
			delete(rawMsg, key)
