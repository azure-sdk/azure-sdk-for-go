...
// HypervSitesControllerServer is a fake server for instances of the armmigrationdiscovery.HypervSitesControllerClient type.
type HypervSitesControllerServer struct {
	...
	ComputeErrorSummary func(ctx context.Context, resourceGroupName string, siteName string, body any, options *armmigrationdiscovery.HypervSitesControllerClientComputeErrorSummaryOptions) (resp azfake.Responder[armmigrationdiscovery.HypervSitesControllerClientComputeErrorSummaryResponse], errResp azfake.ErrorResponder)

	// Computeusage is the fake for method HypervSitesControllerClient.Computeusage
	// HTTP status codes to indicate success: http.StatusOK
	Computeusage func(ctx context.Context, resourceGroupName string, siteName string, body any, options *armmigrationdiscovery.HypervSitesControllerClientComputeusageOptions) (resp azfake.Responder[armmigrationdiscovery.HypervSitesControllerClientComputeusageResponse], errResp azfake.ErrorResponder)

	// Create is the fake for method HypervSitesControllerClient.Create
	// HTTP status codes to indicate success: http.StatusOK, http.StatusCreated
	Create func(ctx context.Context, resourceGroupName string, siteName string, body armmigrationdiscovery.HypervSite, options *armmigrationdiscovery.HypervSitesControllerClientCreateOptions) (resp azfake.Responder[armmigrationdiscovery.HypervSitesControllerClientCreateResponse], errResp azfake.ErrorResponder)

	// Delete is the fake for method HypervSitesControllerClient.Delete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	Delete func(ctx context.Context, resourceGroupName string, siteName string, options *armmigrationdiscovery.HypervSitesControllerClientDeleteOptions) (resp azfake.Responder[armmigrationdiscovery.HypervSitesControllerClientDeleteResponse], errResp azfake.ErrorResponder)

	// BeginExportApplications is the fake for method HypervSitesControllerClient.BeginExportApplications
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginExportApplications func(ctx context.Context, resourceGroupName string, siteName string, body any, options *armmigrationdiscovery.HypervSitesControllerClientBeginExportApplicationsOptions) (resp azfake.PollerResponder[armmigrationdiscovery.HypervSitesControllerClientExportApplicationsResponse], errResp azfake.ErrorResponder)

	// BeginExportMachineErrors is the fake for method HypervSitesControllerClient.BeginExportMachineErrors
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginExportMachineErrors func(ctx context.Context, resourceGroupName string, siteName string, body armmigrationdiscovery.ExportMachineErrorsRequest, options *armmigrationdiscovery.HypervSitesControllerClientBeginExportMachineErrorsOptions) (resp azfake.PollerResponder[armmigrationdiscovery.HypervSitesControllerClientExportMachineErrorsResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method HypervSitesControllerClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, siteName string, options *armmigrationdiscovery.HypervSitesControllerClientGetOptions) (resp azfake.Responder[armmigrationdiscovery.HypervSitesControllerClientGetResponse], errResp azfake.ErrorResponder)

	// ListHealthSummary is the fake for method HypervSitesControllerClient.ListHealthSummary
	// HTTP status codes to indicate success: http.StatusOK
	ListHealthSummary func(ctx context.Context, resourceGroupName string, siteName string, options *armmigrationdiscovery.HypervSitesControllerClientListHealthSummaryOptions) (resp azfake.Responder[armmigrationdiscovery.HypervSitesControllerClientListHealthSummaryResponse], errResp azfake.ErrorResponder)

	// Summary is the fake for method HypervSitesControllerClient.Summary
	// HTTP status codes to indicate success: http.StatusOK
	Summary func(ctx context.Context, resourceGroupName string, siteName string, options *armmigrationdiscovery.HypervSitesControllerClientSummaryOptions) (resp azfake.Responder[armmigrationdiscovery.HypervSitesControllerClientSummaryResponse], errResp azfake.ErrorResponder)

	// Update is the fake for method HypervSitesControllerClient.Update
	// HTTP status codes to indicate success: http.StatusOK
	Update func(ctx context.Context, resourceGroupName string, siteName string, body armmigrationdiscovery.HypervSiteUpdate, options *armmigrationdiscovery.HypervSitesControllerClientUpdateOptions) (resp azfake.Responder[armmigrationdiscovery.HypervSitesControllerClientUpdateResponse], errResp azfake.ErrorResponder)
}
...
// The returned HypervSitesControllerServerTransport instance is connected to an instance of armmigrationdiscovery.HypervSitesControllerClient via the
...
func NewHypervSitesControllerServerTransport(srv *HypervSitesControllerServer) *HypervSitesControllerServerTransport {
	return &HypervSitesControllerServerTransport{
		srv:                      srv,
		beginExportApplications:  newTracker[azfake.PollerResponder[armmigrationdiscovery.HypervSitesControllerClientExportApplicationsResponse]](),
		beginExportMachineErrors: newTracker[azfake.PollerResponder[armmigrationdiscovery.HypervSitesControllerClientExportMachineErrorsResponse]](),
	}
}

// HypervSitesControllerServerTransport connects instances of armmigrationdiscovery.HypervSitesControllerClient to instances of HypervSitesControllerServer.
...
type HypervSitesControllerServerTransport struct {
	...
	beginExportApplications  *tracker[azfake.PollerResponder[armmigrationdiscovery.HypervSitesControllerClientExportApplicationsResponse]]
	beginExportMachineErrors *tracker[azfake.PollerResponder[armmigrationdiscovery.HypervSitesControllerClientExportMachineErrorsResponse]]
}
...
func (h *HypervSitesControllerServerTransport) dispatchCreate(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[armmigrationdiscovery.HypervSite](req)
	if err != nil {
		return nil, err
	}
	resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
...
func (h *HypervSitesControllerServerTransport) dispatchUpdate(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[armmigrationdiscovery.HypervSiteUpdate](req)
	if err != nil {
		return nil, err
	}
	resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
