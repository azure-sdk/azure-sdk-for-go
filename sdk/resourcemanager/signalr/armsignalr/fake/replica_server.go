...
// ReplicaServer is a fake server for instances of the armsignalr.ReplicaClient type.
type ReplicaServer struct {
	...
	SharedPrivateLinkResourcesGet func(ctx context.Context, resourceGroupName string, resourceName string, replicaName string, sharedPrivateLinkResourceName string, options *armsignalr.ReplicaClientSharedPrivateLinkResourcesGetOptions) (resp azfake.Responder[armsignalr.ReplicaClientSharedPrivateLinkResourcesGetResponse], errResp azfake.ErrorResponder)

	// NewSharedPrivateLinkResourcesListPager is the fake for method ReplicaClient.NewSharedPrivateLinkResourcesListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewSharedPrivateLinkResourcesListPager func(resourceGroupName string, resourceName string, replicaName string, options *armsignalr.ReplicaClientSharedPrivateLinkResourcesListOptions) (resp azfake.PagerResponder[armsignalr.ReplicaClientSharedPrivateLinkResourcesListResponse])
}

// NewReplicaServerTransport creates a new instance of ReplicaServerTransport with the provided implementation.
// The returned ReplicaServerTransport instance is connected to an instance of armsignalr.ReplicaClient via the
// azcore.ClientOptions.Transporter field in the client's constructor parameters.
func NewReplicaServerTransport(srv *ReplicaServer) *ReplicaServerTransport {
	return &ReplicaServerTransport{
		srv: srv,
		beginSharedPrivateLinkResourcesCreateOrUpdate: newTracker[azfake.PollerResponder[armsignalr.ReplicaClientSharedPrivateLinkResourcesCreateOrUpdateResponse]](),
		newSharedPrivateLinkResourcesListPager:        newTracker[azfake.PagerResponder[armsignalr.ReplicaClientSharedPrivateLinkResourcesListResponse]](),
	}
}

// ReplicaServerTransport connects instances of armsignalr.ReplicaClient to instances of ReplicaServer.
// Don't use this type directly, use NewReplicaServerTransport instead.
type ReplicaServerTransport struct {
	srv                                           *ReplicaServer
	beginSharedPrivateLinkResourcesCreateOrUpdate *tracker[azfake.PollerResponder[armsignalr.ReplicaClientSharedPrivateLinkResourcesCreateOrUpdateResponse]]
	newSharedPrivateLinkResourcesListPager        *tracker[azfake.PagerResponder[armsignalr.ReplicaClientSharedPrivateLinkResourcesListResponse]]
}
...
func (r *ReplicaServerTransport) dispatchNewSharedPrivateLinkResourcesListPager(req *http.Request) (*http.Response, error) {
	...
	if newSharedPrivateLinkResourcesListPager == nil {
		...
		server.PagerResponderInjectNextLinks(newSharedPrivateLinkResourcesListPager, req, func(page *armsignalr.ReplicaClientSharedPrivateLinkResourcesListResponse, createLink func() string) {
