...
type JobsClientStopExecutionResponse struct {
	// Stop Job Execution Response
	Value *string
}

// UnmarshalJSON implements the json.Unmarshaller interface for type JobsClientStopExecutionResponse.
func (j *JobsClientStopExecutionResponse) UnmarshalJSON(data []byte) error {
