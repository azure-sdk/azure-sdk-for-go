...
func (w *WorkspaceManagedSQLServerDedicatedSQLMinimalTLSSettingsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if workspaceManagedSqlServerDedicatedSqlminimalTlssettingsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = workspaceManagedSqlServerDedicatedSqlminimalTlssettingsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to WorkspaceManagedSQLServerDedicatedSQLMinimalTLSSettingsServerTransport
var workspaceManagedSqlServerDedicatedSqlminimalTlssettingsServerTransportInterceptor interface {
