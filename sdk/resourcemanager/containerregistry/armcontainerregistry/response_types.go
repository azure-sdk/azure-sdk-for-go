...
// CacheRulesClientGetAsyncResponse contains the response from method CacheRulesClient.GetAsync.
type CacheRulesClientGetAsyncResponse struct {
	CacheRule
}

// CacheRulesClientListAsyncResponse contains the response from method CacheRulesClient.ListAsync.
type CacheRulesClientListAsyncResponse struct {
