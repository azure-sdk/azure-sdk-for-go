...
func (t *TransformationsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if transformationsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = transformationsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			case "TransformationsClient.CreateOrReplace":
				res.resp, res.err = t.dispatchCreateOrReplace(req)
...
// set this to conditionally intercept incoming requests to TransformationsServerTransport
var transformationsServerTransportInterceptor interface {
