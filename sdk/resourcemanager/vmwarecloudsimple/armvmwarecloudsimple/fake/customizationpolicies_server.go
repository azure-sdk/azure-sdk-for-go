...
func (c *CustomizationPoliciesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if customizationPoliciesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = customizationPoliciesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to CustomizationPoliciesServerTransport
var customizationPoliciesServerTransportInterceptor interface {
