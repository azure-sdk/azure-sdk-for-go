...
type AzureDevOpsOrganizationProfile struct {
	...
	PermissionProfile AzureDevOpsPermissionProfileClassification
}
...
type AzureDevOpsPermissionProfile struct {
	// REQUIRED; Discriminator property for AzureDevOpsPermissionProfile.
	Kind *string
}

// GetAzureDevOpsPermissionProfile implements the AzureDevOpsPermissionProfileClassification interface for type AzureDevOpsPermissionProfile.
func (a *AzureDevOpsPermissionProfile) GetAzureDevOpsPermissionProfile() *AzureDevOpsPermissionProfile {
	return a
}
...
// GetAzureDevOpsPermissionProfile implements the AzureDevOpsPermissionProfileClassification interface for type CreatorOnly.
func (c *CreatorOnly) GetAzureDevOpsPermissionProfile() *AzureDevOpsPermissionProfile {
...
// InheritPermissions - Pool will inherit permissions from the project or organization.
type InheritPermissions struct {
	// REQUIRED; Discriminator property for AzureDevOpsPermissionProfile.
	Kind *string
}

// GetAzureDevOpsPermissionProfile implements the AzureDevOpsPermissionProfileClassification interface for type InheritPermissions.
func (i *InheritPermissions) GetAzureDevOpsPermissionProfile() *AzureDevOpsPermissionProfile {
	return &AzureDevOpsPermissionProfile{
		Kind: i.Kind,
	}
}
...
type Interactive struct {
	// REQUIRED; Discriminator property for LogonType.
	Kind *string
}

// GetLogonType implements the LogonTypeClassification interface for type Interactive.
func (i *Interactive) GetLogonType() *LogonType {
	return &LogonType{
		Kind: i.Kind,
	}
}
...
// GetLogonType implements the LogonTypeClassification interface for type LogonType.
func (l *LogonType) GetLogonType() *LogonType { return l }
...
type OsProfile struct {
	...
	LogonType LogonTypeClassification
}
...
// GetLogonType implements the LogonTypeClassification interface for type Service.
func (s *Service) GetLogonType() *LogonType {
	return &LogonType{
		Kind: s.Kind,
	}
}
...
// GetAzureDevOpsPermissionProfile implements the AzureDevOpsPermissionProfileClassification interface for type SpecificAccounts.
func (s *SpecificAccounts) GetAzureDevOpsPermissionProfile() *AzureDevOpsPermissionProfile {
	return &AzureDevOpsPermissionProfile{
		Kind: s.Kind,
	}
}
