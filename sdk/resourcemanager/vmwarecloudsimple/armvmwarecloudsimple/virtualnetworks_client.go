...
func (client *VirtualNetworksClient) getCreateRequest(ctx context.Context, regionID string, pcName string, virtualNetworkName string, _ *VirtualNetworksClientGetOptions) (*policy.Request, error) {
...
func (client *VirtualNetworksClient) listCreateRequest(ctx context.Context, regionID string, pcName string, resourcePoolName string, _ *VirtualNetworksClientListOptions) (*policy.Request, error) {
