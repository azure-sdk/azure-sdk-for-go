...
func (s *ServiceFabricSchedulesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if serviceFabricSchedulesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = serviceFabricSchedulesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to ServiceFabricSchedulesServerTransport
var serviceFabricSchedulesServerTransportInterceptor interface {
