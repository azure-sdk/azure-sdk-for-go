...
func (client *ServiceClient) BeginApplyNetworkConfigurationUpdates(ctx context.Context, resourceGroupName string, serviceName string, options *ServiceClientBeginApplyNetworkConfigurationUpdatesOptions) (*runtime.Poller[ServiceClientApplyNetworkConfigurationUpdatesResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return runtime.NewPoller[ServiceClientApplyNetworkConfigurationUpdatesResponse](resp, client.pl, nil)
	} else {
...
func (client *ServiceClient) BeginBackup(ctx context.Context, resourceGroupName string, serviceName string, parameters ServiceBackupRestoreParameters, options *ServiceClientBeginBackupOptions) (*runtime.Poller[ServiceClientBackupResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return runtime.NewPoller[ServiceClientBackupResponse](resp, client.pl, nil)
	} else {
...
// resourceGroupName - The name of the resource group.
// serviceName - The name of the API Management service.
// options - ServiceClientDeleteOptions contains the optional parameters for the ServiceClient.Delete method.
func (client *ServiceClient) Delete(ctx context.Context, resourceGroupName string, serviceName string, options *ServiceClientDeleteOptions) (ServiceClientDeleteResponse, error) {
	...
	if !runtime.HasStatusCode(resp, http.StatusOK, http.StatusNoContent) {
		return ServiceClientDeleteResponse{}, runtime.NewResponseError(resp)
	}
	return ServiceClientDeleteResponse{}, nil
}

// deleteCreateRequest creates the Delete request.
func (client *ServiceClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, options *ServiceClientDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}"
	if resourceGroupName == "" {
		return nil, errors.New("parameter resourceGroupName cannot be empty")
	}
...
func (client *ServiceClient) BeginRestore(ctx context.Context, resourceGroupName string, serviceName string, parameters ServiceBackupRestoreParameters, options *ServiceClientBeginRestoreOptions) (*runtime.Poller[ServiceClientRestoreResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return runtime.NewPoller[ServiceClientRestoreResponse](resp, client.pl, nil)
	} else {
...
// BeginUpdateHostname - Creates, updates, or deletes the custom hostnames for an API Management service. The custom hostname
// can be applied to the Proxy and Portal endpoint. This is a long running operation and could take
// several minutes to complete. This operation will be deprecated in the next version update.
// If the operation fails it returns an *azcore.ResponseError type.
// Generated from API version 2022-01-09
// resourceGroupName - The name of the resource group.
// serviceName - The name of the API Management service.
// parameters - Parameters supplied to the UpdateHostname operation.
// options - ServiceClientBeginUpdateHostnameOptions contains the optional parameters for the ServiceClient.BeginUpdateHostname
// method.
func (client *ServiceClient) BeginUpdateHostname(ctx context.Context, resourceGroupName string, serviceName string, parameters ServiceUpdateHostnameParameters, options *ServiceClientBeginUpdateHostnameOptions) (*runtime.Poller[ServiceClientUpdateHostnameResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.updateHostname(ctx, resourceGroupName, serviceName, parameters, options)
		if err != nil {
			return nil, err
		}
		return runtime.NewPoller[ServiceClientUpdateHostnameResponse](resp, client.pl, nil)
	} else {
		return runtime.NewPollerFromResumeToken[ServiceClientUpdateHostnameResponse](options.ResumeToken, client.pl, nil)
	}
}

// UpdateHostname - Creates, updates, or deletes the custom hostnames for an API Management service. The custom hostname can
// be applied to the Proxy and Portal endpoint. This is a long running operation and could take
// several minutes to complete. This operation will be deprecated in the next version update.
// If the operation fails it returns an *azcore.ResponseError type.
// Generated from API version 2022-01-09
func (client *ServiceClient) updateHostname(ctx context.Context, resourceGroupName string, serviceName string, parameters ServiceUpdateHostnameParameters, options *ServiceClientBeginUpdateHostnameOptions) (*http.Response, error) {
	req, err := client.updateHostnameCreateRequest(ctx, resourceGroupName, serviceName, parameters, options)
	if err != nil {
		return nil, err
	}
	resp, err := client.pl.Do(req)
...
// updateHostnameCreateRequest creates the UpdateHostname request.
func (client *ServiceClient) updateHostnameCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, parameters ServiceUpdateHostnameParameters, options *ServiceClientBeginUpdateHostnameOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/updatehostname"
	if resourceGroupName == "" {
		return nil, errors.New("parameter resourceGroupName cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{resourceGroupName}", url.PathEscape(resourceGroupName))
...
// UploadCertificate - Upload Custom Domain SSL certificate for an API Management service. This operation will be deprecated
// in future releases.
// If the operation fails it returns an *azcore.ResponseError type.
// Generated from API version 2022-01-09
// resourceGroupName - The name of the resource group.
...
// options - ServiceClientUploadCertificateOptions contains the optional parameters for the ServiceClient.UploadCertificate
// method.
func (client *ServiceClient) UploadCertificate(ctx context.Context, resourceGroupName string, serviceName string, parameters ServiceUploadCertificateParameters, options *ServiceClientUploadCertificateOptions) (ServiceClientUploadCertificateResponse, error) {
	req, err := client.uploadCertificateCreateRequest(ctx, resourceGroupName, serviceName, parameters, options)
	if err != nil {
		return ServiceClientUploadCertificateResponse{}, err
	}
	resp, err := client.pl.Do(req)
	if err != nil {
		return ServiceClientUploadCertificateResponse{}, err
	...
	if !runtime.HasStatusCode(resp, http.StatusOK) {
		return ServiceClientUploadCertificateResponse{}, runtime.NewResponseError(resp)
	}
	return client.uploadCertificateHandleResponse(resp)
}

// uploadCertificateCreateRequest creates the UploadCertificate request.
func (client *ServiceClient) uploadCertificateCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, parameters ServiceUploadCertificateParameters, options *ServiceClientUploadCertificateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/uploadcertificate"
	if resourceGroupName == "" {
		return nil, errors.New("parameter resourceGroupName cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{resourceGroupName}", url.PathEscape(resourceGroupName))
...
func (client *ServiceClient) uploadCertificateHandleResponse(resp *http.Response) (ServiceClientUploadCertificateResponse, error) {
	result := ServiceClientUploadCertificateResponse{}
	if err := runtime.UnmarshalAsJSON(resp, &result.CertificateInformation); err != nil {
		return ServiceClientUploadCertificateResponse{}, err
	}
	return result, nil
}
