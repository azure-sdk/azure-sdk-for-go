...
// DbSystemShapesClient contains the methods for the Oracle.Database namespace.
...
func (client *DbSystemShapesClient) listByLocationCreateRequest(ctx context.Context, location string, _ *DbSystemShapesClientListByLocationOptions) (*policy.Request, error) {
