...
- Type of `RebootNodeOptions.Parameters` has been changed from `*RebootNodeContent` to `*RebootNodeKinds`
...
- Field `ClientRequestID`, `OCPDate`, `ReturnClientRequestID`, `Timeout` of struct `CreateJobOptions` has been removed
- Field `ClientRequestID`, `OCPDate`, `ReturnClientRequestID`, `Timeout` of struct `CreateJobScheduleOptions` has been removed
- Field `ClientRequestID`, `OCPDate`, `ReturnClientRequestID`, `Timeout` of struct `CreateNodeUserOptions` has been removed
- Field `ClientRequestID`, `OCPDate`, `ReturnClientRequestID`, `Timeout` of struct `CreatePoolOptions` has been removed
...
- Field `ClientRequestID`, `OCPDate`, `ReturnClientRequestID`, `Timeout` of struct `CreateTaskOptions` has been removed
- Field `ClientRequestID`, `OCPDate`, `Parameters`, `ReturnClientRequestID`, `Timeout` of struct `DeallocateNodeOptions` has been removed
...
- Field `ClientRequestID`, `IfMatch`, `IfModifiedSince`, `IfNoneMatch`, `IfUnmodifiedSince`, `OCPDate`, `ReturnClientRequestID`, `Timeout` of struct `DisableJobOptions` has been removed
- Field `OCPDate` of struct `DisableJobScheduleOptions` has been removed
- Field `ClientRequestID`, `OCPDate`, `Parameters`, `ReturnClientRequestID`, `Timeout` of struct `DisableNodeSchedulingOptions` has been removed
...
- Field `ClientRequestID`, `IfMatch`, `IfModifiedSince`, `IfNoneMatch`, `IfUnmodifiedSince`, `OCPDate`, `ReturnClientRequestID`, `Timeout` of struct `EnablePoolAutoScaleOptions` has been removed
- Field `ClientRequestID`, `OCPDate`, `ReturnClientRequestID`, `Timeout` of struct `EvaluatePoolAutoScaleOptions` has been removed
...
- Field `ClientRequestID`, `OCPDate`, `Parameters`, `ReturnClientRequestID`, `Timeout` of struct `ReimageNodeOptions` has been removed
...
- Field `ClientRequestID`, `IfMatch`, `IfModifiedSince`, `IfNoneMatch`, `IfUnmodifiedSince`, `OCPDate`, `ReturnClientRequestID`, `Timeout` of struct `ResizePoolOptions` has been removed
...
- Field `ClientRequestID`, `Force`, `IfMatch`, `IfModifiedSince`, `IfNoneMatch`, `IfUnmodifiedSince`, `OCPDate`, `Parameters`, `ReturnClientRequestID`, `Timeout` of struct `TerminateJobOptions` has been removed
...
- Field `ClientRequestID`, `IfMatch`, `IfModifiedSince`, `IfNoneMatch`, `IfUnmodifiedSince`, `OCPDate`, `ReturnClientRequestID`, `Timeout` of struct `UpdateJobOptions` has been removed
- Field `ClientRequestID`, `IfMatch`, `IfModifiedSince`, `IfNoneMatch`, `IfUnmodifiedSince`, `OCPDate`, `ReturnClientRequestID`, `Timeout` of struct `UpdateJobScheduleOptions` has been removed
- Field `ClientRequestID`, `IfMatch`, `IfModifiedSince`, `IfNoneMatch`, `IfUnmodifiedSince`, `OCPDate`, `ReturnClientRequestID`, `Timeout` of struct `UpdatePoolOptions` has been removed
- Field `ClientRequestID`, `OCPDate`, `ReturnClientRequestID`, `Timeout` of struct `UploadNodeLogsOptions` has been removed
...
- New field `AllTasksCompleteMode`, `AllowTaskPreemption`, `CommonEnvironmentSettings`, `Constraints`, `DisplayName`, `ID`, `JobManagerTask`, `JobPreparationTask`, `JobReleaseTask`, `MaxParallelTasks`, `Metadata`, `NetworkConfiguration`, `PoolInfo`, `Priority`, `TaskFailureMode`, `UsesTaskDependencies` in struct `CreateJobOptions`
- New field `DisplayName`, `ID`, `JobSpecification`, `Metadata`, `Schedule` in struct `CreateJobScheduleOptions`
- New field `ExpiryTime`, `IsAdmin`, `Name`, `Password`, `SSHPublicKey` in struct `CreateNodeUserOptions`
- New field `ApplicationPackageReferences`, `AutoScaleEvaluationInterval`, `AutoScaleFormula`, `CertificateReferences`, `DisplayName`, `EnableAutoScale`, `EnableInterNodeCommunication`, `ID`, `Metadata`, `MountConfiguration`, `NetworkConfiguration`, `ResizeTimeout`, `ResourceTags`, `StartTask`, `TargetDedicatedNodes`, `TargetLowPriorityNodes`, `TargetNodeCommunicationMode`, `TaskSchedulingPolicy`, `TaskSlotsPerNode`, `UpgradePolicy`, `UserAccounts`, `VMSize`, `VirtualMachineConfiguration` in struct `CreatePoolOptions`
...
- New field `AffinityInfo`, `ApplicationPackageReferences`, `AuthenticationTokenSettings`, `CommandLine`, `Constraints`, `ContainerSettings`, `DependsOn`, `DisplayName`, `EnvironmentSettings`, `ExitConditions`, `ID`, `MultiInstanceSettings`, `OutputFiles`, `RequiredSlots`, `ResourceFiles`, `UserIdentity` in struct `CreateTaskOptions`
- New field `NodeDeallocateOption` in struct `DeallocateNodeOptions`
...
- New field `DisableTasks` in struct `DisableJobOptions`
- New field `Ocpdate` in struct `DisableJobScheduleOptions`
- New field `NodeDisableSchedulingOption` in struct `DisableNodeSchedulingOptions`
...
- New field `AutoScaleEvaluationInterval`, `AutoScaleFormula` in struct `EnablePoolAutoScaleOptions`
- New field `AutoScaleFormula` in struct `EvaluatePoolAutoScaleOptions`
...
- New field `NodeReimageOption` in struct `ReimageNodeOptions`
...
- New field `NodeDeallocationOption`, `ResizeTimeout`, `TargetDedicatedNodes`, `TargetLowPriorityNodes` in struct `ResizePoolOptions`
...
- New field `TerminationReason` in struct `TerminateJobOptions`
- New field `Ocpdate` in struct `TerminateJobScheduleOptions`
- New field `Ocpdate` in struct `TerminateTaskOptions`
- New field `AllTasksCompleteMode`, `AllowTaskPreemption`, `Constraints`, `MaxParallelTasks`, `Metadata`, `NetworkConfiguration`, `PoolInfo`, `Priority` in struct `UpdateJobOptions`
- New field `JobSpecification`, `Metadata`, `Schedule` in struct `UpdateJobScheduleOptions`
- New field `ApplicationPackageReferences`, `CertificateReferences`, `DisplayName`, `EnableInterNodeCommunication`, `Metadata`, `MountConfiguration`, `NetworkConfiguration`, `ResourceTags`, `StartTask`, `TargetNodeCommunicationMode`, `TaskSchedulingPolicy`, `TaskSlotsPerNode`, `UpgradePolicy`, `UserAccounts`, `VMSize`, `VirtualMachineConfiguration` in struct `UpdatePoolOptions`
- New field `ContainerURL`, `EndTime`, `IdentityReference`, `StartTime` in struct `UploadNodeLogsOptions`
