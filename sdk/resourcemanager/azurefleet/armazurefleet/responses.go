...
// VirtualMachineScaleSetsClientListByFleetResponse contains the response from method VirtualMachineScaleSetsClient.NewListByFleetPager.
type VirtualMachineScaleSetsClientListByFleetResponse struct {
