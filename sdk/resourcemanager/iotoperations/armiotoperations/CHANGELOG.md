...
- New enum type `DataflowEnpointHostType` with values `DataflowEnpointHostTypeCustomKafka`, `DataflowEnpointHostTypeCustomMq`, `DataflowEnpointHostTypeEventGrid`, `DataflowEnpointHostTypeEventhub`, `DataflowEnpointHostTypeFabricRT`, `DataflowEnpointHostTypeLocalMq`
...
- New enum type `DiagnosticsRemoteSupportActivationState` with values `DiagnosticsRemoteSupportActivationStateDisabled`, `DiagnosticsRemoteSupportActivationStateEnabled`
...
- New function `*DiagnosticClient.NewListByInstanceResourcePager(string, string, *DiagnosticClientListByInstanceResourceOptions) *runtime.Pager[DiagnosticClientListByInstanceResourceResponse]`
