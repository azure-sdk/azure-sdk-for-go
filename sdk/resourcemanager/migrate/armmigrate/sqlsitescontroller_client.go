...
// TriggerImportInventory - Method to trigger the import SQL inventory.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2024-12-01-preview
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
...
//   - sqlSiteName - SQL site name.
//   - body - The content of the action request
//   - options - SQLSitesControllerClientTriggerImportInventoryOptions contains the optional parameters for the SQLSitesControllerClient.TriggerImportInventory
//     method.
func (client *SQLSitesControllerClient) TriggerImportInventory(ctx context.Context, resourceGroupName string, siteName string, sqlSiteName string, body SQLInventoryImportBody, options *SQLSitesControllerClientTriggerImportInventoryOptions) (SQLSitesControllerClientTriggerImportInventoryResponse, error) {
	var err error
	const operationName = "SQLSitesControllerClient.TriggerImportInventory"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.triggerImportInventoryCreateRequest(ctx, resourceGroupName, siteName, sqlSiteName, body, options)
	if err != nil {
		return SQLSitesControllerClientTriggerImportInventoryResponse{}, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
	if err != nil {
		return SQLSitesControllerClientTriggerImportInventoryResponse{}, err
	...
	resp, err := client.triggerImportInventoryHandleResponse(httpResp)
	return resp, err
}

// triggerImportInventoryCreateRequest creates the TriggerImportInventory request.
func (client *SQLSitesControllerClient) triggerImportInventoryCreateRequest(ctx context.Context, resourceGroupName string, siteName string, sqlSiteName string, body SQLInventoryImportBody, options *SQLSitesControllerClientTriggerImportInventoryOptions) (*policy.Request, error) {
...
// triggerImportInventoryHandleResponse handles the TriggerImportInventory response.
func (client *SQLSitesControllerClient) triggerImportInventoryHandleResponse(resp *http.Response) (SQLSitesControllerClientTriggerImportInventoryResponse, error) {
	result := SQLSitesControllerClientTriggerImportInventoryResponse{}
	if err := runtime.UnmarshalAsJSON(resp, &result.SQLInventoryImportBody); err != nil {
		return SQLSitesControllerClientTriggerImportInventoryResponse{}, err
	}
	return result, nil
...
// ValidateAndImportInventory - Method to validate the SQL inventory before triggering the import process.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2024-12-01-preview
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
