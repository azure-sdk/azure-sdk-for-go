...
func (i *InvoicesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if invoicesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = invoicesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			case "InvoicesClient.BeginAmend":
				res.resp, res.err = i.dispatchBeginAmend(req)
			case "InvoicesClient.BeginDownloadByBillingAccount":
				res.resp, res.err = i.dispatchBeginDownloadByBillingAccount(req)
			case "InvoicesClient.BeginDownloadByBillingSubscription":
				res.resp, res.err = i.dispatchBeginDownloadByBillingSubscription(req)
			case "InvoicesClient.BeginDownloadDocumentsByBillingAccount":
				res.resp, res.err = i.dispatchBeginDownloadDocumentsByBillingAccount(req)
			case "InvoicesClient.BeginDownloadDocumentsByBillingSubscription":
				res.resp, res.err = i.dispatchBeginDownloadDocumentsByBillingSubscription(req)
			case "InvoicesClient.BeginDownloadSummaryByBillingAccount":
				res.resp, res.err = i.dispatchBeginDownloadSummaryByBillingAccount(req)
			case "InvoicesClient.Get":
				res.resp, res.err = i.dispatchGet(req)
			case "InvoicesClient.GetByBillingAccount":
				res.resp, res.err = i.dispatchGetByBillingAccount(req)
			case "InvoicesClient.GetByBillingSubscription":
				res.resp, res.err = i.dispatchGetByBillingSubscription(req)
			case "InvoicesClient.NewListByBillingAccountPager":
				res.resp, res.err = i.dispatchNewListByBillingAccountPager(req)
			case "InvoicesClient.NewListByBillingProfilePager":
				res.resp, res.err = i.dispatchNewListByBillingProfilePager(req)
			case "InvoicesClient.NewListByBillingSubscriptionPager":
				res.resp, res.err = i.dispatchNewListByBillingSubscriptionPager(req)
			default:
...
// set this to conditionally intercept incoming requests to InvoicesServerTransport
var invoicesServerTransportInterceptor interface {
