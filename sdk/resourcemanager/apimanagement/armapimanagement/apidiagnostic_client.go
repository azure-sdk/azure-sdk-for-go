...
// apiID - API identifier. Must be unique in the current API Management service instance.
// diagnosticID - Diagnostic identifier. Must be unique in the current API Management service instance.
// options - APIDiagnosticClientHeadOptions contains the optional parameters for the APIDiagnosticClient.Head method.
func (client *APIDiagnosticClient) Head(ctx context.Context, resourceGroupName string, serviceName string, apiID string, diagnosticID string, options *APIDiagnosticClientHeadOptions) (APIDiagnosticClientHeadResponse, error) {
	req, err := client.headCreateRequest(ctx, resourceGroupName, serviceName, apiID, diagnosticID, options)
	if err != nil {
		return APIDiagnosticClientHeadResponse{}, err
	}
	resp, err := client.pl.Do(req)
	if err != nil {
		return APIDiagnosticClientHeadResponse{}, err
	...
	if !runtime.HasStatusCode(resp, http.StatusOK) {
		return APIDiagnosticClientHeadResponse{}, runtime.NewResponseError(resp)
	}
	return client.headHandleResponse(resp)
}

// headCreateRequest creates the Head request.
func (client *APIDiagnosticClient) headCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, apiID string, diagnosticID string, options *APIDiagnosticClientHeadOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}/diagnostics/{diagnosticId}"
	if resourceGroupName == "" {
		return nil, errors.New("parameter resourceGroupName cannot be empty")
	}
...
func (client *APIDiagnosticClient) headHandleResponse(resp *http.Response) (APIDiagnosticClientHeadResponse, error) {
	result := APIDiagnosticClientHeadResponse{}
	if val := resp.Header.Get("ETag"); val != "" {
		result.ETag = &val
	}
...
func (client *APIDiagnosticClient) Update(ctx context.Context, resourceGroupName string, serviceName string, apiID string, diagnosticID string, ifMatch string, parameters DiagnosticContract, options *APIDiagnosticClientUpdateOptions) (APIDiagnosticClientUpdateResponse, error) {
	...
	return APIDiagnosticClientUpdateResponse{}, nil
}
