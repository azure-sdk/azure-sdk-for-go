...
func (client *B2CTenantsClient) BeginCreate(ctx context.Context, resourceGroupName string, resourceName string, options *B2CTenantsClientBeginCreateOptions) (*armruntime.Poller[B2CTenantsClientCreateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return armruntime.NewPoller(resp, client.pl, &armruntime.NewPollerOptions[B2CTenantsClientCreateResponse]{
			FinalStateVia: armruntime.FinalStateViaLocation,
		})
	} else {
		return armruntime.NewPollerFromResumeToken[B2CTenantsClientCreateResponse](options.ResumeToken, client.pl, nil)
	}
}
...
func (client *B2CTenantsClient) BeginDelete(ctx context.Context, resourceGroupName string, resourceName string, options *B2CTenantsClientBeginDeleteOptions) (*armruntime.Poller[B2CTenantsClientDeleteResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return armruntime.NewPoller(resp, client.pl, &armruntime.NewPollerOptions[B2CTenantsClientDeleteResponse]{
			FinalStateVia: armruntime.FinalStateViaLocation,
		})
	} else {
		return armruntime.NewPollerFromResumeToken[B2CTenantsClientDeleteResponse](options.ResumeToken, client.pl, nil)
	}
}
