...
// Components3Iu67JSchemasVirtualnetworkpropertiesPropertiesSubnetsItemsPropertiesRoutetableProperties - RouteTablePropertiesFormat
// route Table resource.
type Components3Iu67JSchemasVirtualnetworkpropertiesPropertiesSubnetsItemsPropertiesRoutetableProperties struct {
	// Routes - Collection of routes contained within a route table.
	Routes []*VirtualNetworkPropertiesSubnetsPropertiesItemsItem
}

// ComponentsCr63WSchemasVirtualnetworkpropertiesPropertiesSubnetsItemsPropertiesIPConfigurationreferencesItems - IPConfigurationReference
// - Describes a IPConfiguration under the virtual network
type ComponentsCr63WSchemasVirtualnetworkpropertiesPropertiesSubnetsItemsPropertiesIPConfigurationreferencesItems struct {
	// IPConfigurationID
	ID *string
}

// ComponentsI4F0MhSchemasVirtualnetworkpropertiesPropertiesSubnetsItemsPropertiesRoutetable - RouteTable for the subnet
type ComponentsI4F0MhSchemasVirtualnetworkpropertiesPropertiesSubnetsItemsPropertiesRoutetable struct {
	...
	Properties *Components3Iu67JSchemasVirtualnetworkpropertiesPropertiesSubnetsItemsPropertiesRoutetableProperties
...
// VirtualMachineVMConfigAgentInstanceView - The instance view of the VM Config Agent running on the virtual machine.
type VirtualMachineVMConfigAgentInstanceView struct {
...
// VirtualNetworkProperties - Properties under the virtual network resource
type VirtualNetworkProperties struct {
	...
	// READ-ONLY; Provisioning state of the virtual network.
	ProvisioningState *ProvisioningStateEnum

	// READ-ONLY; The observed state of virtual networks
	Status *VirtualNetworkStatus
}

// VirtualNetworkPropertiesDhcpOptions - DhcpOptions contains an array of DNS servers available to VMs deployed in the virtual
...
// VirtualNetworkPropertiesSubnetsItem - Subnet subnet in a virtual network resource.
type VirtualNetworkPropertiesSubnetsItem struct {
	// Name - The name of the resource that is unique within a resource group. This name can be used to access the resource.
	Name *string

	// SubnetProperties - Properties of the subnet.
	Properties *VirtualNetworkPropertiesSubnetsItemAutoGenerated
}

// VirtualNetworkPropertiesSubnetsItemAutoGenerated - SubnetProperties - Properties of the subnet.
type VirtualNetworkPropertiesSubnetsItemAutoGenerated struct {
...
// VirtualNetworkPropertiesSubnetsItemRouteTableRoutesItem - RoutePropertiesFormat - Properties of the route.
type VirtualNetworkPropertiesSubnetsItemRouteTableRoutesItem struct {
...
// VirtualNetworkPropertiesSubnetsPropertiesItemsItem - Route is associated with a subnet.
type VirtualNetworkPropertiesSubnetsPropertiesItemsItem struct {
	// Name - name of the subnet
	Name *string

	// RoutePropertiesFormat - Properties of the route.
	Properties *VirtualNetworkPropertiesSubnetsItemRouteTableRoutesItem
}

// VirtualNetworkStatus - The observed state of virtual networks
...
// VirtualNetworks - The virtual network resource definition.
...
// VirtualNetworksUpdateRequest - The virtual network resource patch definition.
