...
type Account struct {
	...
	Properties *AccountPropertiesReadOnly `json:"properties,omitempty"`
...
// AccountForPutRequest - An Azure Video Indexer account.
type AccountForPutRequest struct {
	// REQUIRED; The geo-location where the resource lives
	Location *string `json:"location,omitempty"`
...
// AccountPropertiesReadOnly - Azure Video Indexer account properties
type AccountPropertiesReadOnly struct {
	// The media services details
	MediaServices *MediaServicesForPutRequest `json:"mediaServices,omitempty"`
