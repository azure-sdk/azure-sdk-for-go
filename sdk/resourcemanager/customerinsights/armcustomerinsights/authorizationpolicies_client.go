...
func (client *AuthorizationPoliciesClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, hubName string, authorizationPolicyName string, parameters AuthorizationPolicyResourceFormat, _ *AuthorizationPoliciesClientCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *AuthorizationPoliciesClient) getCreateRequest(ctx context.Context, resourceGroupName string, hubName string, authorizationPolicyName string, _ *AuthorizationPoliciesClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.CustomerInsights/hubs/{hubName}/authorizationPolicies/{authorizationPolicyName}"
	if resourceGroupName == "" {
		return nil, errors.New("parameter resourceGroupName cannot be empty")
	}
...
func (client *AuthorizationPoliciesClient) listByHubCreateRequest(ctx context.Context, resourceGroupName string, hubName string, _ *AuthorizationPoliciesClientListByHubOptions) (*policy.Request, error) {
...
func (client *AuthorizationPoliciesClient) regeneratePrimaryKeyCreateRequest(ctx context.Context, resourceGroupName string, hubName string, authorizationPolicyName string, _ *AuthorizationPoliciesClientRegeneratePrimaryKeyOptions) (*policy.Request, error) {
...
func (client *AuthorizationPoliciesClient) regenerateSecondaryKeyCreateRequest(ctx context.Context, resourceGroupName string, hubName string, authorizationPolicyName string, _ *AuthorizationPoliciesClientRegenerateSecondaryKeyOptions) (*policy.Request, error) {
