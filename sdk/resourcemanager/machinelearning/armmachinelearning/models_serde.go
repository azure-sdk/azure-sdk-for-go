...
func (w WorkspaceProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "lazyInitSystemDatastores", w.LazyInitSystemDatastores)
...
func (w *WorkspaceProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "keyVaults":
			...
			delete(rawMsg, key)
		case "lazyInitSystemDatastores":
			err = unpopulate(val, "LazyInitSystemDatastores", &w.LazyInitSystemDatastores)
			delete(rawMsg, key)
		case "managedNetwork":
