...
func (s *ShareSubscriptionsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if shareSubscriptionsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = shareSubscriptionsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			case "ShareSubscriptionsClient.BeginCancelSynchronization":
				res.resp, res.err = s.dispatchBeginCancelSynchronization(req)
			...
			case "ShareSubscriptionsClient.NewListByAccountPager":
				res.resp, res.err = s.dispatchNewListByAccountPager(req)
			case "ShareSubscriptionsClient.NewListSourceShareSynchronizationSettingsPager":
				res.resp, res.err = s.dispatchNewListSourceShareSynchronizationSettingsPager(req)
			case "ShareSubscriptionsClient.NewListSynchronizationDetailsPager":
				res.resp, res.err = s.dispatchNewListSynchronizationDetailsPager(req)
			case "ShareSubscriptionsClient.NewListSynchronizationsPager":
				res.resp, res.err = s.dispatchNewListSynchronizationsPager(req)
			case "ShareSubscriptionsClient.BeginSynchronize":
				res.resp, res.err = s.dispatchBeginSynchronize(req)
			default:
...
// set this to conditionally intercept incoming requests to ShareSubscriptionsServerTransport
var shareSubscriptionsServerTransportInterceptor interface {
