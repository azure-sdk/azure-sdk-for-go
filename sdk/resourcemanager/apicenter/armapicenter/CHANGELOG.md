...
- New enum type `APIType` with values `APITypeGraphql`, `APITypeGrpc`, `APITypeRest`, `APITypeSoap`, `APITypeWebhook`, `APITypeWebsocket`
...
- New enum type `EnvironmentType` with values `EnvironmentTypeDevelopment`, `EnvironmentTypeProduction`, `EnvironmentTypeStaging`, `EnvironmentTypeTesting`
...
- New function `*APIDefinitionsClient.ImportSpecification(context.Context, string, string, APISpecImportSource, *APIDefinitionsClientImportSpecificationOptions) (APIDefinitionsClientImportSpecificationResponse, error)`
...
- New function `*ServicesClient.ExportMetadataSchema(context.Context, string, string, MetadataAssignmentEntity, *ServicesClientExportMetadataSchemaOptions) (ServicesClientExportMetadataSchemaResponse, error)`
...
- New struct `APISpecImportSource`
- New struct `APISpecImportSourceSpecification`
