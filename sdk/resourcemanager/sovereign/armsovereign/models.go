...
// DecommissionedManagementGroupPropertiesUpdate - The 'Decommissioned' management group properties.
...
type GenerateLandingZoneRequest struct {
	...
	// only of letters, digits, '-', '.', or '_'. No other special characters are
	// supported.
	...
	// If left empty, the default will be to deploy under the tenant root management
	// group.
...
// LandingZoneAccountResourceUpdate - The Landing zone account resource type. A Landing zone account is the container for
...
type LandingZoneConfigurationResourceProperties struct {
	...
	// default naming convention for those resource types. Example -
	// 'customNamingConvention': [{'resourceType': 'azureFirewalls', 'formula': '{DeploymentPrefix}-afwl-{DeploymentSuffix}'}]
...
type LandingZoneConfigurationResourcePropertiesUpdate struct {
	...
	// Parameter used to deploy a DDoS protection plan: Select 'Yes' to enable deployment, 'No' to skip it, or 'Existing' to reuse
	// an existing DDoS protection plan.
	DdosProtectionCreationOption *ResourceCreationOptions
	...
	// Parameter used to deploy a log analytics workspace: Select 'Yes' to enable deployment, 'No' to skip it, or 'Existing' to
...
type LandingZoneRegistrationResourceProperties struct {
	...
	// REQUIRED; The managed identity to be assigned to this landing zone registration.
	ManagedIdentity *ManagedIdentityProperties
...
// ManagedIdentityPropertiesUpdate - The properties of managed identity, specifically including type and resource ID.
...
// ManagementGroupPropertiesUpdate - The properties of policy initiatives applied to the management group.
...
// SandboxManagementGroupPropertiesUpdate - The 'Sandbox' management group properties.
