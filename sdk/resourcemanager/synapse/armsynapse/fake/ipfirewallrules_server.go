...
func (i *IPFirewallRulesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if ipFirewallRulesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = ipFirewallRulesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "IPFirewallRulesClient.NewListByWorkspacePager":
				res.resp, res.err = i.dispatchNewListByWorkspacePager(req)
			case "IPFirewallRulesClient.BeginReplaceAll":
				res.resp, res.err = i.dispatchBeginReplaceAll(req)
			default:
...
// set this to conditionally intercept incoming requests to IPFirewallRulesServerTransport
var ipFirewallRulesServerTransportInterceptor interface {
