...
- New field `DevBoxProvisioningSettings`, `NetworkSettings`, `RestrictedResourceTypes` in struct `Properties`
- New field `DevBoxProvisioningSettings`, `NetworkSettings`, `RestrictedResourceTypes` in struct `UpdateProperties`
