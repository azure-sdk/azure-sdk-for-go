...
// DataReferenceCredentialDtoClassification provides polymorphic access to related types.
// Call the interface's GetDataReferenceCredentialDto() method to access the common type.
// Use a type switch to determine the concrete type.  The possible types are:
// - *AnonymousAccessCredentialDto, *DataReferenceCredentialDto, *DockerCredentialDto, *ManagedIdentityCredentialDto, *SASCredentialDto
type DataReferenceCredentialDtoClassification interface {
	// GetDataReferenceCredentialDto returns the DataReferenceCredentialDto content of the underlying type.
	GetDataReferenceCredentialDto() *DataReferenceCredentialDto
}
...
// Use a type switch to determine the concrete type.  The possible types are:
// - *PendingUploadCredentialDto, *PendingUploadSASCredentialDto
