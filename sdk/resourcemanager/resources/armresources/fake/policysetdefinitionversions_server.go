...
// PolicySetDefinitionVersionsServer is a fake server for instances of the armresources.PolicySetDefinitionVersionsClient type.
type PolicySetDefinitionVersionsServer struct {
	...
	CreateOrUpdate func(ctx context.Context, policySetDefinitionName string, policyDefinitionVersion string, parameters armresources.PolicySetDefinitionVersion, options *armresources.PolicySetDefinitionVersionsClientCreateOrUpdateOptions) (resp azfake.Responder[armresources.PolicySetDefinitionVersionsClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)

	// CreateOrUpdateAtManagementGroup is the fake for method PolicySetDefinitionVersionsClient.CreateOrUpdateAtManagementGroup
	// HTTP status codes to indicate success: http.StatusOK, http.StatusCreated
	CreateOrUpdateAtManagementGroup func(ctx context.Context, managementGroupName string, policySetDefinitionName string, policyDefinitionVersion string, parameters armresources.PolicySetDefinitionVersion, options *armresources.PolicySetDefinitionVersionsClientCreateOrUpdateAtManagementGroupOptions) (resp azfake.Responder[armresources.PolicySetDefinitionVersionsClientCreateOrUpdateAtManagementGroupResponse], errResp azfake.ErrorResponder)

	// Delete is the fake for method PolicySetDefinitionVersionsClient.Delete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	Delete func(ctx context.Context, policySetDefinitionName string, policyDefinitionVersion string, options *armresources.PolicySetDefinitionVersionsClientDeleteOptions) (resp azfake.Responder[armresources.PolicySetDefinitionVersionsClientDeleteResponse], errResp azfake.ErrorResponder)

	// DeleteAtManagementGroup is the fake for method PolicySetDefinitionVersionsClient.DeleteAtManagementGroup
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	DeleteAtManagementGroup func(ctx context.Context, managementGroupName string, policySetDefinitionName string, policyDefinitionVersion string, options *armresources.PolicySetDefinitionVersionsClientDeleteAtManagementGroupOptions) (resp azfake.Responder[armresources.PolicySetDefinitionVersionsClientDeleteAtManagementGroupResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method PolicySetDefinitionVersionsClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, policySetDefinitionName string, policyDefinitionVersion string, options *armresources.PolicySetDefinitionVersionsClientGetOptions) (resp azfake.Responder[armresources.PolicySetDefinitionVersionsClientGetResponse], errResp azfake.ErrorResponder)

	// GetAtManagementGroup is the fake for method PolicySetDefinitionVersionsClient.GetAtManagementGroup
	// HTTP status codes to indicate success: http.StatusOK
	GetAtManagementGroup func(ctx context.Context, managementGroupName string, policySetDefinitionName string, policyDefinitionVersion string, options *armresources.PolicySetDefinitionVersionsClientGetAtManagementGroupOptions) (resp azfake.Responder[armresources.PolicySetDefinitionVersionsClientGetAtManagementGroupResponse], errResp azfake.ErrorResponder)

	// GetBuiltIn is the fake for method PolicySetDefinitionVersionsClient.GetBuiltIn
	// HTTP status codes to indicate success: http.StatusOK
	GetBuiltIn func(ctx context.Context, policySetDefinitionName string, policyDefinitionVersion string, options *armresources.PolicySetDefinitionVersionsClientGetBuiltInOptions) (resp azfake.Responder[armresources.PolicySetDefinitionVersionsClientGetBuiltInResponse], errResp azfake.ErrorResponder)

	// NewListPager is the fake for method PolicySetDefinitionVersionsClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(policySetDefinitionName string, options *armresources.PolicySetDefinitionVersionsClientListOptions) (resp azfake.PagerResponder[armresources.PolicySetDefinitionVersionsClientListResponse])

	// ListAll is the fake for method PolicySetDefinitionVersionsClient.ListAll
	// HTTP status codes to indicate success: http.StatusOK
	ListAll func(ctx context.Context, options *armresources.PolicySetDefinitionVersionsClientListAllOptions) (resp azfake.Responder[armresources.PolicySetDefinitionVersionsClientListAllResponse], errResp azfake.ErrorResponder)

	// ListAllAtManagementGroup is the fake for method PolicySetDefinitionVersionsClient.ListAllAtManagementGroup
	// HTTP status codes to indicate success: http.StatusOK
	ListAllAtManagementGroup func(ctx context.Context, managementGroupName string, options *armresources.PolicySetDefinitionVersionsClientListAllAtManagementGroupOptions) (resp azfake.Responder[armresources.PolicySetDefinitionVersionsClientListAllAtManagementGroupResponse], errResp azfake.ErrorResponder)

	// ListAllBuiltins is the fake for method PolicySetDefinitionVersionsClient.ListAllBuiltins
	// HTTP status codes to indicate success: http.StatusOK
	ListAllBuiltins func(ctx context.Context, options *armresources.PolicySetDefinitionVersionsClientListAllBuiltinsOptions) (resp azfake.Responder[armresources.PolicySetDefinitionVersionsClientListAllBuiltinsResponse], errResp azfake.ErrorResponder)

	// NewListBuiltInPager is the fake for method PolicySetDefinitionVersionsClient.NewListBuiltInPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListBuiltInPager func(policySetDefinitionName string, options *armresources.PolicySetDefinitionVersionsClientListBuiltInOptions) (resp azfake.PagerResponder[armresources.PolicySetDefinitionVersionsClientListBuiltInResponse])

	// NewListByManagementGroupPager is the fake for method PolicySetDefinitionVersionsClient.NewListByManagementGroupPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByManagementGroupPager func(managementGroupName string, policySetDefinitionName string, options *armresources.PolicySetDefinitionVersionsClientListByManagementGroupOptions) (resp azfake.PagerResponder[armresources.PolicySetDefinitionVersionsClientListByManagementGroupResponse])
}
...
// The returned PolicySetDefinitionVersionsServerTransport instance is connected to an instance of armresources.PolicySetDefinitionVersionsClient via the
...
func NewPolicySetDefinitionVersionsServerTransport(srv *PolicySetDefinitionVersionsServer) *PolicySetDefinitionVersionsServerTransport {
	return &PolicySetDefinitionVersionsServerTransport{
		srv:                           srv,
		newListPager:                  newTracker[azfake.PagerResponder[armresources.PolicySetDefinitionVersionsClientListResponse]](),
		newListBuiltInPager:           newTracker[azfake.PagerResponder[armresources.PolicySetDefinitionVersionsClientListBuiltInResponse]](),
		newListByManagementGroupPager: newTracker[azfake.PagerResponder[armresources.PolicySetDefinitionVersionsClientListByManagementGroupResponse]](),
	}
}

// PolicySetDefinitionVersionsServerTransport connects instances of armresources.PolicySetDefinitionVersionsClient to instances of PolicySetDefinitionVersionsServer.
...
type PolicySetDefinitionVersionsServerTransport struct {
	...
	newListPager                  *tracker[azfake.PagerResponder[armresources.PolicySetDefinitionVersionsClientListResponse]]
	newListBuiltInPager           *tracker[azfake.PagerResponder[armresources.PolicySetDefinitionVersionsClientListBuiltInResponse]]
	newListByManagementGroupPager *tracker[azfake.PagerResponder[armresources.PolicySetDefinitionVersionsClientListByManagementGroupResponse]]
}
...
func (p *PolicySetDefinitionVersionsServerTransport) dispatchCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[armresources.PolicySetDefinitionVersion](req)
	if err != nil {
		return nil, err
	}
...
func (p *PolicySetDefinitionVersionsServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		var options *armresources.PolicySetDefinitionVersionsClientListOptions
		if topParam != nil {
			options = &armresources.PolicySetDefinitionVersionsClientListOptions{
				Top: topParam,
			}
		}
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armresources.PolicySetDefinitionVersionsClientListResponse, createLink func() string) {
...
func (p *PolicySetDefinitionVersionsServerTransport) dispatchNewListBuiltInPager(req *http.Request) (*http.Response, error) {
	...
	if newListBuiltInPager == nil {
		...
		var options *armresources.PolicySetDefinitionVersionsClientListBuiltInOptions
		if topParam != nil {
			options = &armresources.PolicySetDefinitionVersionsClientListBuiltInOptions{
				Top: topParam,
			}
		}
		...
		server.PagerResponderInjectNextLinks(newListBuiltInPager, req, func(page *armresources.PolicySetDefinitionVersionsClientListBuiltInResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
...
func (p *PolicySetDefinitionVersionsServerTransport) dispatchNewListByManagementGroupPager(req *http.Request) (*http.Response, error) {
	...
	if newListByManagementGroupPager == nil {
		...
		var options *armresources.PolicySetDefinitionVersionsClientListByManagementGroupOptions
		if topParam != nil {
			options = &armresources.PolicySetDefinitionVersionsClientListByManagementGroupOptions{
				Top: topParam,
			}
		}
		...
		server.PagerResponderInjectNextLinks(newListByManagementGroupPager, req, func(page *armresources.PolicySetDefinitionVersionsClientListByManagementGroupResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
