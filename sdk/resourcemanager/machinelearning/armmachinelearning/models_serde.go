...
func (s *SweepJob) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "tags":
			...
			delete(rawMsg, key)
		case "trial":
			s.Trial, err = unmarshalTrialClassification(val)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", s, err)
...
func (t Trial) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	objectMap["trialType"] = t.TrialType
	return json.Marshal(objectMap)
}
...
func (t *Trial) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "trialType":
			err = unpopulate(val, "TrialType", &t.TrialType)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", t, err)
...
func (t TrialComponent) MarshalJSON() ([]byte, error) {
	...
	objectMap["trialType"] = TrialTypeCommandComponent
	return json.Marshal(objectMap)
}
...
// MarshalJSON implements the json.Marshaller interface for type TrialPipelineComponent.
func (t TrialPipelineComponent) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "componentId", t.ComponentID)
	objectMap["trialType"] = TrialTypePipelineComponent
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type TrialPipelineComponent.
func (t *TrialPipelineComponent) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", t, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "componentId":
			err = unpopulate(val, "ComponentID", &t.ComponentID)
			delete(rawMsg, key)
		case "trialType":
			err = unpopulate(val, "TrialType", &t.TrialType)
			delete(rawMsg, key)
