...
// DiscoveredAsset - Discovered Asset definition.
...
// DiscoveredAssetEndpointProfile - Discovered Asset Endpoint Profile definition.
...
// DiscoveredAssetEndpointProfileListResult - The response of a DiscoveredAssetEndpointProfile list operation.
type DiscoveredAssetEndpointProfileListResult struct {
	// REQUIRED; The DiscoveredAssetEndpointProfile items on this page
...
// DiscoveredAssetEndpointProfileProperties - Defines the Discovered Asset Endpoint Profile properties.
type DiscoveredAssetEndpointProfileProperties struct {
	// REQUIRED; Identifier used to detect changes in the asset endpoint profile.
	DiscoveryID *string
...
// DiscoveredAssetEndpointProfileUpdate - The type used for update operations of the DiscoveredAssetEndpointProfile.
...
// DiscoveredAssetEndpointProfileUpdateProperties - The updatable properties of the DiscoveredAssetEndpointProfile.
...
// DiscoveredAssetListResult - The response of a DiscoveredAsset list operation.
type DiscoveredAssetListResult struct {
	// REQUIRED; The DiscoveredAsset items on this page
...
// DiscoveredAssetProperties - Defines the discovered asset properties.
...
// DiscoveredAssetUpdate - The type used for update operations of the DiscoveredAsset.
...
// DiscoveredAssetUpdateProperties - The updatable properties of the DiscoveredAsset.
...
// DiscoveredDataPoint - Defines the data point properties.
...
// DiscoveredDataset - Defines the dataset properties.
...
// DiscoveredEvent - Defines the event properties.
