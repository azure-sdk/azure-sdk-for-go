...
type TranscriptionServer struct {
	...
	Transcribe func(ctx context.Context, transcribeRequest azspeechtranscription.transcribeRequest, audio io.ReadSeekCloser, options *azspeechtranscription.TranscriptionClientTranscribeOptions) (resp azfake.Responder[azspeechtranscription.TranscriptionClientTranscribeResponse], errResp azfake.ErrorResponder)
}
...
func (t *TranscriptionServerTransport) dispatchTranscribe(req *http.Request) (*http.Response, error) {
	...
	var transcribeRequest azspeechtranscription.transcribeRequest
	...
	respr, errRespr := t.srv.Transcribe(req.Context(), transcribeRequest, audio, nil)
