...
- New enum type `AgentlessScanning` with values `AgentlessScanningDisabled`, `AgentlessScanningEnabled`, `AgentlessScanningNotApplicable`
...
- New field `AgentlessScanning`, `Capabilities` in struct `DevOpsConfigurationProperties`
