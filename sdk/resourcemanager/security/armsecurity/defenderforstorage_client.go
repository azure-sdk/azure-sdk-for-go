...
//     method.
func (client *DefenderForStorageClient) CancelMalwareScan(ctx context.Context, resourceID string, settingName SettingNameAutoGenerated, scanID string, options *DefenderForStorageClientCancelMalwareScanOptions) (DefenderForStorageClientCancelMalwareScanResponse, error) {
	var err error
...
func (client *DefenderForStorageClient) cancelMalwareScanCreateRequest(ctx context.Context, resourceID string, settingName SettingNameAutoGenerated, scanID string, options *DefenderForStorageClientCancelMalwareScanOptions) (*policy.Request, error) {
...
//     method.
func (client *DefenderForStorageClient) Create(ctx context.Context, resourceID string, settingName SettingNameAutoGenerated, defenderForStorageSetting DefenderForStorageSetting, options *DefenderForStorageClientCreateOptions) (DefenderForStorageClientCreateResponse, error) {
	var err error
...
func (client *DefenderForStorageClient) createCreateRequest(ctx context.Context, resourceID string, settingName SettingNameAutoGenerated, defenderForStorageSetting DefenderForStorageSetting, options *DefenderForStorageClientCreateOptions) (*policy.Request, error) {
...
func (client *DefenderForStorageClient) Get(ctx context.Context, resourceID string, settingName SettingNameAutoGenerated, options *DefenderForStorageClientGetOptions) (DefenderForStorageClientGetResponse, error) {
	var err error
...
func (client *DefenderForStorageClient) getCreateRequest(ctx context.Context, resourceID string, settingName SettingNameAutoGenerated, options *DefenderForStorageClientGetOptions) (*policy.Request, error) {
	urlPath := "/{resourceId}/providers/Microsoft.Security/defenderForStorageSettings/{settingName}"
	urlPath = strings.ReplaceAll(urlPath, "{resourceId}", resourceID)
	if settingName == "" {
		return nil, errors.New("parameter settingName cannot be empty")
...
//     method.
func (client *DefenderForStorageClient) GetMalwareScan(ctx context.Context, resourceID string, settingName SettingNameAutoGenerated, scanID string, options *DefenderForStorageClientGetMalwareScanOptions) (DefenderForStorageClientGetMalwareScanResponse, error) {
	var err error
...
func (client *DefenderForStorageClient) getMalwareScanCreateRequest(ctx context.Context, resourceID string, settingName SettingNameAutoGenerated, scanID string, options *DefenderForStorageClientGetMalwareScanOptions) (*policy.Request, error) {
...
//     method.
func (client *DefenderForStorageClient) StartMalwareScan(ctx context.Context, resourceID string, settingName SettingNameAutoGenerated, options *DefenderForStorageClientStartMalwareScanOptions) (DefenderForStorageClientStartMalwareScanResponse, error) {
	var err error
...
func (client *DefenderForStorageClient) startMalwareScanCreateRequest(ctx context.Context, resourceID string, settingName SettingNameAutoGenerated, options *DefenderForStorageClientStartMalwareScanOptions) (*policy.Request, error) {
