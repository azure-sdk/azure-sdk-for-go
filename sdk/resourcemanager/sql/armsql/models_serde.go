...
func (d DatabaseOperationProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "phaseCode", d.PhaseCode)
	populate(objectMap, "phaseDescription", d.PhaseDescription)
	populate(objectMap, "phaseInformation", d.PhaseInformation)
...
func (d *DatabaseOperationProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "percentComplete":
			...
			delete(rawMsg, key)
		case "phaseCode":
			err = unpopulate(val, "PhaseCode", &d.PhaseCode)
			delete(rawMsg, key)
		case "phaseDescription":
			err = unpopulate(val, "PhaseDescription", &d.PhaseDescription)
			delete(rawMsg, key)
		case "phaseInformation":
			err = unpopulate(val, "PhaseInformation", &d.PhaseInformation)
			delete(rawMsg, key)
		case "serverName":
