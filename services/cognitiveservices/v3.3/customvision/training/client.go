...
func (client BaseClient) CreateImageRegionsPreparer(ctx context.Context, projectID uuid.UUID, batch ImageRegionCreateBatch) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.AsPost(),
		autorest.WithCustomBaseURL("{Endpoint}/customvision/v3.3/training", urlParameters),
...
// projectID - the id of the project the iteration belongs to.
// iterationID - the id of the iteration to get.
// threshold - the threshold used to determine true predictions. Accepted values are between 1 and 0. Defaults
// to 0.8
// overlapThreshold - if applicable, the bounding box overlap threshold used to determine true predictions.
// Accepted values are between 1 and 0. Defaults to 0.5
...
// metadata - the metadata to be updated to the specified images. Limited to 50 key-value pairs per image. The
// length of key is limited to 256. The length of value is limited to 512.
