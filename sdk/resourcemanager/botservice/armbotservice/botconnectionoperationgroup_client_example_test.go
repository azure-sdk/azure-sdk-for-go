...
func ExampleBotConnectionOperationGroupClient_ListServiceProviders() {
	...
	res, err := clientFactory.NewBotConnectionOperationGroupClient().ListServiceProviders(ctx, nil)
	if err != nil {
	...
	// res = armbotservice.BotConnectionOperationGroupClientListServiceProvidersResponse{
