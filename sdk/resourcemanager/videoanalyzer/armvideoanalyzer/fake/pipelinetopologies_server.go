...
func (p *PipelineTopologiesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if pipelineTopologiesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = pipelineTopologiesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to PipelineTopologiesServerTransport
var pipelineTopologiesServerTransportInterceptor interface {
