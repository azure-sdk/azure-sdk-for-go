...
func NewContainerAppsBuildsByContainerAppClient(subscriptionID string, containerAppName string, credential azcore.TokenCredential, options *arm.ClientOptions) (*ContainerAppsBuildsByContainerAppClient, error) {
...
//     method.
func (client *ContainerAppsBuildsByContainerAppClient) NewListPager(resourceGroupName string, options *ContainerAppsBuildsByContainerAppClientListOptions) *runtime.Pager[ContainerAppsBuildsByContainerAppClientListResponse] {
...
func (client *ContainerAppsBuildsByContainerAppClient) listCreateRequest(ctx context.Context, resourceGroupName string, options *ContainerAppsBuildsByContainerAppClientListOptions) (*policy.Request, error) {
	...
	if client.containerAppName == "" {
		return nil, errors.New("parameter client.containerAppName cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{containerAppName}", url.PathEscape(client.containerAppName))
