...
// AzureLargeInstancesServer is a fake server for instances of the armazurelargeinstance.AzureLargeInstancesClient type.
type AzureLargeInstancesServer struct {
	// Create is the fake for method AzureLargeInstancesClient.Create
	// HTTP status codes to indicate success: http.StatusOK, http.StatusCreated
	Create func(ctx context.Context, resourceGroupName string, azureLargeInstanceName string, azurelargeinstanceproperties armazurelargeinstance.AzureLargeInstance, options *armazurelargeinstance.AzureLargeInstancesClientCreateOptions) (resp azfake.Responder[armazurelargeinstance.AzureLargeInstancesClientCreateResponse], errResp azfake.ErrorResponder)

	// BeginDelete is the fake for method AzureLargeInstancesClient.BeginDelete
	// HTTP status codes to indicate success: http.StatusAccepted, http.StatusNoContent
	BeginDelete func(ctx context.Context, resourceGroupName string, azureLargeInstanceName string, options *armazurelargeinstance.AzureLargeInstancesClientBeginDeleteOptions) (resp azfake.PollerResponder[armazurelargeinstance.AzureLargeInstancesClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method AzureLargeInstancesClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, azureLargeInstanceName string, options *armazurelargeinstance.AzureLargeInstancesClientGetOptions) (resp azfake.Responder[armazurelargeinstance.AzureLargeInstancesClientGetResponse], errResp azfake.ErrorResponder)

	// NewListByResourceGroupPager is the fake for method AzureLargeInstancesClient.NewListByResourceGroupPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByResourceGroupPager func(resourceGroupName string, options *armazurelargeinstance.AzureLargeInstancesClientListByResourceGroupOptions) (resp azfake.PagerResponder[armazurelargeinstance.AzureLargeInstancesClientListByResourceGroupResponse])

	// NewListBySubscriptionPager is the fake for method AzureLargeInstancesClient.NewListBySubscriptionPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListBySubscriptionPager func(options *armazurelargeinstance.AzureLargeInstancesClientListBySubscriptionOptions) (resp azfake.PagerResponder[armazurelargeinstance.AzureLargeInstancesClientListBySubscriptionResponse])

	// BeginRestart is the fake for method AzureLargeInstancesClient.BeginRestart
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginRestart func(ctx context.Context, resourceGroupName string, azureLargeInstanceName string, options *armazurelargeinstance.AzureLargeInstancesClientBeginRestartOptions) (resp azfake.PollerResponder[armazurelargeinstance.AzureLargeInstancesClientRestartResponse], errResp azfake.ErrorResponder)

	// BeginShutdown is the fake for method AzureLargeInstancesClient.BeginShutdown
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginShutdown func(ctx context.Context, resourceGroupName string, azureLargeInstanceName string, options *armazurelargeinstance.AzureLargeInstancesClientBeginShutdownOptions) (resp azfake.PollerResponder[armazurelargeinstance.AzureLargeInstancesClientShutdownResponse], errResp azfake.ErrorResponder)

	// BeginStart is the fake for method AzureLargeInstancesClient.BeginStart
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginStart func(ctx context.Context, resourceGroupName string, azureLargeInstanceName string, options *armazurelargeinstance.AzureLargeInstancesClientBeginStartOptions) (resp azfake.PollerResponder[armazurelargeinstance.AzureLargeInstancesClientStartResponse], errResp azfake.ErrorResponder)

	// Update is the fake for method AzureLargeInstancesClient.Update
	// HTTP status codes to indicate success: http.StatusOK
	Update func(ctx context.Context, resourceGroupName string, azureLargeInstanceName string, tagsParameter armazurelargeinstance.Tags, options *armazurelargeinstance.AzureLargeInstancesClientUpdateOptions) (resp azfake.Responder[armazurelargeinstance.AzureLargeInstancesClientUpdateResponse], errResp azfake.ErrorResponder)
}
...
// The returned AzureLargeInstancesServerTransport instance is connected to an instance of armazurelargeinstance.AzureLargeInstancesClient via the
...
func NewAzureLargeInstancesServerTransport(srv *AzureLargeInstancesServer) *AzureLargeInstancesServerTransport {
	return &AzureLargeInstancesServerTransport{
		srv:                         srv,
		beginDelete:                 newTracker[azfake.PollerResponder[armazurelargeinstance.AzureLargeInstancesClientDeleteResponse]](),
		newListByResourceGroupPager: newTracker[azfake.PagerResponder[armazurelargeinstance.AzureLargeInstancesClientListByResourceGroupResponse]](),
		newListBySubscriptionPager:  newTracker[azfake.PagerResponder[armazurelargeinstance.AzureLargeInstancesClientListBySubscriptionResponse]](),
		beginRestart:                newTracker[azfake.PollerResponder[armazurelargeinstance.AzureLargeInstancesClientRestartResponse]](),
		beginShutdown:               newTracker[azfake.PollerResponder[armazurelargeinstance.AzureLargeInstancesClientShutdownResponse]](),
		beginStart:                  newTracker[azfake.PollerResponder[armazurelargeinstance.AzureLargeInstancesClientStartResponse]](),
	}
}

// AzureLargeInstancesServerTransport connects instances of armazurelargeinstance.AzureLargeInstancesClient to instances of AzureLargeInstancesServer.
...
type AzureLargeInstancesServerTransport struct {
	...
	beginDelete                 *tracker[azfake.PollerResponder[armazurelargeinstance.AzureLargeInstancesClientDeleteResponse]]
	newListByResourceGroupPager *tracker[azfake.PagerResponder[armazurelargeinstance.AzureLargeInstancesClientListByResourceGroupResponse]]
	newListBySubscriptionPager  *tracker[azfake.PagerResponder[armazurelargeinstance.AzureLargeInstancesClientListBySubscriptionResponse]]
	beginRestart                *tracker[azfake.PollerResponder[armazurelargeinstance.AzureLargeInstancesClientRestartResponse]]
	beginShutdown               *tracker[azfake.PollerResponder[armazurelargeinstance.AzureLargeInstancesClientShutdownResponse]]
	beginStart                  *tracker[azfake.PollerResponder[armazurelargeinstance.AzureLargeInstancesClientStartResponse]]
}
...
func (a *AzureLargeInstancesServerTransport) Do(req *http.Request) (*http.Response, error) {
	...
	switch method {
	case "AzureLargeInstancesClient.Create":
		resp, err = a.dispatchCreate(req)
	case "AzureLargeInstancesClient.BeginDelete":
...
func (a *AzureLargeInstancesServerTransport) dispatchCreate(req *http.Request) (*http.Response, error) {
	if a.srv.Create == nil {
	...
	body, err := server.UnmarshalRequestAsJSON[armazurelargeinstance.AzureLargeInstance](req)
	if err != nil {
		return nil, err
	}
...
func (a *AzureLargeInstancesServerTransport) dispatchBeginDelete(req *http.Request) (*http.Response, error) {
	...
	if beginDelete == nil {
		...
		respr, errRespr := a.srv.BeginDelete(req.Context(), resourceGroupNameParam, azureLargeInstanceNameParam, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginDelete = &respr
...
func (a *AzureLargeInstancesServerTransport) dispatchNewListByResourceGroupPager(req *http.Request) (*http.Response, error) {
	...
	if newListByResourceGroupPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListByResourceGroupPager, req, func(page *armazurelargeinstance.AzureLargeInstancesClientListByResourceGroupResponse, createLink func() string) {
...
func (a *AzureLargeInstancesServerTransport) dispatchNewListBySubscriptionPager(req *http.Request) (*http.Response, error) {
	...
	if newListBySubscriptionPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListBySubscriptionPager, req, func(page *armazurelargeinstance.AzureLargeInstancesClientListBySubscriptionResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
...
func (a *AzureLargeInstancesServerTransport) dispatchBeginRestart(req *http.Request) (*http.Response, error) {
	...
	if beginRestart == nil {
		...
		var options *armazurelargeinstance.AzureLargeInstancesClientBeginRestartOptions
		if !reflect.ValueOf(body).IsZero() {
			options = &armazurelargeinstance.AzureLargeInstancesClientBeginRestartOptions{
				ForceParameter: &body,
			}
		}
...
func (a *AzureLargeInstancesServerTransport) dispatchUpdate(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[armazurelargeinstance.Tags](req)
	if err != nil {
		return nil, err
	}
	resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
