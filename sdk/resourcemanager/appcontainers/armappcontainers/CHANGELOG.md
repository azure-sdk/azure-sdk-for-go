...
- New enum type `LabelHistoryRecordItemStatus` with values `LabelHistoryRecordItemStatusFailed`, `LabelHistoryRecordItemStatusStarting`, `LabelHistoryRecordItemStatusSucceeded`
...
- New field `AvailabilityZones`, `PrivateLinkDefaultDomain` in struct `ManagedEnvironmentProperties`
