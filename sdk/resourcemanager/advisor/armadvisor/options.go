...
type RecommendationMetadataClientListOptions struct {
	...
	// Filter can be applied to properties ['Category', 'Control', 'RetirementDate'] with operators ['eq', 'and', 'le', 'ge'].
	// Example:
	// - $filter=recommendationCategory eq 'HighAvailability' and recommendationControl eq 'ServiceUpgradeAndRetirement' and retirementDate
	// ge '2024-01-01' and retirementDate le '2028-01-01'
	Filter *string
}
