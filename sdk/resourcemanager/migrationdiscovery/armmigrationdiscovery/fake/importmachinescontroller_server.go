...
// ImportMachinesControllerServer is a fake server for instances of the armmigrationdiscovery.ImportMachinesControllerClient type.
type ImportMachinesControllerServer struct {
	...
	Delete func(ctx context.Context, resourceGroupName string, siteName string, machineName string, options *armmigrationdiscovery.ImportMachinesControllerClientDeleteOptions) (resp azfake.Responder[armmigrationdiscovery.ImportMachinesControllerClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method ImportMachinesControllerClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, siteName string, machineName string, options *armmigrationdiscovery.ImportMachinesControllerClientGetOptions) (resp azfake.Responder[armmigrationdiscovery.ImportMachinesControllerClientGetResponse], errResp azfake.ErrorResponder)

	// NewListByImportSitePager is the fake for method ImportMachinesControllerClient.NewListByImportSitePager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByImportSitePager func(resourceGroupName string, siteName string, options *armmigrationdiscovery.ImportMachinesControllerClientListByImportSiteOptions) (resp azfake.PagerResponder[armmigrationdiscovery.ImportMachinesControllerClientListByImportSiteResponse])
}
...
// The returned ImportMachinesControllerServerTransport instance is connected to an instance of armmigrationdiscovery.ImportMachinesControllerClient via the
...
func NewImportMachinesControllerServerTransport(srv *ImportMachinesControllerServer) *ImportMachinesControllerServerTransport {
	return &ImportMachinesControllerServerTransport{
		srv:                      srv,
		newListByImportSitePager: newTracker[azfake.PagerResponder[armmigrationdiscovery.ImportMachinesControllerClientListByImportSiteResponse]](),
	}
}

// ImportMachinesControllerServerTransport connects instances of armmigrationdiscovery.ImportMachinesControllerClient to instances of ImportMachinesControllerServer.
...
type ImportMachinesControllerServerTransport struct {
	...
	newListByImportSitePager *tracker[azfake.PagerResponder[armmigrationdiscovery.ImportMachinesControllerClientListByImportSiteResponse]]
}
...
func (i *ImportMachinesControllerServerTransport) dispatchNewListByImportSitePager(req *http.Request) (*http.Response, error) {
	...
	if newListByImportSitePager == nil {
		...
		var options *armmigrationdiscovery.ImportMachinesControllerClientListByImportSiteOptions
		if filterParam != nil || topParam != nil || continuationTokenParam != nil || totalRecordCountParam != nil {
			options = &armmigrationdiscovery.ImportMachinesControllerClientListByImportSiteOptions{
				Filter:            filterParam,
				Top:               topParam,
		...
		server.PagerResponderInjectNextLinks(newListByImportSitePager, req, func(page *armmigrationdiscovery.ImportMachinesControllerClientListByImportSiteResponse, createLink func() string) {
