...
func (client *SpringbootserversClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, siteName string, springbootserversName string, springbootservers SpringbootserversModel, _ *SpringbootserversClientCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *SpringbootserversClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, siteName string, springbootserversName string, _ *SpringbootserversClientBeginDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OffAzureSpringBoot/springbootsites/{siteName}/springbootservers/{springbootserversName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *SpringbootserversClient) getCreateRequest(ctx context.Context, resourceGroupName string, siteName string, springbootserversName string, _ *SpringbootserversClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OffAzureSpringBoot/springbootsites/{siteName}/springbootservers/{springbootserversName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *SpringbootserversClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, siteName string, _ *SpringbootserversClientListByResourceGroupOptions) (*policy.Request, error) {
...
func (client *SpringbootserversClient) listBySubscriptionCreateRequest(ctx context.Context, siteName string, _ *SpringbootserversClientListBySubscriptionOptions) (*policy.Request, error) {
...
func (client *SpringbootserversClient) updateCreateRequest(ctx context.Context, resourceGroupName string, siteName string, springbootserversName string, springbootservers SpringbootserversPatch, _ *SpringbootserversClientUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OffAzureSpringBoot/springbootsites/{siteName}/springbootservers/{springbootserversName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
