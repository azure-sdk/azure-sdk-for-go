...
type IpamPoolsServer struct {
	// Create is the fake for method IpamPoolsClient.Create
	// HTTP status codes to indicate success: http.StatusOK, http.StatusCreated
	Create func(ctx context.Context, resourceGroupName string, networkManagerName string, poolName string, options *armnetwork.IpamPoolsClientCreateOptions) (resp azfake.Responder[armnetwork.IpamPoolsClientCreateResponse], errResp azfake.ErrorResponder)
...
func (i *IpamPoolsServerTransport) dispatchCreate(req *http.Request) (*http.Response, error) {
	if i.srv.Create == nil {
	...
	var options *armnetwork.IpamPoolsClientCreateOptions
	if !reflect.ValueOf(body).IsZero() {
		options = &armnetwork.IpamPoolsClientCreateOptions{
			Body: &body,
		}
	}
	respr, errRespr := i.srv.Create(req.Context(), resourceGroupNameParam, networkManagerNameParam, poolNameParam, options)
