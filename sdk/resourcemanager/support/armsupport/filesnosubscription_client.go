...
func (client *FilesNoSubscriptionClient) createCreateRequest(ctx context.Context, fileWorkspaceName string, fileName string, createFileParameters FileDetails, _ *FilesNoSubscriptionClientCreateOptions) (*policy.Request, error) {
...
func (client *FilesNoSubscriptionClient) getCreateRequest(ctx context.Context, fileWorkspaceName string, fileName string, _ *FilesNoSubscriptionClientGetOptions) (*policy.Request, error) {
	urlPath := "/providers/Microsoft.Support/fileWorkspaces/{fileWorkspaceName}/files/{fileName}"
	if fileWorkspaceName == "" {
		return nil, errors.New("parameter fileWorkspaceName cannot be empty")
	}
...
func (client *FilesNoSubscriptionClient) uploadCreateRequest(ctx context.Context, fileWorkspaceName string, fileName string, uploadFile UploadFile, _ *FilesNoSubscriptionClientUploadOptions) (*policy.Request, error) {
