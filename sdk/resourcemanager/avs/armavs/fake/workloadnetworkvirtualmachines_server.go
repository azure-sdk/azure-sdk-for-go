...
type WorkloadNetworkVirtualMachinesServer struct {
	...
	// HTTP status codes to indicate success: http.StatusOK
	NewListByWorkloadNetworkPager func(resourceGroupName string, privateCloudName string, options *armavs.WorkloadNetworkVirtualMachinesClientListByWorkloadNetworkOptions) (resp azfake.PagerResponder[armavs.WorkloadNetworkVirtualMachinesClientListByWorkloadNetworkResponse])
}
