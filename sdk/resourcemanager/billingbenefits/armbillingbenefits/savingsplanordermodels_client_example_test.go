...
// Generated from example definition: 2024-11-01-preview/SavingsPlanOrderElevate.json
func ExampleSavingsPlanOrderModelsClient_Elevate() {
	...
	res, err := clientFactory.NewSavingsPlanOrderModelsClient().Elevate(ctx, "20000000-0000-0000-0000-000000000000", nil)
	if err != nil {
	...
	// res = armbillingbenefits.SavingsPlanOrderModelsClientElevateResponse{
...
// Generated from example definition: 2024-11-01-preview/SavingsPlanOrderExpandedGet.json
func ExampleSavingsPlanOrderModelsClient_Get_savingsPlanOrderWithExpandedPaymentsGet() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	res, err := clientFactory.NewSavingsPlanOrderModelsClient().Get(ctx, "20000000-0000-0000-0000-000000000000", &SavingsPlanOrderModelsClientGetOptions{
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armbillingbenefits.SavingsPlanOrderModelsClientGetResponse{
...
// Generated from example definition: 2024-11-01-preview/SavingsPlanOrderGet.json
func ExampleSavingsPlanOrderModelsClient_Get_savingsPlanOrderGet() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	res, err := clientFactory.NewSavingsPlanOrderModelsClient().Get(ctx, "20000000-0000-0000-0000-000000000000", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
...
// Generated from example definition: 2024-11-01-preview/SavingsPlanOrderList.json
func ExampleSavingsPlanOrderModelsClient_NewListPager() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	pager := clientFactory.NewSavingsPlanOrderModelsClient().NewListPager(nil)
	for pager.More() {
		...
		// page = armbillingbenefits.SavingsPlanOrderModelsClientListResponse{
