...
//     method.
func (client *ScriptExecutionsClient) NewListByPrivateCloudPager(resourceGroupName string, privateCloudName string, options *ScriptExecutionsClientListByPrivateCloudOptions) *runtime.Pager[ScriptExecutionsClientListByPrivateCloudResponse] {
...
func (client *ScriptExecutionsClient) listByPrivateCloudCreateRequest(ctx context.Context, resourceGroupName string, privateCloudName string, _ *ScriptExecutionsClientListByPrivateCloudOptions) (*policy.Request, error) {
