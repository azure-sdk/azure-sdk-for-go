...
func (m ManagedEnvironmentProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "provisioningState", m.ProvisioningState)
	populate(objectMap, "quotas", m.Quotas)
...
func (m *ManagedEnvironmentProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "provisioningState":
			...
			delete(rawMsg, key)
		case "quotas":
			err = unpopulate(val, "Quotas", &m.Quotas)
			delete(rawMsg, key)
		case "staticIp":
...
// MarshalJSON implements the json.Marshaller interface for type ManagedEnvironmentQuota.
func (m ManagedEnvironmentQuota) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "cores", m.Cores)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ManagedEnvironmentQuota.
func (m *ManagedEnvironmentQuota) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", m, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "cores":
			err = unpopulate(val, "Cores", &m.Cores)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", m, err)
...
// MarshalJSON implements the json.Marshaller interface for type QuotaStatus.
func (q QuotaStatus) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "total", q.Total)
	populate(objectMap, "used", q.Used)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type QuotaStatus.
func (q *QuotaStatus) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", q, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "total":
			err = unpopulate(val, "Total", &q.Total)
			delete(rawMsg, key)
		case "used":
			err = unpopulate(val, "Used", &q.Used)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", q, err)
