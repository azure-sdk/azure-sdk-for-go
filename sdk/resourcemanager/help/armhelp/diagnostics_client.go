...
func (client *DiagnosticsClient) BeginCreate(ctx context.Context, diagnosticResourceRequest DiagnosticResource, options *DiagnosticsClientBeginCreateOptions) (*runtime.Poller[DiagnosticsClientCreateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return runtime.NewPoller(resp, client.pl, &runtime.NewPollerOptions[DiagnosticsClientCreateResponse]{
			FinalStateVia: runtime.FinalStateViaAzureAsyncOp,
		})
	} else {
		return runtime.NewPollerFromResumeToken[DiagnosticsClientCreateResponse](options.ResumeToken, client.pl, nil)
	}
}
