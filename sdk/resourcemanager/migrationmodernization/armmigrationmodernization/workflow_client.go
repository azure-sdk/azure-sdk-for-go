...
func (client *WorkflowClient) getCreateRequest(ctx context.Context, subscriptionID string, resourceGroupName string, modernizeProjectName string, workflowName string, _ *WorkflowClientGetOptions) (*policy.Request, error) {
