...
// SQLDiscoverySiteDataSourceControllerServer is a fake server for instances of the armmigrationdiscovery.SQLDiscoverySiteDataSourceControllerClient type.
type SQLDiscoverySiteDataSourceControllerServer struct {
	...
	BeginCreate func(ctx context.Context, resourceGroupName string, siteName string, sqlSiteName string, discoverySiteDataSourceName string, body armmigrationdiscovery.SQLDiscoverySiteDataSource, options *armmigrationdiscovery.SQLDiscoverySiteDataSourceControllerClientBeginCreateOptions) (resp azfake.PollerResponder[armmigrationdiscovery.SQLDiscoverySiteDataSourceControllerClientCreateResponse], errResp azfake.ErrorResponder)

	// Delete is the fake for method SQLDiscoverySiteDataSourceControllerClient.Delete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	Delete func(ctx context.Context, resourceGroupName string, siteName string, sqlSiteName string, discoverySiteDataSourceName string, options *armmigrationdiscovery.SQLDiscoverySiteDataSourceControllerClientDeleteOptions) (resp azfake.Responder[armmigrationdiscovery.SQLDiscoverySiteDataSourceControllerClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method SQLDiscoverySiteDataSourceControllerClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, siteName string, sqlSiteName string, discoverySiteDataSourceName string, options *armmigrationdiscovery.SQLDiscoverySiteDataSourceControllerClientGetOptions) (resp azfake.Responder[armmigrationdiscovery.SQLDiscoverySiteDataSourceControllerClientGetResponse], errResp azfake.ErrorResponder)

	// NewListBySQLSitePager is the fake for method SQLDiscoverySiteDataSourceControllerClient.NewListBySQLSitePager
	// HTTP status codes to indicate success: http.StatusOK
	NewListBySQLSitePager func(resourceGroupName string, siteName string, sqlSiteName string, options *armmigrationdiscovery.SQLDiscoverySiteDataSourceControllerClientListBySQLSiteOptions) (resp azfake.PagerResponder[armmigrationdiscovery.SQLDiscoverySiteDataSourceControllerClientListBySQLSiteResponse])
}
...
// The returned SQLDiscoverySiteDataSourceControllerServerTransport instance is connected to an instance of armmigrationdiscovery.SQLDiscoverySiteDataSourceControllerClient via the
...
func NewSQLDiscoverySiteDataSourceControllerServerTransport(srv *SQLDiscoverySiteDataSourceControllerServer) *SQLDiscoverySiteDataSourceControllerServerTransport {
	return &SQLDiscoverySiteDataSourceControllerServerTransport{
		srv:                   srv,
		beginCreate:           newTracker[azfake.PollerResponder[armmigrationdiscovery.SQLDiscoverySiteDataSourceControllerClientCreateResponse]](),
		newListBySQLSitePager: newTracker[azfake.PagerResponder[armmigrationdiscovery.SQLDiscoverySiteDataSourceControllerClientListBySQLSiteResponse]](),
	}
}

// SQLDiscoverySiteDataSourceControllerServerTransport connects instances of armmigrationdiscovery.SQLDiscoverySiteDataSourceControllerClient to instances of SQLDiscoverySiteDataSourceControllerServer.
...
type SQLDiscoverySiteDataSourceControllerServerTransport struct {
	...
	beginCreate           *tracker[azfake.PollerResponder[armmigrationdiscovery.SQLDiscoverySiteDataSourceControllerClientCreateResponse]]
	newListBySQLSitePager *tracker[azfake.PagerResponder[armmigrationdiscovery.SQLDiscoverySiteDataSourceControllerClientListBySQLSiteResponse]]
}
...
func (s *SQLDiscoverySiteDataSourceControllerServerTransport) dispatchBeginCreate(req *http.Request) (*http.Response, error) {
	...
	if beginCreate == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armmigrationdiscovery.SQLDiscoverySiteDataSource](req)
		if err != nil {
			return nil, err
		}
...
func (s *SQLDiscoverySiteDataSourceControllerServerTransport) dispatchNewListBySQLSitePager(req *http.Request) (*http.Response, error) {
	...
	if newListBySQLSitePager == nil {
		...
		server.PagerResponderInjectNextLinks(newListBySQLSitePager, req, func(page *armmigrationdiscovery.SQLDiscoverySiteDataSourceControllerClientListBySQLSiteResponse, createLink func() string) {
