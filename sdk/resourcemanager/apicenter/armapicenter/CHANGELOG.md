...
- New enum type `APISourceType` with values `APISourceTypeAmazonAPIGateway`, `APISourceTypeAzureAPIManagement`
...
- New function `*WorkspacesClient.BeginImportAPISource(context.Context, string, string, string, ImportAPISourceRequest, *WorkspacesClientBeginImportAPISourceOptions) (*runtime.Poller[WorkspacesClientImportAPISourceResponse], error)`
- New struct `APISource`
- New struct `APISourceListResult`
- New struct `APISourceProperties`
- New struct `AmazonAPIGatewaySource`
- New struct `AzureAPIManagementSource`
- New struct `AzureAPIManagementSourceImportApis`
- New struct `DeletedService`
- New struct `DeletedServiceListResult`
- New struct `DeletedServiceProperties`
- New struct `ErrorAdditionalInfo`
- New struct `ErrorDetail`
- New struct `ImportAPISourceRequest`
