...
// collectorBody - New or Updated Hyper-V collector.
...
func (client *HyperVCollectorsClient) Create(ctx context.Context, resourceGroupName string, projectName string, hyperVCollectorName string, collectorBody HyperVCollector, options *HyperVCollectorsClientCreateOptions) (HyperVCollectorsClientCreateResponse, error) {
	req, err := client.createCreateRequest(ctx, resourceGroupName, projectName, hyperVCollectorName, collectorBody, options)
	if err != nil {
...
func (client *HyperVCollectorsClient) createCreateRequest(ctx context.Context, resourceGroupName string, projectName string, hyperVCollectorName string, collectorBody HyperVCollector, options *HyperVCollectorsClientCreateOptions) (*policy.Request, error) {
	...
	return req, runtime.MarshalAsJSON(req, collectorBody)
}
