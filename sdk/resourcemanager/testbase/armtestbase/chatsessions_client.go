...
func (client *ChatSessionsClient) getCreateRequest(ctx context.Context, resourceGroupName string, testBaseAccountName string, chatSessionName string, _ *ChatSessionsClientGetOptions) (*policy.Request, error) {
...
func (client *ChatSessionsClient) listCreateRequest(ctx context.Context, resourceGroupName string, testBaseAccountName string, _ *ChatSessionsClientListOptions) (*policy.Request, error) {
