...
func (client *HCRPReportsClient) getCreateRequest(ctx context.Context, resourceGroupName string, machineName string, configurationProfileAssignmentName string, reportName string, _ *HCRPReportsClientGetOptions) (*policy.Request, error) {
...
func (client *HCRPReportsClient) listByConfigurationProfileAssignmentsCreateRequest(ctx context.Context, resourceGroupName string, machineName string, configurationProfileAssignmentName string, _ *HCRPReportsClientListByConfigurationProfileAssignmentsOptions) (*policy.Request, error) {
