...
- Function `*ManagedDatabaseSensitivityLabelsClient.Get` parameter(s) have been changed from `(context.Context, string, string, string, string, string, string, SensitivityLabelSource, *ManagedDatabaseSensitivityLabelsClientGetOptions)` to `(context.Context, string, string, string, string, string, string, *ManagedDatabaseSensitivityLabelsClientGetOptions)`
...
- New function `*ManagedDatabaseSensitivityLabelsClient.GetRecommended(context.Context, string, string, string, string, string, string, *ManagedDatabaseSensitivityLabelsClientGetRecommendedOptions) (ManagedDatabaseSensitivityLabelsClientGetRecommendedResponse, error)`
