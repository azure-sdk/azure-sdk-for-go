...
// DataTypesClientListByParentResponse contains the response from method DataTypesClient.NewListByParentPager.
type DataTypesClientListByParentResponse struct {
