...
type ServicesServer struct {
	...
	CreateOrUpdate func(ctx context.Context, resourceGroupName string, serviceName string, payload armapicenter.Service, options *armapicenter.ServicesClientCreateOrUpdateOptions) (resp azfake.Responder[armapicenter.ServicesClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)
