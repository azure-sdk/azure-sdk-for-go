...
// EvidenceClient contains the methods for the Microsoft.AppComplianceAutomation namespace.
...
func (client *EvidenceClient) CreateOrUpdate(ctx context.Context, reportName string, evidenceName string, parameters EvidenceResource, options *EvidenceClientCreateOrUpdateOptions) (EvidenceClientCreateOrUpdateResponse, error) {
	var err error
	const operationName = "EvidenceClient.CreateOrUpdate"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.createOrUpdateCreateRequest(ctx, reportName, evidenceName, parameters, options)
	if err != nil {
...
func (client *EvidenceClient) createOrUpdateCreateRequest(ctx context.Context, reportName string, evidenceName string, parameters EvidenceResource, options *EvidenceClientCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *EvidenceClient) deleteCreateRequest(ctx context.Context, reportName string, evidenceName string, _ *EvidenceClientDeleteOptions) (*policy.Request, error) {
	urlPath := "/providers/Microsoft.AppComplianceAutomation/reports/{reportName}/evidences/{evidenceName}"
	if reportName == "" {
		return nil, errors.New("parameter reportName cannot be empty")
	}
...
func (client *EvidenceClient) downloadCreateRequest(ctx context.Context, reportName string, evidenceName string, body EvidenceFileDownloadRequest, _ *EvidenceClientDownloadOptions) (*policy.Request, error) {
...
func (client *EvidenceClient) getCreateRequest(ctx context.Context, reportName string, evidenceName string, _ *EvidenceClientGetOptions) (*policy.Request, error) {
	urlPath := "/providers/Microsoft.AppComplianceAutomation/reports/{reportName}/evidences/{evidenceName}"
	if reportName == "" {
		return nil, errors.New("parameter reportName cannot be empty")
	}
...
// NewListByReportResourcePager - Returns a paginated list of evidences for a specified report.
//
// Generated from API version 2024-06-27
//   - reportName - Report Name.
//   - options - EvidenceClientListByReportResourceOptions contains the optional parameters for the EvidenceClient.NewListByReportResourcePager
//     method.
func (client *EvidenceClient) NewListByReportResourcePager(reportName string, options *EvidenceClientListByReportResourceOptions) *runtime.Pager[EvidenceClientListByReportResourceResponse] {
	return runtime.NewPager(runtime.PagingHandler[EvidenceClientListByReportResourceResponse]{
		More: func(page EvidenceClientListByReportResourceResponse) bool {
			return page.NextLink != nil && len(*page.NextLink) > 0
		},
		Fetcher: func(ctx context.Context, page *EvidenceClientListByReportResourceResponse) (EvidenceClientListByReportResourceResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "EvidenceClient.NewListByReportResourcePager")
			nextLink := ""
			if page != nil {
			...
			if err != nil {
				return EvidenceClientListByReportResourceResponse{}, err
			}
...
func (client *EvidenceClient) listByReportResourceCreateRequest(ctx context.Context, reportName string, options *EvidenceClientListByReportResourceOptions) (*policy.Request, error) {
...
func (client *EvidenceClient) listByReportResourceHandleResponse(resp *http.Response) (EvidenceClientListByReportResourceResponse, error) {
	result := EvidenceClientListByReportResourceResponse{}
