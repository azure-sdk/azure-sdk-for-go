...
type PrivateCloudsServer struct {
	...
	// HTTP status codes to indicate success: http.StatusOK
	NewListByResourceGroupPager func(resourceGroupName string, options *armavs.PrivateCloudsClientListByResourceGroupOptions) (resp azfake.PagerResponder[armavs.PrivateCloudsClientListByResourceGroupResponse])
