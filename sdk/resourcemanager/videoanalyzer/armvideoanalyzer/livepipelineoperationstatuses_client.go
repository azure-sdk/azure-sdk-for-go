...
func (client *LivePipelineOperationStatusesClient) Get(ctx context.Context, resourceGroupName string, accountName string, livePipelineName string, operationID string, options *LivePipelineOperationStatusesClientGetOptions) (LivePipelineOperationStatusesClientGetResponse, error) {
	var err error
	const operationName = "LivePipelineOperationStatusesClient.Get"
...
func (client *LivePipelineOperationStatusesClient) getCreateRequest(ctx context.Context, resourceGroupName string, accountName string, livePipelineName string, operationID string, _ *LivePipelineOperationStatusesClientGetOptions) (*policy.Request, error) {
