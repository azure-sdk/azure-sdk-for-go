...
func (client *CustomizationPoliciesClient) getCreateRequest(ctx context.Context, regionID string, pcName string, customizationPolicyName string, _ *CustomizationPoliciesClientGetOptions) (*policy.Request, error) {
