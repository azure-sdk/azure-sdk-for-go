...
func (s *SingleSignOnConfigurationsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if singleSignOnConfigurationsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = singleSignOnConfigurationsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to SingleSignOnConfigurationsServerTransport
var singleSignOnConfigurationsServerTransportInterceptor interface {
