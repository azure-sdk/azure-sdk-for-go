...
const (
	// AuthenticationModeMicrosoftEntraID - Microsot Entra ID authentication mode using Entra users assigned to the cluster and
...
const (
	// EntraPrincipalTypeServiePrincipal - Entra service principal type.
	EntraPrincipalTypeServiePrincipal EntraPrincipalType = "ServicePrincipal"
...
func PossibleEntraPrincipalTypeValues() []EntraPrincipalType {
	return []EntraPrincipalType{
		EntraPrincipalTypeServiePrincipal,
...
const (
	// UserRoleDatabaseOwner - Datbase owner role permissions on the target sccope.
