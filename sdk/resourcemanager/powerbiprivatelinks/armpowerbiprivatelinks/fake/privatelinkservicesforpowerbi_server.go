...
func (p *PrivateLinkServicesForPowerBIServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if privateLinkServicesForPowerBiServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = privateLinkServicesForPowerBiServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			case "PrivateLinkServicesForPowerBIClient.ListBySubscriptionID":
				res.resp, res.err = p.dispatchListBySubscriptionID(req)
			default:
...
// set this to conditionally intercept incoming requests to PrivateLinkServicesForPowerBIServerTransport
var privateLinkServicesForPowerBiServerTransportInterceptor interface {
