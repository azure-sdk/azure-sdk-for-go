...
// Generated from example definition: 2024-11-01-preview/ReservationOrderAliasCreate.json
func ExampleReservationOrderAliasResponsesClient_BeginCreate() {
	...
	poller, err := clientFactory.NewReservationOrderAliasResponsesClient().BeginCreate(ctx, "reservationOrderAlias123", armbillingbenefits.ReservationOrderAliasRequest{
	...
	// res = armbillingbenefits.ReservationOrderAliasResponsesClientCreateResponse{
...
// Generated from example definition: 2024-11-01-preview/ReservationOrderAliasGet.json
func ExampleReservationOrderAliasResponsesClient_Get() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	res, err := clientFactory.NewReservationOrderAliasResponsesClient().Get(ctx, "reservationOrderAlias123", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armbillingbenefits.ReservationOrderAliasResponsesClientGetResponse{
	// 	ReservationOrderAliasResponse: &armbillingbenefits.ReservationOrderAliasResponse{
	// 		Name: to.Ptr("reservationOrderAlias123"),
	// 		Type: to.Ptr("Microsoft.BillingBenefits/reservationOrderAliases"),
	// 		ID: to.Ptr("/providers/microsoft.billingbenefits/reservationOrderAliases/reservationOrderAlias123"),
