...
func ExampleConnectedClustersClient_BeginCreateOrReplace_createClusterAgentlessKindAwsExample() {
	...
	poller, err := clientFactory.NewConnectedClustersClient().BeginCreateOrReplace(ctx, "k8sc-rg", "testCluster", nil)
	if err != nil {
	...
	// res = armhybridkubernetes.ConnectedClustersClientCreateOrReplaceResponse{
...
func ExampleConnectedClustersClient_BeginCreateOrReplace_createClusterExample() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
...
func ExampleConnectedClustersClient_BeginCreateOrReplace_createClusterPrivateLinkExample() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
...
func ExampleConnectedClustersClient_BeginCreateOrReplace_createClusterKindExample() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
...
func ExampleConnectedClustersClient_BeginCreateOrReplace_updateClusterByPutExample() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
...
func ExampleConnectedClustersClient_BeginDelete() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	poller, err := clientFactory.NewConnectedClustersClient().BeginDelete(ctx, "k8sc-rg", "testCluster", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	res, err := poller.PollUntilDone(ctx, nil)
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armhybridkubernetes.ConnectedClustersClientDeleteResponse{
	// }
}

// Generated from example definition: 2024-12-01-preview/GetClusterExample.json
func ExampleConnectedClustersClient_Get_getClusterExample() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	res, err := clientFactory.NewConnectedClustersClient().Get(ctx, "k8sc-rg", "testCluster", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armhybridkubernetes.ConnectedClustersClientGetResponse{
	// 	ConnectedCluster: &armhybridkubernetes.ConnectedCluster{
	// 		Name: to.Ptr("connectedCluster1"),
	// 		Type: to.Ptr("Microsoft.Kubernetes/connectedClusters"),
	// 		ID: to.Ptr("/subscriptions/1bfbb5d0-917e-4346-9026-1d3b344417f5/resourceGroups/akkeshar/providers/Microsoft.Kubernetes/connectedClusters/connectedCluster1"),
...
func ExampleConnectedClustersClient_Get_getProvisionedClusterExample() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
...
func ExampleConnectedClustersClient_NewListByResourceGroupPager() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	pager := clientFactory.NewConnectedClustersClient().NewListByResourceGroupPager("k8sc-rg", nil)
	for pager.More() {
		...
		// page = armhybridkubernetes.ConnectedClustersClientListByResourceGroupResponse{
...
func ExampleConnectedClustersClient_NewListBySubscriptionPager() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	pager := clientFactory.NewConnectedClustersClient().NewListBySubscriptionPager(nil)
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armhybridkubernetes.ConnectedClustersClientListBySubscriptionResponse{
		// 	ConnectedClusterList: armhybridkubernetes.ConnectedClusterList{
		// 		NextLink: to.Ptr("https://serviceRoot/subscriptions/subId/resourcegroups/resourceGroupName/providers/Microsoft.Kubernetes/connectedClusters?api-version=2019-11-01-preview&$skiptoken=X'12345'"),
		// 		Value: []*armhybridkubernetes.ConnectedCluster{
		// 			{
...
func ExampleConnectedClustersClient_ListClusterUserCredential_listClusterUserCredentialExample() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	res, err := clientFactory.NewConnectedClustersClient().ListClusterUserCredential(ctx, "k8sc-rg", "testCluster", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armhybridkubernetes.ConnectedClustersClientListClusterUserCredentialResponse{
...
func ExampleConnectedClustersClient_ListClusterUserCredential_listClusterUserCredentialNonAadExample() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
...
func ExampleConnectedClustersClient_ListClusterUserCredential_listClusterUserCredentialCspExample() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
...
func ExampleConnectedClustersClient_ListClusterUserCredential_listClusterUserCredentialNonAadCspExample() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
...
func ExampleConnectedClustersClient_Update() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	res, err := clientFactory.NewConnectedClustersClient().Update(ctx, "k8sc-rg", "testCluster", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armhybridkubernetes.ConnectedClustersClientUpdateResponse{
	// 	ConnectedCluster: &armhybridkubernetes.ConnectedCluster{
	// 		Name: to.Ptr("connectedCluster1"),
	// 		Type: to.Ptr("Microsoft.Kubernetes/connectedClusters"),
	// 		ID: to.Ptr("/subscriptions/1bfbb5d0-917e-4346-9026-1d3b344417f5/resourceGroups/akkeshar/providers/Microsoft.Kubernetes/connectedClusters/connectedCluster1"),
