...
// ResourceSyncRulesClientUpdateOptions contains the optional parameters for the ResourceSyncRulesClient.Update method.
type ResourceSyncRulesClientUpdateOptions struct {
	// placeholder for future optional parameters
}
