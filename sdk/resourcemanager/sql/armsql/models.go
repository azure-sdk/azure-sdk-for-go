...
type DatabaseOperationProperties struct {
	...
	// READ-ONLY; The operation phase code.
	PhaseCode *int32 `json:"phaseCode,omitempty" azure:"ro"`

	// READ-ONLY; The operation phase description.
	PhaseDescription *string `json:"phaseDescription,omitempty" azure:"ro"`
