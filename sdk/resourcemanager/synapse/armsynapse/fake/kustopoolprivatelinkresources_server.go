...
func (k *KustoPoolPrivateLinkResourcesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if kustoPoolPrivateLinkResourcesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = kustoPoolPrivateLinkResourcesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to KustoPoolPrivateLinkResourcesServerTransport
var kustoPoolPrivateLinkResourcesServerTransportInterceptor interface {
