...
type AFDDomainProperties struct {
	...
	// different profiles.
	ReferencedRoutePath *AFDDomainReferencedRoutePathList `json:"referencedRoutePath,omitempty" azure:"ro"`
...
type AFDDomainReferencedRoutePath struct {
	...
	Route *ResourceReference `json:"route,omitempty"`
}

// AFDDomainReferencedRoutePathList - The JSON object list that contains the overall picture of how routes are used for the
// shared custom domain across different profiles.
type AFDDomainReferencedRoutePathList struct {
	// List of route configuration of the shared custom domain.
	Value []*AFDDomainReferencedRoutePath `json:"value,omitempty"`
}
