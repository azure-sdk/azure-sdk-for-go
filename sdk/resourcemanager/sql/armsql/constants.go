...
const (
	ServerCreateModeDatabaseMigrationV1 ServerCreateMode = "DatabaseMigrationV1"
	ServerCreateModeNormal              ServerCreateMode = "Normal"
	ServerCreateModeRestore             ServerCreateMode = "Restore"
	ServerCreateModeServerMigration     ServerCreateMode = "ServerMigration"
	ServerCreateModeServerMigrationV1   ServerCreateMode = "ServerMigrationV1"
	ServerCreateModeStandby             ServerCreateMode = "Standby"
)
...
func PossibleServerCreateModeValues() []ServerCreateMode {
	return []ServerCreateMode{
		ServerCreateModeDatabaseMigrationV1,
		ServerCreateModeNormal,
		ServerCreateModeRestore,
		ServerCreateModeServerMigration,
		ServerCreateModeServerMigrationV1,
		ServerCreateModeStandby,
	}
}
