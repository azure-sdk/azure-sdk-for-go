...
// PolicyDefinitionVersionsServer is a fake server for instances of the armdeploymentscripts.PolicyDefinitionVersionsClient type.
type PolicyDefinitionVersionsServer struct {
	...
	CreateOrUpdate func(ctx context.Context, policyDefinitionName string, policyDefinitionVersion string, parameters armdeploymentscripts.PolicyDefinitionVersion, options *armdeploymentscripts.PolicyDefinitionVersionsClientCreateOrUpdateOptions) (resp azfake.Responder[armdeploymentscripts.PolicyDefinitionVersionsClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)

	// CreateOrUpdateAtManagementGroup is the fake for method PolicyDefinitionVersionsClient.CreateOrUpdateAtManagementGroup
	// HTTP status codes to indicate success: http.StatusOK, http.StatusCreated
	CreateOrUpdateAtManagementGroup func(ctx context.Context, managementGroupName string, policyDefinitionName string, policyDefinitionVersion string, parameters armdeploymentscripts.PolicyDefinitionVersion, options *armdeploymentscripts.PolicyDefinitionVersionsClientCreateOrUpdateAtManagementGroupOptions) (resp azfake.Responder[armdeploymentscripts.PolicyDefinitionVersionsClientCreateOrUpdateAtManagementGroupResponse], errResp azfake.ErrorResponder)

	// Delete is the fake for method PolicyDefinitionVersionsClient.Delete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	Delete func(ctx context.Context, policyDefinitionName string, policyDefinitionVersion string, options *armdeploymentscripts.PolicyDefinitionVersionsClientDeleteOptions) (resp azfake.Responder[armdeploymentscripts.PolicyDefinitionVersionsClientDeleteResponse], errResp azfake.ErrorResponder)

	// DeleteAtManagementGroup is the fake for method PolicyDefinitionVersionsClient.DeleteAtManagementGroup
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	DeleteAtManagementGroup func(ctx context.Context, managementGroupName string, policyDefinitionName string, policyDefinitionVersion string, options *armdeploymentscripts.PolicyDefinitionVersionsClientDeleteAtManagementGroupOptions) (resp azfake.Responder[armdeploymentscripts.PolicyDefinitionVersionsClientDeleteAtManagementGroupResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method PolicyDefinitionVersionsClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, policyDefinitionName string, policyDefinitionVersion string, options *armdeploymentscripts.PolicyDefinitionVersionsClientGetOptions) (resp azfake.Responder[armdeploymentscripts.PolicyDefinitionVersionsClientGetResponse], errResp azfake.ErrorResponder)

	// GetAtManagementGroup is the fake for method PolicyDefinitionVersionsClient.GetAtManagementGroup
	// HTTP status codes to indicate success: http.StatusOK
	GetAtManagementGroup func(ctx context.Context, managementGroupName string, policyDefinitionName string, policyDefinitionVersion string, options *armdeploymentscripts.PolicyDefinitionVersionsClientGetAtManagementGroupOptions) (resp azfake.Responder[armdeploymentscripts.PolicyDefinitionVersionsClientGetAtManagementGroupResponse], errResp azfake.ErrorResponder)

	// GetBuiltIn is the fake for method PolicyDefinitionVersionsClient.GetBuiltIn
	// HTTP status codes to indicate success: http.StatusOK
	GetBuiltIn func(ctx context.Context, policyDefinitionName string, policyDefinitionVersion string, options *armdeploymentscripts.PolicyDefinitionVersionsClientGetBuiltInOptions) (resp azfake.Responder[armdeploymentscripts.PolicyDefinitionVersionsClientGetBuiltInResponse], errResp azfake.ErrorResponder)

	// NewListPager is the fake for method PolicyDefinitionVersionsClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(policyDefinitionName string, options *armdeploymentscripts.PolicyDefinitionVersionsClientListOptions) (resp azfake.PagerResponder[armdeploymentscripts.PolicyDefinitionVersionsClientListResponse])

	// ListAll is the fake for method PolicyDefinitionVersionsClient.ListAll
	// HTTP status codes to indicate success: http.StatusOK
	ListAll func(ctx context.Context, options *armdeploymentscripts.PolicyDefinitionVersionsClientListAllOptions) (resp azfake.Responder[armdeploymentscripts.PolicyDefinitionVersionsClientListAllResponse], errResp azfake.ErrorResponder)

	// ListAllAtManagementGroup is the fake for method PolicyDefinitionVersionsClient.ListAllAtManagementGroup
	// HTTP status codes to indicate success: http.StatusOK
	ListAllAtManagementGroup func(ctx context.Context, managementGroupName string, options *armdeploymentscripts.PolicyDefinitionVersionsClientListAllAtManagementGroupOptions) (resp azfake.Responder[armdeploymentscripts.PolicyDefinitionVersionsClientListAllAtManagementGroupResponse], errResp azfake.ErrorResponder)

	// ListAllBuiltins is the fake for method PolicyDefinitionVersionsClient.ListAllBuiltins
	// HTTP status codes to indicate success: http.StatusOK
	ListAllBuiltins func(ctx context.Context, options *armdeploymentscripts.PolicyDefinitionVersionsClientListAllBuiltinsOptions) (resp azfake.Responder[armdeploymentscripts.PolicyDefinitionVersionsClientListAllBuiltinsResponse], errResp azfake.ErrorResponder)

	// NewListBuiltInPager is the fake for method PolicyDefinitionVersionsClient.NewListBuiltInPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListBuiltInPager func(policyDefinitionName string, options *armdeploymentscripts.PolicyDefinitionVersionsClientListBuiltInOptions) (resp azfake.PagerResponder[armdeploymentscripts.PolicyDefinitionVersionsClientListBuiltInResponse])

	// NewListByManagementGroupPager is the fake for method PolicyDefinitionVersionsClient.NewListByManagementGroupPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByManagementGroupPager func(managementGroupName string, policyDefinitionName string, options *armdeploymentscripts.PolicyDefinitionVersionsClientListByManagementGroupOptions) (resp azfake.PagerResponder[armdeploymentscripts.PolicyDefinitionVersionsClientListByManagementGroupResponse])
}
...
// The returned PolicyDefinitionVersionsServerTransport instance is connected to an instance of armdeploymentscripts.PolicyDefinitionVersionsClient via the
...
func NewPolicyDefinitionVersionsServerTransport(srv *PolicyDefinitionVersionsServer) *PolicyDefinitionVersionsServerTransport {
	return &PolicyDefinitionVersionsServerTransport{
		srv:                           srv,
		newListPager:                  newTracker[azfake.PagerResponder[armdeploymentscripts.PolicyDefinitionVersionsClientListResponse]](),
		newListBuiltInPager:           newTracker[azfake.PagerResponder[armdeploymentscripts.PolicyDefinitionVersionsClientListBuiltInResponse]](),
		newListByManagementGroupPager: newTracker[azfake.PagerResponder[armdeploymentscripts.PolicyDefinitionVersionsClientListByManagementGroupResponse]](),
	}
}

// PolicyDefinitionVersionsServerTransport connects instances of armdeploymentscripts.PolicyDefinitionVersionsClient to instances of PolicyDefinitionVersionsServer.
...
type PolicyDefinitionVersionsServerTransport struct {
	...
	newListPager                  *tracker[azfake.PagerResponder[armdeploymentscripts.PolicyDefinitionVersionsClientListResponse]]
	newListBuiltInPager           *tracker[azfake.PagerResponder[armdeploymentscripts.PolicyDefinitionVersionsClientListBuiltInResponse]]
	newListByManagementGroupPager *tracker[azfake.PagerResponder[armdeploymentscripts.PolicyDefinitionVersionsClientListByManagementGroupResponse]]
}
...
func (p *PolicyDefinitionVersionsServerTransport) dispatchCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[armdeploymentscripts.PolicyDefinitionVersion](req)
	if err != nil {
		return nil, err
	}
...
func (p *PolicyDefinitionVersionsServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		var options *armdeploymentscripts.PolicyDefinitionVersionsClientListOptions
		if topParam != nil {
			options = &armdeploymentscripts.PolicyDefinitionVersionsClientListOptions{
				Top: topParam,
			}
		}
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armdeploymentscripts.PolicyDefinitionVersionsClientListResponse, createLink func() string) {
...
func (p *PolicyDefinitionVersionsServerTransport) dispatchNewListBuiltInPager(req *http.Request) (*http.Response, error) {
	...
	if newListBuiltInPager == nil {
		...
		var options *armdeploymentscripts.PolicyDefinitionVersionsClientListBuiltInOptions
		if topParam != nil {
			options = &armdeploymentscripts.PolicyDefinitionVersionsClientListBuiltInOptions{
				Top: topParam,
			}
		}
		...
		server.PagerResponderInjectNextLinks(newListBuiltInPager, req, func(page *armdeploymentscripts.PolicyDefinitionVersionsClientListBuiltInResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
...
func (p *PolicyDefinitionVersionsServerTransport) dispatchNewListByManagementGroupPager(req *http.Request) (*http.Response, error) {
	...
	if newListByManagementGroupPager == nil {
		...
		var options *armdeploymentscripts.PolicyDefinitionVersionsClientListByManagementGroupOptions
		if topParam != nil {
			options = &armdeploymentscripts.PolicyDefinitionVersionsClientListByManagementGroupOptions{
				Top: topParam,
			}
		}
		...
		server.PagerResponderInjectNextLinks(newListByManagementGroupPager, req, func(page *armdeploymentscripts.PolicyDefinitionVersionsClientListByManagementGroupResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
