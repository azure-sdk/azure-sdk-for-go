...
func (client *ServerInstancesClient) listBySAPInstanceCreateRequest(ctx context.Context, resourceGroupName string, sapDiscoverySiteName string, sapInstanceName string, _ *ServerInstancesClientListBySAPInstanceOptions) (*policy.Request, error) {
