...
// ErrorAdditionalInfo - Additional information about an error.
type ErrorAdditionalInfo struct {
	// READ-ONLY; The additional error information.
	Info any

	// READ-ONLY; The type of the additional error information.
	Type *string
}

// ErrorDetail - The error object detail.
