...
- New field `FirewallPolicySize` in struct `FirewallPolicyPropertiesFormat`
- New field `RuleCollectionGroupSize` in struct `FirewallPolicyRuleCollectionGroupProperties`
