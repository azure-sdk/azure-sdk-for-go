...
type IntegrationServiceEnvironmentSKUsServer struct {
	...
	NewListPager func(integrationServiceEnvironmentName string, options *armlogic.IntegrationServiceEnvironmentSKUsClientListOptions) (resp azfake.PagerResponder[armlogic.IntegrationServiceEnvironmentSKUsClientListResponse])
}
...
func (i *IntegrationServiceEnvironmentSKUsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if integrationServiceEnvironmentSkUsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = integrationServiceEnvironmentSkUsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to IntegrationServiceEnvironmentSKUsServerTransport
var integrationServiceEnvironmentSkUsServerTransportInterceptor interface {
