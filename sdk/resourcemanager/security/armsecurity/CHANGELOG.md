...
- Operation `*ContactsClient.NewListPager` does not support pagination anymore, use `*ContactsClient.List` instead.
...
- Field `NextLink` of struct `ContactList` has been removed
...
- New function `*APICollectionsClient.Create(context.Context, string, string, string, *APICollectionsClientCreateOptions) (APICollectionsClientCreateResponse, error)`
- New function `*APICollectionsClient.Delete(context.Context, string, string, string, *APICollectionsClientDeleteOptions) (APICollectionsClientDeleteResponse, error)`
- New function `*APICollectionsClient.Get(context.Context, string, string, string, *APICollectionsClientGetOptions) (APICollectionsClientGetResponse, error)`
- New function `*APICollectionsClient.NewListPager(string, string, *APICollectionsClientListOptions) *runtime.Pager[APICollectionsClientListResponse]`
