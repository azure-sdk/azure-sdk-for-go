...
func (s *SubAssessmentsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if subAssessmentsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = subAssessmentsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to SubAssessmentsServerTransport
var subAssessmentsServerTransportInterceptor interface {
