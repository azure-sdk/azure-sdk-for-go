...
func (c *CheckScopedNameAvailabilityServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if checkScopedNameAvailabilityServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = checkScopedNameAvailabilityServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to CheckScopedNameAvailabilityServerTransport
var checkScopedNameAvailabilityServerTransportInterceptor interface {
