...
- Struct `MarkdownPartMetadataSettingsContentSettings` has been removed
...
- Field `Settings` of struct `MarkdownPartMetadataSettingsContent` has been removed
...
- New field `Content`, `MarkdownSource`, `MarkdownURI`, `Subtitle`, `Title` in struct `MarkdownPartMetadataSettingsContent`
