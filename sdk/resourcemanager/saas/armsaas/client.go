...
func (client *Client) createResourceCreateRequest(ctx context.Context, parameters ResourceCreation, _ *ClientBeginCreateResourceOptions) (*policy.Request, error) {
...
func (client *Client) deleteCreateRequest(ctx context.Context, resourceID string, parameters DeleteOptions, _ *ClientBeginDeleteOptions) (*policy.Request, error) {
...
func (client *Client) getResourceCreateRequest(ctx context.Context, resourceID string, _ *ClientGetResourceOptions) (*policy.Request, error) {
	urlPath := "/providers/Microsoft.SaaS/saasresources/{resourceId}"
	if resourceID == "" {
		return nil, errors.New("parameter resourceID cannot be empty")
	}
...
func (client *Client) updateResourceCreateRequest(ctx context.Context, resourceID string, parameters ResourceCreation, _ *ClientBeginUpdateResourceOptions) (*policy.Request, error) {
	urlPath := "/providers/Microsoft.SaaS/saasresources/{resourceId}"
	if resourceID == "" {
		return nil, errors.New("parameter resourceID cannot be empty")
	}
