...
func (w *WaitStatisticsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if waitStatisticsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = waitStatisticsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "WaitStatisticsClient.NewListByServerPager":
				res.resp, res.err = w.dispatchNewListByServerPager(req)
			default:
...
// set this to conditionally intercept incoming requests to WaitStatisticsServerTransport
var waitStatisticsServerTransportInterceptor interface {
