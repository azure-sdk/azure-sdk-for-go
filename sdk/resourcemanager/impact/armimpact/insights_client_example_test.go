...
func ExampleInsightsClient_Create() {
	...
	res, err := clientFactory.NewInsightsClient().Create(ctx, "impactid22", "insightId12", armimpact.Insight{
		Properties: &armimpact.InsightProperties{
			Content: &armimpact.Content{
	...
	// res = armimpact.InsightsClientCreateResponse{
	// 	Insight: &armimpact.Insight{
...
func ExampleInsightsClient_Delete() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armimpact.InsightsClientDeleteResponse{
	// }
}
...
func ExampleInsightsClient_Get_getInsightSampleForDiagnosticsCategory() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armimpact.InsightsClientGetResponse{
	// 	Insight: &armimpact.Insight{
...
func ExampleInsightsClient_Get_getInsightSampleForMitigationActionCategory() {
	...
	// 			},
	// 			AdditionalDetails: &armimpact.InsightPropertiesAdditionalDetails{
	// 			},
	// 		},
	// 	},
	// }
...
func ExampleInsightsClient_NewListBySubscriptionPager() {
	...
	for pager.More() {
		...
		// page = armimpact.InsightsClientListBySubscriptionResponse{
		// 	InsightListResult: armimpact.InsightListResult{
		// 		Value: []*armimpact.Insight{
		// 			{
		// 				ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/providers/microsoft.Impact/workloadImpacts/impactid22/insights/insightId12"),
		// 				Name: to.Ptr("insightId12"),
		// 				Type: to.Ptr("Microsoft.Impact/insights"),
