...
func (a *AssetTrackOperationResultsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if assetTrackOperationResultsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = assetTrackOperationResultsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to AssetTrackOperationResultsServerTransport
var assetTrackOperationResultsServerTransportInterceptor interface {
