...
// supported for Microsoft Customer Agreements (MCA) and Enterprise Agreement (EA) billing accounts.
//
...
func (client *LotsClient) listByBillingAccountCreateRequest(ctx context.Context, billingAccountID string, options *LotsClientListByBillingAccountOptions) (*policy.Request, error) {
	...
	if options != nil && options.ExtendedProperties != nil {
		reqQP.Set("extendedProperties", strconv.FormatBool(*options.ExtendedProperties))
	}
