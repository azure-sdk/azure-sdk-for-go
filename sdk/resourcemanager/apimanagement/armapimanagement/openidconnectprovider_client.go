...
// serviceName - The name of the API Management service.
// opid - Identifier of the OpenID Connect Provider.
// ifMatch - The entity state (Etag) version of the OpenID Connect Provider to delete. A value of "*" can be used for If-Match
...
// NewListByServicePager - Lists all OpenID Connect Providers.
// If the operation fails it returns an *azcore.ResponseError type.
// Generated from API version 2022-01-09
// resourceGroupName - The name of the resource group.
// serviceName - The name of the API Management service.
...
// serviceName - The name of the API Management service.
// opid - Identifier of the OpenID Connect Provider.
// ifMatch - The entity state (Etag) version of the OpenID Connect Provider to update. A value of "*" can be used for If-Match
// to unconditionally apply the operation.
...
func (client *OpenIDConnectProviderClient) Update(ctx context.Context, resourceGroupName string, serviceName string, opid string, ifMatch string, parameters OpenidConnectProviderUpdateContract, options *OpenIDConnectProviderClientUpdateOptions) (OpenIDConnectProviderClientUpdateResponse, error) {
	...
	return OpenIDConnectProviderClientUpdateResponse{}, nil
}
