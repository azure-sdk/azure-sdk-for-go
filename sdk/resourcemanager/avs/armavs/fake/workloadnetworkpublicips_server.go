...
type WorkloadNetworkPublicIPsServer struct {
	...
	// NewListPager is the fake for method WorkloadNetworkPublicIPsClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(resourceGroupName string, privateCloudName string, options *armavs.WorkloadNetworkPublicIPsClientListOptions) (resp azfake.PagerResponder[armavs.WorkloadNetworkPublicIPsClientListResponse])
}
...
func NewWorkloadNetworkPublicIPsServerTransport(srv *WorkloadNetworkPublicIPsServer) *WorkloadNetworkPublicIPsServerTransport {
	return &WorkloadNetworkPublicIPsServerTransport{
		...
		newListPager: newTracker[azfake.PagerResponder[armavs.WorkloadNetworkPublicIPsClientListResponse]](),
	}
}
...
type WorkloadNetworkPublicIPsServerTransport struct {
	...
	newListPager *tracker[azfake.PagerResponder[armavs.WorkloadNetworkPublicIPsClientListResponse]]
}
...
func (w *WorkloadNetworkPublicIPsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if workloadNetworkPublicIPsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = workloadNetworkPublicIPsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "WorkloadNetworkPublicIPsClient.NewListPager":
...
func (w *WorkloadNetworkPublicIPsServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armavs.WorkloadNetworkPublicIPsClientListResponse, createLink func() string) {
...
// set this to conditionally intercept incoming requests to WorkloadNetworkPublicIPsServerTransport
var workloadNetworkPublicIPsServerTransportInterceptor interface {
