...
// NewListByResourceGroupPager - List Frontend resources by TrafficController
//
// Generated from API version 2024-05-01-preview
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - trafficControllerName - traffic controller name for path
//   - options - FrontendsInterfaceClientListByResourceGroupOptions contains the optional parameters for the FrontendsInterfaceClient.NewListByResourceGroupPager
//     method.
func (client *FrontendsInterfaceClient) NewListByResourceGroupPager(resourceGroupName string, trafficControllerName string, options *FrontendsInterfaceClientListByResourceGroupOptions) *runtime.Pager[FrontendsInterfaceClientListByResourceGroupResponse] {
	return runtime.NewPager(runtime.PagingHandler[FrontendsInterfaceClientListByResourceGroupResponse]{
		More: func(page FrontendsInterfaceClientListByResourceGroupResponse) bool {
			return page.NextLink != nil && len(*page.NextLink) > 0
		},
		Fetcher: func(ctx context.Context, page *FrontendsInterfaceClientListByResourceGroupResponse) (FrontendsInterfaceClientListByResourceGroupResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "FrontendsInterfaceClient.NewListByResourceGroupPager")
			nextLink := ""
			if page != nil {
			...
			if err != nil {
				return FrontendsInterfaceClientListByResourceGroupResponse{}, err
			}
...
func (client *FrontendsInterfaceClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, trafficControllerName string, _ *FrontendsInterfaceClientListByResourceGroupOptions) (*policy.Request, error) {
...
func (client *FrontendsInterfaceClient) listByResourceGroupHandleResponse(resp *http.Response) (FrontendsInterfaceClientListByResourceGroupResponse, error) {
	result := FrontendsInterfaceClientListByResourceGroupResponse{}
...
//     method.
func (client *FrontendsInterfaceClient) Update(ctx context.Context, resourceGroupName string, trafficControllerName string, frontendName string, properties Frontend, options *FrontendsInterfaceClientUpdateOptions) (FrontendsInterfaceClientUpdateResponse, error) {
	var err error
...
func (client *FrontendsInterfaceClient) updateCreateRequest(ctx context.Context, resourceGroupName string, trafficControllerName string, frontendName string, properties Frontend, _ *FrontendsInterfaceClientUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceNetworking/trafficControllers/{trafficControllerName}/frontends/{frontendName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
