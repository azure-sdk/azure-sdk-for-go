...
type PreviewAlertRuleRequest struct {
	// REQUIRED; The alert rule to preview.
	AlertRule *LogAlertRuleResource

	// REQUIRED; The query parameter that specifies the lookback of the preview.
	LookbackPeriod *string

	// REQUIRED; The query parameter that specifies rule type to be previewed.
	RuleType *string
}
