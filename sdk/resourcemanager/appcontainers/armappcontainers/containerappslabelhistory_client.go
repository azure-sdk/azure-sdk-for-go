...
func (client *ContainerAppsLabelHistoryClient) DeleteLabelHistory(ctx context.Context, resourceGroupName string, containerAppName string, labelName string, options *ContainerAppsLabelHistoryClientDeleteLabelHistoryOptions) (ContainerAppsLabelHistoryClientDeleteLabelHistoryResponse, error) {
	...
	if !runtime.HasStatusCode(httpResp, http.StatusNoContent, http.StatusConflict) {
...
func (client *ContainerAppsLabelHistoryClient) deleteLabelHistoryCreateRequest(ctx context.Context, resourceGroupName string, containerAppName string, labelName string, options *ContainerAppsLabelHistoryClientDeleteLabelHistoryOptions) (*policy.Request, error) {
...
func (client *ContainerAppsLabelHistoryClient) getLabelHistoryCreateRequest(ctx context.Context, resourceGroupName string, containerAppName string, labelName string, options *ContainerAppsLabelHistoryClientGetLabelHistoryOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.App/containerApps/{containerAppName}/labelHistory/{labelName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
