...
// NewGetPager - Gets a private link resource for cluster.
...
// method.
func (client *PrivateLinkResourcesClient) NewGetPager(resourceGroupName string, clusterName string, privateLinkResourceName string, options *PrivateLinkResourcesClientGetOptions) *runtime.Pager[PrivateLinkResourcesClientGetResponse] {
