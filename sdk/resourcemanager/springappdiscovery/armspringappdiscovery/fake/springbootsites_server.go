...
func (s *SpringbootsitesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if springbootsitesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = springbootsitesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "SpringbootsitesClient.BeginTriggerRefreshSite":
				res.resp, res.err = s.dispatchBeginTriggerRefreshSite(req)
...
// set this to conditionally intercept incoming requests to SpringbootsitesServerTransport
var springbootsitesServerTransportInterceptor interface {
