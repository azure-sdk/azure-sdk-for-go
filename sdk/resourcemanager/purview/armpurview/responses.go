...
// UserAssignedIdentitiesClientAssignResponse contains the response from method UserAssignedIdentitiesClient.Assign.
type UserAssignedIdentitiesClientAssignResponse struct {
	// The Domain Scoped User Assigned Managed Identity of the resource
	DomainScopedUserAssignedIdentity
}
