...
type ServerFactory struct {
	...
	// TrustedIDProvidersServer contains the fakes for client TrustedIDProvidersClient
...
// The returned ServerFactoryTransport instance is connected to an instance of armdatalakestore.ClientFactory via the
...
// ServerFactoryTransport connects instances of armdatalakestore.ClientFactory to instances of ServerFactory.
...
type ServerFactoryTransport struct {
	...
	trTrustedIDProvidersServer  *TrustedIDProvidersServerTransport
...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "TrustedIDProvidersClient":
		initServer(s, &s.trTrustedIDProvidersServer, func() *TrustedIDProvidersServerTransport {
			return NewTrustedIDProvidersServerTransport(&s.srv.TrustedIDProvidersServer)
		})
		resp, err = s.trTrustedIDProvidersServer.Do(req)
