...
func (s *ServerEndpointsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if serverEndpointsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = serverEndpointsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "ServerEndpointsClient.BeginRecallAction":
				res.resp, res.err = s.dispatchBeginRecallAction(req)
...
// set this to conditionally intercept incoming requests to ServerEndpointsServerTransport
var serverEndpointsServerTransportInterceptor interface {
