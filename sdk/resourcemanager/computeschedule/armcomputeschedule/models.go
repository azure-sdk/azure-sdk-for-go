...
// ExecuteDeleteRequest - The ExecuteDeleteRequest request for delete operations
...
type ResourceProvisionPayload struct {
	// REQUIRED; Number of resources to be created
	ResourceCount *int32
...
// SubmitCreateRequest - The SubmitCreateRequest request for create operations
...
// SubmitDeleteRequest - The SubmitDeleteRequest request for delete operations
type SubmitDeleteRequest struct {
	// REQUIRED; The execution parameters for the request
	ExecutionParameters *ExecutionParameters
...
// VirtualMachineExtensionData - struct for VMExtension data
type VirtualMachineExtensionData struct {
	// REQUIRED; name of VM extension
	Name *string

	// REQUIRED; properties for VM extension e.g. publisher, version etc, value can dynamic int32,string, bool etc.
