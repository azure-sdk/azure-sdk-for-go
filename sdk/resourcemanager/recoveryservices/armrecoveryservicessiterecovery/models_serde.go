...
func (d *DisableProtectionInputProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "replicationProviderInput":
			err = unpopulate(val, "ReplicationProviderInput", &d.ReplicationProviderInput)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", d, err)
...
func (d DisableProtectionProviderSpecificInput) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	objectMap["instanceType"] = "DisableProtectionProviderSpecificInput"
	return json.Marshal(objectMap)
}
...
// MarshalJSON implements the json.Marshaller interface for type ProviderSpecificInput.
func (p ProviderSpecificInput) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	objectMap["instanceType"] = p.InstanceType
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ProviderSpecificInput.
func (p *ProviderSpecificInput) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", p, err)
	}
