...
- New field `ArtifactStreamingProfile`, `GpuProfile`, `VMIdentityProfile` in struct `ManagedClusterAgentPoolProfile`
- New field `ArtifactStreamingProfile`, `GpuProfile`, `VMIdentityProfile` in struct `ManagedClusterAgentPoolProfileProperties`
