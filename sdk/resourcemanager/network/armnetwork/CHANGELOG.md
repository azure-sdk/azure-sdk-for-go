...
- Function `*AdminRulesClient.CreateOrUpdate` parameter(s) have been changed from `(context.Context, string, string, string, string, string, BaseAdminRuleClassification, *AdminRulesClientCreateOrUpdateOptions)` to `(context.Context, string, string, string, string, string, AdminRule, *AdminRulesClientCreateOrUpdateOptions)`
- Type of `AdminRuleListResult.Value` has been changed from `[]BaseAdminRuleClassification` to `[]*AdminRule`
- Field `Etag` of struct `AdminRule` has been removed
- Field `Etag` of struct `AdminRuleCollection` has been removed
- Field `BaseAdminRuleClassification` of struct `AdminRulesClientCreateOrUpdateResponse` has been removed
- Field `BaseAdminRuleClassification` of struct `AdminRulesClientGetResponse` has been removed
...
- New anonymous field `AdminRule` in struct `AdminRulesClientCreateOrUpdateResponse`
- New anonymous field `AdminRule` in struct `AdminRulesClientGetResponse`
