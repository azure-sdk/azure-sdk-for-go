...
func NewWorkspaceAPIOperationPolicyClient(subscriptionID string, credential azcore.TokenCredential, options *arm.ClientOptions) (*WorkspaceAPIOperationPolicyClient, error) {
	cl, err := arm.NewClient(moduleName+".WorkspaceAPIOperationPolicyClient", moduleVersion, credential, options)
	if err != nil {
		return nil, err
	}
...
//     method.
func (client *WorkspaceAPIOperationPolicyClient) ListByOperation(ctx context.Context, resourceGroupName string, serviceName string, workspaceID string, apiID string, operationID string, options *WorkspaceAPIOperationPolicyClientListByOperationOptions) (WorkspaceAPIOperationPolicyClientListByOperationResponse, error) {
