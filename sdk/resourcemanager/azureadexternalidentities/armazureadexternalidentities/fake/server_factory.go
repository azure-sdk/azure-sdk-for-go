...
type ServerFactory struct {
	...
	ExternalTenantsServer                 ExternalTenantsServer
...
type ServerFactoryTransport struct {
	...
	trExternalTenantsServer                 *ExternalTenantsServerTransport
...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "ExternalTenantsClient":
		initServer(s, &s.trExternalTenantsServer, func() *ExternalTenantsServerTransport {
			return NewExternalTenantsServerTransport(&s.srv.ExternalTenantsServer)
		})
		resp, err = s.trExternalTenantsServer.Do(req)
