...
func (o *OriginGroupsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if originGroupsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = originGroupsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to OriginGroupsServerTransport
var originGroupsServerTransportInterceptor interface {
