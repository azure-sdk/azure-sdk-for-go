...
// AbapOsConnector - Describes the AbapOs connector configuration.
type AbapOsConnector struct {
	// REQUIRED; Represents the types of SAP systems.
	SapSystemType *SapSystemArmType

	// Represents the types of HTTPS configuration to connect to the JavaOs or SapControlOs system.
	HTTPSConfiguration *HTTPSConfigurationArmType
	Instance           *string
	Server             *string
	Severity           *int32
	Suffix             *string
...
// GetSystemsConfigurationConnector implements the SystemsConfigurationConnectorClassification interface for type AbapOsConnector.
func (a *AbapOsConnector) GetSystemsConfigurationConnector() *SystemsConfigurationConnector {
	return &SystemsConfigurationConnector{
		SapSystemType: a.SapSystemType,
	}
}
...
type AgentArmModel struct {
	// The name of the agent. only letters with numbers, underscores and hyphens are allowed example: "my-agent"
	AgentContainerName *string
	DisplayName        *string
	KeyVaultAuth       *KeyVaultAuthType
	...
	// READ-ONLY; The systems that installed in the agent.
	AgentsSystems []*AgentsSystemArmModel
...
type AgentsSystemArmModel struct {
	// The system instance ID inside the agent. Example: "0a16301c-5686-42f9-8575-4fe7b64598ba"
	AgentsSystemName *string

	// The SAP client ID. Example: "001"
	SapClientID *string

	// The SAP system ID. Example: "A4H"
	SapSystemID *string
}
...
type Content struct {
	// REQUIRED; Description of the content.
	Description *string
...
type CustomizableConnectorUIConfig struct {
	...
	// REQUIRED; Gets or sets the sample queries for the connector.
	...
	// Gets or sets the name of the table the connector will insert the data to. This name can be used in other queries by specifying
	// {{graphQueriesTableName}} placeholder in Query and LastDataReceivedQuery
	// values.
	GraphQueriesTableName *string
...
type InstructionStep struct {
	...
	// Gets or sets the inner instruction steps details. Foe Example: instruction step 1 might contain inner instruction steps:
...
type Instructions struct {
	// REQUIRED; What actions should be taken to complete the recommendation.
	ActionsToBePerformed *string

	// REQUIRED; Explains why the recommendation is important.
...
// JavaOsConnector - Describes the JavaOs connector configuration.
type JavaOsConnector struct {
	// REQUIRED; Represents the types of SAP systems.
	SapSystemType *SapSystemArmType
...
// GetSystemsConfigurationConnector implements the SystemsConfigurationConnectorClassification interface for type JavaOsConnector.
func (j *JavaOsConnector) GetSystemsConfigurationConnector() *SystemsConfigurationConnector {
	return &SystemsConfigurationConnector{
		SapSystemType: j.SapSystemType,
	}
}
...
// LogArmModel - Describes a log.
type LogArmModel struct {
	...
	// Types of ingestion.
	IngestionType *IngestionArmType
...
// NetWeaverConnector - Describes the NetWeaver connector.
type NetWeaverConnector struct {
	// REQUIRED; Client number of the ABAP server. Example - 001
	Client *string

	// REQUIRED; Represents the types of SAP systems.
	SapSystemType *SapSystemArmType

	// REQUIRED; System ID of the ABAP server. Example - A4H
	SystemID *string

	// REQUIRED; System number of the ABAP server.
	SystemNumber *string
	...
	AuthenticationType *AuthenticationArmType
...
// GetSystemsConfigurationConnector implements the SystemsConfigurationConnectorClassification interface for type NetWeaverConnector.
func (n *NetWeaverConnector) GetSystemsConfigurationConnector() *SystemsConfigurationConnector {
	return &SystemsConfigurationConnector{
		SapSystemType: n.SapSystemType,
	}
}
...
type Recommendation struct {
	// REQUIRED; List of actions to take for this recommendation.
	Actions []*RecommendedAction

	// REQUIRED; Category of the recommendation.
	Category *Category

	// REQUIRED; Context of the recommendation.
	Context *Context

	// REQUIRED; Description of the recommendation.
	Description *string

	// REQUIRED; id of recommendation.
	ID *string

	// REQUIRED; Instructions of the recommendation.
	Instructions *Instructions

	// REQUIRED; The time stamp (UTC) when the recommendation was last evaluated.
	LastEvaluatedTimeUTC *time.Time

	// REQUIRED; Priority of the recommendation.
	Priority *Priority

	// REQUIRED; Id of the recommendation type.
	RecommendationTypeID *string

	// REQUIRED; Title of the recommendation type.
	...
	// REQUIRED; Id of the workspace this recommendation refers to.
	WorkspaceID *string
...
// RecommendedAction - What actions should be taken to complete the recommendation.
type RecommendedAction struct {
	// REQUIRED; Text of the link to complete the action.
	LinkText *string

	// REQUIRED; The Link to complete the action.
	LinkURL *string
...
// SampleQuery - The sample queries for the connector.
type SampleQuery struct {
	// REQUIRED; Gets or sets the sample query description.
	Description *string

	// REQUIRED; Gets or sets the KQL sample query.
	Query *string
}
...
// SapSystemsConfiguration - Describes the SAP configuration.
type SapSystemsConfiguration struct {
	// REQUIRED; Represents the types of configuration for a system.
	ConfigurationType *ConfigurationArmType
	...
	// Base Model for API authentication - support kinds: Microsoft.Azure.Sentinel.BizApps.SystemsApiService.Controllers.Preview.Version202403_01.Models.Systems.SubModel.Enums.AuthenticationArmType
	// values.
	Connector SystemsConfigurationConnectorClassification

	// The connector configuration. Options are NetWeaver, JavaOs and AbapOs.
	Logs []*LogArmModel
}

// GetSystemsConfiguration implements the SystemsConfigurationClassification interface for type SapSystemsConfiguration.
func (s *SapSystemsConfiguration) GetSystemsConfiguration() *SystemsConfiguration {
...
type SystemArmModel struct {
	DisplayName *string

	// The configuration of the system.
	Sonfiguration SystemsConfigurationClassification
...
// SystemsConfiguration - The configuration of the system.
type SystemsConfiguration struct {
	// REQUIRED; Represents the types of configuration for a system.
	ConfigurationType *ConfigurationArmType
}

// GetSystemsConfiguration implements the SystemsConfigurationClassification interface for type SystemsConfiguration.
func (s *SystemsConfiguration) GetSystemsConfiguration() *SystemsConfiguration { return s }

// SystemsConfigurationConnector - Base Model for API authentication - support kinds: Microsoft.Azure.Sentinel.BizApps.SystemsApiService.Controllers.Preview.Version202403_01.Models.Systems.SubModel.Enums.AuthenticationArmType
// values.
type SystemsConfigurationConnector struct {
	// REQUIRED; Represents the types of SAP systems.
	SapSystemType *SapSystemArmType
}

// GetSystemsConfigurationConnector implements the SystemsConfigurationConnectorClassification interface for type SystemsConfigurationConnector.
func (s *SystemsConfigurationConnector) GetSystemsConfigurationConnector() *SystemsConfigurationConnector {
	return s
}
