...
func (client *VirtualMachinesClient) getCreateRequest(ctx context.Context, resourceGroupName string, labName string, virtualMachineName string, _ *VirtualMachinesClientGetOptions) (*policy.Request, error) {
...
func (client *VirtualMachinesClient) redeployCreateRequest(ctx context.Context, resourceGroupName string, labName string, virtualMachineName string, _ *VirtualMachinesClientBeginRedeployOptions) (*policy.Request, error) {
...
func (client *VirtualMachinesClient) reimageCreateRequest(ctx context.Context, resourceGroupName string, labName string, virtualMachineName string, _ *VirtualMachinesClientBeginReimageOptions) (*policy.Request, error) {
...
func (client *VirtualMachinesClient) resetPasswordCreateRequest(ctx context.Context, resourceGroupName string, labName string, virtualMachineName string, body ResetPasswordBody, _ *VirtualMachinesClientBeginResetPasswordOptions) (*policy.Request, error) {
...
func (client *VirtualMachinesClient) startCreateRequest(ctx context.Context, resourceGroupName string, labName string, virtualMachineName string, _ *VirtualMachinesClientBeginStartOptions) (*policy.Request, error) {
...
func (client *VirtualMachinesClient) stopCreateRequest(ctx context.Context, resourceGroupName string, labName string, virtualMachineName string, _ *VirtualMachinesClientBeginStopOptions) (*policy.Request, error) {
