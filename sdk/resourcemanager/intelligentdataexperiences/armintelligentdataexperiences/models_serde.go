...
// MarshalJSON implements the json.Marshaller interface for type DiagnosticSetting.
func (d DiagnosticSetting) MarshalJSON() ([]byte, error) {
...
// UnmarshalJSON implements the json.Unmarshaller interface for type DiagnosticSetting.
func (d *DiagnosticSetting) UnmarshalJSON(data []byte) error {
