...
func (client *ResourceLinksClient) createOrUpdateCreateRequest(ctx context.Context, linkID string, parameters ResourceLink, _ *ResourceLinksClientCreateOrUpdateOptions) (*policy.Request, error) {
	urlPath := "/{linkId}"
...
func (client *ResourceLinksClient) deleteCreateRequest(ctx context.Context, linkID string, _ *ResourceLinksClientDeleteOptions) (*policy.Request, error) {
	urlPath := "/{linkId}"
	urlPath = strings.ReplaceAll(urlPath, "{linkId}", linkID)
...
func (client *ResourceLinksClient) getCreateRequest(ctx context.Context, linkID string, _ *ResourceLinksClientGetOptions) (*policy.Request, error) {
	urlPath := "/{linkId}"
	urlPath = strings.ReplaceAll(urlPath, "{linkId}", linkID)
