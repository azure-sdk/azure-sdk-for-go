...
// KvResourceParameters - The parameters to define the key value resource scope that the SAS token is authorized to access.
type KvResourceParameters struct {
	// REQUIRED
...
// GetResourceParameters implements the ResourceParametersClassification interface for type KvResourceParameters.
func (k *KvResourceParameters) GetResourceParameters() *ResourceParameters {
...
// ResetSasTokensParameters - Parameters used for resetting SAS token.
type ResetSasTokensParameters struct {
...
// ResourceParameters - The parameters to define the data plane resource scope that the SAS token is authorized to access.
type ResourceParameters struct {
	// REQUIRED
	ResourceType *ResourceType
}

// GetResourceParameters implements the ResourceParametersClassification interface for type ResourceParameters.
func (r *ResourceParameters) GetResourceParameters() *ResourceParameters { return r }
...
type SasTokenGenerationParameters struct {
	...
	ResourceParameters ResourceParametersClassification
}
...
type SasTokenGenerationResult struct {
	...
	// READ-ONLY; The parameters to define the data plane resource scope.
	ResourceParameters ResourceParametersClassification
...
// SnapshotResourceParameters - The parameters to define the snapshot resource scope that the SAS token is authorized to access.
type SnapshotResourceParameters struct {
...
// GetResourceParameters implements the ResourceParametersClassification interface for type SnapshotResourceParameters.
func (s *SnapshotResourceParameters) GetResourceParameters() *ResourceParameters {
	return &ResourceParameters{
