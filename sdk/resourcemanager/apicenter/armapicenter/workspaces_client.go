...
func (client *WorkspacesClient) importAPISourceCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, workspaceName string, body ImportAPISourceRequest, options *WorkspacesClientBeginImportAPISourceOptions) (*policy.Request, error) {
