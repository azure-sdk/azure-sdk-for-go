...
// VMInstanceHybridIdentityMetadatasClient contains the methods for the Microsoft.ScVmm namespace.
...
func (client *VMInstanceHybridIdentityMetadatasClient) getCreateRequest(ctx context.Context, resourceURI string, _ *VMInstanceHybridIdentityMetadatasClientGetOptions) (*policy.Request, error) {
...
// NewListByVirtualMachineInstancePager - Implements GET HybridIdentityMetadata in a vm.
//
// Generated from API version 2023-10-07
//   - resourceURI - The fully qualified Azure Resource manager identifier of the resource.
...
func (client *VMInstanceHybridIdentityMetadatasClient) listByVirtualMachineInstanceCreateRequest(ctx context.Context, resourceURI string, _ *VMInstanceHybridIdentityMetadatasClientListByVirtualMachineInstanceOptions) (*policy.Request, error) {
