...
// ExecutionContainerStatus - Container Apps Job execution.
type ExecutionContainerStatus struct {
	// Exit code
	Code *int32
...
// ExecutionJobStatus - Container Apps Job execution.
type ExecutionJobStatus struct {
	// Pods in the execution.
	Pods []*ExecutionPodStatus
}

// ExecutionPodStatus - Container Apps Job execution.
type ExecutionPodStatus struct {
	// Containers in the execution
	Containers []*ExecutionContainerStatus
...
type JobExecutionProperties struct {
	...
	DetailedStatus *ExecutionJobStatus
