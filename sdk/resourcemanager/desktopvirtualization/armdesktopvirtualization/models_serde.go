...
func (a ApplicationGroupProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "migrationRequest", a.MigrationRequest)
...
func (a *ApplicationGroupProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "migrationRequest":
			err = unpopulate(val, "MigrationRequest", &a.MigrationRequest)
			delete(rawMsg, key)
		case "objectId":
...
func (h *HostPoolProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "maxSessionLimit":
			...
			delete(rawMsg, key)
		case "migrationRequest":
			err = unpopulate(val, "MigrationRequest", &h.MigrationRequest)
			delete(rawMsg, key)
		case "objectId":
...
// MarshalJSON implements the json.Marshaller interface for type MigrationRequestProperties.
func (m MigrationRequestProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "migrationPath", m.MigrationPath)
	populate(objectMap, "operation", m.Operation)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type MigrationRequestProperties.
func (m *MigrationRequestProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", m, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "migrationPath":
			err = unpopulate(val, "MigrationPath", &m.MigrationPath)
			delete(rawMsg, key)
		case "operation":
