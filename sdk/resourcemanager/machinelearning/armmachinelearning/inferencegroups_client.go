...
func (client *InferenceGroupsClient) getDeltaModelsStatusAsyncCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, poolName string, groupName string, body DeltaModelStatusRequest, options *InferenceGroupsClientGetDeltaModelsStatusAsyncOptions) (*policy.Request, error) {
...
func (client *InferenceGroupsClient) listDeltaModelsAsyncCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, poolName string, groupName string, body DeltaModelListRequest, options *InferenceGroupsClientListDeltaModelsAsyncOptions) (*policy.Request, error) {
...
//   - options - InferenceGroupsClientModifyDeltaModelsAsyncOptions contains the optional parameters for the InferenceGroupsClient.ModifyDeltaModelsAsync
//     method.
func (client *InferenceGroupsClient) ModifyDeltaModelsAsync(ctx context.Context, resourceGroupName string, workspaceName string, poolName string, groupName string, body DeltaModelModifyRequest, options *InferenceGroupsClientModifyDeltaModelsAsyncOptions) (InferenceGroupsClientModifyDeltaModelsAsyncResponse, error) {
	var err error
	const operationName = "InferenceGroupsClient.ModifyDeltaModelsAsync"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.modifyDeltaModelsAsyncCreateRequest(ctx, resourceGroupName, workspaceName, poolName, groupName, body, options)
	if err != nil {
		return InferenceGroupsClientModifyDeltaModelsAsyncResponse{}, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
	if err != nil {
		return InferenceGroupsClientModifyDeltaModelsAsyncResponse{}, err
	...
	return InferenceGroupsClientModifyDeltaModelsAsyncResponse{}, nil
}

// modifyDeltaModelsAsyncCreateRequest creates the ModifyDeltaModelsAsync request.
func (client *InferenceGroupsClient) modifyDeltaModelsAsyncCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, poolName string, groupName string, body DeltaModelModifyRequest, options *InferenceGroupsClientModifyDeltaModelsAsyncOptions) (*policy.Request, error) {
