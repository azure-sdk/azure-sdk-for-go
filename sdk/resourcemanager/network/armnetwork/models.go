...
type ConnectivityInformation struct {
	...
	DestinationPortStatus *DestinationPortStatus `json:"destinationPortStatus,omitempty"`

	// SecurityAnalysis results at the destination endpoint.
	DestinationSecurityRuleAnalysis *ConfigurationDiagnosticResponse `json:"destinationSecurityRuleAnalysis,omitempty"`

	// The NextHop Details from the source.
	NextHopAnalysis *NextHopResult `json:"nextHopAnalysis,omitempty"`

	// Port Status at the Source.
	SourcePortStatus *SourcePortStatus `json:"sourcePortStatus,omitempty"`

	// SecurityAnalysis results at the source endpoint.
	SourceSecurityRuleAnalysis *ConfigurationDiagnosticResponse `json:"sourceSecurityRuleAnalysis,omitempty"`
