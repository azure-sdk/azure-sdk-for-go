...
- New field `PhaseCode` in struct `DatabaseOperationProperties`
- New field `PhaseDescription` in struct `DatabaseOperationProperties`
- New field `PhaseInformation` in struct `DatabaseOperationProperties`
