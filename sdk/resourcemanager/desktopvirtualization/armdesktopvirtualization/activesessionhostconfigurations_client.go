...
// Get - Get a ActiveSessionHostConfiguration.
...
func (client *ActiveSessionHostConfigurationsClient) getCreateRequest(ctx context.Context, resourceGroupName string, hostPoolName string, _ *ActiveSessionHostConfigurationsClientGetOptions) (*policy.Request, error) {
...
// NewListByHostPoolPager - Operation to list the ActiveSessionHostConfigurations associated with the HostPool
//
// Generated from API version 2025-04-01-preview
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - hostPoolName - The name of the host pool within the specified resource group
...
func (client *ActiveSessionHostConfigurationsClient) listByHostPoolCreateRequest(ctx context.Context, resourceGroupName string, hostPoolName string, _ *ActiveSessionHostConfigurationsClientListByHostPoolOptions) (*policy.Request, error) {
