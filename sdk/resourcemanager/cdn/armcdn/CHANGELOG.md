...
- New struct `ProfilePropertiesLogScrubbing`
- New struct `ProfilePropertiesUpdateParametersLogScrubbing`
...
- New field `ExtendedProperties`, `LogScrubbing` in struct `ProfileProperties`
