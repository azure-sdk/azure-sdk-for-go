...
type SessionHostConfigurationsServer struct {
	...
	BeginUpdate func(ctx context.Context, resourceGroupName string, hostPoolName string, sessionHostConfiguration armdesktopvirtualization.SessionHostConfigurationPatch, options *armdesktopvirtualization.SessionHostConfigurationsClientBeginUpdateOptions) (resp azfake.PollerResponder[armdesktopvirtualization.SessionHostConfigurationsClientUpdateResponse], errResp azfake.ErrorResponder)
}
...
func (s *SessionHostConfigurationsServerTransport) dispatchBeginUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginUpdate == nil {
		...
		respr, errRespr := s.srv.BeginUpdate(req.Context(), resourceGroupNameParam, hostPoolNameParam, body, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginUpdate = &respr
