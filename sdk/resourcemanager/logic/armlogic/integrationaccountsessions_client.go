...
func (client *IntegrationAccountSessionsClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, integrationAccountName string, sessionName string, session IntegrationAccountSession, _ *IntegrationAccountSessionsClientCreateOrUpdateOptions) (*policy.Request, error) {
