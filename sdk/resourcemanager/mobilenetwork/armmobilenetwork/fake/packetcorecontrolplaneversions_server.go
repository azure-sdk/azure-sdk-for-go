...
func (p *PacketCoreControlPlaneVersionsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if packetCoreControlPlaneVersionsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = packetCoreControlPlaneVersionsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to PacketCoreControlPlaneVersionsServerTransport
var packetCoreControlPlaneVersionsServerTransportInterceptor interface {
