...
func (client *PipelinesClient) approveConnectionCreateRequest(ctx context.Context, resourceGroupName string, pipelineName string, connection ResourceBody, _ *PipelinesClientBeginApproveConnectionOptions) (*policy.Request, error) {
...
func (client *PipelinesClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, pipelineName string, pipeline Pipeline, _ *PipelinesClientBeginCreateOrUpdateOptions) (*policy.Request, error) {
...
//     method.
func (client *PipelinesClient) BeginExecuteAction(ctx context.Context, resourceGroupName string, pipelineName string, action Action, options *PipelinesClientBeginExecuteActionOptions) (*runtime.Poller[PipelinesClientExecuteActionResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.executeAction(ctx, resourceGroupName, pipelineName, action, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2025-04-11-preview
func (client *PipelinesClient) executeAction(ctx context.Context, resourceGroupName string, pipelineName string, action Action, options *PipelinesClientBeginExecuteActionOptions) (*http.Response, error) {
	var err error
	const operationName = "PipelinesClient.BeginExecuteAction"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.executeActionCreateRequest(ctx, resourceGroupName, pipelineName, action, options)
	if err != nil {
		return nil, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
...
func (client *PipelinesClient) executeActionCreateRequest(ctx context.Context, resourceGroupName string, pipelineName string, action Action, _ *PipelinesClientBeginExecuteActionOptions) (*policy.Request, error) {
...
func (client *PipelinesClient) rejectConnectionCreateRequest(ctx context.Context, resourceGroupName string, pipelineName string, connection ResourceBody, _ *PipelinesClientBeginRejectConnectionOptions) (*policy.Request, error) {
...
func (client *PipelinesClient) updateCreateRequest(ctx context.Context, resourceGroupName string, pipelineName string, pipeline PipelinesPatch, _ *PipelinesClientBeginUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureDataTransfer/pipelines/{pipelineName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
