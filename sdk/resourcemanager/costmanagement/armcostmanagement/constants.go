...
const (
	// BudgetNotificationOperatorTypeEqualTo - Alert will be triggered if the evaluated cost is the same as threshold value. Note:
	// It’s not recommended to use this OperatorType as there’s low chance of cost being exactly the same as threshold value,
	...
	// BudgetNotificationOperatorTypeGreaterThan - Alert will be triggered if the evaluated cost is greater than the threshold
	...
	// BudgetNotificationOperatorTypeGreaterThanOrEqualTo - Alert will be triggered if the evaluated cost is greater than or equal
