...
func (o OpenAIIntegrationProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "openAIConnectorId", o.OpenAIConnectorID)
...
func (o *OpenAIIntegrationProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "lastRefreshAt":
			...
			delete(rawMsg, key)
		case "openAIConnectorId":
			err = unpopulate(val, "OpenAIConnectorID", &o.OpenAIConnectorID)
			delete(rawMsg, key)
...
// MarshalJSON implements the json.Marshaller interface for type ResubscribeResponse.
func (r ResubscribeResponse) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "properties", r.Properties)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ResubscribeResponse.
func (r *ResubscribeResponse) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", r, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type ResubscribeResponseProperties.
func (r ResubscribeResponseProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "marketplaceSubscriptionId", r.MarketplaceSubscriptionID)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ResubscribeResponseProperties.
func (r *ResubscribeResponseProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", r, err)
	}
	for key, val := range rawMsg {
		...
		case "marketplaceSubscriptionId":
			err = unpopulate(val, "MarketplaceSubscriptionID", &r.MarketplaceSubscriptionID)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", r, err)
