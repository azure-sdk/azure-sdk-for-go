...
// PolicySettingsLogScrubbing - Defines rules to scrub sensitive fields in Web Application Firewall logs
...
// WebApplicationFirewallScrubbingRules - Defines contents of a log scrub rules.
type WebApplicationFirewallScrubbingRules struct {
	...
	// Match against a specific key from the QueryString, PostArgs, RequestHeader or Cookies variables in the log. Default value
	// is null.
	Selector *string
