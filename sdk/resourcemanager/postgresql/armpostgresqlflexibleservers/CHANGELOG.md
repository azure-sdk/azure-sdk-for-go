...
- New enum type `RecommendationType` with values `RecommendationTypeAnalyzeTable`, `RecommendationTypeCreateIndex`, `RecommendationTypeDropIndex`
...
- New enum type `TuningOptionEnum` with values `TuningOptionEnumConfiguration`, `TuningOptionEnumIndex`, `TuningOptionEnumTable`
...
- New function `PossibleRecommendationTypeValues() []RecommendationType`
...
- New struct `ObjectRecommendationListResult`
- New struct `ObjectRecommendationResource`
- New struct `ObjectRecommendationResourceProperties`
- New struct `ObjectRecommendationResourcePropertiesAnalyzedWorkload`
- New struct `ObjectRecommendationResourcePropertiesImplementationDetails`
