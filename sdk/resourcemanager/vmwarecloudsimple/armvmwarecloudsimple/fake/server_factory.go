...
type ServerFactory struct {
	// CustomizationPoliciesServer contains the fakes for client CustomizationPoliciesClient
	CustomizationPoliciesServer CustomizationPoliciesServer

	// DedicatedCloudNodesServer contains the fakes for client DedicatedCloudNodesClient
	DedicatedCloudNodesServer DedicatedCloudNodesServer

	// DedicatedCloudServicesServer contains the fakes for client DedicatedCloudServicesClient
	...
	// SKUsAvailabilityServer contains the fakes for client SKUsAvailabilityClient
