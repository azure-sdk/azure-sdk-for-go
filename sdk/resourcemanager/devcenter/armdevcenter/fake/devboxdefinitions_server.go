...
func (d *DevBoxDefinitionsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if devBoxDefinitionsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = devBoxDefinitionsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "DevBoxDefinitionsClient.GetByProject":
				res.resp, res.err = d.dispatchGetByProject(req)
			case "DevBoxDefinitionsClient.NewListByDevCenterPager":
				res.resp, res.err = d.dispatchNewListByDevCenterPager(req)
			case "DevBoxDefinitionsClient.NewListByProjectPager":
				res.resp, res.err = d.dispatchNewListByProjectPager(req)
...
// set this to conditionally intercept incoming requests to DevBoxDefinitionsServerTransport
var devBoxDefinitionsServerTransportInterceptor interface {
