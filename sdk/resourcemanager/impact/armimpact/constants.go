...
const (
	moduleName    = "github.com/Azure/azure-sdk-for-go/sdk/resourcemanager/impact/armimpact"
...
// ImpactCategoryEnum - List of impact categories.
type ImpactCategoryEnum string

const (
	// ImpactCategoryEnumAvailability - Availability category
	ImpactCategoryEnumAvailability ImpactCategoryEnum = "Availability"
	// ImpactCategoryEnumOther - Other category
	ImpactCategoryEnumOther ImpactCategoryEnum = "Other"
	// ImpactCategoryEnumPerformance - Performance category
	ImpactCategoryEnumPerformance ImpactCategoryEnum = "Performance"
)

// PossibleImpactCategoryEnumValues returns the possible values for the ImpactCategoryEnum const type.
func PossibleImpactCategoryEnumValues() []ImpactCategoryEnum {
	return []ImpactCategoryEnum{
		ImpactCategoryEnumAvailability,
		ImpactCategoryEnumOther,
		ImpactCategoryEnumPerformance,
	}
}
