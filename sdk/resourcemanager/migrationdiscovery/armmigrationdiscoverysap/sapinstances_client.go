...
// NewListPager - Lists the SAP Instance resources for the given SAP Migration discovery site resource.
//
// Generated from API version 2023-10-01-preview
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - sapDiscoverySiteName - The name of the discovery site resource for SAP Migration.
//   - options - SAPInstancesClientListOptions contains the optional parameters for the SAPInstancesClient.NewListPager method.
func (client *SAPInstancesClient) NewListPager(resourceGroupName string, sapDiscoverySiteName string, options *SAPInstancesClientListOptions) *runtime.Pager[SAPInstancesClientListResponse] {
	return runtime.NewPager(runtime.PagingHandler[SAPInstancesClientListResponse]{
		More: func(page SAPInstancesClientListResponse) bool {
			return page.NextLink != nil && len(*page.NextLink) > 0
		},
		Fetcher: func(ctx context.Context, page *SAPInstancesClientListResponse) (SAPInstancesClientListResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "SAPInstancesClient.NewListPager")
			nextLink := ""
			if page != nil {
				nextLink = *page.NextLink
			}
			resp, err := runtime.FetcherForNextLink(ctx, client.internal.Pipeline(), nextLink, func(ctx context.Context) (*policy.Request, error) {
				return client.listCreateRequest(ctx, resourceGroupName, sapDiscoverySiteName, options)
			}, nil)
			if err != nil {
				return SAPInstancesClientListResponse{}, err
			}
...
func (client *SAPInstancesClient) listCreateRequest(ctx context.Context, resourceGroupName string, sapDiscoverySiteName string, _ *SAPInstancesClientListOptions) (*policy.Request, error) {
...
func (client *SAPInstancesClient) listHandleResponse(resp *http.Response) (SAPInstancesClientListResponse, error) {
	result := SAPInstancesClientListResponse{}
