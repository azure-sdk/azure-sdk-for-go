...
// MarshalJSON implements the json.Marshaller interface for type ManagedResourceAssignedIdentities.
func (m ManagedResourceAssignedIdentities) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "principalId", m.PrincipalID)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ManagedResourceAssignedIdentities.
func (m *ManagedResourceAssignedIdentities) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", m, err)
	}
...
func (m ManagedResourceGroupSettings) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "assignIdentities", m.AssignIdentities)
	return json.Marshal(objectMap)
}
...
func (m *ManagedResourceGroupSettings) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "assignIdentities":
			err = unpopulate(val, "AssignIdentities", &m.AssignIdentities)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", m, err)
