...
func (client *RoleAssignmentsClient) NewListForResourcePager(resourceGroupName string, resourceProviderNamespace string, resourceType string, resourceName string, options *RoleAssignmentsClientListForResourceOptions) *runtime.Pager[RoleAssignmentsClientListForResourceResponse] {
	return runtime.NewPager(runtime.PageProcessor[RoleAssignmentsClientListForResourceResponse]{
...
func (client *RoleAssignmentsClient) NewListForResourceGroupPager(resourceGroupName string, options *RoleAssignmentsClientListForResourceGroupOptions) *runtime.Pager[RoleAssignmentsClientListForResourceGroupResponse] {
	return runtime.NewPager(runtime.PageProcessor[RoleAssignmentsClientListForResourceGroupResponse]{
...
func (client *RoleAssignmentsClient) NewListForSubscriptionPager(options *RoleAssignmentsClientListForSubscriptionOptions) *runtime.Pager[RoleAssignmentsClientListForSubscriptionResponse] {
	return runtime.NewPager(runtime.PageProcessor[RoleAssignmentsClientListForSubscriptionResponse]{
...
func (client *RoleAssignmentsClient) validateHandleResponse(resp *http.Response) (RoleAssignmentsClientValidateResponse, error) {
	result := RoleAssignmentsClientValidateResponse{}
...
func (client *RoleAssignmentsClient) validateByIDHandleResponse(resp *http.Response) (RoleAssignmentsClientValidateByIDResponse, error) {
	result := RoleAssignmentsClientValidateByIDResponse{}
	if err := runtime.UnmarshalAsJSON(resp, &result.ValidationResponse); err != nil {
		return RoleAssignmentsClientValidateByIDResponse{}, err
	}
	return result, nil
