...
func (b *BlueprintsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if blueprintsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = blueprintsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to BlueprintsServerTransport
var blueprintsServerTransportInterceptor interface {
