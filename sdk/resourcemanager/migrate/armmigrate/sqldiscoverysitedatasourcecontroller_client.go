...
// BeginDelete - Delete a SqlDiscoverySiteDataSource
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2024-05-01-preview
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
...
//   - sqlSiteName - SQL site name.
//   - discoverySiteDataSourceName - SQL Discovery site data source name.
//   - options - SQLDiscoverySiteDataSourceControllerClientBeginDeleteOptions contains the optional parameters for the SQLDiscoverySiteDataSourceControllerClient.BeginDelete
//     method.
func (client *SQLDiscoverySiteDataSourceControllerClient) BeginDelete(ctx context.Context, resourceGroupName string, siteName string, sqlSiteName string, discoverySiteDataSourceName string, options *SQLDiscoverySiteDataSourceControllerClientBeginDeleteOptions) (*runtime.Poller[SQLDiscoverySiteDataSourceControllerClientDeleteResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.deleteOperation(ctx, resourceGroupName, siteName, sqlSiteName, discoverySiteDataSourceName, options)
		if err != nil {
			return nil, err
		}
		poller, err := runtime.NewPoller(resp, client.internal.Pipeline(), &runtime.NewPollerOptions[SQLDiscoverySiteDataSourceControllerClientDeleteResponse]{
			FinalStateVia: runtime.FinalStateViaLocation,
			Tracer:        client.internal.Tracer(),
		})
		return poller, err
	} else {
		return runtime.NewPollerFromResumeToken(options.ResumeToken, client.internal.Pipeline(), &runtime.NewPollerFromResumeTokenOptions[SQLDiscoverySiteDataSourceControllerClientDeleteResponse]{
			Tracer: client.internal.Tracer(),
		})
	}
}
...
//
// Generated from API version 2024-05-01-preview
func (client *SQLDiscoverySiteDataSourceControllerClient) deleteOperation(ctx context.Context, resourceGroupName string, siteName string, sqlSiteName string, discoverySiteDataSourceName string, options *SQLDiscoverySiteDataSourceControllerClientBeginDeleteOptions) (*http.Response, error) {
	var err error
	const operationName = "SQLDiscoverySiteDataSourceControllerClient.BeginDelete"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
...
func (client *SQLDiscoverySiteDataSourceControllerClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, siteName string, sqlSiteName string, discoverySiteDataSourceName string, options *SQLDiscoverySiteDataSourceControllerClientBeginDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OffAzure/masterSites/{siteName}/sqlSites/{sqlSiteName}/discoverySiteDataSources/{discoverySiteDataSourceName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
