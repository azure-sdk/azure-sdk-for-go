...
func (client *WorkflowTriggerHistoriesClient) resubmitCreateRequest(ctx context.Context, resourceGroupName string, workflowName string, triggerName string, historyName string, _ *WorkflowTriggerHistoriesClientResubmitOptions) (*policy.Request, error) {
