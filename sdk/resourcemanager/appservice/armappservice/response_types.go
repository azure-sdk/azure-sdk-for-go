...
// StaticSitesClientCreateOrUpdateTrafficSplittingResponse contains the response from method StaticSitesClient.BeginCreateOrUpdateTrafficSplitting.
type StaticSitesClientCreateOrUpdateTrafficSplittingResponse struct {
	StaticSiteTrafficSplittingPropertiesARMResource
}
...
// StaticSitesClientDeleteTrafficSplittingResponse contains the response from method StaticSitesClient.DeleteTrafficSplitting.
type StaticSitesClientDeleteTrafficSplittingResponse struct {
	// placeholder for future response values
}
...
// StaticSitesClientGetTrafficSplittingResponse contains the response from method StaticSitesClient.GetTrafficSplitting.
type StaticSitesClientGetTrafficSplittingResponse struct {
	StaticSiteTrafficSplittingPropertiesARMResource
}
...
type StaticSitesClientListBasicAuthResponse struct {
	StaticSiteTrafficSplittingPropertiesCollection
}
