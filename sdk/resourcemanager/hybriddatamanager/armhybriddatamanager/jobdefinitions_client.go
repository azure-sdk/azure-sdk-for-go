...
// options - JobDefinitionsClientCancelOptions contains the optional parameters for the JobDefinitionsClient.Cancel method.
func (client *JobDefinitionsClient) Cancel(ctx context.Context, dataServiceName string, jobDefinitionName string, resourceGroupName string, dataManagerName string, options *JobDefinitionsClientCancelOptions) (JobDefinitionsClientCancelResponse, error) {
	req, err := client.cancelCreateRequest(ctx, dataServiceName, jobDefinitionName, resourceGroupName, dataManagerName, options)
	if err != nil {
		return JobDefinitionsClientCancelResponse{}, err
	}
	...
	if !runtime.HasStatusCode(resp, http.StatusOK) {
		return JobDefinitionsClientCancelResponse{}, runtime.NewResponseError(resp)
	}
	return JobDefinitionsClientCancelResponse{}, nil
}

// cancelCreateRequest creates the Cancel request.
func (client *JobDefinitionsClient) cancelCreateRequest(ctx context.Context, dataServiceName string, jobDefinitionName string, resourceGroupName string, dataManagerName string, options *JobDefinitionsClientCancelOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HybridData/dataManagers/{dataManagerName}/dataServices/{dataServiceName}/jobDefinitions/{jobDefinitionName}/cancel"
	if dataServiceName == "" {
...
// RetryJob - This method retries the first failed or cancelled job that has not already been skipped for the job definition.
// If the operation fails it returns an *azcore.ResponseError type.
// Generated from API version 2021-05-01
// dataServiceName - The data service type of the job definition.
// jobDefinitionName - Name of the job definition.
...
// dataManagerName - The name of the DataManager Resource within the specified resource group. DataManager names must be between
// 3 and 24 characters in length and use any alphanumeric and underscore only
// options - JobDefinitionsClientRetryJobOptions contains the optional parameters for the JobDefinitionsClient.RetryJob method.
func (client *JobDefinitionsClient) RetryJob(ctx context.Context, dataServiceName string, jobDefinitionName string, resourceGroupName string, dataManagerName string, options *JobDefinitionsClientRetryJobOptions) (JobDefinitionsClientRetryJobResponse, error) {
	req, err := client.retryJobCreateRequest(ctx, dataServiceName, jobDefinitionName, resourceGroupName, dataManagerName, options)
	if err != nil {
		return JobDefinitionsClientRetryJobResponse{}, err
	}
	resp, err := client.pl.Do(req)
	if err != nil {
		return JobDefinitionsClientRetryJobResponse{}, err
	...
	if !runtime.HasStatusCode(resp, http.StatusOK) {
		return JobDefinitionsClientRetryJobResponse{}, runtime.NewResponseError(resp)
	}
	return JobDefinitionsClientRetryJobResponse{}, nil
}

// retryJobCreateRequest creates the RetryJob request.
func (client *JobDefinitionsClient) retryJobCreateRequest(ctx context.Context, dataServiceName string, jobDefinitionName string, resourceGroupName string, dataManagerName string, options *JobDefinitionsClientRetryJobOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HybridData/dataManagers/{dataManagerName}/dataServices/{dataServiceName}/jobDefinitions/{jobDefinitionName}/retryjob"
	if dataServiceName == "" {
		return nil, errors.New("parameter dataServiceName cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{dataServiceName}", url.PathEscape(dataServiceName))
...
// SkipJob - This method skips last executed failed or cancelled job.
// If the operation fails it returns an *azcore.ResponseError type.
// Generated from API version 2021-05-01
// dataServiceName - The data service type of the job definition.
// jobDefinitionName - Name of the job definition.
...
// dataManagerName - The name of the DataManager Resource within the specified resource group. DataManager names must be between
// 3 and 24 characters in length and use any alphanumeric and underscore only
// options - JobDefinitionsClientSkipJobOptions contains the optional parameters for the JobDefinitionsClient.SkipJob method.
func (client *JobDefinitionsClient) SkipJob(ctx context.Context, dataServiceName string, jobDefinitionName string, resourceGroupName string, dataManagerName string, options *JobDefinitionsClientSkipJobOptions) (JobDefinitionsClientSkipJobResponse, error) {
	req, err := client.skipJobCreateRequest(ctx, dataServiceName, jobDefinitionName, resourceGroupName, dataManagerName, options)
	if err != nil {
		return JobDefinitionsClientSkipJobResponse{}, err
	}
	resp, err := client.pl.Do(req)
	if err != nil {
		return JobDefinitionsClientSkipJobResponse{}, err
	...
	if !runtime.HasStatusCode(resp, http.StatusOK) {
		return JobDefinitionsClientSkipJobResponse{}, runtime.NewResponseError(resp)
	}
	return JobDefinitionsClientSkipJobResponse{}, nil
}

// skipJobCreateRequest creates the SkipJob request.
func (client *JobDefinitionsClient) skipJobCreateRequest(ctx context.Context, dataServiceName string, jobDefinitionName string, resourceGroupName string, dataManagerName string, options *JobDefinitionsClientSkipJobOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HybridData/dataManagers/{dataManagerName}/dataServices/{dataServiceName}/jobDefinitions/{jobDefinitionName}/skipjob"
	if dataServiceName == "" {
		return nil, errors.New("parameter dataServiceName cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{dataServiceName}", url.PathEscape(dataServiceName))
