...
func (a *AscUsagesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if ascUsagesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = ascUsagesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to AscUsagesServerTransport
var ascUsagesServerTransportInterceptor interface {
