...
- New value `ActiveRevisionsModeLabeled` added to enum type `ActiveRevisionsMode`
...
- New enum type `LabelsProvisioningState` with values `LabelsProvisioningStateCanceled`, `LabelsProvisioningStateFailed`, `LabelsProvisioningStateInProgress`, `LabelsProvisioningStateSucceeded`
...
- New function `*ClientFactory.NewContainerAppsLabelsClient() *ContainerAppsLabelsClient`
...
- New function `NewContainerAppsLabelsClient(string, azcore.TokenCredential, *arm.ClientOptions) (*ContainerAppsLabelsClient, error)`
- New function `*ContainerAppsLabelsClient.BeginCreateOrUpdate(context.Context, string, string, string, Labels, *ContainerAppsLabelsClientBeginCreateOrUpdateOptions) (*runtime.Poller[ContainerAppsLabelsClientCreateOrUpdateResponse], error)`
- New function `*ContainerAppsLabelsClient.BeginDelete(context.Context, string, string, string, *ContainerAppsLabelsClientBeginDeleteOptions) (*runtime.Poller[ContainerAppsLabelsClientDeleteResponse], error)`
- New function `*ContainerAppsLabelsClient.Get(context.Context, string, string, string, *ContainerAppsLabelsClientGetOptions) (ContainerAppsLabelsClientGetResponse, error)`
- New function `*ContainerAppsLabelsClient.NewListPager(string, string, *ContainerAppsLabelsClientListOptions) *runtime.Pager[ContainerAppsLabelsClientListResponse]`
...
- New struct `Label`
- New struct `Labels`
- New struct `LabelsCollection`
- New struct `LabelsProperties`
