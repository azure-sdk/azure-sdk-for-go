...
func (d *DiskPoolsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if diskPoolsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = diskPoolsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "DiskPoolsClient.BeginDeallocate":
				res.resp, res.err = d.dispatchBeginDeallocate(req)
			...
			case "DiskPoolsClient.BeginUpgrade":
				res.resp, res.err = d.dispatchBeginUpgrade(req)
			default:
...
// set this to conditionally intercept incoming requests to DiskPoolsServerTransport
var diskPoolsServerTransportInterceptor interface {
