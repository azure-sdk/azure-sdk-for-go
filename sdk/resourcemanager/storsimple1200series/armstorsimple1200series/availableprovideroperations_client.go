...
func (client *AvailableProviderOperationsClient) listCreateRequest(ctx context.Context, _ *AvailableProviderOperationsClientListOptions) (*policy.Request, error) {
