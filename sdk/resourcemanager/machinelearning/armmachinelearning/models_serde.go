...
// MarshalJSON implements the json.Marshaller interface for type ComputeInstanceOsPatchingResult.
func (c ComputeInstanceOsPatchingResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "osPatchingErrors", c.OSPatchingErrors)
	populate(objectMap, "osPatchingStatus", c.OSPatchingStatus)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ComputeInstanceOsPatchingResult.
func (c *ComputeInstanceOsPatchingResult) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
	for key, val := range rawMsg {
		...
		case "osPatchingErrors":
			err = unpopulate(val, "OSPatchingErrors", &c.OSPatchingErrors)
			delete(rawMsg, key)
		case "osPatchingStatus":
			err = unpopulate(val, "OSPatchingStatus", &c.OSPatchingStatus)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", c, err)
...
func (c ComputeInstanceProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "osPatchingResult", c.OSPatchingResult)
...
func (c *ComputeInstanceProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "osImageMetadata":
			...
			delete(rawMsg, key)
		case "osPatchingResult":
			err = unpopulate(val, "OSPatchingResult", &c.OSPatchingResult)
			delete(rawMsg, key)
...
func (m ManagedIdentityAuthTypeWorkspaceConnectionProperties) MarshalJSON() ([]byte, error) {
	...
	populateAny(objectMap, "metadata", m.Metadata)
...
func (n NoneAuthTypeWorkspaceConnectionProperties) MarshalJSON() ([]byte, error) {
	...
	populateAny(objectMap, "metadata", n.Metadata)
...
func (o OAuth2AuthTypeWorkspaceConnectionProperties) MarshalJSON() ([]byte, error) {
	...
	populateAny(objectMap, "metadata", o.Metadata)
...
func (u UsernamePasswordAuthTypeWorkspaceConnectionProperties) MarshalJSON() ([]byte, error) {
	...
	populateAny(objectMap, "metadata", u.Metadata)
