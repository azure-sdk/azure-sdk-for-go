...
//     method.
func (client *WatchersClient) BeginSetFlowLogConfiguration(ctx context.Context, resourceGroupName string, networkWatcherName string, parameters FlowLogInformationRequest, options *WatchersClientBeginSetFlowLogConfigurationOptions) (*runtime.Poller[WatchersClientSetFlowLogConfigurationResponse], error) {
	if options == nil || options.ResumeToken == "" {
...
//
// Generated from API version 2023-05-01
func (client *WatchersClient) setFlowLogConfiguration(ctx context.Context, resourceGroupName string, networkWatcherName string, parameters FlowLogInformationRequest, options *WatchersClientBeginSetFlowLogConfigurationOptions) (*http.Response, error) {
	var err error
...
func (client *WatchersClient) setFlowLogConfigurationCreateRequest(ctx context.Context, resourceGroupName string, networkWatcherName string, parameters FlowLogInformationRequest, options *WatchersClientBeginSetFlowLogConfigurationOptions) (*policy.Request, error) {
