...
func (client *EvaluatedWebAppsOperationsClient) getCreateRequest(ctx context.Context, resourceGroupName string, projectName string, businessCaseName string, evaluatedWebAppName string, options *EvaluatedWebAppsOperationsClientGetOptions) (*policy.Request, error) {
