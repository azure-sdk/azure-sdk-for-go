...
// NewListByParentPager - List BgpPeer resources by parent
//
// Generated from API version 2024-03-01
//   - resourceURI - The fully qualified Azure Resource manager identifier of the resource.
//   - options - BgpPeersClientListByParentOptions contains the optional parameters for the BgpPeersClient.NewListByParentPager
//     method.
func (client *BgpPeersClient) NewListByParentPager(resourceURI string, options *BgpPeersClientListByParentOptions) *runtime.Pager[BgpPeersClientListByParentResponse] {
	return runtime.NewPager(runtime.PagingHandler[BgpPeersClientListByParentResponse]{
		More: func(page BgpPeersClientListByParentResponse) bool {
			return page.NextLink != nil && len(*page.NextLink) > 0
		},
		Fetcher: func(ctx context.Context, page *BgpPeersClientListByParentResponse) (BgpPeersClientListByParentResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "BgpPeersClient.NewListByParentPager")
			nextLink := ""
			if page != nil {
			...
			if err != nil {
				return BgpPeersClientListByParentResponse{}, err
			}
...
func (client *BgpPeersClient) listByParentCreateRequest(ctx context.Context, resourceURI string, _ *BgpPeersClientListByParentOptions) (*policy.Request, error) {
...
func (client *BgpPeersClient) listByParentHandleResponse(resp *http.Response) (BgpPeersClientListByParentResponse, error) {
	result := BgpPeersClientListByParentResponse{}
