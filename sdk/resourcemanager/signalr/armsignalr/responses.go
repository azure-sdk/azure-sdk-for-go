...
// ReplicaClientSharedPrivateLinkResourcesCreateOrUpdateResponse contains the response from method ReplicaClient.BeginSharedPrivateLinkResourcesCreateOrUpdate.
type ReplicaClientSharedPrivateLinkResourcesCreateOrUpdateResponse struct {
	// Describes a Shared Private Link Resource
	SharedPrivateLinkResource
}

// ReplicaClientSharedPrivateLinkResourcesGetResponse contains the response from method ReplicaClient.SharedPrivateLinkResourcesGet.
type ReplicaClientSharedPrivateLinkResourcesGetResponse struct {
	// Describes a Shared Private Link Resource
	SharedPrivateLinkResource
}

// ReplicaClientSharedPrivateLinkResourcesListResponse contains the response from method ReplicaClient.NewSharedPrivateLinkResourcesListPager.
type ReplicaClientSharedPrivateLinkResourcesListResponse struct {
