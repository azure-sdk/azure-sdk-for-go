...
// serviceName - The name of the API Management service.
// loggerid - Logger identifier. Must be unique in the API Management service instance.
// ifMatch - The entity state (Etag) version of the logger to delete. A value of "*" can be used for If-Match to unconditionally
// apply the operation.
...
// serviceName - The name of the API Management service.
// loggerid - Logger identifier. Must be unique in the API Management service instance.
// ifMatch - The entity state (Etag) version of the logger to update. A value of "*" can be used for If-Match to unconditionally
// apply the operation.
...
func (client *LoggerClient) Update(ctx context.Context, resourceGroupName string, serviceName string, loggerid string, ifMatch string, parameters LoggerUpdateContract, options *LoggerClientUpdateOptions) (LoggerClientUpdateResponse, error) {
	...
	return LoggerClientUpdateResponse{}, nil
}
