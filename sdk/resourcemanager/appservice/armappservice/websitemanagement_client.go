...
// ListVirtualNetworkIntegrations - Retrieve information regarding the provided virtual network integration, such as its allocated
// resources and its allocated IP
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2024-11-01
//   - location - The name of the Azure region.
//   - request - Object contains the subnetResourceId
//   - options - WebSiteManagementClientListVirtualNetworkIntegrationsOptions contains the optional parameters for the WebSiteManagementClient.ListVirtualNetworkIntegrations
//     method.
func (client *WebSiteManagementClient) ListVirtualNetworkIntegrations(ctx context.Context, location string, request VirtualNetworkIntegrationRequest, options *WebSiteManagementClientListVirtualNetworkIntegrationsOptions) (WebSiteManagementClientListVirtualNetworkIntegrationsResponse, error) {
	var err error
	const operationName = "WebSiteManagementClient.ListVirtualNetworkIntegrations"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.listVirtualNetworkIntegrationsCreateRequest(ctx, location, request, options)
	if err != nil {
		return WebSiteManagementClientListVirtualNetworkIntegrationsResponse{}, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
	if err != nil {
		return WebSiteManagementClientListVirtualNetworkIntegrationsResponse{}, err
	...
	resp, err := client.listVirtualNetworkIntegrationsHandleResponse(httpResp)
	return resp, err
}

// listVirtualNetworkIntegrationsCreateRequest creates the ListVirtualNetworkIntegrations request.
func (client *WebSiteManagementClient) listVirtualNetworkIntegrationsCreateRequest(ctx context.Context, location string, request VirtualNetworkIntegrationRequest, options *WebSiteManagementClientListVirtualNetworkIntegrationsOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/providers/Microsoft.Web/locations/{location}/listVirtualNetworkIntegrations"
	if location == "" {
...
// listVirtualNetworkIntegrationsHandleResponse handles the ListVirtualNetworkIntegrations response.
func (client *WebSiteManagementClient) listVirtualNetworkIntegrationsHandleResponse(resp *http.Response) (WebSiteManagementClientListVirtualNetworkIntegrationsResponse, error) {
	result := WebSiteManagementClientListVirtualNetworkIntegrationsResponse{}
...
// PurgeUnusedVirtualNetworkIntegrations - Delete orphaned (unused) VNET integration, otherwise fail the call if there are
// sites that are still using the VNET integrations
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2024-11-01
//   - location - The name of the Azure region.
//   - request - Object contains the subnetResourceId
//   - options - WebSiteManagementClientPurgeUnusedVirtualNetworkIntegrationsOptions contains the optional parameters for the
//     WebSiteManagementClient.PurgeUnusedVirtualNetworkIntegrations method.
func (client *WebSiteManagementClient) PurgeUnusedVirtualNetworkIntegrations(ctx context.Context, location string, request VirtualNetworkIntegrationRequest, options *WebSiteManagementClientPurgeUnusedVirtualNetworkIntegrationsOptions) (WebSiteManagementClientPurgeUnusedVirtualNetworkIntegrationsResponse, error) {
	var err error
	const operationName = "WebSiteManagementClient.PurgeUnusedVirtualNetworkIntegrations"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.purgeUnusedVirtualNetworkIntegrationsCreateRequest(ctx, location, request, options)
	if err != nil {
		return WebSiteManagementClientPurgeUnusedVirtualNetworkIntegrationsResponse{}, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
	if err != nil {
		return WebSiteManagementClientPurgeUnusedVirtualNetworkIntegrationsResponse{}, err
	...
	resp, err := client.purgeUnusedVirtualNetworkIntegrationsHandleResponse(httpResp)
	return resp, err
}

// purgeUnusedVirtualNetworkIntegrationsCreateRequest creates the PurgeUnusedVirtualNetworkIntegrations request.
func (client *WebSiteManagementClient) purgeUnusedVirtualNetworkIntegrationsCreateRequest(ctx context.Context, location string, request VirtualNetworkIntegrationRequest, options *WebSiteManagementClientPurgeUnusedVirtualNetworkIntegrationsOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/providers/Microsoft.Web/locations/{location}/purgeUnusedVirtualNetworkIntegration"
	if location == "" {
		return nil, errors.New("parameter location cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{location}", url.PathEscape(location))
...
// purgeUnusedVirtualNetworkIntegrationsHandleResponse handles the PurgeUnusedVirtualNetworkIntegrations response.
func (client *WebSiteManagementClient) purgeUnusedVirtualNetworkIntegrationsHandleResponse(resp *http.Response) (WebSiteManagementClientPurgeUnusedVirtualNetworkIntegrationsResponse, error) {
	result := WebSiteManagementClientPurgeUnusedVirtualNetworkIntegrationsResponse{}
	if err := runtime.UnmarshalAsJSON(resp, &result.VirtualNetworkIntegrationResponse); err != nil {
		return WebSiteManagementClientPurgeUnusedVirtualNetworkIntegrationsResponse{}, err
	}
	return result, nil
}
