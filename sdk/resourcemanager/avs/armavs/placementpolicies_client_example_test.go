...
func ExamplePlacementPoliciesClient_BeginCreateOrUpdate() {
	...
	poller, err := clientFactory.NewPlacementPoliciesClient().BeginCreateOrUpdate(ctx, "group1", "cloud1", "cluster1", "policy1", nil)
	if err != nil {
...
func ExamplePlacementPoliciesClient_NewListPager() {
	...
	for pager.More() {
		...
		// 				Name: to.Ptr("policy2"),
		// 				Type: to.Ptr("Microsoft.AVS/privateClouds/clusters/placementPolicies"),
		// 				Properties: &armavs.VMVMPlacementPolicyProperties{
...
func ExamplePlacementPoliciesClient_BeginUpdate() {
	...
	poller, err := clientFactory.NewPlacementPoliciesClient().BeginUpdate(ctx, "group1", "cloud1", "cluster1", "policy1", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	res, err := poller.PollUntilDone(ctx, nil)
