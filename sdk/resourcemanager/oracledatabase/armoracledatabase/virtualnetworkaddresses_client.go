...
// NewListByParentPager - List VirtualNetworkAddress resources by CloudVmCluster
//
// Generated from API version 2025-03-01
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - cloudvmclustername - CloudVmCluster name
//   - options - VirtualNetworkAddressesClientListByParentOptions contains the optional parameters for the VirtualNetworkAddressesClient.NewListByParentPager
//     method.
func (client *VirtualNetworkAddressesClient) NewListByParentPager(resourceGroupName string, cloudvmclustername string, options *VirtualNetworkAddressesClientListByParentOptions) *runtime.Pager[VirtualNetworkAddressesClientListByParentResponse] {
	return runtime.NewPager(runtime.PagingHandler[VirtualNetworkAddressesClientListByParentResponse]{
		More: func(page VirtualNetworkAddressesClientListByParentResponse) bool {
			return page.NextLink != nil && len(*page.NextLink) > 0
		},
		Fetcher: func(ctx context.Context, page *VirtualNetworkAddressesClientListByParentResponse) (VirtualNetworkAddressesClientListByParentResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "VirtualNetworkAddressesClient.NewListByParentPager")
			nextLink := ""
			if page != nil {
			...
			if err != nil {
				return VirtualNetworkAddressesClientListByParentResponse{}, err
			}
...
func (client *VirtualNetworkAddressesClient) listByParentCreateRequest(ctx context.Context, resourceGroupName string, cloudvmclustername string, _ *VirtualNetworkAddressesClientListByParentOptions) (*policy.Request, error) {
...
func (client *VirtualNetworkAddressesClient) listByParentHandleResponse(resp *http.Response) (VirtualNetworkAddressesClientListByParentResponse, error) {
	result := VirtualNetworkAddressesClientListByParentResponse{}
