...
func (o *OperationsDiscoveryServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if operationsDiscoveryServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = operationsDiscoveryServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to OperationsDiscoveryServerTransport
var operationsDiscoveryServerTransportInterceptor interface {
