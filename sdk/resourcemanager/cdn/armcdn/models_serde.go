...
func (a AFDDomainProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "referencedRoutePath", a.ReferencedRoutePath)
...
func (a *AFDDomainProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "provisioningState":
			...
			delete(rawMsg, key)
		case "referencedRoutePath":
			err = unpopulate(val, "ReferencedRoutePath", &a.ReferencedRoutePath)
			delete(rawMsg, key)
		case "tlsSettings":
...
func (a AFDDomainReferencedRoutePath) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "route", a.Route)
	return json.Marshal(objectMap)
}
...
func (a *AFDDomainReferencedRoutePath) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "paths":
			...
			delete(rawMsg, key)
		case "route":
			err = unpopulate(val, "Route", &a.Route)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", a, err)
...
// MarshalJSON implements the json.Marshaller interface for type AFDDomainReferencedRoutePathList.
func (a AFDDomainReferencedRoutePathList) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "value", a.Value)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type AFDDomainReferencedRoutePathList.
func (a *AFDDomainReferencedRoutePathList) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", a, err)
	}
