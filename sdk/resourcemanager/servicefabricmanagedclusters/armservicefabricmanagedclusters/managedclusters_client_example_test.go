...
// Generated from example definition: 2024-11-01-preview/ManagedClusterPutOperation_example_max.json
func ExampleManagedClustersClient_BeginCreateOrUpdate_putAClusterWithMaximumParameters() {
	...
	poller, err := clientFactory.NewManagedClustersClient().BeginCreateOrUpdate(ctx, "resRg", "mycluster", nil)
	if err != nil {
...
// Generated from example definition: 2024-11-01-preview/ManagedClusterPutOperation_example_min.json
...
// Generated from example definition: 2024-11-01-preview/ManagedClusterDeleteOperation_example.json
...
// Generated from example definition: 2024-11-01-preview/ManagedClusterGetOperation_example.json
...
// Generated from example definition: 2024-11-01-preview/ManagedClusterListByResourceGroupOperation_example.json
...
// Generated from example definition: 2024-11-01-preview/ManagedClusterPatchOperation_example.json
func ExampleManagedClustersClient_Update() {
	...
	res, err := clientFactory.NewManagedClustersClient().Update(ctx, "resRg", "myCluster", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
