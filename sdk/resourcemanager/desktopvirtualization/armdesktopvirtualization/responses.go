...
// ControlSessionHostProvisioningClientPostResponse contains the response from method ControlSessionHostProvisioningClient.BeginPost.
type ControlSessionHostProvisioningClientPostResponse struct {
	// placeholder for future response values
}
...
// SessionHostProvisioningStatusesClientGetResponse contains the response from method SessionHostProvisioningStatusesClient.Get.
type SessionHostProvisioningStatusesClientGetResponse struct {
