...
func (client *DatabasesClient) BeginCreate(ctx context.Context, resourceGroupName string, clusterName string, databaseName string, resource Database, options *DatabasesClientBeginCreateOptions) (*runtime.Poller[DatabasesClientCreateResponse], error) {
...
// If the operation fails it returns an *azcore.ResponseError type.
// Generated from API version 2022-01-01
func (client *DatabasesClient) create(ctx context.Context, resourceGroupName string, clusterName string, databaseName string, resource Database, options *DatabasesClientBeginCreateOptions) (*http.Response, error) {
...
func (client *DatabasesClient) createCreateRequest(ctx context.Context, resourceGroupName string, clusterName string, databaseName string, resource Database, options *DatabasesClientBeginCreateOptions) (*policy.Request, error) {
...
func (client *DatabasesClient) BeginExportRdb(ctx context.Context, resourceGroupName string, clusterName string, databaseName string, body ExportParameters, options *DatabasesClientBeginExportRdbOptions) (*runtime.Poller[DatabasesClientExportRdbResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return runtime.NewPoller(resp, client.pl, &runtime.NewPollerOptions[DatabasesClientExportRdbResponse]{
			FinalStateVia: runtime.FinalStateViaAzureAsyncOp,
		})
	} else {
		return runtime.NewPollerFromResumeToken[DatabasesClientExportRdbResponse](options.ResumeToken, client.pl, nil)
	}
}
...
func (client *DatabasesClient) BeginImportRdb(ctx context.Context, resourceGroupName string, clusterName string, databaseName string, body ImportParameters, options *DatabasesClientBeginImportRdbOptions) (*runtime.Poller[DatabasesClientImportRdbResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return runtime.NewPoller(resp, client.pl, &runtime.NewPollerOptions[DatabasesClientImportRdbResponse]{
			FinalStateVia: runtime.FinalStateViaAzureAsyncOp,
		})
	} else {
		return runtime.NewPollerFromResumeToken[DatabasesClientImportRdbResponse](options.ResumeToken, client.pl, nil)
	}
}
...
func (client *DatabasesClient) BeginUpdate(ctx context.Context, resourceGroupName string, clusterName string, databaseName string, properties interface{}, options *DatabasesClientBeginUpdateOptions) (*runtime.Poller[DatabasesClientUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
...
// If the operation fails it returns an *azcore.ResponseError type.
// Generated from API version 2022-01-01
func (client *DatabasesClient) update(ctx context.Context, resourceGroupName string, clusterName string, databaseName string, properties interface{}, options *DatabasesClientBeginUpdateOptions) (*http.Response, error) {
...
func (client *DatabasesClient) updateCreateRequest(ctx context.Context, resourceGroupName string, clusterName string, databaseName string, properties interface{}, options *DatabasesClientBeginUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cache/redisEnterprise/{clusterName}/databases/{databaseName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
