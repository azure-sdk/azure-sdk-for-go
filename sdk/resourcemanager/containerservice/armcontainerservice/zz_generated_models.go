...
type ManagedClusterAgentPoolProfile struct {
	...
	// If orchestratorVersion was a fully specified version , this field will be exactly equal to it. If orchestratorVersion was
	// , this field will contain the full version being used.
...
// ManagedClusterWorkloadAutoScalerProfile - Configuration of Kubernetes workload auto scalers.
type ManagedClusterWorkloadAutoScalerProfile struct {
	// KEDA auto scaler configuration.
	Keda *WorkloadAutoScalerKedaConfiguration `json:"keda,omitempty"`
}
...
// WorkloadAutoScalerKedaConfiguration - KEDA auto scaler configuration.
type WorkloadAutoScalerKedaConfiguration struct {
	// REQUIRED; Whether KEDA is enabled.
	Enabled *bool `json:"enabled,omitempty"`
}
