...
type ManagedIntegrationRuntimeManagedVirtualNetworkReference struct {
	...
	// READ-ONLY; The id of the managed virtual network.
	ID *string `json:"id,omitempty" azure:"ro"`
}
...
type SelfHostedIntegrationRuntimeStatusTypeProperties struct {
	...
	AutoUpdateETA *time.Time `json:"autoUpdateETA,omitempty"`
	...
	// READ-ONLY; OS Type, 1- Windows; 2- Linux
	...
	// READ-ONLY; Target framework type, 0 - DotNetFramework ; 1 - DotNetCore
