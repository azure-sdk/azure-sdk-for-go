...
type ServerFactory struct {
	// ApplicationResourcesServer contains the fakes for client ApplicationResourcesClient
	...
	// BusinessProcessVersionsServer contains the fakes for client BusinessProcessVersionsClient
	BusinessProcessVersionsServer BusinessProcessVersionsServer

	// BusinessProcessesServer contains the fakes for client BusinessProcessesClient
	BusinessProcessesServer BusinessProcessesServer

	// InfrastructureResourcesServer contains the fakes for client InfrastructureResourcesClient
	InfrastructureResourcesServer InfrastructureResourcesServer

	// OperationsServer contains the fakes for client OperationsClient
	OperationsServer OperationsServer

	// SpacesServer contains the fakes for client SpacesClient
