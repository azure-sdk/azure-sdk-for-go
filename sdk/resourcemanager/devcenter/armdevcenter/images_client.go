...
func (client *ImagesClient) getByProjectCreateRequest(ctx context.Context, resourceGroupName string, projectName string, imageName string, options *ImagesClientGetByProjectOptions) (*policy.Request, error) {
...
func (client *ImagesClient) listByProjectCreateRequest(ctx context.Context, resourceGroupName string, projectName string, options *ImagesClientListByProjectOptions) (*policy.Request, error) {
