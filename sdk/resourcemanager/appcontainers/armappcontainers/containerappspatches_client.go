...
func NewContainerAppsPatchesClient(subscriptionID string, containerAppName string, credential azcore.TokenCredential, options *arm.ClientOptions) (*ContainerAppsPatchesClient, error) {
...
//     method.
func (client *ContainerAppsPatchesClient) BeginApply(ctx context.Context, resourceGroupName string, patchName string, options *ContainerAppsPatchesClientBeginApplyOptions) (*runtime.Poller[ContainerAppsPatchesClientApplyResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.apply(ctx, resourceGroupName, patchName, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2024-02-02-preview
func (client *ContainerAppsPatchesClient) apply(ctx context.Context, resourceGroupName string, patchName string, options *ContainerAppsPatchesClientBeginApplyOptions) (*http.Response, error) {
	var err error
	const operationName = "ContainerAppsPatchesClient.BeginApply"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.applyCreateRequest(ctx, resourceGroupName, patchName, options)
	if err != nil {
		return nil, err
	}
...
func (client *ContainerAppsPatchesClient) applyCreateRequest(ctx context.Context, resourceGroupName string, patchName string, options *ContainerAppsPatchesClientBeginApplyOptions) (*policy.Request, error) {
...
//     method.
func (client *ContainerAppsPatchesClient) BeginDelete(ctx context.Context, resourceGroupName string, patchName string, options *ContainerAppsPatchesClientBeginDeleteOptions) (*runtime.Poller[ContainerAppsPatchesClientDeleteResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.deleteOperation(ctx, resourceGroupName, patchName, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2024-02-02-preview
func (client *ContainerAppsPatchesClient) deleteOperation(ctx context.Context, resourceGroupName string, patchName string, options *ContainerAppsPatchesClientBeginDeleteOptions) (*http.Response, error) {
	var err error
	const operationName = "ContainerAppsPatchesClient.BeginDelete"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.deleteCreateRequest(ctx, resourceGroupName, patchName, options)
	if err != nil {
		return nil, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
...
func (client *ContainerAppsPatchesClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, patchName string, options *ContainerAppsPatchesClientBeginDeleteOptions) (*policy.Request, error) {
...
//     method.
func (client *ContainerAppsPatchesClient) Get(ctx context.Context, resourceGroupName string, patchName string, options *ContainerAppsPatchesClientGetOptions) (ContainerAppsPatchesClientGetResponse, error) {
	var err error
	const operationName = "ContainerAppsPatchesClient.Get"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.getCreateRequest(ctx, resourceGroupName, patchName, options)
	if err != nil {
...
func (client *ContainerAppsPatchesClient) getCreateRequest(ctx context.Context, resourceGroupName string, patchName string, options *ContainerAppsPatchesClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.App/containerApps/{containerAppName}/patches/{patchName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
//     method.
func (client *ContainerAppsPatchesClient) NewListByContainerAppPager(resourceGroupName string, options *ContainerAppsPatchesClientListByContainerAppOptions) *runtime.Pager[ContainerAppsPatchesClientListByContainerAppResponse] {
	return runtime.NewPager(runtime.PagingHandler[ContainerAppsPatchesClientListByContainerAppResponse]{
		...
		Fetcher: func(ctx context.Context, page *ContainerAppsPatchesClientListByContainerAppResponse) (ContainerAppsPatchesClientListByContainerAppResponse, error) {
			...
			resp, err := runtime.FetcherForNextLink(ctx, client.internal.Pipeline(), nextLink, func(ctx context.Context) (*policy.Request, error) {
				return client.listByContainerAppCreateRequest(ctx, resourceGroupName, options)
			}, nil)
			if err != nil {
...
func (client *ContainerAppsPatchesClient) listByContainerAppCreateRequest(ctx context.Context, resourceGroupName string, options *ContainerAppsPatchesClientListByContainerAppOptions) (*policy.Request, error) {
...
//     method.
func (client *ContainerAppsPatchesClient) BeginSkipConfigure(ctx context.Context, resourceGroupName string, patchName string, patchSkipConfig PatchSkipConfig, options *ContainerAppsPatchesClientBeginSkipConfigureOptions) (*runtime.Poller[ContainerAppsPatchesClientSkipConfigureResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.skipConfigure(ctx, resourceGroupName, patchName, patchSkipConfig, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2024-02-02-preview
func (client *ContainerAppsPatchesClient) skipConfigure(ctx context.Context, resourceGroupName string, patchName string, patchSkipConfig PatchSkipConfig, options *ContainerAppsPatchesClientBeginSkipConfigureOptions) (*http.Response, error) {
	var err error
	const operationName = "ContainerAppsPatchesClient.BeginSkipConfigure"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.skipConfigureCreateRequest(ctx, resourceGroupName, patchName, patchSkipConfig, options)
	if err != nil {
		return nil, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
...
func (client *ContainerAppsPatchesClient) skipConfigureCreateRequest(ctx context.Context, resourceGroupName string, patchName string, patchSkipConfig PatchSkipConfig, options *ContainerAppsPatchesClientBeginSkipConfigureOptions) (*policy.Request, error) {
