...
- New enum type `DefaultBuilderConfigurationState` with values `DefaultBuilderConfigurationStateDisabled`, `DefaultBuilderConfigurationStateEnabled`
...
- New enum type `TriggerType` with values `TriggerTypeManual`
...
- New field `DefaultBuilderConfiguration` in struct `BuildServiceProperties`
