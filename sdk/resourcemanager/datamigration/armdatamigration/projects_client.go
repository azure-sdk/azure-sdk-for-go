...
// a new project or updates an existing one. Database Migration Service (classic) - SQL scenarios
// are on a deprecation path and will be retired on 15 March 2026 for all customers. Please migrate to Azure SQL database
// services by using the latest Azure Database Migration Service version which is
...
// existing project. Database Migration Service (classic) - SQL scenarios are on a
// deprecation path and will be retired on 15 March 2026 for all customers. Please migrate to Azure SQL database services
// by using the latest Azure Database Migration Service version which is available
