...
func (s SasTokenGenerationParameters) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "signedParameters", s.SignedParameters)
	return json.Marshal(objectMap)
}
...
func (s *SasTokenGenerationParameters) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "resourceType":
			...
			delete(rawMsg, key)
		case "signedParameters":
			err = unpopulate(val, "SignedParameters", &s.SignedParameters)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", s, err)
...
// MarshalJSON implements the json.Marshaller interface for type SignedParameters.
func (s SignedParameters) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type SignedParameters.
func (s *SignedParameters) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
