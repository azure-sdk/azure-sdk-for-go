...
type HypervHostControllerServer struct {
	...
	// Delete is the fake for method HypervHostControllerClient.Delete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	Delete func(ctx context.Context, resourceGroupName string, siteName string, hostName string, options *armmigrate.HypervHostControllerClientDeleteOptions) (resp azfake.Responder[armmigrate.HypervHostControllerClientDeleteResponse], errResp azfake.ErrorResponder)
...
func (h *HypervHostControllerServerTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "HypervHostControllerClient.Delete":
...
func (h *HypervHostControllerServerTransport) dispatchDelete(req *http.Request) (*http.Response, error) {
	if h.srv.Delete == nil {
	...
	respr, errRespr := h.srv.Delete(req.Context(), resourceGroupNameParam, siteNameParam, hostNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
