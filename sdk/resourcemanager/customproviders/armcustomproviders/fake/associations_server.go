...
func (a *AssociationsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if associationsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = associationsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to AssociationsServerTransport
var associationsServerTransportInterceptor interface {
