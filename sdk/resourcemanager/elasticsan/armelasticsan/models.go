...
type ElasticSan struct {
	...
	// READ-ONLY; The name of the ElasticSan.
	Name *string
...
// PrivateLinkResourceListResult - Paged collection of PrivateLinkResource items
...
type Snapshot struct {
	...
	// READ-ONLY; The name of the volume snapshot within the given volume group.
	Name *string
...
type VolumeGroup struct {
	...
	// READ-ONLY; The name of the VolumeGroup.
	Name *string
