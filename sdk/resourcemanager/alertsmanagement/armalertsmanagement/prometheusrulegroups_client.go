...
// NewListBySubscriptionTestPager - Retrieve Prometheus all rule group definitions in a subscription.
//
// Generated from API version 2023-03-01
//   - options - PrometheusRuleGroupsClientListBySubscriptionTestOptions contains the optional parameters for the PrometheusRuleGroupsClient.NewListBySubscriptionTestPager
//     method.
func (client *PrometheusRuleGroupsClient) NewListBySubscriptionTestPager(options *PrometheusRuleGroupsClientListBySubscriptionTestOptions) *runtime.Pager[PrometheusRuleGroupsClientListBySubscriptionTestResponse] {
	return runtime.NewPager(runtime.PagingHandler[PrometheusRuleGroupsClientListBySubscriptionTestResponse]{
		More: func(page PrometheusRuleGroupsClientListBySubscriptionTestResponse) bool {
			return false
		},
		Fetcher: func(ctx context.Context, page *PrometheusRuleGroupsClientListBySubscriptionTestResponse) (PrometheusRuleGroupsClientListBySubscriptionTestResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "PrometheusRuleGroupsClient.NewListBySubscriptionTestPager")
			req, err := client.listBySubscriptionTestCreateRequest(ctx, options)
			if err != nil {
				return PrometheusRuleGroupsClientListBySubscriptionTestResponse{}, err
			}
			resp, err := client.internal.Pipeline().Do(req)
			if err != nil {
				return PrometheusRuleGroupsClientListBySubscriptionTestResponse{}, err
			...
			if !runtime.HasStatusCode(resp, http.StatusOK) {
				return PrometheusRuleGroupsClientListBySubscriptionTestResponse{}, runtime.NewResponseError(resp)
			}
			return client.listBySubscriptionTestHandleResponse(resp)
		},
		Tracer: client.internal.Tracer(),
	})
}

// listBySubscriptionTestCreateRequest creates the ListBySubscriptionTest request.
func (client *PrometheusRuleGroupsClient) listBySubscriptionTestCreateRequest(ctx context.Context, options *PrometheusRuleGroupsClientListBySubscriptionTestOptions) (*policy.Request, error) {
...
// listBySubscriptionTestHandleResponse handles the ListBySubscriptionTest response.
func (client *PrometheusRuleGroupsClient) listBySubscriptionTestHandleResponse(resp *http.Response) (PrometheusRuleGroupsClientListBySubscriptionTestResponse, error) {
	result := PrometheusRuleGroupsClientListBySubscriptionTestResponse{}
	if err := runtime.UnmarshalAsJSON(resp, &result.PrometheusRuleGroupResourceCollection); err != nil {
		return PrometheusRuleGroupsClientListBySubscriptionTestResponse{}, err
	}
	return result, nil
