...
// IntegrationRuntimesOperationStatus - integration runtime operation results request.
type IntegrationRuntimesOperationStatus struct {
...
// ManagementClientIntegrationRuntimeStartOperationStatusOptions contains the optional parameters for the ManagementClient.IntegrationRuntimeStartOperationStatus
// method.
type ManagementClientIntegrationRuntimeStartOperationStatusOptions struct {
	// ETag of the integration runtime entity. Should only be specified for get. If the ETag matches the existing entity tag,
	// or if * was provided, then no content will be returned.
	IfNoneMatch *string
}
