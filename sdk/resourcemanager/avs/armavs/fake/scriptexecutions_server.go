...
type ScriptExecutionsServer struct {
	...
	// HTTP status codes to indicate success: http.StatusOK
	NewListByPrivateCloudPager func(resourceGroupName string, privateCloudName string, options *armavs.ScriptExecutionsClientListByPrivateCloudOptions) (resp azfake.PagerResponder[armavs.ScriptExecutionsClientListByPrivateCloudResponse])
}
