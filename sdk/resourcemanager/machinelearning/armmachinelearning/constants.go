...
// GenerationTokenStatisticsMetric - Generation token statistics metric enum.
...
// PossibleGenerationTokenStatisticsMetricValues returns the possible values for the GenerationTokenStatisticsMetric const type.
func PossibleGenerationTokenStatisticsMetricValues() []GenerationTokenStatisticsMetric {
	return []GenerationTokenStatisticsMetric{
...
const (
	...
	// MonitoringInputDataTypeTrailing - An input data which trailing relatively to the monitor's current run.
...
func PossibleMonitoringInputDataTypeValues() []MonitoringInputDataType {
	return []MonitoringInputDataType{
		...
		MonitoringInputDataTypeTrailing,
	}
}
