...
// Generated from example definition: 2023-10-20/TagRules_CreateOrUpdate.json
func ExampleTagRulesClient_CreateOrUpdate() {
	...
	res, err := clientFactory.NewTagRulesClient().CreateOrUpdate(ctx, "myResourceGroup", "myMonitor", "default", armdatadog.MonitoringTagRules{
	...
	// res = armdatadog.TagRulesClientCreateOrUpdateResponse{
	// 	MonitoringTagRules: &armdatadog.MonitoringTagRules{
	// 		Name: to.Ptr("default"),
...
// Generated from example definition: 2023-10-20/TagRules_Get.json
func ExampleTagRulesClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armdatadog.TagRulesClientGetResponse{
	// 	MonitoringTagRules: &armdatadog.MonitoringTagRules{
	// 		Name: to.Ptr("default"),
	// 		Type: to.Ptr("Microsoft.Datadog/monitors/tagRules"),
	// 		ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/myResourceGroup/providers/Microsoft.Datadog/monitors/myMonitor/tagRules/default"),
...
// Generated from example definition: 2023-10-20/TagRules_List.json
func ExampleTagRulesClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armdatadog.TagRulesClientListResponse{
		// 	MonitoringTagRulesListResponse: armdatadog.MonitoringTagRulesListResponse{
