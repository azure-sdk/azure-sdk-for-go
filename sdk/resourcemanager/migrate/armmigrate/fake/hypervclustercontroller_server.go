...
func (h *HypervClusterControllerServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if hypervClusterControllerServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = hypervClusterControllerServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			case "HypervClusterControllerClient.BeginCreateCluster":
				res.resp, res.err = h.dispatchBeginCreateCluster(req)
			...
			case "HypervClusterControllerClient.GetCluster":
				res.resp, res.err = h.dispatchGetCluster(req)
...
// set this to conditionally intercept incoming requests to HypervClusterControllerServerTransport
var hypervClusterControllerServerTransportInterceptor interface {
