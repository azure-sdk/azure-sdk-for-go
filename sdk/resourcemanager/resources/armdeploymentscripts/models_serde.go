...
// UnmarshalJSON implements the json.Unmarshaller interface for type DeploymentScriptPropertiesBase.
func (d *DeploymentScriptPropertiesBase) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", d, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "cleanupPreference":
			err = unpopulate(val, "CleanupPreference", &d.CleanupPreference)
			delete(rawMsg, key)
		case "containerSettings":
			err = unpopulate(val, "ContainerSettings", &d.ContainerSettings)
			delete(rawMsg, key)
		case "outputs":
		...
		case "status":
			...
			delete(rawMsg, key)
		case "storageAccountSettings":
			err = unpopulate(val, "StorageAccountSettings", &d.StorageAccountSettings)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", d, err)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type ScriptConfigurationBase.
func (s *ScriptConfigurationBase) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
	...
	for key, val := range rawMsg {
		...
		case "forceUpdateTag":
			...
			delete(rawMsg, key)
		case "primaryScriptUri":
			err = unpopulate(val, "PrimaryScriptURI", &s.PrimaryScriptURI)
			delete(rawMsg, key)
		case "retentionInterval":
			err = unpopulate(val, "RetentionInterval", &s.RetentionInterval)
			delete(rawMsg, key)
		case "scriptContent":
			err = unpopulate(val, "ScriptContent", &s.ScriptContent)
			delete(rawMsg, key)
		case "supportingScriptUris":
			err = unpopulate(val, "SupportingScriptUris", &s.SupportingScriptUris)
			delete(rawMsg, key)
		case "timeout":
