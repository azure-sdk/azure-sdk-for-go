...
func unmarshalDetailsBaseClassification(rawMsg json.RawMessage) (DetailsBaseClassification, error) {
	if rawMsg == nil || string(rawMsg) == "null" {
		return nil, nil
	}
	var m map[string]any
	...
	var b DetailsBaseClassification
	switch m["detailsType"] {
	case string(DetailsTypeAbnormalEvent):
		b = &AbnormalEventDetails{}
	case string(DetailsTypeAzureMetric):
		b = &AzureMetricDetails{}
	case string(DetailsTypeDiagnostics):
		b = &DiagnosticsSolutionDetails{}
	case string(DetailsTypeInvestigation):
		b = &InvestigationDetails{}
	case string(DetailsTypeRelatedAlert):
		b = &RelatedAlertDetails{}
	case string(DetailsTypeResourceHealth):
		b = &ResourceHealthDetails{}
	default:
		b = &DetailsBase{}
	}
	if err := json.Unmarshal(rawMsg, b); err != nil {
