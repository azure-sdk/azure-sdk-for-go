...
// ListByAPI - Get the policy configuration at the workspace level.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2022-09-01-preview
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
...
//     method.
func (client *WorkspacePolicyClient) ListByAPI(ctx context.Context, resourceGroupName string, serviceName string, workspaceID string, options *WorkspacePolicyClientListByAPIOptions) (WorkspacePolicyClientListByAPIResponse, error) {
