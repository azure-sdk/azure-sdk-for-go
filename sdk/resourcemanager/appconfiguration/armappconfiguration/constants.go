...
// SasAuth - This property manages if SAS token authentication is enabled or disabled.
type SasAuth string

const (
	// SasAuthDisabled - SAS token authentication is disabled.
	SasAuthDisabled SasAuth = "Disabled"
	// SasAuthEnabled - SAS token authentication is enabled.
	SasAuthEnabled SasAuth = "Enabled"
)

// PossibleSasAuthValues returns the possible values for the SasAuth const type.
func PossibleSasAuthValues() []SasAuth {
	return []SasAuth{
		SasAuthDisabled,
		SasAuthEnabled,
	}
...
// SasTokenKind - The kind of the SAS token.
type SasTokenKind string

const (
	SasTokenKindPrimary   SasTokenKind = "Primary"
	SasTokenKindSecondary SasTokenKind = "Secondary"
)

// PossibleSasTokenKindValues returns the possible values for the SasTokenKind const type.
func PossibleSasTokenKindValues() []SasTokenKind {
	return []SasTokenKind{
		SasTokenKindPrimary,
		SasTokenKindSecondary,
	}
}
