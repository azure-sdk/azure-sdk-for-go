...
func (client *CostsClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, labName string, name string, labCost LabCost, _ *CostsClientCreateOrUpdateOptions) (*policy.Request, error) {
