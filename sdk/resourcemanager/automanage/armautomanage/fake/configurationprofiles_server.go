...
func (c *ConfigurationProfilesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if configurationProfilesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = configurationProfilesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to ConfigurationProfilesServerTransport
var configurationProfilesServerTransportInterceptor interface {
