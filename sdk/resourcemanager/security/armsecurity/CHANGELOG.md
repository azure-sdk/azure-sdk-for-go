...
- New function `*SensitivitySettingsClient.GetSensitivitySettings(context.Context, *SensitivitySettingsClientGetSensitivitySettingsOptions) (SensitivitySettingsClientGetSensitivitySettingsResponse, error)`
- New function `*SensitivitySettingsClient.ListSensitivitySettings(context.Context, *SensitivitySettingsClientListSensitivitySettingsOptions) (SensitivitySettingsClientListSensitivitySettingsResponse, error)`
- New function `*SensitivitySettingsClient.UpdateSensitivitySettings(context.Context, UpdateSensitivitySettingsRequest, *SensitivitySettingsClientUpdateSensitivitySettingsOptions) (SensitivitySettingsClientUpdateSensitivitySettingsResponse, error)`
