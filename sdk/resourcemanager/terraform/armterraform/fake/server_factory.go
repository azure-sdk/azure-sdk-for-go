...
type ServerFactory struct {
	AzureTerraformManagementServer AzureTerraformManagementServer
...
type ServerFactoryTransport struct {
	srv                              *ServerFactory
	trMu                             sync.Mutex
	trAzureTerraformManagementServer *AzureTerraformManagementServerTransport
...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	switch client {
	case "AzureTerraformManagementClient":
		initServer(s, &s.trAzureTerraformManagementServer, func() *AzureTerraformManagementServerTransport {
			return NewAzureTerraformManagementServerTransport(&s.srv.AzureTerraformManagementServer)
		})
		resp, err = s.trAzureTerraformManagementServer.Do(req)
