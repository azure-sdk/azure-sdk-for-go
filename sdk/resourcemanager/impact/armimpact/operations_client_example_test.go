...
func ExampleOperationsClient_NewListPager() {
	...
	clientFactory, err := armimpact.NewClientFactory("<subscriptionID>", cred, nil)
	if err != nil {
	...
	for pager.More() {
		...
		// page = armimpact.OperationsClientListResponse{
		// 	OperationListResult: armimpact.OperationListResult{
		// 		Value: []*armimpact.Operation{
		// 			{
		// 				Name: to.Ptr("Microsoft.Impact/workloadImpacts/write"),
		// 				Display: &armimpact.OperationDisplay{
