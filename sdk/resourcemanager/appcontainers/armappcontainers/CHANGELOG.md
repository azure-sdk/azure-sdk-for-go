...
- New field `DomainControlValidation` in struct `CertificateProperties`
- New field `Error` in struct `CertificateProperties`
- New field `ValidationToken` in struct `CertificateProperties`
