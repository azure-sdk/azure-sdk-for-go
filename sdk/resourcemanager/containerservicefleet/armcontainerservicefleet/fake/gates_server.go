...
type GatesServer struct {
	...
	BeginUpdate func(ctx context.Context, resourceGroupName string, fleetName string, gateName string, properties armcontainerservicefleet.GateUpdate, options *armcontainerservicefleet.GatesClientBeginUpdateOptions) (resp azfake.PollerResponder[armcontainerservicefleet.GatesClientUpdateResponse], errResp azfake.ErrorResponder)
}
...
func (g *GatesServerTransport) dispatchBeginUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginUpdate == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armcontainerservicefleet.GateUpdate](req)
		if err != nil {
			return nil, err
		}
		resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
