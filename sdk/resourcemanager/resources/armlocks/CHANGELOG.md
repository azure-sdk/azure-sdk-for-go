...
- Enum `LockLevel` has been removed
- Function `NewAuthorizationOperationsClient` has been removed
- Function `*AuthorizationOperationsClient.NewListPager` has been removed
...
- Function `NewManagementLocksClient` has been removed
- Function `*ManagementLocksClient.CreateOrUpdateAtResourceGroupLevel` has been removed
- Function `*ManagementLocksClient.CreateOrUpdateAtResourceLevel` has been removed
- Function `*ManagementLocksClient.CreateOrUpdateAtSubscriptionLevel` has been removed
- Function `*ManagementLocksClient.CreateOrUpdateByScope` has been removed
- Function `*ManagementLocksClient.DeleteAtResourceGroupLevel` has been removed
- Function `*ManagementLocksClient.DeleteAtResourceLevel` has been removed
- Function `*ManagementLocksClient.DeleteAtSubscriptionLevel` has been removed
- Function `*ManagementLocksClient.DeleteByScope` has been removed
- Function `*ManagementLocksClient.GetAtResourceGroupLevel` has been removed
- Function `*ManagementLocksClient.GetAtResourceLevel` has been removed
- Function `*ManagementLocksClient.GetAtSubscriptionLevel` has been removed
- Function `*ManagementLocksClient.GetByScope` has been removed
- Function `*ManagementLocksClient.NewListAtResourceGroupLevelPager` has been removed
- Function `*ManagementLocksClient.NewListAtResourceLevelPager` has been removed
- Function `*ManagementLocksClient.NewListAtSubscriptionLevelPager` has been removed
- Function `*ManagementLocksClient.NewListByScopePager` has been removed
- Struct `ErrorDetail` has been removed
- Struct `ManagementLockListResult` has been removed
- Struct `ManagementLockObject` has been removed
- Struct `ManagementLockOwner` has been removed
- Struct `ManagementLockProperties` has been removed
