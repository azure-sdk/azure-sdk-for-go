...
- Function `*DeletedServersClient.NewListByLocationPager` has been removed
- Function `*DeletedServersClient.BeginRecover` has been removed
...
- New function `*DeletedServersClient.NewListByResourceGroupPager(string, *DeletedServersClientListByResourceGroupOptions) *runtime.Pager[DeletedServersClientListByResourceGroupResponse]`
...
- New field `ScheduledPurgeDate` in struct `DeletedServerProperties`
