...
// BlockedRescheduleConstraint - Time ranges blocked for rescheduling maintenance
type BlockedRescheduleConstraint struct {
	// READ-ONLY; Start date time
	Category *BlockedDatesConstraintCategory

	// READ-ONLY; The kind of constraint
	Kind *RescheduleConstraintKind

	// READ-ONLY; Date ranges blocked for reschedule
	TimeRanges []*BlockedRescheduleConstraintTimeRange
}

// GetRescheduleConstraint implements the RescheduleConstraintClassification interface for type BlockedRescheduleConstraint.
func (b *BlockedRescheduleConstraint) GetRescheduleConstraint() *RescheduleConstraint {
	return &RescheduleConstraint{
		Kind: b.Kind,
	}
}

// BlockedRescheduleConstraintTimeRange - Blocked Time range Constraints for maintenance
type BlockedRescheduleConstraintTimeRange struct {
	// READ-ONLY; End date Time
	EndAt *time.Time
...
// DeadlineRescheduleConstraint - The deadline constraint for rescheduling maintenance
type DeadlineRescheduleConstraint struct {
	// READ-ONLY; The deadline
	Deadline *time.Time
...
// GetRescheduleConstraint implements the RescheduleConstraintClassification interface for type DeadlineRescheduleConstraint.
func (d *DeadlineRescheduleConstraint) GetRescheduleConstraint() *RescheduleConstraint {
	return &RescheduleConstraint{
		Kind: d.Kind,
	}
}
...
// FreezeDaysRescheduleConstraint - The deadline constraint for rescheduling maintenance
type FreezeDaysRescheduleConstraint struct {
	// READ-ONLY; Freeze days
	FreezeDays []*time.Time

	// READ-ONLY; The kind of constraint
	Kind *RescheduleConstraintKind
}

// GetRescheduleConstraint implements the RescheduleConstraintClassification interface for type FreezeDaysRescheduleConstraint.
func (f *FreezeDaysRescheduleConstraint) GetRescheduleConstraint() *RescheduleConstraint {
	return &RescheduleConstraint{
		Kind: f.Kind,
	}
}
...
// Reschedule - Constraints for rescheduling maintenance
type Reschedule struct {
	// READ-ONLY; Constraints for rescheduling maintenance
	Constraints []RescheduleConstraintClassification
...
// RescheduleConstraint - Constraint for rescheduling maintenance
type RescheduleConstraint struct {
	// READ-ONLY; The kind of constraint
	Kind *RescheduleConstraintKind
}

// GetRescheduleConstraint implements the RescheduleConstraintClassification interface for type RescheduleConstraint.
func (r *RescheduleConstraint) GetRescheduleConstraint() *RescheduleConstraint { return r }
