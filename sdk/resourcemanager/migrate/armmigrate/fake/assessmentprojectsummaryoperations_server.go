...
// AssessmentProjectSummaryOperationsServer is a fake server for instances of the armmigrate.AssessmentProjectSummaryOperationsClient type.
type AssessmentProjectSummaryOperationsServer struct {
	...
	Get func(ctx context.Context, resourceGroupName string, projectName string, projectSummaryName string, options *armmigrate.AssessmentProjectSummaryOperationsClientGetOptions) (resp azfake.Responder[armmigrate.AssessmentProjectSummaryOperationsClientGetResponse], errResp azfake.ErrorResponder)
	...
	// HTTP status codes to indicate success: http.StatusOK
	NewListByAssessmentProjectPager func(resourceGroupName string, projectName string, options *armmigrate.AssessmentProjectSummaryOperationsClientListByAssessmentProjectOptions) (resp azfake.PagerResponder[armmigrate.AssessmentProjectSummaryOperationsClientListByAssessmentProjectResponse])
}
...
// The returned AssessmentProjectSummaryOperationsServerTransport instance is connected to an instance of armmigrate.AssessmentProjectSummaryOperationsClient via the
...
func NewAssessmentProjectSummaryOperationsServerTransport(srv *AssessmentProjectSummaryOperationsServer) *AssessmentProjectSummaryOperationsServerTransport {
	return &AssessmentProjectSummaryOperationsServerTransport{
		srv:                             srv,
		newListByAssessmentProjectPager: newTracker[azfake.PagerResponder[armmigrate.AssessmentProjectSummaryOperationsClientListByAssessmentProjectResponse]](),
	}
}

// AssessmentProjectSummaryOperationsServerTransport connects instances of armmigrate.AssessmentProjectSummaryOperationsClient to instances of AssessmentProjectSummaryOperationsServer.
...
type AssessmentProjectSummaryOperationsServerTransport struct {
	...
	newListByAssessmentProjectPager *tracker[azfake.PagerResponder[armmigrate.AssessmentProjectSummaryOperationsClientListByAssessmentProjectResponse]]
}
...
func (a *AssessmentProjectSummaryOperationsServerTransport) dispatchNewListByAssessmentProjectPager(req *http.Request) (*http.Response, error) {
	...
	if newListByAssessmentProjectPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListByAssessmentProjectPager, req, func(page *armmigrate.AssessmentProjectSummaryOperationsClientListByAssessmentProjectResponse, createLink func() string) {
