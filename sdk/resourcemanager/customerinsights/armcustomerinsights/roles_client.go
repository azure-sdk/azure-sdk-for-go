...
func (client *RolesClient) listByHubCreateRequest(ctx context.Context, resourceGroupName string, hubName string, _ *RolesClientListByHubOptions) (*policy.Request, error) {
