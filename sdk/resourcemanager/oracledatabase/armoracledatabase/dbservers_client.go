...
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - cloudexadatainfrastructurename - CloudExadataInfrastructure name
//   - options - DbServersClientListByParentOptions contains the optional parameters for the DbServersClient.NewListByParentPager
//     method.
func (client *DbServersClient) NewListByParentPager(resourceGroupName string, cloudexadatainfrastructurename string, options *DbServersClientListByParentOptions) *runtime.Pager[DbServersClientListByParentResponse] {
	return runtime.NewPager(runtime.PagingHandler[DbServersClientListByParentResponse]{
		More: func(page DbServersClientListByParentResponse) bool {
			return page.NextLink != nil && len(*page.NextLink) > 0
		},
		Fetcher: func(ctx context.Context, page *DbServersClientListByParentResponse) (DbServersClientListByParentResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "DbServersClient.NewListByParentPager")
			nextLink := ""
			if page != nil {
				nextLink = *page.NextLink
			}
			resp, err := runtime.FetcherForNextLink(ctx, client.internal.Pipeline(), nextLink, func(ctx context.Context) (*policy.Request, error) {
				return client.listByParentCreateRequest(ctx, resourceGroupName, cloudexadatainfrastructurename, options)
			}, nil)
			if err != nil {
				return DbServersClientListByParentResponse{}, err
			}
...
func (client *DbServersClient) listByParentCreateRequest(ctx context.Context, resourceGroupName string, cloudexadatainfrastructurename string, _ *DbServersClientListByParentOptions) (*policy.Request, error) {
...
func (client *DbServersClient) listByParentHandleResponse(resp *http.Response) (DbServersClientListByParentResponse, error) {
	result := DbServersClientListByParentResponse{}
