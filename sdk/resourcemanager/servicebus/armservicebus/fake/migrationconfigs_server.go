...
func (m *MigrationConfigsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if migrationConfigsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = migrationConfigsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			case "MigrationConfigsClient.CompleteMigration":
				res.resp, res.err = m.dispatchCompleteMigration(req)
			case "MigrationConfigsClient.BeginCreateAndStartMigration":
				res.resp, res.err = m.dispatchBeginCreateAndStartMigration(req)
			...
			case "MigrationConfigsClient.Revert":
				res.resp, res.err = m.dispatchRevert(req)
			default:
...
// set this to conditionally intercept incoming requests to MigrationConfigsServerTransport
var migrationConfigsServerTransportInterceptor interface {
