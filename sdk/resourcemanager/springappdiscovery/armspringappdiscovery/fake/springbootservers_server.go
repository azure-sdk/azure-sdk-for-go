...
func (s *SpringbootserversServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if springbootserversServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = springbootserversServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to SpringbootserversServerTransport
var springbootserversServerTransportInterceptor interface {
