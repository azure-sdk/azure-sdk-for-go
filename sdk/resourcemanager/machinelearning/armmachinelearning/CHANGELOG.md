...
- New type alias `FeatureDataType` with values `FeatureDataTypeBinary`, `FeatureDataTypeDatetime`, `FeatureDataTypeDouble`, `FeatureDataTypeFloat`, `FeatureDataTypeInteger`, `FeatureDataTypeLong`, `FeatureDataTypeString`
...
- New function `*ModelVersionsClient.BeginPackage(context.Context, string, string, string, string, any, *ModelVersionsClientBeginPackageOptions) (*runtime.Poller[ModelVersionsClientPackageResponse], error)`
...
- New field `DeploymentProperties` in struct `BatchDeploymentProperties`
