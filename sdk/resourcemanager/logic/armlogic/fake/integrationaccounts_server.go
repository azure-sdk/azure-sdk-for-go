...
type IntegrationAccountsServer struct {
	...
	CreateOrUpdate func(ctx context.Context, resourceGroupName string, integrationAccountName string, resource armlogic.IntegrationAccount, options *armlogic.IntegrationAccountsClientCreateOrUpdateOptions) (resp azfake.Responder[armlogic.IntegrationAccountsClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)
	...
	// HTTP status codes to indicate success: http.StatusOK
	ListCallbackURL func(ctx context.Context, resourceGroupName string, integrationAccountName string, body armlogic.GetCallbackURLParameters, options *armlogic.IntegrationAccountsClientListCallbackURLOptions) (resp azfake.Responder[armlogic.IntegrationAccountsClientListCallbackURLResponse], errResp azfake.ErrorResponder)

	// ListKeyVaultKeys is the fake for method IntegrationAccountsClient.ListKeyVaultKeys
	// HTTP status codes to indicate success: http.StatusOK
	ListKeyVaultKeys func(ctx context.Context, resourceGroupName string, integrationAccountName string, body armlogic.ListKeyVaultKeysDefinition, options *armlogic.IntegrationAccountsClientListKeyVaultKeysOptions) (resp azfake.Responder[armlogic.IntegrationAccountsClientListKeyVaultKeysResponse], errResp azfake.ErrorResponder)

	// LogTrackingEvents is the fake for method IntegrationAccountsClient.LogTrackingEvents
	// HTTP status codes to indicate success: http.StatusOK
	LogTrackingEvents func(ctx context.Context, resourceGroupName string, integrationAccountName string, body armlogic.TrackingEventsDefinition, options *armlogic.IntegrationAccountsClientLogTrackingEventsOptions) (resp azfake.Responder[armlogic.IntegrationAccountsClientLogTrackingEventsResponse], errResp azfake.ErrorResponder)

	// RegenerateAccessKey is the fake for method IntegrationAccountsClient.RegenerateAccessKey
	// HTTP status codes to indicate success: http.StatusOK
	RegenerateAccessKey func(ctx context.Context, resourceGroupName string, integrationAccountName string, body armlogic.RegenerateActionParameter, options *armlogic.IntegrationAccountsClientRegenerateAccessKeyOptions) (resp azfake.Responder[armlogic.IntegrationAccountsClientRegenerateAccessKeyResponse], errResp azfake.ErrorResponder)

	// Update is the fake for method IntegrationAccountsClient.Update
	// HTTP status codes to indicate success: http.StatusOK
	Update func(ctx context.Context, resourceGroupName string, integrationAccountName string, properties armlogic.IntegrationAccount, options *armlogic.IntegrationAccountsClientUpdateOptions) (resp azfake.Responder[armlogic.IntegrationAccountsClientUpdateResponse], errResp azfake.ErrorResponder)
}
...
func (i *IntegrationAccountsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if integrationAccountsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = integrationAccountsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "IntegrationAccountsClient.ListCallbackURL":
				res.resp, res.err = i.dispatchListCallbackURL(req)
			case "IntegrationAccountsClient.ListKeyVaultKeys":
				res.resp, res.err = i.dispatchListKeyVaultKeys(req)
			case "IntegrationAccountsClient.LogTrackingEvents":
				res.resp, res.err = i.dispatchLogTrackingEvents(req)
			case "IntegrationAccountsClient.RegenerateAccessKey":
				res.resp, res.err = i.dispatchRegenerateAccessKey(req)
...
func (i *IntegrationAccountsServerTransport) dispatchListKeyVaultKeys(req *http.Request) (*http.Response, error) {
	if i.srv.ListKeyVaultKeys == nil {
		return nil, &nonRetriableError{errors.New("fake for method ListKeyVaultKeys not implemented")}
	}
	...
	respr, errRespr := i.srv.ListKeyVaultKeys(req.Context(), resourceGroupNameParam, integrationAccountNameParam, body, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
	...
	resp, err := server.MarshalResponseAsJSON(respContent, server.GetResponse(respr).KeyVaultKeyCollection, req)
	if err != nil {
		return nil, err
	}
	return resp, nil
...
// set this to conditionally intercept incoming requests to IntegrationAccountsServerTransport
var integrationAccountsServerTransportInterceptor interface {
