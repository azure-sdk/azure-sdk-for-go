...
func (client *Client) listApprovedSchemasCreateRequest(ctx context.Context, pipeline ListApprovedSchemasRequest, _ *ClientListApprovedSchemasOptions) (*policy.Request, error) {
...
func (client *Client) validateSchemaCreateRequest(ctx context.Context, schema Schema, _ *ClientValidateSchemaOptions) (*policy.Request, error) {
