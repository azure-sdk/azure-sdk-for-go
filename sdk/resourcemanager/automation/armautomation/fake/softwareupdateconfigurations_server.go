...
func (s *SoftwareUpdateConfigurationsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if softwareUpdateConfigurationsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = softwareUpdateConfigurationsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to SoftwareUpdateConfigurationsServerTransport
var softwareUpdateConfigurationsServerTransportInterceptor interface {
