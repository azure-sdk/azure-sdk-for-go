...
//     method.
func (client *WorkloadNetworkDNSServicesClient) NewListByWorkloadNetworkPager(resourceGroupName string, privateCloudName string, options *WorkloadNetworkDNSServicesClientListByWorkloadNetworkOptions) *runtime.Pager[WorkloadNetworkDNSServicesClientListByWorkloadNetworkResponse] {
...
func (client *WorkloadNetworkDNSServicesClient) listByWorkloadNetworkCreateRequest(ctx context.Context, resourceGroupName string, privateCloudName string, _ *WorkloadNetworkDNSServicesClientListByWorkloadNetworkOptions) (*policy.Request, error) {
