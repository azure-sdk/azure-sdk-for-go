...
func (client *AvailableClusterPoolVersionsClient) listByLocationCreateRequest(ctx context.Context, location string, _ *AvailableClusterPoolVersionsClientListByLocationOptions) (*policy.Request, error) {
