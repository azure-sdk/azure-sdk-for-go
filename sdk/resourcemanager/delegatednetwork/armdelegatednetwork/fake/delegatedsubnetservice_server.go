...
func (d *DelegatedSubnetServiceServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if delegatedSubnetServiceServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = delegatedSubnetServiceServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			case "DelegatedSubnetServiceClient.BeginDeleteDetails":
				res.resp, res.err = d.dispatchBeginDeleteDetails(req)
			case "DelegatedSubnetServiceClient.GetDetails":
				res.resp, res.err = d.dispatchGetDetails(req)
			...
			case "DelegatedSubnetServiceClient.BeginPatchDetails":
				res.resp, res.err = d.dispatchBeginPatchDetails(req)
			case "DelegatedSubnetServiceClient.BeginPutDetails":
				res.resp, res.err = d.dispatchBeginPutDetails(req)
			default:
...
// set this to conditionally intercept incoming requests to DelegatedSubnetServiceServerTransport
var delegatedSubnetServiceServerTransportInterceptor interface {
