...
// PolicyDefinitionVersionsServer is a fake server for instances of the armsubscriptions.PolicyDefinitionVersionsClient type.
type PolicyDefinitionVersionsServer struct {
	...
	CreateOrUpdate func(ctx context.Context, policyDefinitionName string, policyDefinitionVersion string, parameters armsubscriptions.PolicyDefinitionVersion, options *armsubscriptions.PolicyDefinitionVersionsClientCreateOrUpdateOptions) (resp azfake.Responder[armsubscriptions.PolicyDefinitionVersionsClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)

	// CreateOrUpdateAtManagementGroup is the fake for method PolicyDefinitionVersionsClient.CreateOrUpdateAtManagementGroup
	// HTTP status codes to indicate success: http.StatusOK, http.StatusCreated
	CreateOrUpdateAtManagementGroup func(ctx context.Context, managementGroupName string, policyDefinitionName string, policyDefinitionVersion string, parameters armsubscriptions.PolicyDefinitionVersion, options *armsubscriptions.PolicyDefinitionVersionsClientCreateOrUpdateAtManagementGroupOptions) (resp azfake.Responder[armsubscriptions.PolicyDefinitionVersionsClientCreateOrUpdateAtManagementGroupResponse], errResp azfake.ErrorResponder)

	// Delete is the fake for method PolicyDefinitionVersionsClient.Delete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	Delete func(ctx context.Context, policyDefinitionName string, policyDefinitionVersion string, options *armsubscriptions.PolicyDefinitionVersionsClientDeleteOptions) (resp azfake.Responder[armsubscriptions.PolicyDefinitionVersionsClientDeleteResponse], errResp azfake.ErrorResponder)

	// DeleteAtManagementGroup is the fake for method PolicyDefinitionVersionsClient.DeleteAtManagementGroup
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	DeleteAtManagementGroup func(ctx context.Context, managementGroupName string, policyDefinitionName string, policyDefinitionVersion string, options *armsubscriptions.PolicyDefinitionVersionsClientDeleteAtManagementGroupOptions) (resp azfake.Responder[armsubscriptions.PolicyDefinitionVersionsClientDeleteAtManagementGroupResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method PolicyDefinitionVersionsClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, policyDefinitionName string, policyDefinitionVersion string, options *armsubscriptions.PolicyDefinitionVersionsClientGetOptions) (resp azfake.Responder[armsubscriptions.PolicyDefinitionVersionsClientGetResponse], errResp azfake.ErrorResponder)

	// GetAtManagementGroup is the fake for method PolicyDefinitionVersionsClient.GetAtManagementGroup
	// HTTP status codes to indicate success: http.StatusOK
	GetAtManagementGroup func(ctx context.Context, managementGroupName string, policyDefinitionName string, policyDefinitionVersion string, options *armsubscriptions.PolicyDefinitionVersionsClientGetAtManagementGroupOptions) (resp azfake.Responder[armsubscriptions.PolicyDefinitionVersionsClientGetAtManagementGroupResponse], errResp azfake.ErrorResponder)

	// GetBuiltIn is the fake for method PolicyDefinitionVersionsClient.GetBuiltIn
	// HTTP status codes to indicate success: http.StatusOK
	GetBuiltIn func(ctx context.Context, policyDefinitionName string, policyDefinitionVersion string, options *armsubscriptions.PolicyDefinitionVersionsClientGetBuiltInOptions) (resp azfake.Responder[armsubscriptions.PolicyDefinitionVersionsClientGetBuiltInResponse], errResp azfake.ErrorResponder)

	// NewListPager is the fake for method PolicyDefinitionVersionsClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(policyDefinitionName string, options *armsubscriptions.PolicyDefinitionVersionsClientListOptions) (resp azfake.PagerResponder[armsubscriptions.PolicyDefinitionVersionsClientListResponse])

	// ListAll is the fake for method PolicyDefinitionVersionsClient.ListAll
	// HTTP status codes to indicate success: http.StatusOK
	ListAll func(ctx context.Context, options *armsubscriptions.PolicyDefinitionVersionsClientListAllOptions) (resp azfake.Responder[armsubscriptions.PolicyDefinitionVersionsClientListAllResponse], errResp azfake.ErrorResponder)

	// ListAllAtManagementGroup is the fake for method PolicyDefinitionVersionsClient.ListAllAtManagementGroup
	// HTTP status codes to indicate success: http.StatusOK
	ListAllAtManagementGroup func(ctx context.Context, managementGroupName string, options *armsubscriptions.PolicyDefinitionVersionsClientListAllAtManagementGroupOptions) (resp azfake.Responder[armsubscriptions.PolicyDefinitionVersionsClientListAllAtManagementGroupResponse], errResp azfake.ErrorResponder)

	// ListAllBuiltins is the fake for method PolicyDefinitionVersionsClient.ListAllBuiltins
	// HTTP status codes to indicate success: http.StatusOK
	ListAllBuiltins func(ctx context.Context, options *armsubscriptions.PolicyDefinitionVersionsClientListAllBuiltinsOptions) (resp azfake.Responder[armsubscriptions.PolicyDefinitionVersionsClientListAllBuiltinsResponse], errResp azfake.ErrorResponder)

	// NewListBuiltInPager is the fake for method PolicyDefinitionVersionsClient.NewListBuiltInPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListBuiltInPager func(policyDefinitionName string, options *armsubscriptions.PolicyDefinitionVersionsClientListBuiltInOptions) (resp azfake.PagerResponder[armsubscriptions.PolicyDefinitionVersionsClientListBuiltInResponse])

	// NewListByManagementGroupPager is the fake for method PolicyDefinitionVersionsClient.NewListByManagementGroupPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByManagementGroupPager func(managementGroupName string, policyDefinitionName string, options *armsubscriptions.PolicyDefinitionVersionsClientListByManagementGroupOptions) (resp azfake.PagerResponder[armsubscriptions.PolicyDefinitionVersionsClientListByManagementGroupResponse])
}
...
// The returned PolicyDefinitionVersionsServerTransport instance is connected to an instance of armsubscriptions.PolicyDefinitionVersionsClient via the
...
func NewPolicyDefinitionVersionsServerTransport(srv *PolicyDefinitionVersionsServer) *PolicyDefinitionVersionsServerTransport {
	return &PolicyDefinitionVersionsServerTransport{
		srv:                           srv,
		newListPager:                  newTracker[azfake.PagerResponder[armsubscriptions.PolicyDefinitionVersionsClientListResponse]](),
		newListBuiltInPager:           newTracker[azfake.PagerResponder[armsubscriptions.PolicyDefinitionVersionsClientListBuiltInResponse]](),
		newListByManagementGroupPager: newTracker[azfake.PagerResponder[armsubscriptions.PolicyDefinitionVersionsClientListByManagementGroupResponse]](),
	}
}

// PolicyDefinitionVersionsServerTransport connects instances of armsubscriptions.PolicyDefinitionVersionsClient to instances of PolicyDefinitionVersionsServer.
...
type PolicyDefinitionVersionsServerTransport struct {
	...
	newListPager                  *tracker[azfake.PagerResponder[armsubscriptions.PolicyDefinitionVersionsClientListResponse]]
	newListBuiltInPager           *tracker[azfake.PagerResponder[armsubscriptions.PolicyDefinitionVersionsClientListBuiltInResponse]]
	newListByManagementGroupPager *tracker[azfake.PagerResponder[armsubscriptions.PolicyDefinitionVersionsClientListByManagementGroupResponse]]
}
...
func (p *PolicyDefinitionVersionsServerTransport) dispatchCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[armsubscriptions.PolicyDefinitionVersion](req)
	if err != nil {
		return nil, err
	}
...
func (p *PolicyDefinitionVersionsServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		var options *armsubscriptions.PolicyDefinitionVersionsClientListOptions
		if topParam != nil {
			options = &armsubscriptions.PolicyDefinitionVersionsClientListOptions{
				Top: topParam,
			}
		}
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armsubscriptions.PolicyDefinitionVersionsClientListResponse, createLink func() string) {
...
func (p *PolicyDefinitionVersionsServerTransport) dispatchNewListBuiltInPager(req *http.Request) (*http.Response, error) {
	...
	if newListBuiltInPager == nil {
		...
		var options *armsubscriptions.PolicyDefinitionVersionsClientListBuiltInOptions
		if topParam != nil {
			options = &armsubscriptions.PolicyDefinitionVersionsClientListBuiltInOptions{
				Top: topParam,
			}
		}
		...
		server.PagerResponderInjectNextLinks(newListBuiltInPager, req, func(page *armsubscriptions.PolicyDefinitionVersionsClientListBuiltInResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
...
func (p *PolicyDefinitionVersionsServerTransport) dispatchNewListByManagementGroupPager(req *http.Request) (*http.Response, error) {
	...
	if newListByManagementGroupPager == nil {
		...
		var options *armsubscriptions.PolicyDefinitionVersionsClientListByManagementGroupOptions
		if topParam != nil {
			options = &armsubscriptions.PolicyDefinitionVersionsClientListByManagementGroupOptions{
				Top: topParam,
			}
		}
		...
		server.PagerResponderInjectNextLinks(newListByManagementGroupPager, req, func(page *armsubscriptions.PolicyDefinitionVersionsClientListByManagementGroupResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
