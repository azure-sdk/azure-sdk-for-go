...
func (l LotProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "orgType", l.OrgType)
...
func (l *LotProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "isEstimatedBalance":
			...
			delete(rawMsg, key)
		case "orgType":
			err = unpopulate(val, "OrgType", &l.OrgType)
			delete(rawMsg, key)
		case "originalAmount":
...
func (p PricesheetDownloadProperties) MarshalJSON() ([]byte, error) {
	...
	populateTimeRFC3339(objectMap, "validTill", p.ValidTill)
	return json.Marshal(objectMap)
}
...
func (p *PricesheetDownloadProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "downloadUrl":
			...
			delete(rawMsg, key)
		case "validTill":
			err = unpopulateTimeRFC3339(val, "ValidTill", &p.ValidTill)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", p, err)
