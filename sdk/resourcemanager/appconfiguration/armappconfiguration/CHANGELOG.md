...
- New enum type `SasAuth` with values `SasAuthDisabled`, `SasAuthEnabled`
...
- New field `DataPlaneProxy`, `Experimentation`, `SasAuth`, `Telemetry` in struct `ConfigurationStoreProperties`
- New field `DataPlaneProxy`, `Experimentation`, `SasAuth`, `Telemetry` in struct `ConfigurationStorePropertiesUpdateParameters`
