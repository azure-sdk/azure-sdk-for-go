...
// Generated from example definition: 2024-10-01/EnterpriseDetails_Post.json
func ExampleManagedGrafanasClient_CheckEnterpriseDetails() {
	...
	res, err := clientFactory.NewManagedGrafanasClient().CheckEnterpriseDetails(ctx, "myResourceGroup", "myWorkspace", nil)
	if err != nil {
	...
	// res = armdashboard.ManagedGrafanasClientCheckEnterpriseDetailsResponse{
...
// Generated from example definition: 2024-10-01/Grafana_Create.json
func ExampleManagedGrafanasClient_BeginCreate() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	poller, err := clientFactory.NewManagedGrafanasClient().BeginCreate(ctx, "myResourceGroup", "myWorkspace", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armdashboard.ManagedGrafanasClientCreateResponse{
...
// Generated from example definition: 2024-10-01/Grafana_Delete.json
func ExampleManagedGrafanasClient_BeginDelete() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	poller, err := clientFactory.NewManagedGrafanasClient().BeginDelete(ctx, "myResourceGroup", "myWorkspace", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	res, err := poller.PollUntilDone(ctx, nil)
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armdashboard.ManagedGrafanasClientDeleteResponse{
	// }
}

// Generated from example definition: 2024-10-01/Grafana_FetchAvailablePlugins.json
func ExampleManagedGrafanasClient_FetchAvailablePlugins() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	res, err := clientFactory.NewManagedGrafanasClient().FetchAvailablePlugins(ctx, "myResourceGroup", "myWorkspace", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armdashboard.ManagedGrafanasClientFetchAvailablePluginsResponse{
...
// Generated from example definition: 2024-10-01/Grafana_Get.json
func ExampleManagedGrafanasClient_Get() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	res, err := clientFactory.NewManagedGrafanasClient().Get(ctx, "myResourceGroup", "myWorkspace", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armdashboard.ManagedGrafanasClientGetResponse{
	// 	ManagedGrafana: &armdashboard.ManagedGrafana{
	// 		Name: to.Ptr("myWorkspace"),
	// 		Type: to.Ptr("Microsoft.Dashboard/grafana"),
	// 		ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/myResourceGroup/grafana/myWorkspace"),
...
// Generated from example definition: 2024-10-01/Grafana_List.json
func ExampleManagedGrafanasClient_NewListPager() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	pager := clientFactory.NewManagedGrafanasClient().NewListPager(nil)
	for pager.More() {
		...
		// page = armdashboard.ManagedGrafanasClientListResponse{
...
// Generated from example definition: 2024-10-01/Grafana_ListByResourceGroup.json
func ExampleManagedGrafanasClient_NewListByResourceGroupPager() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	pager := clientFactory.NewManagedGrafanasClient().NewListByResourceGroupPager("myResourceGroup", nil)
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armdashboard.ManagedGrafanasClientListByResourceGroupResponse{
		// 	ManagedGrafanaListResponse: armdashboard.ManagedGrafanaListResponse{
		// 		Value: []*armdashboard.ManagedGrafana{
		// 			{
		// 				Name: to.Ptr("myWorkspace"),
...
// Generated from example definition: 2024-10-01/ManagedPrivateEndpoints_Refresh.json
func ExampleManagedGrafanasClient_BeginRefresh() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	poller, err := clientFactory.NewManagedGrafanasClient().BeginRefresh(ctx, "myResourceGroup", "myWorkspace", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	res, err := poller.PollUntilDone(ctx, nil)
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armdashboard.ManagedGrafanasClientRefreshResponse{
	// }
}

// Generated from example definition: 2024-10-01/Grafana_Update.json
func ExampleManagedGrafanasClient_Update() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	res, err := clientFactory.NewManagedGrafanasClient().Update(ctx, "myResourceGroup", "myWorkspace", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armdashboard.ManagedGrafanasClientUpdateResponse{
	// 	ManagedGrafana: &armdashboard.ManagedGrafana{
	// 		Name: to.Ptr("myWorkspace"),
	// 		Type: to.Ptr("Microsoft.Dashboard/grafana"),
	// 		ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/myResourceGroup/grafana/myWorkspace"),
