...
// APISourceType - Supported API source types for import/sync.
type APISourceType string

const (
	// APISourceTypeAmazonAPIGateway - Amazon API Gateway
	APISourceTypeAmazonAPIGateway APISourceType = "AmazonApiGateway"
	// APISourceTypeAzureAPIManagement - Azure API Management
	APISourceTypeAzureAPIManagement APISourceType = "AzureApiManagement"
)

// PossibleAPISourceTypeValues returns the possible values for the APISourceType const type.
func PossibleAPISourceTypeValues() []APISourceType {
	return []APISourceType{
		APISourceTypeAmazonAPIGateway,
		APISourceTypeAzureAPIManagement,
	}
}
