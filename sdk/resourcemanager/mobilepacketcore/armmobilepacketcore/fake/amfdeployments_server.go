...
func (a *AmfDeploymentsServerTransport) dispatchCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := a.srv.CreateOrUpdate(req.Context(), resourceGroupNameParam, amfDeploymentNameParam, body, nil)
