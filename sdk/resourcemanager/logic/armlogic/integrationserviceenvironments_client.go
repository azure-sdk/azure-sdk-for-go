...
//   - options - IntegrationServiceEnvironmentsClientUpdateOptions contains the optional parameters for the IntegrationServiceEnvironmentsClient.Update
//     method.
func (client *IntegrationServiceEnvironmentsClient) Update(ctx context.Context, integrationServiceEnvironmentName string, properties IntegrationServiceEnvironment, options *IntegrationServiceEnvironmentsClientUpdateOptions) (IntegrationServiceEnvironmentsClientUpdateResponse, error) {
	var err error
	const operationName = "IntegrationServiceEnvironmentsClient.Update"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
...
func (client *IntegrationServiceEnvironmentsClient) updateCreateRequest(ctx context.Context, integrationServiceEnvironmentName string, properties IntegrationServiceEnvironment, _ *IntegrationServiceEnvironmentsClientUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/providers/Microsoft.Logic/integrationServiceEnvironments/{integrationServiceEnvironmentName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *IntegrationServiceEnvironmentsClient) updateHandleResponse(resp *http.Response) (IntegrationServiceEnvironmentsClientUpdateResponse, error) {
	result := IntegrationServiceEnvironmentsClientUpdateResponse{}
	if err := runtime.UnmarshalAsJSON(resp, &result.IntegrationServiceEnvironment); err != nil {
		return IntegrationServiceEnvironmentsClientUpdateResponse{}, err
	}
	return result, nil
