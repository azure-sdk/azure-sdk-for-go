...
//     method.
func (client *ResourceReferenceClient) GetByTargetResources(ctx context.Context, body ResourceReferenceRequest, options *ResourceReferenceClientGetByTargetResourcesOptions) (ResourceReferenceClientGetByTargetResourcesResponse, error) {
	var err error
	const operationName = "ResourceReferenceClient.GetByTargetResources"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.getByTargetResourcesCreateRequest(ctx, body, options)
	if err != nil {
...
func (client *ResourceReferenceClient) getByTargetResourcesCreateRequest(ctx context.Context, body ResourceReferenceRequest, _ *ResourceReferenceClientGetByTargetResourcesOptions) (*policy.Request, error) {
