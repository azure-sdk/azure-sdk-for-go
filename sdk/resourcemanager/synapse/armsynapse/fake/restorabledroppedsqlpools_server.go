...
func (r *RestorableDroppedSQLPoolsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if restorableDroppedSqlPoolsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = restorableDroppedSqlPoolsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "RestorableDroppedSQLPoolsClient.NewListByWorkspacePager":
				res.resp, res.err = r.dispatchNewListByWorkspacePager(req)
			default:
...
// set this to conditionally intercept incoming requests to RestorableDroppedSQLPoolsServerTransport
var restorableDroppedSqlPoolsServerTransportInterceptor interface {
