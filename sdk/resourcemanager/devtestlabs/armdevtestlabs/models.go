...
type LabProperties struct {
	...
	ManagementIdentities map[string]interface{} `json:"managementIdentities,omitempty"`
...
// LabSecretsClientListOptions contains the optional parameters for the LabSecretsClient.List method.
...
// PolicySetsClientListOptions contains the optional parameters for the PolicySetsClient.List method.
...
// ServiceRunnersClientListOptions contains the optional parameters for the ServiceRunnersClient.List method.
...
// SharedImagesClientListOptions contains the optional parameters for the SharedImagesClient.List method.
