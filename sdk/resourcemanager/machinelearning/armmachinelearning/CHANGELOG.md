...
- New function `*ClientFactory.NewStandbyPoolClient() *StandbyPoolClient`
...
- New function `NewStandbyPoolClient(string, azcore.TokenCredential, *arm.ClientOptions) (*StandbyPoolClient, error)`
- New function `*StandbyPoolClient.CreateOrUpdate(context.Context, string, string, string, StandbyPoolProperties, *StandbyPoolClientCreateOrUpdateOptions) (StandbyPoolClientCreateOrUpdateResponse, error)`
- New function `*StandbyPoolClient.Delete(context.Context, string, string, string, *StandbyPoolClientDeleteOptions) (StandbyPoolClientDeleteResponse, error)`
- New function `*StandbyPoolClient.Get(context.Context, string, string, string, *StandbyPoolClientGetOptions) (StandbyPoolClientGetResponse, error)`
- New function `*StandbyPoolClient.List(context.Context, string, string, *StandbyPoolClientListOptions) (StandbyPoolClientListResponse, error)`
...
- New struct `GetStandbyPoolResponse`
...
- New struct `StandbyPoolProperties`
- New struct `StandbyPoolResourceStatus`
...
- New field `CreatedByWorkspaceArmID`, `ExpiryTime`, `IsSharedToAll`, `Metadata` in struct `ManagedIdentityAuthTypeWorkspaceConnectionProperties`
...
- New field `CreatedByWorkspaceArmID`, `ExpiryTime`, `IsSharedToAll`, `Metadata` in struct `NoneAuthTypeWorkspaceConnectionProperties`
...
- New field `CreatedByWorkspaceArmID`, `ExpiryTime`, `IsSharedToAll`, `Metadata` in struct `PATAuthTypeWorkspaceConnectionProperties`
...
- New field `CreatedByWorkspaceArmID`, `ExpiryTime`, `IsSharedToAll`, `Metadata` in struct `SASAuthTypeWorkspaceConnectionProperties`
...
- New field `CreatedByWorkspaceArmID`, `ExpiryTime`, `IsSharedToAll`, `Metadata` in struct `UsernamePasswordAuthTypeWorkspaceConnectionProperties`
...
- New field `AssociatedWorkspaces`, `ContainerRegistries`, `EnableDataIsolation`, `ExistingWorkspaces`, `FeatureStoreSettings`, `HubResourceID`, `KeyVaults`, `ManagedNetwork`, `ServerlessComputeCustomSubnet`, `ServerlessComputeNoPublicIP`, `SoftDeleteRetentionInDays`, `StorageAccounts`, `SystemDatastoresAuthMode`, `WorkspaceHubConfig` in struct `WorkspaceProperties`
- New field `EnableDataIsolation`, `Encryption`, `FeatureStoreSettings`, `ManagedNetwork`, `ServerlessComputeCustomSubnet`, `ServerlessComputeNoPublicIP`, `SoftDeleteRetentionInDays`, `V1LegacyMode` in struct `WorkspacePropertiesUpdateParameters`
