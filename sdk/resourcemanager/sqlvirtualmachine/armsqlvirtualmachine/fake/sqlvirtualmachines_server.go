...
type SQLVirtualMachinesServer struct {
	...
	// BeginTroubleshoot is the fake for method SQLVirtualMachinesClient.BeginTroubleshoot
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginTroubleshoot func(ctx context.Context, resourceGroupName string, sqlVirtualMachineName string, parameters armsqlvirtualmachine.SQLVMTroubleshooting, options *armsqlvirtualmachine.SQLVirtualMachinesClientBeginTroubleshootOptions) (resp azfake.PollerResponder[armsqlvirtualmachine.SQLVirtualMachinesClientTroubleshootResponse], errResp azfake.ErrorResponder)
...
func NewSQLVirtualMachinesServerTransport(srv *SQLVirtualMachinesServer) *SQLVirtualMachinesServerTransport {
	return &SQLVirtualMachinesServerTransport{
		...
		beginTroubleshoot:           newTracker[azfake.PollerResponder[armsqlvirtualmachine.SQLVirtualMachinesClientTroubleshootResponse]](),
...
type SQLVirtualMachinesServerTransport struct {
	...
	beginTroubleshoot           *tracker[azfake.PollerResponder[armsqlvirtualmachine.SQLVirtualMachinesClientTroubleshootResponse]]
...
func (s *SQLVirtualMachinesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		if !intercepted {
			...
			case "SQLVirtualMachinesClient.BeginTroubleshoot":
				res.resp, res.err = s.dispatchBeginTroubleshoot(req)
...
func (s *SQLVirtualMachinesServerTransport) dispatchBeginTroubleshoot(req *http.Request) (*http.Response, error) {
	if s.srv.BeginTroubleshoot == nil {
		return nil, &nonRetriableError{errors.New("fake for method BeginTroubleshoot not implemented")}
	}
	beginTroubleshoot := s.beginTroubleshoot.get(req)
	if beginTroubleshoot == nil {
		...
		respr, errRespr := s.srv.BeginTroubleshoot(req.Context(), resourceGroupNameParam, sqlVirtualMachineNameParam, body, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginTroubleshoot = &respr
		s.beginTroubleshoot.add(req, beginTroubleshoot)
	}
	...
	if !contains([]int{http.StatusOK, http.StatusAccepted}, resp.StatusCode) {
		s.beginTroubleshoot.remove(req)
