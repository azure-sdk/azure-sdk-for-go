...
func (client *JobsClient) cancelCreateRequest(ctx context.Context, deviceName string, jobName string, resourceGroupName string, managerName string, _ *JobsClientBeginCancelOptions) (*policy.Request, error) {
...
func (client *JobsClient) getCreateRequest(ctx context.Context, deviceName string, jobName string, resourceGroupName string, managerName string, _ *JobsClientGetOptions) (*policy.Request, error) {
