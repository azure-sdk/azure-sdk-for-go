	...
	go func() {
		...
		if !intercepted {
			...
			case "VirtualMachinesClient.BeginAddDataDisk":
				res.resp, res.err = v.dispatchBeginAddDataDisk(req)
			case "VirtualMachinesClient.BeginApplyArtifacts":
				res.resp, res.err = v.dispatchBeginApplyArtifacts(req)
			case "VirtualMachinesClient.BeginClaim":
				res.resp, res.err = v.dispatchBeginClaim(req)
			...
			case "VirtualMachinesClient.BeginDetachDataDisk":
				res.resp, res.err = v.dispatchBeginDetachDataDisk(req)
			case "VirtualMachinesClient.Get":
				res.resp, res.err = v.dispatchGet(req)
			case "VirtualMachinesClient.GetRdpFileContents":
				res.resp, res.err = v.dispatchGetRdpFileContents(req)
			...
			case "VirtualMachinesClient.ListApplicableSchedules":
				res.resp, res.err = v.dispatchListApplicableSchedules(req)
			...
			case "VirtualMachinesClient.BeginResize":
				res.resp, res.err = v.dispatchBeginResize(req)
			...
			case "VirtualMachinesClient.BeginTransferDisks":
				res.resp, res.err = v.dispatchBeginTransferDisks(req)
			case "VirtualMachinesClient.BeginUnClaim":
				res.resp, res.err = v.dispatchBeginUnClaim(req)
