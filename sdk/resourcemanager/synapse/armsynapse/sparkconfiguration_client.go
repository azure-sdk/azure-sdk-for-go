...
func (client *SparkConfigurationClient) getCreateRequest(ctx context.Context, resourceGroupName string, sparkConfigurationName string, workspaceName string, _ *SparkConfigurationClientGetOptions) (*policy.Request, error) {
