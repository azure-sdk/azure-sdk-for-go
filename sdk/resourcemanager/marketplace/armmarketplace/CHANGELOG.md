...
- New function `*ClientFactory.NewPrivateStoreCollectionOffersWithContextsPlansClient() *PrivateStoreCollectionOffersWithContextsPlansClient`
...
- New function `NewPrivateStoreCollectionOffersWithContextsPlansClient(azcore.TokenCredential, *arm.ClientOptions) (*PrivateStoreCollectionOffersWithContextsPlansClient, error)`
- New function `*PrivateStoreCollectionOffersWithContextsPlansClient.NewListPager(string, string, *PrivateStoreCollectionOffersWithContextsPlansClientListOptions) *runtime.Pager[PrivateStoreCollectionOffersWithContextsPlansClientListResponse]`
...
- New struct `GetCollectionOffersWithContextsPlansDetails`
- New struct `GetCollectionOffersWithContextsPlansProperties`
