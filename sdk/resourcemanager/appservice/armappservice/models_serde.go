...
func (s StaticSite) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "trafficSplitting", s.TrafficSplitting)
...
func (s *StaticSite) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "trafficSplitting":
			err = unpopulate(val, "TrafficSplitting", &s.TrafficSplitting)
			delete(rawMsg, key)
...
// MarshalJSON implements the json.Marshaller interface for type StaticSiteTrafficSplittingProperties.
func (s StaticSiteTrafficSplittingProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "id", s.ID)
	populate(objectMap, "kind", s.Kind)
	populate(objectMap, "name", s.Name)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type StaticSiteTrafficSplittingProperties.
func (s *StaticSiteTrafficSplittingProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type StaticSiteTrafficSplittingPropertiesARMResource.
func (s StaticSiteTrafficSplittingPropertiesARMResource) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "id", s.ID)
	populate(objectMap, "kind", s.Kind)
	populate(objectMap, "name", s.Name)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type StaticSiteTrafficSplittingPropertiesARMResource.
func (s *StaticSiteTrafficSplittingPropertiesARMResource) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type StaticSiteTrafficSplittingPropertiesARMResourceProperties.
func (s StaticSiteTrafficSplittingPropertiesARMResourceProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "environmentDistribution", s.EnvironmentDistribution)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type StaticSiteTrafficSplittingPropertiesARMResourceProperties.
func (s *StaticSiteTrafficSplittingPropertiesARMResourceProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
	for key, val := range rawMsg {
		var err error
		switch key {
		case "environmentDistribution":
			err = unpopulate(val, "EnvironmentDistribution", &s.EnvironmentDistribution)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", s, err)
...
// MarshalJSON implements the json.Marshaller interface for type StaticSiteTrafficSplittingPropertiesCollection.
func (s StaticSiteTrafficSplittingPropertiesCollection) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "nextLink", s.NextLink)
	populate(objectMap, "value", s.Value)
	return json.Marshal(objectMap)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type StaticSiteTrafficSplittingPropertiesCollection.
func (s *StaticSiteTrafficSplittingPropertiesCollection) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type StaticSiteTrafficSplittingPropertiesProperties.
func (s StaticSiteTrafficSplittingPropertiesProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "environmentDistribution", s.EnvironmentDistribution)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type StaticSiteTrafficSplittingPropertiesProperties.
func (s *StaticSiteTrafficSplittingPropertiesProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
