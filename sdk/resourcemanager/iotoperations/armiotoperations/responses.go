...
// AkriDiscoveryHandlerClientCreateOrUpdateResponse contains the response from method AkriDiscoveryHandlerClient.BeginCreateOrUpdate.
type AkriDiscoveryHandlerClientCreateOrUpdateResponse struct {
	// AkriDiscoveryHandler resource.
	AkriDiscoveryHandlerResource
}

// AkriDiscoveryHandlerClientDeleteResponse contains the response from method AkriDiscoveryHandlerClient.BeginDelete.
type AkriDiscoveryHandlerClientDeleteResponse struct {
	// placeholder for future response values
}

// AkriDiscoveryHandlerClientGetResponse contains the response from method AkriDiscoveryHandlerClient.Get.
type AkriDiscoveryHandlerClientGetResponse struct {
	// AkriDiscoveryHandler resource.
	AkriDiscoveryHandlerResource
}

// AkriDiscoveryHandlerClientListByInstanceResourceResponse contains the response from method AkriDiscoveryHandlerClient.NewListByInstanceResourcePager.
type AkriDiscoveryHandlerClientListByInstanceResourceResponse struct {
	// The response of a AkriDiscoveryHandlerResource list operation.
	AkriDiscoveryHandlerResourceListResult
}
...
// DiagnosticClientListByInstanceResourceResponse contains the response from method DiagnosticClient.NewListByInstanceResourcePager.
type DiagnosticClientListByInstanceResourceResponse struct {
