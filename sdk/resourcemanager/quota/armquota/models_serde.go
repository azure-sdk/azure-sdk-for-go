...
// MarshalJSON implements the json.Marshaller interface for type AssignedToSubscription.
func (a AssignedToSubscription) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type AssignedToSubscription.
func (a *AssignedToSubscription) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", a, err)
	}
...
func (g GroupQuotaDetails) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "assignedToSubscriptions", g.AssignedToSubscriptions)
...
func (g *GroupQuotaDetails) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		var err error
		switch key {
		case "assignedToSubscriptions":
			err = unpopulate(val, "AssignedToSubscriptions", &g.AssignedToSubscriptions)
			delete(rawMsg, key)
		case "availableLimit":
...
func (s *SubscriptionGroupQuotaAssignment) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "managementGroupId":
			err = unpopulate(val, "ManagementGroupID", &s.ManagementGroupID)
			delete(rawMsg, key)
		case "quotaAllocated":
...
// MarshalJSON implements the json.Marshaller interface for type SubscriptionQuotaAllocationRequest.
func (s SubscriptionQuotaAllocationRequest) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "properties", s.Properties)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type SubscriptionQuotaAllocationRequest.
func (s *SubscriptionQuotaAllocationRequest) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type SubscriptionQuotaAllocationRequestProperties.
func (s SubscriptionQuotaAllocationRequestProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "limit", s.Limit)
	populate(objectMap, "provisioningState", s.ProvisioningState)
	return json.Marshal(objectMap)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type SubscriptionQuotaAllocationRequestProperties.
func (s *SubscriptionQuotaAllocationRequestProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
...
func (s SubscriptionQuotaDetails) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "limit", s.Limit)
	populate(objectMap, "nonShareableQuota", s.NonShareableQuota)
	populate(objectMap, "provisioningState", s.ProvisioningState)
	populate(objectMap, "quotaSources", s.QuotaSources)
	return json.Marshal(objectMap)
}
...
func (s *SubscriptionQuotaDetails) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "limit":
			err = unpopulate(val, "Limit", &s.Limit)
			delete(rawMsg, key)
		case "nonShareableQuota":
			err = unpopulate(val, "NonShareableQuota", &s.NonShareableQuota)
			delete(rawMsg, key)
		case "provisioningState":
			err = unpopulate(val, "ProvisioningState", &s.ProvisioningState)
			delete(rawMsg, key)
		case "quotaSources":
			err = unpopulate(val, "QuotaSources", &s.QuotaSources)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", s, err)
