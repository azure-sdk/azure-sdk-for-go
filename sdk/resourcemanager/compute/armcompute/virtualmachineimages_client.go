...
// NewListPager - Gets a list of all virtual machine image versions for the specified location, publisher, offer, and SKU.
//
// Generated from API version 2024-07-01
//   - location - The name of Azure region.
//   - publisherName - A valid image publisher.
//   - offer - A valid image publisher offer.
//   - skus - A valid image SKU.
//   - options - VirtualMachineImagesClientListOptions contains the optional parameters for the VirtualMachineImagesClient.NewListPager
//     method.
func (client *VirtualMachineImagesClient) NewListPager(location string, publisherName string, offer string, skus string, options *VirtualMachineImagesClientListOptions) *runtime.Pager[VirtualMachineImagesClientListResponse] {
	return runtime.NewPager(runtime.PagingHandler[VirtualMachineImagesClientListResponse]{
		More: func(page VirtualMachineImagesClientListResponse) bool {
			return page.NextLink != nil && len(*page.NextLink) > 0
		},
		Fetcher: func(ctx context.Context, page *VirtualMachineImagesClientListResponse) (VirtualMachineImagesClientListResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "VirtualMachineImagesClient.NewListPager")
			nextLink := ""
			if page != nil {
				nextLink = *page.NextLink
			}
			resp, err := runtime.FetcherForNextLink(ctx, client.internal.Pipeline(), nextLink, func(ctx context.Context) (*policy.Request, error) {
				return client.listCreateRequest(ctx, location, publisherName, offer, skus, options)
			}, nil)
			if err != nil {
...
// NewListOffersPager - Gets a list of virtual machine image offers for the specified location and publisher.
//
// Generated from API version 2024-07-01
//   - location - The name of Azure region.
//   - publisherName - A valid image publisher.
//   - options - VirtualMachineImagesClientListOffersOptions contains the optional parameters for the VirtualMachineImagesClient.NewListOffersPager
//     method.
func (client *VirtualMachineImagesClient) NewListOffersPager(location string, publisherName string, options *VirtualMachineImagesClientListOffersOptions) *runtime.Pager[VirtualMachineImagesClientListOffersResponse] {
	return runtime.NewPager(runtime.PagingHandler[VirtualMachineImagesClientListOffersResponse]{
		More: func(page VirtualMachineImagesClientListOffersResponse) bool {
			return page.NextLink != nil && len(*page.NextLink) > 0
		},
		Fetcher: func(ctx context.Context, page *VirtualMachineImagesClientListOffersResponse) (VirtualMachineImagesClientListOffersResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "VirtualMachineImagesClient.NewListOffersPager")
			nextLink := ""
			if page != nil {
				nextLink = *page.NextLink
			}
			resp, err := runtime.FetcherForNextLink(ctx, client.internal.Pipeline(), nextLink, func(ctx context.Context) (*policy.Request, error) {
				return client.listOffersCreateRequest(ctx, location, publisherName, options)
			}, nil)
			if err != nil {
...
// NewListPublishersPager - Gets a list of virtual machine image publishers for the specified Azure location.
//
// Generated from API version 2024-07-01
//   - location - The name of Azure region.
//   - options - VirtualMachineImagesClientListPublishersOptions contains the optional parameters for the VirtualMachineImagesClient.NewListPublishersPager
//     method.
func (client *VirtualMachineImagesClient) NewListPublishersPager(location string, options *VirtualMachineImagesClientListPublishersOptions) *runtime.Pager[VirtualMachineImagesClientListPublishersResponse] {
	return runtime.NewPager(runtime.PagingHandler[VirtualMachineImagesClientListPublishersResponse]{
		More: func(page VirtualMachineImagesClientListPublishersResponse) bool {
			return page.NextLink != nil && len(*page.NextLink) > 0
		},
		Fetcher: func(ctx context.Context, page *VirtualMachineImagesClientListPublishersResponse) (VirtualMachineImagesClientListPublishersResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "VirtualMachineImagesClient.NewListPublishersPager")
			nextLink := ""
			if page != nil {
				nextLink = *page.NextLink
			}
			resp, err := runtime.FetcherForNextLink(ctx, client.internal.Pipeline(), nextLink, func(ctx context.Context) (*policy.Request, error) {
				return client.listPublishersCreateRequest(ctx, location, options)
			}, nil)
			if err != nil {
...
// NewListSKUsPager - Gets a list of virtual machine image SKUs for the specified location, publisher, and offer.
//
// Generated from API version 2024-07-01
//   - location - The name of Azure region.
//   - publisherName - A valid image publisher.
//   - offer - A valid image publisher offer.
//   - options - VirtualMachineImagesClientListSKUsOptions contains the optional parameters for the VirtualMachineImagesClient.NewListSKUsPager
//     method.
func (client *VirtualMachineImagesClient) NewListSKUsPager(location string, publisherName string, offer string, options *VirtualMachineImagesClientListSKUsOptions) *runtime.Pager[VirtualMachineImagesClientListSKUsResponse] {
	return runtime.NewPager(runtime.PagingHandler[VirtualMachineImagesClientListSKUsResponse]{
		More: func(page VirtualMachineImagesClientListSKUsResponse) bool {
			return page.NextLink != nil && len(*page.NextLink) > 0
		},
		Fetcher: func(ctx context.Context, page *VirtualMachineImagesClientListSKUsResponse) (VirtualMachineImagesClientListSKUsResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "VirtualMachineImagesClient.NewListSKUsPager")
			nextLink := ""
			if page != nil {
				nextLink = *page.NextLink
			}
			resp, err := runtime.FetcherForNextLink(ctx, client.internal.Pipeline(), nextLink, func(ctx context.Context) (*policy.Request, error) {
				return client.listSKUsCreateRequest(ctx, location, publisherName, offer, options)
			}, nil)
			if err != nil {
