...
- New function `*AppResiliencyClient.Patch(context.Context, string, string, string, AppResiliency, *AppResiliencyClientPatchOptions) (AppResiliencyClientPatchResponse, error)`
...
- New function `*JobsClient.ProxyList(context.Context, string, string, *JobsClientProxyListOptions) (JobsClientProxyListResponse, error)`
