...
type GroupQuotaSubscriptionsServer struct {
	...
	// Delete is the fake for method GroupQuotaSubscriptionsClient.Delete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	Delete func(ctx context.Context, managementGroupID string, groupQuotaName string, options *armquota.GroupQuotaSubscriptionsClientDeleteOptions) (resp azfake.Responder[armquota.GroupQuotaSubscriptionsClientDeleteResponse], errResp azfake.ErrorResponder)
...
func (g *GroupQuotaSubscriptionsServerTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "GroupQuotaSubscriptionsClient.Delete":
...
func (g *GroupQuotaSubscriptionsServerTransport) dispatchDelete(req *http.Request) (*http.Response, error) {
	if g.srv.Delete == nil {
	...
	respr, errRespr := g.srv.Delete(req.Context(), managementGroupIDParam, groupQuotaNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
