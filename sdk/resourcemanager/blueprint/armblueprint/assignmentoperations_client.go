...
func (client *AssignmentOperationsClient) getCreateRequest(ctx context.Context, resourceScope string, assignmentName string, assignmentOperationName string, _ *AssignmentOperationsClientGetOptions) (*policy.Request, error) {
...
func (client *AssignmentOperationsClient) listCreateRequest(ctx context.Context, resourceScope string, assignmentName string, _ *AssignmentOperationsClientListOptions) (*policy.Request, error) {
