...
// SQLSitesControllerClientBeginImportInventoryOptions contains the optional parameters for the SQLSitesControllerClient.BeginImportInventory
// method.
type SQLSitesControllerClientBeginImportInventoryOptions struct {
	// Resumes the LRO from the provided token.
	ResumeToken string
}
