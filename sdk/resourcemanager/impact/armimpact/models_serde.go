...
// MarshalJSON implements the json.Marshaller interface for type CategoryListResult.
func (c CategoryListResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type CategoryListResult.
func (c *CategoryListResult) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type CategoryProperties.
func (c CategoryProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "categoryId", c.CategoryID)
	populate(objectMap, "description", c.Description)
	populate(objectMap, "parentCategoryId", c.ParentCategoryID)
	populate(objectMap, "provisioningState", c.ProvisioningState)
	populate(objectMap, "requiredImpactProperties", c.RequiredImpactProperties)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type CategoryProperties.
func (c *CategoryProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "categoryId":
			err = unpopulate(val, "CategoryID", &c.CategoryID)
			delete(rawMsg, key)
		case "description":
			err = unpopulate(val, "Description", &c.Description)
			delete(rawMsg, key)
		case "parentCategoryId":
			err = unpopulate(val, "ParentCategoryID", &c.ParentCategoryID)
			delete(rawMsg, key)
		case "provisioningState":
			err = unpopulate(val, "ProvisioningState", &c.ProvisioningState)
			delete(rawMsg, key)
		case "requiredImpactProperties":
			err = unpopulate(val, "RequiredImpactProperties", &c.RequiredImpactProperties)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", c, err)
...
func (d Details) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "impactId", d.ImpactID)
	populate(objectMap, "impactedResourceId", d.ImpactedResourceID)
...
func (d *Details) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "endTime":
			...
			delete(rawMsg, key)
		case "impactId":
			err = unpopulate(val, "ImpactID", &d.ImpactID)
			delete(rawMsg, key)
		case "impactedResourceId":
			err = unpopulate(val, "ImpactedResourceID", &d.ImpactedResourceID)
			delete(rawMsg, key)
		case "startTime":
...
// MarshalJSON implements the json.Marshaller interface for type ImpactedResources.
func (i ImpactedResources) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "impactedResourceId", i.ImpactedResourceID)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ImpactedResources.
func (i *ImpactedResources) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
...
func (i InsightProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateAny(objectMap, "additionalDetails", i.AdditionalDetails)
...
// MarshalJSON implements the json.Marshaller interface for type TopologyImpact.
func (t TopologyImpact) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type TopologyImpact.
func (t *TopologyImpact) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
...
// MarshalJSON implements the json.Marshaller interface for type TopologyImpactListResult.
func (t TopologyImpactListResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type TopologyImpactListResult.
func (t *TopologyImpactListResult) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", t, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type TopologyImpactProperties.
func (t TopologyImpactProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateAny(objectMap, "additionalProperties", t.AdditionalProperties)
	populate(objectMap, "clientIncidentDetails", t.ClientIncidentDetails)
	populate(objectMap, "confidenceLevel", t.ConfidenceLevel)
	populateDateTimeRFC3339(objectMap, "endDateTime", t.EndDateTime)
	populate(objectMap, "errorDetails", t.ErrorDetails)
	populate(objectMap, "impactCategory", t.ImpactCategory)
	populate(objectMap, "impactDescription", t.ImpactDescription)
	populate(objectMap, "impactGroupId", t.ImpactGroupID)
	populate(objectMap, "impactedResources", t.ImpactedResources)
	populate(objectMap, "performance", t.Performance)
	populate(objectMap, "provisioningState", t.ProvisioningState)
	populateDateTimeRFC3339(objectMap, "reportedTimeUtc", t.ReportedTimeUTC)
	populateDateTimeRFC3339(objectMap, "startDateTime", t.StartDateTime)
	populate(objectMap, "topologyImpactUniqueId", t.TopologyImpactUniqueID)
	populate(objectMap, "workload", t.Workload)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type TopologyImpactProperties.
func (t *TopologyImpactProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", t, err)
	}
	for key, val := range rawMsg {
		...
		case "additionalProperties":
			err = unpopulate(val, "AdditionalProperties", &t.AdditionalProperties)
			delete(rawMsg, key)
		case "clientIncidentDetails":
			err = unpopulate(val, "ClientIncidentDetails", &t.ClientIncidentDetails)
			delete(rawMsg, key)
		case "confidenceLevel":
			err = unpopulate(val, "ConfidenceLevel", &t.ConfidenceLevel)
			delete(rawMsg, key)
		case "endDateTime":
			err = unpopulateDateTimeRFC3339(val, "EndDateTime", &t.EndDateTime)
			delete(rawMsg, key)
		case "errorDetails":
			err = unpopulate(val, "ErrorDetails", &t.ErrorDetails)
			delete(rawMsg, key)
		case "impactCategory":
			err = unpopulate(val, "ImpactCategory", &t.ImpactCategory)
			delete(rawMsg, key)
		case "impactDescription":
			err = unpopulate(val, "ImpactDescription", &t.ImpactDescription)
			delete(rawMsg, key)
		case "impactGroupId":
			err = unpopulate(val, "ImpactGroupID", &t.ImpactGroupID)
			delete(rawMsg, key)
		case "impactedResources":
			err = unpopulate(val, "ImpactedResources", &t.ImpactedResources)
			delete(rawMsg, key)
		case "performance":
			err = unpopulate(val, "Performance", &t.Performance)
			delete(rawMsg, key)
		case "provisioningState":
			err = unpopulate(val, "ProvisioningState", &t.ProvisioningState)
			delete(rawMsg, key)
		case "reportedTimeUtc":
			err = unpopulateDateTimeRFC3339(val, "ReportedTimeUTC", &t.ReportedTimeUTC)
			delete(rawMsg, key)
		case "startDateTime":
			err = unpopulateDateTimeRFC3339(val, "StartDateTime", &t.StartDateTime)
			delete(rawMsg, key)
		case "topologyImpactUniqueId":
			err = unpopulate(val, "TopologyImpactUniqueID", &t.TopologyImpactUniqueID)
			delete(rawMsg, key)
		case "workload":
			err = unpopulate(val, "Workload", &t.Workload)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", t, err)
...
func (w WorkloadImpactProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateAny(objectMap, "additionalProperties", w.AdditionalProperties)
