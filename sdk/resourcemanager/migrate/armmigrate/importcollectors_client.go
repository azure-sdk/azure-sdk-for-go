...
// collectorBody - New or Updated Import collector.
...
func (client *ImportCollectorsClient) Create(ctx context.Context, resourceGroupName string, projectName string, importCollectorName string, collectorBody ImportCollector, options *ImportCollectorsClientCreateOptions) (ImportCollectorsClientCreateResponse, error) {
	req, err := client.createCreateRequest(ctx, resourceGroupName, projectName, importCollectorName, collectorBody, options)
	if err != nil {
...
func (client *ImportCollectorsClient) createCreateRequest(ctx context.Context, resourceGroupName string, projectName string, importCollectorName string, collectorBody ImportCollector, options *ImportCollectorsClientCreateOptions) (*policy.Request, error) {
