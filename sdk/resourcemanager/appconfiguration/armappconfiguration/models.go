...
// NSPAccessRuleProperties - Properties of an access rule on a network profile
type NSPAccessRuleProperties struct {
	// READ-ONLY; List of IPv4 or IPv6 address prefixes granted access
	AddressPrefixes []*string

	// READ-ONLY; The direction of the access rule
	Direction *AccessRuleDirection
}

// NSPProfile - Properties of the related network profile
type NSPProfile struct {
	// READ-ONLY; List of access rules on the associated network profile
	AccessRules []*NSPProfileAccessRule

	// READ-ONLY; The access rules version number
	AccessRulesVersion *string

	// READ-ONLY; The diagnostic settings version number
	DiagnosticSettingsVersion *string

	// READ-ONLY; List of enabled log categories
	EnabledLogCategories []*string

	// READ-ONLY; The name of the network profile
	Name *string
}

// NSPProfileAccessRule - Details of an access rule on a network profile
type NSPProfileAccessRule struct {
	// Properties of an access rule on a network profile
	Properties *NSPAccessRuleProperties

	// READ-ONLY; The name of the access rule
	Name *string
}

// NSPProperties - Properties of the network security perimeter
type NSPProperties struct {
	// READ-ONLY; Azure resource ID of the network security perimeter
	ID *string

	// READ-ONLY; The geo-location of the network security perimeter
	Location *string

	// READ-ONLY; The network security perimeter GUID
	PerimeterGUID *string
}

// NSPProvisioningIssue - A network security perimeter provisioning issue
type NSPProvisioningIssue struct {
	...
	// READ-ONLY; The name of the provisioning issue
	Name *string
}

// NSPProvisioningIssueProperties - Properties of a network security perimeter provisioning issue
type NSPProvisioningIssueProperties struct {
	// READ-ONLY; The description of the provisioning issue
	Description *string

	// READ-ONLY; The type of provisioning issue
	IssueType *NSPProvisioningIssueType

	// READ-ONLY; The severity of the provisioning issue
	Severity *NSPProvisioningIssueSeverity

	// READ-ONLY; Access rules that can be added to the perimeter to remediate the issue
	SuggestedAccessRules []*NSPProfileAccessRule

	// READ-ONLY; List of IDs of Azure resources that can be associated to the same perimeter to remediate the issue
	SuggestedResourceIDs []*string
}

// NSPResourceAssociation - Properties of the related Resource Association
type NSPResourceAssociation struct {
	// READ-ONLY; The access mode of the Resource Association
	AccessMode *NSPResourceAssociationAccessMode

	// READ-ONLY; The name of the Resource Association
	Name *string
}
...
// NetworkSecurityPerimeterConfiguration - A network security perimeter configuration
...
type NetworkSecurityPerimeterConfigurationListResult struct {
	...
	// READ-ONLY; The collection value.
...
type NetworkSecurityPerimeterConfigurationProperties struct {
	...
	// READ-ONLY; List of warnings and errors related to network security perimeter provisioning.
	ProvisioningIssues []*NSPProvisioningIssue

	// READ-ONLY; The provisioning status of the network security perimeter configuration.
