...
func (client *ClusterUpgradeHistoriesClient) listCreateRequest(ctx context.Context, resourceGroupName string, clusterPoolName string, clusterName string, _ *ClusterUpgradeHistoriesClientListOptions) (*policy.Request, error) {
