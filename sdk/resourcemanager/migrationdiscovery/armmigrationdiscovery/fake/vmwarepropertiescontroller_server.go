...
func (v *VmwarePropertiesControllerServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if vmwarePropertiesControllerServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = vmwarePropertiesControllerServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			case "VmwarePropertiesControllerClient.BeginUpdateDependencyMapStatus":
				res.resp, res.err = v.dispatchBeginUpdateDependencyMapStatus(req)
			case "VmwarePropertiesControllerClient.BeginUpdateProperties":
				res.resp, res.err = v.dispatchBeginUpdateProperties(req)
			case "VmwarePropertiesControllerClient.BeginUpdateRunAsAccount":
				res.resp, res.err = v.dispatchBeginUpdateRunAsAccount(req)
...
// set this to conditionally intercept incoming requests to VmwarePropertiesControllerServerTransport
var vmwarePropertiesControllerServerTransportInterceptor interface {
