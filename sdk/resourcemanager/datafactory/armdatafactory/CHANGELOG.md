...
- New enum type `AzurePostgreSQLSinkWriteMethod` with values `AzurePostgreSQLSinkWriteMethodBulkInsert`, `AzurePostgreSQLSinkWriteMethodCopyCommand`, `AzurePostgreSQLSinkWriteMethodUpsert`
