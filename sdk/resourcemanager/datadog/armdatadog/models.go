...
type MonitorResource struct {
	...
	// READ-ONLY; Monitor resource name
	Name     *string
...
type MonitoredSubscriptionProperties struct {
	...
	// READ-ONLY; The configuration name. Only 'default' value is supported.
	Name *string
...
type SetDefaultKeyParameterBody struct {
	Body *APIKey
}
