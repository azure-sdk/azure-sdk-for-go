...
const (
	// ProfileTypeC2PAContentCredentials - Used for signing content files.
	ProfileTypeC2PAContentCredentials ProfileType = "C2PAContentCredentials"
	// ProfileTypePrivateTrust - Used for signing code files which are distributed internally within organization or group boundary.
	...
	// ProfileTypePublicTrust - Used for signing code files which are distributed publicly.
	ProfileTypePublicTrust ProfileType = "PublicTrust"
	// ProfileTypePublicTrustTest - Used for signing code files for testing purpose.
	ProfileTypePublicTrustTest ProfileType = "PublicTrustTest"
	// ProfileTypeVBSEnclave - Used for signing code files which are run in secure vbs enclave.
...
func PossibleProfileTypeValues() []ProfileType {
	return []ProfileType{
		ProfileTypeC2PAContentCredentials,
