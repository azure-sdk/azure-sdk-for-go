...
// BeginDelete - The operation to delete a virtual machine. NOTE: As of version 2024-11-01, we are rolling out a feature where
// if the forceDeletion parameter is unspecified OR not explicitly set to false, AND the VM
// meets the relevant criteria, then the VM will be force deleted. The criteria is 1) All disks must be marked with the delete
// option and 2) VM must be on Merlin Fast Path. To avoid defaulting to force
// delete, ensure that the forceDeletion parameter is explicitly set to false.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2024-11-01
//   - resourceGroupName - The name of the resource group.
...
// Delete - The operation to delete a virtual machine. NOTE: As of version 2024-11-01, we are rolling out a feature where
// if the forceDeletion parameter is unspecified OR not explicitly set to false, AND the VM
// meets the relevant criteria, then the VM will be force deleted. The criteria is 1) All disks must be marked with the delete
// option and 2) VM must be on Merlin Fast Path. To avoid defaulting to force
// delete, ensure that the forceDeletion parameter is explicitly set to false.
