...
// BeginPost - Control actions on a session host update.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2024-08-08-preview
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - hostPoolName - The name of the host pool within the specified resource group
//   - hostPoolUpdateControlParameter - The content of the action request
...
// Post - Control actions on a session host update.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2024-08-08-preview
...
func (client *ControlSessionHostUpdateClient) postCreateRequest(ctx context.Context, resourceGroupName string, hostPoolName string, hostPoolUpdateControlParameter HostPoolUpdateControlParameter, options *ControlSessionHostUpdateClientBeginPostOptions) (*policy.Request, error) {
