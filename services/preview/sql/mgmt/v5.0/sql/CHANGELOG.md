...
1. ReplicationLinksClient.Delete(context.Context, string, string, string, string) (autorest.Response, error)
1. ReplicationLinksClient.DeletePreparer(context.Context, string, string, string, string) (*http.Request, error)
1. ReplicationLinksClient.DeleteResponder(*http.Response) (autorest.Response, error)
1. ReplicationLinksClient.DeleteSender(*http.Request) (*http.Response, error)
1. ReplicationLinksClient.Failover(context.Context, string, string, string, string) (ReplicationLinksFailoverFuture, error)
1. ReplicationLinksClient.FailoverAllowDataLoss(context.Context, string, string, string, string) (ReplicationLinksFailoverAllowDataLossFuture, error)
1. ReplicationLinksClient.FailoverAllowDataLossPreparer(context.Context, string, string, string, string) (*http.Request, error)
1. ReplicationLinksClient.FailoverAllowDataLossResponder(*http.Response) (autorest.Response, error)
1. ReplicationLinksClient.FailoverAllowDataLossSender(*http.Request) (ReplicationLinksFailoverAllowDataLossFuture, error)
1. ReplicationLinksClient.FailoverPreparer(context.Context, string, string, string, string) (*http.Request, error)
1. ReplicationLinksClient.FailoverResponder(*http.Response) (autorest.Response, error)
1. ReplicationLinksClient.FailoverSender(*http.Request) (ReplicationLinksFailoverFuture, error)
...
1. ReplicationLinksFailoverAllowDataLossFuture
1. ReplicationLinksFailoverFuture
