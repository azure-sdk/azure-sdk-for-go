...
func (s *SecurityPINsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if securityPiNsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = securityPiNsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to SecurityPINsServerTransport
var securityPiNsServerTransportInterceptor interface {
