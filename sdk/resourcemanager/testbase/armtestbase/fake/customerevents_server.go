...
func (c *CustomerEventsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if customerEventsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = customerEventsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to CustomerEventsServerTransport
var customerEventsServerTransportInterceptor interface {
