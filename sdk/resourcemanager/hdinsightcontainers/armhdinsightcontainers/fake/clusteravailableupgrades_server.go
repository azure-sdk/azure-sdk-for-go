...
func (c *ClusterAvailableUpgradesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if clusterAvailableUpgradesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = clusterAvailableUpgradesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to ClusterAvailableUpgradesServerTransport
var clusterAvailableUpgradesServerTransportInterceptor interface {
