...
type GroupQuotasServer struct {
	...
	// Delete is the fake for method GroupQuotasClient.Delete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	Delete func(ctx context.Context, managementGroupID string, groupQuotaName string, options *armquota.GroupQuotasClientDeleteOptions) (resp azfake.Responder[armquota.GroupQuotasClientDeleteResponse], errResp azfake.ErrorResponder)
...
func (g *GroupQuotasServerTransport) dispatchDelete(req *http.Request) (*http.Response, error) {
	if g.srv.Delete == nil {
