...
func (c *ConfigurationServicesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if configurationServicesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = configurationServicesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "ConfigurationServicesClient.BeginValidateResource":
				res.resp, res.err = c.dispatchBeginValidateResource(req)
			default:
...
// set this to conditionally intercept incoming requests to ConfigurationServicesServerTransport
var configurationServicesServerTransportInterceptor interface {
