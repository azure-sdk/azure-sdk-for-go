...
func (client *WorkflowRunActionRepetitionsClient) getCreateRequest(ctx context.Context, resourceGroupName string, workflowName string, runName string, actionName string, repetitionName string, _ *WorkflowRunActionRepetitionsClientGetOptions) (*policy.Request, error) {
...
func (client *WorkflowRunActionRepetitionsClient) listCreateRequest(ctx context.Context, resourceGroupName string, workflowName string, runName string, actionName string, _ *WorkflowRunActionRepetitionsClientListOptions) (*policy.Request, error) {
...
func (client *WorkflowRunActionRepetitionsClient) listExpressionTracesCreateRequest(ctx context.Context, resourceGroupName string, workflowName string, runName string, actionName string, repetitionName string, _ *WorkflowRunActionRepetitionsClientListExpressionTracesOptions) (*policy.Request, error) {
