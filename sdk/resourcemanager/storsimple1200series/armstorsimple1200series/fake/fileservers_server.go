...
func (f *FileServersServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if fileServersServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = fileServersServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			case "FileServersClient.BeginBackupNow":
				res.resp, res.err = f.dispatchBeginBackupNow(req)
			...
			case "FileServersClient.NewListByDevicePager":
				res.resp, res.err = f.dispatchNewListByDevicePager(req)
			case "FileServersClient.NewListByManagerPager":
				res.resp, res.err = f.dispatchNewListByManagerPager(req)
			case "FileServersClient.NewListMetricDefinitionPager":
				res.resp, res.err = f.dispatchNewListMetricDefinitionPager(req)
			case "FileServersClient.NewListMetricsPager":
				res.resp, res.err = f.dispatchNewListMetricsPager(req)
			default:
...
// set this to conditionally intercept incoming requests to FileServersServerTransport
var fileServersServerTransportInterceptor interface {
