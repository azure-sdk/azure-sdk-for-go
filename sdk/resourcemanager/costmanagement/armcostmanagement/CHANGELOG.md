...
- Type of `AlertPropertiesDetails.TagFilter` has been changed from `interface{}` to `any`
- Type of `AlertPropertiesDetails.ResourceFilter` has been changed from `[]interface{}` to `[]any`
- Type of `AlertPropertiesDetails.ResourceGroupFilter` has been changed from `[]interface{}` to `[]any`
- Type of `AlertPropertiesDetails.MeterFilter` has been changed from `[]interface{}` to `[]any`
...
- Type of `QueryProperties.Rows` has been changed from `[][]interface{}` to `[][]any`
