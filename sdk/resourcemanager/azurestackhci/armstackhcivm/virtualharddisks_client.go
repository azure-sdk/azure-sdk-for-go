...
func (client *VirtualHardDisksClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, virtualHardDiskName string, resource VirtualHardDisk, options *VirtualHardDisksClientBeginCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *VirtualHardDisksClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, options *VirtualHardDisksClientListByResourceGroupOptions) (*policy.Request, error) {
...
//     method.
func (client *VirtualHardDisksClient) BeginUpdate(ctx context.Context, resourceGroupName string, virtualHardDiskName string, properties VirtualHardDiskTagsUpdate, options *VirtualHardDisksClientBeginUpdateOptions) (*runtime.Poller[VirtualHardDisksClientUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
...
//
// Generated from API version 2024-02-01-preview
func (client *VirtualHardDisksClient) update(ctx context.Context, resourceGroupName string, virtualHardDiskName string, properties VirtualHardDiskTagsUpdate, options *VirtualHardDisksClientBeginUpdateOptions) (*http.Response, error) {
	var err error
...
func (client *VirtualHardDisksClient) updateCreateRequest(ctx context.Context, resourceGroupName string, virtualHardDiskName string, properties VirtualHardDiskTagsUpdate, options *VirtualHardDisksClientBeginUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureStackHCI/virtualHardDisks/{virtualHardDiskName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
