...
func (client *ContainersClient) deleteCreateRequest(ctx context.Context, resourceGroup string, fluidRelayServerName string, fluidRelayContainerName string, _ *ContainersClientDeleteOptions) (*policy.Request, error) {
...
func (client *ContainersClient) getCreateRequest(ctx context.Context, resourceGroup string, fluidRelayServerName string, fluidRelayContainerName string, _ *ContainersClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroup}/providers/Microsoft.FluidRelay/fluidRelayServers/{fluidRelayServerName}/fluidRelayContainers/{fluidRelayContainerName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *ContainersClient) listByFluidRelayServersCreateRequest(ctx context.Context, resourceGroup string, fluidRelayServerName string, _ *ContainersClientListByFluidRelayServersOptions) (*policy.Request, error) {
