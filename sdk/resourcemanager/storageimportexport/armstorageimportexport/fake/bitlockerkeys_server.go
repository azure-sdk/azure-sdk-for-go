...
func (b *BitLockerKeysServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if bitLockerKeysServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = bitLockerKeysServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to BitLockerKeysServerTransport
var bitLockerKeysServerTransportInterceptor interface {
