...
func (i *IntegrationServiceEnvironmentManagedAPIOperationsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if integrationServiceEnvironmentManagedApiOperationsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = integrationServiceEnvironmentManagedApiOperationsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to IntegrationServiceEnvironmentManagedAPIOperationsServerTransport
var integrationServiceEnvironmentManagedApiOperationsServerTransportInterceptor interface {
