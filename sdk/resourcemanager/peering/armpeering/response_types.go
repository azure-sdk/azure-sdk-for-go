...
// ResourceMoveClientMoveResourcesResponse contains the response from method ResourceMoveClient.MoveResources.
type ResourceMoveClientMoveResourcesResponse struct {
	// placeholder for future response values
}

// ResourceMoveClientValidateMoveResourcesResponse contains the response from method ResourceMoveClient.ValidateMoveResources.
type ResourceMoveClientValidateMoveResourcesResponse struct {
	// placeholder for future response values
}
