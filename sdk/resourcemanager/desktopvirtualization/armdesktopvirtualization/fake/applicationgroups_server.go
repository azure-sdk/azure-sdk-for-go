...
func (a *ApplicationGroupsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if applicationGroupsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = applicationGroupsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to ApplicationGroupsServerTransport
var applicationGroupsServerTransportInterceptor interface {
