	...
	go func() {
		...
		if !intercepted {
			...
			case "JobsClient.NewListByDataManagerPager":
				res.resp, res.err = j.dispatchNewListByDataManagerPager(req)
			case "JobsClient.NewListByDataServicePager":
				res.resp, res.err = j.dispatchNewListByDataServicePager(req)
			case "JobsClient.NewListByJobDefinitionPager":
				res.resp, res.err = j.dispatchNewListByJobDefinitionPager(req)
