...
// collectorBody - New or Updated VMware collector.
...
func (client *VMwareCollectorsClient) Create(ctx context.Context, resourceGroupName string, projectName string, vmWareCollectorName string, collectorBody VMwareCollector, options *VMwareCollectorsClientCreateOptions) (VMwareCollectorsClientCreateResponse, error) {
	req, err := client.createCreateRequest(ctx, resourceGroupName, projectName, vmWareCollectorName, collectorBody, options)
	if err != nil {
...
func (client *VMwareCollectorsClient) createCreateRequest(ctx context.Context, resourceGroupName string, projectName string, vmWareCollectorName string, collectorBody VMwareCollector, options *VMwareCollectorsClientCreateOptions) (*policy.Request, error) {
