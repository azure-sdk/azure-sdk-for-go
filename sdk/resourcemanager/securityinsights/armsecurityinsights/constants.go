...
// OverviewSectionKind - The overview supported section kinds
type OverviewSectionKind string

const (
	OverviewSectionKindAnalytics      OverviewSectionKind = "Analytics"
	OverviewSectionKindAutomation     OverviewSectionKind = "Automation"
	OverviewSectionKindDataConnectors OverviewSectionKind = "DataConnectors"
	OverviewSectionKindIncidents      OverviewSectionKind = "Incidents"
)

// PossibleOverviewSectionKindValues returns the possible values for the OverviewSectionKind const type.
func PossibleOverviewSectionKindValues() []OverviewSectionKind {
	return []OverviewSectionKind{
		OverviewSectionKindAnalytics,
		OverviewSectionKindAutomation,
		OverviewSectionKindDataConnectors,
		OverviewSectionKindIncidents,
	}
}
