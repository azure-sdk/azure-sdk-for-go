...
func (i *InputsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if inputsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = inputsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			case "InputsClient.CreateOrReplace":
				res.resp, res.err = i.dispatchCreateOrReplace(req)
			...
			case "InputsClient.NewListByStreamingJobPager":
				res.resp, res.err = i.dispatchNewListByStreamingJobPager(req)
			case "InputsClient.BeginTest":
				res.resp, res.err = i.dispatchBeginTest(req)
...
// set this to conditionally intercept incoming requests to InputsServerTransport
var inputsServerTransportInterceptor interface {
