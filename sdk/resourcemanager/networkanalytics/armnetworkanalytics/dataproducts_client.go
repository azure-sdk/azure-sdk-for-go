...
func (client *DataProductsClient) addUserRoleCreateRequest(ctx context.Context, resourceGroupName string, dataProductName string, body RoleAssignmentCommonProperties, _ *DataProductsClientAddUserRoleOptions) (*policy.Request, error) {
...
func (client *DataProductsClient) createCreateRequest(ctx context.Context, resourceGroupName string, dataProductName string, resource DataProduct, _ *DataProductsClientBeginCreateOptions) (*policy.Request, error) {
...
func (client *DataProductsClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, dataProductName string, _ *DataProductsClientBeginDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetworkAnalytics/dataProducts/{dataProductName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *DataProductsClient) generateStorageAccountSasTokenCreateRequest(ctx context.Context, resourceGroupName string, dataProductName string, body AccountSas, _ *DataProductsClientGenerateStorageAccountSasTokenOptions) (*policy.Request, error) {
...
func (client *DataProductsClient) getCreateRequest(ctx context.Context, resourceGroupName string, dataProductName string, _ *DataProductsClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetworkAnalytics/dataProducts/{dataProductName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *DataProductsClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, _ *DataProductsClientListByResourceGroupOptions) (*policy.Request, error) {
...
func (client *DataProductsClient) listBySubscriptionCreateRequest(ctx context.Context, _ *DataProductsClientListBySubscriptionOptions) (*policy.Request, error) {
...
//     method.
func (client *DataProductsClient) ListRolesAssignments(ctx context.Context, resourceGroupName string, dataProductName string, body ListRolesAssignmentsRequest, options *DataProductsClientListRolesAssignmentsOptions) (DataProductsClientListRolesAssignmentsResponse, error) {
	var err error
...
func (client *DataProductsClient) listRolesAssignmentsCreateRequest(ctx context.Context, resourceGroupName string, dataProductName string, body ListRolesAssignmentsRequest, _ *DataProductsClientListRolesAssignmentsOptions) (*policy.Request, error) {
...
func (client *DataProductsClient) removeUserRoleCreateRequest(ctx context.Context, resourceGroupName string, dataProductName string, body RoleAssignmentDetail, _ *DataProductsClientRemoveUserRoleOptions) (*policy.Request, error) {
...
func (client *DataProductsClient) rotateKeyCreateRequest(ctx context.Context, resourceGroupName string, dataProductName string, body KeyVaultInfo, _ *DataProductsClientRotateKeyOptions) (*policy.Request, error) {
...
//     method.
func (client *DataProductsClient) BeginUpdate(ctx context.Context, resourceGroupName string, dataProductName string, properties DataProduct, options *DataProductsClientBeginUpdateOptions) (*runtime.Poller[DataProductsClientUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
...
//
// Generated from API version 2023-11-15
func (client *DataProductsClient) update(ctx context.Context, resourceGroupName string, dataProductName string, properties DataProduct, options *DataProductsClientBeginUpdateOptions) (*http.Response, error) {
	var err error
...
func (client *DataProductsClient) updateCreateRequest(ctx context.Context, resourceGroupName string, dataProductName string, properties DataProduct, _ *DataProductsClientBeginUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetworkAnalytics/dataProducts/{dataProductName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
