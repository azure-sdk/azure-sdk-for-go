...
- New enum type `CleanupPolicyRetentionDescription` with values `CleanupPolicyRetentionDescriptionCompact`, `CleanupPolicyRetentionDescriptionDelete`, `CleanupPolicyRetentionDescriptionDeleteCompact`
