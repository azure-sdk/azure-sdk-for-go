...
- Operation `*VirtualMachineImagesClient.List` has supported pagination, use `*VirtualMachineImagesClient.NewListPager` instead.
- Operation `*VirtualMachineImagesClient.ListOffers` has supported pagination, use `*VirtualMachineImagesClient.NewListOffersPager` instead.
- Operation `*VirtualMachineImagesClient.ListPublishers` has supported pagination, use `*VirtualMachineImagesClient.NewListPublishersPager` instead.
- Operation `*VirtualMachineImagesClient.ListSKUs` has supported pagination, use `*VirtualMachineImagesClient.NewListSKUsPager` instead.
- Operation `*VirtualMachineImagesEdgeZoneClient.List` has supported pagination, use `*VirtualMachineImagesEdgeZoneClient.NewListPager` instead.
- Operation `*VirtualMachineImagesEdgeZoneClient.ListOffers` has supported pagination, use `*VirtualMachineImagesEdgeZoneClient.NewListOffersPager` instead.
- Operation `*VirtualMachineImagesEdgeZoneClient.ListPublishers` has supported pagination, use `*VirtualMachineImagesEdgeZoneClient.NewListPublishersPager` instead.
- Operation `*VirtualMachineImagesEdgeZoneClient.ListSKUs` has supported pagination, use `*VirtualMachineImagesEdgeZoneClient.NewListSKUsPager` instead.
...
- Field `DiskRestorePointList` of struct `DiskRestorePointClientListByRestorePointResponse` has been removed
...
- New struct `DiskRestorePointListResult`
- New struct `ErrorAdditionalInfo`
- New struct `ErrorDetail`
- New struct `ErrorResponse`
- New struct `Operation`
- New struct `OperationDisplay`
- New struct `PagedVirtualMachineImageResource`
...
- New field `ResourceID`, `ResourceName`, `ResourceType`, `SystemData` in struct `DiskRestorePoint`
- New anonymous field `DiskRestorePointListResult` in struct `DiskRestorePointClientListByRestorePointResponse`
...
- New field `ConnectionID`, `ConnectionName`, `ConnectionType`, `SystemData` in struct `PrivateEndpointConnection`
...
- New field `ProvisionAfterExtensions`, `ProvisioningState` in struct `VirtualMachineExtensionUpdateProperties`
...
- New field `ExtensionName`, `ExtensionType`, `SystemData` in struct `VirtualMachineScaleSetExtension`
- New field `SystemData` in struct `VirtualMachineScaleSetVM`
- New field `ExtensionName`, `ExtensionType`, `SystemData` in struct `VirtualMachineScaleSetVMExtension`
