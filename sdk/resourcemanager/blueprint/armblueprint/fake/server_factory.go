...
type ServerFactory struct {
	...
	// AssignmentOperationsServer contains the fakes for client AssignmentOperationsClient
	...
	// BlueprintsServer contains the fakes for client BlueprintsClient
	BlueprintsServer BlueprintsServer

	// PublishedArtifactsServer contains the fakes for client PublishedArtifactsClient
	PublishedArtifactsServer PublishedArtifactsServer

	// PublishedBlueprintsServer contains the fakes for client PublishedBlueprintsClient
