...
func (s *StorageDomainsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if storageDomainsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = storageDomainsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to StorageDomainsServerTransport
var storageDomainsServerTransportInterceptor interface {
