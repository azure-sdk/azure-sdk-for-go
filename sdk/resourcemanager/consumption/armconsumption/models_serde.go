...
func (e EventProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "chargesInLotCurrency", e.ChargesInLotCurrency)
	...
	populate(objectMap, "closedBalanceInLotCurrency", e.ClosedBalanceInLotCurrency)
...
func (e *EventProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "chargesInBillingCurrency":
			...
			delete(rawMsg, key)
		case "chargesInLotCurrency":
			err = unpopulate(val, "ChargesInLotCurrency", &e.ChargesInLotCurrency)
			delete(rawMsg, key)
		case "closedBalance":
		...
		case "closedBalanceInBillingCurrency":
			...
			delete(rawMsg, key)
		case "closedBalanceInLotCurrency":
			err = unpopulate(val, "ClosedBalanceInLotCurrency", &e.ClosedBalanceInLotCurrency)
			delete(rawMsg, key)
		case "creditCurrency":
