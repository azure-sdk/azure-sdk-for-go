...
func (e EndpointDeploymentResourceProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "raiPolicyName", e.RaiPolicyName)
	populate(objectMap, "versionUpgradeOption", e.VersionUpgradeOption)
	return json.Marshal(objectMap)
}
...
func (e *EndpointDeploymentResourceProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "provisioningState":
			...
			delete(rawMsg, key)
		case "raiPolicyName":
			err = unpopulate(val, "RaiPolicyName", &e.RaiPolicyName)
			delete(rawMsg, key)
		case "versionUpgradeOption":
			err = unpopulate(val, "VersionUpgradeOption", &e.VersionUpgradeOption)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", e, err)
