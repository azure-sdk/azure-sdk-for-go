...
// LabSecretsClientBeginUpdateOptions contains the optional parameters for the LabSecretsClient.BeginUpdate method.
type LabSecretsClientBeginUpdateOptions struct {
	// Resumes the LRO from the provided token.
	ResumeToken string
}
