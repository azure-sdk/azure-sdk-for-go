...
func (s *SmartGroupsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if smartGroupsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = smartGroupsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			case "SmartGroupsClient.ChangeState":
				res.resp, res.err = s.dispatchChangeState(req)
			case "SmartGroupsClient.NewGetAllPager":
				res.resp, res.err = s.dispatchNewGetAllPager(req)
			case "SmartGroupsClient.GetByID":
				res.resp, res.err = s.dispatchGetByID(req)
			case "SmartGroupsClient.GetHistory":
				res.resp, res.err = s.dispatchGetHistory(req)
			default:
...
// set this to conditionally intercept incoming requests to SmartGroupsServerTransport
var smartGroupsServerTransportInterceptor interface {
