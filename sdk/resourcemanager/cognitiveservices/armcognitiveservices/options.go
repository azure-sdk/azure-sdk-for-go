...
// RaiBlocklistClientCreateOrUpdateOptions contains the optional parameters for the RaiBlocklistClient.CreateOrUpdate method.
type RaiBlocklistClientCreateOrUpdateOptions struct {
	// placeholder for future optional parameters
}

// RaiBlocklistClientGetOptions contains the optional parameters for the RaiBlocklistClient.Get method.
type RaiBlocklistClientGetOptions struct {
	// placeholder for future optional parameters
}

// RaiBlocklistItemClientBeginDeleteOptions contains the optional parameters for the RaiBlocklistItemClient.BeginDelete method.
type RaiBlocklistItemClientBeginDeleteOptions struct {
	// Resumes the LRO from the provided token.
	ResumeToken string
}

// RaiBlocklistItemClientCreateOrUpdateOptions contains the optional parameters for the RaiBlocklistItemClient.CreateOrUpdate
// method.
type RaiBlocklistItemClientCreateOrUpdateOptions struct {
	// placeholder for future optional parameters
}

// RaiBlocklistItemClientGetOptions contains the optional parameters for the RaiBlocklistItemClient.Get method.
type RaiBlocklistItemClientGetOptions struct {
	// placeholder for future optional parameters
}
...
// RaiContentFiltersClientListOptions contains the optional parameters for the RaiContentFiltersClient.List method.
