...
// AzureBareMetalInstancesClientPutResponse contains the response from method AzureBareMetalInstancesClient.Put.
type AzureBareMetalInstancesClientPutResponse struct {
	// placeholder for future response values
}
