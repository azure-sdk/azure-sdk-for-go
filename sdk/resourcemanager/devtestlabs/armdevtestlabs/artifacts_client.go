...
func (client *ArtifactsClient) generateArmTemplateCreateRequest(ctx context.Context, resourceGroupName string, labName string, artifactSourceName string, name string, generateArmTemplateRequest GenerateArmTemplateRequest, _ *ArtifactsClientGenerateArmTemplateOptions) (*policy.Request, error) {
