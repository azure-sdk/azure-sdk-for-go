...
// BeginCreateCheckpoint - Implements the operation to creates a checkpoint in a virtual machine instance.
...
// CreateCheckpoint - Implements the operation to creates a checkpoint in a virtual machine instance.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2023-10-07
...
func (client *VirtualMachineInstancesClient) createCheckpointCreateRequest(ctx context.Context, resourceURI string, body VirtualMachineCreateCheckpoint, _ *VirtualMachineInstancesClientBeginCreateCheckpointOptions) (*policy.Request, error) {
...
// BeginCreateOrUpdate - Implements virtual machine PUT method.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2023-10-07
//   - resourceURI - The fully qualified Azure Resource manager identifier of the resource.
...
// CreateOrUpdate - Implements virtual machine PUT method.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2023-10-07
...
// BeginDelete - Deletes an virtual machine.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2023-10-07
//   - resourceURI - The fully qualified Azure Resource manager identifier of the resource.
...
// Delete - Deletes an virtual machine.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2023-10-07
...
// BeginDeleteCheckpoint - Implements the operation to delete a checkpoint in a virtual machine instance.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2023-10-07
//   - resourceURI - The fully qualified Azure Resource manager identifier of the resource.
...
// DeleteCheckpoint - Implements the operation to delete a checkpoint in a virtual machine instance.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2023-10-07
...
func (client *VirtualMachineInstancesClient) deleteCheckpointCreateRequest(ctx context.Context, resourceURI string, body VirtualMachineDeleteCheckpoint, _ *VirtualMachineInstancesClientBeginDeleteCheckpointOptions) (*policy.Request, error) {
...
// NewListByArmPager - Implements List virtual machine instances.
//
// Generated from API version 2023-10-07
//   - resourceURI - The fully qualified Azure Resource manager identifier of the resource.
//   - options - VirtualMachineInstancesClientListByArmOptions contains the optional parameters for the VirtualMachineInstancesClient.NewListByArmPager
//     method.
func (client *VirtualMachineInstancesClient) NewListByArmPager(resourceURI string, options *VirtualMachineInstancesClientListByArmOptions) *runtime.Pager[VirtualMachineInstancesClientListByArmResponse] {
	return runtime.NewPager(runtime.PagingHandler[VirtualMachineInstancesClientListByArmResponse]{
		More: func(page VirtualMachineInstancesClientListByArmResponse) bool {
			return page.NextLink != nil && len(*page.NextLink) > 0
		},
		Fetcher: func(ctx context.Context, page *VirtualMachineInstancesClientListByArmResponse) (VirtualMachineInstancesClientListByArmResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "VirtualMachineInstancesClient.NewListByArmPager")
			nextLink := ""
			if page != nil {
				nextLink = *page.NextLink
			}
			resp, err := runtime.FetcherForNextLink(ctx, client.internal.Pipeline(), nextLink, func(ctx context.Context) (*policy.Request, error) {
				return client.listByArmCreateRequest(ctx, resourceURI, options)
			}, nil)
			if err != nil {
				return VirtualMachineInstancesClientListByArmResponse{}, err
			}
			return client.listByArmHandleResponse(resp)
		},
		Tracer: client.internal.Tracer(),
	})
}

// listByArmCreateRequest creates the ListByArm request.
func (client *VirtualMachineInstancesClient) listByArmCreateRequest(ctx context.Context, resourceURI string, _ *VirtualMachineInstancesClientListByArmOptions) (*policy.Request, error) {
...
// listByArmHandleResponse handles the ListByArm response.
func (client *VirtualMachineInstancesClient) listByArmHandleResponse(resp *http.Response) (VirtualMachineInstancesClientListByArmResponse, error) {
	result := VirtualMachineInstancesClientListByArmResponse{}
...
// BeginRestart - Implements the operation to restart a virtual machine.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2023-10-07
//   - resourceURI - The fully qualified Azure Resource manager identifier of the resource.
...
// Restart - Implements the operation to restart a virtual machine.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2023-10-07
...
// BeginRestoreCheckpoint - Implements the operation to restores to a checkpoint in a virtual machine instance.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2023-10-07
//   - resourceURI - The fully qualified Azure Resource manager identifier of the resource.
...
// RestoreCheckpoint - Implements the operation to restores to a checkpoint in a virtual machine instance.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2023-10-07
...
func (client *VirtualMachineInstancesClient) restoreCheckpointCreateRequest(ctx context.Context, resourceURI string, body VirtualMachineRestoreCheckpoint, _ *VirtualMachineInstancesClientBeginRestoreCheckpointOptions) (*policy.Request, error) {
...
// BeginStart - Implements the operation to start a virtual machine.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2023-10-07
//   - resourceURI - The fully qualified Azure Resource manager identifier of the resource.
...
// Start - Implements the operation to start a virtual machine.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2023-10-07
...
// BeginStop - Implements the operation to stop a virtual machine.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2023-10-07
//   - resourceURI - The fully qualified Azure Resource manager identifier of the resource.
...
// Stop - Implements the operation to stop a virtual machine.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2023-10-07
...
func (client *VirtualMachineInstancesClient) stopCreateRequest(ctx context.Context, resourceURI string, body StopVirtualMachineOptions, _ *VirtualMachineInstancesClientBeginStopOptions) (*policy.Request, error) {
...
// BeginUpdate - Updates a virtual machine.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2023-10-07
//   - resourceURI - The fully qualified Azure Resource manager identifier of the resource.
...
func (client *VirtualMachineInstancesClient) updateCreateRequest(ctx context.Context, resourceURI string, properties VirtualMachineInstanceUpdate, _ *VirtualMachineInstancesClientBeginUpdateOptions) (*policy.Request, error) {
	urlPath := "/{resourceUri}/providers/Microsoft.ScVmm/virtualMachineInstances/default"
	if resourceURI == "" {
		return nil, errors.New("parameter resourceURI cannot be empty")
	}
