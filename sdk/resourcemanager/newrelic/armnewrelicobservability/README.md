...
```go
client, err := armnewrelicobservability.NewAccountsClient(<subscription ID>, cred, nil)
```
...
client, err := armnewrelicobservability.NewAccountsClient(<subscription ID>, cred, &options)
```
