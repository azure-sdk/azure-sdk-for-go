...
// The returned OperationsServerTransport instance is connected to an instance of armmariadb.OperationsClient via the
// azcore.ClientOptions.Transporter field in the client's constructor parameters.
func NewOperationsServerTransport(srv *OperationsServer) *OperationsServerTransport {
	return &OperationsServerTransport{srv: srv}
}

// OperationsServerTransport connects instances of armmariadb.OperationsClient to instances of OperationsServer.
