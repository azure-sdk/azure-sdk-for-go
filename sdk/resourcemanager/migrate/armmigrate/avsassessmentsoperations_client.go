...
func NewAvsAssessmentsOperationsClient(subscriptionID string, credential azcore.TokenCredential, options *arm.ClientOptions) (*AvsAssessmentsOperationsClient, error) {
	cl, err := arm.NewClient(moduleName+".AvsAssessmentsOperationsClient", moduleVersion, credential, options)
	if err != nil {
		return nil, err
	}
...
func (client *AvsAssessmentsOperationsClient) BeginCreate(ctx context.Context, resourceGroupName string, projectName string, groupName string, assessmentName string, resource AvsAssessment, options *AvsAssessmentsOperationsClientBeginCreateOptions) (*runtime.Poller[AvsAssessmentsOperationsClientCreateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return runtime.NewPollerFromResumeToken[AvsAssessmentsOperationsClientCreateResponse](options.ResumeToken, client.internal.Pipeline(), nil)
	}
}
...
func (client *AvsAssessmentsOperationsClient) createCreateRequest(ctx context.Context, resourceGroupName string, projectName string, groupName string, assessmentName string, resource AvsAssessment, options *AvsAssessmentsOperationsClientBeginCreateOptions) (*policy.Request, error) {
...
func (client *AvsAssessmentsOperationsClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, projectName string, groupName string, assessmentName string, options *AvsAssessmentsOperationsClientDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Migrate/assessmentProjects/{projectName}/groups/{groupName}/avsAssessments/{assessmentName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *AvsAssessmentsOperationsClient) BeginDownloadURL(ctx context.Context, resourceGroupName string, projectName string, groupName string, assessmentName string, body any, options *AvsAssessmentsOperationsClientBeginDownloadURLOptions) (*runtime.Poller[AvsAssessmentsOperationsClientDownloadURLResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return runtime.NewPollerFromResumeToken[AvsAssessmentsOperationsClientDownloadURLResponse](options.ResumeToken, client.internal.Pipeline(), nil)
	}
}
...
func (client *AvsAssessmentsOperationsClient) downloadURLCreateRequest(ctx context.Context, resourceGroupName string, projectName string, groupName string, assessmentName string, body any, options *AvsAssessmentsOperationsClientBeginDownloadURLOptions) (*policy.Request, error) {
...
func (client *AvsAssessmentsOperationsClient) getCreateRequest(ctx context.Context, resourceGroupName string, projectName string, groupName string, assessmentName string, options *AvsAssessmentsOperationsClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Migrate/assessmentProjects/{projectName}/groups/{groupName}/avsAssessments/{assessmentName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
	...
	return runtime.NewPager(runtime.PagingHandler[AvsAssessmentsOperationsClientListByGroupResponse]{
		...
		Fetcher: func(ctx context.Context, page *AvsAssessmentsOperationsClientListByGroupResponse) (AvsAssessmentsOperationsClientListByGroupResponse, error) {
			...
			if !runtime.HasStatusCode(resp, http.StatusOK) {
				return AvsAssessmentsOperationsClientListByGroupResponse{}, runtime.NewResponseError(resp)
			}
...
func (client *AvsAssessmentsOperationsClient) listByGroupCreateRequest(ctx context.Context, resourceGroupName string, projectName string, groupName string, options *AvsAssessmentsOperationsClientListByGroupOptions) (*policy.Request, error) {
