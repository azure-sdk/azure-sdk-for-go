...
// The returned PrivateEndpointConnectionsCompServerTransport instance is connected to an instance of armm365securityandcompliance.PrivateEndpointConnectionsCompClient via the
...
func NewPrivateEndpointConnectionsCompServerTransport(srv *PrivateEndpointConnectionsCompServer) *PrivateEndpointConnectionsCompServerTransport {
	return &PrivateEndpointConnectionsCompServerTransport{
		srv:                   srv,
		beginCreateOrUpdate:   newTracker[azfake.PollerResponder[armm365securityandcompliance.PrivateEndpointConnectionsCompClientCreateOrUpdateResponse]](),
		beginDelete:           newTracker[azfake.PollerResponder[armm365securityandcompliance.PrivateEndpointConnectionsCompClientDeleteResponse]](),
		newListByServicePager: newTracker[azfake.PagerResponder[armm365securityandcompliance.PrivateEndpointConnectionsCompClientListByServiceResponse]](),
	}
}

// PrivateEndpointConnectionsCompServerTransport connects instances of armm365securityandcompliance.PrivateEndpointConnectionsCompClient to instances of PrivateEndpointConnectionsCompServer.
// Don't use this type directly, use NewPrivateEndpointConnectionsCompServerTransport instead.
type PrivateEndpointConnectionsCompServerTransport struct {
	srv                   *PrivateEndpointConnectionsCompServer
	beginCreateOrUpdate   *tracker[azfake.PollerResponder[armm365securityandcompliance.PrivateEndpointConnectionsCompClientCreateOrUpdateResponse]]
	beginDelete           *tracker[azfake.PollerResponder[armm365securityandcompliance.PrivateEndpointConnectionsCompClientDeleteResponse]]
	newListByServicePager *tracker[azfake.PagerResponder[armm365securityandcompliance.PrivateEndpointConnectionsCompClientListByServiceResponse]]
}

// Do implements the policy.Transporter interface for PrivateEndpointConnectionsCompServerTransport.
func (p *PrivateEndpointConnectionsCompServerTransport) Do(req *http.Request) (*http.Response, error) {
...
func (p *PrivateEndpointConnectionsCompServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if privateEndpointConnectionsCompServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = privateEndpointConnectionsCompServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			case "PrivateEndpointConnectionsCompClient.BeginCreateOrUpdate":
				res.resp, res.err = p.dispatchBeginCreateOrUpdate(req)
			case "PrivateEndpointConnectionsCompClient.BeginDelete":
				res.resp, res.err = p.dispatchBeginDelete(req)
			case "PrivateEndpointConnectionsCompClient.Get":
				res.resp, res.err = p.dispatchGet(req)
			case "PrivateEndpointConnectionsCompClient.NewListByServicePager":
...
func (p *PrivateEndpointConnectionsCompServerTransport) dispatchBeginCreateOrUpdate(req *http.Request) (*http.Response, error) {
	if p.srv.BeginCreateOrUpdate == nil {
		return nil, &nonRetriableError{errors.New("fake for method BeginCreateOrUpdate not implemented")}
	}
	beginCreateOrUpdate := p.beginCreateOrUpdate.get(req)
	if beginCreateOrUpdate == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.M365SecurityAndCompliance/privateLinkServicesForM365ComplianceCenter/(?P<resourceName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/privateEndpointConnections/(?P<privateEndpointConnectionName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)`
...
func (p *PrivateEndpointConnectionsCompServerTransport) dispatchBeginDelete(req *http.Request) (*http.Response, error) {
...
func (p *PrivateEndpointConnectionsCompServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	if p.srv.Get == nil {
...
func (p *PrivateEndpointConnectionsCompServerTransport) dispatchNewListByServicePager(req *http.Request) (*http.Response, error) {
	...
	if newListByServicePager == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.M365SecurityAndCompliance/privateLinkServicesForM365ComplianceCenter/(?P<resourceName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/privateEndpointConnections`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		...
		server.PagerResponderInjectNextLinks(newListByServicePager, req, func(page *armm365securityandcompliance.PrivateEndpointConnectionsCompClientListByServiceResponse, createLink func() string) {
...
// set this to conditionally intercept incoming requests to PrivateEndpointConnectionsCompServerTransport
var privateEndpointConnectionsCompServerTransportInterceptor interface {
