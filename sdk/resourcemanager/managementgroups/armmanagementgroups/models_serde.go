...
// MarshalJSON implements the json.Marshaller interface for type ParentGroupBagInfo.
func (p ParentGroupBagInfo) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
...
// UnmarshalJSON implements the json.Unmarshaller interface for type ParentGroupBagInfo.
func (p *ParentGroupBagInfo) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
