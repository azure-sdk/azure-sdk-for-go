...
func (client *KustoPoolPrivateLinkResourcesClient) listCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, kustoPoolName string, _ *KustoPoolPrivateLinkResourcesClientListOptions) (*policy.Request, error) {
