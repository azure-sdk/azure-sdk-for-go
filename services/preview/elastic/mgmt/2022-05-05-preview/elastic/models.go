...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/preview/elastic/mgmt/2022-05-05-preview/elastic"

// AssociateTrafficFilterAssociateFuture an abstraction for monitoring and retrieving the results of a
// long-running operation.
type AssociateTrafficFilterAssociateFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(AssociateTrafficFilterClient) (autorest.Response, error)
}

// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *AssociateTrafficFilterAssociateFuture) UnmarshalJSON(body []byte) error {
...
// result is the default implementation for AssociateTrafficFilterAssociateFuture.Result.
func (future *AssociateTrafficFilterAssociateFuture) result(client AssociateTrafficFilterClient) (ar autorest.Response, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "elastic.AssociateTrafficFilterAssociateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		ar.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("elastic.AssociateTrafficFilterAssociateFuture")
		return
	}
	ar.Response = future.Response()
	return
...
// CreateAndAssociateIPFilterCreateFuture an abstraction for monitoring and retrieving the results of a
// long-running operation.
type CreateAndAssociateIPFilterCreateFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(CreateAndAssociateIPFilterClient) (autorest.Response, error)
}

// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *CreateAndAssociateIPFilterCreateFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for CreateAndAssociateIPFilterCreateFuture.Result.
func (future *CreateAndAssociateIPFilterCreateFuture) result(client CreateAndAssociateIPFilterClient) (ar autorest.Response, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "elastic.CreateAndAssociateIPFilterCreateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		ar.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("elastic.CreateAndAssociateIPFilterCreateFuture")
		return
	}
	ar.Response = future.Response()
	return
...
// CreateAndAssociatePLFilterCreateFuture an abstraction for monitoring and retrieving the results of a
// long-running operation.
type CreateAndAssociatePLFilterCreateFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(CreateAndAssociatePLFilterClient) (autorest.Response, error)
}

// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *CreateAndAssociatePLFilterCreateFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for CreateAndAssociatePLFilterCreateFuture.Result.
func (future *CreateAndAssociatePLFilterCreateFuture) result(client CreateAndAssociatePLFilterClient) (ar autorest.Response, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "elastic.CreateAndAssociatePLFilterCreateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		ar.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("elastic.CreateAndAssociatePLFilterCreateFuture")
		return
	}
	ar.Response = future.Response()
	return
...
// DetachAndDeleteTrafficFilterDeleteFuture an abstraction for monitoring and retrieving the results of a
// long-running operation.
type DetachAndDeleteTrafficFilterDeleteFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(DetachAndDeleteTrafficFilterClient) (autorest.Response, error)
}

// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *DetachAndDeleteTrafficFilterDeleteFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for DetachAndDeleteTrafficFilterDeleteFuture.Result.
func (future *DetachAndDeleteTrafficFilterDeleteFuture) result(client DetachAndDeleteTrafficFilterClient) (ar autorest.Response, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "elastic.DetachAndDeleteTrafficFilterDeleteFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		ar.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("elastic.DetachAndDeleteTrafficFilterDeleteFuture")
		return
	}
	ar.Response = future.Response()
	return
...
// DetachTrafficFilterUpdateFuture an abstraction for monitoring and retrieving the results of a
// long-running operation.
type DetachTrafficFilterUpdateFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(DetachTrafficFilterClient) (autorest.Response, error)
}

// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *DetachTrafficFilterUpdateFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for DetachTrafficFilterUpdateFuture.Result.
func (future *DetachTrafficFilterUpdateFuture) result(client DetachTrafficFilterClient) (ar autorest.Response, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "elastic.DetachTrafficFilterUpdateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		ar.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("elastic.DetachTrafficFilterUpdateFuture")
		return
	}
	ar.Response = future.Response()
	return
...
// ExternalUserCreationResponse the properties of the response we got from elastic while creating external
// user
type ExternalUserCreationResponse struct {
	autorest.Response `json:"-"`
	// Created - READ-ONLY; Shows if user is created or updated
	Created *bool `json:"created,omitempty"`
}

// MarshalJSON is the custom marshaler for ExternalUserCreationResponse.
func (eucr ExternalUserCreationResponse) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	return json.Marshal(objectMap)
}
...
type ExternalUserInfo struct {
	// UserName - Username of the user to be created or updated
	UserName *string `json:"userName,omitempty"`
	// FullName - Full name of the user to be created or updated
	FullName *string `json:"fullName,omitempty"`
	// Password - Password of the user to be created or updated
	Password *string `json:"password,omitempty"`
	// EmailID - Email id of the user to be created or updated
	EmailID *string `json:"emailId,omitempty"`
	// Roles - Roles to be assigned for  created or updated user
...
type MonitorUpgrade struct {
	// Version - Version to which the elastic monitor should be upgraded to
	Version *string `json:"version,omitempty"`
}

// MonitorUpgradeFuture an abstraction for monitoring and retrieving the results of a long-running
// operation.
type MonitorUpgradeFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(MonitorClient) (autorest.Response, error)
}

// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *MonitorUpgradeFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for MonitorUpgradeFuture.Result.
func (future *MonitorUpgradeFuture) result(client MonitorClient) (ar autorest.Response, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "elastic.MonitorUpgradeFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		ar.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("elastic.MonitorUpgradeFuture")
		return
	}
	ar.Response = future.Response()
	return
...
type TrafficFilter struct {
	...
	// Type - Type of the elastic filter. Possible values include: 'IP', 'AzurePrivateEndpoint'
