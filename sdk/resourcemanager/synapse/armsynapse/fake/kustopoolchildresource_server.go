...
func (k *KustoPoolChildResourceServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if kustoPoolChildResourceServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = kustoPoolChildResourceServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to KustoPoolChildResourceServerTransport
var kustoPoolChildResourceServerTransportInterceptor interface {
