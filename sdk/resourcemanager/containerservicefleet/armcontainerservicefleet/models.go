...
// SkipRequest - The definition of a single skip request.
type SkipRequest struct {
	// REQUIRED; The skip target. To skip a member/group/stage, use the member/group/stage's name; Tp skip an after stage wait,
	// use the parent stage's name.
	Target *string
