...
func (client *AssessedWebApplicationOperationsClient) getCreateRequest(ctx context.Context, resourceGroupName string, projectName string, assessmentName string, assessedWorkload string, options *AssessedWebApplicationOperationsClientGetOptions) (*policy.Request, error) {
