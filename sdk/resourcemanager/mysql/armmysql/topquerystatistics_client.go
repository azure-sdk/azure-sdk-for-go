...
func (client *TopQueryStatisticsClient) getCreateRequest(ctx context.Context, resourceGroupName string, serverName string, queryStatisticID string, _ *TopQueryStatisticsClientGetOptions) (*policy.Request, error) {
...
func (client *TopQueryStatisticsClient) listByServerCreateRequest(ctx context.Context, resourceGroupName string, serverName string, parameters TopQueryStatisticsInput, _ *TopQueryStatisticsClientListByServerOptions) (*policy.Request, error) {
