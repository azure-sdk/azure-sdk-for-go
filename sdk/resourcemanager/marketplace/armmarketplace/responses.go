...
// PrivateStoreCollectionOffersWithContextsPlansClientListResponse contains the response from method PrivateStoreCollectionOffersWithContextsPlansClient.NewListPager.
type PrivateStoreCollectionOffersWithContextsPlansClientListResponse struct {
	OfferListResponse
}
