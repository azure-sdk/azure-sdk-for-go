...
type NamespaceReplicaLocation struct {
	...
	// READ-ONLY; state of Namespace replica.
	ReplicaState *string
}
...
type Properties struct {
	...
	// the time in which message got appended inside broker log. CreateTime refers
	// to the time in which the message was generated on source side and producers can set this timestamp while sending the message.
	// Default value is AppendTime. If you are using AMQP protocol, CreateTime
	...
	// READ-ONLY; Denotes the unique identifier for event hub and is generated by service while creating topic. This identifier
	// can be used in kafka runtime apis wherever a UUID is required e.g Fetch & Delete Topic.
	// This identifier is not supported in AMQP runtime operations yet.
	Identifier *string
