...
type DataManagerForAgricultureSolutionProperties struct {
	...
	// READ-ONLY; Gets or sets scope of the Data Manager For Agriculture related parameters that need to be validated in solutionInference
	// trigger request. Example. [{ "resourceIdName" :"boundaryId", "resourceType" :
	// "Boundary" }].
...
type SolutionsClientCreateOrUpdateOptions struct {
	...
	RequestBody *SolutionInstallationRequest
}
