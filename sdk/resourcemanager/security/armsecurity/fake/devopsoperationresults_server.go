...
func (d *DevOpsOperationResultsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if devOpsOperationResultsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = devOpsOperationResultsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to DevOpsOperationResultsServerTransport
var devOpsOperationResultsServerTransportInterceptor interface {
