...
// ProtectedClustersQueryParameter - Query parameter to enumerate protected clusters.
type ProtectedClustersQueryParameter struct {
	// The replication provider type.
	InstanceType *string
...
type ReplicationProtectionCluster struct {
	...
	// READ-ONLY; The protection cluster Id.
	ID *string

	// READ-ONLY; The name of the protection cluster.
	Name *string
