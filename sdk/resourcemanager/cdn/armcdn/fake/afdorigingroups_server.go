...
func (a *AFDOriginGroupsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if afdOriginGroupsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = afdOriginGroupsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to AFDOriginGroupsServerTransport
var afdOriginGroupsServerTransportInterceptor interface {
