...
func (client *OperationResultsClient) getCreateRequest(ctx context.Context, locations string, operationResultsID string, _ *OperationResultsClientGetOptions) (*policy.Request, error) {
