...
// CredentialPropertiesClassification provides polymorphic access to related types.
// Call the interface's GetCredentialProperties() method to access the common type.
// Use a type switch to determine the concrete type.  The possible types are:
// - *CredentialProperties, *IntuneSingletonResourceProperties
type CredentialPropertiesClassification interface {
	// GetCredentialProperties returns the CredentialProperties content of the underlying type.
	GetCredentialProperties() *CredentialProperties
}

// GalleryAppSKUPropertiesClassification provides polymorphic access to related types.
// Call the interface's GetGalleryAppSKUProperties() method to access the common type.
// Use a type switch to determine the concrete type.  The possible types are:
// - *GalleryAppSKUProperties, *WingetAppSKUProperties
type GalleryAppSKUPropertiesClassification interface {
	// GetGalleryAppSKUProperties returns the GalleryAppSKUProperties content of the underlying type.
	GetGalleryAppSKUProperties() *GalleryAppSKUProperties
}
