...
- Function `*ClientFactory.NewDefenderForStorageClient` has been removed
...
- Function `NewDefenderForStorageClient` has been removed
- Function `*DefenderForStorageClient.Create` has been removed
- Function `*DefenderForStorageClient.Get` has been removed
...
- Struct `DefenderForStorageSetting` has been removed
- Struct `DefenderForStorageSettingProperties` has been removed
...
- Struct `MalwareScanningProperties` has been removed
...
- Struct `OnUploadProperties` has been removed
...
- Struct `SensitiveDataDiscoveryProperties` has been removed
