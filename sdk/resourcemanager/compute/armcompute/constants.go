...
type ExpandAutoGenerated string

const (
	ExpandAutoGeneratedProperties ExpandAutoGenerated = "Properties"
)

// PossibleExpandAutoGeneratedValues returns the possible values for the ExpandAutoGenerated const type.
func PossibleExpandAutoGeneratedValues() []ExpandAutoGenerated {
	return []ExpandAutoGenerated{
		ExpandAutoGeneratedProperties,
	}
}
