...
func (client *WorkflowTriggersClient) runCreateRequest(ctx context.Context, resourceGroupName string, workflowName string, triggerName string, _ *WorkflowTriggersClientRunOptions) (*policy.Request, error) {
...
func (client *WorkflowTriggersClient) setStateCreateRequest(ctx context.Context, resourceGroupName string, workflowName string, triggerName string, setState SetTriggerStateActionDefinition, _ *WorkflowTriggersClientSetStateOptions) (*policy.Request, error) {
