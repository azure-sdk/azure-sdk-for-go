...
func (client *PrivateEndpointConnectionProxyControllerClient) createCreateRequest(ctx context.Context, resourceGroupName string, migrateProjectName string, pecProxyName string, body PrivateEndpointConnectionProxy, _ *PrivateEndpointConnectionProxyControllerClientCreateOptions) (*policy.Request, error) {
...
func (client *PrivateEndpointConnectionProxyControllerClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, migrateProjectName string, pecProxyName string, _ *PrivateEndpointConnectionProxyControllerClientDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Migrate/migrateProjects/{migrateProjectName}/privateEndpointConnectionProxies/{pecProxyName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *PrivateEndpointConnectionProxyControllerClient) getCreateRequest(ctx context.Context, resourceGroupName string, migrateProjectName string, pecProxyName string, _ *PrivateEndpointConnectionProxyControllerClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Migrate/migrateProjects/{migrateProjectName}/privateEndpointConnectionProxies/{pecProxyName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *PrivateEndpointConnectionProxyControllerClient) listPrivateEndpointConnectionProxiesCreateRequest(ctx context.Context, resourceGroupName string, migrateProjectName string, _ *PrivateEndpointConnectionProxyControllerClientListPrivateEndpointConnectionProxiesOptions) (*policy.Request, error) {
...
func (client *PrivateEndpointConnectionProxyControllerClient) validateCreateRequest(ctx context.Context, resourceGroupName string, migrateProjectName string, pecProxyName string, body PrivateEndpointConnectionProxy, _ *PrivateEndpointConnectionProxyControllerClientValidateOptions) (*policy.Request, error) {
