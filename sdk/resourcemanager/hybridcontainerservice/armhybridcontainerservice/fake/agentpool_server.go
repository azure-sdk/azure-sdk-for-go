...
func (a *AgentPoolServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if agentPoolServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = agentPoolServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "AgentPoolClient.NewListByProvisionedClusterPager":
				res.resp, res.err = a.dispatchNewListByProvisionedClusterPager(req)
			default:
...
// set this to conditionally intercept incoming requests to AgentPoolServerTransport
var agentPoolServerTransportInterceptor interface {
