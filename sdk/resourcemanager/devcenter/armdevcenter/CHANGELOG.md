...
- New field `DevBoxDefinition`, `DevBoxDefinitionType` in struct `PoolProperties`
- New field `DevBoxDefinition`, `DevBoxDefinitionType` in struct `PoolUpdateProperties`
- New field `DevBoxProvisioningSettings`, `NetworkSettings`, `PlanID` in struct `Properties`
- New field `DevBoxProvisioningSettings`, `NetworkSettings`, `PlanID` in struct `UpdateProperties`
