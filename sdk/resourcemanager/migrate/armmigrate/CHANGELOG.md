...
- New enum type `CosmosDBImportMachinesJobEntityImportMachinesJobPropertiesJobResultValues` with values `CosmosDBImportMachinesJobEntityImportMachinesJobPropertiesJobResultValuesCompleted`, `CosmosDBImportMachinesJobEntityImportMachinesJobPropertiesJobResultValuesCompletedWithErrors`, `CosmosDBImportMachinesJobEntityImportMachinesJobPropertiesJobResultValuesCompletedWithWarnings`, `CosmosDBImportMachinesJobEntityImportMachinesJobPropertiesJobResultValuesFailed`, `CosmosDBImportMachinesJobEntityImportMachinesJobPropertiesJobResultValuesInProgress`, `CosmosDBImportMachinesJobEntityImportMachinesJobPropertiesJobResultValuesUnknown`, `CosmosDBImportMachinesJobEntityImportMachinesJobPropertiesJobResultValuesWaitingForBlobUpload`
...
- New function `*HypervHostControllerClient.Delete(context.Context, string, string, string, *HypervHostControllerClientDeleteOptions) (HypervHostControllerClientDeleteResponse, error)`
...
- New function `*PrivateEndpointConnectionControllerClient.BeginDelete(context.Context, string, string, string, *PrivateEndpointConnectionControllerClientBeginDeleteOptions) (*runtime.Poller[PrivateEndpointConnectionControllerClientDeleteResponse], error)`
...
- New function `*SQLDiscoverySiteDataSourceControllerClient.BeginDelete(context.Context, string, string, string, string, *SQLDiscoverySiteDataSourceControllerClientBeginDeleteOptions) (*runtime.Poller[SQLDiscoverySiteDataSourceControllerClientDeleteResponse], error)`
...
- New function `*SQLSitesControllerClient.ErrorDetailedSummary(context.Context, string, string, string, ErrorSummaryRequest, *SQLSitesControllerClientErrorDetailedSummaryOptions) (SQLSitesControllerClientErrorDetailedSummaryResponse, error)`
...
- New function `*VcenterControllerClient.BeginDelete(context.Context, string, string, string, *VcenterControllerClientBeginDeleteOptions) (*runtime.Poller[VcenterControllerClientDeleteResponse], error)`
...
- New function `*WebAppSitesControllerClient.Delete(context.Context, string, string, string, *WebAppSitesControllerClientDeleteOptions) (WebAppSitesControllerClientDeleteResponse, error)`
...
- New struct `ErrorDetailedSummary`
...
- New struct `ExportImportedMachinesJobCollection`
...
- New struct `ImportMachinesJobImportMachinesJobCollection`
...
- New struct `SQLSite`
- New struct `SQLSiteErrorDetails`
...
- New struct `V20190501PreviewSasURIResponse`
- New struct `Vcenter`
