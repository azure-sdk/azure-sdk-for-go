...
// NewGetPager - Get the resource sku, resource type, and sku capacity of the NGroups resource.
//
...
func (client *NGroupsSKUsClient) NewGetPager(resourceGroupName string, ngroupsName string, options *NGroupsSKUsClientGetOptions) *runtime.Pager[NGroupsSKUsClientGetResponse] {
	return runtime.NewPager(runtime.PagingHandler[NGroupsSKUsClientGetResponse]{
		...
		Fetcher: func(ctx context.Context, page *NGroupsSKUsClientGetResponse) (NGroupsSKUsClientGetResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "NGroupsSKUsClient.NewGetPager")
			nextLink := ""
			if page != nil {
...
func (client *NGroupsSKUsClient) getCreateRequest(ctx context.Context, resourceGroupName string, ngroupsName string, options *NGroupsSKUsClientGetOptions) (*policy.Request, error) {
