...
- New function `*ManagementClient.BeginGetSessionRecordingSasURL(context.Context, string, string, *ManagementClientBeginGetSessionRecordingSasURLOptions) (*runtime.Poller[ManagementClientGetSessionRecordingSasURLResponse], error)`
- New function `*ManagementClient.BeginSetSessionRecordingSasURL(context.Context, string, string, string, *ManagementClientBeginSetSessionRecordingSasURLOptions) (*runtime.Poller[ManagementClientSetSessionRecordingSasURLResponse], error)`
...
- New struct `SetSessionRecordingSasURLResponse`
...
- New field `EnablePrivateOnlyBastion`, `EnableSessionRecording` in struct `BastionHostPropertiesFormat`
