...
func (f *FunctionsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if functionsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = functionsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			case "FunctionsClient.CreateOrReplace":
				res.resp, res.err = f.dispatchCreateOrReplace(req)
			...
			case "FunctionsClient.NewListByStreamingJobPager":
				res.resp, res.err = f.dispatchNewListByStreamingJobPager(req)
			case "FunctionsClient.RetrieveDefaultDefinition":
				res.resp, res.err = f.dispatchRetrieveDefaultDefinition(req)
			case "FunctionsClient.BeginTest":
				res.resp, res.err = f.dispatchBeginTest(req)
...
// set this to conditionally intercept incoming requests to FunctionsServerTransport
var functionsServerTransportInterceptor interface {
