...
// IacProfilesClientQuickTemplateOptions contains the optional parameters for the IacProfilesClient.QuickTemplate method.
type IacProfilesClientQuickTemplateOptions struct {
	// placeholder for future optional parameters
}
