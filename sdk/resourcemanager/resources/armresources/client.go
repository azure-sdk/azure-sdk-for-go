...
// CheckExistenceByID - Checks by ID whether a resource exists. This API currently works only for a limited set of Resource
...
func (client *Client) BeginCreateOrUpdate(ctx context.Context, resourceGroupName string, resourceProviderNamespace string, parentResourcePath string, resourceType string, resourceName string, apiVersion string, parameters GenericResource, options *ClientBeginCreateOrUpdateOptions) (*runtime.Poller[ClientCreateOrUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		poller, err := runtime.NewPoller[ClientCreateOrUpdateResponse](resp, client.internal.Pipeline(), nil)
		return poller, err
	} else {
...
func (client *Client) BeginCreateOrUpdateByID(ctx context.Context, resourceID string, apiVersion string, parameters GenericResource, options *ClientBeginCreateOrUpdateByIDOptions) (*runtime.Poller[ClientCreateOrUpdateByIDResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		poller, err := runtime.NewPoller[ClientCreateOrUpdateByIDResponse](resp, client.internal.Pipeline(), nil)
		return poller, err
	} else {
...
func (client *Client) BeginDelete(ctx context.Context, resourceGroupName string, resourceProviderNamespace string, parentResourcePath string, resourceType string, resourceName string, apiVersion string, options *ClientBeginDeleteOptions) (*runtime.Poller[ClientDeleteResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		poller, err := runtime.NewPoller[ClientDeleteResponse](resp, client.internal.Pipeline(), nil)
		return poller, err
	} else {
...
func (client *Client) BeginDeleteByID(ctx context.Context, resourceID string, apiVersion string, options *ClientBeginDeleteByIDOptions) (*runtime.Poller[ClientDeleteByIDResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		poller, err := runtime.NewPoller[ClientDeleteByIDResponse](resp, client.internal.Pipeline(), nil)
		return poller, err
	} else {
...
// NewListByParentPager - Lists child resources of a given parent resource.
//
// Generated from API version 2022-09-01
//   - resourceGroupName - The name of the resource group containing the resource to get. The name is case insensitive.
//   - resourceProviderNamespace - The namespace of the resource provider.
...
func (client *Client) NewListByParentPager(resourceGroupName string, resourceProviderNamespace string, parentResourcePath string, resourceType string, apiVersion string, options *ClientListByParentOptions) *runtime.Pager[ClientListByParentResponse] {
	return runtime.NewPager(runtime.PagingHandler[ClientListByParentResponse]{
		...
		Fetcher: func(ctx context.Context, page *ClientListByParentResponse) (ClientListByParentResponse, error) {
			...
			var err error
			if page == nil {
				req, err = client.listByParentCreateRequest(ctx, resourceGroupName, resourceProviderNamespace, parentResourcePath, resourceType, apiVersion, options)
			} else {
				req, err = runtime.NewRequest(ctx, http.MethodGet, *page.NextLink)
			}
			if err != nil {
			...
			if !runtime.HasStatusCode(resp, http.StatusOK) {
				return ClientListByParentResponse{}, runtime.NewResponseError(resp)
			}
...
func (client *Client) listByParentCreateRequest(ctx context.Context, resourceGroupName string, resourceProviderNamespace string, parentResourcePath string, resourceType string, apiVersion string, options *ClientListByParentOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/{resourceProviderNamespace}/{parentResourcePath}/{resourceType}"
	if resourceGroupName == "" {
		return nil, errors.New("parameter resourceGroupName cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{resourceGroupName}", url.PathEscape(resourceGroupName))
...
func (client *Client) BeginMoveResources(ctx context.Context, sourceResourceGroupName string, parameters MoveInfo, options *ClientBeginMoveResourcesOptions) (*runtime.Poller[ClientMoveResourcesResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		poller, err := runtime.NewPoller[ClientMoveResourcesResponse](resp, client.internal.Pipeline(), nil)
		return poller, err
	} else {
...
func (client *Client) BeginUpdate(ctx context.Context, resourceGroupName string, resourceProviderNamespace string, parentResourcePath string, resourceType string, resourceName string, apiVersion string, parameters GenericResource, options *ClientBeginUpdateOptions) (*runtime.Poller[ClientUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		poller, err := runtime.NewPoller[ClientUpdateResponse](resp, client.internal.Pipeline(), nil)
		return poller, err
	} else {
...
func (client *Client) BeginUpdateByID(ctx context.Context, resourceID string, apiVersion string, parameters GenericResource, options *ClientBeginUpdateByIDOptions) (*runtime.Poller[ClientUpdateByIDResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		poller, err := runtime.NewPoller[ClientUpdateByIDResponse](resp, client.internal.Pipeline(), nil)
		return poller, err
	} else {
...
func (client *Client) BeginValidateMoveResources(ctx context.Context, sourceResourceGroupName string, parameters MoveInfo, options *ClientBeginValidateMoveResourcesOptions) (*runtime.Poller[ClientValidateMoveResourcesResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		poller, err := runtime.NewPoller[ClientValidateMoveResourcesResponse](resp, client.internal.Pipeline(), nil)
		return poller, err
	} else {
