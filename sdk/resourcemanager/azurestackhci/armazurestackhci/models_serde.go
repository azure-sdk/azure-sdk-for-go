...
// MarshalJSON implements the json.Marshaller interface for type StorageAdapterIPInfo.
func (s StorageAdapterIPInfo) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "ipv4Address", s.IPv4Address)
	populate(objectMap, "physicalNode", s.PhysicalNode)
	populate(objectMap, "subnetMask", s.SubnetMask)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type StorageAdapterIPInfo.
func (s *StorageAdapterIPInfo) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
	for key, val := range rawMsg {
		...
		case "ipv4Address":
			...
			delete(rawMsg, key)
		case "physicalNode":
			err = unpopulate(val, "PhysicalNode", &s.PhysicalNode)
			delete(rawMsg, key)
		case "subnetMask":
			err = unpopulate(val, "SubnetMask", &s.SubnetMask)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", s, err)
...
func (s StorageNetworks) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "storageAdapterIPInfo", s.StorageAdapterIPInfo)
...
func (s *StorageNetworks) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "storageAdapterIPInfo":
			err = unpopulate(val, "StorageAdapterIPInfo", &s.StorageAdapterIPInfo)
			delete(rawMsg, key)
		case "vlanId":
