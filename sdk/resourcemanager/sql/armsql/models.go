...
// CreateOrUpdateProperties - Properties for creating and updating distributed availability group
...
// DatabaseVulnerabilityAssessmentRuleBaselineAutoGenerated - A database vulnerability assessment rule baseline.
type DatabaseVulnerabilityAssessmentRuleBaselineAutoGenerated struct {
	// Resource properties.
	Properties *DatabaseVulnerabilityAssessmentRuleBaselinePropertiesAutoGenerated
...
// DatabaseVulnerabilityAssessmentRuleBaselinePropertiesAutoGenerated - Properties of a database Vulnerability Assessment
// rule baseline.
type DatabaseVulnerabilityAssessmentRuleBaselinePropertiesAutoGenerated struct {
	// REQUIRED; The rule baseline result
	BaselineResults []*DatabaseVulnerabilityAssessmentRuleBaselineItem
}
...
type DistributedAvailabilityGroupDatabase struct {
	...
	// READ-ONLY; The name of the database in link
	DatabaseName *string
...
type DistributedAvailabilityGroupProperties struct {
	...
	// READ-ONLY; Databases in the distributed availability group
	...
	// READ-ONLY; Managed instance side availability group name
	InstanceAvailabilityGroupName *string

	// READ-ONLY; Managed instance side link role
	InstanceLinkRole *LinkRole

	// READ-ONLY; SQL server side availability group name
	PartnerAvailabilityGroupName *string

	// READ-ONLY; SQL server side endpoint - IP or DNS resolvable name
...
// DistributedAvailabilityGroupsCreateOrUpdateRequestBody - Information for creating and updating distributed availability
// group
type DistributedAvailabilityGroupsCreateOrUpdateRequestBody struct {
	// Resource properties.
...
type ExportDatabaseDefinition struct {
	...
	// Optional resource information to enable network isolation for request.
	NetworkIsolation *NetworkIsolationSettingsAutoGenerated
}
...
type ImportNewDatabaseDefinition struct {
	...
	// Optional resource information to enable network isolation for request.
	NetworkIsolation *NetworkIsolationSettingsAutoGenerated2
...
type ManagedInstanceProperties struct {
	...
	// Storage IOps. Minimum value: 120. Maximum value: 120000. Increments of 1 IOps allowed only. Maximum value depends on the
	...
	// Storage throughput in MBps. Minimum value: 25. Maximum value: 4000. Increments of 1 MBps allowed only. Maximum value depends
...
// NetworkIsolationSettingsAutoGenerated2 - Contains the ARM resources for which to create private endpoint connection.
type NetworkIsolationSettingsAutoGenerated2 struct {
	// The resource id for the SQL server which is the target of this request. If set, private endpoint connection will be created
	// for the SQL server. Must match server which is target of the operation.
	SQLServerResourceID *string
