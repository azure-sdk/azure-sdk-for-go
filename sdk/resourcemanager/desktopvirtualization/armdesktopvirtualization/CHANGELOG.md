...
- Field `ApplicationGroup` of struct `ApplicationGroupsClientUpdateResponse` has been removed
...
- Field `Desktop` of struct `DesktopsClientUpdateResponse` has been removed
- Field `HostPool` of struct `HostPoolsClientUpdateOptions` has been removed
- Field `HostPool` of struct `HostPoolsClientUpdateResponse` has been removed
...
- Field `ScalingPlanPersonalSchedule` of struct `ScalingPlanPersonalSchedulesClientUpdateResponse` has been removed
...
- Field `ScalingPlan` of struct `ScalingPlansClientUpdateResponse` has been removed
...
- New anonymous field `ApplicationGroupPatch` in struct `ApplicationGroupsClientUpdateResponse`
- New anonymous field `ApplicationPatch` in struct `ApplicationsClientUpdateResponse`
- New anonymous field `DesktopPatch` in struct `DesktopsClientUpdateResponse`
...
- New anonymous field `HostPoolPatch` in struct `HostPoolsClientUpdateResponse`
- New anonymous field `ResourceProviderOperationListResult` in struct `OperationsClientListResponse`
- New anonymous field `ScalingPlanPersonalSchedulePatch` in struct `ScalingPlanPersonalSchedulesClientUpdateResponse`
- New field `Name` in struct `ScalingPlanPooledScheduleProperties`
- New anonymous field `ScalingPlanPooledSchedulePatch` in struct `ScalingPlanPooledSchedulesClientUpdateResponse`
- New anonymous field `ScalingPlanPatch` in struct `ScalingPlansClientUpdateResponse`
...
- New anonymous field `SendMessage` in struct `UserSessionsClientSendMessageResponse`
