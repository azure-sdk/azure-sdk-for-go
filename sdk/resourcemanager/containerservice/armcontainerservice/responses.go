...
// LoadBalancersClientRebalanceResponse contains the response from method LoadBalancersClient.BeginRebalance.
type LoadBalancersClientRebalanceResponse struct {
	// placeholder for future response values
}
