...
// AssessedSQLInstanceV2OperationsServer is a fake server for instances of the armmigrate.AssessedSQLInstanceV2OperationsClient type.
type AssessedSQLInstanceV2OperationsServer struct {
	...
	Get func(ctx context.Context, resourceGroupName string, projectName string, groupName string, assessmentName string, assessedSQLInstanceName string, options *armmigrate.AssessedSQLInstanceV2OperationsClientGetOptions) (resp azfake.Responder[armmigrate.AssessedSQLInstanceV2OperationsClientGetResponse], errResp azfake.ErrorResponder)

	// NewListBySQLAssessmentV2Pager is the fake for method AssessedSQLInstanceV2OperationsClient.NewListBySQLAssessmentV2Pager
	// HTTP status codes to indicate success: http.StatusOK
	NewListBySQLAssessmentV2Pager func(resourceGroupName string, projectName string, groupName string, assessmentName string, options *armmigrate.AssessedSQLInstanceV2OperationsClientListBySQLAssessmentV2Options) (resp azfake.PagerResponder[armmigrate.AssessedSQLInstanceV2OperationsClientListBySQLAssessmentV2Response])
}
...
// The returned AssessedSQLInstanceV2OperationsServerTransport instance is connected to an instance of armmigrate.AssessedSQLInstanceV2OperationsClient via the
...
func NewAssessedSQLInstanceV2OperationsServerTransport(srv *AssessedSQLInstanceV2OperationsServer) *AssessedSQLInstanceV2OperationsServerTransport {
	return &AssessedSQLInstanceV2OperationsServerTransport{
		srv:                           srv,
		newListBySQLAssessmentV2Pager: newTracker[azfake.PagerResponder[armmigrate.AssessedSQLInstanceV2OperationsClientListBySQLAssessmentV2Response]](),
	}
}

// AssessedSQLInstanceV2OperationsServerTransport connects instances of armmigrate.AssessedSQLInstanceV2OperationsClient to instances of AssessedSQLInstanceV2OperationsServer.
...
type AssessedSQLInstanceV2OperationsServerTransport struct {
	...
	newListBySQLAssessmentV2Pager *tracker[azfake.PagerResponder[armmigrate.AssessedSQLInstanceV2OperationsClientListBySQLAssessmentV2Response]]
}
...
func (a *AssessedSQLInstanceV2OperationsServerTransport) dispatchNewListBySQLAssessmentV2Pager(req *http.Request) (*http.Response, error) {
	...
	if newListBySQLAssessmentV2Pager == nil {
		...
		var options *armmigrate.AssessedSQLInstanceV2OperationsClientListBySQLAssessmentV2Options
		if filterParam != nil || pageSizeParam != nil || continuationTokenParam != nil || totalRecordCountParam != nil {
			options = &armmigrate.AssessedSQLInstanceV2OperationsClientListBySQLAssessmentV2Options{
				Filter:            filterParam,
		...
		server.PagerResponderInjectNextLinks(newListBySQLAssessmentV2Pager, req, func(page *armmigrate.AssessedSQLInstanceV2OperationsClientListBySQLAssessmentV2Response, createLink func() string) {
