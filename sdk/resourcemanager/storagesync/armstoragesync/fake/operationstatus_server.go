...
// The returned OperationStatusServerTransport instance is connected to an instance of armstoragesync.OperationStatusClient via the
...
// OperationStatusServerTransport connects instances of armstoragesync.OperationStatusClient to instances of OperationStatusServer.
...
func (o *OperationStatusServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.StorageSync/locations/(?P<locationName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/workflows/(?P<workflowId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/operations/(?P<operationId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)`
	...
	respr, errRespr := o.srv.Get(req.Context(), resourceGroupNameParam, locationNameParam, workflowIDParam, operationIDParam, nil)
