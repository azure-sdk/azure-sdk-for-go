...
//     method.
func (client *ScriptPackagesClient) NewListByPrivateCloudPager(resourceGroupName string, privateCloudName string, options *ScriptPackagesClientListByPrivateCloudOptions) *runtime.Pager[ScriptPackagesClientListByPrivateCloudResponse] {
...
func (client *ScriptPackagesClient) listByPrivateCloudCreateRequest(ctx context.Context, resourceGroupName string, privateCloudName string, _ *ScriptPackagesClientListByPrivateCloudOptions) (*policy.Request, error) {
