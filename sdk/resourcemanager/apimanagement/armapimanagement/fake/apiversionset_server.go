...
// NewAPIVersionSetServerTransport creates a new instance of APIVersionSetServerTransport with the provided implementation.
// The returned APIVersionSetServerTransport instance is connected to an instance of armapimanagement.APIVersionSetClient via the
// azcore.ClientOptions.Transporter field in the client's constructor parameters.
func NewAPIVersionSetServerTransport(srv *APIVersionSetServer) *APIVersionSetServerTransport {
	return &APIVersionSetServerTransport{
		srv:                   srv,
		newListByServicePager: newTracker[azfake.PagerResponder[armapimanagement.APIVersionSetClientListByServiceResponse]](),
	}
}

// APIVersionSetServerTransport connects instances of armapimanagement.APIVersionSetClient to instances of APIVersionSetServer.
// Don't use this type directly, use NewAPIVersionSetServerTransport instead.
type APIVersionSetServerTransport struct {
	srv                   *APIVersionSetServer
	newListByServicePager *tracker[azfake.PagerResponder[armapimanagement.APIVersionSetClientListByServiceResponse]]
}

// Do implements the policy.Transporter interface for APIVersionSetServerTransport.
func (a *APIVersionSetServerTransport) Do(req *http.Request) (*http.Response, error) {
	...
	switch method {
	case "APIVersionSetClient.CreateOrUpdate":
		resp, err = a.dispatchCreateOrUpdate(req)
	case "APIVersionSetClient.Delete":
		resp, err = a.dispatchDelete(req)
	case "APIVersionSetClient.Get":
		resp, err = a.dispatchGet(req)
	case "APIVersionSetClient.GetEntityTag":
		resp, err = a.dispatchGetEntityTag(req)
	case "APIVersionSetClient.NewListByServicePager":
		resp, err = a.dispatchNewListByServicePager(req)
	case "APIVersionSetClient.Update":
...
func (a *APIVersionSetServerTransport) dispatchCreateOrUpdate(req *http.Request) (*http.Response, error) {
	if a.srv.CreateOrUpdate == nil {
		return nil, &nonRetriableError{errors.New("fake for method CreateOrUpdate not implemented")}
	}
	const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.ApiManagement/service/(?P<serviceName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/apiVersionSets/(?P<versionSetId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)`
	...
	var options *armapimanagement.APIVersionSetClientCreateOrUpdateOptions
	if ifMatchParam != nil {
		options = &armapimanagement.APIVersionSetClientCreateOrUpdateOptions{
			IfMatch: ifMatchParam,
		}
	}
	respr, errRespr := a.srv.CreateOrUpdate(req.Context(), resourceGroupNameParam, serviceNameParam, versionSetIDParam, body, options)
...
func (a *APIVersionSetServerTransport) dispatchDelete(req *http.Request) (*http.Response, error) {
	if a.srv.Delete == nil {
	...
	respr, errRespr := a.srv.Delete(req.Context(), resourceGroupNameParam, serviceNameParam, versionSetIDParam, getHeaderValue(req.Header, "If-Match"), nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (a *APIVersionSetServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	if a.srv.Get == nil {
	...
	respr, errRespr := a.srv.Get(req.Context(), resourceGroupNameParam, serviceNameParam, versionSetIDParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (a *APIVersionSetServerTransport) dispatchGetEntityTag(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := a.srv.GetEntityTag(req.Context(), resourceGroupNameParam, serviceNameParam, versionSetIDParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (a *APIVersionSetServerTransport) dispatchNewListByServicePager(req *http.Request) (*http.Response, error) {
	...
	if newListByServicePager == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.ApiManagement/service/(?P<serviceName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/apiVersionSets`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		...
		var options *armapimanagement.APIVersionSetClientListByServiceOptions
		if filterParam != nil || topParam != nil || skipParam != nil {
			options = &armapimanagement.APIVersionSetClientListByServiceOptions{
				Filter: filterParam,
				Top:    topParam,
				Skip:   skipParam,
			}
		...
		server.PagerResponderInjectNextLinks(newListByServicePager, req, func(page *armapimanagement.APIVersionSetClientListByServiceResponse, createLink func() string) {
...
func (a *APIVersionSetServerTransport) dispatchUpdate(req *http.Request) (*http.Response, error) {
	if a.srv.Update == nil {
	...
	respr, errRespr := a.srv.Update(req.Context(), resourceGroupNameParam, serviceNameParam, versionSetIDParam, getHeaderValue(req.Header, "If-Match"), body, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
