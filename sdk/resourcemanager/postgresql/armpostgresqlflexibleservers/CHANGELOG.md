...
- New field `GeoBackupDelegatedIdentityClientID`, `PrimaryDelegatedIdentityClientID` in struct `DataEncryption`
...
- New field `DelegatedResources` in struct `UserAssignedIdentity`
