...
func ExampleSAPApplicationServerInstancesClient_BeginStart_startTheSapApplicationServerInstance() {
	...
	poller, err := clientFactory.NewSAPApplicationServerInstancesClient().BeginStart(ctx, "test-rg", "X00", "app01", armworkloadssapvirtualinstance.StartRequest{}, nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	res, err := poller.PollUntilDone(ctx, nil)
...
func ExampleSAPApplicationServerInstancesClient_BeginStart_startVirtualMachineAndTheSapApplicationServerInstanceOnIt() {
	...
	poller, err := clientFactory.NewSAPApplicationServerInstancesClient().BeginStart(ctx, "test-rg", "X00", "app01", armworkloadssapvirtualinstance.StartRequest{
		StartVM: to.Ptr(true),
	}, nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
...
func ExampleSAPApplicationServerInstancesClient_BeginStop_stopTheSapApplicationServerInstance() {
	...
	poller, err := clientFactory.NewSAPApplicationServerInstancesClient().BeginStop(ctx, "test-rg", "X00", "app01", armworkloadssapvirtualinstance.StopRequest{
