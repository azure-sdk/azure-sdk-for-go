...
func (m *ModuleServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if moduleServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = moduleServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "ModuleClient.NewListByAutomationAccountPager":
				res.resp, res.err = m.dispatchNewListByAutomationAccountPager(req)
...
// set this to conditionally intercept incoming requests to ModuleServerTransport
var moduleServerTransportInterceptor interface {
