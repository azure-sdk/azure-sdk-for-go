...
The `armsourcecontrolconfigurations` module provides operations for working with Azure Kubernetesconfiguration.

[Source code](https://github.com/Azure/azure-sdk-for-go/tree/main/sdk/resourcemanager/kubernetesconfiguration/armsourcecontrolconfigurations)
...
```sh
go get github.com/Azure/azure-sdk-for-go/sdk/resourcemanager/kubernetesconfiguration/armsourcecontrolconfigurations
```
...
```go
clientFactory, err := armsourcecontrolconfigurations.NewClientFactory(<subscription ID>, cred, nil)
```
...
clientFactory, err := armsourcecontrolconfigurations.NewClientFactory(<subscription ID>, cred, &options)
```
