...
func (client *CertificatesClient) retrieveProofOfPossessionNonceCreateRequest(ctx context.Context, resourceGroupName string, catalogName string, serialNumber string, body ProofOfPossessionNonceRequest, _ *CertificatesClientRetrieveProofOfPossessionNonceOptions) (*policy.Request, error) {
