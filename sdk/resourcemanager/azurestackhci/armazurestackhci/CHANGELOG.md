...
- New field `Properties` in struct `EdgeDevice`
- New anonymous field `EdgeDevice` in struct `EdgeDevicesClientCreateOrUpdateResponse`
- New anonymous field `EdgeDevice` in struct `EdgeDevicesClientGetResponse`
