...
type AssociationsInterfaceServer struct {
	...
	// NewListByResourceGroupPager is the fake for method AssociationsInterfaceClient.NewListByResourceGroupPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByResourceGroupPager func(resourceGroupName string, trafficControllerName string, options *armservicenetworking.AssociationsInterfaceClientListByResourceGroupOptions) (resp azfake.PagerResponder[armservicenetworking.AssociationsInterfaceClientListByResourceGroupResponse])

	// Update is the fake for method AssociationsInterfaceClient.Update
	// HTTP status codes to indicate success: http.StatusOK
	Update func(ctx context.Context, resourceGroupName string, trafficControllerName string, associationName string, properties armservicenetworking.Association, options *armservicenetworking.AssociationsInterfaceClientUpdateOptions) (resp azfake.Responder[armservicenetworking.AssociationsInterfaceClientUpdateResponse], errResp azfake.ErrorResponder)
}
...
func NewAssociationsInterfaceServerTransport(srv *AssociationsInterfaceServer) *AssociationsInterfaceServerTransport {
	return &AssociationsInterfaceServerTransport{
		...
		newListByResourceGroupPager: newTracker[azfake.PagerResponder[armservicenetworking.AssociationsInterfaceClientListByResourceGroupResponse]](),
	}
}
...
type AssociationsInterfaceServerTransport struct {
	...
	newListByResourceGroupPager *tracker[azfake.PagerResponder[armservicenetworking.AssociationsInterfaceClientListByResourceGroupResponse]]
}
...
func (a *AssociationsInterfaceServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	case "AssociationsInterfaceClient.NewListByResourceGroupPager":
...
func (a *AssociationsInterfaceServerTransport) dispatchNewListByResourceGroupPager(req *http.Request) (*http.Response, error) {
	...
	if newListByResourceGroupPager == nil {
		...
		resp := a.srv.NewListByResourceGroupPager(resourceGroupNameParam, trafficControllerNameParam, nil)
		newListByResourceGroupPager = &resp
		a.newListByResourceGroupPager.add(req, newListByResourceGroupPager)
		server.PagerResponderInjectNextLinks(newListByResourceGroupPager, req, func(page *armservicenetworking.AssociationsInterfaceClientListByResourceGroupResponse, createLink func() string) {
