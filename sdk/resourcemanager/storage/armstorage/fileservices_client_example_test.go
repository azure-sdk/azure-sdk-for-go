...
func ExampleFileServicesClient_NewListServiceUsagesPager() {
	...
	pager := clientFactory.NewFileServicesClient().NewListServiceUsagesPager("res4410", "sto8607", nil)
	for pager.More() {
		...
		// page = armstorage.FileServicesClientListServiceUsagesResponse{
		// 	FileServiceUsages: armstorage.FileServiceUsages{
