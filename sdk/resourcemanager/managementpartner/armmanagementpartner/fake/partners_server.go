...
func (p *PartnersServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if partnersServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = partnersServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to PartnersServerTransport
var partnersServerTransportInterceptor interface {
