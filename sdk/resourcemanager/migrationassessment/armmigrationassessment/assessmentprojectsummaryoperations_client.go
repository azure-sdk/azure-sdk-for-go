...
func (client *AssessmentProjectSummaryOperationsClient) getCreateRequest(ctx context.Context, resourceGroupName string, projectName string, projectSummaryName string, options *AssessmentProjectSummaryOperationsClientGetOptions) (*policy.Request, error) {
...
func (client *AssessmentProjectSummaryOperationsClient) listByAssessmentProjectCreateRequest(ctx context.Context, resourceGroupName string, projectName string, options *AssessmentProjectSummaryOperationsClientListByAssessmentProjectOptions) (*policy.Request, error) {
