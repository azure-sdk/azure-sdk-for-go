...
func ExampleWorkloadNetworkDNSZonesClient_BeginCreate() {
	...
	poller, err := clientFactory.NewWorkloadNetworkDNSZonesClient().BeginCreate(ctx, "group1", "cloud1", "dnsZone1", nil)
	if err != nil {
	...
	// res = armavs.WorkloadNetworkDNSZonesClientCreateResponse{
...
func ExampleWorkloadNetworkDNSZonesClient_BeginDelete() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	poller, err := clientFactory.NewWorkloadNetworkDNSZonesClient().BeginDelete(ctx, "group1", "dnsZone1", "cloud1", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	res, err := poller.PollUntilDone(ctx, nil)
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armavs.WorkloadNetworkDNSZonesClientDeleteResponse{
	// }
}

// Generated from example definition: 2024-09-01/WorkloadNetworks_GetDnsZone.json
func ExampleWorkloadNetworkDNSZonesClient_Get() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	res, err := clientFactory.NewWorkloadNetworkDNSZonesClient().Get(ctx, "group1", "cloud1", "dnsZone1", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armavs.WorkloadNetworkDNSZonesClientGetResponse{
	// 	WorkloadNetworkDNSZone: &armavs.WorkloadNetworkDNSZone{
	// 		ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/group1/providers/Microsoft.AVS/privateClouds/cloud1/workloadNetworks/default/dnsZones/dnsZone1"),
...
func ExampleWorkloadNetworkDNSZonesClient_NewListPager() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	pager := clientFactory.NewWorkloadNetworkDNSZonesClient().NewListPager("group1", "cloud1", nil)
	for pager.More() {
		...
		// page = armavs.WorkloadNetworkDNSZonesClientListResponse{
...
func ExampleWorkloadNetworkDNSZonesClient_BeginUpdate() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	poller, err := clientFactory.NewWorkloadNetworkDNSZonesClient().BeginUpdate(ctx, "group1", "cloud1", "dnsZone1", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	res, err := poller.PollUntilDone(ctx, nil)
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armavs.WorkloadNetworkDNSZonesClientUpdateResponse{
	// 	WorkloadNetworkDNSZone: &armavs.WorkloadNetworkDNSZone{
	// 		ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/group1/providers/Microsoft.AVS/privateClouds/cloud1/workloadNetworks/default/dnsZones/dnsZone1"),
	// 		Name: to.Ptr("dnsZone1"),
	// 		Properties: &armavs.WorkloadNetworkDNSZoneProperties{
