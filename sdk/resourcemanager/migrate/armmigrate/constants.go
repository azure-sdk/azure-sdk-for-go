...
type LinuxAzureHybridUseBenefit string

const (
	LinuxAzureHybridUseBenefitNo      LinuxAzureHybridUseBenefit = "No"
	LinuxAzureHybridUseBenefitUnknown LinuxAzureHybridUseBenefit = "Unknown"
	LinuxAzureHybridUseBenefitYes     LinuxAzureHybridUseBenefit = "Yes"
)

// PossibleLinuxAzureHybridUseBenefitValues returns the possible values for the LinuxAzureHybridUseBenefit const type.
func PossibleLinuxAzureHybridUseBenefitValues() []LinuxAzureHybridUseBenefit {
	return []LinuxAzureHybridUseBenefit{
		LinuxAzureHybridUseBenefitNo,
		LinuxAzureHybridUseBenefitUnknown,
		LinuxAzureHybridUseBenefitYes,
	}
}
