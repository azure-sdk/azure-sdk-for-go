...
func ExampleManagedPrivateEndpointModelsClient_BeginCreate() {
	...
	poller, err := clientFactory.NewManagedPrivateEndpointModelsClient().BeginCreate(ctx, "myResourceGroup", "myWorkspace", "myMPEName", nil)
	if err != nil {
...
func ExampleManagedPrivateEndpointModelsClient_BeginUpdate() {
	...
	poller, err := clientFactory.NewManagedPrivateEndpointModelsClient().BeginUpdate(ctx, "myResourceGroup", "myWorkspace", "myMPEName", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	res, err := poller.PollUntilDone(ctx, nil)
