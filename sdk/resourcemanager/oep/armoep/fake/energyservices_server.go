...
func (e *EnergyServicesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if energyServicesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = energyServicesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			case "EnergyServicesClient.BeginAddPartition":
				res.resp, res.err = e.dispatchBeginAddPartition(req)
			...
			case "EnergyServicesClient.ListPartitions":
				res.resp, res.err = e.dispatchListPartitions(req)
			case "EnergyServicesClient.BeginRemovePartition":
				res.resp, res.err = e.dispatchBeginRemovePartition(req)
...
// set this to conditionally intercept incoming requests to EnergyServicesServerTransport
var energyServicesServerTransportInterceptor interface {
