...
// MarshalJSON implements the json.Marshaller interface for type EnterprisePackageDownloadInfo.
func (e EnterprisePackageDownloadInfo) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "checksum", e.Checksum)
	populate(objectMap, "link", e.Link)
	populate(objectMap, "version", e.Version)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type EnterprisePackageDownloadInfo.
func (e *EnterprisePackageDownloadInfo) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "checksum":
			err = unpopulate(val, "Checksum", &e.Checksum)
			delete(rawMsg, key)
		case "link":
			err = unpopulate(val, "Link", &e.Link)
			delete(rawMsg, key)
		case "version":
...
// MarshalJSON implements the json.Marshaller interface for type FullPackageDownloadInfo.
func (f FullPackageDownloadInfo) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "iso", f.Iso)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type FullPackageDownloadInfo.
func (f *FullPackageDownloadInfo) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", f, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type PackageBaseDownloadInfo.
func (p PackageBaseDownloadInfo) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type PackageBaseDownloadInfo.
func (p *PackageBaseDownloadInfo) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", p, err)
	}
...
func (p PackageDownloadInfo) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "link", p.Link)
	populate(objectMap, "releaseDate", p.ReleaseDate)
	populate(objectMap, "scope", p.Scope)
	populate(objectMap, "supportedUntil", p.SupportedUntil)
	populate(objectMap, "version", p.Version)
...
func (p *PackageDownloadInfo) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "link":
			...
			delete(rawMsg, key)
		case "releaseDate":
			err = unpopulate(val, "ReleaseDate", &p.ReleaseDate)
			delete(rawMsg, key)
		case "scope":
			err = unpopulate(val, "Scope", &p.Scope)
			delete(rawMsg, key)
		case "supportedUntil":
			err = unpopulate(val, "SupportedUntil", &p.SupportedUntil)
			delete(rawMsg, key)
		case "version":
			err = unpopulate(val, "Version", &p.Version)
			delete(rawMsg, key)
...
func (u UpgradePackageDownloadInfo) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "releaseDate", u.ReleaseDate)
	populate(objectMap, "scope", u.Scope)
	populate(objectMap, "supportedUntil", u.SupportedUntil)
...
func (u *UpgradePackageDownloadInfo) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "link":
			...
			delete(rawMsg, key)
		case "releaseDate":
			err = unpopulate(val, "ReleaseDate", &u.ReleaseDate)
			delete(rawMsg, key)
		case "scope":
			err = unpopulate(val, "Scope", &u.Scope)
			delete(rawMsg, key)
		case "supportedUntil":
			err = unpopulate(val, "SupportedUntil", &u.SupportedUntil)
			delete(rawMsg, key)
		case "version":
