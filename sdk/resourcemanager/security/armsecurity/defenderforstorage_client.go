...
func (client *DefenderForStorageClient) cancelMalwareScanCreateRequest(ctx context.Context, resourceID string, settingName SettingNameAutoGenerated, scanID string, _ *DefenderForStorageClientCancelMalwareScanOptions) (*policy.Request, error) {
...
func (client *DefenderForStorageClient) createCreateRequest(ctx context.Context, resourceID string, settingName SettingNameAutoGenerated, defenderForStorageSetting DefenderForStorageSetting, _ *DefenderForStorageClientCreateOptions) (*policy.Request, error) {
...
func (client *DefenderForStorageClient) getCreateRequest(ctx context.Context, resourceID string, settingName SettingNameAutoGenerated, _ *DefenderForStorageClientGetOptions) (*policy.Request, error) {
	urlPath := "/{resourceId}/providers/Microsoft.Security/defenderForStorageSettings/{settingName}"
	urlPath = strings.ReplaceAll(urlPath, "{resourceId}", resourceID)
	if settingName == "" {
		return nil, errors.New("parameter settingName cannot be empty")
...
func (client *DefenderForStorageClient) getMalwareScanCreateRequest(ctx context.Context, resourceID string, settingName SettingNameAutoGenerated, scanID string, _ *DefenderForStorageClientGetMalwareScanOptions) (*policy.Request, error) {
...
func (client *DefenderForStorageClient) startMalwareScanCreateRequest(ctx context.Context, resourceID string, settingName SettingNameAutoGenerated, _ *DefenderForStorageClientStartMalwareScanOptions) (*policy.Request, error) {
