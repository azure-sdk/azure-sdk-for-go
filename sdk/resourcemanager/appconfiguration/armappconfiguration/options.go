...
// ConfigurationStoresClientResetSasKindOptions contains the optional parameters for the ConfigurationStoresClient.ResetSasKind
// method.
type ConfigurationStoresClientResetSasKindOptions struct {
	// placeholder for future optional parameters
}
