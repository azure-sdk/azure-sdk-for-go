...
- Type of `IPConfiguration.PublicIPAddressConfiguration` has been changed from `*IPConfigurationPublicIPAddressConfiguration` to `*PublicIPAddressConfiguration`
...
- Struct `IPConfigurationPublicIPAddressConfiguration` has been removed
...
- New struct `PublicIPAddressConfiguration`
