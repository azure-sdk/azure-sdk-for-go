...
func (client *ProxyArtifactClient) getCreateRequest(ctx context.Context, resourceGroupName string, publisherName string, artifactStoreName string, artifactName string, _ *ProxyArtifactClientGetOptions) (*policy.Request, error) {
...
func (client *ProxyArtifactClient) listCreateRequest(ctx context.Context, resourceGroupName string, publisherName string, artifactStoreName string, _ *ProxyArtifactClientListOptions) (*policy.Request, error) {
...
func (client *ProxyArtifactClient) updateStateCreateRequest(ctx context.Context, resourceGroupName string, publisherName string, artifactStoreName string, artifactName string, artifactVersionName string, parameters ArtifactChangeState, _ *ProxyArtifactClientBeginUpdateStateOptions) (*policy.Request, error) {
