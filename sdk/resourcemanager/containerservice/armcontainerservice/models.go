...
type AgentPoolGPUProfile struct {
	// The default value is true. GPU Driver Installation can only be set true when VM has associated GPU resource. It is intended
	// as an opt-out feature for users who want to install GPU drivers themselves
	// to avoid any installations.
