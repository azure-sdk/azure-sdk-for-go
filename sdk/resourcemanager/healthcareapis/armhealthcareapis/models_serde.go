...
func (a AnalyticsConnectorFhirToParquetMapping) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "anonymizationSchemaReference", a.AnonymizationSchemaReference)
	...
	populate(objectMap, "transformationSchemaReference", a.TransformationSchemaReference)
...
func (a *AnalyticsConnectorFhirToParquetMapping) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		var err error
		switch key {
		case "anonymizationSchemaReference":
			err = unpopulate(val, "AnonymizationSchemaReference", &a.AnonymizationSchemaReference)
			delete(rawMsg, key)
		...
		case "filterConfigurationReference":
			...
			delete(rawMsg, key)
		case "transformationSchemaReference":
			err = unpopulate(val, "TransformationSchemaReference", &a.TransformationSchemaReference)
			delete(rawMsg, key)
		case "type":
			err = unpopulate(val, "Type", &a.Type)
			delete(rawMsg, key)
