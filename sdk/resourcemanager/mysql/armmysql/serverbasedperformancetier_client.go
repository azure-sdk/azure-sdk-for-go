...
func (client *ServerBasedPerformanceTierClient) listCreateRequest(ctx context.Context, resourceGroupName string, serverName string, _ *ServerBasedPerformanceTierClientListOptions) (*policy.Request, error) {
