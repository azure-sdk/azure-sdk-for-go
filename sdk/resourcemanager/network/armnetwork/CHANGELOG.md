...
- New function `*ClientFactory.NewListClient() *ListClient`
...
- New function `NewListClient(string, azcore.TokenCredential, *arm.ClientOptions) (*ListClient, error)`
- New function `*ListClient.VPNLinkConnectionsSharedKey(context.Context, string, string, string, string, *ListClientVPNLinkConnectionsSharedKeyOptions) (ListClientVPNLinkConnectionsSharedKeyResponse, error)`
- New function `*VPNLinkConnectionsClient.BeginPutSharedKey(context.Context, string, string, string, string, string, SharedKeyProperties, *VPNLinkConnectionsClientBeginPutSharedKeyOptions) (*runtime.Poller[VPNLinkConnectionsClientPutSharedKeyResponse], error)`
- New function `*VPNLinkConnectionsClient.SharedKeyGet(context.Context, string, string, string, string, string, *VPNLinkConnectionsClientSharedKeyGetOptions) (VPNLinkConnectionsClientSharedKeyGetResponse, error)`
...
- New struct `ListVPNLinkConnectionsSharedKeyResult`
- New struct `SharedKey`
