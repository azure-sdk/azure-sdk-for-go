...
- Enum `TemplateSpecExpandKind` has been removed
...
- Function `*Client.GetBuiltIn` has been removed
- Function `*Client.NewListBuiltInsPager` has been removed
...
- Function `NewTemplateSpecVersionsClient` has been removed
- Function `*TemplateSpecVersionsClient.CreateOrUpdate` has been removed
- Function `*TemplateSpecVersionsClient.Delete` has been removed
- Function `*TemplateSpecVersionsClient.Get` has been removed
- Function `*TemplateSpecVersionsClient.GetBuiltIn` has been removed
- Function `*TemplateSpecVersionsClient.NewListBuiltInsPager` has been removed
- Function `*TemplateSpecVersionsClient.NewListPager` has been removed
- Function `*TemplateSpecVersionsClient.Update` has been removed
- Struct `AzureResourceBase` has been removed
- Struct `Error` has been removed
- Struct `LinkedTemplateArtifact` has been removed
- Struct `ListResult` has been removed
- Struct `TemplateSpec` has been removed
- Struct `TemplateSpecProperties` has been removed
- Struct `TemplateSpecUpdateModel` has been removed
- Struct `TemplateSpecVersion` has been removed
- Struct `TemplateSpecVersionInfo` has been removed
- Struct `TemplateSpecVersionProperties` has been removed
- Struct `TemplateSpecVersionUpdateModel` has been removed
- Struct `TemplateSpecVersionsListResult` has been removed
