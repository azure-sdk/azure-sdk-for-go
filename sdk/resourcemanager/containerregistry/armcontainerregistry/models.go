...
// CacheRulesClientGetAsyncOptions contains the optional parameters for the CacheRulesClient.GetAsync method.
type CacheRulesClientGetAsyncOptions struct {
	// placeholder for future optional parameters
}

// CacheRulesClientListAsyncOptions contains the optional parameters for the CacheRulesClient.ListAsync method.
type CacheRulesClientListAsyncOptions struct {
	// placeholder for future optional parameters
}
