...
func (t *TracksServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if tracksServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = tracksServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "TracksClient.BeginUpdateTrackData":
				res.resp, res.err = t.dispatchBeginUpdateTrackData(req)
			default:
...
// set this to conditionally intercept incoming requests to TracksServerTransport
var tracksServerTransportInterceptor interface {
