...
// BeginCreateNotificationsAtActionGroupResourceLevel - Send test notifications to a set of provided receivers at the action
// group level.
...
func (client *ActionGroupsClient) BeginCreateNotificationsAtActionGroupResourceLevel(ctx context.Context, resourceGroupName string, actionGroupName string, notificationRequest NotificationRequestBody, options *ActionGroupsClientBeginCreateNotificationsAtActionGroupResourceLevelOptions) (*armruntime.Poller[ActionGroupsClientCreateNotificationsAtActionGroupResourceLevelResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return armruntime.NewPoller(resp, client.pl, &armruntime.NewPollerOptions[ActionGroupsClientCreateNotificationsAtActionGroupResourceLevelResponse]{
			FinalStateVia: armruntime.FinalStateViaLocation,
		})
	} else {
		return armruntime.NewPollerFromResumeToken[ActionGroupsClientCreateNotificationsAtActionGroupResourceLevelResponse](options.ResumeToken, client.pl, nil)
	}
}

// CreateNotificationsAtActionGroupResourceLevel - Send test notifications to a set of provided receivers at the action group
// level.
// If the operation fails it returns an *azcore.ResponseError type.
...
// BeginCreateNotificationsAtResourceGroupLevel - Send test notifications to a set of provided receivers the the resource
// group level.
// If the operation fails it returns an *azcore.ResponseError type.
// resourceGroupName - The name of the resource group. The name is case insensitive.
// notificationRequest - The notification request body which includes the contact details
...
// CreateNotificationsAtResourceGroupLevel - Send test notifications to a set of provided receivers the the resource group
// level.
// If the operation fails it returns an *azcore.ResponseError type.
...
// BeginPostTestNotifications - Send test notifications to a set of provided receivers at the subscription level.
// If the operation fails it returns an *azcore.ResponseError type.
// notificationRequest - The notification request body which includes the contact details
...
// PostTestNotifications - Send test notifications to a set of provided receivers at the subscription level.
// If the operation fails it returns an *azcore.ResponseError type.
