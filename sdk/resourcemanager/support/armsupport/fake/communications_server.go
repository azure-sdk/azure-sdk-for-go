...
func (c *CommunicationsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if communicationsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = communicationsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to CommunicationsServerTransport
var communicationsServerTransportInterceptor interface {
