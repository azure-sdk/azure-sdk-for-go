...
func (client *CatalogsClient) uploadImageCreateRequest(ctx context.Context, resourceGroupName string, catalogName string, uploadImageRequest Image, _ *CatalogsClientBeginUploadImageOptions) (*policy.Request, error) {
