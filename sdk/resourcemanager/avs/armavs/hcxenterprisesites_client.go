...
//     method.
func (client *HcxEnterpriseSitesClient) NewListByPrivateCloudPager(resourceGroupName string, privateCloudName string, options *HcxEnterpriseSitesClientListByPrivateCloudOptions) *runtime.Pager[HcxEnterpriseSitesClientListByPrivateCloudResponse] {
...
func (client *HcxEnterpriseSitesClient) listByPrivateCloudCreateRequest(ctx context.Context, resourceGroupName string, privateCloudName string, _ *HcxEnterpriseSitesClientListByPrivateCloudOptions) (*policy.Request, error) {
