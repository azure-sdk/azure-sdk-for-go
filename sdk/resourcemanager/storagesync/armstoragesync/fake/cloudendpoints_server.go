...
func (c *CloudEndpointsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if cloudEndpointsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = cloudEndpointsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			case "CloudEndpointsClient.AfsShareMetadataCertificatePublicKeys":
				res.resp, res.err = c.dispatchAfsShareMetadataCertificatePublicKeys(req)
			...
			case "CloudEndpointsClient.NewListBySyncGroupPager":
				res.resp, res.err = c.dispatchNewListBySyncGroupPager(req)
			case "CloudEndpointsClient.BeginPostBackup":
				res.resp, res.err = c.dispatchBeginPostBackup(req)
			case "CloudEndpointsClient.BeginPostRestore":
				res.resp, res.err = c.dispatchBeginPostRestore(req)
			case "CloudEndpointsClient.BeginPreBackup":
				res.resp, res.err = c.dispatchBeginPreBackup(req)
			case "CloudEndpointsClient.BeginPreRestore":
				res.resp, res.err = c.dispatchBeginPreRestore(req)
...
// set this to conditionally intercept incoming requests to CloudEndpointsServerTransport
var cloudEndpointsServerTransportInterceptor interface {
