...
// SecurityPerimeterAssociableResourceTypesClient contains the methods for the NetworkSecurityPerimeterAssociableResourceTypes group.
...
func (client *SecurityPerimeterAssociableResourceTypesClient) listCreateRequest(ctx context.Context, location string, options *SecurityPerimeterAssociableResourceTypesClientListOptions) (*policy.Request, error) {
