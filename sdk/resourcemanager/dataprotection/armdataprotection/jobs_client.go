...
// GenerateProgressURL - Generates read SAS URL for a blob from which current job progress can be read.
...
//   - options - JobsClientGenerateProgressURLOptions contains the optional parameters for the JobsClient.GenerateProgressURL
//     method.
func (client *JobsClient) GenerateProgressURL(ctx context.Context, resourceGroupName string, vaultName string, jobID string, options *JobsClientGenerateProgressURLOptions) (JobsClientGenerateProgressURLResponse, error) {
	var err error
	req, err := client.generateProgressURLCreateRequest(ctx, resourceGroupName, vaultName, jobID, options)
	if err != nil {
		return JobsClientGenerateProgressURLResponse{}, err
	}
	...
	resp, err := client.generateProgressURLHandleResponse(httpResp)
	return resp, err
}

// generateProgressURLCreateRequest creates the GenerateProgressURL request.
func (client *JobsClient) generateProgressURLCreateRequest(ctx context.Context, resourceGroupName string, vaultName string, jobID string, options *JobsClientGenerateProgressURLOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataProtection/backupVaults/{vaultName}/backupJobs/{jobId}/generateProgressUrl"
...
// generateProgressURLHandleResponse handles the GenerateProgressURL response.
func (client *JobsClient) generateProgressURLHandleResponse(resp *http.Response) (JobsClientGenerateProgressURLResponse, error) {
	result := JobsClientGenerateProgressURLResponse{}
	if err := runtime.UnmarshalAsJSON(resp, &result.AzureBackupJobProgressURL); err != nil {
		return JobsClientGenerateProgressURLResponse{}, err
	}
	return result, nil
}
...
func (client *JobsClient) BeginTriggerCancel(ctx context.Context, resourceGroupName string, vaultName string, jobID string, options *JobsClientBeginTriggerCancelOptions) (*runtime.Poller[JobsClientTriggerCancelResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		poller, err := runtime.NewPoller(resp, client.internal.Pipeline(), &runtime.NewPollerOptions[JobsClientTriggerCancelResponse]{
