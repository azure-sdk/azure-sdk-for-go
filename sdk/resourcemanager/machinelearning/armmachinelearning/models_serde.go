...
func (c CustomMonitoringSignal) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "lookbackPeriod", c.LookbackPeriod)
...
func (c *CustomMonitoringSignal) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "componentId":
			...
			delete(rawMsg, key)
		case "inputAssets":
			err = unpopulate(val, "InputAssets", &c.InputAssets)
			delete(rawMsg, key)
		case "lookbackPeriod":
			err = unpopulate(val, "LookbackPeriod", &c.LookbackPeriod)
			delete(rawMsg, key)
...
func (d DataDriftMonitoringSignal) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "baselineData", d.BaselineData)
	populate(objectMap, "dataSegment", d.DataSegment)
	populate(objectMap, "features", d.Features)
	populate(objectMap, "lookbackPeriod", d.LookbackPeriod)
	...
	populate(objectMap, "targetData", d.TargetData)
	return json.Marshal(objectMap)
}
...
func (d *DataDriftMonitoringSignal) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "baselineData":
			err = unpopulate(val, "BaselineData", &d.BaselineData)
			delete(rawMsg, key)
		case "dataSegment":
		...
		case "features":
			...
			delete(rawMsg, key)
		case "lookbackPeriod":
			err = unpopulate(val, "LookbackPeriod", &d.LookbackPeriod)
			delete(rawMsg, key)
		case "metricThresholds":
		...
		case "signalType":
			...
			delete(rawMsg, key)
		case "targetData":
			err = unpopulate(val, "TargetData", &d.TargetData)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", d, err)
...
func (f FeatureAttributionDriftMonitoringSignal) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "baselineData", f.BaselineData)
	populate(objectMap, "lookbackPeriod", f.LookbackPeriod)
	populate(objectMap, "metricThreshold", f.MetricThreshold)
	populate(objectMap, "mode", f.Mode)
	populate(objectMap, "modelType", f.ModelType)
	objectMap["signalType"] = MonitoringSignalTypeFeatureAttributionDrift
	populate(objectMap, "targetData", f.TargetData)
	return json.Marshal(objectMap)
}
...
func (f *FeatureAttributionDriftMonitoringSignal) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "baselineData":
			err = unpopulate(val, "BaselineData", &f.BaselineData)
			delete(rawMsg, key)
		case "lookbackPeriod":
			err = unpopulate(val, "LookbackPeriod", &f.LookbackPeriod)
			delete(rawMsg, key)
		...
		case "mode":
			...
			delete(rawMsg, key)
		case "modelType":
			err = unpopulate(val, "ModelType", &f.ModelType)
			delete(rawMsg, key)
		case "signalType":
			err = unpopulate(val, "SignalType", &f.SignalType)
			delete(rawMsg, key)
		case "targetData":
			err = unpopulate(val, "TargetData", &f.TargetData)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", f, err)
...
// MarshalJSON implements the json.Marshaller interface for type ModelPerformanceSignalBase.
func (m ModelPerformanceSignalBase) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "baselineData", m.BaselineData)
	...
	populate(objectMap, "mode", m.Mode)
	objectMap["signalType"] = "ModelPerformanceSignalBase"
	populate(objectMap, "targetData", m.TargetData)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ModelPerformanceSignalBase.
func (m *ModelPerformanceSignalBase) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", m, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "baselineData":
			err = unpopulate(val, "BaselineData", &m.BaselineData)
			delete(rawMsg, key)
		case "dataSegment":
		...
		case "signalType":
			...
			delete(rawMsg, key)
		case "targetData":
			err = unpopulate(val, "TargetData", &m.TargetData)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", m, err)
...
func (m *MonitorDefinition) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "alertNotificationSetting":
			...
			delete(rawMsg, key)
		case "computeId":
			err = unpopulate(val, "ComputeID", &m.ComputeID)
			delete(rawMsg, key)
...
// MarshalJSON implements the json.Marshaller interface for type MonitoringInputData.
func (m MonitoringInputData) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateAny(objectMap, "asset", m.Asset)
	populate(objectMap, "dataContext", m.DataContext)
	populate(objectMap, "preprocessingComponentId", m.PreprocessingComponentID)
	populate(objectMap, "targetColumnName", m.TargetColumnName)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type MonitoringInputData.
func (m *MonitoringInputData) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", m, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "asset":
			err = unpopulate(val, "Asset", &m.Asset)
			delete(rawMsg, key)
		case "dataContext":
			err = unpopulate(val, "DataContext", &m.DataContext)
			delete(rawMsg, key)
		case "preprocessingComponentId":
			err = unpopulate(val, "PreprocessingComponentID", &m.PreprocessingComponentID)
			delete(rawMsg, key)
		case "targetColumnName":
			err = unpopulate(val, "TargetColumnName", &m.TargetColumnName)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", m, err)
...
func (p PackageRequest) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "targetEnvironmentName", p.TargetEnvironmentName)
	populate(objectMap, "targetEnvironmentVersion", p.TargetEnvironmentVersion)
	return json.Marshal(objectMap)
}
...
func (p *PackageRequest) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "targetEnvironmentName":
			err = unpopulate(val, "TargetEnvironmentName", &p.TargetEnvironmentName)
			delete(rawMsg, key)
		case "targetEnvironmentVersion":
			err = unpopulate(val, "TargetEnvironmentVersion", &p.TargetEnvironmentVersion)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", p, err)
...
func (p PredictionDriftMonitoringSignal) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "baselineData", p.BaselineData)
	populate(objectMap, "lookbackPeriod", p.LookbackPeriod)
	...
	populate(objectMap, "targetData", p.TargetData)
	return json.Marshal(objectMap)
}
...
func (p *PredictionDriftMonitoringSignal) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "baselineData":
			err = unpopulate(val, "BaselineData", &p.BaselineData)
			delete(rawMsg, key)
		case "lookbackPeriod":
			err = unpopulate(val, "LookbackPeriod", &p.LookbackPeriod)
			delete(rawMsg, key)
		case "metricThresholds":
		...
		case "signalType":
			...
			delete(rawMsg, key)
		case "targetData":
			err = unpopulate(val, "TargetData", &p.TargetData)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", p, err)
