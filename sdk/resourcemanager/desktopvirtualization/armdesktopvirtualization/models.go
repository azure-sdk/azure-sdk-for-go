...
type ScalingPlanPatchProperties struct {
	...
	Schedules []*ScalingPlanPooledScheduleProperties
...
type ScalingPlanPooledScheduleList struct {
	...
	Value []*ScalingPlanPooledSchedulePut
...
// ScalingPlanPooledSchedulePut - Represents a ScalingPlanPooledSchedule properties that can be put.
type ScalingPlanPooledSchedulePut struct {
	// Detailed properties for ScalingPlanPooledSchedule
	Properties *ScalingPlanPooledSchedulePutProperties
...
// ScalingPlanPooledSchedulePutProperties - A ScalingPlanPooledSchedule.
type ScalingPlanPooledSchedulePutProperties struct {
	// REQUIRED; Set of days of the week on which this schedule is active.
	DaysOfWeek []*DayOfWeek
