...
func (l *LibraryServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if libraryServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = libraryServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to LibraryServerTransport
var libraryServerTransportInterceptor interface {
