...
type WorkspaceProperties struct {
	...
	// Lazily initialize system datastores until the moment they are first needed. When set, delays the moment that containers
	// and file shares are created on the workspace-associated Azure storage account.
