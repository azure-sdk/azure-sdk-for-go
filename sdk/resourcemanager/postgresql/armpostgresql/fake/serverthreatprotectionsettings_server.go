...
type ServerThreatProtectionSettingsServer struct {
	...
	BeginCreateOrUpdate func(ctx context.Context, resourceGroupName string, serverName string, threatProtectionName armpostgresql.ThreatProtectionName, parameters armpostgresql.ServerThreatProtectionSettingsModel, options *armpostgresql.ServerThreatProtectionSettingsClientBeginCreateOrUpdateOptions) (resp azfake.PollerResponder[armpostgresql.ServerThreatProtectionSettingsClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method ServerThreatProtectionSettingsClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, serverName string, threatProtectionName armpostgresql.ThreatProtectionName, options *armpostgresql.ServerThreatProtectionSettingsClientGetOptions) (resp azfake.Responder[armpostgresql.ServerThreatProtectionSettingsClientGetResponse], errResp azfake.ErrorResponder)

	// NewListByServerPager is the fake for method ServerThreatProtectionSettingsClient.NewListByServerPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByServerPager func(resourceGroupName string, serverName string, options *armpostgresql.ServerThreatProtectionSettingsClientListByServerOptions) (resp azfake.PagerResponder[armpostgresql.ServerThreatProtectionSettingsClientListByServerResponse])
}
...
func NewServerThreatProtectionSettingsServerTransport(srv *ServerThreatProtectionSettingsServer) *ServerThreatProtectionSettingsServerTransport {
	return &ServerThreatProtectionSettingsServerTransport{
		...
		newListByServerPager: newTracker[azfake.PagerResponder[armpostgresql.ServerThreatProtectionSettingsClientListByServerResponse]](),
	}
}
...
type ServerThreatProtectionSettingsServerTransport struct {
	...
	newListByServerPager *tracker[azfake.PagerResponder[armpostgresql.ServerThreatProtectionSettingsClientListByServerResponse]]
}
...
func (s *ServerThreatProtectionSettingsServerTransport) dispatchBeginCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginCreateOrUpdate == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armpostgresql.ServerThreatProtectionSettingsModel](req)
		if err != nil {
			return nil, err
		}
...
func (s *ServerThreatProtectionSettingsServerTransport) dispatchNewListByServerPager(req *http.Request) (*http.Response, error) {
	...
	if newListByServerPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListByServerPager, req, func(page *armpostgresql.ServerThreatProtectionSettingsClientListByServerResponse, createLink func() string) {
