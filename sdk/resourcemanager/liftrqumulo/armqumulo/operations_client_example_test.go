...
// Generated from example definition: 2024-06-19/Operations_List_MaximumSet_Gen.json
func ExampleOperationsClient_NewListPager_operationsList() {
	...
	clientFactory, err := armqumulo.NewClientFactory("<subscriptionID>", cred, nil)
	if err != nil {
	...
	for pager.More() {
		...
		// page = armqumulo.OperationsClientListResponse{
		// 	OperationListResult: armqumulo.OperationListResult{
		...
		// 			},
		// 		},
		// 		NextLink: to.Ptr("vxtunikmzmz"),
		// 	},
		// }
	}
}

// Generated from example definition: 2024-06-19/Operations_List_MinimumSet_Gen.json
