...
func (p ProxyResourceSystemData) MarshalJSON() ([]byte, error) {
	...
	populateTimeRFC3339(objectMap, "lastModifiedAt", p.LastModifiedAt)
...
func (p *ProxyResourceSystemData) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "createdByType":
			...
			delete(rawMsg, key)
		case "lastModifiedAt":
			err = unpopulateTimeRFC3339(val, "LastModifiedAt", &p.LastModifiedAt)
			delete(rawMsg, key)
		case "lastModifiedBy":
...
func (t *TrackedResourceSystemData) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "createdByType":
			...
			delete(rawMsg, key)
		case "lastModifiedAt":
			err = unpopulateTimeRFC3339(val, "LastModifiedAt", &t.LastModifiedAt)
			delete(rawMsg, key)
		case "lastModifiedBy":
