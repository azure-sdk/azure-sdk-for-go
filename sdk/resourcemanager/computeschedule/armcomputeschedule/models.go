...
// OperationErrorsResult - This is the first level of operation errors from the request to get errors per vm operation
type OperationErrorsResult struct {
	// REQUIRED; The creation time of the error result
	CreationTime *time.Time

	// REQUIRED; The operationId identifying a vm operation
	OperationID *string
