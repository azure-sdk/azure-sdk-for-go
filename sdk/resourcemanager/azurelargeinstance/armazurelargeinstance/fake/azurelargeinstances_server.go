...
type AzureLargeInstancesServer struct {
	...
	// Delete is the fake for method AzureLargeInstancesClient.Delete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	Delete func(ctx context.Context, resourceGroupName string, azureLargeInstanceName string, options *armazurelargeinstance.AzureLargeInstancesClientDeleteOptions) (resp azfake.Responder[armazurelargeinstance.AzureLargeInstancesClientDeleteResponse], errResp azfake.ErrorResponder)
...
func (a *AzureLargeInstancesServerTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "AzureLargeInstancesClient.Delete":
...
func (a *AzureLargeInstancesServerTransport) dispatchDelete(req *http.Request) (*http.Response, error) {
	if a.srv.Delete == nil {
