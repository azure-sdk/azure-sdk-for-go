...
- New function `*NetworkSecurityPerimeterClient.NewListConfigurationPager(string, string, *NetworkSecurityPerimeterClientListConfigurationOptions) *runtime.Pager[NetworkSecurityPerimeterClientListConfigurationResponse]`
