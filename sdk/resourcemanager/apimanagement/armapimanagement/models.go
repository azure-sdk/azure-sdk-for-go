...
// PolicyStatusCollection - The response of the list policy status.
type PolicyStatusCollection struct {
	// Next page link if any.
	NextLink *string
...
// PolicyStatusContract - Policy Status Contract details.
type PolicyStatusContract struct {
	// Properties of the Policy Status.
	Properties *PolicyStatusContractProperties
...
// PolicyStatusContractProperties - Policy status Properties.
type PolicyStatusContractProperties struct {
