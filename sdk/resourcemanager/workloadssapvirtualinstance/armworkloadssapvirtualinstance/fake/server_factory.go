...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "SAPApplicationServerInstancesClient":
		initServer(s, &s.trSAPApplicationServerInstancesServer, func() *SAPApplicationServerInstancesServerTransport { return NewSAPApplicationServerInstancesServerTransport(&s.srv.SAPApplicationServerInstancesServer) })
		resp, err = s.trSAPApplicationServerInstancesServer.Do(req)
	case "SAPCentralServerInstancesClient":
		initServer(s, &s.trSAPCentralServerInstancesServer, func() *SAPCentralServerInstancesServerTransport { return NewSAPCentralServerInstancesServerTransport(&s.srv.SAPCentralServerInstancesServer) })
		resp, err = s.trSAPCentralServerInstancesServer.Do(req)
	case "SAPDatabaseInstancesClient":
		initServer(s, &s.trSAPDatabaseInstancesServer, func() *SAPDatabaseInstancesServerTransport { return NewSAPDatabaseInstancesServerTransport(&s.srv.SAPDatabaseInstancesServer) })
		resp, err = s.trSAPDatabaseInstancesServer.Do(req)
	case "SAPVirtualInstancesClient":
		initServer(s, &s.trSAPVirtualInstancesServer, func() *SAPVirtualInstancesServerTransport { return NewSAPVirtualInstancesServerTransport(&s.srv.SAPVirtualInstancesServer) })
