...
func (p Properties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "routeSettings", p.RouteSettings)
...
func (p *Properties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "resourceStopped":
			...
			delete(rawMsg, key)
		case "routeSettings":
			err = unpopulate(val, "RouteSettings", &p.RouteSettings)
			delete(rawMsg, key)
		case "serverPort":
...
// MarshalJSON implements the json.Marshaller interface for type RouteSettings.
func (r RouteSettings) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "connectionBalanceWeight", r.ConnectionBalanceWeight)
	populate(objectMap, "latencyWeight", r.LatencyWeight)
	populate(objectMap, "serverBalanceWeight", r.ServerBalanceWeight)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type RouteSettings.
func (r *RouteSettings) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", r, err)
	}
	for key, val := range rawMsg {
		var err error
		switch key {
		case "connectionBalanceWeight":
			err = unpopulate(val, "ConnectionBalanceWeight", &r.ConnectionBalanceWeight)
			delete(rawMsg, key)
		case "latencyWeight":
			err = unpopulate(val, "LatencyWeight", &r.LatencyWeight)
			delete(rawMsg, key)
		case "serverBalanceWeight":
			err = unpopulate(val, "ServerBalanceWeight", &r.ServerBalanceWeight)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", r, err)
...
func (s ServerlessSettings) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "keepAliveIntervalInSeconds", s.KeepAliveIntervalInSeconds)
	return json.Marshal(objectMap)
}
...
func (s *ServerlessSettings) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "connectionTimeoutInSeconds":
			...
			delete(rawMsg, key)
		case "keepAliveIntervalInSeconds":
			err = unpopulate(val, "KeepAliveIntervalInSeconds", &s.KeepAliveIntervalInSeconds)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", s, err)
