...
// VulnerabilityAssessmentBaselinesClientGetResponse contains the response from method VulnerabilityAssessmentBaselinesClient.Get.
type VulnerabilityAssessmentBaselinesClientGetResponse struct {
	DatabaseSQLVulnerabilityAssessmentBaselineSet
}

// VulnerabilityAssessmentBaselinesClientListBySQLVulnerabilityAssessmentResponse contains the response from method VulnerabilityAssessmentBaselinesClient.ListBySQLVulnerabilityAssessment.
type VulnerabilityAssessmentBaselinesClientListBySQLVulnerabilityAssessmentResponse struct {
	DatabaseSQLVulnerabilityAssessmentBaselineSetListResult
}
...
// VulnerabilityAssessmentRuleBaselinesClientCreateOrUpdateResponse contains the response from method VulnerabilityAssessmentRuleBaselinesClient.CreateOrUpdate.
type VulnerabilityAssessmentRuleBaselinesClientCreateOrUpdateResponse struct {
	DatabaseSQLVulnerabilityAssessmentRuleBaseline
}
...
// VulnerabilityAssessmentRuleBaselinesClientGetResponse contains the response from method VulnerabilityAssessmentRuleBaselinesClient.Get.
type VulnerabilityAssessmentRuleBaselinesClientGetResponse struct {
	DatabaseSQLVulnerabilityAssessmentRuleBaseline
}

// VulnerabilityAssessmentRuleBaselinesClientListByBaselineResponse contains the response from method VulnerabilityAssessmentRuleBaselinesClient.ListByBaseline.
type VulnerabilityAssessmentRuleBaselinesClientListByBaselineResponse struct {
	DatabaseSQLVulnerabilityAssessmentRuleBaselineListResult
}
...
// VulnerabilityAssessmentsSettingsClientDeleteResponse contains the response from method VulnerabilityAssessmentsSettingsClient.Delete.
type VulnerabilityAssessmentsSettingsClientDeleteResponse struct {
	// placeholder for future response values
}
