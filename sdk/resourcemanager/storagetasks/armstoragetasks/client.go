...
func (client *Client) PreviewActions(ctx context.Context, location string, parameters StorageTaskPreviewAction, options *ClientPreviewActionsOptions) (ClientPreviewActionsResponse, error) {
	var err error
...
func (client *Client) previewActionsCreateRequest(ctx context.Context, location string, parameters StorageTaskPreviewAction, options *ClientPreviewActionsOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/providers/Microsoft.StorageTasks/locations/{location}/previewActions"
	urlPath = strings.ReplaceAll(urlPath, "{subscriptionId}", url.PathEscape(client.subscriptionID))
	if location == "" {
