...
type CapacitiesServer struct {
	...
	// List is the fake for method CapacitiesClient.List
	// HTTP status codes to indicate success: http.StatusOK
	List func(ctx context.Context, options *armpowerbidedicated.CapacitiesClientListOptions) (resp azfake.Responder[armpowerbidedicated.CapacitiesClientListResponse], errResp azfake.ErrorResponder)

	// ListByResourceGroup is the fake for method CapacitiesClient.ListByResourceGroup
	// HTTP status codes to indicate success: http.StatusOK
	ListByResourceGroup func(ctx context.Context, resourceGroupName string, options *armpowerbidedicated.CapacitiesClientListByResourceGroupOptions) (resp azfake.Responder[armpowerbidedicated.CapacitiesClientListByResourceGroupResponse], errResp azfake.ErrorResponder)
...
func (c *CapacitiesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		if !intercepted {
			...
			case "CapacitiesClient.List":
				res.resp, res.err = c.dispatchList(req)
			case "CapacitiesClient.ListByResourceGroup":
				res.resp, res.err = c.dispatchListByResourceGroup(req)
...
func (c *CapacitiesServerTransport) dispatchList(req *http.Request) (*http.Response, error) {
	if c.srv.List == nil {
	...
	resp, err := server.MarshalResponseAsJSON(respContent, server.GetResponse(respr).DedicatedCapacities, req)
	if err != nil {
		return nil, err
	}
	return resp, nil
...
func (c *CapacitiesServerTransport) dispatchListByResourceGroup(req *http.Request) (*http.Response, error) {
