...
func (client *SmartGroupsClient) changeStateCreateRequest(ctx context.Context, smartGroupID string, newState AlertState, _ *SmartGroupsClientChangeStateOptions) (*policy.Request, error) {
...
func (client *SmartGroupsClient) getByIDCreateRequest(ctx context.Context, smartGroupID string, _ *SmartGroupsClientGetByIDOptions) (*policy.Request, error) {
...
func (client *SmartGroupsClient) getHistoryCreateRequest(ctx context.Context, smartGroupID string, _ *SmartGroupsClientGetHistoryOptions) (*policy.Request, error) {
