...
// The returned ClusterPoolsServerTransport instance is connected to an instance of armhdinsightcontainers.ClusterPoolsClient via the
// azcore.ClientOptions.Transporter field in the client's constructor parameters.
func NewClusterPoolsServerTransport(srv *ClusterPoolsServer) *ClusterPoolsServerTransport {
	return &ClusterPoolsServerTransport{
		srv:                         srv,
		beginCreateOrUpdate:         newTracker[azfake.PollerResponder[armhdinsightcontainers.ClusterPoolsClientCreateOrUpdateResponse]](),
		beginDelete:                 newTracker[azfake.PollerResponder[armhdinsightcontainers.ClusterPoolsClientDeleteResponse]](),
...
// ClusterPoolsServerTransport connects instances of armhdinsightcontainers.ClusterPoolsClient to instances of ClusterPoolsServer.
// Don't use this type directly, use NewClusterPoolsServerTransport instead.
type ClusterPoolsServerTransport struct {
	srv                         *ClusterPoolsServer
	beginCreateOrUpdate         *tracker[azfake.PollerResponder[armhdinsightcontainers.ClusterPoolsClientCreateOrUpdateResponse]]
	beginDelete                 *tracker[azfake.PollerResponder[armhdinsightcontainers.ClusterPoolsClientDeleteResponse]]
...
func (c *ClusterPoolsServerTransport) Do(req *http.Request) (*http.Response, error) {
...
func (c *ClusterPoolsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if clusterPoolsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = clusterPoolsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			case "ClusterPoolsClient.BeginCreateOrUpdate":
				res.resp, res.err = c.dispatchBeginCreateOrUpdate(req)
			case "ClusterPoolsClient.BeginDelete":
				res.resp, res.err = c.dispatchBeginDelete(req)
			case "ClusterPoolsClient.Get":
				res.resp, res.err = c.dispatchGet(req)
			case "ClusterPoolsClient.NewListByResourceGroupPager":
				res.resp, res.err = c.dispatchNewListByResourceGroupPager(req)
			case "ClusterPoolsClient.NewListBySubscriptionPager":
			...
			case "ClusterPoolsClient.BeginUpgrade":
				res.resp, res.err = c.dispatchBeginUpgrade(req)
			default:
...
func (c *ClusterPoolsServerTransport) dispatchBeginCreateOrUpdate(req *http.Request) (*http.Response, error) {
	if c.srv.BeginCreateOrUpdate == nil {
		return nil, &nonRetriableError{errors.New("fake for method BeginCreateOrUpdate not implemented")}
	}
	beginCreateOrUpdate := c.beginCreateOrUpdate.get(req)
	if beginCreateOrUpdate == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.HDInsight/clusterpools/(?P<clusterPoolName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if matches == nil || len(matches) < 3 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
		}
		body, err := server.UnmarshalRequestAsJSON[armhdinsightcontainers.ClusterPool](req)
		if err != nil {
			return nil, err
		}
		...
		respr, errRespr := c.srv.BeginCreateOrUpdate(req.Context(), resourceGroupNameParam, clusterPoolNameParam, body, nil)
...
func (c *ClusterPoolsServerTransport) dispatchBeginDelete(req *http.Request) (*http.Response, error) {
	...
	if beginDelete == nil {
		...
		respr, errRespr := c.srv.BeginDelete(req.Context(), resourceGroupNameParam, clusterPoolNameParam, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginDelete = &respr
...
func (c *ClusterPoolsServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	if c.srv.Get == nil {
	...
	respr, errRespr := c.srv.Get(req.Context(), resourceGroupNameParam, clusterPoolNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	...
	resp, err := server.MarshalResponseAsJSON(respContent, server.GetResponse(respr).ClusterPool, req)
	if err != nil {
		return nil, err
	}
	return resp, nil
...
func (c *ClusterPoolsServerTransport) dispatchNewListByResourceGroupPager(req *http.Request) (*http.Response, error) {
	...
	if newListByResourceGroupPager == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.HDInsight/clusterpools`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		...
		server.PagerResponderInjectNextLinks(newListByResourceGroupPager, req, func(page *armhdinsightcontainers.ClusterPoolsClientListByResourceGroupResponse, createLink func() string) {
...
func (c *ClusterPoolsServerTransport) dispatchNewListBySubscriptionPager(req *http.Request) (*http.Response, error) {
	...
	if newListBySubscriptionPager == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.HDInsight/clusterpools`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		...
		server.PagerResponderInjectNextLinks(newListBySubscriptionPager, req, func(page *armhdinsightcontainers.ClusterPoolsClientListBySubscriptionResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
...
func (c *ClusterPoolsServerTransport) dispatchBeginUpdateTags(req *http.Request) (*http.Response, error) {
	...
	if beginUpdateTags == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armhdinsightcontainers.TagsObject](req)
		if err != nil {
			return nil, err
		}
		resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
		...
		respr, errRespr := c.srv.BeginUpdateTags(req.Context(), resourceGroupNameParam, clusterPoolNameParam, body, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
...
// set this to conditionally intercept incoming requests to ClusterPoolsServerTransport
var clusterPoolsServerTransportInterceptor interface {
