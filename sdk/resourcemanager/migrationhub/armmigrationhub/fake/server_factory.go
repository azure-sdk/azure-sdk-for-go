...
type ServerFactory struct {
	// DatabaseInstancesControllerServer contains the fakes for client DatabaseInstancesControllerClient
	DatabaseInstancesControllerServer DatabaseInstancesControllerServer

	// DatabasesControllerServer contains the fakes for client DatabasesControllerClient
	DatabasesControllerServer DatabasesControllerServer

	// EventsControllerServer contains the fakes for client EventsControllerClient
	...
	// MigrateProjectsControllerServer contains the fakes for client MigrateProjectsControllerClient
	...
	// PrivateEndpointConnectionProxyControllerServer contains the fakes for client PrivateEndpointConnectionProxyControllerClient
	PrivateEndpointConnectionProxyControllerServer PrivateEndpointConnectionProxyControllerServer

	// PrivateEndpointConnectionsControllerServer contains the fakes for client PrivateEndpointConnectionsControllerClient
	PrivateEndpointConnectionsControllerServer PrivateEndpointConnectionsControllerServer

	// PrivateLinkResourceControllerServer contains the fakes for client PrivateLinkResourceControllerClient
	...
	// SolutionsControllerServer contains the fakes for client SolutionsControllerClient
	SolutionsControllerServer SolutionsControllerServer

	// VirtualDesktopUserControllerServer contains the fakes for client VirtualDesktopUserControllerClient
	...
	// WebSitesControllerServer contains the fakes for client WebSitesControllerClient
