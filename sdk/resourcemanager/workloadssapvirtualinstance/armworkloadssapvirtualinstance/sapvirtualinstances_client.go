...
func (client *SAPVirtualInstancesClient) startCreateRequest(ctx context.Context, resourceGroupName string, sapVirtualInstanceName string, body StartRequest, _ *SAPVirtualInstancesClientBeginStartOptions) (*policy.Request, error) {
...
func (client *SAPVirtualInstancesClient) stopCreateRequest(ctx context.Context, resourceGroupName string, sapVirtualInstanceName string, body StopRequest, _ *SAPVirtualInstancesClientBeginStopOptions) (*policy.Request, error) {
