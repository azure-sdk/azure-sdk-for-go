...
func (client *LogicalNetworksClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, logicalNetworkName string, resource LogicalNetwork, options *LogicalNetworksClientBeginCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *LogicalNetworksClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, options *LogicalNetworksClientListByResourceGroupOptions) (*policy.Request, error) {
...
func (client *LogicalNetworksClient) updateCreateRequest(ctx context.Context, resourceGroupName string, logicalNetworkName string, properties LogicalNetworksUpdateRequest, options *LogicalNetworksClientBeginUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureStackHCI/logicalNetworks/{logicalNetworkName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
