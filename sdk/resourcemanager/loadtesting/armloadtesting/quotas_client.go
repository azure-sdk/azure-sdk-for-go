...
func (client *QuotasClient) checkAvailabilityCreateRequest(ctx context.Context, location string, quotaBucketName string, body QuotaBucketRequest, _ *QuotasClientCheckAvailabilityOptions) (*policy.Request, error) {
