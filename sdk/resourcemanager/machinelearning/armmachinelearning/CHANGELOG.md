...
- New field `ManagedNetwork`, `ServerlessComputeSettings` in struct `WorkspaceProperties`
- New field `ServerlessComputeSettings` in struct `WorkspacePropertiesUpdateParameters`
