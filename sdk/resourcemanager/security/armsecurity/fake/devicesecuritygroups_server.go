...
func (d *DeviceSecurityGroupsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if deviceSecurityGroupsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = deviceSecurityGroupsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to DeviceSecurityGroupsServerTransport
var deviceSecurityGroupsServerTransportInterceptor interface {
