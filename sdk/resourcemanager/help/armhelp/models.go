...
type ContinueParameterBody struct {
...
type DiagnosticResource struct {
	...
	// READ-ONLY; Unique resource name for insight resources
	Name *string
...
type SimplifiedSolutionsResource struct {
	...
	// READ-ONLY; Simplified Solutions Resource Name.
	Name *string
...
type SolutionResource struct {
	...
	// READ-ONLY; Solution resource Name.
	Name *string
...
type TroubleshooterResource struct {
	...
	// READ-ONLY; Troubleshooter resource Name.
	Name *string
...
type WarmUpParameterBody struct {
