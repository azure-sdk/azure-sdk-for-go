...
type DataVersionBaseProperties struct {
	...
	// REQUIRED; [Required] Uri of the data. Usage/meaning depends on Microsoft.MachineLearning.ManagementFrontEnd.Contracts.V20221001Preview.Assets.DataVersionBase.DataType
...
// RegistriesClientDeleteOptions contains the optional parameters for the RegistriesClient.Delete method.
type RegistriesClientDeleteOptions struct {
	// placeholder for future optional parameters
}
