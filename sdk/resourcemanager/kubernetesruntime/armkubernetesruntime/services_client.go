...
// NewListByParentPager - List ServiceResource resources by parent
//
// Generated from API version 2024-03-01
//   - resourceURI - The fully qualified Azure Resource manager identifier of the resource.
//   - options - ServicesClientListByParentOptions contains the optional parameters for the ServicesClient.NewListByParentPager
//     method.
func (client *ServicesClient) NewListByParentPager(resourceURI string, options *ServicesClientListByParentOptions) *runtime.Pager[ServicesClientListByParentResponse] {
	return runtime.NewPager(runtime.PagingHandler[ServicesClientListByParentResponse]{
		More: func(page ServicesClientListByParentResponse) bool {
			return page.NextLink != nil && len(*page.NextLink) > 0
		},
		Fetcher: func(ctx context.Context, page *ServicesClientListByParentResponse) (ServicesClientListByParentResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "ServicesClient.NewListByParentPager")
			nextLink := ""
			if page != nil {
			...
			if err != nil {
				return ServicesClientListByParentResponse{}, err
			}
...
func (client *ServicesClient) listByParentCreateRequest(ctx context.Context, resourceURI string, _ *ServicesClientListByParentOptions) (*policy.Request, error) {
...
func (client *ServicesClient) listByParentHandleResponse(resp *http.Response) (ServicesClientListByParentResponse, error) {
	result := ServicesClientListByParentResponse{}
