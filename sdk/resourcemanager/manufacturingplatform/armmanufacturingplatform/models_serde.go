...
// MarshalJSON implements the json.Marshaller interface for type AmlProfile.
func (a AmlProfile) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "customNerServiceUri", a.CustomNerServiceURI)
	populate(objectMap, "id", a.ID)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type AmlProfile.
func (a *AmlProfile) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", a, err)
	}
	for key, val := range rawMsg {
		var err error
		switch key {
		case "customNerServiceUri":
			err = unpopulate(val, "CustomNerServiceURI", &a.CustomNerServiceURI)
			delete(rawMsg, key)
		case "id":
			err = unpopulate(val, "ID", &a.ID)
			delete(rawMsg, key)
...
// MarshalJSON implements the json.Marshaller interface for type AmlProfileUpdate.
func (a AmlProfileUpdate) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "customNerServiceUri", a.CustomNerServiceURI)
	populate(objectMap, "id", a.ID)
	return json.Marshal(objectMap)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type AmlProfileUpdate.
func (a *AmlProfileUpdate) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", a, err)
	}
...
func (m MdsResourceProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "amlProfile", m.AmlProfile)
	populate(objectMap, "cmkProfile", m.CmkProfile)
	populate(objectMap, "continuousExportPeriod", m.ContinuousExportPeriod)
	...
	populate(objectMap, "enableTeamsNotification", m.EnableTeamsNotification)
	...
	populate(objectMap, "userManagedAdxProfile", m.UserManagedAdxProfile)
	populate(objectMap, "userManagedDatabaseProfile", m.UserManagedDatabaseProfile)
...
func (m *MdsResourceProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "aksProfile":
			...
			delete(rawMsg, key)
		case "amlProfile":
			err = unpopulate(val, "AmlProfile", &m.AmlProfile)
			delete(rawMsg, key)
		case "cmkProfile":
			err = unpopulate(val, "CmkProfile", &m.CmkProfile)
			delete(rawMsg, key)
		case "continuousExportPeriod":
			err = unpopulate(val, "ContinuousExportPeriod", &m.ContinuousExportPeriod)
			delete(rawMsg, key)
		...
		case "enableDiagnosticSettings":
			...
			delete(rawMsg, key)
		case "enableTeamsNotification":
			err = unpopulate(val, "EnableTeamsNotification", &m.EnableTeamsNotification)
			delete(rawMsg, key)
		...
		case "storageProfile":
			...
			delete(rawMsg, key)
		case "userManagedAdxProfile":
			err = unpopulate(val, "UserManagedAdxProfile", &m.UserManagedAdxProfile)
			delete(rawMsg, key)
		case "userManagedDatabaseProfile":
			err = unpopulate(val, "UserManagedDatabaseProfile", &m.UserManagedDatabaseProfile)
			delete(rawMsg, key)
...
// MarshalJSON implements the json.Marshaller interface for type UserManagedAdxProfile.
func (u UserManagedAdxProfile) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "dataIngestionUri", u.DataIngestionURI)
	populate(objectMap, "id", u.ID)
	populate(objectMap, "uri", u.URI)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type UserManagedAdxProfile.
func (u *UserManagedAdxProfile) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", u, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "dataIngestionUri":
			err = unpopulate(val, "DataIngestionURI", &u.DataIngestionURI)
			delete(rawMsg, key)
		case "id":
...
// MarshalJSON implements the json.Marshaller interface for type UserManagedDatabaseProfile.
func (u UserManagedDatabaseProfile) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "cosmosId", u.CosmosID)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type UserManagedDatabaseProfile.
func (u *UserManagedDatabaseProfile) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", u, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "cosmosId":
			err = unpopulate(val, "CosmosID", &u.CosmosID)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", u, err)
