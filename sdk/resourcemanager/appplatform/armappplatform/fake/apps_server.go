...
func (a *AppsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if appsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = appsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to AppsServerTransport
var appsServerTransportInterceptor interface {
