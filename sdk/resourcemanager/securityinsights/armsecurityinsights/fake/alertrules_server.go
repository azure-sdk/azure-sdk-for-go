...
func (a *AlertRulesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if alertRulesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = alertRulesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to AlertRulesServerTransport
var alertRulesServerTransportInterceptor interface {
