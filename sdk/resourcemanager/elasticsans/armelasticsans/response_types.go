...
// SnapshotsClientExportResponse contains the response from method SnapshotsClient.Export.
type SnapshotsClientExportResponse struct {
	Snapshot
}
...
// SnapshotsClientListByVolumeGroupResponse contains the response from method SnapshotsClient.ListByVolumeGroup.
