...
func (p *PrivateEndpointConnectionsAdtAPIServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if privateEndpointConnectionsAdtApiServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = privateEndpointConnectionsAdtApiServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to PrivateEndpointConnectionsAdtAPIServerTransport
var privateEndpointConnectionsAdtApiServerTransportInterceptor interface {
