...
func (d DaprMetadata) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "name", d.Name)
	populate(objectMap, "secretId", d.SecretID)
...
func (e EnvironmentVar) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "name", e.Name)
	populate(objectMap, "secretId", e.SecretID)
...
func (e *EnvironmentVar) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "name":
			...
			delete(rawMsg, key)
		case "secretId":
			err = unpopulate(val, "SecretID", &e.SecretID)
			delete(rawMsg, key)
		case "secretRef":
...
// MarshalJSON implements the json.Marshaller interface for type ManagedEnvironmentSecret.
func (m ManagedEnvironmentSecret) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "id", m.ID)
	populate(objectMap, "name", m.Name)
	populate(objectMap, "properties", m.Properties)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type ManagedEnvironmentSecret.
func (m *ManagedEnvironmentSecret) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", m, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type ManagedEnvironmentSecretProperties.
func (m ManagedEnvironmentSecretProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "identity", m.Identity)
	populate(objectMap, "keyVaultUrl", m.KeyVaultURL)
	populate(objectMap, "name", m.Name)
	populate(objectMap, "value", m.Value)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ManagedEnvironmentSecretProperties.
func (m *ManagedEnvironmentSecretProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", m, err)
	}
	for key, val := range rawMsg {
		...
		case "identity":
			...
			delete(rawMsg, key)
		case "keyVaultUrl":
			err = unpopulate(val, "KeyVaultURL", &m.KeyVaultURL)
			delete(rawMsg, key)
		case "name":
			err = unpopulate(val, "Name", &m.Name)
			delete(rawMsg, key)
...
// MarshalJSON implements the json.Marshaller interface for type ManagedEnvironmentSecretsCollection.
func (m ManagedEnvironmentSecretsCollection) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "nextLink", m.NextLink)
	populate(objectMap, "value", m.Value)
	return json.Marshal(objectMap)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type ManagedEnvironmentSecretsCollection.
func (m *ManagedEnvironmentSecretsCollection) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", m, err)
	}
...
func (o OpenTelemetryConfiguration) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "includeSystemTelemetry", o.IncludeSystemTelemetry)
...
func (o *OpenTelemetryConfiguration) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "destinationsConfiguration":
			...
			delete(rawMsg, key)
		case "includeSystemTelemetry":
			err = unpopulate(val, "IncludeSystemTelemetry", &o.IncludeSystemTelemetry)
			delete(rawMsg, key)
...
func (r RegistryCredentials) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "passwordSecretId", r.PasswordSecretID)
...
func (r *RegistryCredentials) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "passwordSecretId":
			err = unpopulate(val, "PasswordSecretID", &r.PasswordSecretID)
			delete(rawMsg, key)
...
func (s ScaleRuleAuth) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "secretId", s.SecretID)
