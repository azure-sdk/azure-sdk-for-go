...
//   - storageTaskName - The name of the storage task within the specified resource group. Storage task names must be between
//     3 and 18 characters in length and use numbers and lower-case letters only.
//   - options - StorageTasksClientListOptions contains the optional parameters for the StorageTasksClient.NewListPager method.
func (client *StorageTasksClient) NewListPager(resourceGroupName string, storageTaskName string, options *StorageTasksClientListOptions) *runtime.Pager[StorageTasksClientListResponse] {
	return runtime.NewPager(runtime.PagingHandler[StorageTasksClientListResponse]{
		More: func(page StorageTasksClientListResponse) bool {
			return page.NextLink != nil && len(*page.NextLink) > 0
		},
		Fetcher: func(ctx context.Context, page *StorageTasksClientListResponse) (StorageTasksClientListResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "StorageTasksClient.NewListPager")
			nextLink := ""
			if page != nil {
			...
			if err != nil {
				return StorageTasksClientListResponse{}, err
			}
...
func (client *StorageTasksClient) listCreateRequest(ctx context.Context, resourceGroupName string, storageTaskName string, options *StorageTasksClientListOptions) (*policy.Request, error) {
...
func (client *StorageTasksClient) listHandleResponse(resp *http.Response) (StorageTasksClientListResponse, error) {
	result := StorageTasksClientListResponse{}
...
// NewStorageTaskAssignmentListPager - Lists Resource IDs of the Storage Task Assignments associated with this Storage Task.
//
// Generated from API version 2023-01-01
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - storageTaskName - The name of the storage task within the specified resource group. Storage task names must be between
//     3 and 18 characters in length and use numbers and lower-case letters only.
//   - options - StorageTasksClientStorageTaskAssignmentListOptions contains the optional parameters for the StorageTasksClient.NewStorageTaskAssignmentListPager
//     method.
func (client *StorageTasksClient) NewStorageTaskAssignmentListPager(resourceGroupName string, storageTaskName string, options *StorageTasksClientStorageTaskAssignmentListOptions) *runtime.Pager[StorageTasksClientStorageTaskAssignmentListResponse] {
	return runtime.NewPager(runtime.PagingHandler[StorageTasksClientStorageTaskAssignmentListResponse]{
		More: func(page StorageTasksClientStorageTaskAssignmentListResponse) bool {
			return page.NextLink != nil && len(*page.NextLink) > 0
		},
		Fetcher: func(ctx context.Context, page *StorageTasksClientStorageTaskAssignmentListResponse) (StorageTasksClientStorageTaskAssignmentListResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "StorageTasksClient.NewStorageTaskAssignmentListPager")
			nextLink := ""
			if page != nil {
				nextLink = *page.NextLink
			}
			resp, err := runtime.FetcherForNextLink(ctx, client.internal.Pipeline(), nextLink, func(ctx context.Context) (*policy.Request, error) {
				return client.storageTaskAssignmentListCreateRequest(ctx, resourceGroupName, storageTaskName, options)
			}, nil)
			if err != nil {
				return StorageTasksClientStorageTaskAssignmentListResponse{}, err
			}
			return client.storageTaskAssignmentListHandleResponse(resp)
		},
		Tracer: client.internal.Tracer(),
	})
}

// storageTaskAssignmentListCreateRequest creates the StorageTaskAssignmentList request.
func (client *StorageTasksClient) storageTaskAssignmentListCreateRequest(ctx context.Context, resourceGroupName string, storageTaskName string, options *StorageTasksClientStorageTaskAssignmentListOptions) (*policy.Request, error) {
...
// storageTaskAssignmentListHandleResponse handles the StorageTaskAssignmentList response.
func (client *StorageTasksClient) storageTaskAssignmentListHandleResponse(resp *http.Response) (StorageTasksClientStorageTaskAssignmentListResponse, error) {
	result := StorageTasksClientStorageTaskAssignmentListResponse{}
