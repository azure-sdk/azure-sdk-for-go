...
//     method.
func (client *ModelVersionsClient) BeginPackage(ctx context.Context, resourceGroupName string, workspaceName string, name string, version string, body any, options *ModelVersionsClientBeginPackageOptions) (*runtime.Poller[ModelVersionsClientPackageResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.packageOperation(ctx, resourceGroupName, workspaceName, name, version, body, options)
		if err != nil {
			return nil, err
		}
		return runtime.NewPoller(resp, client.pl, &runtime.NewPollerOptions[ModelVersionsClientPackageResponse]{
			FinalStateVia: runtime.FinalStateViaLocation,
		})
	} else {
		return runtime.NewPollerFromResumeToken[ModelVersionsClientPackageResponse](options.ResumeToken, client.pl, nil)
	}
}
...
//
// Generated from API version 2023-02-01-preview
func (client *ModelVersionsClient) packageOperation(ctx context.Context, resourceGroupName string, workspaceName string, name string, version string, body any, options *ModelVersionsClientBeginPackageOptions) (*http.Response, error) {
...
func (client *ModelVersionsClient) packageCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, name string, version string, body any, options *ModelVersionsClientBeginPackageOptions) (*policy.Request, error) {
