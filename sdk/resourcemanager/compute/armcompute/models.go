...
// AzureResourceManagerArmResponseSharingUpdate - Azure operation completed successfully.
type AzureResourceManagerArmResponseSharingUpdate struct {
...
// PagedVirtualMachineImageResource - Paged collection of VirtualMachineImageResource items
type PagedVirtualMachineImageResource struct {
	// REQUIRED; The VirtualMachineImageResource items on this page
