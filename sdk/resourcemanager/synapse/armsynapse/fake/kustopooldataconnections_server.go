...
func (k *KustoPoolDataConnectionsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if kustoPoolDataConnectionsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = kustoPoolDataConnectionsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			case "KustoPoolDataConnectionsClient.CheckNameAvailability":
				res.resp, res.err = k.dispatchCheckNameAvailability(req)
			...
			case "KustoPoolDataConnectionsClient.BeginDataConnectionValidation":
				res.resp, res.err = k.dispatchBeginDataConnectionValidation(req)
			...
			case "KustoPoolDataConnectionsClient.NewListByDatabasePager":
				res.resp, res.err = k.dispatchNewListByDatabasePager(req)
...
// set this to conditionally intercept incoming requests to KustoPoolDataConnectionsServerTransport
var kustoPoolDataConnectionsServerTransportInterceptor interface {
