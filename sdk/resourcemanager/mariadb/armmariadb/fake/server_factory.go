...
type ServerFactory struct {
	// AdvisorsServer contains the fakes for client AdvisorsClient
	...
	// LocationBasedPerformanceTierServer contains the fakes for client LocationBasedPerformanceTierClient
	LocationBasedPerformanceTierServer LocationBasedPerformanceTierServer

	// LocationBasedRecommendedActionSessionsOperationStatusServer contains the fakes for client LocationBasedRecommendedActionSessionsOperationStatusClient
	LocationBasedRecommendedActionSessionsOperationStatusServer LocationBasedRecommendedActionSessionsOperationStatusServer

	// LocationBasedRecommendedActionSessionsResultServer contains the fakes for client LocationBasedRecommendedActionSessionsResultClient
	...
	// QueryTextsServer contains the fakes for client QueryTextsClient
	QueryTextsServer QueryTextsServer

	// RecommendedActionsServer contains the fakes for client RecommendedActionsClient
	RecommendedActionsServer RecommendedActionsServer

	// RecoverableServersServer contains the fakes for client RecoverableServersClient
	...
	// ServerBasedPerformanceTierServer contains the fakes for client ServerBasedPerformanceTierClient
	ServerBasedPerformanceTierServer ServerBasedPerformanceTierServer

	// ServerParametersServer contains the fakes for client ServerParametersClient
	...
	// TopQueryStatisticsServer contains the fakes for client TopQueryStatisticsClient
	...
	// WaitStatisticsServer contains the fakes for client WaitStatisticsClient
