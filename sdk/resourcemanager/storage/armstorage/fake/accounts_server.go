...
type AccountsServerTransport struct {
	...
	beginCustomerInitiatedMigration          *azfake.PollerResponder[armstorage.AccountsClientCustomerInitiatedMigrationResponse]
...
func (a *AccountsServerTransport) dispatchBeginCustomerInitiatedMigration(req *http.Request) (*http.Response, error) {
	...
	if a.beginCustomerInitiatedMigration == nil {
		...
		a.beginCustomerInitiatedMigration = &respr
	}

	resp, err := server.PollerResponderNext(a.beginCustomerInitiatedMigration, req)
	if err != nil {
		return nil, err
	}
	...
	if !server.PollerResponderMore(a.beginCustomerInitiatedMigration) {
		a.beginCustomerInitiatedMigration = nil
	}
