...
func (client *ConfigurationGroupSchemasClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, publisherName string, configurationGroupSchemaName string, parameters ConfigurationGroupSchema, _ *ConfigurationGroupSchemasClientBeginCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *ConfigurationGroupSchemasClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, publisherName string, configurationGroupSchemaName string, _ *ConfigurationGroupSchemasClientBeginDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HybridNetwork/publishers/{publisherName}/configurationGroupSchemas/{configurationGroupSchemaName}"
	if resourceGroupName == "" {
		return nil, errors.New("parameter resourceGroupName cannot be empty")
	}
...
func (client *ConfigurationGroupSchemasClient) getCreateRequest(ctx context.Context, resourceGroupName string, publisherName string, configurationGroupSchemaName string, _ *ConfigurationGroupSchemasClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HybridNetwork/publishers/{publisherName}/configurationGroupSchemas/{configurationGroupSchemaName}"
	if resourceGroupName == "" {
		return nil, errors.New("parameter resourceGroupName cannot be empty")
	}
...
func (client *ConfigurationGroupSchemasClient) listByPublisherCreateRequest(ctx context.Context, resourceGroupName string, publisherName string, _ *ConfigurationGroupSchemasClientListByPublisherOptions) (*policy.Request, error) {
...
func (client *ConfigurationGroupSchemasClient) updateCreateRequest(ctx context.Context, resourceGroupName string, publisherName string, configurationGroupSchemaName string, parameters TagsObject, _ *ConfigurationGroupSchemasClientUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HybridNetwork/publishers/{publisherName}/configurationGroupSchemas/{configurationGroupSchemaName}"
	if resourceGroupName == "" {
		return nil, errors.New("parameter resourceGroupName cannot be empty")
	}
...
func (client *ConfigurationGroupSchemasClient) updateStateCreateRequest(ctx context.Context, resourceGroupName string, publisherName string, configurationGroupSchemaName string, parameters ConfigurationGroupSchemaVersionUpdateState, _ *ConfigurationGroupSchemasClientBeginUpdateStateOptions) (*policy.Request, error) {
