...
func (b *BuildServiceBuilderServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if buildServiceBuilderServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = buildServiceBuilderServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "BuildServiceBuilderClient.ListDeployments":
				res.resp, res.err = b.dispatchListDeployments(req)
			default:
...
// set this to conditionally intercept incoming requests to BuildServiceBuilderServerTransport
var buildServiceBuilderServerTransportInterceptor interface {
