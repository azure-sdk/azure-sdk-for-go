...
type WorkloadNetworksServer struct {
	...
	// HTTP status codes to indicate success: http.StatusOK
	NewListByPrivateCloudPager func(resourceGroupName string, privateCloudName string, options *armavs.WorkloadNetworksClientListByPrivateCloudOptions) (resp azfake.PagerResponder[armavs.WorkloadNetworksClientListByPrivateCloudResponse])
}
...
func (w *WorkloadNetworksServerTransport) dispatchNewListByPrivateCloudPager(req *http.Request) (*http.Response, error) {
	...
	if newListByPrivateCloudPager == nil {
		...
		resp := w.srv.NewListByPrivateCloudPager(resourceGroupNameParam, privateCloudNameParam, nil)
