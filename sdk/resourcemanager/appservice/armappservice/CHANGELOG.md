...
- Field `Kind` of struct `AseV3NetworkingConfiguration` has been removed
- Field `Kind` of struct `CustomDNSSuffixConfiguration` has been removed
...
- New value `CustomDNSSuffixProvisioningStateCanceled` added to enum type `CustomDNSSuffixProvisioningState`
...
- New struct `AseV3NetworkingConfigurationResource`
- New struct `CustomDNSSuffixConfigurationResource`
