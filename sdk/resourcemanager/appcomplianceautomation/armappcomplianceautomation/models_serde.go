...
// MarshalJSON implements the json.Marshaller interface for type SnapshotDownloadProperties.
func (s SnapshotDownloadProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
...
// UnmarshalJSON implements the json.Unmarshaller interface for type SnapshotDownloadProperties.
func (s *SnapshotDownloadProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
