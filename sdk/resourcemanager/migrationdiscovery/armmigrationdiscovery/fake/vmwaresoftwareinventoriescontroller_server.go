...
// VmwareSoftwareInventoriesControllerServer is a fake server for instances of the armmigrationdiscovery.VmwareSoftwareInventoriesControllerClient type.
type VmwareSoftwareInventoriesControllerServer struct {
	...
	GetMachineSoftwareInventory func(ctx context.Context, resourceGroupName string, siteName string, machineName string, defaultParam armmigrationdiscovery.Default, options *armmigrationdiscovery.VmwareSoftwareInventoriesControllerClientGetMachineSoftwareInventoryOptions) (resp azfake.Responder[armmigrationdiscovery.VmwareSoftwareInventoriesControllerClientGetMachineSoftwareInventoryResponse], errResp azfake.ErrorResponder)
	...
	// HTTP status codes to indicate success: http.StatusOK
	NewListByMachineResourcePager func(resourceGroupName string, siteName string, machineName string, options *armmigrationdiscovery.VmwareSoftwareInventoriesControllerClientListByMachineResourceOptions) (resp azfake.PagerResponder[armmigrationdiscovery.VmwareSoftwareInventoriesControllerClientListByMachineResourceResponse])
}
...
// The returned VmwareSoftwareInventoriesControllerServerTransport instance is connected to an instance of armmigrationdiscovery.VmwareSoftwareInventoriesControllerClient via the
...
func NewVmwareSoftwareInventoriesControllerServerTransport(srv *VmwareSoftwareInventoriesControllerServer) *VmwareSoftwareInventoriesControllerServerTransport {
	return &VmwareSoftwareInventoriesControllerServerTransport{
		srv:                           srv,
		newListByMachineResourcePager: newTracker[azfake.PagerResponder[armmigrationdiscovery.VmwareSoftwareInventoriesControllerClientListByMachineResourceResponse]](),
	}
}

// VmwareSoftwareInventoriesControllerServerTransport connects instances of armmigrationdiscovery.VmwareSoftwareInventoriesControllerClient to instances of VmwareSoftwareInventoriesControllerServer.
...
type VmwareSoftwareInventoriesControllerServerTransport struct {
	...
	newListByMachineResourcePager *tracker[azfake.PagerResponder[armmigrationdiscovery.VmwareSoftwareInventoriesControllerClientListByMachineResourceResponse]]
}
...
func (v *VmwareSoftwareInventoriesControllerServerTransport) dispatchNewListByMachineResourcePager(req *http.Request) (*http.Response, error) {
	...
	if newListByMachineResourcePager == nil {
		...
		server.PagerResponderInjectNextLinks(newListByMachineResourcePager, req, func(page *armmigrationdiscovery.VmwareSoftwareInventoriesControllerClientListByMachineResourceResponse, createLink func() string) {
