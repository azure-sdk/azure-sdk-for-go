...
func (c *ControllerServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if controllerServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = controllerServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "ControllerClient.GetDetails":
				res.resp, res.err = c.dispatchGetDetails(req)
...
// set this to conditionally intercept incoming requests to ControllerServerTransport
var controllerServerTransportInterceptor interface {
