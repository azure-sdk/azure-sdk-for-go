...
// Generated from API version 2023-04-01-preview
//   - resourceURI - The fully qualified Azure Resource manager identifier of the Hybrid Compute machine resource to be extended.
//   - options - VirtualMachineInstancesClientListOptions contains the optional parameters for the VirtualMachineInstancesClient.List
//     method.
func (client *VirtualMachineInstancesClient) List(ctx context.Context, resourceURI string, options *VirtualMachineInstancesClientListOptions) (VirtualMachineInstancesClientListResponse, error) {
	var err error
