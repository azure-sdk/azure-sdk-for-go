...
type ExportDeliveryDestination struct {
	...
	// REQUIRED; The name of the directory where exports will be uploaded. Use a period (.) to target the root of directory.
...
type SavingsPlanUtilizationSummaryProperties struct {
	...
	// Suppose the API call is for usageDate > 2023-08-01 and usageDate < 2022-10-31 at a daily
...
type TagInheritanceProperties struct {
	// REQUIRED; When resource has the same tag as subscription or resource group and this property is set to true - the subscription
	// or resource group tag will be applied. If subscription and resource group tags are
	// also the same, subscription tag will be applied.
