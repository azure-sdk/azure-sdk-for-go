...
// Get get a pipeline step run from a pipeline run
// Parameters:
// resourceGroupName - the resource group name.
// workspaceName - the name of the workspace.
// pipelineRunName - the name of the pipeline run.
// pipelineStepRunName - the name of the pipeline step run.
func (client PipelineStepRunsClient) Get(ctx context.Context, resourceGroupName string, workspaceName string, pipelineRunName string, pipelineStepRunName string) (result PipelineStepRun, err error) {
	...
	req, err := client.GetPreparer(ctx, resourceGroupName, workspaceName, pipelineRunName, pipelineStepRunName)
	if err != nil {
...
func (client PipelineStepRunsClient) GetPreparer(ctx context.Context, resourceGroupName string, workspaceName string, pipelineRunName string, pipelineStepRunName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"pipelineRunName":     autorest.Encode("path", pipelineRunName),
		"pipelineStepRunName": autorest.Encode("path", pipelineStepRunName),
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithPathParameters("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataCollaboration/workspaces/{workspaceName}/pipelineRuns/{pipelineRunName}/pipelineStepRuns/{pipelineStepRunName}", pathParameters),
...
// ListByPipelineRun list all step runs in a pipeline run
// Parameters:
// resourceGroupName - the resource group name.
// workspaceName - the name of the workspace.
// pipelineRunName - the name of the pipeline run.
// skipToken - continuation token
func (client PipelineStepRunsClient) ListByPipelineRun(ctx context.Context, resourceGroupName string, workspaceName string, pipelineRunName string, skipToken string) (result PipelineStepRunListPage, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.ListByPipelineRunPreparer(ctx, resourceGroupName, workspaceName, pipelineRunName, skipToken)
	if err != nil {
	...
	if result.psrl.hasNextLink() && result.psrl.IsEmpty() {
...
func (client PipelineStepRunsClient) ListByPipelineRunPreparer(ctx context.Context, resourceGroupName string, workspaceName string, pipelineRunName string, skipToken string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"pipelineRunName":   autorest.Encode("path", pipelineRunName),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"subscriptionId":    autorest.Encode("path", client.SubscriptionID),
	...
	preparer := autorest.CreatePreparer(
		autorest.AsGet(),
		autorest.WithBaseURL(client.BaseURI),
		autorest.WithPathParameters("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataCollaboration/workspaces/{workspaceName}/pipelineRuns/{pipelineRunName}/pipelineStepRuns", pathParameters),
		autorest.WithQueryParameters(queryParameters))
	return preparer.Prepare((&http.Request{}).WithContext(ctx))
}
...
func (client PipelineStepRunsClient) ListByPipelineRunComplete(ctx context.Context, resourceGroupName string, workspaceName string, pipelineRunName string, skipToken string) (result PipelineStepRunListIterator, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/PipelineStepRunsClient.ListByPipelineRun")
		defer func() {
			sc := -1
	...
	result.page, err = client.ListByPipelineRun(ctx, resourceGroupName, workspaceName, pipelineRunName, skipToken)
	return
}
