...
//     method.
func (client *VaultsClient) BeginCreateOrUpdate(ctx context.Context, resourceGroupName string, vaultName string, parameters Vault, options *VaultsClientBeginCreateOrUpdateOptions) (*runtime.Poller[VaultsClientCreateOrUpdateResponse], error) {
...
//
// Generated from API version 2024-11-01
func (client *VaultsClient) createOrUpdate(ctx context.Context, resourceGroupName string, vaultName string, parameters Vault, options *VaultsClientBeginCreateOrUpdateOptions) (*http.Response, error) {
	var err error
...
func (client *VaultsClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, vaultName string, parameters Vault, _ *VaultsClientBeginCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *VaultsClient) listDeletedCreateRequest(ctx context.Context, _ *VaultsClientListDeletedOptions) (*policy.Request, error) {
