...
// IntegrationServiceEnvironmentNetworkHealthClient contains the methods for the IntegrationServiceEnvironmentNetworkHealth
// group.
...
//     method.
func (client *IntegrationServiceEnvironmentNetworkHealthClient) Get(ctx context.Context, integrationServiceEnvironmentName string, options *IntegrationServiceEnvironmentNetworkHealthClientGetOptions) (IntegrationServiceEnvironmentNetworkHealthClientGetResponse, error) {
	var err error
...
func (client *IntegrationServiceEnvironmentNetworkHealthClient) getCreateRequest(ctx context.Context, integrationServiceEnvironmentName string, _ *IntegrationServiceEnvironmentNetworkHealthClientGetOptions) (*policy.Request, error) {
