...
// AppSpaceResourceLabel - Label indicating if a resource is a Favorite or not. Default is not favorite.
type AppSpaceResourceLabel string

const (
	AppSpaceResourceLabelDefault  AppSpaceResourceLabel = "Default"
	AppSpaceResourceLabelFavorite AppSpaceResourceLabel = "Favorite"
)

// PossibleAppSpaceResourceLabelValues returns the possible values for the AppSpaceResourceLabel const type.
func PossibleAppSpaceResourceLabelValues() []AppSpaceResourceLabel {
	return []AppSpaceResourceLabel{
		AppSpaceResourceLabelDefault,
		AppSpaceResourceLabelFavorite,
	}
}
