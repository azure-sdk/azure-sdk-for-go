...
// GuestAgentsClient contains the methods for the Microsoft.ScVmm namespace.
...
// BeginCreate - Implements GuestAgent PUT method.
...
// Create - Implements GuestAgent PUT method.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2023-10-07
...
// Delete - Deletes a GuestAgent resource.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2023-10-07
//   - resourceURI - The fully qualified Azure Resource manager identifier of the resource.
...
func (client *GuestAgentsClient) deleteCreateRequest(ctx context.Context, resourceURI string, _ *GuestAgentsClientDeleteOptions) (*policy.Request, error) {
	urlPath := "/{resourceUri}/providers/Microsoft.ScVmm/virtualMachineInstances/default/guestAgents/default"
	if resourceURI == "" {
		return nil, errors.New("parameter resourceURI cannot be empty")
	}
...
// NewListByVirtualMachineInstancePager - Implements GET GuestAgent in a vm.
//
// Generated from API version 2023-10-07
//   - resourceURI - The fully qualified Azure Resource manager identifier of the resource.
