...
func (client *ServiceRunnersClient) BeginCreateOrUpdate(ctx context.Context, resourceGroupName string, labName string, name string, serviceRunner ServiceRunner, options *ServiceRunnersClientBeginCreateOrUpdateOptions) (*runtime.Poller[ServiceRunnersClientCreateOrUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return runtime.NewPoller[ServiceRunnersClientCreateOrUpdateResponse](resp, client.pl, nil)
	} else {
		return runtime.NewPollerFromResumeToken[ServiceRunnersClientCreateOrUpdateResponse](options.ResumeToken, client.pl, nil)
	}
}
...
func (client *ServiceRunnersClient) BeginDelete(ctx context.Context, resourceGroupName string, labName string, name string, options *ServiceRunnersClientBeginDeleteOptions) (*runtime.Poller[ServiceRunnersClientDeleteResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return runtime.NewPoller[ServiceRunnersClientDeleteResponse](resp, client.pl, nil)
	} else {
		return runtime.NewPollerFromResumeToken[ServiceRunnersClientDeleteResponse](options.ResumeToken, client.pl, nil)
	}
}
...
// resourceGroupName - The name of the resource group.
// labName - The name of the lab.
// options - ServiceRunnersClientListOptions contains the optional parameters for the ServiceRunnersClient.List method.
