...
//   - elasticSanName - The name of the ElasticSan.
//   - volumeGroupName - The name of the VolumeGroup.
//   - parameters - Volume Name List
//   - options - VolumeGroupsClientBeginPreBackupOptions contains the optional parameters for the VolumeGroupsClient.BeginPreBackup
//     method.
func (client *VolumeGroupsClient) BeginPreBackup(ctx context.Context, resourceGroupName string, elasticSanName string, volumeGroupName string, parameters VolumeNameList, options *VolumeGroupsClientBeginPreBackupOptions) (*runtime.Poller[VolumeGroupsClientPreBackupResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.preBackup(ctx, resourceGroupName, elasticSanName, volumeGroupName, parameters, options)
		if err != nil {
			return nil, err
		}
		poller, err := runtime.NewPoller(resp, client.internal.Pipeline(), &runtime.NewPollerOptions[VolumeGroupsClientPreBackupResponse]{
			FinalStateVia: runtime.FinalStateViaLocation,
			Tracer:        client.internal.Tracer(),
		})
		return poller, err
	} else {
		return runtime.NewPollerFromResumeToken(options.ResumeToken, client.internal.Pipeline(), &runtime.NewPollerFromResumeTokenOptions[VolumeGroupsClientPreBackupResponse]{
			Tracer: client.internal.Tracer(),
		})
	}
}
...
//
// Generated from API version 2025-03-01
func (client *VolumeGroupsClient) preBackup(ctx context.Context, resourceGroupName string, elasticSanName string, volumeGroupName string, parameters VolumeNameList, options *VolumeGroupsClientBeginPreBackupOptions) (*http.Response, error) {
	var err error
	const operationName = "VolumeGroupsClient.BeginPreBackup"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
...
func (client *VolumeGroupsClient) preBackupCreateRequest(ctx context.Context, resourceGroupName string, elasticSanName string, volumeGroupName string, parameters VolumeNameList, _ *VolumeGroupsClientBeginPreBackupOptions) (*policy.Request, error) {
...
//   - elasticSanName - The name of the ElasticSan.
//   - volumeGroupName - The name of the VolumeGroup.
//   - parameters - Disk Snapshot List
//   - options - VolumeGroupsClientBeginPreRestoreOptions contains the optional parameters for the VolumeGroupsClient.BeginPreRestore
//     method.
func (client *VolumeGroupsClient) BeginPreRestore(ctx context.Context, resourceGroupName string, elasticSanName string, volumeGroupName string, parameters DiskSnapshotList, options *VolumeGroupsClientBeginPreRestoreOptions) (*runtime.Poller[VolumeGroupsClientPreRestoreResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.preRestore(ctx, resourceGroupName, elasticSanName, volumeGroupName, parameters, options)
		if err != nil {
			return nil, err
		}
		poller, err := runtime.NewPoller(resp, client.internal.Pipeline(), &runtime.NewPollerOptions[VolumeGroupsClientPreRestoreResponse]{
			FinalStateVia: runtime.FinalStateViaLocation,
			Tracer:        client.internal.Tracer(),
		})
		return poller, err
	} else {
		return runtime.NewPollerFromResumeToken(options.ResumeToken, client.internal.Pipeline(), &runtime.NewPollerFromResumeTokenOptions[VolumeGroupsClientPreRestoreResponse]{
			Tracer: client.internal.Tracer(),
		})
	}
}
...
//
// Generated from API version 2025-03-01
func (client *VolumeGroupsClient) preRestore(ctx context.Context, resourceGroupName string, elasticSanName string, volumeGroupName string, parameters DiskSnapshotList, options *VolumeGroupsClientBeginPreRestoreOptions) (*http.Response, error) {
	var err error
	const operationName = "VolumeGroupsClient.BeginPreRestore"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
...
func (client *VolumeGroupsClient) preRestoreCreateRequest(ctx context.Context, resourceGroupName string, elasticSanName string, volumeGroupName string, parameters DiskSnapshotList, _ *VolumeGroupsClientBeginPreRestoreOptions) (*policy.Request, error) {
