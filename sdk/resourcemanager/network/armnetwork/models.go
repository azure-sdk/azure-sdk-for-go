...
type VirtualNetworkEncryption struct {
	...
	// If the encrypted VNet allows VM that does not support encryption. This field is for future support, only supported value
	// at this time is AllowUnencrypted
