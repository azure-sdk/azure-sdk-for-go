...
func (c *CommunicationsNoSubscriptionServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if communicationsNoSubscriptionServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = communicationsNoSubscriptionServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to CommunicationsNoSubscriptionServerTransport
var communicationsNoSubscriptionServerTransportInterceptor interface {
