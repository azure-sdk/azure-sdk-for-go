...
- New enum type `ModelName` with values `ModelNameDataBox`, `ModelNameDataBoxCustomerDisk`, `ModelNameDataBoxDisk`, `ModelNameDataBoxHeavy`, `ModelNameDataBoxV2X100`, `ModelNameDataBoxV2X500`
