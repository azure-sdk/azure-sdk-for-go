...
func (w *WidgetTypesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if widgetTypesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = widgetTypesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "WidgetTypesClient.NewListByHubPager":
				res.resp, res.err = w.dispatchNewListByHubPager(req)
			default:
...
// set this to conditionally intercept incoming requests to WidgetTypesServerTransport
var widgetTypesServerTransportInterceptor interface {
