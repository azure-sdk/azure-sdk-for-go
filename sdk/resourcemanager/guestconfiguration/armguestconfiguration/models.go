...
// AssignmentsClientVMHealthCheckOptions contains the optional parameters for the AssignmentsClient.VMHealthCheck method.
type AssignmentsClientVMHealthCheckOptions struct {
	// placeholder for future optional parameters
}
...
// HealthCheckAssignment - List all policy assignments with detailed properties on the VM
type HealthCheckAssignment struct {
	// Available in Azure Policy
	AvailableInAzurePolicy *bool `json:"availableInAzurePolicy,omitempty"`

	// Available In Data Plane
	AvailableInDataPlane *bool `json:"availableInDataPlane,omitempty"`

	// Configuration Name
	ConfigurationName *string `json:"configurationName,omitempty"`

	// Guest Configuration Assignment Name
	GuestConfigurationAssignmentName *string `json:"guestConfigurationAssignmentName,omitempty"`

	// Policy Visibility to ARM In Data plane
	IsVisibleToArmInDp *bool `json:"isVisibleToArmInDp,omitempty"`
	...
	// The guest configuration to assign.
	PolicyConfigurationParameters *Navigation `json:"policyConfigurationParameters,omitempty"`
	...
	// READ-ONLY; A value indicating compliance status of the machine for the assigned guest configuration in Data Plane
	ComplianceStatusInDp *ComplianceStatus `json:"complianceStatusInDp,omitempty" azure:"ro"`
	...
	PolicyAssignmentParameters interface{} `json:"policyAssignmentParameters,omitempty" azure:"ro"`
}
...
// VMHealthCheckProperties - Get the VM Health Details (policy assignments)
type VMHealthCheckProperties struct {
	// List of policy assignment details on the VM
	Assignments []*HealthCheckAssignment `json:"assignments,omitempty"`

	// Installation status for Guest Configuration extension on VM
	IsGcExtensionInstalled *bool `json:"isGcExtensionInstalled,omitempty"`

	// MSI enablement status on VM
	IsMsiEnabled *bool `json:"isMsiEnabled,omitempty"`
}
