...
func (client *SQLPoolSchemasClient) getCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, sqlPoolName string, schemaName string, _ *SQLPoolSchemasClientGetOptions) (*policy.Request, error) {
