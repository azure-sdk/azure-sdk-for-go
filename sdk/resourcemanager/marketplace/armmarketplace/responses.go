...
// RPServiceClientPrivateStoreCollectionOfferPlansListResponse contains the response from method RPServiceClient.PrivateStoreCollectionOfferPlansList.
type RPServiceClientPrivateStoreCollectionOfferPlansListResponse struct {
	PlanListResponse
}
