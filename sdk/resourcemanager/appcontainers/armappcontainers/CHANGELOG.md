...
- New function `*JobsExecutionsClient.BeginList(context.Context, string, string, *JobsExecutionsClientBeginListOptions) (*runtime.Poller[*runtime.Pager[JobsExecutionsClientListResponse]], error)`
...
- New struct `JobsExecutionsClient`
- New struct `JobsExecutionsClientListResponse`
