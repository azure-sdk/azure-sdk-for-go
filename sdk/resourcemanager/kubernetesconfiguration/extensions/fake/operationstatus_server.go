...
// OperationStatusServer is a fake server for instances of the extensions.OperationStatusClient type.
type OperationStatusServer struct {
	// Get is the fake for method OperationStatusClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, clusterRp string, clusterResourceName string, clusterName string, extensionName string, operationID string, options *extensions.OperationStatusClientGetOptions) (resp azfake.Responder[extensions.OperationStatusClientGetResponse], errResp azfake.ErrorResponder)
}
...
// The returned OperationStatusServerTransport instance is connected to an instance of extensions.OperationStatusClient via the
...
// OperationStatusServerTransport connects instances of extensions.OperationStatusClient to instances of OperationStatusServer.
