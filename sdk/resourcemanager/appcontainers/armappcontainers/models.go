...
// ContainerAppsJobTemplate - Container Apps Job versioned application definition. Defines the desired state of an immutable
// revision. Any changes to this section Will result in a new revision being created
type ContainerAppsJobTemplate struct {
