...
// AppResiliencyClientPatchOptions contains the optional parameters for the AppResiliencyClient.Patch method.
type AppResiliencyClientPatchOptions struct {
	// placeholder for future optional parameters
}
...
// JobsClientProxyListOptions contains the optional parameters for the JobsClient.ProxyList method.
type JobsClientProxyListOptions struct {
	// placeholder for future optional parameters
}
