...
// MarshalJSON implements the json.Marshaller interface for type BenefitsUtilizationSummariesOperationStatus.
func (b BenefitsUtilizationSummariesOperationStatus) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
...
// UnmarshalJSON implements the json.Unmarshaller interface for type BenefitsUtilizationSummariesOperationStatus.
func (b *BenefitsUtilizationSummariesOperationStatus) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
...
// MarshalJSON implements the json.Marshaller interface for type BenefitsUtilizationSummariesReportURL.
func (b BenefitsUtilizationSummariesReportURL) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "reportUrl", b.ReportURL)
	populateTimeRFC3339(objectMap, "validUntil", b.ValidUntil)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type BenefitsUtilizationSummariesReportURL.
func (b *BenefitsUtilizationSummariesReportURL) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", b, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "reportUrl":
			err = unpopulate(val, "ReportURL", &b.ReportURL)
			delete(rawMsg, key)
		case "validUntil":
			err = unpopulateTimeRFC3339(val, "ValidUntil", &b.ValidUntil)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", b, err)
...
func (m MarkupRuleProperties) MarshalJSON() ([]byte, error) {
	...
	populateTimeRFC3339(objectMap, "endDate", m.EndDate)
	populate(objectMap, "percentage", m.Percentage)
	populateTimeRFC3339(objectMap, "startDate", m.StartDate)
	return json.Marshal(objectMap)
}
...
func (m *MarkupRuleProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "description":
			...
			delete(rawMsg, key)
		case "endDate":
			err = unpopulateTimeRFC3339(val, "EndDate", &m.EndDate)
			delete(rawMsg, key)
		case "percentage":
			err = unpopulate(val, "Percentage", &m.Percentage)
			delete(rawMsg, key)
		case "startDate":
			err = unpopulateTimeRFC3339(val, "StartDate", &m.StartDate)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", m, err)
