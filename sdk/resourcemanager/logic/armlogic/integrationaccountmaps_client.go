...
func (client *IntegrationAccountMapsClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, integrationAccountName string, mapName string, mapParam IntegrationAccountMap, _ *IntegrationAccountMapsClientCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *IntegrationAccountMapsClient) listContentCallbackURLCreateRequest(ctx context.Context, resourceGroupName string, integrationAccountName string, mapName string, listContentCallbackURL GetCallbackURLParameters, _ *IntegrationAccountMapsClientListContentCallbackURLOptions) (*policy.Request, error) {
