...
// BeginCreate - Creates the landing zone registration.
...
// Create - Creates the landing zone registration.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2025-02-27-preview
...
// Delete - Deletes the landing zone registration.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2025-02-27-preview
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
...
func (client *LandingZoneRegistrationOperationsClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, landingZoneAccountName string, landingZoneRegistrationName string, options *LandingZoneRegistrationOperationsClientDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sovereign/landingZoneAccounts/{landingZoneAccountName}/landingZoneRegistrations/{landingZoneRegistrationName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
// Get - Gets the landing zone registration.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2025-02-27-preview
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
...
func (client *LandingZoneRegistrationOperationsClient) getCreateRequest(ctx context.Context, resourceGroupName string, landingZoneAccountName string, landingZoneRegistrationName string, options *LandingZoneRegistrationOperationsClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sovereign/landingZoneAccounts/{landingZoneAccountName}/landingZoneRegistrations/{landingZoneRegistrationName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
// NewListByResourceGroupPager - Lists the landing zone registrations within a resource group.
//
// Generated from API version 2025-02-27-preview
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - landingZoneAccountName - The parent landing zone account
...
func (client *LandingZoneRegistrationOperationsClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, landingZoneAccountName string, options *LandingZoneRegistrationOperationsClientListByResourceGroupOptions) (*policy.Request, error) {
...
// NewListBySubscriptionPager - Lists the landing zone registrations within a subscription.
//
// Generated from API version 2025-02-27-preview
//   - landingZoneAccountName - The parent landing zone account
...
func (client *LandingZoneRegistrationOperationsClient) listBySubscriptionCreateRequest(ctx context.Context, landingZoneAccountName string, options *LandingZoneRegistrationOperationsClientListBySubscriptionOptions) (*policy.Request, error) {
...
// BeginUpdate - Updates the landing zone registration.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2025-02-27-preview
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
...
// Update - Updates the landing zone registration.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2025-02-27-preview
...
func (client *LandingZoneRegistrationOperationsClient) updateCreateRequest(ctx context.Context, resourceGroupName string, landingZoneAccountName string, landingZoneRegistrationName string, properties LandingZoneRegistrationResourceUpdate, options *LandingZoneRegistrationOperationsClientBeginUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sovereign/landingZoneAccounts/{landingZoneAccountName}/landingZoneRegistrations/{landingZoneRegistrationName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
