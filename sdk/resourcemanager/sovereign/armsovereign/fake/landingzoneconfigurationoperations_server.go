...
type LandingZoneConfigurationOperationsServer struct {
	...
	// NewListPager is the fake for method LandingZoneConfigurationOperationsClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(resourceGroupName string, landingZoneAccountName string, options *armsovereign.LandingZoneConfigurationOperationsClientListOptions) (resp azfake.PagerResponder[armsovereign.LandingZoneConfigurationOperationsClientListResponse])
...
func NewLandingZoneConfigurationOperationsServerTransport(srv *LandingZoneConfigurationOperationsServer) *LandingZoneConfigurationOperationsServerTransport {
	return &LandingZoneConfigurationOperationsServerTransport{
		...
		newListPager:               newTracker[azfake.PagerResponder[armsovereign.LandingZoneConfigurationOperationsClientListResponse]](),
...
type LandingZoneConfigurationOperationsServerTransport struct {
	...
	newListPager               *tracker[azfake.PagerResponder[armsovereign.LandingZoneConfigurationOperationsClientListResponse]]
...
func (l *LandingZoneConfigurationOperationsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		if !intercepted {
			...
			case "LandingZoneConfigurationOperationsClient.NewListPager":
...
func (l *LandingZoneConfigurationOperationsServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armsovereign.LandingZoneConfigurationOperationsClientListResponse, createLink func() string) {
