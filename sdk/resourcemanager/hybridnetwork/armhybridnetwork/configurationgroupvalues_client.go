...
func (client *ConfigurationGroupValuesClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, configurationGroupValueName string, parameters ConfigurationGroupValue, _ *ConfigurationGroupValuesClientBeginCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *ConfigurationGroupValuesClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, configurationGroupValueName string, _ *ConfigurationGroupValuesClientBeginDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HybridNetwork/configurationGroupValues/{configurationGroupValueName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *ConfigurationGroupValuesClient) getCreateRequest(ctx context.Context, resourceGroupName string, configurationGroupValueName string, _ *ConfigurationGroupValuesClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HybridNetwork/configurationGroupValues/{configurationGroupValueName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *ConfigurationGroupValuesClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, _ *ConfigurationGroupValuesClientListByResourceGroupOptions) (*policy.Request, error) {
...
func (client *ConfigurationGroupValuesClient) listBySubscriptionCreateRequest(ctx context.Context, _ *ConfigurationGroupValuesClientListBySubscriptionOptions) (*policy.Request, error) {
...
func (client *ConfigurationGroupValuesClient) updateTagsCreateRequest(ctx context.Context, resourceGroupName string, configurationGroupValueName string, parameters TagsObject, _ *ConfigurationGroupValuesClientUpdateTagsOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HybridNetwork/configurationGroupValues/{configurationGroupValueName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
