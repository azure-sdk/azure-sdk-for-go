...
// DetailsBaseClassification provides polymorphic access to related types.
// Call the interface's GetDetailsBase() method to access the common type.
// Use a type switch to determine the concrete type.  The possible types are:
// - *AbnormalEventDetails, *AzureMetricDetails, *DetailsBase, *DiagnosticsSolutionDetails, *InvestigationDetails, *RelatedAlertDetails,
// - *ResourceHealthDetails
type DetailsBaseClassification interface {
	// GetDetailsBase returns the DetailsBase content of the underlying type.
