...
// MarshalJSON implements the json.Marshaller interface for type PlanListResponse.
func (p PlanListResponse) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type PlanListResponse.
