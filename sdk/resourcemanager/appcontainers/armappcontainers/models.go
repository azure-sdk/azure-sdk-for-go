...
type ManagedEnvironmentProperties struct {
	...
	Quotas *ManagedEnvironmentQuota `json:"quotas,omitempty"`
...
// ManagedEnvironmentQuota - Managed environment quota status
type ManagedEnvironmentQuota struct {
	// The cores quota status
	Cores *QuotaStatus `json:"cores,omitempty"`
}
...
type QuotaStatus struct {
	// READ-ONLY; Total quota amount
	Total *float64 `json:"total,omitempty" azure:"ro"`

	// READ-ONLY; Used quota amount
	Used *float64 `json:"used,omitempty" azure:"ro"`
}
