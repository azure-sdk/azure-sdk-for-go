...
func (e *EventSourcesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if eventSourcesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = eventSourcesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "EventSourcesClient.ListByEnvironment":
				res.resp, res.err = e.dispatchListByEnvironment(req)
...
// set this to conditionally intercept incoming requests to EventSourcesServerTransport
var eventSourcesServerTransportInterceptor interface {
