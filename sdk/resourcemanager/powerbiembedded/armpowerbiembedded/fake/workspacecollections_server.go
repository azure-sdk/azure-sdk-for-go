...
func (w *WorkspaceCollectionsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if workspaceCollectionsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = workspaceCollectionsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "WorkspaceCollectionsClient.GetAccessKeys":
				res.resp, res.err = w.dispatchGetAccessKeys(req)
			case "WorkspaceCollectionsClient.GetByName":
				res.resp, res.err = w.dispatchGetByName(req)
			...
			case "WorkspaceCollectionsClient.Migrate":
				res.resp, res.err = w.dispatchMigrate(req)
			case "WorkspaceCollectionsClient.RegenerateKey":
				res.resp, res.err = w.dispatchRegenerateKey(req)
...
// set this to conditionally intercept incoming requests to WorkspaceCollectionsServerTransport
var workspaceCollectionsServerTransportInterceptor interface {
