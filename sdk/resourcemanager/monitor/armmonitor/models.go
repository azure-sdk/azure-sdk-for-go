...
type AzureMonitorWorkspace struct {
	...
	// READ-ONLY; Gets or sets allow or disallow public network access to Azure Monitor Workspace
...
type DataCollectionEndpoint struct {
	...
	// Failover configuration on this endpoint. This property can only be updated by Log Analytics Control Plane (LACP) for DCE
	// with Log Analytics Destination
	...
	// Metadata for the resource. This property can only be updated by Log Analytics Control Plane (LACP) for DCE with Log Analytics
	// Destination
...
// DataCollectionEndpointFailoverConfiguration - Failover configuration on this endpoint. This property can only be updated
...
// ErrorResponseAutoGenerated4 - The error response.
...
// MetadataAutoGenerated - Metadata about the resource
type MetadataAutoGenerated struct {
	// READ-ONLY; Azure offering managing this resource on-behalf-of customer.
	ProvisionedBy *string
...
// MetadataAutoGenerated2 - Metadata about the resource
type MetadataAutoGenerated2 struct {
	// READ-ONLY; Azure offering managing this resource on-behalf-of customer.
	ProvisionedBy *string
...
// ResourceForUpdateAutoGenerated - Definition of ARM tracked top level resource properties for update operation.
type ResourceForUpdateAutoGenerated struct {
	// Managed Service Identity.
	Identity *ResourceForUpdateIdentity
...
type ResourceForUpdateDceProperties struct {
...
// ResourceForUpdateDcePropertiesFailoverConfiguration - Failover configuration
type ResourceForUpdateDcePropertiesFailoverConfiguration struct {
	// Active location where data flow will occur.
	ActiveLocation *string
...
// ResourceForUpdateDcePropertiesMetadata - Metadata for the resource
type ResourceForUpdateDcePropertiesMetadata struct {
	// Azure offering managing this resource on-behalf-of customer.
	ProvisionedBy *string
...
// ResourceForUpdateProperties - Properties of the Data Collection Endpoint that are being updated.
type ResourceForUpdateProperties struct {
	// Failover configuration
	FailoverConfiguration *ResourceForUpdateDcePropertiesFailoverConfiguration
