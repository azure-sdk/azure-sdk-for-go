...
// mutable custom properties, there is little reason to update an existing one. Database Migration Service (classic) - SQL
// scenarios are on a deprecation path and will be retired on 15 March 2026 for all
// customers. Please migrate to Azure SQL database services by using the latest Azure Database Migration Service version which
// is available as an extension in Azure Data Studio, or by using Azure
...
// properties, there is little reason to do so. Database Migration Service (classic) - SQL scenarios are on a deprecation
// path and will be retired on 15 March 2026 for all customers. Please migrate to
// Azure SQL database services by using the latest Azure Database Migration Service version which is available as an extension
