...
// Use a type switch to determine the concrete type.  The possible types are:
// - *ConnectToMongoDbTaskProperties, *ConnectToSourceMySQLTaskProperties, *ConnectToSourceOracleSyncTaskProperties, *ConnectToSourcePostgreSQLSyncTaskProperties,
// - *ConnectToSourceSQLServerSyncTaskProperties, *ConnectToSourceSQLServerTaskProperties, *ConnectToTargetAzureDbForMySQLTaskProperties,
...
// - *GetUserTablesPostgreSQLTaskProperties, *GetUserTablesSQLSyncTaskProperties, *GetUserTablesSQLTaskProperties, *MigrateMongoDbTaskProperties,
// - *MigrateMySQLAzureDbForMySQLOfflineTaskProperties, *MigrateMySQLAzureDbForMySQLSyncTaskProperties, *MigrateOracleAzureDbForPostgreSQLSyncTaskProperties,
// - *MigratePostgreSQLAzureDbForPostgreSQLSyncTaskProperties, *MigrateSQLServerSQLDbSyncTaskProperties, *MigrateSQLServerSQLDbTaskProperties,
// - *MigrateSQLServerSQLMISyncTaskProperties, *MigrateSQLServerSQLMITaskProperties, *MigrateSsisTaskProperties, *ProjectTaskProperties,
