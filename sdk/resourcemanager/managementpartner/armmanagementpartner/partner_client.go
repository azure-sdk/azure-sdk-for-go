...
func (client *PartnerClient) createCreateRequest(ctx context.Context, partnerID string, _ *PartnerClientCreateOptions) (*policy.Request, error) {
...
func (client *PartnerClient) deleteCreateRequest(ctx context.Context, partnerID string, _ *PartnerClientDeleteOptions) (*policy.Request, error) {
	urlPath := "/providers/Microsoft.ManagementPartner/partners/{partnerId}"
	if partnerID == "" {
		return nil, errors.New("parameter partnerID cannot be empty")
	}
...
func (client *PartnerClient) getCreateRequest(ctx context.Context, partnerID string, _ *PartnerClientGetOptions) (*policy.Request, error) {
	urlPath := "/providers/Microsoft.ManagementPartner/partners/{partnerId}"
	if partnerID == "" {
		return nil, errors.New("parameter partnerID cannot be empty")
	}
...
func (client *PartnerClient) updateCreateRequest(ctx context.Context, partnerID string, _ *PartnerClientUpdateOptions) (*policy.Request, error) {
	urlPath := "/providers/Microsoft.ManagementPartner/partners/{partnerId}"
	if partnerID == "" {
		return nil, errors.New("parameter partnerID cannot be empty")
	}
