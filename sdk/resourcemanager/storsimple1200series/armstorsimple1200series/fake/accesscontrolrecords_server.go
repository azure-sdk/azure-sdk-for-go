...
type AccessControlRecordsServer struct {
	...
	BeginCreateOrUpdate func(ctx context.Context, accessControlRecordName string, resourceGroupName string, managerName string, accessControlRecord armstorsimple1200series.AccessControlRecord, options *armstorsimple1200series.AccessControlRecordsClientBeginCreateOrUpdateOptions) (resp azfake.PollerResponder[armstorsimple1200series.AccessControlRecordsClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)

	// BeginDelete is the fake for method AccessControlRecordsClient.BeginDelete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginDelete func(ctx context.Context, accessControlRecordName string, resourceGroupName string, managerName string, options *armstorsimple1200series.AccessControlRecordsClientBeginDeleteOptions) (resp azfake.PollerResponder[armstorsimple1200series.AccessControlRecordsClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method AccessControlRecordsClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, accessControlRecordName string, resourceGroupName string, managerName string, options *armstorsimple1200series.AccessControlRecordsClientGetOptions) (resp azfake.Responder[armstorsimple1200series.AccessControlRecordsClientGetResponse], errResp azfake.ErrorResponder)

	// NewListByManagerPager is the fake for method AccessControlRecordsClient.NewListByManagerPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByManagerPager func(resourceGroupName string, managerName string, options *armstorsimple1200series.AccessControlRecordsClientListByManagerOptions) (resp azfake.PagerResponder[armstorsimple1200series.AccessControlRecordsClientListByManagerResponse])
}
...
// The returned AccessControlRecordsServerTransport instance is connected to an instance of armstorsimple1200series.AccessControlRecordsClient via the
...
func NewAccessControlRecordsServerTransport(srv *AccessControlRecordsServer) *AccessControlRecordsServerTransport {
	return &AccessControlRecordsServerTransport{
		srv:                   srv,
		beginCreateOrUpdate:   newTracker[azfake.PollerResponder[armstorsimple1200series.AccessControlRecordsClientCreateOrUpdateResponse]](),
		beginDelete:           newTracker[azfake.PollerResponder[armstorsimple1200series.AccessControlRecordsClientDeleteResponse]](),
		newListByManagerPager: newTracker[azfake.PagerResponder[armstorsimple1200series.AccessControlRecordsClientListByManagerResponse]](),
	}
}

// AccessControlRecordsServerTransport connects instances of armstorsimple1200series.AccessControlRecordsClient to instances of AccessControlRecordsServer.
...
type AccessControlRecordsServerTransport struct {
	...
	beginCreateOrUpdate   *tracker[azfake.PollerResponder[armstorsimple1200series.AccessControlRecordsClientCreateOrUpdateResponse]]
	beginDelete           *tracker[azfake.PollerResponder[armstorsimple1200series.AccessControlRecordsClientDeleteResponse]]
	newListByManagerPager *tracker[azfake.PagerResponder[armstorsimple1200series.AccessControlRecordsClientListByManagerResponse]]
}
...
func (a *AccessControlRecordsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if accessControlRecordsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = accessControlRecordsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
func (a *AccessControlRecordsServerTransport) dispatchBeginCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginCreateOrUpdate == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armstorsimple1200series.AccessControlRecord](req)
		if err != nil {
			return nil, err
		}
...
// set this to conditionally intercept incoming requests to AccessControlRecordsServerTransport
var accessControlRecordsServerTransportInterceptor interface {
