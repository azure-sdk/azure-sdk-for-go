...
func (p *ProblemClassificationsNoSubscriptionServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if problemClassificationsNoSubscriptionServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = problemClassificationsNoSubscriptionServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			case "ProblemClassificationsNoSubscriptionClient.ClassifyProblems":
				res.resp, res.err = p.dispatchClassifyProblems(req)
			default:
...
// set this to conditionally intercept incoming requests to ProblemClassificationsNoSubscriptionServerTransport
var problemClassificationsNoSubscriptionServerTransportInterceptor interface {
