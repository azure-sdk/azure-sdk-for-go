...
type AvailableContactsListResult struct {
	// REQUIRED; The AvailableContacts items on this page
...
// AvailableGroundStationListResult - Ground Stations available to schedule Contacts.
type AvailableGroundStationListResult struct {
	// REQUIRED; The AvailableGroundStation items on this page
...
// AzureResourceManagerArmResponseAvailableContactsListResult - Azure operation completed successfully.
type AzureResourceManagerArmResponseAvailableContactsListResult struct {
...
// ContactProfileListResult - The response of a ContactProfile list operation.
type ContactProfileListResult struct {
	// REQUIRED; The ContactProfile items on this page
...
// SpacecraftListResult - The response of a Spacecraft list operation.
type SpacecraftListResult struct {
	// REQUIRED; The Spacecraft items on this page
	Value []*Spacecraft
