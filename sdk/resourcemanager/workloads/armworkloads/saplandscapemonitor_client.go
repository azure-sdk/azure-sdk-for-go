...
// NewListPager - Gets configuration values for Single Pane Of Glass for SAP monitor for the specified subscription, resource
// group, and resource name.
//
// Generated from API version 2023-12-01-preview
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - monitorName - Name of the SAP monitor resource.
//   - options - SapLandscapeMonitorClientListOptions contains the optional parameters for the SapLandscapeMonitorClient.NewListPager
//     method.
func (client *SapLandscapeMonitorClient) NewListPager(resourceGroupName string, monitorName string, options *SapLandscapeMonitorClientListOptions) *runtime.Pager[SapLandscapeMonitorClientListResponse] {
	return runtime.NewPager(runtime.PagingHandler[SapLandscapeMonitorClientListResponse]{
		More: func(page SapLandscapeMonitorClientListResponse) bool {
			return page.NextLink != nil && len(*page.NextLink) > 0
		},
		Fetcher: func(ctx context.Context, page *SapLandscapeMonitorClientListResponse) (SapLandscapeMonitorClientListResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "SapLandscapeMonitorClient.NewListPager")
			nextLink := ""
			if page != nil {
