...
type LoadBalancersServer struct {
	...
	BeginDelete func(ctx context.Context, resourceURI string, loadBalancerName string, options *armkubernetesruntime.LoadBalancersClientBeginDeleteOptions) (resp azfake.PollerResponder[armkubernetesruntime.LoadBalancersClientDeleteResponse], errResp azfake.ErrorResponder)
...
func NewLoadBalancersServerTransport(srv *LoadBalancersServer) *LoadBalancersServerTransport {
	return &LoadBalancersServerTransport{
		...
		beginDelete:         newTracker[azfake.PollerResponder[armkubernetesruntime.LoadBalancersClientDeleteResponse]](),
...
type LoadBalancersServerTransport struct {
	...
	beginDelete         *tracker[azfake.PollerResponder[armkubernetesruntime.LoadBalancersClientDeleteResponse]]
...
func (l *LoadBalancersServerTransport) dispatchBeginDelete(req *http.Request) (*http.Response, error) {
	...
	if beginDelete == nil {
		...
		respr, errRespr := l.srv.BeginDelete(req.Context(), resourceURIParam, loadBalancerNameParam, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginDelete = &respr
