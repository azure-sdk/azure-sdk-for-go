...
func (c ClusterResourceProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "privateLinkAutoApproveSubscriptions", c.PrivateLinkAutoApproveSubscriptions)
...
func (c *ClusterResourceProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "initialCassandraAdminPassword":
			...
			delete(rawMsg, key)
		case "privateLinkAutoApproveSubscriptions":
			err = unpopulate(val, "PrivateLinkAutoApproveSubscriptions", &c.PrivateLinkAutoApproveSubscriptions)
			delete(rawMsg, key)
