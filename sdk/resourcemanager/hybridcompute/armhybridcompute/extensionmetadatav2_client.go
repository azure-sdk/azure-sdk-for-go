...
func (client *ExtensionMetadataV2Client) getCreateRequest(ctx context.Context, location string, publisher string, extensionType string, version string, options *ExtensionMetadataV2ClientGetOptions) (*policy.Request, error) {
...
func (client *ExtensionMetadataV2Client) listCreateRequest(ctx context.Context, location string, publisher string, extensionType string, options *ExtensionMetadataV2ClientListOptions) (*policy.Request, error) {
