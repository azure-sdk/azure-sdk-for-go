...
- New enum type `ConfigurationNameAutoGenerated` with values `ConfigurationNameAutoGeneratedDuration`
...
- New function `*ConfigurationsClient.CreateInResourceGroupDuration(context.Context, string, ConfigurationName, ConfigurationNameAutoGenerated, ConfigData, *ConfigurationsClientCreateInResourceGroupDurationOptions) (ConfigurationsClientCreateInResourceGroupDurationResponse, error)`
- New function `*ConfigurationsClient.CreateInSubscriptionDuration(context.Context, ConfigurationName, ConfigurationNameAutoGenerated, ConfigData, *ConfigurationsClientCreateInSubscriptionDurationOptions) (ConfigurationsClientCreateInSubscriptionDurationResponse, error)`
