...
- New function `*ClientFactory.NewIndexesClient() *IndexesClient`
- New function `*ClientFactory.NewIndexesVersionsClient() *IndexesVersionsClient`
...
- New function `NewIndexesClient(string, azcore.TokenCredential, *arm.ClientOptions) (*IndexesClient, error)`
- New function `*IndexesClient.NewListByResourceGroupPager(string, *IndexesClientListByResourceGroupOptions) *runtime.Pager[IndexesClientListByResourceGroupResponse]`
- New function `NewIndexesVersionsClient(string, azcore.TokenCredential, *arm.ClientOptions) (*IndexesVersionsClient, error)`
- New function `*IndexesVersionsClient.CreateOrUpdate(context.Context, string, string, string, IndexVersion, *IndexesVersionsClientCreateOrUpdateOptions) (IndexesVersionsClientCreateOrUpdateResponse, error)`
- New function `*IndexesVersionsClient.Delete(context.Context, string, string, string, *IndexesVersionsClientDeleteOptions) (IndexesVersionsClientDeleteResponse, error)`
- New function `*IndexesVersionsClient.Get(context.Context, string, string, string, *IndexesVersionsClientGetOptions) (IndexesVersionsClientGetResponse, error)`
- New function `*IndexesVersionsClient.NewListByIndexPager(string, string, *IndexesVersionsClientListByIndexOptions) *runtime.Pager[IndexesVersionsClientListByIndexResponse]`
...
- New struct `IndexListResult`
- New struct `IndexVersion`
- New struct `IndexVersionListResult`
- New struct `IndexVersionProperties`
...
- New field `AssociatedWorkspaces`, `ContainerRegistries`, `EnableDataIsolation`, `ExistingWorkspaces`, `FeatureStoreSettings`, `HubResourceID`, `KeyVaults`, `ManagedNetwork`, `ServerlessComputeSettings`, `SoftDeleteRetentionInDays`, `StorageAccounts`, `SystemDatastoresAuthMode`, `WorkspaceHubConfig` in struct `WorkspaceProperties`
- New field `EnableDataIsolation`, `Encryption`, `FeatureStoreSettings`, `ManagedNetwork`, `ServerlessComputeSettings`, `SoftDeleteRetentionInDays`, `V1LegacyMode` in struct `WorkspacePropertiesUpdateParameters`
