...
func ExampleCategoriesClient_Get() {
	...
	res, err := clientFactory.NewCategoriesClient().Get(ctx, "ARMOperation.Create", nil)
	if err != nil {
	...
	// res = armimpact.CategoriesClientGetResponse{
	// 	Category: &armimpact.Category{
	...
	// 		Properties: &armimpact.CategoryProperties{
	...
	// 			RequiredImpactProperties: []*armimpact.RequiredImpactProperties{
	// 				{
...
func ExampleCategoriesClient_NewListBySubscriptionPager() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	pager := clientFactory.NewCategoriesClient().NewListBySubscriptionPager(&CategoriesClientListBySubscriptionOptions{
	...
	for pager.More() {
		...
		// page = armimpact.CategoriesClientListBySubscriptionResponse{
		// 	CategoryListResult: armimpact.CategoryListResult{
		// 		Value: []*armimpact.Category{
		// 			{
		// 				ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/providers/microsoft.Impact/ImpactCategories/ARMOperation.Create"),
		// 				Name: to.Ptr("ARMOperation.Create"),
		// 				Type: to.Ptr("Microsoft.Impact/impactCategories"),
