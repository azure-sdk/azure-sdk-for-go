...
//   - options - IpamPoolsClientCreateOptions contains the optional parameters for the IpamPoolsClient.Create method.
func (client *IpamPoolsClient) Create(ctx context.Context, resourceGroupName string, networkManagerName string, poolName string, options *IpamPoolsClientCreateOptions) (IpamPoolsClientCreateResponse, error) {
	var err error
	const operationName = "IpamPoolsClient.Create"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.createCreateRequest(ctx, resourceGroupName, networkManagerName, poolName, options)
	if err != nil {
		return IpamPoolsClientCreateResponse{}, err
	}
...
func (client *IpamPoolsClient) createCreateRequest(ctx context.Context, resourceGroupName string, networkManagerName string, poolName string, options *IpamPoolsClientCreateOptions) (*policy.Request, error) {
...
func (client *IpamPoolsClient) createHandleResponse(resp *http.Response) (IpamPoolsClientCreateResponse, error) {
	result := IpamPoolsClientCreateResponse{}
