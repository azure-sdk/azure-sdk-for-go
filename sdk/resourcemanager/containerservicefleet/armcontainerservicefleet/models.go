...
// GatePropertiesUpdate - A Gate controls the progression during a staged rollout, e.g. in an Update Run.
type GatePropertiesUpdate struct {
	// The state of the Gate.
	State *GateState
}

// GateTarget - The target that the Gate is controlling, e.g. an Update Run.
type GateTarget struct {
	// REQUIRED; The resource id that the Gate is controlling the rollout of.
	ID *string

	// REQUIRED; Properties specific to the target of this Gate.
	Properties *GateTargetProperties

	// REQUIRED; The type of the resource being targeted by this Gate.
	Type *GateTargetType
}

type GateTargetProperties struct {
	// REQUIRED; Properties specific to the Update Run.
	UpdateRun *UpdateRunGateTarget
}

// GateUpdate - A Gate controls the progression during a staged rollout, e.g. in an Update Run.
type GateUpdate struct {
	// REQUIRED; The geo-location where the resource lives
	Location *string

	// The resource-specific properties for this resource.
	Properties *GatePropertiesUpdate
...
// UpdateRunGateTarget - The Gate is targeting an Update Run staged rollout.
type UpdateRunGateTarget struct {
