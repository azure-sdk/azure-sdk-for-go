...
// DefenderForStorageSettingProperties - A Defender for Storage resource properties.
...
type MalwareScanningProperties struct {
	...
	// READ-ONLY; Optional. A status describing the success/failure of Malware Scanning enablement/disablement operation.
...
type SensitiveDataDiscoveryProperties struct {
	...
	// READ-ONLY; Optional. A status describing the success/failure of Sensitive Data Discovery's enablement/disablement operation.
	OperationStatus *OperationStatusAutoGenerated
}
