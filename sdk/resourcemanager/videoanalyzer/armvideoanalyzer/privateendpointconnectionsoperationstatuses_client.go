...
// PrivateEndpointConnectionsOperationStatusesClient contains the methods for the PrivateEndpointConnectionsOperationStatuses
// group.
...
func (client *PrivateEndpointConnectionsOperationStatusesClient) getCreateRequest(ctx context.Context, resourceGroupName string, accountName string, name string, operationID string, _ *PrivateEndpointConnectionsOperationStatusesClientGetOptions) (*policy.Request, error) {
