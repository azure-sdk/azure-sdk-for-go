...
// CreateOrGetPendingUpload - Generate a storage location and credential for the client to upload a data asset to.
...
//   - options - RegistryDataVersionsClientCreateOrGetPendingUploadOptions contains the optional parameters for the RegistryDataVersionsClient.CreateOrGetPendingUpload
//     method.
func (client *RegistryDataVersionsClient) CreateOrGetPendingUpload(ctx context.Context, resourceGroupName string, registryName string, name string, version string, body PendingUploadRequestDto, options *RegistryDataVersionsClientCreateOrGetPendingUploadOptions) (RegistryDataVersionsClientCreateOrGetPendingUploadResponse, error) {
	req, err := client.createOrGetPendingUploadCreateRequest(ctx, resourceGroupName, registryName, name, version, body, options)
	if err != nil {
		return RegistryDataVersionsClientCreateOrGetPendingUploadResponse{}, err
	}
	...
	if !runtime.HasStatusCode(resp, http.StatusOK) {
		return RegistryDataVersionsClientCreateOrGetPendingUploadResponse{}, runtime.NewResponseError(resp)
	}
...
func (client *RegistryDataVersionsClient) createOrGetPendingUploadCreateRequest(ctx context.Context, resourceGroupName string, registryName string, name string, version string, body PendingUploadRequestDto, options *RegistryDataVersionsClientCreateOrGetPendingUploadOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/registries/{registryName}/data/{name}/versions/pendingUpload/{version}"
...
func (client *RegistryDataVersionsClient) createOrGetPendingUploadHandleResponse(resp *http.Response) (RegistryDataVersionsClientCreateOrGetPendingUploadResponse, error) {
	result := RegistryDataVersionsClientCreateOrGetPendingUploadResponse{}
