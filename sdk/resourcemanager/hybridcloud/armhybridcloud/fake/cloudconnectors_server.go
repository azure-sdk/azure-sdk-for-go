...
func (c *CloudConnectorsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if cloudConnectorsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = cloudConnectorsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "CloudConnectorsClient.BeginDiscoverResources":
				res.resp, res.err = c.dispatchBeginDiscoverResources(req)
...
// set this to conditionally intercept incoming requests to CloudConnectorsServerTransport
var cloudConnectorsServerTransportInterceptor interface {
