...
// PrivateLinkServiceResourceOperationResultsClient contains the methods for the PrivateLinkServiceResourceOperationResults
// group.
...
func (client *PrivateLinkServiceResourceOperationResultsClient) getCreateRequest(ctx context.Context, operationID string, _ *PrivateLinkServiceResourceOperationResultsClientBeginGetOptions) (*policy.Request, error) {
