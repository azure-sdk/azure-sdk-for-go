...
// MarshalJSON implements the json.Marshaller interface for type EnrichmentIPGeodataAutoGenerated.
func (e EnrichmentIPGeodataAutoGenerated) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "asn", e.Asn)
	populate(objectMap, "carrier", e.Carrier)
	populate(objectMap, "city", e.City)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type EnrichmentIPGeodataAutoGenerated.
func (e *EnrichmentIPGeodataAutoGenerated) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", e, err)
	}
