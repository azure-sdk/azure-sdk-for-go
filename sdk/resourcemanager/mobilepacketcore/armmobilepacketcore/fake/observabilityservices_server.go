...
func (o *ObservabilityServicesServerTransport) dispatchCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := o.srv.CreateOrUpdate(req.Context(), resourceGroupNameParam, observabilityServiceNameParam, body, nil)
