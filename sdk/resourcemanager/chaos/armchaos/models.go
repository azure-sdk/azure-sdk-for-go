...
type CapabilityTypeListResult struct {
	...
	// READ-ONLY; The CapabilityType items on this page
	Value []*CapabilityType
}

// CapabilityTypeProperties - Model that represents the Capability Type properties model.Model that represents the Capability
...
// ExperimentExecution - Model that represents the execution of an Experiment.
...
// PostActionResult - Model that represents the post action response.
type PostActionResult struct {
	// READ-ONLY; The name of the resource.
	Name *string

	// READ-ONLY; The statusUrl of the post action.
	StatusURL *string
}
...
type Target struct {
	...
	// READ-ONLY; Azure resource location.
	Location *string
...
type TargetReference struct {
	// REQUIRED; Resource identifier of a Target resource.
	ID *string
