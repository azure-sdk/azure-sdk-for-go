...
func (client *VirtualMachineApplicationsClient) BeginDelete(ctx context.Context, resourceGroupName string, vmName string, applicationName string, options *VirtualMachineApplicationsClientBeginDeleteOptions) (*runtime.Poller[VirtualMachineApplicationsClientDeleteResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		poller, err := runtime.NewPoller(resp, client.internal.Pipeline(), &runtime.NewPollerOptions[VirtualMachineApplicationsClientDeleteResponse]{
...
func (client *VirtualMachineApplicationsClient) deleteOperation(ctx context.Context, resourceGroupName string, vmName string, applicationName string, options *VirtualMachineApplicationsClientBeginDeleteOptions) (*http.Response, error) {
	var err error
	const operationName = "VirtualMachineApplicationsClient.BeginDelete"
...
func (client *VirtualMachineApplicationsClient) Get(ctx context.Context, resourceGroupName string, vmName string, applicationName string, options *VirtualMachineApplicationsClientGetOptions) (VirtualMachineApplicationsClientGetResponse, error) {
	var err error
	const operationName = "VirtualMachineApplicationsClient.Get"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
...
func (client *VirtualMachineApplicationsClient) GetInstanceView(ctx context.Context, resourceGroupName string, vmName string, applicationName string, options *VirtualMachineApplicationsClientGetInstanceViewOptions) (VirtualMachineApplicationsClientGetInstanceViewResponse, error) {
	var err error
	const operationName = "VirtualMachineApplicationsClient.GetInstanceView"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
...
// NewListPager - The operation to get all applications of a Virtual Machine.
//
// Generated from API version 2023-09-01
//   - resourceGroupName - The name of the resource group.
//   - vmName - The name of the virtual machine.
//   - options - VirtualMachineApplicationsClientListOptions contains the optional parameters for the VirtualMachineApplicationsClient.NewListPager
//     method.
func (client *VirtualMachineApplicationsClient) NewListPager(resourceGroupName string, vmName string, options *VirtualMachineApplicationsClientListOptions) *runtime.Pager[VirtualMachineApplicationsClientListResponse] {
	return runtime.NewPager(runtime.PagingHandler[VirtualMachineApplicationsClientListResponse]{
		More: func(page VirtualMachineApplicationsClientListResponse) bool {
			return false
		},
		Fetcher: func(ctx context.Context, page *VirtualMachineApplicationsClientListResponse) (VirtualMachineApplicationsClientListResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "VirtualMachineApplicationsClient.NewListPager")
...
//     method.
func (client *VirtualMachineApplicationsClient) BeginPut(ctx context.Context, resourceGroupName string, vmName string, applicationName string, application VMApplicationWithInstanceView, options *VirtualMachineApplicationsClientBeginPutOptions) (*runtime.Poller[VirtualMachineApplicationsClientPutResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.put(ctx, resourceGroupName, vmName, applicationName, application, options)
		if err != nil {
			return nil, err
		}
		poller, err := runtime.NewPoller[VirtualMachineApplicationsClientPutResponse](resp, client.internal.Pipeline(), nil)
		return poller, err
	} else {
...
//
// Generated from API version 2023-09-01
func (client *VirtualMachineApplicationsClient) put(ctx context.Context, resourceGroupName string, vmName string, applicationName string, application VMApplicationWithInstanceView, options *VirtualMachineApplicationsClientBeginPutOptions) (*http.Response, error) {
	var err error
	const operationName = "VirtualMachineApplicationsClient.BeginPut"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
...
func (client *VirtualMachineApplicationsClient) putCreateRequest(ctx context.Context, resourceGroupName string, vmName string, applicationName string, application VMApplicationWithInstanceView, options *VirtualMachineApplicationsClientBeginPutOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachines/{vmName}/VMApplications/{applicationName}"
	if resourceGroupName == "" {
		return nil, errors.New("parameter resourceGroupName cannot be empty")
	}
