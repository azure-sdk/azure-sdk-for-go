...
type CurrentSpend struct {
	...
	Amount *float32 `json:"amount,omitempty" azure:"ro"`
...
type Notification struct {
	...
	//
	// * LessThan
	Operator *BudgetNotificationOperatorType `json:"operator,omitempty"`
...
type SavingsPlanUtilizationSummaryProperties struct {
	...
	// Suppose the API call is for usageDate > 2023-04-01-preview and usageDate < 2022-10-31 at a
