...
func (client *OutboundRulesClient) BeginPost(ctx context.Context, resourceGroupName string, workspaceName string, managedNetworkName string, body ManagedNetworkSettingsDtoBasicResource, options *OutboundRulesClientBeginPostOptions) (*runtime.Poller[*runtime.Pager[OutboundRulesClientPostResponse]], error) {
...
//
// Generated from API version 2025-04-01
func (client *OutboundRulesClient) post(ctx context.Context, resourceGroupName string, workspaceName string, managedNetworkName string, body ManagedNetworkSettingsDtoBasicResource, options *OutboundRulesClientBeginPostOptions) (*http.Response, error) {
	var err error
...
func (client *OutboundRulesClient) postCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, managedNetworkName string, body ManagedNetworkSettingsDtoBasicResource, _ *OutboundRulesClientBeginPostOptions) (*policy.Request, error) {
