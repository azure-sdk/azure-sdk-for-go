...
func (p *PrivateLinkResourcesSecServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if privateLinkResourcesSecServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = privateLinkResourcesSecServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to PrivateLinkResourcesSecServerTransport
var privateLinkResourcesSecServerTransportInterceptor interface {
