...
func (g *GrantsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if grantsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = grantsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "GrantsClient.NewListAllPager":
				res.resp, res.err = g.dispatchNewListAllPager(req)
			default:
...
// set this to conditionally intercept incoming requests to GrantsServerTransport
var grantsServerTransportInterceptor interface {
