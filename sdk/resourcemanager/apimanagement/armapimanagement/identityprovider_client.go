...
// method.
func (client *IdentityProviderClient) CreateOrUpdate(ctx context.Context, resourceGroupName string, serviceName string, identityProviderName IdentityProviderType, parameters IdentityProviderContract, options *IdentityProviderClientCreateOrUpdateOptions) (IdentityProviderClientCreateOrUpdateResponse, error) {
...
func (client *IdentityProviderClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, identityProviderName IdentityProviderType, parameters IdentityProviderContract, options *IdentityProviderClientCreateOrUpdateOptions) (*policy.Request, error) {
...
// serviceName - The name of the API Management service.
// identityProviderName - Identity Provider Type identifier.
// ifMatch - The entity state (Etag) version of the backend to delete. A value of "*" can be used for If-Match to unconditionally
// apply the operation.
...
// method.
func (client *IdentityProviderClient) ListByService(ctx context.Context, resourceGroupName string, serviceName string, options *IdentityProviderClientListByServiceOptions) (IdentityProviderClientListByServiceResponse, error) {
...
// serviceName - The name of the API Management service.
// identityProviderName - Identity Provider Type identifier.
// ifMatch - The entity state (Etag) version of the identity provider configuration to update. A value of "*" can be used
...
func (client *IdentityProviderClient) Update(ctx context.Context, resourceGroupName string, serviceName string, identityProviderName IdentityProviderType, ifMatch string, parameters IdentityProviderUpdateParameters, options *IdentityProviderClientUpdateOptions) (IdentityProviderClientUpdateResponse, error) {
	...
	return IdentityProviderClientUpdateResponse{}, nil
}
