...
type ServerFactory struct {
	// AttachedDataNetworksServer contains the fakes for client AttachedDataNetworksClient
	AttachedDataNetworksServer AttachedDataNetworksServer

	// DataNetworksServer contains the fakes for client DataNetworksClient
	DataNetworksServer DataNetworksServer

	// DiagnosticsPackagesServer contains the fakes for client DiagnosticsPackagesClient
	DiagnosticsPackagesServer DiagnosticsPackagesServer

	// ExtendedUeInformationServer contains the fakes for client ExtendedUeInformationClient
	ExtendedUeInformationServer ExtendedUeInformationServer

	// MobileNetworksServer contains the fakes for client MobileNetworksClient
	...
	// PacketCoreControlPlaneVersionsServer contains the fakes for client PacketCoreControlPlaneVersionsClient
	PacketCoreControlPlaneVersionsServer PacketCoreControlPlaneVersionsServer

	// PacketCoreControlPlanesServer contains the fakes for client PacketCoreControlPlanesClient
	PacketCoreControlPlanesServer PacketCoreControlPlanesServer

	// PacketCoreDataPlanesServer contains the fakes for client PacketCoreDataPlanesClient
	PacketCoreDataPlanesServer PacketCoreDataPlanesServer

	// RoutingInfoServer contains the fakes for client RoutingInfoClient
	RoutingInfoServer RoutingInfoServer

	// ServicesServer contains the fakes for client ServicesClient
	ServicesServer ServicesServer

	// SimGroupsServer contains the fakes for client SimGroupsClient
	SimGroupsServer SimGroupsServer

	// SimPoliciesServer contains the fakes for client SimPoliciesClient
	SimPoliciesServer SimPoliciesServer

	// SimsServer contains the fakes for client SimsClient
	SimsServer SimsServer

	// SitesServer contains the fakes for client SitesClient
	SitesServer SitesServer

	// SlicesServer contains the fakes for client SlicesClient
	SlicesServer SlicesServer

	// UeInformationServer contains the fakes for client UeInformationClient
