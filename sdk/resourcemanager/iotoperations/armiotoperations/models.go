...
// AdrProperties - The properties of an ADR instance.
type AdrProperties struct {
	// REQUIRED; This determines if the ADR service is enabled.
...
// AkriInstanceProperties - The properties of an AKRI instance.
type AkriInstanceProperties struct {
	// REQUIRED; This determines if the AKRI service is enabled.
	State *OperationalMode
}
...
// CertManagerCertConfig - Cert Manager Cert properties
type CertManagerCertConfig struct {
...
// Components - The configuration for components of the AIO Instance.
...
// ConnectorInstanceProperties - The properties of a Connector instance.
type ConnectorInstanceProperties struct {
	// REQUIRED; This determines if the Connector service is enabled.
	State *OperationalMode
}
...
type DataflowEndpointMqtt struct {
	// REQUIRED; authentication properties. DEFAULT: kubernetes.audience=aio-mq-internal. NOTE - Enum field only property is allowed
...
// DataflowInstanceProperties - The properties of an Dataflow instance.
type DataflowInstanceProperties struct {
	// REQUIRED; This determines if the Dataflow service is enabled.
	State *OperationalMode
}

// DataflowOperationDetails - Dataflow Operation properties. NOTE - One only method is allowed to be used for one entry.
type DataflowOperationDetails struct {
...
// OpenTelemetryExportConfig - OpenTelemetry Export Configuration properties
type OpenTelemetryExportConfig struct {
	// REQUIRED; The open telemetry collector endpoint to export to.
...
// OpenTelemetryLogExportConfig - OpenTelemetry Log Export Configuration properties
...
// PrincipalDetails - PrincipalDefinition properties of Rule
...
// SchemaRegistryInstanceProperties - The properties of a Schema Registry instance.
type SchemaRegistryInstanceProperties struct {
	// REQUIRED; This determines if the Schema Registry service is enabled.
	State *OperationalMode
}
