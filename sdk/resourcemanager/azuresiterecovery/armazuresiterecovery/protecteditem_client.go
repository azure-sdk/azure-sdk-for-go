...
func NewProtectedItemClient(credential azcore.TokenCredential, options *arm.ClientOptions) (*ProtectedItemClient, error) {
...
//     method.
func (client *ProtectedItemClient) BeginCreate(ctx context.Context, subscriptionID string, resourceGroupName string, vaultName string, protectedItemName string, body ProtectedItemModel, options *ProtectedItemClientBeginCreateOptions) (*runtime.Poller[ProtectedItemClientCreateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.create(ctx, subscriptionID, resourceGroupName, vaultName, protectedItemName, body, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2021-02-16-preview
func (client *ProtectedItemClient) create(ctx context.Context, subscriptionID string, resourceGroupName string, vaultName string, protectedItemName string, body ProtectedItemModel, options *ProtectedItemClientBeginCreateOptions) (*http.Response, error) {
	var err error
	req, err := client.createCreateRequest(ctx, subscriptionID, resourceGroupName, vaultName, protectedItemName, body, options)
	if err != nil {
		return nil, err
	}
...
func (client *ProtectedItemClient) createCreateRequest(ctx context.Context, subscriptionID string, resourceGroupName string, vaultName string, protectedItemName string, body ProtectedItemModel, options *ProtectedItemClientBeginCreateOptions) (*policy.Request, error) {
...
//     method.
func (client *ProtectedItemClient) BeginDelete(ctx context.Context, subscriptionID string, resourceGroupName string, vaultName string, protectedItemName string, options *ProtectedItemClientBeginDeleteOptions) (*runtime.Poller[ProtectedItemClientDeleteResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.deleteOperation(ctx, subscriptionID, resourceGroupName, vaultName, protectedItemName, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2021-02-16-preview
func (client *ProtectedItemClient) deleteOperation(ctx context.Context, subscriptionID string, resourceGroupName string, vaultName string, protectedItemName string, options *ProtectedItemClientBeginDeleteOptions) (*http.Response, error) {
	var err error
	req, err := client.deleteCreateRequest(ctx, subscriptionID, resourceGroupName, vaultName, protectedItemName, options)
	if err != nil {
		return nil, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
...
func (client *ProtectedItemClient) deleteCreateRequest(ctx context.Context, subscriptionID string, resourceGroupName string, vaultName string, protectedItemName string, options *ProtectedItemClientBeginDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataReplication/replicationVaults/{vaultName}/protectedItems/{protectedItemName}"
	if subscriptionID == "" {
		return nil, errors.New("parameter subscriptionID cannot be empty")
	}
...
func (client *ProtectedItemClient) Get(ctx context.Context, subscriptionID string, resourceGroupName string, vaultName string, protectedItemName string, options *ProtectedItemClientGetOptions) (ProtectedItemClientGetResponse, error) {
	var err error
	req, err := client.getCreateRequest(ctx, subscriptionID, resourceGroupName, vaultName, protectedItemName, options)
	if err != nil {
...
func (client *ProtectedItemClient) getCreateRequest(ctx context.Context, subscriptionID string, resourceGroupName string, vaultName string, protectedItemName string, options *ProtectedItemClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataReplication/replicationVaults/{vaultName}/protectedItems/{protectedItemName}"
	if subscriptionID == "" {
		return nil, errors.New("parameter subscriptionID cannot be empty")
	}
...
func (client *ProtectedItemClient) NewListPager(subscriptionID string, resourceGroupName string, vaultName string, options *ProtectedItemClientListOptions) *runtime.Pager[ProtectedItemClientListResponse] {
...
func (client *ProtectedItemClient) listCreateRequest(ctx context.Context, subscriptionID string, resourceGroupName string, vaultName string, options *ProtectedItemClientListOptions) (*policy.Request, error) {
...
//     method.
func (client *ProtectedItemClient) BeginPlannedFailover(ctx context.Context, subscriptionID string, resourceGroupName string, vaultName string, protectedItemName string, options *ProtectedItemClientBeginPlannedFailoverOptions) (*runtime.Poller[ProtectedItemClientPlannedFailoverResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.plannedFailover(ctx, subscriptionID, resourceGroupName, vaultName, protectedItemName, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2021-02-16-preview
func (client *ProtectedItemClient) plannedFailover(ctx context.Context, subscriptionID string, resourceGroupName string, vaultName string, protectedItemName string, options *ProtectedItemClientBeginPlannedFailoverOptions) (*http.Response, error) {
	var err error
	req, err := client.plannedFailoverCreateRequest(ctx, subscriptionID, resourceGroupName, vaultName, protectedItemName, options)
	if err != nil {
		return nil, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
...
func (client *ProtectedItemClient) plannedFailoverCreateRequest(ctx context.Context, subscriptionID string, resourceGroupName string, vaultName string, protectedItemName string, options *ProtectedItemClientBeginPlannedFailoverOptions) (*policy.Request, error) {
