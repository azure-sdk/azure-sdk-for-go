...
- New function `*GetUsagesInLocationClient.NewListPager(string, string, *GetUsagesInLocationClientListOptions) *runtime.Pager[GetUsagesInLocationClientListResponse]`
...
- New field `DaprConfig`, `SKU` in struct `SiteProperties`
