...
func (client *SQLPoolColumnsClient) getCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, sqlPoolName string, schemaName string, tableName string, columnName string, _ *SQLPoolColumnsClientGetOptions) (*policy.Request, error) {
