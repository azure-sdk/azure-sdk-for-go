...
func (client *ResourcesClient) listCreateRequest(ctx context.Context, _ *ResourcesClientListOptions) (*policy.Request, error) {
...
func (client *ResourcesClient) listAccessTokenCreateRequest(ctx context.Context, resourceID string, _ *ResourcesClientListAccessTokenOptions) (*policy.Request, error) {
