...
- New enum type `IngressTargetPortScheme` with values `IngressTargetPortSchemeHTTP`, `IngressTargetPortSchemeHTTPS`
...
- New field `AdditionalPortMappings`, `TargetPortScheme` in struct `Ingress`
