...
// ActiveSessionHostConfiguration - Schema for ActiveSessionHostConfiguration properties.
type ActiveSessionHostConfiguration struct {
	// REQUIRED; Detailed properties for ActiveSessionHostConfiguration
...
type ActiveSessionHostConfigurationList struct {
	// REQUIRED; The ActiveSessionHostConfiguration items on this page
...
// ActiveSessionHostConfigurationProperties - Represents a ActiveSessionHostConfiguration definition. This has all of the
...
type ActiveSessionHostConfigurationProperties struct {
	...
	// REQUIRED; Image configurations of the HostPool.
...
type AppAttachPackageList struct {
	// REQUIRED; The AppAttachPackage items on this page
...
type ApplicationGroupList struct {
	// REQUIRED; The ApplicationGroup items on this page
...
type DesktopList struct {
	// REQUIRED; The Desktop items on this page
	Value []*Desktop
...
type ExpandMsixImageList struct {
	// REQUIRED; The ExpandMsixImage items on this page
...
type HostPoolList struct {
	// REQUIRED; The HostPool items on this page
	Value []*HostPool
...
type MSIXPackageList struct {
	// REQUIRED; The MSIXPackage items on this page
	Value []*MSIXPackage
...
type MarketplaceInfoProperties struct {
	// REQUIRED; The version of the image.
	ExactVersion *string
...
// PrivateEndpointConnectionListResultWithSystemData - List of private endpoint connection associated with the specified HostPool
type PrivateEndpointConnectionListResultWithSystemData struct {
	// REQUIRED; The PrivateEndpointConnectionWithSystemData items on this page
...
// ResourceProviderOperationListResult - A list of REST API operations supported by an Azure Resource Provider. It contains
// an URL link to get the next set of results.
type ResourceProviderOperationListResult struct {
	// REQUIRED; The ResourceProviderOperation items on this page
...
type ScalingPlanList struct {
	// REQUIRED; The ScalingPlan items on this page
	Value []*ScalingPlan
...
type ScalingPlanPersonalScheduleList struct {
	// REQUIRED; The ScalingPlanPersonalSchedule items on this page
...
// ScalingPlanPersonalSchedulePatchProperties - ScalingPlanPersonalSchedule properties that can be patched.
...
type ScalingPlanPooledScheduleList struct {
	// REQUIRED; The ScalingPlanPooledSchedule items on this page
...
// ScalingPlanPooledSchedulePatchProperties - A ScalingPlanPooledSchedule that can be patched.
...
// SessionHostConfiguration - Schema for SessionHostConfiguration properties.
...
type SessionHostConfigurationList struct {
	// REQUIRED; The SessionHostConfiguration items on this page
...
// SessionHostConfigurationPatch - SessionHostConfiguration properties that can be patched.
...
type SessionHostList struct {
	// REQUIRED; The SessionHost items on this page
	Value []*SessionHost
...
// SessionHostManagement - Schema for SessionHostManagement properties.
...
type SessionHostManagementList struct {
	// REQUIRED; The SessionHostManagement items on this page
...
// SessionHostManagementPatch - SessionHostManagement properties that can be patched.
...
// SessionHostManagementPatchProperties - Represents a SessionHostManagementPatch definition.
...
// SessionHostManagementUpdateStatus - Schema for SessionHostManagementUpdateStatus properties.
type SessionHostManagementUpdateStatus struct {
	// READ-ONLY; Operation status. Current defined values are < Error | Scheduled | UpdatingSessionHosts | ValidatingSessionHostUpdate
...
type SessionHostProperties struct {
	...
	// READ-ONLY; Update state of a SessionHost.
...
type StartMenuItemList struct {
	// REQUIRED; The StartMenuItem items on this page
	Value []*StartMenuItem
...
type UserSessionList struct {
	// REQUIRED; The UserSession items on this page
	Value []*UserSession
...
// WorkspacePatch - Workspace properties that can be patched.A patch model
