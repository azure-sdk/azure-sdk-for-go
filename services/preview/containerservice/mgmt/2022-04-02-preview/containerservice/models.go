...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/preview/containerservice/mgmt/2022-04-02-preview/containerservice"
...
type ManagedClusterAgentPoolProfile struct {
	...
	// EnableCustomCATrust - When set to true, AKS deploys a daemonset and host services to sync custom certificate authorities from a user-provided config map into node trust stores. Defaults to false.
...
func (mcapp ManagedClusterAgentPoolProfile) MarshalJSON() ([]byte, error) {
	...
	if mcapp.EnableCustomCATrust != nil {
		objectMap["enableCustomCATrust"] = mcapp.EnableCustomCATrust
	}
...
func (mcappp ManagedClusterAgentPoolProfileProperties) MarshalJSON() ([]byte, error) {
	...
	if mcappp.EnableCustomCATrust != nil {
		objectMap["enableCustomCATrust"] = mcappp.EnableCustomCATrust
	}
...
type NetworkProfile struct {
	...
	// NetworkPluginMode - Network plugin mode used for building the Kubernetes network. Possible values include: 'Overlay'
...
type NetworkProfileForSnapshot struct {
	...
	NetworkPlugin NetworkPlugin `json:"networkPlugin,omitempty"`
	// NetworkPluginMode - NetworkPluginMode for managed cluster snapshot. Possible values include: 'Overlay'
	NetworkPluginMode NetworkPluginMode `json:"networkPluginMode,omitempty"`
...
type TrustedAccessRole struct {
	// SourceResourceType - READ-ONLY; Resource type of Azure resource
	SourceResourceType *string `json:"sourceResourceType,omitempty"`
	// Name - READ-ONLY; Name of role, name is unique under a source resource type
	Name *string `json:"name,omitempty"`
	// Rules - READ-ONLY; List of rules for the role. This maps to 'rules' property of [Kubernetes Cluster Role](https://kubernetes.io/docs/reference/kubernetes-api/authorization-resources/cluster-role-v1/#ClusterRole).
	Rules *[]TrustedAccessRoleRule `json:"rules,omitempty"`
}

// MarshalJSON is the custom marshaler for TrustedAccessRole.
func (tarVar TrustedAccessRole) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	return json.Marshal(objectMap)
}
...
type TrustedAccessRoleBinding struct {
	autorest.Response                   `json:"-"`
	*TrustedAccessRoleBindingProperties `json:"properties,omitempty"`
	// ID - READ-ONLY; Fully qualified resource ID for the resource. Ex - /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{resourceProviderNamespace}/{resourceType}/{resourceName}
	ID *string `json:"id,omitempty"`
	// Name - READ-ONLY; The name of the resource
	Name *string `json:"name,omitempty"`
...
// MarshalJSON is the custom marshaler for TrustedAccessRoleBinding.
func (tarb TrustedAccessRoleBinding) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if tarb.TrustedAccessRoleBindingProperties != nil {
		objectMap["properties"] = tarb.TrustedAccessRoleBindingProperties
	}
	return json.Marshal(objectMap)
}

// UnmarshalJSON is the custom unmarshaler for TrustedAccessRoleBinding struct.
func (tarb *TrustedAccessRoleBinding) UnmarshalJSON(body []byte) error {
	var m map[string]*json.RawMessage
	err := json.Unmarshal(body, &m)
	if err != nil {
		return err
	...
	for k, v := range m {
		...
		case "properties":
			if v != nil {
				var trustedAccessRoleBindingProperties TrustedAccessRoleBindingProperties
				err = json.Unmarshal(*v, &trustedAccessRoleBindingProperties)
				if err != nil {
					return err
				}
				tarb.TrustedAccessRoleBindingProperties = &trustedAccessRoleBindingProperties
			}
		case "id":
			if v != nil {
				var ID string
...
type TrustedAccessRoleBindingListResult struct {
	autorest.Response `json:"-"`
	// Value - Role binding list
	Value *[]TrustedAccessRoleBinding `json:"value,omitempty"`
	// NextLink - READ-ONLY; Link to next page of resources.
	NextLink *string `json:"nextLink,omitempty"`
}

// MarshalJSON is the custom marshaler for TrustedAccessRoleBindingListResult.
func (tarblr TrustedAccessRoleBindingListResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if tarblr.Value != nil {
		objectMap["value"] = tarblr.Value
	}
	return json.Marshal(objectMap)
}

// TrustedAccessRoleBindingListResultIterator provides access to a complete listing of
// TrustedAccessRoleBinding values.
type TrustedAccessRoleBindingListResultIterator struct {
	i    int
	page TrustedAccessRoleBindingListResultPage
}

// NextWithContext advances to the next value.  If there was an error making
// the request the iterator does not advance and the error is returned.
func (iter *TrustedAccessRoleBindingListResultIterator) NextWithContext(ctx context.Context) (err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/TrustedAccessRoleBindingListResultIterator.NextWithContext")
		defer func() {
			sc := -1
			if iter.Response().Response.Response != nil {
				sc = iter.Response().Response.Response.StatusCode
...
// the request the iterator does not advance and the error is returned.
// Deprecated: Use NextWithContext() instead.
func (iter *TrustedAccessRoleBindingListResultIterator) Next() error {
	return iter.NextWithContext(context.Background())
}

// NotDone returns true if the enumeration should be started or is not yet complete.
func (iter TrustedAccessRoleBindingListResultIterator) NotDone() bool {
	return iter.page.NotDone() && iter.i < len(iter.page.Values())
}

// Response returns the raw server response from the last page request.
func (iter TrustedAccessRoleBindingListResultIterator) Response() TrustedAccessRoleBindingListResult {
	return iter.page.Response()
}

// Value returns the current value or a zero-initialized value if the
// iterator has advanced beyond the end of the collection.
func (iter TrustedAccessRoleBindingListResultIterator) Value() TrustedAccessRoleBinding {
	if !iter.page.NotDone() {
...
// Creates a new instance of the TrustedAccessRoleBindingListResultIterator type.
func NewTrustedAccessRoleBindingListResultIterator(page TrustedAccessRoleBindingListResultPage) TrustedAccessRoleBindingListResultIterator {
	return TrustedAccessRoleBindingListResultIterator{page: page}
}

// IsEmpty returns true if the ListResult contains no values.
func (tarblr TrustedAccessRoleBindingListResult) IsEmpty() bool {
	return tarblr.Value == nil || len(*tarblr.Value) == 0
}

// hasNextLink returns true if the NextLink is not empty.
func (tarblr TrustedAccessRoleBindingListResult) hasNextLink() bool {
	return tarblr.NextLink != nil && len(*tarblr.NextLink) != 0
}

// trustedAccessRoleBindingListResultPreparer prepares a request to retrieve the next set of results.
// It returns nil if no more results exist.
func (tarblr TrustedAccessRoleBindingListResult) trustedAccessRoleBindingListResultPreparer(ctx context.Context) (*http.Request, error) {
	if !tarblr.hasNextLink() {
		return nil, nil
	}
	return autorest.Prepare((&http.Request{}).WithContext(ctx),
		autorest.AsJSON(),
		autorest.AsGet(),
		autorest.WithBaseURL(to.String(tarblr.NextLink)))
}

// TrustedAccessRoleBindingListResultPage contains a page of TrustedAccessRoleBinding values.
type TrustedAccessRoleBindingListResultPage struct {
	fn     func(context.Context, TrustedAccessRoleBindingListResult) (TrustedAccessRoleBindingListResult, error)
	tarblr TrustedAccessRoleBindingListResult
}

// NextWithContext advances to the next page of values.  If there was an error making
// the request the page does not advance and the error is returned.
func (page *TrustedAccessRoleBindingListResultPage) NextWithContext(ctx context.Context) (err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/TrustedAccessRoleBindingListResultPage.NextWithContext")
		defer func() {
			sc := -1
			if page.Response().Response.Response != nil {
				sc = page.Response().Response.Response.StatusCode
	...
	for {
		next, err := page.fn(ctx, page.tarblr)
		if err != nil {
			return err
		}
		page.tarblr = next
...
// the request the page does not advance and the error is returned.
// Deprecated: Use NextWithContext() instead.
func (page *TrustedAccessRoleBindingListResultPage) Next() error {
	return page.NextWithContext(context.Background())
}

// NotDone returns true if the page enumeration should be started or is not yet complete.
func (page TrustedAccessRoleBindingListResultPage) NotDone() bool {
	return !page.tarblr.IsEmpty()
}

// Response returns the raw server response from the last page request.
func (page TrustedAccessRoleBindingListResultPage) Response() TrustedAccessRoleBindingListResult {
	return page.tarblr
}

// Values returns the slice of values for the current page or nil if there are no values.
func (page TrustedAccessRoleBindingListResultPage) Values() []TrustedAccessRoleBinding {
	if page.tarblr.IsEmpty() {
		return nil
	}
	return *page.tarblr.Value
}

// Creates a new instance of the TrustedAccessRoleBindingListResultPage type.
func NewTrustedAccessRoleBindingListResultPage(cur TrustedAccessRoleBindingListResult, getNextPage func(context.Context, TrustedAccessRoleBindingListResult) (TrustedAccessRoleBindingListResult, error)) TrustedAccessRoleBindingListResultPage {
	return TrustedAccessRoleBindingListResultPage{
		fn:     getNextPage,
		tarblr: cur,
	}
}
...
type TrustedAccessRoleBindingProperties struct {
	// ProvisioningState - READ-ONLY; The current provisioning state of trusted access role binding. Possible values include: 'TrustedAccessRoleBindingProvisioningStateSucceeded', 'TrustedAccessRoleBindingProvisioningStateFailed', 'TrustedAccessRoleBindingProvisioningStateUpdating', 'TrustedAccessRoleBindingProvisioningStateDeleting'
...
// MarshalJSON is the custom marshaler for TrustedAccessRoleBindingProperties.
func (tarbp TrustedAccessRoleBindingProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if tarbp.SourceResourceID != nil {
		objectMap["sourceResourceId"] = tarbp.SourceResourceID
	}
	if tarbp.Roles != nil {
		objectMap["roles"] = tarbp.Roles
	}
	return json.Marshal(objectMap)
}
...
type TrustedAccessRoleListResult struct {
	autorest.Response `json:"-"`
	// Value - READ-ONLY; Role list
	Value *[]TrustedAccessRole `json:"value,omitempty"`
	// NextLink - READ-ONLY; Link to next page of resources.
	NextLink *string `json:"nextLink,omitempty"`
}

// MarshalJSON is the custom marshaler for TrustedAccessRoleListResult.
func (tarlr TrustedAccessRoleListResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	return json.Marshal(objectMap)
}

// TrustedAccessRoleListResultIterator provides access to a complete listing of TrustedAccessRole values.
type TrustedAccessRoleListResultIterator struct {
	i    int
	page TrustedAccessRoleListResultPage
}

// NextWithContext advances to the next value.  If there was an error making
// the request the iterator does not advance and the error is returned.
func (iter *TrustedAccessRoleListResultIterator) NextWithContext(ctx context.Context) (err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/TrustedAccessRoleListResultIterator.NextWithContext")
		defer func() {
			sc := -1
			if iter.Response().Response.Response != nil {
				sc = iter.Response().Response.Response.StatusCode
...
// the request the iterator does not advance and the error is returned.
// Deprecated: Use NextWithContext() instead.
func (iter *TrustedAccessRoleListResultIterator) Next() error {
	return iter.NextWithContext(context.Background())
}

// NotDone returns true if the enumeration should be started or is not yet complete.
func (iter TrustedAccessRoleListResultIterator) NotDone() bool {
	return iter.page.NotDone() && iter.i < len(iter.page.Values())
}

// Response returns the raw server response from the last page request.
func (iter TrustedAccessRoleListResultIterator) Response() TrustedAccessRoleListResult {
	return iter.page.Response()
}

// Value returns the current value or a zero-initialized value if the
// iterator has advanced beyond the end of the collection.
func (iter TrustedAccessRoleListResultIterator) Value() TrustedAccessRole {
	if !iter.page.NotDone() {
		return TrustedAccessRole{}
	}
	return iter.page.Values()[iter.i]
}

// Creates a new instance of the TrustedAccessRoleListResultIterator type.
func NewTrustedAccessRoleListResultIterator(page TrustedAccessRoleListResultPage) TrustedAccessRoleListResultIterator {
	return TrustedAccessRoleListResultIterator{page: page}
}

// IsEmpty returns true if the ListResult contains no values.
func (tarlr TrustedAccessRoleListResult) IsEmpty() bool {
	return tarlr.Value == nil || len(*tarlr.Value) == 0
}

// hasNextLink returns true if the NextLink is not empty.
func (tarlr TrustedAccessRoleListResult) hasNextLink() bool {
	return tarlr.NextLink != nil && len(*tarlr.NextLink) != 0
}

// trustedAccessRoleListResultPreparer prepares a request to retrieve the next set of results.
// It returns nil if no more results exist.
func (tarlr TrustedAccessRoleListResult) trustedAccessRoleListResultPreparer(ctx context.Context) (*http.Request, error) {
	if !tarlr.hasNextLink() {
		return nil, nil
	}
	return autorest.Prepare((&http.Request{}).WithContext(ctx),
		autorest.AsJSON(),
		autorest.AsGet(),
		autorest.WithBaseURL(to.String(tarlr.NextLink)))
}

// TrustedAccessRoleListResultPage contains a page of TrustedAccessRole values.
type TrustedAccessRoleListResultPage struct {
	fn    func(context.Context, TrustedAccessRoleListResult) (TrustedAccessRoleListResult, error)
	tarlr TrustedAccessRoleListResult
}

// NextWithContext advances to the next page of values.  If there was an error making
// the request the page does not advance and the error is returned.
func (page *TrustedAccessRoleListResultPage) NextWithContext(ctx context.Context) (err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/TrustedAccessRoleListResultPage.NextWithContext")
		defer func() {
			sc := -1
			if page.Response().Response.Response != nil {
				sc = page.Response().Response.Response.StatusCode
	...
	for {
		next, err := page.fn(ctx, page.tarlr)
		if err != nil {
			return err
		}
		page.tarlr = next
...
// the request the page does not advance and the error is returned.
// Deprecated: Use NextWithContext() instead.
func (page *TrustedAccessRoleListResultPage) Next() error {
	return page.NextWithContext(context.Background())
}

// NotDone returns true if the page enumeration should be started or is not yet complete.
func (page TrustedAccessRoleListResultPage) NotDone() bool {
	return !page.tarlr.IsEmpty()
}

// Response returns the raw server response from the last page request.
func (page TrustedAccessRoleListResultPage) Response() TrustedAccessRoleListResult {
	return page.tarlr
}

// Values returns the slice of values for the current page or nil if there are no values.
func (page TrustedAccessRoleListResultPage) Values() []TrustedAccessRole {
	if page.tarlr.IsEmpty() {
		return nil
	}
	return *page.tarlr.Value
}

// Creates a new instance of the TrustedAccessRoleListResultPage type.
func NewTrustedAccessRoleListResultPage(cur TrustedAccessRoleListResult, getNextPage func(context.Context, TrustedAccessRoleListResult) (TrustedAccessRoleListResult, error)) TrustedAccessRoleListResultPage {
	return TrustedAccessRoleListResultPage{
		fn:    getNextPage,
		tarlr: cur,
	}
}
...
type TrustedAccessRoleRule struct {
	// Verbs - READ-ONLY; List of allowed verbs
	Verbs *[]string `json:"verbs,omitempty"`
	// APIGroups - READ-ONLY; List of allowed apiGroups
	APIGroups *[]string `json:"apiGroups,omitempty"`
	// Resources - READ-ONLY; List of allowed resources
	Resources *[]string `json:"resources,omitempty"`
	// ResourceNames - READ-ONLY; List of allowed names
	ResourceNames *[]string `json:"resourceNames,omitempty"`
	// NonResourceURLs - READ-ONLY; List of allowed nonResourceURLs
	NonResourceURLs *[]string `json:"nonResourceURLs,omitempty"`
}

// MarshalJSON is the custom marshaler for TrustedAccessRoleRule.
func (tarr TrustedAccessRoleRule) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	return json.Marshal(objectMap)
}
