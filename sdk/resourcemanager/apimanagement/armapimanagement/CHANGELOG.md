...
- New function `*WorkspaceAPIOperationPolicyClient.ListByOperation(context.Context, string, string, string, string, string, *WorkspaceAPIOperationPolicyClientListByOperationOptions) (WorkspaceAPIOperationPolicyClientListByOperationResponse, error)`
...
- New function `*WorkspaceAPIPolicyClient.ListByAPI(context.Context, string, string, string, string, *WorkspaceAPIPolicyClientListByAPIOptions) (WorkspaceAPIPolicyClientListByAPIResponse, error)`
...
- New function `*WorkspacePolicyClient.ListByAPI(context.Context, string, string, string, *WorkspacePolicyClientListByAPIOptions) (WorkspacePolicyClientListByAPIResponse, error)`
...
- New function `*WorkspacePolicyFragmentClient.ListByService(context.Context, string, string, string, *WorkspacePolicyFragmentClientListByServiceOptions) (WorkspacePolicyFragmentClientListByServiceResponse, error)`
