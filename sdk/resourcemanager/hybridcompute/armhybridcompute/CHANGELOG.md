...
- Function `*LicensesClient.BeginValidateLicense` parameter(s) have been changed from `(context.Context, License, *LicensesClientBeginValidateLicenseOptions)` to `(context.Context, LicenseValidateModel, *LicensesClientBeginValidateLicenseOptions)`
...
- New struct `LicenseValidateModel`
