...
func (a *AvailableOSServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if availableOSServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = availableOSServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to AvailableOSServerTransport
var availableOSServerTransportInterceptor interface {
