...
// AzurePostgreSQLSinkWriteMethod - The write behavior for the operation. Default is Bulk Insert.
type AzurePostgreSQLSinkWriteMethod string

const (
	AzurePostgreSQLSinkWriteMethodBulkInsert  AzurePostgreSQLSinkWriteMethod = "BulkInsert"
	AzurePostgreSQLSinkWriteMethodCopyCommand AzurePostgreSQLSinkWriteMethod = "CopyCommand"
	AzurePostgreSQLSinkWriteMethodUpsert      AzurePostgreSQLSinkWriteMethod = "Upsert"
)

// PossibleAzurePostgreSQLSinkWriteMethodValues returns the possible values for the AzurePostgreSQLSinkWriteMethod const type.
func PossibleAzurePostgreSQLSinkWriteMethodValues() []AzurePostgreSQLSinkWriteMethod {
	return []AzurePostgreSQLSinkWriteMethod{
		AzurePostgreSQLSinkWriteMethodBulkInsert,
		AzurePostgreSQLSinkWriteMethodCopyCommand,
		AzurePostgreSQLSinkWriteMethodUpsert,
	}
}
