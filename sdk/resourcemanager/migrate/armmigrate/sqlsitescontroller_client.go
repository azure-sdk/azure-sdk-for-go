...
// ExportURI - Method to generate export/read SAS uri for import.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2024-12-01-preview
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
...
//   - sqlSiteName - SQL site name.
//   - body - The content of the action request
//   - options - SQLSitesControllerClientExportURIOptions contains the optional parameters for the SQLSitesControllerClient.ExportURI
//     method.
func (client *SQLSitesControllerClient) ExportURI(ctx context.Context, resourceGroupName string, siteName string, sqlSiteName string, body SQLInventoryImportBody, options *SQLSitesControllerClientExportURIOptions) (SQLSitesControllerClientExportURIResponse, error) {
	var err error
	const operationName = "SQLSitesControllerClient.ExportURI"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.exportURICreateRequest(ctx, resourceGroupName, siteName, sqlSiteName, body, options)
	if err != nil {
		return SQLSitesControllerClientExportURIResponse{}, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
	if err != nil {
		return SQLSitesControllerClientExportURIResponse{}, err
...
func (client *SQLSitesControllerClient) exportURICreateRequest(ctx context.Context, resourceGroupName string, siteName string, sqlSiteName string, body SQLInventoryImportBody, _ *SQLSitesControllerClientExportURIOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OffAzure/masterSites/{siteName}/sqlSites/{sqlSiteName}/exportUri"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{subscriptionId}", url.PathEscape(client.subscriptionID))
...
func (client *SQLSitesControllerClient) exportURIHandleResponse(resp *http.Response) (SQLSitesControllerClientExportURIResponse, error) {
	result := SQLSitesControllerClientExportURIResponse{}
...
// BeginImportURI - Initiates SQL inventory import process. This is an asynchronous operation that returns a 202 Accepted
...
//   - options - SQLSitesControllerClientBeginImportURIOptions contains the optional parameters for the SQLSitesControllerClient.BeginImportURI
//     method.
func (client *SQLSitesControllerClient) BeginImportURI(ctx context.Context, resourceGroupName string, siteName string, sqlSiteName string, body SQLInventoryImportBody, options *SQLSitesControllerClientBeginImportURIOptions) (*runtime.Poller[SQLSitesControllerClientImportURIResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.importURI(ctx, resourceGroupName, siteName, sqlSiteName, body, options)
		if err != nil {
			return nil, err
		}
		poller, err := runtime.NewPoller(resp, client.internal.Pipeline(), &runtime.NewPollerOptions[SQLSitesControllerClientImportURIResponse]{
			FinalStateVia: runtime.FinalStateViaLocation,
			Tracer:        client.internal.Tracer(),
		})
		return poller, err
	} else {
		return runtime.NewPollerFromResumeToken(options.ResumeToken, client.internal.Pipeline(), &runtime.NewPollerFromResumeTokenOptions[SQLSitesControllerClientImportURIResponse]{
			Tracer: client.internal.Tracer(),
		})
	}
}

// ImportURI - Initiates SQL inventory import process. This is an asynchronous operation that returns a 202 Accepted response
// and requires polling for completion status.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2024-12-01-preview
func (client *SQLSitesControllerClient) importURI(ctx context.Context, resourceGroupName string, siteName string, sqlSiteName string, body SQLInventoryImportBody, options *SQLSitesControllerClientBeginImportURIOptions) (*http.Response, error) {
	var err error
	const operationName = "SQLSitesControllerClient.BeginImportURI"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.importURICreateRequest(ctx, resourceGroupName, siteName, sqlSiteName, body, options)
	if err != nil {
		return nil, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
...
func (client *SQLSitesControllerClient) importURICreateRequest(ctx context.Context, resourceGroupName string, siteName string, sqlSiteName string, body SQLInventoryImportBody, _ *SQLSitesControllerClientBeginImportURIOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OffAzure/masterSites/{siteName}/sqlSites/{sqlSiteName}/importUri"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{subscriptionId}", url.PathEscape(client.subscriptionID))
...
// ValidateAndImportURI - Validates SQL inventory data for format and correctness before attempting import. This is a safer
// alternative to direct import as it prevents failed imports due to invalid data. The operation performs
...
//   - sqlSiteName - SQL site name.
//   - body - The content of the action request
//   - options - SQLSitesControllerClientValidateAndImportURIOptions contains the optional parameters for the SQLSitesControllerClient.ValidateAndImportURI
//     method.
func (client *SQLSitesControllerClient) ValidateAndImportURI(ctx context.Context, resourceGroupName string, siteName string, sqlSiteName string, body SQLInventoryImportBody, options *SQLSitesControllerClientValidateAndImportURIOptions) (SQLSitesControllerClientValidateAndImportURIResponse, error) {
	var err error
	const operationName = "SQLSitesControllerClient.ValidateAndImportURI"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.validateAndImportURICreateRequest(ctx, resourceGroupName, siteName, sqlSiteName, body, options)
	if err != nil {
		return SQLSitesControllerClientValidateAndImportURIResponse{}, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
	if err != nil {
		return SQLSitesControllerClientValidateAndImportURIResponse{}, err
	...
	resp, err := client.validateAndImportURIHandleResponse(httpResp)
	return resp, err
}

// validateAndImportURICreateRequest creates the ValidateAndImportURI request.
func (client *SQLSitesControllerClient) validateAndImportURICreateRequest(ctx context.Context, resourceGroupName string, siteName string, sqlSiteName string, body SQLInventoryImportBody, _ *SQLSitesControllerClientValidateAndImportURIOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OffAzure/masterSites/{siteName}/sqlSites/{sqlSiteName}/validateAndImportUri"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{subscriptionId}", url.PathEscape(client.subscriptionID))
...
// validateAndImportURIHandleResponse handles the ValidateAndImportURI response.
func (client *SQLSitesControllerClient) validateAndImportURIHandleResponse(resp *http.Response) (SQLSitesControllerClientValidateAndImportURIResponse, error) {
	result := SQLSitesControllerClientValidateAndImportURIResponse{}
	if err := runtime.UnmarshalAsJSON(resp, &result.SQLInventoryImportBody); err != nil {
		return SQLSitesControllerClientValidateAndImportURIResponse{}, err
	}
	return result, nil
