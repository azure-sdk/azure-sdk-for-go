...
type WorkloadNetworkPortMirroringProfilesServer struct {
	...
	// HTTP status codes to indicate success: http.StatusOK
	NewListByWorkloadNetworkPager func(resourceGroupName string, privateCloudName string, options *armavs.WorkloadNetworkPortMirroringProfilesClientListByWorkloadNetworkOptions) (resp azfake.PagerResponder[armavs.WorkloadNetworkPortMirroringProfilesClientListByWorkloadNetworkResponse])
