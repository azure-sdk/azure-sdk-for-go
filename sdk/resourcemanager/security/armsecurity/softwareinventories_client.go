...
func (client *SoftwareInventoriesClient) getCreateRequest(ctx context.Context, resourceGroupName string, resourceNamespace string, resourceType string, resourceName string, softwareName string, _ *SoftwareInventoriesClientGetOptions) (*policy.Request, error) {
...
func (client *SoftwareInventoriesClient) listByExtendedResourceCreateRequest(ctx context.Context, resourceGroupName string, resourceNamespace string, resourceType string, resourceName string, _ *SoftwareInventoriesClientListByExtendedResourceOptions) (*policy.Request, error) {
...
func (client *SoftwareInventoriesClient) listBySubscriptionCreateRequest(ctx context.Context, _ *SoftwareInventoriesClientListBySubscriptionOptions) (*policy.Request, error) {
