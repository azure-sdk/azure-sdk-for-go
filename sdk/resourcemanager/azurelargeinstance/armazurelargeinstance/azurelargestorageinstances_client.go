...
// Create - Create an azure large storage resource.
...
//   - options - AzureLargeStorageInstancesClientCreateOptions contains the optional parameters for the AzureLargeStorageInstancesClient.Create
//     method.
func (client *AzureLargeStorageInstancesClient) Create(ctx context.Context, resourceGroupName string, azureLargeStorageInstanceName string, requestBodyParameters AzureLargeStorageInstance, options *AzureLargeStorageInstancesClientCreateOptions) (AzureLargeStorageInstancesClientCreateResponse, error) {
	var err error
	const operationName = "AzureLargeStorageInstancesClient.Create"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.createCreateRequest(ctx, resourceGroupName, azureLargeStorageInstanceName, requestBodyParameters, options)
	if err != nil {
		return AzureLargeStorageInstancesClientCreateResponse{}, err
	}
...
func (client *AzureLargeStorageInstancesClient) createCreateRequest(ctx context.Context, resourceGroupName string, azureLargeStorageInstanceName string, requestBodyParameters AzureLargeStorageInstance, options *AzureLargeStorageInstancesClientCreateOptions) (*policy.Request, error) {
...
func (client *AzureLargeStorageInstancesClient) createHandleResponse(resp *http.Response) (AzureLargeStorageInstancesClientCreateResponse, error) {
	result := AzureLargeStorageInstancesClientCreateResponse{}
...
// Delete - Delete an AzureLargeStorageInstance.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2024-01-10-preview
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - azureLargeStorageInstanceName - Name of the AzureLargeStorageInstance.
//   - options - AzureLargeStorageInstancesClientDeleteOptions contains the optional parameters for the AzureLargeStorageInstancesClient.Delete
//     method.
func (client *AzureLargeStorageInstancesClient) Delete(ctx context.Context, resourceGroupName string, azureLargeStorageInstanceName string, options *AzureLargeStorageInstancesClientDeleteOptions) (AzureLargeStorageInstancesClientDeleteResponse, error) {
	var err error
	const operationName = "AzureLargeStorageInstancesClient.Delete"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.deleteCreateRequest(ctx, resourceGroupName, azureLargeStorageInstanceName, options)
	if err != nil {
		return AzureLargeStorageInstancesClientDeleteResponse{}, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
	if err != nil {
		return AzureLargeStorageInstancesClientDeleteResponse{}, err
	...
	return AzureLargeStorageInstancesClientDeleteResponse{}, nil
}

// deleteCreateRequest creates the Delete request.
func (client *AzureLargeStorageInstancesClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, azureLargeStorageInstanceName string, options *AzureLargeStorageInstancesClientDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureLargeInstance/azureLargeStorageInstances/{azureLargeStorageInstanceName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
//     method.
func (client *AzureLargeStorageInstancesClient) Update(ctx context.Context, resourceGroupName string, azureLargeStorageInstanceName string, tagsParameter Tags, options *AzureLargeStorageInstancesClientUpdateOptions) (AzureLargeStorageInstancesClientUpdateResponse, error) {
	var err error
...
func (client *AzureLargeStorageInstancesClient) updateCreateRequest(ctx context.Context, resourceGroupName string, azureLargeStorageInstanceName string, tagsParameter Tags, options *AzureLargeStorageInstancesClientUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureLargeInstance/azureLargeStorageInstances/{azureLargeStorageInstanceName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
