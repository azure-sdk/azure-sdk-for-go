...
func (c *ClientFactory) NewRaiBlocklistClient() *RaiBlocklistClient {
	subClient, _ := NewRaiBlocklistClient(c.subscriptionID, c.credential, c.options)
	return subClient
}

func (c *ClientFactory) NewRaiBlocklistItemClient() *RaiBlocklistItemClient {
	subClient, _ := NewRaiBlocklistItemClient(c.subscriptionID, c.credential, c.options)
	return subClient
}
