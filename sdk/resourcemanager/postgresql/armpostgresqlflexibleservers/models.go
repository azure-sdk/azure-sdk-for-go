...
// ServerThreatProtectionListResult - A list of the server's Threat Protection settings.
...
// ServerThreatProtectionSettingsModel - Server's Threat Protection settings.
