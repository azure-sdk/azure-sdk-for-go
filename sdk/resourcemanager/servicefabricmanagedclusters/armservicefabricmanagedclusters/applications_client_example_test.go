...
func ExampleApplicationsClient_BeginCreateOrUpdate_putAnApplicationWithMaximumParameters() {
	...
	poller, err := clientFactory.NewApplicationsClient().BeginCreateOrUpdate(ctx, "resRg", "myCluster", "myApp", nil)
	if err != nil {
...
func ExampleApplicationsClient_BeginResumeUpgrade() {
	...
	poller, err := clientFactory.NewApplicationsClient().BeginResumeUpgrade(ctx, "resRg", "myCluster", "myApp", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	_, err = poller.PollUntilDone(ctx, nil)
...
func ExampleApplicationsClient_Update() {
	...
	res, err := clientFactory.NewApplicationsClient().Update(ctx, "resRg", "myCluster", "myApp", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
