...
// BusinessProcessesServer is a fake server for instances of the armazureintegrationspaces.BusinessProcessesClient type.
type BusinessProcessesServer struct {
	...
	CreateOrUpdate func(ctx context.Context, resourceGroupName string, spaceName string, applicationName string, businessProcessName string, resource armazureintegrationspaces.BusinessProcess, options *armazureintegrationspaces.BusinessProcessesClientCreateOrUpdateOptions) (resp azfake.Responder[armazureintegrationspaces.BusinessProcessesClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)

	// Delete is the fake for method BusinessProcessesClient.Delete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	Delete func(ctx context.Context, resourceGroupName string, spaceName string, applicationName string, businessProcessName string, options *armazureintegrationspaces.BusinessProcessesClientDeleteOptions) (resp azfake.Responder[armazureintegrationspaces.BusinessProcessesClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method BusinessProcessesClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, spaceName string, applicationName string, businessProcessName string, options *armazureintegrationspaces.BusinessProcessesClientGetOptions) (resp azfake.Responder[armazureintegrationspaces.BusinessProcessesClientGetResponse], errResp azfake.ErrorResponder)

	// NewListByApplicationPager is the fake for method BusinessProcessesClient.NewListByApplicationPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByApplicationPager func(resourceGroupName string, spaceName string, applicationName string, options *armazureintegrationspaces.BusinessProcessesClientListByApplicationOptions) (resp azfake.PagerResponder[armazureintegrationspaces.BusinessProcessesClientListByApplicationResponse])

	// Patch is the fake for method BusinessProcessesClient.Patch
	// HTTP status codes to indicate success: http.StatusOK
	Patch func(ctx context.Context, resourceGroupName string, spaceName string, applicationName string, businessProcessName string, properties armazureintegrationspaces.BusinessProcessUpdate, options *armazureintegrationspaces.BusinessProcessesClientPatchOptions) (resp azfake.Responder[armazureintegrationspaces.BusinessProcessesClientPatchResponse], errResp azfake.ErrorResponder)
}
...
// The returned BusinessProcessesServerTransport instance is connected to an instance of armazureintegrationspaces.BusinessProcessesClient via the
...
func NewBusinessProcessesServerTransport(srv *BusinessProcessesServer) *BusinessProcessesServerTransport {
	return &BusinessProcessesServerTransport{
		srv:                       srv,
		newListByApplicationPager: newTracker[azfake.PagerResponder[armazureintegrationspaces.BusinessProcessesClientListByApplicationResponse]](),
	}
}

// BusinessProcessesServerTransport connects instances of armazureintegrationspaces.BusinessProcessesClient to instances of BusinessProcessesServer.
...
type BusinessProcessesServerTransport struct {
	...
	newListByApplicationPager *tracker[azfake.PagerResponder[armazureintegrationspaces.BusinessProcessesClientListByApplicationResponse]]
}
...
func (b *BusinessProcessesServerTransport) dispatchCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[armazureintegrationspaces.BusinessProcess](req)
	if err != nil {
		return nil, err
	}
...
func (b *BusinessProcessesServerTransport) dispatchNewListByApplicationPager(req *http.Request) (*http.Response, error) {
	...
	if newListByApplicationPager == nil {
		...
		var options *armazureintegrationspaces.BusinessProcessesClientListByApplicationOptions
		if topParam != nil || skipParam != nil || maxpagesizeParam != nil || filterParam != nil || len(selectParam) > 0 || len(expandParam) > 0 || len(orderbyParam) > 0 {
			options = &armazureintegrationspaces.BusinessProcessesClientListByApplicationOptions{
				Top:         topParam,
				Skip:        skipParam,
		...
		server.PagerResponderInjectNextLinks(newListByApplicationPager, req, func(page *armazureintegrationspaces.BusinessProcessesClientListByApplicationResponse, createLink func() string) {
...
func (b *BusinessProcessesServerTransport) dispatchPatch(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[armazureintegrationspaces.BusinessProcessUpdate](req)
	if err != nil {
		return nil, err
	}
	resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
