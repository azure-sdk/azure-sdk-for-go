	...
	go func() {
		...
		if !intercepted {
			...
			case "DeploymentsClient.BeginDisableRemoteDebugging":
				res.resp, res.err = d.dispatchBeginDisableRemoteDebugging(req)
			case "DeploymentsClient.BeginEnableRemoteDebugging":
				res.resp, res.err = d.dispatchBeginEnableRemoteDebugging(req)
			case "DeploymentsClient.BeginGenerateHeapDump":
				res.resp, res.err = d.dispatchBeginGenerateHeapDump(req)
			case "DeploymentsClient.BeginGenerateThreadDump":
				res.resp, res.err = d.dispatchBeginGenerateThreadDump(req)
			case "DeploymentsClient.Get":
				res.resp, res.err = d.dispatchGet(req)
			case "DeploymentsClient.GetLogFileURL":
				res.resp, res.err = d.dispatchGetLogFileURL(req)
			case "DeploymentsClient.GetRemoteDebuggingConfig":
				res.resp, res.err = d.dispatchGetRemoteDebuggingConfig(req)
			...
			case "DeploymentsClient.NewListForClusterPager":
				res.resp, res.err = d.dispatchNewListForClusterPager(req)
			...
			case "DeploymentsClient.BeginStartJFR":
				res.resp, res.err = d.dispatchBeginStartJFR(req)
			case "DeploymentsClient.BeginStop":
				res.resp, res.err = d.dispatchBeginStop(req)
