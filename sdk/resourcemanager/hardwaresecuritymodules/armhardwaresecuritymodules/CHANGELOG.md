...
- New enum type `BackupRestoreOperationStatus` with values `BackupRestoreOperationStatusFailed`, `BackupRestoreOperationStatusInProgress`, `BackupRestoreOperationStatusSucceeded`
...
- New function `*ClientFactory.NewCloudHsmClustersBackupStatusClient() *CloudHsmClustersBackupStatusClient`
- New function `*ClientFactory.NewCloudHsmClustersClient() *CloudHsmClustersClient`
- New function `*ClientFactory.NewCloudHsmClustersRestoreStatusClient() *CloudHsmClustersRestoreStatusClient`
...
- New function `NewCloudHsmClustersBackupStatusClient(string, azcore.TokenCredential, *arm.ClientOptions) (*CloudHsmClustersBackupStatusClient, error)`
- New function `*CloudHsmClustersBackupStatusClient.Get(context.Context, string, string, string, *CloudHsmClustersBackupStatusClientGetOptions) (CloudHsmClustersBackupStatusClientGetResponse, error)`
...
- New function `*CloudHsmClustersClient.BeginPreBackup(context.Context, string, string, *CloudHsmClustersClientBeginPreBackupOptions) (*runtime.Poller[CloudHsmClustersClientPreBackupResponse], error)`
- New function `*CloudHsmClustersClient.BeginPreRestore(context.Context, string, string, *CloudHsmClustersClientBeginPreRestoreOptions) (*runtime.Poller[CloudHsmClustersClientPreRestoreResponse], error)`
...
- New function `NewCloudHsmClustersRestoreStatusClient(string, azcore.TokenCredential, *arm.ClientOptions) (*CloudHsmClustersRestoreStatusClient, error)`
- New function `*CloudHsmClustersRestoreStatusClient.Get(context.Context, string, string, string, *CloudHsmClustersRestoreStatusClientGetOptions) (CloudHsmClustersRestoreStatusClientGetResponse, error)`
...
- New struct `BackupRestoreBaseResult`
