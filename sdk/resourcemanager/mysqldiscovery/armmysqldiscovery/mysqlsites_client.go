...
func (client *MySQLSitesClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, siteName string, resource MySQLSite, _ *MySQLSitesClientBeginCreateOrUpdateOptions) (*policy.Request, error) {
