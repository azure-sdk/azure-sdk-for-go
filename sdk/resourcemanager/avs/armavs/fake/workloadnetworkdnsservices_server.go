...
type WorkloadNetworkDNSServicesServer struct {
	...
	BeginCreate func(ctx context.Context, resourceGroupName string, privateCloudName string, dnsServiceID string, workloadNetworkDNSService armavs.WorkloadNetworkDNSService, options *armavs.WorkloadNetworkDNSServicesClientBeginCreateOptions) (resp azfake.PollerResponder[armavs.WorkloadNetworkDNSServicesClientCreateResponse], errResp azfake.ErrorResponder)

	// BeginDelete is the fake for method WorkloadNetworkDNSServicesClient.BeginDelete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginDelete func(ctx context.Context, resourceGroupName string, dnsServiceID string, privateCloudName string, options *armavs.WorkloadNetworkDNSServicesClientBeginDeleteOptions) (resp azfake.PollerResponder[armavs.WorkloadNetworkDNSServicesClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method WorkloadNetworkDNSServicesClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, privateCloudName string, dnsServiceID string, options *armavs.WorkloadNetworkDNSServicesClientGetOptions) (resp azfake.Responder[armavs.WorkloadNetworkDNSServicesClientGetResponse], errResp azfake.ErrorResponder)

	// NewListPager is the fake for method WorkloadNetworkDNSServicesClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(resourceGroupName string, privateCloudName string, options *armavs.WorkloadNetworkDNSServicesClientListOptions) (resp azfake.PagerResponder[armavs.WorkloadNetworkDNSServicesClientListResponse])

	// BeginUpdate is the fake for method WorkloadNetworkDNSServicesClient.BeginUpdate
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginUpdate func(ctx context.Context, resourceGroupName string, privateCloudName string, dnsServiceID string, workloadNetworkDNSService armavs.WorkloadNetworkDNSService, options *armavs.WorkloadNetworkDNSServicesClientBeginUpdateOptions) (resp azfake.PollerResponder[armavs.WorkloadNetworkDNSServicesClientUpdateResponse], errResp azfake.ErrorResponder)
}
...
func NewWorkloadNetworkDNSServicesServerTransport(srv *WorkloadNetworkDNSServicesServer) *WorkloadNetworkDNSServicesServerTransport {
	return &WorkloadNetworkDNSServicesServerTransport{
		...
		newListPager: newTracker[azfake.PagerResponder[armavs.WorkloadNetworkDNSServicesClientListResponse]](),
...
type WorkloadNetworkDNSServicesServerTransport struct {
	...
	newListPager *tracker[azfake.PagerResponder[armavs.WorkloadNetworkDNSServicesClientListResponse]]
...
func (w *WorkloadNetworkDNSServicesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if workloadNetworkDnsServicesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = workloadNetworkDnsServicesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "WorkloadNetworkDNSServicesClient.NewListPager":
...
func (w *WorkloadNetworkDNSServicesServerTransport) dispatchBeginCreate(req *http.Request) (*http.Response, error) {
	...
	if beginCreate == nil {
		...
		respr, errRespr := w.srv.BeginCreate(req.Context(), resourceGroupNameParam, privateCloudNameParam, dnsServiceIDParam, body, nil)
...
func (w *WorkloadNetworkDNSServicesServerTransport) dispatchBeginDelete(req *http.Request) (*http.Response, error) {
	...
	if beginDelete == nil {
		...
		respr, errRespr := w.srv.BeginDelete(req.Context(), resourceGroupNameParam, dnsServiceIDParam, privateCloudNameParam, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginDelete = &respr
...
func (w *WorkloadNetworkDNSServicesServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := w.srv.Get(req.Context(), resourceGroupNameParam, privateCloudNameParam, dnsServiceIDParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
...
func (w *WorkloadNetworkDNSServicesServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armavs.WorkloadNetworkDNSServicesClientListResponse, createLink func() string) {
...
func (w *WorkloadNetworkDNSServicesServerTransport) dispatchBeginUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginUpdate == nil {
		...
		respr, errRespr := w.srv.BeginUpdate(req.Context(), resourceGroupNameParam, privateCloudNameParam, dnsServiceIDParam, body, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginUpdate = &respr
...
// set this to conditionally intercept incoming requests to WorkloadNetworkDNSServicesServerTransport
var workloadNetworkDnsServicesServerTransportInterceptor interface {
