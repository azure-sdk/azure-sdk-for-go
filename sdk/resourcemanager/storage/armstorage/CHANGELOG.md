...
- Type of `AccountPropertiesUpdateParameters.PublicNetworkAccess` has been changed from `*PublicNetworkAccess` to `*PublicNetworkAccessLegacy`
...
- New enum type `PublicNetworkAccessLegacy` with values `PublicNetworkAccessLegacyDisabled`, `PublicNetworkAccessLegacyEnabled`
