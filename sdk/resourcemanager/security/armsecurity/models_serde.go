...
// MarshalJSON implements the json.Marshaller interface for type TrustedIPs.
func (t TrustedIPs) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "id", t.ID)
	populate(objectMap, "name", t.Name)
	populate(objectMap, "properties", t.Properties)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type TrustedIPs.
func (t *TrustedIPs) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", t, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type TrustedIPsList.
func (t TrustedIPsList) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "nextLink", t.NextLink)
	populate(objectMap, "value", t.Value)
	return json.Marshal(objectMap)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type TrustedIPsList.
func (t *TrustedIPsList) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", t, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type TrustedIPsMetadata.
func (t TrustedIPsMetadata) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "createdBy", t.CreatedBy)
	populateDateTimeRFC3339(objectMap, "createdOn", t.CreatedOn)
	populate(objectMap, "updatedBy", t.UpdatedBy)
	populateDateTimeRFC3339(objectMap, "updatedOn", t.UpdatedOn)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type TrustedIPsMetadata.
func (t *TrustedIPsMetadata) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", t, err)
	}
	for key, val := range rawMsg {
		...
		case "createdOn":
			...
			delete(rawMsg, key)
		case "updatedBy":
			err = unpopulate(val, "UpdatedBy", &t.UpdatedBy)
			delete(rawMsg, key)
		case "updatedOn":
			err = unpopulateDateTimeRFC3339(val, "UpdatedOn", &t.UpdatedOn)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", t, err)
...
// MarshalJSON implements the json.Marshaller interface for type TrustedIPsProperties.
func (t TrustedIPsProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "cidr", t.Cidr)
	populate(objectMap, "displayName", t.DisplayName)
	populate(objectMap, "inheritedFrom", t.InheritedFrom)
	populate(objectMap, "metadata", t.Metadata)
	populate(objectMap, "tenantId", t.TenantID)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type TrustedIPsProperties.
func (t *TrustedIPsProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", t, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "cidr":
			err = unpopulate(val, "Cidr", &t.Cidr)
			delete(rawMsg, key)
		case "displayName":
			err = unpopulate(val, "DisplayName", &t.DisplayName)
			delete(rawMsg, key)
		case "inheritedFrom":
			err = unpopulate(val, "InheritedFrom", &t.InheritedFrom)
			delete(rawMsg, key)
		case "metadata":
