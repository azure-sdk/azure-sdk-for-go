...
func (f *FirewallPolicyDeploymentsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if firewallPolicyDeploymentsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = firewallPolicyDeploymentsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			case "FirewallPolicyDeploymentsClient.BeginDeploy":
				res.resp, res.err = f.dispatchBeginDeploy(req)
			default:
...
// set this to conditionally intercept incoming requests to FirewallPolicyDeploymentsServerTransport
var firewallPolicyDeploymentsServerTransportInterceptor interface {
