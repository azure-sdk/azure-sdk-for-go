...
func (s StorageConfiguration) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "storageMonitorConfiguration", s.StorageMonitorConfiguration)
...
func (s *StorageConfiguration) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "fileSystemName":
			...
			delete(rawMsg, key)
		case "storageMonitorConfiguration":
			err = unpopulate(val, "StorageMonitorConfiguration", &s.StorageMonitorConfiguration)
			delete(rawMsg, key)
...
// MarshalJSON implements the json.Marshaller interface for type StorageMonitorConfiguration.
func (s StorageMonitorConfiguration) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "messageQueue", s.MessageQueue)
	populate(objectMap, "poisonQueue", s.PoisonQueue)
	populate(objectMap, "systemTopicResourceId", s.SystemTopicResourceID)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type StorageMonitorConfiguration.
func (s *StorageMonitorConfiguration) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "messageQueue":
			err = unpopulate(val, "MessageQueue", &s.MessageQueue)
			delete(rawMsg, key)
		case "poisonQueue":
			err = unpopulate(val, "PoisonQueue", &s.PoisonQueue)
			delete(rawMsg, key)
		case "systemTopicResourceId":
			err = unpopulate(val, "SystemTopicResourceID", &s.SystemTopicResourceID)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", s, err)
...
// MarshalJSON implements the json.Marshaller interface for type StorageMonitorQueue.
func (s StorageMonitorQueue) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "name", s.Name)
	populate(objectMap, "timeToLiveInSeconds", s.TimeToLiveInSeconds)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type StorageMonitorQueue.
func (s *StorageMonitorQueue) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
	for key, val := range rawMsg {
		...
		case "timeToLiveInSeconds":
			err = unpopulate(val, "TimeToLiveInSeconds", &s.TimeToLiveInSeconds)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", s, err)
