...
// OperationStatusServer is a fake server for instances of the armservicefabricmanagedclusters.OperationStatusClient type.
type OperationStatusServer struct {
	// Get is the fake for method OperationStatusClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, location string, operationID string, options *armservicefabricmanagedclusters.OperationStatusClientGetOptions) (resp azfake.Responder[armservicefabricmanagedclusters.OperationStatusClientGetResponse], errResp azfake.ErrorResponder)
}
...
// The returned OperationStatusServerTransport instance is connected to an instance of armservicefabricmanagedclusters.OperationStatusClient via the
...
// OperationStatusServerTransport connects instances of armservicefabricmanagedclusters.OperationStatusClient to instances of OperationStatusServer.
...
func (o *OperationStatusServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.ServiceFabric/locations/(?P<location>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/managedClusterOperations/(?P<operationId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)`
	...
	resp, err := server.MarshalResponseAsJSON(respContent, server.GetResponse(respr).LongRunningOperationResult, req)
	if err != nil {
		return nil, err
	}
	return resp, nil
