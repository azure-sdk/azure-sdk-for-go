...
func (s *SAPCentralInstancesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if sapCentralInstancesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = sapCentralInstancesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "SAPCentralInstancesClient.BeginStartInstance":
				res.resp, res.err = s.dispatchBeginStartInstance(req)
			case "SAPCentralInstancesClient.BeginStopInstance":
				res.resp, res.err = s.dispatchBeginStopInstance(req)
...
// set this to conditionally intercept incoming requests to SAPCentralInstancesServerTransport
var sapCentralInstancesServerTransportInterceptor interface {
