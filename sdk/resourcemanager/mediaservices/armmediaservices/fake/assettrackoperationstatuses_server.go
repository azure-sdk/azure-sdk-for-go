...
func (a *AssetTrackOperationStatusesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if assetTrackOperationStatusesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = assetTrackOperationStatusesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to AssetTrackOperationStatusesServerTransport
var assetTrackOperationStatusesServerTransportInterceptor interface {
