...
- Field `Count` of struct `APICollection` has been removed
- Field `Count` of struct `APIReleaseCollection` has been removed
- Field `Count` of struct `APIRevisionCollection` has been removed
- Field `Count` of struct `APIVersionSetCollection` has been removed
- Field `Count` of struct `AccessInformationCollection` has been removed
- Field `Count` of struct `AuthorizationServerCollection` has been removed
- Field `Count` of struct `BackendCollection` has been removed
- Field `Count` of struct `CacheCollection` has been removed
- Field `Count` of struct `CertificateCollection` has been removed
- Field `Count` of struct `DiagnosticCollection` has been removed
- Field `Count` of struct `EmailTemplateCollection` has been removed
- Field `Count` of struct `GatewayCollection` has been removed
- Field `Count` of struct `GlobalSchemaCollection` has been removed
- Field `Count` of struct `GroupCollection` has been removed
- Field `Count` of struct `IdentityProviderList` has been removed
- Field `Count` of struct `IssueAttachmentCollection` has been removed
- Field `Count` of struct `IssueCollection` has been removed
- Field `Count` of struct `IssueCommentCollection` has been removed
- Field `Count` of struct `LoggerCollection` has been removed
- Field `Count` of struct `NamedValueCollection` has been removed
- Field `Count` of struct `NotificationCollection` has been removed
- Field `Count` of struct `OpenIDConnectProviderCollection` has been removed
- Field `Count` of struct `OperationCollection` has been removed
- Field `Count` of struct `PolicyCollection` has been removed
- Field `Count` of struct `PolicyDescriptionCollection` has been removed
- Field `Count` of struct `PortalSettingsCollection` has been removed
- Field `Count` of struct `ProductCollection` has been removed
- Field `Count` of struct `QuotaCounterCollection` has been removed
- Field `Count` of struct `RecipientEmailCollection` has been removed
- Field `Count` of struct `RecipientUserCollection` has been removed
- Field `Count` of struct `RegionListResult` has been removed
- Field `Count` of struct `ReportCollection` has been removed
- Field `Count` of struct `RequestReportCollection` has been removed
- Field `Count` of struct `SchemaCollection` has been removed
- Field `Count` of struct `SubscriptionCollection` has been removed
- Field `Count` of struct `TagCollection` has been removed
- Field `Count` of struct `TagDescriptionCollection` has been removed
- Field `Count` of struct `TagResourceCollection` has been removed
- Field `Count` of struct `UserCollection` has been removed
- Field `Count` of struct `UserIdentityCollection` has been removed

### Features Added

- New value `APITypeOData` added to enum type `APIType`
- New value `ContentFormatOData`, `ContentFormatODataLink` added to enum type `ContentFormat`
...
- New value `SoapAPITypeOData` added to enum type `SoapAPIType`
...
- New field `ConfigurationAPI`, `DeveloperPortalStatus`, `LegacyPortalStatus`, `NatGatewayState`, `OutboundPublicIPAddresses` in struct `ServiceBaseProperties`
- New field `ConfigurationAPI`, `DeveloperPortalStatus`, `LegacyPortalStatus`, `NatGatewayState`, `OutboundPublicIPAddresses` in struct `ServiceProperties`
- New field `ConfigurationAPI`, `DeveloperPortalStatus`, `LegacyPortalStatus`, `NatGatewayState`, `OutboundPublicIPAddresses` in struct `ServiceUpdateProperties`
