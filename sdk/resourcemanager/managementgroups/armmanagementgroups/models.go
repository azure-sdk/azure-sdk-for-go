...
// ParentGroupBagInfo - The ID, name and displayName of the parent management group.
type ParentGroupBagInfo struct {
...
type SubscriptionUnderManagementGroupProperties struct {
	...
	Parent *ParentGroupBagInfo `json:"parent,omitempty"`
