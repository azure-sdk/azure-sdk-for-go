...
type ErrorDetailAutoGenerated2 struct {
	...
	// READ-ONLY; The error details.
	Details []*ErrorDetailAutoGenerated2 `json:"details,omitempty" azure:"ro"`
...
type ErrorResponseAutoGenerated3 struct {
	// The error object.
	Error *ErrorDetailAutoGenerated2 `json:"error,omitempty"`
}
...
// SQLPoolGet - A SQL Analytics pool
type SQLPoolGet struct {
	// REQUIRED; The geo-location where the resource lives
	Location *string `json:"location,omitempty"`
	...
	// SQL pool properties
	Properties *SQLPoolResourcePropertiesGet `json:"properties,omitempty"`

	// SQL pool SKU
	SKU *SKUGet `json:"sku,omitempty"`
...
// SQLPoolResourcePropertiesGet - Properties of a SQL Analytics pool
type SQLPoolResourcePropertiesGet struct {
	// catalogCollation
	CatalogCollation *string `json:"catalogCollation,omitempty"`
