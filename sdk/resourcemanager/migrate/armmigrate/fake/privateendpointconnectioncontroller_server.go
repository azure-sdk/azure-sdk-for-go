...
type PrivateEndpointConnectionControllerServer struct {
	...
	Delete func(ctx context.Context, resourceGroupName string, siteName string, peConnectionName string, options *armmigrate.PrivateEndpointConnectionControllerClientDeleteOptions) (resp azfake.Responder[armmigrate.PrivateEndpointConnectionControllerClientDeleteResponse], errResp azfake.ErrorResponder)
