...
func (r RegisteredServerProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "friendlyName", r.FriendlyName)
	populate(objectMap, "identityId", r.IdentityID)
	populate(objectMap, "identityType", r.IdentityType)
	populate(objectMap, "lastHeartBeat", r.LastHeartBeat)
...
func (r *RegisteredServerProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "friendlyName":
			...
			delete(rawMsg, key)
		case "identityId":
			err = unpopulate(val, "IdentityID", &r.IdentityID)
			delete(rawMsg, key)
		case "identityType":
			err = unpopulate(val, "IdentityType", &r.IdentityType)
			delete(rawMsg, key)
		case "lastHeartBeat":
			err = unpopulate(val, "LastHeartBeat", &r.LastHeartBeat)
			delete(rawMsg, key)
...
// MarshalJSON implements the json.Marshaller interface for type RegisteredServerUpdateParametersProperties.
func (r RegisteredServerUpdateParametersProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "ApplicationId", r.ApplicationID)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type RegisteredServerUpdateParametersProperties.
func (r *RegisteredServerUpdateParametersProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", r, err)
	}
...
func (s ServiceCreateParametersProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "identityId", s.IdentityID)
	populate(objectMap, "identityType", s.IdentityType)
...
func (s *ServiceCreateParametersProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "identityId":
			err = unpopulate(val, "IdentityID", &s.IdentityID)
			delete(rawMsg, key)
		case "identityType":
			err = unpopulate(val, "IdentityType", &s.IdentityType)
			delete(rawMsg, key)
