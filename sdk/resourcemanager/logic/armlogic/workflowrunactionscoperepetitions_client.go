...
//   - runName - The name of the WorkflowRun
//   - actionName - The name of the WorkflowRunAction
//   - repetitionName - The name of the WorkflowRunActionRepetitionDefinition
...
func (client *WorkflowRunActionScopeRepetitionsClient) getCreateRequest(ctx context.Context, resourceGroupName string, workflowName string, runName string, actionName string, repetitionName string, _ *WorkflowRunActionScopeRepetitionsClientGetOptions) (*policy.Request, error) {
...
func (client *WorkflowRunActionScopeRepetitionsClient) listCreateRequest(ctx context.Context, resourceGroupName string, workflowName string, runName string, actionName string, _ *WorkflowRunActionScopeRepetitionsClientListOptions) (*policy.Request, error) {
