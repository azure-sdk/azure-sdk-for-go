...
// CROSSClientVERBREAKINGCHANGETESTPrometheusRuleGroupsListBySubscriptionOptions contains the optional parameters for the
// CROSSClient.NewVERBREAKINGCHANGETESTPrometheusRuleGroupsListBySubscriptionPager method.
type CROSSClientVERBREAKINGCHANGETESTPrometheusRuleGroupsListBySubscriptionOptions struct {
	// placeholder for future optional parameters
}
