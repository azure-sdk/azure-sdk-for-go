...
func (s *SoftwareInventoriesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if softwareInventoriesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = softwareInventoriesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "SoftwareInventoriesClient.NewListByExtendedResourcePager":
				res.resp, res.err = s.dispatchNewListByExtendedResourcePager(req)
...
// set this to conditionally intercept incoming requests to SoftwareInventoriesServerTransport
var softwareInventoriesServerTransportInterceptor interface {
