...
// MarshalJSON implements the json.Marshaller interface for type ScgCloud.
func (s ScgCloud) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "gateway", s.Gateway)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ScgCloud.
func (s *ScgCloud) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "gateway":
			err = unpopulate(val, "Gateway", &s.Gateway)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", s, err)
...
// MarshalJSON implements the json.Marshaller interface for type ScgSpring.
func (s ScgSpring) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "cloud", s.Cloud)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ScgSpring.
func (s *ScgSpring) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type SpringCloudGateway.
func (s SpringCloudGateway) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "route", s.Route)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type SpringCloudGateway.
func (s *SpringCloudGateway) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "route":
			err = unpopulate(val, "Route", &s.Route)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", s, err)
...
func (s SpringCloudGatewayComponent) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "provisioningState", s.ProvisioningState)
	populate(objectMap, "serviceBinds", s.ServiceBinds)
	populate(objectMap, "spring", s.Spring)
	return json.Marshal(objectMap)
}
...
func (s *SpringCloudGatewayComponent) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "serviceBinds":
			...
			delete(rawMsg, key)
		case "spring":
			err = unpopulate(val, "Spring", &s.Spring)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", s, err)
