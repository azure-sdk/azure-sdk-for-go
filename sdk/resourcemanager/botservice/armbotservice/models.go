...
type ConnectionSetting struct {
	...
	// READ-ONLY; The name of the Bot Service Connection Setting resource.
	Name *string
...
type NetworkSecurityPerimeterConfiguration struct {
	...
	// READ-ONLY; The resource association Name. Composed of parameter guid and association name.
	Name *string
