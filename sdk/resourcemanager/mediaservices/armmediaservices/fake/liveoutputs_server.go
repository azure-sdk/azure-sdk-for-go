...
func (l *LiveOutputsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if liveOutputsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = liveOutputsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			case "LiveOutputsClient.AsyncOperation":
				res.resp, res.err = l.dispatchAsyncOperation(req)
			...
			case "LiveOutputsClient.OperationLocation":
				res.resp, res.err = l.dispatchOperationLocation(req)
			default:
...
// set this to conditionally intercept incoming requests to LiveOutputsServerTransport
var liveOutputsServerTransportInterceptor interface {
