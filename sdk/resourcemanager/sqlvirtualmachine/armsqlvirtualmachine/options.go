...
// GroupsClientListBySQLVMGroupOptions contains the optional parameters for the GroupsClient.NewListBySQLVMGroupPager method.
type GroupsClientListBySQLVMGroupOptions struct {
	// placeholder for future optional parameters
}
...
// SQLVirtualMachinesClientBeginTroubleshootOptions contains the optional parameters for the SQLVirtualMachinesClient.BeginTroubleshoot
// method.
type SQLVirtualMachinesClientBeginTroubleshootOptions struct {
	// Resumes the long-running operation from the provided token.
	ResumeToken string
}
