...
// DatabaseBillingVersionClientCreateOptions contains the optional parameters for the DatabaseBillingVersionClient.Create
// method.
type DatabaseBillingVersionClientCreateOptions struct {
	// placeholder for future optional parameters
}
