...
// AzureAPIManagementSourceImportApis - API source configuration for Azure API Management.
type AzureAPIManagementSourceImportApis struct {
	// REQUIRED; An entity the metadata schema is requested for.
