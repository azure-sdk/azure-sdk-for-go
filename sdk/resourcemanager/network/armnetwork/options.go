...
// ApplicationGatewaysClientBeginCommitMigrationOptions contains the optional parameters for the ApplicationGatewaysClient.BeginCommitMigration
// method.
type ApplicationGatewaysClientBeginCommitMigrationOptions struct {
	// Resumes the LRO from the provided token.
	ResumeToken string
}
...
// ApplicationGatewaysClientBeginExecuteMigrationOptions contains the optional parameters for the ApplicationGatewaysClient.BeginExecuteMigration
// method.
type ApplicationGatewaysClientBeginExecuteMigrationOptions struct {
	// Resumes the LRO from the provided token.
	ResumeToken string
}

// ApplicationGatewaysClientBeginPrepareMigrationOptions contains the optional parameters for the ApplicationGatewaysClient.BeginPrepareMigration
// method.
type ApplicationGatewaysClientBeginPrepareMigrationOptions struct {
	// Resumes the LRO from the provided token.
	ResumeToken string
}
