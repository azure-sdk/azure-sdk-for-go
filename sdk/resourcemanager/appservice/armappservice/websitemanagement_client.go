...
// NewListStaticSiteRegionsPager - Description for Get a list of available Static Site regions.
//
// Generated from API version 2024-04-01
//   - options - WebSiteManagementClientListStaticSiteRegionsOptions contains the optional parameters for the WebSiteManagementClient.NewListStaticSiteRegionsPager
//     method.
func (client *WebSiteManagementClient) NewListStaticSiteRegionsPager(options *WebSiteManagementClientListStaticSiteRegionsOptions) *runtime.Pager[WebSiteManagementClientListStaticSiteRegionsResponse] {
	return runtime.NewPager(runtime.PagingHandler[WebSiteManagementClientListStaticSiteRegionsResponse]{
		More: func(page WebSiteManagementClientListStaticSiteRegionsResponse) bool {
			return page.NextLink != nil && len(*page.NextLink) > 0
		},
		Fetcher: func(ctx context.Context, page *WebSiteManagementClientListStaticSiteRegionsResponse) (WebSiteManagementClientListStaticSiteRegionsResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "WebSiteManagementClient.NewListStaticSiteRegionsPager")
			nextLink := ""
			if page != nil {
				nextLink = *page.NextLink
			}
			resp, err := runtime.FetcherForNextLink(ctx, client.internal.Pipeline(), nextLink, func(ctx context.Context) (*policy.Request, error) {
				return client.listStaticSiteRegionsCreateRequest(ctx, options)
			}, nil)
			if err != nil {
				return WebSiteManagementClientListStaticSiteRegionsResponse{}, err
			}
			return client.listStaticSiteRegionsHandleResponse(resp)
		},
		Tracer: client.internal.Tracer(),
	})
}

// listStaticSiteRegionsCreateRequest creates the ListStaticSiteRegions request.
func (client *WebSiteManagementClient) listStaticSiteRegionsCreateRequest(ctx context.Context, options *WebSiteManagementClientListStaticSiteRegionsOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/providers/Microsoft.Web/staticSiteRegions"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{subscriptionId}", url.PathEscape(client.subscriptionID))
...
// listStaticSiteRegionsHandleResponse handles the ListStaticSiteRegions response.
func (client *WebSiteManagementClient) listStaticSiteRegionsHandleResponse(resp *http.Response) (WebSiteManagementClientListStaticSiteRegionsResponse, error) {
	result := WebSiteManagementClientListStaticSiteRegionsResponse{}
	if err := runtime.UnmarshalAsJSON(resp, &result.StaticSiteRegionCollection); err != nil {
		return WebSiteManagementClientListStaticSiteRegionsResponse{}, err
	}
	return result, nil
}
