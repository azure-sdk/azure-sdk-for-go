...
func (client *LocationsClient) checkNameAvailabilityCreateRequest(ctx context.Context, location string, nameAvailabilityParameters NameAvailabilityParameters, _ *LocationsClientCheckNameAvailabilityOptions) (*policy.Request, error) {
...
func (client *LocationsClient) checkNameAvailabilityHandleResponse(resp *http.Response) (LocationsClientCheckNameAvailabilityResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.NameAvailabilityResult); err != nil {
		return LocationsClientCheckNameAvailabilityResponse{}, err
	}
	return result, nil
}
