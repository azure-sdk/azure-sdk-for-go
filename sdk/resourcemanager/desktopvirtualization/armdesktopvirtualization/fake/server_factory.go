...
type ServerFactory struct {
	// ActiveSessionHostConfigurationsServer contains the fakes for client ActiveSessionHostConfigurationsClient
	...
	// ApplicationGroupsServer contains the fakes for client ApplicationGroupsClient
	...
	// ControlSessionHostProvisioningServer contains the fakes for client ControlSessionHostProvisioningClient
	ControlSessionHostProvisioningServer ControlSessionHostProvisioningServer

	// ControlSessionHostUpdateServer contains the fakes for client ControlSessionHostUpdateClient
	ControlSessionHostUpdateServer ControlSessionHostUpdateServer

	// DesktopsServer contains the fakes for client DesktopsClient
	DesktopsServer DesktopsServer

	// HostPoolsServer contains the fakes for client HostPoolsClient
	HostPoolsServer HostPoolsServer

	// InitiateSessionHostUpdateServer contains the fakes for client InitiateSessionHostUpdateClient
	InitiateSessionHostUpdateServer InitiateSessionHostUpdateServer

	// MSIXPackagesServer contains the fakes for client MSIXPackagesClient
	MSIXPackagesServer MSIXPackagesServer

	// MsixImagesServer contains the fakes for client MsixImagesClient
	...
	// ScalingPlanPersonalSchedulesServer contains the fakes for client ScalingPlanPersonalSchedulesClient
	ScalingPlanPersonalSchedulesServer ScalingPlanPersonalSchedulesServer

	// ScalingPlanPooledSchedulesServer contains the fakes for client ScalingPlanPooledSchedulesClient
	ScalingPlanPooledSchedulesServer ScalingPlanPooledSchedulesServer

	// ScalingPlansServer contains the fakes for client ScalingPlansClient
	ScalingPlansServer ScalingPlansServer

	// SessionHostServer contains the fakes for client SessionHostClient
	SessionHostServer SessionHostServer

	// SessionHostConfigurationsServer contains the fakes for client SessionHostConfigurationsClient
	SessionHostConfigurationsServer SessionHostConfigurationsServer

	// SessionHostManagementsServer contains the fakes for client SessionHostManagementsClient
	SessionHostManagementsServer SessionHostManagementsServer

	// SessionHostManagementsUpdateStatusServer contains the fakes for client SessionHostManagementsUpdateStatusClient
	SessionHostManagementsUpdateStatusServer SessionHostManagementsUpdateStatusServer

	// SessionHostProvisioningStatusesServer contains the fakes for client SessionHostProvisioningStatusesClient
	SessionHostProvisioningStatusesServer SessionHostProvisioningStatusesServer

	// SessionHostsServer contains the fakes for client SessionHostsClient
	SessionHostsServer SessionHostsServer

	// StartMenuItemsServer contains the fakes for client StartMenuItemsClient
	StartMenuItemsServer StartMenuItemsServer

	// UserSessionsServer contains the fakes for client UserSessionsClient
...
type ServerFactoryTransport struct {
	...
	trControlSessionHostProvisioningServer     *ControlSessionHostProvisioningServerTransport
	...
	trSessionHostProvisioningStatusesServer    *SessionHostProvisioningStatusesServerTransport
...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "ControlSessionHostProvisioningClient":
		initServer(s, &s.trControlSessionHostProvisioningServer, func() *ControlSessionHostProvisioningServerTransport {
			return NewControlSessionHostProvisioningServerTransport(&s.srv.ControlSessionHostProvisioningServer)
		})
		resp, err = s.trControlSessionHostProvisioningServer.Do(req)
	...
	case "SessionHostProvisioningStatusesClient":
		initServer(s, &s.trSessionHostProvisioningStatusesServer, func() *SessionHostProvisioningStatusesServerTransport {
			return NewSessionHostProvisioningStatusesServerTransport(&s.srv.SessionHostProvisioningStatusesServer)
		})
		resp, err = s.trSessionHostProvisioningStatusesServer.Do(req)
