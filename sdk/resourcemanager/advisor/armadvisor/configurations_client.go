...
//     method.
func (client *ConfigurationsClient) CreateInResourceGroupDuration(ctx context.Context, resourceGroup string, configurationName ConfigurationName, configContract ConfigData, options *ConfigurationsClientCreateInResourceGroupDurationOptions) (ConfigurationsClientCreateInResourceGroupDurationResponse, error) {
	var err error
	req, err := client.createInResourceGroupDurationCreateRequest(ctx, resourceGroup, configurationName, configContract, options)
	if err != nil {
...
func (client *ConfigurationsClient) createInResourceGroupDurationCreateRequest(ctx context.Context, resourceGroup string, configurationName ConfigurationName, configContract ConfigData, options *ConfigurationsClientCreateInResourceGroupDurationOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroup}/providers/Microsoft.Advisor/configurations/v2/{configurationName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{subscriptionId}", url.PathEscape(client.subscriptionID))
...
//     method.
func (client *ConfigurationsClient) CreateInSubscriptionDuration(ctx context.Context, configurationName ConfigurationName, configContract ConfigData, options *ConfigurationsClientCreateInSubscriptionDurationOptions) (ConfigurationsClientCreateInSubscriptionDurationResponse, error) {
	var err error
	req, err := client.createInSubscriptionDurationCreateRequest(ctx, configurationName, configContract, options)
	if err != nil {
...
func (client *ConfigurationsClient) createInSubscriptionDurationCreateRequest(ctx context.Context, configurationName ConfigurationName, configContract ConfigData, options *ConfigurationsClientCreateInSubscriptionDurationOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/providers/Microsoft.Advisor/configurations/v2/{configurationName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{subscriptionId}", url.PathEscape(client.subscriptionID))
