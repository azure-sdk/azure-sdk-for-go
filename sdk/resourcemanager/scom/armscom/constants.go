...
// DataType - The types of data to be ingested to Log Analytics workspace.
type DataType string

const (
	// DataTypeAudit - Audit data
	DataTypeAudit DataType = "Audit"
	// DataTypeEvent - Event data
	DataTypeEvent DataType = "Event"
	// DataTypePerformance - Performance data
	DataTypePerformance DataType = "Performance"
	// DataTypeState - State data
...
const (
	// HybridLicenseTypeAzureHybridBenefit - Azure Hybrid Benefit license
	HybridLicenseTypeAzureHybridBenefit HybridLicenseType = "AzureHybridBenefit"
	// HybridLicenseTypeNone - No license
...
const (
	...
	// ManagedIdentityTypeSystemAssignedUserAssigned - System and user assigned managed identity.
