...
//     method.
func (client *WorkloadNetworksClient) NewListByPrivateCloudPager(resourceGroupName string, privateCloudName string, options *WorkloadNetworksClientListByPrivateCloudOptions) *runtime.Pager[WorkloadNetworksClientListByPrivateCloudResponse] {
...
func (client *WorkloadNetworksClient) listByPrivateCloudCreateRequest(ctx context.Context, resourceGroupName string, privateCloudName string, _ *WorkloadNetworksClientListByPrivateCloudOptions) (*policy.Request, error) {
