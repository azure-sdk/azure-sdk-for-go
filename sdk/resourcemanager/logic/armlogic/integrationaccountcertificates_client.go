...
func (client *IntegrationAccountCertificatesClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, integrationAccountName string, certificateName string, certificate IntegrationAccountCertificate, _ *IntegrationAccountCertificatesClientCreateOrUpdateOptions) (*policy.Request, error) {
