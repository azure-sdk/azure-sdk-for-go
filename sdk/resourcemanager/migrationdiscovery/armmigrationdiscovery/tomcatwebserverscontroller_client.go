...
func (client *TomcatWebServersControllerClient) getCreateRequest(ctx context.Context, resourceGroupName string, siteName string, webAppSiteName string, webServerName string, _ *TomcatWebServersControllerClientGetOptions) (*policy.Request, error) {
