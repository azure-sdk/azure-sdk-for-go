...
// VirtualNetworkSubnetUsageServer is a fake server for instances of the armpostgresql.VirtualNetworkSubnetUsageClient type.
type VirtualNetworkSubnetUsageServer struct {
	...
	Execute func(ctx context.Context, locationName string, parameters armpostgresql.VirtualNetworkSubnetUsageParameter, options *armpostgresql.VirtualNetworkSubnetUsageClientExecuteOptions) (resp azfake.Responder[armpostgresql.VirtualNetworkSubnetUsageClientExecuteResponse], errResp azfake.ErrorResponder)
}
...
// The returned VirtualNetworkSubnetUsageServerTransport instance is connected to an instance of armpostgresql.VirtualNetworkSubnetUsageClient via the
...
// VirtualNetworkSubnetUsageServerTransport connects instances of armpostgresql.VirtualNetworkSubnetUsageClient to instances of VirtualNetworkSubnetUsageServer.
...
func (v *VirtualNetworkSubnetUsageServerTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "VirtualNetworkSubnetUsageClient.Execute":
		resp, err = v.dispatchExecute(req)
	default:
...
func (v *VirtualNetworkSubnetUsageServerTransport) dispatchExecute(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[armpostgresql.VirtualNetworkSubnetUsageParameter](req)
	if err != nil {
		return nil, err
	}
