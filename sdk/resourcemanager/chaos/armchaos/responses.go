...
// ExperimentExecutionsClientGetExecutionDetailsResponse contains the response from method ExperimentExecutionsClient.GetExecutionDetails.
type ExperimentExecutionsClientGetExecutionDetailsResponse struct {
	// Model that represents the execution details of an Experiment.
	ExperimentExecutionDetails
}

// ExperimentExecutionsClientGetExecutionResponse contains the response from method ExperimentExecutionsClient.GetExecution.
type ExperimentExecutionsClientGetExecutionResponse struct {
	// Model that represents the execution of a Experiment.
	ExperimentExecution
}

// ExperimentExecutionsClientListAllExecutionsResponse contains the response from method ExperimentExecutionsClient.NewListAllExecutionsPager.
type ExperimentExecutionsClientListAllExecutionsResponse struct {
