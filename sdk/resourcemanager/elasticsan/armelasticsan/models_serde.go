...
func (s ScaleUpProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "maxScaleUpTiB", s.MaxScaleUpTiB)
	populate(objectMap, "policyEnforcement", s.PolicyEnforcement)
...
func (s *ScaleUpProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "increaseCapacityUnitByTiB":
			...
			delete(rawMsg, key)
		case "maxScaleUpTiB":
			err = unpopulate(val, "MaxScaleUpTiB", &s.MaxScaleUpTiB)
			delete(rawMsg, key)
		case "policyEnforcement":
			err = unpopulate(val, "PolicyEnforcement", &s.PolicyEnforcement)
			delete(rawMsg, key)
		case "unusedSizeTiB":
