...
// NewEdgeClusterMachineSKUsClient creates a new instance of EdgeClusterMachineSKUsClient.
func (c *ClientFactory) NewEdgeClusterMachineSKUsClient() *EdgeClusterMachineSKUsClient {
	return &EdgeClusterMachineSKUsClient{
		subscriptionID: c.subscriptionID,
		internal:       c.internal,
	}
}

// NewEdgeClusterNodesClient creates a new instance of EdgeClusterNodesClient.
func (c *ClientFactory) NewEdgeClusterNodesClient() *EdgeClusterNodesClient {
	return &EdgeClusterNodesClient{
		subscriptionID: c.subscriptionID,
		internal:       c.internal,
	}
}

// NewEdgeClusterRuntimeVersionsClient creates a new instance of EdgeClusterRuntimeVersionsClient.
func (c *ClientFactory) NewEdgeClusterRuntimeVersionsClient() *EdgeClusterRuntimeVersionsClient {
	return &EdgeClusterRuntimeVersionsClient{
		subscriptionID: c.subscriptionID,
		internal:       c.internal,
	}
}

// NewEdgeClusterSKUsClient creates a new instance of EdgeClusterSKUsClient.
func (c *ClientFactory) NewEdgeClusterSKUsClient() *EdgeClusterSKUsClient {
	return &EdgeClusterSKUsClient{
		subscriptionID: c.subscriptionID,
		internal:       c.internal,
	}
}

// NewEdgeClustersClient creates a new instance of EdgeClustersClient.
func (c *ClientFactory) NewEdgeClustersClient() *EdgeClustersClient {
	return &EdgeClustersClient{
		subscriptionID: c.subscriptionID,
		internal:       c.internal,
	}
}
...
// NewRegistrationHubImagesClient creates a new instance of RegistrationHubImagesClient.
func (c *ClientFactory) NewRegistrationHubImagesClient() *RegistrationHubImagesClient {
	return &RegistrationHubImagesClient{
		subscriptionID: c.subscriptionID,
		internal:       c.internal,
	}
}

// NewRegistrationHubMachinesClient creates a new instance of RegistrationHubMachinesClient.
func (c *ClientFactory) NewRegistrationHubMachinesClient() *RegistrationHubMachinesClient {
	return &RegistrationHubMachinesClient{
		subscriptionID: c.subscriptionID,
		internal:       c.internal,
	}
}

// NewRegistrationHubsClient creates a new instance of RegistrationHubsClient.
func (c *ClientFactory) NewRegistrationHubsClient() *RegistrationHubsClient {
	return &RegistrationHubsClient{
		subscriptionID: c.subscriptionID,
		internal:       c.internal,
	}
}
