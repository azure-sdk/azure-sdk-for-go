...
// JobConfiguration - Non versioned Azure Spring Apps Job configuration
...
type JobExecution struct {
	...
	// READ-ONLY; Current state of the job execution
...
// JobExecutionTemplateEnvironmentVariables - Environment variables of Job execution
type JobExecutionTemplateEnvironmentVariables struct {
	// Non-sensitive properties
	Properties map[string]*string
...
type JobResourceCollection struct {
	// REQUIRED; Collection of Job resources.
	Value []*JobResource
