...
- Operation `*WebSiteManagementClient.NewListAseRegionsPager` does not support pagination anymore, use `*WebSiteManagementClient.ListAseRegions` instead.
- Field `NextLink` of struct `AseRegionCollection` has been removed
