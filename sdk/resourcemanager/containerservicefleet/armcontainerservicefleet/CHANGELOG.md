...
- `ManagedClusterUpgradeTypeControlPlaneOnly` from enum `ManagedClusterUpgradeType` has been removed
- Operation `*UpdateRunsClient.BeginSkip` has been changed to non-LRO, use `*UpdateRunsClient.Skip` instead.
