...
// RegistryCodeVersionsClientGetBlobReferenceSASResponse contains the response from method RegistryCodeVersionsClient.GetBlobReferenceSAS.
type RegistryCodeVersionsClientGetBlobReferenceSASResponse struct {
...
// RegistryComponentVersionsClientGetBlobReferenceSASResponse contains the response from method RegistryComponentVersionsClient.GetBlobReferenceSAS.
type RegistryComponentVersionsClientGetBlobReferenceSASResponse struct {
	BlobReferenceSASResponseDto
}
...
// RegistryDataVersionsClientGetBlobReferenceSASResponse contains the response from method RegistryDataVersionsClient.GetBlobReferenceSAS.
type RegistryDataVersionsClientGetBlobReferenceSASResponse struct {
	BlobReferenceSASResponseDto
}
...
// RegistryEnvironmentVersionsClientGetBlobReferenceSASResponse contains the response from method RegistryEnvironmentVersionsClient.GetBlobReferenceSAS.
type RegistryEnvironmentVersionsClientGetBlobReferenceSASResponse struct {
	BlobReferenceSASResponseDto
}
...
// RegistryModelVersionsClientGetBlobReferenceSASResponse contains the response from method RegistryModelVersionsClient.GetBlobReferenceSAS.
type RegistryModelVersionsClientGetBlobReferenceSASResponse struct {
	BlobReferenceSASResponseDto
}
