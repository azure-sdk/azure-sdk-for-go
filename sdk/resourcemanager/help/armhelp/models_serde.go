...
// MarshalJSON implements the json.Marshaller interface for type ContinueParameterBody.
func (c ContinueParameterBody) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "continueRequestBody", c.ContinueRequestBody)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ContinueParameterBody.
func (c *ContinueParameterBody) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
	for key, val := range rawMsg {
		...
		case "continueRequestBody":
			err = unpopulate(val, "ContinueRequestBody", &c.ContinueRequestBody)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", c, err)
...
// MarshalJSON implements the json.Marshaller interface for type WarmUpParameterBody.
func (w WarmUpParameterBody) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "solutionWarmUpRequestBody", w.SolutionWarmUpRequestBody)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type WarmUpParameterBody.
func (w *WarmUpParameterBody) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
	...
	for key, val := range rawMsg {
		var err error
		switch key {
		case "solutionWarmUpRequestBody":
			err = unpopulate(val, "SolutionWarmUpRequestBody", &w.SolutionWarmUpRequestBody)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", w, err)
