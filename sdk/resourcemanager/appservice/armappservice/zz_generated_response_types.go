...
// EnvironmentsClientTestUpgradeNotificationResponse contains the response from method EnvironmentsClient.TestUpgradeNotification.
type EnvironmentsClientTestUpgradeNotificationResponse struct {
	// placeholder for future response values
}
