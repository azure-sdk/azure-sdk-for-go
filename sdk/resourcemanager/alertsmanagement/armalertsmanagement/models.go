...
type InvestigationExecution struct {
	// REQUIRED; The time at which the investigation execution completed
...
type InvestigationResult struct {
	...
	// REQUIRED; The type of this investigation entity
	EntityType *string
	...
	// REQUIRED; The last update time of the investigation
...
type IssueProperties struct {
	// REQUIRED; The issue impact time
	...
	// READ-ONLY; The number of alerts related to the issue
	AlertsCount *int32
	...
	// READ-ONLY; The number of resources related to the issue
...
type RelatedAlert struct {
	...
	// READ-ONLY; The time this relation was added to the issue
	AddedAt *time.Time

	// READ-ONLY; The last update time of this relation
	LastModifiedAt *time.Time
...
type RunParameters struct {
	...
	// REQUIRED; The impact time to investigate
	ImpactTime *time.Time
...
type StartInvestigationParameters struct {
	...
	// The impact time to use for this investigation - by default, the impact time from the issue is used
	ImpactTime *time.Time
}
