...
func unmarshalMigrateMySQLAzureDbForMySQLReplicateChangesTaskOutputClassification(rawMsg json.RawMessage) (MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutputClassification, error) {
	if rawMsg == nil {
		return nil, nil
	}
	var m map[string]interface{}
	...
	var b MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutputClassification
	switch m["resultType"] {
	case "ErrorOutput":
		b = &MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutputError{}
	case "MigrationLevelOutput":
		b = &MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutputMigrationLevel{}
	default:
		b = &MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutput{}
	}
	return b, json.Unmarshal(rawMsg, b)
}

func unmarshalMigrateMySQLAzureDbForMySQLReplicateChangesTaskOutputClassificationArray(rawMsg json.RawMessage) ([]MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutputClassification, error) {
	if rawMsg == nil {
		return nil, nil
	}
	var rawMessages []json.RawMessage
	...
	fArray := make([]MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutputClassification, len(rawMessages))
	for index, rawMessage := range rawMessages {
		f, err := unmarshalMigrateMySQLAzureDbForMySQLReplicateChangesTaskOutputClassification(rawMessage)
		if err != nil {
			return nil, err
		}
		fArray[index] = f
...
func unmarshalMigrateMySQLAzureDbForMySQLTaskResultClassification(rawMsg json.RawMessage) (MigrateMySQLAzureDbForMySQLTaskResultClassification, error) {
	if rawMsg == nil {
		return nil, nil
	}
	var m map[string]interface{}
	...
	var b MigrateMySQLAzureDbForMySQLTaskResultClassification
	switch m["resultType"] {
	case "DatabaseLevelOutput":
		b = &MigrateMySQLAzureDbForMySQLOfflineTaskOutputDatabaseLevel{}
	case "ErrorOutput":
		b = &MigrateMySQLAzureDbForMySQLOfflineTaskOutputError{}
	case "MigrateMySqlAzureDbForMySqlOfflineTaskOutput":
		b = &MigrateMySQLAzureDbForMySQLOfflineTaskOutput{}
	case "MigrateMySqlAzureDbForMySqlReplicateChangesTaskOutput":
		b = &MigrateMySQLAzureDbForMySQLReplicateChangesTaskOutput{}
	case "MigrateMySqlAzureDbForMySqlSyncTaskOutput":
	...
	case "TableLevelOutput":
		b = &MigrateMySQLAzureDbForMySQLOfflineTaskOutputTableLevel{}
	default:
		b = &MigrateMySQLAzureDbForMySQLTaskResult{}
	}
	return b, json.Unmarshal(rawMsg, b)
}

func unmarshalMigrateMySQLAzureDbForMySQLTaskResultClassificationArray(rawMsg json.RawMessage) ([]MigrateMySQLAzureDbForMySQLTaskResultClassification, error) {
	if rawMsg == nil {
		return nil, nil
	}
	var rawMessages []json.RawMessage
	...
	fArray := make([]MigrateMySQLAzureDbForMySQLTaskResultClassification, len(rawMessages))
	for index, rawMessage := range rawMessages {
		f, err := unmarshalMigrateMySQLAzureDbForMySQLTaskResultClassification(rawMessage)
		if err != nil {
			return nil, err
		}
		fArray[index] = f
...
func unmarshalProjectTaskPropertiesClassification(rawMsg json.RawMessage) (ProjectTaskPropertiesClassification, error) {
	...
	case string(TaskTypeMigrateMySQLAzureDbForMySQLReplicateChanges):
		b = &MigrateMySQLAzureDbForMySQLReplicateChangesTaskProperties{}
