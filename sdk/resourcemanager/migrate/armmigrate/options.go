...
// SQLSitesControllerClientBeginImportURIOptions contains the optional parameters for the SQLSitesControllerClient.BeginImportURI
// method.
type SQLSitesControllerClientBeginImportURIOptions struct {
	// Resumes the long-running operation from the provided token.
	ResumeToken string
}
...
// SQLSitesControllerClientExportURIOptions contains the optional parameters for the SQLSitesControllerClient.ExportURI method.
type SQLSitesControllerClientExportURIOptions struct {
	// placeholder for future optional parameters
}
...
// SQLSitesControllerClientValidateAndImportURIOptions contains the optional parameters for the SQLSitesControllerClient.ValidateAndImportURI
// method.
type SQLSitesControllerClientValidateAndImportURIOptions struct {
	// placeholder for future optional parameters
}
