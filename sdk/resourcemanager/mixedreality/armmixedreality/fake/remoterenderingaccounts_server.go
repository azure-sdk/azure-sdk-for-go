...
func (r *RemoteRenderingAccountsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if remoteRenderingAccountsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = remoteRenderingAccountsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "RemoteRenderingAccountsClient.ListKeys":
				res.resp, res.err = r.dispatchListKeys(req)
			case "RemoteRenderingAccountsClient.RegenerateKeys":
				res.resp, res.err = r.dispatchRegenerateKeys(req)
...
// set this to conditionally intercept incoming requests to RemoteRenderingAccountsServerTransport
var remoteRenderingAccountsServerTransportInterceptor interface {
