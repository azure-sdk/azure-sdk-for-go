...
func (client *CassandraResourcesClient) NewListCassandraRoleAssignmentsPager(resourceGroupName string, accountName string, options *CassandraResourcesClientListCassandraRoleAssignmentsOptions) *runtime.Pager[CassandraResourcesClientListCassandraRoleAssignmentsResponse] {
	return runtime.NewPager(runtime.PagingHandler[CassandraResourcesClientListCassandraRoleAssignmentsResponse]{
		...
		Fetcher: func(ctx context.Context, page *CassandraResourcesClientListCassandraRoleAssignmentsResponse) (CassandraResourcesClientListCassandraRoleAssignmentsResponse, error) {
			...
			req, err := client.listCassandraRoleAssignmentsCreateRequest(ctx, resourceGroupName, accountName, options)
			if err != nil {
			...
			if !runtime.HasStatusCode(resp, http.StatusOK) {
				return CassandraResourcesClientListCassandraRoleAssignmentsResponse{}, runtime.NewResponseError(resp)
			}
...
func (client *CassandraResourcesClient) NewListCassandraRoleDefinitionsPager(resourceGroupName string, accountName string, options *CassandraResourcesClientListCassandraRoleDefinitionsOptions) *runtime.Pager[CassandraResourcesClientListCassandraRoleDefinitionsResponse] {
	return runtime.NewPager(runtime.PagingHandler[CassandraResourcesClientListCassandraRoleDefinitionsResponse]{
		...
		Fetcher: func(ctx context.Context, page *CassandraResourcesClientListCassandraRoleDefinitionsResponse) (CassandraResourcesClientListCassandraRoleDefinitionsResponse, error) {
			...
			req, err := client.listCassandraRoleDefinitionsCreateRequest(ctx, resourceGroupName, accountName, options)
			if err != nil {
			...
			if !runtime.HasStatusCode(resp, http.StatusOK) {
				return CassandraResourcesClientListCassandraRoleDefinitionsResponse{}, runtime.NewResponseError(resp)
			}
