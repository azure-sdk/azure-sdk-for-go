...
type FaultSimulation struct {
	...
	Parameters FaultSimulationParametersClassification
...
// FaultSimulationIDParameters - Parameters for Fault Simulation id.
type FaultSimulationIDParameters struct {
	// REQUIRED; The fault simulation identifier.
	SimulationID *string
}
...
// FaultSimulationParameters - Parameters for Fault Simulation action.
type FaultSimulationParameters struct {
	// REQUIRED; The kind of fault simulation.
	FaultKind *FaultKind
...
// GetFaultSimulationParameters implements the FaultSimulationParametersClassification interface for type FaultSimulationParameters.
func (f *FaultSimulationParameters) GetFaultSimulationParameters() *FaultSimulationParameters {
	return f
}
...
// ZoneFaultSimulationParameters - Parameters for Zone Fault Simulation action.
type ZoneFaultSimulationParameters struct {
	// REQUIRED; The kind of fault simulation.
	FaultKind *FaultKind
...
// GetFaultSimulationParameters implements the FaultSimulationParametersClassification interface for type ZoneFaultSimulationParameters.
func (z *ZoneFaultSimulationParameters) GetFaultSimulationParameters() *FaultSimulationParameters {
	return &FaultSimulationParameters{
