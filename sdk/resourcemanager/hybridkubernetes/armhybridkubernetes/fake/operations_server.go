...
type OperationsServer struct {
	...
	NewListPager func(options *armhybridkubernetes.OperationsClientListOptions) (resp azfake.PagerResponder[armhybridkubernetes.OperationsClientListResponse])
}
...
func NewOperationsServerTransport(srv *OperationsServer) *OperationsServerTransport {
	return &OperationsServerTransport{
		srv:          srv,
		newListPager: newTracker[azfake.PagerResponder[armhybridkubernetes.OperationsClientListResponse]](),
	}
}
...
type OperationsServerTransport struct {
	...
	newListPager *tracker[azfake.PagerResponder[armhybridkubernetes.OperationsClientListResponse]]
}
...
func (o *OperationsServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armhybridkubernetes.OperationsClientListResponse, createLink func() string) {
