...
func (r *RegistryModelContainersServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if registryModelContainersServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = registryModelContainersServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to RegistryModelContainersServerTransport
var registryModelContainersServerTransportInterceptor interface {
