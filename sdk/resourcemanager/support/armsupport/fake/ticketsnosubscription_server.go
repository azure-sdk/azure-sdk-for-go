...
func (t *TicketsNoSubscriptionServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if ticketsNoSubscriptionServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = ticketsNoSubscriptionServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to TicketsNoSubscriptionServerTransport
var ticketsNoSubscriptionServerTransportInterceptor interface {
