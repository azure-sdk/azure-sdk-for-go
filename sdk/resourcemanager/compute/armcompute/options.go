...
type CapacityReservationGroupsClientListBySubscriptionOptions struct {
	...
	// The query option to fetch Capacity Reservation Group Resource Ids. 'CreatedInSubscription' enables fetching Resource Ids
	// for all capacity reservation group resources created in the
	// subscription.'SharedWithSubscription' enables fetching Resource Ids for all capacity reservation group resources shared
	// with the subscription.'All' enables fetching Resource Ids for all capacity
