...
// StandbyPoolClientCreateOrUpdateResponse contains the response from method StandbyPoolClient.CreateOrUpdate.
type StandbyPoolClientCreateOrUpdateResponse struct {
	// placeholder for future response values
}

// StandbyPoolClientDeleteResponse contains the response from method StandbyPoolClient.Delete.
type StandbyPoolClientDeleteResponse struct {
	// placeholder for future response values
}

// StandbyPoolClientGetResponse contains the response from method StandbyPoolClient.Get.
type StandbyPoolClientGetResponse struct {
	// The response object from a successful call requesting a particular standby pool.
	GetStandbyPoolResponse
}

// StandbyPoolClientListResponse contains the response from method StandbyPoolClient.List.
type StandbyPoolClientListResponse struct {
	// placeholder for future response values
}
