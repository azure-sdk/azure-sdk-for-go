...
// SitesControllerServer is a fake server for instances of the armmigrationdiscovery.SitesControllerClient type.
type SitesControllerServer struct {
	...
	ComputeErrorSummary func(ctx context.Context, resourceGroupName string, siteName string, body any, options *armmigrationdiscovery.SitesControllerClientComputeErrorSummaryOptions) (resp azfake.Responder[armmigrationdiscovery.SitesControllerClientComputeErrorSummaryResponse], errResp azfake.ErrorResponder)

	// Computeusage is the fake for method SitesControllerClient.Computeusage
	// HTTP status codes to indicate success: http.StatusOK
	Computeusage func(ctx context.Context, resourceGroupName string, siteName string, body any, options *armmigrationdiscovery.SitesControllerClientComputeusageOptions) (resp azfake.Responder[armmigrationdiscovery.SitesControllerClientComputeusageResponse], errResp azfake.ErrorResponder)

	// Create is the fake for method SitesControllerClient.Create
	// HTTP status codes to indicate success: http.StatusOK, http.StatusCreated
	Create func(ctx context.Context, resourceGroupName string, siteName string, body armmigrationdiscovery.VmwareSite, options *armmigrationdiscovery.SitesControllerClientCreateOptions) (resp azfake.Responder[armmigrationdiscovery.SitesControllerClientCreateResponse], errResp azfake.ErrorResponder)

	// Delete is the fake for method SitesControllerClient.Delete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	Delete func(ctx context.Context, resourceGroupName string, siteName string, options *armmigrationdiscovery.SitesControllerClientDeleteOptions) (resp azfake.Responder[armmigrationdiscovery.SitesControllerClientDeleteResponse], errResp azfake.ErrorResponder)

	// BeginExportApplications is the fake for method SitesControllerClient.BeginExportApplications
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginExportApplications func(ctx context.Context, resourceGroupName string, siteName string, body any, options *armmigrationdiscovery.SitesControllerClientBeginExportApplicationsOptions) (resp azfake.PollerResponder[armmigrationdiscovery.SitesControllerClientExportApplicationsResponse], errResp azfake.ErrorResponder)

	// BeginExportMachineErrors is the fake for method SitesControllerClient.BeginExportMachineErrors
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginExportMachineErrors func(ctx context.Context, resourceGroupName string, siteName string, body armmigrationdiscovery.ExportMachineErrorsRequest, options *armmigrationdiscovery.SitesControllerClientBeginExportMachineErrorsOptions) (resp azfake.PollerResponder[armmigrationdiscovery.SitesControllerClientExportMachineErrorsResponse], errResp azfake.ErrorResponder)

	// BeginExportMachines is the fake for method SitesControllerClient.BeginExportMachines
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginExportMachines func(ctx context.Context, resourceGroupName string, siteName string, body armmigrationdiscovery.ExportMachinesRequest, options *armmigrationdiscovery.SitesControllerClientBeginExportMachinesOptions) (resp azfake.PollerResponder[armmigrationdiscovery.SitesControllerClientExportMachinesResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method SitesControllerClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, siteName string, options *armmigrationdiscovery.SitesControllerClientGetOptions) (resp azfake.Responder[armmigrationdiscovery.SitesControllerClientGetResponse], errResp azfake.ErrorResponder)

	// NewListByResourceGroupPager is the fake for method SitesControllerClient.NewListByResourceGroupPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByResourceGroupPager func(resourceGroupName string, options *armmigrationdiscovery.SitesControllerClientListByResourceGroupOptions) (resp azfake.PagerResponder[armmigrationdiscovery.SitesControllerClientListByResourceGroupResponse])

	// NewListBySubscriptionPager is the fake for method SitesControllerClient.NewListBySubscriptionPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListBySubscriptionPager func(options *armmigrationdiscovery.SitesControllerClientListBySubscriptionOptions) (resp azfake.PagerResponder[armmigrationdiscovery.SitesControllerClientListBySubscriptionResponse])

	// ListHealthSummary is the fake for method SitesControllerClient.ListHealthSummary
	// HTTP status codes to indicate success: http.StatusOK
	ListHealthSummary func(ctx context.Context, resourceGroupName string, siteName string, options *armmigrationdiscovery.SitesControllerClientListHealthSummaryOptions) (resp azfake.Responder[armmigrationdiscovery.SitesControllerClientListHealthSummaryResponse], errResp azfake.ErrorResponder)

	// Summary is the fake for method SitesControllerClient.Summary
	// HTTP status codes to indicate success: http.StatusOK
	Summary func(ctx context.Context, resourceGroupName string, siteName string, options *armmigrationdiscovery.SitesControllerClientSummaryOptions) (resp azfake.Responder[armmigrationdiscovery.SitesControllerClientSummaryResponse], errResp azfake.ErrorResponder)

	// Update is the fake for method SitesControllerClient.Update
	// HTTP status codes to indicate success: http.StatusOK
	Update func(ctx context.Context, resourceGroupName string, siteName string, body armmigrationdiscovery.VmwareSiteUpdate, options *armmigrationdiscovery.SitesControllerClientUpdateOptions) (resp azfake.Responder[armmigrationdiscovery.SitesControllerClientUpdateResponse], errResp azfake.ErrorResponder)
}
...
// The returned SitesControllerServerTransport instance is connected to an instance of armmigrationdiscovery.SitesControllerClient via the
...
func NewSitesControllerServerTransport(srv *SitesControllerServer) *SitesControllerServerTransport {
	return &SitesControllerServerTransport{
		srv:                         srv,
		beginExportApplications:     newTracker[azfake.PollerResponder[armmigrationdiscovery.SitesControllerClientExportApplicationsResponse]](),
		beginExportMachineErrors:    newTracker[azfake.PollerResponder[armmigrationdiscovery.SitesControllerClientExportMachineErrorsResponse]](),
		beginExportMachines:         newTracker[azfake.PollerResponder[armmigrationdiscovery.SitesControllerClientExportMachinesResponse]](),
		newListByResourceGroupPager: newTracker[azfake.PagerResponder[armmigrationdiscovery.SitesControllerClientListByResourceGroupResponse]](),
		newListBySubscriptionPager:  newTracker[azfake.PagerResponder[armmigrationdiscovery.SitesControllerClientListBySubscriptionResponse]](),
	}
}

// SitesControllerServerTransport connects instances of armmigrationdiscovery.SitesControllerClient to instances of SitesControllerServer.
...
type SitesControllerServerTransport struct {
	...
	beginExportApplications     *tracker[azfake.PollerResponder[armmigrationdiscovery.SitesControllerClientExportApplicationsResponse]]
	beginExportMachineErrors    *tracker[azfake.PollerResponder[armmigrationdiscovery.SitesControllerClientExportMachineErrorsResponse]]
	beginExportMachines         *tracker[azfake.PollerResponder[armmigrationdiscovery.SitesControllerClientExportMachinesResponse]]
	newListByResourceGroupPager *tracker[azfake.PagerResponder[armmigrationdiscovery.SitesControllerClientListByResourceGroupResponse]]
	newListBySubscriptionPager  *tracker[azfake.PagerResponder[armmigrationdiscovery.SitesControllerClientListBySubscriptionResponse]]
}
...
func (s *SitesControllerServerTransport) dispatchCreate(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[armmigrationdiscovery.VmwareSite](req)
	if err != nil {
		return nil, err
	}
	resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
...
func (s *SitesControllerServerTransport) dispatchBeginExportMachines(req *http.Request) (*http.Response, error) {
	...
	if beginExportMachines == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armmigrationdiscovery.ExportMachinesRequest](req)
		if err != nil {
			return nil, err
		}
		resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
...
func (s *SitesControllerServerTransport) dispatchNewListByResourceGroupPager(req *http.Request) (*http.Response, error) {
	...
	if newListByResourceGroupPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListByResourceGroupPager, req, func(page *armmigrationdiscovery.SitesControllerClientListByResourceGroupResponse, createLink func() string) {
...
func (s *SitesControllerServerTransport) dispatchNewListBySubscriptionPager(req *http.Request) (*http.Response, error) {
	...
	if newListBySubscriptionPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListBySubscriptionPager, req, func(page *armmigrationdiscovery.SitesControllerClientListBySubscriptionResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
...
func (s *SitesControllerServerTransport) dispatchUpdate(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[armmigrationdiscovery.VmwareSiteUpdate](req)
	if err != nil {
		return nil, err
	}
	resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
