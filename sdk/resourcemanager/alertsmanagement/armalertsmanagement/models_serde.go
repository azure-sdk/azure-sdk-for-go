...
// MarshalJSON implements the json.Marshaller interface for type LogAlertRuleIdentity.
func (l LogAlertRuleIdentity) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type LogAlertRuleIdentity.
func (l *LogAlertRuleIdentity) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", l, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type LogAlertRuleUserIdentityProperties.
func (l LogAlertRuleUserIdentityProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "clientId", l.ClientID)
	populate(objectMap, "principalId", l.PrincipalID)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type LogAlertRuleUserIdentityProperties.
func (l *LogAlertRuleUserIdentityProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", l, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "clientId":
			err = unpopulate(val, "ClientID", &l.ClientID)
			delete(rawMsg, key)
		case "principalId":
			err = unpopulate(val, "PrincipalID", &l.PrincipalID)
			delete(rawMsg, key)
