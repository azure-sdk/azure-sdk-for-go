...
// KeyRotationPolicyActionType - The type of the action. The value should be compared case-insensitively.
...
const (
	...
	// KeyRotationPolicyActionTypeRotate - Rotate the key based on the key policy.
