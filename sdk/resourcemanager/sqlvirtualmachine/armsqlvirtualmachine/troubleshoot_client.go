...
// BeginTroubleshoot - Starts SQL virtual machine troubleshoot.
...
// parameters - The SQL virtual machine troubleshoot entity.
...
// method.
func (client *TroubleshootClient) BeginTroubleshoot(ctx context.Context, resourceGroupName string, sqlVirtualMachineName string, parameters SQLVMTroubleshoot, options *TroubleshootClientBeginTroubleshootOptions) (*runtime.Poller[TroubleshootClientTroubleshootResponse], error) {
...
// Troubleshoot - Starts SQL virtual machine troubleshoot.
// If the operation fails it returns an *azcore.ResponseError type.
// Generated from API version 2022-08-01-preview
func (client *TroubleshootClient) troubleshoot(ctx context.Context, resourceGroupName string, sqlVirtualMachineName string, parameters SQLVMTroubleshoot, options *TroubleshootClientBeginTroubleshootOptions) (*http.Response, error) {
...
func (client *TroubleshootClient) troubleshootCreateRequest(ctx context.Context, resourceGroupName string, sqlVirtualMachineName string, parameters SQLVMTroubleshoot, options *TroubleshootClientBeginTroubleshootOptions) (*policy.Request, error) {
