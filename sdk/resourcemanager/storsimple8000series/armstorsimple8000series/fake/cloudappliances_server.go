...
func (c *CloudAppliancesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if cloudAppliancesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = cloudAppliancesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			case "CloudAppliancesClient.NewListSupportedConfigurationsPager":
				res.resp, res.err = c.dispatchNewListSupportedConfigurationsPager(req)
			case "CloudAppliancesClient.BeginProvision":
				res.resp, res.err = c.dispatchBeginProvision(req)
			default:
...
// set this to conditionally intercept incoming requests to CloudAppliancesServerTransport
var cloudAppliancesServerTransportInterceptor interface {
