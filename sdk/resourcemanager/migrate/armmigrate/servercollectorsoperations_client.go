...
func NewServerCollectorsOperationsClient(subscriptionID string, credential azcore.TokenCredential, options *arm.ClientOptions) (*ServerCollectorsOperationsClient, error) {
	cl, err := arm.NewClient(moduleName+".ServerCollectorsOperationsClient", moduleVersion, credential, options)
	if err != nil {
		return nil, err
	}
...
func (client *ServerCollectorsOperationsClient) BeginCreate(ctx context.Context, resourceGroupName string, projectName string, serverCollectorName string, resource ServerCollector, options *ServerCollectorsOperationsClientBeginCreateOptions) (*runtime.Poller[ServerCollectorsOperationsClientCreateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return runtime.NewPollerFromResumeToken[ServerCollectorsOperationsClientCreateResponse](options.ResumeToken, client.internal.Pipeline(), nil)
	}
}
...
func (client *ServerCollectorsOperationsClient) createCreateRequest(ctx context.Context, resourceGroupName string, projectName string, serverCollectorName string, resource ServerCollector, options *ServerCollectorsOperationsClientBeginCreateOptions) (*policy.Request, error) {
...
func (client *ServerCollectorsOperationsClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, projectName string, serverCollectorName string, options *ServerCollectorsOperationsClientDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Migrate/assessmentProjects/{projectName}/servercollectors/{serverCollectorName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *ServerCollectorsOperationsClient) getCreateRequest(ctx context.Context, resourceGroupName string, projectName string, serverCollectorName string, options *ServerCollectorsOperationsClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Migrate/assessmentProjects/{projectName}/servercollectors/{serverCollectorName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
	...
	return runtime.NewPager(runtime.PagingHandler[ServerCollectorsOperationsClientListByAssessmentProjectResponse]{
		...
		Fetcher: func(ctx context.Context, page *ServerCollectorsOperationsClientListByAssessmentProjectResponse) (ServerCollectorsOperationsClientListByAssessmentProjectResponse, error) {
			...
			if !runtime.HasStatusCode(resp, http.StatusOK) {
				return ServerCollectorsOperationsClientListByAssessmentProjectResponse{}, runtime.NewResponseError(resp)
			}
...
func (client *ServerCollectorsOperationsClient) listByAssessmentProjectCreateRequest(ctx context.Context, resourceGroupName string, projectName string, options *ServerCollectorsOperationsClientListByAssessmentProjectOptions) (*policy.Request, error) {
