...
func (client *ChatTranscriptsNoSubscriptionClient) getCreateRequest(ctx context.Context, supportTicketName string, chatTranscriptName string, _ *ChatTranscriptsNoSubscriptionClientGetOptions) (*policy.Request, error) {
