...
type DatabaseProperties struct {
	// REQUIRED; Redis eviction policy - default is VolatileLRU
	EvictionPolicy *EvictionPolicy `json:"evictionPolicy,omitempty"`

	// REQUIRED; Persistence settings
	Persistence *Persistence `json:"persistence,omitempty"`

	// REQUIRED; Port number for the database to listen on. The only valid value currently, is 10000. Other values may be valid
	// in the future.
...
// OperationStatus - Proxy resource for selecting azure location
