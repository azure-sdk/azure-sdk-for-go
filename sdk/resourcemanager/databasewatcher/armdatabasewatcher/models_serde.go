...
func (v ValidationIssue) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "validationResourceId", v.ValidationResourceID)
	populate(objectMap, "validationResourceType", v.ValidationResourceType)
	return json.Marshal(objectMap)
}
...
func (v *ValidationIssue) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "recommendationUrl":
			...
			delete(rawMsg, key)
		case "validationResourceId":
			err = unpopulate(val, "ValidationResourceID", &v.ValidationResourceID)
			delete(rawMsg, key)
		case "validationResourceType":
			err = unpopulate(val, "ValidationResourceType", &v.ValidationResourceType)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", v, err)
