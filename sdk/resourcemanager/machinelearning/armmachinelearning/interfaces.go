...
// TrialClassification provides polymorphic access to related types.
// Call the interface's GetTrial() method to access the common type.
// Use a type switch to determine the concrete type.  The possible types are:
// - *Trial, *TrialComponent, *TrialPipelineComponent
type TrialClassification interface {
	// GetTrial returns the Trial content of the underlying type.
	GetTrial() *Trial
}
