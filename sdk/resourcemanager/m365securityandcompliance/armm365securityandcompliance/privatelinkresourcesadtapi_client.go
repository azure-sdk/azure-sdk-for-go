...
func (client *PrivateLinkResourcesAdtAPIClient) getCreateRequest(ctx context.Context, resourceGroupName string, resourceName string, groupName string, _ *PrivateLinkResourcesAdtAPIClientGetOptions) (*policy.Request, error) {
...
func (client *PrivateLinkResourcesAdtAPIClient) listByServiceCreateRequest(ctx context.Context, resourceGroupName string, resourceName string, _ *PrivateLinkResourcesAdtAPIClientListByServiceOptions) (*policy.Request, error) {
