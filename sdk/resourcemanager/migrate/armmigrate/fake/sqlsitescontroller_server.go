...
type SQLSitesControllerServer struct {
	...
	// ExportURI is the fake for method SQLSitesControllerClient.ExportURI
	// HTTP status codes to indicate success: http.StatusOK
	ExportURI func(ctx context.Context, resourceGroupName string, siteName string, sqlSiteName string, body armmigrate.SQLInventoryImportBody, options *armmigrate.SQLSitesControllerClientExportURIOptions) (resp azfake.Responder[armmigrate.SQLSitesControllerClientExportURIResponse], errResp azfake.ErrorResponder)
	...
	// BeginImportURI is the fake for method SQLSitesControllerClient.BeginImportURI
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginImportURI func(ctx context.Context, resourceGroupName string, siteName string, sqlSiteName string, body armmigrate.SQLInventoryImportBody, options *armmigrate.SQLSitesControllerClientBeginImportURIOptions) (resp azfake.PollerResponder[armmigrate.SQLSitesControllerClientImportURIResponse], errResp azfake.ErrorResponder)
	...
	// ValidateAndImportURI is the fake for method SQLSitesControllerClient.ValidateAndImportURI
	// HTTP status codes to indicate success: http.StatusOK
	ValidateAndImportURI func(ctx context.Context, resourceGroupName string, siteName string, sqlSiteName string, body armmigrate.SQLInventoryImportBody, options *armmigrate.SQLSitesControllerClientValidateAndImportURIOptions) (resp azfake.Responder[armmigrate.SQLSitesControllerClientValidateAndImportURIResponse], errResp azfake.ErrorResponder)
}
...
func NewSQLSitesControllerServerTransport(srv *SQLSitesControllerServer) *SQLSitesControllerServerTransport {
	return &SQLSitesControllerServerTransport{
		...
		beginImportURI:             newTracker[azfake.PollerResponder[armmigrate.SQLSitesControllerClientImportURIResponse]](),
...
type SQLSitesControllerServerTransport struct {
	...
	beginImportURI             *tracker[azfake.PollerResponder[armmigrate.SQLSitesControllerClientImportURIResponse]]
...
func (s *SQLSitesControllerServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		if !intercepted {
			...
			case "SQLSitesControllerClient.ExportURI":
				res.resp, res.err = s.dispatchExportURI(req)
			case "SQLSitesControllerClient.Get":
				res.resp, res.err = s.dispatchGet(req)
			case "SQLSitesControllerClient.BeginImportURI":
				res.resp, res.err = s.dispatchBeginImportURI(req)
			...
			case "SQLSitesControllerClient.ValidateAndImportURI":
				res.resp, res.err = s.dispatchValidateAndImportURI(req)
			default:
...
func (s *SQLSitesControllerServerTransport) dispatchExportURI(req *http.Request) (*http.Response, error) {
	if s.srv.ExportURI == nil {
		return nil, &nonRetriableError{errors.New("fake for method ExportURI not implemented")}
	}
	const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.OffAzure/masterSites/(?P<siteName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/sqlSites/(?P<sqlSiteName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/exportUri`
	regex := regexp.MustCompile(regexStr)
	matches := regex.FindStringSubmatch(req.URL.EscapedPath())
	if matches == nil || len(matches) < 4 {
		return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
	...
	respr, errRespr := s.srv.ExportURI(req.Context(), resourceGroupNameParam, siteNameParam, sqlSiteNameParam, body, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (s *SQLSitesControllerServerTransport) dispatchBeginImportURI(req *http.Request) (*http.Response, error) {
	if s.srv.BeginImportURI == nil {
		return nil, &nonRetriableError{errors.New("fake for method BeginImportURI not implemented")}
	}
	beginImportURI := s.beginImportURI.get(req)
	if beginImportURI == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.OffAzure/masterSites/(?P<siteName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/sqlSites/(?P<sqlSiteName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/importUri`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if matches == nil || len(matches) < 4 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
		...
		respr, errRespr := s.srv.BeginImportURI(req.Context(), resourceGroupNameParam, siteNameParam, sqlSiteNameParam, body, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginImportURI = &respr
		s.beginImportURI.add(req, beginImportURI)
	}

	resp, err := server.PollerResponderNext(beginImportURI, req)
	if err != nil {
		return nil, err
	}

	if !contains([]int{http.StatusOK, http.StatusAccepted, http.StatusNoContent}, resp.StatusCode) {
		s.beginImportURI.remove(req)
		return nil, &nonRetriableError{fmt.Errorf("unexpected status code %d. acceptable values are http.StatusOK, http.StatusAccepted, http.StatusNoContent", resp.StatusCode)}
	}
	if !server.PollerResponderMore(beginImportURI) {
		s.beginImportURI.remove(req)
	}
...
func (s *SQLSitesControllerServerTransport) dispatchValidateAndImportURI(req *http.Request) (*http.Response, error) {
	if s.srv.ValidateAndImportURI == nil {
		return nil, &nonRetriableError{errors.New("fake for method ValidateAndImportURI not implemented")}
	}
	const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.OffAzure/masterSites/(?P<siteName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/sqlSites/(?P<sqlSiteName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/validateAndImportUri`
	regex := regexp.MustCompile(regexStr)
	matches := regex.FindStringSubmatch(req.URL.EscapedPath())
	if matches == nil || len(matches) < 4 {
		return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
	...
	respr, errRespr := s.srv.ValidateAndImportURI(req.Context(), resourceGroupNameParam, siteNameParam, sqlSiteNameParam, body, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
