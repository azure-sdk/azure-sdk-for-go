...
func (client *SubscriptionsClient) getCreateRequest(ctx context.Context, subscriptionID string, _ *SubscriptionsClientGetOptions) (*policy.Request, error) {
...
func (client *SubscriptionsClient) listCreateRequest(ctx context.Context, _ *SubscriptionsClientListOptions) (*policy.Request, error) {
...
func (client *SubscriptionsClient) listLocationsCreateRequest(ctx context.Context, subscriptionID string, _ *SubscriptionsClientListLocationsOptions) (*policy.Request, error) {
