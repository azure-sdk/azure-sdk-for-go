...
const (
	ExpandTypeProperties ExpandType = "Properties"
)

// PossibleExpandTypeValues returns the possible values for the ExpandType const type.
func PossibleExpandTypeValues() []ExpandType {
	return []ExpandType{
		ExpandTypeProperties,
	}
}
