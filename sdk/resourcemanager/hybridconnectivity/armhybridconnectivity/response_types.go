...
// ServiceconfigurationsClientCreateResponse contains the response from method ServiceconfigurationsClient.Create.
type ServiceconfigurationsClientCreateResponse struct {
