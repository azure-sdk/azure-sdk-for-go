...
// PolicyDefinitionsServer is a fake server for instances of the armfeatures.PolicyDefinitionsClient type.
type PolicyDefinitionsServer struct {
	...
	CreateOrUpdate func(ctx context.Context, policyDefinitionName string, parameters armfeatures.PolicyDefinition, options *armfeatures.PolicyDefinitionsClientCreateOrUpdateOptions) (resp azfake.Responder[armfeatures.PolicyDefinitionsClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)

	// CreateOrUpdateAtManagementGroup is the fake for method PolicyDefinitionsClient.CreateOrUpdateAtManagementGroup
	// HTTP status codes to indicate success: http.StatusCreated
	CreateOrUpdateAtManagementGroup func(ctx context.Context, managementGroupID string, policyDefinitionName string, parameters armfeatures.PolicyDefinition, options *armfeatures.PolicyDefinitionsClientCreateOrUpdateAtManagementGroupOptions) (resp azfake.Responder[armfeatures.PolicyDefinitionsClientCreateOrUpdateAtManagementGroupResponse], errResp azfake.ErrorResponder)

	// Delete is the fake for method PolicyDefinitionsClient.Delete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	Delete func(ctx context.Context, policyDefinitionName string, options *armfeatures.PolicyDefinitionsClientDeleteOptions) (resp azfake.Responder[armfeatures.PolicyDefinitionsClientDeleteResponse], errResp azfake.ErrorResponder)

	// DeleteAtManagementGroup is the fake for method PolicyDefinitionsClient.DeleteAtManagementGroup
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	DeleteAtManagementGroup func(ctx context.Context, managementGroupID string, policyDefinitionName string, options *armfeatures.PolicyDefinitionsClientDeleteAtManagementGroupOptions) (resp azfake.Responder[armfeatures.PolicyDefinitionsClientDeleteAtManagementGroupResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method PolicyDefinitionsClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, policyDefinitionName string, options *armfeatures.PolicyDefinitionsClientGetOptions) (resp azfake.Responder[armfeatures.PolicyDefinitionsClientGetResponse], errResp azfake.ErrorResponder)

	// GetAtManagementGroup is the fake for method PolicyDefinitionsClient.GetAtManagementGroup
	// HTTP status codes to indicate success: http.StatusOK
	GetAtManagementGroup func(ctx context.Context, managementGroupID string, policyDefinitionName string, options *armfeatures.PolicyDefinitionsClientGetAtManagementGroupOptions) (resp azfake.Responder[armfeatures.PolicyDefinitionsClientGetAtManagementGroupResponse], errResp azfake.ErrorResponder)

	// GetBuiltIn is the fake for method PolicyDefinitionsClient.GetBuiltIn
	// HTTP status codes to indicate success: http.StatusOK
	GetBuiltIn func(ctx context.Context, policyDefinitionName string, options *armfeatures.PolicyDefinitionsClientGetBuiltInOptions) (resp azfake.Responder[armfeatures.PolicyDefinitionsClientGetBuiltInResponse], errResp azfake.ErrorResponder)

	// NewListPager is the fake for method PolicyDefinitionsClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(options *armfeatures.PolicyDefinitionsClientListOptions) (resp azfake.PagerResponder[armfeatures.PolicyDefinitionsClientListResponse])

	// NewListBuiltInPager is the fake for method PolicyDefinitionsClient.NewListBuiltInPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListBuiltInPager func(options *armfeatures.PolicyDefinitionsClientListBuiltInOptions) (resp azfake.PagerResponder[armfeatures.PolicyDefinitionsClientListBuiltInResponse])

	// NewListByManagementGroupPager is the fake for method PolicyDefinitionsClient.NewListByManagementGroupPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByManagementGroupPager func(managementGroupID string, options *armfeatures.PolicyDefinitionsClientListByManagementGroupOptions) (resp azfake.PagerResponder[armfeatures.PolicyDefinitionsClientListByManagementGroupResponse])
}
...
// The returned PolicyDefinitionsServerTransport instance is connected to an instance of armfeatures.PolicyDefinitionsClient via the
...
func NewPolicyDefinitionsServerTransport(srv *PolicyDefinitionsServer) *PolicyDefinitionsServerTransport {
	return &PolicyDefinitionsServerTransport{
		srv:                           srv,
		newListPager:                  newTracker[azfake.PagerResponder[armfeatures.PolicyDefinitionsClientListResponse]](),
		newListBuiltInPager:           newTracker[azfake.PagerResponder[armfeatures.PolicyDefinitionsClientListBuiltInResponse]](),
		newListByManagementGroupPager: newTracker[azfake.PagerResponder[armfeatures.PolicyDefinitionsClientListByManagementGroupResponse]](),
	}
}

// PolicyDefinitionsServerTransport connects instances of armfeatures.PolicyDefinitionsClient to instances of PolicyDefinitionsServer.
...
type PolicyDefinitionsServerTransport struct {
	...
	newListPager                  *tracker[azfake.PagerResponder[armfeatures.PolicyDefinitionsClientListResponse]]
	newListBuiltInPager           *tracker[azfake.PagerResponder[armfeatures.PolicyDefinitionsClientListBuiltInResponse]]
	newListByManagementGroupPager *tracker[azfake.PagerResponder[armfeatures.PolicyDefinitionsClientListByManagementGroupResponse]]
}
...
func (p *PolicyDefinitionsServerTransport) dispatchCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[armfeatures.PolicyDefinition](req)
	if err != nil {
		return nil, err
	}
...
func (p *PolicyDefinitionsServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		var options *armfeatures.PolicyDefinitionsClientListOptions
		if filterParam != nil || topParam != nil {
			options = &armfeatures.PolicyDefinitionsClientListOptions{
				Filter: filterParam,
				Top:    topParam,
			}
		}
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armfeatures.PolicyDefinitionsClientListResponse, createLink func() string) {
...
func (p *PolicyDefinitionsServerTransport) dispatchNewListBuiltInPager(req *http.Request) (*http.Response, error) {
	...
	if newListBuiltInPager == nil {
		...
		var options *armfeatures.PolicyDefinitionsClientListBuiltInOptions
		if filterParam != nil || topParam != nil {
			options = &armfeatures.PolicyDefinitionsClientListBuiltInOptions{
				Filter: filterParam,
				Top:    topParam,
			}
		}
		...
		server.PagerResponderInjectNextLinks(newListBuiltInPager, req, func(page *armfeatures.PolicyDefinitionsClientListBuiltInResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
...
func (p *PolicyDefinitionsServerTransport) dispatchNewListByManagementGroupPager(req *http.Request) (*http.Response, error) {
	...
	if newListByManagementGroupPager == nil {
		...
		var options *armfeatures.PolicyDefinitionsClientListByManagementGroupOptions
		if filterParam != nil || topParam != nil {
			options = &armfeatures.PolicyDefinitionsClientListByManagementGroupOptions{
				Filter: filterParam,
				Top:    topParam,
			}
		}
		...
		server.PagerResponderInjectNextLinks(newListByManagementGroupPager, req, func(page *armfeatures.PolicyDefinitionsClientListByManagementGroupResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
