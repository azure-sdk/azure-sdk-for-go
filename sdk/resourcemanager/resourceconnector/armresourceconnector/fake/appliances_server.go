...
func (a *AppliancesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if appliancesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = appliancesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "AppliancesClient.GetTelemetryConfig":
				res.resp, res.err = a.dispatchGetTelemetryConfig(req)
			case "AppliancesClient.GetUpgradeGraph":
				res.resp, res.err = a.dispatchGetUpgradeGraph(req)
			...
			case "AppliancesClient.ListClusterUserCredential":
				res.resp, res.err = a.dispatchListClusterUserCredential(req)
...
// set this to conditionally intercept incoming requests to AppliancesServerTransport
var appliancesServerTransportInterceptor interface {
