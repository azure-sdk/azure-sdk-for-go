...
type ReportConfigDefinition struct {
	...
	// Optionally select a resource provider to get detailed usage information. Permitted values include 'Microsoft.ContainerService'.
	Provider *string
...
type SavingsPlanUtilizationSummaryProperties struct {
	...
	// Suppose the API call is for usageDate > 2023-09-01-preview and usageDate < 2022-10-31 at a
