...
- New function `*ClientFactory.NewActionGroupsClient() *ActionGroupsClient`
- New function `*ClientFactory.NewActivityLogAlertsClient() *ActivityLogAlertsClient`
- New function `*ClientFactory.NewActivityLogsClient() *ActivityLogsClient`
- New function `*ClientFactory.NewAlertRuleIncidentsClient() *AlertRuleIncidentsClient`
- New function `*ClientFactory.NewAlertRulesClient() *AlertRulesClient`
- New function `*ClientFactory.NewAutoscaleSettingsClient() *AutoscaleSettingsClient`
- New function `*ClientFactory.NewAzureMonitorWorkspacesClient() *AzureMonitorWorkspacesClient`
- New function `*ClientFactory.NewBaselinesClient() *BaselinesClient`
- New function `*ClientFactory.NewDataCollectionEndpointsClient() *DataCollectionEndpointsClient`
- New function `*ClientFactory.NewDataCollectionRuleAssociationsClient() *DataCollectionRuleAssociationsClient`
- New function `*ClientFactory.NewDataCollectionRulesClient() *DataCollectionRulesClient`
...
- New function `*ClientFactory.NewEventCategoriesClient() *EventCategoriesClient`
- New function `*ClientFactory.NewLogProfilesClient() *LogProfilesClient`
- New function `*ClientFactory.NewMetricAlertsClient() *MetricAlertsClient`
- New function `*ClientFactory.NewMetricAlertsStatusClient() *MetricAlertsStatusClient`
- New function `*ClientFactory.NewMetricDefinitionsClient() *MetricDefinitionsClient`
- New function `*ClientFactory.NewMetricNamespacesClient() *MetricNamespacesClient`
- New function `*ClientFactory.NewMetricsClient() *MetricsClient`
- New function `*ClientFactory.NewOperationsClient() *OperationsClient`
- New function `*ClientFactory.NewOperationsForMonitorClient() *OperationsForMonitorClient`
- New function `*ClientFactory.NewPredictiveMetricClient() *PredictiveMetricClient`
- New function `*ClientFactory.NewPrivateEndpointConnectionsClient() *PrivateEndpointConnectionsClient`
- New function `*ClientFactory.NewPrivateLinkResourcesClient() *PrivateLinkResourcesClient`
- New function `*ClientFactory.NewPrivateLinkScopeOperationStatusClient() *PrivateLinkScopeOperationStatusClient`
- New function `*ClientFactory.NewPrivateLinkScopedResourcesClient() *PrivateLinkScopedResourcesClient`
- New function `*ClientFactory.NewPrivateLinkScopesClient() *PrivateLinkScopesClient`
- New function `*ClientFactory.NewScheduledQueryRulesClient() *ScheduledQueryRulesClient`
- New function `*ClientFactory.NewTenantActionGroupsClient() *TenantActionGroupsClient`
- New function `*ClientFactory.NewTenantActivityLogsClient() *TenantActivityLogsClient`
