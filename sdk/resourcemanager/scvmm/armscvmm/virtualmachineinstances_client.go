...
//     method.
func (client *VirtualMachineInstancesClient) BeginRestart(ctx context.Context, resourceURI string, body any, options *VirtualMachineInstancesClientBeginRestartOptions) (*runtime.Poller[VirtualMachineInstancesClientRestartResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.restart(ctx, resourceURI, body, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2023-10-07
func (client *VirtualMachineInstancesClient) restart(ctx context.Context, resourceURI string, body any, options *VirtualMachineInstancesClientBeginRestartOptions) (*http.Response, error) {
	var err error
	const operationName = "VirtualMachineInstancesClient.BeginRestart"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.restartCreateRequest(ctx, resourceURI, body, options)
	if err != nil {
		return nil, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
...
func (client *VirtualMachineInstancesClient) restartCreateRequest(ctx context.Context, resourceURI string, body any, options *VirtualMachineInstancesClientBeginRestartOptions) (*policy.Request, error) {
...
//     method.
func (client *VirtualMachineInstancesClient) BeginStart(ctx context.Context, resourceURI string, body any, options *VirtualMachineInstancesClientBeginStartOptions) (*runtime.Poller[VirtualMachineInstancesClientStartResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.start(ctx, resourceURI, body, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2023-10-07
func (client *VirtualMachineInstancesClient) start(ctx context.Context, resourceURI string, body any, options *VirtualMachineInstancesClientBeginStartOptions) (*http.Response, error) {
	var err error
	const operationName = "VirtualMachineInstancesClient.BeginStart"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.startCreateRequest(ctx, resourceURI, body, options)
	if err != nil {
		return nil, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
...
func (client *VirtualMachineInstancesClient) startCreateRequest(ctx context.Context, resourceURI string, body any, options *VirtualMachineInstancesClientBeginStartOptions) (*policy.Request, error) {
