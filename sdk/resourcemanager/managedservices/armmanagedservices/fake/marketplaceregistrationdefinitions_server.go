...
func (m *MarketplaceRegistrationDefinitionsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if marketplaceRegistrationDefinitionsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = marketplaceRegistrationDefinitionsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to MarketplaceRegistrationDefinitionsServerTransport
var marketplaceRegistrationDefinitionsServerTransportInterceptor interface {
