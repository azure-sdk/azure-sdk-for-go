...
type SQLDiscoverySiteDataSourceControllerServer struct {
	...
	// BeginDelete is the fake for method SQLDiscoverySiteDataSourceControllerClient.BeginDelete
	// HTTP status codes to indicate success: http.StatusAccepted, http.StatusNoContent
	BeginDelete func(ctx context.Context, resourceGroupName string, siteName string, sqlSiteName string, discoverySiteDataSourceName string, options *armmigrate.SQLDiscoverySiteDataSourceControllerClientBeginDeleteOptions) (resp azfake.PollerResponder[armmigrate.SQLDiscoverySiteDataSourceControllerClientDeleteResponse], errResp azfake.ErrorResponder)
...
func NewSQLDiscoverySiteDataSourceControllerServerTransport(srv *SQLDiscoverySiteDataSourceControllerServer) *SQLDiscoverySiteDataSourceControllerServerTransport {
	return &SQLDiscoverySiteDataSourceControllerServerTransport{
		...
		beginDelete:           newTracker[azfake.PollerResponder[armmigrate.SQLDiscoverySiteDataSourceControllerClientDeleteResponse]](),
...
type SQLDiscoverySiteDataSourceControllerServerTransport struct {
	...
	beginDelete           *tracker[azfake.PollerResponder[armmigrate.SQLDiscoverySiteDataSourceControllerClientDeleteResponse]]
...
func (s *SQLDiscoverySiteDataSourceControllerServerTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "SQLDiscoverySiteDataSourceControllerClient.BeginDelete":
...
func (s *SQLDiscoverySiteDataSourceControllerServerTransport) dispatchBeginDelete(req *http.Request) (*http.Response, error) {
	...
	if beginDelete == nil {
		...
		respr, errRespr := s.srv.BeginDelete(req.Context(), resourceGroupNameParam, siteNameParam, sqlSiteNameParam, discoverySiteDataSourceNameParam, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginDelete = &respr
