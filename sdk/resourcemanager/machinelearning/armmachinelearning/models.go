...
type BaseEnvironmentID struct {
	...
	// REQUIRED; [Required] Resource id accepting Azure resource Id or AzureMlId.
	ResourceID *string
}
...
type PackageRequest struct {
	...
	// REQUIRED; [Required] Azure resource ID of the target environment to be created by package operation.
