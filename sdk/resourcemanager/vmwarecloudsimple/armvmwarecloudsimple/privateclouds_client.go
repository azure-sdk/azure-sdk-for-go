...
func (client *PrivateCloudsClient) getCreateRequest(ctx context.Context, pcName string, regionID string, _ *PrivateCloudsClientGetOptions) (*policy.Request, error) {
...
func (client *PrivateCloudsClient) listCreateRequest(ctx context.Context, regionID string, _ *PrivateCloudsClientListOptions) (*policy.Request, error) {
