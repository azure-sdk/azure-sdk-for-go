...
func ExampleSolutionResourceSelfHelpsClient_Get() {
	...
	res, err := clientFactory.NewSolutionResourceSelfHelpsClient().Get(ctx, "SolutionId1", nil)
	if err != nil {
	...
	// res = armhelp.SolutionResourceSelfHelpsClientGetResponse{
	// 	SolutionResourceSelfHelp: &armhelp.SolutionResourceSelfHelp{
	...
	// 		Properties: &armhelp.SolutionsResourcePropertiesSelfHelp{
	// 			Content: to.Ptr("<p>sample content</p>"),
	// 			ReplacementMaps: &armhelp.ReplacementMapsSelfHelp{
	...
	// 				},
	// 			},
	// 			Sections: []*armhelp.SectionSelfHelp{
	// 				{
	// 					Content: to.Ptr("<p>sample content</p>"),
	// 					ReplacementMaps: &armhelp.ReplacementMapsSelfHelp{
	// 					},
