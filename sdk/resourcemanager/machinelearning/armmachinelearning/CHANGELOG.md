...
- Type of `SweepJob.Trial` has been changed from `*TrialComponent` to `TrialClassification`
...
- New enum type `TrialType` with values `TrialTypeCommandComponent`, `TrialTypePipelineComponent`
...
- New function `*Trial.GetTrial() *Trial`
- New function `*TrialComponent.GetTrial() *Trial`
- New function `*TrialPipelineComponent.GetTrial() *Trial`
...
- New struct `TrialPipelineComponent`
...
- New field `TrialType` in struct `TrialComponent`
