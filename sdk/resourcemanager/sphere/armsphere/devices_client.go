...
func (client *DevicesClient) generateCapabilityImageCreateRequest(ctx context.Context, resourceGroupName string, catalogName string, productName string, deviceGroupName string, deviceName string, body GenerateCapabilityImageRequest, _ *DevicesClientBeginGenerateCapabilityImageOptions) (*policy.Request, error) {
