...
// MonitorsClientUpdateAgentStatusResponse contains the response from method MonitorsClient.UpdateAgentStatus.
type MonitorsClientUpdateAgentStatusResponse struct {
	// placeholder for future response values
}
