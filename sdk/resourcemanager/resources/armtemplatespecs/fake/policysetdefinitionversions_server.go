...
// PolicySetDefinitionVersionsServer is a fake server for instances of the armtemplatespecs.PolicySetDefinitionVersionsClient type.
type PolicySetDefinitionVersionsServer struct {
	...
	CreateOrUpdate func(ctx context.Context, policySetDefinitionName string, policyDefinitionVersion string, parameters armtemplatespecs.PolicySetDefinitionVersion, options *armtemplatespecs.PolicySetDefinitionVersionsClientCreateOrUpdateOptions) (resp azfake.Responder[armtemplatespecs.PolicySetDefinitionVersionsClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)

	// CreateOrUpdateAtManagementGroup is the fake for method PolicySetDefinitionVersionsClient.CreateOrUpdateAtManagementGroup
	// HTTP status codes to indicate success: http.StatusOK, http.StatusCreated
	CreateOrUpdateAtManagementGroup func(ctx context.Context, managementGroupName string, policySetDefinitionName string, policyDefinitionVersion string, parameters armtemplatespecs.PolicySetDefinitionVersion, options *armtemplatespecs.PolicySetDefinitionVersionsClientCreateOrUpdateAtManagementGroupOptions) (resp azfake.Responder[armtemplatespecs.PolicySetDefinitionVersionsClientCreateOrUpdateAtManagementGroupResponse], errResp azfake.ErrorResponder)

	// Delete is the fake for method PolicySetDefinitionVersionsClient.Delete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	Delete func(ctx context.Context, policySetDefinitionName string, policyDefinitionVersion string, options *armtemplatespecs.PolicySetDefinitionVersionsClientDeleteOptions) (resp azfake.Responder[armtemplatespecs.PolicySetDefinitionVersionsClientDeleteResponse], errResp azfake.ErrorResponder)

	// DeleteAtManagementGroup is the fake for method PolicySetDefinitionVersionsClient.DeleteAtManagementGroup
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	DeleteAtManagementGroup func(ctx context.Context, managementGroupName string, policySetDefinitionName string, policyDefinitionVersion string, options *armtemplatespecs.PolicySetDefinitionVersionsClientDeleteAtManagementGroupOptions) (resp azfake.Responder[armtemplatespecs.PolicySetDefinitionVersionsClientDeleteAtManagementGroupResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method PolicySetDefinitionVersionsClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, policySetDefinitionName string, policyDefinitionVersion string, options *armtemplatespecs.PolicySetDefinitionVersionsClientGetOptions) (resp azfake.Responder[armtemplatespecs.PolicySetDefinitionVersionsClientGetResponse], errResp azfake.ErrorResponder)

	// GetAtManagementGroup is the fake for method PolicySetDefinitionVersionsClient.GetAtManagementGroup
	// HTTP status codes to indicate success: http.StatusOK
	GetAtManagementGroup func(ctx context.Context, managementGroupName string, policySetDefinitionName string, policyDefinitionVersion string, options *armtemplatespecs.PolicySetDefinitionVersionsClientGetAtManagementGroupOptions) (resp azfake.Responder[armtemplatespecs.PolicySetDefinitionVersionsClientGetAtManagementGroupResponse], errResp azfake.ErrorResponder)

	// GetBuiltIn is the fake for method PolicySetDefinitionVersionsClient.GetBuiltIn
	// HTTP status codes to indicate success: http.StatusOK
	GetBuiltIn func(ctx context.Context, policySetDefinitionName string, policyDefinitionVersion string, options *armtemplatespecs.PolicySetDefinitionVersionsClientGetBuiltInOptions) (resp azfake.Responder[armtemplatespecs.PolicySetDefinitionVersionsClientGetBuiltInResponse], errResp azfake.ErrorResponder)

	// NewListPager is the fake for method PolicySetDefinitionVersionsClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(policySetDefinitionName string, options *armtemplatespecs.PolicySetDefinitionVersionsClientListOptions) (resp azfake.PagerResponder[armtemplatespecs.PolicySetDefinitionVersionsClientListResponse])

	// ListAll is the fake for method PolicySetDefinitionVersionsClient.ListAll
	// HTTP status codes to indicate success: http.StatusOK
	ListAll func(ctx context.Context, options *armtemplatespecs.PolicySetDefinitionVersionsClientListAllOptions) (resp azfake.Responder[armtemplatespecs.PolicySetDefinitionVersionsClientListAllResponse], errResp azfake.ErrorResponder)

	// ListAllAtManagementGroup is the fake for method PolicySetDefinitionVersionsClient.ListAllAtManagementGroup
	// HTTP status codes to indicate success: http.StatusOK
	ListAllAtManagementGroup func(ctx context.Context, managementGroupName string, options *armtemplatespecs.PolicySetDefinitionVersionsClientListAllAtManagementGroupOptions) (resp azfake.Responder[armtemplatespecs.PolicySetDefinitionVersionsClientListAllAtManagementGroupResponse], errResp azfake.ErrorResponder)

	// ListAllBuiltins is the fake for method PolicySetDefinitionVersionsClient.ListAllBuiltins
	// HTTP status codes to indicate success: http.StatusOK
	ListAllBuiltins func(ctx context.Context, options *armtemplatespecs.PolicySetDefinitionVersionsClientListAllBuiltinsOptions) (resp azfake.Responder[armtemplatespecs.PolicySetDefinitionVersionsClientListAllBuiltinsResponse], errResp azfake.ErrorResponder)

	// NewListBuiltInPager is the fake for method PolicySetDefinitionVersionsClient.NewListBuiltInPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListBuiltInPager func(policySetDefinitionName string, options *armtemplatespecs.PolicySetDefinitionVersionsClientListBuiltInOptions) (resp azfake.PagerResponder[armtemplatespecs.PolicySetDefinitionVersionsClientListBuiltInResponse])

	// NewListByManagementGroupPager is the fake for method PolicySetDefinitionVersionsClient.NewListByManagementGroupPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByManagementGroupPager func(managementGroupName string, policySetDefinitionName string, options *armtemplatespecs.PolicySetDefinitionVersionsClientListByManagementGroupOptions) (resp azfake.PagerResponder[armtemplatespecs.PolicySetDefinitionVersionsClientListByManagementGroupResponse])
}
...
// The returned PolicySetDefinitionVersionsServerTransport instance is connected to an instance of armtemplatespecs.PolicySetDefinitionVersionsClient via the
...
func NewPolicySetDefinitionVersionsServerTransport(srv *PolicySetDefinitionVersionsServer) *PolicySetDefinitionVersionsServerTransport {
	return &PolicySetDefinitionVersionsServerTransport{
		srv:                           srv,
		newListPager:                  newTracker[azfake.PagerResponder[armtemplatespecs.PolicySetDefinitionVersionsClientListResponse]](),
		newListBuiltInPager:           newTracker[azfake.PagerResponder[armtemplatespecs.PolicySetDefinitionVersionsClientListBuiltInResponse]](),
		newListByManagementGroupPager: newTracker[azfake.PagerResponder[armtemplatespecs.PolicySetDefinitionVersionsClientListByManagementGroupResponse]](),
	}
}

// PolicySetDefinitionVersionsServerTransport connects instances of armtemplatespecs.PolicySetDefinitionVersionsClient to instances of PolicySetDefinitionVersionsServer.
...
type PolicySetDefinitionVersionsServerTransport struct {
	...
	newListPager                  *tracker[azfake.PagerResponder[armtemplatespecs.PolicySetDefinitionVersionsClientListResponse]]
	newListBuiltInPager           *tracker[azfake.PagerResponder[armtemplatespecs.PolicySetDefinitionVersionsClientListBuiltInResponse]]
	newListByManagementGroupPager *tracker[azfake.PagerResponder[armtemplatespecs.PolicySetDefinitionVersionsClientListByManagementGroupResponse]]
}
...
func (p *PolicySetDefinitionVersionsServerTransport) dispatchCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[armtemplatespecs.PolicySetDefinitionVersion](req)
	if err != nil {
		return nil, err
	}
...
func (p *PolicySetDefinitionVersionsServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		var options *armtemplatespecs.PolicySetDefinitionVersionsClientListOptions
		if topParam != nil {
			options = &armtemplatespecs.PolicySetDefinitionVersionsClientListOptions{
				Top: topParam,
			}
		}
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armtemplatespecs.PolicySetDefinitionVersionsClientListResponse, createLink func() string) {
...
func (p *PolicySetDefinitionVersionsServerTransport) dispatchNewListBuiltInPager(req *http.Request) (*http.Response, error) {
	...
	if newListBuiltInPager == nil {
		...
		var options *armtemplatespecs.PolicySetDefinitionVersionsClientListBuiltInOptions
		if topParam != nil {
			options = &armtemplatespecs.PolicySetDefinitionVersionsClientListBuiltInOptions{
				Top: topParam,
			}
		}
		...
		server.PagerResponderInjectNextLinks(newListBuiltInPager, req, func(page *armtemplatespecs.PolicySetDefinitionVersionsClientListBuiltInResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
...
func (p *PolicySetDefinitionVersionsServerTransport) dispatchNewListByManagementGroupPager(req *http.Request) (*http.Response, error) {
	...
	if newListByManagementGroupPager == nil {
		...
		var options *armtemplatespecs.PolicySetDefinitionVersionsClientListByManagementGroupOptions
		if topParam != nil {
			options = &armtemplatespecs.PolicySetDefinitionVersionsClientListByManagementGroupOptions{
				Top: topParam,
			}
		}
		...
		server.PagerResponderInjectNextLinks(newListByManagementGroupPager, req, func(page *armtemplatespecs.PolicySetDefinitionVersionsClientListByManagementGroupResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
