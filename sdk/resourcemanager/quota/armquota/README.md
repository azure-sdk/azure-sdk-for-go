...
```go
client := clientFactory.NewGroupQuotaSubscriptionQuotaAllocationClient()
```
...
[open an issue](https://github.com/Azure/azure-sdk-for-go/issues) and assign the `Quota` label.
