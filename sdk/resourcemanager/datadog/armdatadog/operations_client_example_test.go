...
// Generated from example definition: 2023-10-20/Operations_List.json
func ExampleOperationsClient_NewListPager() {
	...
	clientFactory, err := armdatadog.NewClientFactory("<subscriptionID>", cred, nil)
	if err != nil {
	...
	for pager.More() {
		...
		// page = armdatadog.OperationsClientListResponse{
		// 	OperationListResult: armdatadog.OperationListResult{
