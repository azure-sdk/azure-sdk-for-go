...
// VMWareSpehereAssignmentsClientCreateOrUpdateResponse contains the response from method VMWareSpehereAssignmentsClient.CreateOrUpdate.
type VMWareSpehereAssignmentsClientCreateOrUpdateResponse struct {
	Assignment
}

// VMWareSpehereAssignmentsClientDeleteResponse contains the response from method VMWareSpehereAssignmentsClient.Delete.
type VMWareSpehereAssignmentsClientDeleteResponse struct {
	// placeholder for future response values
}

// VMWareSpehereAssignmentsClientGetResponse contains the response from method VMWareSpehereAssignmentsClient.Get.
type VMWareSpehereAssignmentsClientGetResponse struct {
	Assignment
}

// VMWareSpehereAssignmentsClientListResponse contains the response from method VMWareSpehereAssignmentsClient.NewListPager.
type VMWareSpehereAssignmentsClientListResponse struct {
	AssignmentList
}

// VMWareSpehereAssignmentsReportsClientGetResponse contains the response from method VMWareSpehereAssignmentsReportsClient.Get.
type VMWareSpehereAssignmentsReportsClientGetResponse struct {
	AssignmentReport
}

// VMWareSpehereAssignmentsReportsClientListResponse contains the response from method VMWareSpehereAssignmentsReportsClient.List.
type VMWareSpehereAssignmentsReportsClientListResponse struct {
	AssignmentReportList
}
