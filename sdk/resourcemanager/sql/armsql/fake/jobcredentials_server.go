...
func (j *JobCredentialsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if jobCredentialsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = jobCredentialsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to JobCredentialsServerTransport
var jobCredentialsServerTransportInterceptor interface {
