...
- New field `DeveloperPortalEnabled`, `LegacyPortalEnabled`, `NatGatewayState`, `OutboundPublicIPAddresses` in struct `ServiceBaseProperties`
- New field `DeveloperPortalEnabled`, `LegacyPortalEnabled`, `NatGatewayState`, `OutboundPublicIPAddresses` in struct `ServiceProperties`
- New field `DeveloperPortalEnabled`, `LegacyPortalEnabled`, `NatGatewayState`, `OutboundPublicIPAddresses` in struct `ServiceUpdateProperties`
