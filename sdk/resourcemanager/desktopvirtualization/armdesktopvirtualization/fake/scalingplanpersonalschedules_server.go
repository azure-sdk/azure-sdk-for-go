...
func (s *ScalingPlanPersonalSchedulesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if scalingPlanPersonalSchedulesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = scalingPlanPersonalSchedulesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to ScalingPlanPersonalSchedulesServerTransport
var scalingPlanPersonalSchedulesServerTransportInterceptor interface {
