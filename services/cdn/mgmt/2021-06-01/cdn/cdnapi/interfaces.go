...
type AFDProfilesClientAPI interface {
	CheckHostNameAvailability(ctx context.Context, resourceGroupName string, profileName string, checkHostNameAvailabilityInput cdn.CheckHostNameAvailabilityInput) (result cdn.CheckNameAvailabilityOutput, err error)
...
type RuleSetsClientAPI interface {
	Create(ctx context.Context, resourceGroupName string, profileName string, ruleSetName string) (result cdn.RuleSet, err error)
...
type SecurityPoliciesClientAPI interface {
	...
	Patch(ctx context.Context, resourceGroupName string, profileName string, securityPolicyName string, securityPolicyUpdateProperties cdn.SecurityPolicyUpdateParameters) (result cdn.SecurityPoliciesPatchFuture, err error)
}
