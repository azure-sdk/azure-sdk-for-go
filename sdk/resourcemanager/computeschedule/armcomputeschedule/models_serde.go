...
func (r ResourceProvisionPayload) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "vmExtensions", r.VMExtensions)
	return json.Marshal(objectMap)
}
...
func (r *ResourceProvisionPayload) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "resourcePrefix":
			...
			delete(rawMsg, key)
		case "vmExtensions":
			err = unpopulate(val, "VMExtensions", &r.VMExtensions)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", r, err)
...
// MarshalJSON implements the json.Marshaller interface for type SubmitCreateRequest.
func (s SubmitCreateRequest) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "correlationid", s.Correlationid)
	populate(objectMap, "executionParameters", s.ExecutionParameters)
	populate(objectMap, "resourceConfigParameters", s.ResourceConfigParameters)
	populate(objectMap, "schedule", s.Schedule)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type SubmitCreateRequest.
func (s *SubmitCreateRequest) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
	for key, val := range rawMsg {
		...
		case "executionParameters":
			...
			delete(rawMsg, key)
		case "resourceConfigParameters":
			err = unpopulate(val, "ResourceConfigParameters", &s.ResourceConfigParameters)
			delete(rawMsg, key)
		case "schedule":
...
// MarshalJSON implements the json.Marshaller interface for type SubmitDeleteRequest.
func (s SubmitDeleteRequest) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "correlationid", s.Correlationid)
	populate(objectMap, "executionParameters", s.ExecutionParameters)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type SubmitDeleteRequest.
func (s *SubmitDeleteRequest) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type VirtualMachineExtensionData.
func (v VirtualMachineExtensionData) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type VirtualMachineExtensionData.
func (v *VirtualMachineExtensionData) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
