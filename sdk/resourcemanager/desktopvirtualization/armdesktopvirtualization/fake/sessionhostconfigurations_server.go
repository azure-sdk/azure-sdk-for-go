...
func (s *SessionHostConfigurationsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if sessionHostConfigurationsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = sessionHostConfigurationsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to SessionHostConfigurationsServerTransport
var sessionHostConfigurationsServerTransportInterceptor interface {
