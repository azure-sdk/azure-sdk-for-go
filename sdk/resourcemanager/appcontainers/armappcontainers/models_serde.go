...
func (d DaprAppHealth) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "probeInterval", d.ProbeInterval)
	populate(objectMap, "probeTimeout", d.ProbeTimeout)
...
func (d *DaprAppHealth) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "path":
			...
			delete(rawMsg, key)
		case "probeInterval":
			err = unpopulate(val, "ProbeInterval", &d.ProbeInterval)
			delete(rawMsg, key)
		case "probeTimeout":
			err = unpopulate(val, "ProbeTimeout", &d.ProbeTimeout)
			delete(rawMsg, key)
		case "threshold":
