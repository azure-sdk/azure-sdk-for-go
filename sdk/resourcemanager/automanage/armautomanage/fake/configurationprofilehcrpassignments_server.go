...
func (c *ConfigurationProfileHCRPAssignmentsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if configurationProfileHcrpAssignmentsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = configurationProfileHcrpAssignmentsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to ConfigurationProfileHCRPAssignmentsServerTransport
var configurationProfileHcrpAssignmentsServerTransportInterceptor interface {
