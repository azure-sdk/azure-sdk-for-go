...
func (c ClusterProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "clusterUpgradeList", c.ClusterUpgradeList)
...
func (c *ClusterProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		var err error
		switch key {
		case "clusterUpgradeList":
			err = unpopulate(val, "ClusterUpgradeList", &c.ClusterUpgradeList)
			delete(rawMsg, key)
		case "createdAt":
...
// MarshalJSON implements the json.Marshaller interface for type ClusterUpgradeHistoryList.
func (c ClusterUpgradeHistoryList) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "nextLink", c.NextLink)
	populate(objectMap, "value", c.Value)
	return json.Marshal(objectMap)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type ClusterUpgradeHistoryList.
func (c *ClusterUpgradeHistoryList) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type ClusterUpgradeWindow.
func (c ClusterUpgradeWindow) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "clusterupgradewindowproperties", c.Clusterupgradewindowproperties)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ClusterUpgradeWindow.
func (c *ClusterUpgradeWindow) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
	for key, val := range rawMsg {
		var err error
		switch key {
		case "clusterupgradewindowproperties":
			err = unpopulate(val, "Clusterupgradewindowproperties", &c.Clusterupgradewindowproperties)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", c, err)
...
// MarshalJSON implements the json.Marshaller interface for type ClusterUpgradeWindowClusterupgradewindowproperties.
func (c ClusterUpgradeWindowClusterupgradewindowproperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "preferredring", c.Preferredring)
	populate(objectMap, "preferredstartdayofweek", c.Preferredstartdayofweek)
	populate(objectMap, "preferredstarthourofday", c.Preferredstarthourofday)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ClusterUpgradeWindowClusterupgradewindowproperties.
func (c *ClusterUpgradeWindowClusterupgradewindowproperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "preferredring":
			err = unpopulate(val, "Preferredring", &c.Preferredring)
			delete(rawMsg, key)
		case "preferredstartdayofweek":
			err = unpopulate(val, "Preferredstartdayofweek", &c.Preferredstartdayofweek)
			delete(rawMsg, key)
		case "preferredstarthourofday":
			err = unpopulate(val, "Preferredstarthourofday", &c.Preferredstarthourofday)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", c, err)
