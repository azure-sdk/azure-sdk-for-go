...
```go
client := clientFactory.NewApplicationDefinitionsClient()
```
...
[open an issue](https://github.com/Azure/azure-sdk-for-go/issues) and assign the `Managed Application` label.
