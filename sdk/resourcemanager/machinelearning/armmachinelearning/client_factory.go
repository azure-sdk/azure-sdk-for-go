...
func (c *ClientFactory) NewAzureMachineLearningServicesClient() *AzureMachineLearningServicesClient {
	subClient, _ := NewAzureMachineLearningServicesClient(c.subscriptionID, c.credential, c.options)
	return subClient
}
