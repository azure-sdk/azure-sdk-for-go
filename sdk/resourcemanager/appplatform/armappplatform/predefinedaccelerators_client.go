...
func (client *PredefinedAcceleratorsClient) disableCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, applicationAcceleratorName string, predefinedAcceleratorName string, _ *PredefinedAcceleratorsClientBeginDisableOptions) (*policy.Request, error) {
...
func (client *PredefinedAcceleratorsClient) enableCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, applicationAcceleratorName string, predefinedAcceleratorName string, _ *PredefinedAcceleratorsClientBeginEnableOptions) (*policy.Request, error) {
...
func (client *PredefinedAcceleratorsClient) getCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, applicationAcceleratorName string, predefinedAcceleratorName string, _ *PredefinedAcceleratorsClientGetOptions) (*policy.Request, error) {
...
func (client *PredefinedAcceleratorsClient) listCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, applicationAcceleratorName string, _ *PredefinedAcceleratorsClientListOptions) (*policy.Request, error) {
