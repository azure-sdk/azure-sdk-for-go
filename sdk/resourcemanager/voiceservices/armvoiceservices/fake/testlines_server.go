...
func (t *TestLinesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if testLinesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = testLinesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "TestLinesClient.NewListByCommunicationsGatewayPager":
				res.resp, res.err = t.dispatchNewListByCommunicationsGatewayPager(req)
...
// set this to conditionally intercept incoming requests to TestLinesServerTransport
var testLinesServerTransportInterceptor interface {
