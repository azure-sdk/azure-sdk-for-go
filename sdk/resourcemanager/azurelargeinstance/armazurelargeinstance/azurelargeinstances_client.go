...
func (client *AzureLargeInstancesClient) shutdownCreateRequest(ctx context.Context, resourceGroupName string, azureLargeInstanceName string, body any, options *AzureLargeInstancesClientBeginShutdownOptions) (*policy.Request, error) {
...
func (client *AzureLargeInstancesClient) startCreateRequest(ctx context.Context, resourceGroupName string, azureLargeInstanceName string, body any, options *AzureLargeInstancesClientBeginStartOptions) (*policy.Request, error) {
