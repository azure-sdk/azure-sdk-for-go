...
// MarshalJSON implements the json.Marshaller interface for type IndexesProperties.
func (i IndexesProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "description", i.Description)
	populate(objectMap, "indexConfigurations", i.IndexConfigurations)
	populate(objectMap, "previousVersionIndexId", i.PreviousVersionIndexID)
	populate(objectMap, "properties", i.Properties)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type IndexesProperties.
func (i *IndexesProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", i, err)
	}
	for key, val := range rawMsg {
		...
		case "indexConfigurations":
			...
			delete(rawMsg, key)
		case "previousVersionIndexId":
			err = unpopulate(val, "PreviousVersionIndexID", &i.PreviousVersionIndexID)
			delete(rawMsg, key)
		case "properties":
			err = unpopulate(val, "Properties", &i.Properties)
			delete(rawMsg, key)
...
// MarshalJSON implements the json.Marshaller interface for type IndexesResourceArmPaginatedResult.
func (i IndexesResourceArmPaginatedResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type IndexesResourceArmPaginatedResult.
func (i *IndexesResourceArmPaginatedResult) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", i, err)
	}
