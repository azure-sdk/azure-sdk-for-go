...
// RetrieveCertificateOrderContact - Return contactadmin namefirst,namelast,phone.
// If the operation fails it returns an *azcore.ResponseError type.
// Generated from API version 2022-09-01
// resourceGroupName - Name of the resource group to which the resource belongs.
// name - Name of the certificate order.
// options - CertificateOrdersClientRetrieveCertificateOrderContactOptions contains the optional parameters for the CertificateOrdersClient.RetrieveCertificateOrderContact
// method.
func (client *CertificateOrdersClient) RetrieveCertificateOrderContact(ctx context.Context, resourceGroupName string, name string, options *CertificateOrdersClientRetrieveCertificateOrderContactOptions) (CertificateOrdersClientRetrieveCertificateOrderContactResponse, error) {
	req, err := client.retrieveCertificateOrderContactCreateRequest(ctx, resourceGroupName, name, options)
	if err != nil {
		return CertificateOrdersClientRetrieveCertificateOrderContactResponse{}, err
	}
	resp, err := client.pl.Do(req)
	if err != nil {
		return CertificateOrdersClientRetrieveCertificateOrderContactResponse{}, err
	...
	if !runtime.HasStatusCode(resp, http.StatusOK) {
		return CertificateOrdersClientRetrieveCertificateOrderContactResponse{}, runtime.NewResponseError(resp)
	}
	return client.retrieveCertificateOrderContactHandleResponse(resp)
}

// retrieveCertificateOrderContactCreateRequest creates the RetrieveCertificateOrderContact request.
func (client *CertificateOrdersClient) retrieveCertificateOrderContactCreateRequest(ctx context.Context, resourceGroupName string, name string, options *CertificateOrdersClientRetrieveCertificateOrderContactOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.CertificateRegistration/certificateOrders/{name}/retrieveCertificateOrderContact"
	if resourceGroupName == "" {
		return nil, errors.New("parameter resourceGroupName cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{resourceGroupName}", url.PathEscape(resourceGroupName))
...
// retrieveCertificateOrderContactHandleResponse handles the RetrieveCertificateOrderContact response.
func (client *CertificateOrdersClient) retrieveCertificateOrderContactHandleResponse(resp *http.Response) (CertificateOrdersClientRetrieveCertificateOrderContactResponse, error) {
	result := CertificateOrdersClientRetrieveCertificateOrderContactResponse{}
	if err := runtime.UnmarshalAsJSON(resp, &result.CertificateOrderContact); err != nil {
		return CertificateOrdersClientRetrieveCertificateOrderContactResponse{}, err
	}
	return result, nil
}
