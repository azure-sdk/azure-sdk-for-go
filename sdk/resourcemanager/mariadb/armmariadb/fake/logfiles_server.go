...
// The returned LogFilesServerTransport instance is connected to an instance of armmariadb.LogFilesClient via the
// azcore.ClientOptions.Transporter field in the client's constructor parameters.
func NewLogFilesServerTransport(srv *LogFilesServer) *LogFilesServerTransport {
	return &LogFilesServerTransport{
		srv:                  srv,
		newListByServerPager: newTracker[azfake.PagerResponder[armmariadb.LogFilesClientListByServerResponse]](),
	}
}

// LogFilesServerTransport connects instances of armmariadb.LogFilesClient to instances of LogFilesServer.
// Don't use this type directly, use NewLogFilesServerTransport instead.
type LogFilesServerTransport struct {
	srv                  *LogFilesServer
	newListByServerPager *tracker[azfake.PagerResponder[armmariadb.LogFilesClientListByServerResponse]]
}
...
func (l *LogFilesServerTransport) dispatchNewListByServerPager(req *http.Request) (*http.Response, error) {
	...
	if newListByServerPager == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.DBforMariaDB/servers/(?P<serverName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/logFiles`
