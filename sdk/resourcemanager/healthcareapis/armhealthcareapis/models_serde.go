...
// MarshalJSON implements the json.Marshaller interface for type MedtechMappingValidationError.
func (m MedtechMappingValidationError) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "category", m.Category)
	populate(objectMap, "level", m.Level)
	populate(objectMap, "lineInfo", m.LineInfo)
	populate(objectMap, "message", m.Message)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type MedtechMappingValidationError.
func (m *MedtechMappingValidationError) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
	...
	for key, val := range rawMsg {
		...
		case "level":
			...
			delete(rawMsg, key)
		case "lineInfo":
			err = unpopulate(val, "LineInfo", &m.LineInfo)
			delete(rawMsg, key)
		case "message":
...
// MarshalJSON implements the json.Marshaller interface for type MedtechMappingValidationLineInfo.
func (m MedtechMappingValidationLineInfo) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "lineNumber", m.LineNumber)
	populate(objectMap, "linePosition", m.LinePosition)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type MedtechMappingValidationLineInfo.
func (m *MedtechMappingValidationLineInfo) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", m, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "lineNumber":
			err = unpopulate(val, "LineNumber", &m.LineNumber)
			delete(rawMsg, key)
		case "linePosition":
			err = unpopulate(val, "LinePosition", &m.LinePosition)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", m, err)
...
// MarshalJSON implements the json.Marshaller interface for type MedtechMeasurement.
func (m MedtechMeasurement) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "correlationId", m.CorrelationID)
	populate(objectMap, "deviceId", m.DeviceID)
	populate(objectMap, "encounterId", m.EncounterID)
	populateTimeRFC3339(objectMap, "occurrenceTimeUtc", m.OccurrenceTimeUTC)
	populate(objectMap, "properties", m.Properties)
	populate(objectMap, "type", m.Type)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type MedtechMeasurement.
func (m *MedtechMeasurement) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", m, err)
	}
	for key, val := range rawMsg {
		...
		case "deviceId":
			...
			delete(rawMsg, key)
		case "encounterId":
			err = unpopulate(val, "EncounterID", &m.EncounterID)
			delete(rawMsg, key)
		case "occurrenceTimeUtc":
			err = unpopulateTimeRFC3339(val, "OccurrenceTimeUTC", &m.OccurrenceTimeUTC)
			delete(rawMsg, key)
		case "properties":
...
// MarshalJSON implements the json.Marshaller interface for type MedtechMeasurementProperty.
func (m MedtechMeasurementProperty) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
...
// UnmarshalJSON implements the json.Unmarshaller interface for type MedtechMeasurementProperty.
func (m *MedtechMeasurementProperty) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", m, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type ValidateMedtechMappingsDeviceResult.
func (v ValidateMedtechMappingsDeviceResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "aggregatedCount", &v.AggregatedCount)
	populate(objectMap, "deviceEvent", &v.DeviceEvent)
	populate(objectMap, "exceptions", v.Exceptions)
	populate(objectMap, "measurements", v.Measurements)
	populate(objectMap, "observations", v.Observations)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ValidateMedtechMappingsDeviceResult.
func (v *ValidateMedtechMappingsDeviceResult) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
	...
	for key, val := range rawMsg {
		...
		case "aggregatedCount":
			err = unpopulate(val, "AggregatedCount", &v.AggregatedCount)
			delete(rawMsg, key)
		case "deviceEvent":
			err = unpopulate(val, "DeviceEvent", &v.DeviceEvent)
			delete(rawMsg, key)
		case "exceptions":
			err = unpopulate(val, "Exceptions", &v.Exceptions)
			delete(rawMsg, key)
		case "measurements":
			err = unpopulate(val, "Measurements", &v.Measurements)
			delete(rawMsg, key)
		case "observations":
			err = unpopulate(val, "Observations", &v.Observations)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", v, err)
...
// MarshalJSON implements the json.Marshaller interface for type ValidateMedtechMappingsParameters.
func (v ValidateMedtechMappingsParameters) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "aggregateErrors", v.AggregateErrors)
	populate(objectMap, "deviceEvents", v.DeviceEvents)
	populate(objectMap, "deviceMapping", v.DeviceMapping)
	populate(objectMap, "fhirMapping", v.FhirMapping)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ValidateMedtechMappingsParameters.
func (v *ValidateMedtechMappingsParameters) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", v, err)
	}
	for key, val := range rawMsg {
		...
		case "aggregateErrors":
			err = unpopulate(val, "AggregateErrors", &v.AggregateErrors)
			delete(rawMsg, key)
		case "deviceEvents":
			err = unpopulate(val, "DeviceEvents", &v.DeviceEvents)
			delete(rawMsg, key)
		case "deviceMapping":
			err = unpopulate(val, "DeviceMapping", &v.DeviceMapping)
			delete(rawMsg, key)
		case "fhirMapping":
			err = unpopulate(val, "FhirMapping", &v.FhirMapping)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", v, err)
...
// MarshalJSON implements the json.Marshaller interface for type ValidateMedtechMappingsResult.
func (v ValidateMedtechMappingsResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "deviceResults", v.DeviceResults)
	populate(objectMap, "templateResult", v.TemplateResult)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ValidateMedtechMappingsResult.
func (v *ValidateMedtechMappingsResult) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", v, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "deviceResults":
			err = unpopulate(val, "DeviceResults", &v.DeviceResults)
			delete(rawMsg, key)
		case "templateResult":
			err = unpopulate(val, "TemplateResult", &v.TemplateResult)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", v, err)
...
// MarshalJSON implements the json.Marshaller interface for type ValidateMedtechMappingsResultTemplateResult.
func (v ValidateMedtechMappingsResultTemplateResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "exceptions", v.Exceptions)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ValidateMedtechMappingsResultTemplateResult.
func (v *ValidateMedtechMappingsResultTemplateResult) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", v, err)
	}
