...
type CollectionOffersByAllContextsPayload struct {
	...
	Properties *CollectionOffersByAllContextsProperties `json:"properties,omitempty"`
}
...
type CollectionOffersByContext struct {
	// List of offers
	Offers *CollectionOffersByContextOffers `json:"offers,omitempty"`

	// READ-ONLY; Offer's context, e.g. subscription ID, tenant ID.
	Context *string `json:"context,omitempty" azure:"ro"`
}
...
type CollectionOffersByContextList struct {
	...
	// READ-ONLY
	Value []*CollectionOffersByContext `json:"value,omitempty" azure:"ro"`
}
...
type CollectionProperties struct {
	...
	AppliedRules []*Rule `json:"appliedRules,omitempty" azure:"ro"`

	// READ-ONLY; Indicating whether all items are approved for this collection (=true) or not (=false).
	ApproveAllItems *bool `json:"approveAllItems,omitempty" azure:"ro"`

	// READ-ONLY; Gets the modified date of all items approved.
	ApproveAllItemsModifiedAt *time.Time `json:"approveAllItemsModifiedAt,omitempty" azure:"ro"`
...
type QueryUserRulesProperties struct {
	...
	Properties *QueryUserRulesDetails `json:"properties,omitempty"`
}
