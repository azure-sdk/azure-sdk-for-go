...
type ManagedClustersClientAPI interface {
	...
	Delete(ctx context.Context, resourceGroupName string, resourceName string, noPoddisruptionbudget *bool) (result containerservice.ManagedClustersDeleteFuture, err error)
...
type AgentPoolsClientAPI interface {
	...
	Delete(ctx context.Context, resourceGroupName string, resourceName string, agentPoolName string, noPoddisruptionbudget *bool) (result containerservice.AgentPoolsDeleteFuture, err error)
