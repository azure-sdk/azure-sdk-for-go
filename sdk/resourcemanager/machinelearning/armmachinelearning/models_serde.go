...
// MarshalJSON implements the json.Marshaller interface for type AnonymousAccessCredentialDto.
func (a AnonymousAccessCredentialDto) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	objectMap["credentialType"] = DataReferenceCredentialTypeNoCredentials
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type AnonymousAccessCredentialDto.
func (a *AnonymousAccessCredentialDto) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", a, err)
	}
...
func (b *BlobReferenceForConsumptionDto) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "blobUri":
			...
			delete(rawMsg, key)
		case "credential":
			b.Credential, err = unmarshalDataReferenceCredentialDtoClassification(val)
			delete(rawMsg, key)
...
// MarshalJSON implements the json.Marshaller interface for type BlobReferenceSASRequestDto.
func (b BlobReferenceSASRequestDto) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "blobUri", b.BlobURI)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type BlobReferenceSASRequestDto.
func (b *BlobReferenceSASRequestDto) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", b, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type BlobReferenceSASResponseDto.
func (b BlobReferenceSASResponseDto) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "blobReferenceForConsumption", b.BlobReferenceForConsumption)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type BlobReferenceSASResponseDto.
func (b *BlobReferenceSASResponseDto) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", b, err)
	}
	for key, val := range rawMsg {
		...
		case "blobReferenceForConsumption":
			err = unpopulate(val, "BlobReferenceForConsumption", &b.BlobReferenceForConsumption)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", b, err)
...
// MarshalJSON implements the json.Marshaller interface for type DataReferenceCredentialDto.
func (d DataReferenceCredentialDto) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	objectMap["credentialType"] = d.CredentialType
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type DataReferenceCredentialDto.
func (d *DataReferenceCredentialDto) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", d, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type DockerCredentialDto.
func (d DockerCredentialDto) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type DockerCredentialDto.
func (d *DockerCredentialDto) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", d, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type ManagedIdentityCredentialDto.
func (m ManagedIdentityCredentialDto) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type ManagedIdentityCredentialDto.
func (m *ManagedIdentityCredentialDto) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", m, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type PendingUploadBlobReferenceForConsumptionDto.
func (p PendingUploadBlobReferenceForConsumptionDto) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "blobUri", p.BlobURI)
	populate(objectMap, "credential", p.Credential)
	populate(objectMap, "storageAccountArmId", p.StorageAccountArmID)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type PendingUploadBlobReferenceForConsumptionDto.
func (p *PendingUploadBlobReferenceForConsumptionDto) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", p, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "blobUri":
			err = unpopulate(val, "BlobURI", &p.BlobURI)
			delete(rawMsg, key)
		case "credential":
			p.Credential, err = unmarshalPendingUploadCredentialDtoClassification(val)
			delete(rawMsg, key)
		case "storageAccountArmId":
			err = unpopulate(val, "StorageAccountArmID", &p.StorageAccountArmID)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", p, err)
...
// MarshalJSON implements the json.Marshaller interface for type PendingUploadSASCredentialDto.
func (p PendingUploadSASCredentialDto) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	objectMap["credentialType"] = PendingUploadCredentialTypeSAS
	populate(objectMap, "sasUri", p.SasURI)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type PendingUploadSASCredentialDto.
func (p *PendingUploadSASCredentialDto) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", p, err)
	}
	for key, val := range rawMsg {
		...
		case "credentialType":
			...
			delete(rawMsg, key)
		case "sasUri":
			err = unpopulate(val, "SasURI", &p.SasURI)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", p, err)
