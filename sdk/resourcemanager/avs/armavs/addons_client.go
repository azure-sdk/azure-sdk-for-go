...
//     method.
func (client *AddonsClient) NewListByPrivateCloudPager(resourceGroupName string, privateCloudName string, options *AddonsClientListByPrivateCloudOptions) *runtime.Pager[AddonsClientListByPrivateCloudResponse] {
...
func (client *AddonsClient) listByPrivateCloudCreateRequest(ctx context.Context, resourceGroupName string, privateCloudName string, _ *AddonsClientListByPrivateCloudOptions) (*policy.Request, error) {
