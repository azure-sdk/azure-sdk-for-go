...
func (client *StandardsClient) deleteCreateRequest(ctx context.Context, scope string, standardID string, options *StandardsClientDeleteOptions) (*policy.Request, error) {
	urlPath := "/{scope}/providers/Microsoft.Security/securityStandards/{standardId}"
	if scope == "" {
		return nil, errors.New("parameter scope cannot be empty")
	}
