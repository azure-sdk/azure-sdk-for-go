...
func (h *HCRPReportsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if hcrpReportsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = hcrpReportsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to HCRPReportsServerTransport
var hcrpReportsServerTransportInterceptor interface {
