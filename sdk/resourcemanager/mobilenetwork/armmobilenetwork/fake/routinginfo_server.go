...
func (r *RoutingInfoServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if routingInfoServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = routingInfoServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to RoutingInfoServerTransport
var routingInfoServerTransportInterceptor interface {
