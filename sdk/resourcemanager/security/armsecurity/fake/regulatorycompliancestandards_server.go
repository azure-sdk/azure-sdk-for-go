...
func (r *RegulatoryComplianceStandardsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if regulatoryComplianceStandardsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = regulatoryComplianceStandardsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to RegulatoryComplianceStandardsServerTransport
var regulatoryComplianceStandardsServerTransportInterceptor interface {
