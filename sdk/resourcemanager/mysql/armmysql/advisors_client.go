...
func (client *AdvisorsClient) getCreateRequest(ctx context.Context, resourceGroupName string, serverName string, advisorName string, _ *AdvisorsClientGetOptions) (*policy.Request, error) {
...
func (client *AdvisorsClient) listByServerCreateRequest(ctx context.Context, resourceGroupName string, serverName string, _ *AdvisorsClientListByServerOptions) (*policy.Request, error) {
