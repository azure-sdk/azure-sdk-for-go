...
```go
client, err := armapp.NewAvailableWorkloadProfilesClient(<subscription ID>, cred, nil)
```
...
client, err := armapp.NewAvailableWorkloadProfilesClient(<subscription ID>, cred, &options)
```
