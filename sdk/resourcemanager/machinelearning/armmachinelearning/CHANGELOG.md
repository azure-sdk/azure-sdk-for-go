...
- New field `AllowRoleAssignmentOnRG`, `EnableSoftwareBillOfMaterials`, `IPAllowlist`, `SoftDeleteRetentionInDays` in struct `WorkspacePropertiesUpdateParameters`
