	...
	go func() {
		...
		if !intercepted {
			...
			case "AutoUpgradeProfileOperationsClient.BeginGenerate":
				res.resp, res.err = a.dispatchBeginGenerate(req)
			default:
...
func (a *AutoUpgradeProfileOperationsServerTransport) dispatchBeginGenerate(req *http.Request) (*http.Response, error) {
	...
	if beginGenerate == nil {
		...
		respr, errRespr := a.srv.BeginGenerate(req.Context(), resourceGroupNameParam, fleetNameParam, autoUpgradeProfileNameParam, nil)
