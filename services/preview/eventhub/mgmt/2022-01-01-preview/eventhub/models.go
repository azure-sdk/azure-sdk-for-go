...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/preview/eventhub/mgmt/2022-01-01-preview/eventhub"
...
type ApplicationGroupListResult struct {
	...
	// NextLink - READ-ONLY; Link to the next set of results. Not empty if Value contains an incomplete list of Authorization Rules
	NextLink *string `json:"nextLink,omitempty"`
}

// MarshalJSON is the custom marshaler for ApplicationGroupListResult.
func (aglr ApplicationGroupListResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if aglr.Value != nil {
		objectMap["value"] = aglr.Value
	}
	return json.Marshal(objectMap)
}

// ApplicationGroupListResultIterator provides access to a complete listing of ApplicationGroup values.
type ApplicationGroupListResultIterator struct {
	i    int
	page ApplicationGroupListResultPage
}

// NextWithContext advances to the next value.  If there was an error making
// the request the iterator does not advance and the error is returned.
func (iter *ApplicationGroupListResultIterator) NextWithContext(ctx context.Context) (err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/ApplicationGroupListResultIterator.NextWithContext")
		defer func() {
			sc := -1
...
func (iter *ApplicationGroupListResultIterator) Next() error {
	return iter.NextWithContext(context.Background())
}

// NotDone returns true if the enumeration should be started or is not yet complete.
func (iter ApplicationGroupListResultIterator) NotDone() bool {
	return iter.page.NotDone() && iter.i < len(iter.page.Values())
}

// Response returns the raw server response from the last page request.
func (iter ApplicationGroupListResultIterator) Response() ApplicationGroupListResult {
	return iter.page.Response()
}

// Value returns the current value or a zero-initialized value if the
// iterator has advanced beyond the end of the collection.
func (iter ApplicationGroupListResultIterator) Value() ApplicationGroup {
...
// Creates a new instance of the ApplicationGroupListResultIterator type.
func NewApplicationGroupListResultIterator(page ApplicationGroupListResultPage) ApplicationGroupListResultIterator {
	return ApplicationGroupListResultIterator{page: page}
}

// IsEmpty returns true if the ListResult contains no values.
func (aglr ApplicationGroupListResult) IsEmpty() bool {
	return aglr.Value == nil || len(*aglr.Value) == 0
}

// hasNextLink returns true if the NextLink is not empty.
func (aglr ApplicationGroupListResult) hasNextLink() bool {
	return aglr.NextLink != nil && len(*aglr.NextLink) != 0
}

// applicationGroupListResultPreparer prepares a request to retrieve the next set of results.
// It returns nil if no more results exist.
func (aglr ApplicationGroupListResult) applicationGroupListResultPreparer(ctx context.Context) (*http.Request, error) {
	if !aglr.hasNextLink() {
		return nil, nil
	}
...
// ApplicationGroupListResultPage contains a page of ApplicationGroup values.
type ApplicationGroupListResultPage struct {
	fn   func(context.Context, ApplicationGroupListResult) (ApplicationGroupListResult, error)
	aglr ApplicationGroupListResult
}

// NextWithContext advances to the next page of values.  If there was an error making
// the request the page does not advance and the error is returned.
func (page *ApplicationGroupListResultPage) NextWithContext(ctx context.Context) (err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/ApplicationGroupListResultPage.NextWithContext")
		defer func() {
			sc := -1
...
// the request the page does not advance and the error is returned.
// Deprecated: Use NextWithContext() instead.
func (page *ApplicationGroupListResultPage) Next() error {
	return page.NextWithContext(context.Background())
}

// NotDone returns true if the page enumeration should be started or is not yet complete.
func (page ApplicationGroupListResultPage) NotDone() bool {
	return !page.aglr.IsEmpty()
}

// Response returns the raw server response from the last page request.
func (page ApplicationGroupListResultPage) Response() ApplicationGroupListResult {
	return page.aglr
}

// Values returns the slice of values for the current page or nil if there are no values.
func (page ApplicationGroupListResultPage) Values() []ApplicationGroup {
...
// Creates a new instance of the ApplicationGroupListResultPage type.
func NewApplicationGroupListResultPage(cur ApplicationGroupListResult, getNextPage func(context.Context, ApplicationGroupListResult) (ApplicationGroupListResult, error)) ApplicationGroupListResultPage {
	return ApplicationGroupListResultPage{
		fn:   getNextPage,
		aglr: cur,
	}
}

// BasicApplicationGroupPolicy properties of the Application Group policy
type BasicApplicationGroupPolicy interface {
	AsThrottlingPolicy() (*ThrottlingPolicy, bool)
	AsApplicationGroupPolicy() (*ApplicationGroupPolicy, bool)
}
...
type ApplicationGroupPolicy struct {
	...
	Name *string `json:"name,omitempty"`
	// Type - Possible values include: 'TypeApplicationGroupPolicy', 'TypeThrottlingPolicy'
	Type Type `json:"type,omitempty"`
}

func unmarshalBasicApplicationGroupPolicy(body []byte) (BasicApplicationGroupPolicy, error) {
	...
	switch m["type"] {
	case string(TypeThrottlingPolicy):
		var tp ThrottlingPolicy
		err := json.Unmarshal(body, &tp)
		return tp, err
	default:
		var agp ApplicationGroupPolicy
		err := json.Unmarshal(body, &agp)
		return agp, err
	}
}
func unmarshalBasicApplicationGroupPolicyArray(body []byte) ([]BasicApplicationGroupPolicy, error) {
	...
	agpArray := make([]BasicApplicationGroupPolicy, len(rawMessages))

	for index, rawMessage := range rawMessages {
		agp, err := unmarshalBasicApplicationGroupPolicy(*rawMessage)
		if err != nil {
			return nil, err
		}
		agpArray[index] = agp
...
// MarshalJSON is the custom marshaler for ApplicationGroupPolicy.
func (agp ApplicationGroupPolicy) MarshalJSON() ([]byte, error) {
	agp.Type = TypeApplicationGroupPolicy
	objectMap := make(map[string]interface{})
	if agp.Name != nil {
...
// AsThrottlingPolicy is the BasicApplicationGroupPolicy implementation for ApplicationGroupPolicy.
func (agp ApplicationGroupPolicy) AsThrottlingPolicy() (*ThrottlingPolicy, bool) {
	return nil, false
}

// AsApplicationGroupPolicy is the BasicApplicationGroupPolicy implementation for ApplicationGroupPolicy.
func (agp ApplicationGroupPolicy) AsApplicationGroupPolicy() (*ApplicationGroupPolicy, bool) {
	return &agp, true
}

// AsBasicApplicationGroupPolicy is the BasicApplicationGroupPolicy implementation for ApplicationGroupPolicy.
func (agp ApplicationGroupPolicy) AsBasicApplicationGroupPolicy() (BasicApplicationGroupPolicy, bool) {
	return &agp, true
}
...
type ApplicationGroupProperties struct {
	...
	Policies *[]BasicApplicationGroupPolicy `json:"policies,omitempty"`
}

// UnmarshalJSON is the custom unmarshaler for ApplicationGroupProperties struct.
func (ag *ApplicationGroupProperties) UnmarshalJSON(body []byte) error {
	var m map[string]*json.RawMessage
	err := json.Unmarshal(body, &m)
	if err != nil {
		return err
	...
	for k, v := range m {
		...
		case "isEnabled":
			if v != nil {
				...
				ag.IsEnabled = &isEnabled
			}
		case "clientAppGroupIdentifier":
			if v != nil {
				var clientAppGroupIdentifier string
				err = json.Unmarshal(*v, &clientAppGroupIdentifier)
				if err != nil {
					return err
				}
				ag.ClientAppGroupIdentifier = &clientAppGroupIdentifier
			}
		case "policies":
			if v != nil {
				policies, err := unmarshalBasicApplicationGroupPolicyArray(*v)
				if err != nil {
					return err
				}
				ag.Policies = &policies
			}
		}
	}
...
func (c ClusterProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if c.SupportsScaling != nil {
		objectMap["supportsScaling"] = c.SupportsScaling
	}
	return json.Marshal(objectMap)
}
...
func (en EHNamespaceProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if en.MinimumTLSVersion != "" {
		objectMap["minimumTlsVersion"] = en.MinimumTLSVersion
	}
	...
	if en.PublicNetworkAccess != "" {
		objectMap["publicNetworkAccess"] = en.PublicNetworkAccess
	}
...
type NetworkRuleSetProperties struct {
	...
	// PublicNetworkAccess - This determines if traffic is allowed over public network. By default it is enabled. If value is SecuredByPerimeter then Inbound and Outbound communication is controlled by the network security perimeter and profile's access rules. Possible values include: 'PublicNetworkAccessFlagEnabled', 'PublicNetworkAccessFlagDisabled', 'PublicNetworkAccessFlagSecuredByPerimeter'
...
// NetworkSecurityPerimeterConfiguration network Security Perimeter related configurations of a given
// namespace
type NetworkSecurityPerimeterConfiguration struct {
	...
	*NetworkSecurityPerimeterConfigurationProperties `json:"properties,omitempty"`
	// Location - Resource location.
	Location *string `json:"location,omitempty"`
	// Tags - Resource tags.
	Tags map[string]*string `json:"tags"`
...
// MarshalJSON is the custom marshaler for NetworkSecurityPerimeterConfiguration.
func (nspc NetworkSecurityPerimeterConfiguration) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if nspc.NetworkSecurityPerimeterConfigurationProperties != nil {
		objectMap["properties"] = nspc.NetworkSecurityPerimeterConfigurationProperties
	}
	if nspc.Location != nil {
		objectMap["location"] = nspc.Location
	}
	if nspc.Tags != nil {
		objectMap["tags"] = nspc.Tags
	}
	return json.Marshal(objectMap)
}

// UnmarshalJSON is the custom unmarshaler for NetworkSecurityPerimeterConfiguration struct.
func (nspc *NetworkSecurityPerimeterConfiguration) UnmarshalJSON(body []byte) error {
	var m map[string]*json.RawMessage
	err := json.Unmarshal(body, &m)
	if err != nil {
		return err
	...
	for k, v := range m {
		...
		case "properties":
			if v != nil {
				var networkSecurityPerimeterConfigurationProperties NetworkSecurityPerimeterConfigurationProperties
				err = json.Unmarshal(*v, &networkSecurityPerimeterConfigurationProperties)
				if err != nil {
					return err
				}
				nspc.NetworkSecurityPerimeterConfigurationProperties = &networkSecurityPerimeterConfigurationProperties
			}
		case "location":
			if v != nil {
				var location string
...
// NetworkSecurityPerimeterConfigurationList result of the List NetworkSecurityPerimeterConfiguration
// operation.
type NetworkSecurityPerimeterConfigurationList struct {
	autorest.Response `json:"-"`
	// Value - READ-ONLY; A collection of NetworkSecurityPerimeterConfigurations
	Value *[]NetworkSecurityPerimeterConfiguration `json:"value,omitempty"`
}

// MarshalJSON is the custom marshaler for NetworkSecurityPerimeterConfigurationList.
func (nspcl NetworkSecurityPerimeterConfigurationList) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	return json.Marshal(objectMap)
}
...
type NetworkSecurityPerimeterConfigurationProperties struct {
	// ProvisioningState - Provisioning state of NetworkSecurityPerimeter configuration propagation. Possible values include: 'NetworkSecurityPerimeterConfigurationProvisioningStateUnknown', 'NetworkSecurityPerimeterConfigurationProvisioningStateCreating', 'NetworkSecurityPerimeterConfigurationProvisioningStateUpdating', 'NetworkSecurityPerimeterConfigurationProvisioningStateAccepted', 'NetworkSecurityPerimeterConfigurationProvisioningStateInvalidResponse', 'NetworkSecurityPerimeterConfigurationProvisioningStateSucceeded', 'NetworkSecurityPerimeterConfigurationProvisioningStateSucceededWithIssues', 'NetworkSecurityPerimeterConfigurationProvisioningStateFailed', 'NetworkSecurityPerimeterConfigurationProvisioningStateDeleting', 'NetworkSecurityPerimeterConfigurationProvisioningStateDeleted', 'NetworkSecurityPerimeterConfigurationProvisioningStateCanceled'
	...
	// ResourceAssociation - READ-ONLY; Information about resource association
	...
	// Profile - READ-ONLY; Information about current network profile
	Profile *NetworkSecurityPerimeterConfigurationPropertiesProfile `json:"profile,omitempty"`
}

// MarshalJSON is the custom marshaler for NetworkSecurityPerimeterConfigurationProperties.
func (nspcp NetworkSecurityPerimeterConfigurationProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if nspcp.ProvisioningState != "" {
		objectMap["provisioningState"] = nspcp.ProvisioningState
	}
	if nspcp.ProvisioningIssues != nil {
		objectMap["provisioningIssues"] = nspcp.ProvisioningIssues
	}
	if nspcp.NetworkSecurityPerimeter != nil {
		objectMap["networkSecurityPerimeter"] = nspcp.NetworkSecurityPerimeter
	}
	return json.Marshal(objectMap)
}
...
// NetworkSecurityPerimeterConfigurationPropertiesResourceAssociation information about resource
// association
type NetworkSecurityPerimeterConfigurationPropertiesResourceAssociation struct {
	// Name - Name of the resource association
	Name *string `json:"name,omitempty"`
	// AccessMode - Access Mode of the resource association. Possible values include: 'NoAssociationMode', 'EnforcedMode', 'LearningMode', 'AuditMode', 'UnspecifiedMode'
	AccessMode ResourceAssociationAccessMode `json:"accessMode,omitempty"`
}

// NetworkSecurityPerimeterConfigurationsCreateOrUpdateFuture an abstraction for monitoring and retrieving
// the results of a long-running operation.
type NetworkSecurityPerimeterConfigurationsCreateOrUpdateFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(NetworkSecurityPerimeterConfigurationsClient) (autorest.Response, error)
}

// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *NetworkSecurityPerimeterConfigurationsCreateOrUpdateFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for NetworkSecurityPerimeterConfigurationsCreateOrUpdateFuture.Result.
func (future *NetworkSecurityPerimeterConfigurationsCreateOrUpdateFuture) result(client NetworkSecurityPerimeterConfigurationsClient) (ar autorest.Response, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "eventhub.NetworkSecurityPerimeterConfigurationsCreateOrUpdateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		ar.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("eventhub.NetworkSecurityPerimeterConfigurationsCreateOrUpdateFuture")
		return
	}
	ar.Response = future.Response()
	return
...
type NspAccessRule struct {
	...
	Type *string `json:"type,omitempty"`
	// Properties - READ-ONLY; Properties of Access Rule
	Properties *NspAccessRuleProperties `json:"properties,omitempty"`
}

// MarshalJSON is the custom marshaler for NspAccessRule.
func (nar NspAccessRule) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if nar.ID != nil {
		objectMap["id"] = nar.ID
	}
	if nar.Name != nil {
		objectMap["name"] = nar.Name
	}
	if nar.Type != nil {
		objectMap["type"] = nar.Type
	}
	return json.Marshal(objectMap)
}
...
type NspAccessRuleProperties struct {
	// Direction - Direction of Access Rule. Possible values include: 'Inbound', 'Outbound'
	...
	// NetworkSecurityPerimeters - READ-ONLY; NetworkSecurityPerimeters for inbound rules
	NetworkSecurityPerimeters *[]NetworkSecurityPerimeter `json:"networkSecurityPerimeters,omitempty"`
	// FullyQualifiedDomainNames - READ-ONLY; FQDN for outbound rules
	FullyQualifiedDomainNames *[]string `json:"fullyQualifiedDomainNames,omitempty"`
}

// MarshalJSON is the custom marshaler for NspAccessRuleProperties.
func (nar NspAccessRuleProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if nar.Direction != "" {
		objectMap["direction"] = nar.Direction
	}
	if nar.AddressPrefixes != nil {
		objectMap["addressPrefixes"] = nar.AddressPrefixes
	}
	if nar.Subscriptions != nil {
		objectMap["subscriptions"] = nar.Subscriptions
	}
	return json.Marshal(objectMap)
}
...
type ProvisioningIssue struct {
	...
	Name *string `json:"name,omitempty"`
	// Properties - READ-ONLY; Properties of Provisioning Issue
	Properties *ProvisioningIssueProperties `json:"properties,omitempty"`
}

// MarshalJSON is the custom marshaler for ProvisioningIssue.
func (pi ProvisioningIssue) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if pi.Name != nil {
...
type ThrottlingPolicy struct {
	...
	// MetricID - Metric Id on which the throttle limit should be set, MetricId can be discovered by hovering over Metric in the Metrics section of Event Hub Namespace inside Azure Portal. Possible values include: 'IncomingBytes', 'OutgoingBytes', 'IncomingMessages', 'OutgoingMessages'
...
// MarshalJSON is the custom marshaler for ThrottlingPolicy.
func (tp ThrottlingPolicy) MarshalJSON() ([]byte, error) {
	tp.Type = TypeThrottlingPolicy
	objectMap := make(map[string]interface{})
	if tp.RateLimitThreshold != nil {
		objectMap["rateLimitThreshold"] = tp.RateLimitThreshold
	}
	if tp.MetricID != "" {
		objectMap["metricId"] = tp.MetricID
	}
	if tp.Name != nil {
		objectMap["name"] = tp.Name
	}
	if tp.Type != "" {
		objectMap["type"] = tp.Type
	}
	return json.Marshal(objectMap)
}

// AsThrottlingPolicy is the BasicApplicationGroupPolicy implementation for ThrottlingPolicy.
func (tp ThrottlingPolicy) AsThrottlingPolicy() (*ThrottlingPolicy, bool) {
	return &tp, true
}

// AsApplicationGroupPolicy is the BasicApplicationGroupPolicy implementation for ThrottlingPolicy.
func (tp ThrottlingPolicy) AsApplicationGroupPolicy() (*ApplicationGroupPolicy, bool) {
	return nil, false
}

// AsBasicApplicationGroupPolicy is the BasicApplicationGroupPolicy implementation for ThrottlingPolicy.
func (tp ThrottlingPolicy) AsBasicApplicationGroupPolicy() (BasicApplicationGroupPolicy, bool) {
	return &tp, true
}
