...
func (client *DevOpsPoliciesClient) getCreateRequest(ctx context.Context, resourceGroupName string, securityConnectorName string, policyName string, _ *DevOpsPoliciesClientGetOptions) (*policy.Request, error) {
