...
// AddressResourcesServer is a fake server for instances of the armcontoso.AddressResourcesClient type.
type AddressResourcesServer struct {
	...
	BeginCreate func(ctx context.Context, resourceGroupName string, addressName string, addressResource armcontoso.AddressResource, options *armcontoso.AddressResourcesClientBeginCreateOptions) (resp azfake.PollerResponder[armcontoso.AddressResourcesClientCreateResponse], errResp azfake.ErrorResponder)

	// BeginDelete is the fake for method AddressResourcesClient.BeginDelete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginDelete func(ctx context.Context, resourceGroupName string, addressName string, options *armcontoso.AddressResourcesClientBeginDeleteOptions) (resp azfake.PollerResponder[armcontoso.AddressResourcesClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method AddressResourcesClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, addressName string, options *armcontoso.AddressResourcesClientGetOptions) (resp azfake.Responder[armcontoso.AddressResourcesClientGetResponse], errResp azfake.ErrorResponder)

	// NewListByResourceGroupPager is the fake for method AddressResourcesClient.NewListByResourceGroupPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByResourceGroupPager func(resourceGroupName string, options *armcontoso.AddressResourcesClientListByResourceGroupOptions) (resp azfake.PagerResponder[armcontoso.AddressResourcesClientListByResourceGroupResponse])

	// NewListBySubscriptionPager is the fake for method AddressResourcesClient.NewListBySubscriptionPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListBySubscriptionPager func(options *armcontoso.AddressResourcesClientListBySubscriptionOptions) (resp azfake.PagerResponder[armcontoso.AddressResourcesClientListBySubscriptionResponse])

	// BeginUpdate is the fake for method AddressResourcesClient.BeginUpdate
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginUpdate func(ctx context.Context, resourceGroupName string, addressName string, addressUpdateParameter armcontoso.AddressUpdateParameter, options *armcontoso.AddressResourcesClientBeginUpdateOptions) (resp azfake.PollerResponder[armcontoso.AddressResourcesClientUpdateResponse], errResp azfake.ErrorResponder)
}
...
// The returned AddressResourcesServerTransport instance is connected to an instance of armcontoso.AddressResourcesClient via the
...
func NewAddressResourcesServerTransport(srv *AddressResourcesServer) *AddressResourcesServerTransport {
	return &AddressResourcesServerTransport{
		srv:                         srv,
		beginCreate:                 newTracker[azfake.PollerResponder[armcontoso.AddressResourcesClientCreateResponse]](),
		beginDelete:                 newTracker[azfake.PollerResponder[armcontoso.AddressResourcesClientDeleteResponse]](),
		newListByResourceGroupPager: newTracker[azfake.PagerResponder[armcontoso.AddressResourcesClientListByResourceGroupResponse]](),
		newListBySubscriptionPager:  newTracker[azfake.PagerResponder[armcontoso.AddressResourcesClientListBySubscriptionResponse]](),
		beginUpdate:                 newTracker[azfake.PollerResponder[armcontoso.AddressResourcesClientUpdateResponse]](),
	}
}

// AddressResourcesServerTransport connects instances of armcontoso.AddressResourcesClient to instances of AddressResourcesServer.
...
type AddressResourcesServerTransport struct {
	...
	beginCreate                 *tracker[azfake.PollerResponder[armcontoso.AddressResourcesClientCreateResponse]]
	beginDelete                 *tracker[azfake.PollerResponder[armcontoso.AddressResourcesClientDeleteResponse]]
	newListByResourceGroupPager *tracker[azfake.PagerResponder[armcontoso.AddressResourcesClientListByResourceGroupResponse]]
	newListBySubscriptionPager  *tracker[azfake.PagerResponder[armcontoso.AddressResourcesClientListBySubscriptionResponse]]
	beginUpdate                 *tracker[azfake.PollerResponder[armcontoso.AddressResourcesClientUpdateResponse]]
}
...
func (a *AddressResourcesServerTransport) dispatchBeginCreate(req *http.Request) (*http.Response, error) {
	...
	if beginCreate == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armcontoso.AddressResource](req)
		if err != nil {
			return nil, err
		}
...
func (a *AddressResourcesServerTransport) dispatchNewListByResourceGroupPager(req *http.Request) (*http.Response, error) {
	...
	if newListByResourceGroupPager == nil {
		...
		var options *armcontoso.AddressResourcesClientListByResourceGroupOptions
		if filterParam != nil || skipTokenParam != nil || topParam != nil {
			options = &armcontoso.AddressResourcesClientListByResourceGroupOptions{
				Filter:    filterParam,
		...
		server.PagerResponderInjectNextLinks(newListByResourceGroupPager, req, func(page *armcontoso.AddressResourcesClientListByResourceGroupResponse, createLink func() string) {
...
func (a *AddressResourcesServerTransport) dispatchNewListBySubscriptionPager(req *http.Request) (*http.Response, error) {
	...
	if newListBySubscriptionPager == nil {
		...
		var options *armcontoso.AddressResourcesClientListBySubscriptionOptions
		if filterParam != nil || skipTokenParam != nil || topParam != nil {
			options = &armcontoso.AddressResourcesClientListBySubscriptionOptions{
				Filter:    filterParam,
				SkipToken: skipTokenParam,
				Top:       topParam,
			}
		...
		server.PagerResponderInjectNextLinks(newListBySubscriptionPager, req, func(page *armcontoso.AddressResourcesClientListBySubscriptionResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
...
func (a *AddressResourcesServerTransport) dispatchBeginUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginUpdate == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armcontoso.AddressUpdateParameter](req)
		if err != nil {
			return nil, err
		}
		resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
		...
		var options *armcontoso.AddressResourcesClientBeginUpdateOptions
		if ifMatchParam != nil {
			options = &armcontoso.AddressResourcesClientBeginUpdateOptions{
