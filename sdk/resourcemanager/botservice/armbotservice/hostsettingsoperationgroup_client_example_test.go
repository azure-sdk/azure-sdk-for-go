...
func ExampleHostSettingsOperationGroupClient_Get() {
	...
	res, err := clientFactory.NewHostSettingsOperationGroupClient().Get(ctx, nil)
	if err != nil {
	...
	// res = armbotservice.HostSettingsOperationGroupClientGetResponse{
