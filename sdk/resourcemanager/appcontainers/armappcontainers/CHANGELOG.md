...
- New field `AppHealth` in struct `Dapr`
- New field `AvailabilityZones`, `DiskEncryptionConfiguration`, `IngressConfiguration`, `PrivateLinkDefaultDomain` in struct `ManagedEnvironmentProperties`
