...
func (i InMageRcmDisksDefaultInput) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "customTargetDiskSize", i.CustomTargetDiskSize)
	populate(objectMap, "diskEncryptionSetId", i.DiskEncryptionSetID)
	populate(objectMap, "diskType", i.DiskType)
	populate(objectMap, "iops", i.Iops)
	populate(objectMap, "logStorageAccountId", i.LogStorageAccountID)
...
func (i *InMageRcmDisksDefaultInput) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		var err error
		switch key {
		case "customTargetDiskSize":
			err = unpopulate(val, "CustomTargetDiskSize", &i.CustomTargetDiskSize)
			delete(rawMsg, key)
		case "diskEncryptionSetId":
			err = unpopulate(val, "DiskEncryptionSetID", &i.DiskEncryptionSetID)
			delete(rawMsg, key)
...
// MarshalJSON implements the json.Marshaller interface for type ProtectedClustersQueryParameter.
func (p ProtectedClustersQueryParameter) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "instanceType", p.InstanceType)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type ProtectedClustersQueryParameter.
func (p *ProtectedClustersQueryParameter) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", p, err)
	}
