...
func NewMySQLServersClient(subscriptionID string, siteName string, serverName string, credential azcore.TokenCredential, options *arm.ClientOptions) (*MySQLServersClient, error) {
...
//     method.
func (client *MySQLServersClient) CreateOrUpdate(ctx context.Context, resourceGroupName string, body MySQLServer, options *MySQLServersClientCreateOrUpdateOptions) (MySQLServersClientCreateOrUpdateResponse, error) {
	var err error
...
func (client *MySQLServersClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, body MySQLServer, options *MySQLServersClientCreateOrUpdateOptions) (*policy.Request, error) {
	...
	if client.serverName == "" {
		return nil, errors.New("parameter client.serverName cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{serverName}", url.PathEscape(client.serverName))
...
func (client *MySQLServersClient) Delete(ctx context.Context, resourceGroupName string, options *MySQLServersClientDeleteOptions) (MySQLServersClientDeleteResponse, error) {
	var err error
...
func (client *MySQLServersClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, options *MySQLServersClientDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MySQLDiscovery/MySQLSites/{siteName}/MySQLServers/{serverName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *MySQLServersClient) Get(ctx context.Context, resourceGroupName string, options *MySQLServersClientGetOptions) (MySQLServersClientGetResponse, error) {
	var err error
...
func (client *MySQLServersClient) getCreateRequest(ctx context.Context, resourceGroupName string, options *MySQLServersClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MySQLDiscovery/MySQLSites/{siteName}/MySQLServers/{serverName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
//     method.
func (client *MySQLServersClient) NewListBySitePager(resourceGroupName string, options *MySQLServersClientListBySiteOptions) *runtime.Pager[MySQLServersClientListBySiteResponse] {
...
func (client *MySQLServersClient) listBySiteCreateRequest(ctx context.Context, resourceGroupName string, options *MySQLServersClientListBySiteOptions) (*policy.Request, error) {
...
//     method.
func (client *MySQLServersClient) BeginUpdate(ctx context.Context, resourceGroupName string, body MySQLServerResourcePatch, options *MySQLServersClientBeginUpdateOptions) (*runtime.Poller[MySQLServersClientUpdateResponse], error) {
...
//
// Generated from API version 2024-12-30-preview
func (client *MySQLServersClient) update(ctx context.Context, resourceGroupName string, body MySQLServerResourcePatch, options *MySQLServersClientBeginUpdateOptions) (*http.Response, error) {
	var err error
...
func (client *MySQLServersClient) updateCreateRequest(ctx context.Context, resourceGroupName string, body MySQLServerResourcePatch, options *MySQLServersClientBeginUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MySQLDiscovery/MySQLSites/{siteName}/MySQLServers/{serverName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
