...
func (e *EmailRegistrationsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if emailRegistrationsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = emailRegistrationsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			case "EmailRegistrationsClient.ActivateEmail":
				res.resp, res.err = e.dispatchActivateEmail(req)
			case "EmailRegistrationsClient.RegisterEmail":
				res.resp, res.err = e.dispatchRegisterEmail(req)
			default:
...
// set this to conditionally intercept incoming requests to EmailRegistrationsServerTransport
var emailRegistrationsServerTransportInterceptor interface {
