...
// NetworkInterfacesServer is a fake server for instances of the armstackhcivm.NetworkInterfacesClient type.
type NetworkInterfacesServer struct {
	...
	BeginCreateOrUpdate func(ctx context.Context, resourceGroupName string, networkInterfaceName string, resource armstackhcivm.NetworkInterface, options *armstackhcivm.NetworkInterfacesClientBeginCreateOrUpdateOptions) (resp azfake.PollerResponder[armstackhcivm.NetworkInterfacesClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)

	// BeginDelete is the fake for method NetworkInterfacesClient.BeginDelete
	// HTTP status codes to indicate success: http.StatusAccepted, http.StatusNoContent
	BeginDelete func(ctx context.Context, resourceGroupName string, networkInterfaceName string, options *armstackhcivm.NetworkInterfacesClientBeginDeleteOptions) (resp azfake.PollerResponder[armstackhcivm.NetworkInterfacesClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method NetworkInterfacesClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, networkInterfaceName string, options *armstackhcivm.NetworkInterfacesClientGetOptions) (resp azfake.Responder[armstackhcivm.NetworkInterfacesClientGetResponse], errResp azfake.ErrorResponder)

	// NewListAllPager is the fake for method NetworkInterfacesClient.NewListAllPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListAllPager func(options *armstackhcivm.NetworkInterfacesClientListAllOptions) (resp azfake.PagerResponder[armstackhcivm.NetworkInterfacesClientListAllResponse])

	// NewListByResourceGroupPager is the fake for method NetworkInterfacesClient.NewListByResourceGroupPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByResourceGroupPager func(resourceGroupName string, options *armstackhcivm.NetworkInterfacesClientListByResourceGroupOptions) (resp azfake.PagerResponder[armstackhcivm.NetworkInterfacesClientListByResourceGroupResponse])

	// BeginUpdate is the fake for method NetworkInterfacesClient.BeginUpdate
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginUpdate func(ctx context.Context, resourceGroupName string, networkInterfaceName string, properties armstackhcivm.NetworkInterfaceTagsUpdate, options *armstackhcivm.NetworkInterfacesClientBeginUpdateOptions) (resp azfake.PollerResponder[armstackhcivm.NetworkInterfacesClientUpdateResponse], errResp azfake.ErrorResponder)
}
...
// The returned NetworkInterfacesServerTransport instance is connected to an instance of armstackhcivm.NetworkInterfacesClient via the
...
func NewNetworkInterfacesServerTransport(srv *NetworkInterfacesServer) *NetworkInterfacesServerTransport {
	return &NetworkInterfacesServerTransport{
		srv:                         srv,
		beginCreateOrUpdate:         newTracker[azfake.PollerResponder[armstackhcivm.NetworkInterfacesClientCreateOrUpdateResponse]](),
		beginDelete:                 newTracker[azfake.PollerResponder[armstackhcivm.NetworkInterfacesClientDeleteResponse]](),
		newListAllPager:             newTracker[azfake.PagerResponder[armstackhcivm.NetworkInterfacesClientListAllResponse]](),
		newListByResourceGroupPager: newTracker[azfake.PagerResponder[armstackhcivm.NetworkInterfacesClientListByResourceGroupResponse]](),
		beginUpdate:                 newTracker[azfake.PollerResponder[armstackhcivm.NetworkInterfacesClientUpdateResponse]](),
	}
}

// NetworkInterfacesServerTransport connects instances of armstackhcivm.NetworkInterfacesClient to instances of NetworkInterfacesServer.
...
type NetworkInterfacesServerTransport struct {
	...
	beginCreateOrUpdate         *tracker[azfake.PollerResponder[armstackhcivm.NetworkInterfacesClientCreateOrUpdateResponse]]
	beginDelete                 *tracker[azfake.PollerResponder[armstackhcivm.NetworkInterfacesClientDeleteResponse]]
	newListAllPager             *tracker[azfake.PagerResponder[armstackhcivm.NetworkInterfacesClientListAllResponse]]
	newListByResourceGroupPager *tracker[azfake.PagerResponder[armstackhcivm.NetworkInterfacesClientListByResourceGroupResponse]]
	beginUpdate                 *tracker[azfake.PollerResponder[armstackhcivm.NetworkInterfacesClientUpdateResponse]]
}
...
func (n *NetworkInterfacesServerTransport) dispatchBeginCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginCreateOrUpdate == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armstackhcivm.NetworkInterface](req)
		if err != nil {
			return nil, err
		}
...
func (n *NetworkInterfacesServerTransport) dispatchNewListAllPager(req *http.Request) (*http.Response, error) {
	...
	if newListAllPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListAllPager, req, func(page *armstackhcivm.NetworkInterfacesClientListAllResponse, createLink func() string) {
...
func (n *NetworkInterfacesServerTransport) dispatchNewListByResourceGroupPager(req *http.Request) (*http.Response, error) {
	...
	if newListByResourceGroupPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListByResourceGroupPager, req, func(page *armstackhcivm.NetworkInterfacesClientListByResourceGroupResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
...
func (n *NetworkInterfacesServerTransport) dispatchBeginUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginUpdate == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armstackhcivm.NetworkInterfaceTagsUpdate](req)
		if err != nil {
			return nil, err
		}
		resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
