...
//   - options - CapacityReservationGroupsClientCapacityReservationGroupsListBySubscriptionOptions contains the optional parameters
//     for the CapacityReservationGroupsClient.NewCapacityReservationGroupsListBySubscriptionPager method.
func (client *CapacityReservationGroupsClient) NewCapacityReservationGroupsListBySubscriptionPager(options *CapacityReservationGroupsClientCapacityReservationGroupsListBySubscriptionOptions) *runtime.Pager[CapacityReservationGroupsClientCapacityReservationGroupsListBySubscriptionResponse] {
	return runtime.NewPager(runtime.PagingHandler[CapacityReservationGroupsClientCapacityReservationGroupsListBySubscriptionResponse]{
		More: func(page CapacityReservationGroupsClientCapacityReservationGroupsListBySubscriptionResponse) bool {
			return page.NextLink != nil && len(*page.NextLink) > 0
		},
		Fetcher: func(ctx context.Context, page *CapacityReservationGroupsClientCapacityReservationGroupsListBySubscriptionResponse) (CapacityReservationGroupsClientCapacityReservationGroupsListBySubscriptionResponse, error) {
			var req *policy.Request
			var err error
			if page == nil {
				req, err = client.capacityReservationGroupsListBySubscriptionCreateRequest(ctx, options)
			} else {
				req, err = runtime.NewRequest(ctx, http.MethodGet, *page.NextLink)
			}
			if err != nil {
				return CapacityReservationGroupsClientCapacityReservationGroupsListBySubscriptionResponse{}, err
			}
			...
			if !runtime.HasStatusCode(resp, http.StatusOK) {
				return CapacityReservationGroupsClientCapacityReservationGroupsListBySubscriptionResponse{}, runtime.NewResponseError(resp)
			}
			return client.capacityReservationGroupsListBySubscriptionHandleResponse(resp)
		},
	})
}

// capacityReservationGroupsListBySubscriptionCreateRequest creates the CapacityReservationGroupsListBySubscription request.
func (client *CapacityReservationGroupsClient) capacityReservationGroupsListBySubscriptionCreateRequest(ctx context.Context, options *CapacityReservationGroupsClientCapacityReservationGroupsListBySubscriptionOptions) (*policy.Request, error) {
...
// capacityReservationGroupsListBySubscriptionHandleResponse handles the CapacityReservationGroupsListBySubscription response.
func (client *CapacityReservationGroupsClient) capacityReservationGroupsListBySubscriptionHandleResponse(resp *http.Response) (CapacityReservationGroupsClientCapacityReservationGroupsListBySubscriptionResponse, error) {
	result := CapacityReservationGroupsClientCapacityReservationGroupsListBySubscriptionResponse{}
...
func (client *CapacityReservationGroupsClient) NewListPager(resourceGroupName string, options *CapacityReservationGroupsClientListOptions) *runtime.Pager[CapacityReservationGroupsClientListResponse] {
	return runtime.NewPager(runtime.PagingHandler[CapacityReservationGroupsClientListResponse]{
		...
		Fetcher: func(ctx context.Context, page *CapacityReservationGroupsClientListResponse) (CapacityReservationGroupsClientListResponse, error) {
			...
			if !runtime.HasStatusCode(resp, http.StatusOK) {
				return CapacityReservationGroupsClientListResponse{}, runtime.NewResponseError(resp)
			}
...
func (client *CapacityReservationGroupsClient) Update(ctx context.Context, resourceGroupName string, groupID string, body PartialMinimalTrackedResourceWithSKUAndIdentity, options *CapacityReservationGroupsClientUpdateOptions) (CapacityReservationGroupsClientUpdateResponse, error) {
	...
	return CapacityReservationGroupsClientUpdateResponse{}, nil
}
