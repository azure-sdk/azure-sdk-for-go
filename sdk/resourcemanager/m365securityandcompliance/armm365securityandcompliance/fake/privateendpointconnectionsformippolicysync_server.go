...
func (p *PrivateEndpointConnectionsForMIPPolicySyncServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if privateEndpointConnectionsForMipPolicySyncServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = privateEndpointConnectionsForMipPolicySyncServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to PrivateEndpointConnectionsForMIPPolicySyncServerTransport
var privateEndpointConnectionsForMipPolicySyncServerTransportInterceptor interface {
