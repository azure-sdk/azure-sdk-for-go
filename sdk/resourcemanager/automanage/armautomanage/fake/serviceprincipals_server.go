...
func (s *ServicePrincipalsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if servicePrincipalsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = servicePrincipalsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to ServicePrincipalsServerTransport
var servicePrincipalsServerTransportInterceptor interface {
