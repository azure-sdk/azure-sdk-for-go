...
type ServerFactory struct {
	...
	// AccountConnectorsServer contains the fakes for client AccountConnectorsClient
	...
	// CustomAssessmentAutomationsServer contains the fakes for client CustomAssessmentAutomationsClient
	CustomAssessmentAutomationsServer CustomAssessmentAutomationsServer

	// CustomEntityStoreAssignmentsServer contains the fakes for client CustomEntityStoreAssignmentsClient
	...
	// DevOpsPoliciesServer contains the fakes for client DevOpsPoliciesClient
	DevOpsPoliciesServer DevOpsPoliciesServer

	// DevOpsPolicyAssignmentsServer contains the fakes for client DevOpsPolicyAssignmentsClient
	...
	// SoftwareInventoriesServer contains the fakes for client SoftwareInventoriesClient
...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "StandardsClient":
		initServer(s, &s.trStandardsServer, func() *StandardsServerTransport { return NewStandardsServerTransport(&s.srv.StandardsServer) })
