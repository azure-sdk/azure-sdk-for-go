...
- New function `*ContainerAppsAPIClient.GetVerificationID(context.Context, *ContainerAppsAPIClientGetVerificationIDOptions) (ContainerAppsAPIClientGetVerificationIDResponse, error)`
...
- New field `AppInsightsConfiguration`, `OpenTelemetryConfiguration`, `PeerAuthentication` in struct `ManagedEnvironmentProperties`
