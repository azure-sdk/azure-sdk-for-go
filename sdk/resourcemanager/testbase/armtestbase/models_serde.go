...
func (b BillingHubExecutionUsageDetail) MarshalJSON() ([]byte, error) {
	...
	populateDateTimeRFC3339(objectMap, "endTimeStamp", b.EndTimeStamp)
	...
	populateDateTimeRFC3339(objectMap, "startTimeStamp", b.StartTimeStamp)
...
func (b *BillingHubExecutionUsageDetail) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "billedCharges":
			...
			delete(rawMsg, key)
		case "endTimeStamp":
			err = unpopulateDateTimeRFC3339(val, "EndTimeStamp", &b.EndTimeStamp)
			delete(rawMsg, key)
		...
		case "sku":
			...
			delete(rawMsg, key)
		case "startTimeStamp":
			err = unpopulateDateTimeRFC3339(val, "StartTimeStamp", &b.StartTimeStamp)
			delete(rawMsg, key)
		case "testType":
...
func (b BillingHubFreeHourIncrementEntry) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateDateTimeRFC3339(objectMap, "createTimeStamp", b.CreateTimeStamp)
	populateDateTimeRFC3339(objectMap, "expirationTimeStamp", b.ExpirationTimeStamp)
...
func (b *BillingHubFreeHourIncrementEntry) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "createTimeStamp":
			err = unpopulateDateTimeRFC3339(val, "CreateTimeStamp", &b.CreateTimeStamp)
			delete(rawMsg, key)
		case "expirationTimeStamp":
			err = unpopulateDateTimeRFC3339(val, "ExpirationTimeStamp", &b.ExpirationTimeStamp)
			delete(rawMsg, key)
		case "freeHourStatus":
...
func (b BillingHubUsageGroup) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "release", b.Release)
	populateDateTimeRFC3339(objectMap, "releaseBuildDate", b.ReleaseBuildDate)
...
func (b *BillingHubUsageGroup) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "releaseBuildDate":
			err = unpopulateDateTimeRFC3339(val, "ReleaseBuildDate", &b.ReleaseBuildDate)
			delete(rawMsg, key)
...
func (c CustomImageProperties) MarshalJSON() ([]byte, error) {
	...
	populateDateTimeRFC3339(objectMap, "releaseVersionDate", c.ReleaseVersionDate)
...
func (c *CustomImageProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "releaseVersionDate":
			err = unpopulateDateTimeRFC3339(val, "ReleaseVersionDate", &c.ReleaseVersionDate)
			delete(rawMsg, key)
		case "source":
...
func (d DraftPackageIntuneAppMetadataItem) MarshalJSON() ([]byte, error) {
	...
	populateDateTimeRFC3339(objectMap, "createDate", d.CreateDate)
...
func (d *DraftPackageIntuneAppMetadataItem) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "appName":
			...
			delete(rawMsg, key)
		case "createDate":
			err = unpopulateDateTimeRFC3339(val, "CreateDate", &d.CreateDate)
			delete(rawMsg, key)
		case "dependencyIds":
...
func (f FeatureUpdateSupportedOsesProperties) MarshalJSON() ([]byte, error) {
	...
	populateDateTimeRFC3339(objectMap, "startTime", f.StartTime)
...
func (f *FeatureUpdateSupportedOsesProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "osName":
			...
			delete(rawMsg, key)
		case "startTime":
			err = unpopulateDateTimeRFC3339(val, "StartTime", &f.StartTime)
			delete(rawMsg, key)
		case "state":
...
func (i InplaceUpgradeProperties) MarshalJSON() ([]byte, error) {
	...
	populateDateTimeRFC3339(objectMap, "baselineReleaseVersionDate", i.BaselineReleaseVersionDate)
	populate(objectMap, "customImageDisplayName", i.CustomImageDisplayName)
	populate(objectMap, "customImageId", i.CustomImageID)
	populateDateTimeRFC3339(objectMap, "upgradeEndTime", i.UpgradeEndTime)
	populateDateTimeRFC3339(objectMap, "upgradeStartTime", i.UpgradeStartTime)
	return json.Marshal(objectMap)
}
...
func (i *InplaceUpgradeProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "baselineReleaseVersionDate":
			err = unpopulateDateTimeRFC3339(val, "BaselineReleaseVersionDate", &i.BaselineReleaseVersionDate)
			delete(rawMsg, key)
		...
		case "customImageId":
			...
			delete(rawMsg, key)
		case "upgradeEndTime":
			err = unpopulateDateTimeRFC3339(val, "UpgradeEndTime", &i.UpgradeEndTime)
			delete(rawMsg, key)
		case "upgradeStartTime":
			err = unpopulateDateTimeRFC3339(val, "UpgradeStartTime", &i.UpgradeStartTime)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", i, err)
...
func (r ReleaseProperties) MarshalJSON() ([]byte, error) {
	...
	populateDateTimeRFC3339(objectMap, "releaseVersionDate", r.ReleaseVersionDate)
	return json.Marshal(objectMap)
}
...
func (r *ReleaseProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "releaseName":
			...
			delete(rawMsg, key)
		case "releaseVersionDate":
			err = unpopulateDateTimeRFC3339(val, "ReleaseVersionDate", &r.ReleaseVersionDate)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", r, err)
...
func (t TestResultProperties) MarshalJSON() ([]byte, error) {
	...
	populateDateTimeRFC3339(objectMap, "testEndTime", t.TestEndTime)
	populate(objectMap, "testRunTime", t.TestRunTime)
	populateDateTimeRFC3339(objectMap, "testStartTime", t.TestStartTime)
...
func (t *TestResultProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "releaseVersionDate":
			...
			delete(rawMsg, key)
		case "testEndTime":
			err = unpopulateDateTimeRFC3339(val, "TestEndTime", &t.TestEndTime)
			delete(rawMsg, key)
		case "testRunTime":
			err = unpopulate(val, "TestRunTime", &t.TestRunTime)
			delete(rawMsg, key)
		case "testStartTime":
			err = unpopulateDateTimeRFC3339(val, "TestStartTime", &t.TestStartTime)
			delete(rawMsg, key)
		case "testStatus":
