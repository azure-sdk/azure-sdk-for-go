...
```go
client, err := armazurestack.NewCustomerSubscriptionsClient(<subscription ID>, cred, nil)
```
...
client, err := armazurestack.NewCustomerSubscriptionsClient(<subscription ID>, cred, &options)
```
