...
// MarshalJSON implements the json.Marshaller interface for type CloudManagerTenant.
func (c CloudManagerTenant) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "name", c.Name)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type CloudManagerTenant.
func (c *CloudManagerTenant) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
