...
type GlobalReachConnectionsServer struct {
	...
	// HTTP status codes to indicate success: http.StatusOK
	NewListByPrivateCloudPager func(resourceGroupName string, privateCloudName string, options *armavs.GlobalReachConnectionsClientListByPrivateCloudOptions) (resp azfake.PagerResponder[armavs.GlobalReachConnectionsClientListByPrivateCloudResponse])
}
...
func (g *GlobalReachConnectionsServerTransport) dispatchNewListByPrivateCloudPager(req *http.Request) (*http.Response, error) {
	...
	if newListByPrivateCloudPager == nil {
		...
		resp := g.srv.NewListByPrivateCloudPager(resourceGroupNameParam, privateCloudNameParam, nil)
