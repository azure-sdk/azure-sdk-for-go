...
func (c *ComputePoliciesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if computePoliciesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = computePoliciesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to ComputePoliciesServerTransport
var computePoliciesServerTransportInterceptor interface {
