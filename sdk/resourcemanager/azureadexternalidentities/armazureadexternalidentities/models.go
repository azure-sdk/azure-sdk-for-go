...
type CIAMTenantResource struct {
	...
	// REQUIRED; SKU properties of the Azure AD for customers tenant. Learn more about Azure AD for customers billing at aka.ms/b2cBilling
	// [https://aka.ms/b2cBilling].
	SKU *CIAMResourceSKU
...
type CIAMTenantUpdateRequest struct {
	// SKU properties of the Azure AD for customers tenant. Learn more about Azure AD for customers billing at aka.ms/b2cBilling
	// [https://aka.ms/b2cBilling].
	SKU *CIAMResourceSKU
...
// CreateCIAMTenantRequestBody - The information needed to create the Azure AD for customers tenant and corresponding Azure
// resource, which is used for billing purposes.
type CreateCIAMTenantRequestBody struct {
	// REQUIRED; The location in which the resource is hosted and data resides. Can be one of 'United States', 'Europe', 'Asia
	// Pacific', or 'Australia'. Refer to this documentation [https://aka.ms/B2CDataResidency]
	// for more information.
	Location *string
	...
	// REQUIRED
	Properties *CreateCIAMTenantRequestBodyProperties
...
type CreateCIAMTenantRequestBodyProperties struct {
