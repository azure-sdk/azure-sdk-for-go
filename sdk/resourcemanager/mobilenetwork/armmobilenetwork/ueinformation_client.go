...
func (client *UeInformationClient) listCreateRequest(ctx context.Context, resourceGroupName string, packetCoreControlPlaneName string, _ *UeInformationClientListOptions) (*policy.Request, error) {
