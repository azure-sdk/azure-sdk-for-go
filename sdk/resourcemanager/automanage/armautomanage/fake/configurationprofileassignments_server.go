...
func (c *ConfigurationProfileAssignmentsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if configurationProfileAssignmentsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = configurationProfileAssignmentsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "ConfigurationProfileAssignmentsClient.NewListByClusterNamePager":
				res.resp, res.err = c.dispatchNewListByClusterNamePager(req)
			case "ConfigurationProfileAssignmentsClient.NewListByMachineNamePager":
				res.resp, res.err = c.dispatchNewListByMachineNamePager(req)
			...
			case "ConfigurationProfileAssignmentsClient.NewListByVirtualMachinesPager":
				res.resp, res.err = c.dispatchNewListByVirtualMachinesPager(req)
			default:
...
// set this to conditionally intercept incoming requests to ConfigurationProfileAssignmentsServerTransport
var configurationProfileAssignmentsServerTransportInterceptor interface {
