...
func (l *LabsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if labsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = labsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "LabsClient.GenerateInviteCode":
				res.resp, res.err = l.dispatchGenerateInviteCode(req)
			case "LabsClient.Get":
...
// set this to conditionally intercept incoming requests to LabsServerTransport
var labsServerTransportInterceptor interface {
