...
func (o *OutputsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if outputsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = outputsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			case "OutputsClient.CreateOrReplace":
				res.resp, res.err = o.dispatchCreateOrReplace(req)
			...
			case "OutputsClient.NewListByStreamingJobPager":
				res.resp, res.err = o.dispatchNewListByStreamingJobPager(req)
			case "OutputsClient.BeginTest":
				res.resp, res.err = o.dispatchBeginTest(req)
...
// set this to conditionally intercept incoming requests to OutputsServerTransport
var outputsServerTransportInterceptor interface {
