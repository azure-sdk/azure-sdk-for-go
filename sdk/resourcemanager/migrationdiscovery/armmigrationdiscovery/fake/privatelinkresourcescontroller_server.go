...
func (p *PrivateLinkResourcesControllerServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if privateLinkResourcesControllerServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = privateLinkResourcesControllerServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "PrivateLinkResourcesControllerClient.NewListByMasterSitePager":
				res.resp, res.err = p.dispatchNewListByMasterSitePager(req)
			default:
...
// set this to conditionally intercept incoming requests to PrivateLinkResourcesControllerServerTransport
var privateLinkResourcesControllerServerTransportInterceptor interface {
