...
type WorkloadNetworkVMGroupsServer struct {
	...
	BeginCreate func(ctx context.Context, resourceGroupName string, privateCloudName string, vmGroupID string, workloadNetworkVMGroup armavs.WorkloadNetworkVMGroup, options *armavs.WorkloadNetworkVMGroupsClientBeginCreateOptions) (resp azfake.PollerResponder[armavs.WorkloadNetworkVMGroupsClientCreateResponse], errResp azfake.ErrorResponder)

	// BeginDelete is the fake for method WorkloadNetworkVMGroupsClient.BeginDelete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginDelete func(ctx context.Context, resourceGroupName string, vmGroupID string, privateCloudName string, options *armavs.WorkloadNetworkVMGroupsClientBeginDeleteOptions) (resp azfake.PollerResponder[armavs.WorkloadNetworkVMGroupsClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method WorkloadNetworkVMGroupsClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, privateCloudName string, vmGroupID string, options *armavs.WorkloadNetworkVMGroupsClientGetOptions) (resp azfake.Responder[armavs.WorkloadNetworkVMGroupsClientGetResponse], errResp azfake.ErrorResponder)

	// NewListPager is the fake for method WorkloadNetworkVMGroupsClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(resourceGroupName string, privateCloudName string, options *armavs.WorkloadNetworkVMGroupsClientListOptions) (resp azfake.PagerResponder[armavs.WorkloadNetworkVMGroupsClientListResponse])

	// BeginUpdate is the fake for method WorkloadNetworkVMGroupsClient.BeginUpdate
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginUpdate func(ctx context.Context, resourceGroupName string, privateCloudName string, vmGroupID string, workloadNetworkVMGroup armavs.WorkloadNetworkVMGroup, options *armavs.WorkloadNetworkVMGroupsClientBeginUpdateOptions) (resp azfake.PollerResponder[armavs.WorkloadNetworkVMGroupsClientUpdateResponse], errResp azfake.ErrorResponder)
}
...
func NewWorkloadNetworkVMGroupsServerTransport(srv *WorkloadNetworkVMGroupsServer) *WorkloadNetworkVMGroupsServerTransport {
	return &WorkloadNetworkVMGroupsServerTransport{
		...
		newListPager: newTracker[azfake.PagerResponder[armavs.WorkloadNetworkVMGroupsClientListResponse]](),
...
type WorkloadNetworkVMGroupsServerTransport struct {
	...
	newListPager *tracker[azfake.PagerResponder[armavs.WorkloadNetworkVMGroupsClientListResponse]]
...
func (w *WorkloadNetworkVMGroupsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if workloadNetworkVMGroupsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = workloadNetworkVMGroupsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "WorkloadNetworkVMGroupsClient.NewListPager":
...
func (w *WorkloadNetworkVMGroupsServerTransport) dispatchBeginCreate(req *http.Request) (*http.Response, error) {
	...
	if beginCreate == nil {
		...
		respr, errRespr := w.srv.BeginCreate(req.Context(), resourceGroupNameParam, privateCloudNameParam, vmGroupIDParam, body, nil)
...
func (w *WorkloadNetworkVMGroupsServerTransport) dispatchBeginDelete(req *http.Request) (*http.Response, error) {
	...
	if beginDelete == nil {
		...
		respr, errRespr := w.srv.BeginDelete(req.Context(), resourceGroupNameParam, vmGroupIDParam, privateCloudNameParam, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginDelete = &respr
...
func (w *WorkloadNetworkVMGroupsServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := w.srv.Get(req.Context(), resourceGroupNameParam, privateCloudNameParam, vmGroupIDParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
...
func (w *WorkloadNetworkVMGroupsServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armavs.WorkloadNetworkVMGroupsClientListResponse, createLink func() string) {
...
func (w *WorkloadNetworkVMGroupsServerTransport) dispatchBeginUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginUpdate == nil {
		...
		respr, errRespr := w.srv.BeginUpdate(req.Context(), resourceGroupNameParam, privateCloudNameParam, vmGroupIDParam, body, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginUpdate = &respr
...
// set this to conditionally intercept incoming requests to WorkloadNetworkVMGroupsServerTransport
var workloadNetworkVMGroupsServerTransportInterceptor interface {
