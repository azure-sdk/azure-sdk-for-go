...
type WorkloadNetworkDhcpConfigurationsServer struct {
	...
	// HTTP status codes to indicate success: http.StatusOK
	NewListByWorkloadNetworkPager func(resourceGroupName string, privateCloudName string, options *armavs.WorkloadNetworkDhcpConfigurationsClientListByWorkloadNetworkOptions) (resp azfake.PagerResponder[armavs.WorkloadNetworkDhcpConfigurationsClientListByWorkloadNetworkResponse])
