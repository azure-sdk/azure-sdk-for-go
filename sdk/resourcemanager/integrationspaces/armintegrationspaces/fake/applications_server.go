	...
	go func() {
		...
		if !intercepted {
			...
			case "ApplicationsClient.DeleteBusinessProcessDevelopmentArtifact":
				res.resp, res.err = a.dispatchDeleteBusinessProcessDevelopmentArtifact(req)
			case "ApplicationsClient.Get":
				res.resp, res.err = a.dispatchGet(req)
			case "ApplicationsClient.GetBusinessProcessDevelopmentArtifact":
				res.resp, res.err = a.dispatchGetBusinessProcessDevelopmentArtifact(req)
			case "ApplicationsClient.ListBusinessProcessDevelopmentArtifacts":
				res.resp, res.err = a.dispatchListBusinessProcessDevelopmentArtifacts(req)
			case "ApplicationsClient.NewListBySpacePager":
				res.resp, res.err = a.dispatchNewListBySpacePager(req)
			...
			case "ApplicationsClient.SaveBusinessProcessDevelopmentArtifact":
				res.resp, res.err = a.dispatchSaveBusinessProcessDevelopmentArtifact(req)
			case "ApplicationsClient.ValidateBusinessProcessDevelopmentArtifact":
				res.resp, res.err = a.dispatchValidateBusinessProcessDevelopmentArtifact(req)
			default:
