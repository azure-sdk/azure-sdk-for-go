...
func (client *WebAppAssessmentV2SummaryOperationsClient) getCreateRequest(ctx context.Context, resourceGroupName string, projectName string, groupName string, assessmentName string, summaryName string, options *WebAppAssessmentV2SummaryOperationsClientGetOptions) (*policy.Request, error) {
...
func (client *WebAppAssessmentV2SummaryOperationsClient) listByWebAppAssessmentV2CreateRequest(ctx context.Context, resourceGroupName string, projectName string, groupName string, assessmentName string, options *WebAppAssessmentV2SummaryOperationsClientListByWebAppAssessmentV2Options) (*policy.Request, error) {
