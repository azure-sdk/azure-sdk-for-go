...
// WebAppDiscoverySiteDataSourcesControllerServer is a fake server for instances of the armmigrationdiscovery.WebAppDiscoverySiteDataSourcesControllerClient type.
type WebAppDiscoverySiteDataSourcesControllerServer struct {
	...
	BeginCreate func(ctx context.Context, resourceGroupName string, siteName string, webAppSiteName string, discoverySiteDataSourceName string, body armmigrationdiscovery.DiscoverySiteDataSource, options *armmigrationdiscovery.WebAppDiscoverySiteDataSourcesControllerClientBeginCreateOptions) (resp azfake.PollerResponder[armmigrationdiscovery.WebAppDiscoverySiteDataSourcesControllerClientCreateResponse], errResp azfake.ErrorResponder)

	// BeginDelete is the fake for method WebAppDiscoverySiteDataSourcesControllerClient.BeginDelete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginDelete func(ctx context.Context, resourceGroupName string, siteName string, webAppSiteName string, discoverySiteDataSourceName string, options *armmigrationdiscovery.WebAppDiscoverySiteDataSourcesControllerClientBeginDeleteOptions) (resp azfake.PollerResponder[armmigrationdiscovery.WebAppDiscoverySiteDataSourcesControllerClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method WebAppDiscoverySiteDataSourcesControllerClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, siteName string, webAppSiteName string, discoverySiteDataSourceName string, options *armmigrationdiscovery.WebAppDiscoverySiteDataSourcesControllerClientGetOptions) (resp azfake.Responder[armmigrationdiscovery.WebAppDiscoverySiteDataSourcesControllerClientGetResponse], errResp azfake.ErrorResponder)

	// NewListByWebAppSitePager is the fake for method WebAppDiscoverySiteDataSourcesControllerClient.NewListByWebAppSitePager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByWebAppSitePager func(resourceGroupName string, siteName string, webAppSiteName string, options *armmigrationdiscovery.WebAppDiscoverySiteDataSourcesControllerClientListByWebAppSiteOptions) (resp azfake.PagerResponder[armmigrationdiscovery.WebAppDiscoverySiteDataSourcesControllerClientListByWebAppSiteResponse])
}
...
// The returned WebAppDiscoverySiteDataSourcesControllerServerTransport instance is connected to an instance of armmigrationdiscovery.WebAppDiscoverySiteDataSourcesControllerClient via the
...
func NewWebAppDiscoverySiteDataSourcesControllerServerTransport(srv *WebAppDiscoverySiteDataSourcesControllerServer) *WebAppDiscoverySiteDataSourcesControllerServerTransport {
	return &WebAppDiscoverySiteDataSourcesControllerServerTransport{
		srv:                      srv,
		beginCreate:              newTracker[azfake.PollerResponder[armmigrationdiscovery.WebAppDiscoverySiteDataSourcesControllerClientCreateResponse]](),
		beginDelete:              newTracker[azfake.PollerResponder[armmigrationdiscovery.WebAppDiscoverySiteDataSourcesControllerClientDeleteResponse]](),
		newListByWebAppSitePager: newTracker[azfake.PagerResponder[armmigrationdiscovery.WebAppDiscoverySiteDataSourcesControllerClientListByWebAppSiteResponse]](),
	}
}

// WebAppDiscoverySiteDataSourcesControllerServerTransport connects instances of armmigrationdiscovery.WebAppDiscoverySiteDataSourcesControllerClient to instances of WebAppDiscoverySiteDataSourcesControllerServer.
...
type WebAppDiscoverySiteDataSourcesControllerServerTransport struct {
	...
	beginCreate              *tracker[azfake.PollerResponder[armmigrationdiscovery.WebAppDiscoverySiteDataSourcesControllerClientCreateResponse]]
	beginDelete              *tracker[azfake.PollerResponder[armmigrationdiscovery.WebAppDiscoverySiteDataSourcesControllerClientDeleteResponse]]
	newListByWebAppSitePager *tracker[azfake.PagerResponder[armmigrationdiscovery.WebAppDiscoverySiteDataSourcesControllerClientListByWebAppSiteResponse]]
}
...
func (w *WebAppDiscoverySiteDataSourcesControllerServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if webAppDiscoverySiteDataSourcesControllerServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = webAppDiscoverySiteDataSourcesControllerServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
func (w *WebAppDiscoverySiteDataSourcesControllerServerTransport) dispatchBeginCreate(req *http.Request) (*http.Response, error) {
	...
	if beginCreate == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armmigrationdiscovery.DiscoverySiteDataSource](req)
		if err != nil {
			return nil, err
		}
...
func (w *WebAppDiscoverySiteDataSourcesControllerServerTransport) dispatchNewListByWebAppSitePager(req *http.Request) (*http.Response, error) {
	...
	if newListByWebAppSitePager == nil {
		...
		server.PagerResponderInjectNextLinks(newListByWebAppSitePager, req, func(page *armmigrationdiscovery.WebAppDiscoverySiteDataSourcesControllerClientListByWebAppSiteResponse, createLink func() string) {
...
// set this to conditionally intercept incoming requests to WebAppDiscoverySiteDataSourcesControllerServerTransport
var webAppDiscoverySiteDataSourcesControllerServerTransportInterceptor interface {
