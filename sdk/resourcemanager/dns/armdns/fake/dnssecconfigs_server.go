...
type DnssecConfigsServer struct {
	...
	BeginCreateOrUpdate func(ctx context.Context, resourceGroupName string, zoneName string, resource armdns.DnssecConfig, options *armdns.DnssecConfigsClientBeginCreateOrUpdateOptions) (resp azfake.PollerResponder[armdns.DnssecConfigsClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)
...
func (d *DnssecConfigsServerTransport) dispatchBeginCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginCreateOrUpdate == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armdns.DnssecConfig](req)
		if err != nil {
			return nil, err
		}
		...
		respr, errRespr := d.srv.BeginCreateOrUpdate(req.Context(), resourceGroupNameParam, zoneNameParam, body, options)
