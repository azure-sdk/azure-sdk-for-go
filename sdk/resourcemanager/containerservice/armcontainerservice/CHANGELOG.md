...
- New field `ArtifactStreamingProfile`, `GpuProfile`, `NodeInitializationTaints` in struct `ManagedClusterAgentPoolProfile`
- New field `ArtifactStreamingProfile`, `GpuProfile`, `NodeInitializationTaints` in struct `ManagedClusterAgentPoolProfileProperties`
