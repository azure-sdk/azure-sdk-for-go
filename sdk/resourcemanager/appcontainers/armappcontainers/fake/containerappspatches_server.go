...
type ContainerAppsPatchesServer struct {
	...
	BeginApply func(ctx context.Context, resourceGroupName string, patchName string, options *armappcontainers.ContainerAppsPatchesClientBeginApplyOptions) (resp azfake.PollerResponder[armappcontainers.ContainerAppsPatchesClientApplyResponse], errResp azfake.ErrorResponder)

	// BeginDelete is the fake for method ContainerAppsPatchesClient.BeginDelete
	// HTTP status codes to indicate success: http.StatusAccepted, http.StatusNoContent
	BeginDelete func(ctx context.Context, resourceGroupName string, patchName string, options *armappcontainers.ContainerAppsPatchesClientBeginDeleteOptions) (resp azfake.PollerResponder[armappcontainers.ContainerAppsPatchesClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method ContainerAppsPatchesClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, patchName string, options *armappcontainers.ContainerAppsPatchesClientGetOptions) (resp azfake.Responder[armappcontainers.ContainerAppsPatchesClientGetResponse], errResp azfake.ErrorResponder)

	// NewListByContainerAppPager is the fake for method ContainerAppsPatchesClient.NewListByContainerAppPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByContainerAppPager func(resourceGroupName string, options *armappcontainers.ContainerAppsPatchesClientListByContainerAppOptions) (resp azfake.PagerResponder[armappcontainers.ContainerAppsPatchesClientListByContainerAppResponse])
...
func (c *ContainerAppsPatchesServerTransport) dispatchBeginApply(req *http.Request) (*http.Response, error) {
	...
	if beginApply == nil {
		...
		respr, errRespr := c.srv.BeginApply(req.Context(), resourceGroupNameParam, patchNameParam, nil)
...
func (c *ContainerAppsPatchesServerTransport) dispatchBeginDelete(req *http.Request) (*http.Response, error) {
	...
	if beginDelete == nil {
		...
		respr, errRespr := c.srv.BeginDelete(req.Context(), resourceGroupNameParam, patchNameParam, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginDelete = &respr
...
func (c *ContainerAppsPatchesServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := c.srv.Get(req.Context(), resourceGroupNameParam, patchNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
...
func (c *ContainerAppsPatchesServerTransport) dispatchNewListByContainerAppPager(req *http.Request) (*http.Response, error) {
	...
	if newListByContainerAppPager == nil {
		...
		resp := c.srv.NewListByContainerAppPager(resourceGroupNameParam, options)
...
func (c *ContainerAppsPatchesServerTransport) dispatchBeginSkipConfigure(req *http.Request) (*http.Response, error) {
	...
	if beginSkipConfigure == nil {
		...
		respr, errRespr := c.srv.BeginSkipConfigure(req.Context(), resourceGroupNameParam, patchNameParam, body, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
