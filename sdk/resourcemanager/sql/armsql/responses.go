...
// DatabaseBillingVersionClientCreateResponse contains the response from method DatabaseBillingVersionClient.Create.
type DatabaseBillingVersionClientCreateResponse struct {
	// A response containing a billing version.
	DatabaseBillingVersionResponse
}
