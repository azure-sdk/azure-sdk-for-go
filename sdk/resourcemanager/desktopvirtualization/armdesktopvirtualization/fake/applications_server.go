...
type ApplicationsServer struct {
	...
	// HTTP status codes to indicate success: http.StatusOK
	Update func(ctx context.Context, resourceGroupName string, applicationGroupName string, applicationName string, body armdesktopvirtualization.ApplicationPatch, options *armdesktopvirtualization.ApplicationsClientUpdateOptions) (resp azfake.Responder[armdesktopvirtualization.ApplicationsClientUpdateResponse], errResp azfake.ErrorResponder)
}
...
func (a *ApplicationsServerTransport) dispatchUpdate(req *http.Request) (*http.Response, error) {
	...
	resp, err := server.MarshalResponseAsJSON(respContent, server.GetResponse(respr).ApplicationPatch, req)
	if err != nil {
		return nil, err
	}
	return resp, nil
