...
func (client *ReportClient) createOrUpdateCreateRequest(ctx context.Context, reportName string, properties ReportResource, _ *ReportClientBeginCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *ReportClient) nestedResourceCheckNameAvailabilityCreateRequest(ctx context.Context, reportName string, body CheckNameAvailabilityRequest, _ *ReportClientNestedResourceCheckNameAvailabilityOptions) (*policy.Request, error) {
