...
func (client *ConsumerInvitationsClient) getCreateRequest(ctx context.Context, location string, invitationID string, _ *ConsumerInvitationsClientGetOptions) (*policy.Request, error) {
...
func (client *ConsumerInvitationsClient) rejectInvitationCreateRequest(ctx context.Context, location string, invitation ConsumerInvitation, _ *ConsumerInvitationsClientRejectInvitationOptions) (*policy.Request, error) {
