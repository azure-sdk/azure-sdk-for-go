...
func unmarshalDataReferenceCredentialDtoClassification(rawMsg json.RawMessage) (DataReferenceCredentialDtoClassification, error) {
	if rawMsg == nil {
		return nil, nil
	}
	var m map[string]any
...
func unmarshalPendingUploadCredentialDtoClassification(rawMsg json.RawMessage) (PendingUploadCredentialDtoClassification, error) {
	...
	case string(PendingUploadCredentialTypeSAS):
		b = &PendingUploadSASCredentialDto{}
	default:
