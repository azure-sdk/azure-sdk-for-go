...
func (k *KustoPoolPrincipalAssignmentsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if kustoPoolPrincipalAssignmentsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = kustoPoolPrincipalAssignmentsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to KustoPoolPrincipalAssignmentsServerTransport
var kustoPoolPrincipalAssignmentsServerTransportInterceptor interface {
