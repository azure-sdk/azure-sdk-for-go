...
// ClientOperationsListResponse contains the response from method Client.OperationsList.
...
// MonitoringAccountsClientCreateResponse contains the response from method MonitoringAccountsClient.Create.
type MonitoringAccountsClientCreateResponse struct {
	MonitoringAccountResource
}

// MonitoringAccountsClientDeleteResponse contains the response from method MonitoringAccountsClient.Delete.
type MonitoringAccountsClientDeleteResponse struct {
	// placeholder for future response values
}

// MonitoringAccountsClientGetResponse contains the response from method MonitoringAccountsClient.Get.
type MonitoringAccountsClientGetResponse struct {
	MonitoringAccountResource
}

// MonitoringAccountsClientListByResourceGroupResponse contains the response from method MonitoringAccountsClient.ListByResourceGroup.
type MonitoringAccountsClientListByResourceGroupResponse struct {
	MonitoringAccountResourceListResult
}

// MonitoringAccountsClientListBySubscriptionResponse contains the response from method MonitoringAccountsClient.ListBySubscription.
type MonitoringAccountsClientListBySubscriptionResponse struct {
	MonitoringAccountResourceListResult
}

// MonitoringAccountsClientUpdateResponse contains the response from method MonitoringAccountsClient.Update.
type MonitoringAccountsClientUpdateResponse struct {
	MonitoringAccountResource
}
