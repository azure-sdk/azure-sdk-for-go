...
- New field `ETag`, `MessageOfTheDay` in struct `ManagedClusterAgentPoolProfile`
- New field `ETag`, `MessageOfTheDay` in struct `ManagedClusterAgentPoolProfileProperties`
