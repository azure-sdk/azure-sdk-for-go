...
- New enum type `SecurityPolicyWebApplicationFirewallAssociationIsProfileLevel` with values `SecurityPolicyWebApplicationFirewallAssociationIsProfileLevelFalse`, `SecurityPolicyWebApplicationFirewallAssociationIsProfileLevelTrue`
...
- New field `IsProfileLevel`, `Routes` in struct `SecurityPolicyWebApplicationFirewallAssociation`
