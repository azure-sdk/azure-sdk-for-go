...
type RunCommandInput struct {
	// REQUIRED; The run command id. Valid list of commandIds: Windows: https://learn.microsoft.com/en-us/azure/virtual-machines/windows/run-command#available-commands.
	// Linux
