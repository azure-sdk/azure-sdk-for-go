...
```go
client := clientFactory.NewPrivateEndpointConnectionResourcesClient()
```
...
[open an issue](https://github.com/Azure/azure-sdk-for-go/issues) and assign the `Notification Hubs` label.
