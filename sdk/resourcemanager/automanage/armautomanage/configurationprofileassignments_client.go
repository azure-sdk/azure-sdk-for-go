...
func (client *ConfigurationProfileAssignmentsClient) createOrUpdateCreateRequest(ctx context.Context, configurationProfileAssignmentName string, resourceGroupName string, vmName string, parameters ConfigurationProfileAssignment, _ *ConfigurationProfileAssignmentsClientCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *ConfigurationProfileAssignmentsClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, configurationProfileAssignmentName string, vmName string, _ *ConfigurationProfileAssignmentsClientDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachines/{vmName}/providers/Microsoft.Automanage/configurationProfileAssignments/{configurationProfileAssignmentName}"
	if resourceGroupName == "" {
		return nil, errors.New("parameter resourceGroupName cannot be empty")
	}
...
func (client *ConfigurationProfileAssignmentsClient) getCreateRequest(ctx context.Context, resourceGroupName string, configurationProfileAssignmentName string, vmName string, _ *ConfigurationProfileAssignmentsClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachines/{vmName}/providers/Microsoft.Automanage/configurationProfileAssignments/{configurationProfileAssignmentName}"
	if resourceGroupName == "" {
		return nil, errors.New("parameter resourceGroupName cannot be empty")
	}
...
func (client *ConfigurationProfileAssignmentsClient) listCreateRequest(ctx context.Context, resourceGroupName string, _ *ConfigurationProfileAssignmentsClientListOptions) (*policy.Request, error) {
...
func (client *ConfigurationProfileAssignmentsClient) listByClusterNameCreateRequest(ctx context.Context, resourceGroupName string, clusterName string, _ *ConfigurationProfileAssignmentsClientListByClusterNameOptions) (*policy.Request, error) {
...
func (client *ConfigurationProfileAssignmentsClient) listByMachineNameCreateRequest(ctx context.Context, resourceGroupName string, machineName string, _ *ConfigurationProfileAssignmentsClientListByMachineNameOptions) (*policy.Request, error) {
...
func (client *ConfigurationProfileAssignmentsClient) listBySubscriptionCreateRequest(ctx context.Context, _ *ConfigurationProfileAssignmentsClientListBySubscriptionOptions) (*policy.Request, error) {
...
func (client *ConfigurationProfileAssignmentsClient) listByVirtualMachinesCreateRequest(ctx context.Context, resourceGroupName string, vmName string, _ *ConfigurationProfileAssignmentsClientListByVirtualMachinesOptions) (*policy.Request, error) {
