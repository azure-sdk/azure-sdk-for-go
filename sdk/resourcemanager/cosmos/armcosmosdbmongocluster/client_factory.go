...
func (c *ClientFactory) NewAzureCosmosDBForMongoDBVCoreClient() *AzureCosmosDBForMongoDBVCoreClient {
	subClient, _ := NewAzureCosmosDBForMongoDBVCoreClient(c.credential, c.options)
	return subClient
}
