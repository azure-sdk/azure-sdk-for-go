...
func (m *MobileNetworksServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if mobileNetworksServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = mobileNetworksServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "MobileNetworksClient.NewListSimGroupsPager":
				res.resp, res.err = m.dispatchNewListSimGroupsPager(req)
...
// set this to conditionally intercept incoming requests to MobileNetworksServerTransport
var mobileNetworksServerTransportInterceptor interface {
