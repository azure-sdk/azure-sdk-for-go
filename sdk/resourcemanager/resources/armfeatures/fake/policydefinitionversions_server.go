...
// PolicyDefinitionVersionsServer is a fake server for instances of the armfeatures.PolicyDefinitionVersionsClient type.
type PolicyDefinitionVersionsServer struct {
	...
	CreateOrUpdate func(ctx context.Context, policyDefinitionName string, policyDefinitionVersion string, parameters armfeatures.PolicyDefinitionVersion, options *armfeatures.PolicyDefinitionVersionsClientCreateOrUpdateOptions) (resp azfake.Responder[armfeatures.PolicyDefinitionVersionsClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)

	// CreateOrUpdateAtManagementGroup is the fake for method PolicyDefinitionVersionsClient.CreateOrUpdateAtManagementGroup
	// HTTP status codes to indicate success: http.StatusOK, http.StatusCreated
	CreateOrUpdateAtManagementGroup func(ctx context.Context, managementGroupName string, policyDefinitionName string, policyDefinitionVersion string, parameters armfeatures.PolicyDefinitionVersion, options *armfeatures.PolicyDefinitionVersionsClientCreateOrUpdateAtManagementGroupOptions) (resp azfake.Responder[armfeatures.PolicyDefinitionVersionsClientCreateOrUpdateAtManagementGroupResponse], errResp azfake.ErrorResponder)

	// Delete is the fake for method PolicyDefinitionVersionsClient.Delete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	Delete func(ctx context.Context, policyDefinitionName string, policyDefinitionVersion string, options *armfeatures.PolicyDefinitionVersionsClientDeleteOptions) (resp azfake.Responder[armfeatures.PolicyDefinitionVersionsClientDeleteResponse], errResp azfake.ErrorResponder)

	// DeleteAtManagementGroup is the fake for method PolicyDefinitionVersionsClient.DeleteAtManagementGroup
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	DeleteAtManagementGroup func(ctx context.Context, managementGroupName string, policyDefinitionName string, policyDefinitionVersion string, options *armfeatures.PolicyDefinitionVersionsClientDeleteAtManagementGroupOptions) (resp azfake.Responder[armfeatures.PolicyDefinitionVersionsClientDeleteAtManagementGroupResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method PolicyDefinitionVersionsClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, policyDefinitionName string, policyDefinitionVersion string, options *armfeatures.PolicyDefinitionVersionsClientGetOptions) (resp azfake.Responder[armfeatures.PolicyDefinitionVersionsClientGetResponse], errResp azfake.ErrorResponder)

	// GetAtManagementGroup is the fake for method PolicyDefinitionVersionsClient.GetAtManagementGroup
	// HTTP status codes to indicate success: http.StatusOK
	GetAtManagementGroup func(ctx context.Context, managementGroupName string, policyDefinitionName string, policyDefinitionVersion string, options *armfeatures.PolicyDefinitionVersionsClientGetAtManagementGroupOptions) (resp azfake.Responder[armfeatures.PolicyDefinitionVersionsClientGetAtManagementGroupResponse], errResp azfake.ErrorResponder)

	// GetBuiltIn is the fake for method PolicyDefinitionVersionsClient.GetBuiltIn
	// HTTP status codes to indicate success: http.StatusOK
	GetBuiltIn func(ctx context.Context, policyDefinitionName string, policyDefinitionVersion string, options *armfeatures.PolicyDefinitionVersionsClientGetBuiltInOptions) (resp azfake.Responder[armfeatures.PolicyDefinitionVersionsClientGetBuiltInResponse], errResp azfake.ErrorResponder)

	// NewListPager is the fake for method PolicyDefinitionVersionsClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(policyDefinitionName string, options *armfeatures.PolicyDefinitionVersionsClientListOptions) (resp azfake.PagerResponder[armfeatures.PolicyDefinitionVersionsClientListResponse])

	// ListAll is the fake for method PolicyDefinitionVersionsClient.ListAll
	// HTTP status codes to indicate success: http.StatusOK
	ListAll func(ctx context.Context, options *armfeatures.PolicyDefinitionVersionsClientListAllOptions) (resp azfake.Responder[armfeatures.PolicyDefinitionVersionsClientListAllResponse], errResp azfake.ErrorResponder)

	// ListAllAtManagementGroup is the fake for method PolicyDefinitionVersionsClient.ListAllAtManagementGroup
	// HTTP status codes to indicate success: http.StatusOK
	ListAllAtManagementGroup func(ctx context.Context, managementGroupName string, options *armfeatures.PolicyDefinitionVersionsClientListAllAtManagementGroupOptions) (resp azfake.Responder[armfeatures.PolicyDefinitionVersionsClientListAllAtManagementGroupResponse], errResp azfake.ErrorResponder)

	// ListAllBuiltins is the fake for method PolicyDefinitionVersionsClient.ListAllBuiltins
	// HTTP status codes to indicate success: http.StatusOK
	ListAllBuiltins func(ctx context.Context, options *armfeatures.PolicyDefinitionVersionsClientListAllBuiltinsOptions) (resp azfake.Responder[armfeatures.PolicyDefinitionVersionsClientListAllBuiltinsResponse], errResp azfake.ErrorResponder)

	// NewListBuiltInPager is the fake for method PolicyDefinitionVersionsClient.NewListBuiltInPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListBuiltInPager func(policyDefinitionName string, options *armfeatures.PolicyDefinitionVersionsClientListBuiltInOptions) (resp azfake.PagerResponder[armfeatures.PolicyDefinitionVersionsClientListBuiltInResponse])

	// NewListByManagementGroupPager is the fake for method PolicyDefinitionVersionsClient.NewListByManagementGroupPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByManagementGroupPager func(managementGroupName string, policyDefinitionName string, options *armfeatures.PolicyDefinitionVersionsClientListByManagementGroupOptions) (resp azfake.PagerResponder[armfeatures.PolicyDefinitionVersionsClientListByManagementGroupResponse])
}
...
// The returned PolicyDefinitionVersionsServerTransport instance is connected to an instance of armfeatures.PolicyDefinitionVersionsClient via the
...
func NewPolicyDefinitionVersionsServerTransport(srv *PolicyDefinitionVersionsServer) *PolicyDefinitionVersionsServerTransport {
	return &PolicyDefinitionVersionsServerTransport{
		srv:                           srv,
		newListPager:                  newTracker[azfake.PagerResponder[armfeatures.PolicyDefinitionVersionsClientListResponse]](),
		newListBuiltInPager:           newTracker[azfake.PagerResponder[armfeatures.PolicyDefinitionVersionsClientListBuiltInResponse]](),
		newListByManagementGroupPager: newTracker[azfake.PagerResponder[armfeatures.PolicyDefinitionVersionsClientListByManagementGroupResponse]](),
	}
}

// PolicyDefinitionVersionsServerTransport connects instances of armfeatures.PolicyDefinitionVersionsClient to instances of PolicyDefinitionVersionsServer.
...
type PolicyDefinitionVersionsServerTransport struct {
	...
	newListPager                  *tracker[azfake.PagerResponder[armfeatures.PolicyDefinitionVersionsClientListResponse]]
	newListBuiltInPager           *tracker[azfake.PagerResponder[armfeatures.PolicyDefinitionVersionsClientListBuiltInResponse]]
	newListByManagementGroupPager *tracker[azfake.PagerResponder[armfeatures.PolicyDefinitionVersionsClientListByManagementGroupResponse]]
}
...
func (p *PolicyDefinitionVersionsServerTransport) dispatchCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[armfeatures.PolicyDefinitionVersion](req)
	if err != nil {
		return nil, err
	}
...
func (p *PolicyDefinitionVersionsServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		var options *armfeatures.PolicyDefinitionVersionsClientListOptions
		if topParam != nil {
			options = &armfeatures.PolicyDefinitionVersionsClientListOptions{
				Top: topParam,
			}
		}
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armfeatures.PolicyDefinitionVersionsClientListResponse, createLink func() string) {
...
func (p *PolicyDefinitionVersionsServerTransport) dispatchNewListBuiltInPager(req *http.Request) (*http.Response, error) {
	...
	if newListBuiltInPager == nil {
		...
		var options *armfeatures.PolicyDefinitionVersionsClientListBuiltInOptions
		if topParam != nil {
			options = &armfeatures.PolicyDefinitionVersionsClientListBuiltInOptions{
				Top: topParam,
			}
		}
		...
		server.PagerResponderInjectNextLinks(newListBuiltInPager, req, func(page *armfeatures.PolicyDefinitionVersionsClientListBuiltInResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
...
func (p *PolicyDefinitionVersionsServerTransport) dispatchNewListByManagementGroupPager(req *http.Request) (*http.Response, error) {
	...
	if newListByManagementGroupPager == nil {
		...
		var options *armfeatures.PolicyDefinitionVersionsClientListByManagementGroupOptions
		if topParam != nil {
			options = &armfeatures.PolicyDefinitionVersionsClientListByManagementGroupOptions{
				Top: topParam,
			}
		}
		...
		server.PagerResponderInjectNextLinks(newListByManagementGroupPager, req, func(page *armfeatures.PolicyDefinitionVersionsClientListByManagementGroupResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
