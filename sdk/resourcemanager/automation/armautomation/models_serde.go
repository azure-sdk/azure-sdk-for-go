...
func (h *HybridRunbookWorkerGroup) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "groupType":
			...
			delete(rawMsg, key)
		case "hybridRunbookWorkers":
			err = unpopulate(val, "HybridRunbookWorkers", &h.HybridRunbookWorkers)
			delete(rawMsg, key)
		case "id":
			err = unpopulate(val, "ID", &h.ID)
			delete(rawMsg, key)
...
// MarshalJSON implements the json.Marshaller interface for type HybridRunbookWorkerGroupUpdateParameters.
func (h HybridRunbookWorkerGroupUpdateParameters) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "credential", h.Credential)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type HybridRunbookWorkerGroupUpdateParameters.
func (h *HybridRunbookWorkerGroupUpdateParameters) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", h, err)
	}
