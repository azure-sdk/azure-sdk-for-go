...
type AzureLargeInstancesServer struct {
	...
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginShutdown func(ctx context.Context, resourceGroupName string, azureLargeInstanceName string, body map[string]any, options *armazurelargeinstance.AzureLargeInstancesClientBeginShutdownOptions) (resp azfake.PollerResponder[armazurelargeinstance.AzureLargeInstancesClientShutdownResponse], errResp azfake.ErrorResponder)

	// BeginStart is the fake for method AzureLargeInstancesClient.BeginStart
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginStart func(ctx context.Context, resourceGroupName string, azureLargeInstanceName string, body map[string]any, options *armazurelargeinstance.AzureLargeInstancesClientBeginStartOptions) (resp azfake.PollerResponder[armazurelargeinstance.AzureLargeInstancesClientStartResponse], errResp azfake.ErrorResponder)
