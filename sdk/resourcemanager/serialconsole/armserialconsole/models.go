...
type DisableSerialConsoleResult struct {
	...
	Properties *State `json:"properties,omitempty"`
}
...
// OperationsForbidden - The provided authentication information was insufficient for access to Serial Console
type OperationsForbidden struct {
	// Error code
	Code *string `json:"code,omitempty"`
...
// State - Returns whether or not Serial Console is disabled.
type State struct {
