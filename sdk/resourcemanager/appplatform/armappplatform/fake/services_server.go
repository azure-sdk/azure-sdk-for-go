	...
	go func() {
		...
		if !intercepted {
			...
			case "ServicesClient.BeginDisableApmGlobally":
				res.resp, res.err = s.dispatchBeginDisableApmGlobally(req)
			case "ServicesClient.DisableTestEndpoint":
				res.resp, res.err = s.dispatchDisableTestEndpoint(req)
			case "ServicesClient.BeginEnableApmGlobally":
				res.resp, res.err = s.dispatchBeginEnableApmGlobally(req)
			case "ServicesClient.EnableTestEndpoint":
				res.resp, res.err = s.dispatchEnableTestEndpoint(req)
			case "ServicesClient.BeginFlushVnetDNSSetting":
				res.resp, res.err = s.dispatchBeginFlushVnetDNSSetting(req)
			...
			case "ServicesClient.ListGloballyEnabledApms":
				res.resp, res.err = s.dispatchListGloballyEnabledApms(req)
			case "ServicesClient.NewListSupportedApmTypesPager":
				res.resp, res.err = s.dispatchNewListSupportedApmTypesPager(req)
			case "ServicesClient.NewListSupportedServerVersionsPager":
				res.resp, res.err = s.dispatchNewListSupportedServerVersionsPager(req)
			case "ServicesClient.ListTestKeys":
				res.resp, res.err = s.dispatchListTestKeys(req)
			case "ServicesClient.RegenerateTestKey":
				res.resp, res.err = s.dispatchRegenerateTestKey(req)
