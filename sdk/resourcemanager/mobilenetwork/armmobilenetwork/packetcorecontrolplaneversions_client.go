...
func (client *PacketCoreControlPlaneVersionsClient) getCreateRequest(ctx context.Context, versionName string, _ *PacketCoreControlPlaneVersionsClientGetOptions) (*policy.Request, error) {
...
func (client *PacketCoreControlPlaneVersionsClient) getBySubscriptionCreateRequest(ctx context.Context, versionName string, subscriptionID string, _ *PacketCoreControlPlaneVersionsClientGetBySubscriptionOptions) (*policy.Request, error) {
...
func (client *PacketCoreControlPlaneVersionsClient) listCreateRequest(ctx context.Context, _ *PacketCoreControlPlaneVersionsClientListOptions) (*policy.Request, error) {
...
func (client *PacketCoreControlPlaneVersionsClient) listBySubscriptionCreateRequest(ctx context.Context, subscriptionID string, _ *PacketCoreControlPlaneVersionsClientListBySubscriptionOptions) (*policy.Request, error) {
