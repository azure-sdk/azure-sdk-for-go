...
// ScalingMethodType - The desired scaling method to be used to scale the hosts in the assigned host pool.
type ScalingMethodType string

const (
	// ScalingMethodTypeCreateDeletePowerManage - Scaling will manage the hosts in the host pool by power managing the hosts,
	// as well as creating and deleting hosts to modify the host pool size. This requires the create delete object to be set,
	// and the assigned hostpool to have a session host config property.
	ScalingMethodTypeCreateDeletePowerManage ScalingMethodType = "CreateDeletePowerManage"
	// ScalingMethodTypePowerManage - Scaling will manage hosts in the host pool by power managing the hosts, but will not change
	// the host pool size.
	ScalingMethodTypePowerManage ScalingMethodType = "PowerManage"
)

// PossibleScalingMethodTypeValues returns the possible values for the ScalingMethodType const type.
func PossibleScalingMethodTypeValues() []ScalingMethodType {
	return []ScalingMethodType{
		ScalingMethodTypeCreateDeletePowerManage,
		ScalingMethodTypePowerManage,
	}
}
