...
func (c *ClientFactory) NewCloudConnectionsClient(subscriptionID string, cloudConnectionName string) *CloudConnectionsClient {
...
func (c *ClientFactory) NewCloudConnectorsClient(subscriptionID string, cloudConnectorName string) *CloudConnectorsClient {
