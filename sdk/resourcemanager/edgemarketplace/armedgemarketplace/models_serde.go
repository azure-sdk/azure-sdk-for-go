...
// MarshalJSON implements the json.Marshaller interface for type OfferSearchRequest.
func (o OfferSearchRequest) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "category", o.Category)
	populate(objectMap, "offerId", o.OfferID)
	populate(objectMap, "publisherName", o.PublisherName)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type OfferSearchRequest.
func (o *OfferSearchRequest) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", o, err)
	}
	for key, val := range rawMsg {
		...
		case "offerId":
			...
			delete(rawMsg, key)
		case "publisherName":
			err = unpopulate(val, "PublisherName", &o.PublisherName)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", o, err)
