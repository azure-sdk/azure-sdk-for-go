...
func (client *ManagedNetworkSettingsClient) getHandleResponse(resp *http.Response) (ManagedNetworkSettingsClientGetResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.ManagedNetworkSettingsDtoBasicResource); err != nil {
		return ManagedNetworkSettingsClientGetResponse{}, err
	}
	return result, nil
}
...
//     method.
func (client *ManagedNetworkSettingsClient) BeginPatch(ctx context.Context, resourceGroupName string, workspaceName string, managedNetworkName string, body ManagedNetworkSettingsDtoBasicResource, options *ManagedNetworkSettingsClientBeginPatchOptions) (*runtime.Poller[ManagedNetworkSettingsClientPatchResponse], error) {
...
//
// Generated from API version 2025-04-01
func (client *ManagedNetworkSettingsClient) patch(ctx context.Context, resourceGroupName string, workspaceName string, managedNetworkName string, body ManagedNetworkSettingsDtoBasicResource, options *ManagedNetworkSettingsClientBeginPatchOptions) (*http.Response, error) {
	var err error
...
func (client *ManagedNetworkSettingsClient) patchCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, managedNetworkName string, body ManagedNetworkSettingsDtoBasicResource, _ *ManagedNetworkSettingsClientBeginPatchOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/managedNetworks/{managedNetworkName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
//     method.
func (client *ManagedNetworkSettingsClient) BeginPut(ctx context.Context, resourceGroupName string, workspaceName string, managedNetworkName string, body ManagedNetworkSettingsDtoBasicResource, options *ManagedNetworkSettingsClientBeginPutOptions) (*runtime.Poller[ManagedNetworkSettingsClientPutResponse], error) {
	if options == nil || options.ResumeToken == "" {
...
//
// Generated from API version 2025-04-01
func (client *ManagedNetworkSettingsClient) put(ctx context.Context, resourceGroupName string, workspaceName string, managedNetworkName string, body ManagedNetworkSettingsDtoBasicResource, options *ManagedNetworkSettingsClientBeginPutOptions) (*http.Response, error) {
	var err error
...
func (client *ManagedNetworkSettingsClient) putCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, managedNetworkName string, body ManagedNetworkSettingsDtoBasicResource, _ *ManagedNetworkSettingsClientBeginPutOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/managedNetworks/{managedNetworkName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
