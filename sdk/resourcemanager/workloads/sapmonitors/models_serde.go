...
func (a AlertRuleProperties) MarshalJSON() ([]byte, error) {
	...
	objectMap["autoMitigate"] = "string"
	objectMap["dimension"] = "string"
...
// MarshalJSON implements the json.Marshaller interface for type AlertRuleQueryParameter.
func (a AlertRuleQueryParameter) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "name", a.Name)
	populate(objectMap, "value", a.Value)
	return json.Marshal(objectMap)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type AlertRuleQueryParameter.
func (a *AlertRuleQueryParameter) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", a, err)
	}
