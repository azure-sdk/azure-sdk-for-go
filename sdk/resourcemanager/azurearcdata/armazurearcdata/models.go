...
// AGReplicas - The information about each failover group replica.
...
type ArcSQLAvailabilityGroupDatabasesListResult struct {
	...
	Value []*SQLAvailabilityGroupDatabaseResource `json:"value,omitempty" azure:"ro"`
}
...
type ArcSQLAvailabilityGroupReplicaListResult struct {
	...
	Value []*SQLAvailabilityGroupReplicaResource `json:"value,omitempty" azure:"ro"`
}
...
type ArcSQLServerAvailabilityGroupListResult struct {
	...
	Value []*SQLServerAvailabilityGroupResource `json:"value,omitempty" azure:"ro"`
}
...
type AvailabilityGroupConfigure struct {
	...
	AvailabilityModeDesc *string `json:"availabilityModeDesc,omitempty"`
	...
	FailoverModeDesc *string `json:"failoverModeDesc,omitempty"`

	// Date that the replica was modified.
	ModifyDate *time.Time `json:"modifyDate,omitempty"`

	// Allowed the connections for primary role of the availability group replica.
	PrimaryRoleAllowConnectionsDesc *string `json:"primaryRoleAllowConnectionsDesc,omitempty"`

	// Connectivity endpoint (URL) of the read only availability replica.
	ReadOnlyRoutingURL *string `json:"readOnlyRoutingUrl,omitempty"`

	// Connectivity endpoint (URL) of the read write availability replica.
	ReadWriteRoutingURL *string `json:"readWriteRoutingUrl,omitempty"`

	// Allowed the connections for secondary role of availability group replica.
	SecondaryRoleAllowConnectionsDesc *string `json:"secondaryRoleAllowConnectionsDesc,omitempty"`

	// Describes seeding mode.
	SeedingModeDesc *string `json:"seedingModeDesc,omitempty"`
...
type AvailabilityGroupState struct {
	...
	AvailabilityGroupReplicaRole *string `json:"availabilityGroupReplicaRole,omitempty"`

	// Connected state description of the availability group replica.
	ConnectedStateDesc *string `json:"connectedStateDesc,omitempty"`

	// Last connect error description of the availability group replica.
	LastConnectErrorDescription *string `json:"lastConnectErrorDescription,omitempty"`

	// Last connect error time stamp of the availability group replica.
	LastConnectErrorTimestamp *time.Time `json:"lastConnectErrorTimestamp,omitempty"`

	// Operation state description of the availability group replica
	OperationalStateDesc *string `json:"operationalStateDesc,omitempty"`

	// Recovery health description of the availability group replica.
	RecoveryHealthDesc *string `json:"recoveryHealthDesc,omitempty"`

	// Synchronization health description of the availability group replica.
	SynchronizationHealthDesc *string `json:"synchronizationHealthDesc,omitempty"`
}
...
type FailoverGroupListResult struct {
	...
	Value []*FailoverGroupResource `json:"value,omitempty" azure:"ro"`
}
...
type FailoverGroupSpec struct {
	...
	Role *InstanceFailoverGroupRole `json:"role,omitempty"`

	// OPTIONAL; Contains additional key/value pairs not defined in the schema.
	AdditionalProperties map[string]any

	// The name of the partner SQL managed instance.
	PartnerMI *string `json:"partnerMI,omitempty"`

	// The mirroring endpoint public certificate for the partner SQL managed instance. Only PEM format is supported.
	PartnerMirroringCert *string `json:"partnerMirroringCert,omitempty"`

	// The mirroring endpoint URL of the partner SQL managed instance.
	PartnerMirroringURL *string `json:"partnerMirroringURL,omitempty"`

	// The partner sync mode of the SQL managed instance.
	PartnerSyncMode *FailoverGroupPartnerSyncMode `json:"partnerSyncMode,omitempty"`
	...
	SharedName *string `json:"sharedName,omitempty"`

	// The name of the SQL managed instance with this failover group role.
	SourceMI *string `json:"sourceMI,omitempty"`
}

// FailoverGroupStatus - The status of the Kubernetes custom resource.
type FailoverGroupStatus struct {
	...
	Replicas []*AGReplicas `json:"replicas,omitempty"`
...
type SQLAvailabilityGroup struct {
	...
	// null
	Properties *SQLAvailabilityGroupProperties `json:"properties,omitempty"`
...
type SQLAvailabilityGroupDatabaseReplicaResourceProperties struct {
	...
	DatabaseStateDesc *string `json:"databaseStateDesc,omitempty"`

	// Whether this replica is transaction committer.
	IsCommitParticipant *bool `json:"isCommitParticipant,omitempty"`

	// Whether the availability database is local.
	IsLocal *bool `json:"isLocal,omitempty"`

	// Returns 1 if the replica is primary, or 0 if it is a secondary replica.
	IsPrimaryReplica *bool `json:"isPrimaryReplica,omitempty"`
	...
	SuspendReasonDesc *string `json:"suspendReasonDesc,omitempty"`

	// Description of the health of database.
	SynchronizationHealthDesc *string `json:"synchronizationHealthDesc,omitempty"`

	// Description of the data-movement state.
	SynchronizationStateDesc *string `json:"synchronizationStateDesc,omitempty"`
...
type SQLAvailabilityGroupDatabaseResource struct {
	...
	Properties *SQLAvailabilityGroupMultiDatabaseReplicaResourceProperties `json:"properties,omitempty"`
...
type SQLAvailabilityGroupListResult struct {
	...
	// READ-ONLY; Array of results.
	Value []*SQLAvailabilityGroup `json:"value,omitempty" azure:"ro"`
}
...
type SQLAvailabilityGroupMultiDatabaseReplicaResourceProperties struct {
	...
	Value []*SQLAvailabilityGroupDatabaseReplicaResourceProperties `json:"value,omitempty"`
...
type SQLAvailabilityGroupProperties struct {
	...
	BasicFeatures *bool `json:"basicFeatures,omitempty"`

	// SQL Server availability group cluster type description
	ClusterTypeDesc *string `json:"clusterTypeDesc,omitempty"`
	...
	DtcSupport *bool `json:"dtcSupport,omitempty"`
	...
	RequiredSynchronizedSecondariesCommit *int32 `json:"requiredSynchronizedSecondariesCommit,omitempty"`
...
type SQLAvailabilityGroupReplicaResource struct {
	...
	Properties *SQLAvailabilityGroupReplicaResourceProperties `json:"properties,omitempty"`
...
type SQLAvailabilityGroupReplicaResourceProperties struct {
	// null
	Configure *AvailabilityGroupConfigure `json:"configure,omitempty"`
	...
	// null
	State *AvailabilityGroupState `json:"state,omitempty"`
...
type SQLServerAvailabilityGroupResource struct {
	...
	Properties *SQLServerAvailabilityGroupResourceProperties `json:"properties,omitempty"`
