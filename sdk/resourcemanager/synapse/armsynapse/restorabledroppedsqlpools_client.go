...
func (client *RestorableDroppedSQLPoolsClient) getCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, restorableDroppedSQLPoolID string, _ *RestorableDroppedSQLPoolsClientGetOptions) (*policy.Request, error) {
...
func (client *RestorableDroppedSQLPoolsClient) listByWorkspaceCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, _ *RestorableDroppedSQLPoolsClientListByWorkspaceOptions) (*policy.Request, error) {
