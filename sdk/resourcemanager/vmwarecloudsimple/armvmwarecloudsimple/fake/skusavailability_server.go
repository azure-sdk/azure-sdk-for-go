...
func (s *SKUsAvailabilityServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if skUsAvailabilityServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = skUsAvailabilityServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to SKUsAvailabilityServerTransport
var skUsAvailabilityServerTransportInterceptor interface {
