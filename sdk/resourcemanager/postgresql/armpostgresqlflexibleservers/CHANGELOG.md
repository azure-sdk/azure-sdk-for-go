...
- New enum type `ReplicaLinkState` with values `ReplicaLinkStateActive`, `ReplicaLinkStateBroken`, `ReplicaLinkStateCatchup`, `ReplicaLinkStateProvisioning`, `ReplicaLinkStateReconfiguring`, `ReplicaLinkStateUpdating`
