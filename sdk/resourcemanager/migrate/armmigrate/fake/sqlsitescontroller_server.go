...
type SQLSitesControllerServer struct {
	...
	// TriggerImportInventory is the fake for method SQLSitesControllerClient.TriggerImportInventory
	// HTTP status codes to indicate success: http.StatusOK
	TriggerImportInventory func(ctx context.Context, resourceGroupName string, siteName string, sqlSiteName string, body armmigrate.SQLInventoryImportBody, options *armmigrate.SQLSitesControllerClientTriggerImportInventoryOptions) (resp azfake.Responder[armmigrate.SQLSitesControllerClientTriggerImportInventoryResponse], errResp azfake.ErrorResponder)
...
func (s *SQLSitesControllerServerTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "SQLSitesControllerClient.TriggerImportInventory":
		resp, err = s.dispatchTriggerImportInventory(req)
...
func (s *SQLSitesControllerServerTransport) dispatchTriggerImportInventory(req *http.Request) (*http.Response, error) {
	if s.srv.TriggerImportInventory == nil {
		return nil, &nonRetriableError{errors.New("fake for method TriggerImportInventory not implemented")}
	}
	...
	respr, errRespr := s.srv.TriggerImportInventory(req.Context(), resourceGroupNameParam, siteNameParam, sqlSiteNameParam, body, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
