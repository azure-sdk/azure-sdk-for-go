...
//     method.
func (client *AuthorizationsClient) NewListByPrivateCloudPager(resourceGroupName string, privateCloudName string, options *AuthorizationsClientListByPrivateCloudOptions) *runtime.Pager[AuthorizationsClientListByPrivateCloudResponse] {
...
func (client *AuthorizationsClient) listByPrivateCloudCreateRequest(ctx context.Context, resourceGroupName string, privateCloudName string, _ *AuthorizationsClientListByPrivateCloudOptions) (*policy.Request, error) {
