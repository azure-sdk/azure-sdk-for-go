...
type ClusterResponseProperties struct {
	...
	// READ-ONLY; Restore point creation time (ISO8601 format), specifying the time to restore from.
	PointInTimeUTC *time.Time `json:"pointInTimeUTC,omitempty" azure:"ro"`
...
type RoleProperties struct {
	...
	// READ-ONLY; Provisioning state of the cluster role
	ProvisioningState *string `json:"provisioningState,omitempty" azure:"ro"`
}
...
type ServerConfigurationRequest struct {
	// REQUIRED; The properties of a configuration.
	Properties *ServerConfigurationRequestProperties `json:"properties,omitempty"`
}

// ServerConfigurationRequestProperties - The properties of a server configuration request.
