...
func (h *HardwareComponentGroupsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if hardwareComponentGroupsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = hardwareComponentGroupsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			case "HardwareComponentGroupsClient.BeginChangeControllerPowerState":
				res.resp, res.err = h.dispatchBeginChangeControllerPowerState(req)
			case "HardwareComponentGroupsClient.NewListByDevicePager":
				res.resp, res.err = h.dispatchNewListByDevicePager(req)
			default:
...
// set this to conditionally intercept incoming requests to HardwareComponentGroupsServerTransport
var hardwareComponentGroupsServerTransportInterceptor interface {
