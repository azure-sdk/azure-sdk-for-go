...
type AvailabilitySet struct {
	...
	// READ-ONLY; Name of the AvailabilitySet.
	Name *string
...
type CloudInventoryItem struct {
	// CONSTANT; They inventory type.
	// Field has constant value InventoryTypeCloud, any specified value is ignored.
...
type GuestAgent struct {
	...
	// READ-ONLY; Name of the guest agent.
	Name *string
...
type InventoryItem struct {
	...
	// READ-ONLY; Name of the inventoryItem.
	Name *string
...
type VMInstanceHybridIdentityMetadata struct {
	...
	// READ-ONLY; Name of the VM Instance Hybrid Identity Metadata
	Name *string
...
type VirtualMachineInstance struct {
	...
	// READ-ONLY; Name of the virtual machine instance.
	Name *string
...
type VirtualMachineInventoryItem struct {
	// CONSTANT; They inventory type.
	// Field has constant value InventoryTypeVirtualMachine, any specified value is ignored.
	InventoryType *InventoryType
...
type VirtualMachineTemplate struct {
	...
	// READ-ONLY; Name of the VirtualMachineTemplate.
	Name *string
...
type VirtualMachineTemplateInventoryItem struct {
	// CONSTANT; They inventory type.
	// Field has constant value InventoryTypeVirtualMachineTemplate, any specified value is ignored.
	InventoryType *InventoryType
...
type VirtualNetwork struct {
	...
	// READ-ONLY; Name of the VirtualNetwork.
	Name *string
...
type VirtualNetworkInventoryItem struct {
	// CONSTANT; They inventory type.
	// Field has constant value InventoryTypeVirtualNetwork, any specified value is ignored.
	InventoryType *InventoryType
...
type VmmServer struct {
	...
	// READ-ONLY; Name of the VmmServer.
	Name *string
