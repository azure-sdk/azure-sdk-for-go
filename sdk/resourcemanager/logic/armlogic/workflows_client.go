...
func (client *WorkflowsClient) Update(ctx context.Context, resourceGroupName string, workflowName string, properties AzureResourceManagerFoundationsArmTagsProperty, options *WorkflowsClientUpdateOptions) (WorkflowsClientUpdateResponse, error) {
	var err error
...
func (client *WorkflowsClient) updateCreateRequest(ctx context.Context, resourceGroupName string, workflowName string, properties AzureResourceManagerFoundationsArmTagsProperty, _ *WorkflowsClientUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Logic/workflows/{workflowName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
