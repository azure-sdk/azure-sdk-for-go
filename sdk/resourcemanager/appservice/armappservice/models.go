...
// AseV3NetworkingConfiguration - Full view of networking configuration for an ASEv3.
type AseV3NetworkingConfiguration struct {
	...
	// READ-ONLY; Resource id for the networking configuration of an ASEv3.
	ID *string

	// READ-ONLY; Resource name for the networking configuration of an ASEv3
	Name *string

	// READ-ONLY; Resource type for the networking configuration of an ASEv3.
	Type *string
}

// AseV3NetworkingConfigurationProperties - Properties of an ASEv3 networking configuration.
...
// AseV3NetworkingConfigurationResource - ASEv3 networking configuration ARM resource.
type AseV3NetworkingConfigurationResource struct {
	// Kind of resource.
	Kind *string
...
// CustomDNSSuffixConfiguration - Full view of the custom domain suffix configuration for ASE.
type CustomDNSSuffixConfiguration struct {
	...
	// READ-ONLY; Resource id for the custom DNS suffix configuration for an ASE.
	ID *string

	// READ-ONLY; Resource name for the custom DNS suffix configuration for an ASE
	Name *string

	// READ-ONLY; Resource type for the custom DNS suffix configuration for an ASE.
	Type *string
}

// CustomDNSSuffixConfigurationProperties - Properties of an ASE custom domain suffix configuration.
...
// CustomDNSSuffixConfigurationResource - ASE Custom DNS Suffix Configuration ARM resource.
type CustomDNSSuffixConfigurationResource struct {
	// Kind of resource.
	Kind *string
