...
- New field `ManagedNetwork`, `ServerlessComputeCustomSubnet`, `ServerlessComputeNoPublicIP` in struct `WorkspaceProperties`
- New field `ServerlessComputeCustomSubnet`, `ServerlessComputeNoPublicIP` in struct `WorkspacePropertiesUpdateParameters`
