...
func ExampleScriptExecutionsClient_BeginCreateOrUpdate() {
	...
	poller, err := clientFactory.NewScriptExecutionsClient().BeginCreateOrUpdate(ctx, "group1", "cloud1", "addSsoServer", nil)
	if err != nil {
...
func ExampleScriptExecutionsClient_GetExecutionLogs() {
	...
	res, err := clientFactory.NewScriptExecutionsClient().GetExecutionLogs(ctx, "group1", "cloud1", "addSsoServer", &ScriptExecutionsClientGetExecutionLogsOptions{
