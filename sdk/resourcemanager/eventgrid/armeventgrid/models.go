...
type WebhookAuthenticationSettings struct {
	// REQUIRED; Azure Active Directory Application ID or URI to get the access token that will be included as the bearer token
	// in delivery requests.
	AzureActiveDirectoryApplicationIDOrURI *string

	// REQUIRED; Azure Active Directory Tenant ID to get the access token that will be included as the bearer token in delivery
	// requests.
	AzureActiveDirectoryTenantID *string
