...
```sh
go get github.com/Azure/azure-sdk-for-go/sdk/resourcemanager/hybridcompute/armhybridcompute/v3
```
...
[open an issue](https://github.com/Azure/azure-sdk-for-go/issues) and assign the `Hybrid Compute` label.
