...
func (b *BrokerAuthorizationServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if brokerAuthorizationServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = brokerAuthorizationServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
func (b *BrokerAuthorizationServerTransport) dispatchBeginCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginCreateOrUpdate == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armiotoperations.AuthorizationResource](req)
		if err != nil {
			return nil, err
		}
...
func (b *BrokerAuthorizationServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	resp, err := server.MarshalResponseAsJSON(respContent, server.GetResponse(respr).AuthorizationResource, req)
	if err != nil {
		return nil, err
	}
	return resp, nil
...
// set this to conditionally intercept incoming requests to BrokerAuthorizationServerTransport
var brokerAuthorizationServerTransportInterceptor interface {
