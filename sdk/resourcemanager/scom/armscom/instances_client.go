...
// BeginCreateOrUpdate - Create or update SCOM monitoring instance
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2022-09-13-preview
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - instanceName - Name of the SCOM monitoring instance
//   - monitoringInstance - SCOM Monitoring Instance
...
//     method.
func (client *InstancesClient) BeginCreateOrUpdate(ctx context.Context, resourceGroupName string, instanceName string, monitoringInstance MonitoringInstance, options *InstancesClientBeginCreateOrUpdateOptions) (*runtime.Poller[InstancesClientCreateOrUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.createOrUpdate(ctx, resourceGroupName, instanceName, monitoringInstance, options)
		if err != nil {
			return nil, err
		}
		...
		return runtime.NewPollerFromResumeToken[InstancesClientCreateOrUpdateResponse](options.ResumeToken, client.internal.Pipeline(), nil)
	}
}

// CreateOrUpdate - Create or update SCOM monitoring instance
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2022-09-13-preview
func (client *InstancesClient) createOrUpdate(ctx context.Context, resourceGroupName string, instanceName string, monitoringInstance MonitoringInstance, options *InstancesClientBeginCreateOrUpdateOptions) (*http.Response, error) {
	var err error
	req, err := client.createOrUpdateCreateRequest(ctx, resourceGroupName, instanceName, monitoringInstance, options)
	if err != nil {
		return nil, err
	}
...
func (client *InstancesClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, instanceName string, monitoringInstance MonitoringInstance, options *InstancesClientBeginCreateOrUpdateOptions) (*policy.Request, error) {
	...
	reqQP.Set("api-version", "2022-09-13-preview")
	...
	if err := runtime.MarshalAsJSON(req, monitoringInstance); err != nil {
		return nil, err
	}
	return req, nil
}

// BeginDelete - Delete a SCOM monitoring instance
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2022-09-13-preview
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
...
// Delete - Delete a SCOM monitoring instance
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2022-09-13-preview
...
// Get - Get SCOM monitoring instance details
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2022-09-13-preview
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
...
func (client *InstancesClient) getHandleResponse(resp *http.Response) (InstancesClientGetResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.MonitoringInstance); err != nil {
		return InstancesClientGetResponse{}, err
	}
	return result, nil
}

// NewListByResourceGroupPager - Lists all SCOM monitoring instances in a resource group
//
// Generated from API version 2022-09-13-preview
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
...
// NewListBySubscriptionPager - Lists all SCOM monitoring instances in a subscription
//
// Generated from API version 2022-09-13-preview
...
func (client *InstancesClient) BeginPatchServers(ctx context.Context, resourceGroupName string, instanceName string, options *InstancesClientBeginPatchServersOptions) (*runtime.Poller[InstancesClientPatchServersResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return runtime.NewPollerFromResumeToken[InstancesClientPatchServersResponse](options.ResumeToken, client.internal.Pipeline(), nil)
	}
}
...
// BeginScale - Scaling SCOM monitoring instance
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2022-09-13-preview
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
...
func (client *InstancesClient) BeginScale(ctx context.Context, resourceGroupName string, instanceName string, body ScalingProperties, options *InstancesClientBeginScaleOptions) (*runtime.Poller[InstancesClientScaleResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return runtime.NewPollerFromResumeToken[InstancesClientScaleResponse](options.ResumeToken, client.internal.Pipeline(), nil)
	}
}

// Scale - Scaling SCOM monitoring instance
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2022-09-13-preview
...
// BeginUpdate - Patch SCOM monitoring instance
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2022-09-13-preview
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - instanceName - Name of the SCOM monitoring instance
//   - monitoringInstance - SCOM monitoring instance properties update
//   - options - InstancesClientBeginUpdateOptions contains the optional parameters for the InstancesClient.BeginUpdate method.
func (client *InstancesClient) BeginUpdate(ctx context.Context, resourceGroupName string, instanceName string, monitoringInstance MonitoringInstancePatch, options *InstancesClientBeginUpdateOptions) (*runtime.Poller[InstancesClientUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.update(ctx, resourceGroupName, instanceName, monitoringInstance, options)
		if err != nil {
			return nil, err
		}
		...
		return runtime.NewPollerFromResumeToken[InstancesClientUpdateResponse](options.ResumeToken, client.internal.Pipeline(), nil)
	}
}

// Update - Patch SCOM monitoring instance
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2022-09-13-preview
func (client *InstancesClient) update(ctx context.Context, resourceGroupName string, instanceName string, monitoringInstance MonitoringInstancePatch, options *InstancesClientBeginUpdateOptions) (*http.Response, error) {
	var err error
	req, err := client.updateCreateRequest(ctx, resourceGroupName, instanceName, monitoringInstance, options)
	if err != nil {
		return nil, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
...
func (client *InstancesClient) updateCreateRequest(ctx context.Context, resourceGroupName string, instanceName string, monitoringInstance MonitoringInstancePatch, options *InstancesClientBeginUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Scom/managedInstances/{instanceName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
