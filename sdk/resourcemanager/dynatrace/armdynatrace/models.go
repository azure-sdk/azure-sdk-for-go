...
// AgentStatus - Details of resource that has Dynatrace agent installed through the Azure Dynatrace resource.
...
// AgentStatusRequest - Request for updating resources given in list according to action.
