...
//     method.
func (client *DnssecConfigsClient) BeginCreateOrUpdate(ctx context.Context, resourceGroupName string, zoneName string, resource DnssecConfig, options *DnssecConfigsClientBeginCreateOrUpdateOptions) (*runtime.Poller[DnssecConfigsClientCreateOrUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.createOrUpdate(ctx, resourceGroupName, zoneName, resource, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2023-07-01-preview
func (client *DnssecConfigsClient) createOrUpdate(ctx context.Context, resourceGroupName string, zoneName string, resource DnssecConfig, options *DnssecConfigsClientBeginCreateOrUpdateOptions) (*http.Response, error) {
	var err error
	const operationName = "DnssecConfigsClient.BeginCreateOrUpdate"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.createOrUpdateCreateRequest(ctx, resourceGroupName, zoneName, resource, options)
	if err != nil {
		return nil, err
	}
...
func (client *DnssecConfigsClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, zoneName string, resource DnssecConfig, options *DnssecConfigsClientBeginCreateOrUpdateOptions) (*policy.Request, error) {
