...
// ReasonForKeyVault - The reason that a vault name could not be used. The Reason element is only returned if NameAvailable
// is false.
type ReasonForKeyVault string

const (
	ReasonForKeyVaultAccountNameInvalid ReasonForKeyVault = "AccountNameInvalid"
	ReasonForKeyVaultAlreadyExists      ReasonForKeyVault = "AlreadyExists"
)

// PossibleReasonForKeyVaultValues returns the possible values for the ReasonForKeyVault const type.
func PossibleReasonForKeyVaultValues() []ReasonForKeyVault {
	return []ReasonForKeyVault{
		ReasonForKeyVaultAccountNameInvalid,
		ReasonForKeyVaultAlreadyExists,
	}
}

// ReasonForManagedHsm - The reason that a managed hsm name could not be used. The reason element is only returned if NameAvailable
// is false.
...
// PossibleReasonForManagedHsmValues returns the possible values for the ReasonForManagedHsm const type.
func PossibleReasonForManagedHsmValues() []ReasonForManagedHsm {
	return []ReasonForManagedHsm{
