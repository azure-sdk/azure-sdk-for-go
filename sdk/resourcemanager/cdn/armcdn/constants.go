...
// BackendProtocol - Backend protocol used to establish connection with customer's backend.
...
// ClientIPPreservationState - Preserves the client side source IP allowing the back-end to see the IP address of the client.
// This can then be used by applications for applying any rules. Valid options are 'Enabled' or 'Disabled'
type ClientIPPreservationState string

const (
	ClientIPPreservationStateDisabled ClientIPPreservationState = "Disabled"
	ClientIPPreservationStateEnabled  ClientIPPreservationState = "Enabled"
)

// PossibleClientIPPreservationStateValues returns the possible values for the ClientIPPreservationState const type.
func PossibleClientIPPreservationStateValues() []ClientIPPreservationState {
	return []ClientIPPreservationState{
		ClientIPPreservationStateDisabled,
		ClientIPPreservationStateEnabled,
	}
}
...
// FrontendProtocol - Frontend protocol for TCP/UDP routes.
type FrontendProtocol string

const (
	FrontendProtocolTCP FrontendProtocol = "TCP"
	FrontendProtocolUDP FrontendProtocol = "UDP"
)

// PossibleFrontendProtocolValues returns the possible values for the FrontendProtocol const type.
func PossibleFrontendProtocolValues() []FrontendProtocol {
...
const (
	...
	ProbeProtocolUDP    ProbeProtocol = "UDP"
)
...
// RouteType - The type of L7 or L4 route to use for this origin group. Valid options are 'L7Route' or 'L4Route'. This will
// help validate L4 origin groups with L4 routes
type RouteType string

const (
	RouteTypeL4Route RouteType = "L4Route"
	RouteTypeL7Route RouteType = "L7Route"
)
...
// RoutingMethod - Routing method for TCP/UDP routes based on SNI or Ports division, if it is SNI based then the we can read
// SNI header to get the origin name or if its based on the ports then we can have port division
...
const (
	RoutingMethodPortBased RoutingMethod = "PortBased"
	RoutingMethodSNIBased  RoutingMethod = "SNIBased"
)
...
func PossibleRoutingMethodValues() []RoutingMethod {
	return []RoutingMethod{
		RoutingMethodPortBased,
		RoutingMethodSNIBased,
	}
}
...
// SessionAffinityType - The type of L4 session affinity to use for this origin group. Valid options are 'SourceIP' or 'None'
type SessionAffinityType string

const (
	SessionAffinityTypeNone     SessionAffinityType = "None"
	SessionAffinityTypeSourceIP SessionAffinityType = "SourceIP"
)

// PossibleSessionAffinityTypeValues returns the possible values for the SessionAffinityType const type.
func PossibleSessionAffinityTypeValues() []SessionAffinityType {
	return []SessionAffinityType{
		SessionAffinityTypeNone,
		SessionAffinityTypeSourceIP,
	}
}
