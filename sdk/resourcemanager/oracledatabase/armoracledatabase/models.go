...
type AutonomousDatabaseBaseProperties struct {
	...
	// READ-ONLY; The list of Azure IDs of standby databases located in Autonomous Data Guard remote regions that are associated
	// with the source database. Note that for Autonomous Database Serverless instances, standby
	// databases located in the same region as the source primary database do not have Azure IDs.
	PeerDbIDs []*string
