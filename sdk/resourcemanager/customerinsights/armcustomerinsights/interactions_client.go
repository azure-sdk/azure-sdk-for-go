...
func (client *InteractionsClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, hubName string, interactionName string, parameters InteractionResourceFormat, _ *InteractionsClientBeginCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *InteractionsClient) suggestRelationshipLinksCreateRequest(ctx context.Context, resourceGroupName string, hubName string, interactionName string, _ *InteractionsClientSuggestRelationshipLinksOptions) (*policy.Request, error) {
