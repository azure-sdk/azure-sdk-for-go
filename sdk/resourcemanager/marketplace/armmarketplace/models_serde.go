...
// MarshalJSON implements the json.Marshaller interface for type GetCollectionOffersWithContextsPlansDetails.
func (g GetCollectionOffersWithContextsPlansDetails) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "offerIds", g.OfferIDs)
	populate(objectMap, "subscriptionIds", g.SubscriptionIDs)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type GetCollectionOffersWithContextsPlansDetails.
func (g *GetCollectionOffersWithContextsPlansDetails) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "offerIds":
			err = unpopulate(val, "OfferIDs", &g.OfferIDs)
			delete(rawMsg, key)
		case "subscriptionIds":
			err = unpopulate(val, "SubscriptionIDs", &g.SubscriptionIDs)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", g, err)
...
// MarshalJSON implements the json.Marshaller interface for type GetCollectionOffersWithContextsPlansProperties.
func (g GetCollectionOffersWithContextsPlansProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "properties", g.Properties)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type GetCollectionOffersWithContextsPlansProperties.
func (g *GetCollectionOffersWithContextsPlansProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", g, err)
	}
