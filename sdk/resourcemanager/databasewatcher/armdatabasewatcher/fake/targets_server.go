...
type TargetsServer struct {
	...
	// NewListByParentPager is the fake for method TargetsClient.NewListByParentPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByParentPager func(resourceGroupName string, watcherName string, options *armdatabasewatcher.TargetsClientListByParentOptions) (resp azfake.PagerResponder[armdatabasewatcher.TargetsClientListByParentResponse])
}
...
func NewTargetsServerTransport(srv *TargetsServer) *TargetsServerTransport {
	return &TargetsServerTransport{
		srv:                  srv,
		newListByParentPager: newTracker[azfake.PagerResponder[armdatabasewatcher.TargetsClientListByParentResponse]](),
	}
}
...
type TargetsServerTransport struct {
	srv                  *TargetsServer
	newListByParentPager *tracker[azfake.PagerResponder[armdatabasewatcher.TargetsClientListByParentResponse]]
}
...
func (t *TargetsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	case "TargetsClient.NewListByParentPager":
		resp, err = t.dispatchNewListByParentPager(req)
	default:
...
func (t *TargetsServerTransport) dispatchNewListByParentPager(req *http.Request) (*http.Response, error) {
	if t.srv.NewListByParentPager == nil {
		return nil, &nonRetriableError{errors.New("fake for method NewListByParentPager not implemented")}
	}
	newListByParentPager := t.newListByParentPager.get(req)
	if newListByParentPager == nil {
		...
		resp := t.srv.NewListByParentPager(resourceGroupNameParam, watcherNameParam, nil)
		newListByParentPager = &resp
		t.newListByParentPager.add(req, newListByParentPager)
		server.PagerResponderInjectNextLinks(newListByParentPager, req, func(page *armdatabasewatcher.TargetsClientListByParentResponse, createLink func() string) {
	...
	if !contains([]int{http.StatusOK}, resp.StatusCode) {
		t.newListByParentPager.remove(req)
