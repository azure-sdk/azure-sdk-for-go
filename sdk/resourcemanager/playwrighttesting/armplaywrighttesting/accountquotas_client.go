...
func (client *AccountQuotasClient) getCreateRequest(ctx context.Context, resourceGroupName string, accountName string, quotaName QuotaNames, _ *AccountQuotasClientGetOptions) (*policy.Request, error) {
...
func (client *AccountQuotasClient) listByAccountCreateRequest(ctx context.Context, resourceGroupName string, accountName string, _ *AccountQuotasClientListByAccountOptions) (*policy.Request, error) {
