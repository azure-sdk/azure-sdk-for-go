...
func (p *PrometheusRuleGroupsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if prometheusRuleGroupsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = prometheusRuleGroupsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to PrometheusRuleGroupsServerTransport
var prometheusRuleGroupsServerTransportInterceptor interface {
