...
// AllocationRequestBase - The new quota limit requested.
...
type AllocationRequestBaseProperties struct {
	...
	// ResourceProviderScope for the quota request. Format: /providers/{ResourceProviderName}/locations/{Azure region} Example:
	// /providers/{Microsoft.Compute}/locations/{eastus}. Please replace the
	// ResourceProviderName, Azure region as per the requested resource.
...
// AllocationRequestStatus - The new quota limit request status.
...
type GroupQuotaDetails struct {
	...
	// READ-ONLY; Allocated Group Quota to subscriptions.
	AllocatedToSubscriptions []*AllocatedToSubscription
