...
- Struct `FileShareItems` has been removed
- Struct `ListContainerItems` has been removed
...
- Field `ListContainerItems` of struct `BlobContainersClientListResponse` has been removed
...
- Field `FileShareItems` of struct `FileSharesClientListResponse` has been removed
...
- New struct `BlobContainerListResult`
- New struct `FileShareListResult`
...
- New anonymous field `BlobContainerListResult` in struct `BlobContainersClientListResponse`
...
- New anonymous field `FileShareListResult` in struct `FileSharesClientListResponse`
