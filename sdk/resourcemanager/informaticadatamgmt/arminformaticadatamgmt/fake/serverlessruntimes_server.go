...
func (s *ServerlessRuntimesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if serverlessRuntimesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = serverlessRuntimesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			case "ServerlessRuntimesClient.CheckDependencies":
				res.resp, res.err = s.dispatchCheckDependencies(req)
			...
			case "ServerlessRuntimesClient.NewListByInformaticaOrganizationResourcePager":
				res.resp, res.err = s.dispatchNewListByInformaticaOrganizationResourcePager(req)
			case "ServerlessRuntimesClient.ServerlessResourceByID":
				res.resp, res.err = s.dispatchServerlessResourceByID(req)
			case "ServerlessRuntimesClient.StartFailedServerlessRuntime":
				res.resp, res.err = s.dispatchStartFailedServerlessRuntime(req)
...
// set this to conditionally intercept incoming requests to ServerlessRuntimesServerTransport
var serverlessRuntimesServerTransportInterceptor interface {
