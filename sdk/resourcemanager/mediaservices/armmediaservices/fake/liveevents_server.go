...
func (l *LiveEventsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if liveEventsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = liveEventsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			case "LiveEventsClient.BeginAllocate":
				res.resp, res.err = l.dispatchBeginAllocate(req)
			...
			case "LiveEventsClient.BeginListGetStatus":
				res.resp, res.err = l.dispatchBeginListGetStatus(req)
			case "LiveEventsClient.BeginListGetStreamEvents":
				res.resp, res.err = l.dispatchBeginListGetStreamEvents(req)
			case "LiveEventsClient.BeginListGetTrackIngestHeartbeats":
				res.resp, res.err = l.dispatchBeginListGetTrackIngestHeartbeats(req)
			case "LiveEventsClient.OperationLocation":
				res.resp, res.err = l.dispatchOperationLocation(req)
			case "LiveEventsClient.BeginReset":
				res.resp, res.err = l.dispatchBeginReset(req)
			case "LiveEventsClient.BeginStart":
				res.resp, res.err = l.dispatchBeginStart(req)
			case "LiveEventsClient.BeginStop":
				res.resp, res.err = l.dispatchBeginStop(req)
...
// set this to conditionally intercept incoming requests to LiveEventsServerTransport
var liveEventsServerTransportInterceptor interface {
