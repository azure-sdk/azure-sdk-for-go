...
// DeletedServer - An Azure SQL server that has been deleted and can be restored.
...
type DeletedServerProperties struct {
	...
	// READ-ONLY; The fully qualified domain name of the server before deletion.
	FullyQualifiedDomainName *string

	// READ-ONLY; The original ID of the server before deletion.
	OriginalID *string

	// READ-ONLY; Time at which the server data will be purged, after which server restore will no longer be possible. If this
	// is null, then default behavior will be used.
