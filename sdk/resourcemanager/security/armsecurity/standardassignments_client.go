...
func NewStandardAssignmentsClient(credential azcore.TokenCredential, options *arm.ClientOptions) (*StandardAssignmentsClient, error) {
	cl, err := arm.NewClient(moduleName+".StandardAssignmentsClient", moduleVersion, credential, options)
	if err != nil {
		return nil, err
	}
...
func (client *StandardAssignmentsClient) Create(ctx context.Context, resourceID string, standardAssignmentName string, standardAssignment StandardAssignment, options *StandardAssignmentsClientCreateOptions) (StandardAssignmentsClientCreateResponse, error) {
	...
	if !runtime.HasStatusCode(resp, http.StatusOK, http.StatusCreated) {
		return StandardAssignmentsClientCreateResponse{}, runtime.NewResponseError(resp)
	}
	return client.createHandleResponse(resp)
}

// createCreateRequest creates the Create request.
func (client *StandardAssignmentsClient) createCreateRequest(ctx context.Context, resourceID string, standardAssignmentName string, standardAssignment StandardAssignment, options *StandardAssignmentsClientCreateOptions) (*policy.Request, error) {
	...
	return req, runtime.MarshalAsJSON(req, standardAssignment)
}
...
func (client *StandardAssignmentsClient) Delete(ctx context.Context, resourceID string, standardAssignmentName string, options *StandardAssignmentsClientDeleteOptions) (StandardAssignmentsClientDeleteResponse, error) {
	...
	if !runtime.HasStatusCode(resp, http.StatusOK, http.StatusNoContent) {
		return StandardAssignmentsClientDeleteResponse{}, runtime.NewResponseError(resp)
	}
	return StandardAssignmentsClientDeleteResponse{}, nil
}

// deleteCreateRequest creates the Delete request.
func (client *StandardAssignmentsClient) deleteCreateRequest(ctx context.Context, resourceID string, standardAssignmentName string, options *StandardAssignmentsClientDeleteOptions) (*policy.Request, error) {
	urlPath := "/{resourceId}/providers/Microsoft.Security/standardAssignments/{standardAssignmentName}"
	urlPath = strings.ReplaceAll(urlPath, "{resourceId}", resourceID)
	if standardAssignmentName == "" {
		return nil, errors.New("parameter standardAssignmentName cannot be empty")
...
func (client *StandardAssignmentsClient) Get(ctx context.Context, standardAssignmentName string, resourceID string, options *StandardAssignmentsClientGetOptions) (StandardAssignmentsClientGetResponse, error) {
	req, err := client.getCreateRequest(ctx, standardAssignmentName, resourceID, options)
	if err != nil {
	...
	if !runtime.HasStatusCode(resp, http.StatusOK) {
		return StandardAssignmentsClientGetResponse{}, runtime.NewResponseError(resp)
	}
	return client.getHandleResponse(resp)
}

// getCreateRequest creates the Get request.
func (client *StandardAssignmentsClient) getCreateRequest(ctx context.Context, standardAssignmentName string, resourceID string, options *StandardAssignmentsClientGetOptions) (*policy.Request, error) {
	urlPath := "/{resourceId}/providers/Microsoft.Security/standardAssignments/{standardAssignmentName}"
	if standardAssignmentName == "" {
		return nil, errors.New("parameter standardAssignmentName cannot be empty")
	}
...
func (client *StandardAssignmentsClient) NewListPager(scope string, options *StandardAssignmentsClientListOptions) *runtime.Pager[StandardAssignmentsClientListResponse] {
	return runtime.NewPager(runtime.PagingHandler[StandardAssignmentsClientListResponse]{
		...
		Fetcher: func(ctx context.Context, page *StandardAssignmentsClientListResponse) (StandardAssignmentsClientListResponse, error) {
			...
			if !runtime.HasStatusCode(resp, http.StatusOK) {
				return StandardAssignmentsClientListResponse{}, runtime.NewResponseError(resp)
			}
...
func (client *StandardAssignmentsClient) listCreateRequest(ctx context.Context, scope string, options *StandardAssignmentsClientListOptions) (*policy.Request, error) {
