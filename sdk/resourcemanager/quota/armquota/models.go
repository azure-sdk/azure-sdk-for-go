...
// AdditionalAttributes - Additional attribute to allow subscriptions to be part of the GroupQuota.
type AdditionalAttributes struct {
	// REQUIRED; The grouping Id for the group quota. It can be management Group Id or ServiceTreeId if applicable.
	GroupID *GroupingID
...
// AssignedToSubscription - SubscriptionIds and quota allocated to subscriptions from the GroupQuota.
type AssignedToSubscription struct {
...
type GroupQuotaDetails struct {
	...
	// READ-ONLY; Assigned Group Quota to subscriptions.
	AssignedToSubscriptions []*AssignedToSubscription

	// READ-ONLY; The available Group Quota Limit at the MG level. This Group quota can be assigned to subscription(s).
...
// GroupingID - The grouping Id for the group quota. It can be management Group Id or ServiceTreeId if applicable.
type GroupingID struct {
	// GroupingId type. It is a required property. More types of groupIds can be supported in future. MGID is already in the URI,
	// so it's not needed.'
...
// SubscriptionGroupQuotaAssignment - MGId the source of groupQuota.
...
// SubscriptionQuotaAllocationRequest - The new quota limit for the subscription.
type SubscriptionQuotaAllocationRequest struct {
...
type SubscriptionQuotaAllocationRequestProperties struct {
...
// SubscriptionQuotaAllocations - Quota assigned to a subscription for the specific Resource Provider, Location, ResourceName.
...
type SubscriptionQuotaDetails struct {
	...
	// READ-ONLY; The total quota limit for the subscription.
	Limit *int64

	// READ-ONLY; The non shareable quota for the subscription.
	NonShareableQuota *int64
