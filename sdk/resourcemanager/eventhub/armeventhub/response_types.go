...
// UpgradeWindowClientGetResponse contains the response from method UpgradeWindowClient.Get.
type UpgradeWindowClientGetResponse struct {
	// Contains all settings for the cluster upgrade window.
	ClusterUpgradeWindow
}

// UpgradeWindowClientPatchResponse contains the response from method UpgradeWindowClient.Patch.
type UpgradeWindowClientPatchResponse struct {
	// Contains all settings for the cluster upgrade window.
	ClusterUpgradeWindow
}

// UpgradeWindowHistoryClientGetResponse contains the response from method UpgradeWindowHistoryClient.NewGetPager.
type UpgradeWindowHistoryClientGetResponse struct {
	// The response of the List Cluster Upgrade History operation
	ClusterUpgradeHistoryList
}

// UpgradeWindowTriggerClientPostResponse contains the response from method UpgradeWindowTriggerClient.Post.
type UpgradeWindowTriggerClientPostResponse struct {
	// placeholder for future response values
}
