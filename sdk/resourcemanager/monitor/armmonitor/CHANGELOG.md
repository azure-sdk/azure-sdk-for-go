...
- Function `*TenantActionGroupsClient.Update` parameter(s) have been changed from `(context.Context, string, string, string, ActionGroupPatchBodyAutoGenerated, *TenantActionGroupsClientUpdateOptions)` to `(context.Context, string, string, string, ActionGroupPatchBody, *TenantActionGroupsClientUpdateOptions)`
- Type of `TenantActionGroup.AzureAppPushReceivers` has been changed from `[]*AzureAppPushReceiverAutoGenerated` to `[]*AzureAppPushReceiver`
- Type of `TenantActionGroup.EmailReceivers` has been changed from `[]*EmailReceiverAutoGenerated` to `[]*EmailReceiver`
- Type of `TenantActionGroup.SmsReceivers` has been changed from `[]*SmsReceiverAutoGenerated` to `[]*SmsReceiver`
- Type of `TenantActionGroup.VoiceReceivers` has been changed from `[]*VoiceReceiverAutoGenerated` to `[]*VoiceReceiver`
- Type of `TenantActionGroup.WebhookReceivers` has been changed from `[]*WebhookReceiverAutoGenerated` to `[]*WebhookReceiver`
...
- Type alias `KnownLocationSpecProvisioningStatus` has been removed
...
- Type alias `KnownPrometheusForwarderDataSourceStreams` has been removed
...
- Type alias `MetricAggregationType` has been removed
- Type alias `MetricClass` has been removed
- Type alias `MetricResultType` has been removed
...
- Type alias `Unit` has been removed
...
- Field `Detail` of struct `ActionDetail` has been removed
