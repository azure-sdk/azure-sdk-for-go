...
func (client *PrivateLinkResourcesForMIPPolicySyncClient) getCreateRequest(ctx context.Context, resourceGroupName string, resourceName string, groupName string, _ *PrivateLinkResourcesForMIPPolicySyncClientGetOptions) (*policy.Request, error) {
...
func (client *PrivateLinkResourcesForMIPPolicySyncClient) listByServiceCreateRequest(ctx context.Context, resourceGroupName string, resourceName string, _ *PrivateLinkResourcesForMIPPolicySyncClientListByServiceOptions) (*policy.Request, error) {
