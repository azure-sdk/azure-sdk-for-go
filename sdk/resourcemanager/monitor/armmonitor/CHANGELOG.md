...
- New field `PrivateEndpointConnections` in struct `AzureMonitorWorkspace`
- New field `PublicNetworkAccess` in struct `AzureMonitorWorkspace`
- New field `PrivateEndpointConnections` in struct `AzureMonitorWorkspaceResourceProperties`
- New field `PublicNetworkAccess` in struct `AzureMonitorWorkspaceResourceProperties`
- New field `Error` in struct `ErrorResponse`
- New field `Code` in struct `ErrorResponseAutoGenerated2`
- New field `Message` in struct `ErrorResponseAutoGenerated2`
