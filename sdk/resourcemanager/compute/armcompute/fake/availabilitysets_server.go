...
func (a *AvailabilitySetsServerTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "AvailabilitySetsClient.CancelMigrationToVirtualMachineScaleSet":
		resp, err = a.dispatchCancelMigrationToVirtualMachineScaleSet(req)
	case "AvailabilitySetsClient.BeginConvertToVirtualMachineScaleSet":
		resp, err = a.dispatchBeginConvertToVirtualMachineScaleSet(req)
	...
	case "AvailabilitySetsClient.StartMigrationToVirtualMachineScaleSet":
		resp, err = a.dispatchStartMigrationToVirtualMachineScaleSet(req)
	...
	case "AvailabilitySetsClient.ValidateMigrationToVirtualMachineScaleSet":
		resp, err = a.dispatchValidateMigrationToVirtualMachineScaleSet(req)
	default:
