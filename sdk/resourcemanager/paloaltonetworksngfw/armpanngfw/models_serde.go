...
func (c Changelog) MarshalJSON() ([]byte, error) {
	...
	populateTimeRFC3339(objectMap, "lastCommitted", c.LastCommitted)
...
func (c *Changelog) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "changes":
			...
			delete(rawMsg, key)
		case "lastCommitted":
			err = unpopulateTimeRFC3339(val, "LastCommitted", &c.LastCommitted)
			delete(rawMsg, key)
		case "lastModified":
...
func (r RuleCounter) MarshalJSON() ([]byte, error) {
	...
	populateTimeRFC3339(objectMap, "lastUpdatedTimestamp", r.LastUpdatedTimestamp)
	populate(objectMap, "priority", r.Priority)
	populateTimeRFC3339(objectMap, "requestTimestamp", r.RequestTimestamp)
...
func (r *RuleCounter) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "lastUpdatedTimestamp":
			err = unpopulateTimeRFC3339(val, "LastUpdatedTimestamp", &r.LastUpdatedTimestamp)
			delete(rawMsg, key)
		case "priority":
			err = unpopulate(val, "Priority", &r.Priority)
			delete(rawMsg, key)
		case "requestTimestamp":
			err = unpopulateTimeRFC3339(val, "RequestTimestamp", &r.RequestTimestamp)
			delete(rawMsg, key)
		case "ruleListName":
