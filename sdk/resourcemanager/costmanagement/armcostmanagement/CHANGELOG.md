...
- Type of `GenerateDetailedCostReportErrorResponse.Error` has been changed from `*ErrorDetails` to `*ErrorDetailsWithIntegerCode`
- Type of `GenerateDetailedCostReportOperationStatuses.Error` has been changed from `*ErrorDetails` to `*ErrorDetailsWithIntegerCode`
...
- New struct `ErrorDetailsWithIntegerCode`
