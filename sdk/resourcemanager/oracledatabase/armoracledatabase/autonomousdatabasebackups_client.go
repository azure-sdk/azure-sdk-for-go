...
// NewListByParentPager - List AutonomousDatabaseBackup resources by AutonomousDatabase
//
// Generated from API version 2025-03-01
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - autonomousdatabasename - The database name.
//   - options - AutonomousDatabaseBackupsClientListByParentOptions contains the optional parameters for the AutonomousDatabaseBackupsClient.NewListByParentPager
//     method.
func (client *AutonomousDatabaseBackupsClient) NewListByParentPager(resourceGroupName string, autonomousdatabasename string, options *AutonomousDatabaseBackupsClientListByParentOptions) *runtime.Pager[AutonomousDatabaseBackupsClientListByParentResponse] {
	return runtime.NewPager(runtime.PagingHandler[AutonomousDatabaseBackupsClientListByParentResponse]{
		More: func(page AutonomousDatabaseBackupsClientListByParentResponse) bool {
			return page.NextLink != nil && len(*page.NextLink) > 0
		},
		Fetcher: func(ctx context.Context, page *AutonomousDatabaseBackupsClientListByParentResponse) (AutonomousDatabaseBackupsClientListByParentResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "AutonomousDatabaseBackupsClient.NewListByParentPager")
			nextLink := ""
			if page != nil {
				nextLink = *page.NextLink
			}
			resp, err := runtime.FetcherForNextLink(ctx, client.internal.Pipeline(), nextLink, func(ctx context.Context) (*policy.Request, error) {
				return client.listByParentCreateRequest(ctx, resourceGroupName, autonomousdatabasename, options)
			}, nil)
			if err != nil {
				return AutonomousDatabaseBackupsClientListByParentResponse{}, err
			}
...
func (client *AutonomousDatabaseBackupsClient) listByParentCreateRequest(ctx context.Context, resourceGroupName string, autonomousdatabasename string, _ *AutonomousDatabaseBackupsClientListByParentOptions) (*policy.Request, error) {
...
func (client *AutonomousDatabaseBackupsClient) listByParentHandleResponse(resp *http.Response) (AutonomousDatabaseBackupsClientListByParentResponse, error) {
	result := AutonomousDatabaseBackupsClientListByParentResponse{}
...
//     method.
func (client *AutonomousDatabaseBackupsClient) BeginUpdate(ctx context.Context, resourceGroupName string, autonomousdatabasename string, adbbackupid string, properties AutonomousDatabaseBackup, options *AutonomousDatabaseBackupsClientBeginUpdateOptions) (*runtime.Poller[AutonomousDatabaseBackupsClientUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
...
//
// Generated from API version 2025-03-01
func (client *AutonomousDatabaseBackupsClient) update(ctx context.Context, resourceGroupName string, autonomousdatabasename string, adbbackupid string, properties AutonomousDatabaseBackup, options *AutonomousDatabaseBackupsClientBeginUpdateOptions) (*http.Response, error) {
	var err error
...
func (client *AutonomousDatabaseBackupsClient) updateCreateRequest(ctx context.Context, resourceGroupName string, autonomousdatabasename string, adbbackupid string, properties AutonomousDatabaseBackup, _ *AutonomousDatabaseBackupsClientBeginUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Oracle.Database/autonomousDatabases/{autonomousdatabasename}/autonomousDatabaseBackups/{adbbackupid}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
