...
// GiVersionsClient contains the methods for the Oracle.Database namespace.
...
func (client *GiVersionsClient) listByLocationCreateRequest(ctx context.Context, location string, _ *GiVersionsClientListByLocationOptions) (*policy.Request, error) {
