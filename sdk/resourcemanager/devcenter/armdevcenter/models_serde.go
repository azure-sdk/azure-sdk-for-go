...
// MarshalJSON implements the json.Marshaller interface for type CurationProfile.
func (c CurationProfile) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "id", c.ID)
	populate(objectMap, "name", c.Name)
	populate(objectMap, "properties", c.Properties)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type CurationProfile.
func (c *CurationProfile) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type CurationProfileListResult.
func (c CurationProfileListResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "nextLink", c.NextLink)
	populate(objectMap, "value", c.Value)
	return json.Marshal(objectMap)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type CurationProfileListResult.
func (c *CurationProfileListResult) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type CurationProfileProperties.
func (c CurationProfileProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "provisioningState", c.ProvisioningState)
	populate(objectMap, "resourcePolicies", c.ResourcePolicies)
	populate(objectMap, "scopes", c.Scopes)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type CurationProfileProperties.
func (c *CurationProfileProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
	for key, val := range rawMsg {
		...
		case "resourcePolicies":
			err = unpopulate(val, "ResourcePolicies", &c.ResourcePolicies)
			delete(rawMsg, key)
		case "scopes":
...
// MarshalJSON implements the json.Marshaller interface for type CurationProfileUpdate.
func (c CurationProfileUpdate) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "properties", c.Properties)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type CurationProfileUpdate.
func (c *CurationProfileUpdate) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type CurationProfileUpdateProperties.
func (c CurationProfileUpdateProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "resourcePolicies", c.ResourcePolicies)
	populate(objectMap, "scopes", c.Scopes)
	return json.Marshal(objectMap)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type CurationProfileUpdateProperties.
func (c *CurationProfileUpdateProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
...
func (p PlanMemberProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "syncStatus", p.SyncStatus)
...
func (p *PlanMemberProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "provisioningState":
			...
			delete(rawMsg, key)
		case "syncStatus":
			err = unpopulate(val, "SyncStatus", &p.SyncStatus)
			delete(rawMsg, key)
		case "tier":
...
// MarshalJSON implements the json.Marshaller interface for type PlanMemberSyncStatus.
func (p PlanMemberSyncStatus) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "lastSyncError", p.LastSyncError)
	populateDateTimeRFC3339(objectMap, "lastSyncTime", p.LastSyncTime)
	populate(objectMap, "syncState", p.SyncState)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type PlanMemberSyncStatus.
func (p *PlanMemberSyncStatus) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", p, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "lastSyncError":
			err = unpopulate(val, "LastSyncError", &p.LastSyncError)
			delete(rawMsg, key)
		case "lastSyncTime":
			err = unpopulateDateTimeRFC3339(val, "LastSyncTime", &p.LastSyncTime)
			delete(rawMsg, key)
		case "syncState":
			err = unpopulate(val, "SyncState", &p.SyncState)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", p, err)
...
// MarshalJSON implements the json.Marshaller interface for type PlanMemberUpdateProperties.
func (p PlanMemberUpdateProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "tier", p.Tier)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type PlanMemberUpdateProperties.
func (p *PlanMemberUpdateProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", p, err)
	}
...
func (p Properties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "provisioningState", p.ProvisioningState)
	populate(objectMap, "restrictedResourceTypes", p.RestrictedResourceTypes)
	return json.Marshal(objectMap)
}
...
func (p *Properties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "provisioningState":
			err = unpopulate(val, "ProvisioningState", &p.ProvisioningState)
			delete(rawMsg, key)
		case "restrictedResourceTypes":
			err = unpopulate(val, "RestrictedResourceTypes", &p.RestrictedResourceTypes)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", p, err)
...
func (u UpdateProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "restrictedResourceTypes", u.RestrictedResourceTypes)
	return json.Marshal(objectMap)
}
...
func (u *UpdateProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "projectCatalogSettings":
			...
			delete(rawMsg, key)
		case "restrictedResourceTypes":
			err = unpopulate(val, "RestrictedResourceTypes", &u.RestrictedResourceTypes)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", u, err)
