...
func (d DatabaseMigrationPropertiesSQLDb) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "provisioningState", d.ProvisioningState)
	populate(objectMap, "sqlDataCopyThresholds", d.SQLDataCopyThresholds)
	populate(objectMap, "scope", d.Scope)
	populate(objectMap, "sourceDatabaseName", d.SourceDatabaseName)
	populate(objectMap, "sourceSqlConnection", d.SourceSQLConnection)
...
func (d *DatabaseMigrationPropertiesSQLDb) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "provisioningState":
			err = unpopulate(val, "ProvisioningState", &d.ProvisioningState)
			delete(rawMsg, key)
		case "sqlDataCopyThresholds":
			err = unpopulate(val, "SQLDataCopyThresholds", &d.SQLDataCopyThresholds)
			delete(rawMsg, key)
		case "scope":
			err = unpopulate(val, "Scope", &d.Scope)
			delete(rawMsg, key)
...
// MarshalJSON implements the json.Marshaller interface for type DatabaseMigrationSQLMiListResult.
func (d DatabaseMigrationSQLMiListResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "nextLink", d.NextLink)
	populate(objectMap, "value", d.Value)
	return json.Marshal(objectMap)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type DatabaseMigrationSQLMiListResult.
func (d *DatabaseMigrationSQLMiListResult) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", d, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type DatabaseMigrationSQLVMListResult.
func (d DatabaseMigrationSQLVMListResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "nextLink", d.NextLink)
	populate(objectMap, "value", d.Value)
	return json.Marshal(objectMap)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type DatabaseMigrationSQLVMListResult.
func (d *DatabaseMigrationSQLVMListResult) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", d, err)
	}
...
func (k KeyVaultProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "fileSharePasswordSecretName", k.FileSharePasswordSecretName)
	populate(objectMap, "fileShareUsernameSecretName", k.FileShareUsernameSecretName)
	populate(objectMap, "name", k.Name)
	populate(objectMap, "sourcePasswordSecretName", k.SourcePasswordSecretName)
	populate(objectMap, "sourceUsernameSecretName", k.SourceUsernameSecretName)
	return json.Marshal(objectMap)
}
...
func (k *KeyVaultProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		var err error
		switch key {
		case "fileSharePasswordSecretName":
			err = unpopulate(val, "FileSharePasswordSecretName", &k.FileSharePasswordSecretName)
			delete(rawMsg, key)
		case "fileShareUsernameSecretName":
			err = unpopulate(val, "FileShareUsernameSecretName", &k.FileShareUsernameSecretName)
			delete(rawMsg, key)
		case "name":
			err = unpopulate(val, "Name", &k.Name)
			delete(rawMsg, key)
		case "sourcePasswordSecretName":
			err = unpopulate(val, "SourcePasswordSecretName", &k.SourcePasswordSecretName)
			delete(rawMsg, key)
		case "sourceUsernameSecretName":
			err = unpopulate(val, "SourceUsernameSecretName", &k.SourceUsernameSecretName)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", k, err)
...
// MarshalJSON implements the json.Marshaller interface for type SQLDataCopyThresholds.
func (s SQLDataCopyThresholds) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "cidxKbsThreshold", s.CidxKbsThreshold)
	populate(objectMap, "cidxRowThreshold", s.CidxRowThreshold)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type SQLDataCopyThresholds.
func (s *SQLDataCopyThresholds) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
	for key, val := range rawMsg {
		var err error
		switch key {
		case "cidxKbsThreshold":
			err = unpopulate(val, "CidxKbsThreshold", &s.CidxKbsThreshold)
			delete(rawMsg, key)
		case "cidxRowThreshold":
			err = unpopulate(val, "CidxRowThreshold", &s.CidxRowThreshold)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", s, err)
...
// MarshalJSON implements the json.Marshaller interface for type SQLDbBackupConfiguration.
func (s SQLDbBackupConfiguration) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "sourceLocation", s.SourceLocation)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type SQLDbBackupConfiguration.
func (s *SQLDbBackupConfiguration) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type SQLDbSourceBackupLocation.
func (s SQLDbSourceBackupLocation) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "fileStorageType", s.FileStorageType)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type SQLDbSourceBackupLocation.
func (s *SQLDbSourceBackupLocation) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type TestConnectivityData.
func (t TestConnectivityData) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
...
// UnmarshalJSON implements the json.Unmarshaller interface for type TestConnectivityData.
func (t *TestConnectivityData) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", t, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type ValidateIR.
func (v ValidateIR) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "backupConfiguration", v.BackupConfiguration)
	populate(objectMap, "errors", v.Errors)
	populate(objectMap, "kind", v.Kind)
	populate(objectMap, "sourceDatabaseName", v.SourceDatabaseName)
	populate(objectMap, "sourceSqlConnection", v.SourceSQLConnection)
	populate(objectMap, "succeeded", v.Succeeded)
	populate(objectMap, "targetDatabaseName", v.TargetDatabaseName)
	populate(objectMap, "targetSqlConnection", v.TargetSQLConnection)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ValidateIR.
func (v *ValidateIR) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "backupConfiguration":
			err = unpopulate(val, "BackupConfiguration", &v.BackupConfiguration)
			delete(rawMsg, key)
		case "errors":
		...
		case "kind":
			...
			delete(rawMsg, key)
		case "sourceDatabaseName":
			err = unpopulate(val, "SourceDatabaseName", &v.SourceDatabaseName)
			delete(rawMsg, key)
		case "sourceSqlConnection":
			err = unpopulate(val, "SourceSQLConnection", &v.SourceSQLConnection)
			delete(rawMsg, key)
		case "succeeded":
			err = unpopulate(val, "Succeeded", &v.Succeeded)
			delete(rawMsg, key)
		case "targetDatabaseName":
			err = unpopulate(val, "TargetDatabaseName", &v.TargetDatabaseName)
			delete(rawMsg, key)
		case "targetSqlConnection":
			err = unpopulate(val, "TargetSQLConnection", &v.TargetSQLConnection)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", v, err)
