...
func (client *ActionRequestsClient) Delete(ctx context.Context, resourceGroupName string, testBaseAccountName string, actionRequestName string, options *ActionRequestsClientDeleteOptions) (ActionRequestsClientDeleteResponse, error) {
	var err error
	const operationName = "ActionRequestsClient.Delete"
...
func (client *ActionRequestsClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, testBaseAccountName string, actionRequestName string, _ *ActionRequestsClientDeleteOptions) (*policy.Request, error) {
...
func (client *ActionRequestsClient) Get(ctx context.Context, resourceGroupName string, testBaseAccountName string, actionRequestName string, options *ActionRequestsClientGetOptions) (ActionRequestsClientGetResponse, error) {
	var err error
	const operationName = "ActionRequestsClient.Get"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
...
func (client *ActionRequestsClient) getCreateRequest(ctx context.Context, resourceGroupName string, testBaseAccountName string, actionRequestName string, _ *ActionRequestsClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.TestBase/testBaseAccounts/{testBaseAccountName}/actionRequests/{actionRequestName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *ActionRequestsClient) NewListPager(resourceGroupName string, testBaseAccountName string, options *ActionRequestsClientListOptions) *runtime.Pager[ActionRequestsClientListResponse] {
	return runtime.NewPager(runtime.PagingHandler[ActionRequestsClientListResponse]{
		...
		Fetcher: func(ctx context.Context, page *ActionRequestsClientListResponse) (ActionRequestsClientListResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "ActionRequestsClient.NewListPager")
			nextLink := ""
			if page != nil {
...
func (client *ActionRequestsClient) Put(ctx context.Context, resourceGroupName string, testBaseAccountName string, actionRequestName string, options *ActionRequestsClientPutOptions) (ActionRequestsClientPutResponse, error) {
	var err error
	const operationName = "ActionRequestsClient.Put"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
