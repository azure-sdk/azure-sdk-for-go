...
type ClusterResourceProperties struct {
	...
	// Which connection method Managed Cassandra should use to conenct to Azure resources it needs. 'None' is the deafukt which
	// means conenct directly, 'Vpn' will connect through a VPN endpoint for added
	...
	// If AzureConnectionMethod is VPN, the list of subscriptions that are automatically approved to connect to the private link
	// resource that is used establish a private link to the Azure services used by
	// the cluster
	...
	// READ-ONLY; If AzureConnectionMethod is VPN, the resource id of the private link resource that is used establish a private
...
type DataCenterResourceProperties struct {
	...
	// If AzureConnectionMethod is VPN, IP address of the private endpoint connected to the clusters private link to access Azure
	// Services.
