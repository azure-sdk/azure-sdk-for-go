...
func (client *RegistrationsClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroup string, registrationName string, tokenParam RegistrationParameter, _ *RegistrationsClientCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *RegistrationsClient) deleteCreateRequest(ctx context.Context, resourceGroup string, registrationName string, _ *RegistrationsClientDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroup}/providers/Microsoft.AzureStack/registrations/{registrationName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *RegistrationsClient) enableRemoteManagementCreateRequest(ctx context.Context, resourceGroup string, registrationName string, _ *RegistrationsClientEnableRemoteManagementOptions) (*policy.Request, error) {
...
func (client *RegistrationsClient) getCreateRequest(ctx context.Context, resourceGroup string, registrationName string, _ *RegistrationsClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroup}/providers/Microsoft.AzureStack/registrations/{registrationName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *RegistrationsClient) getActivationKeyCreateRequest(ctx context.Context, resourceGroup string, registrationName string, _ *RegistrationsClientGetActivationKeyOptions) (*policy.Request, error) {
...
func (client *RegistrationsClient) listCreateRequest(ctx context.Context, resourceGroup string, _ *RegistrationsClientListOptions) (*policy.Request, error) {
...
func (client *RegistrationsClient) listBySubscriptionCreateRequest(ctx context.Context, _ *RegistrationsClientListBySubscriptionOptions) (*policy.Request, error) {
...
func (client *RegistrationsClient) updateCreateRequest(ctx context.Context, resourceGroup string, registrationName string, tokenParam RegistrationParameter, _ *RegistrationsClientUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroup}/providers/Microsoft.AzureStack/registrations/{registrationName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
