...
type TrustedIPs struct {
	...
	Properties *TrustedIPsProperties
...
// TrustedIPsList - Page of a trusted IPs list
type TrustedIPsList struct {
	// READ-ONLY; The URI to fetch the next page
	NextLink *string

	// READ-ONLY; Collection of trusted IPs in this page
	Value []*TrustedIPs
}

// TrustedIPsMetadata - The trusted IPs metadata
type TrustedIPsMetadata struct {
	// READ-ONLY; The object id (GUID) of the entity that created the trusted IPs
	CreatedBy *string

	// READ-ONLY; Trusted IPs creation date
	CreatedOn *time.Time

	// READ-ONLY; The object id (GUID) of the entity that last updated the trusted IPs
	UpdatedBy *string

	// READ-ONLY; Trusted IPs last update date
	UpdatedOn *time.Time
}

// TrustedIPsProperties - Describes properties of a trusted IPs
type TrustedIPsProperties struct {
	// REQUIRED; Specifies the trusted IPs range in CIDR notation
	Cidr *string

	// REQUIRED; Display name of the trusted IPs
	DisplayName *string

	// The trusted IPs metadata
	Metadata *TrustedIPsMetadata

	// READ-ONLY; The scope from which the trusted IPs object was inherited; if not applicable, this will be null
	InheritedFrom *string
