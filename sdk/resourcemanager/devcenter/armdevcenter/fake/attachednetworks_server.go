...
func (a *AttachedNetworksServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if attachedNetworksServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = attachedNetworksServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "AttachedNetworksClient.GetByDevCenter":
				res.resp, res.err = a.dispatchGetByDevCenter(req)
			case "AttachedNetworksClient.GetByProject":
				res.resp, res.err = a.dispatchGetByProject(req)
			case "AttachedNetworksClient.NewListByDevCenterPager":
				res.resp, res.err = a.dispatchNewListByDevCenterPager(req)
			case "AttachedNetworksClient.NewListByProjectPager":
				res.resp, res.err = a.dispatchNewListByProjectPager(req)
			default:
...
// set this to conditionally intercept incoming requests to AttachedNetworksServerTransport
var attachedNetworksServerTransportInterceptor interface {
