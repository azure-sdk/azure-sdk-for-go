...
- New const `BenefitPlanKindReservation`
- New const `BenefitUtilizationSummaryKindSavingsPlan`
- New const `ScopeShared`
- New const `BenefitPlanKindSavingsPlan`
- New const `CostDetailsStatusTypeFailedCostDetailsStatusType`
- New const `BenefitUtilizationSummaryKindIncludedQuantity`
- New const `CostDetailsMetricTypeAmortizedCostCostDetailsMetricType`
- New const `ScopeSingle`
- New const `BenefitUtilizationSummaryKindReservation`
...
- New type alias `BenefitPlanKind`
- New type alias `BenefitUtilizationSummaryKind`
...
- New function `PossibleBenefitPlanKindValues() []BenefitPlanKind`
...
- New function `PossibleBenefitUtilizationSummaryKindValues() []BenefitUtilizationSummaryKind`
...
- New function `NewBenefitRecommendationClient(azcore.TokenCredential, *arm.ClientOptions) (*BenefitRecommendationClient, error)`
...
- New function `*BenefitRecommendationClient.Get(context.Context, string, string, *BenefitRecommendationClientGetOptions) (BenefitRecommendationClientGetResponse, error)`
...
- New struct `BenefitRecommendationClient`
- New struct `BenefitRecommendationClientGetOptions`
- New struct `BenefitRecommendationClientGetResponse`
...
- New struct `BenefitUtilizationResource`
...
- New field `Kind` in struct `Resource`
