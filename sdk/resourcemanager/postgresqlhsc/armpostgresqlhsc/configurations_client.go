...
// BeginCreateOrUpdateCoordinator - Updates configuration of coordinator in a cluster
...
//   - options - ConfigurationsClientBeginCreateOrUpdateCoordinatorOptions contains the optional parameters for the ConfigurationsClient.BeginCreateOrUpdateCoordinator
//     method.
func (client *ConfigurationsClient) BeginCreateOrUpdateCoordinator(ctx context.Context, resourceGroupName string, clusterName string, configurationName string, parameters ServerConfigurationRequest, options *ConfigurationsClientBeginCreateOrUpdateCoordinatorOptions) (*runtime.Poller[ConfigurationsClientCreateOrUpdateCoordinatorResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.createOrUpdateCoordinator(ctx, resourceGroupName, clusterName, configurationName, parameters, options)
		if err != nil {
			return nil, err
		}
		return runtime.NewPoller(resp, client.pl, &runtime.NewPollerOptions[ConfigurationsClientCreateOrUpdateCoordinatorResponse]{
			FinalStateVia: runtime.FinalStateViaAzureAsyncOp,
		})
	} else {
		return runtime.NewPollerFromResumeToken[ConfigurationsClientCreateOrUpdateCoordinatorResponse](options.ResumeToken, client.pl, nil)
	}
}

// CreateOrUpdateCoordinator - Updates configuration of coordinator in a cluster
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2022-11-08
func (client *ConfigurationsClient) createOrUpdateCoordinator(ctx context.Context, resourceGroupName string, clusterName string, configurationName string, parameters ServerConfigurationRequest, options *ConfigurationsClientBeginCreateOrUpdateCoordinatorOptions) (*http.Response, error) {
	req, err := client.createOrUpdateCoordinatorCreateRequest(ctx, resourceGroupName, clusterName, configurationName, parameters, options)
	if err != nil {
		return nil, err
	}
...
// createOrUpdateCoordinatorCreateRequest creates the CreateOrUpdateCoordinator request.
func (client *ConfigurationsClient) createOrUpdateCoordinatorCreateRequest(ctx context.Context, resourceGroupName string, clusterName string, configurationName string, parameters ServerConfigurationRequest, options *ConfigurationsClientBeginCreateOrUpdateCoordinatorOptions) (*policy.Request, error) {
...
// BeginCreateOrUpdateNode - Updates configuration of nodes in a cluster
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2022-11-08
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
...
//   - configurationName - The name of the cluster configuration.
//   - parameters - The required parameters for updating a cluster configuration.
//   - options - ConfigurationsClientBeginCreateOrUpdateNodeOptions contains the optional parameters for the ConfigurationsClient.BeginCreateOrUpdateNode
//     method.
func (client *ConfigurationsClient) BeginCreateOrUpdateNode(ctx context.Context, resourceGroupName string, clusterName string, configurationName string, parameters ServerConfigurationRequest, options *ConfigurationsClientBeginCreateOrUpdateNodeOptions) (*runtime.Poller[ConfigurationsClientCreateOrUpdateNodeResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.createOrUpdateNode(ctx, resourceGroupName, clusterName, configurationName, parameters, options)
		if err != nil {
			return nil, err
		}
		return runtime.NewPoller(resp, client.pl, &runtime.NewPollerOptions[ConfigurationsClientCreateOrUpdateNodeResponse]{
			FinalStateVia: runtime.FinalStateViaAzureAsyncOp,
		})
	} else {
		return runtime.NewPollerFromResumeToken[ConfigurationsClientCreateOrUpdateNodeResponse](options.ResumeToken, client.pl, nil)
	}
}

// CreateOrUpdateNode - Updates configuration of nodes in a cluster
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2022-11-08
func (client *ConfigurationsClient) createOrUpdateNode(ctx context.Context, resourceGroupName string, clusterName string, configurationName string, parameters ServerConfigurationRequest, options *ConfigurationsClientBeginCreateOrUpdateNodeOptions) (*http.Response, error) {
	req, err := client.createOrUpdateNodeCreateRequest(ctx, resourceGroupName, clusterName, configurationName, parameters, options)
	if err != nil {
		return nil, err
	}
	resp, err := client.pl.Do(req)
...
// createOrUpdateNodeCreateRequest creates the CreateOrUpdateNode request.
func (client *ConfigurationsClient) createOrUpdateNodeCreateRequest(ctx context.Context, resourceGroupName string, clusterName string, configurationName string, parameters ServerConfigurationRequest, options *ConfigurationsClientBeginCreateOrUpdateNodeOptions) (*policy.Request, error) {
...
// GetNode - Gets information of a configuration for node.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2022-11-08
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
