...
func (client *MachinesControllerClient) getCreateRequest(ctx context.Context, resourceGroupName string, siteName string, machineName string, _ *MachinesControllerClientGetOptions) (*policy.Request, error) {
...
func (client *MachinesControllerClient) startCreateRequest(ctx context.Context, resourceGroupName string, siteName string, machineName string, _ *MachinesControllerClientBeginStartOptions) (*policy.Request, error) {
...
func (client *MachinesControllerClient) stopCreateRequest(ctx context.Context, resourceGroupName string, siteName string, machineName string, _ *MachinesControllerClientBeginStopOptions) (*policy.Request, error) {
...
func (client *MachinesControllerClient) updateCreateRequest(ctx context.Context, resourceGroupName string, siteName string, machineName string, body MachineResourceUpdate, _ *MachinesControllerClientUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OffAzure/vmwareSites/{siteName}/machines/{machineName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
