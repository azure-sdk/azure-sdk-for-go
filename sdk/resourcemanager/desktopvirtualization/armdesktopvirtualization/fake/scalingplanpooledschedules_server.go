...
func (s *ScalingPlanPooledSchedulesServerTransport) dispatchUpdate(req *http.Request) (*http.Response, error) {
	...
	resp, err := server.MarshalResponseAsJSON(respContent, server.GetResponse(respr).ScalingPlanPooledSchedulePatch, req)
	if err != nil {
		return nil, err
	}
	return resp, nil
