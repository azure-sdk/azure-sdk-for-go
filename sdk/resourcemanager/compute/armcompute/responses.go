...
// VirtualMachineImagesClientListOffersResponse contains the response from method VirtualMachineImagesClient.NewListOffersPager.
...
// VirtualMachineImagesClientListPublishersResponse contains the response from method VirtualMachineImagesClient.NewListPublishersPager.
type VirtualMachineImagesClientListPublishersResponse struct {
	// Paged collection of VirtualMachineImageResource items
	PagedVirtualMachineImageResource
}

// VirtualMachineImagesClientListResponse contains the response from method VirtualMachineImagesClient.NewListPager.
type VirtualMachineImagesClientListResponse struct {
	// Paged collection of VirtualMachineImageResource items
	PagedVirtualMachineImageResource
}

// VirtualMachineImagesClientListSKUsResponse contains the response from method VirtualMachineImagesClient.NewListSKUsPager.
...
// VirtualMachineImagesEdgeZoneClientListOffersResponse contains the response from method VirtualMachineImagesEdgeZoneClient.NewListOffersPager.
type VirtualMachineImagesEdgeZoneClientListOffersResponse struct {
	// Paged collection of VirtualMachineImageResource items
	PagedVirtualMachineImageResource
}

// VirtualMachineImagesEdgeZoneClientListPublishersResponse contains the response from method VirtualMachineImagesEdgeZoneClient.NewListPublishersPager.
type VirtualMachineImagesEdgeZoneClientListPublishersResponse struct {
	// Paged collection of VirtualMachineImageResource items
	PagedVirtualMachineImageResource
}

// VirtualMachineImagesEdgeZoneClientListResponse contains the response from method VirtualMachineImagesEdgeZoneClient.NewListPager.
type VirtualMachineImagesEdgeZoneClientListResponse struct {
	// Paged collection of VirtualMachineImageResource items
	PagedVirtualMachineImageResource
}

// VirtualMachineImagesEdgeZoneClientListSKUsResponse contains the response from method VirtualMachineImagesEdgeZoneClient.NewListSKUsPager.
