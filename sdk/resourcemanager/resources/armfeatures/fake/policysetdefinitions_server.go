...
// PolicySetDefinitionsServer is a fake server for instances of the armfeatures.PolicySetDefinitionsClient type.
type PolicySetDefinitionsServer struct {
	...
	CreateOrUpdate func(ctx context.Context, policySetDefinitionName string, parameters armfeatures.PolicySetDefinition, options *armfeatures.PolicySetDefinitionsClientCreateOrUpdateOptions) (resp azfake.Responder[armfeatures.PolicySetDefinitionsClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)

	// CreateOrUpdateAtManagementGroup is the fake for method PolicySetDefinitionsClient.CreateOrUpdateAtManagementGroup
	// HTTP status codes to indicate success: http.StatusOK, http.StatusCreated
	CreateOrUpdateAtManagementGroup func(ctx context.Context, managementGroupID string, policySetDefinitionName string, parameters armfeatures.PolicySetDefinition, options *armfeatures.PolicySetDefinitionsClientCreateOrUpdateAtManagementGroupOptions) (resp azfake.Responder[armfeatures.PolicySetDefinitionsClientCreateOrUpdateAtManagementGroupResponse], errResp azfake.ErrorResponder)

	// Delete is the fake for method PolicySetDefinitionsClient.Delete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	Delete func(ctx context.Context, policySetDefinitionName string, options *armfeatures.PolicySetDefinitionsClientDeleteOptions) (resp azfake.Responder[armfeatures.PolicySetDefinitionsClientDeleteResponse], errResp azfake.ErrorResponder)

	// DeleteAtManagementGroup is the fake for method PolicySetDefinitionsClient.DeleteAtManagementGroup
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	DeleteAtManagementGroup func(ctx context.Context, managementGroupID string, policySetDefinitionName string, options *armfeatures.PolicySetDefinitionsClientDeleteAtManagementGroupOptions) (resp azfake.Responder[armfeatures.PolicySetDefinitionsClientDeleteAtManagementGroupResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method PolicySetDefinitionsClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, policySetDefinitionName string, options *armfeatures.PolicySetDefinitionsClientGetOptions) (resp azfake.Responder[armfeatures.PolicySetDefinitionsClientGetResponse], errResp azfake.ErrorResponder)

	// GetAtManagementGroup is the fake for method PolicySetDefinitionsClient.GetAtManagementGroup
	// HTTP status codes to indicate success: http.StatusOK
	GetAtManagementGroup func(ctx context.Context, managementGroupID string, policySetDefinitionName string, options *armfeatures.PolicySetDefinitionsClientGetAtManagementGroupOptions) (resp azfake.Responder[armfeatures.PolicySetDefinitionsClientGetAtManagementGroupResponse], errResp azfake.ErrorResponder)

	// GetBuiltIn is the fake for method PolicySetDefinitionsClient.GetBuiltIn
	// HTTP status codes to indicate success: http.StatusOK
	GetBuiltIn func(ctx context.Context, policySetDefinitionName string, options *armfeatures.PolicySetDefinitionsClientGetBuiltInOptions) (resp azfake.Responder[armfeatures.PolicySetDefinitionsClientGetBuiltInResponse], errResp azfake.ErrorResponder)

	// NewListPager is the fake for method PolicySetDefinitionsClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(options *armfeatures.PolicySetDefinitionsClientListOptions) (resp azfake.PagerResponder[armfeatures.PolicySetDefinitionsClientListResponse])

	// NewListBuiltInPager is the fake for method PolicySetDefinitionsClient.NewListBuiltInPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListBuiltInPager func(options *armfeatures.PolicySetDefinitionsClientListBuiltInOptions) (resp azfake.PagerResponder[armfeatures.PolicySetDefinitionsClientListBuiltInResponse])

	// NewListByManagementGroupPager is the fake for method PolicySetDefinitionsClient.NewListByManagementGroupPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByManagementGroupPager func(managementGroupID string, options *armfeatures.PolicySetDefinitionsClientListByManagementGroupOptions) (resp azfake.PagerResponder[armfeatures.PolicySetDefinitionsClientListByManagementGroupResponse])
}
...
// The returned PolicySetDefinitionsServerTransport instance is connected to an instance of armfeatures.PolicySetDefinitionsClient via the
...
func NewPolicySetDefinitionsServerTransport(srv *PolicySetDefinitionsServer) *PolicySetDefinitionsServerTransport {
	return &PolicySetDefinitionsServerTransport{
		srv:                           srv,
		newListPager:                  newTracker[azfake.PagerResponder[armfeatures.PolicySetDefinitionsClientListResponse]](),
		newListBuiltInPager:           newTracker[azfake.PagerResponder[armfeatures.PolicySetDefinitionsClientListBuiltInResponse]](),
		newListByManagementGroupPager: newTracker[azfake.PagerResponder[armfeatures.PolicySetDefinitionsClientListByManagementGroupResponse]](),
	}
}

// PolicySetDefinitionsServerTransport connects instances of armfeatures.PolicySetDefinitionsClient to instances of PolicySetDefinitionsServer.
...
type PolicySetDefinitionsServerTransport struct {
	...
	newListPager                  *tracker[azfake.PagerResponder[armfeatures.PolicySetDefinitionsClientListResponse]]
	newListBuiltInPager           *tracker[azfake.PagerResponder[armfeatures.PolicySetDefinitionsClientListBuiltInResponse]]
	newListByManagementGroupPager *tracker[azfake.PagerResponder[armfeatures.PolicySetDefinitionsClientListByManagementGroupResponse]]
}
...
func (p *PolicySetDefinitionsServerTransport) dispatchCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[armfeatures.PolicySetDefinition](req)
	if err != nil {
		return nil, err
	}
...
func (p *PolicySetDefinitionsServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		var options *armfeatures.PolicySetDefinitionsClientListOptions
		if filterParam != nil || topParam != nil {
			options = &armfeatures.PolicySetDefinitionsClientListOptions{
				Filter: filterParam,
				Top:    topParam,
			}
		}
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armfeatures.PolicySetDefinitionsClientListResponse, createLink func() string) {
...
func (p *PolicySetDefinitionsServerTransport) dispatchNewListBuiltInPager(req *http.Request) (*http.Response, error) {
	...
	if newListBuiltInPager == nil {
		...
		var options *armfeatures.PolicySetDefinitionsClientListBuiltInOptions
		if filterParam != nil || topParam != nil {
			options = &armfeatures.PolicySetDefinitionsClientListBuiltInOptions{
				Filter: filterParam,
				Top:    topParam,
			}
		}
		...
		server.PagerResponderInjectNextLinks(newListBuiltInPager, req, func(page *armfeatures.PolicySetDefinitionsClientListBuiltInResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
...
func (p *PolicySetDefinitionsServerTransport) dispatchNewListByManagementGroupPager(req *http.Request) (*http.Response, error) {
	...
	if newListByManagementGroupPager == nil {
		...
		var options *armfeatures.PolicySetDefinitionsClientListByManagementGroupOptions
		if filterParam != nil || topParam != nil {
			options = &armfeatures.PolicySetDefinitionsClientListByManagementGroupOptions{
				Filter: filterParam,
				Top:    topParam,
			}
		}
		...
		server.PagerResponderInjectNextLinks(newListByManagementGroupPager, req, func(page *armfeatures.PolicySetDefinitionsClientListByManagementGroupResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
