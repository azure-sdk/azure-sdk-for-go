...
- New function `*ClientFactory.NewBenefitUtilizationSummariesAsyncClient() *BenefitUtilizationSummariesAsyncClient`
...
- New field `EndTime` in struct `GenerateDetailedCostReportOperationStatuses`
- New field `StartTime` in struct `GenerateDetailedCostReportOperationStatuses`
