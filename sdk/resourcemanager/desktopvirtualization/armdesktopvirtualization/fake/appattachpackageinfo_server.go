...
func (a *AppAttachPackageInfoServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if appAttachPackageInfoServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = appAttachPackageInfoServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			case "AppAttachPackageInfoClient.NewImportPager":
				res.resp, res.err = a.dispatchNewImportPager(req)
			default:
...
// set this to conditionally intercept incoming requests to AppAttachPackageInfoServerTransport
var appAttachPackageInfoServerTransportInterceptor interface {
