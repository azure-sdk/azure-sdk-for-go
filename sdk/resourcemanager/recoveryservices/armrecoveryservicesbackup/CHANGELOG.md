...
- Operation `*ProtectedItemsClient.Delete` has been changed to LRO, use `*ProtectedItemsClient.BeginDelete` instead.
...
- Operation `*ProtectionContainersClient.Unregister` has been changed to LRO, use `*ProtectionContainersClient.BeginUnregister` instead.
