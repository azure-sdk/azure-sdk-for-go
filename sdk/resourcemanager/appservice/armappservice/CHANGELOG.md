...
- New type alias `TrafficSplittingName` with values `TrafficSplittingNameDefault`
...
- New function `*StaticSitesClient.BeginCreateOrUpdateTrafficSplitting(context.Context, string, string, BasicAuthName, StaticSiteTrafficSplittingPropertiesARMResource, *StaticSitesClientBeginCreateOrUpdateTrafficSplittingOptions) (*runtime.Poller[StaticSitesClientCreateOrUpdateTrafficSplittingResponse], error)`
...
- New function `*StaticSitesClient.DeleteTrafficSplitting(context.Context, string, string, TrafficSplittingName, *StaticSitesClientDeleteTrafficSplittingOptions) (StaticSitesClientDeleteTrafficSplittingResponse, error)`
...
- New function `*StaticSitesClient.GetTrafficSplitting(context.Context, string, string, TrafficSplittingName, *StaticSitesClientGetTrafficSplittingOptions) (StaticSitesClientGetTrafficSplittingResponse, error)`
...
- New struct `StaticSiteTrafficSplittingProperties`
- New struct `StaticSiteTrafficSplittingPropertiesARMResource`
- New struct `StaticSiteTrafficSplittingPropertiesARMResourceProperties`
- New struct `StaticSiteTrafficSplittingPropertiesCollection`
- New struct `StaticSiteTrafficSplittingPropertiesProperties`
...
- New field `TrafficSplitting` in struct `StaticSite`
