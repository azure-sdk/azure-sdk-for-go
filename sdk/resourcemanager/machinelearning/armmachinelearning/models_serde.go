...
// MarshalJSON implements the json.Marshaller interface for type CustomIncludeAllVersionsQueryParameter.
func (c CustomIncludeAllVersionsQueryParameter) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "includeAllVersions", c.IncludeAllVersions)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type CustomIncludeAllVersionsQueryParameter.
func (c *CustomIncludeAllVersionsQueryParameter) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
	for key, val := range rawMsg {
		...
		case "includeAllVersions":
			err = unpopulate(val, "IncludeAllVersions", &c.IncludeAllVersions)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", c, err)
...
// MarshalJSON implements the json.Marshaller interface for type CustomLatestQueryParameter.
func (c CustomLatestQueryParameter) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "latest", c.Latest)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type CustomLatestQueryParameter.
func (c *CustomLatestQueryParameter) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "latest":
			err = unpopulate(val, "Latest", &c.Latest)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", c, err)
...
// MarshalJSON implements the json.Marshaller interface for type IndexListResult.
func (i IndexListResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type IndexListResult.
func (i *IndexListResult) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", i, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type IndexVersion.
func (i IndexVersion) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "id", i.ID)
	populate(objectMap, "name", i.Name)
	populate(objectMap, "properties", i.Properties)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type IndexVersion.
func (i *IndexVersion) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", i, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type IndexVersionListResult.
func (i IndexVersionListResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "nextLink", i.NextLink)
	populate(objectMap, "value", i.Value)
	return json.Marshal(objectMap)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type IndexVersionListResult.
func (i *IndexVersionListResult) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", i, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type IndexVersionProperties.
func (i IndexVersionProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "indexConfigurations", i.IndexConfigurations)
	populate(objectMap, "storageUri", i.StorageURI)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type IndexVersionProperties.
func (i *IndexVersionProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", i, err)
	}
	for key, val := range rawMsg {
		var err error
		switch key {
		case "indexConfigurations":
			err = unpopulate(val, "IndexConfigurations", &i.IndexConfigurations)
			delete(rawMsg, key)
		case "storageUri":
