...
func (i *ImportSitesControllerServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if importSitesControllerServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = importSitesControllerServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to ImportSitesControllerServerTransport
var importSitesControllerServerTransportInterceptor interface {
