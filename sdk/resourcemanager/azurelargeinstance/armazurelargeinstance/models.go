...
// ListResult - The response from the List Azure Large Instances operation.
...
type Properties struct {
	...
	// ARM ID of another AzureLargeInstanceInstance that will share a network with this AzureLargeInstanceInstance
	...
	// READ-ONLY; State of provisioning of the AzureLargeInstanceInstance
