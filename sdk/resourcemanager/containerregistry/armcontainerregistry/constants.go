...
// PipelineTargetType - The type of target for the export pipeline.
type PipelineTargetType string

const (
	PipelineTargetTypeAzureStorageBlobContainer PipelineTargetType = "AzureStorageBlobContainer"
)

// PossiblePipelineTargetTypeValues returns the possible values for the PipelineTargetType const type.
func PossiblePipelineTargetTypeValues() []PipelineTargetType {
	return []PipelineTargetType{
		PipelineTargetTypeAzureStorageBlobContainer,
	}
}
