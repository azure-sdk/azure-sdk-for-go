	...
	go func() {
		...
		if !intercepted {
			...
			case "SapVirtualInstancesClient.InvokeAvailabilityZoneDetails":
				res.resp, res.err = s.dispatchInvokeAvailabilityZoneDetails(req)
			case "SapVirtualInstancesClient.InvokeDiskConfigurations":
				res.resp, res.err = s.dispatchInvokeDiskConfigurations(req)
			case "SapVirtualInstancesClient.InvokeSapSupportedSKU":
				res.resp, res.err = s.dispatchInvokeSapSupportedSKU(req)
			case "SapVirtualInstancesClient.InvokeSizingRecommendations":
				res.resp, res.err = s.dispatchInvokeSizingRecommendations(req)
