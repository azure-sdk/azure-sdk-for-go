...
func (k KubernetesClusterRestoreCriteria) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "resourceModifierTemplate", k.ResourceModifierTemplate)
...
func (k *KubernetesClusterRestoreCriteria) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "persistentVolumeRestoreMode":
			...
			delete(rawMsg, key)
		case "resourceModifierTemplate":
			err = unpopulate(val, "ResourceModifierTemplate", &k.ResourceModifierTemplate)
			delete(rawMsg, key)
