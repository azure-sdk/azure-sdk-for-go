...
type AlertRuleRecommendationProperties struct {
	...
	// REQUIRED; Provides the display information for an alert rule recommendation recommendations.
	DisplayInformation *DisplayInformationItem `json:"displayInformation,omitempty"`
...
// DisplayInformationItem - Provides the display information for an alert rule recommendation recommendations.
type DisplayInformationItem struct {
	// The documentation link to display inside an information balloon.
	InfoBallonLink *string `json:"infoBallonLink,omitempty"`

	// The information to display inside an information balloon.
	InfoBallonMessage *string `json:"infoBallonMessage,omitempty"`

	// Provides display information specific for Metric Alerts rule.
	MetricAlertsDisplayInformation *MetricAlertsDisplayInformation `json:"metricAlertsDisplayInformation,omitempty"`
...
// MetricAlertsDisplayInformation - Provides display information specific for Metric Alerts rule.
type MetricAlertsDisplayInformation struct {
	// REQUIRED; The display units to use in the UI for the metric alert rule.
	DisplayUnits *MetricAlertsDisplayUnit `json:"displayUnits,omitempty"`

	// REQUIRED; The metric display name to use in the UI for the metric alert rule.
