...
// for Azure Reserved Instances (RI) for the current billing period. We recommend
// downloading an Azure Price Sheet for when entering a new billing period if you would maintain an ongoing record of past
// Azure Reserved Instance (RI) pricing.
...
// files, each with max size of 75MB. The 2023-11-01 version has been upgraded to
// use http POST method; details can be found below.
// All versions of the Microsoft.Consumption Azure Price Sheet - Download by Billing Account (including 2022-06-01, 2021-10-01,
// 2020-01-01-preview, 2019-10-01, 2019-05-01) are scheduled to be retired on
// 01 June 2026 and will no longer be supported after this date.
...
// Agreement.
// You can use the new 2023-11-01 API version for billing periods January 2023 onwards. Azure Reserved Instance (RI) pricing
