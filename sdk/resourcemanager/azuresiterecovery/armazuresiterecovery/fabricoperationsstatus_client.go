...
func NewFabricOperationsStatusClient(credential azcore.TokenCredential, options *arm.ClientOptions) (*FabricOperationsStatusClient, error) {
...
//     method.
func (client *FabricOperationsStatusClient) Get(ctx context.Context, subscriptionID string, resourceGroupName string, fabricName string, operationID string, options *FabricOperationsStatusClientGetOptions) (FabricOperationsStatusClientGetResponse, error) {
	var err error
	req, err := client.getCreateRequest(ctx, subscriptionID, resourceGroupName, fabricName, operationID, options)
	if err != nil {
...
func (client *FabricOperationsStatusClient) getCreateRequest(ctx context.Context, subscriptionID string, resourceGroupName string, fabricName string, operationID string, options *FabricOperationsStatusClientGetOptions) (*policy.Request, error) {
