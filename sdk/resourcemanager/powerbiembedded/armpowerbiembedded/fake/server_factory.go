...
type ServerFactory struct {
	...
	// WorkspaceCollectionsServer contains the fakes for client WorkspaceCollectionsClient
	WorkspaceCollectionsServer WorkspaceCollectionsServer
...
// The returned ServerFactoryTransport instance is connected to an instance of armpowerbiembedded.ClientFactory via the
...
// ServerFactoryTransport connects instances of armpowerbiembedded.ClientFactory to instances of ServerFactory.
// Don't use this type directly, use NewServerFactoryTransport instead.
type ServerFactoryTransport struct {
	srv                          *ServerFactory
	trMu                         sync.Mutex
	trManagementServer           *ManagementServerTransport
	trWorkspaceCollectionsServer *WorkspaceCollectionsServerTransport
...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "WorkspaceCollectionsClient":
		initServer(s, &s.trWorkspaceCollectionsServer, func() *WorkspaceCollectionsServerTransport {
			return NewWorkspaceCollectionsServerTransport(&s.srv.WorkspaceCollectionsServer)
		})
		resp, err = s.trWorkspaceCollectionsServer.Do(req)
