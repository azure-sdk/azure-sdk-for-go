...
func (w *WorkspaceManagedSQLServerSecurityAlertPolicyServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if workspaceManagedSqlServerSecurityAlertPolicyServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = workspaceManagedSqlServerSecurityAlertPolicyServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to WorkspaceManagedSQLServerSecurityAlertPolicyServerTransport
var workspaceManagedSqlServerSecurityAlertPolicyServerTransportInterceptor interface {
