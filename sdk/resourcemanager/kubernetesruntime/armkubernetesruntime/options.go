...
// BgpPeersClientBeginDeleteOptions contains the optional parameters for the BgpPeersClient.BeginDelete method.
type BgpPeersClientBeginDeleteOptions struct {
	// Resumes the LRO from the provided token.
	ResumeToken string
}
