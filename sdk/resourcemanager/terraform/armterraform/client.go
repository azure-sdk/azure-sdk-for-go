...
// Client contains the methods for the Terraform group.
...
func (client *Client) exportTerraformCreateRequest(ctx context.Context, body BaseExportModelClassification, options *ClientBeginExportTerraformOptions) (*policy.Request, error) {
