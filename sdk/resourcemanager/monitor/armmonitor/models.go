...
type ScheduledQueryRuleProperties struct {
	...
	// The flag which indicates whether unidentified table or column names in the query text should be ignored during validation.
	// The default is false. Relevant only for Log Alert rules with an evaluation
	// frequency which is greater than 1 minute.
