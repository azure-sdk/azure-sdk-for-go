...
// DataTransferServiceResourceCreateUpdateParameters - Parameters for Create or Update request for DataTransferServiceResource
...
func (d *DataTransferServiceResourceCreateUpdateParameters) GetServiceResourceCreateUpdateProperties() *ServiceResourceCreateUpdateProperties {
...
// GraphAPIComputeServiceResourceCreateUpdateParameters - Parameters for Create or Update request for GraphAPIComputeServiceResource
...
func (g *GraphAPIComputeServiceResourceCreateUpdateParameters) GetServiceResourceCreateUpdateProperties() *ServiceResourceCreateUpdateProperties {
	return &ServiceResourceCreateUpdateProperties{
...
// MaterializedViewsBuilderServiceResourceCreateUpdateParameters - Parameters for Create or Update request for MaterializedViewsBuilderServiceResource
...
func (m *MaterializedViewsBuilderServiceResourceCreateUpdateParameters) GetServiceResourceCreateUpdateProperties() *ServiceResourceCreateUpdateProperties {
	return &ServiceResourceCreateUpdateProperties{
...
// ProvisioningIssue - Describes provisioning issue for a network security perimeter configuration
type ProvisioningIssue struct {
	// READ-ONLY; Name of the issue
	Name *string

	// READ-ONLY; Properties of a provisioning issue
...
type ProvisioningIssueProperties struct {
	...
	// READ-ONLY; Access rules that can be added to the same profile to remediate the issue.
	SuggestedAccessRules []*AccessRule

	// READ-ONLY; Fully qualified resource IDs of resources that can be associated to the same perimeter to remediate the issue.
...
// SQLDedicatedGatewayServiceResourceCreateUpdateParameters - Parameters for Create or Update request for SqlDedicatedGatewayServiceResource
...
func (s *SQLDedicatedGatewayServiceResourceCreateUpdateParameters) GetServiceResourceCreateUpdateProperties() *ServiceResourceCreateUpdateProperties {
	return &ServiceResourceCreateUpdateProperties{
