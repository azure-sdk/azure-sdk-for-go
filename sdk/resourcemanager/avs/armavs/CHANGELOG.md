...
- New enum type `MaintenanceStateName` with values `MaintenanceStateNameCanceled`, `MaintenanceStateNameFailed`, `MaintenanceStateNameInProgress`, `MaintenanceStateNameNotScheduled`, `MaintenanceStateNamePlanned`, `MaintenanceStateNameSuccess`
