...
func (a *ApplicationLiveViewsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if applicationLiveViewsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = applicationLiveViewsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to ApplicationLiveViewsServerTransport
var applicationLiveViewsServerTransportInterceptor interface {
