...
func (b *BuildpackBindingServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if buildpackBindingServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = buildpackBindingServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "BuildpackBindingClient.NewListForClusterPager":
				res.resp, res.err = b.dispatchNewListForClusterPager(req)
			default:
...
// set this to conditionally intercept incoming requests to BuildpackBindingServerTransport
var buildpackBindingServerTransportInterceptor interface {
