...
// MarshalJSON implements the json.Marshaller interface for type ConnectionExportValidity.
func (c ConnectionExportValidity) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type ConnectionExportValidity.
func (c *ConnectionExportValidity) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type ExportDetail.
func (e ExportDetail) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "exportDetailCategory", e.ExportDetailCategory)
	populate(objectMap, "exportDetailCode", e.ExportDetailCode)
	populate(objectMap, "exportDetailMessage", e.ExportDetailMessage)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ExportDetail.
func (e *ExportDetail) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", e, err)
	}
	for key, val := range rawMsg {
		var err error
		switch key {
		case "exportDetailCategory":
			err = unpopulate(val, "ExportDetailCategory", &e.ExportDetailCategory)
			delete(rawMsg, key)
		case "exportDetailCode":
			err = unpopulate(val, "ExportDetailCode", &e.ExportDetailCode)
			delete(rawMsg, key)
		case "exportDetailMessage":
			err = unpopulate(val, "ExportDetailMessage", &e.ExportDetailMessage)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", e, err)
...
// MarshalJSON implements the json.Marshaller interface for type ResourceExportValidity.
func (r ResourceExportValidity) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "details", r.Details)
	populate(objectMap, "validationState", r.ValidationState)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ResourceExportValidity.
func (r *ResourceExportValidity) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", r, err)
	}
	for key, val := range rawMsg {
		...
		case "details":
			...
			delete(rawMsg, key)
		case "validationState":
			err = unpopulate(val, "ValidationState", &r.ValidationState)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", r, err)
...
// MarshalJSON implements the json.Marshaller interface for type WorkflowExportRequest.
func (w WorkflowExportRequest) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "workflowExportOptions", w.WorkflowExportOptions)
	populate(objectMap, "workflows", w.Workflows)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type WorkflowExportRequest.
func (w *WorkflowExportRequest) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", w, err)
	}
	for key, val := range rawMsg {
		var err error
		switch key {
		case "workflowExportOptions":
			err = unpopulate(val, "WorkflowExportOptions", &w.WorkflowExportOptions)
			delete(rawMsg, key)
		case "workflows":
			err = unpopulate(val, "Workflows", &w.Workflows)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", w, err)
...
// MarshalJSON implements the json.Marshaller interface for type WorkflowExportResult.
func (w WorkflowExportResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "details", w.Details)
	populate(objectMap, "packageLink", w.PackageLink)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type WorkflowExportResult.
func (w *WorkflowExportResult) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", w, err)
	}
	for key, val := range rawMsg {
		...
		case "details":
			...
			delete(rawMsg, key)
		case "packageLink":
			err = unpopulate(val, "PackageLink", &w.PackageLink)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", w, err)
...
// MarshalJSON implements the json.Marshaller interface for type WorkflowExportValidity.
func (w WorkflowExportValidity) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "connections", w.Connections)
	populate(objectMap, "parameters", w.Parameters)
	populate(objectMap, "validationState", w.ValidationState)
	populate(objectMap, "workflowOperations", w.WorkflowOperations)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type WorkflowExportValidity.
func (w *WorkflowExportValidity) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", w, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "connections":
			err = unpopulate(val, "Connections", &w.Connections)
			delete(rawMsg, key)
		case "parameters":
			err = unpopulate(val, "Parameters", &w.Parameters)
			delete(rawMsg, key)
		case "validationState":
			err = unpopulate(val, "ValidationState", &w.ValidationState)
			delete(rawMsg, key)
		case "workflowOperations":
			err = unpopulate(val, "WorkflowOperations", &w.WorkflowOperations)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", w, err)
...
// MarshalJSON implements the json.Marshaller interface for type WorkflowExportValidityResult.
func (w WorkflowExportValidityResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "validationState", w.ValidationState)
	populate(objectMap, "workflows", w.Workflows)
	return json.Marshal(objectMap)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type WorkflowExportValidityResult.
func (w *WorkflowExportValidityResult) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", w, err)
	}
