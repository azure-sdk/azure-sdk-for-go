...
// MarshalJSON implements the json.Marshaller interface for type AzureResourceManagerArmResponseAvailableContactsListResult.
func (a AzureResourceManagerArmResponseAvailableContactsListResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "body", a.Body)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type AzureResourceManagerArmResponseAvailableContactsListResult.
func (a *AzureResourceManagerArmResponseAvailableContactsListResult) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", a, err)
	}
