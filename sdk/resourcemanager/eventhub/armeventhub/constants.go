...
// PreferredRing - Preferred ring to perform upgrade
type PreferredRing string

const (
	PreferredRingEarly  PreferredRing = "Early"
	PreferredRingLate   PreferredRing = "Late"
	PreferredRingMiddle PreferredRing = "Middle"
	PreferredRingNone   PreferredRing = "None"
)

// PossiblePreferredRingValues returns the possible values for the PreferredRing const type.
func PossiblePreferredRingValues() []PreferredRing {
	return []PreferredRing{
		PreferredRingEarly,
		PreferredRingLate,
		PreferredRingMiddle,
		PreferredRingNone,
...
// Preferredstartdayofweek - Preferred day of the week in UTC to begin an upgrade
type Preferredstartdayofweek string

const (
	PreferredstartdayofweekFriday    Preferredstartdayofweek = "Friday"
	PreferredstartdayofweekMonday    Preferredstartdayofweek = "Monday"
	PreferredstartdayofweekSaturday  Preferredstartdayofweek = "Saturday"
	PreferredstartdayofweekSunday    Preferredstartdayofweek = "Sunday"
	PreferredstartdayofweekThursday  Preferredstartdayofweek = "Thursday"
	PreferredstartdayofweekTuesday   Preferredstartdayofweek = "Tuesday"
	PreferredstartdayofweekWednesday Preferredstartdayofweek = "Wednesday"
)

// PossiblePreferredstartdayofweekValues returns the possible values for the Preferredstartdayofweek const type.
func PossiblePreferredstartdayofweekValues() []Preferredstartdayofweek {
	return []Preferredstartdayofweek{
		PreferredstartdayofweekFriday,
		PreferredstartdayofweekMonday,
		PreferredstartdayofweekSaturday,
		PreferredstartdayofweekSunday,
		PreferredstartdayofweekThursday,
		PreferredstartdayofweekTuesday,
		PreferredstartdayofweekWednesday,
	}
}
...
// Status - Status of the cluster upgrade
type Status string
