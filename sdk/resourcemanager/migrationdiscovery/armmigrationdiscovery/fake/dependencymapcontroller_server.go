...
func (d *DependencyMapControllerServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if dependencyMapControllerServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = dependencyMapControllerServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			case "DependencyMapControllerClient.BeginClientGroupMembers":
				res.resp, res.err = d.dispatchBeginClientGroupMembers(req)
			case "DependencyMapControllerClient.BeginExportDependencies":
				res.resp, res.err = d.dispatchBeginExportDependencies(req)
			case "DependencyMapControllerClient.BeginGenerateCoarseMap":
				res.resp, res.err = d.dispatchBeginGenerateCoarseMap(req)
			case "DependencyMapControllerClient.BeginGenerateDetailedMap":
				res.resp, res.err = d.dispatchBeginGenerateDetailedMap(req)
			case "DependencyMapControllerClient.BeginServerGroupMembers":
				res.resp, res.err = d.dispatchBeginServerGroupMembers(req)
			default:
...
// set this to conditionally intercept incoming requests to DependencyMapControllerServerTransport
var dependencyMapControllerServerTransportInterceptor interface {
