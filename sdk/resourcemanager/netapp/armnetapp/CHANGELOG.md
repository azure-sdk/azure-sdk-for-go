...
- New field `LdapConfiguration`, `MultiAdStatus`, `NfsV4IDDomain` in struct `AccountProperties`
...
- New field `DestinationReplications`, `ExternalReplicationSetupInfo`, `ExternalReplicationSetupStatus` in struct `ReplicationObject`
