...
func (client *CatalogsClient) countDevicesCreateRequest(ctx context.Context, resourceGroupName string, catalogName string, _ *CatalogsClientCountDevicesOptions) (*policy.Request, error) {
...
func (client *CatalogsClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, catalogName string, resource Catalog, _ *CatalogsClientBeginCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *CatalogsClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, catalogName string, _ *CatalogsClientBeginDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureSphere/catalogs/{catalogName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *CatalogsClient) getCreateRequest(ctx context.Context, resourceGroupName string, catalogName string, _ *CatalogsClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureSphere/catalogs/{catalogName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *CatalogsClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, _ *CatalogsClientListByResourceGroupOptions) (*policy.Request, error) {
...
func (client *CatalogsClient) listBySubscriptionCreateRequest(ctx context.Context, _ *CatalogsClientListBySubscriptionOptions) (*policy.Request, error) {
...
func (client *CatalogsClient) updateCreateRequest(ctx context.Context, resourceGroupName string, catalogName string, properties CatalogUpdate, _ *CatalogsClientUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureSphere/catalogs/{catalogName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
//     method.
func (client *CatalogsClient) BeginUploadImage(ctx context.Context, resourceGroupName string, catalogName string, body Image, options *CatalogsClientBeginUploadImageOptions) (*runtime.Poller[CatalogsClientUploadImageResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.uploadImage(ctx, resourceGroupName, catalogName, body, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2024-04-01
func (client *CatalogsClient) uploadImage(ctx context.Context, resourceGroupName string, catalogName string, body Image, options *CatalogsClientBeginUploadImageOptions) (*http.Response, error) {
	var err error
	const operationName = "CatalogsClient.BeginUploadImage"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.uploadImageCreateRequest(ctx, resourceGroupName, catalogName, body, options)
	if err != nil {
		return nil, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
...
func (client *CatalogsClient) uploadImageCreateRequest(ctx context.Context, resourceGroupName string, catalogName string, body Image, _ *CatalogsClientBeginUploadImageOptions) (*policy.Request, error) {
