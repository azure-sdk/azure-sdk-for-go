...
// PagedStorageTaskAssignment - The response from the List Storage Tasks operation.
type PagedStorageTaskAssignment struct {
...
// StorageTaskListResult - The response of a StorageTask list operation.
type StorageTaskListResult struct {
	// REQUIRED; The StorageTask items on this page
	Value []*StorageTask
...
// StorageTaskReportInstanceListResult - The response of a StorageTaskReportInstance list operation.
type StorageTaskReportInstanceListResult struct {
