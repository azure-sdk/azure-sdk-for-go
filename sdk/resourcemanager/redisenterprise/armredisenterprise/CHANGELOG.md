...
- New function `*DatabasesClient.BeginFlush(context.Context, string, string, string, *DatabasesClientBeginFlushOptions) (*runtime.Poller[DatabasesClientFlushResponse], error)`
