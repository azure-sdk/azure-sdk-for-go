...
type AcrDetails struct {
	...
	// Details of user created ACR account to be used for the Registry. Not supported in most cases and will throw 400 error if
	// provided.
...
type StorageAccountDetails struct {
	...
	// Details of user created storage account to be used for the registry. Not supported in most cases and will throw 400 error
	// if provided.
