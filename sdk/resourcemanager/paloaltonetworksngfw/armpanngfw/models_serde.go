...
func (s SupportInfo) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "accountIdForBilling", s.AccountIDForBilling)
	populate(objectMap, "accountRegistered", s.AccountRegistered)
	populate(objectMap, "associationType", s.AssociationType)
...
func (s *SupportInfo) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "accountId":
			...
			delete(rawMsg, key)
		case "accountIdForBilling":
			err = unpopulate(val, "AccountIDForBilling", &s.AccountIDForBilling)
			delete(rawMsg, key)
		case "accountRegistered":
			err = unpopulate(val, "AccountRegistered", &s.AccountRegistered)
			delete(rawMsg, key)
		case "associationType":
			err = unpopulate(val, "AssociationType", &s.AssociationType)
			delete(rawMsg, key)
		case "freeTrial":
