...
// Generated from example definition: 2025-03-01-preview/Branches_CreateOrUpdate_MaximumSet_Gen.json
func ExampleBranchesClient_BeginCreateOrUpdate() {
	...
	poller, err := clientFactory.NewBranchesClient().BeginCreateOrUpdate(ctx, "rgneon", "testOrg123", "test-entity", "test-entity", armneonpostgres.Branch{
	...
	// 			},
	// 		},
	// 		ID: to.Ptr("/subscriptions/671936A4-ED6C-445D-ACEE-5637920E7051/resourceGroups/rgneon/providers/Microsoft.Neon/organizations/testOrg123/projects/test-entity/branches/test-entity"),
	// 		Name: to.Ptr("qcnherkhwdvkbkwykpjxzdnk"),
	// 		Type: to.Ptr("ted"),
...
// Generated from example definition: 2025-03-01-preview/Branches_Delete_MaximumSet_Gen.json
func ExampleBranchesClient_Delete() {
	...
	res, err := clientFactory.NewBranchesClient().Delete(ctx, "rgneon", "testOrg123", "test-entity", "test-entity", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
...
// Generated from example definition: 2025-03-01-preview/Branches_Get_MaximumSet_Gen.json
func ExampleBranchesClient_Get() {
	...
	res, err := clientFactory.NewBranchesClient().Get(ctx, "rgneon", "testOrg123", "test-entity", "test-entity", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
...
// Generated from example definition: 2025-03-01-preview/Branches_List_MaximumSet_Gen.json
func ExampleBranchesClient_NewListPager() {
	...
	pager := clientFactory.NewBranchesClient().NewListPager("rgneon", "testOrg123", "test-entity", nil)
	for pager.More() {
		...
		// 					},
		// 				},
		// 				ID: to.Ptr("/subscriptions/671936A4-ED6C-445D-ACEE-5637920E7051/resourceGroups/rgneon/providers/Microsoft.Neon/organizations/testOrg123/projects/test-entity/branches/test-name"),
		// 				Name: to.Ptr("qcnherkhwdvkbkwykpjxzdnk"),
		// 				Type: to.Ptr("ted"),
		// 				SystemData: &armneonpostgres.SystemData{
		// 					CreatedBy: to.Ptr("dknvmdx"),
...
// Generated from example definition: 2025-03-01-preview/Branches_Update_MaximumSet_Gen.json
func ExampleBranchesClient_BeginUpdate() {
	...
	poller, err := clientFactory.NewBranchesClient().BeginUpdate(ctx, "rgneon", "testOrg123", "test-entity", "test-entity", armneonpostgres.Branch{
		Properties: &armneonpostgres.BranchProperties{
			EntityName: to.Ptr("test-name"),
			Attributes: []*armneonpostgres.Attributes{
				{
