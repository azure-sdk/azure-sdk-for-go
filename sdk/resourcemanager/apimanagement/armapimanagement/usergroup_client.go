...
func (client *UserGroupClient) NewListPager(resourceGroupName string, serviceName string, uid string, options *UserGroupClientListOptions) *runtime.Pager[UserGroupClientListResponse] {
...
func (client *UserGroupClient) listCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, uid string, options *UserGroupClientListOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/users/{uid}/groups"
