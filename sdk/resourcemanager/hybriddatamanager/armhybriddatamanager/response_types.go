...
// JobDefinitionsClientCancelResponse contains the response from method JobDefinitionsClient.Cancel.
type JobDefinitionsClientCancelResponse struct {
	// placeholder for future response values
}
...
// JobDefinitionsClientRetryJobResponse contains the response from method JobDefinitionsClient.RetryJob.
type JobDefinitionsClientRetryJobResponse struct {
	// placeholder for future response values
}
...
// JobDefinitionsClientSkipJobResponse contains the response from method JobDefinitionsClient.SkipJob.
type JobDefinitionsClientSkipJobResponse struct {
	// placeholder for future response values
}
