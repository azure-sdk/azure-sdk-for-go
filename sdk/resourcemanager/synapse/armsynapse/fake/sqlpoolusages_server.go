...
func (s *SQLPoolUsagesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if sqlPoolUsagesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = sqlPoolUsagesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to SQLPoolUsagesServerTransport
var sqlPoolUsagesServerTransportInterceptor interface {
