...
type CommunityTrainingsServer struct {
	...
	BeginUpdate func(ctx context.Context, resourceGroupName string, communityTrainingName string, properties armcommunitytraining.CommunityTraining, options *armcommunitytraining.CommunityTrainingsClientBeginUpdateOptions) (resp azfake.PollerResponder[armcommunitytraining.CommunityTrainingsClientUpdateResponse], errResp azfake.ErrorResponder)
}
