...
func (d *DataNetworksServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if dataNetworksServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = dataNetworksServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "DataNetworksClient.NewListByMobileNetworkPager":
				res.resp, res.err = d.dispatchNewListByMobileNetworkPager(req)
...
// set this to conditionally intercept incoming requests to DataNetworksServerTransport
var dataNetworksServerTransportInterceptor interface {
