...
- New function `*AutoUpgradeProfileOperationsClient.BeginGenerate(context.Context, string, string, string, *AutoUpgradeProfileOperationsClientBeginGenerateOptions) (*runtime.Poller[AutoUpgradeProfileOperationsClientGenerateResponse], error)`
- New function `*AutoUpgradeProfileOperationsClient.GenerateUpdateRuns(context.Context, string, string, string, GenerateUpdateRunRequest, *AutoUpgradeProfileOperationsClientGenerateUpdateRunsOptions) (AutoUpgradeProfileOperationsClientGenerateUpdateRunsResponse, error)`
...
- New struct `GenerateUpdateRunRequest`
