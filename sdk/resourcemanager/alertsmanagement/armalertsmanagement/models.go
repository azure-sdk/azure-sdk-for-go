...
// LogAlertRuleIdentity - Identity for the resource.
type LogAlertRuleIdentity struct {
	...
	UserAssignedIdentities map[string]*LogAlertRuleUserIdentityProperties
...
// LogAlertRuleUserIdentityProperties - User assigned identity properties.
type LogAlertRuleUserIdentityProperties struct {
