...
func (client *FirewallPoliciesClient) createOrUpdateDraftCreateRequest(ctx context.Context, resourceGroupName string, firewallPolicyName string, parameters FirewallPolicyDraft, options *FirewallPoliciesClientCreateOrUpdateDraftOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/firewallPolicies/{firewallPolicyName}/draft/default"
	if resourceGroupName == "" {
		return nil, errors.New("parameter resourceGroupName cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{resourceGroupName}", url.PathEscape(resourceGroupName))
...
func (client *FirewallPoliciesClient) deleteDraftHandleResponse(resp *http.Response) (FirewallPoliciesClientDeleteDraftResponse, error) {
	result := FirewallPoliciesClientDeleteDraftResponse{}
