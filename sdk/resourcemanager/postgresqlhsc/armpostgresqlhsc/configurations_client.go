...
//     method.
func (client *ConfigurationsClient) BeginCreateOrUpdateCoordinator(ctx context.Context, resourceGroupName string, clusterName string, configurationName string, parameters ServerConfiguration, options *ConfigurationsClientBeginCreateOrUpdateCoordinatorOptions) (*runtime.Poller[ConfigurationsClientCreateOrUpdateCoordinatorResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.createOrUpdateCoordinator(ctx, resourceGroupName, clusterName, configurationName, parameters, options)
		if err != nil {
			return nil, err
		}
		return runtime.NewPoller(resp, client.internal.Pipeline(), &runtime.NewPollerOptions[ConfigurationsClientCreateOrUpdateCoordinatorResponse]{
			FinalStateVia: runtime.FinalStateViaAzureAsyncOp,
		})
	} else {
		return runtime.NewPollerFromResumeToken[ConfigurationsClientCreateOrUpdateCoordinatorResponse](options.ResumeToken, client.internal.Pipeline(), nil)
	}
}
...
//
// Generated from API version 2022-11-08
func (client *ConfigurationsClient) createOrUpdateCoordinator(ctx context.Context, resourceGroupName string, clusterName string, configurationName string, parameters ServerConfiguration, options *ConfigurationsClientBeginCreateOrUpdateCoordinatorOptions) (*http.Response, error) {
...
func (client *ConfigurationsClient) createOrUpdateCoordinatorCreateRequest(ctx context.Context, resourceGroupName string, clusterName string, configurationName string, parameters ServerConfiguration, options *ConfigurationsClientBeginCreateOrUpdateCoordinatorOptions) (*policy.Request, error) {
...
// BeginCreateOrUpdateNode - Updates configuration of worker nodes in a cluster
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2022-11-08
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
...
//     method.
func (client *ConfigurationsClient) BeginCreateOrUpdateNode(ctx context.Context, resourceGroupName string, clusterName string, configurationName string, parameters ServerConfiguration, options *ConfigurationsClientBeginCreateOrUpdateNodeOptions) (*runtime.Poller[ConfigurationsClientCreateOrUpdateNodeResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.createOrUpdateNode(ctx, resourceGroupName, clusterName, configurationName, parameters, options)
		if err != nil {
			return nil, err
		}
		return runtime.NewPoller(resp, client.internal.Pipeline(), &runtime.NewPollerOptions[ConfigurationsClientCreateOrUpdateNodeResponse]{
			FinalStateVia: runtime.FinalStateViaAzureAsyncOp,
		})
	} else {
		return runtime.NewPollerFromResumeToken[ConfigurationsClientCreateOrUpdateNodeResponse](options.ResumeToken, client.internal.Pipeline(), nil)
	}
}

// CreateOrUpdateNode - Updates configuration of worker nodes in a cluster
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2022-11-08
func (client *ConfigurationsClient) createOrUpdateNode(ctx context.Context, resourceGroupName string, clusterName string, configurationName string, parameters ServerConfiguration, options *ConfigurationsClientBeginCreateOrUpdateNodeOptions) (*http.Response, error) {
...
func (client *ConfigurationsClient) createOrUpdateNodeCreateRequest(ctx context.Context, resourceGroupName string, clusterName string, configurationName string, parameters ServerConfiguration, options *ConfigurationsClientBeginCreateOrUpdateNodeOptions) (*policy.Request, error) {
