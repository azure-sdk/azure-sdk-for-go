...
// PrivateEndpointConnectionsOperationResultsClient contains the methods for the PrivateEndpointConnectionsOperationResults
// group.
...
func (client *PrivateEndpointConnectionsOperationResultsClient) getCreateRequest(ctx context.Context, resourceGroupName string, accountName string, name string, operationID string, _ *PrivateEndpointConnectionsOperationResultsClientGetOptions) (*policy.Request, error) {
