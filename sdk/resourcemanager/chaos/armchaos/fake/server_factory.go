...
type ServerFactory struct {
	...
	// ExperimentExecutionsServer contains the fakes for client ExperimentExecutionsClient
	ExperimentExecutionsServer ExperimentExecutionsServer
...
type ServerFactoryTransport struct {
	...
	trExperimentExecutionsServer *ExperimentExecutionsServerTransport
...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "ExperimentExecutionsClient":
		initServer(s, &s.trExperimentExecutionsServer, func() *ExperimentExecutionsServerTransport {
			return NewExperimentExecutionsServerTransport(&s.srv.ExperimentExecutionsServer)
		})
		resp, err = s.trExperimentExecutionsServer.Do(req)
