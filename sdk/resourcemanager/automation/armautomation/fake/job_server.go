	...
	go func() {
		...
		if !intercepted {
			...
			case "JobClient.GetOutput":
				res.resp, res.err = j.dispatchGetOutput(req)
			case "JobClient.GetRunbookContent":
				res.resp, res.err = j.dispatchGetRunbookContent(req)
			...
			case "JobClient.Resume":
				res.resp, res.err = j.dispatchResume(req)
			case "JobClient.Stop":
				res.resp, res.err = j.dispatchStop(req)
			case "JobClient.Suspend":
				res.resp, res.err = j.dispatchSuspend(req)
			default:
