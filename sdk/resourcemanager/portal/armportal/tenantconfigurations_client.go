...
func (client *TenantConfigurationsClient) createCreateRequest(ctx context.Context, configurationName string, resource Configuration, _ *TenantConfigurationsClientCreateOptions) (*policy.Request, error) {
...
func (client *TenantConfigurationsClient) deleteCreateRequest(ctx context.Context, configurationName string, _ *TenantConfigurationsClientDeleteOptions) (*policy.Request, error) {
	urlPath := "/providers/Microsoft.Portal/tenantConfigurations/{configurationName}"
	if configurationName == "" {
		return nil, errors.New("parameter configurationName cannot be empty")
	}
...
func (client *TenantConfigurationsClient) getCreateRequest(ctx context.Context, configurationName string, _ *TenantConfigurationsClientGetOptions) (*policy.Request, error) {
	urlPath := "/providers/Microsoft.Portal/tenantConfigurations/{configurationName}"
	if configurationName == "" {
		return nil, errors.New("parameter configurationName cannot be empty")
	}
...
func (client *TenantConfigurationsClient) listCreateRequest(ctx context.Context, _ *TenantConfigurationsClientListOptions) (*policy.Request, error) {
