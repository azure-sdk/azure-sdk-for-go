...
func (a AddonVrProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "provisioningState", a.ProvisioningState)
	populate(objectMap, "replicationNetwork", a.ReplicationNetwork)
...
func (a *AddonVrProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "replicationNetwork":
			err = unpopulate(val, "ReplicationNetwork", &a.ReplicationNetwork)
			delete(rawMsg, key)
		case "vrsCount":
...
// MarshalJSON implements the json.Marshaller interface for type BlockedRescheduleConstraint.
func (b BlockedRescheduleConstraint) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "category", b.Category)
	objectMap["kind"] = RescheduleConstraintKindBlocked
	populate(objectMap, "timeRanges", b.TimeRanges)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type BlockedRescheduleConstraint.
func (b *BlockedRescheduleConstraint) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", b, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type BlockedRescheduleConstraintTimeRange.
func (b BlockedRescheduleConstraintTimeRange) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateDateTimeRFC3339(objectMap, "endAt", b.EndAt)
	populate(objectMap, "reason", b.Reason)
	populateDateTimeRFC3339(objectMap, "startAt", b.StartAt)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type BlockedRescheduleConstraintTimeRange.
func (b *BlockedRescheduleConstraintTimeRange) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", b, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "endAt":
			err = unpopulateDateTimeRFC3339(val, "EndAt", &b.EndAt)
			delete(rawMsg, key)
		case "reason":
			err = unpopulate(val, "Reason", &b.Reason)
			delete(rawMsg, key)
		case "startAt":
			err = unpopulateDateTimeRFC3339(val, "StartAt", &b.StartAt)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", b, err)
...
// MarshalJSON implements the json.Marshaller interface for type DeadlineRescheduleConstraint.
func (d DeadlineRescheduleConstraint) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateDateTimeRFC3339(objectMap, "deadline", d.Deadline)
	objectMap["kind"] = RescheduleConstraintKindDeadline
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type DeadlineRescheduleConstraint.
func (d *DeadlineRescheduleConstraint) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", d, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "deadline":
			err = unpopulateDateTimeRFC3339(val, "Deadline", &d.Deadline)
			delete(rawMsg, key)
		case "kind":
...
// MarshalJSON implements the json.Marshaller interface for type FreezeDaysRescheduleConstraint.
func (f FreezeDaysRescheduleConstraint) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	aux := make([]*dateType, len(f.FreezeDays), len(f.FreezeDays))
	for i := 0; i < len(f.FreezeDays); i++ {
		aux[i] = (*dateType)(f.FreezeDays[i])
	}
	populate(objectMap, "freezeDays", aux)
	objectMap["kind"] = RescheduleConstraintKindFreezeDays
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type FreezeDaysRescheduleConstraint.
func (f *FreezeDaysRescheduleConstraint) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
	...
	for key, val := range rawMsg {
		...
		case "freezeDays":
			var aux []*dateType
			err = unpopulate(val, "FreezeDays", &aux)
			for _, au := range aux {
				f.FreezeDays = append(f.FreezeDays, (*time.Time)(au))
			}
			delete(rawMsg, key)
		case "kind":
...
func (m MaintenanceProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "reschedule", m.Reschedule)
...
func (m *MaintenanceProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "provisioningState":
			...
			delete(rawMsg, key)
		case "reschedule":
			err = unpopulate(val, "Reschedule", &m.Reschedule)
			delete(rawMsg, key)
...
// MarshalJSON implements the json.Marshaller interface for type Reschedule.
func (r Reschedule) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type Reschedule.
func (r *Reschedule) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "constraints":
			r.Constraints, err = unmarshalRescheduleConstraintClassificationArray(val)
			delete(rawMsg, key)
		case "disabledReason":
...
// MarshalJSON implements the json.Marshaller interface for type RescheduleConstraint.
func (r RescheduleConstraint) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	objectMap["kind"] = r.Kind
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type RescheduleConstraint.
func (r *RescheduleConstraint) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", r, err)
	}
