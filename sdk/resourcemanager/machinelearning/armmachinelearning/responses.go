...
// WorkspacesClientListConnectionModelsResponse contains the response from method WorkspacesClient.ListConnectionModels.
type WorkspacesClientListConnectionModelsResponse struct {
	EndpointModels
}
