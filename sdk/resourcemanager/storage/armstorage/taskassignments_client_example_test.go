...
func ExampleTaskAssignmentsClient_NewListPager() {
	...
	pager := clientFactory.NewTaskAssignmentsClient().NewListPager("res4228", "sto4445", nil)
	for pager.More() {
		...
		// page = armstorage.TaskAssignmentsClientListResponse{
		// 	TaskAssignmentsList: armstorage.TaskAssignmentsList{
