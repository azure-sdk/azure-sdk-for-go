...
- New function `*SQLSitesControllerClient.ExportURI(context.Context, string, string, string, SQLInventoryImportBody, *SQLSitesControllerClientExportURIOptions) (SQLSitesControllerClientExportURIResponse, error)`
...
- New function `*SQLSitesControllerClient.BeginImportURI(context.Context, string, string, string, SQLInventoryImportBody, *SQLSitesControllerClientBeginImportURIOptions) (*runtime.Poller[SQLSitesControllerClientImportURIResponse], error)`
...
- New function `*SQLSitesControllerClient.ValidateAndImportURI(context.Context, string, string, string, SQLInventoryImportBody, *SQLSitesControllerClientValidateAndImportURIOptions) (SQLSitesControllerClientValidateAndImportURIResponse, error)`
