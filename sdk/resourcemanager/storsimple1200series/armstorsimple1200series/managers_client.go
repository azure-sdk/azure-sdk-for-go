...
func (client *ManagersClient) createExtendedInfoCreateRequest(ctx context.Context, resourceGroupName string, managerName string, managerExtendedInfo ManagerExtendedInfo, _ *ManagersClientCreateExtendedInfoOptions) (*policy.Request, error) {
...
func (client *ManagersClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, managerName string, manager Manager, _ *ManagersClientCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *ManagersClient) getEncryptionKeyCreateRequest(ctx context.Context, resourceGroupName string, managerName string, _ *ManagersClientGetEncryptionKeyOptions) (*policy.Request, error) {
...
func (client *ManagersClient) updateExtendedInfoCreateRequest(ctx context.Context, resourceGroupName string, managerName string, ifMatch string, managerExtendedInfo ManagerExtendedInfo, _ *ManagersClientUpdateExtendedInfoOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorSimple/managers/{managerName}/extendedInformation/vaultExtendedInfo"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *ManagersClient) uploadRegistrationCertificateCreateRequest(ctx context.Context, certificateName string, resourceGroupName string, managerName string, uploadCertificateRequestrequest UploadCertificateRequest, _ *ManagersClientUploadRegistrationCertificateOptions) (*policy.Request, error) {
