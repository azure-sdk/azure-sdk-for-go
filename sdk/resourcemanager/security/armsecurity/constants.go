...
const (
	// ApplicationConditionOperatorEquals - Checks that the string value of the data defined in Property equals any of the given
	// values (exact fit)
	ApplicationConditionOperatorEquals ApplicationConditionOperator = "Equals"
	// ApplicationConditionOperatorIn - Checks that the string value of the data defined in Property contains the given value
...
// StateForAlertNotifications - Defines if email notifications will be sent about new security alerts
...
// PossibleStateForAlertNotificationsValues returns the possible values for the StateForAlertNotifications const type.
func PossibleStateForAlertNotificationsValues() []StateForAlertNotifications {
	return []StateForAlertNotifications{
		StateForAlertNotificationsOff,
		StateForAlertNotificationsOn,
	}
}

// StateForNotificationsByRole - Defines whether to send email notifications from AMicrosoft Defender for Cloud to persons
...
// PossibleStateForNotificationsByRoleValues returns the possible values for the StateForNotificationsByRole const type.
func PossibleStateForNotificationsByRoleValues() []StateForNotificationsByRole {
	return []StateForNotificationsByRole{
		StateForNotificationsByRoleOff,
		StateForNotificationsByRoleOn,
	}
}
