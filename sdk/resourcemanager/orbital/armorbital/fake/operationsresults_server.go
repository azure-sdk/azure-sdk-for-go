...
type OperationsResultsServer struct {
	...
	Get func(ctx context.Context, location string, operationID string, options *armorbital.OperationsResultsClientGetOptions) (resp azfake.Responder[armorbital.OperationsResultsClientGetResponse], errResp azfake.ErrorResponder)
}
