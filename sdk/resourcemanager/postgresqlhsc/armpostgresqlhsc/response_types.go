...
// ServerGroupClientPromoteReadReplicaResponse contains the response from method ServerGroupClient.PromoteReadReplica.
type ServerGroupClientPromoteReadReplicaResponse struct {
	// placeholder for future response values
}
