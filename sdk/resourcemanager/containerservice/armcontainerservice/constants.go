...
// AdvancedNetworkPolicies - This allows users to configure Layer 7 network policies (FQDN, HTTP, Kafka). Policies themselves
...
const (
	...
	// SchedulerConfigModeNone - No config customization. Use default configuration.
	SchedulerConfigModeNone SchedulerConfigMode = "None"
)
