...
type SapLandscapeMonitorServer struct {
	...
	// NewListPager is the fake for method SapLandscapeMonitorClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(resourceGroupName string, monitorName string, options *armworkloads.SapLandscapeMonitorClientListOptions) (resp azfake.PagerResponder[armworkloads.SapLandscapeMonitorClientListResponse])
...
func NewSapLandscapeMonitorServerTransport(srv *SapLandscapeMonitorServer) *SapLandscapeMonitorServerTransport {
	return &SapLandscapeMonitorServerTransport{
		srv:          srv,
		newListPager: newTracker[azfake.PagerResponder[armworkloads.SapLandscapeMonitorClientListResponse]](),
	}
}
...
type SapLandscapeMonitorServerTransport struct {
	...
	newListPager *tracker[azfake.PagerResponder[armworkloads.SapLandscapeMonitorClientListResponse]]
}
...
func (s *SapLandscapeMonitorServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	case "SapLandscapeMonitorClient.NewListPager":
...
func (s *SapLandscapeMonitorServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armworkloads.SapLandscapeMonitorClientListResponse, createLink func() string) {
