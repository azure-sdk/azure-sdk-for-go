...
// only at the time of ordering the newer generation device i.e. DataBoxV2x100 and
// DataBoxV2x500 as of May/2024
...
const (
	...
	// ModelNameDataBoxV2X100 - Data Box V2 100TB.
	ModelNameDataBoxV2X100 ModelName = "DataBoxV2x100"
	// ModelNameDataBoxV2X500 - Data Box V2 500TB.
	ModelNameDataBoxV2X500 ModelName = "DataBoxV2x500"
)
...
func PossibleModelNameValues() []ModelName {
	return []ModelName{
		...
		ModelNameDataBoxV2X100,
		ModelNameDataBoxV2X500,
	}
}
