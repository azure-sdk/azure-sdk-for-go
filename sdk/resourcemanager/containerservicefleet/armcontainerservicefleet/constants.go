...
// GateTargetType - The type of the Gate target.
type GateTargetType string

const (
	// GateTargetTypeUpdateRun - The Gate targets an Update Run.
	GateTargetTypeUpdateRun GateTargetType = "UpdateRun"
)

// PossibleGateTargetTypeValues returns the possible values for the GateTargetType const type.
func PossibleGateTargetTypeValues() []GateTargetType {
	return []GateTargetType{
		GateTargetTypeUpdateRun,
	}
}
