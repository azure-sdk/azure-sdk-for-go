...
//   - options - SessionHostConfigurationsClientCreateOrUpdateOptions contains the optional parameters for the SessionHostConfigurationsClient.CreateOrUpdate
//     method.
func (client *SessionHostConfigurationsClient) CreateOrUpdate(ctx context.Context, resourceGroupName string, hostPoolName string, sessionHostConfiguration SessionHostConfiguration, options *SessionHostConfigurationsClientCreateOrUpdateOptions) (SessionHostConfigurationsClientCreateOrUpdateResponse, error) {
	var err error
	const operationName = "SessionHostConfigurationsClient.CreateOrUpdate"
	...
	if err != nil {
		return SessionHostConfigurationsClientCreateOrUpdateResponse{}, err
	}
...
func (client *SessionHostConfigurationsClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, hostPoolName string, sessionHostConfiguration SessionHostConfiguration, options *SessionHostConfigurationsClientCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *SessionHostConfigurationsClient) createOrUpdateHandleResponse(resp *http.Response) (SessionHostConfigurationsClientCreateOrUpdateResponse, error) {
	result := SessionHostConfigurationsClientCreateOrUpdateResponse{}
