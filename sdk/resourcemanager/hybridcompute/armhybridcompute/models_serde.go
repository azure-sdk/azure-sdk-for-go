...
// MarshalJSON implements the json.Marshaller interface for type LicenseValidateModel.
func (l LicenseValidateModel) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "location", l.Location)
	populate(objectMap, "name", l.Name)
	populate(objectMap, "properties", l.Properties)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type LicenseValidateModel.
func (l *LicenseValidateModel) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", l, err)
	}
