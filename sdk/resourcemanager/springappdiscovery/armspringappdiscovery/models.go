...
// ErrorSummaryListResult - The response of a ErrorSummary list operation.
type ErrorSummaryListResult struct {
...
// SpringbootappsModelListResult - The response of a SpringbootappsModel list operation.
type SpringbootappsModelListResult struct {
	// REQUIRED; The SpringbootappsModel items on this page
...
// SpringbootserversModelListResult - The response of a SpringbootserversModel list operation.
type SpringbootserversModelListResult struct {
	// REQUIRED; The SpringbootserversModel items on this page
...
// SpringbootsitesModelListResult - The response of a SpringbootsitesModel list operation.
type SpringbootsitesModelListResult struct {
	// REQUIRED; The SpringbootsitesModel items on this page
...
// SummaryListResult - The response of a Summary list operation.
