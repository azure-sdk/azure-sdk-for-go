...
// NewReplicationInfrastructureClient creates a new instance of ReplicationInfrastructureClient.
func (c *ClientFactory) NewReplicationInfrastructureClient() *ReplicationInfrastructureClient {
	subClient, _ := NewReplicationInfrastructureClient(c.subscriptionID, c.credential, c.options)
	return subClient
}
