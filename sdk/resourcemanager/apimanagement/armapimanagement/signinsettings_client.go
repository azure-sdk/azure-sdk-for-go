...
// resourceGroupName - The name of the resource group.
// serviceName - The name of the API Management service.
// options - SignInSettingsClientHeadOptions contains the optional parameters for the SignInSettingsClient.Head method.
func (client *SignInSettingsClient) Head(ctx context.Context, resourceGroupName string, serviceName string, options *SignInSettingsClientHeadOptions) (SignInSettingsClientHeadResponse, error) {
	req, err := client.headCreateRequest(ctx, resourceGroupName, serviceName, options)
	if err != nil {
		return SignInSettingsClientHeadResponse{}, err
	}
	resp, err := client.pl.Do(req)
	if err != nil {
		return SignInSettingsClientHeadResponse{}, err
	...
	if !runtime.HasStatusCode(resp, http.StatusOK) {
		return SignInSettingsClientHeadResponse{}, runtime.NewResponseError(resp)
	}
	return client.headHandleResponse(resp)
}

// headCreateRequest creates the Head request.
func (client *SignInSettingsClient) headCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, options *SignInSettingsClientHeadOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/portalsettings/signin"
	if resourceGroupName == "" {
		return nil, errors.New("parameter resourceGroupName cannot be empty")
	}
...
func (client *SignInSettingsClient) headHandleResponse(resp *http.Response) (SignInSettingsClientHeadResponse, error) {
	result := SignInSettingsClientHeadResponse{}
	if val := resp.Header.Get("ETag"); val != "" {
		result.ETag = &val
	}
