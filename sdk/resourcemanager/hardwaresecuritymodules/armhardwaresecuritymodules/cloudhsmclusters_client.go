...
// BeginValidateBackup - Pre Backup operation to validate whether the customer can perform a backup on the Cloud HSM Cluster
...
//   - cloudHsmClusterName - The name of the Cloud HSM Cluster within the specified resource group. Cloud HSM Cluster names must
//     be between 3 and 23 characters in length.
//   - options - CloudHsmClustersClientBeginValidateBackupOptions contains the optional parameters for the CloudHsmClustersClient.BeginValidateBackup
//     method.
func (client *CloudHsmClustersClient) BeginValidateBackup(ctx context.Context, resourceGroupName string, cloudHsmClusterName string, options *CloudHsmClustersClientBeginValidateBackupOptions) (*runtime.Poller[CloudHsmClustersClientValidateBackupResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.validateBackup(ctx, resourceGroupName, cloudHsmClusterName, options)
		if err != nil {
			return nil, err
		}
		poller, err := runtime.NewPoller(resp, client.internal.Pipeline(), &runtime.NewPollerOptions[CloudHsmClustersClientValidateBackupResponse]{
			FinalStateVia: runtime.FinalStateViaAzureAsyncOp,
			Tracer:        client.internal.Tracer(),
		})
		return poller, err
	} else {
		return runtime.NewPollerFromResumeToken(options.ResumeToken, client.internal.Pipeline(), &runtime.NewPollerFromResumeTokenOptions[CloudHsmClustersClientValidateBackupResponse]{
			Tracer: client.internal.Tracer(),
		})
	}
}

// ValidateBackup - Pre Backup operation to validate whether the customer can perform a backup on the Cloud HSM Cluster resource
// in the specified subscription.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2024-06-30
func (client *CloudHsmClustersClient) validateBackup(ctx context.Context, resourceGroupName string, cloudHsmClusterName string, options *CloudHsmClustersClientBeginValidateBackupOptions) (*http.Response, error) {
	var err error
	const operationName = "CloudHsmClustersClient.BeginValidateBackup"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.validateBackupCreateRequest(ctx, resourceGroupName, cloudHsmClusterName, options)
	if err != nil {
		return nil, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
...
func (client *CloudHsmClustersClient) validateBackupCreateRequest(ctx context.Context, resourceGroupName string, cloudHsmClusterName string, options *CloudHsmClustersClientBeginValidateBackupOptions) (*policy.Request, error) {
...
// BeginValidateRestore - Queued validating pre restore operation
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2024-06-30
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - cloudHsmClusterName - The name of the Cloud HSM Cluster within the specified resource group. Cloud HSM Cluster names must
//     be between 3 and 23 characters in length.
//   - options - CloudHsmClustersClientBeginValidateRestoreOptions contains the optional parameters for the CloudHsmClustersClient.BeginValidateRestore
//     method.
func (client *CloudHsmClustersClient) BeginValidateRestore(ctx context.Context, resourceGroupName string, cloudHsmClusterName string, options *CloudHsmClustersClientBeginValidateRestoreOptions) (*runtime.Poller[CloudHsmClustersClientValidateRestoreResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.validateRestore(ctx, resourceGroupName, cloudHsmClusterName, options)
		if err != nil {
			return nil, err
		}
		poller, err := runtime.NewPoller(resp, client.internal.Pipeline(), &runtime.NewPollerOptions[CloudHsmClustersClientValidateRestoreResponse]{
			FinalStateVia: runtime.FinalStateViaAzureAsyncOp,
			Tracer:        client.internal.Tracer(),
		})
		return poller, err
	} else {
		return runtime.NewPollerFromResumeToken(options.ResumeToken, client.internal.Pipeline(), &runtime.NewPollerFromResumeTokenOptions[CloudHsmClustersClientValidateRestoreResponse]{
			Tracer: client.internal.Tracer(),
		})
	}
}

// ValidateRestore - Queued validating pre restore operation
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2024-06-30
func (client *CloudHsmClustersClient) validateRestore(ctx context.Context, resourceGroupName string, cloudHsmClusterName string, options *CloudHsmClustersClientBeginValidateRestoreOptions) (*http.Response, error) {
	var err error
	const operationName = "CloudHsmClustersClient.BeginValidateRestore"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.validateRestoreCreateRequest(ctx, resourceGroupName, cloudHsmClusterName, options)
	if err != nil {
		return nil, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
...
// validateRestoreCreateRequest creates the ValidateRestore request.
func (client *CloudHsmClustersClient) validateRestoreCreateRequest(ctx context.Context, resourceGroupName string, cloudHsmClusterName string, options *CloudHsmClustersClientBeginValidateRestoreOptions) (*policy.Request, error) {
