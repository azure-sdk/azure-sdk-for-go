...
const (
	...
	CPUThresholdOneHundred CPUThreshold = "100"
...
type ConfigurationNameAutoGenerated string

const (
	ConfigurationNameAutoGeneratedDuration ConfigurationNameAutoGenerated = "duration"
)

// PossibleConfigurationNameAutoGeneratedValues returns the possible values for the ConfigurationNameAutoGenerated const type.
func PossibleConfigurationNameAutoGeneratedValues() []ConfigurationNameAutoGenerated {
	return []ConfigurationNameAutoGenerated{
		ConfigurationNameAutoGeneratedDuration,
	}
}
