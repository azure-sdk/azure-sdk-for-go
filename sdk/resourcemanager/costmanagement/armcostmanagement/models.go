...
type BenefitRecommendationProperties struct {
	// REQUIRED; Scope of the benefit. For example, Single or Shared.
	Scope *Scope `json:"scope,omitempty"`

	// Grain of the proposed commitment amount. For example, hourly, monthly etc.
	CommitmentGranularity *Grain `json:"commitmentGranularity,omitempty"`

	// The number of days of usage used to look back for computing the recommendation.
	...
	// READ-ONLY; ARM SKU name. For example, StandardD1V2 for Reservations and ComputeSavingsPlan for SavingsPlan.
...
type BenefitUtilizationSummaryProperties struct {
	// The benefit type. For example, reservation or savings plan
	BenefitType *BenefitKind `json:"benefitType,omitempty"`

	// READ-ONLY; ARM SKU name. For example, StandardD1V2 for reservations and ComputeSavingsPlan for savings plan.
	ArmSKUName *string `json:"armSkuName,omitempty" azure:"ro"`
...
type RecommendationUsageDetails struct {
	// The grain of the usage. For example, hourly or monthly etc.
