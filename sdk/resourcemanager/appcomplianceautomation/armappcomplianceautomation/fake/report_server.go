...
func (r *ReportServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if reportServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = reportServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "ReportClient.BeginFix":
				res.resp, res.err = r.dispatchBeginFix(req)
			case "ReportClient.Get":
				res.resp, res.err = r.dispatchGet(req)
			case "ReportClient.GetScopingQuestions":
				res.resp, res.err = r.dispatchGetScopingQuestions(req)
			...
			case "ReportClient.NestedResourceCheckNameAvailability":
				res.resp, res.err = r.dispatchNestedResourceCheckNameAvailability(req)
			case "ReportClient.BeginSyncCertRecord":
				res.resp, res.err = r.dispatchBeginSyncCertRecord(req)
			case "ReportClient.BeginUpdate":
				res.resp, res.err = r.dispatchBeginUpdate(req)
			case "ReportClient.BeginVerify":
				res.resp, res.err = r.dispatchBeginVerify(req)
			default:
...
// set this to conditionally intercept incoming requests to ReportServerTransport
var reportServerTransportInterceptor interface {
