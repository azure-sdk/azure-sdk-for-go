...
type TagRulesServer struct {
	...
	CreateOrUpdate func(ctx context.Context, resourceGroupName string, monitorName string, ruleSetName string, options *armdatadog.TagRulesClientCreateOrUpdateOptions) (resp azfake.Responder[armdatadog.TagRulesClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)
...
func (t *TagRulesServerTransport) dispatchCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	var options *armdatadog.TagRulesClientCreateOrUpdateOptions
	if !reflect.ValueOf(body).IsZero() {
		options = &armdatadog.TagRulesClientCreateOrUpdateOptions{
			Body: &body,
		}
	}
