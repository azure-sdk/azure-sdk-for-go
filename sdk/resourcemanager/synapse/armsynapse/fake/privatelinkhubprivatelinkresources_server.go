...
func (p *PrivateLinkHubPrivateLinkResourcesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if privateLinkHubPrivateLinkResourcesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = privateLinkHubPrivateLinkResourcesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to PrivateLinkHubPrivateLinkResourcesServerTransport
var privateLinkHubPrivateLinkResourcesServerTransportInterceptor interface {
