...
func (d *DataManagerForAgricultureExtensionsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if dataManagerForAgricultureExtensionsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = dataManagerForAgricultureExtensionsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to DataManagerForAgricultureExtensionsServerTransport
var dataManagerForAgricultureExtensionsServerTransportInterceptor interface {
