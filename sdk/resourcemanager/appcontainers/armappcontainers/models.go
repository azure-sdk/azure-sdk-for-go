...
// HTTPRouteConfigPatch - Advanced Ingress routing for path/header based routing for a Container App Environment
type HTTPRouteConfigPatch struct {
	// Http Route Config properties
...
// HTTPRouteConfigPatchProperties - Http Route Config properties
type HTTPRouteConfigPatchProperties struct {
...
// ManagedHTTPRouteConfigCollection - Collection of Advanced Ingress Routing Config resources.
type ManagedHTTPRouteConfigCollection struct {
	// REQUIRED; Collection of resources.
...
// ManagedHTTPRoutePatch - A Http Route Config to update
type ManagedHTTPRoutePatch struct {
	// Application-specific metadata in the form of key-value pairs.
	Tags map[string]*string
}
