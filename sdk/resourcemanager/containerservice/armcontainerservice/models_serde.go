...
func (m ManagedClusterSecurityProfile) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "azureDefender", m.AzureDefender)
...
func (m *ManagedClusterSecurityProfile) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "azureDefender":
			err = unpopulate(val, "AzureDefender", &m.AzureDefender)
			delete(rawMsg, key)
...
// MarshalJSON implements the json.Marshaller interface for type ManagedClusterSecurityProfileAzureDefender.
func (m ManagedClusterSecurityProfileAzureDefender) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "enabled", m.Enabled)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type ManagedClusterSecurityProfileAzureDefender.
func (m *ManagedClusterSecurityProfileAzureDefender) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", m, err)
	}
