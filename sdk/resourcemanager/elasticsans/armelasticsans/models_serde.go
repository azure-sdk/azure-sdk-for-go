...
func (r ResourceTypeSKU) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "elasticSan", r.ElasticSan)
...
func (r *ResourceTypeSKU) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "elasticSan":
			err = unpopulate(val, "ElasticSan", &r.ElasticSan)
			delete(rawMsg, key)
		case "locationInfo":
		...
		case "sku":
			...
			delete(rawMsg, key)
		case "volume":
			err = unpopulate(val, "Volume", &r.Volume)
			delete(rawMsg, key)
		case "volumeGroup":
			err = unpopulate(val, "VolumeGroup", &r.VolumeGroup)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", r, err)
...
// MarshalJSON implements the json.Marshaller interface for type SanTierInfo.
func (s SanTierInfo) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "iopsPerBaseTiB", s.IopsPerBaseTiB)
	populate(objectMap, "maxMBps", s.MaxMBps)
	populate(objectMap, "maxSizeTiB", s.MaxSizeTiB)
	populate(objectMap, "maxVolumeGroupCount", s.MaxVolumeGroupCount)
	populate(objectMap, "mbpsPerBaseTiB", s.MbpsPerBaseTiB)
	populate(objectMap, "minIncrementSizeTiB", s.MinIncrementSizeTiB)
	populate(objectMap, "minSizeTiB", s.MinSizeTiB)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type SanTierInfo.
func (s *SanTierInfo) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "iopsPerBaseTiB":
			err = unpopulate(val, "IopsPerBaseTiB", &s.IopsPerBaseTiB)
			delete(rawMsg, key)
		case "maxMBps":
			err = unpopulate(val, "MaxMBps", &s.MaxMBps)
			delete(rawMsg, key)
		case "maxSizeTiB":
			err = unpopulate(val, "MaxSizeTiB", &s.MaxSizeTiB)
			delete(rawMsg, key)
		case "maxVolumeGroupCount":
			err = unpopulate(val, "MaxVolumeGroupCount", &s.MaxVolumeGroupCount)
			delete(rawMsg, key)
		case "mbpsPerBaseTiB":
			err = unpopulate(val, "MbpsPerBaseTiB", &s.MbpsPerBaseTiB)
			delete(rawMsg, key)
		case "minIncrementSizeTiB":
			err = unpopulate(val, "MinIncrementSizeTiB", &s.MinIncrementSizeTiB)
			delete(rawMsg, key)
		case "minSizeTiB":
			err = unpopulate(val, "MinSizeTiB", &s.MinSizeTiB)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", s, err)
...
// MarshalJSON implements the json.Marshaller interface for type VolumeGroupTierInfo.
func (v VolumeGroupTierInfo) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "maxVolumeCount", v.MaxVolumeCount)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type VolumeGroupTierInfo.
func (v *VolumeGroupTierInfo) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", v, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "maxVolumeCount":
			err = unpopulate(val, "MaxVolumeCount", &v.MaxVolumeCount)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", v, err)
...
// MarshalJSON implements the json.Marshaller interface for type VolumeTierInfo.
func (v VolumeTierInfo) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "iopsPerBaseGiB", v.IopsPerBaseGiB)
	populate(objectMap, "maxIops", v.MaxIops)
	populate(objectMap, "maxMBps", v.MaxMBps)
	populate(objectMap, "maxSizeGiB", v.MaxSizeGiB)
	populate(objectMap, "minIncrementSizeGiB", v.MinIncrementSizeGiB)
	populate(objectMap, "minSizeGiB", v.MinSizeGiB)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type VolumeTierInfo.
func (v *VolumeTierInfo) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", v, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "iopsPerBaseGiB":
			err = unpopulate(val, "IopsPerBaseGiB", &v.IopsPerBaseGiB)
			delete(rawMsg, key)
		case "maxIops":
			err = unpopulate(val, "MaxIops", &v.MaxIops)
			delete(rawMsg, key)
		case "maxMBps":
			err = unpopulate(val, "MaxMBps", &v.MaxMBps)
			delete(rawMsg, key)
		case "maxSizeGiB":
			err = unpopulate(val, "MaxSizeGiB", &v.MaxSizeGiB)
			delete(rawMsg, key)
		case "minIncrementSizeGiB":
			err = unpopulate(val, "MinIncrementSizeGiB", &v.MinIncrementSizeGiB)
			delete(rawMsg, key)
		case "minSizeGiB":
			err = unpopulate(val, "MinSizeGiB", &v.MinSizeGiB)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", v, err)
