...
type NotificationHubResource struct {
	...
	// READ-ONLY; Notification Hub name
	Name *string
...
type PrivateLinkResource struct {
	...
	// READ-ONLY; Name of the Private Link sub-resource. The only supported sub-resource is "namespace"
	Name *string
...
type SharedAccessAuthorizationRuleResource struct {
	...
	// READ-ONLY; Authorization Rule Name
	Name     *string
	Location *string
	Tags     map[string]*string
