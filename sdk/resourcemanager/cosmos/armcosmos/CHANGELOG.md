...
## 3.0.0-beta.5 (2024-04-16)
### Breaking Changes

- Type of `DataTransferJobProperties.Error` has been changed from `*ErrorResponse` to `*ErrorResponseAutoGenerated`
- Function `*CassandraClustersClient.GetCommandAsync` has been removed
- Function `*CassandraClustersClient.BeginInvokeCommandAsync` has been removed
...
- New function `*CassandraClustersClient.GetAsyncCommand(context.Context, string, string, string, *CassandraClustersClientGetAsyncCommandOptions) (CassandraClustersClientGetAsyncCommandResponse, error)`
...
- New function `*CassandraClustersClient.BeginInvokeAsyncCommand(context.Context, string, string, CommandPostBody, *CassandraClustersClientBeginInvokeAsyncCommandOptions) (*runtime.Poller[CassandraClustersClientInvokeAsyncCommandResponse], error)`
