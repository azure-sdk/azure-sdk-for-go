...
func (client *NetworkDeviceSKUsClient) getCreateRequest(ctx context.Context, networkDeviceSKUName string, _ *NetworkDeviceSKUsClientGetOptions) (*policy.Request, error) {
