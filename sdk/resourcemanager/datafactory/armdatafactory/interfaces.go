...
// - *OrcSource, *ParquetSource, *PaypalSource, *PhoenixSource, *PostgreSQLSource, *PrestoSource, *QuickBooksSource, *RelationalSource,
...
// - *ServiceNowLinkedService, *ServiceNowV2LinkedService, *SftpServerLinkedService, *SharePointOnlineListLinkedService, *ShopifyLinkedService,
// - *SmartsheetLinkedService, *SnowflakeLinkedService, *SnowflakeV2LinkedService, *SparkLinkedService, *SquareLinkedService,
...
// - *PrestoSource, *QuickBooksSource, *ResponsysSource, *SQLDWSource, *SQLMISource, *SQLServerSource, *SQLSource, *SalesforceMarketingCloudSource,
// - *SalesforceSource, *SalesforceV2Source, *SapBwSource, *SapCloudForCustomerSource, *SapEccSource, *SapHanaSource, *SapOdpSource,
// - *SapOpenHubSource, *SapTableSource, *ServiceNowSource, *ServiceNowV2Source, *ShopifySource, *SparkSource, *SquareSource,
// - *SybaseSource, *TabularSource, *TeradataSource, *VerticaSource, *WarehouseSource, *XeroSource, *ZohoSource
