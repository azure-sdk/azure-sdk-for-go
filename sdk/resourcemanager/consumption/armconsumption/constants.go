...
// OrgType - The organization type of the lot.
type OrgType string

const (
	// OrgTypeContributorOrgType - Contributor organization type for Multi-Entity consumption commitment.
	OrgTypeContributorOrgType OrgType = "Contributor"
	// OrgTypePrimaryOrgType - Primary organization type for Multi-Entity consumption commitment.
	OrgTypePrimaryOrgType OrgType = "Primary"
)

// PossibleOrgTypeValues returns the possible values for the OrgType const type.
func PossibleOrgTypeValues() []OrgType {
	return []OrgType{
		OrgTypeContributorOrgType,
		OrgTypePrimaryOrgType,
	}
}
