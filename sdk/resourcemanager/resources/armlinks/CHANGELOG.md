...
- Function `NewResourceLinksClient` has been removed
- Function `*ResourceLinksClient.CreateOrUpdate` has been removed
- Function `*ResourceLinksClient.Delete` has been removed
- Function `*ResourceLinksClient.Get` has been removed
- Function `*ResourceLinksClient.NewListAtSourceScopePager` has been removed
- Function `*ResourceLinksClient.NewListAtSubscriptionPager` has been removed
- Struct `Operation` has been removed
- Struct `OperationDisplay` has been removed
- Struct `OperationListResult` has been removed
- Struct `ResourceLink` has been removed
- Struct `ResourceLinkFilter` has been removed
- Struct `ResourceLinkProperties` has been removed
- Struct `ResourceLinkResult` has been removed
