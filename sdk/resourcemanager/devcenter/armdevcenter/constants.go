...
// AzureAiServicesEnableStatus - Indicates whether Azure AI services are enabled for a project.
type AzureAiServicesEnableStatus string

const (
	AzureAiServicesEnableStatusDisabled AzureAiServicesEnableStatus = "Disabled"
	AzureAiServicesEnableStatusEnabled  AzureAiServicesEnableStatus = "Enabled"
)

// PossibleAzureAiServicesEnableStatusValues returns the possible values for the AzureAiServicesEnableStatus const type.
func PossibleAzureAiServicesEnableStatusValues() []AzureAiServicesEnableStatus {
	return []AzureAiServicesEnableStatus{
		AzureAiServicesEnableStatusDisabled,
		AzureAiServicesEnableStatusEnabled,
	}
}
...
// DevBoxAutoDeleteEnableStatus - Indicates whether auto delete is enabled.
type DevBoxAutoDeleteEnableStatus string

const (
	DevBoxAutoDeleteEnableStatusDisabled DevBoxAutoDeleteEnableStatus = "Disabled"
	DevBoxAutoDeleteEnableStatusEnabled  DevBoxAutoDeleteEnableStatus = "Enabled"
)

// PossibleDevBoxAutoDeleteEnableStatusValues returns the possible values for the DevBoxAutoDeleteEnableStatus const type.
func PossibleDevBoxAutoDeleteEnableStatusValues() []DevBoxAutoDeleteEnableStatus {
	return []DevBoxAutoDeleteEnableStatus{
		DevBoxAutoDeleteEnableStatusDisabled,
		DevBoxAutoDeleteEnableStatusEnabled,
	}
}
...
// ServerlessGpuSessionsEnableStatus - Indicates whether serverless GPU session access is enabled.
type ServerlessGpuSessionsEnableStatus string

const (
	ServerlessGpuSessionsEnableStatusDisabled ServerlessGpuSessionsEnableStatus = "Disabled"
	ServerlessGpuSessionsEnableStatusEnabled  ServerlessGpuSessionsEnableStatus = "Enabled"
)

// PossibleServerlessGpuSessionsEnableStatusValues returns the possible values for the ServerlessGpuSessionsEnableStatus const type.
func PossibleServerlessGpuSessionsEnableStatusValues() []ServerlessGpuSessionsEnableStatus {
	return []ServerlessGpuSessionsEnableStatus{
		ServerlessGpuSessionsEnableStatusDisabled,
		ServerlessGpuSessionsEnableStatusEnabled,
	}
}
...
// WorkspaceStorageEnableStatus - Indicates whether workspace storage is enabled.
type WorkspaceStorageEnableStatus string

const (
	WorkspaceStorageEnableStatusDisabled WorkspaceStorageEnableStatus = "Disabled"
	WorkspaceStorageEnableStatusEnabled  WorkspaceStorageEnableStatus = "Enabled"
)

// PossibleWorkspaceStorageEnableStatusValues returns the possible values for the WorkspaceStorageEnableStatus const type.
func PossibleWorkspaceStorageEnableStatusValues() []WorkspaceStorageEnableStatus {
	return []WorkspaceStorageEnableStatus{
		WorkspaceStorageEnableStatusDisabled,
		WorkspaceStorageEnableStatusEnabled,
	}
}
