...
func (client *ServicePrincipalsClient) getCreateRequest(ctx context.Context, _ *ServicePrincipalsClientGetOptions) (*policy.Request, error) {
...
func (client *ServicePrincipalsClient) listBySubscriptionCreateRequest(ctx context.Context, _ *ServicePrincipalsClientListBySubscriptionOptions) (*policy.Request, error) {
