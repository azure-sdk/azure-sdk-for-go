...
type ConfigurationsServer struct {
	...
	CreateOrUpdate func(ctx context.Context, resourceGroupName string, resourceName string, resource armmaintenance.Configuration, options *armmaintenance.ConfigurationsClientCreateOrUpdateOptions) (resp azfake.Responder[armmaintenance.ConfigurationsClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)
	...
	// HTTP status codes to indicate success: http.StatusOK
	Update func(ctx context.Context, resourceGroupName string, resourceName string, properties armmaintenance.Configuration, options *armmaintenance.ConfigurationsClientUpdateOptions) (resp azfake.Responder[armmaintenance.ConfigurationsClientUpdateResponse], errResp azfake.ErrorResponder)
}
