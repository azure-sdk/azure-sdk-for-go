...
func (p *ProtectionPolicyOperationResultsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if protectionPolicyOperationResultsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = protectionPolicyOperationResultsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to ProtectionPolicyOperationResultsServerTransport
var protectionPolicyOperationResultsServerTransportInterceptor interface {
