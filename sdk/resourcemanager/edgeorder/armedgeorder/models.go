...
type AddressResource struct {
	...
	// READ-ONLY; The name of the address Resource within the specified resource group. address names must be between 3 and 24
...
type OrderItemResource struct {
	...
	// READ-ONLY; The name of the order item.
	Name *string
...
type OrderResource struct {
	...
	// READ-ONLY; The name of the order.
	Name *string
