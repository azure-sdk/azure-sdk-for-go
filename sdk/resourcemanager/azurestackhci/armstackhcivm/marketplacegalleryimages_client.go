...
func (client *MarketplaceGalleryImagesClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, marketplaceGalleryImageName string, resource MarketplaceGalleryImage, options *MarketplaceGalleryImagesClientBeginCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *MarketplaceGalleryImagesClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, options *MarketplaceGalleryImagesClientListByResourceGroupOptions) (*policy.Request, error) {
...
func (client *MarketplaceGalleryImagesClient) updateCreateRequest(ctx context.Context, resourceGroupName string, marketplaceGalleryImageName string, properties MarketplaceGalleryImageTagsUpdate, options *MarketplaceGalleryImagesClientBeginUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureStackHCI/marketplaceGalleryImages/{marketplaceGalleryImageName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
