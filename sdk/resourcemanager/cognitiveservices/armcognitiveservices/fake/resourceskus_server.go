...
// The returned ResourceSKUsServerTransport instance is connected to an instance of armcognitiveservices.ResourceSKUsClient via the
...
func NewResourceSKUsServerTransport(srv *ResourceSKUsServer) *ResourceSKUsServerTransport {
	return &ResourceSKUsServerTransport{
		srv:          srv,
		newListPager: newTracker[azfake.PagerResponder[armcognitiveservices.ResourceSKUsClientListResponse]](),
	}
}

// ResourceSKUsServerTransport connects instances of armcognitiveservices.ResourceSKUsClient to instances of ResourceSKUsServer.
...
type ResourceSKUsServerTransport struct {
	...
	newListPager *tracker[azfake.PagerResponder[armcognitiveservices.ResourceSKUsClientListResponse]]
}
...
func (r *ResourceSKUsServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.CognitiveServices/skus`
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armcognitiveservices.ResourceSKUsClientListResponse, createLink func() string) {
