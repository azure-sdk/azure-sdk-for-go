...
type ManagedGatewaysServer struct {
	...
	CreateOrUpdate func(ctx context.Context, resourceGroupName string, instanceName string, managedGatewayName string, resource armscom.ManagedGateway, options *armscom.ManagedGatewaysClientCreateOrUpdateOptions) (resp azfake.Responder[armscom.ManagedGatewaysClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)

	// Delete is the fake for method ManagedGatewaysClient.Delete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	Delete func(ctx context.Context, resourceGroupName string, instanceName string, managedGatewayName string, options *armscom.ManagedGatewaysClientDeleteOptions) (resp azfake.Responder[armscom.ManagedGatewaysClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method ManagedGatewaysClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, instanceName string, managedGatewayName string, options *armscom.ManagedGatewaysClientGetOptions) (resp azfake.Responder[armscom.ManagedGatewaysClientGetResponse], errResp azfake.ErrorResponder)

	// NewListByManagedInstancePager is the fake for method ManagedGatewaysClient.NewListByManagedInstancePager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByManagedInstancePager func(resourceGroupName string, instanceName string, options *armscom.ManagedGatewaysClientListByManagedInstanceOptions) (resp azfake.PagerResponder[armscom.ManagedGatewaysClientListByManagedInstanceResponse])
}
...
func (m *ManagedGatewaysServerTransport) dispatchCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[armscom.ManagedGateway](req)
	if err != nil {
		return nil, err
	}
	...
	managedGatewayNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("managedGatewayName")])
	if err != nil {
		return nil, err
	}
	respr, errRespr := m.srv.CreateOrUpdate(req.Context(), resourceGroupNameParam, instanceNameParam, managedGatewayNameParam, body, nil)
...
func (m *ManagedGatewaysServerTransport) dispatchDelete(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := m.srv.Delete(req.Context(), resourceGroupNameParam, instanceNameParam, managedGatewayNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (m *ManagedGatewaysServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := m.srv.Get(req.Context(), resourceGroupNameParam, instanceNameParam, managedGatewayNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (m *ManagedGatewaysServerTransport) dispatchNewListByManagedInstancePager(req *http.Request) (*http.Response, error) {
	...
	if newListByManagedInstancePager == nil {
		...
		resp := m.srv.NewListByManagedInstancePager(resourceGroupNameParam, instanceNameParam, nil)
