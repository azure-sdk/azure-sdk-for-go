...
// MarshalJSON implements the json.Marshaller interface for type QuickTemplateRequest.
func (q QuickTemplateRequest) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "instanceName", q.InstanceName)
	populate(objectMap, "quickStartTemplateType", q.QuickStartTemplateType)
	populate(objectMap, "stageName", q.StageName)
	populate(objectMap, "templateName", q.TemplateName)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type QuickTemplateRequest.
func (q *QuickTemplateRequest) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "instanceName":
			err = unpopulate(val, "InstanceName", &q.InstanceName)
			delete(rawMsg, key)
		case "quickStartTemplateType":
			err = unpopulate(val, "QuickStartTemplateType", &q.QuickStartTemplateType)
			delete(rawMsg, key)
		case "stageName":
			err = unpopulate(val, "StageName", &q.StageName)
			delete(rawMsg, key)
		case "templateName":
			err = unpopulate(val, "TemplateName", &q.TemplateName)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", q, err)
