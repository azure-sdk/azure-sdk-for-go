...
func (a *AllowedConnectionsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if allowedConnectionsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = allowedConnectionsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "AllowedConnectionsClient.NewListByHomeRegionPager":
				res.resp, res.err = a.dispatchNewListByHomeRegionPager(req)
			default:
...
// set this to conditionally intercept incoming requests to AllowedConnectionsServerTransport
var allowedConnectionsServerTransportInterceptor interface {
