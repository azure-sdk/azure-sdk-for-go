...
func (g *GatewayCustomDomainsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if gatewayCustomDomainsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = gatewayCustomDomainsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to GatewayCustomDomainsServerTransport
var gatewayCustomDomainsServerTransportInterceptor interface {
