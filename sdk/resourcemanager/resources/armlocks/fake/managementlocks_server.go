...
func (m *ManagementLocksServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if managementLocksServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = managementLocksServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			case "ManagementLocksClient.CreateOrUpdateAtResourceGroupLevel":
				res.resp, res.err = m.dispatchCreateOrUpdateAtResourceGroupLevel(req)
			case "ManagementLocksClient.CreateOrUpdateAtResourceLevel":
				res.resp, res.err = m.dispatchCreateOrUpdateAtResourceLevel(req)
			case "ManagementLocksClient.CreateOrUpdateAtSubscriptionLevel":
				res.resp, res.err = m.dispatchCreateOrUpdateAtSubscriptionLevel(req)
			case "ManagementLocksClient.CreateOrUpdateByScope":
				res.resp, res.err = m.dispatchCreateOrUpdateByScope(req)
			case "ManagementLocksClient.DeleteAtResourceGroupLevel":
				res.resp, res.err = m.dispatchDeleteAtResourceGroupLevel(req)
			case "ManagementLocksClient.DeleteAtResourceLevel":
				res.resp, res.err = m.dispatchDeleteAtResourceLevel(req)
			case "ManagementLocksClient.DeleteAtSubscriptionLevel":
				res.resp, res.err = m.dispatchDeleteAtSubscriptionLevel(req)
			case "ManagementLocksClient.DeleteByScope":
				res.resp, res.err = m.dispatchDeleteByScope(req)
			case "ManagementLocksClient.GetAtResourceGroupLevel":
				res.resp, res.err = m.dispatchGetAtResourceGroupLevel(req)
			case "ManagementLocksClient.GetAtResourceLevel":
				res.resp, res.err = m.dispatchGetAtResourceLevel(req)
			case "ManagementLocksClient.GetAtSubscriptionLevel":
				res.resp, res.err = m.dispatchGetAtSubscriptionLevel(req)
			case "ManagementLocksClient.GetByScope":
				res.resp, res.err = m.dispatchGetByScope(req)
			case "ManagementLocksClient.NewListAtResourceGroupLevelPager":
				res.resp, res.err = m.dispatchNewListAtResourceGroupLevelPager(req)
			case "ManagementLocksClient.NewListAtResourceLevelPager":
				res.resp, res.err = m.dispatchNewListAtResourceLevelPager(req)
			case "ManagementLocksClient.NewListAtSubscriptionLevelPager":
				res.resp, res.err = m.dispatchNewListAtSubscriptionLevelPager(req)
...
// set this to conditionally intercept incoming requests to ManagementLocksServerTransport
var managementLocksServerTransportInterceptor interface {
