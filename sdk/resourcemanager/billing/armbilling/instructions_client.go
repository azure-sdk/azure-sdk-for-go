...
func NewInstructionsClient(credential azcore.TokenCredential, options *arm.ClientOptions) (*InstructionsClient, error) {
	cl, err := arm.NewClient(moduleName+".InstructionsClient", moduleVersion, credential, options)
	if err != nil {
		return nil, err
	}
...
//   - billingAccountName - The ID that uniquely identifies a billing account.
//   - billingProfileName - The ID that uniquely identifies a billing profile.
//   - options - InstructionsClientListByBillingProfileOptions contains the optional parameters for the InstructionsClient.NewListByBillingProfilePager
//     method.
