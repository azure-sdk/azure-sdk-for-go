...
type ExecutionTarget struct {
	// REQUIRED; Required list of object prefixes to be included for task execution
	Prefix []*string
...
// ExecutionTargetUpdate - Target helps provide filter parameters for the objects in the storage account and forms the execution
// context for the storage task
...
type TaskAssignmentExecutionContext struct {
	// REQUIRED; Execution target of the storage task assignment
