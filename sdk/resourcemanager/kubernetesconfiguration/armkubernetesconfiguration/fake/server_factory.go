...
type ServerFactory struct {
	...
	// FluxConfigurationsServer contains the fakes for client FluxConfigurationsClient
	...
	// SourceControlConfigurationsServer contains the fakes for client SourceControlConfigurationsClient
