...
func (client *ExtendedUeInformationClient) getCreateRequest(ctx context.Context, resourceGroupName string, packetCoreControlPlaneName string, ueID string, _ *ExtendedUeInformationClientGetOptions) (*policy.Request, error) {
