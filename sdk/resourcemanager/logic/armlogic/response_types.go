...
// LocationsClientValidateWorkflowExportResponse contains the response from method LocationsClient.ValidateWorkflowExport.
type LocationsClientValidateWorkflowExportResponse struct {
	// The workflow export validity result.
	WorkflowExportValidityResult
}

// LocationsClientWorkflowExportResponse contains the response from method LocationsClient.WorkflowExport.
type LocationsClientWorkflowExportResponse struct {
