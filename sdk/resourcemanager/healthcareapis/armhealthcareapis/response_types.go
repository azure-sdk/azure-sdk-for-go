...
// AnalyticsConnectorsClientCreateOrUpdateResponse contains the response from method AnalyticsConnectorsClient.BeginCreateOrUpdate.
type AnalyticsConnectorsClientCreateOrUpdateResponse struct {
	AnalyticsConnector
}

// AnalyticsConnectorsClientDeleteResponse contains the response from method AnalyticsConnectorsClient.BeginDelete.
type AnalyticsConnectorsClientDeleteResponse struct {
	// placeholder for future response values
}

// AnalyticsConnectorsClientGetResponse contains the response from method AnalyticsConnectorsClient.Get.
type AnalyticsConnectorsClientGetResponse struct {
	AnalyticsConnector
}

// AnalyticsConnectorsClientListByWorkspaceResponse contains the response from method AnalyticsConnectorsClient.NewListByWorkspacePager.
type AnalyticsConnectorsClientListByWorkspaceResponse struct {
	AnalyticsConnectorCollection
}

// AnalyticsConnectorsClientUpdateResponse contains the response from method AnalyticsConnectorsClient.BeginUpdate.
type AnalyticsConnectorsClientUpdateResponse struct {
	AnalyticsConnector
}
