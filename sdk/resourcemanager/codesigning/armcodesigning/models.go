...
type AccountProperties struct {
	...
	// READ-ONLY; The URI of the code signing account for performing operations on certificate profiles.
	AccountURI *string

	// READ-ONLY; Status of the current operation on code signing account.
	ProvisioningState *ProvisioningState
}

// AccountSKU - SKU of the code signing account.
