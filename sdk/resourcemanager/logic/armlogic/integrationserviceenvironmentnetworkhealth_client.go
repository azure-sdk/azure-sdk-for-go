...
func (client *IntegrationServiceEnvironmentNetworkHealthClient) getCreateRequest(ctx context.Context, resourceGroup string, integrationServiceEnvironmentName string, _ *IntegrationServiceEnvironmentNetworkHealthClientGetOptions) (*policy.Request, error) {
