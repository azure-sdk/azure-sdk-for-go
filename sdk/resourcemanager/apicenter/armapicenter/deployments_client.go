...
func (client *DeploymentsClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, workspaceName string, apiName string, deploymentName string, resource Deployment, _ *DeploymentsClientCreateOrUpdateOptions) (*policy.Request, error) {
