...
func (p *PrivateEndpointConnectionsPrivateLinkHubServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if privateEndpointConnectionsPrivateLinkHubServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = privateEndpointConnectionsPrivateLinkHubServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to PrivateEndpointConnectionsPrivateLinkHubServerTransport
var privateEndpointConnectionsPrivateLinkHubServerTransportInterceptor interface {
