...
// BenchmarkReferenceAutoGenerated - Benchmark reference
type BenchmarkReferenceAutoGenerated struct {
	// READ-ONLY; The name of the Benchmark (i.e. CIS, NIST, etc.)
	Benchmark *string

	// READ-ONLY; Reference within the benchmark, if applicable
	Reference *string
}
...
// JitNetworkAccessPolicyInitiatePort - A port to open access for. The model should contain either allowedSourceAddressPrefix
// or allowedSourceAddressPrefixes, but not both. The Model should contain either duration or endTimeUtc, but not
// both.
...
type SQLServerVulnerabilityProperties struct {
	...
	// READ-ONLY; Specifies the benchmark references
	Benchmarks []*BenchmarkReferenceAutoGenerated

	// READ-ONLY; Time of last reported scan (UTC)
	LastReportedScanTime *time.Time
