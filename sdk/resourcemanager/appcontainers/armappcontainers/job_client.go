...
func (client *JobClient) BeginRun(ctx context.Context, resourceGroupName string, jobName string, options *JobClientBeginRunOptions) (*runtime.Poller[JobClientRunResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.run(ctx, resourceGroupName, jobName, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2022-11-01-preview
func (client *JobClient) run(ctx context.Context, resourceGroupName string, jobName string, options *JobClientBeginRunOptions) (*http.Response, error) {
	req, err := client.runCreateRequest(ctx, resourceGroupName, jobName, options)
	if err != nil {
		return nil, err
	}
	resp, err := client.pl.Do(req)
...
func (client *JobClient) runCreateRequest(ctx context.Context, resourceGroupName string, jobName string, options *JobClientBeginRunOptions) (*policy.Request, error) {
...
// BeginTerminate - Terminates execution of a running container apps job
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2022-11-01-preview
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - jobName - Name of the Container Apps Job.
//   - options - JobClientBeginTerminateOptions contains the optional parameters for the JobClient.BeginTerminate method.
func (client *JobClient) BeginTerminate(ctx context.Context, resourceGroupName string, jobName string, options *JobClientBeginTerminateOptions) (*runtime.Poller[JobClientTerminateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.terminate(ctx, resourceGroupName, jobName, options)
		if err != nil {
			return nil, err
		}
		return runtime.NewPoller(resp, client.pl, &runtime.NewPollerOptions[JobClientTerminateResponse]{
			FinalStateVia: runtime.FinalStateViaLocation,
		})
	} else {
		return runtime.NewPollerFromResumeToken[JobClientTerminateResponse](options.ResumeToken, client.pl, nil)
	}
}

// Terminate - Terminates execution of a running container apps job
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2022-11-01-preview
func (client *JobClient) terminate(ctx context.Context, resourceGroupName string, jobName string, options *JobClientBeginTerminateOptions) (*http.Response, error) {
	req, err := client.terminateCreateRequest(ctx, resourceGroupName, jobName, options)
	if err != nil {
		return nil, err
	}
	resp, err := client.pl.Do(req)
...
// terminateCreateRequest creates the Terminate request.
func (client *JobClient) terminateCreateRequest(ctx context.Context, resourceGroupName string, jobName string, options *JobClientBeginTerminateOptions) (*policy.Request, error) {
