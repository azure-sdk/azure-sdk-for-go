...
func (client *PrivateEndpointConnectionsClient) createOrUpdateHandleResponse(resp *http.Response) (PrivateEndpointConnectionsClientCreateOrUpdateResponse, error) {
	...
	case http.StatusBadRequest:
		var val ErrorResponse
		if err := runtime.UnmarshalAsJSON(resp, &val); err != nil {
			return PrivateEndpointConnectionsClientCreateOrUpdateResponse{}, err
		}
		result.Value = val
	default:
		return PrivateEndpointConnectionsClientCreateOrUpdateResponse{}, fmt.Errorf("unhandled HTTP status code %d", resp.StatusCode)
	}
	return result, nil
}
...
func (client *PrivateEndpointConnectionsClient) getHandleResponse(resp *http.Response) (PrivateEndpointConnectionsClientGetResponse, error) {
	...
	case http.StatusNotFound:
		...
		result.Value = val
	default:
		return PrivateEndpointConnectionsClientGetResponse{}, fmt.Errorf("unhandled HTTP status code %d", resp.StatusCode)
	}
	return result, nil
}
