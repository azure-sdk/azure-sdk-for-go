...
// VcenterControllerServer is a fake server for instances of the armmigrationdiscovery.VcenterControllerClient type.
type VcenterControllerServer struct {
	// BeginCreate is the fake for method VcenterControllerClient.BeginCreate
	// HTTP status codes to indicate success: http.StatusOK, http.StatusCreated
	BeginCreate func(ctx context.Context, resourceGroupName string, siteName string, vcenterName string, body armmigrationdiscovery.Vcenter, options *armmigrationdiscovery.VcenterControllerClientBeginCreateOptions) (resp azfake.PollerResponder[armmigrationdiscovery.VcenterControllerClientCreateResponse], errResp azfake.ErrorResponder)

	// Delete is the fake for method VcenterControllerClient.Delete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	Delete func(ctx context.Context, resourceGroupName string, siteName string, vcenterName string, options *armmigrationdiscovery.VcenterControllerClientDeleteOptions) (resp azfake.Responder[armmigrationdiscovery.VcenterControllerClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method VcenterControllerClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, siteName string, vcenterName string, options *armmigrationdiscovery.VcenterControllerClientGetOptions) (resp azfake.Responder[armmigrationdiscovery.VcenterControllerClientGetResponse], errResp azfake.ErrorResponder)

	// NewListByVmwareSitePager is the fake for method VcenterControllerClient.NewListByVmwareSitePager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByVmwareSitePager func(resourceGroupName string, siteName string, options *armmigrationdiscovery.VcenterControllerClientListByVmwareSiteOptions) (resp azfake.PagerResponder[armmigrationdiscovery.VcenterControllerClientListByVmwareSiteResponse])
}
...
// The returned VcenterControllerServerTransport instance is connected to an instance of armmigrationdiscovery.VcenterControllerClient via the
...
func NewVcenterControllerServerTransport(srv *VcenterControllerServer) *VcenterControllerServerTransport {
	return &VcenterControllerServerTransport{
		srv:                      srv,
		beginCreate:              newTracker[azfake.PollerResponder[armmigrationdiscovery.VcenterControllerClientCreateResponse]](),
		newListByVmwareSitePager: newTracker[azfake.PagerResponder[armmigrationdiscovery.VcenterControllerClientListByVmwareSiteResponse]](),
	}
}

// VcenterControllerServerTransport connects instances of armmigrationdiscovery.VcenterControllerClient to instances of VcenterControllerServer.
...
type VcenterControllerServerTransport struct {
	...
	beginCreate              *tracker[azfake.PollerResponder[armmigrationdiscovery.VcenterControllerClientCreateResponse]]
	newListByVmwareSitePager *tracker[azfake.PagerResponder[armmigrationdiscovery.VcenterControllerClientListByVmwareSiteResponse]]
}
...
func (v *VcenterControllerServerTransport) dispatchBeginCreate(req *http.Request) (*http.Response, error) {
	...
	if beginCreate == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armmigrationdiscovery.Vcenter](req)
		if err != nil {
			return nil, err
		}
...
func (v *VcenterControllerServerTransport) dispatchNewListByVmwareSitePager(req *http.Request) (*http.Response, error) {
	...
	if newListByVmwareSitePager == nil {
		...
		var options *armmigrationdiscovery.VcenterControllerClientListByVmwareSiteOptions
		if filterParam != nil {
			options = &armmigrationdiscovery.VcenterControllerClientListByVmwareSiteOptions{
				Filter: filterParam,
			}
		}
		...
		server.PagerResponderInjectNextLinks(newListByVmwareSitePager, req, func(page *armmigrationdiscovery.VcenterControllerClientListByVmwareSiteResponse, createLink func() string) {
