...
func (k *KustoPoolsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if kustoPoolsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = kustoPoolsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			case "KustoPoolsClient.BeginAddLanguageExtensions":
				res.resp, res.err = k.dispatchBeginAddLanguageExtensions(req)
			...
			case "KustoPoolsClient.BeginDetachFollowerDatabases":
				res.resp, res.err = k.dispatchBeginDetachFollowerDatabases(req)
			case "KustoPoolsClient.Get":
				res.resp, res.err = k.dispatchGet(req)
			case "KustoPoolsClient.ListByWorkspace":
				res.resp, res.err = k.dispatchListByWorkspace(req)
			case "KustoPoolsClient.NewListFollowerDatabasesPager":
				res.resp, res.err = k.dispatchNewListFollowerDatabasesPager(req)
			case "KustoPoolsClient.NewListLanguageExtensionsPager":
				res.resp, res.err = k.dispatchNewListLanguageExtensionsPager(req)
			case "KustoPoolsClient.NewListSKUsPager":
				res.resp, res.err = k.dispatchNewListSKUsPager(req)
			case "KustoPoolsClient.NewListSKUsByResourcePager":
				res.resp, res.err = k.dispatchNewListSKUsByResourcePager(req)
			case "KustoPoolsClient.BeginRemoveLanguageExtensions":
				res.resp, res.err = k.dispatchBeginRemoveLanguageExtensions(req)
			case "KustoPoolsClient.BeginStart":
				res.resp, res.err = k.dispatchBeginStart(req)
			case "KustoPoolsClient.BeginStop":
				res.resp, res.err = k.dispatchBeginStop(req)
...
// set this to conditionally intercept incoming requests to KustoPoolsServerTransport
var kustoPoolsServerTransportInterceptor interface {
