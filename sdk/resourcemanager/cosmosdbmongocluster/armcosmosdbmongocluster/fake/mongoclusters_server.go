...
// MongoClustersServer is a fake server for instances of the armcosmosdbmongocluster.MongoClustersClient type.
type MongoClustersServer struct {
	...
	CheckNameAvailability func(ctx context.Context, location string, body armcosmosdbmongocluster.CheckNameAvailabilityRequest, options *armcosmosdbmongocluster.MongoClustersClientCheckNameAvailabilityOptions) (resp azfake.Responder[armcosmosdbmongocluster.MongoClustersClientCheckNameAvailabilityResponse], errResp azfake.ErrorResponder)

	// BeginCreateOrUpdate is the fake for method MongoClustersClient.BeginCreateOrUpdate
	// HTTP status codes to indicate success: http.StatusOK, http.StatusCreated
	BeginCreateOrUpdate func(ctx context.Context, resourceGroupName string, mongoClusterName string, resource armcosmosdbmongocluster.MongoCluster, options *armcosmosdbmongocluster.MongoClustersClientBeginCreateOrUpdateOptions) (resp azfake.PollerResponder[armcosmosdbmongocluster.MongoClustersClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)

	// BeginDelete is the fake for method MongoClustersClient.BeginDelete
	// HTTP status codes to indicate success: http.StatusAccepted, http.StatusNoContent
	BeginDelete func(ctx context.Context, resourceGroupName string, mongoClusterName string, options *armcosmosdbmongocluster.MongoClustersClientBeginDeleteOptions) (resp azfake.PollerResponder[armcosmosdbmongocluster.MongoClustersClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method MongoClustersClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, mongoClusterName string, options *armcosmosdbmongocluster.MongoClustersClientGetOptions) (resp azfake.Responder[armcosmosdbmongocluster.MongoClustersClientGetResponse], errResp azfake.ErrorResponder)

	// NewListPager is the fake for method MongoClustersClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(options *armcosmosdbmongocluster.MongoClustersClientListOptions) (resp azfake.PagerResponder[armcosmosdbmongocluster.MongoClustersClientListResponse])

	// NewListByResourceGroupPager is the fake for method MongoClustersClient.NewListByResourceGroupPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByResourceGroupPager func(resourceGroupName string, options *armcosmosdbmongocluster.MongoClustersClientListByResourceGroupOptions) (resp azfake.PagerResponder[armcosmosdbmongocluster.MongoClustersClientListByResourceGroupResponse])

	// ListConnectionStrings is the fake for method MongoClustersClient.ListConnectionStrings
	// HTTP status codes to indicate success: http.StatusOK
	ListConnectionStrings func(ctx context.Context, resourceGroupName string, mongoClusterName string, options *armcosmosdbmongocluster.MongoClustersClientListConnectionStringsOptions) (resp azfake.Responder[armcosmosdbmongocluster.MongoClustersClientListConnectionStringsResponse], errResp azfake.ErrorResponder)

	// BeginUpdate is the fake for method MongoClustersClient.BeginUpdate
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginUpdate func(ctx context.Context, resourceGroupName string, mongoClusterName string, properties armcosmosdbmongocluster.MongoClusterUpdate, options *armcosmosdbmongocluster.MongoClustersClientBeginUpdateOptions) (resp azfake.PollerResponder[armcosmosdbmongocluster.MongoClustersClientUpdateResponse], errResp azfake.ErrorResponder)
}

// NewMongoClustersServerTransport creates a new instance of MongoClustersServerTransport with the provided implementation.
// The returned MongoClustersServerTransport instance is connected to an instance of armcosmosdbmongocluster.MongoClustersClient via the
...
func NewMongoClustersServerTransport(srv *MongoClustersServer) *MongoClustersServerTransport {
	return &MongoClustersServerTransport{
		srv:                         srv,
		beginCreateOrUpdate:         newTracker[azfake.PollerResponder[armcosmosdbmongocluster.MongoClustersClientCreateOrUpdateResponse]](),
		beginDelete:                 newTracker[azfake.PollerResponder[armcosmosdbmongocluster.MongoClustersClientDeleteResponse]](),
		newListPager:                newTracker[azfake.PagerResponder[armcosmosdbmongocluster.MongoClustersClientListResponse]](),
		newListByResourceGroupPager: newTracker[azfake.PagerResponder[armcosmosdbmongocluster.MongoClustersClientListByResourceGroupResponse]](),
		beginUpdate:                 newTracker[azfake.PollerResponder[armcosmosdbmongocluster.MongoClustersClientUpdateResponse]](),
	}
}

// MongoClustersServerTransport connects instances of armcosmosdbmongocluster.MongoClustersClient to instances of MongoClustersServer.
...
type MongoClustersServerTransport struct {
	...
	beginCreateOrUpdate         *tracker[azfake.PollerResponder[armcosmosdbmongocluster.MongoClustersClientCreateOrUpdateResponse]]
	beginDelete                 *tracker[azfake.PollerResponder[armcosmosdbmongocluster.MongoClustersClientDeleteResponse]]
	newListPager                *tracker[azfake.PagerResponder[armcosmosdbmongocluster.MongoClustersClientListResponse]]
	newListByResourceGroupPager *tracker[azfake.PagerResponder[armcosmosdbmongocluster.MongoClustersClientListByResourceGroupResponse]]
	beginUpdate                 *tracker[azfake.PollerResponder[armcosmosdbmongocluster.MongoClustersClientUpdateResponse]]
}
...
func (m *MongoClustersServerTransport) dispatchCheckNameAvailability(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[armcosmosdbmongocluster.CheckNameAvailabilityRequest](req)
	if err != nil {
		return nil, err
	}
...
func (m *MongoClustersServerTransport) dispatchBeginCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginCreateOrUpdate == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armcosmosdbmongocluster.MongoCluster](req)
		if err != nil {
			return nil, err
		}
...
func (m *MongoClustersServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armcosmosdbmongocluster.MongoClustersClientListResponse, createLink func() string) {
...
func (m *MongoClustersServerTransport) dispatchNewListByResourceGroupPager(req *http.Request) (*http.Response, error) {
	...
	if newListByResourceGroupPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListByResourceGroupPager, req, func(page *armcosmosdbmongocluster.MongoClustersClientListByResourceGroupResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
...
func (m *MongoClustersServerTransport) dispatchBeginUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginUpdate == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armcosmosdbmongocluster.MongoClusterUpdate](req)
		if err != nil {
			return nil, err
		}
		resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
