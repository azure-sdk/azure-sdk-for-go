...
func ExampleApplicationTypesClient_CreateOrUpdate() {
	...
	res, err := clientFactory.NewApplicationTypesClient().CreateOrUpdate(ctx, "resRg", "myCluster", "myAppType", nil)
	if err != nil {
...
func ExampleApplicationTypesClient_Update() {
	...
	res, err := clientFactory.NewApplicationTypesClient().Update(ctx, "resRg", "myCluster", "myAppType", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
