...
type ServerFactory struct {
	...
	AttackPatternServer                      AttackPatternServer
	AttackPatternsServer                     AttackPatternsServer
	...
	IndicatorServer                          IndicatorServer
	IndicatorsServer                         IndicatorsServer
	...
	ThreatActorServer                        ThreatActorServer
	ThreatActorsServer                       ThreatActorsServer
...
type ServerFactoryTransport struct {
	...
	trAttackPatternServer                      *AttackPatternServerTransport
	trAttackPatternsServer                     *AttackPatternsServerTransport
	...
	trIdentitiesServer                         *IdentitiesServerTransport
	trIdentityServer                           *IdentityServerTransport
	...
	trIndicatorServer                          *IndicatorServerTransport
	trIndicatorsServer                         *IndicatorsServerTransport
	...
	trRelationshipServer                       *RelationshipServerTransport
	...
	trThreatActorServer                        *ThreatActorServerTransport
	trThreatActorsServer                       *ThreatActorsServerTransport
...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "AttackPatternClient":
		initServer(s, &s.trAttackPatternServer, func() *AttackPatternServerTransport {
			return NewAttackPatternServerTransport(&s.srv.AttackPatternServer)
		})
		resp, err = s.trAttackPatternServer.Do(req)
	case "AttackPatternsClient":
		initServer(s, &s.trAttackPatternsServer, func() *AttackPatternsServerTransport {
			return NewAttackPatternsServerTransport(&s.srv.AttackPatternsServer)
		})
		resp, err = s.trAttackPatternsServer.Do(req)
	...
	case "IdentitiesClient":
		initServer(s, &s.trIdentitiesServer, func() *IdentitiesServerTransport { return NewIdentitiesServerTransport(&s.srv.IdentitiesServer) })
		resp, err = s.trIdentitiesServer.Do(req)
	case "IdentityClient":
		initServer(s, &s.trIdentityServer, func() *IdentityServerTransport { return NewIdentityServerTransport(&s.srv.IdentityServer) })
		resp, err = s.trIdentityServer.Do(req)
	...
	case "IndicatorClient":
		initServer(s, &s.trIndicatorServer, func() *IndicatorServerTransport { return NewIndicatorServerTransport(&s.srv.IndicatorServer) })
		resp, err = s.trIndicatorServer.Do(req)
	case "IndicatorsClient":
		initServer(s, &s.trIndicatorsServer, func() *IndicatorsServerTransport { return NewIndicatorsServerTransport(&s.srv.IndicatorsServer) })
		resp, err = s.trIndicatorsServer.Do(req)
	case "MetadataClient":
	...
	case "RelationshipClient":
		initServer(s, &s.trRelationshipServer, func() *RelationshipServerTransport { return NewRelationshipServerTransport(&s.srv.RelationshipServer) })
		resp, err = s.trRelationshipServer.Do(req)
	...
	case "ThreatActorClient":
		initServer(s, &s.trThreatActorServer, func() *ThreatActorServerTransport { return NewThreatActorServerTransport(&s.srv.ThreatActorServer) })
		resp, err = s.trThreatActorServer.Do(req)
	case "ThreatActorsClient":
		initServer(s, &s.trThreatActorsServer, func() *ThreatActorsServerTransport { return NewThreatActorsServerTransport(&s.srv.ThreatActorsServer) })
		resp, err = s.trThreatActorsServer.Do(req)
