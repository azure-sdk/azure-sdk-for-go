...
func (client *AlertsClient) clearCreateRequest(ctx context.Context, resourceGroupName string, managerName string, parameters ClearAlertRequest, _ *AlertsClientClearOptions) (*policy.Request, error) {
...
func (client *AlertsClient) sendTestEmailCreateRequest(ctx context.Context, deviceName string, resourceGroupName string, managerName string, parameters SendTestAlertEmailRequest, _ *AlertsClientSendTestEmailOptions) (*policy.Request, error) {
