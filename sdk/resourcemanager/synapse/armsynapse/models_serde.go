...
// MarshalJSON implements the json.Marshaller interface for type IntergrationruntimesOperationStatus.
func (i IntergrationruntimesOperationStatus) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "id", i.ID)
	populate(objectMap, "location", i.Location)
	populate(objectMap, "name", i.Name)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type IntergrationruntimesOperationStatus.
func (i *IntergrationruntimesOperationStatus) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", i, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type IntergrationruntimesOperationStatusProperties.
func (i IntergrationruntimesOperationStatusProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
...
// UnmarshalJSON implements the json.Unmarshaller interface for type IntergrationruntimesOperationStatusProperties.
func (i *IntergrationruntimesOperationStatusProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", i, err)
	}
