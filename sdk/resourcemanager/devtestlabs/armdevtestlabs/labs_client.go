...
func (client *LabsClient) BeginClaimAnyVM(ctx context.Context, resourceGroupName string, name string, options *LabsClientBeginClaimAnyVMOptions) (*runtime.Poller[LabsClientClaimAnyVMResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return runtime.NewPoller(resp, client.internal.Pipeline(), &runtime.NewPollerOptions[LabsClientClaimAnyVMResponse]{
			FinalStateVia: runtime.FinalStateViaLocation,
		})
	} else {
		return runtime.NewPollerFromResumeToken[LabsClientClaimAnyVMResponse](options.ResumeToken, client.internal.Pipeline(), nil)
	}
}
...
func (client *LabsClient) BeginCreateEnvironment(ctx context.Context, resourceGroupName string, name string, labVirtualMachineCreationParameter LabVirtualMachineCreationParameter, options *LabsClientBeginCreateEnvironmentOptions) (*runtime.Poller[LabsClientCreateEnvironmentResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return runtime.NewPoller(resp, client.internal.Pipeline(), &runtime.NewPollerOptions[LabsClientCreateEnvironmentResponse]{
			FinalStateVia: runtime.FinalStateViaLocation,
		})
	} else {
		return runtime.NewPollerFromResumeToken[LabsClientCreateEnvironmentResponse](options.ResumeToken, client.internal.Pipeline(), nil)
	}
}
...
// EnsureCurrentUserProfile - Ensure the current user has a valid profile in the lab.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2021-09-01
//   - resourceGroupName - The name of the resource group.
//   - name - The name of the lab.
//   - options - LabsClientEnsureCurrentUserProfileOptions contains the optional parameters for the LabsClient.EnsureCurrentUserProfile
//     method.
func (client *LabsClient) EnsureCurrentUserProfile(ctx context.Context, resourceGroupName string, name string, options *LabsClientEnsureCurrentUserProfileOptions) (LabsClientEnsureCurrentUserProfileResponse, error) {
	req, err := client.ensureCurrentUserProfileCreateRequest(ctx, resourceGroupName, name, options)
	if err != nil {
		return LabsClientEnsureCurrentUserProfileResponse{}, err
	}
	resp, err := client.internal.Pipeline().Do(req)
	if err != nil {
		return LabsClientEnsureCurrentUserProfileResponse{}, err
	...
	if !runtime.HasStatusCode(resp, http.StatusOK) {
		return LabsClientEnsureCurrentUserProfileResponse{}, runtime.NewResponseError(resp)
	}
	return LabsClientEnsureCurrentUserProfileResponse{}, nil
}

// ensureCurrentUserProfileCreateRequest creates the EnsureCurrentUserProfile request.
func (client *LabsClient) ensureCurrentUserProfileCreateRequest(ctx context.Context, resourceGroupName string, name string, options *LabsClientEnsureCurrentUserProfileOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs/{name}/ensureCurrentUserProfile"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{subscriptionId}", url.PathEscape(client.subscriptionID))
...
func (client *LabsClient) BeginExportResourceUsage(ctx context.Context, resourceGroupName string, name string, exportResourceUsageParameters ExportResourceUsageParameters, options *LabsClientBeginExportResourceUsageOptions) (*runtime.Poller[LabsClientExportResourceUsageResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return runtime.NewPoller(resp, client.internal.Pipeline(), &runtime.NewPollerOptions[LabsClientExportResourceUsageResponse]{
			FinalStateVia: runtime.FinalStateViaLocation,
		})
	} else {
		return runtime.NewPollerFromResumeToken[LabsClientExportResourceUsageResponse](options.ResumeToken, client.internal.Pipeline(), nil)
	}
}
...
func (client *LabsClient) BeginImportVirtualMachine(ctx context.Context, resourceGroupName string, name string, importLabVirtualMachineRequest ImportLabVirtualMachineRequest, options *LabsClientBeginImportVirtualMachineOptions) (*runtime.Poller[LabsClientImportVirtualMachineResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return runtime.NewPoller(resp, client.internal.Pipeline(), &runtime.NewPollerOptions[LabsClientImportVirtualMachineResponse]{
			FinalStateVia: runtime.FinalStateViaLocation,
		})
	} else {
		return runtime.NewPollerFromResumeToken[LabsClientImportVirtualMachineResponse](options.ResumeToken, client.internal.Pipeline(), nil)
	}
}
...
//   - resourceGroupName - The name of the resource group.
//   - name - The name of the lab.
//   - lab - Allows modifying tags of labs. All other properties will be ignored.
