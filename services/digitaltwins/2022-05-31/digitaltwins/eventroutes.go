...
func (client EventRoutesClient) Add(ctx context.Context, ID string, eventRoute EventRoute, traceparent string, tracestate string) (result autorest.Response, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: eventRoute,
			Constraints: []validation.Constraint{{Target: "eventRoute.EndpointName", Name: validation.Null, Rule: true, Chain: nil},
				{Target: "eventRoute.Filter", Name: validation.Null, Rule: true, Chain: nil}}}}); err != nil {
