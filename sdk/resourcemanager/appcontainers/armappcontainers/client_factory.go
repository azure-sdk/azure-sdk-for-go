...
// NewContainerAppsLabelsClient creates a new instance of ContainerAppsLabelsClient.
func (c *ClientFactory) NewContainerAppsLabelsClient() *ContainerAppsLabelsClient {
	subClient, _ := NewContainerAppsLabelsClient(c.subscriptionID, c.credential, c.options)
	return subClient
}
