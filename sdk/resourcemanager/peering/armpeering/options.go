...
// ResourceMoveClientMoveResourcesOptions contains the optional parameters for the ResourceMoveClient.MoveResources method.
type ResourceMoveClientMoveResourcesOptions struct {
	// placeholder for future optional parameters
}

// ResourceMoveClientValidateMoveResourcesOptions contains the optional parameters for the ResourceMoveClient.ValidateMoveResources
// method.
type ResourceMoveClientValidateMoveResourcesOptions struct {
	// placeholder for future optional parameters
}
