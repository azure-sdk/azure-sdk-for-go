...
type SecurityPoliciesInterfaceServer struct {
	...
	// NewListByResourceGroupPager is the fake for method SecurityPoliciesInterfaceClient.NewListByResourceGroupPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByResourceGroupPager func(resourceGroupName string, trafficControllerName string, options *armservicenetworking.SecurityPoliciesInterfaceClientListByResourceGroupOptions) (resp azfake.PagerResponder[armservicenetworking.SecurityPoliciesInterfaceClientListByResourceGroupResponse])

	// Update is the fake for method SecurityPoliciesInterfaceClient.Update
	// HTTP status codes to indicate success: http.StatusOK
	Update func(ctx context.Context, resourceGroupName string, trafficControllerName string, securityPolicyName string, properties armservicenetworking.SecurityPolicy, options *armservicenetworking.SecurityPoliciesInterfaceClientUpdateOptions) (resp azfake.Responder[armservicenetworking.SecurityPoliciesInterfaceClientUpdateResponse], errResp azfake.ErrorResponder)
}
...
func NewSecurityPoliciesInterfaceServerTransport(srv *SecurityPoliciesInterfaceServer) *SecurityPoliciesInterfaceServerTransport {
	return &SecurityPoliciesInterfaceServerTransport{
		...
		newListByResourceGroupPager: newTracker[azfake.PagerResponder[armservicenetworking.SecurityPoliciesInterfaceClientListByResourceGroupResponse]](),
	}
}
...
type SecurityPoliciesInterfaceServerTransport struct {
	...
	newListByResourceGroupPager *tracker[azfake.PagerResponder[armservicenetworking.SecurityPoliciesInterfaceClientListByResourceGroupResponse]]
}
...
func (s *SecurityPoliciesInterfaceServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	case "SecurityPoliciesInterfaceClient.NewListByResourceGroupPager":
...
func (s *SecurityPoliciesInterfaceServerTransport) dispatchNewListByResourceGroupPager(req *http.Request) (*http.Response, error) {
	...
	if newListByResourceGroupPager == nil {
		...
		resp := s.srv.NewListByResourceGroupPager(resourceGroupNameParam, trafficControllerNameParam, nil)
		newListByResourceGroupPager = &resp
		s.newListByResourceGroupPager.add(req, newListByResourceGroupPager)
		server.PagerResponderInjectNextLinks(newListByResourceGroupPager, req, func(page *armservicenetworking.SecurityPoliciesInterfaceClientListByResourceGroupResponse, createLink func() string) {
