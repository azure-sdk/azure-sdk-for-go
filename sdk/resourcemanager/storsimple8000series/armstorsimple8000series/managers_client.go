...
func (client *ManagersClient) createExtendedInfoCreateRequest(ctx context.Context, resourceGroupName string, managerName string, parameters ManagerExtendedInfo, _ *ManagersClientCreateExtendedInfoOptions) (*policy.Request, error) {
...
func (client *ManagersClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, managerName string, parameters Manager, _ *ManagersClientCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *ManagersClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, managerName string, _ *ManagersClientDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorSimple/managers/{managerName}"
	urlPath = strings.ReplaceAll(urlPath, "{subscriptionId}", client.subscriptionID)
	urlPath = strings.ReplaceAll(urlPath, "{resourceGroupName}", resourceGroupName)
	urlPath = strings.ReplaceAll(urlPath, "{managerName}", managerName)
...
func (client *ManagersClient) deleteExtendedInfoCreateRequest(ctx context.Context, resourceGroupName string, managerName string, _ *ManagersClientDeleteExtendedInfoOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorSimple/managers/{managerName}/extendedInformation/vaultExtendedInfo"
	urlPath = strings.ReplaceAll(urlPath, "{subscriptionId}", client.subscriptionID)
	urlPath = strings.ReplaceAll(urlPath, "{resourceGroupName}", resourceGroupName)
	urlPath = strings.ReplaceAll(urlPath, "{managerName}", managerName)
...
func (client *ManagersClient) getCreateRequest(ctx context.Context, resourceGroupName string, managerName string, _ *ManagersClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorSimple/managers/{managerName}"
	urlPath = strings.ReplaceAll(urlPath, "{subscriptionId}", client.subscriptionID)
	urlPath = strings.ReplaceAll(urlPath, "{resourceGroupName}", resourceGroupName)
	urlPath = strings.ReplaceAll(urlPath, "{managerName}", managerName)
...
func (client *ManagersClient) getActivationKeyCreateRequest(ctx context.Context, resourceGroupName string, managerName string, _ *ManagersClientGetActivationKeyOptions) (*policy.Request, error) {
...
func (client *ManagersClient) getDevicePublicEncryptionKeyCreateRequest(ctx context.Context, deviceName string, resourceGroupName string, managerName string, _ *ManagersClientGetDevicePublicEncryptionKeyOptions) (*policy.Request, error) {
...
func (client *ManagersClient) getEncryptionSettingsCreateRequest(ctx context.Context, resourceGroupName string, managerName string, _ *ManagersClientGetEncryptionSettingsOptions) (*policy.Request, error) {
...
func (client *ManagersClient) getExtendedInfoCreateRequest(ctx context.Context, resourceGroupName string, managerName string, _ *ManagersClientGetExtendedInfoOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorSimple/managers/{managerName}/extendedInformation/vaultExtendedInfo"
	urlPath = strings.ReplaceAll(urlPath, "{subscriptionId}", client.subscriptionID)
	urlPath = strings.ReplaceAll(urlPath, "{resourceGroupName}", resourceGroupName)
	urlPath = strings.ReplaceAll(urlPath, "{managerName}", managerName)
...
func (client *ManagersClient) getPublicEncryptionKeyCreateRequest(ctx context.Context, resourceGroupName string, managerName string, _ *ManagersClientGetPublicEncryptionKeyOptions) (*policy.Request, error) {
...
func (client *ManagersClient) listCreateRequest(ctx context.Context, _ *ManagersClientListOptions) (*policy.Request, error) {
...
func (client *ManagersClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, _ *ManagersClientListByResourceGroupOptions) (*policy.Request, error) {
...
func (client *ManagersClient) listMetricDefinitionCreateRequest(ctx context.Context, resourceGroupName string, managerName string, _ *ManagersClientListMetricDefinitionOptions) (*policy.Request, error) {
...
func (client *ManagersClient) listMetricsCreateRequest(ctx context.Context, resourceGroupName string, managerName string, filter string, _ *ManagersClientListMetricsOptions) (*policy.Request, error) {
...
func (client *ManagersClient) regenerateActivationKeyCreateRequest(ctx context.Context, resourceGroupName string, managerName string, _ *ManagersClientRegenerateActivationKeyOptions) (*policy.Request, error) {
...
func (client *ManagersClient) updateCreateRequest(ctx context.Context, resourceGroupName string, managerName string, parameters ManagerPatch, _ *ManagersClientUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorSimple/managers/{managerName}"
	urlPath = strings.ReplaceAll(urlPath, "{subscriptionId}", client.subscriptionID)
	urlPath = strings.ReplaceAll(urlPath, "{resourceGroupName}", resourceGroupName)
	urlPath = strings.ReplaceAll(urlPath, "{managerName}", managerName)
...
func (client *ManagersClient) updateExtendedInfoCreateRequest(ctx context.Context, resourceGroupName string, managerName string, ifMatch string, parameters ManagerExtendedInfo, _ *ManagersClientUpdateExtendedInfoOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorSimple/managers/{managerName}/extendedInformation/vaultExtendedInfo"
	urlPath = strings.ReplaceAll(urlPath, "{subscriptionId}", client.subscriptionID)
	urlPath = strings.ReplaceAll(urlPath, "{resourceGroupName}", resourceGroupName)
	urlPath = strings.ReplaceAll(urlPath, "{managerName}", managerName)
