...
type Extension struct {
	...
	// MdeDesignatedSubscription - VirtualMachinesP1;VirtualMachinesP2
	// AgentlessVmScanning - CloudPostureDefault;VirtualMachinesP2;ContainersDefaultPreview
	// EntraPermissionsManagement - CloudPostureDefault
	// FileIntegrityMonitoring - VirtualMachinesP2
	// ContainerSensor - ContainersDefault
	// ContainerIntegrityContribution - ContainersDefaultPreview;CloudPostureDefaultPreview
	// AIPromptEvidence - AIDefault
	// ApiPosture - CloudPostureDefaultPreview
	Name *string
