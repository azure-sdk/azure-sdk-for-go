...
type FirewallStatusProperty struct {
	...
	HealthReason *string `json:"healthReason,omitempty" azure:"ro"`
	...
	IsPanoramaManaged *BooleanEnum `json:"isPanoramaManaged,omitempty" azure:"ro"`

	// READ-ONLY; Panorama Status
	PanoramaStatus *PanoramaStatus `json:"panoramaStatus,omitempty" azure:"ro"`

	// READ-ONLY; Provisioning state of the resource.
	ProvisioningState *ReadOnlyProvisioningState `json:"provisioningState,omitempty" azure:"ro"`
}

// FirewallStatusResource - Firewall Status
type FirewallStatusResource struct {
	// REQUIRED; The resource-specific properties for this resource.
	Properties *FirewallStatusProperty `json:"properties,omitempty"`
...
type FirewallStatusResourceListResult struct {
	// REQUIRED; The items on this page
	Value []*FirewallStatusResource `json:"value,omitempty"`
...
type PanoramaStatus struct {
	...
	PanoramaServer2Status *ServerStatus `json:"panoramaServer2Status,omitempty" azure:"ro"`

	// READ-ONLY; Primary Panorama connection status
	PanoramaServerStatus *ServerStatus `json:"panoramaServerStatus,omitempty" azure:"ro"`
}
