...
func (s *SubscriptionFeatureRegistrationsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if subscriptionFeatureRegistrationsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = subscriptionFeatureRegistrationsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "SubscriptionFeatureRegistrationsClient.NewListAllBySubscriptionPager":
				res.resp, res.err = s.dispatchNewListAllBySubscriptionPager(req)
...
// set this to conditionally intercept incoming requests to SubscriptionFeatureRegistrationsServerTransport
var subscriptionFeatureRegistrationsServerTransportInterceptor interface {
