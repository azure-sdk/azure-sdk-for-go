...
func (a *AttachedDatabaseConfigurationsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if attachedDatabaseConfigurationsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = attachedDatabaseConfigurationsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to AttachedDatabaseConfigurationsServerTransport
var attachedDatabaseConfigurationsServerTransportInterceptor interface {
