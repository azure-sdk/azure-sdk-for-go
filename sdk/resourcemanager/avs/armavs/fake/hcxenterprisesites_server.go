...
type HcxEnterpriseSitesServer struct {
	...
	// HTTP status codes to indicate success: http.StatusOK
	NewListByPrivateCloudPager func(resourceGroupName string, privateCloudName string, options *armavs.HcxEnterpriseSitesClientListByPrivateCloudOptions) (resp azfake.PagerResponder[armavs.HcxEnterpriseSitesClientListByPrivateCloudResponse])
}
...
func (h *HcxEnterpriseSitesServerTransport) dispatchNewListByPrivateCloudPager(req *http.Request) (*http.Response, error) {
	...
	if newListByPrivateCloudPager == nil {
		...
		resp := h.srv.NewListByPrivateCloudPager(resourceGroupNameParam, privateCloudNameParam, nil)
