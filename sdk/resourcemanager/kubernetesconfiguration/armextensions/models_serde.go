...
// MarshalJSON implements the json.Marshaller interface for type AdditionalDetails.
func (a AdditionalDetails) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "docs", a.Docs)
	populate(objectMap, "releaseNotes", a.ReleaseNotes)
	populate(objectMap, "troubleshootingGuide", a.TroubleshootingGuide)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type AdditionalDetails.
func (a *AdditionalDetails) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "docs":
			err = unpopulate(val, "Docs", &a.Docs)
			delete(rawMsg, key)
		case "releaseNotes":
			err = unpopulate(val, "ReleaseNotes", &a.ReleaseNotes)
			delete(rawMsg, key)
		case "troubleshootingGuide":
			err = unpopulate(val, "TroubleshootingGuide", &a.TroubleshootingGuide)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", a, err)
...
func (e ExtensionProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "managementDetails", e.ManagementDetails)
...
func (e *ExtensionProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "managementDetails":
			err = unpopulate(val, "ManagementDetails", &e.ManagementDetails)
			delete(rawMsg, key)
		case "packageUri":
...
func (m ManagementDetails) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "accessDetails", m.AccessDetails)
...
func (m *ManagementDetails) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "accessDetails":
			err = unpopulate(val, "AccessDetails", &m.AccessDetails)
			delete(rawMsg, key)
		case "category":
...
// MarshalJSON implements the json.Marshaller interface for type ManagementDetailsAccessDetailsItem.
func (m ManagementDetailsAccessDetailsItem) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "allowedActions", m.AllowedActions)
	populate(objectMap, "description", m.Description)
	populate(objectMap, "entity", m.Entity)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ManagementDetailsAccessDetailsItem.
func (m *ManagementDetailsAccessDetailsItem) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", m, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "allowedActions":
			err = unpopulate(val, "AllowedActions", &m.AllowedActions)
			delete(rawMsg, key)
		case "description":
...
// MarshalJSON implements the json.Marshaller interface for type UserAssignedIdentitiesAdditionalProperties.
func (u UserAssignedIdentitiesAdditionalProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type UserAssignedIdentitiesAdditionalProperties.
func (u *UserAssignedIdentitiesAdditionalProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
