...
// The returned OperationResultsServerTransport instance is connected to an instance of armm365securityandcompliance.OperationResultsClient via the
...
// OperationResultsServerTransport connects instances of armm365securityandcompliance.OperationResultsClient to instances of OperationResultsServer.
...
func (o *OperationResultsServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.M365SecurityAndCompliance/locations/(?P<locationName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/operationresults/(?P<operationResultId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)`
