...
type OperationsServer struct {
	...
	NewListPager func(options *armchangeanalysis.OperationsClientListOptions) (resp azfake.PagerResponder[armchangeanalysis.OperationsClientListResponse])
}

// NewOperationsServerTransport creates a new instance of OperationsServerTransport with the provided implementation.
// The returned OperationsServerTransport instance is connected to an instance of armchangeanalysis.OperationsClient via the
// azcore.ClientOptions.Transporter field in the client's constructor parameters.
func NewOperationsServerTransport(srv *OperationsServer) *OperationsServerTransport {
	return &OperationsServerTransport{
		srv:          srv,
		newListPager: newTracker[azfake.PagerResponder[armchangeanalysis.OperationsClientListResponse]](),
	}
}

// OperationsServerTransport connects instances of armchangeanalysis.OperationsClient to instances of OperationsServer.
// Don't use this type directly, use NewOperationsServerTransport instead.
type OperationsServerTransport struct {
	srv          *OperationsServer
	newListPager *tracker[azfake.PagerResponder[armchangeanalysis.OperationsClientListResponse]]
}
...
func (o *OperationsServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		var options *armchangeanalysis.OperationsClientListOptions
		if skipTokenParam != nil {
			options = &armchangeanalysis.OperationsClientListOptions{
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armchangeanalysis.OperationsClientListResponse, createLink func() string) {
