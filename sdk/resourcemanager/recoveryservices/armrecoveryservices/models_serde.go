...
func (c CertificateRequest) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "certificateCreateOptions", c.CertificateCreateOptions)
	populate(objectMap, "properties", c.Properties)
	return json.Marshal(objectMap)
}
...
func (c *CertificateRequest) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		var err error
		switch key {
		case "certificateCreateOptions":
			err = unpopulate(val, "CertificateCreateOptions", &c.CertificateCreateOptions)
			delete(rawMsg, key)
		case "properties":
			err = unpopulate(val, "Properties", &c.Properties)
			delete(rawMsg, key)
...
// MarshalJSON implements the json.Marshaller interface for type CertificateRequestCertificateCreateOptions.
func (c CertificateRequestCertificateCreateOptions) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "validityInHours", c.ValidityInHours)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type CertificateRequestCertificateCreateOptions.
func (c *CertificateRequestCertificateCreateOptions) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
	for key, val := range rawMsg {
		var err error
		switch key {
		case "validityInHours":
			err = unpopulate(val, "ValidityInHours", &c.ValidityInHours)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", c, err)
