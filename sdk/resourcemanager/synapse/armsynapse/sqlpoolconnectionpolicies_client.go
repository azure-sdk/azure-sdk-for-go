...
func (client *SQLPoolConnectionPoliciesClient) getCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, sqlPoolName string, connectionPolicyName ConnectionPolicyName, _ *SQLPoolConnectionPoliciesClientGetOptions) (*policy.Request, error) {
