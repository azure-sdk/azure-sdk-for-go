...
// ComputeInstanceOsPatchingResult - The result of os patching operation on this ComputeInstance.
type ComputeInstanceOsPatchingResult struct {
	// READ-ONLY; Collection of errors encountered when doing os patching.
	OSPatchingErrors []*ErrorResponse

	// READ-ONLY; The current status of current os patching operation.
	OSPatchingStatus *string
}
...
type ComputeInstanceProperties struct {
	...
	// READ-ONLY; The result of os patching operation on this ComputeInstance.
	OSPatchingResult *ComputeInstanceOsPatchingResult
