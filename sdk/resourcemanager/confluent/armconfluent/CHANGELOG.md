...
- New function `*AccessClient.DeleteRoleBinding(context.Context, string, string, *AccessClientDeleteRoleBindingOptions) (AccessClientDeleteRoleBindingResponse, error)`
