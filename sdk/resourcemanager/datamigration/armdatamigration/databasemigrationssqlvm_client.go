...
func (client *DatabaseMigrationsSQLVMClient) BeginDelete(ctx context.Context, resourceGroupName string, sqlVirtualMachineName string, targetDbName string, options *DatabaseMigrationsSQLVMClientBeginDeleteOptions) (*runtime.Poller[DatabaseMigrationsSQLVMClientDeleteResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return runtime.NewPoller[DatabaseMigrationsSQLVMClientDeleteResponse](resp, client.pl, nil)
	} else {
		return runtime.NewPollerFromResumeToken[DatabaseMigrationsSQLVMClientDeleteResponse](options.ResumeToken, client.pl, nil)
	}
}
...
// resourceGroupName - Name of the resource group that contains the resource. You can obtain this value from the Azure Resource
// Manager API or the portal.
// options - DatabaseMigrationsSQLVMClientListByScopeOptions contains the optional parameters for the DatabaseMigrationsSQLVMClient.ListByScope
// method.
func (client *DatabaseMigrationsSQLVMClient) ListByScope(ctx context.Context, resourceGroupName string, sqlVirtualMachineName string, options *DatabaseMigrationsSQLVMClientListByScopeOptions) (DatabaseMigrationsSQLVMClientListByScopeResponse, error) {
	req, err := client.listByScopeCreateRequest(ctx, resourceGroupName, sqlVirtualMachineName, options)
	if err != nil {
		return DatabaseMigrationsSQLVMClientListByScopeResponse{}, err
	}
	resp, err := client.pl.Do(req)
	if err != nil {
		return DatabaseMigrationsSQLVMClientListByScopeResponse{}, err
	...
	if !runtime.HasStatusCode(resp, http.StatusOK) {
		return DatabaseMigrationsSQLVMClientListByScopeResponse{}, runtime.NewResponseError(resp)
	}
	return client.listByScopeHandleResponse(resp)
}

// listByScopeCreateRequest creates the ListByScope request.
func (client *DatabaseMigrationsSQLVMClient) listByScopeCreateRequest(ctx context.Context, resourceGroupName string, sqlVirtualMachineName string, options *DatabaseMigrationsSQLVMClientListByScopeOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.SqlVirtualMachine/sqlVirtualMachines/{sqlVirtualMachineName}/providers/Microsoft.DataMigration/databaseMigrations"
	if resourceGroupName == "" {
		return nil, errors.New("parameter resourceGroupName cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{resourceGroupName}", url.PathEscape(resourceGroupName))
...
func (client *DatabaseMigrationsSQLVMClient) listByScopeHandleResponse(resp *http.Response) (DatabaseMigrationsSQLVMClientListByScopeResponse, error) {
	result := DatabaseMigrationsSQLVMClientListByScopeResponse{}
	if err := runtime.UnmarshalAsJSON(resp, &result.DatabaseMigrationSQLVMListResult); err != nil {
		return DatabaseMigrationsSQLVMClientListByScopeResponse{}, err
	}
	return result, nil
}
