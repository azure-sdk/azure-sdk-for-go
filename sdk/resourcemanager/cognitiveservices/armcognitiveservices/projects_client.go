...
func (client *ProjectsClient) BeginCreate(ctx context.Context, resourceGroupName string, accountName string, projectName string, project Account, options *ProjectsClientBeginCreateOptions) (*runtime.Poller[ProjectsClientCreateResponse], error) {
...
//
// Generated from API version 2025-04-01-preview
func (client *ProjectsClient) create(ctx context.Context, resourceGroupName string, accountName string, projectName string, project Account, options *ProjectsClientBeginCreateOptions) (*http.Response, error) {
	var err error
...
func (client *ProjectsClient) createCreateRequest(ctx context.Context, resourceGroupName string, accountName string, projectName string, project Account, _ *ProjectsClientBeginCreateOptions) (*policy.Request, error) {
...
func (client *ProjectsClient) BeginUpdate(ctx context.Context, resourceGroupName string, accountName string, projectName string, project Account, options *ProjectsClientBeginUpdateOptions) (*runtime.Poller[ProjectsClientUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
...
//
// Generated from API version 2025-04-01-preview
func (client *ProjectsClient) update(ctx context.Context, resourceGroupName string, accountName string, projectName string, project Account, options *ProjectsClientBeginUpdateOptions) (*http.Response, error) {
	var err error
...
func (client *ProjectsClient) updateCreateRequest(ctx context.Context, resourceGroupName string, accountName string, projectName string, project Account, _ *ProjectsClientBeginUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.CognitiveServices/accounts/{accountName}/projects/{projectName}"
	if resourceGroupName == "" {
		return nil, errors.New("parameter resourceGroupName cannot be empty")
	}
