...
func (client *Client) previewAlertRuleCreateRequest(ctx context.Context, parameters PreviewAlertRuleRequest, _ *ClientPreviewAlertRuleOptions) (*policy.Request, error) {
