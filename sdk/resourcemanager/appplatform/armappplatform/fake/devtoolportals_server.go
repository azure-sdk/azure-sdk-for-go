...
func (d *DevToolPortalsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if devToolPortalsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = devToolPortalsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to DevToolPortalsServerTransport
var devToolPortalsServerTransportInterceptor interface {
