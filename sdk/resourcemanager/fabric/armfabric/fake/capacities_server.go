...
type CapacitiesServer struct {
	...
	// Delete is the fake for method CapacitiesClient.Delete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	Delete func(ctx context.Context, resourceGroupName string, capacityName string, options *armfabric.CapacitiesClientDeleteOptions) (resp azfake.Responder[armfabric.CapacitiesClientDeleteResponse], errResp azfake.ErrorResponder)
	...
	// Update is the fake for method CapacitiesClient.Update
	// HTTP status codes to indicate success: http.StatusOK
	Update func(ctx context.Context, resourceGroupName string, capacityName string, properties armfabric.CapacityUpdate, options *armfabric.CapacitiesClientUpdateOptions) (resp azfake.Responder[armfabric.CapacitiesClientUpdateResponse], errResp azfake.ErrorResponder)
}
...
func (c *CapacitiesServerTransport) dispatchDelete(req *http.Request) (*http.Response, error) {
	if c.srv.Delete == nil {
	...
	respr, errRespr := c.srv.Delete(req.Context(), resourceGroupNameParam, capacityNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (c *CapacitiesServerTransport) dispatchUpdate(req *http.Request) (*http.Response, error) {
	if c.srv.Update == nil {
	...
	respr, errRespr := c.srv.Update(req.Context(), resourceGroupNameParam, capacityNameParam, body, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
