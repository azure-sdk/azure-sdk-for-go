...
```go
client, err := armconnectedvmware.NewGuestAgentsClient(<subscription ID>, cred, nil)
```
...
client, err := armconnectedvmware.NewGuestAgentsClient(<subscription ID>, cred, &options)
```
