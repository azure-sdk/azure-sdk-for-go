...
func (client *ComponentsClient) getCreateRequest(ctx context.Context, resourceGroupName string, networkFunctionName string, componentName string, _ *ComponentsClientGetOptions) (*policy.Request, error) {
...
func (client *ComponentsClient) listByNetworkFunctionCreateRequest(ctx context.Context, resourceGroupName string, networkFunctionName string, _ *ComponentsClientListByNetworkFunctionOptions) (*policy.Request, error) {
