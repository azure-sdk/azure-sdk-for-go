...
func (client *OperationsClient) checkNameAvailabilityCreateRequest(ctx context.Context, request CheckNameAvailabilityRequest, _ *OperationsClientCheckNameAvailabilityOptions) (*policy.Request, error) {
...
func (client *OperationsClient) getAzureAsyncHeaderResultCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, operationID string, _ *OperationsClientGetAzureAsyncHeaderResultOptions) (*policy.Request, error) {
...
func (client *OperationsClient) getLocationHeaderResultCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, operationID string, _ *OperationsClientGetLocationHeaderResultOptions) (*policy.Request, error) {
