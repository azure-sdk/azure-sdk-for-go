...
func (c *CatalogsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if catalogsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = catalogsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			case "CatalogsClient.CountDevices":
				res.resp, res.err = c.dispatchCountDevices(req)
			...
			case "CatalogsClient.NewListDeviceGroupsPager":
				res.resp, res.err = c.dispatchNewListDeviceGroupsPager(req)
			case "CatalogsClient.NewListDeviceInsightsPager":
				res.resp, res.err = c.dispatchNewListDeviceInsightsPager(req)
			case "CatalogsClient.NewListDevicesPager":
				res.resp, res.err = c.dispatchNewListDevicesPager(req)
			case "CatalogsClient.Update":
				res.resp, res.err = c.dispatchUpdate(req)
			case "CatalogsClient.BeginUploadImage":
				res.resp, res.err = c.dispatchBeginUploadImage(req)
			default:
...
// set this to conditionally intercept incoming requests to CatalogsServerTransport
var catalogsServerTransportInterceptor interface {
