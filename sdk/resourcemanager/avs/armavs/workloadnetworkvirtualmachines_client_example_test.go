...
func ExampleWorkloadNetworkVirtualMachinesClient_Get() {
	...
	res, err := clientFactory.NewWorkloadNetworkVirtualMachinesClient().Get(ctx, "group1", "cloud1", "vm1", nil)
	if err != nil {
	...
	// res = armavs.WorkloadNetworkVirtualMachinesClientGetResponse{
...
func ExampleWorkloadNetworkVirtualMachinesClient_NewListPager() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	pager := clientFactory.NewWorkloadNetworkVirtualMachinesClient().NewListPager("group1", "cloud1", nil)
	for pager.More() {
		...
		// page = armavs.WorkloadNetworkVirtualMachinesClientListResponse{
