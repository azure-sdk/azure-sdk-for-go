...
func (b *BestPracticesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if bestPracticesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = bestPracticesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to BestPracticesServerTransport
var bestPracticesServerTransportInterceptor interface {
