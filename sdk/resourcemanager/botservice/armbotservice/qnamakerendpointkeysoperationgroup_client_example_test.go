...
func ExampleQnAMakerEndpointKeysOperationGroupClient_Get() {
	...
	res, err := clientFactory.NewQnAMakerEndpointKeysOperationGroupClient().Get(ctx, nil)
	if err != nil {
	...
	// res = armbotservice.QnAMakerEndpointKeysOperationGroupClientGetResponse{
