...
func (client *MySQLServersClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, siteName string, serverName string, resource MySQLServer, _ *MySQLServersClientCreateOrUpdateOptions) (*policy.Request, error) {
