...
// ServerIPv6EnabledFlag - Whether or not IPv6 firewall rule is enabled for this server. Value is optional but if passed in,
// must be 'Enabled' or 'Disabled'
type ServerIPv6EnabledFlag string

const (
	ServerIPv6EnabledFlagDisabled ServerIPv6EnabledFlag = "Disabled"
	ServerIPv6EnabledFlagEnabled  ServerIPv6EnabledFlag = "Enabled"
)

// PossibleServerIPv6EnabledFlagValues returns the possible values for the ServerIPv6EnabledFlag const type.
func PossibleServerIPv6EnabledFlagValues() []ServerIPv6EnabledFlag {
	return []ServerIPv6EnabledFlag{
		ServerIPv6EnabledFlagDisabled,
		ServerIPv6EnabledFlagEnabled,
	}
}
