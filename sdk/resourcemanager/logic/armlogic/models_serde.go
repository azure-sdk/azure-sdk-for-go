...
func (a APIReference) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "name", a.Name)
	populate(objectMap, "swagger", a.Swagger)
	populate(objectMap, "type", a.Type)
	return json.Marshal(objectMap)
}
...
// MarshalJSON implements the json.Marshaller interface for type AzureResourceManagerFoundationsArmTagsProperty.
func (a AzureResourceManagerFoundationsArmTagsProperty) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "tags", a.Tags)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type AzureResourceManagerFoundationsArmTagsProperty.
func (a *AzureResourceManagerFoundationsArmTagsProperty) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", a, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type FlowTemplateConnectorDetails.
func (f FlowTemplateConnectorDetails) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type FlowTemplateConnectorDetails.
func (f *FlowTemplateConnectorDetails) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", f, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type FlowTemplateDetails.
func (f FlowTemplateDetails) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "by", f.By)
	populate(objectMap, "category", f.Category)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type FlowTemplateDetails.
func (f *FlowTemplateDetails) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", f, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type FlowTemplateManifest.
func (f FlowTemplateManifest) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "description", f.Description)
	populate(objectMap, "details", f.Details)
	populate(objectMap, "featuredConnectors", f.FeaturedConnectors)
	populate(objectMap, "summary", f.Summary)
	populate(objectMap, "supportedSku", f.SupportedSKU)
	populate(objectMap, "title", f.Title)
	populate(objectMap, "type", f.Type)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type FlowTemplateManifest.
func (f *FlowTemplateManifest) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", f, err)
	}
	for key, val := range rawMsg {
		...
		case "details":
			...
			delete(rawMsg, key)
		case "featuredConnectors":
			err = unpopulate(val, "FeaturedConnectors", &f.FeaturedConnectors)
			delete(rawMsg, key)
		case "summary":
			err = unpopulate(val, "Summary", &f.Summary)
			delete(rawMsg, key)
		case "supportedSku":
			err = unpopulate(val, "SupportedSKU", &f.SupportedSKU)
			delete(rawMsg, key)
		case "title":
			err = unpopulate(val, "Title", &f.Title)
			delete(rawMsg, key)
		case "type":
...
// MarshalJSON implements the json.Marshaller interface for type IntegrationServiceEnvironmentNetworkHealth.
func (i IntegrationServiceEnvironmentNetworkHealth) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "outboundNetworkDependencies", i.OutboundNetworkDependencies)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type IntegrationServiceEnvironmentNetworkHealth.
func (i *IntegrationServiceEnvironmentNetworkHealth) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", i, err)
	}
...
func (o OperationResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "canResubmit", o.CanResubmit)
	...
	populate(objectMap, "executionMode", o.ExecutionMode)
...
func (o *OperationResult) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "canResubmit":
			err = unpopulate(val, "CanResubmit", &o.CanResubmit)
			delete(rawMsg, key)
		case "code":
		...
		case "error":
			...
			delete(rawMsg, key)
		case "executionMode":
			err = unpopulate(val, "ExecutionMode", &o.ExecutionMode)
			delete(rawMsg, key)
		case "inputs":
...
func (t TemplateProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "manifest", t.Manifest)
...
func (t *TemplateProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "manifest":
			err = unpopulate(val, "Manifest", &t.Manifest)
			delete(rawMsg, key)
		case "provisioningState":
...
// MarshalJSON implements the json.Marshaller interface for type TemplateUpdate.
func (t TemplateUpdate) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "id", t.ID)
	populate(objectMap, "name", t.Name)
	populate(objectMap, "properties", t.Properties)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type TemplateUpdate.
func (t *TemplateUpdate) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", t, err)
	}
...
func (w WorkflowRunActionRepetitionProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "canResubmit", w.CanResubmit)
	populate(objectMap, "code", w.Code)
	populate(objectMap, "correlation", w.Correlation)
	populateDateTimeRFC3339(objectMap, "endTime", w.EndTime)
	populate(objectMap, "error", w.Error)
	populate(objectMap, "executionMode", w.ExecutionMode)
...
func (w *WorkflowRunActionRepetitionProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "canResubmit":
			err = unpopulate(val, "CanResubmit", &w.CanResubmit)
			delete(rawMsg, key)
		case "code":
			err = unpopulate(val, "Code", &w.Code)
			delete(rawMsg, key)
		...
		case "error":
			...
			delete(rawMsg, key)
		case "executionMode":
			err = unpopulate(val, "ExecutionMode", &w.ExecutionMode)
			delete(rawMsg, key)
		case "inputs":
