...
func (p *PartnerServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if partnerServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = partnerServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to PartnerServerTransport
var partnerServerTransportInterceptor interface {
