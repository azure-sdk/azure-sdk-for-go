...
// Generated from API version 2022-10-31-preview
...
func (client *SQLMigrationServicesClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, sqlMigrationServiceName string, parameters SQLMigrationService, options *SQLMigrationServicesClientBeginCreateOrUpdateOptions) (*policy.Request, error) {
	...
	reqQP.Set("api-version", "2022-10-31-preview")
...
// MonitoringData - Retrieve the Monitoring Data.
// If the operation fails it returns an *azcore.ResponseError type.
// Generated from API version 2022-10-31-preview
// resourceGroupName - Name of the resource group that contains the resource. You can obtain this value from the Azure Resource
// Manager API or the portal.
// sqlMigrationServiceName - Name of the SQL Migration Service.
// options - SQLMigrationServicesClientMonitoringDataOptions contains the optional parameters for the SQLMigrationServicesClient.MonitoringData
// method.
func (client *SQLMigrationServicesClient) MonitoringData(ctx context.Context, resourceGroupName string, sqlMigrationServiceName string, options *SQLMigrationServicesClientMonitoringDataOptions) (SQLMigrationServicesClientMonitoringDataResponse, error) {
	req, err := client.monitoringDataCreateRequest(ctx, resourceGroupName, sqlMigrationServiceName, options)
	if err != nil {
		return SQLMigrationServicesClientMonitoringDataResponse{}, err
	}
	resp, err := client.pl.Do(req)
	if err != nil {
		return SQLMigrationServicesClientMonitoringDataResponse{}, err
	...
	if !runtime.HasStatusCode(resp, http.StatusOK) {
		return SQLMigrationServicesClientMonitoringDataResponse{}, runtime.NewResponseError(resp)
	}
	return client.monitoringDataHandleResponse(resp)
}

// monitoringDataCreateRequest creates the MonitoringData request.
func (client *SQLMigrationServicesClient) monitoringDataCreateRequest(ctx context.Context, resourceGroupName string, sqlMigrationServiceName string, options *SQLMigrationServicesClientMonitoringDataOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataMigration/sqlMigrationServices/{sqlMigrationServiceName}/MonitoringData"
	if resourceGroupName == "" {
		return nil, errors.New("parameter resourceGroupName cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{resourceGroupName}", url.PathEscape(resourceGroupName))
...
// monitoringDataHandleResponse handles the MonitoringData response.
func (client *SQLMigrationServicesClient) monitoringDataHandleResponse(resp *http.Response) (SQLMigrationServicesClientMonitoringDataResponse, error) {
	result := SQLMigrationServicesClientMonitoringDataResponse{}
	if err := runtime.UnmarshalAsJSON(resp, &result.IntegrationRuntimeMonitoringData); err != nil {
		return SQLMigrationServicesClientMonitoringDataResponse{}, err
	}
	return result, nil
...
// ValidateIR - Validate IR connectivity to Linked Services.
// If the operation fails it returns an *azcore.ResponseError type.
// Generated from API version 2022-10-31-preview
// resourceGroupName - Name of the resource group that contains the resource. You can obtain this value from the Azure Resource
// Manager API or the portal.
// sqlMigrationServiceName - Name of the SQL Migration Service.
// parameters - Details of SqlMigrationService resource.
// options - SQLMigrationServicesClientValidateIROptions contains the optional parameters for the SQLMigrationServicesClient.ValidateIR
// method.
func (client *SQLMigrationServicesClient) ValidateIR(ctx context.Context, resourceGroupName string, sqlMigrationServiceName string, parameters ValidateIR, options *SQLMigrationServicesClientValidateIROptions) (SQLMigrationServicesClientValidateIRResponse, error) {
	req, err := client.validateIRCreateRequest(ctx, resourceGroupName, sqlMigrationServiceName, parameters, options)
	if err != nil {
		return SQLMigrationServicesClientValidateIRResponse{}, err
	}
	resp, err := client.pl.Do(req)
	if err != nil {
		return SQLMigrationServicesClientValidateIRResponse{}, err
	...
	if !runtime.HasStatusCode(resp, http.StatusOK) {
		return SQLMigrationServicesClientValidateIRResponse{}, runtime.NewResponseError(resp)
	}
	return client.validateIRHandleResponse(resp)
}

// validateIRCreateRequest creates the ValidateIR request.
func (client *SQLMigrationServicesClient) validateIRCreateRequest(ctx context.Context, resourceGroupName string, sqlMigrationServiceName string, parameters ValidateIR, options *SQLMigrationServicesClientValidateIROptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataMigration/sqlMigrationServices/{sqlMigrationServiceName}/validateIR"
	if resourceGroupName == "" {
		return nil, errors.New("parameter resourceGroupName cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{resourceGroupName}", url.PathEscape(resourceGroupName))
...
// validateIRHandleResponse handles the ValidateIR response.
func (client *SQLMigrationServicesClient) validateIRHandleResponse(resp *http.Response) (SQLMigrationServicesClientValidateIRResponse, error) {
	result := SQLMigrationServicesClientValidateIRResponse{}
	if err := runtime.UnmarshalAsJSON(resp, &result.ValidateIR); err != nil {
		return SQLMigrationServicesClientValidateIRResponse{}, err
	}
	return result, nil
}
