...
func (d *DotNetComponentsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if dotNetComponentsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = dotNetComponentsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to DotNetComponentsServerTransport
var dotNetComponentsServerTransportInterceptor interface {
