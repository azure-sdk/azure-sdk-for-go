...
// MarshalJSON implements the json.Marshaller interface for type DisplayInformationItem.
func (d DisplayInformationItem) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "infoBallonLink", d.InfoBallonLink)
	populate(objectMap, "infoBallonMessage", d.InfoBallonMessage)
	populate(objectMap, "metricAlertsDisplayInformation", d.MetricAlertsDisplayInformation)
	populate(objectMap, "ruleInfo", d.RuleInfo)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type DisplayInformationItem.
func (d *DisplayInformationItem) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", d, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "infoBallonLink":
			err = unpopulate(val, "InfoBallonLink", &d.InfoBallonLink)
			delete(rawMsg, key)
		case "infoBallonMessage":
			err = unpopulate(val, "InfoBallonMessage", &d.InfoBallonMessage)
			delete(rawMsg, key)
		case "metricAlertsDisplayInformation":
			err = unpopulate(val, "MetricAlertsDisplayInformation", &d.MetricAlertsDisplayInformation)
			delete(rawMsg, key)
		case "ruleInfo":
			err = unpopulate(val, "RuleInfo", &d.RuleInfo)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", d, err)
...
// MarshalJSON implements the json.Marshaller interface for type MetricAlertsDisplayInformation.
func (m MetricAlertsDisplayInformation) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "displayUnits", m.DisplayUnits)
	populate(objectMap, "metricDisplayName", m.MetricDisplayName)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type MetricAlertsDisplayInformation.
func (m *MetricAlertsDisplayInformation) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", m, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "displayUnits":
			err = unpopulate(val, "DisplayUnits", &m.DisplayUnits)
			delete(rawMsg, key)
		case "metricDisplayName":
			err = unpopulate(val, "MetricDisplayName", &m.MetricDisplayName)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", m, err)
...
func (r RuleArmTemplate) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "variables", &r.Variables)
	return json.Marshal(objectMap)
}
