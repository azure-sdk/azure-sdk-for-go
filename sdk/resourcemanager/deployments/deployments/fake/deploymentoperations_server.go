...
// DeploymentOperationsServer is a fake server for instances of the deployments.DeploymentOperationsClient type.
type DeploymentOperationsServer struct {
	// Get is the fake for method DeploymentOperationsClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, deploymentName string, operationID string, options *deployments.DeploymentOperationsClientGetOptions) (resp azfake.Responder[deployments.DeploymentOperationsClientGetResponse], errResp azfake.ErrorResponder)

	// GetAtManagementGroupScope is the fake for method DeploymentOperationsClient.GetAtManagementGroupScope
	// HTTP status codes to indicate success: http.StatusOK
	GetAtManagementGroupScope func(ctx context.Context, groupID string, deploymentName string, operationID string, options *deployments.DeploymentOperationsClientGetAtManagementGroupScopeOptions) (resp azfake.Responder[deployments.DeploymentOperationsClientGetAtManagementGroupScopeResponse], errResp azfake.ErrorResponder)

	// GetAtScope is the fake for method DeploymentOperationsClient.GetAtScope
	// HTTP status codes to indicate success: http.StatusOK
	GetAtScope func(ctx context.Context, scope string, deploymentName string, operationID string, options *deployments.DeploymentOperationsClientGetAtScopeOptions) (resp azfake.Responder[deployments.DeploymentOperationsClientGetAtScopeResponse], errResp azfake.ErrorResponder)

	// GetAtSubscriptionScope is the fake for method DeploymentOperationsClient.GetAtSubscriptionScope
	// HTTP status codes to indicate success: http.StatusOK
	GetAtSubscriptionScope func(ctx context.Context, deploymentName string, operationID string, options *deployments.DeploymentOperationsClientGetAtSubscriptionScopeOptions) (resp azfake.Responder[deployments.DeploymentOperationsClientGetAtSubscriptionScopeResponse], errResp azfake.ErrorResponder)

	// GetAtTenantScope is the fake for method DeploymentOperationsClient.GetAtTenantScope
	// HTTP status codes to indicate success: http.StatusOK
	GetAtTenantScope func(ctx context.Context, deploymentName string, operationID string, options *deployments.DeploymentOperationsClientGetAtTenantScopeOptions) (resp azfake.Responder[deployments.DeploymentOperationsClientGetAtTenantScopeResponse], errResp azfake.ErrorResponder)

	// NewListPager is the fake for method DeploymentOperationsClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(resourceGroupName string, deploymentName string, options *deployments.DeploymentOperationsClientListOptions) (resp azfake.PagerResponder[deployments.DeploymentOperationsClientListResponse])

	// NewListAtManagementGroupScopePager is the fake for method DeploymentOperationsClient.NewListAtManagementGroupScopePager
	// HTTP status codes to indicate success: http.StatusOK
	NewListAtManagementGroupScopePager func(groupID string, deploymentName string, options *deployments.DeploymentOperationsClientListAtManagementGroupScopeOptions) (resp azfake.PagerResponder[deployments.DeploymentOperationsClientListAtManagementGroupScopeResponse])

	// NewListAtScopePager is the fake for method DeploymentOperationsClient.NewListAtScopePager
	// HTTP status codes to indicate success: http.StatusOK
	NewListAtScopePager func(scope string, deploymentName string, options *deployments.DeploymentOperationsClientListAtScopeOptions) (resp azfake.PagerResponder[deployments.DeploymentOperationsClientListAtScopeResponse])

	// NewListAtSubscriptionScopePager is the fake for method DeploymentOperationsClient.NewListAtSubscriptionScopePager
	// HTTP status codes to indicate success: http.StatusOK
	NewListAtSubscriptionScopePager func(deploymentName string, options *deployments.DeploymentOperationsClientListAtSubscriptionScopeOptions) (resp azfake.PagerResponder[deployments.DeploymentOperationsClientListAtSubscriptionScopeResponse])

	// NewListAtTenantScopePager is the fake for method DeploymentOperationsClient.NewListAtTenantScopePager
	// HTTP status codes to indicate success: http.StatusOK
	NewListAtTenantScopePager func(deploymentName string, options *deployments.DeploymentOperationsClientListAtTenantScopeOptions) (resp azfake.PagerResponder[deployments.DeploymentOperationsClientListAtTenantScopeResponse])
}
...
// The returned DeploymentOperationsServerTransport instance is connected to an instance of deployments.DeploymentOperationsClient via the
...
func NewDeploymentOperationsServerTransport(srv *DeploymentOperationsServer) *DeploymentOperationsServerTransport {
	return &DeploymentOperationsServerTransport{
		srv:                                srv,
		newListPager:                       newTracker[azfake.PagerResponder[deployments.DeploymentOperationsClientListResponse]](),
		newListAtManagementGroupScopePager: newTracker[azfake.PagerResponder[deployments.DeploymentOperationsClientListAtManagementGroupScopeResponse]](),
		newListAtScopePager:                newTracker[azfake.PagerResponder[deployments.DeploymentOperationsClientListAtScopeResponse]](),
		newListAtSubscriptionScopePager:    newTracker[azfake.PagerResponder[deployments.DeploymentOperationsClientListAtSubscriptionScopeResponse]](),
		newListAtTenantScopePager:          newTracker[azfake.PagerResponder[deployments.DeploymentOperationsClientListAtTenantScopeResponse]](),
	}
}

// DeploymentOperationsServerTransport connects instances of deployments.DeploymentOperationsClient to instances of DeploymentOperationsServer.
...
type DeploymentOperationsServerTransport struct {
	...
	newListPager                       *tracker[azfake.PagerResponder[deployments.DeploymentOperationsClientListResponse]]
	newListAtManagementGroupScopePager *tracker[azfake.PagerResponder[deployments.DeploymentOperationsClientListAtManagementGroupScopeResponse]]
	newListAtScopePager                *tracker[azfake.PagerResponder[deployments.DeploymentOperationsClientListAtScopeResponse]]
	newListAtSubscriptionScopePager    *tracker[azfake.PagerResponder[deployments.DeploymentOperationsClientListAtSubscriptionScopeResponse]]
	newListAtTenantScopePager          *tracker[azfake.PagerResponder[deployments.DeploymentOperationsClientListAtTenantScopeResponse]]
}
...
func (d *DeploymentOperationsServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *deployments.DeploymentOperationsClientListResponse, createLink func() string) {
...
func (d *DeploymentOperationsServerTransport) dispatchNewListAtManagementGroupScopePager(req *http.Request) (*http.Response, error) {
	...
	if newListAtManagementGroupScopePager == nil {
		...
		var options *deployments.DeploymentOperationsClientListAtManagementGroupScopeOptions
		if topParam != nil {
			options = &deployments.DeploymentOperationsClientListAtManagementGroupScopeOptions{
				Top: topParam,
			}
		}
		...
		server.PagerResponderInjectNextLinks(newListAtManagementGroupScopePager, req, func(page *deployments.DeploymentOperationsClientListAtManagementGroupScopeResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
...
func (d *DeploymentOperationsServerTransport) dispatchNewListAtScopePager(req *http.Request) (*http.Response, error) {
	...
	if newListAtScopePager == nil {
		...
		var options *deployments.DeploymentOperationsClientListAtScopeOptions
		if topParam != nil {
			options = &deployments.DeploymentOperationsClientListAtScopeOptions{
				Top: topParam,
			}
		}
		...
		server.PagerResponderInjectNextLinks(newListAtScopePager, req, func(page *deployments.DeploymentOperationsClientListAtScopeResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
...
func (d *DeploymentOperationsServerTransport) dispatchNewListAtSubscriptionScopePager(req *http.Request) (*http.Response, error) {
	...
	if newListAtSubscriptionScopePager == nil {
		...
		var options *deployments.DeploymentOperationsClientListAtSubscriptionScopeOptions
		if topParam != nil {
			options = &deployments.DeploymentOperationsClientListAtSubscriptionScopeOptions{
				Top: topParam,
			}
		}
		...
		server.PagerResponderInjectNextLinks(newListAtSubscriptionScopePager, req, func(page *deployments.DeploymentOperationsClientListAtSubscriptionScopeResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
...
func (d *DeploymentOperationsServerTransport) dispatchNewListAtTenantScopePager(req *http.Request) (*http.Response, error) {
	...
	if newListAtTenantScopePager == nil {
		...
		var options *deployments.DeploymentOperationsClientListAtTenantScopeOptions
		if topParam != nil {
			options = &deployments.DeploymentOperationsClientListAtTenantScopeOptions{
				Top: topParam,
			}
		}
		...
		server.PagerResponderInjectNextLinks(newListAtTenantScopePager, req, func(page *deployments.DeploymentOperationsClientListAtTenantScopeResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
