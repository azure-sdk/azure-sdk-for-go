...
func (client *Client) clusterGetVersionCreateRequest(ctx context.Context, resourceGroupName string, clusterRp string, clusterResourceName string, clusterName string, extensionTypeName string, versionNumber string, options *ClientClusterGetVersionOptions) (*policy.Request, error) {
...
func (client *Client) getCreateRequest(ctx context.Context, resourceGroupName string, clusterRp string, clusterResourceName string, clusterName string, extensionTypeName string, options *ClientGetOptions) (*policy.Request, error) {
...
func (client *Client) getVersionCreateRequest(ctx context.Context, location string, extensionTypeName string, versionNumber string, options *ClientGetVersionOptions) (*policy.Request, error) {
...
func (client *Client) locationGetCreateRequest(ctx context.Context, location string, extensionTypeName string, options *ClientLocationGetOptions) (*policy.Request, error) {
