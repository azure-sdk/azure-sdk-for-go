...
func (client *TestSummariesClient) getCreateRequest(ctx context.Context, resourceGroupName string, testBaseAccountName string, testSummaryName string, _ *TestSummariesClientGetOptions) (*policy.Request, error) {
...
func (client *TestSummariesClient) listCreateRequest(ctx context.Context, resourceGroupName string, testBaseAccountName string, _ *TestSummariesClientListOptions) (*policy.Request, error) {
