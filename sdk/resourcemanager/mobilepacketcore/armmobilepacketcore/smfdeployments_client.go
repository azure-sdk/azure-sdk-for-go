...
//     method.
func (client *SmfDeploymentsClient) CreateOrUpdate(ctx context.Context, resourceGroupName string, smfDeploymentName string, resource SmfDeploymentResource, options *SmfDeploymentsClientCreateOrUpdateOptions) (SmfDeploymentsClientCreateOrUpdateResponse, error) {
	var err error
	const operationName = "SmfDeploymentsClient.CreateOrUpdate"
...
func (client *SmfDeploymentsClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, smfDeploymentName string, resource SmfDeploymentResource, _ *SmfDeploymentsClientCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *SmfDeploymentsClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, smfDeploymentName string, _ *SmfDeploymentsClientBeginDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MobilePacketCore/smfDeployments/{smfDeploymentName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *SmfDeploymentsClient) getCreateRequest(ctx context.Context, resourceGroupName string, smfDeploymentName string, _ *SmfDeploymentsClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MobilePacketCore/smfDeployments/{smfDeploymentName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *SmfDeploymentsClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, _ *SmfDeploymentsClientListByResourceGroupOptions) (*policy.Request, error) {
...
func (client *SmfDeploymentsClient) listBySubscriptionCreateRequest(ctx context.Context, _ *SmfDeploymentsClientListBySubscriptionOptions) (*policy.Request, error) {
...
func (client *SmfDeploymentsClient) updateTagsCreateRequest(ctx context.Context, resourceGroupName string, smfDeploymentName string, properties SmfDeploymentResourceTagsUpdate, _ *SmfDeploymentsClientUpdateTagsOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MobilePacketCore/smfDeployments/{smfDeploymentName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
