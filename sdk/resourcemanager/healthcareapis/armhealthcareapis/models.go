...
// AnalyticsConnectorClientBeginUpdateOptions contains the optional parameters for the AnalyticsConnectorClient.BeginUpdate
// method.
type AnalyticsConnectorClientBeginUpdateOptions struct {
...
type AnalyticsConnectorFhirToParquetMapping struct {
	...
	AnonymizationSchemaReference *string `json:"anonymizationSchemaReference,omitempty"`
	...
	TransformationSchemaReference *string `json:"transformationSchemaReference,omitempty"`
}
