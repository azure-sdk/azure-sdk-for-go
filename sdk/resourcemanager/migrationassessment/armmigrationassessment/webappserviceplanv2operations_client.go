...
func (client *WebAppServicePlanV2OperationsClient) getCreateRequest(ctx context.Context, resourceGroupName string, projectName string, groupName string, assessmentName string, webAppServicePlanName string, options *WebAppServicePlanV2OperationsClientGetOptions) (*policy.Request, error) {
