...
func (d DataManagerForAgricultureSolutionProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "evaluatedOutputsDictionary", d.EvaluatedOutputsDictionary)
	populate(objectMap, "inputParametersValidationScopes", d.InputParametersValidationScopes)
...
func (d *DataManagerForAgricultureSolutionProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "evaluatedOutputsDictionary":
			err = unpopulate(val, "EvaluatedOutputsDictionary", &d.EvaluatedOutputsDictionary)
			delete(rawMsg, key)
		case "inputParametersValidationScopes":
			err = unpopulate(val, "InputParametersValidationScopes", &d.InputParametersValidationScopes)
			delete(rawMsg, key)
...
func (i Insight) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "modifiedBy", i.ModifiedBy)
...
func (i *Insight) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "modelVersion":
			...
			delete(rawMsg, key)
		case "modifiedBy":
			err = unpopulate(val, "ModifiedBy", &i.ModifiedBy)
			delete(rawMsg, key)
