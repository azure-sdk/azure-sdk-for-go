...
func (l LogsConfiguration) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "destination", l.Destination)
	populate(objectMap, "logAnalyticsConfiguration", l.LogAnalyticsConfiguration)
	return json.Marshal(objectMap)
}
...
func (l *LogsConfiguration) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "destination":
			err = unpopulate(val, "Destination", &l.Destination)
			delete(rawMsg, key)
		case "logAnalyticsConfiguration":
			err = unpopulate(val, "LogAnalyticsConfiguration", &l.LogAnalyticsConfiguration)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", l, err)
...
func (r Registration) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "appId", r.AppID)
	populate(objectMap, "appSecretSettingName", r.AppSecretSettingName)
	return json.Marshal(objectMap)
}
...
func (r *Registration) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "appId":
			err = unpopulate(val, "AppID", &r.AppID)
			delete(rawMsg, key)
		case "appSecretSettingName":
			err = unpopulate(val, "AppSecretSettingName", &r.AppSecretSettingName)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", r, err)
