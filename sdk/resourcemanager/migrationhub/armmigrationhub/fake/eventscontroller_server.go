...
func (e *EventsControllerServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if eventsControllerServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = eventsControllerServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "EventsControllerClient.GetEvent":
				res.resp, res.err = e.dispatchGetEvent(req)
			case "EventsControllerClient.NewListEventsPager":
				res.resp, res.err = e.dispatchNewListEventsPager(req)
			default:
...
// set this to conditionally intercept incoming requests to EventsControllerServerTransport
var eventsControllerServerTransportInterceptor interface {
