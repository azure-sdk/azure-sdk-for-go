...
type ServerFactory struct {
	...
	// ObjectAnchorsAccountsServer contains the fakes for client ObjectAnchorsAccountsClient
	ObjectAnchorsAccountsServer ObjectAnchorsAccountsServer

	// OperationsServer contains the fakes for client OperationsClient
	OperationsServer OperationsServer

	// RemoteRenderingAccountsServer contains the fakes for client RemoteRenderingAccountsClient
	RemoteRenderingAccountsServer RemoteRenderingAccountsServer

	// SpatialAnchorsAccountsServer contains the fakes for client SpatialAnchorsAccountsClient
