...
type ServerFactory struct {
	...
	// BackupSchedulesServer contains the fakes for client BackupSchedulesClient
	...
	// BandwidthSettingsServer contains the fakes for client BandwidthSettingsClient
	BandwidthSettingsServer BandwidthSettingsServer

	// CloudAppliancesServer contains the fakes for client CloudAppliancesClient
	CloudAppliancesServer CloudAppliancesServer

	// DeviceSettingsServer contains the fakes for client DeviceSettingsClient
	...
	// HardwareComponentGroupsServer contains the fakes for client HardwareComponentGroupsClient
	...
	// VolumeContainersServer contains the fakes for client VolumeContainersClient
