...
// MarshalJSON implements the json.Marshaller interface for type LeaseContainerRequestAutoGenerated.
func (l LeaseContainerRequestAutoGenerated) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
...
// UnmarshalJSON implements the json.Unmarshaller interface for type LeaseContainerRequestAutoGenerated.
func (l *LeaseContainerRequestAutoGenerated) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", l, err)
	}
