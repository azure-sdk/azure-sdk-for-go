...
// ManagedEnvironmentSecretsClientCreateOrUpdateResponse contains the response from method ManagedEnvironmentSecretsClient.CreateOrUpdate.
type ManagedEnvironmentSecretsClientCreateOrUpdateResponse struct {
	// Secret resource for managedEnvironment.
	ManagedEnvironmentSecret
}

// ManagedEnvironmentSecretsClientDeleteResponse contains the response from method ManagedEnvironmentSecretsClient.Delete.
type ManagedEnvironmentSecretsClientDeleteResponse struct {
	// placeholder for future response values
}

// ManagedEnvironmentSecretsClientGetResponse contains the response from method ManagedEnvironmentSecretsClient.Get.
type ManagedEnvironmentSecretsClientGetResponse struct {
	// Secret resource for managedEnvironment.
	ManagedEnvironmentSecret
}

// ManagedEnvironmentSecretsClientGetValueResponse contains the response from method ManagedEnvironmentSecretsClient.GetValue.
type ManagedEnvironmentSecretsClientGetValueResponse struct {
	// Secret resource for managedEnvironment.
	ManagedEnvironmentSecret
}

// ManagedEnvironmentSecretsClientListResponse contains the response from method ManagedEnvironmentSecretsClient.NewListPager.
type ManagedEnvironmentSecretsClientListResponse struct {
