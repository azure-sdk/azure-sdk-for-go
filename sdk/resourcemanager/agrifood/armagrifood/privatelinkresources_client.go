...
func (client *PrivateLinkResourcesClient) getCreateRequest(ctx context.Context, resourceGroupName string, dataManagerForAgricultureResourceName string, subResourceName string, _ *PrivateLinkResourcesClientGetOptions) (*policy.Request, error) {
...
func (client *PrivateLinkResourcesClient) listByResourceCreateRequest(ctx context.Context, resourceGroupName string, dataManagerForAgricultureResourceName string, _ *PrivateLinkResourcesClientListByResourceOptions) (*policy.Request, error) {
