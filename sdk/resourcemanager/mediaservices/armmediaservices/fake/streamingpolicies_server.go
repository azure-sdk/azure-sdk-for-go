...
func (s *StreamingPoliciesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if streamingPoliciesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = streamingPoliciesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to StreamingPoliciesServerTransport
var streamingPoliciesServerTransportInterceptor interface {
