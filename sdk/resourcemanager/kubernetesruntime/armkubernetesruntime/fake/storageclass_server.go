...
type StorageClassServer struct {
	...
	// NewListByParentPager is the fake for method StorageClassClient.NewListByParentPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByParentPager func(resourceURI string, options *armkubernetesruntime.StorageClassClientListByParentOptions) (resp azfake.PagerResponder[armkubernetesruntime.StorageClassClientListByParentResponse])
...
func NewStorageClassServerTransport(srv *StorageClassServer) *StorageClassServerTransport {
	return &StorageClassServerTransport{
		...
		newListByParentPager: newTracker[azfake.PagerResponder[armkubernetesruntime.StorageClassClientListByParentResponse]](),
...
type StorageClassServerTransport struct {
	...
	newListByParentPager *tracker[azfake.PagerResponder[armkubernetesruntime.StorageClassClientListByParentResponse]]
...
func (s *StorageClassServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	case "StorageClassClient.NewListByParentPager":
...
func (s *StorageClassServerTransport) dispatchNewListByParentPager(req *http.Request) (*http.Response, error) {
	...
	if newListByParentPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListByParentPager, req, func(page *armkubernetesruntime.StorageClassClientListByParentResponse, createLink func() string) {
