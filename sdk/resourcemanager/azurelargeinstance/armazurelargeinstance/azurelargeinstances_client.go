...
//
// Generated from API version 2024-01-10-preview
...
func (client *AzureLargeInstancesClient) createCreateRequest(ctx context.Context, resourceGroupName string, azureLargeInstanceName string, azureLargeInstanceProperties AzureLargeInstance, options *AzureLargeInstancesClientCreateOptions) (*policy.Request, error) {
	...
	reqQP.Set("api-version", "2024-01-10-preview")
...
// Delete - Delete the azure large instance after decommission is completed.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2024-01-10-preview
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - azureLargeInstanceName - Name of the AzureLargeInstance.
//   - options - AzureLargeInstancesClientDeleteOptions contains the optional parameters for the AzureLargeInstancesClient.Delete
//     method.
func (client *AzureLargeInstancesClient) Delete(ctx context.Context, resourceGroupName string, azureLargeInstanceName string, options *AzureLargeInstancesClientDeleteOptions) (AzureLargeInstancesClientDeleteResponse, error) {
	var err error
	const operationName = "AzureLargeInstancesClient.Delete"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.deleteCreateRequest(ctx, resourceGroupName, azureLargeInstanceName, options)
	if err != nil {
		return AzureLargeInstancesClientDeleteResponse{}, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
	if err != nil {
		return AzureLargeInstancesClientDeleteResponse{}, err
	...
	return AzureLargeInstancesClientDeleteResponse{}, nil
}

// deleteCreateRequest creates the Delete request.
func (client *AzureLargeInstancesClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, azureLargeInstanceName string, options *AzureLargeInstancesClientDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureLargeInstance/azureLargeInstances/{azureLargeInstanceName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
