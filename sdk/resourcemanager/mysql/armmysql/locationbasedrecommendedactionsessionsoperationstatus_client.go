...
// LocationBasedRecommendedActionSessionsOperationStatusClient contains the methods for the LocationBasedRecommendedActionSessionsOperationStatus
// group.
...
func (client *LocationBasedRecommendedActionSessionsOperationStatusClient) getCreateRequest(ctx context.Context, locationName string, operationID string, _ *LocationBasedRecommendedActionSessionsOperationStatusClientGetOptions) (*policy.Request, error) {
