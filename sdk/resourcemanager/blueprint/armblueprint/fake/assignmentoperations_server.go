...
func (a *AssignmentOperationsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if assignmentOperationsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = assignmentOperationsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to AssignmentOperationsServerTransport
var assignmentOperationsServerTransportInterceptor interface {
