...
// MarshalJSON implements the json.Marshaller interface for type HealthCheckAssignment.
func (h HealthCheckAssignment) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "availableInAzurePolicy", h.AvailableInAzurePolicy)
	populate(objectMap, "availableInDataPlane", h.AvailableInDataPlane)
	populate(objectMap, "complianceStatusInDp", h.ComplianceStatusInDp)
	populate(objectMap, "configurationName", h.ConfigurationName)
	populate(objectMap, "guestConfigurationAssignmentName", h.GuestConfigurationAssignmentName)
	populate(objectMap, "isVisibleToArmInDp", h.IsVisibleToArmInDp)
	populateTimeRFC3339(objectMap, "lastComplianceStatusChecked", h.LastComplianceStatusChecked)
	populate(objectMap, "latestReportId", h.LatestReportID)
	populate(objectMap, "policyAssignmentId", h.PolicyAssignmentID)
	populate(objectMap, "policyAssignmentParameters", &h.PolicyAssignmentParameters)
	populate(objectMap, "policyAssignmentScope", h.PolicyAssignmentScope)
	populate(objectMap, "policyConfigurationParameters", h.PolicyConfigurationParameters)
	populate(objectMap, "policyDefinition", h.PolicyDefinition)
	populate(objectMap, "policyDefinitionEffect", h.PolicyDefinitionEffect)
	populate(objectMap, "policyDefinitionId", h.PolicyDefinitionID)
	populate(objectMap, "policyDefinitionName", h.PolicyDefinitionName)
	populate(objectMap, "policyDisplayName", h.PolicyDisplayName)
	populate(objectMap, "policyType", h.PolicyType)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type HealthCheckAssignment.
func (h *HealthCheckAssignment) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
	...
	for key, val := range rawMsg {
		var err error
		switch key {
		case "availableInAzurePolicy":
			err = unpopulate(val, "AvailableInAzurePolicy", &h.AvailableInAzurePolicy)
			delete(rawMsg, key)
		case "availableInDataPlane":
			err = unpopulate(val, "AvailableInDataPlane", &h.AvailableInDataPlane)
			delete(rawMsg, key)
		case "complianceStatusInDp":
			err = unpopulate(val, "ComplianceStatusInDp", &h.ComplianceStatusInDp)
			delete(rawMsg, key)
		case "configurationName":
			err = unpopulate(val, "ConfigurationName", &h.ConfigurationName)
			delete(rawMsg, key)
		case "guestConfigurationAssignmentName":
			err = unpopulate(val, "GuestConfigurationAssignmentName", &h.GuestConfigurationAssignmentName)
			delete(rawMsg, key)
		case "isVisibleToArmInDp":
			err = unpopulate(val, "IsVisibleToArmInDp", &h.IsVisibleToArmInDp)
			delete(rawMsg, key)
		case "lastComplianceStatusChecked":
			err = unpopulateTimeRFC3339(val, "LastComplianceStatusChecked", &h.LastComplianceStatusChecked)
			delete(rawMsg, key)
		case "latestReportId":
			err = unpopulate(val, "LatestReportID", &h.LatestReportID)
			delete(rawMsg, key)
		case "policyAssignmentId":
			err = unpopulate(val, "PolicyAssignmentID", &h.PolicyAssignmentID)
			delete(rawMsg, key)
		case "policyAssignmentParameters":
			err = unpopulate(val, "PolicyAssignmentParameters", &h.PolicyAssignmentParameters)
			delete(rawMsg, key)
		case "policyAssignmentScope":
			err = unpopulate(val, "PolicyAssignmentScope", &h.PolicyAssignmentScope)
			delete(rawMsg, key)
		case "policyConfigurationParameters":
			err = unpopulate(val, "PolicyConfigurationParameters", &h.PolicyConfigurationParameters)
			delete(rawMsg, key)
		case "policyDefinition":
			err = unpopulate(val, "PolicyDefinition", &h.PolicyDefinition)
			delete(rawMsg, key)
		case "policyDefinitionEffect":
			err = unpopulate(val, "PolicyDefinitionEffect", &h.PolicyDefinitionEffect)
			delete(rawMsg, key)
		case "policyDefinitionId":
			err = unpopulate(val, "PolicyDefinitionID", &h.PolicyDefinitionID)
			delete(rawMsg, key)
		case "policyDefinitionName":
			err = unpopulate(val, "PolicyDefinitionName", &h.PolicyDefinitionName)
			delete(rawMsg, key)
		case "policyDisplayName":
			err = unpopulate(val, "PolicyDisplayName", &h.PolicyDisplayName)
			delete(rawMsg, key)
		case "policyType":
			err = unpopulate(val, "PolicyType", &h.PolicyType)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", h, err)
...
// MarshalJSON implements the json.Marshaller interface for type VMHealthCheckProperties.
func (v VMHealthCheckProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "assignments", v.Assignments)
	populate(objectMap, "isGcExtensionInstalled", v.IsGcExtensionInstalled)
	populate(objectMap, "isMsiEnabled", v.IsMsiEnabled)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type VMHealthCheckProperties.
func (v *VMHealthCheckProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "assignments":
			err = unpopulate(val, "Assignments", &v.Assignments)
			delete(rawMsg, key)
		case "isGcExtensionInstalled":
			err = unpopulate(val, "IsGcExtensionInstalled", &v.IsGcExtensionInstalled)
			delete(rawMsg, key)
		case "isMsiEnabled":
			err = unpopulate(val, "IsMsiEnabled", &v.IsMsiEnabled)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", v, err)
