...
type StorageAccountCredentialsServer struct {
	...
	BeginCreateOrUpdate func(ctx context.Context, credentialName string, resourceGroupName string, managerName string, storageAccount armstorsimple1200series.StorageAccountCredential, options *armstorsimple1200series.StorageAccountCredentialsClientBeginCreateOrUpdateOptions) (resp azfake.PollerResponder[armstorsimple1200series.StorageAccountCredentialsClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)

	// BeginDelete is the fake for method StorageAccountCredentialsClient.BeginDelete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginDelete func(ctx context.Context, credentialName string, resourceGroupName string, managerName string, options *armstorsimple1200series.StorageAccountCredentialsClientBeginDeleteOptions) (resp azfake.PollerResponder[armstorsimple1200series.StorageAccountCredentialsClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method StorageAccountCredentialsClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, credentialName string, resourceGroupName string, managerName string, options *armstorsimple1200series.StorageAccountCredentialsClientGetOptions) (resp azfake.Responder[armstorsimple1200series.StorageAccountCredentialsClientGetResponse], errResp azfake.ErrorResponder)

	// NewListByManagerPager is the fake for method StorageAccountCredentialsClient.NewListByManagerPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByManagerPager func(resourceGroupName string, managerName string, options *armstorsimple1200series.StorageAccountCredentialsClientListByManagerOptions) (resp azfake.PagerResponder[armstorsimple1200series.StorageAccountCredentialsClientListByManagerResponse])
}
...
// The returned StorageAccountCredentialsServerTransport instance is connected to an instance of armstorsimple1200series.StorageAccountCredentialsClient via the
...
func NewStorageAccountCredentialsServerTransport(srv *StorageAccountCredentialsServer) *StorageAccountCredentialsServerTransport {
	return &StorageAccountCredentialsServerTransport{
		srv:                   srv,
		beginCreateOrUpdate:   newTracker[azfake.PollerResponder[armstorsimple1200series.StorageAccountCredentialsClientCreateOrUpdateResponse]](),
		beginDelete:           newTracker[azfake.PollerResponder[armstorsimple1200series.StorageAccountCredentialsClientDeleteResponse]](),
		newListByManagerPager: newTracker[azfake.PagerResponder[armstorsimple1200series.StorageAccountCredentialsClientListByManagerResponse]](),
	}
}

// StorageAccountCredentialsServerTransport connects instances of armstorsimple1200series.StorageAccountCredentialsClient to instances of StorageAccountCredentialsServer.
...
type StorageAccountCredentialsServerTransport struct {
	...
	beginCreateOrUpdate   *tracker[azfake.PollerResponder[armstorsimple1200series.StorageAccountCredentialsClientCreateOrUpdateResponse]]
	beginDelete           *tracker[azfake.PollerResponder[armstorsimple1200series.StorageAccountCredentialsClientDeleteResponse]]
	newListByManagerPager *tracker[azfake.PagerResponder[armstorsimple1200series.StorageAccountCredentialsClientListByManagerResponse]]
}
	...
	go func() {
		...
		if !intercepted {
			...
			case "StorageAccountCredentialsClient.NewListByManagerPager":
				res.resp, res.err = s.dispatchNewListByManagerPager(req)
			default:
...
func (s *StorageAccountCredentialsServerTransport) dispatchBeginCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginCreateOrUpdate == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.StorSimple/managers/(?P<managerName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/storageAccountCredentials/(?P<credentialName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if matches == nil || len(matches) < 4 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
		}
		body, err := server.UnmarshalRequestAsJSON[armstorsimple1200series.StorageAccountCredential](req)
		if err != nil {
			return nil, err
		}
		...
		respr, errRespr := s.srv.BeginCreateOrUpdate(req.Context(), credentialNameParam, resourceGroupNameParam, managerNameParam, body, nil)
...
func (s *StorageAccountCredentialsServerTransport) dispatchBeginDelete(req *http.Request) (*http.Response, error) {
	...
	if beginDelete == nil {
		...
		respr, errRespr := s.srv.BeginDelete(req.Context(), credentialNameParam, resourceGroupNameParam, managerNameParam, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginDelete = &respr
...
func (s *StorageAccountCredentialsServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := s.srv.Get(req.Context(), credentialNameParam, resourceGroupNameParam, managerNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
