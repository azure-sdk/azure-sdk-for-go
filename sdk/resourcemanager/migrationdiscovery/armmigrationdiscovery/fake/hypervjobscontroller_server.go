...
// HypervJobsControllerServer is a fake server for instances of the armmigrationdiscovery.HypervJobsControllerClient type.
type HypervJobsControllerServer struct {
	// Get is the fake for method HypervJobsControllerClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, siteName string, jobName string, options *armmigrationdiscovery.HypervJobsControllerClientGetOptions) (resp azfake.Responder[armmigrationdiscovery.HypervJobsControllerClientGetResponse], errResp azfake.ErrorResponder)

	// NewListByVmwareSitePager is the fake for method HypervJobsControllerClient.NewListByVmwareSitePager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByVmwareSitePager func(resourceGroupName string, siteName string, options *armmigrationdiscovery.HypervJobsControllerClientListByVmwareSiteOptions) (resp azfake.PagerResponder[armmigrationdiscovery.HypervJobsControllerClientListByVmwareSiteResponse])
}
...
// The returned HypervJobsControllerServerTransport instance is connected to an instance of armmigrationdiscovery.HypervJobsControllerClient via the
...
func NewHypervJobsControllerServerTransport(srv *HypervJobsControllerServer) *HypervJobsControllerServerTransport {
	return &HypervJobsControllerServerTransport{
		srv:                      srv,
		newListByVmwareSitePager: newTracker[azfake.PagerResponder[armmigrationdiscovery.HypervJobsControllerClientListByVmwareSiteResponse]](),
	}
}

// HypervJobsControllerServerTransport connects instances of armmigrationdiscovery.HypervJobsControllerClient to instances of HypervJobsControllerServer.
...
type HypervJobsControllerServerTransport struct {
	...
	newListByVmwareSitePager *tracker[azfake.PagerResponder[armmigrationdiscovery.HypervJobsControllerClientListByVmwareSiteResponse]]
}
...
func (h *HypervJobsControllerServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if hypervJobsControllerServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = hypervJobsControllerServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "HypervJobsControllerClient.NewListByVmwareSitePager":
				res.resp, res.err = h.dispatchNewListByVmwareSitePager(req)
			default:
...
func (h *HypervJobsControllerServerTransport) dispatchNewListByVmwareSitePager(req *http.Request) (*http.Response, error) {
	...
	if newListByVmwareSitePager == nil {
		...
		server.PagerResponderInjectNextLinks(newListByVmwareSitePager, req, func(page *armmigrationdiscovery.HypervJobsControllerClientListByVmwareSiteResponse, createLink func() string) {
...
// set this to conditionally intercept incoming requests to HypervJobsControllerServerTransport
var hypervJobsControllerServerTransportInterceptor interface {
