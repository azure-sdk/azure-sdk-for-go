...
//     method.
func (client *MySQLSitesClient) BeginCreateOrUpdate(ctx context.Context, resourceGroupName string, siteName string, body MySQLSite, options *MySQLSitesClientBeginCreateOrUpdateOptions) (*runtime.Poller[MySQLSitesClientCreateOrUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.createOrUpdate(ctx, resourceGroupName, siteName, body, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2024-09-30-preview
func (client *MySQLSitesClient) createOrUpdate(ctx context.Context, resourceGroupName string, siteName string, body MySQLSite, options *MySQLSitesClientBeginCreateOrUpdateOptions) (*http.Response, error) {
	var err error
	const operationName = "MySQLSitesClient.BeginCreateOrUpdate"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.createOrUpdateCreateRequest(ctx, resourceGroupName, siteName, body, options)
	if err != nil {
		return nil, err
	}
...
func (client *MySQLSitesClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, siteName string, body MySQLSite, _ *MySQLSitesClientBeginCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *MySQLSitesClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, siteName string, _ *MySQLSitesClientDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MySQLDiscovery/MySQLSites/{siteName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *MySQLSitesClient) getCreateRequest(ctx context.Context, resourceGroupName string, siteName string, _ *MySQLSitesClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MySQLDiscovery/MySQLSites/{siteName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
// NewListByResourceGroupPager - Lists the MySQLSites resource in a resource group.
//
// Generated from API version 2024-09-30-preview
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
...
func (client *MySQLSitesClient) triggerRefreshCreateRequest(ctx context.Context, resourceGroupName string, siteName string, _ *MySQLSitesClientBeginTriggerRefreshOptions) (*policy.Request, error) {
...
func (client *MySQLSitesClient) updateCreateRequest(ctx context.Context, resourceGroupName string, siteName string, properties MySQLSitesResourcePatch, _ *MySQLSitesClientBeginUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MySQLDiscovery/MySQLSites/{siteName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
