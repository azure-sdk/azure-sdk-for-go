...
func (client *OrchestratorInstanceServiceClient) createCreateRequest(ctx context.Context, resourceGroupName string, resourceName string, parameters Orchestrator, _ *OrchestratorInstanceServiceClientBeginCreateOptions) (*policy.Request, error) {
...
func (client *OrchestratorInstanceServiceClient) getDetailsCreateRequest(ctx context.Context, resourceGroupName string, resourceName string, _ *OrchestratorInstanceServiceClientGetDetailsOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DelegatedNetwork/orchestrators/{resourceName}"
	if resourceGroupName == "" {
		return nil, errors.New("parameter resourceGroupName cannot be empty")
	}
...
func (client *OrchestratorInstanceServiceClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, _ *OrchestratorInstanceServiceClientListByResourceGroupOptions) (*policy.Request, error) {
...
func (client *OrchestratorInstanceServiceClient) listBySubscriptionCreateRequest(ctx context.Context, _ *OrchestratorInstanceServiceClientListBySubscriptionOptions) (*policy.Request, error) {
...
func (client *OrchestratorInstanceServiceClient) patchCreateRequest(ctx context.Context, resourceGroupName string, resourceName string, parameters OrchestratorResourceUpdateParameters, _ *OrchestratorInstanceServiceClientPatchOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DelegatedNetwork/orchestrators/{resourceName}"
	if resourceGroupName == "" {
		return nil, errors.New("parameter resourceGroupName cannot be empty")
	}
