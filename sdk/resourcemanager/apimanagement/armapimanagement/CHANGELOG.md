...
- New field `NatOutboundAddresses` in struct `ServiceBaseProperties`
...
- New field `NatOutboundAddresses` in struct `ServiceProperties`
...
- New field `NatOutboundAddresses` in struct `AdditionalLocation`
- New field `NatGatewayState` in struct `ServiceUpdateProperties`
- New field `NatOutboundAddresses` in struct `ServiceUpdateProperties`
