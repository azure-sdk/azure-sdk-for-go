...
// method.
func (client *StaticSitesClient) BeginPurgeStaticSite(ctx context.Context, resourceGroupName string, name string, options *StaticSitesClientBeginPurgeStaticSiteOptions) (*armruntime.Poller[StaticSitesClientPurgeStaticSiteResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.purgeStaticSite(ctx, resourceGroupName, name, options)
		if err != nil {
			return nil, err
		}
		return armruntime.NewPoller[StaticSitesClientPurgeStaticSiteResponse](resp, client.pl, nil)
	} else {
		return armruntime.NewPollerFromResumeToken[StaticSitesClientPurgeStaticSiteResponse](options.ResumeToken, client.pl, nil)
	}
}
...
// method.
func (client *StaticSitesClient) BeginPurgeStaticSiteBuild(ctx context.Context, resourceGroupName string, name string, environmentName string, options *StaticSitesClientBeginPurgeStaticSiteBuildOptions) (*armruntime.Poller[StaticSitesClientPurgeStaticSiteBuildResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.purgeStaticSiteBuild(ctx, resourceGroupName, name, environmentName, options)
		if err != nil {
			return nil, err
		}
		return armruntime.NewPoller[StaticSitesClientPurgeStaticSiteBuildResponse](resp, client.pl, nil)
	} else {
		return armruntime.NewPollerFromResumeToken[StaticSitesClientPurgeStaticSiteBuildResponse](options.ResumeToken, client.pl, nil)
	}
}
