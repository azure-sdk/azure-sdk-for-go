...
- Function `*SAPVirtualInstancesClient.BeginStart` parameter(s) have been changed from `(context.Context, string, string, *SAPVirtualInstancesClientBeginStartOptions)` to `(context.Context, string, string, StartRequest, *SAPVirtualInstancesClientBeginStartOptions)`
- Function `*SAPVirtualInstancesClient.BeginStop` parameter(s) have been changed from `(context.Context, string, string, *SAPVirtualInstancesClientBeginStopOptions)` to `(context.Context, string, string, StopRequest, *SAPVirtualInstancesClientBeginStopOptions)`
...
- Field `Body` of struct `SAPVirtualInstancesClientBeginStartOptions` has been removed
- Field `Body` of struct `SAPVirtualInstancesClientBeginStopOptions` has been removed
