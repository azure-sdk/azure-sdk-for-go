...
func (client *TestTypesClient) getCreateRequest(ctx context.Context, resourceGroupName string, testBaseAccountName string, testTypeResourceName string, _ *TestTypesClientGetOptions) (*policy.Request, error) {
...
func (client *TestTypesClient) listCreateRequest(ctx context.Context, resourceGroupName string, testBaseAccountName string, _ *TestTypesClientListOptions) (*policy.Request, error) {
