...
// APICollectionsClientCreateResponse contains the response from method APICollectionsClient.Create.
type APICollectionsClientCreateResponse struct {
	// An API collection as represented by Defender for APIs.
	APICollection
}

// APICollectionsClientDeleteResponse contains the response from method APICollectionsClient.Delete.
type APICollectionsClientDeleteResponse struct {
	// placeholder for future response values
}

// APICollectionsClientGetResponse contains the response from method APICollectionsClient.Get.
type APICollectionsClientGetResponse struct {
	// An API collection as represented by Defender for APIs.
	APICollection
}

// APICollectionsClientListResponse contains the response from method APICollectionsClient.NewListPager.
type APICollectionsClientListResponse struct {
