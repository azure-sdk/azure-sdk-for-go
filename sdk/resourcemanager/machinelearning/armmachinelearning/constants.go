...
const (
	TrialTypeCommandComponent  TrialType = "CommandComponent"
	TrialTypePipelineComponent TrialType = "PipelineComponent"
)

// PossibleTrialTypeValues returns the possible values for the TrialType const type.
func PossibleTrialTypeValues() []TrialType {
	return []TrialType{
		TrialTypeCommandComponent,
		TrialTypePipelineComponent,
	}
}
