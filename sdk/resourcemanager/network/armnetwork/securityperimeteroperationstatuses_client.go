...
func (client *SecurityPerimeterOperationStatusesClient) getCreateRequest(ctx context.Context, location string, operationID string, options *SecurityPerimeterOperationStatusesClientGetOptions) (*policy.Request, error) {
