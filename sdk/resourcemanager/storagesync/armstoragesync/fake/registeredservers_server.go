...
func (r *RegisteredServersServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if registeredServersServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = registeredServersServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "RegisteredServersClient.NewListByStorageSyncServicePager":
				res.resp, res.err = r.dispatchNewListByStorageSyncServicePager(req)
			case "RegisteredServersClient.BeginTriggerRollover":
				res.resp, res.err = r.dispatchBeginTriggerRollover(req)
...
// set this to conditionally intercept incoming requests to RegisteredServersServerTransport
var registeredServersServerTransportInterceptor interface {
