...
func (client *NetworkInterfacesClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, networkInterfaceName string, resource NetworkInterface, options *NetworkInterfacesClientBeginCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *NetworkInterfacesClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, options *NetworkInterfacesClientListByResourceGroupOptions) (*policy.Request, error) {
...
//     method.
func (client *NetworkInterfacesClient) BeginUpdate(ctx context.Context, resourceGroupName string, networkInterfaceName string, properties NetworkInterfaceTagsUpdate, options *NetworkInterfacesClientBeginUpdateOptions) (*runtime.Poller[NetworkInterfacesClientUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
...
//
// Generated from API version 2024-02-01-preview
func (client *NetworkInterfacesClient) update(ctx context.Context, resourceGroupName string, networkInterfaceName string, properties NetworkInterfaceTagsUpdate, options *NetworkInterfacesClientBeginUpdateOptions) (*http.Response, error) {
	var err error
...
func (client *NetworkInterfacesClient) updateCreateRequest(ctx context.Context, resourceGroupName string, networkInterfaceName string, properties NetworkInterfaceTagsUpdate, options *NetworkInterfacesClientBeginUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureStackHCI/networkInterfaces/{networkInterfaceName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
