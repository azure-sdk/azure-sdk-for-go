...
- New enum type `Startdayofweek` with values `StartdayofweekFriday`, `StartdayofweekMonday`, `StartdayofweekNone`, `StartdayofweekSaturday`, `StartdayofweekSunday`, `StartdayofweekThursday`, `StartdayofweekTuesday`, `StartdayofweekWednesday`
...
- New field `ProvisioningState`, `UpgradePreferences` in struct `ClusterProperties`
