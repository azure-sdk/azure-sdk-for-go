...
func (client *ProjectsClient) Create(ctx context.Context, resourceGroupName string, projectName string, project Project, options *ProjectsClientCreateOptions) (ProjectsClientCreateResponse, error) {
	req, err := client.createCreateRequest(ctx, resourceGroupName, projectName, project, options)
	if err != nil {
...
func (client *ProjectsClient) createCreateRequest(ctx context.Context, resourceGroupName string, projectName string, project Project, options *ProjectsClientCreateOptions) (*policy.Request, error) {
...
func (client *ProjectsClient) Update(ctx context.Context, resourceGroupName string, projectName string, project Project, options *ProjectsClientUpdateOptions) (ProjectsClientUpdateResponse, error) {
	req, err := client.updateCreateRequest(ctx, resourceGroupName, projectName, project, options)
	if err != nil {
...
func (client *ProjectsClient) updateCreateRequest(ctx context.Context, resourceGroupName string, projectName string, project Project, options *ProjectsClientUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/Microsoft.Migrate/assessmentProjects/{projectName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
