...
func (client *TestResultsClient) getCreateRequest(ctx context.Context, resourceGroupName string, testBaseAccountName string, packageName string, testResultName string, _ *TestResultsClientGetOptions) (*policy.Request, error) {
...
func (client *TestResultsClient) GetConsoleLogDownloadURL(ctx context.Context, resourceGroupName string, testBaseAccountName string, packageName string, testResultName string, parameters TestResultConsoleLogDownloadURLParameters, options *TestResultsClientGetConsoleLogDownloadURLOptions) (TestResultsClientGetConsoleLogDownloadURLResponse, error) {
	var err error
	const operationName = "TestResultsClient.GetConsoleLogDownloadURL"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	...
	resp, err := client.getConsoleLogDownloadURLHandleResponse(httpResp)
	return resp, err
}

// getConsoleLogDownloadURLCreateRequest creates the GetConsoleLogDownloadURL request.
func (client *TestResultsClient) getConsoleLogDownloadURLCreateRequest(ctx context.Context, resourceGroupName string, testBaseAccountName string, packageName string, testResultName string, parameters TestResultConsoleLogDownloadURLParameters, _ *TestResultsClientGetConsoleLogDownloadURLOptions) (*policy.Request, error) {
...
func (client *TestResultsClient) getDownloadURLCreateRequest(ctx context.Context, resourceGroupName string, testBaseAccountName string, packageName string, testResultName string, _ *TestResultsClientGetDownloadURLOptions) (*policy.Request, error) {
...
func (client *TestResultsClient) getVideoDownloadURLCreateRequest(ctx context.Context, resourceGroupName string, testBaseAccountName string, packageName string, testResultName string, _ *TestResultsClientGetVideoDownloadURLOptions) (*policy.Request, error) {
