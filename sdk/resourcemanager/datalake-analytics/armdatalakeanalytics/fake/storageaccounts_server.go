	...
	go func() {
		...
		if !intercepted {
			...
			case "StorageAccountsClient.Add":
				res.resp, res.err = s.dispatchAdd(req)
			...
			case "StorageAccountsClient.GetStorageContainer":
				res.resp, res.err = s.dispatchGetStorageContainer(req)
			...
			case "StorageAccountsClient.NewListSasTokensPager":
				res.resp, res.err = s.dispatchNewListSasTokensPager(req)
			case "StorageAccountsClient.NewListStorageContainersPager":
				res.resp, res.err = s.dispatchNewListStorageContainersPager(req)
