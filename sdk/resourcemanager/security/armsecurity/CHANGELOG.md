...
- Type alias `AADConnectivityState` has been removed
- Type alias `ActionType` has been removed
- Type alias `AdaptiveApplicationControlIssue` has been removed
- Type alias `AdditionalWorkspaceDataType` has been removed
- Type alias `AdditionalWorkspaceType` has been removed
- Type alias `AlertSeverity` has been removed
- Type alias `AlertStatus` has been removed
- Type alias `ApplicationConditionOperator` has been removed
- Type alias `ApplicationSourceResourceType` has been removed
- Type alias `AssessedResourceType` has been removed
- Type alias `AssessmentStatusCode` has been removed
- Type alias `AssessmentType` has been removed
- Type alias `AuthenticationProvisioningState` has been removed
- Type alias `AuthenticationType` has been removed
- Type alias `AutoProvision` has been removed
- Type alias `BundleType` has been removed
- Type alias `Categories` has been removed
- Type alias `CloudName` has been removed
- Type alias `ConfigurationStatus` has been removed
- Type alias `ConnectionType` has been removed
- Type alias `ControlType` has been removed
- Type alias `CreatedByType` has been removed
- Type alias `DataSource` has been removed
- Type alias `Direction` has been removed
- Type alias `EndOfSupportStatus` has been removed
- Type alias `EnforcementMode` has been removed
- Type alias `EnforcementSupport` has been removed
- Type alias `EnvironmentType` has been removed
- Type alias `EventSource` has been removed
- Type alias `ExpandControlsEnum` has been removed
- Type alias `ExpandEnum` has been removed
- Type alias `ExportData` has been removed
- Type alias `ExternalSecuritySolutionKind` has been removed
- Type alias `FileType` has been removed
- Type alias `GovernanceRuleConditionOperator` has been removed
- Type alias `GovernanceRuleOwnerSourceType` has been removed
- Type alias `GovernanceRuleSourceResourceType` has been removed
- Type alias `GovernanceRuleType` has been removed
- Type alias `HybridComputeProvisioningState` has been removed
- Type alias `ImplementationEffort` has been removed
- Type alias `InformationProtectionPolicyName` has been removed
- Type alias `Intent` has been removed
- Type alias `Kind` has been removed
- Type alias `MinimalSeverity` has been removed
- Type alias `OfferingType` has been removed
- Type alias `Operator` has been removed
- Type alias `OrganizationMembershipType` has been removed
- Type alias `PermissionProperty` has been removed
- Type alias `PricingTier` has been removed
- Type alias `PropertyType` has been removed
- Type alias `Protocol` has been removed
- Type alias `ProvisioningState` has been removed
- Type alias `Rank` has been removed
- Type alias `RecommendationAction` has been removed
- Type alias `RecommendationConfigStatus` has been removed
- Type alias `RecommendationStatus` has been removed
- Type alias `RecommendationType` has been removed
- Type alias `ReportedSeverity` has been removed
- Type alias `ResourceIdentifierType` has been removed
- Type alias `ResourceStatus` has been removed
- Type alias `Roles` has been removed
- Type alias `RuleSeverity` has been removed
- Type alias `RuleState` has been removed
- Type alias `RuleStatus` has been removed
- Type alias `RuleType` has been removed
- Type alias `ScanningMode` has been removed
- Type alias `SecurityFamily` has been removed
- Type alias `SecuritySolutionStatus` has been removed
- Type alias `ServerVulnerabilityAssessmentPropertiesProvisioningState` has been removed
- Type alias `SettingKind` has been removed
- Type alias `SettingName` has been removed
- Type alias `Severity` has been removed
- Type alias `SeverityEnum` has been removed
- Type alias `Source` has been removed
- Type alias `SourceSystem` has been removed
- Type alias `State` has been removed
- Type alias `Status` has been removed
- Type alias `StatusReason` has been removed
- Type alias `SubAssessmentStatusCode` has been removed
- Type alias `SubPlan` has been removed
- Type alias `SupportedCloudEnum` has been removed
- Type alias `Tactics` has been removed
- Type alias `TaskUpdateActionType` has been removed
- Type alias `Techniques` has been removed
- Type alias `Threats` has been removed
- Type alias `TransportProtocol` has been removed
- Type alias `Type` has been removed
- Type alias `UnmaskedIPLoggingStatus` has been removed
- Type alias `UserImpact` has been removed
- Type alias `ValueType` has been removed
...
- Function `*GovernanceRulesClient.Delete` has been removed
...
- Struct `AccountConnectorsClient` has been removed
...
- Struct `AdaptiveApplicationControlsClient` has been removed
...
- Struct `AdaptiveNetworkHardeningsClient` has been removed
- Struct `AdaptiveNetworkHardeningsList` has been removed
- Struct `AdditionalWorkspacesProperties` has been removed
- Struct `AdvancedThreatProtectionClient` has been removed
...
- Struct `AlertsSuppressionRulesClient` has been removed
- Struct `AlertsSuppressionRulesList` has been removed
- Struct `AllowedConnectionsClient` has been removed
...
- Struct `AssessmentsMetadataClient` has been removed
...
- Struct `AutoProvisioningSettingsClient` has been removed
...
- Struct `AutomationsClient` has been removed
...
- Struct `ComplianceResultsClient` has been removed
- Struct `ComplianceSegment` has been removed
- Struct `CompliancesClient` has been removed
...
- Struct `ConnectorApplicationClient` has been removed
- Struct `ConnectorApplicationsClient` has been removed
...
- Struct `ConnectorsClient` has been removed
...
- Struct `CustomAssessmentAutomationsClient` has been removed
...
- Struct `CustomEntityStoreAssignmentsClient` has been removed
...
- Struct `DeviceSecurityGroupsClient` has been removed
...
- Struct `DiscoveredSecuritySolutionsClient` has been removed
...
- Struct `ExternalSecuritySolution` has been removed
...
- Struct `ExternalSecuritySolutionsClient` has been removed
...
- Struct `GovernanceAssignmentsClient` has been removed
...
- Struct `GovernanceRulesClient` has been removed
...
- Struct `InformationProtectionPoliciesClient` has been removed
...
- Struct `IngestionSettingsClient` has been removed
...
- Struct `IotSecuritySolutionAnalyticsClient` has been removed
- Struct `IotSecuritySolutionClient` has been removed
- Struct `IotSecuritySolutionsAnalyticsAggregatedAlertClient` has been removed
- Struct `IotSecuritySolutionsAnalyticsRecommendationClient` has been removed
- Struct `JitNetworkAccessPoliciesClient` has been removed
...
- Struct `MdeOnboardingsClient` has been removed
...
- Struct `PricingsClient` has been removed
...
- Struct `RegulatoryComplianceAssessmentsClient` has been removed
...
- Struct `RegulatoryComplianceControlsClient` has been removed
...
- Struct `RegulatoryComplianceStandardsClient` has been removed
...
- Struct `SQLVulnerabilityAssessmentBaselineRulesClient` has been removed
- Struct `SQLVulnerabilityAssessmentScanResultsClient` has been removed
...
- Struct `SecureScoreControlDefinitionsClient` has been removed
...
- Struct `SecureScoreControlsClient` has been removed
- Struct `SecureScoreItem` has been removed
- Struct `SecureScoreItemProperties` has been removed
- Struct `SecureScoresClient` has been removed
...
- Struct `ServerVulnerabilityAssessmentClient` has been removed
...
- Struct `SettingsClient` has been removed
- Struct `SettingsList` has been removed
- Struct `Software` has been removed
- Struct `SoftwareInventoriesClient` has been removed
...
- Struct `SolutionsClient` has been removed
- Struct `SolutionsReferenceData` has been removed
- Struct `SolutionsReferenceDataClient` has been removed
...
- Struct `SubAssessmentsClient` has been removed
...
- Struct `TopologyClient` has been removed
...
- Struct `WorkspaceSettingsClient` has been removed
- Field `Scan` of struct `SQLVulnerabilityAssessmentScansClientGetResponse` has been removed
- Field `Scans` of struct `SQLVulnerabilityAssessmentScansClientListResponse` has been removed
...
- New anonymous field `ScansV2` in struct `SQLVulnerabilityAssessmentScansClientListResponse`
