...
// CategoryListResult - The response of a ImpactCategory list operation.
...
// example, when a VM is impacted due to a network issue, the impacted resource could be VM or the
...
// Connector - A ImpactProviderHub resource
...
// ConnectorProperties - Details of the Impact Connector.
...
// Details - details of of the impact for which insight has been generated.
type Details struct {
...
// ImpactedResources - resource and associated arm correlation ids
...
// TopologyImpact - Topology Impact properties
type TopologyImpact struct {
	// The resource-specific properties for this resource.
	Properties *TopologyImpactProperties
...
// TopologyImpactListResult - The response of a TopologyImpact list operation.
type TopologyImpactListResult struct {
	// REQUIRED; The TopologyImpact items on this page
	Value []*TopologyImpact

	// READ-ONLY; The link to the next page of items
	NextLink *string
}

// TopologyImpactProperties - Topology impact properties
type TopologyImpactProperties struct {
	// REQUIRED; list of impacted resources and associated arm correlation ids
...
type WorkloadImpactProperties struct {
	...
	// a VM is impacted due to a network issue, the impacted resource is identified as
	// the VM, but the root cause is the network. In such cases, the connectivity field will have the details about the network
	// issue
