...
func (i *IscsiDisksServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if iscsiDisksServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = iscsiDisksServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "IscsiDisksClient.NewListByDevicePager":
				res.resp, res.err = i.dispatchNewListByDevicePager(req)
			case "IscsiDisksClient.NewListByIscsiServerPager":
				res.resp, res.err = i.dispatchNewListByIscsiServerPager(req)
			case "IscsiDisksClient.NewListMetricDefinitionPager":
				res.resp, res.err = i.dispatchNewListMetricDefinitionPager(req)
			case "IscsiDisksClient.NewListMetricsPager":
				res.resp, res.err = i.dispatchNewListMetricsPager(req)
			default:
...
// set this to conditionally intercept incoming requests to IscsiDisksServerTransport
var iscsiDisksServerTransportInterceptor interface {
