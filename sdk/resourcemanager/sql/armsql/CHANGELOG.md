...
- New enum type `DatabaseBillingVersion` with values `DatabaseBillingVersionOne`, `DatabaseBillingVersionTwo`
...
- New enum type `HyperscaleBillingVersion` with values `HyperscaleBillingVersionOne`, `HyperscaleBillingVersionTwo`
...
- New function `*ClientFactory.NewDatabaseBillingVersionClient() *DatabaseBillingVersionClient`
- New function `*ClientFactory.NewNetworkSecurityPerimeterConfigurationsClient() *NetworkSecurityPerimeterConfigurationsClient`
- New function `NewDatabaseBillingVersionClient(string, azcore.TokenCredential, *arm.ClientOptions) (*DatabaseBillingVersionClient, error)`
- New function `*DatabaseBillingVersionClient.Create(context.Context, string, string, string, *DatabaseBillingVersionClientCreateOptions) (DatabaseBillingVersionClientCreateResponse, error)`
...
- New struct `DatabaseBillingVersionProperties`
- New struct `DatabaseBillingVersionResponse`
...
- New field `HyperscaleBillingVersion` in struct `DatabaseProperties`
...
- New field `AutoPauseDelay` in struct `ElasticPoolProperties`
- New field `AutoPauseDelay` in struct `ElasticPoolUpdateProperties`
...
- New field `AuthenticationMetadata`, `CreateTime`, `DatabaseFormat`, `ExternalGovernanceStatus`, `HybridSecondaryUsage`, `HybridSecondaryUsageDetected`, `IsGeneralPurposeV2`, `PricingModel`, `StorageIOps`, `StorageThroughputMBps`, `TotalMemoryMB`, `VirtualClusterID` in struct `ManagedInstanceProperties`
- New field `IncludedStorageIOps`, `IncludedStorageThroughputMBps`, `IopsIncludedValueOverrideFactorPerSelectedStorageGB`, `IopsMinValueOverrideFactorPerSelectedStorageGB`, `SupportedMemoryLimitsMB`, `SupportedStorageIOps`, `SupportedStorageThroughputMBps`, `ThroughputMBpsIncludedValueOverrideFactorPerSelectedStorageGB`, `ThroughputMBpsMinValueOverrideFactorPerSelectedStorageGB` in struct `ManagedInstanceVcoresCapability`
