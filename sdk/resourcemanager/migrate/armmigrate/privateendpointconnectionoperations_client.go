...
func NewPrivateEndpointConnectionOperationsClient(subscriptionID string, credential azcore.TokenCredential, options *arm.ClientOptions) (*PrivateEndpointConnectionOperationsClient, error) {
	cl, err := arm.NewClient(moduleName+".PrivateEndpointConnectionOperationsClient", moduleVersion, credential, options)
	if err != nil {
		return nil, err
	}
...
func (client *PrivateEndpointConnectionOperationsClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, projectName string, privateEndpointConnectionName string, options *PrivateEndpointConnectionOperationsClientDeleteOptions) (*policy.Request, error) {
...
func (client *PrivateEndpointConnectionOperationsClient) getCreateRequest(ctx context.Context, resourceGroupName string, projectName string, privateEndpointConnectionName string, options *PrivateEndpointConnectionOperationsClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Migrate/assessmentProjects/{projectName}/privateEndpointConnections/{privateEndpointConnectionName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
	...
	return runtime.NewPager(runtime.PagingHandler[PrivateEndpointConnectionOperationsClientListByAssessmentProjectResponse]{
		...
		Fetcher: func(ctx context.Context, page *PrivateEndpointConnectionOperationsClientListByAssessmentProjectResponse) (PrivateEndpointConnectionOperationsClientListByAssessmentProjectResponse, error) {
			...
			if !runtime.HasStatusCode(resp, http.StatusOK) {
				return PrivateEndpointConnectionOperationsClientListByAssessmentProjectResponse{}, runtime.NewResponseError(resp)
			}
...
func (client *PrivateEndpointConnectionOperationsClient) listByAssessmentProjectCreateRequest(ctx context.Context, resourceGroupName string, projectName string, options *PrivateEndpointConnectionOperationsClientListByAssessmentProjectOptions) (*policy.Request, error) {
...
func (client *PrivateEndpointConnectionOperationsClient) BeginUpdate(ctx context.Context, resourceGroupName string, projectName string, privateEndpointConnectionName string, resource PrivateEndpointConnection, options *PrivateEndpointConnectionOperationsClientBeginUpdateOptions) (*runtime.Poller[PrivateEndpointConnectionOperationsClientUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return runtime.NewPollerFromResumeToken[PrivateEndpointConnectionOperationsClientUpdateResponse](options.ResumeToken, client.internal.Pipeline(), nil)
	}
}
...
func (client *PrivateEndpointConnectionOperationsClient) updateCreateRequest(ctx context.Context, resourceGroupName string, projectName string, privateEndpointConnectionName string, resource PrivateEndpointConnection, options *PrivateEndpointConnectionOperationsClientBeginUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Migrate/assessmentProjects/{projectName}/privateEndpointConnections/{privateEndpointConnectionName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
