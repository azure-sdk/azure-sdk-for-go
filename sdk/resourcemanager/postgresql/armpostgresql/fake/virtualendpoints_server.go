...
func (v *VirtualEndpointsServerTransport) dispatchBeginCreate(req *http.Request) (*http.Response, error) {
	...
	if beginCreate == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armpostgresql.VirtualEndpointResource](req)
		if err != nil {
			return nil, err
		}
