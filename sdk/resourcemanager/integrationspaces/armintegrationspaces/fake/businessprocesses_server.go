...
func (b *BusinessProcessesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if businessProcessesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = businessProcessesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "BusinessProcessesClient.NewListByApplicationPager":
				res.resp, res.err = b.dispatchNewListByApplicationPager(req)
...
// set this to conditionally intercept incoming requests to BusinessProcessesServerTransport
var businessProcessesServerTransportInterceptor interface {
