...
func NewUpfDeploymentsServerTransport(srv *UpfDeploymentsServer) *UpfDeploymentsServerTransport {
	return &UpfDeploymentsServerTransport{
		srv:                         srv,
		beginCreateOrUpdate:         newTracker[azfake.PollerResponder[armmobilepacketcore.UpfDeploymentsClientCreateOrUpdateResponse]](),
...
type UpfDeploymentsServerTransport struct {
	...
	beginCreateOrUpdate         *tracker[azfake.PollerResponder[armmobilepacketcore.UpfDeploymentsClientCreateOrUpdateResponse]]
