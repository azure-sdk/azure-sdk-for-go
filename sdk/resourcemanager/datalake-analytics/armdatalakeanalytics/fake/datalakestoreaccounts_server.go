...
func (d *DataLakeStoreAccountsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if dataLakeStoreAccountsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = dataLakeStoreAccountsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			case "DataLakeStoreAccountsClient.Add":
				res.resp, res.err = d.dispatchAdd(req)
			...
			case "DataLakeStoreAccountsClient.NewListByAccountPager":
				res.resp, res.err = d.dispatchNewListByAccountPager(req)
			default:
...
// set this to conditionally intercept incoming requests to DataLakeStoreAccountsServerTransport
var dataLakeStoreAccountsServerTransportInterceptor interface {
