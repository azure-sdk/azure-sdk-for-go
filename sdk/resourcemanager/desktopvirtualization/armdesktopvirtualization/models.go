...
type ActiveSessionHostConfigurationProperties struct {
	// REQUIRED; Value for availability zones to be used by the session host. Should be from [1,2,3].
	...
	// REQUIRED; The Location for the session host to be created in. It will default to the location of the hostpool if not provided.
	VMLocation *string

	// REQUIRED; The prefix that should be associated with session host names
	VMNamePrefix *string

	// REQUIRED; The ResourceGroup for the session hosts to be created in. It will default to the ResourceGroup of the hostpool
	// if not provided.
	...
	// REQUIRED; Hashtable that lists key/value pair tags to apply to the VMs
