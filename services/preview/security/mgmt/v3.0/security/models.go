...
type CloudOffering struct {
	...
	Description *string `json:"description,omitempty"`
	// OfferingType - Possible values include: 'OfferingTypeCloudOffering', 'OfferingTypeCspmMonitorAws', 'OfferingTypeDefenderForContainersAws', 'OfferingTypeDefenderForServersAws', 'OfferingTypeInformationProtectionAws'
...
type ConnectorProperties struct {
	// HierarchyIdentifier - The multi cloud resource identifier (account id in case of AWS connector).
	HierarchyIdentifier *string `json:"hierarchyIdentifier,omitempty"`
	// CloudName - The multi cloud resource's cloud name. Possible values include: 'Azure', 'AWS', 'GCP'
	...
	// OrganizationalData - The multi cloud account's organizational data
	...
	for k, v := range m {
		...
		case "cloudName":
			if v != nil {
				...
				err = json.Unmarshal(*v, &cloudName)
				if err != nil {
					return err
				}
				cp.CloudName = cloudName
			}
		case "offerings":
			if v != nil {
		...
		case "organizationalData":
			if v != nil {
				var organizationalData ConnectorPropertiesOrganizationalData
				err = json.Unmarshal(*v, &organizationalData)
				if err != nil {
					return err
				}
				cp.OrganizationalData = &organizationalData
			}
		}
	}
...
type ConnectorPropertiesOrganizationalData struct {
	// OrganizationMembershipType - The multi cloud account's membership type in the organization. Possible values include: 'Member', 'Organization'
...
// ScannerConfiguration represents the configuration of the VM scanner
type ScannerConfiguration struct {
	autorest.Response `json:"-"`
	// ScannerProperties - Properties of the VM Scanner resource
	*ScannerProperties `json:"properties,omitempty"`
	// ID - READ-ONLY; Resource Id
	ID *string `json:"id,omitempty"`
	// Name - READ-ONLY; Resource name
	Name *string `json:"name,omitempty"`
...
// MarshalJSON is the custom marshaler for ScannerConfiguration.
func (sc ScannerConfiguration) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if sc.ScannerProperties != nil {
		objectMap["properties"] = sc.ScannerProperties
	}
	if sc.Location != nil {
...
// UnmarshalJSON is the custom unmarshaler for ScannerConfiguration struct.
func (sc *ScannerConfiguration) UnmarshalJSON(body []byte) error {
	var m map[string]*json.RawMessage
	err := json.Unmarshal(body, &m)
	if err != nil {
		return err
	...
	for k, v := range m {
		...
		case "properties":
			if v != nil {
				var scannerProperties ScannerProperties
				err = json.Unmarshal(*v, &scannerProperties)
				if err != nil {
					return err
				}
				sc.ScannerProperties = &scannerProperties
			}
		case "id":
			if v != nil {
				var ID string
...
// ScannerConfigurationList represents a list of VM scanners configurations.
type ScannerConfigurationList struct {
	autorest.Response `json:"-"`
	Value             *[]ScannerConfiguration `json:"value,omitempty"`
}

// ScannerProperties VM Scanner resource properties
type ScannerProperties struct {
	// ScanningMode - The scanning mode. Possible values include: 'Default'
	ScanningMode ScanningMode `json:"scanningMode,omitempty"`
	// ExclusionTags - Dictionary of string key-value pairs representing the tags used to exclude resources from being scanned. Resources tagged with one of these values will not be scanned. The values in the dictionary are case-sensitive
	ExclusionTags map[string]*string `json:"exclusionTags"`
}

// MarshalJSON is the custom marshaler for ScannerProperties.
func (sp ScannerProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if sp.ScanningMode != "" {
		objectMap["scanningMode"] = sp.ScanningMode
	}
	if sp.ExclusionTags != nil {
		objectMap["exclusionTags"] = sp.ExclusionTags
	}
	return json.Marshal(objectMap)
}
