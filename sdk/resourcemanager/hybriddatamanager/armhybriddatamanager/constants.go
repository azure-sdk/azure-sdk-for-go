...
// JobDefinitionState - State of the job definition.
type JobDefinitionState string

const (
	JobDefinitionStateCreated    JobDefinitionState = "Created"
	JobDefinitionStateQueueing   JobDefinitionState = "Queueing"
	JobDefinitionStateWaiting    JobDefinitionState = "Waiting"
	JobDefinitionStateRunning    JobDefinitionState = "Running"
	JobDefinitionStateComplete   JobDefinitionState = "Complete"
	JobDefinitionStateCancelling JobDefinitionState = "Cancelling"
	JobDefinitionStateCancelled  JobDefinitionState = "Cancelled"
	JobDefinitionStatePaused     JobDefinitionState = "Paused"
)

// PossibleJobDefinitionStateValues returns the possible values for the JobDefinitionState const type.
func PossibleJobDefinitionStateValues() []JobDefinitionState {
	return []JobDefinitionState{
		JobDefinitionStateCreated,
		JobDefinitionStateQueueing,
		JobDefinitionStateWaiting,
		JobDefinitionStateRunning,
		JobDefinitionStateComplete,
		JobDefinitionStateCancelling,
		JobDefinitionStateCancelled,
		JobDefinitionStatePaused,
	}
}
...
const (
	...
	RunLocationUsgovtexas         RunLocation = "usgovtexas"
	RunLocationUsgovvirginia      RunLocation = "usgovvirginia"
)
...
func PossibleRunLocationValues() []RunLocation {
	return []RunLocation{
		...
		RunLocationWestus,
		RunLocationWestus2,
		RunLocationUsgovtexas,
		RunLocationUsgovvirginia,
	}
}
