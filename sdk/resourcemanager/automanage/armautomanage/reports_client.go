...
func (client *ReportsClient) getCreateRequest(ctx context.Context, resourceGroupName string, configurationProfileAssignmentName string, reportName string, vmName string, _ *ReportsClientGetOptions) (*policy.Request, error) {
...
func (client *ReportsClient) listByConfigurationProfileAssignmentsCreateRequest(ctx context.Context, resourceGroupName string, configurationProfileAssignmentName string, vmName string, _ *ReportsClientListByConfigurationProfileAssignmentsOptions) (*policy.Request, error) {
