...
// GetAsyncCommand - Get details about a specified command that was run asynchronously.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2024-05-15-preview
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - clusterName - Managed Cassandra cluster name.
//   - commandID - The command id (GUID identifier) for Managed Cassandra cluster command.
//   - options - CassandraClustersClientGetAsyncCommandOptions contains the optional parameters for the CassandraClustersClient.GetAsyncCommand
//     method.
func (client *CassandraClustersClient) GetAsyncCommand(ctx context.Context, resourceGroupName string, clusterName string, commandID string, options *CassandraClustersClientGetAsyncCommandOptions) (CassandraClustersClientGetAsyncCommandResponse, error) {
	var err error
	const operationName = "CassandraClustersClient.GetAsyncCommand"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.getAsyncCommandCreateRequest(ctx, resourceGroupName, clusterName, commandID, options)
	if err != nil {
		return CassandraClustersClientGetAsyncCommandResponse{}, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
	if err != nil {
		return CassandraClustersClientGetAsyncCommandResponse{}, err
	...
	resp, err := client.getAsyncCommandHandleResponse(httpResp)
	return resp, err
}

// getAsyncCommandCreateRequest creates the GetAsyncCommand request.
func (client *CassandraClustersClient) getAsyncCommandCreateRequest(ctx context.Context, resourceGroupName string, clusterName string, commandID string, options *CassandraClustersClientGetAsyncCommandOptions) (*policy.Request, error) {
...
// getAsyncCommandHandleResponse handles the GetAsyncCommand response.
func (client *CassandraClustersClient) getAsyncCommandHandleResponse(resp *http.Response) (CassandraClustersClientGetAsyncCommandResponse, error) {
	result := CassandraClustersClientGetAsyncCommandResponse{}
...
// GetRestore - Get information about a restore that has been triggered.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2024-05-15-preview
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - clusterName - Managed Cassandra cluster name.
//   - backupID - Id of a restorable backup of a Cassandra cluster.
//   - options - CassandraClustersClientGetRestoreOptions contains the optional parameters for the CassandraClustersClient.GetRestore
//     method.
func (client *CassandraClustersClient) GetRestore(ctx context.Context, resourceGroupName string, clusterName string, backupID string, options *CassandraClustersClientGetRestoreOptions) (CassandraClustersClientGetRestoreResponse, error) {
	var err error
	const operationName = "CassandraClustersClient.GetRestore"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.getRestoreCreateRequest(ctx, resourceGroupName, clusterName, backupID, options)
	if err != nil {
		return CassandraClustersClientGetRestoreResponse{}, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
	if err != nil {
		return CassandraClustersClientGetRestoreResponse{}, err
	...
	resp, err := client.getRestoreHandleResponse(httpResp)
	return resp, err
}

// getRestoreCreateRequest creates the GetRestore request.
func (client *CassandraClustersClient) getRestoreCreateRequest(ctx context.Context, resourceGroupName string, clusterName string, backupID string, options *CassandraClustersClientGetRestoreOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DocumentDB/cassandraClusters/{clusterName}/backupRestores/{backupId}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{subscriptionId}", url.PathEscape(client.subscriptionID))
...
// getRestoreHandleResponse handles the GetRestore response.
func (client *CassandraClustersClient) getRestoreHandleResponse(resp *http.Response) (CassandraClustersClientGetRestoreResponse, error) {
	result := CassandraClustersClientGetRestoreResponse{}
	if err := runtime.UnmarshalAsJSON(resp, &result.CassandraClusterRestoreInfo); err != nil {
		return CassandraClustersClientGetRestoreResponse{}, err
	}
	return result, nil
}

// BeginInvokeAsyncCommand - Invoke a command like nodetool for cassandra maintenance asynchronously
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2024-05-15-preview
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
...
//   - options - CassandraClustersClientBeginInvokeAsyncCommandOptions contains the optional parameters for the CassandraClustersClient.BeginInvokeAsyncCommand
//     method.
func (client *CassandraClustersClient) BeginInvokeAsyncCommand(ctx context.Context, resourceGroupName string, clusterName string, body CommandPostBody, options *CassandraClustersClientBeginInvokeAsyncCommandOptions) (*runtime.Poller[CassandraClustersClientInvokeAsyncCommandResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.invokeAsyncCommand(ctx, resourceGroupName, clusterName, body, options)
		if err != nil {
			return nil, err
		}
		poller, err := runtime.NewPoller(resp, client.internal.Pipeline(), &runtime.NewPollerOptions[CassandraClustersClientInvokeAsyncCommandResponse]{
			Tracer: client.internal.Tracer(),
		})
		return poller, err
	} else {
		return runtime.NewPollerFromResumeToken(options.ResumeToken, client.internal.Pipeline(), &runtime.NewPollerFromResumeTokenOptions[CassandraClustersClientInvokeAsyncCommandResponse]{
			Tracer: client.internal.Tracer(),
		})
	}
}

// InvokeAsyncCommand - Invoke a command like nodetool for cassandra maintenance asynchronously
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2024-05-15-preview
func (client *CassandraClustersClient) invokeAsyncCommand(ctx context.Context, resourceGroupName string, clusterName string, body CommandPostBody, options *CassandraClustersClientBeginInvokeAsyncCommandOptions) (*http.Response, error) {
	var err error
	const operationName = "CassandraClustersClient.BeginInvokeAsyncCommand"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.invokeAsyncCommandCreateRequest(ctx, resourceGroupName, clusterName, body, options)
	if err != nil {
		return nil, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
...
// invokeAsyncCommandCreateRequest creates the InvokeAsyncCommand request.
func (client *CassandraClustersClient) invokeAsyncCommandCreateRequest(ctx context.Context, resourceGroupName string, clusterName string, body CommandPostBody, options *CassandraClustersClientBeginInvokeAsyncCommandOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DocumentDB/cassandraClusters/{clusterName}/invokeAsyncCommand"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{subscriptionId}", url.PathEscape(client.subscriptionID))
...
func (client *CassandraClustersClient) NewListCommandPager(resourceGroupName string, clusterName string, options *CassandraClustersClientListCommandOptions) *runtime.Pager[CassandraClustersClientListCommandResponse] {
	return runtime.NewPager(runtime.PagingHandler[CassandraClustersClientListCommandResponse]{
		...
		Fetcher: func(ctx context.Context, page *CassandraClustersClientListCommandResponse) (CassandraClustersClientListCommandResponse, error) {
			...
			req, err := client.listCommandCreateRequest(ctx, resourceGroupName, clusterName, options)
			if err != nil {
			...
			if !runtime.HasStatusCode(resp, http.StatusOK) {
				return CassandraClustersClientListCommandResponse{}, runtime.NewResponseError(resp)
			}
...
func (client *CassandraClustersClient) listCommandCreateRequest(ctx context.Context, resourceGroupName string, clusterName string, options *CassandraClustersClientListCommandOptions) (*policy.Request, error) {
...
// RestoreBackup - Trigger restore of the specified back-up id on the cluster
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2024-05-15-preview
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - clusterName - Managed Cassandra cluster name.
//   - backupID - Id of a restorable backup of a Cassandra cluster.
//   - options - CassandraClustersClientRestoreBackupOptions contains the optional parameters for the CassandraClustersClient.RestoreBackup
//     method.
func (client *CassandraClustersClient) RestoreBackup(ctx context.Context, resourceGroupName string, clusterName string, backupID string, options *CassandraClustersClientRestoreBackupOptions) (CassandraClustersClientRestoreBackupResponse, error) {
	var err error
	const operationName = "CassandraClustersClient.RestoreBackup"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.restoreBackupCreateRequest(ctx, resourceGroupName, clusterName, backupID, options)
	if err != nil {
		return CassandraClustersClientRestoreBackupResponse{}, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
	if err != nil {
		return CassandraClustersClientRestoreBackupResponse{}, err
	...
	resp, err := client.restoreBackupHandleResponse(httpResp)
	return resp, err
}

// restoreBackupCreateRequest creates the RestoreBackup request.
func (client *CassandraClustersClient) restoreBackupCreateRequest(ctx context.Context, resourceGroupName string, clusterName string, backupID string, options *CassandraClustersClientRestoreBackupOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DocumentDB/cassandraClusters/{clusterName}/backupRestores/{backupId}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
// restoreBackupHandleResponse handles the RestoreBackup response.
func (client *CassandraClustersClient) restoreBackupHandleResponse(resp *http.Response) (CassandraClustersClientRestoreBackupResponse, error) {
	result := CassandraClustersClientRestoreBackupResponse{}
	if err := runtime.UnmarshalAsJSON(resp, &result.CassandraClusterRestoreResult); err != nil {
		return CassandraClustersClientRestoreBackupResponse{}, err
	}
	return result, nil
}
