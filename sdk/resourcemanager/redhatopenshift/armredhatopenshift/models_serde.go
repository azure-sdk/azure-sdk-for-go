...
func (l LoadBalancerProfile) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "allocatedOutboundPorts", l.AllocatedOutboundPorts)
	populate(objectMap, "effectiveOutboundIps", l.EffectiveOutboundIPs)
	populate(objectMap, "managedOutboundIps", l.ManagedOutboundIPs)
	populate(objectMap, "outboundIpPrefixes", l.OutboundIPPrefixes)
	populate(objectMap, "outboundIps", l.OutboundIPs)
	return json.Marshal(objectMap)
}
...
func (l *LoadBalancerProfile) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "allocatedOutboundPorts":
			err = unpopulate(val, "AllocatedOutboundPorts", &l.AllocatedOutboundPorts)
			delete(rawMsg, key)
		...
		case "outboundIpPrefixes":
			err = unpopulate(val, "OutboundIPPrefixes", &l.OutboundIPPrefixes)
			delete(rawMsg, key)
		case "outboundIps":
			err = unpopulate(val, "OutboundIPs", &l.OutboundIPs)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", l, err)
...
// MarshalJSON implements the json.Marshaller interface for type OutboundIP.
...
// UnmarshalJSON implements the json.Unmarshaller interface for type OutboundIP.
func (o *OutboundIP) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", o, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type OutboundIPPrefix.
func (o OutboundIPPrefix) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "id", o.ID)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type OutboundIPPrefix.
func (o *OutboundIPPrefix) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", o, err)
	}
