...
func (client *SQLPoolOperationResultsClient) getLocationHeaderResultCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, sqlPoolName string, operationID string, _ *SQLPoolOperationResultsClientBeginGetLocationHeaderResultOptions) (*policy.Request, error) {
