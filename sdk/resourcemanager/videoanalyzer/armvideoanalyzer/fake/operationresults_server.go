...
// OperationResultsServer is a fake server for instances of the armvideoanalyzer.OperationResultsClient type.
type OperationResultsServer struct {
	// Get is the fake for method OperationResultsClient.Get
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	Get func(ctx context.Context, locationName string, operationID string, options *armvideoanalyzer.OperationResultsClientGetOptions) (resp azfake.Responder[armvideoanalyzer.OperationResultsClientGetResponse], errResp azfake.ErrorResponder)
}
...
// The returned OperationResultsServerTransport instance is connected to an instance of armvideoanalyzer.OperationResultsClient via the
...
// OperationResultsServerTransport connects instances of armvideoanalyzer.OperationResultsClient to instances of OperationResultsServer.
...
func (o *OperationResultsServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.Media/locations/(?P<locationName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/videoAnalyzerOperationResults/(?P<operationId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)`
