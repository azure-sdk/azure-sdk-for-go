...
type ServerFactory struct {
	...
	// ComputePoliciesServer contains the fakes for client ComputePoliciesClient
	ComputePoliciesServer ComputePoliciesServer

	// DataLakeStoreAccountsServer contains the fakes for client DataLakeStoreAccountsClient
