...
func (m *ManagedDatabaseTransparentDataEncryptionServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if managedDatabaseTransparentDataEncryptionServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = managedDatabaseTransparentDataEncryptionServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to ManagedDatabaseTransparentDataEncryptionServerTransport
var managedDatabaseTransparentDataEncryptionServerTransportInterceptor interface {
