...
func (client *Client) checkNameAvailabilityLocalCreateRequest(ctx context.Context, location string, checkNameAvailability CheckNameAvailabilityRequest, _ *ClientCheckNameAvailabilityLocalOptions) (*policy.Request, error) {
