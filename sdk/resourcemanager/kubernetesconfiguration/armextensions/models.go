...
type ExtensionProperties struct {
	...
	// READ-ONLY; Additional details provided by the publisher of the extension.
	...
	// READ-ONLY; Metadata about the managing entity and the permitted operations.
...
type ManagedServiceIdentity struct {
	// The type of identity used for the resource. Only user assigned identities are supported for 'Bring your own Identity' model.
	...
	UserAssignedIdentities map[string]*UserAssignedIdentitiesAdditionalProperties
...
// ManagementDetails - Metadata about the managing entity and the permitted operations.
type ManagementDetails struct {
	AccessDetails []*ManagementDetailsAccessDetailsItem
	Category      *string
}

type ManagementDetailsAccessDetailsItem struct {
...
// UserAssignedIdentitiesAdditionalProperties - Additional properties for the User Assigned Identity.
type UserAssignedIdentitiesAdditionalProperties struct {
