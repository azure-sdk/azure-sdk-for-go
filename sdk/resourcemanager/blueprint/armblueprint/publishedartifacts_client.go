...
func (client *PublishedArtifactsClient) getCreateRequest(ctx context.Context, resourceScope string, blueprintName string, versionID string, artifactName string, _ *PublishedArtifactsClientGetOptions) (*policy.Request, error) {
...
func (client *PublishedArtifactsClient) listCreateRequest(ctx context.Context, resourceScope string, blueprintName string, versionID string, _ *PublishedArtifactsClientListOptions) (*policy.Request, error) {
