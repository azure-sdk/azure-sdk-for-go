...
func (s *SQLPoolConnectionPoliciesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if sqlPoolConnectionPoliciesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = sqlPoolConnectionPoliciesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to SQLPoolConnectionPoliciesServerTransport
var sqlPoolConnectionPoliciesServerTransportInterceptor interface {
