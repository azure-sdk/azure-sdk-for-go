...
type LocationBasedRecommendedActionSessionsResultServer struct {
	...
	NewListPager func(locationName string, operationID string, options *armmysql.LocationBasedRecommendedActionSessionsResultClientListOptions) (resp azfake.PagerResponder[armmysql.LocationBasedRecommendedActionSessionsResultClientListResponse])
}
...
// The returned LocationBasedRecommendedActionSessionsResultServerTransport instance is connected to an instance of armmysql.LocationBasedRecommendedActionSessionsResultClient via the
...
func NewLocationBasedRecommendedActionSessionsResultServerTransport(srv *LocationBasedRecommendedActionSessionsResultServer) *LocationBasedRecommendedActionSessionsResultServerTransport {
	return &LocationBasedRecommendedActionSessionsResultServerTransport{
		srv:          srv,
		newListPager: newTracker[azfake.PagerResponder[armmysql.LocationBasedRecommendedActionSessionsResultClientListResponse]](),
	}
}
...
type LocationBasedRecommendedActionSessionsResultServerTransport struct {
	...
	newListPager *tracker[azfake.PagerResponder[armmysql.LocationBasedRecommendedActionSessionsResultClientListResponse]]
}
...
func (l *LocationBasedRecommendedActionSessionsResultServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if locationBasedRecommendedActionSessionsResultServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = locationBasedRecommendedActionSessionsResultServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
func (l *LocationBasedRecommendedActionSessionsResultServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.DBforMySQL/locations/(?P<locationName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/recommendedActionSessionsOperationResults/(?P<operationId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)`
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armmysql.LocationBasedRecommendedActionSessionsResultClientListResponse, createLink func() string) {
...
// set this to conditionally intercept incoming requests to LocationBasedRecommendedActionSessionsResultServerTransport
var locationBasedRecommendedActionSessionsResultServerTransportInterceptor interface {
