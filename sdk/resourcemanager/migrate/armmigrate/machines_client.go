...
func NewMachinesClient(credential azcore.TokenCredential, options *arm.ClientOptions) (*MachinesClient, error) {
	if options == nil {
...
//     method.
func (client *MachinesClient) NewGetAllMachinesInSitePager(subscriptionID string, resourceGroupName string, siteName string, options *MachinesClientGetAllMachinesInSiteOptions) *runtime.Pager[MachinesClientGetAllMachinesInSiteResponse] {
...
func (client *MachinesClient) getAllMachinesInSiteCreateRequest(ctx context.Context, subscriptionID string, resourceGroupName string, siteName string, options *MachinesClientGetAllMachinesInSiteOptions) (*policy.Request, error) {
...
func (client *MachinesClient) GetMachine(ctx context.Context, subscriptionID string, resourceGroupName string, siteName string, machineName string, options *MachinesClientGetMachineOptions) (MachinesClientGetMachineResponse, error) {
...
func (client *MachinesClient) getMachineCreateRequest(ctx context.Context, subscriptionID string, resourceGroupName string, siteName string, machineName string, options *MachinesClientGetMachineOptions) (*policy.Request, error) {
...
func (client *MachinesClient) StartMachine(ctx context.Context, subscriptionID string, resourceGroupName string, siteName string, machineName string, options *MachinesClientStartMachineOptions) (MachinesClientStartMachineResponse, error) {
	req, err := client.startMachineCreateRequest(ctx, subscriptionID, resourceGroupName, siteName, machineName, options)
	if err != nil {
...
func (client *MachinesClient) startMachineCreateRequest(ctx context.Context, subscriptionID string, resourceGroupName string, siteName string, machineName string, options *MachinesClientStartMachineOptions) (*policy.Request, error) {
...
func (client *MachinesClient) StopMachine(ctx context.Context, subscriptionID string, resourceGroupName string, siteName string, machineName string, options *MachinesClientStopMachineOptions) (MachinesClientStopMachineResponse, error) {
	req, err := client.stopMachineCreateRequest(ctx, subscriptionID, resourceGroupName, siteName, machineName, options)
	if err != nil {
...
func (client *MachinesClient) stopMachineCreateRequest(ctx context.Context, subscriptionID string, resourceGroupName string, siteName string, machineName string, options *MachinesClientStopMachineOptions) (*policy.Request, error) {
