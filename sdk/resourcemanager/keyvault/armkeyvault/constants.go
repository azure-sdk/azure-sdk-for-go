...
type ResourceManagerAPIVersions string

const (
	ResourceManagerAPIVersionsTwoThousandFifteen1101          ResourceManagerAPIVersions = "2015-11-01"
	ResourceManagerAPIVersionsTwoThousandTwentyTwo0201Preview ResourceManagerAPIVersions = "2022-02-01-preview"
)

// PossibleResourceManagerAPIVersionsValues returns the possible values for the ResourceManagerAPIVersions const type.
func PossibleResourceManagerAPIVersionsValues() []ResourceManagerAPIVersions {
	return []ResourceManagerAPIVersions{
		ResourceManagerAPIVersionsTwoThousandFifteen1101,
		ResourceManagerAPIVersionsTwoThousandTwentyTwo0201Preview,
	}
}
