...
// MarshalJSON implements the json.Marshaller interface for type CapabilityBase.
...
// UnmarshalJSON implements the json.Unmarshaller interface for type CapabilityBase.
