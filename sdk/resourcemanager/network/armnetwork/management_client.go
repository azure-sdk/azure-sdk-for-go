...
// BeginDisconnectActiveSessions - Returns the list of session state after disconnecting the specified active sessions.
//
// Generated from API version 2024-01-01
//   - resourceGroupName - The name of the resource group.
//   - bastionHostName - The name of the Bastion Host.
//   - sessionIDs - The list of sessionids to disconnect.
//   - options - ManagementClientBeginDisconnectActiveSessionsOptions contains the optional parameters for the ManagementClient.BeginDisconnectActiveSessions
//     method.
func (client *ManagementClient) BeginDisconnectActiveSessions(ctx context.Context, resourceGroupName string, bastionHostName string, sessionIDs SessionIDs, options *ManagementClientBeginDisconnectActiveSessionsOptions) (*runtime.Poller[*runtime.Pager[ManagementClientDisconnectActiveSessionsResponse]], error) {
	pager := runtime.NewPager(runtime.PagingHandler[ManagementClientDisconnectActiveSessionsResponse]{
		...
		Fetcher: func(ctx context.Context, page *ManagementClientDisconnectActiveSessionsResponse) (ManagementClientDisconnectActiveSessionsResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "ManagementClient.BeginDisconnectActiveSessions")
	...
	if options == nil || options.ResumeToken == "" {
		resp, err := client.disconnectActiveSessions(ctx, resourceGroupName, bastionHostName, sessionIDs, options)
		if err != nil {
			return nil, err
		}
		poller, err := runtime.NewPoller(resp, client.internal.Pipeline(), &runtime.NewPollerOptions[*runtime.Pager[ManagementClientDisconnectActiveSessionsResponse]]{
			FinalStateVia: runtime.FinalStateViaLocation,
			Response:      &pager,
			Tracer:        client.internal.Tracer(),
		})
		...
		return runtime.NewPollerFromResumeToken(options.ResumeToken, client.internal.Pipeline(), &runtime.NewPollerFromResumeTokenOptions[*runtime.Pager[ManagementClientDisconnectActiveSessionsResponse]]{
			Response: &pager,
			Tracer:   client.internal.Tracer(),
		})
	}
...
// DisconnectActiveSessions - Returns the list of session state after disconnecting the specified active sessions.
//
// Generated from API version 2024-01-01
func (client *ManagementClient) disconnectActiveSessions(ctx context.Context, resourceGroupName string, bastionHostName string, sessionIDs SessionIDs, options *ManagementClientBeginDisconnectActiveSessionsOptions) (*http.Response, error) {
	var err error
	const operationName = "ManagementClient.BeginDisconnectActiveSessions"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
...
func (client *ManagementClient) disconnectActiveSessionsCreateRequest(ctx context.Context, resourceGroupName string, bastionHostName string, sessionIDs SessionIDs, options *ManagementClientBeginDisconnectActiveSessionsOptions) (*policy.Request, error) {
