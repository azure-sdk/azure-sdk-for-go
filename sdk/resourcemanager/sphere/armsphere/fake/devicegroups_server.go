...
func (d *DeviceGroupsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if deviceGroupsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = deviceGroupsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "DeviceGroupsClient.CountDevices":
				res.resp, res.err = d.dispatchCountDevices(req)
			...
			case "DeviceGroupsClient.NewListByProductPager":
				res.resp, res.err = d.dispatchNewListByProductPager(req)
...
// set this to conditionally intercept incoming requests to DeviceGroupsServerTransport
var deviceGroupsServerTransportInterceptor interface {
