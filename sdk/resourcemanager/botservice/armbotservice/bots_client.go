...
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - resourceName - The name of the Bot resource.
//   - options - BotsClientCreateSignInURLOptions contains the optional parameters for the BotsClient.CreateSignInURL method.
func (client *BotsClient) CreateSignInURL(ctx context.Context, resourceGroupName string, resourceName string, options *BotsClientCreateSignInURLOptions) (BotsClientCreateSignInURLResponse, error) {
	var err error
	const operationName = "BotsClient.CreateSignInURL"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.createSignInURLCreateRequest(ctx, resourceGroupName, resourceName, options)
	if err != nil {
		return BotsClientCreateSignInURLResponse{}, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
	if err != nil {
		return BotsClientCreateSignInURLResponse{}, err
...
func (client *BotsClient) createSignInURLCreateRequest(ctx context.Context, resourceGroupName string, resourceName string, _ *BotsClientCreateSignInURLOptions) (*policy.Request, error) {
...
func (client *BotsClient) createSignInURLHandleResponse(resp *http.Response) (BotsClientCreateSignInURLResponse, error) {
	result := BotsClientCreateSignInURLResponse{}
...
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - resourceName - The name of the Bot resource.
//   - options - BotsClientListByBotResourceOptions contains the optional parameters for the BotsClient.ListByBotResource method.
func (client *BotsClient) ListByBotResource(ctx context.Context, resourceGroupName string, resourceName string, options *BotsClientListByBotResourceOptions) (BotsClientListByBotResourceResponse, error) {
	var err error
	const operationName = "BotsClient.ListByBotResource"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.listByBotResourceCreateRequest(ctx, resourceGroupName, resourceName, options)
	if err != nil {
		return BotsClientListByBotResourceResponse{}, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
	if err != nil {
		return BotsClientListByBotResourceResponse{}, err
...
func (client *BotsClient) listByBotResourceCreateRequest(ctx context.Context, resourceGroupName string, resourceName string, _ *BotsClientListByBotResourceOptions) (*policy.Request, error) {
...
func (client *BotsClient) listByBotResourceHandleResponse(resp *http.Response) (BotsClientListByBotResourceResponse, error) {
	result := BotsClientListByBotResourceResponse{}
