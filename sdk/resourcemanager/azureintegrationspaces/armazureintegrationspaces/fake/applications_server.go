...
import (
	...
	"github.com/Azure/azure-sdk-for-go/sdk/resourcemanager/azureintegrationspaces/armazureintegrationspaces"
	"net/http"
	"net/url"
	"regexp"
	"strconv"
...
// ApplicationsServer is a fake server for instances of the armazureintegrationspaces.ApplicationsClient type.
type ApplicationsServer struct {
	// CreateOrUpdate is the fake for method ApplicationsClient.CreateOrUpdate
	// HTTP status codes to indicate success: http.StatusOK, http.StatusCreated
	CreateOrUpdate func(ctx context.Context, resourceGroupName string, spaceName string, applicationName string, resource armazureintegrationspaces.Application, options *armazureintegrationspaces.ApplicationsClientCreateOrUpdateOptions) (resp azfake.Responder[armazureintegrationspaces.ApplicationsClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)

	// Delete is the fake for method ApplicationsClient.Delete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	Delete func(ctx context.Context, resourceGroupName string, spaceName string, applicationName string, options *armazureintegrationspaces.ApplicationsClientDeleteOptions) (resp azfake.Responder[armazureintegrationspaces.ApplicationsClientDeleteResponse], errResp azfake.ErrorResponder)
	...
	DeleteBusinessProcessDevelopmentArtifact func(ctx context.Context, resourceGroupName string, spaceName string, applicationName string, body armazureintegrationspaces.GetOrDeleteBusinessProcessDevelopmentArtifactRequest, options *armazureintegrationspaces.ApplicationsClientDeleteBusinessProcessDevelopmentArtifactOptions) (resp azfake.Responder[armazureintegrationspaces.ApplicationsClientDeleteBusinessProcessDevelopmentArtifactResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method ApplicationsClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, spaceName string, applicationName string, options *armazureintegrationspaces.ApplicationsClientGetOptions) (resp azfake.Responder[armazureintegrationspaces.ApplicationsClientGetResponse], errResp azfake.ErrorResponder)

	// GetBusinessProcessDevelopmentArtifact is the fake for method ApplicationsClient.GetBusinessProcessDevelopmentArtifact
	// HTTP status codes to indicate success: http.StatusOK
	GetBusinessProcessDevelopmentArtifact func(ctx context.Context, resourceGroupName string, spaceName string, applicationName string, body armazureintegrationspaces.GetOrDeleteBusinessProcessDevelopmentArtifactRequest, options *armazureintegrationspaces.ApplicationsClientGetBusinessProcessDevelopmentArtifactOptions) (resp azfake.Responder[armazureintegrationspaces.ApplicationsClientGetBusinessProcessDevelopmentArtifactResponse], errResp azfake.ErrorResponder)
	...
	// HTTP status codes to indicate success: http.StatusOK
	ListBusinessProcessDevelopmentArtifacts func(ctx context.Context, resourceGroupName string, spaceName string, applicationName string, options *armazureintegrationspaces.ApplicationsClientListBusinessProcessDevelopmentArtifactsOptions) (resp azfake.Responder[armazureintegrationspaces.ApplicationsClientListBusinessProcessDevelopmentArtifactsResponse], errResp azfake.ErrorResponder)

	// NewListBySpacePager is the fake for method ApplicationsClient.NewListBySpacePager
	// HTTP status codes to indicate success: http.StatusOK
	NewListBySpacePager func(resourceGroupName string, spaceName string, options *armazureintegrationspaces.ApplicationsClientListBySpaceOptions) (resp azfake.PagerResponder[armazureintegrationspaces.ApplicationsClientListBySpaceResponse])

	// Patch is the fake for method ApplicationsClient.Patch
	// HTTP status codes to indicate success: http.StatusOK
	Patch func(ctx context.Context, resourceGroupName string, spaceName string, applicationName string, properties armazureintegrationspaces.ApplicationUpdate, options *armazureintegrationspaces.ApplicationsClientPatchOptions) (resp azfake.Responder[armazureintegrationspaces.ApplicationsClientPatchResponse], errResp azfake.ErrorResponder)

	// SaveBusinessProcessDevelopmentArtifact is the fake for method ApplicationsClient.SaveBusinessProcessDevelopmentArtifact
	// HTTP status codes to indicate success: http.StatusOK
	SaveBusinessProcessDevelopmentArtifact func(ctx context.Context, resourceGroupName string, spaceName string, applicationName string, body armazureintegrationspaces.SaveOrValidateBusinessProcessDevelopmentArtifactRequest, options *armazureintegrationspaces.ApplicationsClientSaveBusinessProcessDevelopmentArtifactOptions) (resp azfake.Responder[armazureintegrationspaces.ApplicationsClientSaveBusinessProcessDevelopmentArtifactResponse], errResp azfake.ErrorResponder)
	...
	// HTTP status codes to indicate success: http.StatusOK
	ValidateBusinessProcessDevelopmentArtifact func(ctx context.Context, resourceGroupName string, spaceName string, applicationName string, body armazureintegrationspaces.SaveOrValidateBusinessProcessDevelopmentArtifactRequest, options *armazureintegrationspaces.ApplicationsClientValidateBusinessProcessDevelopmentArtifactOptions) (resp azfake.Responder[armazureintegrationspaces.ApplicationsClientValidateBusinessProcessDevelopmentArtifactResponse], errResp azfake.ErrorResponder)
}

// NewApplicationsServerTransport creates a new instance of ApplicationsServerTransport with the provided implementation.
// The returned ApplicationsServerTransport instance is connected to an instance of armazureintegrationspaces.ApplicationsClient via the
...
func NewApplicationsServerTransport(srv *ApplicationsServer) *ApplicationsServerTransport {
	return &ApplicationsServerTransport{
		srv:                 srv,
		newListBySpacePager: newTracker[azfake.PagerResponder[armazureintegrationspaces.ApplicationsClientListBySpaceResponse]](),
	}
}

// ApplicationsServerTransport connects instances of armazureintegrationspaces.ApplicationsClient to instances of ApplicationsServer.
...
type ApplicationsServerTransport struct {
	...
	newListBySpacePager *tracker[azfake.PagerResponder[armazureintegrationspaces.ApplicationsClientListBySpaceResponse]]
}
...
func (a *ApplicationsServerTransport) dispatchCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[armazureintegrationspaces.Application](req)
	if err != nil {
		return nil, err
	}
...
func (a *ApplicationsServerTransport) dispatchDeleteBusinessProcessDevelopmentArtifact(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[armazureintegrationspaces.GetOrDeleteBusinessProcessDevelopmentArtifactRequest](req)
	if err != nil {
		return nil, err
	}
	resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
...
func (a *ApplicationsServerTransport) dispatchNewListBySpacePager(req *http.Request) (*http.Response, error) {
	...
	if newListBySpacePager == nil {
		...
		var options *armazureintegrationspaces.ApplicationsClientListBySpaceOptions
		if topParam != nil || skipParam != nil || maxpagesizeParam != nil || filterParam != nil || len(selectParam) > 0 || len(expandParam) > 0 || len(orderbyParam) > 0 {
			options = &armazureintegrationspaces.ApplicationsClientListBySpaceOptions{
				Top:         topParam,
				Skip:        skipParam,
		...
		server.PagerResponderInjectNextLinks(newListBySpacePager, req, func(page *armazureintegrationspaces.ApplicationsClientListBySpaceResponse, createLink func() string) {
...
func (a *ApplicationsServerTransport) dispatchPatch(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[armazureintegrationspaces.ApplicationUpdate](req)
	if err != nil {
		return nil, err
	}
	resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
...
func (a *ApplicationsServerTransport) dispatchSaveBusinessProcessDevelopmentArtifact(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[armazureintegrationspaces.SaveOrValidateBusinessProcessDevelopmentArtifactRequest](req)
	if err != nil {
		return nil, err
	}
	resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
