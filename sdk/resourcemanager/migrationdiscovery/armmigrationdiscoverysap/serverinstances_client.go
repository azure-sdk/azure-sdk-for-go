...
func (client *ServerInstancesClient) createCreateRequest(ctx context.Context, resourceGroupName string, sapDiscoverySiteName string, sapInstanceName string, serverInstanceName string, resource ServerInstance, _ *ServerInstancesClientBeginCreateOptions) (*policy.Request, error) {
...
func (client *ServerInstancesClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, sapDiscoverySiteName string, sapInstanceName string, serverInstanceName string, _ *ServerInstancesClientBeginDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Workloads/sapDiscoverySites/{sapDiscoverySiteName}/sapInstances/{sapInstanceName}/serverInstances/{serverInstanceName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *ServerInstancesClient) getCreateRequest(ctx context.Context, resourceGroupName string, sapDiscoverySiteName string, sapInstanceName string, serverInstanceName string, _ *ServerInstancesClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Workloads/sapDiscoverySites/{sapDiscoverySiteName}/sapInstances/{sapInstanceName}/serverInstances/{serverInstanceName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
// NewListPager - Lists the Server Instance resources for the given SAP Instance resource.
//
// Generated from API version 2023-10-01-preview
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - sapDiscoverySiteName - The name of the discovery site resource for SAP Migration.
//   - sapInstanceName - The name of SAP Instance resource for SAP Migration.
//   - options - ServerInstancesClientListOptions contains the optional parameters for the ServerInstancesClient.NewListPager
//     method.
func (client *ServerInstancesClient) NewListPager(resourceGroupName string, sapDiscoverySiteName string, sapInstanceName string, options *ServerInstancesClientListOptions) *runtime.Pager[ServerInstancesClientListResponse] {
	return runtime.NewPager(runtime.PagingHandler[ServerInstancesClientListResponse]{
		More: func(page ServerInstancesClientListResponse) bool {
			return page.NextLink != nil && len(*page.NextLink) > 0
		},
		Fetcher: func(ctx context.Context, page *ServerInstancesClientListResponse) (ServerInstancesClientListResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "ServerInstancesClient.NewListPager")
			nextLink := ""
			if page != nil {
				nextLink = *page.NextLink
			}
			resp, err := runtime.FetcherForNextLink(ctx, client.internal.Pipeline(), nextLink, func(ctx context.Context) (*policy.Request, error) {
				return client.listCreateRequest(ctx, resourceGroupName, sapDiscoverySiteName, sapInstanceName, options)
			}, nil)
			if err != nil {
				return ServerInstancesClientListResponse{}, err
			}
...
func (client *ServerInstancesClient) listCreateRequest(ctx context.Context, resourceGroupName string, sapDiscoverySiteName string, sapInstanceName string, _ *ServerInstancesClientListOptions) (*policy.Request, error) {
...
func (client *ServerInstancesClient) listHandleResponse(resp *http.Response) (ServerInstancesClientListResponse, error) {
	result := ServerInstancesClientListResponse{}
...
func (client *ServerInstancesClient) updateCreateRequest(ctx context.Context, resourceGroupName string, sapDiscoverySiteName string, sapInstanceName string, serverInstanceName string, properties UpdateServerInstanceRequest, _ *ServerInstancesClientUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Workloads/sapDiscoverySites/{sapDiscoverySiteName}/sapInstances/{sapInstanceName}/serverInstances/{serverInstanceName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
