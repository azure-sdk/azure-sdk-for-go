...
- Type of `ArcSettingProperties.ConnectivityProperties` has been changed from `interface{}` to `any`
- Type of `ArcSettingsPatchProperties.ConnectivityProperties` has been changed from `interface{}` to `any`
- Type of `ErrorAdditionalInfo.Info` has been changed from `interface{}` to `any`
- Type of `ExtensionParameters.ProtectedSettings` has been changed from `interface{}` to `any`
- Type of `ExtensionParameters.Settings` has been changed from `interface{}` to `any`
