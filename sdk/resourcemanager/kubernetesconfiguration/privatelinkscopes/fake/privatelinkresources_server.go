...
// PrivateLinkResourcesServer is a fake server for instances of the privatelinkscopes.PrivateLinkResourcesClient type.
type PrivateLinkResourcesServer struct {
	// Get is the fake for method PrivateLinkResourcesClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, scopeName string, groupName string, options *privatelinkscopes.PrivateLinkResourcesClientGetOptions) (resp azfake.Responder[privatelinkscopes.PrivateLinkResourcesClientGetResponse], errResp azfake.ErrorResponder)

	// ListByPrivateLinkScope is the fake for method PrivateLinkResourcesClient.ListByPrivateLinkScope
	// HTTP status codes to indicate success: http.StatusOK
	ListByPrivateLinkScope func(ctx context.Context, resourceGroupName string, scopeName string, options *privatelinkscopes.PrivateLinkResourcesClientListByPrivateLinkScopeOptions) (resp azfake.Responder[privatelinkscopes.PrivateLinkResourcesClientListByPrivateLinkScopeResponse], errResp azfake.ErrorResponder)
}
...
// The returned PrivateLinkResourcesServerTransport instance is connected to an instance of privatelinkscopes.PrivateLinkResourcesClient via the
// azcore.ClientOptions.Transporter field in the client's constructor parameters.
func NewPrivateLinkResourcesServerTransport(srv *PrivateLinkResourcesServer) *PrivateLinkResourcesServerTransport {
	return &PrivateLinkResourcesServerTransport{srv: srv}
}

// PrivateLinkResourcesServerTransport connects instances of privatelinkscopes.PrivateLinkResourcesClient to instances of PrivateLinkResourcesServer.
