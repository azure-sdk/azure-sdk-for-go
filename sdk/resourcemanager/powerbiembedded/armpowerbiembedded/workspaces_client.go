...
func (client *WorkspacesClient) listCreateRequest(ctx context.Context, resourceGroupName string, workspaceCollectionName string, _ *WorkspacesClientListOptions) (*policy.Request, error) {
