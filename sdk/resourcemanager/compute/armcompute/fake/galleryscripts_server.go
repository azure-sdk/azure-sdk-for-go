...
type GalleryScriptsServer struct {
	...
	BeginCreateOrUpdate func(ctx context.Context, resourceGroupName string, galleryScript armcompute.GalleryScript, options *armcompute.GalleryScriptsClientBeginCreateOrUpdateOptions) (resp azfake.PollerResponder[armcompute.GalleryScriptsClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)

	// BeginDelete is the fake for method GalleryScriptsClient.BeginDelete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginDelete func(ctx context.Context, resourceGroupName string, options *armcompute.GalleryScriptsClientBeginDeleteOptions) (resp azfake.PollerResponder[armcompute.GalleryScriptsClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method GalleryScriptsClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, options *armcompute.GalleryScriptsClientGetOptions) (resp azfake.Responder[armcompute.GalleryScriptsClientGetResponse], errResp azfake.ErrorResponder)

	// NewListByGalleryPager is the fake for method GalleryScriptsClient.NewListByGalleryPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByGalleryPager func(resourceGroupName string, options *armcompute.GalleryScriptsClientListByGalleryOptions) (resp azfake.PagerResponder[armcompute.GalleryScriptsClientListByGalleryResponse])

	// BeginUpdate is the fake for method GalleryScriptsClient.BeginUpdate
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginUpdate func(ctx context.Context, resourceGroupName string, galleryScript armcompute.GalleryScriptUpdate, options *armcompute.GalleryScriptsClientBeginUpdateOptions) (resp azfake.PollerResponder[armcompute.GalleryScriptsClientUpdateResponse], errResp azfake.ErrorResponder)
}
