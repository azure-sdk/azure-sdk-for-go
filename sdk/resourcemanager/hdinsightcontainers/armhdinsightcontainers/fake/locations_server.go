...
// The returned LocationsServerTransport instance is connected to an instance of armhdinsightcontainers.LocationsClient via the
...
// LocationsServerTransport connects instances of armhdinsightcontainers.LocationsClient to instances of LocationsServer.
...
func (l *LocationsServerTransport) dispatchCheckNameAvailability(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[armhdinsightcontainers.NameAvailabilityParameters](req)
	if err != nil {
		return nil, err
	}
	...
	resp, err := server.MarshalResponseAsJSON(respContent, server.GetResponse(respr).NameAvailabilityResult, req)
	if err != nil {
		return nil, err
	}
	return resp, nil
