...
```sh
go get github.com/Azure/azure-sdk-for-go/sdk/resourcemanager/orbital/armorbital/v3
```
...
```go
client := clientFactory.NewAvailableGroundStationsClient()
```
...
[open an issue](https://github.com/Azure/azure-sdk-for-go/issues) and assign the `Orbital` label.
