...
// IotEnterpriseProfileUpdateProperties - Describes the Update properties of a Windows IoT Enterprise License Profile.
type IotEnterpriseProfileUpdateProperties struct {
...
// LicenseProfileArmIoTEnterpriseProperties - Describes the properties of a Windows IoT Enterprise License Profile ARM model.
type LicenseProfileArmIoTEnterpriseProperties struct {
...
// LicenseProfileArmWindowsServerProperties - Describes the properties of a Windows Server License Profile ARM model.
type LicenseProfileArmWindowsServerProperties struct {
	// The list of product features.
	ProductFeatures []*ProductFeature
...
type LicenseProfileMachineInstanceView struct {
	...
	// READ-ONLY
	Products *LicenseProfileMachineInstanceViewProducts
...
type LicenseProfileMachineInstanceViewProducts struct {
	// Hybrid Compute Windows IoT Enterprise Profile properties
	IotEnterpriseProfile *LicenseProfileArmIoTEnterpriseProperties

	// Hybrid Compute Windows Server Profile properties
	WindowsServerProfile *LicenseProfileArmWindowsServerProperties
}
...
type LicenseProfileProperties struct {
	...
	Products          *LicenseProfilePropertiesProducts
...
type LicenseProfilePropertiesProducts struct {
	// Hybrid Compute Windows IoT Enterprise Profile properties
	IotEnterpriseProfile *LicenseProfileArmIoTEnterpriseProperties
...
type LicenseProfileUpdateProperties struct {
	...
	Products          *LicenseProfileUpdatePropertiesProducts
	SoftwareAssurance *LicenseProfileUpdatePropertiesSoftwareAssurance
}

type LicenseProfileUpdatePropertiesProducts struct {
	// Hybrid Compute Windows IoT Enterprise Profile Update properties
	IotEnterpriseProfile *IotEnterpriseProfileUpdateProperties

	// Hybrid Compute Windows Server Profile Update properties
	WindowsServerProfile *WindowsServerProfileUpdateProperties
}
...
// WindowsServerProfileUpdateProperties - Describes the Update properties of a Windows Server License Profile.
type WindowsServerProfileUpdateProperties struct {
	// The list of product feature updates.
	ProductFeatures []*ProductFeatureUpdate
