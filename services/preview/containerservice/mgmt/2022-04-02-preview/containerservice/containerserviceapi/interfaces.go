...
import (
	"context"
	"github.com/Azure/azure-sdk-for-go/services/preview/containerservice/mgmt/2022-04-02-preview/containerservice"
...
// TrustedAccessRolesClientAPI contains the set of methods on the TrustedAccessRolesClient type.
type TrustedAccessRolesClientAPI interface {
	List(ctx context.Context, location string) (result containerservice.TrustedAccessRoleListResultPage, err error)
	ListComplete(ctx context.Context, location string) (result containerservice.TrustedAccessRoleListResultIterator, err error)
}

var _ TrustedAccessRolesClientAPI = (*containerservice.TrustedAccessRolesClient)(nil)

// TrustedAccessRoleBindingsClientAPI contains the set of methods on the TrustedAccessRoleBindingsClient type.
type TrustedAccessRoleBindingsClientAPI interface {
	CreateOrUpdate(ctx context.Context, resourceGroupName string, resourceName string, trustedAccessRoleBindingName string, trustedAccessRoleBinding containerservice.TrustedAccessRoleBinding) (result containerservice.TrustedAccessRoleBinding, err error)
	Delete(ctx context.Context, resourceGroupName string, resourceName string, trustedAccessRoleBindingName string) (result autorest.Response, err error)
	Get(ctx context.Context, resourceGroupName string, resourceName string, trustedAccessRoleBindingName string) (result containerservice.TrustedAccessRoleBinding, err error)
	List(ctx context.Context, resourceGroupName string, resourceName string) (result containerservice.TrustedAccessRoleBindingListResultPage, err error)
	ListComplete(ctx context.Context, resourceGroupName string, resourceName string) (result containerservice.TrustedAccessRoleBindingListResultIterator, err error)
}

var _ TrustedAccessRoleBindingsClientAPI = (*containerservice.TrustedAccessRoleBindingsClient)(nil)
