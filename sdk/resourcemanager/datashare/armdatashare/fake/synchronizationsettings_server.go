...
func (s *SynchronizationSettingsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if synchronizationSettingsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = synchronizationSettingsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "SynchronizationSettingsClient.NewListBySharePager":
				res.resp, res.err = s.dispatchNewListBySharePager(req)
			default:
...
// set this to conditionally intercept incoming requests to SynchronizationSettingsServerTransport
var synchronizationSettingsServerTransportInterceptor interface {
