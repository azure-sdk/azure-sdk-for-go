...
func (c *CloudsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if cloudsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = cloudsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to CloudsServerTransport
var cloudsServerTransportInterceptor interface {
