...
func (d DiskDetails) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "targetDiskName", d.TargetDiskName)
	return json.Marshal(objectMap)
}
...
func (d *DiskDetails) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "sourceId":
			...
			delete(rawMsg, key)
		case "targetDiskName":
			err = unpopulate(val, "TargetDiskName", &d.TargetDiskName)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", d, err)
...
func (v VirtualMachineResourceSettings) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "targetDiskDetails", v.TargetDiskDetails)
...
func (v *VirtualMachineResourceSettings) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "targetAvailabilityZone":
			...
			delete(rawMsg, key)
		case "targetDiskDetails":
			err = unpopulate(val, "TargetDiskDetails", &v.TargetDiskDetails)
			delete(rawMsg, key)
		case "targetResourceGroupName":
