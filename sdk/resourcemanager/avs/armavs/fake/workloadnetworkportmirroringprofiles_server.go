...
type WorkloadNetworkPortMirroringProfilesServer struct {
	...
	Get func(ctx context.Context, resourceGroupName string, privateCloudName string, portMirroringID string, options *armavs.WorkloadNetworkPortMirroringProfilesClientGetOptions) (resp azfake.Responder[armavs.WorkloadNetworkPortMirroringProfilesClientGetResponse], errResp azfake.ErrorResponder)

	// NewListPager is the fake for method WorkloadNetworkPortMirroringProfilesClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(resourceGroupName string, privateCloudName string, options *armavs.WorkloadNetworkPortMirroringProfilesClientListOptions) (resp azfake.PagerResponder[armavs.WorkloadNetworkPortMirroringProfilesClientListResponse])

	// BeginUpdate is the fake for method WorkloadNetworkPortMirroringProfilesClient.BeginUpdate
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginUpdate func(ctx context.Context, resourceGroupName string, privateCloudName string, portMirroringID string, workloadNetworkPortMirroring armavs.WorkloadNetworkPortMirroring, options *armavs.WorkloadNetworkPortMirroringProfilesClientBeginUpdateOptions) (resp azfake.PollerResponder[armavs.WorkloadNetworkPortMirroringProfilesClientUpdateResponse], errResp azfake.ErrorResponder)
}
...
func NewWorkloadNetworkPortMirroringProfilesServerTransport(srv *WorkloadNetworkPortMirroringProfilesServer) *WorkloadNetworkPortMirroringProfilesServerTransport {
	return &WorkloadNetworkPortMirroringProfilesServerTransport{
		...
		newListPager: newTracker[azfake.PagerResponder[armavs.WorkloadNetworkPortMirroringProfilesClientListResponse]](),
...
type WorkloadNetworkPortMirroringProfilesServerTransport struct {
	...
	newListPager *tracker[azfake.PagerResponder[armavs.WorkloadNetworkPortMirroringProfilesClientListResponse]]
...
func (w *WorkloadNetworkPortMirroringProfilesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if workloadNetworkPortMirroringProfilesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = workloadNetworkPortMirroringProfilesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "WorkloadNetworkPortMirroringProfilesClient.NewListPager":
...
func (w *WorkloadNetworkPortMirroringProfilesServerTransport) dispatchBeginCreate(req *http.Request) (*http.Response, error) {
	...
	if beginCreate == nil {
		...
		respr, errRespr := w.srv.BeginCreate(req.Context(), resourceGroupNameParam, privateCloudNameParam, portMirroringIDParam, body, nil)
...
func (w *WorkloadNetworkPortMirroringProfilesServerTransport) dispatchBeginDelete(req *http.Request) (*http.Response, error) {
	...
	if beginDelete == nil {
		...
		respr, errRespr := w.srv.BeginDelete(req.Context(), resourceGroupNameParam, portMirroringIDParam, privateCloudNameParam, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginDelete = &respr
...
func (w *WorkloadNetworkPortMirroringProfilesServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := w.srv.Get(req.Context(), resourceGroupNameParam, privateCloudNameParam, portMirroringIDParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
...
func (w *WorkloadNetworkPortMirroringProfilesServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armavs.WorkloadNetworkPortMirroringProfilesClientListResponse, createLink func() string) {
...
func (w *WorkloadNetworkPortMirroringProfilesServerTransport) dispatchBeginUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginUpdate == nil {
		...
		respr, errRespr := w.srv.BeginUpdate(req.Context(), resourceGroupNameParam, privateCloudNameParam, portMirroringIDParam, body, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginUpdate = &respr
...
// set this to conditionally intercept incoming requests to WorkloadNetworkPortMirroringProfilesServerTransport
var workloadNetworkPortMirroringProfilesServerTransportInterceptor interface {
