...
func (client *SQLServerAvailabilityGroupsClient) addDatabasesCreateRequest(ctx context.Context, resourceGroupName string, sqlServerInstanceName string, availabilityGroupName string, databases Databases, options *SQLServerAvailabilityGroupsClientAddDatabasesOptions) (*policy.Request, error) {
...
func (client *SQLServerAvailabilityGroupsClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, sqlServerInstanceName string, availabilityGroupName string, options *SQLServerAvailabilityGroupsClientBeginDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureArcData/sqlServerInstances/{sqlServerInstanceName}/availabilityGroups/{availabilityGroupName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *SQLServerAvailabilityGroupsClient) removeDatabasesCreateRequest(ctx context.Context, resourceGroupName string, sqlServerInstanceName string, availabilityGroupName string, databases Databases, options *SQLServerAvailabilityGroupsClientRemoveDatabasesOptions) (*policy.Request, error) {
