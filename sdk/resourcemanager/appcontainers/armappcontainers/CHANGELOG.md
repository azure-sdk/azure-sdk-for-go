...
- New function `*BuildsClient.ListAuthToken(context.Context, string, string, string, *BuildsClientListAuthTokenOptions) (BuildsClientListAuthTokenResponse, error)`
...
- New function `*ClientFactory.NewManagedEnvironmentSecretsClient() *ManagedEnvironmentSecretsClient`
...
- New function `NewManagedEnvironmentSecretsClient(string, azcore.TokenCredential, *arm.ClientOptions) (*ManagedEnvironmentSecretsClient, error)`
- New function `*ManagedEnvironmentSecretsClient.CreateOrUpdate(context.Context, string, string, string, ManagedEnvironmentSecret, *ManagedEnvironmentSecretsClientCreateOrUpdateOptions) (ManagedEnvironmentSecretsClientCreateOrUpdateResponse, error)`
- New function `*ManagedEnvironmentSecretsClient.Delete(context.Context, string, string, string, *ManagedEnvironmentSecretsClientDeleteOptions) (ManagedEnvironmentSecretsClientDeleteResponse, error)`
- New function `*ManagedEnvironmentSecretsClient.Get(context.Context, string, string, string, *ManagedEnvironmentSecretsClientGetOptions) (ManagedEnvironmentSecretsClientGetResponse, error)`
- New function `*ManagedEnvironmentSecretsClient.GetValue(context.Context, string, string, string, *ManagedEnvironmentSecretsClientGetValueOptions) (ManagedEnvironmentSecretsClientGetValueResponse, error)`
- New function `*ManagedEnvironmentSecretsClient.NewListPager(string, string, *ManagedEnvironmentSecretsClientListOptions) *runtime.Pager[ManagedEnvironmentSecretsClientListResponse]`
...
- New struct `ManagedEnvironmentSecret`
- New struct `ManagedEnvironmentSecretProperties`
- New struct `ManagedEnvironmentSecretsCollection`
...
- New field `SecretID` in struct `DaprMetadata`
- New field `SecretID` in struct `EnvironmentVar`
...
- New field `PasswordSecretID` in struct `RegistryCredentials`
- New field `SecretID` in struct `ScaleRuleAuth`
- New field `SecretID` in struct `SecretVolumeItem`
