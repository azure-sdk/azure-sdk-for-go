...
type Control struct {
	...
	// READ-ONLY; The Id of the control. e.g. "Operational_Security_10"
	ControlID *string
...
type ScopingConfigurationResource struct {
	...
	// READ-ONLY; The scoping configuration of the specific report.
	Name *string
