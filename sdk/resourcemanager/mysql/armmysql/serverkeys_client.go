...
func (client *ServerKeysClient) createOrUpdateCreateRequest(ctx context.Context, serverName string, keyName string, resourceGroupName string, parameters ServerKey, _ *ServerKeysClientBeginCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *ServerKeysClient) deleteCreateRequest(ctx context.Context, serverName string, keyName string, resourceGroupName string, _ *ServerKeysClientBeginDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforMySQL/servers/{serverName}/keys/{keyName}"
	if serverName == "" {
		return nil, errors.New("parameter serverName cannot be empty")
	}
...
func (client *ServerKeysClient) listCreateRequest(ctx context.Context, resourceGroupName string, serverName string, _ *ServerKeysClientListOptions) (*policy.Request, error) {
