...
type PricingProperties struct {
	...
	// Deprecated - READ-ONLY; (optional) will return true if the pricing bundle is deprecated
	Deprecated *bool `json:"deprecated,omitempty"`
	// ReplacedBy - READ-ONLY; (optional) List of pricing bundles which replace the deprecated bundle, if deprecated is true
