...
- New field `ArtifactStreamingProfile`, `GpuProfile`, `NodeInitializationTaints`, `VirtualMachineNodesStatus`, `VirtualMachinesProfile` in struct `ManagedClusterAgentPoolProfile`
- New field `ArtifactStreamingProfile`, `GpuProfile`, `NodeInitializationTaints`, `VirtualMachineNodesStatus`, `VirtualMachinesProfile` in struct `ManagedClusterAgentPoolProfileProperties`
