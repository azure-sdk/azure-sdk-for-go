...
// MarshalJSON implements the json.Marshaller interface for type CreateExternalTenantProperties.
func (c CreateExternalTenantProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "countryCode", c.CountryCode)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type CreateExternalTenantProperties.
func (c *CreateExternalTenantProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type ExternalTenantResource.
func (e ExternalTenantResource) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type ExternalTenantResource.
func (e *ExternalTenantResource) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
...
// MarshalJSON implements the json.Marshaller interface for type ExternalTenantResourceList.
func (e ExternalTenantResourceList) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type ExternalTenantResourceList.
func (e *ExternalTenantResourceList) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", e, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type ExternalTenantResourceProperties.
func (e ExternalTenantResourceProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "billingConfig", e.BillingConfig)
	populate(objectMap, "createTenantProperties", e.CreateTenantProperties)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type ExternalTenantResourceProperties.
func (e *ExternalTenantResourceProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", e, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "billingConfig":
			err = unpopulate(val, "BillingConfig", &e.BillingConfig)
			delete(rawMsg, key)
		case "createTenantProperties":
			err = unpopulate(val, "CreateTenantProperties", &e.CreateTenantProperties)
			delete(rawMsg, key)
		case "domainName":
...
// MarshalJSON implements the json.Marshaller interface for type ExternalTenantResourcePropertiesBillingConfig.
func (e ExternalTenantResourcePropertiesBillingConfig) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "billingType", e.BillingType)
	populate(objectMap, "effectiveStartDateUtc", e.EffectiveStartDateUTC)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ExternalTenantResourcePropertiesBillingConfig.
func (e *ExternalTenantResourcePropertiesBillingConfig) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", e, err)
	}
	for key, val := range rawMsg {
		...
		case "billingType":
			...
			delete(rawMsg, key)
		case "effectiveStartDateUtc":
			err = unpopulate(val, "EffectiveStartDateUTC", &e.EffectiveStartDateUTC)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", e, err)
...
// MarshalJSON implements the json.Marshaller interface for type ExternalTenantResourceSKU.
func (e ExternalTenantResourceSKU) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "name", e.Name)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type ExternalTenantResourceSKU.
func (e *ExternalTenantResourceSKU) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", e, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type ExternalTenantUpdateRequest.
func (e ExternalTenantUpdateRequest) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "sku", e.SKU)
	populate(objectMap, "tags", e.Tags)
	return json.Marshal(objectMap)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type ExternalTenantUpdateRequest.
func (e *ExternalTenantUpdateRequest) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", e, err)
	}
