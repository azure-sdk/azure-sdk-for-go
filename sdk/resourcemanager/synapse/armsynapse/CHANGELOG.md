...
- New function `*ManagementClient.IntegrationRuntimeStartOperationStatus(context.Context, string, string, string, string, string, *ManagementClientIntegrationRuntimeStartOperationStatusOptions) (ManagementClientIntegrationRuntimeStartOperationStatusResponse, error)`
...
- New struct `IntegrationRuntimesOperationStatus`
...
- New struct `ManagementClientIntegrationRuntimeStartOperationStatusOptions`
- New struct `ManagementClientIntegrationRuntimeStartOperationStatusResponse`
