...
func (u *UserSessionsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if userSessionsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = userSessionsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "UserSessionsClient.Disconnect":
				res.resp, res.err = u.dispatchDisconnect(req)
			...
			case "UserSessionsClient.NewListByHostPoolPager":
				res.resp, res.err = u.dispatchNewListByHostPoolPager(req)
			case "UserSessionsClient.SendMessage":
				res.resp, res.err = u.dispatchSendMessage(req)
			default:
...
// set this to conditionally intercept incoming requests to UserSessionsServerTransport
var userSessionsServerTransportInterceptor interface {
