...
// MarshalJSON implements the json.Marshaller interface for type OperationsForbidden.
func (o OperationsForbidden) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
...
// UnmarshalJSON implements the json.Unmarshaller interface for type OperationsForbidden.
func (o *OperationsForbidden) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", o, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type State.
...
// UnmarshalJSON implements the json.Unmarshaller interface for type State.
