...
// AssignmentsClientVMHealthCheckResponse contains the response from method AssignmentsClient.VMHealthCheck.
type AssignmentsClientVMHealthCheckResponse struct {
	VMHealthCheckProperties
}
