...
// ListCredentialsRequest - Represent ListCredentials Request object.
...
type RelayNamespaceAccessProperties struct {
	...
	ServiceConfigurationToken *string `json:"serviceConfigurationToken,omitempty"`
...
type ServiceConfigurationList struct {
	...
	Value []*ServiceConfigurationResource `json:"value,omitempty"`
}
...
type ServiceConfigurationProperties struct {
	...
	// READ-ONLY; The resource provisioning state.
	ProvisioningState *Result `json:"provisioningState,omitempty" azure:"ro"`
}
...
type ServiceConfigurationResource struct {
	...
	Properties *ServiceConfigurationProperties `json:"properties,omitempty"`
...
// ServiceConfigurationResourcePatch - The service details under serviceconfiguration for the target resource.
type ServiceConfigurationResourcePatch struct {
	// The service configuration properties.
	Properties *ServiceConfigurationPropertiesPatch `json:"properties,omitempty"`

	// READ-ONLY; System data of endpoint resource
	SystemData *SystemData `json:"systemData,omitempty" azure:"ro"`
}

// ServiceconfigurationsClientCreateOptions contains the optional parameters for the ServiceconfigurationsClient.Create method.
type ServiceconfigurationsClientCreateOptions struct {
	// placeholder for future optional parameters
}
