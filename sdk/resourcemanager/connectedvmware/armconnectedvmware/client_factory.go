...
func (c *ClientFactory) NewAzureArcVMwareManagementServiceAPIClient() *AzureArcVMwareManagementServiceAPIClient {
	subClient, _ := NewAzureArcVMwareManagementServiceAPIClient(c.subscriptionID, c.credential, c.options)
	return subClient
}
