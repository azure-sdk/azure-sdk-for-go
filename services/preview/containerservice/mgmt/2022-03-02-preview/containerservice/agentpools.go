...
// resourceName - the name of the managed cluster resource.
// agentPoolName - the name of the agent pool.
// noPoddisruptionbudget - no-poddisruptionbudget=true to delete those pods on a node without considering Pod
// Disruption Budget
func (client AgentPoolsClient) Delete(ctx context.Context, resourceGroupName string, resourceName string, agentPoolName string, noPoddisruptionbudget *bool) (result AgentPoolsDeleteFuture, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.DeletePreparer(ctx, resourceGroupName, resourceName, agentPoolName, noPoddisruptionbudget)
	if err != nil {
...
func (client AgentPoolsClient) DeletePreparer(ctx context.Context, resourceGroupName string, resourceName string, agentPoolName string, noPoddisruptionbudget *bool) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"agentPoolName":     autorest.Encode("path", agentPoolName),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"resourceName":      autorest.Encode("path", resourceName),
	...
	if noPoddisruptionbudget != nil {
		queryParameters["no-poddisruptionbudget"] = autorest.Encode("query", *noPoddisruptionbudget)
	}
