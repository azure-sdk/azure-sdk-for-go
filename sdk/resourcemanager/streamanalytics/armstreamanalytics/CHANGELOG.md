...
- Type of `AvroSerialization.Properties` has been changed from `interface{}` to `any`
- Type of `OutputProperties.SizeWindow` has been changed from `*float32` to `*int32`
- Type of `ParquetSerialization.Properties` has been changed from `interface{}` to `any`
- Type of `ServiceBusQueueOutputDataSourceProperties.SystemPropertyColumns` has been changed from `interface{}` to `any`
