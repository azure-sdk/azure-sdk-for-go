...
// JobModelCustomPropertiesAffectedObjectDetails - Gets or sets any custom properties of the affected object.
type JobModelCustomPropertiesAffectedObjectDetails struct {
	// CONSTANT; undefinedField has constant value "object", any specified value is ignored.
	Type        *string
	Description *string
}
