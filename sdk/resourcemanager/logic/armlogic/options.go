...
// LocationsClientValidateWorkflowExportOptions contains the optional parameters for the LocationsClient.ValidateWorkflowExport
// method.
type LocationsClientValidateWorkflowExportOptions struct {
	// placeholder for future optional parameters
}

// LocationsClientWorkflowExportOptions contains the optional parameters for the LocationsClient.WorkflowExport method.
type LocationsClientWorkflowExportOptions struct {
	// placeholder for future optional parameters
}
