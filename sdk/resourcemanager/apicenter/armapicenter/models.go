...
// AnalyzerConfig - API analyzer configuration.
type AnalyzerConfig struct {
	// The resource-specific properties for this resource.
	Properties *AnalyzerConfigProperties
...
// AnalyzerConfigListResult - The response of a AnalyzerConfig list operation.
type AnalyzerConfigListResult struct {
	// READ-ONLY; The AnalyzerConfig items on this page
...
// AnalyzerConfigProperties - API analyzer configuration properties.
type AnalyzerConfigProperties struct {
	// REQUIRED; The type of API analyzer.
	AnalyzerType *AnalyzerType

	// REQUIRED; The title of the analyzer configuration, e.g. "Spectral (OpenAPI)".
	Title *string
	...
	// READ-ONLY; The state of the API analyzer ruleset.
	State *AnalyzerRulesetState
}

// AnalyzerFilter - The API analyzer filter, used to select API definitions for static analysis. All the conditions get applied
// with the logical AND operator.
type AnalyzerFilter struct {
	// REQUIRED; Api definition filter conditions.
	APIDefinitions []*AnalyzerFilterCondition

	// REQUIRED; APi version filter conditions.
	APIVersions []*AnalyzerFilterCondition

	// REQUIRED; API filter conditions.
	Apis []*AnalyzerFilterCondition
}

// AnalyzerFilterCondition - Analyzer filter condition.
type AnalyzerFilterCondition struct {
	// REQUIRED; The operator to use for the filter, e.g. "equals".
	Operator *AnalyzerFilterOperator

	// REQUIRED; The property to filter on, e.g. "lifecycleStage".
	Property *string

	// REQUIRED; The value to filter on, e.g. "production".
	Value any
}
...
// RulesetExportResult - The ruleset export result.
...
// RulesetImportRequest - The API analyzer ruleset import request.
type RulesetImportRequest struct {
