...
func (client *WidgetTypesClient) getCreateRequest(ctx context.Context, resourceGroupName string, hubName string, widgetTypeName string, _ *WidgetTypesClientGetOptions) (*policy.Request, error) {
...
func (client *WidgetTypesClient) listByHubCreateRequest(ctx context.Context, resourceGroupName string, hubName string, _ *WidgetTypesClientListByHubOptions) (*policy.Request, error) {
