...
func (m *ModelSKU) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "deprecationDate":
			err = unpopulateTimeRFC3339(val, "DeprecationDate", &m.DeprecationDate)
			delete(rawMsg, key)
		case "name":
...
func (r RaiContentFilter) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "policyName", r.PolicyName)
	return json.Marshal(objectMap)
}
...
func (r *RaiContentFilter) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "filterType":
			...
			delete(rawMsg, key)
		case "policyName":
			err = unpopulate(val, "PolicyName", &r.PolicyName)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", r, err)
...
func (r RaiPolicyProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "policyType", r.PolicyType)
...
func (r *RaiPolicyProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "mode":
			...
			delete(rawMsg, key)
		case "policyType":
			err = unpopulate(val, "PolicyType", &r.PolicyType)
			delete(rawMsg, key)
