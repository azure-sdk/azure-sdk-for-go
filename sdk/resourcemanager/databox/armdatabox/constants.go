...
// ModelNames - The display name of the sku.
type ModelNames string

const (
	// ModelNamesDataBox - Data Box.
	ModelNamesDataBox ModelNames = "DataBox"
	// ModelNamesDataBoxCustomerDisk - Data Box Customer Disk
	ModelNamesDataBoxCustomerDisk ModelNames = "DataBoxCustomerDisk"
	// ModelNamesDataBoxDisk - Data Box Disk.
	ModelNamesDataBoxDisk ModelNames = "DataBoxDisk"
	// ModelNamesDataBoxHeavy - Data Box Heavy.
	ModelNamesDataBoxHeavy ModelNames = "DataBoxHeavy"
	// ModelNamesDataBoxV2X100 - Data Box V2 100TB.
	ModelNamesDataBoxV2X100 ModelNames = "DataBoxV2x100"
	// ModelNamesDataBoxV2X500 - Data Box V2 500TB.
	ModelNamesDataBoxV2X500 ModelNames = "DataBoxV2x500"
)

// PossibleModelNamesValues returns the possible values for the ModelNames const type.
func PossibleModelNamesValues() []ModelNames {
	return []ModelNames{
		ModelNamesDataBox,
