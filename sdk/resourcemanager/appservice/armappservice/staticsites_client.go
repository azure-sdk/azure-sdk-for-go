...
// BeginCreateOrUpdateTrafficSplitting - Description for Adds or updates traffic splitting for a static site.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2022-09-01
//   - resourceGroupName - Name of the resource group to which the resource belongs.
//   - name - Name of the static site.
//   - trafficSplittingName - name of the traffic splitting entry.
//   - trafficSplittingEnvelope - A JSON representation of the traffic splitting properties.
//   - options - StaticSitesClientBeginCreateOrUpdateTrafficSplittingOptions contains the optional parameters for the StaticSitesClient.BeginCreateOrUpdateTrafficSplitting
//     method.
func (client *StaticSitesClient) BeginCreateOrUpdateTrafficSplitting(ctx context.Context, resourceGroupName string, name string, trafficSplittingName BasicAuthName, trafficSplittingEnvelope StaticSiteTrafficSplittingPropertiesARMResource, options *StaticSitesClientBeginCreateOrUpdateTrafficSplittingOptions) (*runtime.Poller[StaticSitesClientCreateOrUpdateTrafficSplittingResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.createOrUpdateTrafficSplitting(ctx, resourceGroupName, name, trafficSplittingName, trafficSplittingEnvelope, options)
		if err != nil {
			return nil, err
		}
		return runtime.NewPoller[StaticSitesClientCreateOrUpdateTrafficSplittingResponse](resp, client.pl, nil)
	} else {
		return runtime.NewPollerFromResumeToken[StaticSitesClientCreateOrUpdateTrafficSplittingResponse](options.ResumeToken, client.pl, nil)
	}
}

// CreateOrUpdateTrafficSplitting - Description for Adds or updates traffic splitting for a static site.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2022-09-01
func (client *StaticSitesClient) createOrUpdateTrafficSplitting(ctx context.Context, resourceGroupName string, name string, trafficSplittingName BasicAuthName, trafficSplittingEnvelope StaticSiteTrafficSplittingPropertiesARMResource, options *StaticSitesClientBeginCreateOrUpdateTrafficSplittingOptions) (*http.Response, error) {
	req, err := client.createOrUpdateTrafficSplittingCreateRequest(ctx, resourceGroupName, name, trafficSplittingName, trafficSplittingEnvelope, options)
	if err != nil {
		return nil, err
	}
	resp, err := client.pl.Do(req)
...
// createOrUpdateTrafficSplittingCreateRequest creates the CreateOrUpdateTrafficSplitting request.
func (client *StaticSitesClient) createOrUpdateTrafficSplittingCreateRequest(ctx context.Context, resourceGroupName string, name string, trafficSplittingName BasicAuthName, trafficSplittingEnvelope StaticSiteTrafficSplittingPropertiesARMResource, options *StaticSitesClientBeginCreateOrUpdateTrafficSplittingOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/staticSites/{name}/trafficSplitting/{trafficSplittingName}"
	if resourceGroupName == "" {
		return nil, errors.New("parameter resourceGroupName cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{resourceGroupName}", url.PathEscape(resourceGroupName))
	...
	urlPath = strings.ReplaceAll(urlPath, "{name}", url.PathEscape(name))
	if trafficSplittingName == "" {
		return nil, errors.New("parameter trafficSplittingName cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{trafficSplittingName}", url.PathEscape(string(trafficSplittingName)))
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{subscriptionId}", url.PathEscape(client.subscriptionID))
	...
	req.Raw().URL.RawQuery = reqQP.Encode()
	req.Raw().Header["Accept"] = []string{"application/json"}
	return req, runtime.MarshalAsJSON(req, trafficSplittingEnvelope)
}
...
// DeleteTrafficSplitting - Description for Deletes traffic splitting for a static site.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2022-09-01
//   - resourceGroupName - Name of the resource group to which the resource belongs.
//   - name - Name of the static site.
//   - trafficSplittingName - name of the traffic splitting entry.
//   - options - StaticSitesClientDeleteTrafficSplittingOptions contains the optional parameters for the StaticSitesClient.DeleteTrafficSplitting
//     method.
func (client *StaticSitesClient) DeleteTrafficSplitting(ctx context.Context, resourceGroupName string, name string, trafficSplittingName TrafficSplittingName, options *StaticSitesClientDeleteTrafficSplittingOptions) (StaticSitesClientDeleteTrafficSplittingResponse, error) {
	req, err := client.deleteTrafficSplittingCreateRequest(ctx, resourceGroupName, name, trafficSplittingName, options)
	if err != nil {
		return StaticSitesClientDeleteTrafficSplittingResponse{}, err
	}
	resp, err := client.pl.Do(req)
	if err != nil {
		return StaticSitesClientDeleteTrafficSplittingResponse{}, err
	...
	if !runtime.HasStatusCode(resp, http.StatusOK) {
		return StaticSitesClientDeleteTrafficSplittingResponse{}, runtime.NewResponseError(resp)
	}
	return StaticSitesClientDeleteTrafficSplittingResponse{}, nil
}

// deleteTrafficSplittingCreateRequest creates the DeleteTrafficSplitting request.
func (client *StaticSitesClient) deleteTrafficSplittingCreateRequest(ctx context.Context, resourceGroupName string, name string, trafficSplittingName TrafficSplittingName, options *StaticSitesClientDeleteTrafficSplittingOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/staticSites/{name}/trafficSplitting/{trafficSplittingName}"
	if resourceGroupName == "" {
		return nil, errors.New("parameter resourceGroupName cannot be empty")
	}
...
// GetTrafficSplitting - Description for Gets the traffic splitting state of a static site.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2022-09-01
//   - resourceGroupName - Name of the resource group to which the resource belongs.
//   - name - Name of the static site.
//   - trafficSplittingName - name of the traffic splitting entry.
//   - options - StaticSitesClientGetTrafficSplittingOptions contains the optional parameters for the StaticSitesClient.GetTrafficSplitting
//     method.
func (client *StaticSitesClient) GetTrafficSplitting(ctx context.Context, resourceGroupName string, name string, trafficSplittingName TrafficSplittingName, options *StaticSitesClientGetTrafficSplittingOptions) (StaticSitesClientGetTrafficSplittingResponse, error) {
	req, err := client.getTrafficSplittingCreateRequest(ctx, resourceGroupName, name, trafficSplittingName, options)
	if err != nil {
		return StaticSitesClientGetTrafficSplittingResponse{}, err
	}
	resp, err := client.pl.Do(req)
	if err != nil {
		return StaticSitesClientGetTrafficSplittingResponse{}, err
	...
	if !runtime.HasStatusCode(resp, http.StatusOK) {
		return StaticSitesClientGetTrafficSplittingResponse{}, runtime.NewResponseError(resp)
	}
	return client.getTrafficSplittingHandleResponse(resp)
}

// getTrafficSplittingCreateRequest creates the GetTrafficSplitting request.
func (client *StaticSitesClient) getTrafficSplittingCreateRequest(ctx context.Context, resourceGroupName string, name string, trafficSplittingName TrafficSplittingName, options *StaticSitesClientGetTrafficSplittingOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/staticSites/{name}/trafficSplitting/{trafficSplittingName}"
	if resourceGroupName == "" {
		return nil, errors.New("parameter resourceGroupName cannot be empty")
	}
...
// getTrafficSplittingHandleResponse handles the GetTrafficSplitting response.
func (client *StaticSitesClient) getTrafficSplittingHandleResponse(resp *http.Response) (StaticSitesClientGetTrafficSplittingResponse, error) {
	result := StaticSitesClientGetTrafficSplittingResponse{}
	if err := runtime.UnmarshalAsJSON(resp, &result.StaticSiteTrafficSplittingPropertiesARMResource); err != nil {
		return StaticSitesClientGetTrafficSplittingResponse{}, err
	}
	return result, nil
}
...
// NewListBasicAuthPager - Description for Gets the traffic splitting properties for a static site as a collection.
//
// Generated from API version 2022-09-01
//   - resourceGroupName - Name of the resource group to which the resource belongs.
//   - name - Name of the static site.
...
func (client *StaticSitesClient) listBasicAuthCreateRequest(ctx context.Context, resourceGroupName string, name string, options *StaticSitesClientListBasicAuthOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/staticSites/{name}/trafficSplitting"
	if resourceGroupName == "" {
		return nil, errors.New("parameter resourceGroupName cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{resourceGroupName}", url.PathEscape(resourceGroupName))
...
func (client *StaticSitesClient) listBasicAuthHandleResponse(resp *http.Response) (StaticSitesClientListBasicAuthResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.StaticSiteTrafficSplittingPropertiesCollection); err != nil {
		return StaticSitesClientListBasicAuthResponse{}, err
	}
	return result, nil
}
