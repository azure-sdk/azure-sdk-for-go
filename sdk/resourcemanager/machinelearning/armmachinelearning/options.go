...
// ConnectionClientListModelsOptions contains the optional parameters for the ConnectionClient.ListModels method.
type ConnectionClientListModelsOptions struct {
	// placeholder for future optional parameters
}
