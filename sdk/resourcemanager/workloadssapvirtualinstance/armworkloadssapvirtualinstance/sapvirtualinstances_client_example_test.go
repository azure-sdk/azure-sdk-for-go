...
func ExampleSAPVirtualInstancesClient_BeginStart_sapVirtualInstancesStart() {
	...
	poller, err := clientFactory.NewSAPVirtualInstancesClient().BeginStart(ctx, "test-rg", "X00", armworkloadssapvirtualinstance.StartRequest{
		StartVM: to.Ptr(true),
	}, nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
...
func ExampleSAPVirtualInstancesClient_BeginStop_softStopOfSapVirtualInstancesStop() {
	...
	poller, err := clientFactory.NewSAPVirtualInstancesClient().BeginStop(ctx, "test-rg", "X00", armworkloadssapvirtualinstance.StopRequest{
