...
// AutoUpgradeMode - The upgrade mode for auto upgrade. The default is 'compatible'.
...
// ResourceIdentityType - The type of identity used for the resource. Only user assigned identities are supported for 'Bring
// your own Identity' model.
