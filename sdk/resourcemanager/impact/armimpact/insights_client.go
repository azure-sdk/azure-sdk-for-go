...
func (client *InsightsClient) createCreateRequest(ctx context.Context, workloadImpactName string, insightName string, resource Insight, options *InsightsClientCreateOptions) (*policy.Request, error) {
...
func (client *InsightsClient) deleteCreateRequest(ctx context.Context, workloadImpactName string, insightName string, options *InsightsClientDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/providers/Microsoft.Impact/workloadImpacts/{workloadImpactName}/insights/{insightName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *InsightsClient) getCreateRequest(ctx context.Context, workloadImpactName string, insightName string, options *InsightsClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/providers/Microsoft.Impact/workloadImpacts/{workloadImpactName}/insights/{insightName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *InsightsClient) listBySubscriptionCreateRequest(ctx context.Context, workloadImpactName string, options *InsightsClientListBySubscriptionOptions) (*policy.Request, error) {
