...
// BackendBaseParametersType - Type of the backend. A backend can be either Single or Pool.
type BackendBaseParametersType string

const (
	BackendBaseParametersTypePool   BackendBaseParametersType = "pool"
	BackendBaseParametersTypeSingle BackendBaseParametersType = "single"
)

// PossibleBackendBaseParametersTypeValues returns the possible values for the BackendBaseParametersType const type.
func PossibleBackendBaseParametersTypeValues() []BackendBaseParametersType {
	return []BackendBaseParametersType{
		BackendBaseParametersTypePool,
		BackendBaseParametersTypeSingle,
	}
}
