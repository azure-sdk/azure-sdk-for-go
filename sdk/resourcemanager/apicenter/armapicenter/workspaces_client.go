...
func (client *WorkspacesClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, workspaceName string, resource Workspace, _ *WorkspacesClientCreateOrUpdateOptions) (*policy.Request, error) {
...
// BeginImportAPISource - Imports from the API source (one-time import).
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2024-12-01-preview
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
...
//   - options - WorkspacesClientBeginImportAPISourceOptions contains the optional parameters for the WorkspacesClient.BeginImportAPISource
//     method.
func (client *WorkspacesClient) BeginImportAPISource(ctx context.Context, resourceGroupName string, serviceName string, workspaceName string, body ImportAPISourceRequest, options *WorkspacesClientBeginImportAPISourceOptions) (*runtime.Poller[WorkspacesClientImportAPISourceResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.importAPISource(ctx, resourceGroupName, serviceName, workspaceName, body, options)
		if err != nil {
			return nil, err
		}
		poller, err := runtime.NewPoller(resp, client.internal.Pipeline(), &runtime.NewPollerOptions[WorkspacesClientImportAPISourceResponse]{
			FinalStateVia: runtime.FinalStateViaLocation,
			Tracer:        client.internal.Tracer(),
		})
		return poller, err
	} else {
		return runtime.NewPollerFromResumeToken(options.ResumeToken, client.internal.Pipeline(), &runtime.NewPollerFromResumeTokenOptions[WorkspacesClientImportAPISourceResponse]{
			Tracer: client.internal.Tracer(),
		})
	}
}

// ImportAPISource - Imports from the API source (one-time import).
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2024-12-01-preview
func (client *WorkspacesClient) importAPISource(ctx context.Context, resourceGroupName string, serviceName string, workspaceName string, body ImportAPISourceRequest, options *WorkspacesClientBeginImportAPISourceOptions) (*http.Response, error) {
	var err error
	const operationName = "WorkspacesClient.BeginImportAPISource"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.importAPISourceCreateRequest(ctx, resourceGroupName, serviceName, workspaceName, body, options)
	if err != nil {
		return nil, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
...
// importAPISourceCreateRequest creates the ImportAPISource request.
func (client *WorkspacesClient) importAPISourceCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, workspaceName string, body ImportAPISourceRequest, _ *WorkspacesClientBeginImportAPISourceOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiCenter/services/{serviceName}/workspaces/{workspaceName}/importApiSource"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{subscriptionId}", url.PathEscape(client.subscriptionID))
