...
func (client *DatabaseMigrationsSQLMiClient) BeginDelete(ctx context.Context, resourceGroupName string, managedInstanceName string, targetDbName string, options *DatabaseMigrationsSQLMiClientBeginDeleteOptions) (*runtime.Poller[DatabaseMigrationsSQLMiClientDeleteResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return runtime.NewPoller[DatabaseMigrationsSQLMiClientDeleteResponse](resp, client.pl, nil)
	} else {
		return runtime.NewPollerFromResumeToken[DatabaseMigrationsSQLMiClientDeleteResponse](options.ResumeToken, client.pl, nil)
	}
}
...
// ListByScope - Retrieve Database Migration in the scope.
// If the operation fails it returns an *azcore.ResponseError type.
// Generated from API version 2022-10-31-preview
// resourceGroupName - Name of the resource group that contains the resource. You can obtain this value from the Azure Resource
// Manager API or the portal.
// options - DatabaseMigrationsSQLMiClientListByScopeOptions contains the optional parameters for the DatabaseMigrationsSQLMiClient.ListByScope
// method.
func (client *DatabaseMigrationsSQLMiClient) ListByScope(ctx context.Context, resourceGroupName string, managedInstanceName string, options *DatabaseMigrationsSQLMiClientListByScopeOptions) (DatabaseMigrationsSQLMiClientListByScopeResponse, error) {
	req, err := client.listByScopeCreateRequest(ctx, resourceGroupName, managedInstanceName, options)
	if err != nil {
		return DatabaseMigrationsSQLMiClientListByScopeResponse{}, err
	}
	resp, err := client.pl.Do(req)
	if err != nil {
		return DatabaseMigrationsSQLMiClientListByScopeResponse{}, err
	...
	if !runtime.HasStatusCode(resp, http.StatusOK) {
		return DatabaseMigrationsSQLMiClientListByScopeResponse{}, runtime.NewResponseError(resp)
	}
	return client.listByScopeHandleResponse(resp)
}

// listByScopeCreateRequest creates the ListByScope request.
func (client *DatabaseMigrationsSQLMiClient) listByScopeCreateRequest(ctx context.Context, resourceGroupName string, managedInstanceName string, options *DatabaseMigrationsSQLMiClientListByScopeOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/providers/Microsoft.DataMigration/databaseMigrations"
	if resourceGroupName == "" {
		return nil, errors.New("parameter resourceGroupName cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{resourceGroupName}", url.PathEscape(resourceGroupName))
...
func (client *DatabaseMigrationsSQLMiClient) listByScopeHandleResponse(resp *http.Response) (DatabaseMigrationsSQLMiClientListByScopeResponse, error) {
	result := DatabaseMigrationsSQLMiClientListByScopeResponse{}
	if err := runtime.UnmarshalAsJSON(resp, &result.DatabaseMigrationSQLMiListResult); err != nil {
		return DatabaseMigrationsSQLMiClientListByScopeResponse{}, err
	}
	return result, nil
}
