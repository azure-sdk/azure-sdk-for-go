...
func (client *ImagesClient) getUploadURLForDataCreateRequest(ctx context.Context, resourceGroupName string, hubName string, parameters GetImageUploadURLInput, _ *ImagesClientGetUploadURLForDataOptions) (*policy.Request, error) {
...
func (client *ImagesClient) getUploadURLForEntityTypeCreateRequest(ctx context.Context, resourceGroupName string, hubName string, parameters GetImageUploadURLInput, _ *ImagesClientGetUploadURLForEntityTypeOptions) (*policy.Request, error) {
