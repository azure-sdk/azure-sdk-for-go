...
// FleetsServer is a fake server for instances of the armazurefleet.FleetsClient type.
type FleetsServer struct {
	// BeginCreateOrUpdate is the fake for method FleetsClient.BeginCreateOrUpdate
	// HTTP status codes to indicate success: http.StatusOK, http.StatusCreated
	BeginCreateOrUpdate func(ctx context.Context, resourceGroupName string, fleetName string, resource armazurefleet.Fleet, options *armazurefleet.FleetsClientBeginCreateOrUpdateOptions) (resp azfake.PollerResponder[armazurefleet.FleetsClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)

	// BeginDelete is the fake for method FleetsClient.BeginDelete
	// HTTP status codes to indicate success: http.StatusAccepted, http.StatusNoContent
	BeginDelete func(ctx context.Context, resourceGroupName string, fleetName string, options *armazurefleet.FleetsClientBeginDeleteOptions) (resp azfake.PollerResponder[armazurefleet.FleetsClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method FleetsClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, fleetName string, options *armazurefleet.FleetsClientGetOptions) (resp azfake.Responder[armazurefleet.FleetsClientGetResponse], errResp azfake.ErrorResponder)

	// NewListByResourceGroupPager is the fake for method FleetsClient.NewListByResourceGroupPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByResourceGroupPager func(resourceGroupName string, options *armazurefleet.FleetsClientListByResourceGroupOptions) (resp azfake.PagerResponder[armazurefleet.FleetsClientListByResourceGroupResponse])

	// NewListBySubscriptionPager is the fake for method FleetsClient.NewListBySubscriptionPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListBySubscriptionPager func(options *armazurefleet.FleetsClientListBySubscriptionOptions) (resp azfake.PagerResponder[armazurefleet.FleetsClientListBySubscriptionResponse])

	// BeginUpdate is the fake for method FleetsClient.BeginUpdate
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginUpdate func(ctx context.Context, resourceGroupName string, fleetName string, properties armazurefleet.FleetUpdate, options *armazurefleet.FleetsClientBeginUpdateOptions) (resp azfake.PollerResponder[armazurefleet.FleetsClientUpdateResponse], errResp azfake.ErrorResponder)
}

// NewFleetsServerTransport creates a new instance of FleetsServerTransport with the provided implementation.
// The returned FleetsServerTransport instance is connected to an instance of armazurefleet.FleetsClient via the
// azcore.ClientOptions.Transporter field in the client's constructor parameters.
func NewFleetsServerTransport(srv *FleetsServer) *FleetsServerTransport {
	return &FleetsServerTransport{
		srv:                         srv,
		beginCreateOrUpdate:         newTracker[azfake.PollerResponder[armazurefleet.FleetsClientCreateOrUpdateResponse]](),
		beginDelete:                 newTracker[azfake.PollerResponder[armazurefleet.FleetsClientDeleteResponse]](),
		newListByResourceGroupPager: newTracker[azfake.PagerResponder[armazurefleet.FleetsClientListByResourceGroupResponse]](),
		newListBySubscriptionPager:  newTracker[azfake.PagerResponder[armazurefleet.FleetsClientListBySubscriptionResponse]](),
		beginUpdate:                 newTracker[azfake.PollerResponder[armazurefleet.FleetsClientUpdateResponse]](),
	}
}

// FleetsServerTransport connects instances of armazurefleet.FleetsClient to instances of FleetsServer.
// Don't use this type directly, use NewFleetsServerTransport instead.
type FleetsServerTransport struct {
	srv                         *FleetsServer
	beginCreateOrUpdate         *tracker[azfake.PollerResponder[armazurefleet.FleetsClientCreateOrUpdateResponse]]
	beginDelete                 *tracker[azfake.PollerResponder[armazurefleet.FleetsClientDeleteResponse]]
	newListByResourceGroupPager *tracker[azfake.PagerResponder[armazurefleet.FleetsClientListByResourceGroupResponse]]
	newListBySubscriptionPager  *tracker[azfake.PagerResponder[armazurefleet.FleetsClientListBySubscriptionResponse]]
	beginUpdate                 *tracker[azfake.PollerResponder[armazurefleet.FleetsClientUpdateResponse]]
}
...
func (f *FleetsServerTransport) dispatchBeginCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginCreateOrUpdate == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armazurefleet.Fleet](req)
		if err != nil {
			return nil, err
		}
...
func (f *FleetsServerTransport) dispatchNewListByResourceGroupPager(req *http.Request) (*http.Response, error) {
	...
	if newListByResourceGroupPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListByResourceGroupPager, req, func(page *armazurefleet.FleetsClientListByResourceGroupResponse, createLink func() string) {
...
func (f *FleetsServerTransport) dispatchNewListBySubscriptionPager(req *http.Request) (*http.Response, error) {
	...
	if newListBySubscriptionPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListBySubscriptionPager, req, func(page *armazurefleet.FleetsClientListBySubscriptionResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
...
func (f *FleetsServerTransport) dispatchBeginUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginUpdate == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armazurefleet.FleetUpdate](req)
		if err != nil {
			return nil, err
		}
		resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
