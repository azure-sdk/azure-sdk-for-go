...
type ServerFactory struct {
	// AgentPoolServer contains the fakes for client AgentPoolClient
	...
	// ProvisionedClusterInstancesServer contains the fakes for client ProvisionedClusterInstancesClient
