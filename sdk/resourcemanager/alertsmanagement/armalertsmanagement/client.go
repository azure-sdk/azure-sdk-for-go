...
func (client *Client) PreviewAlertRule(ctx context.Context, parameters PreviewAlertRuleRequest, options *ClientPreviewAlertRuleOptions) (ClientPreviewAlertRuleResponse, error) {
	var err error
	const operationName = "Client.PreviewAlertRule"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.previewAlertRuleCreateRequest(ctx, parameters, options)
	if err != nil {
...
func (client *Client) previewAlertRuleCreateRequest(ctx context.Context, parameters PreviewAlertRuleRequest, options *ClientPreviewAlertRuleOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/providers/Microsoft.AlertsManagement/previewAlertRule"
...
func (client *Client) previewAlertRuleHandleResponse(resp *http.Response) (ClientPreviewAlertRuleResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.PreviewAlertRuleResponse); err != nil {
		return ClientPreviewAlertRuleResponse{}, err
	}
	return result, nil
}
