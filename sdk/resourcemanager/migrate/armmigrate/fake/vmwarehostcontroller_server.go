...
// VmwareHostControllerServer is a fake server for instances of the armmigrate.VmwareHostControllerClient type.
type VmwareHostControllerServer struct {
	// Get is the fake for method VmwareHostControllerClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, siteName string, hostName string, options *armmigrate.VmwareHostControllerClientGetOptions) (resp azfake.Responder[armmigrate.VmwareHostControllerClientGetResponse], errResp azfake.ErrorResponder)

	// NewListByVmwareSitePager is the fake for method VmwareHostControllerClient.NewListByVmwareSitePager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByVmwareSitePager func(resourceGroupName string, siteName string, options *armmigrate.VmwareHostControllerClientListByVmwareSiteOptions) (resp azfake.PagerResponder[armmigrate.VmwareHostControllerClientListByVmwareSiteResponse])
}
...
// The returned VmwareHostControllerServerTransport instance is connected to an instance of armmigrate.VmwareHostControllerClient via the
...
func NewVmwareHostControllerServerTransport(srv *VmwareHostControllerServer) *VmwareHostControllerServerTransport {
	return &VmwareHostControllerServerTransport{
		srv:                      srv,
		newListByVmwareSitePager: newTracker[azfake.PagerResponder[armmigrate.VmwareHostControllerClientListByVmwareSiteResponse]](),
	}
}

// VmwareHostControllerServerTransport connects instances of armmigrate.VmwareHostControllerClient to instances of VmwareHostControllerServer.
...
type VmwareHostControllerServerTransport struct {
	...
	newListByVmwareSitePager *tracker[azfake.PagerResponder[armmigrate.VmwareHostControllerClientListByVmwareSiteResponse]]
}
...
func (v *VmwareHostControllerServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if vmwareHostControllerServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = vmwareHostControllerServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "VmwareHostControllerClient.NewListByVmwareSitePager":
				res.resp, res.err = v.dispatchNewListByVmwareSitePager(req)
			default:
...
func (v *VmwareHostControllerServerTransport) dispatchNewListByVmwareSitePager(req *http.Request) (*http.Response, error) {
	...
	if newListByVmwareSitePager == nil {
		...
		server.PagerResponderInjectNextLinks(newListByVmwareSitePager, req, func(page *armmigrate.VmwareHostControllerClientListByVmwareSiteResponse, createLink func() string) {
...
// set this to conditionally intercept incoming requests to VmwareHostControllerServerTransport
var vmwareHostControllerServerTransportInterceptor interface {
