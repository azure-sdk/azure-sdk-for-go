...
// GetCollectionOffersWithContextsPlansDetails - List of offers IDs and list of subscriptions IDs to get the private plans
// besides the public plans
type GetCollectionOffersWithContextsPlansDetails struct {
	// List of offer IDs. If empty, all offers within the collection will be returned.
	OfferIDs []*string
...
// GetCollectionOffersWithContextsPlansProperties - List of offer IDs and list of subscriptions IDs to get the offers' details
type GetCollectionOffersWithContextsPlansProperties struct {
	// List of offer IDs and list of subscriptions IDs to get the offers' details
	Properties *GetCollectionOffersWithContextsPlansDetails
}
