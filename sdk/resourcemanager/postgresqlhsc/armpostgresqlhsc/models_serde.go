...
// MarshalJSON implements the json.Marshaller interface for type ClusterConfiguration.
func (c ClusterConfiguration) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "id", c.ID)
	populate(objectMap, "name", c.Name)
	populate(objectMap, "properties", c.Properties)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type ClusterConfiguration.
func (c *ClusterConfiguration) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type ClusterConfigurationProperties.
func (c ClusterConfigurationProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
...
// UnmarshalJSON implements the json.Unmarshaller interface for type ClusterConfigurationProperties.
func (c *ClusterConfigurationProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
...
func (c ClusterResponseProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "sourceCluster", c.SourceCluster)
...
func (c *ClusterResponseProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "serverNames":
			...
			delete(rawMsg, key)
		case "sourceCluster":
			err = unpopulate(val, "SourceCluster", &c.SourceCluster)
			delete(rawMsg, key)
		case "state":
...
func (p PrivateLinkResourceProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "memberNames", p.MemberNames)
	populate(objectMap, "zoneNames", p.ZoneNames)
	return json.Marshal(objectMap)
}
...
func (p *PrivateLinkResourceProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "groupId":
			...
			delete(rawMsg, key)
		case "memberNames":
			err = unpopulate(val, "MemberNames", &p.MemberNames)
			delete(rawMsg, key)
		case "zoneNames":
			err = unpopulate(val, "ZoneNames", &p.ZoneNames)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", p, err)
