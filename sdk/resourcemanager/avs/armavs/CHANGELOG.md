...
- Type of `PrivateCloudUpdate.Identity` has been changed from `*PrivateCloudIdentity` to `*AzureResourceManagerCommonTypesSystemAssignedServiceIdentity`
...
- New struct `AzureResourceManagerCommonTypesSKU`
- New struct `AzureResourceManagerCommonTypesSystemAssignedServiceIdentity`
