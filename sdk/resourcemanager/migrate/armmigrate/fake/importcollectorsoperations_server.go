...
// ImportCollectorsOperationsServer is a fake server for instances of the armmigrate.ImportCollectorsOperationsClient type.
type ImportCollectorsOperationsServer struct {
	...
	BeginCreate func(ctx context.Context, resourceGroupName string, projectName string, importCollectorName string, resource armmigrate.ImportCollector, options *armmigrate.ImportCollectorsOperationsClientBeginCreateOptions) (resp azfake.PollerResponder[armmigrate.ImportCollectorsOperationsClientCreateResponse], errResp azfake.ErrorResponder)

	// Delete is the fake for method ImportCollectorsOperationsClient.Delete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	Delete func(ctx context.Context, resourceGroupName string, projectName string, importCollectorName string, options *armmigrate.ImportCollectorsOperationsClientDeleteOptions) (resp azfake.Responder[armmigrate.ImportCollectorsOperationsClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method ImportCollectorsOperationsClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, projectName string, importCollectorName string, options *armmigrate.ImportCollectorsOperationsClientGetOptions) (resp azfake.Responder[armmigrate.ImportCollectorsOperationsClientGetResponse], errResp azfake.ErrorResponder)

	// NewListByAssessmentProjectPager is the fake for method ImportCollectorsOperationsClient.NewListByAssessmentProjectPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByAssessmentProjectPager func(resourceGroupName string, projectName string, options *armmigrate.ImportCollectorsOperationsClientListByAssessmentProjectOptions) (resp azfake.PagerResponder[armmigrate.ImportCollectorsOperationsClientListByAssessmentProjectResponse])
}
...
// The returned ImportCollectorsOperationsServerTransport instance is connected to an instance of armmigrate.ImportCollectorsOperationsClient via the
...
func NewImportCollectorsOperationsServerTransport(srv *ImportCollectorsOperationsServer) *ImportCollectorsOperationsServerTransport {
	return &ImportCollectorsOperationsServerTransport{
		srv:                             srv,
		beginCreate:                     newTracker[azfake.PollerResponder[armmigrate.ImportCollectorsOperationsClientCreateResponse]](),
		newListByAssessmentProjectPager: newTracker[azfake.PagerResponder[armmigrate.ImportCollectorsOperationsClientListByAssessmentProjectResponse]](),
	}
}

// ImportCollectorsOperationsServerTransport connects instances of armmigrate.ImportCollectorsOperationsClient to instances of ImportCollectorsOperationsServer.
...
type ImportCollectorsOperationsServerTransport struct {
	...
	beginCreate                     *tracker[azfake.PollerResponder[armmigrate.ImportCollectorsOperationsClientCreateResponse]]
	newListByAssessmentProjectPager *tracker[azfake.PagerResponder[armmigrate.ImportCollectorsOperationsClientListByAssessmentProjectResponse]]
}
...
func (i *ImportCollectorsOperationsServerTransport) dispatchNewListByAssessmentProjectPager(req *http.Request) (*http.Response, error) {
	...
	if newListByAssessmentProjectPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListByAssessmentProjectPager, req, func(page *armmigrate.ImportCollectorsOperationsClientListByAssessmentProjectResponse, createLink func() string) {
