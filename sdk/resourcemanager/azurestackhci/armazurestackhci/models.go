...
// ExtensionParametersProtectedSettings - Protected settings (may contain secrets).
type ExtensionParametersProtectedSettings struct {
	// Workspace Key.
	WorkspaceKey *string
}

// ExtensionParametersSettings - Json formatted public settings for the extension.
type ExtensionParametersSettings struct {
	// Workspace Id.
	WorkspaceID *string
}
