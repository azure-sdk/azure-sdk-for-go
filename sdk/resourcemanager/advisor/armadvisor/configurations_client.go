...
// CreateInResourceGroupDuration - Create/Overwrite Azure Advisor configuration.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2023-01-01
//   - resourceGroup - The name of the Azure resource group.
//   - configurationName - Advisor configuration name. Value must be 'default'
//   - configurationType - Advisor configuration name. Value must be 'duration'
//   - configContract - The Azure Advisor configuration data structure.
//   - options - ConfigurationsClientCreateInResourceGroupDurationOptions contains the optional parameters for the ConfigurationsClient.CreateInResourceGroupDuration
//     method.
func (client *ConfigurationsClient) CreateInResourceGroupDuration(ctx context.Context, resourceGroup string, configurationName ConfigurationName, configurationType ConfigurationNameAutoGenerated, configContract ConfigData, options *ConfigurationsClientCreateInResourceGroupDurationOptions) (ConfigurationsClientCreateInResourceGroupDurationResponse, error) {
	var err error
	req, err := client.createInResourceGroupDurationCreateRequest(ctx, resourceGroup, configurationName, configurationType, configContract, options)
	if err != nil {
		return ConfigurationsClientCreateInResourceGroupDurationResponse{}, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
	if err != nil {
		return ConfigurationsClientCreateInResourceGroupDurationResponse{}, err
	...
	resp, err := client.createInResourceGroupDurationHandleResponse(httpResp)
	return resp, err
}

// createInResourceGroupDurationCreateRequest creates the CreateInResourceGroupDuration request.
func (client *ConfigurationsClient) createInResourceGroupDurationCreateRequest(ctx context.Context, resourceGroup string, configurationName ConfigurationName, configurationType ConfigurationNameAutoGenerated, configContract ConfigData, options *ConfigurationsClientCreateInResourceGroupDurationOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroup}/providers/Microsoft.Advisor/configurations/{configurationName}/v2/{configurationType}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{subscriptionId}", url.PathEscape(client.subscriptionID))
	...
	if configurationType == "" {
		return nil, errors.New("parameter configurationType cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{configurationType}", url.PathEscape(string(configurationType)))
	req, err := runtime.NewRequest(ctx, http.MethodPut, runtime.JoinPaths(client.internal.Endpoint(), urlPath))
	if err != nil {
		return nil, err
	}
...
// createInResourceGroupDurationHandleResponse handles the CreateInResourceGroupDuration response.
func (client *ConfigurationsClient) createInResourceGroupDurationHandleResponse(resp *http.Response) (ConfigurationsClientCreateInResourceGroupDurationResponse, error) {
	result := ConfigurationsClientCreateInResourceGroupDurationResponse{}
	if err := runtime.UnmarshalAsJSON(resp, &result.ConfigData); err != nil {
		return ConfigurationsClientCreateInResourceGroupDurationResponse{}, err
	}
	return result, nil
...
// CreateInSubscriptionDuration - Create/Overwrite Azure Advisor configuration and also delete all configurations of contained
// resource groups.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2023-01-01
...
//   - configurationType - Advisor configuration name. Value must be 'duration'
//   - configContract - The Azure Advisor configuration data structure.
//   - options - ConfigurationsClientCreateInSubscriptionDurationOptions contains the optional parameters for the ConfigurationsClient.CreateInSubscriptionDuration
//     method.
func (client *ConfigurationsClient) CreateInSubscriptionDuration(ctx context.Context, configurationName ConfigurationName, configurationType ConfigurationNameAutoGenerated, configContract ConfigData, options *ConfigurationsClientCreateInSubscriptionDurationOptions) (ConfigurationsClientCreateInSubscriptionDurationResponse, error) {
	var err error
	req, err := client.createInSubscriptionDurationCreateRequest(ctx, configurationName, configurationType, configContract, options)
	if err != nil {
		return ConfigurationsClientCreateInSubscriptionDurationResponse{}, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
	if err != nil {
		return ConfigurationsClientCreateInSubscriptionDurationResponse{}, err
	...
	resp, err := client.createInSubscriptionDurationHandleResponse(httpResp)
	return resp, err
}

// createInSubscriptionDurationCreateRequest creates the CreateInSubscriptionDuration request.
func (client *ConfigurationsClient) createInSubscriptionDurationCreateRequest(ctx context.Context, configurationName ConfigurationName, configurationType ConfigurationNameAutoGenerated, configContract ConfigData, options *ConfigurationsClientCreateInSubscriptionDurationOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/providers/Microsoft.Advisor/configurations/{configurationName}/v2/{configurationType}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{subscriptionId}", url.PathEscape(client.subscriptionID))
...
// createInSubscriptionDurationHandleResponse handles the CreateInSubscriptionDuration response.
func (client *ConfigurationsClient) createInSubscriptionDurationHandleResponse(resp *http.Response) (ConfigurationsClientCreateInSubscriptionDurationResponse, error) {
	result := ConfigurationsClientCreateInSubscriptionDurationResponse{}
	if err := runtime.UnmarshalAsJSON(resp, &result.ConfigData); err != nil {
		return ConfigurationsClientCreateInSubscriptionDurationResponse{}, err
	}
	return result, nil
