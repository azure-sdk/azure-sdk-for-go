...
func (client *AlertsClient) getByIDCreateRequest(ctx context.Context, scope string, alertID string, _ *AlertsClientGetByIDOptions) (*policy.Request, error) {
...
func (client *AlertsClient) getEnrichmentsCreateRequest(ctx context.Context, scope string, alertID string, _ *AlertsClientGetEnrichmentsOptions) (*policy.Request, error) {
...
func (client *AlertsClient) getHistoryCreateRequest(ctx context.Context, scope string, alertID string, _ *AlertsClientGetHistoryOptions) (*policy.Request, error) {
...
func (client *AlertsClient) listEnrichmentsCreateRequest(ctx context.Context, scope string, alertID string, _ *AlertsClientListEnrichmentsOptions) (*policy.Request, error) {
