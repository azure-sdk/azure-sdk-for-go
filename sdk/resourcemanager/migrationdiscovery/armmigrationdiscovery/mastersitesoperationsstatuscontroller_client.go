...
func (client *MasterSitesOperationsStatusControllerClient) getVmwareOperationStatusCreateRequest(ctx context.Context, resourceGroupName string, siteName string, operationStatusName string, _ *MasterSitesOperationsStatusControllerClientGetVmwareOperationStatusOptions) (*policy.Request, error) {
