...
//   - requestHistoryName - The name of the RequestHistory
...
func (client *WorkflowRunActionRequestHistoriesClient) getCreateRequest(ctx context.Context, resourceGroupName string, workflowName string, runName string, actionName string, requestHistoryName string, _ *WorkflowRunActionRequestHistoriesClientGetOptions) (*policy.Request, error) {
...
func (client *WorkflowRunActionRequestHistoriesClient) listCreateRequest(ctx context.Context, resourceGroupName string, workflowName string, runName string, actionName string, _ *WorkflowRunActionRequestHistoriesClientListOptions) (*policy.Request, error) {
