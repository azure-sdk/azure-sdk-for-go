...
// AutoSyncCertificate - Indicates whether to automatically synchronize certificate from key vault or not.
type AutoSyncCertificate string

const (
	AutoSyncCertificateDisabled AutoSyncCertificate = "Disabled"
	AutoSyncCertificateEnabled  AutoSyncCertificate = "Enabled"
)

// PossibleAutoSyncCertificateValues returns the possible values for the AutoSyncCertificate const type.
func PossibleAutoSyncCertificateValues() []AutoSyncCertificate {
	return []AutoSyncCertificate{
		AutoSyncCertificateDisabled,
		AutoSyncCertificateEnabled,
	}
}
