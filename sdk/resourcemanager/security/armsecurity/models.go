...
// DataScanner - Security Data Scanner resource
...
// DataScannersList - Page of a Data Scanners list
type DataScannersList struct {
	// READ-ONLY; The URI to fetch the next page
	NextLink *string

	// READ-ONLY; Collection of Data Scanners in this page
	Value []*DataScanner
}
