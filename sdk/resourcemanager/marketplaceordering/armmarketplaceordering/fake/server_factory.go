...
// The returned ServerFactoryTransport instance is connected to an instance of armmarketplaceordering.ClientFactory via the
...
// ServerFactoryTransport connects instances of armmarketplaceordering.ClientFactory to instances of ServerFactory.
