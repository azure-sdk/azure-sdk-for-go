...
// AssessmentsOperationsServer is a fake server for instances of the armmigrate.AssessmentsOperationsClient type.
type AssessmentsOperationsServer struct {
	...
	BeginCreate func(ctx context.Context, resourceGroupName string, projectName string, groupName string, assessmentName string, resource armmigrate.Assessment, options *armmigrate.AssessmentsOperationsClientBeginCreateOptions) (resp azfake.PollerResponder[armmigrate.AssessmentsOperationsClientCreateResponse], errResp azfake.ErrorResponder)

	// Delete is the fake for method AssessmentsOperationsClient.Delete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	Delete func(ctx context.Context, resourceGroupName string, projectName string, groupName string, assessmentName string, options *armmigrate.AssessmentsOperationsClientDeleteOptions) (resp azfake.Responder[armmigrate.AssessmentsOperationsClientDeleteResponse], errResp azfake.ErrorResponder)

	// BeginDownloadURL is the fake for method AssessmentsOperationsClient.BeginDownloadURL
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginDownloadURL func(ctx context.Context, resourceGroupName string, projectName string, groupName string, assessmentName string, body any, options *armmigrate.AssessmentsOperationsClientBeginDownloadURLOptions) (resp azfake.PollerResponder[armmigrate.AssessmentsOperationsClientDownloadURLResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method AssessmentsOperationsClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, projectName string, groupName string, assessmentName string, options *armmigrate.AssessmentsOperationsClientGetOptions) (resp azfake.Responder[armmigrate.AssessmentsOperationsClientGetResponse], errResp azfake.ErrorResponder)

	// NewListByGroupPager is the fake for method AssessmentsOperationsClient.NewListByGroupPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByGroupPager func(resourceGroupName string, projectName string, groupName string, options *armmigrate.AssessmentsOperationsClientListByGroupOptions) (resp azfake.PagerResponder[armmigrate.AssessmentsOperationsClientListByGroupResponse])
}
...
// The returned AssessmentsOperationsServerTransport instance is connected to an instance of armmigrate.AssessmentsOperationsClient via the
...
func NewAssessmentsOperationsServerTransport(srv *AssessmentsOperationsServer) *AssessmentsOperationsServerTransport {
	return &AssessmentsOperationsServerTransport{
		srv:                 srv,
		beginCreate:         newTracker[azfake.PollerResponder[armmigrate.AssessmentsOperationsClientCreateResponse]](),
		beginDownloadURL:    newTracker[azfake.PollerResponder[armmigrate.AssessmentsOperationsClientDownloadURLResponse]](),
		newListByGroupPager: newTracker[azfake.PagerResponder[armmigrate.AssessmentsOperationsClientListByGroupResponse]](),
	}
}

// AssessmentsOperationsServerTransport connects instances of armmigrate.AssessmentsOperationsClient to instances of AssessmentsOperationsServer.
...
type AssessmentsOperationsServerTransport struct {
	...
	beginCreate         *tracker[azfake.PollerResponder[armmigrate.AssessmentsOperationsClientCreateResponse]]
	beginDownloadURL    *tracker[azfake.PollerResponder[armmigrate.AssessmentsOperationsClientDownloadURLResponse]]
	newListByGroupPager *tracker[azfake.PagerResponder[armmigrate.AssessmentsOperationsClientListByGroupResponse]]
}
...
func (a *AssessmentsOperationsServerTransport) dispatchNewListByGroupPager(req *http.Request) (*http.Response, error) {
	...
	if newListByGroupPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListByGroupPager, req, func(page *armmigrate.AssessmentsOperationsClientListByGroupResponse, createLink func() string) {
