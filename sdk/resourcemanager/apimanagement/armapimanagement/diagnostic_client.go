...
// serviceName - The name of the API Management service.
// diagnosticID - Diagnostic identifier. Must be unique in the current API Management service instance.
// ifMatch - ETag of the Diagnostic Entity. ETag should match the current entity state from the header response of the GET
...
// Head - Gets the entity state (Etag) version of the Diagnostic specified by its identifier.
// Generated from API version 2022-01-09
// resourceGroupName - The name of the resource group.
// serviceName - The name of the API Management service.
// diagnosticID - Diagnostic identifier. Must be unique in the current API Management service instance.
// options - DiagnosticClientHeadOptions contains the optional parameters for the DiagnosticClient.Head method.
func (client *DiagnosticClient) Head(ctx context.Context, resourceGroupName string, serviceName string, diagnosticID string, options *DiagnosticClientHeadOptions) (DiagnosticClientHeadResponse, error) {
	req, err := client.headCreateRequest(ctx, resourceGroupName, serviceName, diagnosticID, options)
	if err != nil {
		return DiagnosticClientHeadResponse{}, err
	}
	resp, err := client.pl.Do(req)
	if err != nil {
		return DiagnosticClientHeadResponse{}, err
	...
	if !runtime.HasStatusCode(resp, http.StatusOK) {
		return DiagnosticClientHeadResponse{}, runtime.NewResponseError(resp)
	}
	return client.headHandleResponse(resp)
}

// headCreateRequest creates the Head request.
func (client *DiagnosticClient) headCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, diagnosticID string, options *DiagnosticClientHeadOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/diagnostics/{diagnosticId}"
	if resourceGroupName == "" {
		return nil, errors.New("parameter resourceGroupName cannot be empty")
	}
...
func (client *DiagnosticClient) headHandleResponse(resp *http.Response) (DiagnosticClientHeadResponse, error) {
	result := DiagnosticClientHeadResponse{}
	if val := resp.Header.Get("ETag"); val != "" {
		result.ETag = &val
	}
...
func (client *DiagnosticClient) Update(ctx context.Context, resourceGroupName string, serviceName string, diagnosticID string, ifMatch string, parameters DiagnosticContract, options *DiagnosticClientUpdateOptions) (DiagnosticClientUpdateResponse, error) {
	...
	return DiagnosticClientUpdateResponse{}, nil
}
