...
// OutboundNetworkDependenciesEndpoint - A outbound network dependencies endpoint
type OutboundNetworkDependenciesEndpoint struct {
	// The category of endpoint
	Category *string `json:"category,omitempty"`

	// Array of endpoints
	Endpoints []*OutboundNetworkDependenciesEndpointProperties `json:"endpoints,omitempty"`
}

// OutboundNetworkDependenciesEndpointDetail - Outbound network dependencies endpoint detail
type OutboundNetworkDependenciesEndpointDetail struct {
...
// OutboundNetworkDependenciesEndpointListResult - A list of outbound network dependencies endpoints
...
// OutboundNetworkDependenciesEndpointProperties - Outbound network dependencies endpoint properties
type OutboundNetworkDependenciesEndpointProperties struct {
	// The domain name of endpoint
	DomainName *string `json:"domainName,omitempty"`

	// Array of endpoint details
	EndpointDetails []*OutboundNetworkDependenciesEndpointDetail `json:"endpointDetails,omitempty"`
}
