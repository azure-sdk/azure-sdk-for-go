...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/resources/mgmt/2021-07-01/managedapplications"
...
// MarshalJSON is the custom marshaler for ApplicationDefinitionProperties.
func (adp ApplicationDefinitionProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if adp.LockLevel != "" {
		objectMap["lockLevel"] = adp.LockLevel
	}
	if adp.DisplayName != nil {
		objectMap["displayName"] = adp.DisplayName
	}
	if adp.IsEnabled != nil {
		objectMap["isEnabled"] = adp.IsEnabled
	}
	if adp.Authorizations != nil {
		objectMap["authorizations"] = adp.Authorizations
	}
	if adp.Artifacts != nil {
		objectMap["artifacts"] = adp.Artifacts
	}
	if adp.Description != nil {
		objectMap["description"] = adp.Description
	}
	if adp.PackageFileURI != nil {
		objectMap["packageFileUri"] = adp.PackageFileURI
	}
	if adp.StorageAccountID != nil {
		objectMap["storageAccountId"] = adp.StorageAccountID
	}
	if adp.MainTemplate != nil {
		objectMap["mainTemplate"] = adp.MainTemplate
	}
	if adp.CreateUIDefinition != nil {
		objectMap["createUiDefinition"] = adp.CreateUIDefinition
	}
	if adp.NotificationPolicy != nil {
		objectMap["notificationPolicy"] = adp.NotificationPolicy
	}
	if adp.LockingPolicy != nil {
		objectMap["lockingPolicy"] = adp.LockingPolicy
	}
	if adp.DeploymentPolicy != nil {
		objectMap["deploymentPolicy"] = adp.DeploymentPolicy
	}
	if adp.ManagementPolicy != nil {
		objectMap["managementPolicy"] = adp.ManagementPolicy
	}
	if adp.Policies != nil {
		objectMap["policies"] = adp.Policies
	}
	return json.Marshal(objectMap)
}
