...
// FullTextPath - Represents the full text path settings for the full text index.
type FullTextPath struct {
	// REQUIRED; A string containing the language of the full text index.
	Language *string

	// REQUIRED; A string containing the path of the full text index.
	Path *string
}
