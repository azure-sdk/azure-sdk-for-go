...
// AppSpacePatch - AppSpace patch object - Patch is done via a json merge and does not require all parameters for TrackedResource
// (i.e. location) to be present.
type AppSpacePatch struct {
	// AppSpace resource specific properties
	Properties *AppSpaceProperties
...
// AppSpaceProperties - AppSpace resource specific properties
type AppSpaceProperties struct {
...
// AppSpaceResource - App Space Resource.
type AppSpaceResource struct {
	// REQUIRED; The geo-location where the resource lives
	Location *string

	// AppSpaceResource resource-specific properties
	Properties *AppSpaceResourceProperties
...
// AppSpaceResourcePatch - AppSpaceResource patch object - Patch is done via a json merge and does not require all parameters
// for TrackedResource (i.e. location) to be present.
type AppSpaceResourcePatch struct {
	// AppSpaceResource resource-specific properties
	Properties *AppSpaceResourceProperties
...
// AppSpaceResourceProperties - AppSpaceResource resource-specific properties
type AppSpaceResourceProperties struct {
	// Enum marking whether or not this App Space Resource is a favorite (values are Default, Favorite)
	AppSpaceResourceLabel *AppSpaceResourceLabel
...
// AppSpaceResourcesCollection - App Space Resource collection ARM resource.
type AppSpaceResourcesCollection struct {
	// REQUIRED; Collection of resources.
	Value []*AppSpaceResource

	// READ-ONLY; Link to next page of resources.
	NextLink *string
}

// AppSpacesCollection - App Space collection ARM resource.
type AppSpacesCollection struct {
	// REQUIRED; Collection of resources.
	Value []*AppSpace
...
// DeploymentInformation - App Space Resource Deployment Information - used to track the deployment information for an App
// Space Resource's tracked ARM resource
...
// MetadataProperty - Property used by Portal UX that is in the list of metadata properties.
...
// RepositoryInformation - App Space Resource Repository Information - used to track the github repository for an App Space
// Resource's tracked ARM resource
