...
func (i *IntegrationRuntimeCredentialsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if integrationRuntimeCredentialsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = integrationRuntimeCredentialsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to IntegrationRuntimeCredentialsServerTransport
var integrationRuntimeCredentialsServerTransportInterceptor interface {
