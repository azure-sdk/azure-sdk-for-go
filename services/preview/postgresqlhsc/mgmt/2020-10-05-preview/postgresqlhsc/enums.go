...
const (
	...
	// NeedsAttention ...
	NeedsAttention ServerHaState = "NeedsAttention"
	// NotEnabled ...
...
func PossibleServerHaStateValues() []ServerHaState {
	return []ServerHaState{CreatingStandby, FailingOver, Healthy, NeedsAttention, NotEnabled, NotSync, RemovingStandby, ReplicatingData}
}
...
func PossibleServerStateValues() []ServerState {
	return []ServerState{ServerStateDisabled, ServerStateDropping, ServerStateNeedsAttention, ServerStateProvisioning, ServerStateReady, ServerStateStarting, ServerStateStopped, ServerStateStopping, ServerStateUpdating}
}
