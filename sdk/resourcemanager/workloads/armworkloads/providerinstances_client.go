...
// ProviderInstancesClient contains the methods for the Microsoft.Workloads namespace.
...
//   - resource - Request body representing a provider instance associated with a SAP monitor.
...
//     method.
func (client *ProviderInstancesClient) BeginCreate(ctx context.Context, resourceGroupName string, monitorName string, providerInstanceName string, resource ProviderInstance, options *ProviderInstancesClientBeginCreateOptions) (*runtime.Poller[ProviderInstancesClientCreateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.create(ctx, resourceGroupName, monitorName, providerInstanceName, resource, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2023-12-01-preview
func (client *ProviderInstancesClient) create(ctx context.Context, resourceGroupName string, monitorName string, providerInstanceName string, resource ProviderInstance, options *ProviderInstancesClientBeginCreateOptions) (*http.Response, error) {
	var err error
	const operationName = "ProviderInstancesClient.BeginCreate"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.createCreateRequest(ctx, resourceGroupName, monitorName, providerInstanceName, resource, options)
	if err != nil {
		return nil, err
	}
...
func (client *ProviderInstancesClient) createCreateRequest(ctx context.Context, resourceGroupName string, monitorName string, providerInstanceName string, resource ProviderInstance, _ *ProviderInstancesClientBeginCreateOptions) (*policy.Request, error) {
...
func (client *ProviderInstancesClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, monitorName string, providerInstanceName string, _ *ProviderInstancesClientBeginDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Workloads/monitors/{monitorName}/providerInstances/{providerInstanceName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *ProviderInstancesClient) getCreateRequest(ctx context.Context, resourceGroupName string, monitorName string, providerInstanceName string, _ *ProviderInstancesClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Workloads/monitors/{monitorName}/providerInstances/{providerInstanceName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
// NewListByMonitorPager - Gets a list of provider instances in the specified SAP monitor. The operations returns various
// properties of each provider instances.
//
// Generated from API version 2023-12-01-preview
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - monitorName - Name of the SAP monitor resource.
//   - options - ProviderInstancesClientListByMonitorOptions contains the optional parameters for the ProviderInstancesClient.NewListByMonitorPager
//     method.
func (client *ProviderInstancesClient) NewListByMonitorPager(resourceGroupName string, monitorName string, options *ProviderInstancesClientListByMonitorOptions) *runtime.Pager[ProviderInstancesClientListByMonitorResponse] {
	return runtime.NewPager(runtime.PagingHandler[ProviderInstancesClientListByMonitorResponse]{
		More: func(page ProviderInstancesClientListByMonitorResponse) bool {
			return page.NextLink != nil && len(*page.NextLink) > 0
		},
		Fetcher: func(ctx context.Context, page *ProviderInstancesClientListByMonitorResponse) (ProviderInstancesClientListByMonitorResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "ProviderInstancesClient.NewListByMonitorPager")
			nextLink := ""
			if page != nil {
			...
			if err != nil {
				return ProviderInstancesClientListByMonitorResponse{}, err
			}
...
func (client *ProviderInstancesClient) listByMonitorCreateRequest(ctx context.Context, resourceGroupName string, monitorName string, _ *ProviderInstancesClientListByMonitorOptions) (*policy.Request, error) {
...
func (client *ProviderInstancesClient) listByMonitorHandleResponse(resp *http.Response) (ProviderInstancesClientListByMonitorResponse, error) {
	result := ProviderInstancesClientListByMonitorResponse{}
