...
func (client *WorkloadDeploymentClient) createCreateRequest(ctx context.Context, subscriptionID string, resourceGroupName string, modernizeProjectName string, workloadDeploymentName string, body WorkloadDeploymentModel, _ *WorkloadDeploymentClientCreateOptions) (*policy.Request, error) {
...
func (client *WorkloadDeploymentClient) getCreateRequest(ctx context.Context, subscriptionID string, resourceGroupName string, modernizeProjectName string, workloadDeploymentName string, _ *WorkloadDeploymentClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Migrate/modernizeProjects/{modernizeProjectName}/workloadDeployments/{workloadDeploymentName}"
	if subscriptionID == "" {
		return nil, errors.New("parameter subscriptionID cannot be empty")
	}
...
func (client *WorkloadDeploymentClient) getSecretConfigurationsCreateRequest(ctx context.Context, subscriptionID string, resourceGroupName string, modernizeProjectName string, workloadDeploymentName string, _ *WorkloadDeploymentClientGetSecretConfigurationsOptions) (*policy.Request, error) {
...
func (client *WorkloadDeploymentClient) listCreateRequest(ctx context.Context, subscriptionID string, resourceGroupName string, modernizeProjectName string, _ *WorkloadDeploymentClientListOptions) (*policy.Request, error) {
...
func (client *WorkloadDeploymentClient) migrateCreateRequest(ctx context.Context, subscriptionID string, resourceGroupName string, modernizeProjectName string, workloadDeploymentName string, _ *WorkloadDeploymentClientBeginMigrateOptions) (*policy.Request, error) {
...
func (client *WorkloadDeploymentClient) testMigrateCleanupCreateRequest(ctx context.Context, subscriptionID string, resourceGroupName string, modernizeProjectName string, workloadDeploymentName string, _ *WorkloadDeploymentClientBeginTestMigrateCleanupOptions) (*policy.Request, error) {
