...
// SAPApplicationServerInstancesServer is a fake server for instances of the armsapvirtualinstance.SAPApplicationServerInstancesClient type.
type SAPApplicationServerInstancesServer struct {
	...
	BeginCreate func(ctx context.Context, resourceGroupName string, sapVirtualInstanceName string, applicationInstanceName string, body armsapvirtualinstance.SAPApplicationServerInstance, options *armsapvirtualinstance.SAPApplicationServerInstancesClientBeginCreateOptions) (resp azfake.PollerResponder[armsapvirtualinstance.SAPApplicationServerInstancesClientCreateResponse], errResp azfake.ErrorResponder)

	// BeginDelete is the fake for method SAPApplicationServerInstancesClient.BeginDelete
	// HTTP status codes to indicate success: http.StatusAccepted, http.StatusNoContent
	BeginDelete func(ctx context.Context, resourceGroupName string, sapVirtualInstanceName string, applicationInstanceName string, options *armsapvirtualinstance.SAPApplicationServerInstancesClientBeginDeleteOptions) (resp azfake.PollerResponder[armsapvirtualinstance.SAPApplicationServerInstancesClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method SAPApplicationServerInstancesClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, sapVirtualInstanceName string, applicationInstanceName string, options *armsapvirtualinstance.SAPApplicationServerInstancesClientGetOptions) (resp azfake.Responder[armsapvirtualinstance.SAPApplicationServerInstancesClientGetResponse], errResp azfake.ErrorResponder)

	// NewListPager is the fake for method SAPApplicationServerInstancesClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(resourceGroupName string, sapVirtualInstanceName string, options *armsapvirtualinstance.SAPApplicationServerInstancesClientListOptions) (resp azfake.PagerResponder[armsapvirtualinstance.SAPApplicationServerInstancesClientListResponse])

	// BeginStartInstance is the fake for method SAPApplicationServerInstancesClient.BeginStartInstance
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginStartInstance func(ctx context.Context, resourceGroupName string, sapVirtualInstanceName string, applicationInstanceName string, options *armsapvirtualinstance.SAPApplicationServerInstancesClientBeginStartInstanceOptions) (resp azfake.PollerResponder[armsapvirtualinstance.SAPApplicationServerInstancesClientStartInstanceResponse], errResp azfake.ErrorResponder)

	// BeginStopInstance is the fake for method SAPApplicationServerInstancesClient.BeginStopInstance
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginStopInstance func(ctx context.Context, resourceGroupName string, sapVirtualInstanceName string, applicationInstanceName string, options *armsapvirtualinstance.SAPApplicationServerInstancesClientBeginStopInstanceOptions) (resp azfake.PollerResponder[armsapvirtualinstance.SAPApplicationServerInstancesClientStopInstanceResponse], errResp azfake.ErrorResponder)

	// Update is the fake for method SAPApplicationServerInstancesClient.Update
	// HTTP status codes to indicate success: http.StatusOK
	Update func(ctx context.Context, resourceGroupName string, sapVirtualInstanceName string, applicationInstanceName string, body armsapvirtualinstance.UpdateSAPApplicationInstanceRequest, options *armsapvirtualinstance.SAPApplicationServerInstancesClientUpdateOptions) (resp azfake.Responder[armsapvirtualinstance.SAPApplicationServerInstancesClientUpdateResponse], errResp azfake.ErrorResponder)
}
...
// The returned SAPApplicationServerInstancesServerTransport instance is connected to an instance of armsapvirtualinstance.SAPApplicationServerInstancesClient via the
...
func NewSAPApplicationServerInstancesServerTransport(srv *SAPApplicationServerInstancesServer) *SAPApplicationServerInstancesServerTransport {
	return &SAPApplicationServerInstancesServerTransport{
		srv:                srv,
		beginCreate:        newTracker[azfake.PollerResponder[armsapvirtualinstance.SAPApplicationServerInstancesClientCreateResponse]](),
		beginDelete:        newTracker[azfake.PollerResponder[armsapvirtualinstance.SAPApplicationServerInstancesClientDeleteResponse]](),
		newListPager:       newTracker[azfake.PagerResponder[armsapvirtualinstance.SAPApplicationServerInstancesClientListResponse]](),
		beginStartInstance: newTracker[azfake.PollerResponder[armsapvirtualinstance.SAPApplicationServerInstancesClientStartInstanceResponse]](),
		beginStopInstance:  newTracker[azfake.PollerResponder[armsapvirtualinstance.SAPApplicationServerInstancesClientStopInstanceResponse]](),
	}
}

// SAPApplicationServerInstancesServerTransport connects instances of armsapvirtualinstance.SAPApplicationServerInstancesClient to instances of SAPApplicationServerInstancesServer.
...
type SAPApplicationServerInstancesServerTransport struct {
	...
	beginCreate        *tracker[azfake.PollerResponder[armsapvirtualinstance.SAPApplicationServerInstancesClientCreateResponse]]
	beginDelete        *tracker[azfake.PollerResponder[armsapvirtualinstance.SAPApplicationServerInstancesClientDeleteResponse]]
	newListPager       *tracker[azfake.PagerResponder[armsapvirtualinstance.SAPApplicationServerInstancesClientListResponse]]
	beginStartInstance *tracker[azfake.PollerResponder[armsapvirtualinstance.SAPApplicationServerInstancesClientStartInstanceResponse]]
	beginStopInstance  *tracker[azfake.PollerResponder[armsapvirtualinstance.SAPApplicationServerInstancesClientStopInstanceResponse]]
}
...
func (s *SAPApplicationServerInstancesServerTransport) dispatchBeginCreate(req *http.Request) (*http.Response, error) {
	...
	if beginCreate == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armsapvirtualinstance.SAPApplicationServerInstance](req)
		if err != nil {
			return nil, err
		}
...
func (s *SAPApplicationServerInstancesServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armsapvirtualinstance.SAPApplicationServerInstancesClientListResponse, createLink func() string) {
...
func (s *SAPApplicationServerInstancesServerTransport) dispatchBeginStartInstance(req *http.Request) (*http.Response, error) {
	...
	if beginStartInstance == nil {
		...
		var options *armsapvirtualinstance.SAPApplicationServerInstancesClientBeginStartInstanceOptions
		if !reflect.ValueOf(body).IsZero() {
			options = &armsapvirtualinstance.SAPApplicationServerInstancesClientBeginStartInstanceOptions{
				Body: &body,
			}
		}
...
func (s *SAPApplicationServerInstancesServerTransport) dispatchBeginStopInstance(req *http.Request) (*http.Response, error) {
	...
	if beginStopInstance == nil {
		...
		var options *armsapvirtualinstance.SAPApplicationServerInstancesClientBeginStopInstanceOptions
		if !reflect.ValueOf(body).IsZero() {
			options = &armsapvirtualinstance.SAPApplicationServerInstancesClientBeginStopInstanceOptions{
				Body: &body,
			}
		}
...
func (s *SAPApplicationServerInstancesServerTransport) dispatchUpdate(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[armsapvirtualinstance.UpdateSAPApplicationInstanceRequest](req)
	if err != nil {
		return nil, err
	}
	resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
