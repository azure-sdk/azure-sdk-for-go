...
type MigrationsServer struct {
	...
	Create func(ctx context.Context, subscriptionID string, resourceGroupName string, targetDbServerName string, migrationName string, parameters armpostgresql.MigrationResource, options *armpostgresql.MigrationsClientCreateOptions) (resp azfake.Responder[armpostgresql.MigrationsClientCreateResponse], errResp azfake.ErrorResponder)

	// Delete is the fake for method MigrationsClient.Delete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	Delete func(ctx context.Context, subscriptionID string, resourceGroupName string, targetDbServerName string, migrationName string, options *armpostgresql.MigrationsClientDeleteOptions) (resp azfake.Responder[armpostgresql.MigrationsClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method MigrationsClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, subscriptionID string, resourceGroupName string, targetDbServerName string, migrationName string, options *armpostgresql.MigrationsClientGetOptions) (resp azfake.Responder[armpostgresql.MigrationsClientGetResponse], errResp azfake.ErrorResponder)

	// NewListByTargetServerPager is the fake for method MigrationsClient.NewListByTargetServerPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByTargetServerPager func(subscriptionID string, resourceGroupName string, targetDbServerName string, options *armpostgresql.MigrationsClientListByTargetServerOptions) (resp azfake.PagerResponder[armpostgresql.MigrationsClientListByTargetServerResponse])

	// Update is the fake for method MigrationsClient.Update
	// HTTP status codes to indicate success: http.StatusOK
	Update func(ctx context.Context, subscriptionID string, resourceGroupName string, targetDbServerName string, migrationName string, parameters armpostgresql.MigrationResourceForPatch, options *armpostgresql.MigrationsClientUpdateOptions) (resp azfake.Responder[armpostgresql.MigrationsClientUpdateResponse], errResp azfake.ErrorResponder)
}
...
func (m *MigrationsServerTransport) dispatchCreate(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[armpostgresql.MigrationResource](req)
	if err != nil {
		return nil, err
	}
