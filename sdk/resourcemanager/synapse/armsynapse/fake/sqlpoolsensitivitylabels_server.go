...
func (s *SQLPoolSensitivityLabelsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if sqlPoolSensitivityLabelsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = sqlPoolSensitivityLabelsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "SQLPoolSensitivityLabelsClient.NewListCurrentPager":
				res.resp, res.err = s.dispatchNewListCurrentPager(req)
			case "SQLPoolSensitivityLabelsClient.NewListRecommendedPager":
				res.resp, res.err = s.dispatchNewListRecommendedPager(req)
...
// set this to conditionally intercept incoming requests to SQLPoolSensitivityLabelsServerTransport
var sqlPoolSensitivityLabelsServerTransportInterceptor interface {
