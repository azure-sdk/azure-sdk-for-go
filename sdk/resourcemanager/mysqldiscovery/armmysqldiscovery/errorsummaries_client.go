...
func (client *ErrorSummariesClient) getCreateRequest(ctx context.Context, resourceGroupName string, siteName string, errorSummaryName string, _ *ErrorSummariesClientGetOptions) (*policy.Request, error) {
...
func (client *ErrorSummariesClient) listBySiteCreateRequest(ctx context.Context, resourceGroupName string, siteName string, _ *ErrorSummariesClientListBySiteOptions) (*policy.Request, error) {
