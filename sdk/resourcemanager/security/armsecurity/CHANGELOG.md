...
- New value `CloudNameDockerHub` added to enum type `CloudName`
- New value `EnvironmentTypeDockerHubOrganization` added to enum type `EnvironmentType`
- New value `OfferingTypeCspmMonitorDockerHub`, `OfferingTypeDefenderCspmDockerHub`, `OfferingTypeDefenderForContainersDockerHub` added to enum type `OfferingType`
