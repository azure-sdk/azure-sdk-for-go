...
func (q *QueuesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if queuesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = queuesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "QueuesClient.CreateOrUpdateAuthorizationRule":
				res.resp, res.err = q.dispatchCreateOrUpdateAuthorizationRule(req)
			case "QueuesClient.Delete":
				res.resp, res.err = q.dispatchDelete(req)
			case "QueuesClient.DeleteAuthorizationRule":
				res.resp, res.err = q.dispatchDeleteAuthorizationRule(req)
			case "QueuesClient.Get":
				res.resp, res.err = q.dispatchGet(req)
			case "QueuesClient.GetAuthorizationRule":
				res.resp, res.err = q.dispatchGetAuthorizationRule(req)
			case "QueuesClient.NewListAuthorizationRulesPager":
				res.resp, res.err = q.dispatchNewListAuthorizationRulesPager(req)
			case "QueuesClient.NewListByNamespacePager":
				res.resp, res.err = q.dispatchNewListByNamespacePager(req)
			case "QueuesClient.ListKeys":
				res.resp, res.err = q.dispatchListKeys(req)
			case "QueuesClient.RegenerateKeys":
				res.resp, res.err = q.dispatchRegenerateKeys(req)
			default:
...
// set this to conditionally intercept incoming requests to QueuesServerTransport
var queuesServerTransportInterceptor interface {
