...
func (p *ProviderActionsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if providerActionsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = providerActionsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "ProviderActionsClient.GetCollectionCount":
				res.resp, res.err = p.dispatchGetCollectionCount(req)
			case "ProviderActionsClient.GetOverviewStatus":
				res.resp, res.err = p.dispatchGetOverviewStatus(req)
			case "ProviderActionsClient.ListInUseStorageAccounts":
				res.resp, res.err = p.dispatchListInUseStorageAccounts(req)
			case "ProviderActionsClient.BeginOnboard":
				res.resp, res.err = p.dispatchBeginOnboard(req)
			case "ProviderActionsClient.BeginTriggerEvaluation":
				res.resp, res.err = p.dispatchBeginTriggerEvaluation(req)
			default:
...
// set this to conditionally intercept incoming requests to ProviderActionsServerTransport
var providerActionsServerTransportInterceptor interface {
