...
type JobDefinitionProperties struct {
	...
	JobDefinitionSchemaVersion *string `json:"jobDefinitionSchemaVersion,omitempty"`

	// State of the job definition.
	JobDefinitionState *JobDefinitionState `json:"jobDefinitionState,omitempty"`
...
// JobDefinitionsClientCancelOptions contains the optional parameters for the JobDefinitionsClient.Cancel method.
type JobDefinitionsClientCancelOptions struct {
	// placeholder for future optional parameters
}
...
// JobDefinitionsClientRetryJobOptions contains the optional parameters for the JobDefinitionsClient.RetryJob method.
type JobDefinitionsClientRetryJobOptions struct {
	// placeholder for future optional parameters
}

// JobDefinitionsClientSkipJobOptions contains the optional parameters for the JobDefinitionsClient.SkipJob method.
type JobDefinitionsClientSkipJobOptions struct {
	// placeholder for future optional parameters
}
...
type JobProperties struct {
	...
	CleanupComputeEndTime *time.Time `json:"cleanupComputeEndTime,omitempty"`

	// Time cleaning up compute started
	CleanupComputeStartTime *time.Time `json:"cleanupComputeStartTime,omitempty"`

	// Time configuring compute for copy stage ended
	CopyConfigureComputeEndTime *time.Time `json:"copyConfigureComputeEndTime,omitempty"`

	// Time configuring compute for copy stage started
	CopyConfigureComputeStartTime *time.Time `json:"copyConfigureComputeStartTime,omitempty"`

	// Time copying files ended
	CopyEndTime *time.Time `json:"copyEndTime,omitempty"`

	// Number of copy errors
	CopyErrors *int64 `json:"copyErrors,omitempty"`

	// Time copying files started
	CopyStartTime *time.Time `json:"copyStartTime,omitempty"`
	...
	DirectoryParserEndTime *time.Time `json:"directoryParserEndTime,omitempty"`

	// Time enumerating source directory started
	DirectoryParserStartTime *time.Time `json:"directoryParserStartTime,omitempty"`

	// Time configuring compute for estimation stage ended
	EstimationConfigureComputeEndTime *time.Time `json:"estimationConfigureComputeEndTime,omitempty"`

	// Time configuring compute for estimation stage started
	EstimationConfigureComputeStartTime *time.Time `json:"estimationConfigureComputeStartTime,omitempty"`

	// Time estimating files ended
	EstimationEndTime *time.Time `json:"estimationEndTime,omitempty"`

	// Time estimating files started
	EstimationStartTime *time.Time `json:"estimationStartTime,omitempty"`

	// Of the items copied by the job as of now, how many are files
	FilesCopiedCounter *int64 `json:"filesCopiedCounter,omitempty"`

	// Of the items deleted by the job as of now, how many are files
	FilesDeletedCounter *int64 `json:"filesDeletedCounter,omitempty"`
	...
	PostCopyEndTime *time.Time `json:"postCopyEndTime,omitempty"`

	// Time copying logs and creating share snapshot started
	PostCopyStartTime *time.Time `json:"postCopyStartTime,omitempty"`

	// Time deleting excess files ended
	PostEstimationEndTime *time.Time `json:"postEstimationEndTime,omitempty"`

	// Time deleting excess files started
	PostEstimationStartTime *time.Time `json:"postEstimationStartTime,omitempty"`

	// Time enumerating target directory ended
	PurgeDetectionEndTime *time.Time `json:"purgeDetectionEndTime,omitempty"`

	// Time enumerating target directory started
	PurgeDetectionStartTime *time.Time `json:"purgeDetectionStartTime,omitempty"`
	...
	TotalItemsToDelete *int64 `json:"totalItemsToDelete,omitempty"`
	...
	UnsupportedFiles *int64 `json:"unsupportedFiles,omitempty"`
}
