...
type WebAppSitesControllerServer struct {
	...
	// Delete is the fake for method WebAppSitesControllerClient.Delete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	Delete func(ctx context.Context, resourceGroupName string, siteName string, webAppSiteName string, options *armmigrate.WebAppSitesControllerClientDeleteOptions) (resp azfake.Responder[armmigrate.WebAppSitesControllerClientDeleteResponse], errResp azfake.ErrorResponder)
...
func (w *WebAppSitesControllerServerTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "WebAppSitesControllerClient.Delete":
...
func (w *WebAppSitesControllerServerTransport) dispatchDelete(req *http.Request) (*http.Response, error) {
	if w.srv.Delete == nil {
	...
	respr, errRespr := w.srv.Delete(req.Context(), resourceGroupNameParam, siteNameParam, webAppSiteNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
