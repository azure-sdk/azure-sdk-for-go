...
// SystemAssignedManagedIdentityProperties - System assigned managed identity properties retrieved from ARM request headers.
type SystemAssignedManagedIdentityProperties struct {
	// Principal Id of system-assigned managed identity.
	PrincipalID *string
