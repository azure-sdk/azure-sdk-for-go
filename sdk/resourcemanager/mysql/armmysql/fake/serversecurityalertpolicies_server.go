...
type ServerSecurityAlertPoliciesServer struct {
	...
	BeginCreateOrUpdate func(ctx context.Context, resourceGroupName string, serverName string, securityAlertPolicyName armmysql.SecurityAlertPolicyName, parameters armmysql.ServerSecurityAlertPolicy, options *armmysql.ServerSecurityAlertPoliciesClientBeginCreateOrUpdateOptions) (resp azfake.PollerResponder[armmysql.ServerSecurityAlertPoliciesClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method ServerSecurityAlertPoliciesClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, serverName string, securityAlertPolicyName armmysql.SecurityAlertPolicyName, options *armmysql.ServerSecurityAlertPoliciesClientGetOptions) (resp azfake.Responder[armmysql.ServerSecurityAlertPoliciesClientGetResponse], errResp azfake.ErrorResponder)

	// NewListByServerPager is the fake for method ServerSecurityAlertPoliciesClient.NewListByServerPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByServerPager func(resourceGroupName string, serverName string, options *armmysql.ServerSecurityAlertPoliciesClientListByServerOptions) (resp azfake.PagerResponder[armmysql.ServerSecurityAlertPoliciesClientListByServerResponse])
}
...
// The returned ServerSecurityAlertPoliciesServerTransport instance is connected to an instance of armmysql.ServerSecurityAlertPoliciesClient via the
...
func NewServerSecurityAlertPoliciesServerTransport(srv *ServerSecurityAlertPoliciesServer) *ServerSecurityAlertPoliciesServerTransport {
	return &ServerSecurityAlertPoliciesServerTransport{
		srv:                  srv,
		beginCreateOrUpdate:  newTracker[azfake.PollerResponder[armmysql.ServerSecurityAlertPoliciesClientCreateOrUpdateResponse]](),
		newListByServerPager: newTracker[azfake.PagerResponder[armmysql.ServerSecurityAlertPoliciesClientListByServerResponse]](),
	}
}

// ServerSecurityAlertPoliciesServerTransport connects instances of armmysql.ServerSecurityAlertPoliciesClient to instances of ServerSecurityAlertPoliciesServer.
...
type ServerSecurityAlertPoliciesServerTransport struct {
	...
	beginCreateOrUpdate  *tracker[azfake.PollerResponder[armmysql.ServerSecurityAlertPoliciesClientCreateOrUpdateResponse]]
	newListByServerPager *tracker[azfake.PagerResponder[armmysql.ServerSecurityAlertPoliciesClientListByServerResponse]]
}
...
func (s *ServerSecurityAlertPoliciesServerTransport) dispatchBeginCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginCreateOrUpdate == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.DBforMySQL/servers/(?P<serverName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/securityAlertPolicies/(?P<securityAlertPolicyName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if matches == nil || len(matches) < 4 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
		}
		body, err := server.UnmarshalRequestAsJSON[armmysql.ServerSecurityAlertPolicy](req)
		if err != nil {
			return nil, err
		}
		...
		securityAlertPolicyNameParam, err := parseWithCast(matches[regex.SubexpIndex("securityAlertPolicyName")], func(v string) (armmysql.SecurityAlertPolicyName, error) {
			p, unescapeErr := url.PathUnescape(v)
			if unescapeErr != nil {
				return "", unescapeErr
			}
			return armmysql.SecurityAlertPolicyName(p), nil
		})
		if err != nil {
			return nil, err
		}
...
func (s *ServerSecurityAlertPoliciesServerTransport) dispatchNewListByServerPager(req *http.Request) (*http.Response, error) {
	...
	if newListByServerPager == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.DBforMySQL/servers/(?P<serverName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/securityAlertPolicies`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		...
		server.PagerResponderInjectNextLinks(newListByServerPager, req, func(page *armmysql.ServerSecurityAlertPoliciesClientListByServerResponse, createLink func() string) {
