...
// The returned VirtualMachineInstancesServerTransport instance is connected to an instance of armazurestackhci.VirtualMachineInstancesClient via the
...
func NewVirtualMachineInstancesServerTransport(srv *VirtualMachineInstancesServer) *VirtualMachineInstancesServerTransport {
	return &VirtualMachineInstancesServerTransport{
		srv:                 srv,
		beginCreateOrUpdate: newTracker[azfake.PollerResponder[armazurestackhci.VirtualMachineInstancesClientCreateOrUpdateResponse]](),
		beginDelete:         newTracker[azfake.PollerResponder[armazurestackhci.VirtualMachineInstancesClientDeleteResponse]](),
		newListPager:        newTracker[azfake.PagerResponder[armazurestackhci.VirtualMachineInstancesClientListResponse]](),
		beginRestart:        newTracker[azfake.PollerResponder[armazurestackhci.VirtualMachineInstancesClientRestartResponse]](),
		beginStart:          newTracker[azfake.PollerResponder[armazurestackhci.VirtualMachineInstancesClientStartResponse]](),
		beginStop:           newTracker[azfake.PollerResponder[armazurestackhci.VirtualMachineInstancesClientStopResponse]](),
		beginUpdate:         newTracker[azfake.PollerResponder[armazurestackhci.VirtualMachineInstancesClientUpdateResponse]](),
	}
}

// VirtualMachineInstancesServerTransport connects instances of armazurestackhci.VirtualMachineInstancesClient to instances of VirtualMachineInstancesServer.
...
type VirtualMachineInstancesServerTransport struct {
	...
	beginCreateOrUpdate *tracker[azfake.PollerResponder[armazurestackhci.VirtualMachineInstancesClientCreateOrUpdateResponse]]
	beginDelete         *tracker[azfake.PollerResponder[armazurestackhci.VirtualMachineInstancesClientDeleteResponse]]
	newListPager        *tracker[azfake.PagerResponder[armazurestackhci.VirtualMachineInstancesClientListResponse]]
	beginRestart        *tracker[azfake.PollerResponder[armazurestackhci.VirtualMachineInstancesClientRestartResponse]]
	beginStart          *tracker[azfake.PollerResponder[armazurestackhci.VirtualMachineInstancesClientStartResponse]]
	beginStop           *tracker[azfake.PollerResponder[armazurestackhci.VirtualMachineInstancesClientStopResponse]]
	beginUpdate         *tracker[azfake.PollerResponder[armazurestackhci.VirtualMachineInstancesClientUpdateResponse]]
}
...
func (v *VirtualMachineInstancesServerTransport) dispatchBeginCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginCreateOrUpdate == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armazurestackhci.VirtualMachineInstance](req)
		if err != nil {
			return nil, err
		}
...
func (v *VirtualMachineInstancesServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armazurestackhci.VirtualMachineInstancesClientListResponse, createLink func() string) {
...
func (v *VirtualMachineInstancesServerTransport) dispatchBeginUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginUpdate == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armazurestackhci.VirtualMachineInstanceUpdateRequest](req)
		if err != nil {
			return nil, err
		}
		resourceURIParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceUri")])
