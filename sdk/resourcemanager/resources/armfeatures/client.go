...
func (client *Client) getCreateRequest(ctx context.Context, resourceProviderNamespace string, featureName string, _ *ClientGetOptions) (*policy.Request, error) {
...
func (client *Client) listCreateRequest(ctx context.Context, resourceProviderNamespace string, _ *ClientListOptions) (*policy.Request, error) {
...
func (client *Client) listAllCreateRequest(ctx context.Context, _ *ClientListAllOptions) (*policy.Request, error) {
...
func (client *Client) registerCreateRequest(ctx context.Context, resourceProviderNamespace string, featureName string, _ *ClientRegisterOptions) (*policy.Request, error) {
...
func (client *Client) unregisterCreateRequest(ctx context.Context, resourceProviderNamespace string, featureName string, _ *ClientUnregisterOptions) (*policy.Request, error) {
