...
// AggregateErrors - Indicates if validation results will be aggregated
type AggregateErrors string

const (
	AggregateErrorsFalse AggregateErrors = "False"
	AggregateErrorsTrue  AggregateErrors = "True"
)

// PossibleAggregateErrorsValues returns the possible values for the AggregateErrors const type.
func PossibleAggregateErrorsValues() []AggregateErrors {
	return []AggregateErrors{
		AggregateErrorsFalse,
		AggregateErrorsTrue,
	}
}
...
// MedtechMappingValidationCategory - Indicates the type of validation being performed
type MedtechMappingValidationCategory string

const (
	MedtechMappingValidationCategoryFHIRTRANSFORMATION MedtechMappingValidationCategory = "FHIRTRANSFORMATION"
	MedtechMappingValidationCategoryNORMALIZATION      MedtechMappingValidationCategory = "NORMALIZATION"
)

// PossibleMedtechMappingValidationCategoryValues returns the possible values for the MedtechMappingValidationCategory const type.
func PossibleMedtechMappingValidationCategoryValues() []MedtechMappingValidationCategory {
	return []MedtechMappingValidationCategory{
		MedtechMappingValidationCategoryFHIRTRANSFORMATION,
		MedtechMappingValidationCategoryNORMALIZATION,
	}
}

// MedtechMappingValidationErrorLevel - Indicates the severity of the validation error
type MedtechMappingValidationErrorLevel string

const (
	MedtechMappingValidationErrorLevelERROR MedtechMappingValidationErrorLevel = "ERROR"
	MedtechMappingValidationErrorLevelWARN  MedtechMappingValidationErrorLevel = "WARN"
)

// PossibleMedtechMappingValidationErrorLevelValues returns the possible values for the MedtechMappingValidationErrorLevel const type.
func PossibleMedtechMappingValidationErrorLevelValues() []MedtechMappingValidationErrorLevel {
	return []MedtechMappingValidationErrorLevel{
		MedtechMappingValidationErrorLevelERROR,
		MedtechMappingValidationErrorLevelWARN,
	}
}
