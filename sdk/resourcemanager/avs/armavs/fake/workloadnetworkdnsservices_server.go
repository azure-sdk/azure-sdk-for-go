...
type WorkloadNetworkDNSServicesServer struct {
	...
	// HTTP status codes to indicate success: http.StatusOK
	NewListByWorkloadNetworkPager func(resourceGroupName string, privateCloudName string, options *armavs.WorkloadNetworkDNSServicesClientListByWorkloadNetworkOptions) (resp azfake.PagerResponder[armavs.WorkloadNetworkDNSServicesClientListByWorkloadNetworkResponse])
