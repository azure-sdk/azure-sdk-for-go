...
func (a AlertProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "alertRuleProperties", a.AlertRuleProperties)
	populate(objectMap, "alertRuleResourceId", a.AlertRuleResourceID)
	populate(objectMap, "errors", a.Errors)
	populate(objectMap, "providerNames", a.ProviderNames)
...
func (a *AlertProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		var err error
		switch key {
		case "alertRuleProperties":
			err = unpopulate(val, "AlertRuleProperties", &a.AlertRuleProperties)
			delete(rawMsg, key)
		...
		case "errors":
			...
			delete(rawMsg, key)
		case "providerNames":
			err = unpopulate(val, "ProviderNames", &a.ProviderNames)
			delete(rawMsg, key)
		case "providerType":
...
// MarshalJSON implements the json.Marshaller interface for type AlertQueryParameter.
func (a AlertQueryParameter) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "name", a.Name)
	populate(objectMap, "value", a.Value)
	return json.Marshal(objectMap)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type AlertQueryParameter.
func (a *AlertQueryParameter) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", a, err)
	}
...
func (a AlertRuleProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "alertQueryParameters", a.AlertQueryParameters)
	populate(objectMap, "autoMitigate", a.AutoMitigate)
	populate(objectMap, "dimension", a.Dimension)
	populate(objectMap, "evaluationFrequency", a.EvaluationFrequency)
	populate(objectMap, "failingPeriodsOperator", a.FailingPeriodsOperator)
	populate(objectMap, "failingPeriodsToAlert", a.FailingPeriodsToAlert)
	populate(objectMap, "muteActionsDuration", a.MuteActionsDuration)
	populate(objectMap, "severity", a.Severity)
	populate(objectMap, "status", a.Status)
	populate(objectMap, "threshold", a.Threshold)
	populate(objectMap, "thresholdOperator", a.ThresholdOperator)
	populate(objectMap, "windowSize", a.WindowSize)
	return json.Marshal(objectMap)
}
...
func (a *AlertRuleProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "actionGroups":
			...
			delete(rawMsg, key)
		case "alertQueryParameters":
			err = unpopulate(val, "AlertQueryParameters", &a.AlertQueryParameters)
			delete(rawMsg, key)
		case "autoMitigate":
			err = unpopulate(val, "AutoMitigate", &a.AutoMitigate)
			delete(rawMsg, key)
		case "dimension":
			err = unpopulate(val, "Dimension", &a.Dimension)
			delete(rawMsg, key)
		case "evaluationFrequency":
			err = unpopulate(val, "EvaluationFrequency", &a.EvaluationFrequency)
			delete(rawMsg, key)
		case "failingPeriodsOperator":
			err = unpopulate(val, "FailingPeriodsOperator", &a.FailingPeriodsOperator)
			delete(rawMsg, key)
		case "failingPeriodsToAlert":
			err = unpopulate(val, "FailingPeriodsToAlert", &a.FailingPeriodsToAlert)
			delete(rawMsg, key)
		case "muteActionsDuration":
			err = unpopulate(val, "MuteActionsDuration", &a.MuteActionsDuration)
			delete(rawMsg, key)
		case "severity":
		...
		case "thresholdOperator":
			err = unpopulate(val, "ThresholdOperator", &a.ThresholdOperator)
			delete(rawMsg, key)
		case "windowSize":
			err = unpopulate(val, "WindowSize", &a.WindowSize)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", a, err)
...
// MarshalJSON implements the json.Marshaller interface for type AlertTemplate.
func (a AlertTemplate) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "id", a.ID)
	populate(objectMap, "name", a.Name)
	populate(objectMap, "properties", a.Properties)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type AlertTemplate.
func (a *AlertTemplate) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", a, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type AlertTemplateListResult.
func (a AlertTemplateListResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "nextLink", a.NextLink)
	populate(objectMap, "value", a.Value)
	return json.Marshal(objectMap)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type AlertTemplateListResult.
func (a *AlertTemplateListResult) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", a, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type AlertTemplateMetricMeasurement.
func (a AlertTemplateMetricMeasurement) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "frequencyInMinutes", a.FrequencyInMinutes)
	populate(objectMap, "metricColumn", a.MetricColumn)
	populate(objectMap, "metricTriggerType", a.MetricTriggerType)
	populate(objectMap, "threshold", a.Threshold)
	populate(objectMap, "thresholdOperator", a.ThresholdOperator)
	populate(objectMap, "timeWindowInMinutes", a.TimeWindowInMinutes)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type AlertTemplateMetricMeasurement.
func (a *AlertTemplateMetricMeasurement) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", a, err)
	}
	for key, val := range rawMsg {
		var err error
		switch key {
		case "frequencyInMinutes":
			err = unpopulate(val, "FrequencyInMinutes", &a.FrequencyInMinutes)
			delete(rawMsg, key)
		case "metricColumn":
			err = unpopulate(val, "MetricColumn", &a.MetricColumn)
			delete(rawMsg, key)
		case "metricTriggerType":
			err = unpopulate(val, "MetricTriggerType", &a.MetricTriggerType)
			delete(rawMsg, key)
		case "threshold":
			err = unpopulate(val, "Threshold", &a.Threshold)
			delete(rawMsg, key)
		case "thresholdOperator":
			err = unpopulate(val, "ThresholdOperator", &a.ThresholdOperator)
			delete(rawMsg, key)
		case "timeWindowInMinutes":
			err = unpopulate(val, "TimeWindowInMinutes", &a.TimeWindowInMinutes)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", a, err)
...
// MarshalJSON implements the json.Marshaller interface for type AlertTemplateProperties.
func (a AlertTemplateProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "alertUnit", a.AlertUnit)
	populate(objectMap, "defaultThreshold", a.DefaultThreshold)
	populate(objectMap, "defaultThresholdInputOption", a.DefaultThresholdInputOption)
	populate(objectMap, "description", a.Description)
	populate(objectMap, "errors", a.Errors)
	populate(objectMap, "lowerBound", a.LowerBound)
	populate(objectMap, "metricMeasurement", a.MetricMeasurement)
	populate(objectMap, "providerType", a.ProviderType)
	populate(objectMap, "provisioningState", a.ProvisioningState)
	populate(objectMap, "query", a.Query)
	populate(objectMap, "queryInputParameters", a.QueryInputParameters)
	populate(objectMap, "severity", a.Severity)
	populate(objectMap, "templateDisplayName", a.TemplateDisplayName)
	populate(objectMap, "thresholdOperator", a.ThresholdOperator)
	populate(objectMap, "upperBound", a.UpperBound)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type AlertTemplateProperties.
func (a *AlertTemplateProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", a, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "alertUnit":
			err = unpopulate(val, "AlertUnit", &a.AlertUnit)
			delete(rawMsg, key)
		case "defaultThreshold":
			err = unpopulate(val, "DefaultThreshold", &a.DefaultThreshold)
			delete(rawMsg, key)
		case "defaultThresholdInputOption":
			err = unpopulate(val, "DefaultThresholdInputOption", &a.DefaultThresholdInputOption)
			delete(rawMsg, key)
		case "description":
		...
		case "errors":
			...
			delete(rawMsg, key)
		case "lowerBound":
			err = unpopulate(val, "LowerBound", &a.LowerBound)
			delete(rawMsg, key)
		case "metricMeasurement":
			err = unpopulate(val, "MetricMeasurement", &a.MetricMeasurement)
			delete(rawMsg, key)
		case "providerType":
			err = unpopulate(val, "ProviderType", &a.ProviderType)
			delete(rawMsg, key)
		...
		case "query":
			...
			delete(rawMsg, key)
		case "queryInputParameters":
			err = unpopulate(val, "QueryInputParameters", &a.QueryInputParameters)
			delete(rawMsg, key)
		case "severity":
			err = unpopulate(val, "Severity", &a.Severity)
			delete(rawMsg, key)
		case "templateDisplayName":
			err = unpopulate(val, "TemplateDisplayName", &a.TemplateDisplayName)
			delete(rawMsg, key)
		case "thresholdOperator":
			err = unpopulate(val, "ThresholdOperator", &a.ThresholdOperator)
			delete(rawMsg, key)
		case "upperBound":
			err = unpopulate(val, "UpperBound", &a.UpperBound)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", a, err)
...
// MarshalJSON implements the json.Marshaller interface for type AlertTemplateQueryInputParameter.
func (a AlertTemplateQueryInputParameter) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "defaultValue", a.DefaultValue)
	populate(objectMap, "description", a.Description)
	populate(objectMap, "displayName", a.DisplayName)
	populate(objectMap, "laQuery", a.LaQuery)
	populate(objectMap, "name", a.Name)
	populate(objectMap, "selectionMode", a.SelectionMode)
	populate(objectMap, "type", a.Type)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type AlertTemplateQueryInputParameter.
func (a *AlertTemplateQueryInputParameter) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", a, err)
	}
	for key, val := range rawMsg {
		...
		case "displayName":
			...
			delete(rawMsg, key)
		case "laQuery":
			err = unpopulate(val, "LaQuery", &a.LaQuery)
			delete(rawMsg, key)
		case "name":
			err = unpopulate(val, "Name", &a.Name)
			delete(rawMsg, key)
		case "selectionMode":
			err = unpopulate(val, "SelectionMode", &a.SelectionMode)
			delete(rawMsg, key)
		case "type":
			err = unpopulate(val, "Type", &a.Type)
			delete(rawMsg, key)
...
// MarshalJSON implements the json.Marshaller interface for type AppServicePlanConfiguration.
func (a AppServicePlanConfiguration) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type AppServicePlanConfiguration.
func (a *AppServicePlanConfiguration) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", a, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type OracleProviderInstanceProperties.
func (o OracleProviderInstanceProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "dbName", o.DbName)
	populate(objectMap, "dbPassword", o.DbPassword)
	populate(objectMap, "dbPasswordUri", o.DbPasswordURI)
	populate(objectMap, "dbPort", o.DbPort)
	populate(objectMap, "dbUsername", o.DbUsername)
	populate(objectMap, "hostname", o.Hostname)
	objectMap["providerType"] = "Oracle"
	populate(objectMap, "sslCertificateUri", o.SSLCertificateURI)
	populate(objectMap, "sslPreference", o.SSLPreference)
	populate(objectMap, "sapSid", o.SapSid)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type OracleProviderInstanceProperties.
func (o *OracleProviderInstanceProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", o, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "dbName":
			err = unpopulate(val, "DbName", &o.DbName)
			delete(rawMsg, key)
		case "dbPassword":
			err = unpopulate(val, "DbPassword", &o.DbPassword)
			delete(rawMsg, key)
		case "dbPasswordUri":
			err = unpopulate(val, "DbPasswordURI", &o.DbPasswordURI)
			delete(rawMsg, key)
		case "dbPort":
			err = unpopulate(val, "DbPort", &o.DbPort)
			delete(rawMsg, key)
		case "dbUsername":
			err = unpopulate(val, "DbUsername", &o.DbUsername)
			delete(rawMsg, key)
		case "hostname":
			err = unpopulate(val, "Hostname", &o.Hostname)
			delete(rawMsg, key)
		case "providerType":
			err = unpopulate(val, "ProviderType", &o.ProviderType)
			delete(rawMsg, key)
		case "sslCertificateUri":
			err = unpopulate(val, "SSLCertificateURI", &o.SSLCertificateURI)
			delete(rawMsg, key)
		case "sslPreference":
			err = unpopulate(val, "SSLPreference", &o.SSLPreference)
			delete(rawMsg, key)
		case "sapSid":
			err = unpopulate(val, "SapSid", &o.SapSid)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", o, err)
...
// MarshalJSON implements the json.Marshaller interface for type SapLandscapeMonitorResource.
func (s SapLandscapeMonitorResource) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type SapLandscapeMonitorResource.
func (s *SapLandscapeMonitorResource) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
