...
type SQLServerAvailabilityGroupsServer struct {
	...
	// Delete is the fake for method SQLServerAvailabilityGroupsClient.Delete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	Delete func(ctx context.Context, resourceGroupName string, sqlServerInstanceName string, availabilityGroupName string, options *armazurearcdata.SQLServerAvailabilityGroupsClientDeleteOptions) (resp azfake.Responder[armazurearcdata.SQLServerAvailabilityGroupsClientDeleteResponse], errResp azfake.ErrorResponder)
	...
	// Update is the fake for method SQLServerAvailabilityGroupsClient.Update
	// HTTP status codes to indicate success: http.StatusOK
	Update func(ctx context.Context, resourceGroupName string, sqlServerInstanceName string, availabilityGroupName string, sqlServerAvailabilityGroupUpdate armazurearcdata.SQLServerAvailabilityGroupUpdate, options *armazurearcdata.SQLServerAvailabilityGroupsClientUpdateOptions) (resp azfake.Responder[armazurearcdata.SQLServerAvailabilityGroupsClientUpdateResponse], errResp azfake.ErrorResponder)
}
...
func (s *SQLServerAvailabilityGroupsServerTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "SQLServerAvailabilityGroupsClient.Delete":
	...
	case "SQLServerAvailabilityGroupsClient.Update":
...
func (s *SQLServerAvailabilityGroupsServerTransport) dispatchDelete(req *http.Request) (*http.Response, error) {
	if s.srv.Delete == nil {
	...
	respr, errRespr := s.srv.Delete(req.Context(), resourceGroupNameParam, sqlServerInstanceNameParam, availabilityGroupNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (s *SQLServerAvailabilityGroupsServerTransport) dispatchUpdate(req *http.Request) (*http.Response, error) {
	if s.srv.Update == nil {
	...
	respr, errRespr := s.srv.Update(req.Context(), resourceGroupNameParam, sqlServerInstanceNameParam, availabilityGroupNameParam, body, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
