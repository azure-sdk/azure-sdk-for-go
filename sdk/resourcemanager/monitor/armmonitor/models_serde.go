...
// MarshalJSON implements the json.Marshaller interface for type ActionDetailAutoGenerated.
func (a ActionDetailAutoGenerated) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "mechanismType", a.MechanismType)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type ActionDetailAutoGenerated.
func (a *ActionDetailAutoGenerated) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", a, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type MetadataAutoGenerated.
func (m MetadataAutoGenerated) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "provisionedBy", m.ProvisionedBy)
	populate(objectMap, "provisionedByImmutableId", m.ProvisionedByImmutableID)
	populate(objectMap, "provisionedByResourceId", m.ProvisionedByResourceID)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type MetadataAutoGenerated.
func (m *MetadataAutoGenerated) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", m, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type MetadataAutoGenerated2.
func (m MetadataAutoGenerated2) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "provisionedBy", m.ProvisionedBy)
	populate(objectMap, "provisionedByImmutableId", m.ProvisionedByImmutableID)
	populate(objectMap, "provisionedByResourceId", m.ProvisionedByResourceID)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type MetadataAutoGenerated2.
func (m *MetadataAutoGenerated2) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", m, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type ResourceForUpdateAutoGenerated.
func (r ResourceForUpdateAutoGenerated) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "identity", r.Identity)
	populate(objectMap, "tags", r.Tags)
	return json.Marshal(objectMap)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type ResourceForUpdateAutoGenerated.
func (r *ResourceForUpdateAutoGenerated) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", r, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type ResourceForUpdateDceProperties.
func (r ResourceForUpdateDceProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "failoverConfiguration", r.FailoverConfiguration)
	populate(objectMap, "metadata", r.Metadata)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ResourceForUpdateDceProperties.
func (r *ResourceForUpdateDceProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", r, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "failoverConfiguration":
			err = unpopulate(val, "FailoverConfiguration", &r.FailoverConfiguration)
			delete(rawMsg, key)
		case "metadata":
...
// MarshalJSON implements the json.Marshaller interface for type ResourceForUpdateDcePropertiesFailoverConfiguration.
func (r ResourceForUpdateDcePropertiesFailoverConfiguration) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type ResourceForUpdateDcePropertiesFailoverConfiguration.
func (r *ResourceForUpdateDcePropertiesFailoverConfiguration) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", r, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type ResourceForUpdateDcePropertiesMetadata.
func (r ResourceForUpdateDcePropertiesMetadata) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "provisionedBy", r.ProvisionedBy)
	populate(objectMap, "provisionedByImmutableId", r.ProvisionedByImmutableID)
	populate(objectMap, "provisionedByResourceId", r.ProvisionedByResourceID)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ResourceForUpdateDcePropertiesMetadata.
func (r *ResourceForUpdateDcePropertiesMetadata) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", r, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "provisionedBy":
			err = unpopulate(val, "ProvisionedBy", &r.ProvisionedBy)
			delete(rawMsg, key)
		case "provisionedByImmutableId":
			err = unpopulate(val, "ProvisionedByImmutableID", &r.ProvisionedByImmutableID)
			delete(rawMsg, key)
		case "provisionedByResourceId":
			err = unpopulate(val, "ProvisionedByResourceID", &r.ProvisionedByResourceID)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", r, err)
...
// MarshalJSON implements the json.Marshaller interface for type ResourceForUpdateProperties.
func (r ResourceForUpdateProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "failoverConfiguration", r.FailoverConfiguration)
	populate(objectMap, "metadata", r.Metadata)
	return json.Marshal(objectMap)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type ResourceForUpdateProperties.
func (r *ResourceForUpdateProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", r, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type TestNotificationDetailsResponseAutoGenerated.
func (t TestNotificationDetailsResponseAutoGenerated) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "actionDetails", t.ActionDetails)
	populate(objectMap, "completedTime", t.CompletedTime)
	populate(objectMap, "context", t.Context)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type TestNotificationDetailsResponseAutoGenerated.
func (t *TestNotificationDetailsResponseAutoGenerated) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", t, err)
	}
