...
// VMScannersClientCreateOrUpdateResponse contains the response from method VMScannersClient.CreateOrUpdate.
type VMScannersClientCreateOrUpdateResponse struct {
	ScannerConfiguration
}

// VMScannersClientDeleteResponse contains the response from method VMScannersClient.Delete.
type VMScannersClientDeleteResponse struct {
	// placeholder for future response values
}

// VMScannersClientGetResponse contains the response from method VMScannersClient.Get.
type VMScannersClientGetResponse struct {
	ScannerConfiguration
}

// VMScannersClientListBySubscriptionResponse contains the response from method VMScannersClient.ListBySubscription.
type VMScannersClientListBySubscriptionResponse struct {
