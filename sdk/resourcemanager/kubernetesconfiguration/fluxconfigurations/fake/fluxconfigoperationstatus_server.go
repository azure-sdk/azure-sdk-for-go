...
// FluxConfigOperationStatusServer is a fake server for instances of the fluxconfigurations.FluxConfigOperationStatusClient type.
type FluxConfigOperationStatusServer struct {
	// Get is the fake for method FluxConfigOperationStatusClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, clusterRp string, clusterResourceName string, clusterName string, fluxConfigurationName string, operationID string, options *fluxconfigurations.FluxConfigOperationStatusClientGetOptions) (resp azfake.Responder[fluxconfigurations.FluxConfigOperationStatusClientGetResponse], errResp azfake.ErrorResponder)
}
...
// The returned FluxConfigOperationStatusServerTransport instance is connected to an instance of fluxconfigurations.FluxConfigOperationStatusClient via the
...
// FluxConfigOperationStatusServerTransport connects instances of fluxconfigurations.FluxConfigOperationStatusClient to instances of FluxConfigOperationStatusServer.
