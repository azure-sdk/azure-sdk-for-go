...
//     method.
func (client *CloudLinksClient) NewListByPrivateCloudPager(resourceGroupName string, privateCloudName string, options *CloudLinksClientListByPrivateCloudOptions) *runtime.Pager[CloudLinksClientListByPrivateCloudResponse] {
...
func (client *CloudLinksClient) listByPrivateCloudCreateRequest(ctx context.Context, resourceGroupName string, privateCloudName string, _ *CloudLinksClientListByPrivateCloudOptions) (*policy.Request, error) {
