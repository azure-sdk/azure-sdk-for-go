...
func (client *DataProductsCatalogsClient) getCreateRequest(ctx context.Context, resourceGroupName string, _ *DataProductsCatalogsClientGetOptions) (*policy.Request, error) {
...
func (client *DataProductsCatalogsClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, _ *DataProductsCatalogsClientListByResourceGroupOptions) (*policy.Request, error) {
...
func (client *DataProductsCatalogsClient) listBySubscriptionCreateRequest(ctx context.Context, _ *DataProductsCatalogsClientListBySubscriptionOptions) (*policy.Request, error) {
