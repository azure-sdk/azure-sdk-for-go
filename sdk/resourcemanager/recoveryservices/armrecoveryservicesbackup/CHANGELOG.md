...
## 5.0.0-beta.1 (2025-03-21)
### Breaking Changes

- Type of `AzureFileshareProtectedItem.WorkloadType` has been changed from `*DataSourceType` to `*DataSourceTypeAutoGenerated3`
- Type of `AzureIaaSClassicComputeVMProtectedItem.WorkloadType` has been changed from `*DataSourceType` to `*DataSourceTypeAutoGenerated3`
- Type of `AzureIaaSComputeVMProtectedItem.WorkloadType` has been changed from `*DataSourceType` to `*DataSourceTypeAutoGenerated3`
- Type of `AzureIaaSVMProtectedItem.WorkloadType` has been changed from `*DataSourceType` to `*DataSourceTypeAutoGenerated3`
- Type of `AzureSQLProtectedItem.WorkloadType` has been changed from `*DataSourceType` to `*DataSourceTypeAutoGenerated3`
- Type of `AzureVMWorkloadProtectedItem.WorkloadType` has been changed from `*DataSourceType` to `*DataSourceTypeAutoGenerated3`
- Type of `AzureVMWorkloadSAPAseDatabaseProtectedItem.WorkloadType` has been changed from `*DataSourceType` to `*DataSourceTypeAutoGenerated3`
- Type of `AzureVMWorkloadSAPHanaDBInstanceProtectedItem.WorkloadType` has been changed from `*DataSourceType` to `*DataSourceTypeAutoGenerated3`
- Type of `AzureVMWorkloadSAPHanaDatabaseProtectedItem.WorkloadType` has been changed from `*DataSourceType` to `*DataSourceTypeAutoGenerated3`
- Type of `AzureVMWorkloadSQLDatabaseProtectedItem.WorkloadType` has been changed from `*DataSourceType` to `*DataSourceTypeAutoGenerated3`
- Type of `BackupStatusRequest.ResourceType` has been changed from `*DataSourceType` to `*DataSourceTypeAutoGenerated2`
- Type of `DPMProtectedItem.WorkloadType` has been changed from `*DataSourceType` to `*DataSourceTypeAutoGenerated3`
- Type of `GenericProtectedItem.WorkloadType` has been changed from `*DataSourceType` to `*DataSourceTypeAutoGenerated3`
- Type of `MabFileFolderProtectedItem.WorkloadType` has been changed from `*DataSourceType` to `*DataSourceTypeAutoGenerated3`
- Type of `PreValidateEnableBackupRequest.ResourceType` has been changed from `*DataSourceType` to `*DataSourceTypeAutoGenerated`
- Type of `ProtectedItem.WorkloadType` has been changed from `*DataSourceType` to `*DataSourceTypeAutoGenerated3`
- Type of `ProtectedItemQueryObject.ItemType` has been changed from `*DataSourceType` to `*DataSourceTypeAutoGenerated3`

### Features Added

- New value `ContainerTypeASEHAContainer`, `ContainerTypeHanaScaleoutContainer`, `ContainerTypeOracleContainer` added to enum type `ContainerType`
- New value `DataSourceTypeAnyDatabase`, `DataSourceTypeOracleDatabase` added to enum type `DataSourceType`
- New value `WorkloadItemTypeAnyDBSystem`, `WorkloadItemTypeAnyDatabase`, `WorkloadItemTypeOracleDatabase`, `WorkloadItemTypeOracleSystem` added to enum type `WorkloadItemType`
- New enum type `DataSourceTypeAutoGenerated` with values `DataSourceTypeAutoGeneratedAnyDatabase`, `DataSourceTypeAutoGeneratedAzureFileShare`, `DataSourceTypeAutoGeneratedAzureSQLDb`, `DataSourceTypeAutoGeneratedClient`, `DataSourceTypeAutoGeneratedExchange`, `DataSourceTypeAutoGeneratedFileFolder`, `DataSourceTypeAutoGeneratedGenericDataSource`, `DataSourceTypeAutoGeneratedInvalid`, `DataSourceTypeAutoGeneratedOracleDatabase`, `DataSourceTypeAutoGeneratedSAPAseDatabase`, `DataSourceTypeAutoGeneratedSAPHanaDBInstance`, `DataSourceTypeAutoGeneratedSAPHanaDatabase`, `DataSourceTypeAutoGeneratedSQLDB`, `DataSourceTypeAutoGeneratedSQLDataBase`, `DataSourceTypeAutoGeneratedSharepoint`, `DataSourceTypeAutoGeneratedSystemState`, `DataSourceTypeAutoGeneratedVM`, `DataSourceTypeAutoGeneratedVMwareVM`
- New enum type `DataSourceTypeAutoGenerated2` with values `DataSourceTypeAutoGenerated2AnyDatabase`, `DataSourceTypeAutoGenerated2AzureFileShare`, `DataSourceTypeAutoGenerated2AzureSQLDb`, `DataSourceTypeAutoGenerated2Client`, `DataSourceTypeAutoGenerated2Exchange`, `DataSourceTypeAutoGenerated2FileFolder`, `DataSourceTypeAutoGenerated2GenericDataSource`, `DataSourceTypeAutoGenerated2Invalid`, `DataSourceTypeAutoGenerated2OracleDatabase`, `DataSourceTypeAutoGenerated2SAPAseDatabase`, `DataSourceTypeAutoGenerated2SAPHanaDBInstance`, `DataSourceTypeAutoGenerated2SAPHanaDatabase`, `DataSourceTypeAutoGenerated2SQLDB`, `DataSourceTypeAutoGenerated2SQLDataBase`, `DataSourceTypeAutoGenerated2Sharepoint`, `DataSourceTypeAutoGenerated2SystemState`, `DataSourceTypeAutoGenerated2VM`, `DataSourceTypeAutoGenerated2VMwareVM`
- New enum type `DataSourceTypeAutoGenerated3` with values `DataSourceTypeAutoGenerated3AnyDatabase`, `DataSourceTypeAutoGenerated3AzureFileShare`, `DataSourceTypeAutoGenerated3AzureSQLDb`, `DataSourceTypeAutoGenerated3Client`, `DataSourceTypeAutoGenerated3Exchange`, `DataSourceTypeAutoGenerated3FileFolder`, `DataSourceTypeAutoGenerated3GenericDataSource`, `DataSourceTypeAutoGenerated3Invalid`, `DataSourceTypeAutoGenerated3OracleDatabase`, `DataSourceTypeAutoGenerated3SAPAseDatabase`, `DataSourceTypeAutoGenerated3SAPHanaDBInstance`, `DataSourceTypeAutoGenerated3SAPHanaDatabase`, `DataSourceTypeAutoGenerated3SQLDB`, `DataSourceTypeAutoGenerated3SQLDataBase`, `DataSourceTypeAutoGenerated3Sharepoint`, `DataSourceTypeAutoGenerated3SystemState`, `DataSourceTypeAutoGenerated3VM`, `DataSourceTypeAutoGenerated3VMwareVM`
...
- New function `*AzureVMWorkloadAnyDatabaseProtectableItem.GetAzureVMWorkloadProtectableItem() *AzureVMWorkloadProtectableItem`
- New function `*AzureVMWorkloadAnyDatabaseProtectableItem.GetWorkloadProtectableItem() *WorkloadProtectableItem`
- New function `*AzureVMWorkloadAnyDatabaseProtectedItem.GetAzureVMWorkloadProtectedItem() *AzureVMWorkloadProtectedItem`
- New function `*AzureVMWorkloadAnyDatabaseProtectedItem.GetProtectedItem() *ProtectedItem`
- New function `*AzureVMWorkloadAnyDatabaseWorkloadItem.GetAzureVMWorkloadItem() *AzureVMWorkloadItem`
- New function `*AzureVMWorkloadAnyDatabaseWorkloadItem.GetWorkloadItem() *WorkloadItem`
- New function `*AzureVMWorkloadOracleDatabaseProtectableItem.GetAzureVMWorkloadProtectableItem() *AzureVMWorkloadProtectableItem`
- New function `*AzureVMWorkloadOracleDatabaseProtectableItem.GetWorkloadProtectableItem() *WorkloadProtectableItem`
- New function `*AzureVMWorkloadOracleDatabaseProtectedItem.GetAzureVMWorkloadProtectedItem() *AzureVMWorkloadProtectedItem`
- New function `*AzureVMWorkloadOracleDatabaseProtectedItem.GetProtectedItem() *ProtectedItem`
- New function `*AzureVMWorkloadOracleDatabaseWorkloadItem.GetAzureVMWorkloadItem() *AzureVMWorkloadItem`
- New function `*AzureVMWorkloadOracleDatabaseWorkloadItem.GetWorkloadItem() *WorkloadItem`
...
- New function `*AzureWorkloadAnyDatabasePointInTimeRecoveryPoint.GetAzureWorkloadPointInTimeRecoveryPoint() *AzureWorkloadPointInTimeRecoveryPoint`
- New function `*AzureWorkloadAnyDatabasePointInTimeRecoveryPoint.GetAzureWorkloadRecoveryPoint() *AzureWorkloadRecoveryPoint`
- New function `*AzureWorkloadAnyDatabasePointInTimeRecoveryPoint.GetRecoveryPoint() *RecoveryPoint`
- New function `*AzureWorkloadAnyDatabasePointInTimeRestoreRequest.GetAzureWorkloadAnyDatabasePointInTimeRestoreRequest() *AzureWorkloadAnyDatabasePointInTimeRestoreRequest`
- New function `*AzureWorkloadAnyDatabasePointInTimeRestoreRequest.GetAzureWorkloadAnyDatabaseRestoreRequest() *AzureWorkloadAnyDatabaseRestoreRequest`
- New function `*AzureWorkloadAnyDatabasePointInTimeRestoreRequest.GetAzureWorkloadRestoreRequest() *AzureWorkloadRestoreRequest`
- New function `*AzureWorkloadAnyDatabasePointInTimeRestoreRequest.GetRestoreRequest() *RestoreRequest`
- New function `*AzureWorkloadAnyDatabasePointInTimeRestoreWithRehydrateRequest.GetAzureWorkloadAnyDatabasePointInTimeRestoreRequest() *AzureWorkloadAnyDatabasePointInTimeRestoreRequest`
- New function `*AzureWorkloadAnyDatabasePointInTimeRestoreWithRehydrateRequest.GetAzureWorkloadAnyDatabaseRestoreRequest() *AzureWorkloadAnyDatabaseRestoreRequest`
- New function `*AzureWorkloadAnyDatabasePointInTimeRestoreWithRehydrateRequest.GetAzureWorkloadRestoreRequest() *AzureWorkloadRestoreRequest`
- New function `*AzureWorkloadAnyDatabasePointInTimeRestoreWithRehydrateRequest.GetRestoreRequest() *RestoreRequest`
- New function `*AzureWorkloadAnyDatabaseRecoveryPoint.GetAzureWorkloadRecoveryPoint() *AzureWorkloadRecoveryPoint`
- New function `*AzureWorkloadAnyDatabaseRecoveryPoint.GetRecoveryPoint() *RecoveryPoint`
- New function `*AzureWorkloadAnyDatabaseRestoreRequest.GetAzureWorkloadAnyDatabaseRestoreRequest() *AzureWorkloadAnyDatabaseRestoreRequest`
- New function `*AzureWorkloadAnyDatabaseRestoreRequest.GetAzureWorkloadRestoreRequest() *AzureWorkloadRestoreRequest`
- New function `*AzureWorkloadAnyDatabaseRestoreRequest.GetRestoreRequest() *RestoreRequest`
- New function `*AzureWorkloadAnyDatabaseRestoreWithRehydrateRequest.GetAzureWorkloadAnyDatabaseRestoreRequest() *AzureWorkloadAnyDatabaseRestoreRequest`
- New function `*AzureWorkloadAnyDatabaseRestoreWithRehydrateRequest.GetAzureWorkloadRestoreRequest() *AzureWorkloadRestoreRequest`
- New function `*AzureWorkloadAnyDatabaseRestoreWithRehydrateRequest.GetRestoreRequest() *RestoreRequest`
- New function `*AzureWorkloadOraclePointInTimeRecoveryPoint.GetAzureWorkloadPointInTimeRecoveryPoint() *AzureWorkloadPointInTimeRecoveryPoint`
- New function `*AzureWorkloadOraclePointInTimeRecoveryPoint.GetAzureWorkloadRecoveryPoint() *AzureWorkloadRecoveryPoint`
- New function `*AzureWorkloadOraclePointInTimeRecoveryPoint.GetRecoveryPoint() *RecoveryPoint`
- New function `*AzureWorkloadOraclePointInTimeRestoreRequest.GetAzureWorkloadOraclePointInTimeRestoreRequest() *AzureWorkloadOraclePointInTimeRestoreRequest`
- New function `*AzureWorkloadOraclePointInTimeRestoreRequest.GetAzureWorkloadOracleRestoreRequest() *AzureWorkloadOracleRestoreRequest`
- New function `*AzureWorkloadOraclePointInTimeRestoreRequest.GetAzureWorkloadRestoreRequest() *AzureWorkloadRestoreRequest`
- New function `*AzureWorkloadOraclePointInTimeRestoreRequest.GetRestoreRequest() *RestoreRequest`
- New function `*AzureWorkloadOraclePointInTimeRestoreWithRehydrateRequest.GetAzureWorkloadOraclePointInTimeRestoreRequest() *AzureWorkloadOraclePointInTimeRestoreRequest`
- New function `*AzureWorkloadOraclePointInTimeRestoreWithRehydrateRequest.GetAzureWorkloadOracleRestoreRequest() *AzureWorkloadOracleRestoreRequest`
- New function `*AzureWorkloadOraclePointInTimeRestoreWithRehydrateRequest.GetAzureWorkloadRestoreRequest() *AzureWorkloadRestoreRequest`
- New function `*AzureWorkloadOraclePointInTimeRestoreWithRehydrateRequest.GetRestoreRequest() *RestoreRequest`
- New function `*AzureWorkloadOracleRecoveryPoint.GetAzureWorkloadRecoveryPoint() *AzureWorkloadRecoveryPoint`
- New function `*AzureWorkloadOracleRecoveryPoint.GetRecoveryPoint() *RecoveryPoint`
- New function `*AzureWorkloadOracleRestoreRequest.GetAzureWorkloadOracleRestoreRequest() *AzureWorkloadOracleRestoreRequest`
- New function `*AzureWorkloadOracleRestoreRequest.GetAzureWorkloadRestoreRequest() *AzureWorkloadRestoreRequest`
- New function `*AzureWorkloadOracleRestoreRequest.GetRestoreRequest() *RestoreRequest`
- New function `*AzureWorkloadOracleRestoreWithRehydrateRequest.GetAzureWorkloadOracleRestoreRequest() *AzureWorkloadOracleRestoreRequest`
- New function `*AzureWorkloadOracleRestoreWithRehydrateRequest.GetAzureWorkloadRestoreRequest() *AzureWorkloadRestoreRequest`
- New function `*AzureWorkloadOracleRestoreWithRehydrateRequest.GetRestoreRequest() *RestoreRequest`
...
- New function `*AzureWorkloadSAPAsePointInTimeRestoreRequest.GetAzureWorkloadSAPAsePointInTimeRestoreRequest() *AzureWorkloadSAPAsePointInTimeRestoreRequest`
...
- New function `*AzureWorkloadSAPAsePointInTimeRestoreWithRehydrateRequest.GetAzureWorkloadRestoreRequest() *AzureWorkloadRestoreRequest`
- New function `*AzureWorkloadSAPAsePointInTimeRestoreWithRehydrateRequest.GetAzureWorkloadSAPAsePointInTimeRestoreRequest() *AzureWorkloadSAPAsePointInTimeRestoreRequest`
- New function `*AzureWorkloadSAPAsePointInTimeRestoreWithRehydrateRequest.GetAzureWorkloadSAPAseRestoreRequest() *AzureWorkloadSAPAseRestoreRequest`
- New function `*AzureWorkloadSAPAsePointInTimeRestoreWithRehydrateRequest.GetRestoreRequest() *RestoreRequest`
...
- New function `*AzureWorkloadSAPAseRestoreWithRehydrateRequest.GetAzureWorkloadRestoreRequest() *AzureWorkloadRestoreRequest`
- New function `*AzureWorkloadSAPAseRestoreWithRehydrateRequest.GetAzureWorkloadSAPAseRestoreRequest() *AzureWorkloadSAPAseRestoreRequest`
- New function `*AzureWorkloadSAPAseRestoreWithRehydrateRequest.GetRestoreRequest() *RestoreRequest`
- New function `PossibleDataSourceTypeAutoGeneratedValues() []DataSourceTypeAutoGenerated`
...
- New struct `AzureVMWorkloadAnyDatabaseProtectableItem`
- New struct `AzureVMWorkloadAnyDatabaseProtectedItem`
- New struct `AzureVMWorkloadAnyDatabaseWorkloadItem`
- New struct `AzureVMWorkloadOracleDatabaseProtectableItem`
- New struct `AzureVMWorkloadOracleDatabaseProtectedItem`
- New struct `AzureVMWorkloadOracleDatabaseWorkloadItem`
- New struct `AzureVMWorkloadSAPHanaScaleoutProtectableItem`
- New struct `AzureWorkloadAnyDatabasePointInTimeRecoveryPoint`
- New struct `AzureWorkloadAnyDatabasePointInTimeRestoreWithRehydrateRequest`
- New struct `AzureWorkloadAnyDatabaseRecoveryPoint`
- New struct `AzureWorkloadAnyDatabaseRestoreWithRehydrateRequest`
- New struct `AzureWorkloadOraclePointInTimeRecoveryPoint`
- New struct `AzureWorkloadOraclePointInTimeRestoreWithRehydrateRequest`
- New struct `AzureWorkloadOracleRecoveryPoint`
- New struct `AzureWorkloadOracleRestoreWithRehydrateRequest`
- New struct `AzureWorkloadSAPAsePointInTimeRecoveryPoint`
- New struct `AzureWorkloadSAPAsePointInTimeRestoreWithRehydrateRequest`
- New struct `AzureWorkloadSAPAseRecoveryPoint`
- New struct `AzureWorkloadSAPAseRestoreWithRehydrateRequest`
