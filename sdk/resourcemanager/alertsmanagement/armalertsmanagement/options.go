...
// OperationsClientListTestOptions contains the optional parameters for the OperationsClient.NewListTestPager method.
type OperationsClientListTestOptions struct {
	// placeholder for future optional parameters
}
