...
func (client *HardwareComponentGroupsClient) changeControllerPowerStateCreateRequest(ctx context.Context, deviceName string, hardwareComponentGroupName string, resourceGroupName string, managerName string, parameters ControllerPowerStateChangeRequest, _ *HardwareComponentGroupsClientBeginChangeControllerPowerStateOptions) (*policy.Request, error) {
...
func (client *HardwareComponentGroupsClient) listByDeviceCreateRequest(ctx context.Context, deviceName string, resourceGroupName string, managerName string, _ *HardwareComponentGroupsClientListByDeviceOptions) (*policy.Request, error) {
