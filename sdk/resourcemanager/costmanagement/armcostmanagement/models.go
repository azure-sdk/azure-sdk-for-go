...
type CommonExportProperties struct {
	...
	// Allow customers to select compress data(gzip, snappy) for exports. This setting will enable destination file compression
	// scheme at runtime. By default set to None.
...
// ExportSuspensionContext - The properties of the export suspension context. This is not populated currently.
