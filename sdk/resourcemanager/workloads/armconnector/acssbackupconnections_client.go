...
func (client *ACSSBackupConnectionsClient) BeginCreate(ctx context.Context, resourceGroupName string, connectorName string, backupName string, body ACSSBackupConnection, options *ACSSBackupConnectionsClientBeginCreateOptions) (*runtime.Poller[ACSSBackupConnectionsClientCreateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		poller, err := runtime.NewPoller(resp, client.internal.Pipeline(), &runtime.NewPollerOptions[ACSSBackupConnectionsClientCreateResponse]{
			Tracer: client.internal.Tracer(),
		})
		return poller, err
	} else {
		return runtime.NewPollerFromResumeToken(options.ResumeToken, client.internal.Pipeline(), &runtime.NewPollerFromResumeTokenOptions[ACSSBackupConnectionsClientCreateResponse]{
			Tracer: client.internal.Tracer(),
		})
	}
}
...
func (client *ACSSBackupConnectionsClient) create(ctx context.Context, resourceGroupName string, connectorName string, backupName string, body ACSSBackupConnection, options *ACSSBackupConnectionsClientBeginCreateOptions) (*http.Response, error) {
	var err error
	const operationName = "ACSSBackupConnectionsClient.BeginCreate"
...
func (client *ACSSBackupConnectionsClient) createCreateRequest(ctx context.Context, resourceGroupName string, connectorName string, backupName string, body ACSSBackupConnection, _ *ACSSBackupConnectionsClientBeginCreateOptions) (*policy.Request, error) {
...
func (client *ACSSBackupConnectionsClient) BeginDelete(ctx context.Context, resourceGroupName string, connectorName string, backupName string, options *ACSSBackupConnectionsClientBeginDeleteOptions) (*runtime.Poller[ACSSBackupConnectionsClientDeleteResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		poller, err := runtime.NewPoller(resp, client.internal.Pipeline(), &runtime.NewPollerOptions[ACSSBackupConnectionsClientDeleteResponse]{
			Tracer: client.internal.Tracer(),
		})
		return poller, err
	} else {
		return runtime.NewPollerFromResumeToken(options.ResumeToken, client.internal.Pipeline(), &runtime.NewPollerFromResumeTokenOptions[ACSSBackupConnectionsClientDeleteResponse]{
			Tracer: client.internal.Tracer(),
		})
	}
}
...
func (client *ACSSBackupConnectionsClient) deleteOperation(ctx context.Context, resourceGroupName string, connectorName string, backupName string, options *ACSSBackupConnectionsClientBeginDeleteOptions) (*http.Response, error) {
	var err error
	const operationName = "ACSSBackupConnectionsClient.BeginDelete"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
...
func (client *ACSSBackupConnectionsClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, connectorName string, backupName string, _ *ACSSBackupConnectionsClientBeginDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Workloads/connectors/{connectorName}/acssBackups/{backupName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *ACSSBackupConnectionsClient) Get(ctx context.Context, resourceGroupName string, connectorName string, backupName string, options *ACSSBackupConnectionsClientGetOptions) (ACSSBackupConnectionsClientGetResponse, error) {
	var err error
	const operationName = "ACSSBackupConnectionsClient.Get"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
...
func (client *ACSSBackupConnectionsClient) getCreateRequest(ctx context.Context, resourceGroupName string, connectorName string, backupName string, _ *ACSSBackupConnectionsClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Workloads/connectors/{connectorName}/acssBackups/{backupName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *ACSSBackupConnectionsClient) NewListPager(resourceGroupName string, connectorName string, options *ACSSBackupConnectionsClientListOptions) *runtime.Pager[ACSSBackupConnectionsClientListResponse] {
	return runtime.NewPager(runtime.PagingHandler[ACSSBackupConnectionsClientListResponse]{
		...
		Fetcher: func(ctx context.Context, page *ACSSBackupConnectionsClientListResponse) (ACSSBackupConnectionsClientListResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "ACSSBackupConnectionsClient.NewListPager")
			nextLink := ""
			if page != nil {
				nextLink = *page.NextLink
			}
			resp, err := runtime.FetcherForNextLink(ctx, client.internal.Pipeline(), nextLink, func(ctx context.Context) (*policy.Request, error) {
				return client.listCreateRequest(ctx, resourceGroupName, connectorName, options)
			}, nil)
			if err != nil {
...
func (client *ACSSBackupConnectionsClient) listCreateRequest(ctx context.Context, resourceGroupName string, connectorName string, _ *ACSSBackupConnectionsClientListOptions) (*policy.Request, error) {
...
func (client *ACSSBackupConnectionsClient) BeginUpdate(ctx context.Context, resourceGroupName string, connectorName string, backupName string, body UpdateACSSBackupConnectionRequest, options *ACSSBackupConnectionsClientBeginUpdateOptions) (*runtime.Poller[ACSSBackupConnectionsClientUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		poller, err := runtime.NewPoller(resp, client.internal.Pipeline(), &runtime.NewPollerOptions[ACSSBackupConnectionsClientUpdateResponse]{
			Tracer: client.internal.Tracer(),
		})
		return poller, err
	} else {
		return runtime.NewPollerFromResumeToken(options.ResumeToken, client.internal.Pipeline(), &runtime.NewPollerFromResumeTokenOptions[ACSSBackupConnectionsClientUpdateResponse]{
			Tracer: client.internal.Tracer(),
		})
	}
}
...
func (client *ACSSBackupConnectionsClient) update(ctx context.Context, resourceGroupName string, connectorName string, backupName string, body UpdateACSSBackupConnectionRequest, options *ACSSBackupConnectionsClientBeginUpdateOptions) (*http.Response, error) {
	var err error
	const operationName = "ACSSBackupConnectionsClient.BeginUpdate"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
...
func (client *ACSSBackupConnectionsClient) updateCreateRequest(ctx context.Context, resourceGroupName string, connectorName string, backupName string, body UpdateACSSBackupConnectionRequest, _ *ACSSBackupConnectionsClientBeginUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Workloads/connectors/{connectorName}/acssBackups/{backupName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
