...
func (client *BillingAccountClient) getPolicyCreateRequest(ctx context.Context, billingAccountID string, _ *BillingAccountClientGetPolicyOptions) (*policy.Request, error) {
