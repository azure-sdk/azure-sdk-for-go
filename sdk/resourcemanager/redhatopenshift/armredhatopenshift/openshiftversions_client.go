...
func (client *OpenShiftVersionsClient) getCreateRequest(ctx context.Context, location string, openShiftVersion string, options *OpenShiftVersionsClientGetOptions) (*policy.Request, error) {
