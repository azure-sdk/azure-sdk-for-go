...
func (client *IntegrationAccountSchemasClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, integrationAccountName string, schemaName string, schema IntegrationAccountSchema, _ *IntegrationAccountSchemasClientCreateOrUpdateOptions) (*policy.Request, error) {
