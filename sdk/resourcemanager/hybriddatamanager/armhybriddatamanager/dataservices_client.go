...
func (client *DataServicesClient) getCreateRequest(ctx context.Context, dataServiceName string, resourceGroupName string, dataManagerName string, _ *DataServicesClientGetOptions) (*policy.Request, error) {
...
func (client *DataServicesClient) listByDataManagerCreateRequest(ctx context.Context, resourceGroupName string, dataManagerName string, _ *DataServicesClientListByDataManagerOptions) (*policy.Request, error) {
