...
func (a *AzureTrafficCollectorsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if azureTrafficCollectorsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = azureTrafficCollectorsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to AzureTrafficCollectorsServerTransport
var azureTrafficCollectorsServerTransportInterceptor interface {
