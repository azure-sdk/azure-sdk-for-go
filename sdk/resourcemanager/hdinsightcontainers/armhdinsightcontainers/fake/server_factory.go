...
type ServerFactory struct {
	// AvailableClusterPoolVersionsServer contains the fakes for client AvailableClusterPoolVersionsClient
	AvailableClusterPoolVersionsServer AvailableClusterPoolVersionsServer

	// AvailableClusterVersionsServer contains the fakes for client AvailableClusterVersionsClient
	AvailableClusterVersionsServer AvailableClusterVersionsServer

	// ClusterAvailableUpgradesServer contains the fakes for client ClusterAvailableUpgradesClient
	...
	// ClusterLibrariesServer contains the fakes for client ClusterLibrariesClient
	ClusterLibrariesServer ClusterLibrariesServer

	// ClusterPoolAvailableUpgradesServer contains the fakes for client ClusterPoolAvailableUpgradesClient
	ClusterPoolAvailableUpgradesServer ClusterPoolAvailableUpgradesServer

	// ClusterPoolUpgradeHistoriesServer contains the fakes for client ClusterPoolUpgradeHistoriesClient
	ClusterPoolUpgradeHistoriesServer ClusterPoolUpgradeHistoriesServer

	// ClusterPoolsServer contains the fakes for client ClusterPoolsClient
	ClusterPoolsServer ClusterPoolsServer

	// ClusterUpgradeHistoriesServer contains the fakes for client ClusterUpgradeHistoriesClient
