...
- New field `AssociatedWorkspaces`, `ContainerRegistries`, `EnableDataIsolation`, `ExistingWorkspaces`, `FeatureStoreSettings`, `HubResourceID`, `KeyVaults`, `ManagedNetwork`, `ScheduledPurgeDate`, `SoftDeleteRetentionInDays`, `SoftDeletedAt`, `StorageAccounts`, `SystemDatastoresAuthMode` in struct `WorkspaceProperties`
- New field `Encryption`, `FeatureStoreSettings`, `ManagedNetwork` in struct `WorkspacePropertiesUpdateParameters`
