...
- Const `MetricAggregationTypeTotal` has been removed
- Const `StorageAccountTypeSecondary` has been removed
- Const `PrivateEndpointServiceConnectionStatusPending` has been removed
- Const `ActionTypeInternal` has been removed
- Const `MetricAggregationTypeCount` has been removed
- Const `PrivateEndpointServiceConnectionStatusRejected` has been removed
- Const `MetricAggregationTypeAverage` has been removed
...
- Const `AccountEncryptionKeyTypeCustomerKey` has been removed
- Const `DefaultActionDeny` has been removed
- Const `DefaultActionAllow` has been removed
- Const `PrivateEndpointServiceConnectionStatusApproved` has been removed
- Const `AccountEncryptionKeyTypeSystemKey` has been removed
- Const `PrivateEndpointConnectionProvisioningStateFailed` has been removed
- Const `StorageAuthenticationManagedIdentity` has been removed
- Const `MetricUnitMilliseconds` has been removed
- Const `StorageAccountTypePrimary` has been removed
- Const `StorageAuthenticationSystem` has been removed
...
- Function `MediaServiceProperties.MarshalJSON` has been removed
- Function `PossibleActionTypeValues` has been removed
- Function `MediaService.MarshalJSON` has been removed
- Function `AccessControl.MarshalJSON` has been removed
...
- Function `MediaServiceUpdate.MarshalJSON` has been removed
- Function `PossibleStorageAuthenticationValues` has been removed
- Function `*Client.NewListBySubscriptionPager` has been removed
- Function `*Client.SyncStorageKeys` has been removed
- Function `*Client.CreateOrUpdate` has been removed
- Function `OperationCollection.MarshalJSON` has been removed
- Function `PossibleMetricAggregationTypeValues` has been removed
...
- Function `*PrivateEndpointConnectionsClient.Delete` has been removed
- Function `PossibleMetricUnitValues` has been removed
- Function `*Client.ListEdgePolicies` has been removed
- Function `NewLocationsClient` has been removed
- Function `MediaServiceIdentity.MarshalJSON` has been removed
- Function `*PrivateLinkResourcesClient.Get` has been removed
- Function `PrivateEndpointConnectionListResult.MarshalJSON` has been removed
- Function `PossibleDefaultActionValues` has been removed
- Function `PossibleAccountEncryptionKeyTypeValues` has been removed
- Struct `AccessControl` has been removed
- Struct `AccountEncryption` has been removed
...
- Struct `ClientCreateOrUpdateResponse` has been removed
- Struct `ClientDeleteOptions` has been removed
...
- Struct `ClientListBySubscriptionOptions` has been removed
- Struct `ClientListBySubscriptionResponse` has been removed
- Struct `ClientListEdgePoliciesOptions` has been removed
- Struct `ClientListEdgePoliciesResponse` has been removed
- Struct `ClientListOptions` has been removed
- Struct `ClientListResponse` has been removed
- Struct `ClientSyncStorageKeysOptions` has been removed
- Struct `ClientSyncStorageKeysResponse` has been removed
- Struct `ClientUpdateOptions` has been removed
- Struct `ClientUpdateResponse` has been removed
- Struct `EdgePolicies` has been removed
- Struct `EdgeUsageDataCollectionPolicy` has been removed
- Struct `EdgeUsageDataEventHub` has been removed
- Struct `EntityNameAvailabilityCheckOutput` has been removed
- Struct `KeyDelivery` has been removed
- Struct `KeyVaultProperties` has been removed
- Struct `ListEdgePoliciesInput` has been removed
- Struct `LocationsClient` has been removed
- Struct `LocationsClientCheckNameAvailabilityOptions` has been removed
- Struct `LocationsClientCheckNameAvailabilityResponse` has been removed
- Struct `LogSpecification` has been removed
- Struct `MediaService` has been removed
- Struct `MediaServiceCollection` has been removed
- Struct `MediaServiceIdentity` has been removed
- Struct `MediaServiceProperties` has been removed
- Struct `MediaServiceUpdate` has been removed
- Struct `MetricDimension` has been removed
- Struct `MetricSpecification` has been removed
- Struct `Operation` has been removed
- Struct `OperationCollection` has been removed
...
- Struct `PrivateEndpointConnectionsClientDeleteOptions` has been removed
...
- Struct `PrivateLinkResourcesClientListOptions` has been removed
- Struct `PrivateLinkResourcesClientListResponse` has been removed
...
- Struct `SyncStorageKeysInput` has been removed
- Struct `UserAssignedManagedIdentity` has been removed
- Field `UncompressedDigitalAudioOpl` of struct `ContentKeyPolicyPlayReadyPlayRight` has been removed
