...
// ExportDetailCategory - The export detail category.
type ExportDetailCategory string

const (
	ExportDetailCategoryInformation  ExportDetailCategory = "Information"
	ExportDetailCategoryNotSpecified ExportDetailCategory = "NotSpecified"
	ExportDetailCategoryRequiredStep ExportDetailCategory = "RequiredStep"
)

// PossibleExportDetailCategoryValues returns the possible values for the ExportDetailCategory const type.
func PossibleExportDetailCategoryValues() []ExportDetailCategory {
	return []ExportDetailCategory{
		ExportDetailCategoryInformation,
		ExportDetailCategoryNotSpecified,
		ExportDetailCategoryRequiredStep,
	}
}

// ExportDetailCode - The export detail code.
type ExportDetailCode string

const (
	ExportDetailCodeConnectionCloningUnsupported ExportDetailCode = "ConnectionCloningUnsupported"
	ExportDetailCodeNotSpecified                 ExportDetailCode = "NotSpecified"
)

// PossibleExportDetailCodeValues returns the possible values for the ExportDetailCode const type.
func PossibleExportDetailCodeValues() []ExportDetailCode {
	return []ExportDetailCode{
		ExportDetailCodeConnectionCloningUnsupported,
		ExportDetailCodeNotSpecified,
	}
}
...
const (
	...
	ValidationStateNotSpecified         ValidationState = "NotSpecified"
	ValidationStateSucceeded            ValidationState = "Succeeded"
	ValidationStateSucceededWithWarning ValidationState = "SucceededWithWarning"
)
...
func PossibleValidationStateValues() []ValidationState {
	return []ValidationState{
		...
		ValidationStateNotSpecified,
		ValidationStateSucceeded,
		ValidationStateSucceededWithWarning,
	}
}

// WorkflowExportOptions - The workflow export options flags. Possible options are: CloneConnections, GenerateInfrastructureTemplates
type WorkflowExportOptions string

const (
	WorkflowExportOptionsCloneConnections                                WorkflowExportOptions = "CloneConnections"
	WorkflowExportOptionsCloneConnectionsGenerateInfrastructureTemplates WorkflowExportOptions = "CloneConnections,GenerateInfrastructureTemplates"
	WorkflowExportOptionsGenerateInfrastructureTemplates                 WorkflowExportOptions = "GenerateInfrastructureTemplates"
)

// PossibleWorkflowExportOptionsValues returns the possible values for the WorkflowExportOptions const type.
func PossibleWorkflowExportOptionsValues() []WorkflowExportOptions {
	return []WorkflowExportOptions{
		WorkflowExportOptionsCloneConnections,
		WorkflowExportOptionsCloneConnectionsGenerateInfrastructureTemplates,
		WorkflowExportOptionsGenerateInfrastructureTemplates,
	}
}
