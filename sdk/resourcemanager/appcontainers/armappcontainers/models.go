...
// PatchCollection - The response of a PatchResource list resources
type PatchCollection struct {
	// REQUIRED; The PatchResource items on this page
	Value []*PatchResource
...
// PatchDetails - The details of specific patch item.
...
// PatchDetailsNewLayer - The details of new run image for the target image.
...
// PatchDetailsOldLayer - The details of old run image for the target image.
...
type PatchProperties struct {
	...
	// READ-ONLY; The status of the patch once it has been provisioned
...
// PatchResource - The resource representation of a patch.
