...
type InferenceEndpointMinimalTrackedResource struct {
	// REQUIRED; [Required]
	Location *string
	...
	// READ-ONLY; The resource URL of the entity (not URL encoded).
	ID *string

	// READ-ONLY; The name of the resource entity.
	Name *string

	// READ-ONLY; System data associated with resource provider
	SystemData *SystemData

	// READ-ONLY; The resource provider and type.
	Type *string
}

// InferenceEndpointMinimalTrackedResourceArmPaginatedResult - A paginated list of InferenceEndpoint entities.
type InferenceEndpointMinimalTrackedResourceArmPaginatedResult struct {
...
// InferenceGroup - Inference group configuration
...
type InferenceGroupMinimalTrackedResourceWithSKU struct {
	// REQUIRED; [Required]
	Location *string
...
// InferenceGroupMinimalTrackedResourceWithSKUArmPaginatedResult - A paginated list of InferenceGroup entities.
type InferenceGroupMinimalTrackedResourceWithSKUArmPaginatedResult struct {
...
type ModelProfile struct {
	// REQUIRED; [Required] The model to create a serverless endpoint of
	ModelURI *string
}
...
type ServerlessEndpointProperties struct {
	// REQUIRED; [Required] The model profile to configure the serverless endpoint with
