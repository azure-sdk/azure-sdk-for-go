...
// SQLAssessmentV2SummaryOperationsServer is a fake server for instances of the armmigrate.SQLAssessmentV2SummaryOperationsClient type.
type SQLAssessmentV2SummaryOperationsServer struct {
	...
	Get func(ctx context.Context, resourceGroupName string, projectName string, groupName string, assessmentName string, summaryName string, options *armmigrate.SQLAssessmentV2SummaryOperationsClientGetOptions) (resp azfake.Responder[armmigrate.SQLAssessmentV2SummaryOperationsClientGetResponse], errResp azfake.ErrorResponder)
	...
	// HTTP status codes to indicate success: http.StatusOK
	NewListBySQLAssessmentV2Pager func(resourceGroupName string, projectName string, groupName string, assessmentName string, options *armmigrate.SQLAssessmentV2SummaryOperationsClientListBySQLAssessmentV2Options) (resp azfake.PagerResponder[armmigrate.SQLAssessmentV2SummaryOperationsClientListBySQLAssessmentV2Response])
}
...
// The returned SQLAssessmentV2SummaryOperationsServerTransport instance is connected to an instance of armmigrate.SQLAssessmentV2SummaryOperationsClient via the
...
func NewSQLAssessmentV2SummaryOperationsServerTransport(srv *SQLAssessmentV2SummaryOperationsServer) *SQLAssessmentV2SummaryOperationsServerTransport {
	return &SQLAssessmentV2SummaryOperationsServerTransport{
		srv:                           srv,
		newListBySQLAssessmentV2Pager: newTracker[azfake.PagerResponder[armmigrate.SQLAssessmentV2SummaryOperationsClientListBySQLAssessmentV2Response]](),
	}
}

// SQLAssessmentV2SummaryOperationsServerTransport connects instances of armmigrate.SQLAssessmentV2SummaryOperationsClient to instances of SQLAssessmentV2SummaryOperationsServer.
...
type SQLAssessmentV2SummaryOperationsServerTransport struct {
	...
	newListBySQLAssessmentV2Pager *tracker[azfake.PagerResponder[armmigrate.SQLAssessmentV2SummaryOperationsClientListBySQLAssessmentV2Response]]
}
...
func (s *SQLAssessmentV2SummaryOperationsServerTransport) dispatchNewListBySQLAssessmentV2Pager(req *http.Request) (*http.Response, error) {
	...
	if newListBySQLAssessmentV2Pager == nil {
		...
		server.PagerResponderInjectNextLinks(newListBySQLAssessmentV2Pager, req, func(page *armmigrate.SQLAssessmentV2SummaryOperationsClientListBySQLAssessmentV2Response, createLink func() string) {
