...
func NewManagementClient(location string, subscriptionID string, skuName string, credential azcore.TokenCredential, options *arm.ClientOptions) (*ManagementClient, error) {
...
//     method.
func (client *ManagementClient) UsageBySubscriptionSKU(ctx context.Context, searchManagementRequestOptions *SearchManagementRequestOptions, options *ManagementClientUsageBySubscriptionSKUOptions) (ManagementClientUsageBySubscriptionSKUResponse, error) {
	var err error
	req, err := client.usageBySubscriptionSKUCreateRequest(ctx, searchManagementRequestOptions, options)
	if err != nil {
...
func (client *ManagementClient) usageBySubscriptionSKUCreateRequest(ctx context.Context, searchManagementRequestOptions *SearchManagementRequestOptions, options *ManagementClientUsageBySubscriptionSKUOptions) (*policy.Request, error) {
	...
	if client.skuName == "" {
		return nil, errors.New("parameter client.skuName cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{skuName}", url.PathEscape(client.skuName))
