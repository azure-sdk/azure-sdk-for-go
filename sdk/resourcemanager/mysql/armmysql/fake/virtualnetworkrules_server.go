...
type VirtualNetworkRulesServer struct {
	...
	BeginCreateOrUpdate func(ctx context.Context, resourceGroupName string, serverName string, virtualNetworkRuleName string, parameters armmysql.VirtualNetworkRule, options *armmysql.VirtualNetworkRulesClientBeginCreateOrUpdateOptions) (resp azfake.PollerResponder[armmysql.VirtualNetworkRulesClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)

	// BeginDelete is the fake for method VirtualNetworkRulesClient.BeginDelete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginDelete func(ctx context.Context, resourceGroupName string, serverName string, virtualNetworkRuleName string, options *armmysql.VirtualNetworkRulesClientBeginDeleteOptions) (resp azfake.PollerResponder[armmysql.VirtualNetworkRulesClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method VirtualNetworkRulesClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, serverName string, virtualNetworkRuleName string, options *armmysql.VirtualNetworkRulesClientGetOptions) (resp azfake.Responder[armmysql.VirtualNetworkRulesClientGetResponse], errResp azfake.ErrorResponder)

	// NewListByServerPager is the fake for method VirtualNetworkRulesClient.NewListByServerPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByServerPager func(resourceGroupName string, serverName string, options *armmysql.VirtualNetworkRulesClientListByServerOptions) (resp azfake.PagerResponder[armmysql.VirtualNetworkRulesClientListByServerResponse])
}
...
// The returned VirtualNetworkRulesServerTransport instance is connected to an instance of armmysql.VirtualNetworkRulesClient via the
...
func NewVirtualNetworkRulesServerTransport(srv *VirtualNetworkRulesServer) *VirtualNetworkRulesServerTransport {
	return &VirtualNetworkRulesServerTransport{
		srv:                  srv,
		beginCreateOrUpdate:  newTracker[azfake.PollerResponder[armmysql.VirtualNetworkRulesClientCreateOrUpdateResponse]](),
		beginDelete:          newTracker[azfake.PollerResponder[armmysql.VirtualNetworkRulesClientDeleteResponse]](),
		newListByServerPager: newTracker[azfake.PagerResponder[armmysql.VirtualNetworkRulesClientListByServerResponse]](),
	}
}

// VirtualNetworkRulesServerTransport connects instances of armmysql.VirtualNetworkRulesClient to instances of VirtualNetworkRulesServer.
...
type VirtualNetworkRulesServerTransport struct {
	...
	beginCreateOrUpdate  *tracker[azfake.PollerResponder[armmysql.VirtualNetworkRulesClientCreateOrUpdateResponse]]
	beginDelete          *tracker[azfake.PollerResponder[armmysql.VirtualNetworkRulesClientDeleteResponse]]
	newListByServerPager *tracker[azfake.PagerResponder[armmysql.VirtualNetworkRulesClientListByServerResponse]]
}
...
func (v *VirtualNetworkRulesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if virtualNetworkRulesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = virtualNetworkRulesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
func (v *VirtualNetworkRulesServerTransport) dispatchBeginCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginCreateOrUpdate == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.DBforMySQL/servers/(?P<serverName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/virtualNetworkRules/(?P<virtualNetworkRuleName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if matches == nil || len(matches) < 4 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
		}
		body, err := server.UnmarshalRequestAsJSON[armmysql.VirtualNetworkRule](req)
		if err != nil {
			return nil, err
		}
...
func (v *VirtualNetworkRulesServerTransport) dispatchNewListByServerPager(req *http.Request) (*http.Response, error) {
	...
	if newListByServerPager == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.DBforMySQL/servers/(?P<serverName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/virtualNetworkRules`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		...
		server.PagerResponderInjectNextLinks(newListByServerPager, req, func(page *armmysql.VirtualNetworkRulesClientListByServerResponse, createLink func() string) {
...
// set this to conditionally intercept incoming requests to VirtualNetworkRulesServerTransport
var virtualNetworkRulesServerTransportInterceptor interface {
