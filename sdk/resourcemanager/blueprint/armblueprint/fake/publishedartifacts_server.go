...
func (p *PublishedArtifactsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if publishedArtifactsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = publishedArtifactsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to PublishedArtifactsServerTransport
var publishedArtifactsServerTransportInterceptor interface {
