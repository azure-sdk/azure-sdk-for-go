...
func (client *DatabaseInstancesControllerClient) getDatabaseInstanceCreateRequest(ctx context.Context, resourceGroupName string, migrateProjectName string, databaseInstanceName string, _ *DatabaseInstancesControllerClientGetDatabaseInstanceOptions) (*policy.Request, error) {
