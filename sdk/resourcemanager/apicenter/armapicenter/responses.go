...
// AnalyzerConfigsClientCreateOrUpdateResponse contains the response from method AnalyzerConfigsClient.CreateOrUpdate.
type AnalyzerConfigsClientCreateOrUpdateResponse struct {
...
// AnalyzerConfigsClientDeleteResponse contains the response from method AnalyzerConfigsClient.Delete.
type AnalyzerConfigsClientDeleteResponse struct {
	// placeholder for future response values
}

// AnalyzerConfigsClientExportRulesetResponse contains the response from method AnalyzerConfigsClient.BeginExportRuleset.
type AnalyzerConfigsClientExportRulesetResponse struct {
	// The ruleset export result.
	RulesetExportResult
}

// AnalyzerConfigsClientGetResponse contains the response from method AnalyzerConfigsClient.Get.
type AnalyzerConfigsClientGetResponse struct {
	// API analyzer configuration.
	AnalyzerConfig
...
// AnalyzerConfigsClientImportRulesetResponse contains the response from method AnalyzerConfigsClient.BeginImportRuleset.
type AnalyzerConfigsClientImportRulesetResponse struct {
	// The current status of an async operation.
	OperationStatusResult
}

// AnalyzerConfigsClientListResponse contains the response from method AnalyzerConfigsClient.NewListPager.
type AnalyzerConfigsClientListResponse struct {
