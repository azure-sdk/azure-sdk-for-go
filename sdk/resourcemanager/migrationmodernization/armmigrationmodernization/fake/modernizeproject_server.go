...
func (m *ModernizeProjectServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if modernizeProjectServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = modernizeProjectServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to ModernizeProjectServerTransport
var modernizeProjectServerTransportInterceptor interface {
