...
// GetPrivateDNSZoneSuffixServer is a fake server for instances of the armpostgresql.GetPrivateDNSZoneSuffixClient type.
type GetPrivateDNSZoneSuffixServer struct {
	// Execute is the fake for method GetPrivateDNSZoneSuffixClient.Execute
	// HTTP status codes to indicate success: http.StatusOK
	Execute func(ctx context.Context, options *armpostgresql.GetPrivateDNSZoneSuffixClientExecuteOptions) (resp azfake.Responder[armpostgresql.GetPrivateDNSZoneSuffixClientExecuteResponse], errResp azfake.ErrorResponder)
}
...
// The returned GetPrivateDNSZoneSuffixServerTransport instance is connected to an instance of armpostgresql.GetPrivateDNSZoneSuffixClient via the
...
// GetPrivateDNSZoneSuffixServerTransport connects instances of armpostgresql.GetPrivateDNSZoneSuffixClient to instances of GetPrivateDNSZoneSuffixServer.
