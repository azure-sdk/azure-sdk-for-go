...
func (client *VmwarePropertiesControllerClient) updateDependencyMapStatusCreateRequest(ctx context.Context, resourceGroupName string, siteName string, updateMachineDepMapStatus UpdateMachineDepMapStatus, _ *VmwarePropertiesControllerClientBeginUpdateDependencyMapStatusOptions) (*policy.Request, error) {
...
func (client *VmwarePropertiesControllerClient) updatePropertiesCreateRequest(ctx context.Context, resourceGroupName string, siteName string, metaData MachineMetadataCollection, _ *VmwarePropertiesControllerClientBeginUpdatePropertiesOptions) (*policy.Request, error) {
...
func (client *VmwarePropertiesControllerClient) updateRunAsAccountCreateRequest(ctx context.Context, resourceGroupName string, siteName string, updateMachineRunAsAccount UpdateMachineRunAsAccount, _ *VmwarePropertiesControllerClientBeginUpdateRunAsAccountOptions) (*policy.Request, error) {
...
func (client *VmwarePropertiesControllerClient) updateTagsCreateRequest(ctx context.Context, resourceGroupName string, siteName string, updateMachineTags UpdateMachineTags, _ *VmwarePropertiesControllerClientBeginUpdateTagsOptions) (*policy.Request, error) {
