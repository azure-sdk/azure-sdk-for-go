...
func (b *BestPracticesVersionsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if bestPracticesVersionsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = bestPracticesVersionsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "BestPracticesVersionsClient.NewListByTenantPager":
				res.resp, res.err = b.dispatchNewListByTenantPager(req)
			default:
...
// set this to conditionally intercept incoming requests to BestPracticesVersionsServerTransport
var bestPracticesVersionsServerTransportInterceptor interface {
