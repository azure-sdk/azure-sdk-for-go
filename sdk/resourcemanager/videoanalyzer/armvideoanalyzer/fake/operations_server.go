...
// OperationsServer is a fake server for instances of the armvideoanalyzer.OperationsClient type.
type OperationsServer struct {
	// List is the fake for method OperationsClient.List
	// HTTP status codes to indicate success: http.StatusOK
	List func(ctx context.Context, options *armvideoanalyzer.OperationsClientListOptions) (resp azfake.Responder[armvideoanalyzer.OperationsClientListResponse], errResp azfake.ErrorResponder)
}

// NewOperationsServerTransport creates a new instance of OperationsServerTransport with the provided implementation.
// The returned OperationsServerTransport instance is connected to an instance of armvideoanalyzer.OperationsClient via the
// azcore.ClientOptions.Transporter field in the client's constructor parameters.
func NewOperationsServerTransport(srv *OperationsServer) *OperationsServerTransport {
	return &OperationsServerTransport{srv: srv}
}

// OperationsServerTransport connects instances of armvideoanalyzer.OperationsClient to instances of OperationsServer.
