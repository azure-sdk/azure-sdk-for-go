...
// MarshalJSON implements the json.Marshaller interface for type NetworkSecurityPerimeterProvisioningIssue.
func (n NetworkSecurityPerimeterProvisioningIssue) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "name", n.Name)
	populate(objectMap, "properties", n.Properties)
	return json.Marshal(objectMap)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type NetworkSecurityPerimeterProvisioningIssue.
func (n *NetworkSecurityPerimeterProvisioningIssue) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", n, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type NetworkSecurityPerimeterProvisioningIssueProperties.
func (n NetworkSecurityPerimeterProvisioningIssueProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type NetworkSecurityPerimeterProvisioningIssueProperties.
func (n *NetworkSecurityPerimeterProvisioningIssueProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", n, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type NetworkSecurityPerimeterResourceAssociation.
func (n NetworkSecurityPerimeterResourceAssociation) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type NetworkSecurityPerimeterResourceAssociation.
func (n *NetworkSecurityPerimeterResourceAssociation) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", n, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type NspAccessRuleSubscription.
func (n NspAccessRuleSubscription) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "id", n.ID)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type NspAccessRuleSubscription.
func (n *NspAccessRuleSubscription) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", n, err)
	}
