...
// Use a type switch to determine the concrete type.  The possible types are:
// - *AnalyticsConnectorDataSource, *AnalyticsConnectorDicomServiceDataSource, *AnalyticsConnectorFhirServiceDataSource
...
// AnalyticsConnectorDicomServiceDataSource - The DICOM service data source for Analytics Connector.
type AnalyticsConnectorDicomServiceDataSource struct {
	// REQUIRED; The API version of DICOM service.
	APIVersion *string `json:"apiVersion,omitempty"`

	// REQUIRED; Type of data source.
	Type *AnalyticsConnectorDataSourceType `json:"type,omitempty"`

	// REQUIRED; The URL of DICOM service.
...
// GetAnalyticsConnectorDataSource implements the AnalyticsConnectorDataSourceClassification interface for type AnalyticsConnectorDicomServiceDataSource.
func (a *AnalyticsConnectorDicomServiceDataSource) GetAnalyticsConnectorDataSource() *AnalyticsConnectorDataSource {
...
// AnalyticsConnectorDicomToParquetMapping - DICOM Service data mapping configuration for Analytics Connector.
type AnalyticsConnectorDicomToParquetMapping struct {
...
// GetAnalyticsConnectorMapping implements the AnalyticsConnectorMappingClassification interface for type AnalyticsConnectorDicomToParquetMapping.
func (a *AnalyticsConnectorDicomToParquetMapping) GetAnalyticsConnectorMapping() *AnalyticsConnectorMapping {
...
// Use a type switch to determine the concrete type.  The possible types are:
// - *AnalyticsConnectorDicomToParquetMapping, *AnalyticsConnectorFhirToParquetMapping, *AnalyticsConnectorMapping
...
type AnalyticsConnectorProperties struct {
	...
	SchedulerCronExpression *string `json:"schedulerCronExpression,omitempty"`
...
// AnalyticsConnectorsClientListByWorkspaceOptions contains the optional parameters for the AnalyticsConnectorsClient.NewListByWorkspacePager
// method.
