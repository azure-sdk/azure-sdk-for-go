...
// NewGetPager - Gets the price sheet for a subscription. Price sheet is available via this API only for May 1, 2014 or later.
// Generated from API version 2021-10-01
// options - PriceSheetClientGetOptions contains the optional parameters for the PriceSheetClient.Get method.
func (client *PriceSheetClient) NewGetPager(options *PriceSheetClientGetOptions) *runtime.Pager[PriceSheetClientGetResponse] {
	return runtime.NewPager(runtime.PagingHandler[PriceSheetClientGetResponse]{
		More: func(page PriceSheetClientGetResponse) bool {
			return page.NextLink != nil && len(*page.NextLink) > 0
		},
		Fetcher: func(ctx context.Context, page *PriceSheetClientGetResponse) (PriceSheetClientGetResponse, error) {
...
// NewGetByBillingPeriodPager - Get the price sheet for a scope by subscriptionId and billing period. Price sheet is available
...
// method.
func (client *PriceSheetClient) NewGetByBillingPeriodPager(billingPeriodName string, options *PriceSheetClientGetByBillingPeriodOptions) *runtime.Pager[PriceSheetClientGetByBillingPeriodResponse] {
	return runtime.NewPager(runtime.PagingHandler[PriceSheetClientGetByBillingPeriodResponse]{
		More: func(page PriceSheetClientGetByBillingPeriodResponse) bool {
			return page.NextLink != nil && len(*page.NextLink) > 0
		},
		Fetcher: func(ctx context.Context, page *PriceSheetClientGetByBillingPeriodResponse) (PriceSheetClientGetByBillingPeriodResponse, error) {
			var req *policy.Request
			var err error
			if page == nil {
