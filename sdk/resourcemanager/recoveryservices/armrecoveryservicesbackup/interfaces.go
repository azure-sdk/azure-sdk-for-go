...
// Use a type switch to determine the concrete type.  The possible types are:
// - *AzureVMWorkloadAnyDatabaseWorkloadItem, *AzureVMWorkloadItem, *AzureVMWorkloadOracleDatabaseWorkloadItem, *AzureVMWorkloadSAPAseDatabaseWorkloadItem,
// - *AzureVMWorkloadSAPAseSystemWorkloadItem, *AzureVMWorkloadSAPHanaDatabaseWorkloadItem, *AzureVMWorkloadSAPHanaSystemWorkloadItem,
...
// Use a type switch to determine the concrete type.  The possible types are:
// - *AzureVMWorkloadAnyDatabaseProtectableItem, *AzureVMWorkloadOracleDatabaseProtectableItem, *AzureVMWorkloadProtectableItem,
...
// Use a type switch to determine the concrete type.  The possible types are:
// - *AzureVMWorkloadAnyDatabaseProtectedItem, *AzureVMWorkloadOracleDatabaseProtectedItem, *AzureVMWorkloadProtectedItem,
// - *AzureVMWorkloadSAPAseDatabaseProtectedItem, *AzureVMWorkloadSAPHanaDBInstanceProtectedItem, *AzureVMWorkloadSAPHanaDatabaseProtectedItem,
...
// AzureWorkloadAnyDatabasePointInTimeRestoreRequestClassification provides polymorphic access to related types.
// Call the interface's GetAzureWorkloadAnyDatabasePointInTimeRestoreRequest() method to access the common type.
// Use a type switch to determine the concrete type.  The possible types are:
// - *AzureWorkloadAnyDatabasePointInTimeRestoreRequest, *AzureWorkloadAnyDatabasePointInTimeRestoreWithRehydrateRequest
type AzureWorkloadAnyDatabasePointInTimeRestoreRequestClassification interface {
	AzureWorkloadAnyDatabaseRestoreRequestClassification
	// GetAzureWorkloadAnyDatabasePointInTimeRestoreRequest returns the AzureWorkloadAnyDatabasePointInTimeRestoreRequest content of the underlying type.
	GetAzureWorkloadAnyDatabasePointInTimeRestoreRequest() *AzureWorkloadAnyDatabasePointInTimeRestoreRequest
}

// AzureWorkloadAnyDatabaseRestoreRequestClassification provides polymorphic access to related types.
// Call the interface's GetAzureWorkloadAnyDatabaseRestoreRequest() method to access the common type.
// Use a type switch to determine the concrete type.  The possible types are:
// - *AzureWorkloadAnyDatabasePointInTimeRestoreRequest, *AzureWorkloadAnyDatabasePointInTimeRestoreWithRehydrateRequest,
// - *AzureWorkloadAnyDatabaseRestoreRequest, *AzureWorkloadAnyDatabaseRestoreWithRehydrateRequest
type AzureWorkloadAnyDatabaseRestoreRequestClassification interface {
	AzureWorkloadRestoreRequestClassification
	// GetAzureWorkloadAnyDatabaseRestoreRequest returns the AzureWorkloadAnyDatabaseRestoreRequest content of the underlying type.
	GetAzureWorkloadAnyDatabaseRestoreRequest() *AzureWorkloadAnyDatabaseRestoreRequest
}
...
// AzureWorkloadOraclePointInTimeRestoreRequestClassification provides polymorphic access to related types.
// Call the interface's GetAzureWorkloadOraclePointInTimeRestoreRequest() method to access the common type.
// Use a type switch to determine the concrete type.  The possible types are:
// - *AzureWorkloadOraclePointInTimeRestoreRequest, *AzureWorkloadOraclePointInTimeRestoreWithRehydrateRequest
type AzureWorkloadOraclePointInTimeRestoreRequestClassification interface {
	AzureWorkloadOracleRestoreRequestClassification
	// GetAzureWorkloadOraclePointInTimeRestoreRequest returns the AzureWorkloadOraclePointInTimeRestoreRequest content of the underlying type.
	GetAzureWorkloadOraclePointInTimeRestoreRequest() *AzureWorkloadOraclePointInTimeRestoreRequest
}

// AzureWorkloadOracleRestoreRequestClassification provides polymorphic access to related types.
// Call the interface's GetAzureWorkloadOracleRestoreRequest() method to access the common type.
// Use a type switch to determine the concrete type.  The possible types are:
// - *AzureWorkloadOraclePointInTimeRestoreRequest, *AzureWorkloadOraclePointInTimeRestoreWithRehydrateRequest, *AzureWorkloadOracleRestoreRequest,
// - *AzureWorkloadOracleRestoreWithRehydrateRequest
type AzureWorkloadOracleRestoreRequestClassification interface {
	AzureWorkloadRestoreRequestClassification
	// GetAzureWorkloadOracleRestoreRequest returns the AzureWorkloadOracleRestoreRequest content of the underlying type.
	GetAzureWorkloadOracleRestoreRequest() *AzureWorkloadOracleRestoreRequest
}
...
// Use a type switch to determine the concrete type.  The possible types are:
// - *AzureWorkloadAnyDatabasePointInTimeRecoveryPoint, *AzureWorkloadOraclePointInTimeRecoveryPoint, *AzureWorkloadPointInTimeRecoveryPoint,
...
// Use a type switch to determine the concrete type.  The possible types are:
// - *AzureWorkloadAnyDatabasePointInTimeRecoveryPoint, *AzureWorkloadAnyDatabaseRecoveryPoint, *AzureWorkloadOraclePointInTimeRecoveryPoint,
// - *AzureWorkloadOracleRecoveryPoint, *AzureWorkloadPointInTimeRecoveryPoint, *AzureWorkloadRecoveryPoint, *AzureWorkloadSAPAsePointInTimeRecoveryPoint,
...
// Use a type switch to determine the concrete type.  The possible types are:
// - *AzureWorkloadAnyDatabasePointInTimeRestoreRequest, *AzureWorkloadAnyDatabasePointInTimeRestoreWithRehydrateRequest,
// - *AzureWorkloadAnyDatabaseRestoreRequest, *AzureWorkloadAnyDatabaseRestoreWithRehydrateRequest, *AzureWorkloadOraclePointInTimeRestoreRequest,
// - *AzureWorkloadOraclePointInTimeRestoreWithRehydrateRequest, *AzureWorkloadOracleRestoreRequest, *AzureWorkloadOracleRestoreWithRehydrateRequest,
// - *AzureWorkloadPointInTimeRestoreRequest, *AzureWorkloadRestoreRequest, *AzureWorkloadSAPAsePointInTimeRestoreRequest,
// - *AzureWorkloadSAPAsePointInTimeRestoreWithRehydrateRequest, *AzureWorkloadSAPAseRestoreRequest, *AzureWorkloadSAPAseRestoreWithRehydrateRequest,
...
// - *AzureWorkloadSAPHanaRestoreWithRehydrateRequest, *AzureWorkloadSQLPointInTimeRestoreRequest, *AzureWorkloadSQLPointInTimeRestoreWithRehydrateRequest,
...
// AzureWorkloadSAPAsePointInTimeRestoreRequestClassification provides polymorphic access to related types.
// Call the interface's GetAzureWorkloadSAPAsePointInTimeRestoreRequest() method to access the common type.
// Use a type switch to determine the concrete type.  The possible types are:
// - *AzureWorkloadSAPAsePointInTimeRestoreRequest, *AzureWorkloadSAPAsePointInTimeRestoreWithRehydrateRequest
type AzureWorkloadSAPAsePointInTimeRestoreRequestClassification interface {
	AzureWorkloadSAPAseRestoreRequestClassification
	// GetAzureWorkloadSAPAsePointInTimeRestoreRequest returns the AzureWorkloadSAPAsePointInTimeRestoreRequest content of the underlying type.
	GetAzureWorkloadSAPAsePointInTimeRestoreRequest() *AzureWorkloadSAPAsePointInTimeRestoreRequest
}
...
// Use a type switch to determine the concrete type.  The possible types are:
// - *AzureWorkloadSAPAsePointInTimeRestoreRequest, *AzureWorkloadSAPAsePointInTimeRestoreWithRehydrateRequest, *AzureWorkloadSAPAseRestoreRequest,
...
// - *AzureSQLProtectedItem, *AzureVMWorkloadAnyDatabaseProtectedItem, *AzureVMWorkloadOracleDatabaseProtectedItem, *AzureVMWorkloadProtectedItem,
// - *AzureVMWorkloadSAPAseDatabaseProtectedItem, *AzureVMWorkloadSAPHanaDBInstanceProtectedItem, *AzureVMWorkloadSAPHanaDatabaseProtectedItem,
...
// Use a type switch to determine the concrete type.  The possible types are:
// - *AzureFileShareRecoveryPoint, *AzureWorkloadAnyDatabasePointInTimeRecoveryPoint, *AzureWorkloadAnyDatabaseRecoveryPoint,
// - *AzureWorkloadOraclePointInTimeRecoveryPoint, *AzureWorkloadOracleRecoveryPoint, *AzureWorkloadPointInTimeRecoveryPoint,
// - *AzureWorkloadRecoveryPoint, *AzureWorkloadSAPAsePointInTimeRecoveryPoint, *AzureWorkloadSAPAseRecoveryPoint, *AzureWorkloadSAPHanaPointInTimeRecoveryPoint,
...
// Use a type switch to determine the concrete type.  The possible types are:
// - *AzureFileShareRestoreRequest, *AzureWorkloadAnyDatabasePointInTimeRestoreRequest, *AzureWorkloadAnyDatabasePointInTimeRestoreWithRehydrateRequest,
// - *AzureWorkloadAnyDatabaseRestoreRequest, *AzureWorkloadAnyDatabaseRestoreWithRehydrateRequest, *AzureWorkloadOraclePointInTimeRestoreRequest,
// - *AzureWorkloadOraclePointInTimeRestoreWithRehydrateRequest, *AzureWorkloadOracleRestoreRequest, *AzureWorkloadOracleRestoreWithRehydrateRequest,
// - *AzureWorkloadPointInTimeRestoreRequest, *AzureWorkloadRestoreRequest, *AzureWorkloadSAPAsePointInTimeRestoreRequest,
// - *AzureWorkloadSAPAsePointInTimeRestoreWithRehydrateRequest, *AzureWorkloadSAPAseRestoreRequest, *AzureWorkloadSAPAseRestoreWithRehydrateRequest,
...
// - *AzureVMWorkloadAnyDatabaseWorkloadItem, *AzureVMWorkloadItem, *AzureVMWorkloadOracleDatabaseWorkloadItem, *AzureVMWorkloadSAPAseDatabaseWorkloadItem,
// - *AzureVMWorkloadSAPAseSystemWorkloadItem, *AzureVMWorkloadSAPHanaDatabaseWorkloadItem, *AzureVMWorkloadSAPHanaSystemWorkloadItem,
// - *AzureVMWorkloadSQLDatabaseWorkloadItem, *AzureVMWorkloadSQLInstanceWorkloadItem, *WorkloadItem
...
// Use a type switch to determine the concrete type.  The possible types are:
// - *AzureFileShareProtectableItem, *AzureIaaSClassicComputeVMProtectableItem, *AzureIaaSComputeVMProtectableItem, *AzureVMWorkloadAnyDatabaseProtectableItem,
// - *AzureVMWorkloadOracleDatabaseProtectableItem, *AzureVMWorkloadProtectableItem, *AzureVMWorkloadSAPAseSystemProtectableItem,
