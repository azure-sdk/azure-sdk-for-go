...
type ServerFactory struct {
	...
	// FeatureServer contains the fakes for client FeatureClient
	FeatureServer FeatureServer

	// SubscriptionFeatureRegistrationsServer contains the fakes for client SubscriptionFeatureRegistrationsClient
