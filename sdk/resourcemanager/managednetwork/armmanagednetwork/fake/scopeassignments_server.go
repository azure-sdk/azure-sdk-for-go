...
func (s *ScopeAssignmentsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if scopeAssignmentsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = scopeAssignmentsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to ScopeAssignmentsServerTransport
var scopeAssignmentsServerTransportInterceptor interface {
