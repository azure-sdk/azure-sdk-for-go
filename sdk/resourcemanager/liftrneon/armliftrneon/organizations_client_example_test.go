...
func ExampleOrganizationsClient_BeginCreateOrUpdate() {
	...
	clientFactory, err := armliftrneon.NewClientFactory("1178323D-8270-4757-B639-D528B6266487", cred, nil)
	if err != nil {
		log.Fatalf("failed to create client: %v", err)
	}
	poller, err := clientFactory.NewOrganizationsClient().BeginCreateOrUpdate(ctx, "rgneon", "XB-.:", armliftrneon.OrganizationResource{
		Properties: &armliftrneon.OrganizationProperties{
			MarketplaceDetails: &armliftrneon.MarketplaceDetails{
				SubscriptionID:     to.Ptr("yxmkfivp"),
				SubscriptionStatus: to.Ptr(armliftrneon.MarketplaceSubscriptionStatusPendingFulfillmentStart),
				OfferDetails: &armliftrneon.OfferDetails{
			...
			UserDetails: &armliftrneon.UserDetails{
			...
			CompanyDetails: &armliftrneon.CompanyDetails{
			...
			PartnerOrganizationProperties: &armliftrneon.PartnerOrganizationProperties{
				OrganizationID:   to.Ptr("nrhvoqzulowcunhmvwfgjcaibvwcl"),
				OrganizationName: to.Ptr("2__.-"),
				SingleSignOnProperties: &armliftrneon.SingleSignOnProperties{
					SingleSignOnState: to.Ptr(armliftrneon.SingleSignOnStatesInitial),
	...
	// res = armliftrneon.OrganizationsClientCreateOrUpdateResponse{
	// 	OrganizationResource: &armliftrneon.OrganizationResource{
	// 		Properties: &armliftrneon.OrganizationProperties{
	// 			MarketplaceDetails: &armliftrneon.MarketplaceDetails{
	// 				SubscriptionID: to.Ptr("yxmkfivp"),
	// 				SubscriptionStatus: to.Ptr(armliftrneon.MarketplaceSubscriptionStatusPendingFulfillmentStart),
	...
	// 				NumberOfEmployees: to.Ptr[int64](23),
	// 			},
	// 			ProvisioningState: to.Ptr(armliftrneon.ResourceProvisioningStateSucceeded),
	// 			PartnerOrganizationProperties: &armliftrneon.PartnerOrganizationProperties{
	// 				OrganizationID: to.Ptr("nrhvoqzulowcunhmvwfgjcaibvwcl"),
	// 				OrganizationName: to.Ptr("2__.-"),
	// 				SingleSignOnProperties: &armliftrneon.SingleSignOnProperties{
	...
	// 		SystemData: &armliftrneon.SystemData{
	// 			CreatedBy: to.Ptr("qfhekdgpvdtqcohjhvlyhzd"),
	// 			CreatedByType: to.Ptr(armliftrneon.CreatedByTypeUser),
	...
	// 			LastModifiedByType: to.Ptr(armliftrneon.CreatedByTypeUser),
...
func ExampleOrganizationsClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armliftrneon.OrganizationsClientGetResponse{
	// 	OrganizationResource: &armliftrneon.OrganizationResource{
	// 		Properties: &armliftrneon.OrganizationProperties{
	// 			MarketplaceDetails: &armliftrneon.MarketplaceDetails{
	// 				SubscriptionID: to.Ptr("yxmkfivp"),
...
func ExampleOrganizationsClient_NewListByResourceGroupPager() {
	...
	for pager.More() {
		...
		// page = armliftrneon.OrganizationsClientListByResourceGroupResponse{
		// 	OrganizationResourceListResult: armliftrneon.OrganizationResourceListResult{
		// 		Value: []*armliftrneon.OrganizationResource{
		// 			{
		// 				Properties: &armliftrneon.OrganizationProperties{
		// 					MarketplaceDetails: &armliftrneon.MarketplaceDetails{
		// 						SubscriptionID: to.Ptr("yxmkfivp"),
...
func ExampleOrganizationsClient_NewListBySubscriptionPager() {
	...
	for pager.More() {
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armliftrneon.OrganizationsClientListBySubscriptionResponse{
		// 	OrganizationResourceListResult: armliftrneon.OrganizationResourceListResult{
		// 		Value: []*armliftrneon.OrganizationResource{
		// 			{
		// 				Properties: &armliftrneon.OrganizationProperties{
...
func ExampleOrganizationsClient_BeginUpdate() {
	...
	poller, err := clientFactory.NewOrganizationsClient().BeginUpdate(ctx, "rgneon", "eRY-J_:", armliftrneon.OrganizationResource{
		Properties: &armliftrneon.OrganizationProperties{
			UserDetails: &armliftrneon.UserDetails{
				FirstName:    to.Ptr("buwwe"),
				LastName:     to.Ptr("escynjpynkoox"),
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armliftrneon.OrganizationsClientUpdateResponse{
	// 	OrganizationResource: &armliftrneon.OrganizationResource{
	// 		Properties: &armliftrneon.OrganizationProperties{
	// 			MarketplaceDetails: &armliftrneon.MarketplaceDetails{
	// 				SubscriptionID: to.Ptr("yxmkfivp"),
