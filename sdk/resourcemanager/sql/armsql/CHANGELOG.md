...
- Type alias `ManagedInstancePropertiesProvisioningState` has been removed
...
- Field `JobExecution` of struct `JobStepExecutionsClientGetResponse` has been removed
- Field `JobExecutionListResult` of struct `JobStepExecutionsClientListByJobExecutionResponse` has been removed
- Field `JobExecution` of struct `JobTargetExecutionsClientGetResponse` has been removed
- Field `JobExecutionListResult` of struct `JobTargetExecutionsClientListByJobExecutionResponse` has been removed
- Field `JobExecutionListResult` of struct `JobTargetExecutionsClientListByStepResponse` has been removed
...
- New struct `JobExecutionAutoGenerated`
- New struct `JobExecutionAutoGenerated2`
- New struct `JobExecutionListResultAutoGenerated`
- New struct `JobExecutionListResultAutoGenerated2`
- New struct `JobExecutionPropertiesAutoGenerated`
- New struct `JobExecutionPropertiesAutoGenerated2`
...
- New anonymous field `JobExecutionAutoGenerated` in struct `JobStepExecutionsClientGetResponse`
- New anonymous field `JobExecutionListResultAutoGenerated` in struct `JobStepExecutionsClientListByJobExecutionResponse`
- New anonymous field `JobExecutionAutoGenerated2` in struct `JobTargetExecutionsClientGetResponse`
- New anonymous field `JobExecutionListResultAutoGenerated2` in struct `JobTargetExecutionsClientListByJobExecutionResponse`
- New anonymous field `JobExecutionListResultAutoGenerated2` in struct `JobTargetExecutionsClientListByStepResponse`
