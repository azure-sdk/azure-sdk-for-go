...
- Field `Condition`, `ConditionVersion` of struct `Permission` has been removed
- Field `SkipToken` of struct `RoleAssignmentsClientListForScopeOptions` has been removed
...
- New function `*RoleAssignmentsClient.Validate(context.Context, string, string, RoleAssignmentCreateParameters, *RoleAssignmentsClientValidateOptions) (RoleAssignmentsClientValidateResponse, error)`
- New function `*RoleAssignmentsClient.ValidateByID(context.Context, string, RoleAssignmentCreateParameters, *RoleAssignmentsClientValidateByIDOptions) (RoleAssignmentsClientValidateByIDResponse, error)`
