...
// ClientDppResourceGuardProxyDeleteResponse contains the response from method Client.DppResourceGuardProxyDelete.
type ClientDppResourceGuardProxyDeleteResponse struct {
	// placeholder for future response values
}

// ClientDppResourceGuardProxyGetResponse contains the response from method Client.DppResourceGuardProxyGet.
type ClientDppResourceGuardProxyGetResponse struct {
	ResourceGuardProxyBaseResource
}

// ClientDppResourceGuardProxyListResponse contains the response from method Client.DppResourceGuardProxyList.
type ClientDppResourceGuardProxyListResponse struct {
	ResourceGuardProxyBaseResourceList
}

// ClientDppResourceGuardProxyPutResponse contains the response from method Client.DppResourceGuardProxyPut.
type ClientDppResourceGuardProxyPutResponse struct {
	ResourceGuardProxyBaseResource
}

// ClientDppResourceGuardProxyUnlockDeleteResponse contains the response from method Client.DppResourceGuardProxyUnlockDelete.
type ClientDppResourceGuardProxyUnlockDeleteResponse struct {
