...
// BuildSettingProperties - Properties of a build setting
type BuildSettingProperties struct {
	// REQUIRED; build setting type
	Type *string

	// Sensitive properties for the APM
	Secrets *BuildSettingPropertiesSecrets

	// READ-ONLY; State of the build setting.
	ProvisioningState *BuildSettingProvisioningState
}

// BuildSettingPropertiesSecrets - Sensitive properties for the APM
type BuildSettingPropertiesSecrets struct {
...
// BuildSettingReference - A reference to the build setting
type BuildSettingReference struct {
	// REQUIRED; Resource id of the build setting
	ResourceID *string
}

// BuildSettingResource - Build setting resource object
type BuildSettingResource struct {
...
// BuildSettingResourceCollection - Object that includes an array of build setting resources and a possible link for next
// set
type BuildSettingResourceCollection struct {
	// URL client should use to fetch the next page (per server side paging). It's null for now, added for future use.
	NextLink *string
...
// JobResourceRequests - Job resource request payload
...
// SupportedBuildSettingType - Supported build setting type
type SupportedBuildSettingType struct {
	// The name of the supported build setting type
	Name *string
}

// SupportedBuildSettingTypes - Supported build setting types payload
type SupportedBuildSettingTypes struct {
	// URL client should use to fetch the next page (per server side paging). It's null for now, added for future use.
	NextLink *string
