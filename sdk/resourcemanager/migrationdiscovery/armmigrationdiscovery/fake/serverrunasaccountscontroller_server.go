...
// ServerRunAsAccountsControllerServer is a fake server for instances of the armmigrationdiscovery.ServerRunAsAccountsControllerClient type.
type ServerRunAsAccountsControllerServer struct {
	...
	Get func(ctx context.Context, resourceGroupName string, siteName string, accountName string, options *armmigrationdiscovery.ServerRunAsAccountsControllerClientGetOptions) (resp azfake.Responder[armmigrationdiscovery.ServerRunAsAccountsControllerClientGetResponse], errResp azfake.ErrorResponder)
	...
	// HTTP status codes to indicate success: http.StatusOK
	NewListByServerSiteResourcePager func(resourceGroupName string, siteName string, options *armmigrationdiscovery.ServerRunAsAccountsControllerClientListByServerSiteResourceOptions) (resp azfake.PagerResponder[armmigrationdiscovery.ServerRunAsAccountsControllerClientListByServerSiteResourceResponse])
}
...
// The returned ServerRunAsAccountsControllerServerTransport instance is connected to an instance of armmigrationdiscovery.ServerRunAsAccountsControllerClient via the
...
func NewServerRunAsAccountsControllerServerTransport(srv *ServerRunAsAccountsControllerServer) *ServerRunAsAccountsControllerServerTransport {
	return &ServerRunAsAccountsControllerServerTransport{
		srv:                              srv,
		newListByServerSiteResourcePager: newTracker[azfake.PagerResponder[armmigrationdiscovery.ServerRunAsAccountsControllerClientListByServerSiteResourceResponse]](),
	}
}

// ServerRunAsAccountsControllerServerTransport connects instances of armmigrationdiscovery.ServerRunAsAccountsControllerClient to instances of ServerRunAsAccountsControllerServer.
...
type ServerRunAsAccountsControllerServerTransport struct {
	...
	newListByServerSiteResourcePager *tracker[azfake.PagerResponder[armmigrationdiscovery.ServerRunAsAccountsControllerClientListByServerSiteResourceResponse]]
}
...
func (s *ServerRunAsAccountsControllerServerTransport) dispatchNewListByServerSiteResourcePager(req *http.Request) (*http.Response, error) {
	...
	if newListByServerSiteResourcePager == nil {
		...
		server.PagerResponderInjectNextLinks(newListByServerSiteResourcePager, req, func(page *armmigrationdiscovery.ServerRunAsAccountsControllerClientListByServerSiteResourceResponse, createLink func() string) {
