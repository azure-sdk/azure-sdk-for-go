...
func (z *ZonesServerTransport) Do(req *http.Request) (*http.Response, error) {
	...
	return z.dispatchToMethodFake(req, method)
}

func (z *ZonesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if zonesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = zonesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			case "ZonesClient.CreateOrUpdate":
				res.resp, res.err = z.dispatchCreateOrUpdate(req)
			case "ZonesClient.BeginDelete":
				res.resp, res.err = z.dispatchBeginDelete(req)
			case "ZonesClient.Get":
				res.resp, res.err = z.dispatchGet(req)
			case "ZonesClient.NewListPager":
				res.resp, res.err = z.dispatchNewListPager(req)
			case "ZonesClient.NewListByResourceGroupPager":
				res.resp, res.err = z.dispatchNewListByResourceGroupPager(req)
			case "ZonesClient.Update":
				res.resp, res.err = z.dispatchUpdate(req)
			default:
...
// set this to conditionally intercept incoming requests to ZonesServerTransport
var zonesServerTransportInterceptor interface {
