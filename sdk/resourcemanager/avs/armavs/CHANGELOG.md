...
- New function `*AddonsClient.NewListByPrivateCloudPager(string, string, *AddonsClientListByPrivateCloudOptions) *runtime.Pager[AddonsClientListByPrivateCloudResponse]`
- New function `*AuthorizationsClient.NewListByPrivateCloudPager(string, string, *AuthorizationsClientListByPrivateCloudOptions) *runtime.Pager[AuthorizationsClientListByPrivateCloudResponse]`
...
- New function `*CloudLinksClient.NewListByPrivateCloudPager(string, string, *CloudLinksClientListByPrivateCloudOptions) *runtime.Pager[CloudLinksClientListByPrivateCloudResponse]`
- New function `*ClustersClient.NewListByPrivateCloudPager(string, string, *ClustersClientListByPrivateCloudOptions) *runtime.Pager[ClustersClientListByPrivateCloudResponse]`
- New function `*DatastoresClient.NewListByClusterPager(string, string, string, *DatastoresClientListByClusterOptions) *runtime.Pager[DatastoresClientListByClusterResponse]`
- New function `*GlobalReachConnectionsClient.NewListByPrivateCloudPager(string, string, *GlobalReachConnectionsClientListByPrivateCloudOptions) *runtime.Pager[GlobalReachConnectionsClientListByPrivateCloudResponse]`
- New function `*HcxEnterpriseSitesClient.NewListByPrivateCloudPager(string, string, *HcxEnterpriseSitesClientListByPrivateCloudOptions) *runtime.Pager[HcxEnterpriseSitesClientListByPrivateCloudResponse]`
...
- New function `*PlacementPoliciesClient.NewListByClusterPager(string, string, string, *PlacementPoliciesClientListByClusterOptions) *runtime.Pager[PlacementPoliciesClientListByClusterResponse]`
- New function `*PrivateCloudsClient.NewListByResourceGroupPager(string, *PrivateCloudsClientListByResourceGroupOptions) *runtime.Pager[PrivateCloudsClientListByResourceGroupResponse]`
- New function `*ScriptCmdletsClient.NewListByScriptPackagePager(string, string, string, *ScriptCmdletsClientListByScriptPackageOptions) *runtime.Pager[ScriptCmdletsClientListByScriptPackageResponse]`
- New function `*ScriptExecutionsClient.NewListByPrivateCloudPager(string, string, *ScriptExecutionsClientListByPrivateCloudOptions) *runtime.Pager[ScriptExecutionsClientListByPrivateCloudResponse]`
- New function `*ScriptPackagesClient.NewListByPrivateCloudPager(string, string, *ScriptPackagesClientListByPrivateCloudOptions) *runtime.Pager[ScriptPackagesClientListByPrivateCloudResponse]`
- New function `*VMVMPlacementPolicyProperties.GetPlacementPolicyProperties() *PlacementPolicyProperties`
- New function `*VirtualMachinesClient.NewListByClusterPager(string, string, string, *VirtualMachinesClientListByClusterOptions) *runtime.Pager[VirtualMachinesClientListByClusterResponse]`
...
- New function `*WorkloadNetworkDNSServicesClient.NewListByWorkloadNetworkPager(string, string, *WorkloadNetworkDNSServicesClientListByWorkloadNetworkOptions) *runtime.Pager[WorkloadNetworkDNSServicesClientListByWorkloadNetworkResponse]`
...
- New function `*WorkloadNetworkDNSZonesClient.NewListByWorkloadNetworkPager(string, string, *WorkloadNetworkDNSZonesClientListByWorkloadNetworkOptions) *runtime.Pager[WorkloadNetworkDNSZonesClientListByWorkloadNetworkResponse]`
...
- New function `*WorkloadNetworkDhcpConfigurationsClient.NewListByWorkloadNetworkPager(string, string, *WorkloadNetworkDhcpConfigurationsClientListByWorkloadNetworkOptions) *runtime.Pager[WorkloadNetworkDhcpConfigurationsClientListByWorkloadNetworkResponse]`
...
- New function `*WorkloadNetworkGatewaysClient.NewListByWorkloadNetworkPager(string, string, *WorkloadNetworkGatewaysClientListByWorkloadNetworkOptions) *runtime.Pager[WorkloadNetworkGatewaysClientListByWorkloadNetworkResponse]`
...
- New function `*WorkloadNetworkPortMirroringProfilesClient.NewListByWorkloadNetworkPager(string, string, *WorkloadNetworkPortMirroringProfilesClientListByWorkloadNetworkOptions) *runtime.Pager[WorkloadNetworkPortMirroringProfilesClientListByWorkloadNetworkResponse]`
...
- New function `*WorkloadNetworkPublicIPsClient.NewListByWorkloadNetworkPager(string, string, *WorkloadNetworkPublicIPsClientListByWorkloadNetworkOptions) *runtime.Pager[WorkloadNetworkPublicIPsClientListByWorkloadNetworkResponse]`
...
- New function `*WorkloadNetworkSegmentsClient.NewListByWorkloadNetworkPager(string, string, *WorkloadNetworkSegmentsClientListByWorkloadNetworkOptions) *runtime.Pager[WorkloadNetworkSegmentsClientListByWorkloadNetworkResponse]`
...
- New function `*WorkloadNetworkVMGroupsClient.NewListByWorkloadNetworkPager(string, string, *WorkloadNetworkVMGroupsClientListByWorkloadNetworkOptions) *runtime.Pager[WorkloadNetworkVMGroupsClientListByWorkloadNetworkResponse]`
...
- New function `*WorkloadNetworkVirtualMachinesClient.NewListByWorkloadNetworkPager(string, string, *WorkloadNetworkVirtualMachinesClientListByWorkloadNetworkOptions) *runtime.Pager[WorkloadNetworkVirtualMachinesClientListByWorkloadNetworkResponse]`
- New function `*WorkloadNetworksClient.NewListByPrivateCloudPager(string, string, *WorkloadNetworksClientListByPrivateCloudOptions) *runtime.Pager[WorkloadNetworksClientListByPrivateCloudResponse]`
