...
func (s *SimPoliciesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if simPoliciesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = simPoliciesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "SimPoliciesClient.NewListByMobileNetworkPager":
				res.resp, res.err = s.dispatchNewListByMobileNetworkPager(req)
...
// set this to conditionally intercept incoming requests to SimPoliciesServerTransport
var simPoliciesServerTransportInterceptor interface {
