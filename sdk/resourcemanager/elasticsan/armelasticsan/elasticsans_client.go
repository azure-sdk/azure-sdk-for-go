...
func (client *ElasticSansClient) BeginCreate(ctx context.Context, resourceGroupName string, elasticSanName string, parameters CreateParameter, options *ElasticSansClientBeginCreateOptions) (*runtime.Poller[ElasticSansClientCreateResponse], error) {
...
//
// Generated from API version 2023-01-01
func (client *ElasticSansClient) create(ctx context.Context, resourceGroupName string, elasticSanName string, parameters CreateParameter, options *ElasticSansClientBeginCreateOptions) (*http.Response, error) {
...
func (client *ElasticSansClient) createCreateRequest(ctx context.Context, resourceGroupName string, elasticSanName string, parameters CreateParameter, options *ElasticSansClientBeginCreateOptions) (*policy.Request, error) {
