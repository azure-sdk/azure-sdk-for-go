...
// NewListPager - Gets a list of all virtual machine image versions for the specified location, edge zone, publisher, offer,
// and SKU.
//
// Generated from API version 2024-07-01
//   - location - The name of Azure region.
...
//   - offer - A valid image publisher offer.
//   - skus - A valid image SKU.
//   - options - VirtualMachineImagesEdgeZoneClientListOptions contains the optional parameters for the VirtualMachineImagesEdgeZoneClient.NewListPager
//     method.
func (client *VirtualMachineImagesEdgeZoneClient) NewListPager(location string, edgeZone string, publisherName string, offer string, skus string, options *VirtualMachineImagesEdgeZoneClientListOptions) *runtime.Pager[VirtualMachineImagesEdgeZoneClientListResponse] {
	return runtime.NewPager(runtime.PagingHandler[VirtualMachineImagesEdgeZoneClientListResponse]{
		More: func(page VirtualMachineImagesEdgeZoneClientListResponse) bool {
			return page.NextLink != nil && len(*page.NextLink) > 0
		},
		Fetcher: func(ctx context.Context, page *VirtualMachineImagesEdgeZoneClientListResponse) (VirtualMachineImagesEdgeZoneClientListResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "VirtualMachineImagesEdgeZoneClient.NewListPager")
			nextLink := ""
			if page != nil {
				nextLink = *page.NextLink
			}
			resp, err := runtime.FetcherForNextLink(ctx, client.internal.Pipeline(), nextLink, func(ctx context.Context) (*policy.Request, error) {
				return client.listCreateRequest(ctx, location, edgeZone, publisherName, offer, skus, options)
			}, nil)
			if err != nil {
...
func (client *VirtualMachineImagesEdgeZoneClient) listHandleResponse(resp *http.Response) (VirtualMachineImagesEdgeZoneClientListResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.PagedVirtualMachineImageResource); err != nil {
		return VirtualMachineImagesEdgeZoneClientListResponse{}, err
	}
	return result, nil
}

// NewListOffersPager - Gets a list of virtual machine image offers for the specified location, edge zone and publisher.
//
// Generated from API version 2024-07-01
//   - location - The name of Azure region.
//   - edgeZone - The name of the edge zone.
//   - publisherName - A valid image publisher.
//   - options - VirtualMachineImagesEdgeZoneClientListOffersOptions contains the optional parameters for the VirtualMachineImagesEdgeZoneClient.NewListOffersPager
//     method.
func (client *VirtualMachineImagesEdgeZoneClient) NewListOffersPager(location string, edgeZone string, publisherName string, options *VirtualMachineImagesEdgeZoneClientListOffersOptions) *runtime.Pager[VirtualMachineImagesEdgeZoneClientListOffersResponse] {
	return runtime.NewPager(runtime.PagingHandler[VirtualMachineImagesEdgeZoneClientListOffersResponse]{
		More: func(page VirtualMachineImagesEdgeZoneClientListOffersResponse) bool {
			return page.NextLink != nil && len(*page.NextLink) > 0
		},
		Fetcher: func(ctx context.Context, page *VirtualMachineImagesEdgeZoneClientListOffersResponse) (VirtualMachineImagesEdgeZoneClientListOffersResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "VirtualMachineImagesEdgeZoneClient.NewListOffersPager")
			nextLink := ""
			if page != nil {
				nextLink = *page.NextLink
			}
			resp, err := runtime.FetcherForNextLink(ctx, client.internal.Pipeline(), nextLink, func(ctx context.Context) (*policy.Request, error) {
				return client.listOffersCreateRequest(ctx, location, edgeZone, publisherName, options)
			}, nil)
			if err != nil {
...
// NewListPublishersPager - Gets a list of virtual machine image publishers for the specified Azure location and edge zone.
//
// Generated from API version 2024-07-01
//   - location - The name of Azure region.
//   - edgeZone - The name of the edge zone.
//   - options - VirtualMachineImagesEdgeZoneClientListPublishersOptions contains the optional parameters for the VirtualMachineImagesEdgeZoneClient.NewListPublishersPager
//     method.
func (client *VirtualMachineImagesEdgeZoneClient) NewListPublishersPager(location string, edgeZone string, options *VirtualMachineImagesEdgeZoneClientListPublishersOptions) *runtime.Pager[VirtualMachineImagesEdgeZoneClientListPublishersResponse] {
	return runtime.NewPager(runtime.PagingHandler[VirtualMachineImagesEdgeZoneClientListPublishersResponse]{
		More: func(page VirtualMachineImagesEdgeZoneClientListPublishersResponse) bool {
			return page.NextLink != nil && len(*page.NextLink) > 0
		},
		Fetcher: func(ctx context.Context, page *VirtualMachineImagesEdgeZoneClientListPublishersResponse) (VirtualMachineImagesEdgeZoneClientListPublishersResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "VirtualMachineImagesEdgeZoneClient.NewListPublishersPager")
			nextLink := ""
			if page != nil {
				nextLink = *page.NextLink
			}
			resp, err := runtime.FetcherForNextLink(ctx, client.internal.Pipeline(), nextLink, func(ctx context.Context) (*policy.Request, error) {
				return client.listPublishersCreateRequest(ctx, location, edgeZone, options)
			}, nil)
			if err != nil {
...
// NewListSKUsPager - Gets a list of virtual machine image SKUs for the specified location, edge zone, publisher, and offer.
//
// Generated from API version 2024-07-01
//   - location - The name of Azure region.
//   - edgeZone - The name of the edge zone.
//   - publisherName - A valid image publisher.
//   - offer - A valid image publisher offer.
//   - options - VirtualMachineImagesEdgeZoneClientListSKUsOptions contains the optional parameters for the VirtualMachineImagesEdgeZoneClient.NewListSKUsPager
//     method.
func (client *VirtualMachineImagesEdgeZoneClient) NewListSKUsPager(location string, edgeZone string, publisherName string, offer string, options *VirtualMachineImagesEdgeZoneClientListSKUsOptions) *runtime.Pager[VirtualMachineImagesEdgeZoneClientListSKUsResponse] {
	return runtime.NewPager(runtime.PagingHandler[VirtualMachineImagesEdgeZoneClientListSKUsResponse]{
		More: func(page VirtualMachineImagesEdgeZoneClientListSKUsResponse) bool {
			return page.NextLink != nil && len(*page.NextLink) > 0
		},
		Fetcher: func(ctx context.Context, page *VirtualMachineImagesEdgeZoneClientListSKUsResponse) (VirtualMachineImagesEdgeZoneClientListSKUsResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "VirtualMachineImagesEdgeZoneClient.NewListSKUsPager")
			nextLink := ""
			if page != nil {
				nextLink = *page.NextLink
			}
			resp, err := runtime.FetcherForNextLink(ctx, client.internal.Pipeline(), nextLink, func(ctx context.Context) (*policy.Request, error) {
				return client.listSKUsCreateRequest(ctx, location, edgeZone, publisherName, offer, options)
			}, nil)
			if err != nil {
