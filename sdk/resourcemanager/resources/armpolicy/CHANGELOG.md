...
- New function `*TokensClient.BeginAcquire(context.Context, TokenRequest, *TokensClientBeginAcquireOptions) (*runtime.Poller[TokensClientAcquireResponse], error)`
...
- New field `AssignmentType`, `DefinitionVersion`, `EffectiveDefinitionVersion`, `InstanceID`, `LatestDefinitionVersion` in struct `AssignmentProperties`
...
- New field `ExternalEvaluationEnforcementSettings`, `Version`, `Versions` in struct `DefinitionProperties`
