...
func (client *LabSecretsClient) BeginCreateOrUpdate(ctx context.Context, resourceGroupName string, labName string, name string, labSecret LabSecret, options *LabSecretsClientBeginCreateOrUpdateOptions) (*runtime.Poller[LabSecretsClientCreateOrUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return runtime.NewPoller[LabSecretsClientCreateOrUpdateResponse](resp, client.pl, nil)
	} else {
		return runtime.NewPollerFromResumeToken[LabSecretsClientCreateOrUpdateResponse](options.ResumeToken, client.pl, nil)
	}
}
...
func (client *LabSecretsClient) BeginDelete(ctx context.Context, resourceGroupName string, labName string, name string, options *LabSecretsClientBeginDeleteOptions) (*runtime.Poller[LabSecretsClientDeleteResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return runtime.NewPoller[LabSecretsClientDeleteResponse](resp, client.pl, nil)
	} else {
		return runtime.NewPollerFromResumeToken[LabSecretsClientDeleteResponse](options.ResumeToken, client.pl, nil)
	}
}
...
// resourceGroupName - The name of the resource group.
// labName - The name of the lab.
// options - LabSecretsClientListOptions contains the optional parameters for the LabSecretsClient.List method.
