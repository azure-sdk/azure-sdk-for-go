...
// BeginDelete - Delete API for managed network settings of a cognitive services account.
//
...
//   - options - ManagedNetworkSettingsClientBeginDeleteOptions contains the optional parameters for the ManagedNetworkSettingsClient.BeginDelete
//     method.
func (client *ManagedNetworkSettingsClient) BeginDelete(ctx context.Context, resourceGroupName string, accountName string, managedNetworkName string, options *ManagedNetworkSettingsClientBeginDeleteOptions) (*runtime.Poller[ManagedNetworkSettingsClientDeleteResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		poller, err := runtime.NewPoller(resp, client.internal.Pipeline(), &runtime.NewPollerOptions[ManagedNetworkSettingsClientDeleteResponse]{
			Tracer: client.internal.Tracer(),
		})
		return poller, err
	} else {
		return runtime.NewPollerFromResumeToken(options.ResumeToken, client.internal.Pipeline(), &runtime.NewPollerFromResumeTokenOptions[ManagedNetworkSettingsClientDeleteResponse]{
			Tracer: client.internal.Tracer(),
		})
	}
}
...
func (client *ManagedNetworkSettingsClient) deleteOperation(ctx context.Context, resourceGroupName string, accountName string, managedNetworkName string, options *ManagedNetworkSettingsClientBeginDeleteOptions) (*http.Response, error) {
	...
	req, err := client.deleteCreateRequest(ctx, resourceGroupName, accountName, managedNetworkName, options)
	if err != nil {
		return nil, err
	}
