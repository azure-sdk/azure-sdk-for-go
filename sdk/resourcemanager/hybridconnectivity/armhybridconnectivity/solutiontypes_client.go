...
func (client *SolutionTypesClient) getCreateRequest(ctx context.Context, resourceGroupName string, solutionType string, options *SolutionTypesClientGetOptions) (*policy.Request, error) {
...
func (client *SolutionTypesClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, options *SolutionTypesClientListByResourceGroupOptions) (*policy.Request, error) {
...
func (client *SolutionTypesClient) listBySubscriptionCreateRequest(ctx context.Context, options *SolutionTypesClientListBySubscriptionOptions) (*policy.Request, error) {
