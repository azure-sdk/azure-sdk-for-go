...
type DatastoresServer struct {
	...
	// HTTP status codes to indicate success: http.StatusOK
	NewListByClusterPager func(resourceGroupName string, privateCloudName string, clusterName string, options *armavs.DatastoresClientListByClusterOptions) (resp azfake.PagerResponder[armavs.DatastoresClientListByClusterResponse])
}
...
func (d *DatastoresServerTransport) dispatchNewListByClusterPager(req *http.Request) (*http.Response, error) {
	...
	if newListByClusterPager == nil {
		...
		resp := d.srv.NewListByClusterPager(resourceGroupNameParam, privateCloudNameParam, clusterNameParam, nil)
