...
type ManagedClusterAgentPoolProfile struct {
	...
	// Customers use this identity to grant AKS access permission to the Capacity Reservation Group and the reserved VMs inside.
	VMIdentityProfile *UserAssignedIdentity
