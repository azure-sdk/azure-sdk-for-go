...
type ConnectorsServer struct {
	...
	// HTTP status codes to indicate success: http.StatusOK
	Update func(ctx context.Context, connectorName string, properties armimpact.Connector, options *armimpact.ConnectorsClientUpdateOptions) (resp azfake.Responder[armimpact.ConnectorsClientUpdateResponse], errResp azfake.ErrorResponder)
}
