...
// TwelveRecommendationssMetadataClientGetResponse contains the response from method TwelveRecommendationssMetadataClient.Get.
type TwelveRecommendationssMetadataClientGetResponse struct {
	MetadataEntity
}
