...
type AzureFileshareProtectedItem struct {
	...
	WorkloadType *DataSourceTypeAutoGenerated3
}
...
// AzureVMWorkloadAnyDatabaseProtectableItem - Azure VM workload-specific protectable item representing AnyDatabase DB.
type AzureVMWorkloadAnyDatabaseProtectableItem struct {
	// REQUIRED; Type of the backup item.
	ProtectableItemType *string
...
// GetAzureVMWorkloadProtectableItem implements the AzureVMWorkloadProtectableItemClassification interface for type AzureVMWorkloadAnyDatabaseProtectableItem.
func (a *AzureVMWorkloadAnyDatabaseProtectableItem) GetAzureVMWorkloadProtectableItem() *AzureVMWorkloadProtectableItem {
...
// GetWorkloadProtectableItem implements the WorkloadProtectableItemClassification interface for type AzureVMWorkloadAnyDatabaseProtectableItem.
func (a *AzureVMWorkloadAnyDatabaseProtectableItem) GetWorkloadProtectableItem() *WorkloadProtectableItem {
	return &WorkloadProtectableItem{
		BackupManagementType: a.BackupManagementType,
		FriendlyName:         a.FriendlyName,
		ProtectableItemType:  a.ProtectableItemType,
...
// AzureVMWorkloadAnyDatabaseProtectedItem - Azure VM workload-specific protected item representing Any Database.
type AzureVMWorkloadAnyDatabaseProtectedItem struct {
	// REQUIRED; backup item type.
	ProtectedItemType *string
...
// GetAzureVMWorkloadProtectedItem implements the AzureVMWorkloadProtectedItemClassification interface for type AzureVMWorkloadAnyDatabaseProtectedItem.
func (a *AzureVMWorkloadAnyDatabaseProtectedItem) GetAzureVMWorkloadProtectedItem() *AzureVMWorkloadProtectedItem {
...
// GetProtectedItem implements the ProtectedItemClassification interface for type AzureVMWorkloadAnyDatabaseProtectedItem.
func (a *AzureVMWorkloadAnyDatabaseProtectedItem) GetProtectedItem() *ProtectedItem {
	return &ProtectedItem{
		BackupManagementType:             a.BackupManagementType,
		BackupSetName:                    a.BackupSetName,
		ContainerName:                    a.ContainerName,
...
// AzureVMWorkloadAnyDatabaseWorkloadItem - Azure VM workload-specific workload item representing Any Database.
type AzureVMWorkloadAnyDatabaseWorkloadItem struct {
	// REQUIRED; Type of the backup item.
...
// GetAzureVMWorkloadItem implements the AzureVMWorkloadItemClassification interface for type AzureVMWorkloadAnyDatabaseWorkloadItem.
func (a *AzureVMWorkloadAnyDatabaseWorkloadItem) GetAzureVMWorkloadItem() *AzureVMWorkloadItem {
...
// GetWorkloadItem implements the WorkloadItemClassification interface for type AzureVMWorkloadAnyDatabaseWorkloadItem.
func (a *AzureVMWorkloadAnyDatabaseWorkloadItem) GetWorkloadItem() *WorkloadItem {
	return &WorkloadItem{
		BackupManagementType: a.BackupManagementType,
		FriendlyName:         a.FriendlyName,
		ProtectionState:      a.ProtectionState,
...
// AzureVMWorkloadOracleDatabaseProtectableItem - Azure VM workload-specific protectable item representing Oracle DB.
type AzureVMWorkloadOracleDatabaseProtectableItem struct {
	// REQUIRED; Type of the backup item.
	ProtectableItemType *string
...
// GetAzureVMWorkloadProtectableItem implements the AzureVMWorkloadProtectableItemClassification interface for type AzureVMWorkloadOracleDatabaseProtectableItem.
func (a *AzureVMWorkloadOracleDatabaseProtectableItem) GetAzureVMWorkloadProtectableItem() *AzureVMWorkloadProtectableItem {
	return &AzureVMWorkloadProtectableItem{
		BackupManagementType:    a.BackupManagementType,
		FriendlyName:            a.FriendlyName,
		IsAutoProtectable:       a.IsAutoProtectable,
...
// GetWorkloadProtectableItem implements the WorkloadProtectableItemClassification interface for type AzureVMWorkloadOracleDatabaseProtectableItem.
func (a *AzureVMWorkloadOracleDatabaseProtectableItem) GetWorkloadProtectableItem() *WorkloadProtectableItem {
	return &WorkloadProtectableItem{
		BackupManagementType: a.BackupManagementType,
		FriendlyName:         a.FriendlyName,
		ProtectableItemType:  a.ProtectableItemType,
...
// AzureVMWorkloadOracleDatabaseProtectedItem - Azure VM workload-specific protected item representing Oracle Database.
type AzureVMWorkloadOracleDatabaseProtectedItem struct {
	// REQUIRED; backup item type.
	ProtectedItemType *string
...
// GetAzureVMWorkloadProtectedItem implements the AzureVMWorkloadProtectedItemClassification interface for type AzureVMWorkloadOracleDatabaseProtectedItem.
func (a *AzureVMWorkloadOracleDatabaseProtectedItem) GetAzureVMWorkloadProtectedItem() *AzureVMWorkloadProtectedItem {
	return &AzureVMWorkloadProtectedItem{
		BackupManagementType:             a.BackupManagementType,
		BackupSetName:                    a.BackupSetName,
		ContainerName:                    a.ContainerName,
...
// GetProtectedItem implements the ProtectedItemClassification interface for type AzureVMWorkloadOracleDatabaseProtectedItem.
func (a *AzureVMWorkloadOracleDatabaseProtectedItem) GetProtectedItem() *ProtectedItem {
	return &ProtectedItem{
		BackupManagementType:             a.BackupManagementType,
		BackupSetName:                    a.BackupSetName,
		ContainerName:                    a.ContainerName,
...
// AzureVMWorkloadOracleDatabaseWorkloadItem - Azure VM workload-specific workload item representing Oracle Database.
type AzureVMWorkloadOracleDatabaseWorkloadItem struct {
	// REQUIRED; Type of the backup item.
	WorkloadItemType *string
...
// GetAzureVMWorkloadItem implements the AzureVMWorkloadItemClassification interface for type AzureVMWorkloadOracleDatabaseWorkloadItem.
func (a *AzureVMWorkloadOracleDatabaseWorkloadItem) GetAzureVMWorkloadItem() *AzureVMWorkloadItem {
	return &AzureVMWorkloadItem{
		BackupManagementType: a.BackupManagementType,
		FriendlyName:         a.FriendlyName,
		IsAutoProtectable:    a.IsAutoProtectable,
...
// GetWorkloadItem implements the WorkloadItemClassification interface for type AzureVMWorkloadOracleDatabaseWorkloadItem.
func (a *AzureVMWorkloadOracleDatabaseWorkloadItem) GetWorkloadItem() *WorkloadItem {
	return &WorkloadItem{
		BackupManagementType: a.BackupManagementType,
		FriendlyName:         a.FriendlyName,
		ProtectionState:      a.ProtectionState,
...
// AzureWorkloadAnyDatabasePointInTimeRecoveryPoint - Recovery point specific to PointInTime for generic any database
type AzureWorkloadAnyDatabasePointInTimeRecoveryPoint struct {
	// REQUIRED; This property will be used as the discriminator for deciding the specific types in the polymorphic chain of types.
	ObjectType *string
...
// type AzureWorkloadAnyDatabasePointInTimeRecoveryPoint.
func (a *AzureWorkloadAnyDatabasePointInTimeRecoveryPoint) GetAzureWorkloadPointInTimeRecoveryPoint() *AzureWorkloadPointInTimeRecoveryPoint {
...
// GetAzureWorkloadRecoveryPoint implements the AzureWorkloadRecoveryPointClassification interface for type AzureWorkloadAnyDatabasePointInTimeRecoveryPoint.
func (a *AzureWorkloadAnyDatabasePointInTimeRecoveryPoint) GetAzureWorkloadRecoveryPoint() *AzureWorkloadRecoveryPoint {
...
// GetRecoveryPoint implements the RecoveryPointClassification interface for type AzureWorkloadAnyDatabasePointInTimeRecoveryPoint.
func (a *AzureWorkloadAnyDatabasePointInTimeRecoveryPoint) GetRecoveryPoint() *RecoveryPoint {
	return &RecoveryPoint{
		ObjectType: a.ObjectType,
	}
}

// AzureWorkloadAnyDatabasePointInTimeRestoreRequest - AzureWorkload AnyDatabase -specific restore. Specifically for PointInTime/Log
// restore
type AzureWorkloadAnyDatabasePointInTimeRestoreRequest struct {
	// REQUIRED; This property will be used as the discriminator for deciding the specific types in the polymorphic chain of types.
	ObjectType *string
...
// GetAzureWorkloadAnyDatabasePointInTimeRestoreRequest implements the AzureWorkloadAnyDatabasePointInTimeRestoreRequestClassification
// interface for type AzureWorkloadAnyDatabasePointInTimeRestoreRequest.
func (a *AzureWorkloadAnyDatabasePointInTimeRestoreRequest) GetAzureWorkloadAnyDatabasePointInTimeRestoreRequest() *AzureWorkloadAnyDatabasePointInTimeRestoreRequest {
	return a
}

// GetAzureWorkloadAnyDatabaseRestoreRequest implements the AzureWorkloadAnyDatabaseRestoreRequestClassification interface
// for type AzureWorkloadAnyDatabasePointInTimeRestoreRequest.
func (a *AzureWorkloadAnyDatabasePointInTimeRestoreRequest) GetAzureWorkloadAnyDatabaseRestoreRequest() *AzureWorkloadAnyDatabaseRestoreRequest {
	return &AzureWorkloadAnyDatabaseRestoreRequest{
		ObjectType:                         a.ObjectType,
...
// GetAzureWorkloadRestoreRequest implements the AzureWorkloadRestoreRequestClassification interface for type AzureWorkloadAnyDatabasePointInTimeRestoreRequest.
func (a *AzureWorkloadAnyDatabasePointInTimeRestoreRequest) GetAzureWorkloadRestoreRequest() *AzureWorkloadRestoreRequest {
...
// GetRestoreRequest implements the RestoreRequestClassification interface for type AzureWorkloadAnyDatabasePointInTimeRestoreRequest.
func (a *AzureWorkloadAnyDatabasePointInTimeRestoreRequest) GetRestoreRequest() *RestoreRequest {
	return &RestoreRequest{
		ObjectType:                     a.ObjectType,
		ResourceGuardOperationRequests: a.ResourceGuardOperationRequests,
	}
...
// AzureWorkloadAnyDatabasePointInTimeRestoreWithRehydrateRequest - AzureWorkload AnyDatabase-specific restore with integrated
// rehydration of recovery point.
type AzureWorkloadAnyDatabasePointInTimeRestoreWithRehydrateRequest struct {
	// REQUIRED; This property will be used as the discriminator for deciding the specific types in the polymorphic chain of types.
	ObjectType *string
...
// GetAzureWorkloadAnyDatabasePointInTimeRestoreRequest implements the AzureWorkloadAnyDatabasePointInTimeRestoreRequestClassification
// interface for type AzureWorkloadAnyDatabasePointInTimeRestoreWithRehydrateRequest.
func (a *AzureWorkloadAnyDatabasePointInTimeRestoreWithRehydrateRequest) GetAzureWorkloadAnyDatabasePointInTimeRestoreRequest() *AzureWorkloadAnyDatabasePointInTimeRestoreRequest {
...
// GetAzureWorkloadAnyDatabaseRestoreRequest implements the AzureWorkloadAnyDatabaseRestoreRequestClassification interface
// for type AzureWorkloadAnyDatabasePointInTimeRestoreWithRehydrateRequest.
func (a *AzureWorkloadAnyDatabasePointInTimeRestoreWithRehydrateRequest) GetAzureWorkloadAnyDatabaseRestoreRequest() *AzureWorkloadAnyDatabaseRestoreRequest {
	return &AzureWorkloadAnyDatabaseRestoreRequest{
		ObjectType:                         a.ObjectType,
		PropertyBag:                        a.PropertyBag,
		RecoveryMode:                       a.RecoveryMode,
...
// GetAzureWorkloadRestoreRequest implements the AzureWorkloadRestoreRequestClassification interface for type AzureWorkloadAnyDatabasePointInTimeRestoreWithRehydrateRequest.
func (a *AzureWorkloadAnyDatabasePointInTimeRestoreWithRehydrateRequest) GetAzureWorkloadRestoreRequest() *AzureWorkloadRestoreRequest {
	return &AzureWorkloadRestoreRequest{
		ObjectType:                         a.ObjectType,
		PropertyBag:                        a.PropertyBag,
		RecoveryMode:                       a.RecoveryMode,
...
// GetRestoreRequest implements the RestoreRequestClassification interface for type AzureWorkloadAnyDatabasePointInTimeRestoreWithRehydrateRequest.
func (a *AzureWorkloadAnyDatabasePointInTimeRestoreWithRehydrateRequest) GetRestoreRequest() *RestoreRequest {
	return &RestoreRequest{
		ObjectType:                     a.ObjectType,
		ResourceGuardOperationRequests: a.ResourceGuardOperationRequests,
	}
...
// AzureWorkloadAnyDatabaseRecoveryPoint - Generic any database specific recoverypoint, specifically encapsulates full/diff
// recoverypoints
type AzureWorkloadAnyDatabaseRecoveryPoint struct {
	// REQUIRED; This property will be used as the discriminator for deciding the specific types in the polymorphic chain of types.
	ObjectType *string
...
// GetAzureWorkloadRecoveryPoint implements the AzureWorkloadRecoveryPointClassification interface for type AzureWorkloadAnyDatabaseRecoveryPoint.
func (a *AzureWorkloadAnyDatabaseRecoveryPoint) GetAzureWorkloadRecoveryPoint() *AzureWorkloadRecoveryPoint {
	return &AzureWorkloadRecoveryPoint{
		ObjectType:                     a.ObjectType,
		RecoveryPointMoveReadinessInfo: a.RecoveryPointMoveReadinessInfo,
		RecoveryPointProperties:        a.RecoveryPointProperties,
...
// GetRecoveryPoint implements the RecoveryPointClassification interface for type AzureWorkloadAnyDatabaseRecoveryPoint.
func (a *AzureWorkloadAnyDatabaseRecoveryPoint) GetRecoveryPoint() *RecoveryPoint {
	return &RecoveryPoint{
		ObjectType: a.ObjectType,
	}
}

// AzureWorkloadAnyDatabaseRestoreRequest - AzureWorkload AnyDatabase-specific restore.
type AzureWorkloadAnyDatabaseRestoreRequest struct {
	// REQUIRED; This property will be used as the discriminator for deciding the specific types in the polymorphic chain of types.
	ObjectType *string
...
// GetAzureWorkloadAnyDatabaseRestoreRequest implements the AzureWorkloadAnyDatabaseRestoreRequestClassification interface
// for type AzureWorkloadAnyDatabaseRestoreRequest.
func (a *AzureWorkloadAnyDatabaseRestoreRequest) GetAzureWorkloadAnyDatabaseRestoreRequest() *AzureWorkloadAnyDatabaseRestoreRequest {
	return a
}

// GetAzureWorkloadRestoreRequest implements the AzureWorkloadRestoreRequestClassification interface for type AzureWorkloadAnyDatabaseRestoreRequest.
func (a *AzureWorkloadAnyDatabaseRestoreRequest) GetAzureWorkloadRestoreRequest() *AzureWorkloadRestoreRequest {
	return &AzureWorkloadRestoreRequest{
		ObjectType:                         a.ObjectType,
		PropertyBag:                        a.PropertyBag,
		RecoveryMode:                       a.RecoveryMode,
...
// GetRestoreRequest implements the RestoreRequestClassification interface for type AzureWorkloadAnyDatabaseRestoreRequest.
func (a *AzureWorkloadAnyDatabaseRestoreRequest) GetRestoreRequest() *RestoreRequest {
	return &RestoreRequest{
		ObjectType:                     a.ObjectType,
		ResourceGuardOperationRequests: a.ResourceGuardOperationRequests,
	}
...
// AzureWorkloadAnyDatabaseRestoreWithRehydrateRequest - AzureWorkload AnyDatabase-specific restore with integrated rehydration
// of recovery point.
type AzureWorkloadAnyDatabaseRestoreWithRehydrateRequest struct {
	// REQUIRED; This property will be used as the discriminator for deciding the specific types in the polymorphic chain of types.
	ObjectType *string
...
// GetAzureWorkloadAnyDatabaseRestoreRequest implements the AzureWorkloadAnyDatabaseRestoreRequestClassification interface
// for type AzureWorkloadAnyDatabaseRestoreWithRehydrateRequest.
func (a *AzureWorkloadAnyDatabaseRestoreWithRehydrateRequest) GetAzureWorkloadAnyDatabaseRestoreRequest() *AzureWorkloadAnyDatabaseRestoreRequest {
	return &AzureWorkloadAnyDatabaseRestoreRequest{
		ObjectType:                         a.ObjectType,
		PropertyBag:                        a.PropertyBag,
		RecoveryMode:                       a.RecoveryMode,
...
// GetAzureWorkloadRestoreRequest implements the AzureWorkloadRestoreRequestClassification interface for type AzureWorkloadAnyDatabaseRestoreWithRehydrateRequest.
func (a *AzureWorkloadAnyDatabaseRestoreWithRehydrateRequest) GetAzureWorkloadRestoreRequest() *AzureWorkloadRestoreRequest {
	return &AzureWorkloadRestoreRequest{
		ObjectType:                         a.ObjectType,
		PropertyBag:                        a.PropertyBag,
		RecoveryMode:                       a.RecoveryMode,
...
// GetRestoreRequest implements the RestoreRequestClassification interface for type AzureWorkloadAnyDatabaseRestoreWithRehydrateRequest.
func (a *AzureWorkloadAnyDatabaseRestoreWithRehydrateRequest) GetRestoreRequest() *RestoreRequest {
	return &RestoreRequest{
		ObjectType:                     a.ObjectType,
		ResourceGuardOperationRequests: a.ResourceGuardOperationRequests,
	}
...
// AzureWorkloadOraclePointInTimeRecoveryPoint - Recovery point specific to PointInTime for Oracle
type AzureWorkloadOraclePointInTimeRecoveryPoint struct {
	// REQUIRED; This property will be used as the discriminator for deciding the specific types in the polymorphic chain of types.
	ObjectType *string
...
// GetAzureWorkloadPointInTimeRecoveryPoint implements the AzureWorkloadPointInTimeRecoveryPointClassification interface for
// type AzureWorkloadOraclePointInTimeRecoveryPoint.
func (a *AzureWorkloadOraclePointInTimeRecoveryPoint) GetAzureWorkloadPointInTimeRecoveryPoint() *AzureWorkloadPointInTimeRecoveryPoint {
	return &AzureWorkloadPointInTimeRecoveryPoint{
		ObjectType:                     a.ObjectType,
		RecoveryPointMoveReadinessInfo: a.RecoveryPointMoveReadinessInfo,
		RecoveryPointProperties:        a.RecoveryPointProperties,
...
// GetAzureWorkloadRecoveryPoint implements the AzureWorkloadRecoveryPointClassification interface for type AzureWorkloadOraclePointInTimeRecoveryPoint.
func (a *AzureWorkloadOraclePointInTimeRecoveryPoint) GetAzureWorkloadRecoveryPoint() *AzureWorkloadRecoveryPoint {
	return &AzureWorkloadRecoveryPoint{
		ObjectType:                     a.ObjectType,
		RecoveryPointMoveReadinessInfo: a.RecoveryPointMoveReadinessInfo,
		RecoveryPointProperties:        a.RecoveryPointProperties,
...
// GetRecoveryPoint implements the RecoveryPointClassification interface for type AzureWorkloadOraclePointInTimeRecoveryPoint.
func (a *AzureWorkloadOraclePointInTimeRecoveryPoint) GetRecoveryPoint() *RecoveryPoint {
	return &RecoveryPoint{
		ObjectType: a.ObjectType,
	}
}

// AzureWorkloadOraclePointInTimeRestoreRequest - AzureWorkload Oracle -specific restore. Specifically for PointInTime/Log
// restore
type AzureWorkloadOraclePointInTimeRestoreRequest struct {
	// REQUIRED; This property will be used as the discriminator for deciding the specific types in the polymorphic chain of types.
	ObjectType *string
...
// GetAzureWorkloadOraclePointInTimeRestoreRequest implements the AzureWorkloadOraclePointInTimeRestoreRequestClassification
// interface for type AzureWorkloadOraclePointInTimeRestoreRequest.
func (a *AzureWorkloadOraclePointInTimeRestoreRequest) GetAzureWorkloadOraclePointInTimeRestoreRequest() *AzureWorkloadOraclePointInTimeRestoreRequest {
	return a
}

// GetAzureWorkloadOracleRestoreRequest implements the AzureWorkloadOracleRestoreRequestClassification interface for type
// AzureWorkloadOraclePointInTimeRestoreRequest.
func (a *AzureWorkloadOraclePointInTimeRestoreRequest) GetAzureWorkloadOracleRestoreRequest() *AzureWorkloadOracleRestoreRequest {
	return &AzureWorkloadOracleRestoreRequest{
		ObjectType:                         a.ObjectType,
		PropertyBag:                        a.PropertyBag,
		RecoveryMode:                       a.RecoveryMode,
		RecoveryType:                       a.RecoveryType,
...
// GetAzureWorkloadRestoreRequest implements the AzureWorkloadRestoreRequestClassification interface for type AzureWorkloadOraclePointInTimeRestoreRequest.
func (a *AzureWorkloadOraclePointInTimeRestoreRequest) GetAzureWorkloadRestoreRequest() *AzureWorkloadRestoreRequest {
	return &AzureWorkloadRestoreRequest{
		ObjectType:                         a.ObjectType,
		PropertyBag:                        a.PropertyBag,
		RecoveryMode:                       a.RecoveryMode,
...
// GetRestoreRequest implements the RestoreRequestClassification interface for type AzureWorkloadOraclePointInTimeRestoreRequest.
func (a *AzureWorkloadOraclePointInTimeRestoreRequest) GetRestoreRequest() *RestoreRequest {
	return &RestoreRequest{
		ObjectType:                     a.ObjectType,
		ResourceGuardOperationRequests: a.ResourceGuardOperationRequests,
	}
...
// AzureWorkloadOraclePointInTimeRestoreWithRehydrateRequest - AzureWorkload Oracle-specific restore with integrated rehydration
// of recovery point.
type AzureWorkloadOraclePointInTimeRestoreWithRehydrateRequest struct {
	// REQUIRED; This property will be used as the discriminator for deciding the specific types in the polymorphic chain of types.
	ObjectType *string
...
// GetAzureWorkloadOraclePointInTimeRestoreRequest implements the AzureWorkloadOraclePointInTimeRestoreRequestClassification
// interface for type AzureWorkloadOraclePointInTimeRestoreWithRehydrateRequest.
func (a *AzureWorkloadOraclePointInTimeRestoreWithRehydrateRequest) GetAzureWorkloadOraclePointInTimeRestoreRequest() *AzureWorkloadOraclePointInTimeRestoreRequest {
	return &AzureWorkloadOraclePointInTimeRestoreRequest{
		ObjectType:                         a.ObjectType,
		PointInTime:                        a.PointInTime,
		PropertyBag:                        a.PropertyBag,
		RecoveryMode:                       a.RecoveryMode,
...
func (a *AzureWorkloadOraclePointInTimeRestoreWithRehydrateRequest) GetAzureWorkloadOracleRestoreRequest() *AzureWorkloadOracleRestoreRequest {
	return &AzureWorkloadOracleRestoreRequest{
		ObjectType:                         a.ObjectType,
		PropertyBag:                        a.PropertyBag,
		RecoveryMode:                       a.RecoveryMode,
...
// GetAzureWorkloadRestoreRequest implements the AzureWorkloadRestoreRequestClassification interface for type AzureWorkloadOraclePointInTimeRestoreWithRehydrateRequest.
func (a *AzureWorkloadOraclePointInTimeRestoreWithRehydrateRequest) GetAzureWorkloadRestoreRequest() *AzureWorkloadRestoreRequest {
	return &AzureWorkloadRestoreRequest{
		ObjectType:                         a.ObjectType,
		PropertyBag:                        a.PropertyBag,
		RecoveryMode:                       a.RecoveryMode,
...
// GetRestoreRequest implements the RestoreRequestClassification interface for type AzureWorkloadOraclePointInTimeRestoreWithRehydrateRequest.
func (a *AzureWorkloadOraclePointInTimeRestoreWithRehydrateRequest) GetRestoreRequest() *RestoreRequest {
	return &RestoreRequest{
		ObjectType:                     a.ObjectType,
		ResourceGuardOperationRequests: a.ResourceGuardOperationRequests,
	}
...
// AzureWorkloadOracleRecoveryPoint - Oracle specific recoverypoint, specifically encapsulates full/diff recoverypoints
type AzureWorkloadOracleRecoveryPoint struct {
	// REQUIRED; This property will be used as the discriminator for deciding the specific types in the polymorphic chain of types.
	ObjectType *string
...
// GetAzureWorkloadRecoveryPoint implements the AzureWorkloadRecoveryPointClassification interface for type AzureWorkloadOracleRecoveryPoint.
func (a *AzureWorkloadOracleRecoveryPoint) GetAzureWorkloadRecoveryPoint() *AzureWorkloadRecoveryPoint {
	return &AzureWorkloadRecoveryPoint{
		ObjectType:                     a.ObjectType,
		RecoveryPointMoveReadinessInfo: a.RecoveryPointMoveReadinessInfo,
		RecoveryPointProperties:        a.RecoveryPointProperties,
...
// GetRecoveryPoint implements the RecoveryPointClassification interface for type AzureWorkloadOracleRecoveryPoint.
func (a *AzureWorkloadOracleRecoveryPoint) GetRecoveryPoint() *RecoveryPoint {
	return &RecoveryPoint{
		ObjectType: a.ObjectType,
	}
}

// AzureWorkloadOracleRestoreRequest - AzureWorkload Oracle-specific restore.
type AzureWorkloadOracleRestoreRequest struct {
	// REQUIRED; This property will be used as the discriminator for deciding the specific types in the polymorphic chain of types.
	ObjectType *string
...
func (a *AzureWorkloadOracleRestoreRequest) GetAzureWorkloadOracleRestoreRequest() *AzureWorkloadOracleRestoreRequest {
	return a
}

// GetAzureWorkloadRestoreRequest implements the AzureWorkloadRestoreRequestClassification interface for type AzureWorkloadOracleRestoreRequest.
func (a *AzureWorkloadOracleRestoreRequest) GetAzureWorkloadRestoreRequest() *AzureWorkloadRestoreRequest {
	return &AzureWorkloadRestoreRequest{
		ObjectType:                         a.ObjectType,
		PropertyBag:                        a.PropertyBag,
		RecoveryMode:                       a.RecoveryMode,
...
// GetRestoreRequest implements the RestoreRequestClassification interface for type AzureWorkloadOracleRestoreRequest.
func (a *AzureWorkloadOracleRestoreRequest) GetRestoreRequest() *RestoreRequest {
	return &RestoreRequest{
		ObjectType:                     a.ObjectType,
		ResourceGuardOperationRequests: a.ResourceGuardOperationRequests,
	}
...
// AzureWorkloadOracleRestoreWithRehydrateRequest - AzureWorkload Oracle-specific restore with integrated rehydration of recovery
// point.
type AzureWorkloadOracleRestoreWithRehydrateRequest struct {
	// REQUIRED; This property will be used as the discriminator for deciding the specific types in the polymorphic chain of types.
	ObjectType *string
...
func (a *AzureWorkloadOracleRestoreWithRehydrateRequest) GetAzureWorkloadOracleRestoreRequest() *AzureWorkloadOracleRestoreRequest {
	return &AzureWorkloadOracleRestoreRequest{
		ObjectType:                         a.ObjectType,
		PropertyBag:                        a.PropertyBag,
		RecoveryMode:                       a.RecoveryMode,
...
// GetAzureWorkloadRestoreRequest implements the AzureWorkloadRestoreRequestClassification interface for type AzureWorkloadOracleRestoreWithRehydrateRequest.
func (a *AzureWorkloadOracleRestoreWithRehydrateRequest) GetAzureWorkloadRestoreRequest() *AzureWorkloadRestoreRequest {
	return &AzureWorkloadRestoreRequest{
		ObjectType:                         a.ObjectType,
		PropertyBag:                        a.PropertyBag,
		RecoveryMode:                       a.RecoveryMode,
...
// GetRestoreRequest implements the RestoreRequestClassification interface for type AzureWorkloadOracleRestoreWithRehydrateRequest.
func (a *AzureWorkloadOracleRestoreWithRehydrateRequest) GetRestoreRequest() *RestoreRequest {
	return &RestoreRequest{
		ObjectType:                     a.ObjectType,
		ResourceGuardOperationRequests: a.ResourceGuardOperationRequests,
	}
...
// GetAzureWorkloadSAPAsePointInTimeRestoreRequest implements the AzureWorkloadSAPAsePointInTimeRestoreRequestClassification
// interface for type AzureWorkloadSAPAsePointInTimeRestoreRequest.
func (a *AzureWorkloadSAPAsePointInTimeRestoreRequest) GetAzureWorkloadSAPAsePointInTimeRestoreRequest() *AzureWorkloadSAPAsePointInTimeRestoreRequest {
	return a
}
...
// AzureWorkloadSAPAsePointInTimeRestoreWithRehydrateRequest - AzureWorkload SAP Ase-specific restore with integrated rehydration
// of recovery point.
type AzureWorkloadSAPAsePointInTimeRestoreWithRehydrateRequest struct {
	// REQUIRED; This property will be used as the discriminator for deciding the specific types in the polymorphic chain of types.
	ObjectType *string
...
// GetAzureWorkloadRestoreRequest implements the AzureWorkloadRestoreRequestClassification interface for type AzureWorkloadSAPAsePointInTimeRestoreWithRehydrateRequest.
func (a *AzureWorkloadSAPAsePointInTimeRestoreWithRehydrateRequest) GetAzureWorkloadRestoreRequest() *AzureWorkloadRestoreRequest {
	return &AzureWorkloadRestoreRequest{
		ObjectType:                         a.ObjectType,
		PropertyBag:                        a.PropertyBag,
		RecoveryMode:                       a.RecoveryMode,
...
// GetAzureWorkloadSAPAsePointInTimeRestoreRequest implements the AzureWorkloadSAPAsePointInTimeRestoreRequestClassification
// interface for type AzureWorkloadSAPAsePointInTimeRestoreWithRehydrateRequest.
func (a *AzureWorkloadSAPAsePointInTimeRestoreWithRehydrateRequest) GetAzureWorkloadSAPAsePointInTimeRestoreRequest() *AzureWorkloadSAPAsePointInTimeRestoreRequest {
...
func (a *AzureWorkloadSAPAsePointInTimeRestoreWithRehydrateRequest) GetAzureWorkloadSAPAseRestoreRequest() *AzureWorkloadSAPAseRestoreRequest {
	return &AzureWorkloadSAPAseRestoreRequest{
		ObjectType:                         a.ObjectType,
		PropertyBag:                        a.PropertyBag,
		RecoveryMode:                       a.RecoveryMode,
...
// GetRestoreRequest implements the RestoreRequestClassification interface for type AzureWorkloadSAPAsePointInTimeRestoreWithRehydrateRequest.
func (a *AzureWorkloadSAPAsePointInTimeRestoreWithRehydrateRequest) GetRestoreRequest() *RestoreRequest {
	return &RestoreRequest{
		ObjectType:                     a.ObjectType,
		ResourceGuardOperationRequests: a.ResourceGuardOperationRequests,
	}
...
// AzureWorkloadSAPAseRestoreWithRehydrateRequest - AzureWorkload SAP Ase-specific restore with integrated rehydration of
// recovery point.
type AzureWorkloadSAPAseRestoreWithRehydrateRequest struct {
	// REQUIRED; This property will be used as the discriminator for deciding the specific types in the polymorphic chain of types.
	ObjectType *string
...
// GetAzureWorkloadRestoreRequest implements the AzureWorkloadRestoreRequestClassification interface for type AzureWorkloadSAPAseRestoreWithRehydrateRequest.
func (a *AzureWorkloadSAPAseRestoreWithRehydrateRequest) GetAzureWorkloadRestoreRequest() *AzureWorkloadRestoreRequest {
	return &AzureWorkloadRestoreRequest{
		ObjectType:                         a.ObjectType,
		PropertyBag:                        a.PropertyBag,
		RecoveryMode:                       a.RecoveryMode,
...
func (a *AzureWorkloadSAPAseRestoreWithRehydrateRequest) GetAzureWorkloadSAPAseRestoreRequest() *AzureWorkloadSAPAseRestoreRequest {
	return &AzureWorkloadSAPAseRestoreRequest{
		ObjectType:                         a.ObjectType,
		PropertyBag:                        a.PropertyBag,
		RecoveryMode:                       a.RecoveryMode,
...
// GetRestoreRequest implements the RestoreRequestClassification interface for type AzureWorkloadSAPAseRestoreWithRehydrateRequest.
func (a *AzureWorkloadSAPAseRestoreWithRehydrateRequest) GetRestoreRequest() *RestoreRequest {
	return &RestoreRequest{
		ObjectType:                     a.ObjectType,
		ResourceGuardOperationRequests: a.ResourceGuardOperationRequests,
	}
