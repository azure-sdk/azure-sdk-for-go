...
// SAPDatabaseInstancesServer is a fake server for instances of the armsapvirtualinstance.SAPDatabaseInstancesClient type.
type SAPDatabaseInstancesServer struct {
	...
	BeginCreate func(ctx context.Context, resourceGroupName string, sapVirtualInstanceName string, databaseInstanceName string, body armsapvirtualinstance.SAPDatabaseInstance, options *armsapvirtualinstance.SAPDatabaseInstancesClientBeginCreateOptions) (resp azfake.PollerResponder[armsapvirtualinstance.SAPDatabaseInstancesClientCreateResponse], errResp azfake.ErrorResponder)

	// BeginDelete is the fake for method SAPDatabaseInstancesClient.BeginDelete
	// HTTP status codes to indicate success: http.StatusAccepted, http.StatusNoContent
	BeginDelete func(ctx context.Context, resourceGroupName string, sapVirtualInstanceName string, databaseInstanceName string, options *armsapvirtualinstance.SAPDatabaseInstancesClientBeginDeleteOptions) (resp azfake.PollerResponder[armsapvirtualinstance.SAPDatabaseInstancesClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method SAPDatabaseInstancesClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, sapVirtualInstanceName string, databaseInstanceName string, options *armsapvirtualinstance.SAPDatabaseInstancesClientGetOptions) (resp azfake.Responder[armsapvirtualinstance.SAPDatabaseInstancesClientGetResponse], errResp azfake.ErrorResponder)

	// NewListPager is the fake for method SAPDatabaseInstancesClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(resourceGroupName string, sapVirtualInstanceName string, options *armsapvirtualinstance.SAPDatabaseInstancesClientListOptions) (resp azfake.PagerResponder[armsapvirtualinstance.SAPDatabaseInstancesClientListResponse])

	// BeginStartInstance is the fake for method SAPDatabaseInstancesClient.BeginStartInstance
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginStartInstance func(ctx context.Context, resourceGroupName string, sapVirtualInstanceName string, databaseInstanceName string, options *armsapvirtualinstance.SAPDatabaseInstancesClientBeginStartInstanceOptions) (resp azfake.PollerResponder[armsapvirtualinstance.SAPDatabaseInstancesClientStartInstanceResponse], errResp azfake.ErrorResponder)

	// BeginStopInstance is the fake for method SAPDatabaseInstancesClient.BeginStopInstance
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginStopInstance func(ctx context.Context, resourceGroupName string, sapVirtualInstanceName string, databaseInstanceName string, options *armsapvirtualinstance.SAPDatabaseInstancesClientBeginStopInstanceOptions) (resp azfake.PollerResponder[armsapvirtualinstance.SAPDatabaseInstancesClientStopInstanceResponse], errResp azfake.ErrorResponder)

	// Update is the fake for method SAPDatabaseInstancesClient.Update
	// HTTP status codes to indicate success: http.StatusOK
	Update func(ctx context.Context, resourceGroupName string, sapVirtualInstanceName string, databaseInstanceName string, body armsapvirtualinstance.UpdateSAPDatabaseInstanceRequest, options *armsapvirtualinstance.SAPDatabaseInstancesClientUpdateOptions) (resp azfake.Responder[armsapvirtualinstance.SAPDatabaseInstancesClientUpdateResponse], errResp azfake.ErrorResponder)
}
...
// The returned SAPDatabaseInstancesServerTransport instance is connected to an instance of armsapvirtualinstance.SAPDatabaseInstancesClient via the
...
func NewSAPDatabaseInstancesServerTransport(srv *SAPDatabaseInstancesServer) *SAPDatabaseInstancesServerTransport {
	return &SAPDatabaseInstancesServerTransport{
		srv:                srv,
		beginCreate:        newTracker[azfake.PollerResponder[armsapvirtualinstance.SAPDatabaseInstancesClientCreateResponse]](),
		beginDelete:        newTracker[azfake.PollerResponder[armsapvirtualinstance.SAPDatabaseInstancesClientDeleteResponse]](),
		newListPager:       newTracker[azfake.PagerResponder[armsapvirtualinstance.SAPDatabaseInstancesClientListResponse]](),
		beginStartInstance: newTracker[azfake.PollerResponder[armsapvirtualinstance.SAPDatabaseInstancesClientStartInstanceResponse]](),
		beginStopInstance:  newTracker[azfake.PollerResponder[armsapvirtualinstance.SAPDatabaseInstancesClientStopInstanceResponse]](),
	}
}

// SAPDatabaseInstancesServerTransport connects instances of armsapvirtualinstance.SAPDatabaseInstancesClient to instances of SAPDatabaseInstancesServer.
...
type SAPDatabaseInstancesServerTransport struct {
	...
	beginCreate        *tracker[azfake.PollerResponder[armsapvirtualinstance.SAPDatabaseInstancesClientCreateResponse]]
	beginDelete        *tracker[azfake.PollerResponder[armsapvirtualinstance.SAPDatabaseInstancesClientDeleteResponse]]
	newListPager       *tracker[azfake.PagerResponder[armsapvirtualinstance.SAPDatabaseInstancesClientListResponse]]
	beginStartInstance *tracker[azfake.PollerResponder[armsapvirtualinstance.SAPDatabaseInstancesClientStartInstanceResponse]]
	beginStopInstance  *tracker[azfake.PollerResponder[armsapvirtualinstance.SAPDatabaseInstancesClientStopInstanceResponse]]
}
...
func (s *SAPDatabaseInstancesServerTransport) dispatchBeginCreate(req *http.Request) (*http.Response, error) {
	...
	if beginCreate == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armsapvirtualinstance.SAPDatabaseInstance](req)
		if err != nil {
			return nil, err
		}
...
func (s *SAPDatabaseInstancesServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armsapvirtualinstance.SAPDatabaseInstancesClientListResponse, createLink func() string) {
...
func (s *SAPDatabaseInstancesServerTransport) dispatchBeginStartInstance(req *http.Request) (*http.Response, error) {
	...
	if beginStartInstance == nil {
		...
		var options *armsapvirtualinstance.SAPDatabaseInstancesClientBeginStartInstanceOptions
		if !reflect.ValueOf(body).IsZero() {
			options = &armsapvirtualinstance.SAPDatabaseInstancesClientBeginStartInstanceOptions{
				Body: &body,
			}
		}
...
func (s *SAPDatabaseInstancesServerTransport) dispatchBeginStopInstance(req *http.Request) (*http.Response, error) {
	...
	if beginStopInstance == nil {
		...
		var options *armsapvirtualinstance.SAPDatabaseInstancesClientBeginStopInstanceOptions
		if !reflect.ValueOf(body).IsZero() {
			options = &armsapvirtualinstance.SAPDatabaseInstancesClientBeginStopInstanceOptions{
				Body: &body,
			}
		}
...
func (s *SAPDatabaseInstancesServerTransport) dispatchUpdate(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[armsapvirtualinstance.UpdateSAPDatabaseInstanceRequest](req)
	if err != nil {
		return nil, err
	}
	resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
