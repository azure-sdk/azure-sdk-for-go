...
- Type of `DiagnosticDataTableResponseObject.Rows` has been changed from `[]interface{}` to `[]any`
- Type of `ErrorAdditionalInfo.Info` has been changed from `interface{}` to `any`
- Const `SKUNamePremium` from type alias `SKUName` has been removed
