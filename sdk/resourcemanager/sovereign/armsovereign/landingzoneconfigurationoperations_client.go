...
func (client *LandingZoneConfigurationOperationsClient) createCopyCreateRequest(ctx context.Context, resourceGroupName string, landingZoneAccountName string, landingZoneConfigurationName string, body CreateLandingZoneConfigurationCopyRequest, _ *LandingZoneConfigurationOperationsClientBeginCreateCopyOptions) (*policy.Request, error) {
...
// NewListPager - List the landing zone configurations within a landing zone account.
//
// Generated from API version 2025-02-27-preview
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - landingZoneAccountName - The landing zone account.
//   - options - LandingZoneConfigurationOperationsClientListOptions contains the optional parameters for the LandingZoneConfigurationOperationsClient.NewListPager
//     method.
func (client *LandingZoneConfigurationOperationsClient) NewListPager(resourceGroupName string, landingZoneAccountName string, options *LandingZoneConfigurationOperationsClientListOptions) *runtime.Pager[LandingZoneConfigurationOperationsClientListResponse] {
	return runtime.NewPager(runtime.PagingHandler[LandingZoneConfigurationOperationsClientListResponse]{
		More: func(page LandingZoneConfigurationOperationsClientListResponse) bool {
			return page.NextLink != nil && len(*page.NextLink) > 0
		},
		Fetcher: func(ctx context.Context, page *LandingZoneConfigurationOperationsClientListResponse) (LandingZoneConfigurationOperationsClientListResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "LandingZoneConfigurationOperationsClient.NewListPager")
			nextLink := ""
			if page != nil {
			...
			if err != nil {
				return LandingZoneConfigurationOperationsClientListResponse{}, err
			}
...
func (client *LandingZoneConfigurationOperationsClient) listCreateRequest(ctx context.Context, resourceGroupName string, landingZoneAccountName string, _ *LandingZoneConfigurationOperationsClientListOptions) (*policy.Request, error) {
...
func (client *LandingZoneConfigurationOperationsClient) listHandleResponse(resp *http.Response) (LandingZoneConfigurationOperationsClientListResponse, error) {
	result := LandingZoneConfigurationOperationsClientListResponse{}
