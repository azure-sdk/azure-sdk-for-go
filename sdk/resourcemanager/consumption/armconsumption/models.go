...
type LotProperties struct {
	...
	// READ-ONLY; The extended properties of the lot returned as a json string. This is only returned when extendedProperties=true
	...
	// READ-ONLY; The used amount from the lot.
	UsedAmount *Amount
}
