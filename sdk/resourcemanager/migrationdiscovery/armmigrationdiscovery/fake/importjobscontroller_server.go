...
// ImportJobsControllerServer is a fake server for instances of the armmigrationdiscovery.ImportJobsControllerClient type.
type ImportJobsControllerServer struct {
	// Get is the fake for method ImportJobsControllerClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, siteName string, jobName string, options *armmigrationdiscovery.ImportJobsControllerClientGetOptions) (resp azfake.Responder[armmigrationdiscovery.ImportJobsControllerClientGetResponse], errResp azfake.ErrorResponder)

	// GetDeletejob is the fake for method ImportJobsControllerClient.GetDeletejob
	// HTTP status codes to indicate success: http.StatusOK
	GetDeletejob func(ctx context.Context, resourceGroupName string, siteName string, jobName string, options *armmigrationdiscovery.ImportJobsControllerClientGetDeletejobOptions) (resp azfake.Responder[armmigrationdiscovery.ImportJobsControllerClientGetDeletejobResponse], errResp azfake.ErrorResponder)

	// GetExportjob is the fake for method ImportJobsControllerClient.GetExportjob
	// HTTP status codes to indicate success: http.StatusOK
	GetExportjob func(ctx context.Context, resourceGroupName string, siteName string, jobName string, options *armmigrationdiscovery.ImportJobsControllerClientGetExportjobOptions) (resp azfake.Responder[armmigrationdiscovery.ImportJobsControllerClientGetExportjobResponse], errResp azfake.ErrorResponder)

	// GetImportjob is the fake for method ImportJobsControllerClient.GetImportjob
	// HTTP status codes to indicate success: http.StatusOK
	GetImportjob func(ctx context.Context, resourceGroupName string, siteName string, jobName string, options *armmigrationdiscovery.ImportJobsControllerClientGetImportjobOptions) (resp azfake.Responder[armmigrationdiscovery.ImportJobsControllerClientGetImportjobResponse], errResp azfake.ErrorResponder)

	// NewListByImportSitePager is the fake for method ImportJobsControllerClient.NewListByImportSitePager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByImportSitePager func(resourceGroupName string, siteName string, options *armmigrationdiscovery.ImportJobsControllerClientListByImportSiteOptions) (resp azfake.PagerResponder[armmigrationdiscovery.ImportJobsControllerClientListByImportSiteResponse])

	// NewListDeletejobsPager is the fake for method ImportJobsControllerClient.NewListDeletejobsPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListDeletejobsPager func(resourceGroupName string, siteName string, options *armmigrationdiscovery.ImportJobsControllerClientListDeletejobsOptions) (resp azfake.PagerResponder[armmigrationdiscovery.ImportJobsControllerClientListDeletejobsResponse])

	// NewListExportjobsPager is the fake for method ImportJobsControllerClient.NewListExportjobsPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListExportjobsPager func(resourceGroupName string, siteName string, options *armmigrationdiscovery.ImportJobsControllerClientListExportjobsOptions) (resp azfake.PagerResponder[armmigrationdiscovery.ImportJobsControllerClientListExportjobsResponse])

	// NewListImportjobsPager is the fake for method ImportJobsControllerClient.NewListImportjobsPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListImportjobsPager func(resourceGroupName string, siteName string, options *armmigrationdiscovery.ImportJobsControllerClientListImportjobsOptions) (resp azfake.PagerResponder[armmigrationdiscovery.ImportJobsControllerClientListImportjobsResponse])
}
...
// The returned ImportJobsControllerServerTransport instance is connected to an instance of armmigrationdiscovery.ImportJobsControllerClient via the
...
func NewImportJobsControllerServerTransport(srv *ImportJobsControllerServer) *ImportJobsControllerServerTransport {
	return &ImportJobsControllerServerTransport{
		srv:                      srv,
		newListByImportSitePager: newTracker[azfake.PagerResponder[armmigrationdiscovery.ImportJobsControllerClientListByImportSiteResponse]](),
		newListDeletejobsPager:   newTracker[azfake.PagerResponder[armmigrationdiscovery.ImportJobsControllerClientListDeletejobsResponse]](),
		newListExportjobsPager:   newTracker[azfake.PagerResponder[armmigrationdiscovery.ImportJobsControllerClientListExportjobsResponse]](),
		newListImportjobsPager:   newTracker[azfake.PagerResponder[armmigrationdiscovery.ImportJobsControllerClientListImportjobsResponse]](),
	}
}

// ImportJobsControllerServerTransport connects instances of armmigrationdiscovery.ImportJobsControllerClient to instances of ImportJobsControllerServer.
...
type ImportJobsControllerServerTransport struct {
	...
	newListByImportSitePager *tracker[azfake.PagerResponder[armmigrationdiscovery.ImportJobsControllerClientListByImportSiteResponse]]
	newListDeletejobsPager   *tracker[azfake.PagerResponder[armmigrationdiscovery.ImportJobsControllerClientListDeletejobsResponse]]
	newListExportjobsPager   *tracker[azfake.PagerResponder[armmigrationdiscovery.ImportJobsControllerClientListExportjobsResponse]]
	newListImportjobsPager   *tracker[azfake.PagerResponder[armmigrationdiscovery.ImportJobsControllerClientListImportjobsResponse]]
}
...
func (i *ImportJobsControllerServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if importJobsControllerServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = importJobsControllerServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "ImportJobsControllerClient.GetDeletejob":
				res.resp, res.err = i.dispatchGetDeletejob(req)
			case "ImportJobsControllerClient.GetExportjob":
				res.resp, res.err = i.dispatchGetExportjob(req)
			case "ImportJobsControllerClient.GetImportjob":
				res.resp, res.err = i.dispatchGetImportjob(req)
			...
			case "ImportJobsControllerClient.NewListDeletejobsPager":
				res.resp, res.err = i.dispatchNewListDeletejobsPager(req)
			case "ImportJobsControllerClient.NewListExportjobsPager":
				res.resp, res.err = i.dispatchNewListExportjobsPager(req)
			case "ImportJobsControllerClient.NewListImportjobsPager":
				res.resp, res.err = i.dispatchNewListImportjobsPager(req)
			default:
...
func (i *ImportJobsControllerServerTransport) dispatchNewListByImportSitePager(req *http.Request) (*http.Response, error) {
	...
	if newListByImportSitePager == nil {
		...
		server.PagerResponderInjectNextLinks(newListByImportSitePager, req, func(page *armmigrationdiscovery.ImportJobsControllerClientListByImportSiteResponse, createLink func() string) {
...
func (i *ImportJobsControllerServerTransport) dispatchNewListDeletejobsPager(req *http.Request) (*http.Response, error) {
	...
	if newListDeletejobsPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListDeletejobsPager, req, func(page *armmigrationdiscovery.ImportJobsControllerClientListDeletejobsResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
...
func (i *ImportJobsControllerServerTransport) dispatchNewListExportjobsPager(req *http.Request) (*http.Response, error) {
	...
	if newListExportjobsPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListExportjobsPager, req, func(page *armmigrationdiscovery.ImportJobsControllerClientListExportjobsResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
...
func (i *ImportJobsControllerServerTransport) dispatchNewListImportjobsPager(req *http.Request) (*http.Response, error) {
	...
	if newListImportjobsPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListImportjobsPager, req, func(page *armmigrationdiscovery.ImportJobsControllerClientListImportjobsResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
...
// set this to conditionally intercept incoming requests to ImportJobsControllerServerTransport
var importJobsControllerServerTransportInterceptor interface {
