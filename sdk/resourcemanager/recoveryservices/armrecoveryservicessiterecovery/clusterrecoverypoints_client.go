...
func NewClusterRecoveryPointsClient(resourceName string, subscriptionID string, fabricName string, protectionContainerName string, replicationProtectionClusterName string, credential azcore.TokenCredential, options *arm.ClientOptions) (*ClusterRecoveryPointsClient, error) {
...
func (client *ClusterRecoveryPointsClient) NewListByReplicationProtectionClusterPager(resourceGroupName string, options *ClusterRecoveryPointsClientListByReplicationProtectionClusterOptions) *runtime.Pager[ClusterRecoveryPointsClientListByReplicationProtectionClusterResponse] {
	return runtime.NewPager(runtime.PagingHandler[ClusterRecoveryPointsClientListByReplicationProtectionClusterResponse]{
		...
		Fetcher: func(ctx context.Context, page *ClusterRecoveryPointsClientListByReplicationProtectionClusterResponse) (ClusterRecoveryPointsClientListByReplicationProtectionClusterResponse, error) {
			...
			resp, err := runtime.FetcherForNextLink(ctx, client.internal.Pipeline(), nextLink, func(ctx context.Context) (*policy.Request, error) {
				return client.listByReplicationProtectionClusterCreateRequest(ctx, resourceGroupName, options)
			}, nil)
			if err != nil {
...
func (client *ClusterRecoveryPointsClient) listByReplicationProtectionClusterCreateRequest(ctx context.Context, resourceGroupName string, options *ClusterRecoveryPointsClientListByReplicationProtectionClusterOptions) (*policy.Request, error) {
