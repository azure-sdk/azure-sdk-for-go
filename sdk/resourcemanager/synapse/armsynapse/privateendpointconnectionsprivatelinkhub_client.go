...
func (client *PrivateEndpointConnectionsPrivateLinkHubClient) getCreateRequest(ctx context.Context, resourceGroupName string, privateLinkHubName string, privateEndpointConnectionName string, _ *PrivateEndpointConnectionsPrivateLinkHubClientGetOptions) (*policy.Request, error) {
...
func (client *PrivateEndpointConnectionsPrivateLinkHubClient) listCreateRequest(ctx context.Context, resourceGroupName string, privateLinkHubName string, _ *PrivateEndpointConnectionsPrivateLinkHubClientListOptions) (*policy.Request, error) {
