...
type ServerFactory struct {
	// EvidenceServer contains the fakes for client EvidenceClient
	EvidenceServer EvidenceServer

	// OperationsServer contains the fakes for client OperationsClient
	OperationsServer OperationsServer

	// ProviderActionsServer contains the fakes for client ProviderActionsClient
	ProviderActionsServer ProviderActionsServer

	// ReportServer contains the fakes for client ReportClient
	ReportServer ReportServer

	// ScopingConfigurationServer contains the fakes for client ScopingConfigurationClient
	ScopingConfigurationServer ScopingConfigurationServer

	// SnapshotServer contains the fakes for client SnapshotClient
