...
func (b *BusinessProcessVersionsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if businessProcessVersionsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = businessProcessVersionsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "BusinessProcessVersionsClient.NewListByBusinessProcessPager":
				res.resp, res.err = b.dispatchNewListByBusinessProcessPager(req)
			default:
...
// set this to conditionally intercept incoming requests to BusinessProcessVersionsServerTransport
var businessProcessVersionsServerTransportInterceptor interface {
