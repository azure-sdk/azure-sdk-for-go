...
func (s *SparkConfigurationsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if sparkConfigurationsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = sparkConfigurationsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to SparkConfigurationsServerTransport
var sparkConfigurationsServerTransportInterceptor interface {
