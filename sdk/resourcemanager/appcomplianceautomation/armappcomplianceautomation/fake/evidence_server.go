...
func (e *EvidenceServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if evidenceServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = evidenceServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "EvidenceClient.Download":
				res.resp, res.err = e.dispatchDownload(req)
			case "EvidenceClient.Get":
				res.resp, res.err = e.dispatchGet(req)
			case "EvidenceClient.NewListByReportPager":
				res.resp, res.err = e.dispatchNewListByReportPager(req)
			default:
...
// set this to conditionally intercept incoming requests to EvidenceServerTransport
var evidenceServerTransportInterceptor interface {
