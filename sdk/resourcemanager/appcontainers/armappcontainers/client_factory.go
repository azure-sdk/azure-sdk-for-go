...
func (c *ClientFactory) NewDotNetComponentsClient() *DotNetComponentsClient {
	subClient, _ := NewDotNetComponentsClient(c.subscriptionID, c.credential, c.options)
	return subClient
}
...
func (c *ClientFactory) NewJavaComponentsClient() *JavaComponentsClient {
	subClient, _ := NewJavaComponentsClient(c.subscriptionID, c.credential, c.options)
	return subClient
}
...
// NewManagedEnvironmentSecretsClient creates a new instance of ManagedEnvironmentSecretsClient.
func (c *ClientFactory) NewManagedEnvironmentSecretsClient() *ManagedEnvironmentSecretsClient {
	subClient, _ := NewManagedEnvironmentSecretsClient(c.subscriptionID, c.credential, c.options)
	return subClient
}
