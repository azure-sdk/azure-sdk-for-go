...
func NewCassandraRepairClient(subscriptionID string, credential azcore.TokenCredential, options *arm.ClientOptions) (*CassandraRepairClient, error) {
	cl, err := arm.NewClient(moduleName+".CassandraRepairClient", moduleVersion, credential, options)
	if err != nil {
		return nil, err
	}
...
func (client *CassandraRepairClient) BeginAbortSegment(ctx context.Context, resourceGroupName string, clusterName string, repairRunID string, segmentID string, options *CassandraRepairClientBeginAbortSegmentOptions) (*runtime.Poller[CassandraRepairClientAbortSegmentResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		poller, err := runtime.NewPoller[CassandraRepairClientAbortSegmentResponse](resp, client.internal.Pipeline(), nil)
		return poller, err
	} else {
		return runtime.NewPollerFromResumeToken[CassandraRepairClientAbortSegmentResponse](options.ResumeToken, client.internal.Pipeline(), nil)
	}
}
...
func (client *CassandraRepairClient) BeginCreate(ctx context.Context, resourceGroupName string, clusterName string, body CassandraClusterRepairPublicResource, options *CassandraRepairClientBeginCreateOptions) (*runtime.Poller[CassandraRepairClientCreateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		poller, err := runtime.NewPoller[CassandraRepairClientCreateResponse](resp, client.internal.Pipeline(), nil)
		return poller, err
	} else {
		return runtime.NewPollerFromResumeToken[CassandraRepairClientCreateResponse](options.ResumeToken, client.internal.Pipeline(), nil)
	}
}
...
func (client *CassandraRepairClient) BeginDelete(ctx context.Context, resourceGroupName string, clusterName string, repairRunID string, ownerName string, options *CassandraRepairClientBeginDeleteOptions) (*runtime.Poller[CassandraRepairClientDeleteResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		poller, err := runtime.NewPoller[CassandraRepairClientDeleteResponse](resp, client.internal.Pipeline(), nil)
		return poller, err
	} else {
		return runtime.NewPollerFromResumeToken[CassandraRepairClientDeleteResponse](options.ResumeToken, client.internal.Pipeline(), nil)
	}
}
...
func (client *CassandraRepairClient) BeginGetClusterStatus(ctx context.Context, resourceGroupName string, clusterName string, options *CassandraRepairClientBeginGetClusterStatusOptions) (*runtime.Poller[CassandraRepairClientGetClusterStatusResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		poller, err := runtime.NewPoller[CassandraRepairClientGetClusterStatusResponse](resp, client.internal.Pipeline(), nil)
		return poller, err
	} else {
		return runtime.NewPollerFromResumeToken[CassandraRepairClientGetClusterStatusResponse](options.ResumeToken, client.internal.Pipeline(), nil)
	}
}
...
func (client *CassandraRepairClient) BeginGetTableStatus(ctx context.Context, resourceGroupName string, clusterName string, options *CassandraRepairClientBeginGetTableStatusOptions) (*runtime.Poller[CassandraRepairClientGetTableStatusResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		poller, err := runtime.NewPoller[CassandraRepairClientGetTableStatusResponse](resp, client.internal.Pipeline(), nil)
		return poller, err
	} else {
		return runtime.NewPollerFromResumeToken[CassandraRepairClientGetTableStatusResponse](options.ResumeToken, client.internal.Pipeline(), nil)
	}
}
...
func (client *CassandraRepairClient) BeginList(ctx context.Context, resourceGroupName string, clusterName string, options *CassandraRepairClientBeginListOptions) (*runtime.Poller[CassandraRepairClientListResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		poller, err := runtime.NewPoller[CassandraRepairClientListResponse](resp, client.internal.Pipeline(), nil)
		return poller, err
	} else {
		return runtime.NewPollerFromResumeToken[CassandraRepairClientListResponse](options.ResumeToken, client.internal.Pipeline(), nil)
	}
}
...
func (client *CassandraRepairClient) BeginListSegments(ctx context.Context, resourceGroupName string, clusterName string, repairRunID string, options *CassandraRepairClientBeginListSegmentsOptions) (*runtime.Poller[CassandraRepairClientListSegmentsResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		poller, err := runtime.NewPoller[CassandraRepairClientListSegmentsResponse](resp, client.internal.Pipeline(), nil)
		return poller, err
	} else {
		return runtime.NewPollerFromResumeToken[CassandraRepairClientListSegmentsResponse](options.ResumeToken, client.internal.Pipeline(), nil)
	}
}
...
func (client *CassandraRepairClient) BeginPause(ctx context.Context, resourceGroupName string, clusterName string, repairRunID string, options *CassandraRepairClientBeginPauseOptions) (*runtime.Poller[CassandraRepairClientPauseResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		poller, err := runtime.NewPoller[CassandraRepairClientPauseResponse](resp, client.internal.Pipeline(), nil)
		return poller, err
	} else {
		return runtime.NewPollerFromResumeToken[CassandraRepairClientPauseResponse](options.ResumeToken, client.internal.Pipeline(), nil)
	}
}
...
func (client *CassandraRepairClient) BeginResume(ctx context.Context, resourceGroupName string, clusterName string, repairRunID string, options *CassandraRepairClientBeginResumeOptions) (*runtime.Poller[CassandraRepairClientResumeResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		poller, err := runtime.NewPoller[CassandraRepairClientResumeResponse](resp, client.internal.Pipeline(), nil)
		return poller, err
	} else {
		return runtime.NewPollerFromResumeToken[CassandraRepairClientResumeResponse](options.ResumeToken, client.internal.Pipeline(), nil)
	}
}
...
func (client *CassandraRepairClient) BeginShow(ctx context.Context, resourceGroupName string, clusterName string, repairRunID string, options *CassandraRepairClientBeginShowOptions) (*runtime.Poller[CassandraRepairClientShowResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		poller, err := runtime.NewPoller[CassandraRepairClientShowResponse](resp, client.internal.Pipeline(), nil)
		return poller, err
	} else {
		return runtime.NewPollerFromResumeToken[CassandraRepairClientShowResponse](options.ResumeToken, client.internal.Pipeline(), nil)
	}
}
...
func (client *CassandraRepairClient) BeginUpdate(ctx context.Context, resourceGroupName string, clusterName string, repairRunID string, intensityValue string, options *CassandraRepairClientBeginUpdateOptions) (*runtime.Poller[CassandraRepairClientUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		poller, err := runtime.NewPoller[CassandraRepairClientUpdateResponse](resp, client.internal.Pipeline(), nil)
		return poller, err
	} else {
		return runtime.NewPollerFromResumeToken[CassandraRepairClientUpdateResponse](options.ResumeToken, client.internal.Pipeline(), nil)
	}
}
