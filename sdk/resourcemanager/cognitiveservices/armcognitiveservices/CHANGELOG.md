...
- New enum type `Scenario` with values `ScenarioAgent`
...
- New field `AllowProjectManagement`, `DefaultProject`, `NetworkInjections` in struct `AccountProperties`
