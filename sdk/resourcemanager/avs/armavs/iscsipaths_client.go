...
// NewListPager - List IscsiPath resources by PrivateCloud
//
// Generated from API version 2023-09-01
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - privateCloudName - Name of the private cloud
//   - options - IscsiPathsClientListOptions contains the optional parameters for the IscsiPathsClient.NewListPager method.
func (client *IscsiPathsClient) NewListPager(resourceGroupName string, privateCloudName string, options *IscsiPathsClientListOptions) *runtime.Pager[IscsiPathsClientListResponse] {
	return runtime.NewPager(runtime.PagingHandler[IscsiPathsClientListResponse]{
		More: func(page IscsiPathsClientListResponse) bool {
			return page.NextLink != nil && len(*page.NextLink) > 0
		},
		Fetcher: func(ctx context.Context, page *IscsiPathsClientListResponse) (IscsiPathsClientListResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "IscsiPathsClient.NewListPager")
			nextLink := ""
			if page != nil {
			...
			if err != nil {
				return IscsiPathsClientListResponse{}, err
			}
...
func (client *IscsiPathsClient) listCreateRequest(ctx context.Context, resourceGroupName string, privateCloudName string, _ *IscsiPathsClientListOptions) (*policy.Request, error) {
...
func (client *IscsiPathsClient) listHandleResponse(resp *http.Response) (IscsiPathsClientListResponse, error) {
	result := IscsiPathsClientListResponse{}
