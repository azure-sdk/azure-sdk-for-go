...
func (client *BusinessCaseOperationsClient) compareSummaryCreateRequest(ctx context.Context, resourceGroupName string, projectName string, businessCaseName string, body any, options *BusinessCaseOperationsClientBeginCompareSummaryOptions) (*policy.Request, error) {
...
func (client *BusinessCaseOperationsClient) createCreateRequest(ctx context.Context, resourceGroupName string, projectName string, businessCaseName string, resource BusinessCase, options *BusinessCaseOperationsClientBeginCreateOptions) (*policy.Request, error) {
...
func (client *BusinessCaseOperationsClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, projectName string, businessCaseName string, options *BusinessCaseOperationsClientDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Migrate/assessmentProjects/{projectName}/businessCases/{businessCaseName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *BusinessCaseOperationsClient) getCreateRequest(ctx context.Context, resourceGroupName string, projectName string, businessCaseName string, options *BusinessCaseOperationsClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Migrate/assessmentProjects/{projectName}/businessCases/{businessCaseName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *BusinessCaseOperationsClient) getReportDownloadURLCreateRequest(ctx context.Context, resourceGroupName string, projectName string, businessCaseName string, body any, options *BusinessCaseOperationsClientBeginGetReportDownloadURLOptions) (*policy.Request, error) {
...
func (client *BusinessCaseOperationsClient) listByAssessmentProjectCreateRequest(ctx context.Context, resourceGroupName string, projectName string, options *BusinessCaseOperationsClientListByAssessmentProjectOptions) (*policy.Request, error) {
