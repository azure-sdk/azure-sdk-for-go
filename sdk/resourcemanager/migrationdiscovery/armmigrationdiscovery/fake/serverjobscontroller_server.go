...
// ServerJobsControllerServer is a fake server for instances of the armmigrationdiscovery.ServerJobsControllerClient type.
type ServerJobsControllerServer struct {
	// Get is the fake for method ServerJobsControllerClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, siteName string, jobName string, options *armmigrationdiscovery.ServerJobsControllerClientGetOptions) (resp azfake.Responder[armmigrationdiscovery.ServerJobsControllerClientGetResponse], errResp azfake.ErrorResponder)

	// NewListByServerSiteResourcePager is the fake for method ServerJobsControllerClient.NewListByServerSiteResourcePager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByServerSiteResourcePager func(resourceGroupName string, siteName string, options *armmigrationdiscovery.ServerJobsControllerClientListByServerSiteResourceOptions) (resp azfake.PagerResponder[armmigrationdiscovery.ServerJobsControllerClientListByServerSiteResourceResponse])
}
...
// The returned ServerJobsControllerServerTransport instance is connected to an instance of armmigrationdiscovery.ServerJobsControllerClient via the
...
func NewServerJobsControllerServerTransport(srv *ServerJobsControllerServer) *ServerJobsControllerServerTransport {
	return &ServerJobsControllerServerTransport{
		srv:                              srv,
		newListByServerSiteResourcePager: newTracker[azfake.PagerResponder[armmigrationdiscovery.ServerJobsControllerClientListByServerSiteResourceResponse]](),
	}
}

// ServerJobsControllerServerTransport connects instances of armmigrationdiscovery.ServerJobsControllerClient to instances of ServerJobsControllerServer.
...
type ServerJobsControllerServerTransport struct {
	...
	newListByServerSiteResourcePager *tracker[azfake.PagerResponder[armmigrationdiscovery.ServerJobsControllerClientListByServerSiteResourceResponse]]
}
...
func (s *ServerJobsControllerServerTransport) dispatchNewListByServerSiteResourcePager(req *http.Request) (*http.Response, error) {
	...
	if newListByServerSiteResourcePager == nil {
		...
		server.PagerResponderInjectNextLinks(newListByServerSiteResourcePager, req, func(page *armmigrationdiscovery.ServerJobsControllerClientListByServerSiteResourceResponse, createLink func() string) {
