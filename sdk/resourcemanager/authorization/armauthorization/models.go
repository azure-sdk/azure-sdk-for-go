...
type AccessReviewDecisionInsightProperties struct {
	...
	InsightCreatedDateTime any `json:"insightCreatedDateTime,omitempty" azure:"ro"`
}
...
type AccessReviewDecisionUserSignInInsightProperties struct {
	...
	LastSignInDateTime any `json:"lastSignInDateTime,omitempty" azure:"ro"`
}
...
type AlertOperationResult struct {
	...
	StatusDetail *string `json:"statusDetail,omitempty" azure:"ro"`
}
