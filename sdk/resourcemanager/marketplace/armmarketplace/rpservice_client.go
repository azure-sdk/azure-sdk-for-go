...
// PrivateStoreCollectionOfferPlansList - Get a list of offer plans for given collection, considering the provided contexts.
...
//   - options - RPServiceClientPrivateStoreCollectionOfferPlansListOptions contains the optional parameters for the RPServiceClient.PrivateStoreCollectionOfferPlansList
//     method.
func (client *RPServiceClient) PrivateStoreCollectionOfferPlansList(ctx context.Context, privateStoreID string, collectionID string, offerID string, options *RPServiceClientPrivateStoreCollectionOfferPlansListOptions) (RPServiceClientPrivateStoreCollectionOfferPlansListResponse, error) {
	var err error
	const operationName = "RPServiceClient.PrivateStoreCollectionOfferPlansList"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.privateStoreCollectionOfferPlansListCreateRequest(ctx, privateStoreID, collectionID, offerID, options)
	if err != nil {
		return RPServiceClientPrivateStoreCollectionOfferPlansListResponse{}, err
	}
	...
	resp, err := client.privateStoreCollectionOfferPlansListHandleResponse(httpResp)
	return resp, err
}

// privateStoreCollectionOfferPlansListCreateRequest creates the PrivateStoreCollectionOfferPlansList request.
func (client *RPServiceClient) privateStoreCollectionOfferPlansListCreateRequest(ctx context.Context, privateStoreID string, collectionID string, offerID string, options *RPServiceClientPrivateStoreCollectionOfferPlansListOptions) (*policy.Request, error) {
	urlPath := "/providers/Microsoft.Marketplace/privateStores/{privateStoreId}/collections/{collectionId}/offers/{offerId}/plans"
	if privateStoreID == "" {
...
// privateStoreCollectionOfferPlansListHandleResponse handles the PrivateStoreCollectionOfferPlansList response.
func (client *RPServiceClient) privateStoreCollectionOfferPlansListHandleResponse(resp *http.Response) (RPServiceClientPrivateStoreCollectionOfferPlansListResponse, error) {
	result := RPServiceClientPrivateStoreCollectionOfferPlansListResponse{}
	if err := runtime.UnmarshalAsJSON(resp, &result.PlanListResponse); err != nil {
		return RPServiceClientPrivateStoreCollectionOfferPlansListResponse{}, err
	}
	return result, nil
}
