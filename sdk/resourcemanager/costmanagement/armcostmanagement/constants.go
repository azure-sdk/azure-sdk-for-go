...
// BenefitsUtilizationSummariesReportSchema - The CSV file from the reportUrl blob link consists of reservation usage data
// with the following schema at daily granularity
type BenefitsUtilizationSummariesReportSchema string

const (
	BenefitsUtilizationSummariesReportSchemaARMSKUName               BenefitsUtilizationSummariesReportSchema = "ARMSkuName"
	BenefitsUtilizationSummariesReportSchemaAvgUtilizationPercentage BenefitsUtilizationSummariesReportSchema = "AvgUtilizationPercentage"
	BenefitsUtilizationSummariesReportSchemaBenefitID                BenefitsUtilizationSummariesReportSchema = "BenefitId"
	BenefitsUtilizationSummariesReportSchemaBenefitOrderID           BenefitsUtilizationSummariesReportSchema = "BenefitOrderId"
	BenefitsUtilizationSummariesReportSchemaBenefitType              BenefitsUtilizationSummariesReportSchema = "BenefitType"
	BenefitsUtilizationSummariesReportSchemaMaxUtilizationPercentage BenefitsUtilizationSummariesReportSchema = "MaxUtilizationPercentage"
	BenefitsUtilizationSummariesReportSchemaMinUtilizationPercentage BenefitsUtilizationSummariesReportSchema = "MinUtilizationPercentage"
	BenefitsUtilizationSummariesReportSchemaUsageDate                BenefitsUtilizationSummariesReportSchema = "UsageDate"
)

// PossibleBenefitsUtilizationSummariesReportSchemaValues returns the possible values for the BenefitsUtilizationSummariesReportSchema const type.
func PossibleBenefitsUtilizationSummariesReportSchemaValues() []BenefitsUtilizationSummariesReportSchema {
	return []BenefitsUtilizationSummariesReportSchema{
		BenefitsUtilizationSummariesReportSchemaARMSKUName,
		BenefitsUtilizationSummariesReportSchemaAvgUtilizationPercentage,
		BenefitsUtilizationSummariesReportSchemaBenefitID,
		BenefitsUtilizationSummariesReportSchemaBenefitOrderID,
		BenefitsUtilizationSummariesReportSchemaBenefitType,
		BenefitsUtilizationSummariesReportSchemaMaxUtilizationPercentage,
		BenefitsUtilizationSummariesReportSchemaMinUtilizationPercentage,
		BenefitsUtilizationSummariesReportSchemaUsageDate,
	}
}
...
const (
	// SettingTypeTagInheritance - Tag Inheritance Settings is to inherit user defined tags from container(subscription/resource
