...
// ApplicationGatewayMigrationRequest - Details of application gateway migration request.
type ApplicationGatewayMigrationRequest struct {
	...
	// SKU of the application gateway resource(Accepted value is Basic,applicable only in case of StandardSmall and StandardMedium
	// with 2 or less instances), otherwise by default standardv1 is migrated to
	// standardv2 and wafv1 is migrated to wafv2.
	SKU *ApplicationGatewaySKU

	// Subnet Id of the v2 application gateway resource.
	SubnetID *string

	// Name of the WAF policy to be attached to the v2 gateway(applicable in only case of the wafv1 to wafv2 migration for converting
	// the waf config associated to wafv1 gateway to a waf policy).
...
type ApplicationGatewayPrepareMigrationRequestResponse struct {
