...
func (s *SQLPoolDataWarehouseUserActivitiesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if sqlPoolDataWarehouseUserActivitiesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = sqlPoolDataWarehouseUserActivitiesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to SQLPoolDataWarehouseUserActivitiesServerTransport
var sqlPoolDataWarehouseUserActivitiesServerTransportInterceptor interface {
