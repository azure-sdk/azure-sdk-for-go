...
// SQLSitesControllerServer is a fake server for instances of the armmigrationdiscovery.SQLSitesControllerClient type.
type SQLSitesControllerServer struct {
	// Create is the fake for method SQLSitesControllerClient.Create
	// HTTP status codes to indicate success: http.StatusOK, http.StatusCreated
	Create func(ctx context.Context, resourceGroupName string, siteName string, sqlSiteName string, body armmigrationdiscovery.SQLSite, options *armmigrationdiscovery.SQLSitesControllerClientCreateOptions) (resp azfake.Responder[armmigrationdiscovery.SQLSitesControllerClientCreateResponse], errResp azfake.ErrorResponder)

	// Delete is the fake for method SQLSitesControllerClient.Delete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	Delete func(ctx context.Context, resourceGroupName string, siteName string, sqlSiteName string, options *armmigrationdiscovery.SQLSitesControllerClientDeleteOptions) (resp azfake.Responder[armmigrationdiscovery.SQLSitesControllerClientDeleteResponse], errResp azfake.ErrorResponder)

	// ErrorSummary is the fake for method SQLSitesControllerClient.ErrorSummary
	// HTTP status codes to indicate success: http.StatusOK
	ErrorSummary func(ctx context.Context, resourceGroupName string, siteName string, sqlSiteName string, body armmigrationdiscovery.ErrorSummaryRequest, options *armmigrationdiscovery.SQLSitesControllerClientErrorSummaryOptions) (resp azfake.Responder[armmigrationdiscovery.SQLSitesControllerClientErrorSummaryResponse], errResp azfake.ErrorResponder)

	// BeginExportSQLServerErrors is the fake for method SQLSitesControllerClient.BeginExportSQLServerErrors
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginExportSQLServerErrors func(ctx context.Context, resourceGroupName string, siteName string, sqlSiteName string, body any, options *armmigrationdiscovery.SQLSitesControllerClientBeginExportSQLServerErrorsOptions) (resp azfake.PollerResponder[armmigrationdiscovery.SQLSitesControllerClientExportSQLServerErrorsResponse], errResp azfake.ErrorResponder)

	// BeginExportSQLServers is the fake for method SQLSitesControllerClient.BeginExportSQLServers
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginExportSQLServers func(ctx context.Context, resourceGroupName string, siteName string, sqlSiteName string, body armmigrationdiscovery.ExportSQLServersRequest, options *armmigrationdiscovery.SQLSitesControllerClientBeginExportSQLServersOptions) (resp azfake.PollerResponder[armmigrationdiscovery.SQLSitesControllerClientExportSQLServersResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method SQLSitesControllerClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, siteName string, sqlSiteName string, options *armmigrationdiscovery.SQLSitesControllerClientGetOptions) (resp azfake.Responder[armmigrationdiscovery.SQLSitesControllerClientGetResponse], errResp azfake.ErrorResponder)

	// NewListByMasterSitePager is the fake for method SQLSitesControllerClient.NewListByMasterSitePager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByMasterSitePager func(resourceGroupName string, siteName string, options *armmigrationdiscovery.SQLSitesControllerClientListByMasterSiteOptions) (resp azfake.PagerResponder[armmigrationdiscovery.SQLSitesControllerClientListByMasterSiteResponse])

	// BeginRefresh is the fake for method SQLSitesControllerClient.BeginRefresh
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginRefresh func(ctx context.Context, resourceGroupName string, siteName string, sqlSiteName string, body armmigrationdiscovery.SQLSiteRefreshBody, options *armmigrationdiscovery.SQLSitesControllerClientBeginRefreshOptions) (resp azfake.PollerResponder[armmigrationdiscovery.SQLSitesControllerClientRefreshResponse], errResp azfake.ErrorResponder)

	// Summary is the fake for method SQLSitesControllerClient.Summary
	// HTTP status codes to indicate success: http.StatusOK
	Summary func(ctx context.Context, resourceGroupName string, siteName string, sqlSiteName string, options *armmigrationdiscovery.SQLSitesControllerClientSummaryOptions) (resp azfake.Responder[armmigrationdiscovery.SQLSitesControllerClientSummaryResponse], errResp azfake.ErrorResponder)

	// BeginUpdate is the fake for method SQLSitesControllerClient.BeginUpdate
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginUpdate func(ctx context.Context, resourceGroupName string, siteName string, sqlSiteName string, properties armmigrationdiscovery.SQLSiteUpdate, options *armmigrationdiscovery.SQLSitesControllerClientBeginUpdateOptions) (resp azfake.PollerResponder[armmigrationdiscovery.SQLSitesControllerClientUpdateResponse], errResp azfake.ErrorResponder)
}
...
// The returned SQLSitesControllerServerTransport instance is connected to an instance of armmigrationdiscovery.SQLSitesControllerClient via the
...
func NewSQLSitesControllerServerTransport(srv *SQLSitesControllerServer) *SQLSitesControllerServerTransport {
	return &SQLSitesControllerServerTransport{
		srv:                        srv,
		beginExportSQLServerErrors: newTracker[azfake.PollerResponder[armmigrationdiscovery.SQLSitesControllerClientExportSQLServerErrorsResponse]](),
		beginExportSQLServers:      newTracker[azfake.PollerResponder[armmigrationdiscovery.SQLSitesControllerClientExportSQLServersResponse]](),
		newListByMasterSitePager:   newTracker[azfake.PagerResponder[armmigrationdiscovery.SQLSitesControllerClientListByMasterSiteResponse]](),
		beginRefresh:               newTracker[azfake.PollerResponder[armmigrationdiscovery.SQLSitesControllerClientRefreshResponse]](),
		beginUpdate:                newTracker[azfake.PollerResponder[armmigrationdiscovery.SQLSitesControllerClientUpdateResponse]](),
	}
}

// SQLSitesControllerServerTransport connects instances of armmigrationdiscovery.SQLSitesControllerClient to instances of SQLSitesControllerServer.
...
type SQLSitesControllerServerTransport struct {
	...
	beginExportSQLServerErrors *tracker[azfake.PollerResponder[armmigrationdiscovery.SQLSitesControllerClientExportSQLServerErrorsResponse]]
	beginExportSQLServers      *tracker[azfake.PollerResponder[armmigrationdiscovery.SQLSitesControllerClientExportSQLServersResponse]]
	newListByMasterSitePager   *tracker[azfake.PagerResponder[armmigrationdiscovery.SQLSitesControllerClientListByMasterSiteResponse]]
	beginRefresh               *tracker[azfake.PollerResponder[armmigrationdiscovery.SQLSitesControllerClientRefreshResponse]]
	beginUpdate                *tracker[azfake.PollerResponder[armmigrationdiscovery.SQLSitesControllerClientUpdateResponse]]
}
...
func (s *SQLSitesControllerServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if sqlSitesControllerServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = sqlSitesControllerServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "SQLSitesControllerClient.ErrorSummary":
				res.resp, res.err = s.dispatchErrorSummary(req)
			case "SQLSitesControllerClient.BeginExportSQLServerErrors":
				res.resp, res.err = s.dispatchBeginExportSQLServerErrors(req)
			case "SQLSitesControllerClient.BeginExportSQLServers":
				res.resp, res.err = s.dispatchBeginExportSQLServers(req)
			case "SQLSitesControllerClient.Get":
				res.resp, res.err = s.dispatchGet(req)
			case "SQLSitesControllerClient.NewListByMasterSitePager":
				res.resp, res.err = s.dispatchNewListByMasterSitePager(req)
...
func (s *SQLSitesControllerServerTransport) dispatchCreate(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[armmigrationdiscovery.SQLSite](req)
	if err != nil {
		return nil, err
	}
...
func (s *SQLSitesControllerServerTransport) dispatchBeginExportSQLServers(req *http.Request) (*http.Response, error) {
	...
	if beginExportSQLServers == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armmigrationdiscovery.ExportSQLServersRequest](req)
		if err != nil {
			return nil, err
		}
		resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
...
func (s *SQLSitesControllerServerTransport) dispatchNewListByMasterSitePager(req *http.Request) (*http.Response, error) {
	...
	if newListByMasterSitePager == nil {
		...
		server.PagerResponderInjectNextLinks(newListByMasterSitePager, req, func(page *armmigrationdiscovery.SQLSitesControllerClientListByMasterSiteResponse, createLink func() string) {
...
func (s *SQLSitesControllerServerTransport) dispatchBeginRefresh(req *http.Request) (*http.Response, error) {
	...
	if beginRefresh == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armmigrationdiscovery.SQLSiteRefreshBody](req)
		if err != nil {
			return nil, err
		}
		resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
...
func (s *SQLSitesControllerServerTransport) dispatchBeginUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginUpdate == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armmigrationdiscovery.SQLSiteUpdate](req)
		if err != nil {
			return nil, err
		}
		resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
...
// set this to conditionally intercept incoming requests to SQLSitesControllerServerTransport
var sqlSitesControllerServerTransportInterceptor interface {
