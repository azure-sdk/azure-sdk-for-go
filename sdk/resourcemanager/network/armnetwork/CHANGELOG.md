...
- New enum type `ApplicationGatewayMigrationType` with values `ApplicationGatewayMigrationTypeUpgradeDeploymentToV2SKU`
...
- New function `*ApplicationGatewaysClient.BeginCommitMigration(context.Context, string, string, ApplicationGatewayMigrationRequest, *ApplicationGatewaysClientBeginCommitMigrationOptions) (*runtime.Poller[ApplicationGatewaysClientCommitMigrationResponse], error)`
- New function `*ApplicationGatewaysClient.BeginExecuteMigration(context.Context, string, string, ApplicationGatewayMigrationRequest, *ApplicationGatewaysClientBeginExecuteMigrationOptions) (*runtime.Poller[ApplicationGatewaysClientExecuteMigrationResponse], error)`
- New function `*ApplicationGatewaysClient.BeginPrepareMigration(context.Context, string, string, ApplicationGatewayMigrationRequest, *ApplicationGatewaysClientBeginPrepareMigrationOptions) (*runtime.Poller[ApplicationGatewaysClientPrepareMigrationResponse], error)`
...
- New struct `ApplicationGatewayMigrationRequest`
- New struct `ApplicationGatewayPrepareMigrationRequestResponse`
