...
func (client *ServerRunAsAccountsControllerClient) getCreateRequest(ctx context.Context, resourceGroupName string, siteName string, accountName string, _ *ServerRunAsAccountsControllerClientGetOptions) (*policy.Request, error) {
...
func (client *ServerRunAsAccountsControllerClient) listByServerSiteResourceCreateRequest(ctx context.Context, resourceGroupName string, siteName string, _ *ServerRunAsAccountsControllerClientListByServerSiteResourceOptions) (*policy.Request, error) {
