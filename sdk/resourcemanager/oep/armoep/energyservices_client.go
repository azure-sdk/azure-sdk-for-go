...
// method.
func (client *EnergyServicesClient) BeginCreate(ctx context.Context, resourceGroupName string, resourceName string, body EnergyService, options *EnergyServicesClientBeginCreateOptions) (*runtime.Poller[EnergyServicesClientCreateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.create(ctx, resourceGroupName, resourceName, body, options)
		if err != nil {
			return nil, err
		}
...
// If the operation fails it returns an *azcore.ResponseError type.
// Generated from API version 2022-04-04-preview
func (client *EnergyServicesClient) create(ctx context.Context, resourceGroupName string, resourceName string, body EnergyService, options *EnergyServicesClientBeginCreateOptions) (*http.Response, error) {
	req, err := client.createCreateRequest(ctx, resourceGroupName, resourceName, body, options)
	if err != nil {
		return nil, err
	}
	resp, err := client.pl.Do(req)
...
func (client *EnergyServicesClient) createCreateRequest(ctx context.Context, resourceGroupName string, resourceName string, body EnergyService, options *EnergyServicesClientBeginCreateOptions) (*policy.Request, error) {
...
func (client *EnergyServicesClient) Update(ctx context.Context, resourceGroupName string, resourceName string, body EnergyResourceUpdate, options *EnergyServicesClientUpdateOptions) (EnergyServicesClientUpdateResponse, error) {
...
func (client *EnergyServicesClient) updateCreateRequest(ctx context.Context, resourceGroupName string, resourceName string, body EnergyResourceUpdate, options *EnergyServicesClientUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OpenEnergyPlatform/energyServices/{resourceName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
