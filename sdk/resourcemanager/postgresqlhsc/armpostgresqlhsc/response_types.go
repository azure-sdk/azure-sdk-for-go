...
// ConfigurationsClientUpdateCoordinatorResponse contains the response from method ConfigurationsClient.BeginUpdateCoordinator.
type ConfigurationsClientUpdateCoordinatorResponse struct {
	ServerConfiguration
}

// ConfigurationsClientUpdateNodeResponse contains the response from method ConfigurationsClient.BeginUpdateNode.
