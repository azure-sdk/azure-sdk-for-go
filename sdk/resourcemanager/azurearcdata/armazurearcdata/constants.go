...
// AssessmentCategory - The category of the requirement.
type AssessmentCategory string

const (
	AssessmentCategoryCertificates                   AssessmentCategory = "Certificates"
	AssessmentCategoryDag                            AssessmentCategory = "Dag"
	AssessmentCategoryManagedInstance                AssessmentCategory = "ManagedInstance"
	AssessmentCategoryManagedInstanceCrossValidation AssessmentCategory = "ManagedInstanceCrossValidation"
	AssessmentCategorySQLServer                      AssessmentCategory = "SQLServer"
)

// PossibleAssessmentCategoryValues returns the possible values for the AssessmentCategory const type.
func PossibleAssessmentCategoryValues() []AssessmentCategory {
	return []AssessmentCategory{
		AssessmentCategoryCertificates,
		AssessmentCategoryDag,
		AssessmentCategoryManagedInstance,
		AssessmentCategoryManagedInstanceCrossValidation,
		AssessmentCategorySQLServer,
	}
}
