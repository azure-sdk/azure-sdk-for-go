...
// MarshalJSON implements the json.Marshaller interface for type UserInfoAutoGenerated.
func (u UserInfoAutoGenerated) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "email", u.Email)
	populate(objectMap, "name", u.Name)
	populate(objectMap, "objectId", u.ObjectID)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type UserInfoAutoGenerated.
func (u *UserInfoAutoGenerated) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", u, err)
	}
