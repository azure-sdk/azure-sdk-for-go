...
func (a *AttachedDataNetworksServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if attachedDataNetworksServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = attachedDataNetworksServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "AttachedDataNetworksClient.NewListByPacketCoreDataPlanePager":
				res.resp, res.err = a.dispatchNewListByPacketCoreDataPlanePager(req)
...
// set this to conditionally intercept incoming requests to AttachedDataNetworksServerTransport
var attachedDataNetworksServerTransportInterceptor interface {
