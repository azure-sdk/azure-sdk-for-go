...
func (v *VirtualDesktopUserControllerServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if virtualDesktopUserControllerServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = virtualDesktopUserControllerServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			case "VirtualDesktopUserControllerClient.GetVirtualDesktopUser":
				res.resp, res.err = v.dispatchGetVirtualDesktopUser(req)
			case "VirtualDesktopUserControllerClient.NewListVirtualDesktopUsersPager":
				res.resp, res.err = v.dispatchNewListVirtualDesktopUsersPager(req)
			default:
...
// set this to conditionally intercept incoming requests to VirtualDesktopUserControllerServerTransport
var virtualDesktopUserControllerServerTransportInterceptor interface {
