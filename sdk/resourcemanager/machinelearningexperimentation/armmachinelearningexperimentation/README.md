...
```go
client, err := armmachinelearningexperimentation.NewAccountsClient(<subscription ID>, cred, nil)
```
...
client, err := armmachinelearningexperimentation.NewAccountsClient(<subscription ID>, cred, &options)
```
