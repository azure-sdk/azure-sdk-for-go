...
// MarshalJSON implements the json.Marshaller interface for type MetadataDependenciesAutoGenerated.
func (m MetadataDependenciesAutoGenerated) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "contentId", m.ContentID)
	populate(objectMap, "criteria", m.Criteria)
	populate(objectMap, "kind", m.Kind)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type MetadataDependenciesAutoGenerated.
func (m *MetadataDependenciesAutoGenerated) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", m, err)
	}
