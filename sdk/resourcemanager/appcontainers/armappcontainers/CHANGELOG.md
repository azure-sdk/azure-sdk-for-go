...
## 4.0.0-beta.1 (2024-10-14)
### Breaking Changes

- Type of `DaprComponent.Properties` has been changed from `*DaprComponentProperties` to `*DaprComponent`
...
- New function `*MaintenanceConfigurationsClient.NewListByManagedEnvironmentResourcePager(string, string, *MaintenanceConfigurationsClientListByManagedEnvironmentResourceOptions) *runtime.Pager[MaintenanceConfigurationsClientListByManagedEnvironmentResourceResponse]`
...
- New field `CertificateKeyVaultProperties`, `CertificateType`, `DeploymentErrors` in struct `CertificateProperties`
