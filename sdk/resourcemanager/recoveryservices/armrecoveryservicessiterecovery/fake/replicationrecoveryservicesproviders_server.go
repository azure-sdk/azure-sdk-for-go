...
func (r *ReplicationRecoveryServicesProvidersServerTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "ReplicationRecoveryServicesProvidersClient.BeginRefreshProvider":
		resp, err = r.dispatchBeginRefreshProvider(req)
	default:
...
func (r *ReplicationRecoveryServicesProvidersServerTransport) dispatchBeginCreate(req *http.Request) (*http.Response, error) {
	...
	if beginCreate == nil {
		...
		respr, errRespr := r.srv.BeginCreate(req.Context(), resourceNameParam, resourceGroupNameParam, fabricNameParam, providerNameParam, body, nil)
...
func (r *ReplicationRecoveryServicesProvidersServerTransport) dispatchBeginDelete(req *http.Request) (*http.Response, error) {
	...
	if beginDelete == nil {
		...
		respr, errRespr := r.srv.BeginDelete(req.Context(), resourceNameParam, resourceGroupNameParam, fabricNameParam, providerNameParam, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginDelete = &respr
...
func (r *ReplicationRecoveryServicesProvidersServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := r.srv.Get(req.Context(), resourceNameParam, resourceGroupNameParam, fabricNameParam, providerNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
...
func (r *ReplicationRecoveryServicesProvidersServerTransport) dispatchBeginPurge(req *http.Request) (*http.Response, error) {
	...
	if beginPurge == nil {
		...
		respr, errRespr := r.srv.BeginPurge(req.Context(), resourceNameParam, resourceGroupNameParam, fabricNameParam, providerNameParam, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginPurge = &respr
...
func (r *ReplicationRecoveryServicesProvidersServerTransport) dispatchBeginRefreshProvider(req *http.Request) (*http.Response, error) {
	...
	if beginRefreshProvider == nil {
		...
		respr, errRespr := r.srv.BeginRefreshProvider(req.Context(), resourceNameParam, resourceGroupNameParam, fabricNameParam, providerNameParam, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
