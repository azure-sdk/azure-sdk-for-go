...
// NewListByParentPager - List StorageClassResource resources by parent
//
// Generated from API version 2024-03-01
//   - resourceURI - The fully qualified Azure Resource manager identifier of the resource.
//   - options - StorageClassClientListByParentOptions contains the optional parameters for the StorageClassClient.NewListByParentPager
//     method.
func (client *StorageClassClient) NewListByParentPager(resourceURI string, options *StorageClassClientListByParentOptions) *runtime.Pager[StorageClassClientListByParentResponse] {
	return runtime.NewPager(runtime.PagingHandler[StorageClassClientListByParentResponse]{
		More: func(page StorageClassClientListByParentResponse) bool {
			return page.NextLink != nil && len(*page.NextLink) > 0
		},
		Fetcher: func(ctx context.Context, page *StorageClassClientListByParentResponse) (StorageClassClientListByParentResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "StorageClassClient.NewListByParentPager")
			nextLink := ""
			if page != nil {
			...
			if err != nil {
				return StorageClassClientListByParentResponse{}, err
			}
...
func (client *StorageClassClient) listByParentCreateRequest(ctx context.Context, resourceURI string, _ *StorageClassClientListByParentOptions) (*policy.Request, error) {
...
func (client *StorageClassClient) listByParentHandleResponse(resp *http.Response) (StorageClassClientListByParentResponse, error) {
	result := StorageClassClientListByParentResponse{}
