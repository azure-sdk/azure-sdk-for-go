...
func (a AuthConfig) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "activeDirectoryAuthEnabled", a.ActiveDirectoryAuthEnabled)
	populate(objectMap, "passwordAuthEnabled", a.PasswordAuthEnabled)
	populate(objectMap, "tenantId", a.TenantID)
	return json.Marshal(objectMap)
}
...
func (a *AuthConfig) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		var err error
		switch key {
		case "activeDirectoryAuthEnabled":
			err = unpopulate(val, "ActiveDirectoryAuthEnabled", &a.ActiveDirectoryAuthEnabled)
			delete(rawMsg, key)
		case "passwordAuthEnabled":
			err = unpopulate(val, "PasswordAuthEnabled", &a.PasswordAuthEnabled)
			delete(rawMsg, key)
		case "tenantId":
			err = unpopulate(val, "TenantID", &a.TenantID)
			delete(rawMsg, key)
