...
// IacProfilesClientQuickTemplateResponse contains the response from method IacProfilesClient.QuickTemplate.
type IacProfilesClientQuickTemplateResponse struct {
	PrLinkResponse
}
