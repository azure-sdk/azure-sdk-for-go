...
func (l *LivePipelinesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if livePipelinesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = livePipelinesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			case "LivePipelinesClient.BeginActivate":
				res.resp, res.err = l.dispatchBeginActivate(req)
			...
			case "LivePipelinesClient.BeginDeactivate":
				res.resp, res.err = l.dispatchBeginDeactivate(req)
...
// set this to conditionally intercept incoming requests to LivePipelinesServerTransport
var livePipelinesServerTransportInterceptor interface {
