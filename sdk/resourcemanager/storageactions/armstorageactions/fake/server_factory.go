...
type ServerFactory struct {
	...
	// StorageTasksOperationGroupServer contains the fakes for client StorageTasksOperationGroupClient
	StorageTasksOperationGroupServer StorageTasksOperationGroupServer
}
...
type ServerFactoryTransport struct {
	...
	trStorageTasksOperationGroupServer *StorageTasksOperationGroupServerTransport
}
...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "StorageTasksOperationGroupClient":
		initServer(s, &s.trStorageTasksOperationGroupServer, func() *StorageTasksOperationGroupServerTransport {
			return NewStorageTasksOperationGroupServerTransport(&s.srv.StorageTasksOperationGroupServer)
		})
		resp, err = s.trStorageTasksOperationGroupServer.Do(req)
	default:
