...
func (client *AutomationRulesClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, automationRuleID string, automationRuleToUpsert AutomationRule, options *AutomationRulesClientCreateOrUpdateOptions) (*policy.Request, error) {
	...
	return req, runtime.MarshalAsJSON(req, automationRuleToUpsert)
}
