...
// JobsClientGenerateProgressURLResponse contains the response from method JobsClient.GenerateProgressURL.
type JobsClientGenerateProgressURLResponse struct {
