...
// ConnectorGovernanceRulesOperationResultClientGetResponse contains the response from method ConnectorGovernanceRulesOperationResultClient.Get.
type ConnectorGovernanceRulesOperationResultClientGetResponse struct {
...
// ManagementGroupGovernanceRulesOperationResultClientGetResponse contains the response from method ManagementGroupGovernanceRulesOperationResultClient.Get.
type ManagementGroupGovernanceRulesOperationResultClientGetResponse struct {
	OperationResultAutoGenerated
	// Location contains the information returned from the location header response.
	Location *string
}
...
// SubscriptionGovernanceRulesOperationResultClientGetResponse contains the response from method SubscriptionGovernanceRulesOperationResultClient.Get.
type SubscriptionGovernanceRulesOperationResultClientGetResponse struct {
	OperationResultAutoGenerated
	// Location contains the information returned from the location header response.
	Location *string
}
