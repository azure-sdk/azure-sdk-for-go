...
func (client *KustoPoolChildResourceClient) checkNameAvailabilityCreateRequest(ctx context.Context, workspaceName string, kustoPoolName string, resourceGroupName string, resourceName DatabaseCheckNameRequest, _ *KustoPoolChildResourceClientCheckNameAvailabilityOptions) (*policy.Request, error) {
