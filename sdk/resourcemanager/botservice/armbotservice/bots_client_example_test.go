...
func ExampleBotsClient_Create() {
	...
	res, err := clientFactory.NewBotsClient().Create(ctx, "OneResourceGroupName", "samplebotname", nil)
	if err != nil {
...
func ExampleBotsClient_CreateSignInURL() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	res, err := clientFactory.NewBotsClient().CreateSignInURL(ctx, "OneResourceGroupName", "samplebotname", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armbotservice.BotsClientCreateSignInURLResponse{
...
func ExampleBotsClient_Delete() {
	...
	res, err := clientFactory.NewBotsClient().Delete(ctx, "OneResourceGroupName", "samplebotname", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armbotservice.BotsClientDeleteResponse{
	// }
}
...
func ExampleBotsClient_Get() {
	...
	// 			MsaAppTenantID: to.Ptr("msaapptenantid"),
	// 			MsaAppType: to.Ptr(armbotservice.MsaAppTypeUserAssignedMSI),
	// 			NetworkSecurityPerimeterConfigurations: []*armbotservice.NetworkSecurityPerimeterConfiguration{
	// 			},
...
func ExampleBotsClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armbotservice.BotsClientListResponse{
		// 	BotResponseList: armbotservice.BotResponseList{
...
// Generated from example definition: 2023-09-15-preview/ListPrivateLinkResources.json
func ExampleBotsClient_ListByBotResource() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	res, err := clientFactory.NewBotsClient().ListByBotResource(ctx, "res6977", "sto2527", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armbotservice.BotsClientListByBotResourceResponse{
...
func ExampleBotsClient_NewListByResourceGroupPager() {
	...
	for pager.More() {
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armbotservice.BotsClientListByResourceGroupResponse{
		// 	BotResponseList: armbotservice.BotResponseList{
		// 		Value: []*armbotservice.Bot{
		// 			{
		// 				Name: to.Ptr("samplebotname"),
...
func ExampleBotsClient_Update() {
	...
	res, err := clientFactory.NewBotsClient().Update(ctx, "OneResourceGroupName", "samplebotname", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
