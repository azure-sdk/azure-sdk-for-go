...
func (a AvailabilitySetResourceSettings) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "targetVirtualMachineScaleSetFlexId", a.TargetVirtualMachineScaleSetFlexID)
...
func (a *AvailabilitySetResourceSettings) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "targetResourceName":
			...
			delete(rawMsg, key)
		case "targetVirtualMachineScaleSetFlexId":
			err = unpopulate(val, "TargetVirtualMachineScaleSetFlexID", &a.TargetVirtualMachineScaleSetFlexID)
			delete(rawMsg, key)
		case "updateDomain":
...
// MarshalJSON implements the json.Marshaller interface for type ChildMoveResourceProperties.
func (c ChildMoveResourceProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "errors", c.Errors)
	populate(objectMap, "moveState", c.MoveState)
	populate(objectMap, "resourceSettings", c.ResourceSettings)
	populate(objectMap, "sourceId", c.SourceID)
	populate(objectMap, "sourceResourceSettings", c.SourceResourceSettings)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ChildMoveResourceProperties.
func (c *ChildMoveResourceProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
	...
	for key, val := range rawMsg {
		...
		case "errors":
			...
			delete(rawMsg, key)
		case "moveState":
			err = unpopulate(val, "MoveState", &c.MoveState)
			delete(rawMsg, key)
		case "resourceSettings":
			c.ResourceSettings, err = unmarshalResourceSettingsClassification(val)
			delete(rawMsg, key)
		case "sourceId":
			err = unpopulate(val, "SourceID", &c.SourceID)
			delete(rawMsg, key)
		case "sourceResourceSettings":
			c.SourceResourceSettings, err = unmarshalResourceSettingsClassification(val)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", c, err)
...
// MarshalJSON implements the json.Marshaller interface for type ChildMoveResourcePropertiesErrors.
func (c ChildMoveResourcePropertiesErrors) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "properties", c.Properties)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ChildMoveResourcePropertiesErrors.
func (c *ChildMoveResourcePropertiesErrors) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
...
func (m MoveResourceProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "childMoveResourcesProperties", m.ChildMoveResourcesProperties)
...
func (m *MoveResourceProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		var err error
		switch key {
		case "childMoveResourcesProperties":
			err = unpopulate(val, "ChildMoveResourcesProperties", &m.ChildMoveResourcesProperties)
			delete(rawMsg, key)
		case "dependsOn":
...
func (v VirtualMachineResourceSettings) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "targetFaultDomain", v.TargetFaultDomain)
...
func (v *VirtualMachineResourceSettings) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "targetFaultDomain":
			err = unpopulate(val, "TargetFaultDomain", &v.TargetFaultDomain)
			delete(rawMsg, key)
		case "targetResourceGroupName":
