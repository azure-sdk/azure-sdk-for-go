...
type ServerFactory struct {
	...
	// PrivateEndpointConnectionsAdtAPIServer contains the fakes for client PrivateEndpointConnectionsAdtAPIClient
	PrivateEndpointConnectionsAdtAPIServer PrivateEndpointConnectionsAdtAPIServer

	// PrivateEndpointConnectionsCompServer contains the fakes for client PrivateEndpointConnectionsCompClient
	PrivateEndpointConnectionsCompServer PrivateEndpointConnectionsCompServer

	// PrivateEndpointConnectionsForEDMServer contains the fakes for client PrivateEndpointConnectionsForEDMClient
	PrivateEndpointConnectionsForEDMServer PrivateEndpointConnectionsForEDMServer

	// PrivateEndpointConnectionsForMIPPolicySyncServer contains the fakes for client PrivateEndpointConnectionsForMIPPolicySyncClient
	PrivateEndpointConnectionsForMIPPolicySyncServer PrivateEndpointConnectionsForMIPPolicySyncServer

	// PrivateEndpointConnectionsForSCCPowershellServer contains the fakes for client PrivateEndpointConnectionsForSCCPowershellClient
	PrivateEndpointConnectionsForSCCPowershellServer PrivateEndpointConnectionsForSCCPowershellServer

	// PrivateEndpointConnectionsSecServer contains the fakes for client PrivateEndpointConnectionsSecClient
	PrivateEndpointConnectionsSecServer PrivateEndpointConnectionsSecServer

	// PrivateLinkResourcesAdtAPIServer contains the fakes for client PrivateLinkResourcesAdtAPIClient
	...
	// PrivateLinkResourcesCompServer contains the fakes for client PrivateLinkResourcesCompClient
	PrivateLinkResourcesCompServer PrivateLinkResourcesCompServer

	// PrivateLinkResourcesForMIPPolicySyncServer contains the fakes for client PrivateLinkResourcesForMIPPolicySyncClient
	PrivateLinkResourcesForMIPPolicySyncServer PrivateLinkResourcesForMIPPolicySyncServer

	// PrivateLinkResourcesForSCCPowershellServer contains the fakes for client PrivateLinkResourcesForSCCPowershellClient
	PrivateLinkResourcesForSCCPowershellServer PrivateLinkResourcesForSCCPowershellServer

	// PrivateLinkResourcesSecServer contains the fakes for client PrivateLinkResourcesSecClient
	PrivateLinkResourcesSecServer PrivateLinkResourcesSecServer

	// PrivateLinkServicesForEDMUploadServer contains the fakes for client PrivateLinkServicesForEDMUploadClient
	PrivateLinkServicesForEDMUploadServer PrivateLinkServicesForEDMUploadServer

	// PrivateLinkServicesForM365ComplianceCenterServer contains the fakes for client PrivateLinkServicesForM365ComplianceCenterClient
	PrivateLinkServicesForM365ComplianceCenterServer PrivateLinkServicesForM365ComplianceCenterServer

	// PrivateLinkServicesForM365SecurityCenterServer contains the fakes for client PrivateLinkServicesForM365SecurityCenterClient
	PrivateLinkServicesForM365SecurityCenterServer PrivateLinkServicesForM365SecurityCenterServer

	// PrivateLinkServicesForMIPPolicySyncServer contains the fakes for client PrivateLinkServicesForMIPPolicySyncClient
	PrivateLinkServicesForMIPPolicySyncServer PrivateLinkServicesForMIPPolicySyncServer

	// PrivateLinkServicesForO365ManagementActivityAPIServer contains the fakes for client PrivateLinkServicesForO365ManagementActivityAPIClient
	PrivateLinkServicesForO365ManagementActivityAPIServer PrivateLinkServicesForO365ManagementActivityAPIServer

	// PrivateLinkServicesForSCCPowershellServer contains the fakes for client PrivateLinkServicesForSCCPowershellClient
