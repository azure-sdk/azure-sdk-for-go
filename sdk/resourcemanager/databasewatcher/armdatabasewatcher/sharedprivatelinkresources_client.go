...
// NewListByParentPager - List SharedPrivateLinkResource resources by Watcher
//
// Generated from API version 2023-09-01-preview
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - watcherName - The database watcher name.
//   - options - SharedPrivateLinkResourcesClientListByParentOptions contains the optional parameters for the SharedPrivateLinkResourcesClient.NewListByParentPager
//     method.
func (client *SharedPrivateLinkResourcesClient) NewListByParentPager(resourceGroupName string, watcherName string, options *SharedPrivateLinkResourcesClientListByParentOptions) *runtime.Pager[SharedPrivateLinkResourcesClientListByParentResponse] {
	return runtime.NewPager(runtime.PagingHandler[SharedPrivateLinkResourcesClientListByParentResponse]{
		More: func(page SharedPrivateLinkResourcesClientListByParentResponse) bool {
			return page.NextLink != nil && len(*page.NextLink) > 0
		},
		Fetcher: func(ctx context.Context, page *SharedPrivateLinkResourcesClientListByParentResponse) (SharedPrivateLinkResourcesClientListByParentResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "SharedPrivateLinkResourcesClient.NewListByParentPager")
			nextLink := ""
			if page != nil {
			...
			if err != nil {
				return SharedPrivateLinkResourcesClientListByParentResponse{}, err
			}
...
func (client *SharedPrivateLinkResourcesClient) listByParentCreateRequest(ctx context.Context, resourceGroupName string, watcherName string, _ *SharedPrivateLinkResourcesClientListByParentOptions) (*policy.Request, error) {
...
func (client *SharedPrivateLinkResourcesClient) listByParentHandleResponse(resp *http.Response) (SharedPrivateLinkResourcesClientListByParentResponse, error) {
	result := SharedPrivateLinkResourcesClientListByParentResponse{}
