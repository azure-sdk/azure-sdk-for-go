...
func (b BackendCredentialsContract) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "managedIdentity", b.ManagedIdentity)
...
func (b *BackendCredentialsContract) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "managedIdentity":
			err = unpopulate(val, "ManagedIdentity", &b.ManagedIdentity)
			delete(rawMsg, key)
		case "query":
...
// MarshalJSON implements the json.Marshaller interface for type BackendManagedIdentityCredentials.
func (b BackendManagedIdentityCredentials) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "clientId", b.ClientID)
	populate(objectMap, "resource", b.Resource)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type BackendManagedIdentityCredentials.
func (b *BackendManagedIdentityCredentials) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", b, err)
	}
	for key, val := range rawMsg {
		...
		case "clientId":
			...
			delete(rawMsg, key)
		case "resource":
			err = unpopulate(val, "Resource", &b.Resource)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", b, err)
...
// MarshalJSON implements the json.Marshaller interface for type GatewayBaseProperties.
func (g GatewayBaseProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "backend", g.Backend)
	populate(objectMap, "configurationApi", g.ConfigurationAPI)
	populateDateTimeRFC3339(objectMap, "createdAtUtc", g.CreatedAtUTC)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type GatewayBaseProperties.
func (g *GatewayBaseProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
	...
	for key, val := range rawMsg {
		...
		case "configurationApi":
			...
			delete(rawMsg, key)
		case "createdAtUtc":
			err = unpopulateDateTimeRFC3339(val, "CreatedAtUTC", &g.CreatedAtUTC)
			delete(rawMsg, key)
		case "frontend":
...
// MarshalJSON implements the json.Marshaller interface for type PolicyWithComplianceCollection.
func (p PolicyWithComplianceCollection) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "nextLink", p.NextLink)
	populate(objectMap, "value", p.Value)
	return json.Marshal(objectMap)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type PolicyWithComplianceCollection.
func (p *PolicyWithComplianceCollection) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", p, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type PolicyWithComplianceContract.
func (p PolicyWithComplianceContract) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "id", p.ID)
	populate(objectMap, "name", p.Name)
	populate(objectMap, "properties", p.Properties)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type PolicyWithComplianceContract.
func (p *PolicyWithComplianceContract) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", p, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type PolicyWithComplianceContractProperties.
func (p PolicyWithComplianceContractProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "complianceState", p.ComplianceState)
	populate(objectMap, "referencePolicyId", p.ReferencePolicyID)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type PolicyWithComplianceContractProperties.
func (p *PolicyWithComplianceContractProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", p, err)
	}
	for key, val := range rawMsg {
		...
		case "complianceState":
			...
			delete(rawMsg, key)
		case "referencePolicyId":
			err = unpopulate(val, "ReferencePolicyID", &p.ReferencePolicyID)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", p, err)
...
// MarshalJSON implements the json.Marshaller interface for type WorkspaceLinksBaseProperties.
func (w WorkspaceLinksBaseProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type WorkspaceLinksBaseProperties.
func (w *WorkspaceLinksBaseProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", w, err)
	}
