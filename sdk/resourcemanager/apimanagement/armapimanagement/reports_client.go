...
func (client *ReportsClient) NewListByGeoPager(resourceGroupName string, serviceName string, options *ReportsClientListByGeoOptions) *runtime.Pager[ReportsClientListByGeoResponse] {
	return runtime.NewPager(runtime.PagingHandler[ReportsClientListByGeoResponse]{
		...
		Fetcher: func(ctx context.Context, page *ReportsClientListByGeoResponse) (ReportsClientListByGeoResponse, error) {
			...
			var err error
			if page == nil {
				req, err = client.listByGeoCreateRequest(ctx, resourceGroupName, serviceName, options)
			} else {
				req, err = runtime.NewRequest(ctx, http.MethodGet, *page.NextLink)
			}
			if err != nil {
...
func (client *ReportsClient) listByGeoCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, options *ReportsClientListByGeoOptions) (*policy.Request, error) {
...
// method.
func (client *ReportsClient) NewListBySubscriptionPager(resourceGroupName string, serviceName string, options *ReportsClientListBySubscriptionOptions) *runtime.Pager[ReportsClientListBySubscriptionResponse] {
	return runtime.NewPager(runtime.PagingHandler[ReportsClientListBySubscriptionResponse]{
		...
		Fetcher: func(ctx context.Context, page *ReportsClientListBySubscriptionResponse) (ReportsClientListBySubscriptionResponse, error) {
			...
			var err error
			if page == nil {
				req, err = client.listBySubscriptionCreateRequest(ctx, resourceGroupName, serviceName, options)
			} else {
				req, err = runtime.NewRequest(ctx, http.MethodGet, *page.NextLink)
			}
			if err != nil {
...
func (client *ReportsClient) listBySubscriptionCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, options *ReportsClientListBySubscriptionOptions) (*policy.Request, error) {
...
func (client *ReportsClient) NewListByTimePager(resourceGroupName string, serviceName string, interval string, options *ReportsClientListByTimeOptions) *runtime.Pager[ReportsClientListByTimeResponse] {
	return runtime.NewPager(runtime.PagingHandler[ReportsClientListByTimeResponse]{
		...
		Fetcher: func(ctx context.Context, page *ReportsClientListByTimeResponse) (ReportsClientListByTimeResponse, error) {
			...
			var err error
			if page == nil {
				req, err = client.listByTimeCreateRequest(ctx, resourceGroupName, serviceName, interval, options)
			} else {
				req, err = runtime.NewRequest(ctx, http.MethodGet, *page.NextLink)
			}
			if err != nil {
...
func (client *ReportsClient) listByTimeCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, interval string, options *ReportsClientListByTimeOptions) (*policy.Request, error) {
