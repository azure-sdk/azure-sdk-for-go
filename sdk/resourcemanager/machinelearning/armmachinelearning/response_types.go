...
// IndexesClientListByResourceGroupResponse contains the response from method IndexesClient.NewListByResourceGroupPager.
type IndexesClientListByResourceGroupResponse struct {
	// The response of a Index list operation.
	IndexListResult
}

// IndexesVersionsClientCreateOrUpdateResponse contains the response from method IndexesVersionsClient.CreateOrUpdate.
type IndexesVersionsClientCreateOrUpdateResponse struct {
	// Index Version resource
	IndexVersion
}

// IndexesVersionsClientDeleteResponse contains the response from method IndexesVersionsClient.Delete.
type IndexesVersionsClientDeleteResponse struct {
	// placeholder for future response values
}

// IndexesVersionsClientGetResponse contains the response from method IndexesVersionsClient.Get.
type IndexesVersionsClientGetResponse struct {
	// Index Version resource
	IndexVersion
}

// IndexesVersionsClientListByIndexResponse contains the response from method IndexesVersionsClient.NewListByIndexPager.
type IndexesVersionsClientListByIndexResponse struct {
