...
// OperatorForCondition - The criteria operator. Relevant and required only for rules of the kind LogAlert.
...
// PossibleOperatorForConditionValues returns the possible values for the OperatorForCondition const type.
func PossibleOperatorForConditionValues() []OperatorForCondition {
	return []OperatorForCondition{
