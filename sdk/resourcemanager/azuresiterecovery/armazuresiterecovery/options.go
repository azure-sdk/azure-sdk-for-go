...
// ManagementServiceAPIClientCheckNameAvailabilityOptions contains the optional parameters for the ManagementServiceAPIClient.CheckNameAvailability
// method.
type ManagementServiceAPIClientCheckNameAvailabilityOptions struct {
	// Resource details.
	Body *CheckNameAvailabilityModel
}

// ManagementServiceAPIClientDeploymentPreflightOptions contains the optional parameters for the ManagementServiceAPIClient.DeploymentPreflight
// method.
type ManagementServiceAPIClientDeploymentPreflightOptions struct {
