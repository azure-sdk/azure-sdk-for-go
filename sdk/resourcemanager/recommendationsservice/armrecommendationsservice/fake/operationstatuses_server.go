...
// OperationStatusesServer is a fake server for instances of the armrecommendationsservice.OperationStatusesClient type.
type OperationStatusesServer struct {
	// Get is the fake for method OperationStatusesClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, location string, operationID string, options *armrecommendationsservice.OperationStatusesClientGetOptions) (resp azfake.Responder[armrecommendationsservice.OperationStatusesClientGetResponse], errResp azfake.ErrorResponder)
}
...
// The returned OperationStatusesServerTransport instance is connected to an instance of armrecommendationsservice.OperationStatusesClient via the
...
// OperationStatusesServerTransport connects instances of armrecommendationsservice.OperationStatusesClient to instances of OperationStatusesServer.
...
func (o *OperationStatusesServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	const regexStr = `/providers/Microsoft\.RecommendationsService/locations/(?P<location>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/operationStatuses/(?P<operationId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)`
