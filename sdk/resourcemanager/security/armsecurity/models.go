...
type AzureServersSetting struct {
	...
	Kind *ServerVulnerabilityAssessmentsSettingKind `json:"kind,omitempty"`
...
type ServerVulnerabilityAssessmentsAzureSettingProperties struct {
	...
	SelectedProvider *ServerVulnerabilityAssessmentsAzureSettingSelectedProvider `json:"selectedProvider,omitempty"`
}
...
// ServerVulnerabilityAssessmentsSettingsClientListOptions contains the optional parameters for the ServerVulnerabilityAssessmentsSettingsClient.NewListPager
// method.
type ServerVulnerabilityAssessmentsSettingsClientListOptions struct {
	// placeholder for future optional parameters
}
...
type ServerVulnerabilityAssessmentsSettingsList struct {
	...
	Value []ServerVulnerabilityAssessmentsSettingClassification `json:"value,omitempty" azure:"ro"`
}
