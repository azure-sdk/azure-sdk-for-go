	...
	go func() {
		...
		if !intercepted {
			...
			case "ServersClient.DissociateGateway":
				res.resp, res.err = s.dispatchDissociateGateway(req)
			case "ServersClient.GetDetails":
				res.resp, res.err = s.dispatchGetDetails(req)
			...
			case "ServersClient.ListGatewayStatus":
				res.resp, res.err = s.dispatchListGatewayStatus(req)
			case "ServersClient.ListOperationResults":
				res.resp, res.err = s.dispatchListOperationResults(req)
			case "ServersClient.ListOperationStatuses":
				res.resp, res.err = s.dispatchListOperationStatuses(req)
			case "ServersClient.ListSKUsForExisting":
				res.resp, res.err = s.dispatchListSKUsForExisting(req)
			case "ServersClient.ListSKUsForNew":
				res.resp, res.err = s.dispatchListSKUsForNew(req)
