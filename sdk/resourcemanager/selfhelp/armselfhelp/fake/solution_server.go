...
func (s *SolutionServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if solutionServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = solutionServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to SolutionServerTransport
var solutionServerTransportInterceptor interface {
