...
// AzureResourceManagerFoundationsUserAssignedIdentity - A managed identity assigned by the user.
type AzureResourceManagerFoundationsUserAssignedIdentity struct {
...
// ComputeProfileUpdate - Compute Profile to use for running user's workloads.
type ComputeProfileUpdate struct {
...
// FleetPropertiesUpdate - Details of the Compute Fleet.
type FleetPropertiesUpdate struct {
...
type ManagedServiceIdentityUpdate struct {
	...
	UserAssignedIdentities map[string]*AzureResourceManagerFoundationsUserAssignedIdentity
}
