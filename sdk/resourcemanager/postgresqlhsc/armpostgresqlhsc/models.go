...
type ClusterProperties struct {
	...
	CoordinatorEnablePublicIPAccess *CoordinatorEnablePublicIPEnum `json:"coordinatorEnablePublicIpAccess,omitempty"`
	...
	EnableHa *EnableHaEnum `json:"enableHa,omitempty"`

	// If shards on coordinator is enabled or not for the cluster.
	EnableShardsOnCoordinator *EnableShardsOnCoordinatorEnum `json:"enableShardsOnCoordinator,omitempty"`
	...
	NodeEnablePublicIPAccess *NodeEnablePublicIPEnum `json:"nodeEnablePublicIpAccess,omitempty"`
...
type ClusterPropertiesForUpdate struct {
	...
	NodeEnablePublicIPAccess *NodeEnablePublicIPEnum `json:"nodeEnablePublicIpAccess,omitempty" azure:"ro"`
}
...
type ClusterResponseProperties struct {
	...
	// READ-ONLY; The location of source cluster for read replica clusters.
	SourceLocation *string `json:"sourceLocation,omitempty" azure:"ro"`

	// READ-ONLY; The resource id of source cluster for read replica clusters.
...
type ClusterServerProperties struct {
	...
	// READ-ONLY; If public IP is requested or not for a server.
	EnablePublicIP *EnablePublicIPEnum `json:"enablePublicIp,omitempty" azure:"ro"`
...
type ConfigurationProperties struct {
	...
	RequiresRestart *RequiresRestartEnum `json:"requiresRestart,omitempty"`
...
// ConfigurationsClientBeginUpdateCoordinatorOptions contains the optional parameters for the ConfigurationsClient.BeginUpdateCoordinator
// method.
type ConfigurationsClientBeginUpdateCoordinatorOptions struct {
	// Resumes the LRO from the provided token.
	ResumeToken string
}
...
type NameAvailability struct {
	...
	NameAvailable *NameAvailableEnum `json:"nameAvailable,omitempty"`
...
type Operation struct {
	...
	IsDataAction *IsDataActionEnum `json:"isDataAction,omitempty"`
...
// PrivateEndpointConnectionActionRequest - A private endpoint connection
type PrivateEndpointConnectionActionRequest struct {
	// REQUIRED; Properties of the private endpoint connection.
	Properties *PrivateEndpointConnectionActionRequestProperties `json:"properties,omitempty"`
}

// PrivateEndpointConnectionActionRequestProperties - The properties used to create a private endpoint connection
type PrivateEndpointConnectionActionRequestProperties struct {
	// REQUIRED; Connection state of the private endpoint connection.
	PrivateLinkServiceConnectionState *PrivateLinkServiceConnectionRequestState `json:"privateLinkServiceConnectionState,omitempty"`
}
...
// PrivateLinkServiceConnectionRequestState - The private link service connection state
type PrivateLinkServiceConnectionRequestState struct {
...
type ServerConfigurationRequest struct {
	// REQUIRED; Represents a configuration properties
	Properties *ServerConfigurationRequestProperties `json:"properties,omitempty"`
}

// ServerConfigurationRequestProperties - Represents a configuration properties
type ServerConfigurationRequestProperties struct {
	// REQUIRED; Represents the value of a configuration.
	Value *string `json:"value,omitempty"`
}
