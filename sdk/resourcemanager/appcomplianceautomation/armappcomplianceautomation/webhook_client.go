...
func (client *WebhookClient) createOrUpdateCreateRequest(ctx context.Context, reportName string, webhookName string, parameters WebhookResource, options *WebhookClientCreateOrUpdateOptions) (*policy.Request, error) {
