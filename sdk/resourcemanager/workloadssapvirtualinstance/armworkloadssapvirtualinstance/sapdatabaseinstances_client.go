...
func (client *SAPDatabaseInstancesClient) startCreateRequest(ctx context.Context, resourceGroupName string, sapVirtualInstanceName string, databaseInstanceName string, body StartRequest, _ *SAPDatabaseInstancesClientBeginStartOptions) (*policy.Request, error) {
...
func (client *SAPDatabaseInstancesClient) stopCreateRequest(ctx context.Context, resourceGroupName string, sapVirtualInstanceName string, databaseInstanceName string, body StopRequest, _ *SAPDatabaseInstancesClientBeginStopOptions) (*policy.Request, error) {
