...
// AssemblyDefinitionsClientCreateOrUpdateResponse contains the response from method AssemblyDefinitionsClient.CreateOrUpdate.
type AssemblyDefinitionsClientCreateOrUpdateResponse struct {
	// The assembly definition.
	AssemblyDefinition
}

// AssemblyDefinitionsClientDeleteResponse contains the response from method AssemblyDefinitionsClient.Delete.
type AssemblyDefinitionsClientDeleteResponse struct {
	// placeholder for future response values
}

// AssemblyDefinitionsClientGetResponse contains the response from method AssemblyDefinitionsClient.Get.
type AssemblyDefinitionsClientGetResponse struct {
	// The assembly definition.
	AssemblyDefinition
}

// AssemblyDefinitionsClientListContentCallbackURLResponse contains the response from method AssemblyDefinitionsClient.ListContentCallbackURL.
type AssemblyDefinitionsClientListContentCallbackURLResponse struct {
	// The workflow trigger callback URL.
	WorkflowTriggerCallbackURL
}

// AssemblyDefinitionsClientListResponse contains the response from method AssemblyDefinitionsClient.List.
type AssemblyDefinitionsClientListResponse struct {
	// A collection of assembly definitions.
	AssemblyCollection
}

// BatchConfigurationsClientCreateOrUpdateResponse contains the response from method BatchConfigurationsClient.CreateOrUpdate.
type BatchConfigurationsClientCreateOrUpdateResponse struct {
	// The batch configuration resource definition.
	BatchConfiguration
}

// BatchConfigurationsClientDeleteResponse contains the response from method BatchConfigurationsClient.Delete.
type BatchConfigurationsClientDeleteResponse struct {
	// placeholder for future response values
}

// BatchConfigurationsClientGetResponse contains the response from method BatchConfigurationsClient.Get.
type BatchConfigurationsClientGetResponse struct {
	// The batch configuration resource definition.
	BatchConfiguration
}

// BatchConfigurationsClientListResponse contains the response from method BatchConfigurationsClient.List.
type BatchConfigurationsClientListResponse struct {
...
// IntegrationServiceEnvironmentsClientIntegrationServiceEnvironmentNetworkHealthGetResponse contains the response from method
// IntegrationServiceEnvironmentsClient.IntegrationServiceEnvironmentNetworkHealthGet.
type IntegrationServiceEnvironmentsClientIntegrationServiceEnvironmentNetworkHealthGetResponse struct {
...
// IntegrationServiceEnvironmentsClientListResponse contains the response from method IntegrationServiceEnvironmentsClient.NewListPager.
type IntegrationServiceEnvironmentsClientListResponse struct {
...
// RequestHistoriesClientGetResponse contains the response from method RequestHistoriesClient.Get.
type RequestHistoriesClientGetResponse struct {
	// The request history.
	RequestHistory
}

// RequestHistoriesClientListResponse contains the response from method RequestHistoriesClient.NewListPager.
type RequestHistoriesClientListResponse struct {
	// The response of a RequestHistory list operation.
	RequestHistoryListResult
}

// TemplatesClientCreateOrUpdateResponse contains the response from method TemplatesClient.CreateOrUpdate.
type TemplatesClientCreateOrUpdateResponse struct {
	// The template type.
	Template
}

// TemplatesClientDeleteResponse contains the response from method TemplatesClient.Delete.
type TemplatesClientDeleteResponse struct {
	// placeholder for future response values
}

// TemplatesClientDisableResponse contains the response from method TemplatesClient.Disable.
type TemplatesClientDisableResponse struct {
	// placeholder for future response values
}

// TemplatesClientEnableResponse contains the response from method TemplatesClient.Enable.
type TemplatesClientEnableResponse struct {
	// placeholder for future response values
}

// TemplatesClientGenerateUpgradedDefinitionResponse contains the response from method TemplatesClient.GenerateUpgradedDefinition.
type TemplatesClientGenerateUpgradedDefinitionResponse struct {
	// Dictionary of <any>
	Value map[string]any
}

// TemplatesClientGetResponse contains the response from method TemplatesClient.Get.
type TemplatesClientGetResponse struct {
	// The template type.
	Template
}

// TemplatesClientListByResourceGroupResponse contains the response from method TemplatesClient.NewListByResourceGroupPager.
type TemplatesClientListByResourceGroupResponse struct {
	// The response of a Template list operation.
	TemplateListResult
}

// TemplatesClientListBySubscriptionResponse contains the response from method TemplatesClient.NewListBySubscriptionPager.
type TemplatesClientListBySubscriptionResponse struct {
	// The response of a Template list operation.
	TemplateListResult
}

// TemplatesClientListCallbackURLResponse contains the response from method TemplatesClient.ListCallbackURL.
type TemplatesClientListCallbackURLResponse struct {
	// The workflow trigger callback URL.
	WorkflowTriggerCallbackURL
}

// TemplatesClientListSwaggerResponse contains the response from method TemplatesClient.ListSwagger.
type TemplatesClientListSwaggerResponse struct {
	// Dictionary of <any>
	Value map[string]any
}

// TemplatesClientMoveResponse contains the response from method TemplatesClient.BeginMove.
type TemplatesClientMoveResponse struct {
	// placeholder for future response values
}

// TemplatesClientRegenerateAccessKeyResponse contains the response from method TemplatesClient.RegenerateAccessKey.
type TemplatesClientRegenerateAccessKeyResponse struct {
	// placeholder for future response values
}

// TemplatesClientUpdateResponse contains the response from method TemplatesClient.Update.
type TemplatesClientUpdateResponse struct {
	// The template type.
	Template
}

// TemplatesClientValidateByResourceGroupResponse contains the response from method TemplatesClient.ValidateByResourceGroup.
type TemplatesClientValidateByResourceGroupResponse struct {
	// placeholder for future response values
}

// WorkflowRunActionRepetitionDefinitionsClientGetResponse contains the response from method WorkflowRunActionRepetitionDefinitionsClient.Get.
type WorkflowRunActionRepetitionDefinitionsClientGetResponse struct {
	// The workflow run action repetition definition.
	WorkflowRunActionRepetitionDefinition
}

// WorkflowRunActionRepetitionDefinitionsClientListExpressionTracesResponse contains the response from method WorkflowRunActionRepetitionDefinitionsClient.ListExpressionTraces.
type WorkflowRunActionRepetitionDefinitionsClientListExpressionTracesResponse struct {
	// The expression traces.
	ExpressionTraces
}

// WorkflowRunActionRepetitionDefinitionsClientListResponse contains the response from method WorkflowRunActionRepetitionDefinitionsClient.NewListPager.
type WorkflowRunActionRepetitionDefinitionsClientListResponse struct {
	// A collection of workflow run action repetitions.
	WorkflowRunActionRepetitionDefinitionCollection
}

// WorkflowRunActionRequestHistoriesOperationsClientGetResponse contains the response from method WorkflowRunActionRequestHistoriesOperationsClient.Get.
type WorkflowRunActionRequestHistoriesOperationsClientGetResponse struct {
	// The request history.
	RequestHistory
}

// WorkflowRunActionRequestHistoriesOperationsClientListResponse contains the response from method WorkflowRunActionRequestHistoriesOperationsClient.NewListPager.
type WorkflowRunActionRequestHistoriesOperationsClientListResponse struct {
	// The response of a RequestHistory list operation.
	RequestHistoryListResult
}

// WorkflowRunActionScopeRepetitionsOperationsClientGetResponse contains the response from method WorkflowRunActionScopeRepetitionsOperationsClient.Get.
type WorkflowRunActionScopeRepetitionsOperationsClientGetResponse struct {
	// The workflow run action repetition definition.
	WorkflowRunActionRepetitionDefinition
}

// WorkflowRunActionScopeRepetitionsOperationsClientListResponse contains the response from method WorkflowRunActionScopeRepetitionsOperationsClient.NewListPager.
type WorkflowRunActionScopeRepetitionsOperationsClientListResponse struct {
	// A collection of workflow run action repetitions.
	WorkflowRunActionRepetitionDefinitionCollection
}
...
// WorkflowRunOperationsOperationsClientGetResponse contains the response from method WorkflowRunOperationsOperationsClient.Get.
type WorkflowRunOperationsOperationsClientGetResponse struct {
	// The workflow run.
	WorkflowRun
}
...
// WorkflowRunsOperationsClientListResponse contains the response from method WorkflowRunsOperationsClient.NewListPager.
type WorkflowRunsOperationsClientListResponse struct {
...
// WorkflowVersionsClientListCallbackURLResponse contains the response from method WorkflowVersionsClient.ListCallbackURL.
type WorkflowVersionsClientListCallbackURLResponse struct {
	// The workflow trigger callback URL.
	WorkflowTriggerCallbackURL
}
...
// WorkflowsOperationsClientValidateByLocationResponse contains the response from method WorkflowsOperationsClient.ValidateByLocation.
type WorkflowsOperationsClientValidateByLocationResponse struct {
	// placeholder for future response values
}
