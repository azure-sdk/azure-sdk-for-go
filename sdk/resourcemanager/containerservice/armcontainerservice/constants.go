...
// PodLinkLocalAccess - Defines access to special link local addresses (IMDS and wire server) for pods with hostNetwork=false.
// If not specified, the default is 'IMDS'.
type PodLinkLocalAccess string

const (
	// PodLinkLocalAccessIMDS - Pods with hostNetwork=false can access IMDS without restriction.
	PodLinkLocalAccessIMDS PodLinkLocalAccess = "IMDS"
	// PodLinkLocalAccessNone - Pods with hostNetwork=false cannot access IMDS and wire server.
