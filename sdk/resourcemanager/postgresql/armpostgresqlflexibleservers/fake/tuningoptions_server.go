...
type TuningOptionsServer struct {
	...
	Get func(ctx context.Context, resourceGroupName string, serverName string, tuningOption string, options *armpostgresqlflexibleservers.TuningOptionsClientGetOptions) (resp azfake.Responder[armpostgresqlflexibleservers.TuningOptionsClientGetResponse], errResp azfake.ErrorResponder)
...
func (t *TuningOptionsServerTransport) dispatchListByServer(req *http.Request) (*http.Response, error) {
	...
	resp, err := server.MarshalResponseAsJSON(respContent, server.GetResponse(respr).TuningOptionsListResult, req)
	if err != nil {
		return nil, err
	}
	return resp, nil
