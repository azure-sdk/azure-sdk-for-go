...
// SharedImageStorageAccountTypeBROKEN - Specifies the storage account type to be used to store the Azure Compute Gallery
// image version in.
type SharedImageStorageAccountTypeBROKEN string

const (
	SharedImageStorageAccountTypeBROKENPremiumLRS  SharedImageStorageAccountTypeBROKEN = "Premium_LRS"
	SharedImageStorageAccountTypeBROKENStandardLRS SharedImageStorageAccountTypeBROKEN = "Standard_LRS"
	SharedImageStorageAccountTypeBROKENStandardZRS SharedImageStorageAccountTypeBROKEN = "Standard_ZRS"
)

// PossibleSharedImageStorageAccountTypeBROKENValues returns the possible values for the SharedImageStorageAccountTypeBROKEN const type.
func PossibleSharedImageStorageAccountTypeBROKENValues() []SharedImageStorageAccountTypeBROKEN {
	return []SharedImageStorageAccountTypeBROKEN{
		SharedImageStorageAccountTypeBROKENPremiumLRS,
		SharedImageStorageAccountTypeBROKENStandardLRS,
		SharedImageStorageAccountTypeBROKENStandardZRS,
	}
}
