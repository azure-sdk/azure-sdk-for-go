...
func (v *VCentersServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if vCentersServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = vCentersServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to VCentersServerTransport
var vCentersServerTransportInterceptor interface {
