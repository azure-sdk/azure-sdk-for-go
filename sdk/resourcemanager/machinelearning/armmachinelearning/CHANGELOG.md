...
- New type alias `ComputeProvisioningState` with values `ComputeProvisioningStateCanceled`, `ComputeProvisioningStateCreating`, `ComputeProvisioningStateDeleting`, `ComputeProvisioningStateFailed`, `ComputeProvisioningStateSucceeded`, `ComputeProvisioningStateUnknown`, `ComputeProvisioningStateUpdating`
