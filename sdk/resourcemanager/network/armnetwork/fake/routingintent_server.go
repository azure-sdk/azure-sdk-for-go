...
func (r *RoutingIntentServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if routingIntentServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = routingIntentServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
func (r *RoutingIntentServerTransport) dispatchBeginCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginCreateOrUpdate == nil {
		...
		routingIntentNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("routingIntentName")])
		if err != nil {
			return nil, err
		}
		respr, errRespr := r.srv.BeginCreateOrUpdate(req.Context(), resourceGroupNameParam, virtualHubNameParam, routingIntentNameParam, body, nil)
...
func (r *RoutingIntentServerTransport) dispatchBeginDelete(req *http.Request) (*http.Response, error) {
	...
	if beginDelete == nil {
		...
		respr, errRespr := r.srv.BeginDelete(req.Context(), resourceGroupNameParam, virtualHubNameParam, routingIntentNameParam, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginDelete = &respr
...
func (r *RoutingIntentServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := r.srv.Get(req.Context(), resourceGroupNameParam, virtualHubNameParam, routingIntentNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
...
// set this to conditionally intercept incoming requests to RoutingIntentServerTransport
var routingIntentServerTransportInterceptor interface {
