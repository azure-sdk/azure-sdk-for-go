...
type SasTokenGenerationParameters struct {
	...
	// REQUIRED; The data plane resource type that the SAS token is authorized to access.
...
type SasTokenGenerationResult struct {
	...
	// READ-ONLY; The data plane resource type that the SAS token is authorized to access.
	ResourceType *string
...
// SignedParameters - The parameters to define the data plane resource scope that the SAS token is authorized to access.
type SignedParameters struct {
	// A filter used to match keys. Syntax reference: https://aka.ms/azconfig/docs/keyvaluefiltering. This is only applicable
	// when the resourceType is Kv.
	Key *string

	// A filter used to match labels. Syntax reference: https://aka.ms/azconfig/docs/keyvaluefiltering. This is only applicable
	// when the resourceType is Kv.
	Label *string
