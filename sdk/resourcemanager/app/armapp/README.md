...
```go
client, err := armapp.NewManagedEnvironmentsDiagnosticsClient(<subscription ID>, cred, nil)
```
...
client, err := armapp.NewManagedEnvironmentsDiagnosticsClient(<subscription ID>, cred, &options)
```
