...
type ScheduledActionsServer struct {
	...
	// VirtualMachinesSubmitCreate is the fake for method ScheduledActionsClient.VirtualMachinesSubmitCreate
	// HTTP status codes to indicate success: http.StatusOK
	VirtualMachinesSubmitCreate func(ctx context.Context, locationparameter string, requestBody armcomputeschedule.SubmitCreateRequest, options *armcomputeschedule.ScheduledActionsClientVirtualMachinesSubmitCreateOptions) (resp azfake.Responder[armcomputeschedule.ScheduledActionsClientVirtualMachinesSubmitCreateResponse], errResp azfake.ErrorResponder)
	...
	// VirtualMachinesSubmitDelete is the fake for method ScheduledActionsClient.VirtualMachinesSubmitDelete
	// HTTP status codes to indicate success: http.StatusOK
	VirtualMachinesSubmitDelete func(ctx context.Context, locationparameter string, requestBody armcomputeschedule.SubmitDeleteRequest, options *armcomputeschedule.ScheduledActionsClientVirtualMachinesSubmitDeleteOptions) (resp azfake.Responder[armcomputeschedule.ScheduledActionsClientVirtualMachinesSubmitDeleteResponse], errResp azfake.ErrorResponder)
...
func (s *ScheduledActionsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		if !intercepted {
			...
			case "ScheduledActionsClient.VirtualMachinesSubmitCreate":
				res.resp, res.err = s.dispatchVirtualMachinesSubmitCreate(req)
			...
			case "ScheduledActionsClient.VirtualMachinesSubmitDelete":
				res.resp, res.err = s.dispatchVirtualMachinesSubmitDelete(req)
...
func (s *ScheduledActionsServerTransport) dispatchVirtualMachinesSubmitCreate(req *http.Request) (*http.Response, error) {
	if s.srv.VirtualMachinesSubmitCreate == nil {
		return nil, &nonRetriableError{errors.New("fake for method VirtualMachinesSubmitCreate not implemented")}
	}
	const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.ComputeSchedule/locations/(?P<locationparameter>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/virtualMachinesSubmitCreate`
	regex := regexp.MustCompile(regexStr)
	matches := regex.FindStringSubmatch(req.URL.EscapedPath())
	if len(matches) < 3 {
		return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
	}
	body, err := server.UnmarshalRequestAsJSON[armcomputeschedule.SubmitCreateRequest](req)
	if err != nil {
		return nil, err
	}
	locationparameterParam, err := url.PathUnescape(matches[regex.SubexpIndex("locationparameter")])
	...
	respr, errRespr := s.srv.VirtualMachinesSubmitCreate(req.Context(), locationparameterParam, body, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (s *ScheduledActionsServerTransport) dispatchVirtualMachinesSubmitDelete(req *http.Request) (*http.Response, error) {
	if s.srv.VirtualMachinesSubmitDelete == nil {
		return nil, &nonRetriableError{errors.New("fake for method VirtualMachinesSubmitDelete not implemented")}
	}
	const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.ComputeSchedule/locations/(?P<locationparameter>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/virtualMachinesSubmitDelete`
	regex := regexp.MustCompile(regexStr)
	matches := regex.FindStringSubmatch(req.URL.EscapedPath())
	if len(matches) < 3 {
		return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
	}
	body, err := server.UnmarshalRequestAsJSON[armcomputeschedule.SubmitDeleteRequest](req)
	if err != nil {
		return nil, err
	}
	locationparameterParam, err := url.PathUnescape(matches[regex.SubexpIndex("locationparameter")])
	...
	respr, errRespr := s.srv.VirtualMachinesSubmitDelete(req.Context(), locationparameterParam, body, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
