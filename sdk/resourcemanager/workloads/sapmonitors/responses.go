...
// AlertTemplatesClientGetResponse contains the response from method AlertTemplatesClient.Get.
type AlertTemplatesClientGetResponse struct {
	// Concrete proxy resource types can be created by aliasing this type using a specific property type.
	AlertTemplate
}

// AlertTemplatesClientListByMonitorResponse contains the response from method AlertTemplatesClient.NewListByMonitorPager.
type AlertTemplatesClientListByMonitorResponse struct {
	// The response of a AlertTemplate list operation.
	AlertTemplateListResult
}

// AlertsClientCreateResponse contains the response from method AlertsClient.BeginCreate.
type AlertsClientCreateResponse struct {
	// A provider instance associated with SAP monitor.
	Alert
}

// AlertsClientDeleteResponse contains the response from method AlertsClient.BeginDelete.
type AlertsClientDeleteResponse struct {
...
// AlertsClientListByMonitorResponse contains the response from method AlertsClient.NewListByMonitorPager.
type AlertsClientListByMonitorResponse struct {
