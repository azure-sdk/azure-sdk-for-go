...
// AnalyticsConnectorClientUpdateResponse contains the response from method AnalyticsConnectorClient.Update.
type AnalyticsConnectorClientUpdateResponse struct {
	AnalyticsConnector
}

// AnalyticsConnectorsClientCreateOrUpdateResponse contains the response from method AnalyticsConnectorsClient.CreateOrUpdate.
type AnalyticsConnectorsClientCreateOrUpdateResponse struct {
	AnalyticsConnector
}

// AnalyticsConnectorsClientDeleteResponse contains the response from method AnalyticsConnectorsClient.Delete.
...
// AnalyticsConnectorsClientListByWorkspaceResponse contains the response from method AnalyticsConnectorsClient.ListByWorkspace.
