...
// MarshalJSON implements the json.Marshaller interface for type OperationOngoing.
func (o OperationOngoing) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "endTime", o.EndTime)
	populate(objectMap, "errorMessage", o.ErrorMessage)
	populate(objectMap, "lastUpdatedTime", o.LastUpdatedTime)
	populate(objectMap, "operationParameters", o.OperationParameters)
	populate(objectMap, "operationRequestId", o.OperationRequestID)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type OperationOngoing.
func (o *OperationOngoing) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", o, err)
	}
	for key, val := range rawMsg {
		...
		case "lastUpdatedTime":
			err = unpopulate(val, "LastUpdatedTime", &o.LastUpdatedTime)
			delete(rawMsg, key)
		case "operationParameters":
			err = unpopulate(val, "OperationParameters", &o.OperationParameters)
			delete(rawMsg, key)
		case "operationRequestId":
			err = unpopulate(val, "OperationRequestID", &o.OperationRequestID)
			delete(rawMsg, key)
		case "operationType":
...
// MarshalJSON implements the json.Marshaller interface for type OperationOngoingListResult.
func (o OperationOngoingListResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "nextLink", o.NextLink)
	populate(objectMap, "value", o.Value)
	return json.Marshal(objectMap)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type OperationOngoingListResult.
func (o *OperationOngoingListResult) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", o, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type RestoreSnapshotResponseSubTask.
func (r RestoreSnapshotResponseSubTask) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "detail", r.Detail)
	populateDateTimeRFC3339(objectMap, "endTime", r.EndTime)
	populate(objectMap, "errorMessage", r.ErrorMessage)
	populateDateTimeRFC3339(objectMap, "estimatedEndTime", r.EstimatedEndTime)
	objectMap["objectType"] = "RestoreSnapshotResponseSubTask"
...
// UnmarshalJSON implements the json.Unmarshaller interface for type RestoreSnapshotResponseSubTask.
func (r *RestoreSnapshotResponseSubTask) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", r, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "detail":
			err = unpopulate(val, "Detail", &r.Detail)
			delete(rawMsg, key)
		case "endTime":
		...
		case "estimatedEndTime":
			err = unpopulateDateTimeRFC3339(val, "EstimatedEndTime", &r.EstimatedEndTime)
			delete(rawMsg, key)
		case "objectType":
...
// MarshalJSON implements the json.Marshaller interface for type RestoreSnapshotResponseType.
func (r RestoreSnapshotResponseType) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "detail", r.Detail)
	populateDateTimeRFC3339(objectMap, "estimatedCompletionTime", r.EstimatedCompletionTime)
	objectMap["objectType"] = ObjectTypeRestoreSnapshotResponse
	populate(objectMap, "operationParameters", r.OperationParameters)
	populate(objectMap, "retryTimes", r.RetryTimes)
	populate(objectMap, "subTasks", r.SubTasks)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type RestoreSnapshotResponseType.
func (r *RestoreSnapshotResponseType) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", r, err)
	}
	for key, val := range rawMsg {
		...
		case "detail":
			...
			delete(rawMsg, key)
		case "estimatedCompletionTime":
			err = unpopulateDateTimeRFC3339(val, "EstimatedCompletionTime", &r.EstimatedCompletionTime)
			delete(rawMsg, key)
		case "objectType":
			err = unpopulate(val, "ObjectType", &r.ObjectType)
			delete(rawMsg, key)
		case "operationParameters":
			err = unpopulate(val, "OperationParameters", &r.OperationParameters)
			delete(rawMsg, key)
		case "retryTimes":
			err = unpopulate(val, "RetryTimes", &r.RetryTimes)
			delete(rawMsg, key)
		case "subTasks":
			err = unpopulate(val, "SubTasks", &r.SubTasks)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", r, err)
...
// MarshalJSON implements the json.Marshaller interface for type ServerForEstimateRestoreSnapshotParameter.
func (s ServerForEstimateRestoreSnapshotParameter) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type ServerForEstimateRestoreSnapshotParameter.
func (s *ServerForEstimateRestoreSnapshotParameter) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type ServerForEstimateRestoreSnapshotResponse.
func (s ServerForEstimateRestoreSnapshotResponse) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "estimatedDurationInSecondsMax", s.EstimatedDurationInSecondsMax)
	populate(objectMap, "estimatedDurationInSecondsMin", s.EstimatedDurationInSecondsMin)
	populate(objectMap, "subTasks", s.SubTasks)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ServerForEstimateRestoreSnapshotResponse.
func (s *ServerForEstimateRestoreSnapshotResponse) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
	for key, val := range rawMsg {
		var err error
		switch key {
		case "estimatedDurationInSecondsMax":
			err = unpopulate(val, "EstimatedDurationInSecondsMax", &s.EstimatedDurationInSecondsMax)
			delete(rawMsg, key)
		case "estimatedDurationInSecondsMin":
			err = unpopulate(val, "EstimatedDurationInSecondsMin", &s.EstimatedDurationInSecondsMin)
			delete(rawMsg, key)
		case "subTasks":
			err = unpopulate(val, "SubTasks", &s.SubTasks)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", s, err)
...
// MarshalJSON implements the json.Marshaller interface for type ServerForEstimateRestoreSnapshotResponseSubTask.
func (s ServerForEstimateRestoreSnapshotResponseSubTask) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "estimatedDurationInSecondsMax", s.EstimatedDurationInSecondsMax)
	populate(objectMap, "estimatedDurationInSecondsMin", s.EstimatedDurationInSecondsMin)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type ServerForEstimateRestoreSnapshotResponseSubTask.
func (s *ServerForEstimateRestoreSnapshotResponseSubTask) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
