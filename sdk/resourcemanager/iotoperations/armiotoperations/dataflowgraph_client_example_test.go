...
func ExampleDataflowGraphClient_BeginCreateOrUpdate() {
			...
			NodeConnections: []*armiotoperations.DataflowGraphNodeConnection{
				{
					From: &armiotoperations.DataflowGraphConnectionInput{
						Name: to.Ptr("wsqbccd"),
						Schema: &armiotoperations.DataflowGraphSchemaSettings{
							SerializationFormat: to.Ptr(armiotoperations.DataflowGraphSerializationFormatDelta),
							SchemaRef:           to.Ptr("gkyqreiunkvdgggy"),
						},
					},
					To: &armiotoperations.DataflowGraphConnectionOutput{
						Name: to.Ptr("dqvkpqshglptwrjfeblfzbofmkfktzbjhidsvqctmbzocbtgtkbgrayg"),
					},
				},
			},
		},
	...
	// 			Type: to.Ptr(armiotoperations.ExtendedLocationTypeCustomLocation),
	// 		},
	// 		ID: to.Ptr("/subscriptions/0000000-0000-0000-0000-000000000000/resourceGroups/resourceGroup123/providers/Microsoft.IoTOperations/instances/resource-name123/dataflowProfiles/resource-name123/dataflowGraphs/resource-name123"),
	// 		Name: to.Ptr("iwhrd"),
	// 		Type: to.Ptr("advacc"),
