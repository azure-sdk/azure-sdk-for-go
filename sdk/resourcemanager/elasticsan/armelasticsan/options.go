...
// ElasticSansClientListByElasticSanOptions contains the optional parameters for the ElasticSansClient.NewListByElasticSanPager
// method.
type ElasticSansClientListByElasticSanOptions struct {
	// placeholder for future optional parameters
}
...
// SKUsOperationGroupClientListOptions contains the optional parameters for the SKUsOperationGroupClient.NewListPager method.
type SKUsOperationGroupClientListOptions struct {
...
// VolumesClientBeginRestoreVolumeOptions contains the optional parameters for the VolumesClient.BeginRestoreVolume method.
type VolumesClientBeginRestoreVolumeOptions struct {
	// Resumes the long-running operation from the provided token.
	ResumeToken string
}
