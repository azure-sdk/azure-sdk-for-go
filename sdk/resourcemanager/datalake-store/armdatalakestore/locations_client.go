...
func (client *LocationsClient) getCapabilityCreateRequest(ctx context.Context, location string, _ *LocationsClientGetCapabilityOptions) (*policy.Request, error) {
...
func (client *LocationsClient) getUsageCreateRequest(ctx context.Context, location string, _ *LocationsClientGetUsageOptions) (*policy.Request, error) {
