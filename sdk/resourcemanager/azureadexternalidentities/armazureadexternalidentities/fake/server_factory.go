...
type ServerFactory struct {
	// B2CTenantsServer contains the fakes for client B2CTenantsClient
	B2CTenantsServer B2CTenantsServer

	// CIAMTenantsServer contains the fakes for client CIAMTenantsClient
	CIAMTenantsServer CIAMTenantsServer

	// ExternalIdentitiesConfigurationServer contains the fakes for client ExternalIdentitiesConfigurationClient
	ExternalIdentitiesConfigurationServer ExternalIdentitiesConfigurationServer

	// GuestUsagesServer contains the fakes for client GuestUsagesClient
