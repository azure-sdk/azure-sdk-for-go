...
func (s *SupportPlanTypesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if supportPlanTypesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = supportPlanTypesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "SupportPlanTypesClient.ListInfo":
				res.resp, res.err = s.dispatchListInfo(req)
			default:
...
// set this to conditionally intercept incoming requests to SupportPlanTypesServerTransport
var supportPlanTypesServerTransportInterceptor interface {
