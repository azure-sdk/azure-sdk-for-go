...
func (c *ClientFactory) NewBuildAuthTokenClient() *BuildAuthTokenClient {
	subClient, _ := NewBuildAuthTokenClient(c.subscriptionID, c.credential, c.options)
	return subClient
}
...
func (c *ClientFactory) NewBuildsByBuilderResourceClient() *BuildsByBuilderResourceClient {
	subClient, _ := NewBuildsByBuilderResourceClient(c.subscriptionID, c.credential, c.options)
	return subClient
}
