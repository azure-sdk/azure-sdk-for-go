...
// MetadataDependenciesAutoGenerated - Dependencies for the content item, what other content items it requires to work. Can
// describe more complex dependencies using a recursive/nested structure. For a single dependency an id/kind/version
// can be supplied or operator/criteria for complex dependencies.
type MetadataDependenciesAutoGenerated struct {
	// Id of the content item we depend on
	ContentID *string
