...
- New field `ScalingPlanPersonalSchedule` in struct `ScalingPlanPersonalSchedulesClientUpdateOptions`
- New field `Name` in struct `ScalingPlanPooledScheduleProperties`
- New field `ScalingPlanPooledSchedule` in struct `ScalingPlanPooledSchedulesClientUpdateOptions`
