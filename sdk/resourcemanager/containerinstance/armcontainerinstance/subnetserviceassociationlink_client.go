...
// method.
func (client *SubnetServiceAssociationLinkClient) BeginDelete(ctx context.Context, resourceGroup string, virtualNetworkName string, subnetName string, options *SubnetServiceAssociationLinkClientBeginDeleteOptions) (*runtime.Poller[SubnetServiceAssociationLinkClientDeleteResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.deleteOperation(ctx, resourceGroup, virtualNetworkName, subnetName, options)
		if err != nil {
			return nil, err
		}
...
// If the operation fails it returns an *azcore.ResponseError type.
// Generated from API version 2021-10-01
func (client *SubnetServiceAssociationLinkClient) deleteOperation(ctx context.Context, resourceGroup string, virtualNetworkName string, subnetName string, options *SubnetServiceAssociationLinkClientBeginDeleteOptions) (*http.Response, error) {
	req, err := client.deleteCreateRequest(ctx, resourceGroup, virtualNetworkName, subnetName, options)
	if err != nil {
		return nil, err
	}
...
func (client *SubnetServiceAssociationLinkClient) deleteCreateRequest(ctx context.Context, resourceGroup string, virtualNetworkName string, subnetName string, options *SubnetServiceAssociationLinkClientBeginDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourcegroups/{resourceGroup}/providers/Microsoft.Network/virtualNetworks/{virtualNetworkName}/subnets/{subnetName}/providers/Microsoft.ContainerInstance/serviceAssociationLinks/default"
