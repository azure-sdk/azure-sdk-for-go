...
// NewListByParentPager - List LoadBalancer resources by parent
//
// Generated from API version 2024-03-01
//   - resourceURI - The fully qualified Azure Resource manager identifier of the resource.
//   - options - LoadBalancersClientListByParentOptions contains the optional parameters for the LoadBalancersClient.NewListByParentPager
//     method.
func (client *LoadBalancersClient) NewListByParentPager(resourceURI string, options *LoadBalancersClientListByParentOptions) *runtime.Pager[LoadBalancersClientListByParentResponse] {
	return runtime.NewPager(runtime.PagingHandler[LoadBalancersClientListByParentResponse]{
		More: func(page LoadBalancersClientListByParentResponse) bool {
			return page.NextLink != nil && len(*page.NextLink) > 0
		},
		Fetcher: func(ctx context.Context, page *LoadBalancersClientListByParentResponse) (LoadBalancersClientListByParentResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "LoadBalancersClient.NewListByParentPager")
			nextLink := ""
			if page != nil {
			...
			if err != nil {
				return LoadBalancersClientListByParentResponse{}, err
			}
...
func (client *LoadBalancersClient) listByParentCreateRequest(ctx context.Context, resourceURI string, _ *LoadBalancersClientListByParentOptions) (*policy.Request, error) {
...
func (client *LoadBalancersClient) listByParentHandleResponse(resp *http.Response) (LoadBalancersClientListByParentResponse, error) {
	result := LoadBalancersClientListByParentResponse{}
