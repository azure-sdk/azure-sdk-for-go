...
func (s *SapInstancesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if sapInstancesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = sapInstancesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "SapInstancesClient.NewListBySapDiscoverySitePager":
				res.resp, res.err = s.dispatchNewListBySapDiscoverySitePager(req)
...
// set this to conditionally intercept incoming requests to SapInstancesServerTransport
var sapInstancesServerTransportInterceptor interface {
