...
func (client *PrivateLinkResourcesSecClient) getCreateRequest(ctx context.Context, resourceGroupName string, resourceName string, groupName string, _ *PrivateLinkResourcesSecClientGetOptions) (*policy.Request, error) {
...
func (client *PrivateLinkResourcesSecClient) listByServiceCreateRequest(ctx context.Context, resourceGroupName string, resourceName string, _ *PrivateLinkResourcesSecClientListByServiceOptions) (*policy.Request, error) {
