...
func (client *ManagedClustersClient) BeginCreateOrUpdate(ctx context.Context, resourceGroupName string, clusterName string, parameters ManagedCluster, options *ManagedClustersClientBeginCreateOrUpdateOptions) (*runtime.Poller[ManagedClustersClientCreateOrUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		poller, err := runtime.NewPoller[ManagedClustersClientCreateOrUpdateResponse](resp, client.internal.Pipeline(), nil)
		return poller, err
	} else {
...
func (client *ManagedClustersClient) BeginDelete(ctx context.Context, resourceGroupName string, clusterName string, options *ManagedClustersClientBeginDeleteOptions) (*runtime.Poller[ManagedClustersClientDeleteResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		poller, err := runtime.NewPoller[ManagedClustersClientDeleteResponse](resp, client.internal.Pipeline(), nil)
		return poller, err
	} else {
...
// ManagedAzResiliencyStatusGet - Action to get Az Resiliency Status of all the Base resources constituting Service Fabric
// Managed Clusters.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2024-11-01-preview
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - clusterName - The name of the cluster resource.
//   - options - ManagedClustersClientManagedAzResiliencyStatusGetOptions contains the optional parameters for the ManagedClustersClient.ManagedAzResiliencyStatusGet
//     method.
func (client *ManagedClustersClient) ManagedAzResiliencyStatusGet(ctx context.Context, resourceGroupName string, clusterName string, options *ManagedClustersClientManagedAzResiliencyStatusGetOptions) (ManagedClustersClientManagedAzResiliencyStatusGetResponse, error) {
	var err error
	req, err := client.managedAzResiliencyStatusGetCreateRequest(ctx, resourceGroupName, clusterName, options)
	if err != nil {
		return ManagedClustersClientManagedAzResiliencyStatusGetResponse{}, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
	if err != nil {
		return ManagedClustersClientManagedAzResiliencyStatusGetResponse{}, err
	...
	resp, err := client.managedAzResiliencyStatusGetHandleResponse(httpResp)
	return resp, err
}

// managedAzResiliencyStatusGetCreateRequest creates the ManagedAzResiliencyStatusGet request.
func (client *ManagedClustersClient) managedAzResiliencyStatusGetCreateRequest(ctx context.Context, resourceGroupName string, clusterName string, _ *ManagedClustersClientManagedAzResiliencyStatusGetOptions) (*policy.Request, error) {
...
// managedAzResiliencyStatusGetHandleResponse handles the ManagedAzResiliencyStatusGet response.
func (client *ManagedClustersClient) managedAzResiliencyStatusGetHandleResponse(resp *http.Response) (ManagedClustersClientManagedAzResiliencyStatusGetResponse, error) {
	result := ManagedClustersClientManagedAzResiliencyStatusGetResponse{}
...
// ManagedMaintenanceWindowStatusGet - Action to get Maintenance Window Status of the Service Fabric Managed Clusters.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2024-11-01-preview
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - clusterName - The name of the cluster resource.
//   - options - ManagedClustersClientManagedMaintenanceWindowStatusGetOptions contains the optional parameters for the ManagedClustersClient.ManagedMaintenanceWindowStatusGet
//     method.
func (client *ManagedClustersClient) ManagedMaintenanceWindowStatusGet(ctx context.Context, resourceGroupName string, clusterName string, options *ManagedClustersClientManagedMaintenanceWindowStatusGetOptions) (ManagedClustersClientManagedMaintenanceWindowStatusGetResponse, error) {
	var err error
	req, err := client.managedMaintenanceWindowStatusGetCreateRequest(ctx, resourceGroupName, clusterName, options)
	if err != nil {
		return ManagedClustersClientManagedMaintenanceWindowStatusGetResponse{}, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
	if err != nil {
		return ManagedClustersClientManagedMaintenanceWindowStatusGetResponse{}, err
	...
	resp, err := client.managedMaintenanceWindowStatusGetHandleResponse(httpResp)
	return resp, err
}

// managedMaintenanceWindowStatusGetCreateRequest creates the ManagedMaintenanceWindowStatusGet request.
func (client *ManagedClustersClient) managedMaintenanceWindowStatusGetCreateRequest(ctx context.Context, resourceGroupName string, clusterName string, _ *ManagedClustersClientManagedMaintenanceWindowStatusGetOptions) (*policy.Request, error) {
...
// managedMaintenanceWindowStatusGetHandleResponse handles the ManagedMaintenanceWindowStatusGet response.
func (client *ManagedClustersClient) managedMaintenanceWindowStatusGetHandleResponse(resp *http.Response) (ManagedClustersClientManagedMaintenanceWindowStatusGetResponse, error) {
	result := ManagedClustersClientManagedMaintenanceWindowStatusGetResponse{}
...
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - clusterName - The name of the cluster resource.
//   - options - ManagedClustersClientPostOptions contains the optional parameters for the ManagedClustersClient.Post method.
func (client *ManagedClustersClient) Post(ctx context.Context, resourceGroupName string, clusterName string, options *ManagedClustersClientPostOptions) (ManagedClustersClientPostResponse, error) {
	var err error
	req, err := client.postCreateRequest(ctx, resourceGroupName, clusterName, options)
	if err != nil {
		return ManagedClustersClientPostResponse{}, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
	if err != nil {
		return ManagedClustersClientPostResponse{}, err
	...
	return ManagedClustersClientPostResponse{}, nil
}

// postCreateRequest creates the Post request.
func (client *ManagedClustersClient) postCreateRequest(ctx context.Context, resourceGroupName string, clusterName string, _ *ManagedClustersClientPostOptions) (*policy.Request, error) {
...
//     method.
func (client *ManagedClustersClient) BeginStartFaultSimulation(ctx context.Context, resourceGroupName string, clusterName string, parameters FaultSimulationContentClassification, options *ManagedClustersClientBeginStartFaultSimulationOptions) (*runtime.Poller[ManagedClustersClientStartFaultSimulationResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.startFaultSimulation(ctx, resourceGroupName, clusterName, parameters, options)
		if err != nil {
			return nil, err
		}
		poller, err := runtime.NewPoller[ManagedClustersClientStartFaultSimulationResponse](resp, client.internal.Pipeline(), nil)
		return poller, err
	} else {
		return runtime.NewPollerFromResumeToken[ManagedClustersClientStartFaultSimulationResponse](options.ResumeToken, client.internal.Pipeline(), nil)
	}
}
...
//
// Generated from API version 2024-11-01-preview
func (client *ManagedClustersClient) startFaultSimulation(ctx context.Context, resourceGroupName string, clusterName string, parameters FaultSimulationContentClassification, options *ManagedClustersClientBeginStartFaultSimulationOptions) (*http.Response, error) {
	var err error
...
func (client *ManagedClustersClient) startFaultSimulationCreateRequest(ctx context.Context, resourceGroupName string, clusterName string, parameters FaultSimulationContentClassification, _ *ManagedClustersClientBeginStartFaultSimulationOptions) (*policy.Request, error) {
...
func (client *ManagedClustersClient) BeginStopFaultSimulation(ctx context.Context, resourceGroupName string, clusterName string, parameters FaultSimulationIDContent, options *ManagedClustersClientBeginStopFaultSimulationOptions) (*runtime.Poller[ManagedClustersClientStopFaultSimulationResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		poller, err := runtime.NewPoller[ManagedClustersClientStopFaultSimulationResponse](resp, client.internal.Pipeline(), nil)
		return poller, err
	} else {
		return runtime.NewPollerFromResumeToken[ManagedClustersClientStopFaultSimulationResponse](options.ResumeToken, client.internal.Pipeline(), nil)
	}
}
