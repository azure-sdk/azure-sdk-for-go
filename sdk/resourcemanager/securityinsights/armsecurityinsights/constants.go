...
// AuthenticationArmType - Types of authentication.
type AuthenticationArmType string

const (
	AuthenticationArmTypeSnc                     AuthenticationArmType = "Snc"
	AuthenticationArmTypeSncWithUsernamePassword AuthenticationArmType = "SncWithUsernamePassword"
	AuthenticationArmTypeUsernamePassword        AuthenticationArmType = "UsernamePassword"
)

// PossibleAuthenticationArmTypeValues returns the possible values for the AuthenticationArmType const type.
func PossibleAuthenticationArmTypeValues() []AuthenticationArmType {
	return []AuthenticationArmType{
		AuthenticationArmTypeSnc,
		AuthenticationArmTypeSncWithUsernamePassword,
		AuthenticationArmTypeUsernamePassword,
	}
}
...
const (
	// CategoryCostOptimization - Cost optimization recommendation.
	CategoryCostOptimization Category = "CostOptimization"
	// CategoryDemo - Demo recommendation.
	CategoryDemo Category = "Demo"
	// CategoryNewFeature - New feature recommendation.
	CategoryNewFeature Category = "NewFeature"
	// CategoryOnboarding - Onboarding recommendation.
	CategoryOnboarding Category = "Onboarding"
	// CategorySocEfficiency - Soc Efficiency recommendation.
...
// ConfigurationArmType - Represents the types of configuration for a system.
type ConfigurationArmType string

const (
	ConfigurationArmTypeSap ConfigurationArmType = "Sap"
)

// PossibleConfigurationArmTypeValues returns the possible values for the ConfigurationArmType const type.
func PossibleConfigurationArmTypeValues() []ConfigurationArmType {
	return []ConfigurationArmType{
		ConfigurationArmTypeSap,
	}
}
...
const (
	Enum24Activity  Enum24 = "Activity"
	Enum24Expansion Enum24 = "Expansion"
)
...
const (
	Enum26Activity Enum26 = "Activity"
)
...
// HTTPSConfigurationArmType - Represents the types of HTTPS configuration to connect to the JavaOs or SapControlOs system.
type HTTPSConfigurationArmType string

const (
	HTTPSConfigurationArmTypeHTTPOnly                    HTTPSConfigurationArmType = "HttpOnly"
	HTTPSConfigurationArmTypeHTTPSWithSSLVerification    HTTPSConfigurationArmType = "HttpsWithSslVerification"
	HTTPSConfigurationArmTypeHTTPSWithoutSSLVerification HTTPSConfigurationArmType = "HttpsWithoutSslVerification"
)

// PossibleHTTPSConfigurationArmTypeValues returns the possible values for the HTTPSConfigurationArmType const type.
func PossibleHTTPSConfigurationArmTypeValues() []HTTPSConfigurationArmType {
	return []HTTPSConfigurationArmType{
		HTTPSConfigurationArmTypeHTTPOnly,
		HTTPSConfigurationArmTypeHTTPSWithSSLVerification,
		HTTPSConfigurationArmTypeHTTPSWithoutSSLVerification,
	}
}
...
// IngestionArmType - Types of ingestion.
type IngestionArmType string

const (
	IngestionArmTypeFull        IngestionArmType = "Full"
	IngestionArmTypeIncremental IngestionArmType = "Incremental"
)

// PossibleIngestionArmTypeValues returns the possible values for the IngestionArmType const type.
func PossibleIngestionArmTypeValues() []IngestionArmType {
	return []IngestionArmType{
		IngestionArmTypeFull,
		IngestionArmTypeIncremental,
	}
}
...
type KeyVaultAuthType string

const (
	KeyVaultAuthTypeApplicationIdentity KeyVaultAuthType = "ApplicationIdentity"
	KeyVaultAuthTypeManagedIdentity     KeyVaultAuthType = "ManagedIdentity"
)

// PossibleKeyVaultAuthTypeValues returns the possible values for the KeyVaultAuthType const type.
func PossibleKeyVaultAuthTypeValues() []KeyVaultAuthType {
	return []KeyVaultAuthType{
		KeyVaultAuthTypeApplicationIdentity,
		KeyVaultAuthTypeManagedIdentity,
	}
}
...
// LogArmType - Types of logs and tables.
type LogArmType string

const (
	LogArmTypeADCP               LogArmType = "ADCP"
	LogArmTypeADR6               LogArmType = "ADR6"
	LogArmTypeAGR1251            LogArmType = "AGR1251"
	LogArmTypeAGRAGRS            LogArmType = "AGRAGRS"
	LogArmTypeAGRDEFINE          LogArmType = "AGRDEFINE"
	LogArmTypeAGRFLAGS           LogArmType = "AGRFLAGS"
	LogArmTypeAGRPROF            LogArmType = "AGRPROF"
	LogArmTypeAGRTCODES          LogArmType = "AGRTCODES"
	LogArmTypeAGRUSERS           LogArmType = "AGRUSERS"
	LogArmTypeAbapAppLog         LogArmType = "AbapAppLog"
	LogArmTypeAbapAuditLog       LogArmType = "AbapAuditLog"
	LogArmTypeAbapChangeDocsLog  LogArmType = "AbapChangeDocsLog"
	LogArmTypeAbapCrLog          LogArmType = "AbapCrLog"
	LogArmTypeAbapFilesLogs      LogArmType = "AbapFilesLogs"
	LogArmTypeAbapJobLog         LogArmType = "AbapJobLog"
	LogArmTypeAbapSpoolLog       LogArmType = "AbapSpoolLog"
	LogArmTypeAbapSpoolOutputLog LogArmType = "AbapSpoolOutputLog"
	LogArmTypeAbapTableDataLog   LogArmType = "AbapTableDataLog"
	LogArmTypeAbapWorkflowLog    LogArmType = "AbapWorkflowLog"
	LogArmTypeDEVACCESS          LogArmType = "DEVACCESS"
	LogArmTypeGateway            LogArmType = "Gateway"
	LogArmTypeICM                LogArmType = "ICM"
	LogArmTypeJavaFilesLogs      LogArmType = "JavaFilesLogs"
	LogArmTypePAHI               LogArmType = "PAHI"
	LogArmTypeSNCSYSACL          LogArmType = "SNCSYSACL"
	LogArmTypeSysLog             LogArmType = "SysLog"
	LogArmTypeUSERADDR           LogArmType = "USERADDR"
	LogArmTypeUSGRPUSER          LogArmType = "USGRPUSER"
	LogArmTypeUSR01              LogArmType = "USR01"
	LogArmTypeUSR02              LogArmType = "USR02"
	LogArmTypeUSR05              LogArmType = "USR05"
	LogArmTypeUSR21              LogArmType = "USR21"
	LogArmTypeUSRACL             LogArmType = "USRACL"
	LogArmTypeUSRSTAMP           LogArmType = "USRSTAMP"
	LogArmTypeUST04              LogArmType = "UST04"
	LogArmTypeWorkProcess        LogArmType = "WorkProcess"
)

// PossibleLogArmTypeValues returns the possible values for the LogArmType const type.
func PossibleLogArmTypeValues() []LogArmType {
	return []LogArmType{
		LogArmTypeADCP,
		LogArmTypeADR6,
		LogArmTypeAGR1251,
		...
		LogArmTypeAGRTCODES,
		LogArmTypeAGRUSERS,
		LogArmTypeAbapAppLog,
		LogArmTypeAbapAuditLog,
		LogArmTypeAbapChangeDocsLog,
		LogArmTypeAbapCrLog,
		LogArmTypeAbapFilesLogs,
		LogArmTypeAbapJobLog,
		LogArmTypeAbapSpoolLog,
		LogArmTypeAbapSpoolOutputLog,
		LogArmTypeAbapTableDataLog,
		LogArmTypeAbapWorkflowLog,
		LogArmTypeDEVACCESS,
		LogArmTypeGateway,
		LogArmTypeICM,
		LogArmTypeJavaFilesLogs,
		LogArmTypePAHI,
		LogArmTypeSNCSYSACL,
		LogArmTypeSysLog,
		LogArmTypeUSERADDR,
		...
		LogArmTypeUSRSTAMP,
		LogArmTypeUST04,
		LogArmTypeWorkProcess,
	}
}

// LogStatusArmType - Types of log status.
type LogStatusArmType string

const (
	LogStatusArmTypeDisabled LogStatusArmType = "Disabled"
	LogStatusArmTypeEnabled  LogStatusArmType = "Enabled"
)

// PossibleLogStatusArmTypeValues returns the possible values for the LogStatusArmType const type.
func PossibleLogStatusArmTypeValues() []LogStatusArmType {
	return []LogStatusArmType{
		LogStatusArmTypeDisabled,
		LogStatusArmTypeEnabled,
	}
}
...
// Priority - Priority of recommendation.
type Priority string

const (
	// PriorityHigh - High priority for recommendation.
	PriorityHigh Priority = "High"
	// PriorityLow - Low priority for recommendation.
	PriorityLow Priority = "Low"
	// PriorityMedium - Medium priority for recommendation.
...
// SapSystemArmType - Represents the types of SAP systems.
type SapSystemArmType string

const (
	SapSystemArmTypeJavaOs       SapSystemArmType = "JavaOs"
	SapSystemArmTypeNetWeaver    SapSystemArmType = "NetWeaver"
	SapSystemArmTypeSapControlOs SapSystemArmType = "SapControlOs"
)

// PossibleSapSystemArmTypeValues returns the possible values for the SapSystemArmType const type.
func PossibleSapSystemArmTypeValues() []SapSystemArmType {
	return []SapSystemArmType{
		SapSystemArmTypeJavaOs,
		SapSystemArmTypeNetWeaver,
		SapSystemArmTypeSapControlOs,
	}
}
...
const (
	SecretSourceTypeAzureKeyVault       SecretSourceType = "AzureKeyVault"
	SecretSourceTypeEnvironmentVariable SecretSourceType = "EnvironmentVariable"
)
...
func PossibleSecretSourceTypeValues() []SecretSourceType {
	return []SecretSourceType{
		SecretSourceTypeAzureKeyVault,
		SecretSourceTypeEnvironmentVariable,
	}
}
...
const (
	...
	// StateCompletedByAction - Recommendation has been completed by action.
	...
	// StateDisabled - Recommendation is disabled.
	StateDisabled State = "Disabled"
	// StateHidden - Recommendation is hidden.
...
// SystemStatusType - The status of the system.
...
// PossibleSystemStatusTypeValues returns the possible values for the SystemStatusType const type.
func PossibleSystemStatusTypeValues() []SystemStatusType {
