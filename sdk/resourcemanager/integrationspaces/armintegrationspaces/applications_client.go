...
func (client *ApplicationsClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, spaceName string, applicationName string, resource Application, _ *ApplicationsClientCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *ApplicationsClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, spaceName string, applicationName string, _ *ApplicationsClientDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.IntegrationSpaces/spaces/{spaceName}/applications/{applicationName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *ApplicationsClient) getCreateRequest(ctx context.Context, resourceGroupName string, spaceName string, applicationName string, _ *ApplicationsClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.IntegrationSpaces/spaces/{spaceName}/applications/{applicationName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *ApplicationsClient) listBusinessProcessDevelopmentArtifactsCreateRequest(ctx context.Context, resourceGroupName string, spaceName string, applicationName string, _ *ApplicationsClientListBusinessProcessDevelopmentArtifactsOptions) (*policy.Request, error) {
...
func (client *ApplicationsClient) patchCreateRequest(ctx context.Context, resourceGroupName string, spaceName string, applicationName string, properties ApplicationUpdate, _ *ApplicationsClientPatchOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.IntegrationSpaces/spaces/{spaceName}/applications/{applicationName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *ApplicationsClient) saveBusinessProcessDevelopmentArtifactCreateRequest(ctx context.Context, resourceGroupName string, spaceName string, applicationName string, body SaveOrValidateBusinessProcessDevelopmentArtifactRequest, _ *ApplicationsClientSaveBusinessProcessDevelopmentArtifactOptions) (*policy.Request, error) {
...
func (client *ApplicationsClient) validateBusinessProcessDevelopmentArtifactCreateRequest(ctx context.Context, resourceGroupName string, spaceName string, applicationName string, body SaveOrValidateBusinessProcessDevelopmentArtifactRequest, _ *ApplicationsClientValidateBusinessProcessDevelopmentArtifactOptions) (*policy.Request, error) {
