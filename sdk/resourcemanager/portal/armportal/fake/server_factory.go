...
type ServerFactory struct {
	...
	// ListTenantConfigurationViolationsServer contains the fakes for client ListTenantConfigurationViolationsClient
	ListTenantConfigurationViolationsServer ListTenantConfigurationViolationsServer

	// OperationsServer contains the fakes for client OperationsClient
	OperationsServer OperationsServer

	// TenantConfigurationsServer contains the fakes for client TenantConfigurationsClient
