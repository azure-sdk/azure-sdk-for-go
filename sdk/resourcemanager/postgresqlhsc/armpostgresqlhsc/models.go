...
// ServerGroupClientBeginPromoteReadReplicaOptions contains the optional parameters for the ServerGroupClient.BeginPromoteReadReplica
// method.
type ServerGroupClientBeginPromoteReadReplicaOptions struct {
	// Resumes the LRO from the provided token.
	ResumeToken string
}
