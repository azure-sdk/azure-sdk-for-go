...
import (
	"context"
	"github.com/Azure/azure-sdk-for-go/services/preview/eventhub/mgmt/2022-01-01-preview/eventhub"
...
// NetworkSecurityPerimeterConfigurationClientAPI contains the set of methods on the NetworkSecurityPerimeterConfigurationClient type.
type NetworkSecurityPerimeterConfigurationClientAPI interface {
	List(ctx context.Context, resourceGroupName string, namespaceName string) (result eventhub.NetworkSecurityPerimeterConfigurationList, err error)
}

var _ NetworkSecurityPerimeterConfigurationClientAPI = (*eventhub.NetworkSecurityPerimeterConfigurationClient)(nil)

// NetworkSecurityPerimeterConfigurationsClientAPI contains the set of methods on the NetworkSecurityPerimeterConfigurationsClient type.
type NetworkSecurityPerimeterConfigurationsClientAPI interface {
	CreateOrUpdate(ctx context.Context, resourceGroupName string, namespaceName string, resourceAssociationName string) (result eventhub.NetworkSecurityPerimeterConfigurationsCreateOrUpdateFuture, err error)
}

var _ NetworkSecurityPerimeterConfigurationsClientAPI = (*eventhub.NetworkSecurityPerimeterConfigurationsClient)(nil)
...
// ApplicationGroupClientAPI contains the set of methods on the ApplicationGroupClient type.
type ApplicationGroupClientAPI interface {
	CreateOrUpdateApplicationGroup(ctx context.Context, resourceGroupName string, namespaceName string, applicationGroupName string, parameters eventhub.ApplicationGroup) (result eventhub.ApplicationGroup, err error)
	Delete(ctx context.Context, resourceGroupName string, namespaceName string, applicationGroupName string) (result autorest.Response, err error)
	Get(ctx context.Context, resourceGroupName string, namespaceName string, applicationGroupName string) (result eventhub.ApplicationGroup, err error)
	ListByNamespace(ctx context.Context, resourceGroupName string, namespaceName string) (result eventhub.ApplicationGroupListResultPage, err error)
	ListByNamespaceComplete(ctx context.Context, resourceGroupName string, namespaceName string) (result eventhub.ApplicationGroupListResultIterator, err error)
}

var _ ApplicationGroupClientAPI = (*eventhub.ApplicationGroupClient)(nil)
