...
func (s *StreamingEndpointsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if streamingEndpointsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = streamingEndpointsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			case "StreamingEndpointsClient.AsyncOperation":
				res.resp, res.err = s.dispatchAsyncOperation(req)
			...
			case "StreamingEndpointsClient.OperationLocation":
				res.resp, res.err = s.dispatchOperationLocation(req)
			case "StreamingEndpointsClient.SKUs":
				res.resp, res.err = s.dispatchSKUs(req)
			case "StreamingEndpointsClient.BeginScale":
				res.resp, res.err = s.dispatchBeginScale(req)
...
// set this to conditionally intercept incoming requests to StreamingEndpointsServerTransport
var streamingEndpointsServerTransportInterceptor interface {
