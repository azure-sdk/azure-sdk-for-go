...
func (b *BrokerListenerServerTransport) dispatchBeginCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginCreateOrUpdate == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armiotoperations.ListenerResource](req)
		if err != nil {
			return nil, err
		}
...
func (b *BrokerListenerServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	resp, err := server.MarshalResponseAsJSON(respContent, server.GetResponse(respr).ListenerResource, req)
	if err != nil {
		return nil, err
	}
	return resp, nil
