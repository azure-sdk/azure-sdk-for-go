...
func (d *DataStoreTypesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if dataStoreTypesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = dataStoreTypesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "DataStoreTypesClient.NewListByDataManagerPager":
				res.resp, res.err = d.dispatchNewListByDataManagerPager(req)
			default:
...
// set this to conditionally intercept incoming requests to DataStoreTypesServerTransport
var dataStoreTypesServerTransportInterceptor interface {
