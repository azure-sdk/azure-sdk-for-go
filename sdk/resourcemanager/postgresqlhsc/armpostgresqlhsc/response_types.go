...
// ClusterClientPromoteReadReplicaResponse contains the response from method ClusterClient.PromoteReadReplica.
type ClusterClientPromoteReadReplicaResponse struct {
	// placeholder for future response values
}

// ClusterClientRestartResponse contains the response from method ClusterClient.Restart.
type ClusterClientRestartResponse struct {
	// placeholder for future response values
}

// ClusterClientStartResponse contains the response from method ClusterClient.Start.
type ClusterClientStartResponse struct {
	// placeholder for future response values
}

// ClusterClientStopResponse contains the response from method ClusterClient.Stop.
type ClusterClientStopResponse struct {
	// placeholder for future response values
}
...
// ConfigurationClientGetCoordinatorResponse contains the response from method ConfigurationClient.GetCoordinator.
type ConfigurationClientGetCoordinatorResponse struct {
	ServerConfiguration
}

// ConfigurationClientGetNodeResponse contains the response from method ConfigurationClient.GetNode.
type ConfigurationClientGetNodeResponse struct {
	ServerConfiguration
}
