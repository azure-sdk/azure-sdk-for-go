...
func (i *IntegrationRuntimeAuthKeysServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if integrationRuntimeAuthKeysServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = integrationRuntimeAuthKeysServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "IntegrationRuntimeAuthKeysClient.Regenerate":
				res.resp, res.err = i.dispatchRegenerate(req)
			default:
...
// set this to conditionally intercept incoming requests to IntegrationRuntimeAuthKeysServerTransport
var integrationRuntimeAuthKeysServerTransportInterceptor interface {
