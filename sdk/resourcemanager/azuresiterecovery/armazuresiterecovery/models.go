...
// OperationModelProperties - Operation model properties.
...
type ProtectedItemDynamicMemoryConfig struct {
	// READ-ONLY; Gets or sets maximum memory in MB.
	MaximumMemoryInMegaBytes *int64

	// READ-ONLY; Gets or sets minimum memory in MB.
	MinimumMemoryInMegaBytes *int64

	// READ-ONLY; Gets or sets target memory buffer in %.
