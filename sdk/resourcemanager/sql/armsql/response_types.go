...
// ManagedDatabaseSensitivityLabelsClientGetRecommendedResponse contains the response from method ManagedDatabaseSensitivityLabelsClient.GetRecommended.
type ManagedDatabaseSensitivityLabelsClientGetRecommendedResponse struct {
	SensitivityLabel
}
