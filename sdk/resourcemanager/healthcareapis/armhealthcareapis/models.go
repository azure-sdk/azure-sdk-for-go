...
// MedtechMappingValidationError - A mapping validation error.
type MedtechMappingValidationError struct {
	// The validation error message.
	Message *string `json:"message,omitempty"`

	// READ-ONLY; Indicates the type of validation being performed
	Category *MedtechMappingValidationCategory `json:"category,omitempty" azure:"ro"`

	// READ-ONLY; Indicates the severity of the validation error
	Level *MedtechMappingValidationErrorLevel `json:"level,omitempty" azure:"ro"`

	// READ-ONLY; Associates the validation error with the position on the mapping template where it occurred
	LineInfo *MedtechMappingValidationLineInfo `json:"lineInfo,omitempty" azure:"ro"`
}

// MedtechMappingValidationLineInfo - Associates the validation error with the position on the mapping template where it occurred
type MedtechMappingValidationLineInfo struct {
...
// MedtechMeasurement - A measurement extracted during the Medtech device event normalization process.
type MedtechMeasurement struct {
	...
	OccurrenceTimeUTC *time.Time                    `json:"occurrenceTimeUtc,omitempty"`
	Properties        []*MedtechMeasurementProperty `json:"properties,omitempty"`

	// The type of measurement being collected.
	Type *string `json:"type,omitempty"`
}

// MedtechMeasurementProperty - The values for an extracted measurement
type MedtechMeasurementProperty struct {
...
// ServicesClientValidateMedtechMappingsOptions contains the optional parameters for the ServicesClient.ValidateMedtechMappings
// method.
type ServicesClientValidateMedtechMappingsOptions struct {
	// placeholder for future optional parameters
}
...
// ValidateMedtechMappingsDeviceResult - A result returned when processing a single device event in Medtech Mapping Validation
// Service.
type ValidateMedtechMappingsDeviceResult struct {
	// Indicates how many Device Events produced the associated Exception.
	AggregatedCount interface{} `json:"aggregatedCount,omitempty"`

	// The device event which was validated.
	DeviceEvent interface{} `json:"deviceEvent,omitempty"`

	// A collection of measurements which were produced.
	Measurements []*MedtechMeasurement `json:"measurements,omitempty"`

	// A collection of observations which were produced.
	Observations []interface{} `json:"observations,omitempty"`

	// READ-ONLY; A list of mapping validation error.
	Exceptions []*MedtechMappingValidationError `json:"exceptions,omitempty" azure:"ro"`
}

// ValidateMedtechMappingsParameters - Input values for the Medtech Mapping Validation Service.
type ValidateMedtechMappingsParameters struct {
	// REQUIRED; The Medtech device mapping template.
	DeviceMapping *IotMappingProperties `json:"deviceMapping,omitempty"`

	// Indicates if validation results will be aggregated
	AggregateErrors *AggregateErrors `json:"aggregateErrors,omitempty"`
...
// ValidateMedtechMappingsResult - The result returned from the Medtech Mapping Validation Service.
type ValidateMedtechMappingsResult struct {
	// Results from validating each device event against the supplied mapping templates.
	DeviceResults []*ValidateMedtechMappingsDeviceResult `json:"deviceResults,omitempty"`

	// The result from validating the mapping templates.
	TemplateResult *ValidateMedtechMappingsResultTemplateResult `json:"templateResult,omitempty"`
}

// ValidateMedtechMappingsResultTemplateResult - The result from validating the mapping templates.
type ValidateMedtechMappingsResultTemplateResult struct {
	// READ-ONLY; A list of mapping validation error.
	Exceptions []*MedtechMappingValidationError `json:"exceptions,omitempty" azure:"ro"`
}
