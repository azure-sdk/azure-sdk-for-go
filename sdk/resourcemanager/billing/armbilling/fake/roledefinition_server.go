...
func (r *RoleDefinitionServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if roleDefinitionServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = roleDefinitionServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to RoleDefinitionServerTransport
var roleDefinitionServerTransportInterceptor interface {
