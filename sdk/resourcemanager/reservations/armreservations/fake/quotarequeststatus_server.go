...
func (q *QuotaRequestStatusServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if quotaRequestStatusServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = quotaRequestStatusServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to QuotaRequestStatusServerTransport
var quotaRequestStatusServerTransportInterceptor interface {
