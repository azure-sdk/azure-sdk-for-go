...
import (
	...
	"github.com/Azure/azure-sdk-for-go/sdk/resourcemanager/kubernetesconfiguration/armsourcecontrolconfigurations"
	"net/http"
	"net/url"
	"regexp"
)

// Server is a fake server for instances of the armsourcecontrolconfigurations.Client type.
type Server struct {
	// CreateOrUpdate is the fake for method Client.CreateOrUpdate
	// HTTP status codes to indicate success: http.StatusOK, http.StatusCreated
	CreateOrUpdate func(ctx context.Context, resourceGroupName string, clusterRp string, clusterResourceName string, clusterName string, sourceControlConfigurationName string, sourceControlConfiguration armsourcecontrolconfigurations.SourceControlConfiguration, options *armsourcecontrolconfigurations.ClientCreateOrUpdateOptions) (resp azfake.Responder[armsourcecontrolconfigurations.ClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)

	// BeginDelete is the fake for method Client.BeginDelete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	BeginDelete func(ctx context.Context, resourceGroupName string, clusterRp string, clusterResourceName string, clusterName string, sourceControlConfigurationName string, options *armsourcecontrolconfigurations.ClientBeginDeleteOptions) (resp azfake.PollerResponder[armsourcecontrolconfigurations.ClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method Client.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, clusterRp string, clusterResourceName string, clusterName string, sourceControlConfigurationName string, options *armsourcecontrolconfigurations.ClientGetOptions) (resp azfake.Responder[armsourcecontrolconfigurations.ClientGetResponse], errResp azfake.ErrorResponder)

	// NewListPager is the fake for method Client.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(resourceGroupName string, clusterRp string, clusterResourceName string, clusterName string, options *armsourcecontrolconfigurations.ClientListOptions) (resp azfake.PagerResponder[armsourcecontrolconfigurations.ClientListResponse])
}

// NewServerTransport creates a new instance of ServerTransport with the provided implementation.
// The returned ServerTransport instance is connected to an instance of armsourcecontrolconfigurations.Client via the
// azcore.ClientOptions.Transporter field in the client's constructor parameters.
func NewServerTransport(srv *Server) *ServerTransport {
	return &ServerTransport{
		srv:          srv,
		beginDelete:  newTracker[azfake.PollerResponder[armsourcecontrolconfigurations.ClientDeleteResponse]](),
		newListPager: newTracker[azfake.PagerResponder[armsourcecontrolconfigurations.ClientListResponse]](),
	}
}

// ServerTransport connects instances of armsourcecontrolconfigurations.Client to instances of Server.
// Don't use this type directly, use NewServerTransport instead.
type ServerTransport struct {
	srv          *Server
	beginDelete  *tracker[azfake.PollerResponder[armsourcecontrolconfigurations.ClientDeleteResponse]]
	newListPager *tracker[azfake.PagerResponder[armsourcecontrolconfigurations.ClientListResponse]]
}
...
func (s *ServerTransport) dispatchCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[armsourcecontrolconfigurations.SourceControlConfiguration](req)
	if err != nil {
		return nil, err
	}
...
func (s *ServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armsourcecontrolconfigurations.ClientListResponse, createLink func() string) {
