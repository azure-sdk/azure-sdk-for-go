...
func (p *PrivateEndpointConnectionControllerServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if privateEndpointConnectionControllerServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = privateEndpointConnectionControllerServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			case "PrivateEndpointConnectionControllerClient.DeletePrivateEndpointConnection":
				res.resp, res.err = p.dispatchDeletePrivateEndpointConnection(req)
			...
			case "PrivateEndpointConnectionControllerClient.PutPrivateEndpointConnection":
				res.resp, res.err = p.dispatchPutPrivateEndpointConnection(req)
			default:
...
// set this to conditionally intercept incoming requests to PrivateEndpointConnectionControllerServerTransport
var privateEndpointConnectionControllerServerTransportInterceptor interface {
