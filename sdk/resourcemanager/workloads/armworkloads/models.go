...
type Db2ProviderInstanceProperties struct {
	// CONSTANT; The provider type. For example, the value can be SapHana.
...
type Monitor struct {
	...
	// READ-ONLY; Name of the SAP monitor resource.
	Name *string
...
type MsSQLServerProviderInstanceProperties struct {
	// CONSTANT; The provider type. For example, the value can be SapHana.
	// Field has constant value "MsSqlServer", any specified value is ignored.
	ProviderType *string
...
type PrometheusHaClusterProviderInstanceProperties struct {
	// CONSTANT; The provider type. For example, the value can be SapHana.
	// Field has constant value "PrometheusHaCluster", any specified value is ignored.
	ProviderType *string
...
type PrometheusOsProviderInstanceProperties struct {
	// CONSTANT; The provider type. For example, the value can be SapHana.
	// Field has constant value "PrometheusOS", any specified value is ignored.
	ProviderType *string
...
type ProviderInstance struct {
	...
	// READ-ONLY; Name of the provider instance.
	Name *string
...
type SapNetWeaverProviderInstanceProperties struct {
	// CONSTANT; The provider type. For example, the value can be SapHana.
	// Field has constant value "SapNetWeaver", any specified value is ignored.
	ProviderType *string
