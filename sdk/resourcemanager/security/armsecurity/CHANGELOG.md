...
- Function `NewApplicationClient` parameter(s) have been changed from `(string, azcore.TokenCredential, *arm.ClientOptions)` to `(azcore.TokenCredential, *arm.ClientOptions)`
- Function `*ApplicationClient.Get` parameter(s) have been changed from `(context.Context, string, *ApplicationClientGetOptions)` to `(context.Context, string, string, string, *ApplicationClientGetOptions)`
...
- Field `ConditionSets`, `Description`, `DisplayName`, `SourceResourceType` of struct `ApplicationProperties` has been removed

### Features Added

- New enum type `BusinessCriticality` with values `BusinessCriticalityHigh`, `BusinessCriticalityLow`, `BusinessCriticalityMedium`, `BusinessCriticalityNotCritical`
- New function `*ApplicationClient.NewListByRuleIDPager(string, string, *ApplicationClientListByRuleIDOptions) *runtime.Pager[ApplicationClientListByRuleIDResponse]`
- New function `*ApplicationClient.NewListPager(string, *ApplicationClientListOptions) *runtime.Pager[ApplicationClientListResponse]`
- New function `*ApplicationClient.Update(context.Context, string, string, string, Application, *ApplicationClientUpdateOptions) (ApplicationClientUpdateResponse, error)`
- New function `NewApplicationMappingRulesClient(azcore.TokenCredential, *arm.ClientOptions) (*ApplicationMappingRulesClient, error)`
- New function `*ApplicationMappingRulesClient.CreateOrUpdate(context.Context, string, string, ApplicationMappingRule, *ApplicationMappingRulesClientCreateOrUpdateOptions) (ApplicationMappingRulesClientCreateOrUpdateResponse, error)`
- New function `*ApplicationMappingRulesClient.Delete(context.Context, string, string, *ApplicationMappingRulesClientDeleteOptions) (ApplicationMappingRulesClientDeleteResponse, error)`
- New function `*ApplicationMappingRulesClient.Get(context.Context, string, string, *ApplicationMappingRulesClientGetOptions) (ApplicationMappingRulesClientGetResponse, error)`
- New function `*ApplicationMappingRulesClient.NewListPager(string, *ApplicationMappingRulesClientListOptions) *runtime.Pager[ApplicationMappingRulesClientListResponse]`
- New function `*ClientFactory.NewApplicationMappingRulesClient() *ApplicationMappingRulesClient`
- New struct `ApplicationList`
- New struct `ApplicationMappingRule`
- New struct `ApplicationMappingRuleList`
- New struct `ApplicationMappingRuleMetaData`
- New struct `ApplicationMappingRuleProperties`
- New field `ApplicationOwner`, `BusinessCriticality`, `KqlQuery`, `TenantID` in struct `ApplicationProperties`
