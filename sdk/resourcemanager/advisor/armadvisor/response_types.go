...
// ConfigurationsClientCreateInResourceGroupDurationResponse contains the response from method ConfigurationsClient.CreateInResourceGroupDuration.
type ConfigurationsClientCreateInResourceGroupDurationResponse struct {
...
// ConfigurationsClientCreateInSubscriptionDurationResponse contains the response from method ConfigurationsClient.CreateInSubscriptionDuration.
type ConfigurationsClientCreateInSubscriptionDurationResponse struct {
	// The Advisor configuration data structure.
	ConfigData
}
