...
// ValidateSessionHostUpdateRequestBody - Object containing the definition for properties to be used in the sessionHostUpdate
// validation.
type ValidateSessionHostUpdateRequestBody struct {
	// The timestamp that the update validation is scheduled for. If none is provided, the update will be executed immediately
	ScheduledDateTime *time.Time
