...
type OperationResultsServer struct {
	...
	BeginGet func(ctx context.Context, location string, operationID string, options *armservicefabricmanagedclusters.OperationResultsClientBeginGetOptions) (resp azfake.PollerResponder[armservicefabricmanagedclusters.OperationResultsClientGetResponse], errResp azfake.ErrorResponder)
}
...
func NewOperationResultsServerTransport(srv *OperationResultsServer) *OperationResultsServerTransport {
	return &OperationResultsServerTransport{
		srv:      srv,
		beginGet: newTracker[azfake.PollerResponder[armservicefabricmanagedclusters.OperationResultsClientGetResponse]](),
	}
}
...
type OperationResultsServerTransport struct {
	...
	beginGet *tracker[azfake.PollerResponder[armservicefabricmanagedclusters.OperationResultsClientGetResponse]]
}
