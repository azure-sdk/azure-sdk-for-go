...
// BusinessProcessVersionsServer is a fake server for instances of the armazureintegrationspaces.BusinessProcessVersionsClient type.
type BusinessProcessVersionsServer struct {
	// Get is the fake for method BusinessProcessVersionsClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, spaceName string, applicationName string, businessProcessName string, businessProcessVersion string, options *armazureintegrationspaces.BusinessProcessVersionsClientGetOptions) (resp azfake.Responder[armazureintegrationspaces.BusinessProcessVersionsClientGetResponse], errResp azfake.ErrorResponder)

	// NewListByBusinessProcessPager is the fake for method BusinessProcessVersionsClient.NewListByBusinessProcessPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByBusinessProcessPager func(resourceGroupName string, spaceName string, applicationName string, businessProcessName string, options *armazureintegrationspaces.BusinessProcessVersionsClientListByBusinessProcessOptions) (resp azfake.PagerResponder[armazureintegrationspaces.BusinessProcessVersionsClientListByBusinessProcessResponse])
}
...
// The returned BusinessProcessVersionsServerTransport instance is connected to an instance of armazureintegrationspaces.BusinessProcessVersionsClient via the
...
func NewBusinessProcessVersionsServerTransport(srv *BusinessProcessVersionsServer) *BusinessProcessVersionsServerTransport {
	return &BusinessProcessVersionsServerTransport{
		srv:                           srv,
		newListByBusinessProcessPager: newTracker[azfake.PagerResponder[armazureintegrationspaces.BusinessProcessVersionsClientListByBusinessProcessResponse]](),
	}
}

// BusinessProcessVersionsServerTransport connects instances of armazureintegrationspaces.BusinessProcessVersionsClient to instances of BusinessProcessVersionsServer.
...
type BusinessProcessVersionsServerTransport struct {
	...
	newListByBusinessProcessPager *tracker[azfake.PagerResponder[armazureintegrationspaces.BusinessProcessVersionsClientListByBusinessProcessResponse]]
}
...
func (b *BusinessProcessVersionsServerTransport) dispatchNewListByBusinessProcessPager(req *http.Request) (*http.Response, error) {
	...
	if newListByBusinessProcessPager == nil {
		...
		var options *armazureintegrationspaces.BusinessProcessVersionsClientListByBusinessProcessOptions
		if topParam != nil || skipParam != nil || maxpagesizeParam != nil || filterParam != nil || len(selectParam) > 0 || len(expandParam) > 0 || len(orderbyParam) > 0 {
			options = &armazureintegrationspaces.BusinessProcessVersionsClientListByBusinessProcessOptions{
				Top:         topParam,
				Skip:        skipParam,
		...
		server.PagerResponderInjectNextLinks(newListByBusinessProcessPager, req, func(page *armazureintegrationspaces.BusinessProcessVersionsClientListByBusinessProcessResponse, createLink func() string) {
