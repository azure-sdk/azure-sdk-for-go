...
type ScriptPackagesServer struct {
	...
	// HTTP status codes to indicate success: http.StatusOK
	NewListByPrivateCloudPager func(resourceGroupName string, privateCloudName string, options *armavs.ScriptPackagesClientListByPrivateCloudOptions) (resp azfake.PagerResponder[armavs.ScriptPackagesClientListByPrivateCloudResponse])
}
