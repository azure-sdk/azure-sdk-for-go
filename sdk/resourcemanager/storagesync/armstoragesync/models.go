...
type RegisteredServerCreateParametersProperties struct {
	...
	// READ-ONLY; Comma separated list of user assigned identities
	IdentityID *string `json:"identityId,omitempty" azure:"ro"`

	// READ-ONLY; Identity Type
	IdentityType *ManagedServiceIdentityType `json:"identityType,omitempty" azure:"ro"`
}
...
type RegisteredServerUpdateParameters struct {
	...
	Properties *RegisteredServerUpdateParametersProperties `json:"properties,omitempty"`
...
// RegisteredServerUpdateParametersProperties - RegisteredServer Create Properties object.
