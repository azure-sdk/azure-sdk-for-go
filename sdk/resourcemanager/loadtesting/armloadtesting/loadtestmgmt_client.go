...
//     method.
func (client *LoadTestMgmtClient) BeginUpdateLoadtest(ctx context.Context, resourceGroupName string, loadTestName string, loadTestResourcePatchRequestBody LoadTestResource, options *LoadTestMgmtClientBeginUpdateLoadtestOptions) (*runtime.Poller[LoadTestMgmtClientUpdateLoadtestResponse], error) {
	if options == nil || options.ResumeToken == "" {
...
//
// Generated from API version 2023-12-01-preview
func (client *LoadTestMgmtClient) updateLoadtest(ctx context.Context, resourceGroupName string, loadTestName string, loadTestResourcePatchRequestBody LoadTestResource, options *LoadTestMgmtClientBeginUpdateLoadtestOptions) (*http.Response, error) {
	var err error
...
func (client *LoadTestMgmtClient) updateLoadtestCreateRequest(ctx context.Context, resourceGroupName string, loadTestName string, loadTestResourcePatchRequestBody LoadTestResource, _ *LoadTestMgmtClientBeginUpdateLoadtestOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.LoadTestService/loadTests/{loadTestName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
