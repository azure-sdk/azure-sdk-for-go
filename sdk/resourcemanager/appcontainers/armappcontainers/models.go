...
type Label struct {
	...
	// READ-ONLY; Container App versioned application definition.
	Template *Template
}

// Labels - Container App Labels.
type Labels struct {
...
// LabelsCollection - Labels collection ARM resource.
...
// LabelsProperties - Labels specific properties
type LabelsProperties struct {
	// Labels for the Container App.
	Labels []*Label

	// READ-ONLY; Current provisioning State of the operation
	ProvisioningState *LabelsProvisioningState
}
