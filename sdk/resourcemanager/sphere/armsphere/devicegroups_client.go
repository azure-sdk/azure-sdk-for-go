...
func (client *DeviceGroupsClient) claimDevicesCreateRequest(ctx context.Context, resourceGroupName string, catalogName string, productName string, deviceGroupName string, body ClaimDevicesRequest, _ *DeviceGroupsClientBeginClaimDevicesOptions) (*policy.Request, error) {
