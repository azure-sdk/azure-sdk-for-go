...
type ServerFactory struct {
	...
	// IntegrationAccountAssembliesServer contains the fakes for client IntegrationAccountAssembliesClient
	IntegrationAccountAssembliesServer IntegrationAccountAssembliesServer

	// IntegrationAccountBatchConfigurationsServer contains the fakes for client IntegrationAccountBatchConfigurationsClient
	...
	// IntegrationServiceEnvironmentManagedAPIOperationsServer contains the fakes for client IntegrationServiceEnvironmentManagedAPIOperationsClient
	...
	// IntegrationServiceEnvironmentNetworkHealthServer contains the fakes for client IntegrationServiceEnvironmentNetworkHealthClient
	IntegrationServiceEnvironmentNetworkHealthServer IntegrationServiceEnvironmentNetworkHealthServer

	// IntegrationServiceEnvironmentSKUsServer contains the fakes for client IntegrationServiceEnvironmentSKUsClient
	...
	// WorkflowRunActionRequestHistoriesServer contains the fakes for client WorkflowRunActionRequestHistoriesClient
	...
	// WorkflowRunOperationsServer contains the fakes for client WorkflowRunOperationsClient
	...
	// WorkflowVersionTriggersServer contains the fakes for client WorkflowVersionTriggersClient
