...
// ConnectorPropertiesUpdate - Details of the Connector.
type ConnectorPropertiesUpdate struct {
	// connector type
	ConnectorType *Platform
}

// ConnectorUpdate - A connector is a resource that can be used to proactively report impacts against workloads in Azure to
// Microsoft.
...
// UploadTokenResponse - A successful response from getUploadToken will contain an "uploadUrl" field. This uploadUrl field's
// value should be follow the format: https://.blob.core.windows.net//?
