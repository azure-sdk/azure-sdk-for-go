...
- New const `AutoHealStatusOn`
- New const `AutoHealStatusOff`
...
- New function `PossibleAutoHealStatusValues() []AutoHealStatus`
...
- New function `*BackupInstancesExtensionRoutingClient.List(string, *BackupInstancesExtensionRoutingClientListOptions) *runtime.Pager[BackupInstancesExtensionRoutingClientListResponse]`
