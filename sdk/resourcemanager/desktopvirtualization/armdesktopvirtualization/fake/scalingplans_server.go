...
func (s *ScalingPlansServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if scalingPlansServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = scalingPlansServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to ScalingPlansServerTransport
var scalingPlansServerTransportInterceptor interface {
