...
- Type of `GenerateDetailedCostReportOperationStatuses.Status` has been changed from `*Status` to `*StatusAutoGenerated`
...
- New enum type `Status` with values `StatusComplete`, `StatusFailed`, `StatusRunning`
