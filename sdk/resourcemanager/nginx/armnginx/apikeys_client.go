...
func NewAPIKeysClient(subscriptionID string, apiKeyName string, credential azcore.TokenCredential, options *arm.ClientOptions) (*APIKeysClient, error) {
...
func (client *APIKeysClient) CreateOrUpdate(ctx context.Context, resourceGroupName string, deploymentName string, options *APIKeysClientCreateOrUpdateOptions) (APIKeysClientCreateOrUpdateResponse, error) {
	var err error
...
func (client *APIKeysClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, deploymentName string, options *APIKeysClientCreateOrUpdateOptions) (*policy.Request, error) {
	...
	if client.apiKeyName == "" {
		return nil, errors.New("parameter client.apiKeyName cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{apiKeyName}", url.PathEscape(client.apiKeyName))
...
func (client *APIKeysClient) Delete(ctx context.Context, resourceGroupName string, deploymentName string, options *APIKeysClientDeleteOptions) (APIKeysClientDeleteResponse, error) {
	var err error
...
func (client *APIKeysClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, deploymentName string, options *APIKeysClientDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Nginx.NginxPlus/nginxDeployments/{deploymentName}/apiKeys/{apiKeyName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *APIKeysClient) Get(ctx context.Context, resourceGroupName string, deploymentName string, options *APIKeysClientGetOptions) (APIKeysClientGetResponse, error) {
	var err error
...
func (client *APIKeysClient) getCreateRequest(ctx context.Context, resourceGroupName string, deploymentName string, options *APIKeysClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Nginx.NginxPlus/nginxDeployments/{deploymentName}/apiKeys/{apiKeyName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
