...
// ErrorResponseAutoGenerated2 - An error response from the API.
...
// ParametersSchema - Schema for operation parameters.
type ParametersSchema struct {
	// REQUIRED; The name of the scenario for which the data is requested
	ScenarioName *string

	// REQUIRED; The parameters for the specified scenario and view
	ScenarioParameters any

	// REQUIRED; The list of scopes for which the data is requested
	Scopes []*string
}
