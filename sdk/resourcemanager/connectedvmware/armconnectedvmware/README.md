...
```go
client, err := armconnectedvmware.NewVirtualNetworksClient(<subscription ID>, cred, nil)
```
...
client, err := armconnectedvmware.NewVirtualNetworksClient(<subscription ID>, cred, &options)
```
