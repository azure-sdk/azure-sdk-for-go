...
type StaticSite struct {
	...
	// READ-ONLY; Traffic splitting distribution for the static site
	TrafficSplitting *StaticSiteTrafficSplittingProperties `json:"trafficSplitting,omitempty" azure:"ro"`
...
// StaticSiteTrafficSplittingProperties - Properties for traffic splitting in a static site
type StaticSiteTrafficSplittingProperties struct {
	// Kind of resource.
	Kind *string `json:"kind,omitempty"`

	// StaticSiteTrafficSplittingProperties resource specific properties
	Properties *StaticSiteTrafficSplittingPropertiesProperties `json:"properties,omitempty"`
...
// StaticSiteTrafficSplittingPropertiesARMResource - Static site traffic splitting properties ARM resource.
type StaticSiteTrafficSplittingPropertiesARMResource struct {
	// Kind of resource.
	Kind *string `json:"kind,omitempty"`

	// StaticSiteTrafficSplittingPropertiesARMResource resource specific properties
	Properties *StaticSiteTrafficSplittingPropertiesARMResourceProperties `json:"properties,omitempty"`
...
// StaticSiteTrafficSplittingPropertiesARMResourceProperties - StaticSiteTrafficSplittingPropertiesARMResource resource specific
// properties
type StaticSiteTrafficSplittingPropertiesARMResourceProperties struct {
	// Dictionary of
	EnvironmentDistribution map[string]*int32 `json:"environmentDistribution,omitempty"`
}

// StaticSiteTrafficSplittingPropertiesCollection - Collection of static site traffic splitting.
type StaticSiteTrafficSplittingPropertiesCollection struct {
	// REQUIRED; Collection of resources.
	Value []*StaticSiteTrafficSplittingPropertiesARMResource `json:"value,omitempty"`

	// READ-ONLY; Link to next page of resources.
	NextLink *string `json:"nextLink,omitempty" azure:"ro"`
}

// StaticSiteTrafficSplittingPropertiesProperties - StaticSiteTrafficSplittingProperties resource specific properties
type StaticSiteTrafficSplittingPropertiesProperties struct {
	// Dictionary of
	EnvironmentDistribution map[string]*int32 `json:"environmentDistribution,omitempty"`
}
...
// StaticSitesClientBeginCreateOrUpdateTrafficSplittingOptions contains the optional parameters for the StaticSitesClient.BeginCreateOrUpdateTrafficSplitting
// method.
type StaticSitesClientBeginCreateOrUpdateTrafficSplittingOptions struct {
	// Resumes the LRO from the provided token.
	ResumeToken string
}
...
// StaticSitesClientDeleteTrafficSplittingOptions contains the optional parameters for the StaticSitesClient.DeleteTrafficSplitting
// method.
type StaticSitesClientDeleteTrafficSplittingOptions struct {
	// placeholder for future optional parameters
}
...
// StaticSitesClientGetTrafficSplittingOptions contains the optional parameters for the StaticSitesClient.GetTrafficSplitting
// method.
type StaticSitesClientGetTrafficSplittingOptions struct {
	// placeholder for future optional parameters
}
