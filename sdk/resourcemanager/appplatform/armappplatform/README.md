...
```sh
go get github.com/Azure/azure-sdk-for-go/sdk/resourcemanager/appplatform/armappplatform/v3
```
...
[open an issue](https://github.com/Azure/azure-sdk-for-go/issues) and assign the `App Platform` label.
