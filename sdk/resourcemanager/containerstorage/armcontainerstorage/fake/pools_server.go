...
type PoolsServer struct {
	...
	BeginUpdate func(ctx context.Context, resourceGroupName string, poolName string, properties armcontainerstorage.Pool, options *armcontainerstorage.PoolsClientBeginUpdateOptions) (resp azfake.PollerResponder[armcontainerstorage.PoolsClientUpdateResponse], errResp azfake.ErrorResponder)
}
