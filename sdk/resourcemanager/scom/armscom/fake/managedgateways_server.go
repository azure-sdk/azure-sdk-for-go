...
type ManagedGatewaysServer struct {
	...
	CreateOrUpdate func(ctx context.Context, resourceGroupName string, managedGateway armscom.ManagedGateway, options *armscom.ManagedGatewaysClientCreateOrUpdateOptions) (resp azfake.Responder[armscom.ManagedGatewaysClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)
