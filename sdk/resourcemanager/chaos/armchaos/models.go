...
type CapabilityTypeProperties struct {
	...
	PermissionsNecessary *CapabilityTypePropertiesPermissionsNecessary `json:"permissionsNecessary,omitempty" azure:"ro"`
...
type ResourceIdentity struct {
	...
	UserAssignedIdentities map[string]*ComponentsEwb5TmSchemasUserassignedidentitiesAdditionalproperties `json:"userAssignedIdentities,omitempty"`
