...
func (o OnUploadFilters) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "excludeBlobsBeginningWith", o.ExcludeBlobsBeginningWith)
	populate(objectMap, "excludeBlobsEndingWith", o.ExcludeBlobsEndingWith)
	populate(objectMap, "excludeBlobsLargerThan", o.ExcludeBlobsLargerThan)
	return json.Marshal(objectMap)
}
...
func (o *OnUploadFilters) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		var err error
		switch key {
		case "excludeBlobsBeginningWith":
			err = unpopulate(val, "ExcludeBlobsBeginningWith", &o.ExcludeBlobsBeginningWith)
			delete(rawMsg, key)
		case "excludeBlobsEndingWith":
			err = unpopulate(val, "ExcludeBlobsEndingWith", &o.ExcludeBlobsEndingWith)
			delete(rawMsg, key)
