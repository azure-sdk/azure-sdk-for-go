...
func NewAssessmentsOperationsClient(subscriptionID string, credential azcore.TokenCredential, options *arm.ClientOptions) (*AssessmentsOperationsClient, error) {
	cl, err := arm.NewClient(moduleName+".AssessmentsOperationsClient", moduleVersion, credential, options)
	if err != nil {
		return nil, err
	}
...
func (client *AssessmentsOperationsClient) BeginCreate(ctx context.Context, resourceGroupName string, projectName string, groupName string, assessmentName string, resource Assessment, options *AssessmentsOperationsClientBeginCreateOptions) (*runtime.Poller[AssessmentsOperationsClientCreateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return runtime.NewPollerFromResumeToken[AssessmentsOperationsClientCreateResponse](options.ResumeToken, client.internal.Pipeline(), nil)
	}
}
...
func (client *AssessmentsOperationsClient) createCreateRequest(ctx context.Context, resourceGroupName string, projectName string, groupName string, assessmentName string, resource Assessment, options *AssessmentsOperationsClientBeginCreateOptions) (*policy.Request, error) {
...
func (client *AssessmentsOperationsClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, projectName string, groupName string, assessmentName string, options *AssessmentsOperationsClientDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Migrate/assessmentProjects/{projectName}/groups/{groupName}/assessments/{assessmentName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *AssessmentsOperationsClient) BeginDownloadURL(ctx context.Context, resourceGroupName string, projectName string, groupName string, assessmentName string, body any, options *AssessmentsOperationsClientBeginDownloadURLOptions) (*runtime.Poller[AssessmentsOperationsClientDownloadURLResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return runtime.NewPollerFromResumeToken[AssessmentsOperationsClientDownloadURLResponse](options.ResumeToken, client.internal.Pipeline(), nil)
	}
}
...
func (client *AssessmentsOperationsClient) downloadURLCreateRequest(ctx context.Context, resourceGroupName string, projectName string, groupName string, assessmentName string, body any, options *AssessmentsOperationsClientBeginDownloadURLOptions) (*policy.Request, error) {
...
func (client *AssessmentsOperationsClient) getCreateRequest(ctx context.Context, resourceGroupName string, projectName string, groupName string, assessmentName string, options *AssessmentsOperationsClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Migrate/assessmentProjects/{projectName}/groups/{groupName}/assessments/{assessmentName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
	...
	return runtime.NewPager(runtime.PagingHandler[AssessmentsOperationsClientListByGroupResponse]{
		...
		Fetcher: func(ctx context.Context, page *AssessmentsOperationsClientListByGroupResponse) (AssessmentsOperationsClientListByGroupResponse, error) {
			...
			if !runtime.HasStatusCode(resp, http.StatusOK) {
				return AssessmentsOperationsClientListByGroupResponse{}, runtime.NewResponseError(resp)
			}
...
func (client *AssessmentsOperationsClient) listByGroupCreateRequest(ctx context.Context, resourceGroupName string, projectName string, groupName string, options *AssessmentsOperationsClientListByGroupOptions) (*policy.Request, error) {
