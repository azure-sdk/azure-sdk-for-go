...
// SQLOperationsStatusControllerServer is a fake server for instances of the armmigrationdiscovery.SQLOperationsStatusControllerClient type.
type SQLOperationsStatusControllerServer struct {
	...
	GetSQLOperationStatus func(ctx context.Context, resourceGroupName string, siteName string, sqlSiteName string, operationStatusName string, options *armmigrationdiscovery.SQLOperationsStatusControllerClientGetSQLOperationStatusOptions) (resp azfake.Responder[armmigrationdiscovery.SQLOperationsStatusControllerClientGetSQLOperationStatusResponse], errResp azfake.ErrorResponder)
}
...
// The returned SQLOperationsStatusControllerServerTransport instance is connected to an instance of armmigrationdiscovery.SQLOperationsStatusControllerClient via the
...
// SQLOperationsStatusControllerServerTransport connects instances of armmigrationdiscovery.SQLOperationsStatusControllerClient to instances of SQLOperationsStatusControllerServer.
