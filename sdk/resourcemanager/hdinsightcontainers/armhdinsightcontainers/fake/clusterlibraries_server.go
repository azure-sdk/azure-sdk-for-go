...
func (c *ClusterLibrariesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if clusterLibrariesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = clusterLibrariesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "ClusterLibrariesClient.BeginManageLibraries":
				res.resp, res.err = c.dispatchBeginManageLibraries(req)
			default:
...
// set this to conditionally intercept incoming requests to ClusterLibrariesServerTransport
var clusterLibrariesServerTransportInterceptor interface {
