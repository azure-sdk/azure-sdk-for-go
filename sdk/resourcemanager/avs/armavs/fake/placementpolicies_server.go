...
func (p *PlacementPoliciesServerTransport) dispatchNewListByClusterPager(req *http.Request) (*http.Response, error) {
	...
	if newListByClusterPager == nil {
		...
		resp := p.srv.NewListByClusterPager(resourceGroupNameParam, privateCloudNameParam, clusterNameParam, nil)
...
func (p *PlacementPoliciesServerTransport) dispatchUpdate(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := p.srv.Update(req.Context(), resourceGroupNameParam, privateCloudNameParam, clusterNameParam, placementPolicyNameParam, body, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
