...
type ConnectedEnvironmentProperties struct {
	...
	DaprResiliencyDefaults *DaprResiliencyDefaults `json:"daprResiliencyDefaults,omitempty"`
...
// ConnectedEnvironmentsDaprResiliencyCircuitBreakerPoliciesClientCreateOrUpdateOptions contains the optional parameters for
// the ConnectedEnvironmentsDaprResiliencyCircuitBreakerPoliciesClient.CreateOrUpdate method.
type ConnectedEnvironmentsDaprResiliencyCircuitBreakerPoliciesClientCreateOrUpdateOptions struct {
	// placeholder for future optional parameters
}

// ConnectedEnvironmentsDaprResiliencyCircuitBreakerPoliciesClientDeleteOptions contains the optional parameters for the ConnectedEnvironmentsDaprResiliencyCircuitBreakerPoliciesClient.Delete
// method.
type ConnectedEnvironmentsDaprResiliencyCircuitBreakerPoliciesClientDeleteOptions struct {
	// placeholder for future optional parameters
}

// ConnectedEnvironmentsDaprResiliencyCircuitBreakerPoliciesClientGetOptions contains the optional parameters for the ConnectedEnvironmentsDaprResiliencyCircuitBreakerPoliciesClient.Get
// method.
type ConnectedEnvironmentsDaprResiliencyCircuitBreakerPoliciesClientGetOptions struct {
	// placeholder for future optional parameters
}

// ConnectedEnvironmentsDaprResiliencyCircuitBreakerPoliciesClientListOptions contains the optional parameters for the ConnectedEnvironmentsDaprResiliencyCircuitBreakerPoliciesClient.NewListPager
// method.
type ConnectedEnvironmentsDaprResiliencyCircuitBreakerPoliciesClientListOptions struct {
	// placeholder for future optional parameters
}

// ConnectedEnvironmentsDaprResiliencyRetryPoliciesClientCreateOrUpdateOptions contains the optional parameters for the ConnectedEnvironmentsDaprResiliencyRetryPoliciesClient.CreateOrUpdate
// method.
type ConnectedEnvironmentsDaprResiliencyRetryPoliciesClientCreateOrUpdateOptions struct {
	// placeholder for future optional parameters
}

// ConnectedEnvironmentsDaprResiliencyRetryPoliciesClientDeleteOptions contains the optional parameters for the ConnectedEnvironmentsDaprResiliencyRetryPoliciesClient.Delete
// method.
type ConnectedEnvironmentsDaprResiliencyRetryPoliciesClientDeleteOptions struct {
	// placeholder for future optional parameters
}

// ConnectedEnvironmentsDaprResiliencyRetryPoliciesClientGetOptions contains the optional parameters for the ConnectedEnvironmentsDaprResiliencyRetryPoliciesClient.Get
// method.
type ConnectedEnvironmentsDaprResiliencyRetryPoliciesClientGetOptions struct {
	// placeholder for future optional parameters
}

// ConnectedEnvironmentsDaprResiliencyRetryPoliciesClientListOptions contains the optional parameters for the ConnectedEnvironmentsDaprResiliencyRetryPoliciesClient.NewListPager
// method.
type ConnectedEnvironmentsDaprResiliencyRetryPoliciesClientListOptions struct {
	// placeholder for future optional parameters
}

// ConnectedEnvironmentsDaprResiliencyTimeoutPoliciesClientCreateOrUpdateOptions contains the optional parameters for the
// ConnectedEnvironmentsDaprResiliencyTimeoutPoliciesClient.CreateOrUpdate method.
type ConnectedEnvironmentsDaprResiliencyTimeoutPoliciesClientCreateOrUpdateOptions struct {
	// placeholder for future optional parameters
}

// ConnectedEnvironmentsDaprResiliencyTimeoutPoliciesClientDeleteOptions contains the optional parameters for the ConnectedEnvironmentsDaprResiliencyTimeoutPoliciesClient.Delete
// method.
type ConnectedEnvironmentsDaprResiliencyTimeoutPoliciesClientDeleteOptions struct {
	// placeholder for future optional parameters
}

// ConnectedEnvironmentsDaprResiliencyTimeoutPoliciesClientGetOptions contains the optional parameters for the ConnectedEnvironmentsDaprResiliencyTimeoutPoliciesClient.Get
// method.
type ConnectedEnvironmentsDaprResiliencyTimeoutPoliciesClientGetOptions struct {
	// placeholder for future optional parameters
}

// ConnectedEnvironmentsDaprResiliencyTimeoutPoliciesClientListOptions contains the optional parameters for the ConnectedEnvironmentsDaprResiliencyTimeoutPoliciesClient.NewListPager
// method.
type ConnectedEnvironmentsDaprResiliencyTimeoutPoliciesClientListOptions struct {
	// placeholder for future optional parameters
}
...
type Dapr struct {
	...
	ResiliencyTargets *DaprResiliencyTargets `json:"resiliencyTargets,omitempty"`
}

// DaprActorResiliencyTarget - Dapr Actor for applied policies
type DaprActorResiliencyTarget struct {
	// REQUIRED; Name of the dapr actor type to apply policies to.
	...
	CircuitBreakerCacheSize *int32 `json:"circuitBreakerCacheSize,omitempty"`

	// Circuit breakers for actors are scoped by 'id', 'type' or 'both'.
	CircuitBreakerScope *string `json:"circuitBreakerScope,omitempty"`
...
// DaprAppResiliencyTarget - Dapr Application for applied policies
type DaprAppResiliencyTarget struct {
	// REQUIRED; Name of the dapr application to apply policies to.
	Target *string `json:"target,omitempty"`
...
// DaprComponentResiliencyTarget - Dapr Component for applied policies
type DaprComponentResiliencyTarget struct {
	// REQUIRED; Name of the dapr component to apply policies to.
	Target *string `json:"target,omitempty"`

	// Inbound operations are calls from the dapr sidecar to your application
	Inbound *DaprComponentResiliencyTargetInbound `json:"inbound,omitempty"`

	// Outbound operations are calls from the dapr sidecar to a component
	Outbound *DaprComponentResiliencyTargetOutbound `json:"outbound,omitempty"`
}

// DaprComponentResiliencyTargetInbound - Inbound operations are calls from the dapr sidecar to your application
type DaprComponentResiliencyTargetInbound struct {
	// Name of Circuit Breaker Policy to apply.
	CircuitBreaker *string `json:"circuitBreaker,omitempty"`
...
// DaprComponentResiliencyTargetOutbound - Outbound operations are calls from the dapr sidecar to a component
type DaprComponentResiliencyTargetOutbound struct {
	// Name of Circuit Breaker Policy to apply.
	CircuitBreaker *string `json:"circuitBreaker,omitempty"`
...
// DaprResiliencyCircuitBreakerPoliciesClientCreateOrUpdateOptions contains the optional parameters for the DaprResiliencyCircuitBreakerPoliciesClient.CreateOrUpdate
// method.
type DaprResiliencyCircuitBreakerPoliciesClientCreateOrUpdateOptions struct {
	// placeholder for future optional parameters
}

// DaprResiliencyCircuitBreakerPoliciesClientDeleteOptions contains the optional parameters for the DaprResiliencyCircuitBreakerPoliciesClient.Delete
// method.
type DaprResiliencyCircuitBreakerPoliciesClientDeleteOptions struct {
	// placeholder for future optional parameters
}

// DaprResiliencyCircuitBreakerPoliciesClientGetOptions contains the optional parameters for the DaprResiliencyCircuitBreakerPoliciesClient.Get
// method.
type DaprResiliencyCircuitBreakerPoliciesClientGetOptions struct {
	// placeholder for future optional parameters
}

// DaprResiliencyCircuitBreakerPoliciesClientListOptions contains the optional parameters for the DaprResiliencyCircuitBreakerPoliciesClient.NewListPager
// method.
type DaprResiliencyCircuitBreakerPoliciesClientListOptions struct {
	// placeholder for future optional parameters
}

// DaprResiliencyCircuitBreakerPoliciesCollection - Dapr Resiliency Circuit Breaker Policy ARM resource.
type DaprResiliencyCircuitBreakerPoliciesCollection struct {
	// REQUIRED; Collection of resources.
	Value []*DaprResiliencyCircuitBreakerPolicy `json:"value,omitempty"`

	// READ-ONLY; Link to next page of resources.
	NextLink *string `json:"nextLink,omitempty" azure:"ro"`
}

// DaprResiliencyCircuitBreakerPolicy - Resiliency Policy Circuit Breakers Policy
type DaprResiliencyCircuitBreakerPolicy struct {
	// DaprResiliencyCircuitBreakerPolicy resource specific properties
	Properties *DaprResiliencyCircuitBreakerPolicyProperties `json:"properties,omitempty"`
...
// DaprResiliencyCircuitBreakerPolicyProperties - DaprResiliencyCircuitBreakerPolicy resource specific properties
type DaprResiliencyCircuitBreakerPolicyProperties struct {
	...
	// A Common Expression Language (CEL) statement that is evaluated by the CB When the statement evaluates to true, the CB trips
	// and becomes open
	Trip *string `json:"trip,omitempty"`
}

// DaprResiliencyDefaults - Default Resiliency Policy
type DaprResiliencyDefaults struct {
	// Circuit Breaker Policy
	CircuitBreakers []*DaprResiliencyCircuitBreakerPolicy `json:"circuitBreakers,omitempty"`

	// Retry Policies
	Retries []*DaprResiliencyRetryPolicy `json:"retries,omitempty"`

	// Timeout Policy
	Timeouts *DaprResiliencyTimeoutPolicy `json:"timeouts,omitempty"`
}

// DaprResiliencyRetryPoliciesClientCreateOrUpdateOptions contains the optional parameters for the DaprResiliencyRetryPoliciesClient.CreateOrUpdate
// method.
type DaprResiliencyRetryPoliciesClientCreateOrUpdateOptions struct {
	// placeholder for future optional parameters
}

// DaprResiliencyRetryPoliciesClientDeleteOptions contains the optional parameters for the DaprResiliencyRetryPoliciesClient.Delete
// method.
type DaprResiliencyRetryPoliciesClientDeleteOptions struct {
	// placeholder for future optional parameters
}

// DaprResiliencyRetryPoliciesClientGetOptions contains the optional parameters for the DaprResiliencyRetryPoliciesClient.Get
// method.
type DaprResiliencyRetryPoliciesClientGetOptions struct {
	// placeholder for future optional parameters
}

// DaprResiliencyRetryPoliciesClientListOptions contains the optional parameters for the DaprResiliencyRetryPoliciesClient.NewListPager
// method.
type DaprResiliencyRetryPoliciesClientListOptions struct {
	// placeholder for future optional parameters
}

// DaprResiliencyRetryPoliciesCollection - Dapr Resiliency Retry Policy ARM resource.
type DaprResiliencyRetryPoliciesCollection struct {
	// REQUIRED; Collection of resources.
	Value []*DaprResiliencyRetryPolicy `json:"value,omitempty"`

	// READ-ONLY; Link to next page of resources.
	NextLink *string `json:"nextLink,omitempty" azure:"ro"`
}

// DaprResiliencyRetryPolicy - Resiliency Policy Retries
type DaprResiliencyRetryPolicy struct {
	// DaprResiliencyRetryPolicy resource specific properties
	Properties *DaprResiliencyRetryPolicyProperties `json:"properties,omitempty"`
...
// DaprResiliencyRetryPolicyProperties - DaprResiliencyRetryPolicy resource specific properties
type DaprResiliencyRetryPolicyProperties struct {
...
// DaprResiliencyTargets - Dapr targets for for applied resiliency policies
type DaprResiliencyTargets struct {
	// List of actor targets their applied policies
	Actors []*DaprActorResiliencyTarget `json:"actors,omitempty"`

	// List of application targets their applied policies
	Apps []*DaprAppResiliencyTarget `json:"apps,omitempty"`

	// List of component targets their applied policies
	Components []*DaprComponentResiliencyTarget `json:"components,omitempty"`
}

// DaprResiliencyTimeoutPoliciesClientCreateOrUpdateOptions contains the optional parameters for the DaprResiliencyTimeoutPoliciesClient.CreateOrUpdate
// method.
type DaprResiliencyTimeoutPoliciesClientCreateOrUpdateOptions struct {
	// placeholder for future optional parameters
}

// DaprResiliencyTimeoutPoliciesClientDeleteOptions contains the optional parameters for the DaprResiliencyTimeoutPoliciesClient.Delete
// method.
type DaprResiliencyTimeoutPoliciesClientDeleteOptions struct {
	// placeholder for future optional parameters
}

// DaprResiliencyTimeoutPoliciesClientGetOptions contains the optional parameters for the DaprResiliencyTimeoutPoliciesClient.Get
// method.
type DaprResiliencyTimeoutPoliciesClientGetOptions struct {
	// placeholder for future optional parameters
}

// DaprResiliencyTimeoutPoliciesClientListOptions contains the optional parameters for the DaprResiliencyTimeoutPoliciesClient.NewListPager
// method.
type DaprResiliencyTimeoutPoliciesClientListOptions struct {
	// placeholder for future optional parameters
}

// DaprResiliencyTimeoutPoliciesCollection - Dapr Resiliency Timeout Policy ARM resource.
type DaprResiliencyTimeoutPoliciesCollection struct {
	// REQUIRED; Collection of resources.
	Value []*DaprResiliencyTimeoutPolicy `json:"value,omitempty"`

	// READ-ONLY; Link to next page of resources.
	NextLink *string `json:"nextLink,omitempty" azure:"ro"`
}

// DaprResiliencyTimeoutPolicy - Resiliency Policy Retries
type DaprResiliencyTimeoutPolicy struct {
	// DaprResiliencyTimeoutPolicy resource specific properties
	Properties *DaprResiliencyTimeoutPolicyProperties `json:"properties,omitempty"`
...
// DaprResiliencyTimeoutPolicyProperties - DaprResiliencyTimeoutPolicy resource specific properties
type DaprResiliencyTimeoutPolicyProperties struct {
