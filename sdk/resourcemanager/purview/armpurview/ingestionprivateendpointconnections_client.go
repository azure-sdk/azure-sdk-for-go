...
func NewIngestionPrivateEndpointConnectionsClient(subscriptionID string, credential azcore.TokenCredential, options *arm.ClientOptions) (*IngestionPrivateEndpointConnectionsClient, error) {
	cl, err := arm.NewClient(moduleName+".IngestionPrivateEndpointConnectionsClient", moduleVersion, credential, options)
	if err != nil {
		return nil, err
	}
	...
	return runtime.NewPager(runtime.PagingHandler[IngestionPrivateEndpointConnectionsClientListResponse]{
		...
		Fetcher: func(ctx context.Context, page *IngestionPrivateEndpointConnectionsClientListResponse) (IngestionPrivateEndpointConnectionsClientListResponse, error) {
			...
			if !runtime.HasStatusCode(resp, http.StatusOK) {
				return IngestionPrivateEndpointConnectionsClientListResponse{}, runtime.NewResponseError(resp)
			}
...
func (client *IngestionPrivateEndpointConnectionsClient) listCreateRequest(ctx context.Context, resourceGroupName string, accountName string, options *IngestionPrivateEndpointConnectionsClientListOptions) (*policy.Request, error) {
...
func (client *IngestionPrivateEndpointConnectionsClient) updateStatusCreateRequest(ctx context.Context, resourceGroupName string, accountName string, request PrivateEndpointConnectionStatusUpdateRequest, options *IngestionPrivateEndpointConnectionsClientUpdateStatusOptions) (*policy.Request, error) {
