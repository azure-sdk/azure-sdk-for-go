...
// MarshalJSON implements the json.Marshaller interface for type APIFlowOptions.
func (a APIFlowOptions) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "apiMode", a.APIMode)
	populate(objectMap, "audienceOverride", a.AudienceOverride)
	populate(objectMap, "cname", a.Cname)
	populate(objectMap, "identityTranslation", a.IdentityTranslation)
	populate(objectMap, "remoteCallingModeClientId", a.RemoteCallingModeClientID)
	populate(objectMap, "remoteEndpoint", a.RemoteEndpoint)
	populate(objectMap, "senderClientId", a.SenderClientID)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type APIFlowOptions.
func (a *APIFlowOptions) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "apiMode":
			err = unpopulate(val, "APIMode", &a.APIMode)
			delete(rawMsg, key)
		case "audienceOverride":
			err = unpopulate(val, "AudienceOverride", &a.AudienceOverride)
			delete(rawMsg, key)
		case "cname":
			err = unpopulate(val, "Cname", &a.Cname)
			delete(rawMsg, key)
		case "identityTranslation":
			err = unpopulate(val, "IdentityTranslation", &a.IdentityTranslation)
			delete(rawMsg, key)
		case "remoteCallingModeClientId":
			err = unpopulate(val, "RemoteCallingModeClientID", &a.RemoteCallingModeClientID)
			delete(rawMsg, key)
		case "remoteEndpoint":
			err = unpopulate(val, "RemoteEndpoint", &a.RemoteEndpoint)
			delete(rawMsg, key)
		case "senderClientId":
			err = unpopulate(val, "SenderClientID", &a.SenderClientID)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", a, err)
...
// MarshalJSON implements the json.Marshaller interface for type ConnectionIDList.
func (c ConnectionIDList) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "value", c.Value)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ConnectionIDList.
func (c *ConnectionIDList) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
...
func (c ConnectionProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "forceDisabledStatus", c.ForceDisabledStatus)
	...
	populate(objectMap, "schemaUris", c.SchemaUris)
...
func (c *ConnectionProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "flowTypes":
			...
			delete(rawMsg, key)
		case "forceDisabledStatus":
			err = unpopulate(val, "ForceDisabledStatus", &c.ForceDisabledStatus)
			delete(rawMsg, key)
		case "justification":
		...
		case "requirementId":
			...
			delete(rawMsg, key)
		case "schemaUris":
			err = unpopulate(val, "SchemaUris", &c.SchemaUris)
			delete(rawMsg, key)
		case "schemas":
...
// MarshalJSON implements the json.Marshaller interface for type FlowListResult.
func (f FlowListResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type FlowListResult.
func (f *FlowListResult) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", f, err)
	}
...
func (f FlowProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "apiFlowOptions", f.APIFlowOptions)
	populate(objectMap, "connection", f.Connection)
	populate(objectMap, "consumerGroup", f.ConsumerGroup)
	populate(objectMap, "customerManagedKeyVaultUri", f.CustomerManagedKeyVaultURI)
	populate(objectMap, "dataType", f.DataType)
	populate(objectMap, "destinationEndpointPorts", f.DestinationEndpointPorts)
	populate(objectMap, "destinationEndpoints", f.DestinationEndpoints)
	populate(objectMap, "eventHubId", f.EventHubID)
	populate(objectMap, "flowId", f.FlowID)
	populate(objectMap, "flowType", f.FlowType)
	populate(objectMap, "forceDisabledStatus", f.ForceDisabledStatus)
	...
	populate(objectMap, "passphrase", f.Passphrase)
	...
	populate(objectMap, "storageTableName", f.StorageTableName)
	populate(objectMap, "streamId", f.StreamID)
	populate(objectMap, "streamLatency", f.StreamLatency)
	populate(objectMap, "streamProtocol", f.StreamProtocol)
	return json.Marshal(objectMap)
}
...
func (f *FlowProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "apiFlowOptions":
			err = unpopulate(val, "APIFlowOptions", &f.APIFlowOptions)
			delete(rawMsg, key)
		case "connection":
			err = unpopulate(val, "Connection", &f.Connection)
			delete(rawMsg, key)
		case "consumerGroup":
			err = unpopulate(val, "ConsumerGroup", &f.ConsumerGroup)
			delete(rawMsg, key)
		case "customerManagedKeyVaultUri":
			err = unpopulate(val, "CustomerManagedKeyVaultURI", &f.CustomerManagedKeyVaultURI)
			delete(rawMsg, key)
		case "dataType":
			err = unpopulate(val, "DataType", &f.DataType)
			delete(rawMsg, key)
		case "destinationEndpointPorts":
			err = unpopulate(val, "DestinationEndpointPorts", &f.DestinationEndpointPorts)
			delete(rawMsg, key)
		case "destinationEndpoints":
			err = unpopulate(val, "DestinationEndpoints", &f.DestinationEndpoints)
			delete(rawMsg, key)
		case "eventHubId":
			err = unpopulate(val, "EventHubID", &f.EventHubID)
			delete(rawMsg, key)
		case "flowId":
		...
		case "flowType":
			...
			delete(rawMsg, key)
		case "forceDisabledStatus":
			err = unpopulate(val, "ForceDisabledStatus", &f.ForceDisabledStatus)
			delete(rawMsg, key)
		case "keyVaultUri":
		...
		case "messagingOptions":
			...
			delete(rawMsg, key)
		case "passphrase":
			err = unpopulate(val, "Passphrase", &f.Passphrase)
			delete(rawMsg, key)
		case "policies":
		...
		case "storageTableName":
			err = unpopulate(val, "StorageTableName", &f.StorageTableName)
			delete(rawMsg, key)
		case "streamId":
			err = unpopulate(val, "StreamID", &f.StreamID)
			delete(rawMsg, key)
		case "streamLatency":
			err = unpopulate(val, "StreamLatency", &f.StreamLatency)
			delete(rawMsg, key)
		case "streamProtocol":
			err = unpopulate(val, "StreamProtocol", &f.StreamProtocol)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", f, err)
...
// MarshalJSON implements the json.Marshaller interface for type GetDestinationEndpointPortsResult.
func (g GetDestinationEndpointPortsResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "ports", g.Ports)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type GetDestinationEndpointPortsResult.
func (g *GetDestinationEndpointPortsResult) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "ports":
			err = unpopulate(val, "Ports", &g.Ports)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", g, err)
...
// MarshalJSON implements the json.Marshaller interface for type GetDestinationEndpointsResult.
func (g GetDestinationEndpointsResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "endpoints", g.Endpoints)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type GetDestinationEndpointsResult.
func (g *GetDestinationEndpointsResult) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", g, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type GetStreamConnectionStringResult.
func (g GetStreamConnectionStringResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "connectionString", g.ConnectionString)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type GetStreamConnectionStringResult.
func (g *GetStreamConnectionStringResult) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", g, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type ListFlowsByPipelineConnection.
func (l ListFlowsByPipelineConnection) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "flows", l.Flows)
	populate(objectMap, "id", l.ID)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ListFlowsByPipelineConnection.
func (l *ListFlowsByPipelineConnection) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", l, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "flows":
			err = unpopulate(val, "Flows", &l.Flows)
			delete(rawMsg, key)
		case "id":
...
// MarshalJSON implements the json.Marshaller interface for type ListFlowsByPipelineResult.
func (l ListFlowsByPipelineResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "value", l.Value)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ListFlowsByPipelineResult.
func (l *ListFlowsByPipelineResult) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", l, err)
	}
...
func (p PendingConnection) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "forceDisabledStatus", p.ForceDisabledStatus)
	...
	populate(objectMap, "schemaUris", p.SchemaUris)
...
func (p *PendingConnection) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "flowTypes":
			...
			delete(rawMsg, key)
		case "forceDisabledStatus":
			err = unpopulate(val, "ForceDisabledStatus", &p.ForceDisabledStatus)
			delete(rawMsg, key)
		case "id":
		...
		case "requirementId":
			...
			delete(rawMsg, key)
		case "schemaUris":
			err = unpopulate(val, "SchemaUris", &p.SchemaUris)
			delete(rawMsg, key)
		case "schemas":
...
// MarshalJSON implements the json.Marshaller interface for type PendingConnectionListResult.
func (p PendingConnectionListResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type PendingConnectionListResult.
func (p *PendingConnectionListResult) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", p, err)
	}
...
func (p PendingFlow) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "apiFlowOptions", p.APIFlowOptions)
	...
	populate(objectMap, "customerManagedKeyVaultUri", p.CustomerManagedKeyVaultURI)
	populate(objectMap, "dataType", p.DataType)
	populate(objectMap, "destinationEndpointPorts", p.DestinationEndpointPorts)
	populate(objectMap, "destinationEndpoints", p.DestinationEndpoints)
	populate(objectMap, "eventHubId", p.EventHubID)
	...
	populate(objectMap, "name", p.Name)
	populate(objectMap, "passphrase", p.Passphrase)
	populate(objectMap, "policies", p.Policies)
	populate(objectMap, "properties", p.Properties)
	populate(objectMap, "provisioningState", p.ProvisioningState)
	populate(objectMap, "schema", p.Schema)
	populate(objectMap, "serviceBusQueueId", p.ServiceBusQueueID)
	populate(objectMap, "sourceAddresses", p.SourceAddresses)
	populate(objectMap, "status", p.Status)
	...
	populate(objectMap, "storageTableName", p.StorageTableName)
	populate(objectMap, "streamId", p.StreamID)
	populate(objectMap, "streamLatency", p.StreamLatency)
	populate(objectMap, "streamProtocol", p.StreamProtocol)
	populate(objectMap, "subscriptionId", p.SubscriptionID)
	populate(objectMap, "systemData", p.SystemData)
	populate(objectMap, "tags", p.Tags)
	populate(objectMap, "type", p.Type)
...
func (p *PendingFlow) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "apiFlowOptions":
			err = unpopulate(val, "APIFlowOptions", &p.APIFlowOptions)
			delete(rawMsg, key)
		case "connection":
		...
		case "consumerGroup":
			...
			delete(rawMsg, key)
		case "customerManagedKeyVaultUri":
			err = unpopulate(val, "CustomerManagedKeyVaultURI", &p.CustomerManagedKeyVaultURI)
			delete(rawMsg, key)
		case "dataType":
			err = unpopulate(val, "DataType", &p.DataType)
			delete(rawMsg, key)
		case "destinationEndpointPorts":
			err = unpopulate(val, "DestinationEndpointPorts", &p.DestinationEndpointPorts)
			delete(rawMsg, key)
		case "destinationEndpoints":
			err = unpopulate(val, "DestinationEndpoints", &p.DestinationEndpoints)
			delete(rawMsg, key)
		case "eventHubId":
			err = unpopulate(val, "EventHubID", &p.EventHubID)
			delete(rawMsg, key)
		case "flowId":
		...
		case "name":
			...
			delete(rawMsg, key)
		case "passphrase":
			err = unpopulate(val, "Passphrase", &p.Passphrase)
			delete(rawMsg, key)
		case "policies":
			err = unpopulate(val, "Policies", &p.Policies)
			delete(rawMsg, key)
		...
		case "serviceBusQueueId":
			...
			delete(rawMsg, key)
		case "sourceAddresses":
			err = unpopulate(val, "SourceAddresses", &p.SourceAddresses)
			delete(rawMsg, key)
		case "status":
			err = unpopulate(val, "Status", &p.Status)
			delete(rawMsg, key)
		...
		case "storageContainerName":
			...
			delete(rawMsg, key)
		case "storageTableName":
			err = unpopulate(val, "StorageTableName", &p.StorageTableName)
			delete(rawMsg, key)
		case "streamId":
			err = unpopulate(val, "StreamID", &p.StreamID)
			delete(rawMsg, key)
		case "streamLatency":
			err = unpopulate(val, "StreamLatency", &p.StreamLatency)
			delete(rawMsg, key)
		case "streamProtocol":
			err = unpopulate(val, "StreamProtocol", &p.StreamProtocol)
			delete(rawMsg, key)
		case "subscriptionId":
			err = unpopulate(val, "SubscriptionID", &p.SubscriptionID)
			delete(rawMsg, key)
...
// MarshalJSON implements the json.Marshaller interface for type PendingFlowListResult.
func (p PendingFlowListResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "nextLink", p.NextLink)
	populate(objectMap, "value", p.Value)
	return json.Marshal(objectMap)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type PendingFlowListResult.
func (p *PendingFlowListResult) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", p, err)
	}
...
func (p PipelineProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "disabledFlowTypes", p.DisabledFlowTypes)
	populate(objectMap, "displayName", p.DisplayName)
	populate(objectMap, "flowTypes", p.FlowTypes)
	populate(objectMap, "policies", p.Policies)
	populate(objectMap, "provisioningState", p.ProvisioningState)
	populate(objectMap, "quarantineDownloadStorageAccount", p.QuarantineDownloadStorageAccount)
	populate(objectMap, "quarantineDownloadStorageContainer", p.QuarantineDownloadStorageContainer)
...
func (p *PipelineProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "connections":
			...
			delete(rawMsg, key)
		case "disabledFlowTypes":
			err = unpopulate(val, "DisabledFlowTypes", &p.DisabledFlowTypes)
			delete(rawMsg, key)
		case "displayName":
		...
		case "provisioningState":
			err = unpopulate(val, "ProvisioningState", &p.ProvisioningState)
			delete(rawMsg, key)
		case "quarantineDownloadStorageAccount":
			err = unpopulate(val, "QuarantineDownloadStorageAccount", &p.QuarantineDownloadStorageAccount)
			delete(rawMsg, key)
		case "quarantineDownloadStorageContainer":
			err = unpopulate(val, "QuarantineDownloadStorageContainer", &p.QuarantineDownloadStorageContainer)
			delete(rawMsg, key)
		case "remoteCloud":
...
func (s Schema) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "schemaUri", s.SchemaURI)
...
func (s *Schema) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "schemaType":
			...
			delete(rawMsg, key)
		case "schemaUri":
			err = unpopulate(val, "SchemaURI", &s.SchemaURI)
			delete(rawMsg, key)
		case "status":
...
// MarshalJSON implements the json.Marshaller interface for type SetDestinationEndpointPorts.
func (s SetDestinationEndpointPorts) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "ports", s.Ports)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type SetDestinationEndpointPorts.
func (s *SetDestinationEndpointPorts) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type SetDestinationEndpoints.
func (s SetDestinationEndpoints) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "endpoints", s.Endpoints)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type SetDestinationEndpoints.
func (s *SetDestinationEndpoints) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "endpoints":
			err = unpopulate(val, "Endpoints", &s.Endpoints)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", s, err)
...
// MarshalJSON implements the json.Marshaller interface for type SetSourceAddresses.
func (s SetSourceAddresses) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "values", s.Values)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type SetSourceAddresses.
func (s *SetSourceAddresses) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type SetStreamPassphrase.
func (s SetStreamPassphrase) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "value", s.Value)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type SetStreamPassphrase.
func (s *SetStreamPassphrase) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type StreamSourceAddresses.
func (s StreamSourceAddresses) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "sourceAddresses", s.SourceAddresses)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type StreamSourceAddresses.
func (s *StreamSourceAddresses) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "sourceAddresses":
			err = unpopulate(val, "SourceAddresses", &s.SourceAddresses)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", s, err)
