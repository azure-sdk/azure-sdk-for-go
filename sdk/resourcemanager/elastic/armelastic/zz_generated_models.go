...
// DetachAndDeleteTrafficFilterClientBeginDeleteOptions contains the optional parameters for the DetachAndDeleteTrafficFilterClient.BeginDelete
// method.
type DetachAndDeleteTrafficFilterClientBeginDeleteOptions struct {
	// Resumes the LRO from the provided token.
	ResumeToken string
	// Ruleset Id of the filter
	RulesetID *string
