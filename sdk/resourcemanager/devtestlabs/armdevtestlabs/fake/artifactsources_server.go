...
func (a *ArtifactSourcesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if artifactSourcesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = artifactSourcesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to ArtifactSourcesServerTransport
var artifactSourcesServerTransportInterceptor interface {
