...
// MarshalJSON implements the json.Marshaller interface for type ExecutionTargetUpdate.
func (e ExecutionTargetUpdate) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "excludePrefix", e.ExcludePrefix)
	populate(objectMap, "prefix", e.Prefix)
	return json.Marshal(objectMap)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type ExecutionTargetUpdate.
func (e *ExecutionTargetUpdate) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", e, err)
	}
