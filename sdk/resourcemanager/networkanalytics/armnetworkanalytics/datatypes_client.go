...
func (client *DataTypesClient) listByDataProductCreateRequest(ctx context.Context, resourceGroupName string, dataProductName string, _ *DataTypesClientListByDataProductOptions) (*policy.Request, error) {
...
func (client *DataTypesClient) updateCreateRequest(ctx context.Context, resourceGroupName string, dataProductName string, dataTypeName string, properties DataTypeUpdate, _ *DataTypesClientBeginUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetworkAnalytics/dataProducts/{dataProductName}/dataTypes/{dataTypeName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
